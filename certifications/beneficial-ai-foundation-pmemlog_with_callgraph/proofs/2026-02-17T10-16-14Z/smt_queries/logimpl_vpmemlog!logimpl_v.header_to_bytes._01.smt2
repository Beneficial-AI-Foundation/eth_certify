...
;; src/logimpl_v.rs:227:10: 227:72 (#0)
...
(push)
 ...
 (assert
  (has_type (Poly%pmemlog!logimpl_v.PersistentHeader. header!) TYPE%pmemlog!logimpl_v.PersistentHeader.)
 )
 ...
 (assert
  (not (=>
    ...
    (=>
     (= tmp%1 (pmemlog!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%pmemlog!logimpl_v.PersistentHeader.
        (Poly%pmemlog!logimpl_v.PersistentHeader. header!)
     )))
     (=>
      (ens%pmemlog!logimpl_v.metadata_to_bytes. tmp%1 metadata_bytes@0)
      (=>
       (= tmp%2 (pmemlog!logimpl_v.PersistentHeader./PersistentHeader/crc (%Poly%pmemlog!logimpl_v.PersistentHeader.
          (Poly%pmemlog!logimpl_v.PersistentHeader. header!)
       )))
       (=>
        (ens%vstd!bytes.u64_to_le_bytes. tmp%2 crc_bytes@0)
        (=>
         ...
         (=>
          (= verus_tmp_old_metadata_bytes@ verus_tmp@1)
          (=>
           ...
           (=>
            (= verus_tmp$1@1 (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
                $ (UINT 8) $ ALLOCATOR_GLOBAL
               ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. crc_bytes@0)
            )))
            (=>
             (= verus_tmp_old_crc_bytes@ verus_tmp$1@1)
             (=>
              (= old_crc_bytes@1 verus_tmp_old_crc_bytes@)
              (=>
               (ens%alloc!vec.impl&%1.append. $ (UINT 8) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u8./allocator_global%.>.
                 crc_bytes@0
                ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. crc_bytes@1) (Poly%alloc!vec.Vec<u8./allocator_global%.>.
                 metadata_bytes@0
               ...
               (=>
                (ens%vstd!bytes.lemma_auto_spec_u64_to_from_le_bytes. 0)
                (=>
                 (= tmp%3 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. old_crc_bytes@1)
                   (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $
                      (UINT 8) $ ALLOCATOR_GLOBAL
                     ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. crc_bytes@1)
                    ) (I pmemlog!logimpl_v.header_crc_offset.?) (I (Add pmemlog!logimpl_v.header_crc_offset.?
                      8
                 )))))
                 (and
                  ...
                  (=>
                   tmp%3
                   (=>
                    (= tmp%4 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. old_metadata_bytes@1)
                      (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $
                         (UINT 8) $ ALLOCATOR_GLOBAL
                        ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. crc_bytes@1)
                       ) (I pmemlog!logimpl_v.header_head_offset.?) (I pmemlog!logimpl_v.header_size.?)
                         ...
                         (and
                          (=>
                           ...
                           (ext_eq false TYPE%pmemlog!logimpl_v.PersistentHeaderMetadata. (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
                             (pmemlog!logimpl_v.spec_bytes_to_metadata.? (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.?
                                $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>.
                                 out!
                                )
                               ) (I pmemlog!logimpl_v.header_head_offset.?) (I pmemlog!logimpl_v.header_size.?)
