...
;; Function-Def pmemlog::math_v::lemma_div_relation_when_mods_have_same_order_alt
;; src/math_v.rs:71:5: 71:90 (#0)
                ...
                (or
                 (and
                  (=>
                   (< (EucDiv y! d!) (EucDiv x! d!))
                   (=>
                    (= tmp%7 (Sub (EucDiv y! d!) (EucDiv x! d!)))
                    (=>
                     (= tmp%8 (Sub 0 1))
                     (and
                      (=>
                       %%location_label%%5
                       (req%vstd!arithmetic.mul.lemma_mul_inequality. tmp%7 tmp%8 d!)
                      )
                      (=>
                       (ens%vstd!arithmetic.mul.lemma_mul_inequality. tmp%7 tmp%8 d!)
                       (=>
                        (= tmp%9 (<= (Mul (Sub (EucDiv y! d!) (EucDiv x! d!)) d!) (Mul (Sub 0 1) d!)))
                        (and
                         (=>
                          %%location_label%%6
                          tmp%9
