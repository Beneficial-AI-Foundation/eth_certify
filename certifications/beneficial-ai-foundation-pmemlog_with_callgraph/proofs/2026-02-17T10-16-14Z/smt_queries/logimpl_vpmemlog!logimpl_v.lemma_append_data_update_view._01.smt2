...
;; src/logimpl_v.rs:459:5: 459:97 (#0)
...
;; Function-Def pmemlog::logimpl_v::lemma_append_data_update_view
;; src/logimpl_v.rs:459:5: 459:97 (#0)
     ...
     (=>
      ...
      (=>
       (= new_pm@ (pmemlog!pmemspec_t.update_contents_to_reflect_write.? (Poly%vstd!seq.Seq<u8.>.
          pm!
         ) (I write_addr!) (Poly%vstd!seq.Seq<u8.>. new_bytes!)
       ))
       (and
        (=>
         %%location_label%%0
        ...
        (=>
         ...
         (and
          (=>
           %%location_label%%1
           (req%pmemlog!logimpl_v.lemma_incorruptible_bool_unchanged. pm! new_pm@)
          )
          (=>
           (ens%pmemlog!logimpl_v.lemma_incorruptible_bool_unchanged. pm! new_pm@)
           (=>
            (= tmp%1 (ext_eq false TYPE%pmemlog!logimpl_v.PersistentHeader. (Poly%pmemlog!logimpl_v.PersistentHeader.
               live_header@
              ) (Poly%pmemlog!logimpl_v.PersistentHeader. (pmemlog!logimpl_v.spec_get_live_header.?
                (Poly%vstd!seq.Seq<u8.>. new_pm@)
            ))))
            (and
             (=>
              %%location_label%%2
             ...
             (=>
              ...
              (=>
               (= tmp%2 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT
                   8
                  ) (Poly%vstd!seq.Seq<u8.>. new_pm@) (I 0) (I write_addr!)
                 ) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!) (I 0) (I write_addr!))
               ))
               (and
                (=>
                 %%location_label%%3
                ...
                (=>
                 ...
                 (=>
                  (= tmp%3 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT
                      8
                     ) (Poly%vstd!seq.Seq<u8.>. new_pm@) (I (Add write_addr! (vstd!seq.Seq.len.? $ (UINT 8)
                        (Poly%vstd!seq.Seq<u8.>. new_bytes!)
                      ))
                     ) (I (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. new_pm@)))
                    ) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!) (I (Add write_addr!
                       (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. new_bytes!))
                      )
                     ) (I (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!)))
                  )))
                  (and
                   (=>
                    %%location_label%%4
                    ...
                    (and
                     (=>
                      ...
                      (req%pmemlog!logimpl_v.lemma_subrange_equality_implies_subsubrange_equality. $ (UINT
                        8
                       ) (Poly%vstd!seq.Seq<u8.>. pm!) (Poly%vstd!seq.Seq<u8.>. new_pm@) 0 write_addr!
                     ))
                     (=>
                      ...
                      (=>
                       (= tmp%4 (Add write_addr! (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. new_bytes!))))
                       (=>
                        (= tmp%5 (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. new_pm@)))
                        (and
                         (=>
                          %%location_label%%6
                          (req%pmemlog!logimpl_v.lemma_subrange_equality_implies_subsubrange_equality. $ (UINT
                            8
                           ) (Poly%vstd!seq.Seq<u8.>. pm!) (Poly%vstd!seq.Seq<u8.>. new_pm@) tmp%4 tmp%5
                         ))
                         (=>
                          (ens%pmemlog!logimpl_v.lemma_subrange_equality_implies_subsubrange_equality. $ (UINT
                            8
                            ...
                            (=>
                             ...
                             (=>
                              (= tmp%6 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT
                                  8
                                 ) (Poly%vstd!seq.Seq<u8.>. new_pm@) (I physical_head@) (I physical_tail@)
                                ) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!) (I physical_head@)
                                 (I physical_tail@)
                              )))
                              (and
                               (=>
