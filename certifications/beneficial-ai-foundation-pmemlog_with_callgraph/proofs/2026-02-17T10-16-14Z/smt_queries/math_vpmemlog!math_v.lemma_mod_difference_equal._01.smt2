...
;; Function-Def pmemlog::math_v::lemma_mod_difference_equal
;; src/math_v.rs:243:5: 243:68 (#0)
    ...
    (=>
     ...
     (and
      ...
      (=>
       ...
       (=>
        (= tmp%1 (= (Sub (Add (Sub (Mul d! (EucDiv y! d!)) (Mul d! (EucDiv x! d!))) (EucMod y!
             d!
            )
           ) (EucMod x! d!)
          ) (Sub y! x!)
         ...
         (=>
          ...
          (=>
           ...
           (=>
            (= tmp%3 (EucDiv x! d!))
            (=>
             (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub. d! tmp%2 tmp%3)
             (=>
              (= tmp%4 (= (Sub (Add (Mul d! (Sub (EucDiv y! d!) (EucDiv x! d!))) (EucMod y! d!)) (
                  EucMod x! d!
                 )
                ) (Sub y! x!)
              ))
              (and
               ...
               (=>
                ...
                (=>
                 (= tmp%5 (let
                   ((tmp%%$ (Sub (Add (Mul d! (Sub (EucDiv y! d!) (EucDiv x! d!))) (EucMod y! d!)) (EucMod
                       x! d!
                   ))))
                   (and
                    (<= 0 tmp%%$)
                     ...
                     (=>
                      ...
                      (and
                       ...
                       (=>
                        ...
                        (=>
                         %%location_label%%7
                         (= (Sub (EucMod y! d!) (EucMod x! d!)) (Sub y! x!))
 ))))))))))))))))))))))))
 (get-info :version)
