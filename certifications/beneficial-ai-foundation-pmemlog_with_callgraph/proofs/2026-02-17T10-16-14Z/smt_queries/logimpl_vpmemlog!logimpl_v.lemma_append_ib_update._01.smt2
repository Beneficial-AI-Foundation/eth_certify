...
;; src/logimpl_v.rs:784:5: 790:6 (#0)
...
;; Function-Def pmemlog::logimpl_v::lemma_append_ib_update
;; src/logimpl_v.rs:784:5: 790:6 (#0)
...
(push)
 ...
 (assert
  (let
   ...
   (forall ((pm_state$ Poly)) (!
     ...
     :qid user_pmemlog__logimpl_v__lemma_append_ib_update_56
     :skolemid skolem_user_pmemlog__logimpl_v__lemma_append_ib_update_56
 ))))
 ...
 (assert
  (not (and
    (=>
     %%location_label%%0
     (req%pmemlog!logimpl_v.lemma_append_ib_update_effect_on_committed. Perm&. Perm& pm!
      new_ib! bytes_to_append! new_header_bytes! perm!
    ))
    (=>
     (ens%pmemlog!logimpl_v.lemma_append_ib_update_effect_on_committed. Perm&. Perm& pm!
      new_ib! bytes_to_append! new_header_bytes! perm!
     )
     (=>
      (= ib_bytes@ (vstd!bytes.spec_u64_to_le_bytes.? (I new_ib!)))
      (=>
       ...
       (=>
        (= tmp%1 pmemlog!logimpl_v.incorruptible_bool_pos.?)
        (and
         (=>
          %%location_label%%1
          (req%pmemlog!logimpl_v.lemma_single_write_crash. pm! tmp%1 ib_bytes@)
         )
         (=>
          (ens%pmemlog!logimpl_v.lemma_single_write_crash. pm! tmp%1 ib_bytes@)
          (and
           (=>
            %%location_label%%2
            (let
           ...
           (=>
            ...
            (forall ((chunks_flushed$ Poly)) (!
              ...
              :qid user_pmemlog__logimpl_v__lemma_append_ib_update_55
              :skolemid skolem_user_pmemlog__logimpl_v__lemma_append_ib_update_55
 )))))))))))))
 (get-info :version)
