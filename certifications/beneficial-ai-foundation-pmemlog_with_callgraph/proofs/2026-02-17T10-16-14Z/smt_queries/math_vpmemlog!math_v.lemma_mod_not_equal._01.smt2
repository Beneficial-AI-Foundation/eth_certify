...
;; Function-Def pmemlog::math_v::lemma_mod_not_equal
;; src/math_v.rs:303:5: 303:61 (#0)
       ...
       (and
        (=>
         ...
         (and
          (=>
           %%location_label%%0
           (req%pmemlog!math_v.lemma_mod_equal. x! y! d!)
          )
          (=>
           (ens%pmemlog!math_v.lemma_mod_equal. x! y! d!)
           (=>
            %%location_label%%1
            false
        ))))
