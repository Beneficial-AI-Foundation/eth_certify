...
;; src/logimpl_v.rs:1091:5: 1091:97 (#0)
...
;; Function-Def pmemlog::logimpl_v::lemma_single_write_crash
;; src/logimpl_v.rs:1091:5: 1091:97 (#0)
 ...
 (assert
  (not (=>
    ...
    (forall ((chunks_flushed$ Poly)) (!
      ...
      :qid user_pmemlog__logimpl_v__lemma_single_write_crash_52
      :skolemid skolem_user_pmemlog__logimpl_v__lemma_single_write_crash_52
 )))))
 (get-info :version)
