...
;; src/logimpl_v.rs:266:10: 266:84 (#0)
...
;; Function-Def pmemlog::logimpl_v::metadata_to_bytes
;; src/logimpl_v.rs:266:10: 266:84 (#0)
...
(push)
 ...
 (assert
  (not (=>
    ...
    (=>
     (= bytes@0 (%Poly%alloc!vec.Vec<u8./allocator_global%.>. tmp%1))
     (=>
      (= verus_tmp@1 (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
          $ (UINT 8) $ ALLOCATOR_GLOBAL
         ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. bytes@0)
      )))
      (=>
       (= verus_tmp_old_bytes@ verus_tmp@1)
       (=>
        (= old_bytes@1 verus_tmp_old_bytes@)
        (=>
         ...
         (=>
          (ens%vstd!bytes.u64_to_le_bytes. tmp%2 head_bytes@0)
          (=>
           (= verus_tmp$1@1 (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
               $ (UINT 8) $ ALLOCATOR_GLOBAL
              ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. head_bytes@0)
           )))
           (=>
            (= verus_tmp_old_head_bytes@ verus_tmp$1@1)
            (=>
             (= old_head_bytes@1 verus_tmp_old_head_bytes@)
             (=>
              ...
              (=>
               (ens%vstd!bytes.u64_to_le_bytes. tmp%3 tail_bytes@0)
               (=>
                (= verus_tmp$2@1 (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
                    $ (UINT 8) $ ALLOCATOR_GLOBAL
                   ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. tail_bytes@0)
                )))
                (=>
                 (= verus_tmp_old_tail_bytes@ verus_tmp$2@1)
                 (=>
                  (= old_tail_bytes@1 verus_tmp_old_tail_bytes@)
                  (=>
                   ...
                   (=>
                    (ens%vstd!bytes.u64_to_le_bytes. tmp%4 log_size_bytes@0)
                    (=>
                     (= verus_tmp$3@1 (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
                         $ (UINT 8) $ ALLOCATOR_GLOBAL
                        ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. log_size_bytes@0)
                     )))
                     (=>
                      (= verus_tmp_old_log_size_bytes@ verus_tmp$3@1)
                      (=>
                       (= old_log_size_bytes@1 verus_tmp_old_log_size_bytes@)
                       (=>
                        (ens%alloc!vec.impl&%1.append. $ (UINT 8) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u8./allocator_global%.>.
                          bytes@0
                         ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. bytes@1) (Poly%alloc!vec.Vec<u8./allocator_global%.>.
                          head_bytes@0
                         ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. head_bytes@1)
                        )
                        (=>
                         (ens%alloc!vec.impl&%1.append. $ (UINT 8) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u8./allocator_global%.>.
                           bytes@1
                          ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. bytes@2) (Poly%alloc!vec.Vec<u8./allocator_global%.>.
                           tail_bytes@0
                          ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. tail_bytes@1)
                         )
                         (=>
                          (ens%alloc!vec.impl&%1.append. $ (UINT 8) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u8./allocator_global%.>.
                            bytes@2
                           ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. bytes@3) (Poly%alloc!vec.Vec<u8./allocator_global%.>.
                            log_size_bytes@0
                           ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. log_size_bytes@1)
                          )
                          (=>
                           (ens%vstd!bytes.lemma_auto_spec_u64_to_from_le_bytes. 0)
                           (=>
                            (= tmp%5 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. old_bytes@1)
                              (vstd!seq.Seq.empty.? $ (UINT 8))
                            ))
                            (and
                             (=>
                             ...
                             (=>
                              tmp%5
                              (=>
                               (= tmp%6 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. old_head_bytes@1)
                                 (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $
                                    (UINT 8) $ ALLOCATOR_GLOBAL
                                   ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. bytes@3)
                                  ) (I (Sub pmemlog!logimpl_v.header_head_offset.? 8)) (I (Add (Sub pmemlog!logimpl_v.header_head_offset.?
                                     8
                                    ) 8
                               )))))
                               (and
                                ...
                                (=>
                                 tmp%6
                                 (=>
                                  (= tmp%7 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. old_tail_bytes@1)
                                    (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $
                                       (UINT 8) $ ALLOCATOR_GLOBAL
                                      ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. bytes@3)
                                     ) (I (Sub pmemlog!logimpl_v.header_tail_offset.? 8)) (I (Add (Sub pmemlog!logimpl_v.header_tail_offset.?
                                  ...
                                  (and
                                   ...
                                   (=>
                                    tmp%7
                                    (=>
                                     (= tmp%8 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. old_log_size_bytes@1)
                                       (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $
                                          (UINT 8) $ ALLOCATOR_GLOBAL
                                         ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. bytes@3)
