...
;; src/logimpl_v.rs:151:5: 151:115 (#0)
...
;; Function-Def pmemlog::logimpl_v::lemma_header_split_into_bytes
;; src/logimpl_v.rs:151:5: 151:115 (#0)
...
(push)
 ...
 (declare-const tmp%7 pmemlog!logimpl_v.PersistentHeaderMetadata.)
 ...
 (assert
  (not (=>
    ...
    (=>
     ...
     (=>
      (= tmp%1 (= (pmemlog!logimpl_v.PersistentHeader./PersistentHeader/crc (%Poly%pmemlog!logimpl_v.PersistentHeader.
          (Poly%pmemlog!logimpl_v.PersistentHeader. header@)
         )
        ) (vstd!bytes.spec_u64_from_le_bytes.? (Poly%vstd!seq.Seq<u8.>. crc_bytes!))
      ))
      (and
       (=>
        %%location_label%%0
       ...
       (=>
        ...
        (=>
         (= tmp%2 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT
           ...
           ) (Poly%vstd!seq.Seq<u8.>. (vstd!bytes.spec_u64_to_le_bytes.? (I (pmemlog!logimpl_v.PersistentHeader./PersistentHeader/crc
               (%Poly%pmemlog!logimpl_v.PersistentHeader. (Poly%pmemlog!logimpl_v.PersistentHeader.
                 header@
         ))))))))
         (and
          ...
          (=>
           tmp%2
           (=>
            (= tmp%3 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. crc_bytes!)
              (Poly%vstd!seq.Seq<u8.>. (vstd!bytes.spec_u64_to_le_bytes.? (I (pmemlog!logimpl_v.PersistentHeader./PersistentHeader/crc
                  (%Poly%pmemlog!logimpl_v.PersistentHeader. (Poly%pmemlog!logimpl_v.PersistentHeader.
                    header@
            ))))))))
            (and
             ...
             (=>
              tmp%3
              (=>
               (= tmp%4 (ext_eq false TYPE%pmemlog!logimpl_v.PersistentHeaderMetadata. (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
                  (pmemlog!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%pmemlog!logimpl_v.PersistentHeader.
                    (Poly%pmemlog!logimpl_v.PersistentHeader. header@)
                  ))
               ...
               (and
                ...
                (=>
                 tmp%4
                 (=>
                  (= tmp%5 (ext_eq false TYPE%pmemlog!logimpl_v.PersistentHeaderMetadata. (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
                     (pmemlog!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%pmemlog!logimpl_v.PersistentHeader.
                       (Poly%pmemlog!logimpl_v.PersistentHeader. header@)
                     ))
                    ) (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (pmemlog!logimpl_v.spec_bytes_to_metadata.?
                  ...
                  (and
                   ...
                   (=>
                    tmp%5
                    (=>
                     (= tmp%6 (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>.
                         header_bytes!
                        ) (I pmemlog!logimpl_v.header_head_offset.?) (I pmemlog!logimpl_v.header_size.?)
                     )))
                     (=>
                      (= tmp%7 (pmemlog!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%pmemlog!logimpl_v.PersistentHeader.
                         (Poly%pmemlog!logimpl_v.PersistentHeader. header@)
                      )))
                      (and
                       (=>
                        %%location_label%%5
                        (req%pmemlog!logimpl_v.lemma_metadata_bytes_eq. metadata_bytes! tmp%6 tmp%7)
                       )
                       (=>
                        (ens%pmemlog!logimpl_v.lemma_metadata_bytes_eq. metadata_bytes! tmp%6 tmp%7)
                        (=>
