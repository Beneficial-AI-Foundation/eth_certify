...
;; src/logimpl_v.rs:1698:14: 1707:37 (#0)
...
;; Function-Def pmemlog::logimpl_v::UntrustedLogImpl::append_no_wrap
;; src/logimpl_v.rs:1698:14: 1707:37 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= tmp%1 (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/tail
      (%Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
        old_header!
    ))))
    (=>
     ...
     (and
      ...
      (=>
       (ens%pmemlog!logimpl_v.impl&%0.addr_logical_to_physical. tmp%1 tmp%2 physical_tail@)
       (=>
        (= tmp%3 (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!@0))
        (=>
         (= tmp%4 (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT
              8
             ) $ ALLOCATOR_GLOBAL
            ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. bytes_to_append!)
         )))
         (and
          (=>
           %%location_label%%1
           (req%pmemlog!logimpl_v.lemma_data_write_is_safe. Perm&. Perm& tmp%3 tmp%4 physical_tail@
            perm!
          ))
          (=>
           (ens%pmemlog!logimpl_v.lemma_data_write_is_safe. Perm&. Perm& tmp%3 tmp%4 physical_tail@
            perm!
           )
           (=>
            (= tmp%6 physical_tail@)
            (=>
             ...
             (and
              (=>
               %%location_label%%2
               (req%pmemlog!pmemspec_t.impl&%0.write. Perm&. Perm& PM&. PM& wrpm!@0 tmp%6 (%Poly%slice%<u8.>.
                 tmp%5
                ) perm!
              ))
              (=>
               ...
               (=>
                (ens%pmemlog!pmemspec_t.impl&%0.write. Perm&. Perm& PM&. PM& wrpm!@0 wrpm!@1 tmp%6
                 (%Poly%slice%<u8.>. tmp%5) perm!
                )
                (=>
                 (= tmp%7 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT
                     8
                 ...
                 (and
                  ...
                  (=>
                   tmp%7
                   (=>
                    (= tmp%8 (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!@1))
                    (=>
                     ...
                     (and
                      (=>
                       ...
                       (req%pmemlog!logimpl_v.lemma_subrange_equality_implies_subsubrange_equality. $ (UINT
                         8
                        ) (Poly%vstd!seq.Seq<u8.>. tmp%8) (Poly%vstd!seq.Seq<u8.>. tmp%9) 0 physical_tail@
                      ))
                      (=>
                       ...
                       (and
                        ...
                        (and
                         (=>
                          %%location_label%%6
                          (= (pmemlog!pmemspec_t.impl&%0.constants.? Perm&. Perm& PM&. PM& wrpm!@1) (pmemlog!pmemspec_t.impl&%0.constants.?
                            Perm&. Perm& PM&. PM& wrpm!@0
                         )))
                         (and
                          (=>
