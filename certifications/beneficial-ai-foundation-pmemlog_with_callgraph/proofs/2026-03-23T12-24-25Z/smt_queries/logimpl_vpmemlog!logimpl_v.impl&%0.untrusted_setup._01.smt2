...
;; src/logimpl_v.rs:1433:9: 1435:37 (#0)
...
;; Function-Def pmemlog::logimpl_v::UntrustedLogImpl::untrusted_setup
;; src/logimpl_v.rs:1433:9: 1435:37 (#0)
...
(push)
 ...
 (declare-const log_state$1@ pmemlog!infinitelog_t.AbstractInfiniteLogState.)
 (declare-const log_state@ core!option.Option.)
 (declare-const log_size@ Int)
 (declare-const log_header_metadata@ pmemlog!logimpl_v.PersistentHeaderMetadata.)
 (declare-const metadata_bytes@ alloc!vec.Vec<u8./allocator_global%.>.)
 (declare-const crc_bytes@ alloc!vec.Vec<u8./allocator_global%.>.)
 (declare-const log_header@ pmemlog!logimpl_v.PersistentHeader.)
 ...
 (assert
  (not (or
    (and
     (=>
      (<= device_size! pmemlog!logimpl_v.contents_offset.?)
      (and
       (=>
        %%location_label%%0
        (uInv 64 (Add pmemlog!logimpl_v.contents_offset.? 1))
       )
       (=>
        (uInv 64 (Add pmemlog!logimpl_v.contents_offset.? 1))
        (=>
         (= result! (core!result.Result./Err (Poly%pmemlog!main_t.InfiniteLogErr. (pmemlog!main_t.InfiniteLogErr./InsufficientSpaceForSetup
             (%I (I (uClip 64 (Add pmemlog!logimpl_v.contents_offset.? 1))))
         ))))
         (and
          (=>
           %%location_label%%1
          ...
          (and
           (=>
            %%location_label%%2
            (= (pmemlog!pmemspec_t.PersistentMemory.constants.? PM&. PM& pm!@0) (pmemlog!pmemspec_t.PersistentMemory.constants.?
              PM&. PM& pm!@0
           )))
           (and
            (=>
     ...
     (=>
      (not (<= device_size! pmemlog!logimpl_v.contents_offset.?))
      %%switch_label%%1
    ))
    (and
     (not %%switch_label%%1)
     (and
      (=>
       %%location_label%%5
       (uInv 64 (Sub device_size! pmemlog!logimpl_v.contents_offset.?))
      )
      (=>
       (uInv 64 (Sub device_size! pmemlog!logimpl_v.contents_offset.?))
       (=>
        (= log_size@ (uClip 64 (Sub device_size! pmemlog!logimpl_v.contents_offset.?)))
        (=>
         (= log_header_metadata@ (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata
           (%I (I 0)) (%I (I 0)) (%I (I log_size@))
         ))
         (=>
          (ens%pmemlog!logimpl_v.metadata_to_bytes. log_header_metadata@ metadata_bytes@)
          (=>
           (ens%pmemlog!pmemspec_t.bytes_crc. metadata_bytes@ crc_bytes@)
           (=>
            ...
            (and
             (=>
              %%location_label%%6
              (req%vstd!bytes.u64_from_le_bytes. (%Poly%slice%<u8.>. tmp%1))
             )
             (=>
              (ens%vstd!bytes.u64_from_le_bytes. (%Poly%slice%<u8.>. tmp%1) tmp%2)
              (=>
               (= log_header@ (pmemlog!logimpl_v.PersistentHeader./PersistentHeader (%I (I tmp%2))
                 (%Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
                   log_header_metadata@
               ))))
               (=>
                (ens%pmemlog!logimpl_v.header_to_bytes. log_header@ header_bytes@)
                (=>
                 (= tmp%3 pmemlog!pmemspec_t.cdb0_val.?)
                 (=>
                  (ens%vstd!bytes.u64_to_le_bytes. tmp%3 initial_ib_bytes@)
                  (=>
                   (= tmp%5 (I pmemlog!logimpl_v.header1_pos.?))
                   (=>
                    (ens%alloc!vec.impl&%1.as_slice. $ (UINT 8) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u8./allocator_global%.>.
                      header_bytes@
                     ) tmp%4
                    ...
                    (and
                     (=>
                      %%location_label%%7
                      (req%pmemlog!pmemspec_t.PersistentMemory.write. PM&. PM& pm!@0 tmp%5 tmp%4)
                     )
                     (=>
                      (has_type pm!@1 PM&)
                      (=>
                       (ens%pmemlog!pmemspec_t.PersistentMemory.write. PM&. PM& pm!@0 pm!@1 tmp%5 tmp%4)
                       (=>
                        (= tmp%7 (I pmemlog!logimpl_v.incorruptible_bool_pos.?))
                        (=>
                         (ens%alloc!vec.impl&%1.as_slice. $ (UINT 8) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u8./allocator_global%.>.
                           initial_ib_bytes@
                          ) tmp%6
                         ...
                         (and
                          (=>
                           %%location_label%%8
                           (req%pmemlog!pmemspec_t.PersistentMemory.write. PM&. PM& pm!@1 tmp%7 tmp%6)
                          )
                          (=>
                           (has_type pm!@2 PM&)
                           (=>
                            (ens%pmemlog!pmemspec_t.PersistentMemory.write. PM&. PM& pm!@1 pm!@2 tmp%7 tmp%6)
                            (=>
                             (ens%vstd!bytes.lemma_auto_spec_u64_to_from_le_bytes. 0)
                             (=>
                              (= tmp%8 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT
                                  8
                                 ) (pmemlog!pmemspec_t.PersistentMemory.view.? PM&. PM& pm!@2) (I pmemlog!logimpl_v.header1_pos.?)
                                 (I (Add pmemlog!logimpl_v.header1_pos.? pmemlog!logimpl_v.header_size.?))
                                ) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>.
                                  header_bytes@
                              ))))
                              (and
                               ...
                               (=>
                                tmp%8
                                (=>
                                 (= tmp%9 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT
                                     8
                                    ) (pmemlog!pmemspec_t.PersistentMemory.view.? PM&. PM& pm!@2) (I pmemlog!logimpl_v.incorruptible_bool_pos.?)
                                    (I (Add pmemlog!logimpl_v.incorruptible_bool_pos.? 8))
                                   ) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>.
                                     initial_ib_bytes@
                                 ))))
                                 (and
                                  ...
                                  (=>
                                   tmp%9
                                   (=>
                                    (= tmp%10 (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (
                                         UINT 8
                                        ) $ ALLOCATOR_GLOBAL
                                    ...
                                    (=>
                                     (= tmp%11 (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (
                                        ...
                                        ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. metadata_bytes@)
                                     )))
                                     (=>
                                      (= tmp%12 (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (
                                           UINT 8
                                          ) $ ALLOCATOR_GLOBAL
                                         ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. header_bytes@)
                                      )))
                                      (and
                                       (=>
                                        %%location_label%%11
                                        (req%pmemlog!logimpl_v.lemma_header_split_into_bytes. tmp%10 tmp%11 tmp%12)
                                       )
                                       (=>
                                        (ens%pmemlog!logimpl_v.lemma_header_split_into_bytes. tmp%10 tmp%11 tmp%12)
                                        (=>
                                         (= tmp%13 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (
                                             UINT 8
                                            ) (pmemlog!pmemspec_t.PersistentMemory.view.? PM&. PM& pm!@2) (I (Add pmemlog!logimpl_v.header1_pos.?
                                         ...
                                         (and
                                          ...
                                          (=>
                                           tmp%13
                                           (=>
                                            (= tmp%14 (%Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.PersistentMemory.view.? PM&.
                                               PM& pm!@2
                                            )))
                                            (=>
                                             (= tmp%15 pmemlog!logimpl_v.header1_pos.?)
                                             (and
                                              (=>
                                               %%location_label%%13
                                               (req%pmemlog!logimpl_v.lemma_header_match. tmp%14 tmp%15 log_header@)
                                              )
                                              (=>
                                               (ens%pmemlog!logimpl_v.lemma_header_match. tmp%14 tmp%15 log_header@)
                                               (=>
                                                (= log_state@ (pmemlog!logimpl_v.impl&%0.recover.? (pmemlog!pmemspec_t.PersistentMemory.view.?
                                                   PM&. PM& pm!@2
                                                )))
                                                (or
                                                 (and
                                                  (=>
                                                   (is-core!option.Option./Some log_state@)
                                                   (=>
                                                    (= log_state$1@ (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (core!option.Option./Some/0
                                                       $ TYPE%pmemlog!infinitelog_t.AbstractInfiniteLogState. (%Poly%core!option.Option.
                                                        (Poly%core!option.Option. log_state@)
                                                    ))))
                                                    (=>
                                                     (= tmp%16 (= (pmemlog!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/head
                                                        (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
                                                          log_state$1@
                                                        ))
                                                       ) 0
                                                     ...
                                                     (and
                                                      ...
                                                      (=>
                                                       tmp%16
                                                       (=>
                                                        (= tmp%17 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (pmemlog!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/log
                                                            (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
                                                              log_state$1@
                                                           )))
                                                          ) (vstd!seq.Seq.empty.? $ (UINT 8))
                                                        ...
                                                        (and
                                                         ...
                                                         (=>
                                                          tmp%17
                                                          (=>
                                                           (= tmp%18 (= (pmemlog!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/capacity
                                                              (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
                                                                log_state$1@
                                                              ))
                                                             ) (Sub log_size@ 1)
                                                  ...
                                                  (=>
                                                   (not (is-core!option.Option./Some log_state@))
                                                   (=>
                                                    %%location_label%%17
                                                    false
                                                 )))
                                                 (and
                                                  ...
                                                  (and
                                                   (=>
                                                    %%location_label%%18
                                                    (uInv 64 (Sub log_size@ 1))
                                                   )
                                                   (=>
                                                    (uInv 64 (Sub log_size@ 1))
                                                    (=>
                                                     (= result! (core!result.Result./Ok (I (uClip 64 (Sub log_size@ 1)))))
                                                     (and
                                                      (=>
                                                       %%location_label%%19
                                                       (%B (pmemlog!pmemspec_t.PersistentMemory.inv.? PM&. PM& pm!@2))
                                                      )
                                                      (and
                                                       (=>
                                                        %%location_label%%20
                                                        (= (pmemlog!pmemspec_t.PersistentMemory.constants.? PM&. PM& pm!@2) (pmemlog!pmemspec_t.PersistentMemory.constants.?
                                                          PM&. PM& pm!@0
                                                       )))
                                                       (and
                                                        (=>
