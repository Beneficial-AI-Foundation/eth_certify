...
;; Function-Def pmemlog::math_v::lemma_div_relation_when_mods_have_different_order
;; src/math_v.rs:99:5: 99:91 (#0)
      ...
      (=>
       ...
       (=>
        ...
        (=>
         (= tmp%2 (EucDiv x! d!))
         (=>
          (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub_other_way. d! tmp%1 tmp%2)
          (=>
           (= tmp%3 (EucDiv y! d!))
           (=>
            ...
            (=>
             (= tmp%4 (EucDiv x! d!))
             (=>
              (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. tmp%4 d!)
              (or
               (and
                (=>
                 (> (EucDiv y! d!) (Add (EucDiv x! d!) 1))
                 (=>
                  (= tmp%5 (Sub (EucDiv y! d!) (EucDiv x! d!)))
                  (and
                   (=>
                    %%location_label%%2
                    (req%vstd!arithmetic.mul.lemma_mul_inequality. 2 tmp%5 d!)
                   )
                   (=>
                    (ens%vstd!arithmetic.mul.lemma_mul_inequality. 2 tmp%5 d!)
                    (=>
                     (= tmp%6 (>= (Mul (Sub (EucDiv y! d!) (EucDiv x! d!)) d!) (Mul 2 d!)))
                     (and
                      (=>
                       %%location_label%%3
                       tmp%6
                ...
                (=>
                 (not (> (EucDiv y! d!) (Add (EucDiv x! d!) 1)))
                 %%switch_label%%1
               ))
               (and
                (not %%switch_label%%1)
                (or
                 (and
                  (=>
                   (<= (EucDiv y! d!) (EucDiv x! d!))
                   (=>
                    (= tmp%7 (Sub (EucDiv x! d!) (EucDiv y! d!)))
                    (and
                     (=>
                      %%location_label%%5
                      (req%vstd!arithmetic.mul.lemma_mul_inequality. 0 tmp%7 d!)
                     )
                     (=>
                      (ens%vstd!arithmetic.mul.lemma_mul_inequality. 0 tmp%7 d!)
                      (=>
                       (= tmp%8 (<= (Mul 0 d!) (Mul (Sub (EucDiv x! d!) (EucDiv y! d!)) d!)))
                       (and
                        (=>
                         %%location_label%%6
                         tmp%8
                        ...
                        (=>
                         tmp%8
                         (=>
                          (= tmp%9 (Sub (EucDiv x! d!) (EucDiv y! d!)))
                          (=>
                           (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. tmp%9 d!)
                           (=>
                            (= tmp%10 (EucDiv x! d!))
                            (=>
                             (= tmp%11 (EucDiv y! d!))
                             (=>
                              (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub. d! tmp%10 tmp%11)
                              (=>
                               (= tmp%12 (= (Mul d! (Sub (EucDiv x! d!) (EucDiv y! d!))) (Sub (Mul d! (EucDiv x! d!))
                                  (Mul d! (EucDiv y! d!))
                               )))
                               (and
                                (=>
                                ...
                                (=>
                                 tmp%12
                                 (=>
                                  (= tmp%13 (<= (Mul 0 d!) (Add (Sub (Sub x! y!) (EucMod x! d!)) (EucMod y! d!))))
                                  (and
                                   (=>
                                    %%location_label%%8
                                    tmp%13
