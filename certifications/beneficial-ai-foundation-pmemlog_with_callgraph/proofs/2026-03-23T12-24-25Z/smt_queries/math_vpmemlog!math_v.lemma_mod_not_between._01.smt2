...
;; Function-Def pmemlog::math_v::lemma_mod_not_between
;; src/math_v.rs:197:5: 197:71 (#0)
    ...
    (and
     (=>
      ...
      (and
       (=>
        %%location_label%%0
        (req%pmemlog!math_v.lemma_mod_auto_basics. d! x!)
       )
       (=>
        (ens%pmemlog!math_v.lemma_mod_auto_basics. d! x!)
        (=>
         (= tmp%1 (= (EucMod y! d!) (EucMod x! d!)))
         (and
          (=>
           %%location_label%%1
           tmp%1
      ...
      (and
       ...
       (=>
        ...
        (and
         (=>
          %%location_label%%4
          (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. y! d!)
         )
         (=>
          (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. y! d!)
          (and
           (=>
            %%location_label%%5
            (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. z! d!)
           )
           (=>
            (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. z! d!)
            (=>
             (= tmp%2 (>= (Sub (Add (Sub (Mul d! (EucDiv y! d!)) (Mul d! (EucDiv x! d!))) (EucMod y!
                  d!
                 )
                ) (EucMod x! d!)
               ) 0
             ...
             (and
              ...
              (=>
               tmp%2
               (=>
                (= tmp%3 (>= (Sub (Mul d! (EucDiv y! d!)) (Mul d! (EucDiv x! d!))) 0))
                (and
                 (=>
                  %%location_label%%7
                  tmp%3
                 ...
                 (=>
                  ...
                  (=>
                   ...
                   (=>
                    (= tmp%5 (EucDiv x! d!))
                    (=>
                     (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub. d! tmp%4 tmp%5)
                     (=>
                      (= tmp%6 (>= (Mul d! (Sub (EucDiv y! d!) (EucDiv x! d!))) 0))
                      (and
                       (=>
                        %%location_label%%8
                        tmp%6
                           ...
                           (and
                            (=>
                             ...
                             (and
                              (=>
                               %%location_label%%10
                               (req%pmemlog!math_v.lemma_div_relation_when_mods_have_different_order. d! z! y!)
                              )
                              (=>
                               (ens%pmemlog!math_v.lemma_div_relation_when_mods_have_different_order. d! z! y!)
                               (and
                                (=>
                                 %%location_label%%11
                                 (req%pmemlog!math_v.lemma_div_relation_when_mods_have_same_order. d! z! x!)
                                )
                                (=>
                                 (ens%pmemlog!math_v.lemma_div_relation_when_mods_have_same_order. d! z! x!)
                                 (=>
                                  %%location_label%%12
                                  false
                            ))))))
