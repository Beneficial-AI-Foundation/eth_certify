...
;; src/logimpl_v.rs:1755:9: 1764:37 (#0)
...
;; Function-Def pmemlog::logimpl_v::UntrustedLogImpl::append_wrap
;; src/logimpl_v.rs:1755:9: 1764:37 (#0)
...
(push)
 ...
 (declare-const old_header! pmemlog!logimpl_v.PersistentHeaderMetadata.)
 ...
 (declare-const append_bytes_slice@ slice%<u8.>.)
 (declare-const bytes1@ slice%<u8.>.)
 (declare-const bytes2@ slice%<u8.>.)
 (assert
  fuel_defaults
 )
 (assert
 ...
 (assert
  (has_type (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. old_header!) TYPE%pmemlog!logimpl_v.PersistentHeaderMetadata.)
 )
 (assert
  (has_type perm! Perm&)
 )
 ...
 (assert
  (= old_header! (pmemlog!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%pmemlog!logimpl_v.PersistentHeader.
     (Poly%pmemlog!logimpl_v.PersistentHeader. (pmemlog!logimpl_v.spec_get_live_header.?
       (Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!@0))
 ))))))
 (assert
  (let
   ((physical_head$ (pmemlog!logimpl_v.spec_addr_logical_to_physical.? (I (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/head
 ...
 (assert
  (not (=>
    (= tmp%1 (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/head
      (%Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
        old_header!
    ))))
    (=>
     (= tmp%2 (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/log_size
       (%Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
         old_header!
     ))))
     (and
      (=>
       %%location_label%%0
       (req%pmemlog!logimpl_v.impl&%0.addr_logical_to_physical. tmp%1 tmp%2)
      )
      (=>
       (ens%pmemlog!logimpl_v.impl&%0.addr_logical_to_physical. tmp%1 tmp%2 physical_head@)
       (=>
        (= tmp%3 (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/tail
          (%Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
            old_header!
        ))))
        (=>
         (= tmp%4 (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/log_size
           (%Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
             old_header!
         ))))
         (and
          (=>
           %%location_label%%1
           (req%pmemlog!logimpl_v.impl&%0.addr_logical_to_physical. tmp%3 tmp%4)
          )
          (=>
           (ens%pmemlog!logimpl_v.impl&%0.addr_logical_to_physical. tmp%3 tmp%4 physical_tail@)
           (and
            (=>
             %%location_label%%2
             (uInv 64 (Add (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/log_size
                (%Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
                  old_header!
                ))
               ) pmemlog!logimpl_v.contents_offset.?
            ...
            (=>
             ...
             (=>
              (= contents_end@ (uClip 64 (Add (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/log_size
                  (%Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
                    old_header!
                  ))
                 ) pmemlog!logimpl_v.contents_offset.?
              ...
              (=>
               ...
               (and
                (=>
                 %%location_label%%3
                 (uInv 64 (Sub contents_end@ physical_tail@))
                )
                (=>
                 (uInv 64 (Sub contents_end@ physical_tail@))
                 (=>
                  (= len1@ (uClip SZ (uClip 64 (Sub contents_end@ physical_tail@))))
                  (=>
                   (ens%alloc!vec.impl&%1.len. $ (UINT 8) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u8./allocator_global%.>.
                     bytes_to_append!
                    ) tmp%5
                   ...
                   (and
                    (=>
                     %%location_label%%4
                     (uInv SZ (Sub tmp%5 len1@))
                    )
                    (=>
                     (uInv SZ (Sub tmp%5 len1@))
                     (=>
                      (= len2@ (uClip SZ (Sub tmp%5 len1@)))
                      (=>
                       ...
                       (=>
                        (= append_bytes_slice@ (%Poly%slice%<u8.>. tmp%6))
                        (and
                         (=>
                          %%location_label%%5
                          (req%vstd!slice.slice_subrange. $ (UINT 8) (Poly%slice%<u8.>. append_bytes_slice@)
                           0 len1@
                         ))
                         (=>
                          (ens%vstd!slice.slice_subrange. $ (UINT 8) (Poly%slice%<u8.>. append_bytes_slice@)
                           0 len1@ tmp%7
                          )
                          (=>
                           (= bytes1@ (%Poly%slice%<u8.>. tmp%7))
                           (and
                            (=>
                             %%location_label%%6
                             (req%vstd!slice.slice_subrange. $ (UINT 8) (Poly%slice%<u8.>. append_bytes_slice@)
                            ...
                            (=>
                             (ens%vstd!slice.slice_subrange. $ (UINT 8) (Poly%slice%<u8.>. append_bytes_slice@)
                              len1@ append_size@ tmp%8
                             )
                             (=>
                              (= bytes2@ (%Poly%slice%<u8.>. tmp%8))
                              (=>
                               (= tmp%9 (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!@0))
                               (=>
                                (= tmp%10 (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $slice (SLICE $ (UINT 8))
                                   (Poly%slice%<u8.>. bytes1@)
                                )))
                                (and
                                 (=>
                                  %%location_label%%7
                                  (req%pmemlog!logimpl_v.lemma_data_write_is_safe. Perm&. Perm& tmp%9 tmp%10 physical_tail@
                                   perm!
                                 ))
                                 (=>
                                  (ens%pmemlog!logimpl_v.lemma_data_write_is_safe. Perm&. Perm& tmp%9 tmp%10 physical_tail@
                                   perm!
                                  )
                                  (and
                                   (=>
                                    %%location_label%%8
                                    (req%pmemlog!pmemspec_t.impl&%0.write. Perm&. Perm& PM&. PM& wrpm!@0 physical_tail@
                                     bytes1@ perm!
                                   ))
                                   (=>
                                    ...
                                    (=>
                                     (ens%pmemlog!pmemspec_t.impl&%0.write. Perm&. Perm& PM&. PM& wrpm!@0 wrpm!@1 physical_tail@
                                      bytes1@ perm!
                                     )
                                     (=>
                                      (= tmp%11 (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!@1))
                                      (=>
                                       (= tmp%12 (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $slice (SLICE $ (UINT 8))
                                          (Poly%slice%<u8.>. bytes2@)
                                       )))
                                       (=>
                                        (= tmp%13 pmemlog!logimpl_v.contents_offset.?)
                                        (and
                                         (=>
                                          %%location_label%%9
                                          (req%pmemlog!logimpl_v.lemma_data_write_is_safe. Perm&. Perm& tmp%11 tmp%12 tmp%13
                                           perm!
                                         ))
                                         (=>
                                          (ens%pmemlog!logimpl_v.lemma_data_write_is_safe. Perm&. Perm& tmp%11 tmp%12 tmp%13
                                           perm!
                                          )
                                          (=>
                                           (= tmp%14 pmemlog!logimpl_v.contents_offset.?)
                                           (and
                                            (=>
                                             %%location_label%%10
                                             (req%pmemlog!pmemspec_t.impl&%0.write. Perm&. Perm& PM&. PM& wrpm!@1 tmp%14 bytes2@
                                              perm!
                                            ))
                                            (=>
                                             ...
                                             (=>
                                              (ens%pmemlog!pmemspec_t.impl&%0.write. Perm&. Perm& PM&. PM& wrpm!@1 wrpm!@2 tmp%14
                                               bytes2@ perm!
                                              )
                                              (=>
                                               (= tmp%15 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (
                                                   UINT 8
                                                  ) (Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM&
                                                    wrpm!@2
                                                   )
                                                  ) (I 0) (I pmemlog!logimpl_v.contents_offset.?)
                                                 ) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.impl&%0.view.?
                                               ...
                                               (and
                                                ...
                                                (=>
                                                 tmp%15
                                                 (=>
                                                  (= tmp%16 (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!@2))
                                                  (=>
                                                   (= tmp%17 (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!@0))
                                                   (=>
                                                    (= tmp%18 pmemlog!logimpl_v.contents_offset.?)
                                                    (and
                                                     (=>
                                                      %%location_label%%12
                                                      (req%pmemlog!logimpl_v.lemma_subrange_equality_implies_subsubrange_equality. $ (UINT
                                                        8
                                                       ) (Poly%vstd!seq.Seq<u8.>. tmp%16) (Poly%vstd!seq.Seq<u8.>. tmp%17) 0 tmp%18
                                                     ))
                                                     (=>
                                                      (ens%pmemlog!logimpl_v.lemma_subrange_equality_implies_subsubrange_equality. $ (UINT
                                                        8
                                                       ) (Poly%vstd!seq.Seq<u8.>. tmp%16) (Poly%vstd!seq.Seq<u8.>. tmp%17) 0 tmp%18
                                                      )
                                                      (and
                                                       ...
                                                       (and
                                                        (=>
                                                         %%location_label%%14
                                                         (is-core!option.Option./Some (pmemlog!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>.
                                                            (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!@2)
                                                        ))))
                                                        (and
                                                         (=>
                                                          %%location_label%%15
                                                                        ...
                                                                        (and
                                                                         (and
                                                                          (and
                                                                           (and
                                                                            (= old_ib$ new_ib$)
                                                                            (ext_eq false TYPE%pmemlog!logimpl_v.HeaderView. (Poly%pmemlog!logimpl_v.HeaderView.
                                                                              old_headers$
                                                                             ) (Poly%pmemlog!logimpl_v.HeaderView. new_headers$)
                                                                           ))
                                                                           (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (
