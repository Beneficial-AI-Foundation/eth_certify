...
;; src/logimpl_v.rs:1108:5: 1108:52 (#0)
...
;; Function-Def pmemlog::logimpl_v::lemma_pm_state_header
;; src/logimpl_v.rs:1108:5: 1108:52 (#0)
...
(push)
 ...
 (declare-const pm_state$1@ pmemlog!infinitelog_t.AbstractInfiniteLogState.)
     ...
     (=>
      ...
      (=>
       ...
       (and
        (=>
         %%location_label%%0
         (req%vstd!arithmetic.div_mod.lemma_mod_division_less_than_divisor. tmp%1 tmp%2)
        )
        (=>
         (ens%vstd!arithmetic.div_mod.lemma_mod_division_less_than_divisor. tmp%1 tmp%2)
         (=>
          ...
          (=>
           ...
           (and
            (=>
             %%location_label%%1
             (req%vstd!arithmetic.div_mod.lemma_mod_division_less_than_divisor. tmp%3 tmp%4)
            )
            (=>
             (ens%vstd!arithmetic.div_mod.lemma_mod_division_less_than_divisor. tmp%3 tmp%4)
             (=>
              (= head@ (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/head
                (%Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
                  (pmemlog!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%pmemlog!logimpl_v.PersistentHeader.
                 ...
                 (=>
                  ...
                  (or
                   (and
                       ...
                       (and
                        (=>
                         ...
                         (and
                          (=>
                           %%location_label%%2
                           (req%pmemlog!math_v.lemma_mod_difference_equal. head@ tail@ log_size@)
                          )
                          (=>
                           (ens%pmemlog!math_v.lemma_mod_difference_equal. head@ tail@ log_size@)
                           %%switch_label%%1
                        )))
                        (=>
                          ...
                          (and
                           (=>
                            ...
                            (and
                             (=>
                              %%location_label%%3
                              (req%pmemlog!math_v.lemma_mod_wrapped_len. head@ tail@ log_size@)
                             )
                             (=>
                              (ens%pmemlog!math_v.lemma_mod_wrapped_len. head@ tail@ log_size@)
                              %%switch_label%%2
                           )))
                           (=>
                            (not (< physical_tail@ physical_head@))
                            (and
                             (=>
                              %%location_label%%4
                              (req%pmemlog!math_v.lemma_mod_equal. head@ tail@ log_size@)
                             )
                             (=>
                              (ens%pmemlog!math_v.lemma_mod_equal. head@ tail@ log_size@)
                              %%switch_label%%2
                          ))))
                          (and
                           (not %%switch_label%%2)
                    ...
                    (=>
                     (not (is-core!option.Option./Some pm_state@))
                     (=>
                      %%location_label%%5
                      false
                   )))
