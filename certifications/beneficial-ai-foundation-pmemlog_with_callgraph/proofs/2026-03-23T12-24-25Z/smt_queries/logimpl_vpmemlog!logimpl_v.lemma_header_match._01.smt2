...
;; src/logimpl_v.rs:101:5: 101:92 (#0)
...
;; Function-Def pmemlog::logimpl_v::lemma_header_match
;; src/logimpl_v.rs:101:5: 101:92 (#0)
 ...
 (assert
  (not (=>
    (= tmp%1 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT
        8
       ) (Poly%vstd!seq.Seq<u8.>. pm!) (I header_pos!) (I (Add header_pos! pmemlog!logimpl_v.header_size.?))
       ...
       ) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!) (I (Add header_pos!
    ...
    (and
     ...
     (=>
      tmp%1
      (=>
       (= tmp%2 (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>.
           pm!
          ) (I (Add header_pos! pmemlog!logimpl_v.header_crc_offset.?)) (I (Add (Add header_pos!
             pmemlog!logimpl_v.header_crc_offset.?
            ) 8
       ...
       (=>
        (= tmp%3 (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>.
            pm!
        ...
        (and
         (=>
          %%location_label%%1
          (req%pmemlog!logimpl_v.lemma_bytes_combine_into_header. tmp%2 tmp%3 header!)
         )
         (=>
          (ens%pmemlog!logimpl_v.lemma_bytes_combine_into_header. tmp%2 tmp%3 header!)
          (=>
           %%location_label%%2
           (let
            ((tmp%%$ (pmemlog!logimpl_v.pm_to_views.? (Poly%vstd!seq.Seq<u8.>. pm!))))
