...
;; Function-Def pmemlog::math_v::lemma_mod_auto_basics
;; src/math_v.rs:8:5: 8:55 (#0)
...
(push)
 ...
 (assert
  (not (and
    (=>
     %%location_label%%0
     (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. x! n!)
    )
    (=>
     (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. x! n!)
     (=>
      (= tmp%1 (Add x! n!))
      (and
       (=>
        %%location_label%%1
        (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. tmp%1 n!)
       )
       (=>
        (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. tmp%1 n!)
        (=>
         (= tmp%2 (Sub x! n!))
         (and
          (=>
           %%location_label%%2
           (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. tmp%2 n!)
          )
          (=>
           (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. tmp%2 n!)
           (=>
            (= zp@ (Sub (Sub (EucDiv (Add x! n!) n!) (EucDiv x! n!)) 1))
            (=>
             (= zm@ (Add (Sub (EucDiv (Sub x! n!) n!) (EucDiv x! n!)) 1))
             (=>
              (= tmp%3 (EucDiv (Add x! n!) n!))
              (=>
               (= tmp%4 (Add (EucDiv x! n!) 1))
               (=>
                (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub. n! tmp%3 tmp%4)
                (=>
                 (= tmp%5 (EucDiv x! n!))
                 (=>
                  (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add. n! tmp%5 1)
                  (=>
                   (= tmp%6 (= (Mul n! zp@) (Sub (Sub (Mul n! (EucDiv (Add x! n!) n!)) (Mul n! (EucDiv x!
                         n!
                       ))
                      ) (Mul n! 1)
                   )))
                   (and
                    ...
                    (=>
                     tmp%6
                     (=>
                      (= tmp%7 (= 0 (Sub (Add (Mul n! zp@) (EucMod (Add x! n!) n!)) (EucMod x! n!))))
                      (and
                       (=>
                        %%location_label%%4
                        tmp%7
                       ...
                       (=>
                        tmp%7
                        (=>
                         (= tmp%8 (EucDiv (Sub x! n!) n!))
                         (=>
                          (= tmp%9 (Sub (EucDiv x! n!) 1))
                          (=>
                           (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub. n! tmp%8 tmp%9)
                           (=>
                            (= tmp%10 (EucDiv x! n!))
                            (=>
                             (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub. n! tmp%10 1)
                             (=>
                              (= tmp%11 (= (Mul n! zm@) (Add (Sub (Mul n! (EucDiv (Sub x! n!) n!)) (Mul n! (EucDiv x!
                                    n!
                                  ))
                                 ) (Mul n! 1)
                              )))
                              (and
                               ...
                               (=>
                                tmp%11
                                (=>
                                 (= tmp%12 (= 0 (Sub (Add (Mul n! zm@) (EucMod (Sub x! n!) n!)) (EucMod x! n!))))
                                 (and
                                  (=>
                                   %%location_label%%6
                                   tmp%12
                                       ...
                                       (=>
                                        ...
                                        (=>
                                         ...
                                         (and
                                          (=>
                                           %%location_label%%8
                                           (req%vstd!arithmetic.mul.lemma_mul_inequality. zp@ tmp%13 n!)
                                          )
                                          (=>
                                           (ens%vstd!arithmetic.mul.lemma_mul_inequality. zp@ tmp%13 n!)
                                           %%switch_label%%4
                                       ))))
                                       (=>
                                        (not (< zp@ 0))
                                       ...
                                       (or
                                        (and
                                         (=>
                                          (= zp@ 0)
                                          (=>
                                           (ens%vstd!arithmetic.mul.lemma_mul_by_zero_is_zero. n!)
                                           %%switch_label%%3
                                         ))
                                         (=>
                                          (not (= zp@ 0))
                                             ...
                                             (=>
                                              ...
                                              (=>
                                               ...
                                               (and
                                                (=>
                                                 %%location_label%%10
                                                 (req%vstd!arithmetic.mul.lemma_mul_inequality. zm@ tmp%14 n!)
                                                )
                                                (=>
                                                 (ens%vstd!arithmetic.mul.lemma_mul_inequality. zm@ tmp%14 n!)
                                                 %%switch_label%%1
                                             ))))
                                             (=>
                                              (not (< zm@ 0))
                                              ...
                                              (and
                                               (=>
                                                ...
                                                (and
                                                 (=>
                                                  %%location_label%%11
                                                  (req%vstd!arithmetic.div_mod.lemma_basic_div_specific_divisor. n!)
                                                 )
                                                 (=>
                                                  (ens%vstd!arithmetic.div_mod.lemma_basic_div_specific_divisor. n!)
                                                  %%switch_label%%0
                                               )))
                                               (=>
                                                (not (let
