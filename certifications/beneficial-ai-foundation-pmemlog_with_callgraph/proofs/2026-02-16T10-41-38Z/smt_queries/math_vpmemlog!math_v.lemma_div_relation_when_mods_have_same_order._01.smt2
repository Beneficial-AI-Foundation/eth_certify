...
;; Function-Def pmemlog::math_v::lemma_div_relation_when_mods_have_same_order
;; src/math_v.rs:41:5: 41:86 (#0)
                ...
                (=>
                 ...
                 (=>
                  ...
                  (and
                   (=>
                    %%location_label%%2
                    (req%vstd!arithmetic.mul.lemma_mul_inequality. 1 tmp%5 d!)
                   )
                   (=>
                    (ens%vstd!arithmetic.mul.lemma_mul_inequality. 1 tmp%5 d!)
                    (=>
                     (= tmp%6 (>= (Mul (Sub (EucDiv y! d!) (EucDiv x! d!)) d!) (Mul 1 d!)))
                     (and
                      (=>
                       %%location_label%%3
                       tmp%6
                      ...
                      (=>
                       tmp%6
                       (=>
                        (= tmp%7 (>= (Sub (Mul (EucDiv y! d!) d!) (Mul (EucDiv x! d!) d!)) d!))
                        (and
                         (=>
                          %%location_label%%4
                          tmp%7
                ...
                (or
                 (and
                  (=>
                   (< (EucDiv y! d!) (EucDiv x! d!))
                   (=>
                    (= tmp%8 (Sub (EucDiv y! d!) (EucDiv x! d!)))
                    (=>
                     (= tmp%9 (Sub 0 1))
                     (and
                      (=>
                       %%location_label%%6
                       (req%vstd!arithmetic.mul.lemma_mul_inequality. tmp%8 tmp%9 d!)
                      )
                      (=>
                       (ens%vstd!arithmetic.mul.lemma_mul_inequality. tmp%8 tmp%9 d!)
                       (=>
                        (= tmp%10 (<= (Mul (Sub (EucDiv y! d!) (EucDiv x! d!)) d!) (Mul (Sub 0 1) d!)))
                        (and
                         (=>
                          %%location_label%%7
                          tmp%10
                         ...
                         (=>
                          ...
                          (=>
                           ...
                           (=>
                            (= tmp%12 (EucDiv x! d!))
                            (=>
                             (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub_other_way. d! tmp%11 tmp%12)
                             (=>
                              %%location_label%%8
                              false
                  ))))))))))))
