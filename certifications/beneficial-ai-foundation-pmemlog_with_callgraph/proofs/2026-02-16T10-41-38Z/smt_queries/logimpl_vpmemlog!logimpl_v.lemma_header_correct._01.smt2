...
;; src/logimpl_v.rs:1053:5: 1053:91 (#0)
...
;; Function-Def pmemlog::logimpl_v::lemma_header_correct
;; src/logimpl_v.rs:1053:5: 1053:91 (#0)
 ...
 (assert
  (not (=>
    (= tmp%1 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT
        8
       ) (Poly%vstd!seq.Seq<u8.>. pm!) (I (Add header_pos! pmemlog!logimpl_v.header_crc_offset.?))
       (I (Add (Add header_pos! pmemlog!logimpl_v.header_crc_offset.?) 8))
      ) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. header_bytes!) (I pmemlog!logimpl_v.header_crc_offset.?)
       (I (Add pmemlog!logimpl_v.header_crc_offset.? 8))
    )))
     ...
     (=>
      ...
      (=>
       (= tmp%2 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT
           8
          ) (Poly%vstd!seq.Seq<u8.>. pm!) (I (Add header_pos! pmemlog!logimpl_v.header_head_offset.?))
          (I (Add header_pos! pmemlog!logimpl_v.header_size.?))
         ) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. header_bytes!) (I pmemlog!logimpl_v.header_head_offset.?)
          (I pmemlog!logimpl_v.header_size.?)
       )))
