...
;; src/logimpl_v.rs:499:5: 499:129 (#0)
...
;; Function-Def pmemlog::logimpl_v::lemma_append_data_update_view_crash
;; src/logimpl_v.rs:499:5: 499:129 (#0)
 ...
 (assert
  (not (=>
    ...
    (=>
     ...
     (=>
      (= new_pm@ (pmemlog!pmemspec_t.update_contents_to_reflect_partially_flushed_write.?
        (Poly%vstd!seq.Seq<u8.>. pm!) (I write_addr!) (Poly%vstd!seq.Seq<u8.>. new_bytes!)
