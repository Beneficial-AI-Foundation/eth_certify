...
;; src/logimpl_v.rs:176:5: 176:70 (#0)
...
;; Function-Def pmemlog::logimpl_v::lemma_seq_addition
;; src/logimpl_v.rs:176:5: 176:70 (#0)
       ...
       (=>
        ...
        (=>
         (let
          ...
          (and
           (<= 0 tmp%%$)
           (< tmp%%$ (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes1!)))
         ))
         (= (vstd!seq.Seq.index.? $ (UINT 8) (vstd!seq.Seq.add.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>.
             bytes1!
            ) (Poly%vstd!seq.Seq<u8.>. bytes2!)
           ) i$
          ) (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes1!) i$)
       )))
       :pattern ((vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes1!) i$))
       :qid user_pmemlog__logimpl_v__lemma_seq_addition_35
       :skolemid skolem_user_pmemlog__logimpl_v__lemma_seq_addition_35
    )))
    (and
     (=>
      %%location_label%%0
          ...
          (=>
           ...
           (=>
            (let
             ...
             (and
              (<= 0 tmp%%$)
              (< tmp%%$ (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes2!)))
            ))
            (= (vstd!seq.Seq.index.? $ (UINT 8) (vstd!seq.Seq.add.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>.
                bytes1!
               ) (Poly%vstd!seq.Seq<u8.>. bytes2!)
              ) (I (Add (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes1!)) (%I i$)))
             ) (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes2!) i$)
          )))
          :pattern ((vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes2!) i$))
          :qid user_pmemlog__logimpl_v__lemma_seq_addition_36
          :skolemid skolem_user_pmemlog__logimpl_v__lemma_seq_addition_36
       )))
       (and
        (=>
         %%location_label%%1
