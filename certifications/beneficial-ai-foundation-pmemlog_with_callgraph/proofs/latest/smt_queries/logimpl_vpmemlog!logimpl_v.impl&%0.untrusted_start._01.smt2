...
;; src/logimpl_v.rs:1494:9: 1500:37 (#0)
...
;; Function-Def pmemlog::logimpl_v::UntrustedLogImpl::untrusted_start
;; src/logimpl_v.rs:1494:9: 1500:37 (#0)
...
(push)
 ...
 (declare-const e@ pmemlog!main_t.InfiniteLogErr.)
 ...
 (declare-const tmp%11 alloc!vec.Vec<u8./allocator_global%.>.)
 ...
 (declare-const tmp%21 vstd!seq.Seq<u8.>.)
 (declare-const tmp%22 vstd!seq.Seq<u8.>.)
 (declare-const tmp%23 Poly)
 (declare-const tmp%24 Poly)
 (declare-const tmp%25 slice%<u8.>.)
 (declare-const tmp%26 pmemlog!logimpl_v.PersistentHeader.)
 ...
 (declare-const tmp%33 vstd!seq.Seq<u8.>.)
 ...
 (declare-const header@ pmemlog!logimpl_v.PersistentHeader.)
 (declare-const head@ Int)
 (declare-const tail@ Int)
 (declare-const log_size@ Int)
 (declare-const untrusted_log@ pmemlog!logimpl_v.UntrustedLogImpl.)
 (assert
  fuel_defaults
 )
 (assert
 ...
 (assert
  (pmemlog!pmemspec_t.impl&%0.inv.? Perm&. Perm& PM&. PM& wrpm!@0)
 )
 (assert
  (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.impl&%0.view.?
 ...
 (assert
  (forall ((pm_state$ Poly)) (!
    ...
    :qid user_pmemlog__logimpl_v__UntrustedLogImpl__untrusted_start_62
    :skolemid skolem_user_pmemlog__logimpl_v__UntrustedLogImpl__untrusted_start_62
 )))
 (declare-fun %%lambda%%4 (Int Int) %%Function%%)
 (assert
  (forall ((%%hole%%0 Int) (%%hole%%1 Int) (i$ Poly)) (!
    (= (%%apply%%0 (%%lambda%%4 %%hole%%0 %%hole%%1) i$) (I (Add (Add (%I i$) %%hole%%0)
       %%hole%%1
    )))
    :pattern ((%%apply%%0 (%%lambda%%4 %%hole%%0 %%hole%%1) i$))
 )))
 ...
 (assert
  (not (and
    ...
    (=>
     ...
     (=>
      (= tmp%1 (> device_size! pmemlog!logimpl_v.contents_offset.?))
      (and
       (=>
        %%location_label%%1
        tmp%1
       ...
       (=>
        ...
        (and
         (=>
          %%location_label%%2
          (req%pmemlog!logimpl_v.impl&%0.read_incorruptible_boolean. PM&. PM& pm@)
         )
         (=>
          (ens%pmemlog!logimpl_v.impl&%0.read_incorruptible_boolean. PM&. PM& pm@ tmp%%@)
          (or
           (and
            (=>
            ...
            (=>
             (not (is-core!result.Result./Ok tmp%%@))
             (=>
              (= e@ (%Poly%pmemlog!main_t.InfiniteLogErr. (core!result.Result./Err/0 $ (UINT 64) $
                 TYPE%pmemlog!main_t.InfiniteLogErr. (%Poly%core!result.Result. (Poly%core!result.Result.
                   tmp%%@
              )))))
              (=>
               (= result! (core!result.Result./Err (Poly%pmemlog!main_t.InfiniteLogErr. e@)))
               (and
                (=>
                 %%location_label%%3
                 (ext_eq false (TYPE%core!option.Option. $ TYPE%pmemlog!infinitelog_t.AbstractInfiniteLogState.)
                 ...
                 (=>
                  ...
                  (ite
                   ...
                   (and
                    ...
                    (not (pmemlog!pmemspec_t.PersistentMemoryConstants./PersistentMemoryConstants/impervious_to_corruption
                      (%Poly%pmemlog!pmemspec_t.PersistentMemoryConstants. (Poly%pmemlog!pmemspec_t.PersistentMemoryConstants.
                        (pmemlog!pmemspec_t.impl&%0.constants.? Perm&. Perm& PM&. PM& wrpm!@0)
           )))))))))))))
           (and
            (not %%switch_label%%3)
            (=>
             (= ib@ (let
               ((ib$1 (%I (core!result.Result./Ok/0 $ (UINT 64) $ TYPE%pmemlog!main_t.InfiniteLogErr.
             ...
             (or
              (and
               (=>
                (= ib@ pmemlog!pmemspec_t.cdb0_val.?)
                (=>
                 (= tmp%3 pmemlog!logimpl_v.header1_pos.?)
                 %%switch_label%%2
               ))
               (=>
                (not (= ib@ pmemlog!pmemspec_t.cdb0_val.?))
                (=>
                 (= tmp%2 (= ib@ pmemlog!pmemspec_t.cdb1_val.?))
                 (and
                  (=>
                   %%location_label%%6
                   tmp%2
                  ...
                  (=>
                   tmp%2
                   (=>
                    (= tmp%3 pmemlog!logimpl_v.header2_pos.?)
                    %%switch_label%%2
              ))))))
              (and
               (not %%switch_label%%2)
               (=>
                ...
                (=>
                 ...
                 (and
                  (=>
                   %%location_label%%7
                   (uInv 64 (Add header_pos@ pmemlog!logimpl_v.header_crc_offset.?))
                  )
                  (=>
                   (uInv 64 (Add header_pos@ pmemlog!logimpl_v.header_crc_offset.?))
                   (=>
                    (= tmp%6 (I (uClip 64 (Add header_pos@ pmemlog!logimpl_v.header_crc_offset.?))))
                    (and
                     (=>
                      %%location_label%%8
                      (req%pmemlog!pmemspec_t.PersistentMemory.read. PM&. PM& tmp%4 tmp%6 (I 8))
                     )
                     (=>
                      (ens%pmemlog!pmemspec_t.PersistentMemory.read. PM&. PM& tmp%4 tmp%6 (I 8) tmp%5)
                      (=>
                       (= crc_bytes@ (%Poly%alloc!vec.Vec<u8./allocator_global%.>. tmp%5))
                       (=>
                        (= verus_tmp@1 (%Poly%vstd!seq.Seq<int.>. (vstd!seq.Seq.new.? $ INT $ (TYPE%fun%1. $
                            INT $ INT
                           ) (I 8) (Poly%fun%1. (mk_fun (%%lambda%%4 header_pos@ pmemlog!logimpl_v.header_crc_offset.?)))
                        )))
                        (=>
                         (= verus_tmp_crc_addrs@ verus_tmp@1)
                         (=>
                          (= crc_addrs@1 verus_tmp_crc_addrs@)
                          (=>
                           (= tmp%7 pm@)
                           (and
                            (=>
                             %%location_label%%9
                             (uInv 64 (Add header_pos@ pmemlog!logimpl_v.header_head_offset.?))
                            )
                            (=>
                             (uInv 64 (Add header_pos@ pmemlog!logimpl_v.header_head_offset.?))
                             (=>
                              (= tmp%8 (I (uClip 64 (Add header_pos@ pmemlog!logimpl_v.header_head_offset.?))))
                              (and
                               (=>
                                %%location_label%%10
                                (uInv 64 (Sub pmemlog!logimpl_v.header_size.? pmemlog!logimpl_v.header_head_offset.?))
                               )
                               (=>
                                (uInv 64 (Sub pmemlog!logimpl_v.header_size.? pmemlog!logimpl_v.header_head_offset.?))
                                (=>
                                 (= tmp%10 (I (uClip 64 (Sub pmemlog!logimpl_v.header_size.? pmemlog!logimpl_v.header_head_offset.?))))
                                 (and
                                  (=>
                                   %%location_label%%11
                                   (req%pmemlog!pmemspec_t.PersistentMemory.read. PM&. PM& tmp%7 tmp%8 tmp%10)
                                  )
                                  (=>
                                   (ens%pmemlog!pmemspec_t.PersistentMemory.read. PM&. PM& tmp%7 tmp%8 tmp%10 tmp%9)
                                   (=>
                                    (= header_bytes@ (%Poly%alloc!vec.Vec<u8./allocator_global%.>. tmp%9))
                                    (=>
                                     (= verus_tmp$1@1 (%Poly%vstd!seq.Seq<int.>. (vstd!seq.Seq.new.? $ INT $ (TYPE%fun%1.
                                         $ INT $ INT
                                        ) (I (nClip (Sub pmemlog!logimpl_v.header_size.? pmemlog!logimpl_v.header_head_offset.?)))
                                        (Poly%fun%1. (mk_fun (%%lambda%%4 header_pos@ pmemlog!logimpl_v.header_head_offset.?)))
                                     )))
                                     (=>
                                      (= verus_tmp_header_addrs@ verus_tmp$1@1)
                                      (=>
                                       (= header_addrs@1 verus_tmp_header_addrs@)
                                       (=>
                                        (ens%pmemlog!pmemspec_t.bytes_crc. header_bytes@ tmp%11)
                                        (=>
                                         ...
                                         (and
                                          (=>
                                           %%location_label%%12
                                           (req%vstd!bytes.u64_from_le_bytes. (%Poly%slice%<u8.>. tmp%12))
                                          )
                                          (=>
                                           (ens%vstd!bytes.u64_from_le_bytes. (%Poly%slice%<u8.>. tmp%12) tmp%13)
                                           (=>
                                            (= tmp%16 tmp%13)
                                            (=>
                                             (ens%alloc!vec.impl&%1.as_slice. $ (UINT 8) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u8./allocator_global%.>.
                                             ...
                                             (and
                                              (=>
                                               %%location_label%%13
                                               (req%vstd!bytes.u64_from_le_bytes. (%Poly%slice%<u8.>. tmp%14))
                                              )
                                              (=>
                                               (ens%vstd!bytes.u64_from_le_bytes. (%Poly%slice%<u8.>. tmp%14) tmp%15)
                                               (or
                                                (and
                                                 (=>
                                                  (= tmp%16 tmp%15)
                                                  (=>
                                                   ...
                                                   (=>
                                                    (= tmp%17 (vstd!bytes.spec_u64_from_le_bytes.? (Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.spec_crc_bytes.?
                                                        (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>.
                                                          header_bytes@
                                                    ))))))
                                                    (=>
                                                     (= tmp%18 (vstd!bytes.spec_u64_from_le_bytes.? (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
                                                         $ (UINT 8) $ ALLOCATOR_GLOBAL
                                                        ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. crc_bytes@)
                                                     )))
                                                     (and
                                                      (=>
                                                       %%location_label%%14
                                                       (req%pmemlog!logimpl_v.lemma_u64_bytes_eq. tmp%17 tmp%18)
                                                      )
                                                      (=>
                                                       (ens%pmemlog!logimpl_v.lemma_u64_bytes_eq. tmp%17 tmp%18)
                                                       (or
                                                        (and
                                                         (=>
                                                          (not (pmemlog!pmemspec_t.PersistentMemoryConstants./PersistentMemoryConstants/impervious_to_corruption
                                                          ...
                                                          (=>
                                                           ...
                                                           (=>
                                                            (= tmp%20 (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.subrange.? $ (UINT 8) (pmemlog!pmemspec_t.PersistentMemory.view.?
                                                                PM&. PM& pm@
                                                               ) (I (Add header_pos@ pmemlog!logimpl_v.header_head_offset.?)) (I (Add header_pos@
                                                                 pmemlog!logimpl_v.header_size.?
                                                            )))))
                                                            (=>
                                                             (= tmp%21 (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (
                                                                  UINT 8
                                                                 ) $ ALLOCATOR_GLOBAL
                                                                ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. crc_bytes@)
                                                             )))
                                                             (=>
                                                              (= tmp%22 (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.subrange.? $ (UINT 8) (pmemlog!pmemspec_t.PersistentMemory.view.?
                                                                  PM&. PM& pm@
                                                                 ) (I (Add header_pos@ pmemlog!logimpl_v.header_crc_offset.?)) (I (Add (Add header_pos@
                                                                    pmemlog!logimpl_v.header_crc_offset.?
                                                                   ) 8
                                                              ...
                                                              (and
                                                               (=>
                                                                %%location_label%%15
                                                                (req%pmemlog!pmemspec_t.axiom_bytes_uncorrupted. tmp%19 tmp%20 header_addrs@1 tmp%21
                                                                 tmp%22 crc_addrs@1
                                                               ))
                                                               (=>
                                                                (ens%pmemlog!pmemspec_t.axiom_bytes_uncorrupted. tmp%19 tmp%20 header_addrs@1 tmp%21
                                                                 tmp%22 crc_addrs@1
                                                                )
                                                                %%switch_label%%1
                                                         )))))))
                                                         (=>
                                                          (not (not (pmemlog!pmemspec_t.PersistentMemoryConstants./PersistentMemoryConstants/impervious_to_corruption
                                                             (%Poly%pmemlog!pmemspec_t.PersistentMemoryConstants. (Poly%pmemlog!pmemspec_t.PersistentMemoryConstants.
                                                               (pmemlog!pmemspec_t.impl&%0.constants.? Perm&. Perm& PM&. PM& wrpm!@0)
                                                          )))))
                                                          %%switch_label%%1
                                                          ...
                                                          (=>
                                                           ...
                                                           (=>
                                                            ...
                                                            (and
                                                             (=>
                                                              %%location_label%%16
                                                              (req%pmemlog!logimpl_v.crc_and_metadata_bytes_to_header. tmp%25 (%Poly%slice%<u8.>.
                                                                tmp%24
                                                             )))
                                                             (=>
                                                              (ens%pmemlog!logimpl_v.crc_and_metadata_bytes_to_header. tmp%25 (%Poly%slice%<u8.>.
                                                                tmp%24
                                                               ) tmp%26
                                                              )
                                                              %%switch_label%%0
                                                 ...
                                                 (=>
                                                  (not (= tmp%16 tmp%15))
                                                  (=>
                                                   (= result! (core!result.Result./Err (Poly%pmemlog!main_t.InfiniteLogErr. pmemlog!main_t.InfiniteLogErr./CRCMismatch)))
                                                   (and
                                                    (=>
                                                     %%location_label%%17
                                                     (ext_eq false (TYPE%core!option.Option. $ TYPE%pmemlog!infinitelog_t.AbstractInfiniteLogState.)
                                                  ...
                                                  (=>
                                                   ...
                                                   (=>
                                                    ...
                                                    (=>
                                                     ...
                                                     (=>
                                                      (= tmp%27 (= device_size! (Add log_size@ pmemlog!logimpl_v.contents_offset.?)))
                                                      (and
                                                       (=>
                                                        %%location_label%%20
                                                        tmp%27
                                                              ...
                                                              (=>
                                                               ...
                                                               (=>
                                                                ...
                                                                (and
                                                                 (=>
                                                                  %%location_label%%23
                                                                  (req%vstd!bytes.u64_from_le_bytes. (%Poly%slice%<u8.>. tmp%30))
                                                                 )
                                                                 (=>
                                                                  (ens%vstd!bytes.u64_from_le_bytes. (%Poly%slice%<u8.>. tmp%30) tmp%31)
                                                                  (=>
                                                                   (= untrusted_log@ (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl (%I (I tmp%32))
                                                                     (%I (I tmp%31)) (%I (I head@)) (%I (I tail@)) (%I (I log_size@))
                                                                   ))
                                                                   (=>
                                                                    (= tmp%33 (%Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.PersistentMemory.view.? PM&.
                                                                       PM& pm@
                                                                    )))
                                                                    (and
                                                                     (=>
                                                                      %%location_label%%24
                                                                      (req%pmemlog!logimpl_v.lemma_pm_state_header. tmp%33)
                                                                     )
                                                                     (=>
                                                                      (ens%pmemlog!logimpl_v.lemma_pm_state_header. tmp%33)
                                                                      (=>
                                                                       (= result! (core!result.Result./Ok (Poly%pmemlog!logimpl_v.UntrustedLogImpl. untrusted_log@)))
                                                                       (and
                                                                        (=>
                                                                         %%location_label%%25
                                                                         (ext_eq false (TYPE%core!option.Option. $ TYPE%pmemlog!infinitelog_t.AbstractInfiniteLogState.)
