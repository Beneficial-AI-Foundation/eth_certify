...
;; Function-Def pmemlog::main_t::InfiniteLogImpl::read
;; src/main_t.rs:234:9: 234:96 (#0)
  ...
  (not (=>
    ...
    (=>
     ...
     (and
      (=>
       %%location_label%%0
       (req%pmemlog!logimpl_v.impl&%0.untrusted_read. $ TYPE%pmemlog!main_t.TrustedPermission.
        PM&. PM& tmp%2 tmp%3 pos! len!
      ))
      (=>
       (ens%pmemlog!logimpl_v.impl&%0.untrusted_read. $ TYPE%pmemlog!main_t.TrustedPermission.
        PM&. PM& tmp%2 tmp%3 pos! len! tmp%1
       )
       (=>
        (= result! tmp%1)
        (=>
