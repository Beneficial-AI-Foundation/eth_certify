...
;; src/pmemspec_t.rs:267:9: 267:50 (#0)
...
;; Function-Def pmemlog::pmemspec_t::WriteRestrictedPersistentMemory::get_pm_ref
;; src/pmemspec_t.rs:267:9: 267:50 (#0)
...
(push)
 ...
 (declare-const self! pmemlog!pmemspec_t.WriteRestrictedPersistentMemory.)
 (assert
  fuel_defaults
 )
 (assert
 ...
 (assert
  (not (=>
    (= pm! (pmemlog!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory/pm
      (%Poly%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. (Poly%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory.
        self!
    ))))
    (and
     (=>
     ...
     (and
      (=>
       %%location_label%%1
       (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (pmemlog!pmemspec_t.PersistentMemory.view.?
         PM&. PM& pm!
        ) (Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM&
          (Poly%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. self!)
      ))))
