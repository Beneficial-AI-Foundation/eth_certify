...
;; src/logimpl_v.rs:128:5: 128:120 (#0)
...
;; Function-Def pmemlog::logimpl_v::lemma_bytes_combine_into_header
;; src/logimpl_v.rs:128:5: 128:120 (#0)
...
(push)
 ...
 (declare-const combined_header@ pmemlog!logimpl_v.PersistentHeader.)
 (assert
  fuel_defaults
 )
 (assert
 ...
 (assert
  (not (=>
    (= crc_val@ (vstd!bytes.spec_u64_from_le_bytes.? (Poly%vstd!seq.Seq<u8.>. crc_bytes!)))
    (=>
     (= metadata@ (pmemlog!logimpl_v.spec_bytes_to_metadata.? (Poly%vstd!seq.Seq<u8.>. metadata_bytes!)))
     (=>
      (ens%pmemlog!logimpl_v.lemma_seq_addition. crc_bytes! metadata_bytes!)
      (=>
       (= combined_header@ (pmemlog!logimpl_v.spec_bytes_to_header.? (vstd!seq.Seq.add.? $
          (UINT 8) (Poly%vstd!seq.Seq<u8.>. crc_bytes!) (Poly%vstd!seq.Seq<u8.>. metadata_bytes!)
       )))
       (=>
        (= tmp%1 (= (pmemlog!logimpl_v.PersistentHeader./PersistentHeader/crc (%Poly%pmemlog!logimpl_v.PersistentHeader.
            (Poly%pmemlog!logimpl_v.PersistentHeader. combined_header@)
           )
          ) crc_val@
        ))
        (and
         ...
         (=>
          tmp%1
          (=>
           (= tmp%2 (ext_eq false TYPE%pmemlog!logimpl_v.PersistentHeaderMetadata. (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
              metadata@
             ) (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (pmemlog!logimpl_v.spec_bytes_to_metadata.?
               (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!seq.Seq.add.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>.
                  crc_bytes!
                 ) (Poly%vstd!seq.Seq<u8.>. metadata_bytes!)
           ...
           (and
            ...
            (=>
             tmp%2
             (=>
              (= tmp%3 (ext_eq false TYPE%pmemlog!logimpl_v.PersistentHeaderMetadata. (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
                 (pmemlog!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%pmemlog!logimpl_v.PersistentHeader.
                   (Poly%pmemlog!logimpl_v.PersistentHeader. combined_header@)
                 ))
                ) (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. metadata@)
