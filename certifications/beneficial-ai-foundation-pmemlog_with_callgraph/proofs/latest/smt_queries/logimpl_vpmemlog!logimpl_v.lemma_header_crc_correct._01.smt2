...
;; src/logimpl_v.rs:1036:5: 1036:110 (#0)
...
;; Function-Def pmemlog::logimpl_v::lemma_header_crc_correct
;; src/logimpl_v.rs:1036:5: 1036:110 (#0)
 ...
 (assert
  (not (=>
    (= tmp%1 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT
        8
       ) (Poly%vstd!seq.Seq<u8.>. header_bytes!) (I pmemlog!logimpl_v.header_crc_offset.?)
       (I (Add pmemlog!logimpl_v.header_crc_offset.? 8))
      ) (Poly%vstd!seq.Seq<u8.>. crc_bytes!)
    ))
    (and
     ...
     (=>
      ...
      (=>
       (= tmp%2 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT
           8
          ) (Poly%vstd!seq.Seq<u8.>. header_bytes!) (I pmemlog!logimpl_v.header_head_offset.?)
          (I pmemlog!logimpl_v.header_size.?)
         ) (Poly%vstd!seq.Seq<u8.>. metadata_bytes!)
       ))
       (and
