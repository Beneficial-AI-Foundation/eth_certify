...
;; Function-Def pmemlog::math_v::lemma_mod_between
;; src/math_v.rs:163:5: 163:67 (#0)
            ...
            (=>
             ...
             (and
              ...
              (=>
               tmp%2
               (=>
                (= tmp%3 (< (Sub (Mul d! (EucDiv y! d!)) (Mul d! (EucDiv x! d!))) d!))
                (and
                 (=>
                  %%location_label%%7
                  tmp%3
                  ...
                  (=>
                   ...
                   (=>
                    ...
                    (=>
                     ...
                     (=>
                      (= tmp%6 (< (Mul d! (Sub (EucDiv y! d!) (EucDiv x! d!))) d!))
                      (and
                       (=>
                        %%location_label%%8
                        tmp%6
                       ...
                       (=>
                        ...
                        (and
                         (=>
                          %%location_label%%9
                          (req%pmemlog!math_v.lemma_div_relation_when_mods_have_same_order. d! x! y!)
                         )
                         (=>
                          (ens%pmemlog!math_v.lemma_div_relation_when_mods_have_same_order. d! x! y!)
                          (=>
                           (= z_mod_d@ (Add (EucMod x! d!) (Sub z! x!)))
                           (and
                            (=>
                             (= tmp%7 (= z! (Add (Mul d! (EucDiv x! d!)) z_mod_d@)))
                             (and
                              (=>
                               %%location_label%%10
                               tmp%7
                              ...
                              (=>
                               ...
                               (=>
                                (= tmp%8 (EucDiv x! d!))
                                (=>
                                 (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. d! tmp%8)
                                 (=>
                                  %%location_label%%11
                                  (= z! (Add (Mul (EucDiv x! d!) d!) z_mod_d@))
                            ))))))
                            (=>
                             (= z! (Add (Mul (EucDiv x! d!) d!) z_mod_d@))
                             (=>
                              ...
                              (and
                               (=>
                                %%location_label%%12
                                (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod_converse. z! d! tmp%9 z_mod_d@)
                               )
                               (=>
                                (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod_converse. z! d! tmp%9 z_mod_d@)
                                %%switch_label%%0
    ))))))))))))))))))))))))))))
    (and
     (not %%switch_label%%0)
