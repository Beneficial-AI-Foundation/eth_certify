...
;; src/logimpl_v.rs:585:5: 585:140 (#0)
...
;; Function-Def pmemlog::logimpl_v::lemma_inactive_header_update_view_crash
;; src/logimpl_v.rs:585:5: 585:140 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= new_pm@ (pmemlog!pmemspec_t.update_contents_to_reflect_partially_flushed_write.?
      (Poly%vstd!seq.Seq<u8.>. pm!) (I header_pos!) (Poly%vstd!seq.Seq<u8.>. new_header_bytes!)
