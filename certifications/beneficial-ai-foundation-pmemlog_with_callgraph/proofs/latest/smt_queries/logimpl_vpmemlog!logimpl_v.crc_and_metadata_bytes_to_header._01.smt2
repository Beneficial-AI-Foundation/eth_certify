...
;; src/logimpl_v.rs:295:10: 295:110 (#0)
...
;; Function-Def pmemlog::logimpl_v::crc_and_metadata_bytes_to_header
;; src/logimpl_v.rs:295:10: 295:110 (#0)
(get-info :all-statistics)
(push)
 (declare-const out! pmemlog!logimpl_v.PersistentHeader.)
 ...
 (assert
  (not (=>
    ...
    (and
     (=>
      %%location_label%%0
      (uInv 64 (Sub pmemlog!logimpl_v.header_head_offset.? 8))
     )
     (=>
      (uInv 64 (Sub pmemlog!logimpl_v.header_head_offset.? 8))
      (=>
       (= tmp%2 (uClip SZ (uClip 64 (Sub pmemlog!logimpl_v.header_head_offset.? 8))))
       (and
        (=>
         %%location_label%%1
         (uInv 64 (Add pmemlog!logimpl_v.header_head_offset.? 8))
        )
        (=>
         (uInv 64 (Add pmemlog!logimpl_v.header_head_offset.? 8))
         (and
          (=>
           %%location_label%%2
           (uInv 64 (Sub (uClip 64 (Add pmemlog!logimpl_v.header_head_offset.? 8)) 8))
          )
          (=>
           (uInv 64 (Sub (uClip 64 (Add pmemlog!logimpl_v.header_head_offset.? 8)) 8))
           (=>
            (= tmp%4 (uClip SZ (uClip 64 (Sub (uClip 64 (Add pmemlog!logimpl_v.header_head_offset.?
                  8
                 )
                ) 8
            ))))
            (and
             (=>
              %%location_label%%3
              (req%vstd!slice.slice_subrange. $ (UINT 8) (Poly%slice%<u8.>. tmp%1) tmp%2 tmp%4)
             )
             (=>
              (ens%vstd!slice.slice_subrange. $ (UINT 8) (Poly%slice%<u8.>. tmp%1) tmp%2 tmp%4 tmp%3)
              (=>
               (= head_bytes@ (%Poly%slice%<u8.>. tmp%3))
               (=>
                (= tmp%5 header_bytes!)
                (and
                 (=>
                  %%location_label%%4
                  (uInv 64 (Sub pmemlog!logimpl_v.header_tail_offset.? 8))
                 )
                 (=>
                  (uInv 64 (Sub pmemlog!logimpl_v.header_tail_offset.? 8))
                  (=>
                   (= tmp%6 (uClip SZ (uClip 64 (Sub pmemlog!logimpl_v.header_tail_offset.? 8))))
                   (and
                    (=>
                     %%location_label%%5
                     (uInv 64 (Add pmemlog!logimpl_v.header_tail_offset.? 8))
                    )
                    (=>
                     (uInv 64 (Add pmemlog!logimpl_v.header_tail_offset.? 8))
                     (and
                      (=>
                       %%location_label%%6
                       (uInv 64 (Sub (uClip 64 (Add pmemlog!logimpl_v.header_tail_offset.? 8)) 8))
                      )
                      (=>
                       (uInv 64 (Sub (uClip 64 (Add pmemlog!logimpl_v.header_tail_offset.? 8)) 8))
                       (=>
                        (= tmp%8 (uClip SZ (uClip 64 (Sub (uClip 64 (Add pmemlog!logimpl_v.header_tail_offset.?
                              8
                             )
                            ) 8
                        ))))
                        (and
                         (=>
                          %%location_label%%7
                          (req%vstd!slice.slice_subrange. $ (UINT 8) (Poly%slice%<u8.>. tmp%5) tmp%6 tmp%8)
                         )
                         (=>
                          (ens%vstd!slice.slice_subrange. $ (UINT 8) (Poly%slice%<u8.>. tmp%5) tmp%6 tmp%8 tmp%7)
                          (=>
                           (= tail_bytes@ (%Poly%slice%<u8.>. tmp%7))
                           (=>
                            (= tmp%9 header_bytes!)
                            (and
                             (=>
                              %%location_label%%8
                              (uInv 64 (Sub pmemlog!logimpl_v.header_log_size_offset.? 8))
                             )
                             (=>
                              (uInv 64 (Sub pmemlog!logimpl_v.header_log_size_offset.? 8))
                              (=>
                               (= tmp%10 (uClip SZ (uClip 64 (Sub pmemlog!logimpl_v.header_log_size_offset.? 8))))
                               (and
                                (=>
                                 %%location_label%%9
                                 (uInv 64 (Add pmemlog!logimpl_v.header_log_size_offset.? 8))
                                )
                                (=>
                                 (uInv 64 (Add pmemlog!logimpl_v.header_log_size_offset.? 8))
                                 (and
                                  (=>
                                   %%location_label%%10
                                   (uInv 64 (Sub (uClip 64 (Add pmemlog!logimpl_v.header_log_size_offset.? 8)) 8))
                                  )
                                  (=>
                                   (uInv 64 (Sub (uClip 64 (Add pmemlog!logimpl_v.header_log_size_offset.? 8)) 8))
                                   (=>
                                    (= tmp%12 (uClip SZ (uClip 64 (Sub (uClip 64 (Add pmemlog!logimpl_v.header_log_size_offset.?
                                          8
                                         )
                                        ) 8
                                    ))))
                                    (and
                                     (=>
                                      %%location_label%%11
                                      (req%vstd!slice.slice_subrange. $ (UINT 8) (Poly%slice%<u8.>. tmp%9) tmp%10 tmp%12)
                                     )
                                     (=>
                                      (ens%vstd!slice.slice_subrange. $ (UINT 8) (Poly%slice%<u8.>. tmp%9) tmp%10 tmp%12
                                       tmp%11
                                      )
                                      (=>
                                       (= log_size_bytes@ (%Poly%slice%<u8.>. tmp%11))
                                       (and
                                        (=>
                                         %%location_label%%12
                                         (req%vstd!bytes.u64_from_le_bytes. crc_bytes!)
                                        )
                                        (=>
                                         (ens%vstd!bytes.u64_from_le_bytes. crc_bytes! tmp%13)
                                         (=>
                                          (= tmp%19 tmp%13)
                                          (and
                                           (=>
                                            %%location_label%%13
                                            (req%vstd!bytes.u64_from_le_bytes. head_bytes@)
                                           )
                                           (=>
                                            (ens%vstd!bytes.u64_from_le_bytes. head_bytes@ tmp%14)
                                            (=>
                                             (= tmp%17 tmp%14)
                                             (and
                                              (=>
                                               %%location_label%%14
                                               (req%vstd!bytes.u64_from_le_bytes. tail_bytes@)
                                              )
                                              (=>
                                               (ens%vstd!bytes.u64_from_le_bytes. tail_bytes@ tmp%15)
                                               (=>
                                                (= tmp%18 tmp%15)
                                                (and
                                                 (=>
                                                  %%location_label%%15
                                                  (req%vstd!bytes.u64_from_le_bytes. log_size_bytes@)
                                                 )
                                                 (=>
                                                  (ens%vstd!bytes.u64_from_le_bytes. log_size_bytes@ tmp%16)
                                                  (=>
                                                   (= out! (pmemlog!logimpl_v.PersistentHeader./PersistentHeader (%I (I tmp%19)) (%Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
                                                      (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata
                                                        (%I (I tmp%17)) (%I (I tmp%18)) (%I (I tmp%16))
                                                   )))))
                                                   (and
                                                    (=>
                                                     %%location_label%%16
                                                    ...
                                                    (=>
                                                     %%location_label%%17
                                                     (ext_eq false TYPE%pmemlog!logimpl_v.PersistentHeaderMetadata. (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
                                                       (pmemlog!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%pmemlog!logimpl_v.PersistentHeader.
                                                         (Poly%pmemlog!logimpl_v.PersistentHeader. out!)
                                                       ))
                                                      ) (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (pmemlog!logimpl_v.spec_bytes_to_metadata.?
                                                        (vstd!view.View.view.? $slice (SLICE $ (UINT 8)) (Poly%slice%<u8.>. header_bytes!))
 )))))))))))))))))))))))))))))))))))))))))))))))))))))))
 (get-info :version)
