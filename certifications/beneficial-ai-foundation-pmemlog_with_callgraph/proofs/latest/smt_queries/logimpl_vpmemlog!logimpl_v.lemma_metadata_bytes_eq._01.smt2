...
;; src/logimpl_v.rs:333:5: 333:111 (#0)
...
;; Function-Def pmemlog::logimpl_v::lemma_metadata_bytes_eq
;; src/logimpl_v.rs:333:5: 333:111 (#0)
(get-info :all-statistics)
(push)
 (declare-const bytes1! vstd!seq.Seq<u8.>.)
 (declare-const bytes2! vstd!seq.Seq<u8.>.)
 (declare-const metadata! pmemlog!logimpl_v.PersistentHeaderMetadata.)
 ...
 (declare-const metadata1@ pmemlog!logimpl_v.PersistentHeaderMetadata.)
 (declare-const metadata2@ pmemlog!logimpl_v.PersistentHeaderMetadata.)
 (assert
  fuel_defaults
 )
 (assert
  (has_type (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. metadata!) TYPE%pmemlog!logimpl_v.PersistentHeaderMetadata.)
 )
 (assert
  (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes1!)) (Sub pmemlog!logimpl_v.header_size.?
    8
 ...
 (assert
  (not (=>
    (= metadata1@ (pmemlog!logimpl_v.spec_bytes_to_metadata.? (Poly%vstd!seq.Seq<u8.>. bytes1!)))
    (=>
     (= metadata2@ (pmemlog!logimpl_v.spec_bytes_to_metadata.? (Poly%vstd!seq.Seq<u8.>. bytes2!)))
     (=>
      (ens%vstd!bytes.lemma_auto_spec_u64_to_from_le_bytes. 0)
      (=>
       (= tmp%1 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (vstd!bytes.spec_u64_to_le_bytes.?
           (I (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/head (%Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
              (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. metadata1@)
          ))))
         ) (Poly%vstd!seq.Seq<u8.>. (vstd!bytes.spec_u64_to_le_bytes.? (I (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/head
             (%Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
               metadata2@
       ))))))))
       (and
        ...
        (=>
         tmp%1
         (=>
          (= tmp%2 (= (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/head
             (%Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
               metadata1@
             ))
            ) (vstd!bytes.spec_u64_from_le_bytes.? (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>.
               bytes1!
              ) (I (Sub pmemlog!logimpl_v.header_head_offset.? 8)) (I (Add (Sub pmemlog!logimpl_v.header_head_offset.?
                 8
                ) 8
          ...
          (and
           ...
           (=>
            tmp%2
            (=>
             (= tmp%3 (= (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/head
                (%Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
                  metadata2@
                ))
               ) (vstd!bytes.spec_u64_from_le_bytes.? (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>.
              ...
              (=>
               ...
               (=>
                (= tmp%4 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT
                    8
                   ) (Poly%vstd!seq.Seq<u8.>. bytes1!) (I (Sub pmemlog!logimpl_v.header_head_offset.?
                     8
                    )
                   ) (I (Add (Sub pmemlog!logimpl_v.header_head_offset.? 8) 8))
                  ) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes2!) (I (Sub pmemlog!logimpl_v.header_head_offset.?
                     8
                    )
                   ) (I (Add (Sub pmemlog!logimpl_v.header_head_offset.? 8) 8))
                )))
                (and
                 ...
                 (=>
                  tmp%4
                  (=>
                   (= tmp%5 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (vstd!bytes.spec_u64_to_le_bytes.?
                       (I (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/tail (%Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
                          (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. metadata1@)
                      ))))
                     ) (Poly%vstd!seq.Seq<u8.>. (vstd!bytes.spec_u64_to_le_bytes.? (I (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/tail
                         (%Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
                           metadata2@
                   ))))))))
                   (and
                    ...
                    (=>
                     tmp%5
                     (=>
                      (= tmp%6 (= (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/tail
                         (%Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
                           metadata1@
                         ))
                        ) (vstd!bytes.spec_u64_from_le_bytes.? (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>.
                      ...
                      (and
                       ...
                       (=>
                        tmp%6
                        (=>
                         (= tmp%7 (= (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/tail
                            (%Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
                              metadata2@
                            ))
                           ) (vstd!bytes.spec_u64_from_le_bytes.? (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>.
                          ...
                          (=>
                           ...
                           (=>
                            (= tmp%8 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT
                                8
                               ) (Poly%vstd!seq.Seq<u8.>. bytes1!) (I (Sub pmemlog!logimpl_v.header_tail_offset.?
                                 8
                                )
                               ) (I (Add (Sub pmemlog!logimpl_v.header_tail_offset.? 8) 8))
                              ) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes2!) (I (Sub pmemlog!logimpl_v.header_tail_offset.?
                                 8
                                )
                               ) (I (Add (Sub pmemlog!logimpl_v.header_tail_offset.? 8) 8))
                            )))
                            (and
                             ...
                             (=>
                              tmp%8
                              (=>
                               (= tmp%9 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (vstd!bytes.spec_u64_to_le_bytes.?
                                   (I (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/log_size (
                                      %Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
                                       metadata1@
                                  )))))
                                 ) (Poly%vstd!seq.Seq<u8.>. (vstd!bytes.spec_u64_to_le_bytes.? (I (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/log_size
                                     (%Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
                                       metadata2@
                               ))))))))
                               (and
                                ...
                                (=>
                                 tmp%9
                                 (=>
                                  (= tmp%10 (= (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/log_size
                                     (%Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
                                       metadata1@
                                     ))
                                    ) (vstd!bytes.spec_u64_from_le_bytes.? (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>.
                                       bytes1!
                                      ) (I (Sub pmemlog!logimpl_v.header_log_size_offset.? 8)) (I (Add (Sub pmemlog!logimpl_v.header_log_size_offset.?
                                         8
                                        ) 8
                                  ))))))
                                  (and
                                   ...
                                   (=>
                                    tmp%10
                                    (=>
                                     (= tmp%11 (= (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/log_size
                                        (%Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
                                          metadata2@
                                        ))
                                       ) (vstd!bytes.spec_u64_from_le_bytes.? (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>.
                                      ...
                                      (=>
                                       ...
                                       (=>
                                        (= tmp%12 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (
                                            UINT 8
                                           ) (Poly%vstd!seq.Seq<u8.>. bytes1!) (I (Sub pmemlog!logimpl_v.header_log_size_offset.?
                                             8
                                            )
                                           ) (I (Add (Sub pmemlog!logimpl_v.header_log_size_offset.? 8) 8))
                                          ) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes2!) (I (Sub pmemlog!logimpl_v.header_log_size_offset.?
                                             8
                                            )
                                           ) (I (Add (Sub pmemlog!logimpl_v.header_log_size_offset.? 8) 8))
                                        )))
                                        (and
                                         ...
                                         (=>
                                          tmp%12
                                          (=>
                                           (= tmp%13 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. bytes1!)
                                             (vstd!seq.Seq.add.? $ (UINT 8) (vstd!seq.Seq.add.? $ (UINT 8) (vstd!seq.Seq.subrange.?
                                                $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes1!) (I (Sub pmemlog!logimpl_v.header_head_offset.?
                                                  8
                                                 )
                                                ) (I (Add (Sub pmemlog!logimpl_v.header_head_offset.? 8) 8))
                                               ) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes1!) (I (Sub pmemlog!logimpl_v.header_tail_offset.?
                                                  8
                                                 )
                                                ) (I (Add (Sub pmemlog!logimpl_v.header_tail_offset.? 8) 8))
                                               )
                                              ) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes1!) (I (Sub pmemlog!logimpl_v.header_log_size_offset.?
                                                 8
                                                )
                                               ) (I (Add (Sub pmemlog!logimpl_v.header_log_size_offset.? 8) 8))
                                           ))))
                                           (and
                                            ...
                                            (=>
                                             ...
                                             (=>
                                              %%location_label%%13
                                              (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. bytes1!) (Poly%vstd!seq.Seq<u8.>.
                                                bytes2!
 )))))))))))))))))))))))))))))))))))))))))))))))
 (get-info :version)
