...
;; src/logimpl_v.rs:1954:9: 1962:37 (#0)
...
;; Function-Specs pmemlog::logimpl_v::lemma_inactive_header_update_view_crash
(declare-fun req%pmemlog!logimpl_v.lemma_inactive_header_update_view_crash. (vstd!seq.Seq<u8.>.
  vstd!seq.Seq<u8.>. Int vstd!set.Set<int.>.
 ) Bool
)
...
(assert
 (forall ((pm! vstd!seq.Seq<u8.>.) (new_header_bytes! vstd!seq.Seq<u8.>.) (header_pos!
   ...
   (= (req%pmemlog!logimpl_v.lemma_inactive_header_update_view_crash. pm! new_header_bytes!
     header_pos! chunks_flushed!
    ) (and
     (=>
   ...
   :pattern ((req%pmemlog!logimpl_v.lemma_inactive_header_update_view_crash. pm! new_header_bytes!
     header_pos! chunks_flushed!
   ))
   :qid internal_req__pmemlog!logimpl_v.lemma_inactive_header_update_view_crash._definition
   :skolemid skolem_internal_req__pmemlog!logimpl_v.lemma_inactive_header_update_view_crash._definition
)))
(declare-fun ens%pmemlog!logimpl_v.lemma_inactive_header_update_view_crash. (vstd!seq.Seq<u8.>.
  vstd!seq.Seq<u8.>. Int vstd!set.Set<int.>.
 ) Bool
)
(assert
 (forall ((pm! vstd!seq.Seq<u8.>.) (new_header_bytes! vstd!seq.Seq<u8.>.) (header_pos!
   ...
   (= (ens%pmemlog!logimpl_v.lemma_inactive_header_update_view_crash. pm! new_header_bytes!
     header_pos! chunks_flushed!
    ) (let
     ((new_pm$ (pmemlog!pmemspec_t.update_contents_to_reflect_partially_flushed_write.? (
         Poly%vstd!seq.Seq<u8.>. pm!
        ) (I header_pos!) (Poly%vstd!seq.Seq<u8.>. new_header_bytes!) (Poly%vstd!set.Set<int.>.
         chunks_flushed!
     ))))
     (let
      ((tmp%%$ (pmemlog!logimpl_v.pm_to_views.? (Poly%vstd!seq.Seq<u8.>. pm!))))
   ...
   :pattern ((ens%pmemlog!logimpl_v.lemma_inactive_header_update_view_crash. pm! new_header_bytes!
     header_pos! chunks_flushed!
   ))
   :qid internal_ens__pmemlog!logimpl_v.lemma_inactive_header_update_view_crash._definition
   :skolemid skolem_internal_ens__pmemlog!logimpl_v.lemma_inactive_header_update_view_crash._definition
)))

;; Function-Specs pmemlog::logimpl_v::lemma_header_correct
(declare-fun req%pmemlog!logimpl_v.lemma_header_correct. (vstd!seq.Seq<u8.>. vstd!seq.Seq<u8.>.
  Int
 ) Bool
)
...
(assert
 (forall ((pm! vstd!seq.Seq<u8.>.) (header_bytes! vstd!seq.Seq<u8.>.) (header_pos! Int))
  (!
   (= (req%pmemlog!logimpl_v.lemma_header_correct. pm! header_bytes! header_pos!) (and
     (=>
     ...
     (=>
      ...
      (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (
         Poly%vstd!seq.Seq<u8.>. header_bytes!
          ...
          (I pmemlog!logimpl_v.header_size.?)
     )))))
     (=>
   ...
   :pattern ((req%pmemlog!logimpl_v.lemma_header_correct. pm! header_bytes! header_pos!))
   :qid internal_req__pmemlog!logimpl_v.lemma_header_correct._definition
   :skolemid skolem_internal_req__pmemlog!logimpl_v.lemma_header_correct._definition
)))
(declare-fun ens%pmemlog!logimpl_v.lemma_header_correct. (vstd!seq.Seq<u8.>. vstd!seq.Seq<u8.>.
  Int
 ) Bool
)
(assert
 (forall ((pm! vstd!seq.Seq<u8.>.) (header_bytes! vstd!seq.Seq<u8.>.) (header_pos! Int))
  (!
   (= (ens%pmemlog!logimpl_v.lemma_header_correct. pm! header_bytes! header_pos!) (and
     (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (
        Poly%vstd!seq.Seq<u8.>. pm!
       ) (I (Add header_pos! pmemlog!logimpl_v.header_crc_offset.?)) (I (Add (Add header_pos!
          pmemlog!logimpl_v.header_crc_offset.?
         ) 8
       ))
      ) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. header_bytes!) (I pmemlog!logimpl_v.header_crc_offset.?)
       (I (Add pmemlog!logimpl_v.header_crc_offset.? 8))
     ))
     (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (
        Poly%vstd!seq.Seq<u8.>. pm!
       ) (I (Add header_pos! pmemlog!logimpl_v.header_head_offset.?)) (I (Add header_pos!
         pmemlog!logimpl_v.header_size.?
       ))
      ) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. header_bytes!) (I pmemlog!logimpl_v.header_head_offset.?)
       (I pmemlog!logimpl_v.header_size.?)
     ))
     (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (
        Poly%vstd!seq.Seq<u8.>. pm!
         ...
         $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!) (I (Add header_pos! pmemlog!logimpl_v.header_head_offset.?))
         (I (Add header_pos! pmemlog!logimpl_v.header_size.?))
   ))))))
   :pattern ((ens%pmemlog!logimpl_v.lemma_header_correct. pm! header_bytes! header_pos!))
   :qid internal_ens__pmemlog!logimpl_v.lemma_header_correct._definition
   :skolemid skolem_internal_ens__pmemlog!logimpl_v.lemma_header_correct._definition
)))
...
;; Function-Specs pmemlog::math_v::lemma_mod_equal
(declare-fun req%pmemlog!math_v.lemma_mod_equal. (Int Int Int) Bool)
...
(assert
 (forall ((x! Int) (y! Int) (d! Int)) (!
   (= (req%pmemlog!math_v.lemma_mod_equal. x! y! d!) (and
     (=>
   ...
   :pattern ((req%pmemlog!math_v.lemma_mod_equal. x! y! d!))
   :qid internal_req__pmemlog!math_v.lemma_mod_equal._definition
   :skolemid skolem_internal_req__pmemlog!math_v.lemma_mod_equal._definition
)))
(declare-fun ens%pmemlog!math_v.lemma_mod_equal. (Int Int Int) Bool)
(assert
 (forall ((x! Int) (y! Int) (d! Int)) (!
   (= (ens%pmemlog!math_v.lemma_mod_equal. x! y! d!) (= x! y!))
   :pattern ((ens%pmemlog!math_v.lemma_mod_equal. x! y! d!))
   :qid internal_ens__pmemlog!math_v.lemma_mod_equal._definition
   :skolemid skolem_internal_ens__pmemlog!math_v.lemma_mod_equal._definition
)))

;; Function-Specs pmemlog::logimpl_v::lemma_pm_state_header
(declare-fun req%pmemlog!logimpl_v.lemma_pm_state_header. (vstd!seq.Seq<u8.>.) Bool)
(declare-const %%global_location_label%%109 Bool)
(declare-const %%global_location_label%%110 Bool)
(assert
 (forall ((pm! vstd!seq.Seq<u8.>.)) (!
   (= (req%pmemlog!logimpl_v.lemma_pm_state_header. pm!) (and
     (=>
     ...
     (=>
      ...
      (let
       ((header$ (pmemlog!logimpl_v.spec_get_live_header.? (Poly%vstd!seq.Seq<u8.>. pm!))))
       (< (Sub (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/tail (
           %Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
            (pmemlog!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%pmemlog!logimpl_v.PersistentHeader.
              (Poly%pmemlog!logimpl_v.PersistentHeader. header$)
          ))))
   ...
   :pattern ((req%pmemlog!logimpl_v.lemma_pm_state_header. pm!))
   :qid internal_req__pmemlog!logimpl_v.lemma_pm_state_header._definition
   :skolemid skolem_internal_req__pmemlog!logimpl_v.lemma_pm_state_header._definition
)))
(declare-fun ens%pmemlog!logimpl_v.lemma_pm_state_header. (vstd!seq.Seq<u8.>.) Bool)
(assert
 (forall ((pm! vstd!seq.Seq<u8.>.)) (!
   (= (ens%pmemlog!logimpl_v.lemma_pm_state_header. pm!) (let
     ((pm_state$ (pmemlog!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. pm!))))
     (let
      ((header$ (pmemlog!logimpl_v.spec_get_live_header.? (Poly%vstd!seq.Seq<u8.>. pm!))))
      (and
       (is-core!option.Option./Some pm_state$)
       (let
        ((pm_state$1 (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (core!option.Option./Some/0
            $ TYPE%pmemlog!infinitelog_t.AbstractInfiniteLogState. (%Poly%core!option.Option.
             (Poly%core!option.Option. pm_state$)
        )))))
        (and
         (= (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/head (%Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
            (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (pmemlog!logimpl_v.PersistentHeader./PersistentHeader/metadata
   ...
   :pattern ((ens%pmemlog!logimpl_v.lemma_pm_state_header. pm!))
   :qid internal_ens__pmemlog!logimpl_v.lemma_pm_state_header._definition
   :skolemid skolem_internal_ens__pmemlog!logimpl_v.lemma_pm_state_header._definition
)))

;; Function-Specs pmemlog::logimpl_v::lemma_append_ib_update_effect_on_committed
(declare-fun req%pmemlog!logimpl_v.lemma_append_ib_update_effect_on_committed. (Dcr
  Type vstd!seq.Seq<u8.>. Int vstd!seq.Seq<u8.>. vstd!seq.Seq<u8.>. Poly
 ) Bool
)
...
(assert
 (forall ((Perm&. Dcr) (Perm& Type) (pm! vstd!seq.Seq<u8.>.) (new_ib! Int) (bytes_to_append!
    vstd!seq.Seq<u8.>.
   ) (new_header_bytes! vstd!seq.Seq<u8.>.) (perm! Poly)
  ) (!
   (= (req%pmemlog!logimpl_v.lemma_append_ib_update_effect_on_committed. Perm&. Perm&
     pm! new_ib! bytes_to_append! new_header_bytes! perm!
    ) (and
     (=>
     ...
     (=>
      ...
      (or
       (= new_ib! pmemlog!pmemspec_t.cdb0_val.?)
       (= new_ib! pmemlog!pmemspec_t.cdb1_val.?)
     ))
     (=>
      %%global_location_label%%114
      (=>
       (= new_ib! pmemlog!pmemspec_t.cdb0_val.?)
       (= (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>.
           pm!
          ) (I pmemlog!logimpl_v.header1_pos.?) (I (Add pmemlog!logimpl_v.header1_pos.? pmemlog!logimpl_v.header_size.?))
         )
        ) new_header_bytes!
     ...
     (=>
      ...
      (= (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>.
       ...
       ) (pmemlog!pmemspec_t.spec_crc_bytes.? (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>.
          new_header_bytes!
         ) (I pmemlog!logimpl_v.header_head_offset.?) (I pmemlog!logimpl_v.header_size.?)
     ))))
     (=>
      ...
      (let
       ((new_header$ (pmemlog!logimpl_v.spec_bytes_to_header.? (Poly%vstd!seq.Seq<u8.>. new_header_bytes!))))
       (let
        ((live_header$ (pmemlog!logimpl_v.spec_get_live_header.? (Poly%vstd!seq.Seq<u8.>. pm!))))
        (and
         (and
          (and
           (= (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/tail (%Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
            ...
            ) (Add (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/tail (
               %Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
                (pmemlog!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%pmemlog!logimpl_v.PersistentHeader.
                  (Poly%pmemlog!logimpl_v.PersistentHeader. live_header$)
              ))))
             ) (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes_to_append!))
           ))
           (= (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/head (%Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
              (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (pmemlog!logimpl_v.PersistentHeader./PersistentHeader/metadata
                (%Poly%pmemlog!logimpl_v.PersistentHeader. (Poly%pmemlog!logimpl_v.PersistentHeader.
          ...
          (= (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/log_size (
             %Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
              (pmemlog!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%pmemlog!logimpl_v.PersistentHeader.
                (Poly%pmemlog!logimpl_v.PersistentHeader. new_header$)
            ))))
           ) (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/log_size (
             %Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
              (pmemlog!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%pmemlog!logimpl_v.PersistentHeader.
      ...
      (let
       ...
       (let
        ...
        (let
         ...
         (let
          ((contents_end$ (Add (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/log_size
              (%Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
                (pmemlog!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%pmemlog!logimpl_v.PersistentHeader.
                  (Poly%pmemlog!logimpl_v.PersistentHeader. live_header$)
              ))))
          ...
          (let
           ((append_size$ (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes_to_append!))))
           (let
            ((len1$ (Sub contents_end$ physical_tail$)))
            (let
             ((len2$ (Sub (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes_to_append!))
                len1$
             )))
             (and
              (and
               (=>
                (>= (Add physical_tail$ append_size$) contents_end$)
                (and
                 (and
                  (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (
                     Poly%vstd!seq.Seq<u8.>. pm!
                    ) (I physical_tail$) (I contents_end$)
                   ) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes_to_append!) (
                     I 0
                    ) (I len1$)
                  ))
                  (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (
                     Poly%vstd!seq.Seq<u8.>. pm!
                    ) (I pmemlog!logimpl_v.contents_offset.?) (I (Add pmemlog!logimpl_v.contents_offset.?
                      len2$
                    ))
                   ) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes_to_append!) (
                     I len1$
                 ...
                 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. bytes_to_append!)
                  (vstd!seq.Seq.add.? $ (UINT 8) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>.
                     pm!
                    ) (I physical_tail$) (I contents_end$)
                   ) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!) (I pmemlog!logimpl_v.contents_offset.?)
                    (I (Add pmemlog!logimpl_v.contents_offset.? len2$))
               )))))
               (=>
                (and
                 (<= physical_head$ physical_tail$)
                ...
                (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (
                   Poly%vstd!seq.Seq<u8.>. pm!
                  ) (I physical_tail$) (I (Add physical_tail$ append_size$))
                 ) (Poly%vstd!seq.Seq<u8.>. bytes_to_append!)
              )))
              (=>
               (< physical_tail$ physical_head$)
               (and
                (< (Add physical_tail$ append_size$) physical_head$)
                (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (
                   Poly%vstd!seq.Seq<u8.>. pm!
                  ) (I physical_tail$) (I (Add physical_tail$ append_size$))
                 ) (Poly%vstd!seq.Seq<u8.>. bytes_to_append!)
     ...
     (=>
      ...
      (let
       ((old_log_state$ (pmemlog!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. pm!))))
       (forall ((pm_state$ Poly)) (!
         (=>
          (has_type pm_state$ (TYPE%vstd!seq.Seq. $ (UINT 8)))
          (= (%B (pmemlog!sccf.CheckPermission.check_permission.? Perm&. Perm& $ (TYPE%vstd!seq.Seq.
              $ (UINT 8)
             ) perm! pm_state$
            )
           ) (let
            ((log_state$ (pmemlog!logimpl_v.impl&%0.recover.? pm_state$)))
            (or
             (= log_state$ old_log_state$)
             (= log_state$ (core!option.Option./Some (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
                (pmemlog!infinitelog_t.impl&%0.append.? (core!option.Option./Some/0 $ TYPE%pmemlog!infinitelog_t.AbstractInfiniteLogState.
                  (%Poly%core!option.Option. (Poly%core!option.Option. old_log_state$))
                 ) (Poly%vstd!seq.Seq<u8.>. bytes_to_append!)
         ))))))))
         :pattern ((pmemlog!sccf.CheckPermission.check_permission.? Perm&. Perm& $ (TYPE%vstd!seq.Seq.
            $ (UINT 8)
         ...
         :qid user_pmemlog__logimpl_v__lemma_append_ib_update_effect_on_committed_49
         :skolemid skolem_user_pmemlog__logimpl_v__lemma_append_ib_update_effect_on_committed_49
   ))))))
   :pattern ((req%pmemlog!logimpl_v.lemma_append_ib_update_effect_on_committed. Perm&.
     Perm& pm! new_ib! bytes_to_append! new_header_bytes! perm!
   ))
   :qid internal_req__pmemlog!logimpl_v.lemma_append_ib_update_effect_on_committed._definition
   :skolemid skolem_internal_req__pmemlog!logimpl_v.lemma_append_ib_update_effect_on_committed._definition
)))
(declare-fun ens%pmemlog!logimpl_v.lemma_append_ib_update_effect_on_committed. (Dcr
  Type vstd!seq.Seq<u8.>. Int vstd!seq.Seq<u8.>. vstd!seq.Seq<u8.>. Poly
 ) Bool
)
(assert
 (forall ((Perm&. Dcr) (Perm& Type) (pm! vstd!seq.Seq<u8.>.) (new_ib! Int) (bytes_to_append!
   ...
   (= (ens%pmemlog!logimpl_v.lemma_append_ib_update_effect_on_committed. Perm&. Perm&
     pm! new_ib! bytes_to_append! new_header_bytes! perm!
    ) (let
     ((ib_bytes$ (vstd!bytes.spec_u64_to_le_bytes.? (I new_ib!))))
     (let
      ((new_pm$ (pmemlog!pmemspec_t.update_contents_to_reflect_write.? (Poly%vstd!seq.Seq<u8.>.
          pm!
         ) (I pmemlog!logimpl_v.incorruptible_bool_pos.?) (Poly%vstd!seq.Seq<u8.>. ib_bytes$)
      )))
      (let
       ((old_log_state$ (pmemlog!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. pm!))))
       (let
        ((new_log_state$ (pmemlog!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. new_pm$))))
        (let
         ((new_live_header$ (pmemlog!logimpl_v.spec_get_live_header.? (Poly%vstd!seq.Seq<u8.>.
             new_pm$
         ))))
         (let
          ((tmp%%$ (pmemlog!logimpl_v.pm_to_views.? (Poly%vstd!seq.Seq<u8.>. new_pm$))))
          (let
           ((new_pm_ib$ (%I (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$))))))
           (and
            (and
             (let
              ((tmp%%$1 (tuple%2./tuple%2 (Poly%core!option.Option. old_log_state$) (Poly%core!option.Option.
                  new_log_state$
              ))))
              (and
               (and
               ...
               (let
                ((old_log_state$1 (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (core!option.Option./Some/0
                    $ TYPE%pmemlog!infinitelog_t.AbstractInfiniteLogState. (%Poly%core!option.Option.
                     (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$1)))
                )))))
                (let
                 ((new_log_state$1 (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (core!option.Option./Some/0
                     $ TYPE%pmemlog!infinitelog_t.AbstractInfiniteLogState. (%Poly%core!option.Option.
                      (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$1)))
                 )))))
                 (and
                  (ext_eq false TYPE%pmemlog!infinitelog_t.AbstractInfiniteLogState. (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
                    new_log_state$1
                   ) (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (pmemlog!infinitelog_t.impl&%0.append.?
                     (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. old_log_state$1) (Poly%vstd!seq.Seq<u8.>.
                      bytes_to_append!
                  ))))
                  (%B (pmemlog!sccf.CheckPermission.check_permission.? Perm&. Perm& $ (TYPE%vstd!seq.Seq.
                     $ (UINT 8)
             ...
             (= new_live_header$ (pmemlog!logimpl_v.spec_bytes_to_header.? (Poly%vstd!seq.Seq<u8.>.
                new_header_bytes!
            ))))
            (= new_ib! new_pm_ib$)
   )))))))))
   :pattern ((ens%pmemlog!logimpl_v.lemma_append_ib_update_effect_on_committed. Perm&.
     Perm& pm! new_ib! bytes_to_append! new_header_bytes! perm!
   ))
   :qid internal_ens__pmemlog!logimpl_v.lemma_append_ib_update_effect_on_committed._definition
   :skolemid skolem_internal_ens__pmemlog!logimpl_v.lemma_append_ib_update_effect_on_committed._definition
)))

;; Function-Specs pmemlog::logimpl_v::lemma_single_write_crash
(declare-fun req%pmemlog!logimpl_v.lemma_single_write_crash. (vstd!seq.Seq<u8.>. Int
  vstd!seq.Seq<u8.>.
 ) Bool
)
...
(assert
 (forall ((pm! vstd!seq.Seq<u8.>.) (write_addr! Int) (bytes_to_write! vstd!seq.Seq<u8.>.))
  (!
   (= (req%pmemlog!logimpl_v.lemma_single_write_crash. pm! write_addr! bytes_to_write!)
    (and
     (=>
      %%global_location_label%%122
      (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes_to_write!)) pmemlog!pmemspec_t.persistence_chunk_size.?)
     )
     (=>
      %%global_location_label%%123
      (= (EucMod write_addr! pmemlog!pmemspec_t.persistence_chunk_size.?) 0)
     )
     (=>
     ...
     (=>
      ...
      (<= (Add write_addr! (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes_to_write!)))
       (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. pm!))
   ))))
   :pattern ((req%pmemlog!logimpl_v.lemma_single_write_crash. pm! write_addr! bytes_to_write!))
   :qid internal_req__pmemlog!logimpl_v.lemma_single_write_crash._definition
   :skolemid skolem_internal_req__pmemlog!logimpl_v.lemma_single_write_crash._definition
)))
(declare-fun ens%pmemlog!logimpl_v.lemma_single_write_crash. (vstd!seq.Seq<u8.>. Int
  vstd!seq.Seq<u8.>.
 ) Bool
)
(assert
 (forall ((pm! vstd!seq.Seq<u8.>.) (write_addr! Int) (bytes_to_write! vstd!seq.Seq<u8.>.))
  (!
   (= (ens%pmemlog!logimpl_v.lemma_single_write_crash. pm! write_addr! bytes_to_write!)
    (forall ((chunks_flushed$ Poly)) (!
      (=>
       (has_type chunks_flushed$ (TYPE%vstd!set.Set. $ INT))
       (let
        ((new_crash_contents$ (pmemlog!pmemspec_t.update_contents_to_reflect_partially_flushed_write.?
           (Poly%vstd!seq.Seq<u8.>. pm!) (I write_addr!) (Poly%vstd!seq.Seq<u8.>. bytes_to_write!)
           chunks_flushed$
        )))
        (let
         ((new_contents$ (pmemlog!pmemspec_t.update_contents_to_reflect_write.? (Poly%vstd!seq.Seq<u8.>.
             pm!
            ) (I write_addr!) (Poly%vstd!seq.Seq<u8.>. bytes_to_write!)
         )))
         (or
          (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. new_crash_contents$)
           (Poly%vstd!seq.Seq<u8.>. pm!)
          )
          (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. new_crash_contents$)
           (Poly%vstd!seq.Seq<u8.>. new_contents$)
      )))))
      :pattern ((pmemlog!pmemspec_t.update_contents_to_reflect_partially_flushed_write.?
        (Poly%vstd!seq.Seq<u8.>. pm!) (I write_addr!) (Poly%vstd!seq.Seq<u8.>. bytes_to_write!)
        chunks_flushed$
      ...
      :skolemid skolem_user_pmemlog__logimpl_v__lemma_single_write_crash_51
   )))
   :pattern ((ens%pmemlog!logimpl_v.lemma_single_write_crash. pm! write_addr! bytes_to_write!))
   :qid internal_ens__pmemlog!logimpl_v.lemma_single_write_crash._definition
   :skolemid skolem_internal_ens__pmemlog!logimpl_v.lemma_single_write_crash._definition
)))

;; Function-Specs pmemlog::logimpl_v::lemma_append_ib_update
(declare-fun req%pmemlog!logimpl_v.lemma_append_ib_update. (Dcr Type vstd!seq.Seq<u8.>.
  Int vstd!seq.Seq<u8.>. vstd!seq.Seq<u8.>. Poly
 ) Bool
)
...
(assert
 (forall ((Perm&. Dcr) (Perm& Type) (pm! vstd!seq.Seq<u8.>.) (new_ib! Int) (bytes_to_append!
   ...
   (= (req%pmemlog!logimpl_v.lemma_append_ib_update. Perm&. Perm& pm! new_ib! bytes_to_append!
     new_header_bytes! perm!
    ) (and
     (=>
     ...
     (=>
      ...
      (let
       ...
       (forall ((pm_state$ Poly)) (!
         ...
         :qid user_pmemlog__logimpl_v__lemma_append_ib_update_53
         :skolemid skolem_user_pmemlog__logimpl_v__lemma_append_ib_update_53
   ))))))
   :pattern ((req%pmemlog!logimpl_v.lemma_append_ib_update. Perm&. Perm& pm! new_ib! bytes_to_append!
     new_header_bytes! perm!
   ))
   :qid internal_req__pmemlog!logimpl_v.lemma_append_ib_update._definition
   :skolemid skolem_internal_req__pmemlog!logimpl_v.lemma_append_ib_update._definition
)))
(declare-fun ens%pmemlog!logimpl_v.lemma_append_ib_update. (Dcr Type vstd!seq.Seq<u8.>.
  Int vstd!seq.Seq<u8.>. vstd!seq.Seq<u8.>. Poly
 ) Bool
)
(assert
 (forall ((Perm&. Dcr) (Perm& Type) (pm! vstd!seq.Seq<u8.>.) (new_ib! Int) (bytes_to_append!
   ...
   (= (ens%pmemlog!logimpl_v.lemma_append_ib_update. Perm&. Perm& pm! new_ib! bytes_to_append!
     new_header_bytes! perm!
    ) (and
     (let
      ((ib_bytes$ (vstd!bytes.spec_u64_to_le_bytes.? (I new_ib!))))
     ...
     (forall ((chunks_flushed$ Poly)) (!
       (=>
        ...
        (%B (let
          ((new_pm$ (pmemlog!pmemspec_t.update_contents_to_reflect_partially_flushed_write.? (
              Poly%vstd!seq.Seq<u8.>. pm!
             ) (I pmemlog!logimpl_v.incorruptible_bool_pos.?) (Poly%vstd!seq.Seq<u8.>. (vstd!bytes.spec_u64_to_le_bytes.?
               (I new_ib!)
              )
             ) chunks_flushed$
          )))
       ...
       :pattern ((pmemlog!pmemspec_t.update_contents_to_reflect_partially_flushed_write.?
         (Poly%vstd!seq.Seq<u8.>. pm!) (I pmemlog!logimpl_v.incorruptible_bool_pos.?) (Poly%vstd!seq.Seq<u8.>.
          (vstd!bytes.spec_u64_to_le_bytes.? (I new_ib!))
         ) chunks_flushed$
       ))
       :qid user_pmemlog__logimpl_v__lemma_append_ib_update_54
       :skolemid skolem_user_pmemlog__logimpl_v__lemma_append_ib_update_54
   ))))
   :pattern ((ens%pmemlog!logimpl_v.lemma_append_ib_update. Perm&. Perm& pm! new_ib! bytes_to_append!
     new_header_bytes! perm!
   ))
   :qid internal_ens__pmemlog!logimpl_v.lemma_append_ib_update._definition
   :skolemid skolem_internal_ens__pmemlog!logimpl_v.lemma_append_ib_update._definition
)))

;; Function-Specs pmemlog::logimpl_v::lemma_header_crc_correct
(declare-fun req%pmemlog!logimpl_v.lemma_header_crc_correct. (vstd!seq.Seq<u8.>. vstd!seq.Seq<u8.>.
  vstd!seq.Seq<u8.>.
 ) Bool
)
...
(assert
 (forall ((header_bytes! vstd!seq.Seq<u8.>.) (crc_bytes! vstd!seq.Seq<u8.>.) (metadata_bytes!
    vstd!seq.Seq<u8.>.
   )
  ) (!
   (= (req%pmemlog!logimpl_v.lemma_header_crc_correct. header_bytes! crc_bytes! metadata_bytes!)
    (and
     (=>
     ...
     (=>
      ...
      (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. crc_bytes!)
       (Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.spec_crc_bytes.? (Poly%vstd!seq.Seq<u8.>.
          metadata_bytes!
     )))))
     (=>
      %%global_location_label%%141
      (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. header_bytes!)
       (vstd!seq.Seq.add.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. crc_bytes!) (Poly%vstd!seq.Seq<u8.>.
         metadata_bytes!
   ))))))
   :pattern ((req%pmemlog!logimpl_v.lemma_header_crc_correct. header_bytes! crc_bytes!
     metadata_bytes!
   ))
   :qid internal_req__pmemlog!logimpl_v.lemma_header_crc_correct._definition
   :skolemid skolem_internal_req__pmemlog!logimpl_v.lemma_header_crc_correct._definition
)))
(declare-fun ens%pmemlog!logimpl_v.lemma_header_crc_correct. (vstd!seq.Seq<u8.>. vstd!seq.Seq<u8.>.
  vstd!seq.Seq<u8.>.
 ) Bool
)
(assert
 (forall ((header_bytes! vstd!seq.Seq<u8.>.) (crc_bytes! vstd!seq.Seq<u8.>.) (metadata_bytes!
   ...
   (= (ens%pmemlog!logimpl_v.lemma_header_crc_correct. header_bytes! crc_bytes! metadata_bytes!)
    (and
     (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (
        Poly%vstd!seq.Seq<u8.>. header_bytes!
       ) (I pmemlog!logimpl_v.header_crc_offset.?) (I (Add pmemlog!logimpl_v.header_crc_offset.?
   ...
   :pattern ((ens%pmemlog!logimpl_v.lemma_header_crc_correct. header_bytes! crc_bytes!
     metadata_bytes!
   ))
   :qid internal_ens__pmemlog!logimpl_v.lemma_header_crc_correct._definition
   :skolemid skolem_internal_ens__pmemlog!logimpl_v.lemma_header_crc_correct._definition
)))

;; Function-Specs pmemlog::logimpl_v::lemma_u64_bytes_eq
(declare-fun req%pmemlog!logimpl_v.lemma_u64_bytes_eq. (Int Int) Bool)
(declare-const %%global_location_label%%142 Bool)
(assert
 (forall ((val1! Int) (val2! Int)) (!
   (= (req%pmemlog!logimpl_v.lemma_u64_bytes_eq. val1! val2!) (=>
     %%global_location_label%%142
     (= val1! val2!)
   ))
   :pattern ((req%pmemlog!logimpl_v.lemma_u64_bytes_eq. val1! val2!))
   :qid internal_req__pmemlog!logimpl_v.lemma_u64_bytes_eq._definition
   :skolemid skolem_internal_req__pmemlog!logimpl_v.lemma_u64_bytes_eq._definition
)))
(declare-fun ens%pmemlog!logimpl_v.lemma_u64_bytes_eq. (Int Int) Bool)
(assert
 (forall ((val1! Int) (val2! Int)) (!
   (= (ens%pmemlog!logimpl_v.lemma_u64_bytes_eq. val1! val2!) (ext_eq false (TYPE%vstd!seq.Seq.
      $ (UINT 8)
     ) (Poly%vstd!seq.Seq<u8.>. (vstd!bytes.spec_u64_to_le_bytes.? (I val1!))) (Poly%vstd!seq.Seq<u8.>.
      (vstd!bytes.spec_u64_to_le_bytes.? (I val2!))
   )))
   :pattern ((ens%pmemlog!logimpl_v.lemma_u64_bytes_eq. val1! val2!))
   :qid internal_ens__pmemlog!logimpl_v.lemma_u64_bytes_eq._definition
   :skolemid skolem_internal_ens__pmemlog!logimpl_v.lemma_u64_bytes_eq._definition
)))

;; Function-Specs pmemlog::logimpl_v::lemma_subrange_eq
(declare-fun req%pmemlog!logimpl_v.lemma_subrange_eq. (Dcr Type Poly Poly) Bool)
(declare-const %%global_location_label%%143 Bool)
(assert
 (forall ((T&. Dcr) (T& Type) (bytes1! Poly) (bytes2! Poly)) (!
   (= (req%pmemlog!logimpl_v.lemma_subrange_eq. T&. T& bytes1! bytes2!) (=>
     %%global_location_label%%143
     (ext_eq false (TYPE%vstd!seq.Seq. T&. T&) bytes1! bytes2!)
   ))
   :pattern ((req%pmemlog!logimpl_v.lemma_subrange_eq. T&. T& bytes1! bytes2!))
   :qid internal_req__pmemlog!logimpl_v.lemma_subrange_eq._definition
   :skolemid skolem_internal_req__pmemlog!logimpl_v.lemma_subrange_eq._definition
)))
(declare-fun ens%pmemlog!logimpl_v.lemma_subrange_eq. (Dcr Type Poly Poly) Bool)
(assert
 (forall ((T&. Dcr) (T& Type) (bytes1! Poly) (bytes2! Poly)) (!
   (= (ens%pmemlog!logimpl_v.lemma_subrange_eq. T&. T& bytes1! bytes2!) (forall ((i$ Poly)
      (j$ Poly)
     ) (!
      (=>
       (and
        ...
        (let
         ...
         (let
          ...
          (and
           ...
           (< tmp%%$1 (vstd!seq.Seq.len.? T&. T& bytes1!))
        )))
        (ext_eq false (TYPE%vstd!seq.Seq. T&. T&) (vstd!seq.Seq.subrange.? T&. T& bytes1! i$
          j$
         ) (vstd!seq.Seq.subrange.? T&. T& bytes2! i$ j$)
      )))
      :pattern ((vstd!seq.Seq.subrange.? T&. T& bytes1! i$ j$))
      :pattern ((vstd!seq.Seq.subrange.? T&. T& bytes2! i$ j$))
      :qid user_pmemlog__logimpl_v__lemma_subrange_eq_57
      :skolemid skolem_user_pmemlog__logimpl_v__lemma_subrange_eq_57
   )))
   :pattern ((ens%pmemlog!logimpl_v.lemma_subrange_eq. T&. T& bytes1! bytes2!))
   :qid internal_ens__pmemlog!logimpl_v.lemma_subrange_eq._definition
   :skolemid skolem_internal_ens__pmemlog!logimpl_v.lemma_subrange_eq._definition
)))

;; Function-Specs pmemlog::logimpl_v::UntrustedLogImpl::addr_logical_to_physical
(declare-fun req%pmemlog!logimpl_v.impl&%0.addr_logical_to_physical. (Int Int) Bool)
...
(assert
 (forall ((addr! Int) (log_size! Int)) (!
   (= (req%pmemlog!logimpl_v.impl&%0.addr_logical_to_physical. addr! log_size!) (and
     (=>
   ...
   :pattern ((req%pmemlog!logimpl_v.impl&%0.addr_logical_to_physical. addr! log_size!))
   :qid internal_req__pmemlog!logimpl_v.impl&__0.addr_logical_to_physical._definition
   :skolemid skolem_internal_req__pmemlog!logimpl_v.impl&__0.addr_logical_to_physical._definition
)))
(declare-fun ens%pmemlog!logimpl_v.impl&%0.addr_logical_to_physical. (Int Int Int)
 Bool
)
(assert
 (forall ((addr! Int) (log_size! Int) (out! Int)) (!
   (= (ens%pmemlog!logimpl_v.impl&%0.addr_logical_to_physical. addr! log_size! out!)
    (and
     (uInv 64 out!)
     (= out! (pmemlog!logimpl_v.spec_addr_logical_to_physical.? (I addr!) (I log_size!)))
   ))
   :pattern ((ens%pmemlog!logimpl_v.impl&%0.addr_logical_to_physical. addr! log_size!
     out!
   ))
   :qid internal_ens__pmemlog!logimpl_v.impl&__0.addr_logical_to_physical._definition
   :skolemid skolem_internal_ens__pmemlog!logimpl_v.impl&__0.addr_logical_to_physical._definition
)))

;; Function-Specs pmemlog::logimpl_v::UntrustedLogImpl::read_incorruptible_boolean
(declare-fun req%pmemlog!logimpl_v.impl&%0.read_incorruptible_boolean. (Dcr Type Poly)
 Bool
)
...
(assert
 (forall ((PM&. Dcr) (PM& Type) (pm! Poly)) (!
   (= (req%pmemlog!logimpl_v.impl&%0.read_incorruptible_boolean. PM&. PM& pm!) (and
     (=>
      %%global_location_label%%147
      (is-core!option.Option./Some (pmemlog!logimpl_v.impl&%0.recover.? (pmemlog!pmemspec_t.PersistentMemory.view.?
         PM&. PM& pm!
     ))))
     (=>
      %%global_location_label%%148
      (%B (pmemlog!pmemspec_t.PersistentMemory.inv.? PM&. PM& pm!))
     )
     (=>
      %%global_location_label%%149
      (> (vstd!seq.Seq.len.? $ (UINT 8) (pmemlog!pmemspec_t.PersistentMemory.view.? PM&. PM&
         pm!
        )
       ) pmemlog!logimpl_v.contents_offset.?
   ))))
   :pattern ((req%pmemlog!logimpl_v.impl&%0.read_incorruptible_boolean. PM&. PM& pm!))
   :qid internal_req__pmemlog!logimpl_v.impl&__0.read_incorruptible_boolean._definition
   :skolemid skolem_internal_req__pmemlog!logimpl_v.impl&__0.read_incorruptible_boolean._definition
)))
(declare-fun ens%pmemlog!logimpl_v.impl&%0.read_incorruptible_boolean. (Dcr Type Poly
  core!result.Result.
 ) Bool
)
(assert
 (forall ((PM&. Dcr) (PM& Type) (pm! Poly) (result! core!result.Result.)) (!
   (= (ens%pmemlog!logimpl_v.impl&%0.read_incorruptible_boolean. PM&. PM& pm! result!)
    (and
     (has_type (Poly%core!result.Result. result!) (TYPE%core!result.Result. $ (UINT 64)
       $ TYPE%pmemlog!main_t.InfiniteLogErr.
     ))
     (ite
      (is-core!result.Result./Ok result!)
      (let
       ((ib$ (%I (core!result.Result./Ok/0 $ (UINT 64) $ TYPE%pmemlog!main_t.InfiniteLogErr.
           (%Poly%core!result.Result. (Poly%core!result.Result. result!))
       ))))
       (let
        ((tmp%%$ (pmemlog!logimpl_v.pm_to_views.? (pmemlog!pmemspec_t.PersistentMemory.view.?
            PM&. PM& pm!
        ))))
        (let
         ((spec_ib$ (%I (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$))))))
         (= ib$ spec_ib$)
      )))
      (and
       (and
        (is-core!result.Result./Err result!)
        (is-pmemlog!main_t.InfiniteLogErr./CRCMismatch (%Poly%pmemlog!main_t.InfiniteLogErr.
          (core!result.Result./Err/0 $ (UINT 64) $ TYPE%pmemlog!main_t.InfiniteLogErr. (%Poly%core!result.Result.
            (Poly%core!result.Result. result!)
       )))))
       (not (pmemlog!pmemspec_t.PersistentMemoryConstants./PersistentMemoryConstants/impervious_to_corruption
         (%Poly%pmemlog!pmemspec_t.PersistentMemoryConstants. (pmemlog!pmemspec_t.PersistentMemory.constants.?
           PM&. PM& pm!
   ))))))))
   :pattern ((ens%pmemlog!logimpl_v.impl&%0.read_incorruptible_boolean. PM&. PM& pm! result!))
   :qid internal_ens__pmemlog!logimpl_v.impl&__0.read_incorruptible_boolean._definition
   :skolemid skolem_internal_ens__pmemlog!logimpl_v.impl&__0.read_incorruptible_boolean._definition
)))

;; Function-Specs pmemlog::pmemspec_t::WriteRestrictedPersistentMemory::write
(declare-fun req%pmemlog!pmemspec_t.impl&%0.write. (Dcr Type Dcr Type Poly Int slice%<u8.>.
  Poly
 ) Bool
)
...
(assert
 (forall ((Perm&. Dcr) (Perm& Type) (PM&. Dcr) (PM& Type) (pre%self! Poly) (addr! Int)
   (bytes! slice%<u8.>.) (perm! Poly)
  ) (!
   (= (req%pmemlog!pmemspec_t.impl&%0.write. Perm&. Perm& PM&. PM& pre%self! addr! bytes!
     perm!
    ) (and
     (=>
      %%global_location_label%%150
      (pmemlog!pmemspec_t.impl&%0.inv.? Perm&. Perm& PM&. PM& pre%self!)
     )
     (=>
      %%global_location_label%%151
      (<= (Add addr! (vstd!seq.Seq.len.? $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $ (
            UINT 8
           )
          ) (Poly%slice%<u8.>. bytes!)
        ))
       ) (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.impl&%0.view.?
          Perm&. Perm& PM&. PM& pre%self!
     )))))
     (=>
     ...
     (=>
      ...
      (forall ((chunks_flushed$ Poly)) (!
        (=>
         (has_type chunks_flushed$ (TYPE%vstd!set.Set. $ INT))
         (%B (let
           ((new_contents$ (pmemlog!pmemspec_t.update_contents_to_reflect_partially_flushed_write.?
              (Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& pre%self!))
              (I addr!) (vstd!view.View.view.? $slice (SLICE $ (UINT 8)) (Poly%slice%<u8.>. bytes!))
              chunks_flushed$
           )))
           (pmemlog!sccf.CheckPermission.check_permission.? Perm&. Perm& $ (TYPE%vstd!seq.Seq.
             $ (UINT 8)
            ) perm! (Poly%vstd!seq.Seq<u8.>. new_contents$)
        ))))
        :pattern ((pmemlog!pmemspec_t.update_contents_to_reflect_partially_flushed_write.?
          (Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& pre%self!))
          (I addr!) (vstd!view.View.view.? $slice (SLICE $ (UINT 8)) (Poly%slice%<u8.>. bytes!))
        ...
        :qid user_pmemlog__pmemspec_t__WriteRestrictedPersistentMemory__write_59
        :skolemid skolem_user_pmemlog__pmemspec_t__WriteRestrictedPersistentMemory__write_59
   )))))
   :pattern ((req%pmemlog!pmemspec_t.impl&%0.write. Perm&. Perm& PM&. PM& pre%self! addr!
     bytes! perm!
   ))
   :qid internal_req__pmemlog!pmemspec_t.impl&__0.write._definition
   :skolemid skolem_internal_req__pmemlog!pmemspec_t.impl&__0.write._definition
)))
(declare-fun ens%pmemlog!pmemspec_t.impl&%0.write. (Dcr Type Dcr Type Poly Poly Int
  slice%<u8.>. Poly
 ) Bool
)
(assert
 (forall ((Perm&. Dcr) (Perm& Type) (PM&. Dcr) (PM& Type) (pre%self! Poly) (self! Poly)
   (addr! Int) (bytes! slice%<u8.>.) (perm! Poly)
  ) (!
   (= (ens%pmemlog!pmemspec_t.impl&%0.write. Perm&. Perm& PM&. PM& pre%self! self! addr!
     bytes! perm!
    ) (and
     (has_type self! (TYPE%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. Perm&. Perm&
       PM&. PM&
     ))
     (pmemlog!pmemspec_t.impl&%0.inv.? Perm&. Perm& PM&. PM& self!)
     (= (pmemlog!pmemspec_t.impl&%0.constants.? Perm&. Perm& PM&. PM& self!) (pmemlog!pmemspec_t.impl&%0.constants.?
       Perm&. Perm& PM&. PM& pre%self!
     ))
     (= (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& self!) (pmemlog!pmemspec_t.update_contents_to_reflect_write.?
       (Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& pre%self!))
       (I addr!) (vstd!view.View.view.? $slice (SLICE $ (UINT 8)) (Poly%slice%<u8.>. bytes!))
   ))))
   :pattern ((ens%pmemlog!pmemspec_t.impl&%0.write. Perm&. Perm& PM&. PM& pre%self! self!
     addr! bytes! perm!
   ))
   :qid internal_ens__pmemlog!pmemspec_t.impl&__0.write._definition
   :skolemid skolem_internal_ens__pmemlog!pmemspec_t.impl&__0.write._definition
)))

;; Function-Specs pmemlog::logimpl_v::UntrustedLogImpl::update_header
(declare-fun req%pmemlog!logimpl_v.impl&%0.update_header. (Dcr Type Dcr Type pmemlog!logimpl_v.UntrustedLogImpl.
  Poly Poly alloc!vec.Vec<u8./allocator_global%.>.
 ) Bool
)
...
(assert
 (forall ((Perm&. Dcr) (Perm& Type) (PM&. Dcr) (PM& Type) (pre%self! pmemlog!logimpl_v.UntrustedLogImpl.)
   (pre%wrpm! Poly) (perm! Poly) (new_header_bytes! alloc!vec.Vec<u8./allocator_global%.>.)
  ) (!
   (= (req%pmemlog!logimpl_v.impl&%0.update_header. Perm&. Perm& PM&. PM& pre%self! pre%wrpm!
     perm! new_header_bytes!
    ) (and
     (=>
     ...
     (=>
      ...
      (< pmemlog!logimpl_v.contents_offset.? (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>.
         (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& pre%wrpm!)
     ))))
     (=>
      %%global_location_label%%156
      (pmemlog!logimpl_v.impl&%0.inv.? Perm&. Perm& PM&. PM& (Poly%pmemlog!logimpl_v.UntrustedLogImpl.
        pre%self!
       ) pre%wrpm!
     ))
     (=>
      ...
      (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (
         vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>.
          ...
          $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL)
           (Poly%alloc!vec.Vec<u8./allocator_global%.>. new_header_bytes!)
          ) (I pmemlog!logimpl_v.header_head_offset.?) (I pmemlog!logimpl_v.header_size.?)
     )))))
     (=>
     ...
     (=>
      ...
      (let
       ((tmp%%$ (pmemlog!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.impl&%0.view.?
            Perm&. Perm& PM&. PM& pre%wrpm!
       )))))
       (and
        (is-core!option.Option./Some tmp%%$)
        (%B (let
          ((log_state$ (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (core!option.Option./Some/0
              $ TYPE%pmemlog!infinitelog_t.AbstractInfiniteLogState. (%Poly%core!option.Option.
               (Poly%core!option.Option. tmp%%$)
          )))))
          (pmemlog!sccf.CheckPermission.check_permission.? Perm&. Perm& $ (TYPE%vstd!seq.Seq.
            $ (UINT 8)
           ) perm! (Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&.
             PM& pre%wrpm!
   ))))))))))
   :pattern ((req%pmemlog!logimpl_v.impl&%0.update_header. Perm&. Perm& PM&. PM& pre%self!
     pre%wrpm! perm! new_header_bytes!
   ))
   :qid internal_req__pmemlog!logimpl_v.impl&__0.update_header._definition
   :skolemid skolem_internal_req__pmemlog!logimpl_v.impl&__0.update_header._definition
)))
(declare-fun ens%pmemlog!logimpl_v.impl&%0.update_header. (Dcr Type Dcr Type pmemlog!logimpl_v.UntrustedLogImpl.
  pmemlog!logimpl_v.UntrustedLogImpl. Poly Poly Poly alloc!vec.Vec<u8./allocator_global%.>.
 ) Bool
)
(assert
 (forall ((Perm&. Dcr) (Perm& Type) (PM&. Dcr) (PM& Type) (pre%self! pmemlog!logimpl_v.UntrustedLogImpl.)
   (self! pmemlog!logimpl_v.UntrustedLogImpl.) (pre%wrpm! Poly) (wrpm! Poly) (perm! Poly)
   (new_header_bytes! alloc!vec.Vec<u8./allocator_global%.>.)
  ) (!
   (= (ens%pmemlog!logimpl_v.impl&%0.update_header. Perm&. Perm& PM&. PM& pre%self! self!
     pre%wrpm! wrpm! perm! new_header_bytes!
    ) (and
     (has_type (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!) TYPE%pmemlog!logimpl_v.UntrustedLogImpl.)
     (has_type wrpm! (TYPE%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. Perm&. Perm&
       PM&. PM&
     ))
     (pmemlog!logimpl_v.impl&%0.inv.? Perm&. Perm& PM&. PM& (Poly%pmemlog!logimpl_v.UntrustedLogImpl.
       self!
     ...
     (is-core!option.Option./Some (pmemlog!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>.
        (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!)
     )))
     (= (pmemlog!pmemspec_t.impl&%0.constants.? Perm&. Perm& PM&. PM& wrpm!) (pmemlog!pmemspec_t.impl&%0.constants.?
       Perm&. Perm& PM&. PM& pre%wrpm!
     ))
     (let
      ((tmp%%$ (tuple%2./tuple%2 (Poly%core!option.Option. (pmemlog!logimpl_v.impl&%0.recover.?
           (Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& pre%wrpm!))
          )
         ) (Poly%core!option.Option. (pmemlog!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>.
            (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!)
      ))))))
      (and
       ...
       (let
        ((old_log_state$ (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (core!option.Option./Some/0
            $ TYPE%pmemlog!infinitelog_t.AbstractInfiniteLogState. (%Poly%core!option.Option.
             (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$)))
        )))))
        (let
         ((new_log_state$ (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (core!option.Option./Some/0
             $ TYPE%pmemlog!infinitelog_t.AbstractInfiniteLogState. (%Poly%core!option.Option.
              (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$)))
         )))))
         (ext_eq false TYPE%pmemlog!infinitelog_t.AbstractInfiniteLogState. (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
           old_log_state$
          ) (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. new_log_state$)
     )))))
     (let
      ((tmp%%$ (pmemlog!logimpl_v.pm_to_views.? (Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.impl&%0.view.?
           Perm&. Perm& PM&. PM& pre%wrpm!
      )))))
      (let
       ((old_pm_ib$ (%I (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$))))))
       (let
        ((old_metadata$ (%Poly%pmemlog!logimpl_v.HeaderView. (tuple%3./tuple%3/1 (%Poly%tuple%3.
             (Poly%tuple%3. tmp%%$)
        )))))
        (let
         ((old_data$ (%Poly%vstd!seq.Seq<u8.>. (tuple%3./tuple%3/2 (%Poly%tuple%3. (Poly%tuple%3.
         ...
         (let
          ((tmp%%$1 (pmemlog!logimpl_v.pm_to_views.? (Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.impl&%0.view.?
               Perm&. Perm& PM&. PM& wrpm!
          )))))
          (let
           ((new_pm_ib$ (%I (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$1))))))
           (let
            ((new_metadata$ (%Poly%pmemlog!logimpl_v.HeaderView. (tuple%3./tuple%3/1 (%Poly%tuple%3.
                 (Poly%tuple%3. tmp%%$1)
            )))))
            (let
             ((new_data$ (%Poly%vstd!seq.Seq<u8.>. (tuple%3./tuple%3/2 (%Poly%tuple%3. (Poly%tuple%3.
             ...
             (let
              ((new_header$ (pmemlog!logimpl_v.spec_bytes_to_header.? (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
                   $ (UINT 8) $ ALLOCATOR_GLOBAL
                  ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. new_header_bytes!)
              ))))
              (and
               (and
                (and
                 (= old_pm_ib$ new_pm_ib$)
                 (=>
                  (= old_pm_ib$ pmemlog!pmemspec_t.cdb0_val.?)
                  (and
                   (and
                    (and
                     (= (pmemlog!logimpl_v.HeaderView./HeaderView/header1 (%Poly%pmemlog!logimpl_v.HeaderView.
                        (Poly%pmemlog!logimpl_v.HeaderView. new_metadata$)
                       )
                      ) (pmemlog!logimpl_v.HeaderView./HeaderView/header1 (%Poly%pmemlog!logimpl_v.HeaderView.
                        (Poly%pmemlog!logimpl_v.HeaderView. old_metadata$)
                     )))
                     (= (pmemlog!logimpl_v.HeaderView./HeaderView/header2 (%Poly%pmemlog!logimpl_v.HeaderView.
                        (Poly%pmemlog!logimpl_v.HeaderView. new_metadata$)
                       )
                    ...
                    (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (
                       Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!)
                      ) (I (Add pmemlog!logimpl_v.header2_pos.? pmemlog!logimpl_v.header_crc_offset.?))
                      (I (Add (Add pmemlog!logimpl_v.header2_pos.? pmemlog!logimpl_v.header_crc_offset.?)
                        8
                      ))
                     ) (Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.spec_crc_bytes.? (vstd!seq.Seq.subrange.?
                        $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm&
                          PM&. PM& wrpm!
                         )
                        ) (I (Add pmemlog!logimpl_v.header2_pos.? pmemlog!logimpl_v.header_head_offset.?))
                        (I (Add pmemlog!logimpl_v.header2_pos.? pmemlog!logimpl_v.header_size.?))
                   )))))
                   (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (
                      Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!)
                ...
                (=>
                 (= old_pm_ib$ pmemlog!pmemspec_t.cdb1_val.?)
                 (and
                  (and
                   (and
                    (= (pmemlog!logimpl_v.HeaderView./HeaderView/header1 (%Poly%pmemlog!logimpl_v.HeaderView.
                   ...
                   (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (
                     ...
                     (I (Add (Add pmemlog!logimpl_v.header1_pos.? pmemlog!logimpl_v.header_crc_offset.?)
                       ...
                       ) (I (Add pmemlog!logimpl_v.header1_pos.? pmemlog!logimpl_v.header_head_offset.?))
                       (I (Add pmemlog!logimpl_v.header1_pos.? pmemlog!logimpl_v.header_size.?))
                  )))))
                  (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (
                     Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!)
   ...
   :pattern ((ens%pmemlog!logimpl_v.impl&%0.update_header. Perm&. Perm& PM&. PM& pre%self!
     self! pre%wrpm! wrpm! perm! new_header_bytes!
   ))
   :qid internal_ens__pmemlog!logimpl_v.impl&__0.update_header._definition
   :skolemid skolem_internal_ens__pmemlog!logimpl_v.impl&__0.update_header._definition
)))

;; Function-Specs pmemlog::logimpl_v::UntrustedLogImpl::untrusted_setup
(declare-fun req%pmemlog!logimpl_v.impl&%0.untrusted_setup. (Dcr Type Poly Int) Bool)
(declare-const %%global_location_label%%161 Bool)
(declare-const %%global_location_label%%162 Bool)
(assert
 (forall ((PM&. Dcr) (PM& Type) (pre%pm! Poly) (device_size! Int)) (!
   (= (req%pmemlog!logimpl_v.impl&%0.untrusted_setup. PM&. PM& pre%pm! device_size!)
    (and
     (=>
      %%global_location_label%%161
      (%B (pmemlog!pmemspec_t.PersistentMemory.inv.? PM&. PM& pre%pm!))
     )
     (=>
   ...
   :pattern ((req%pmemlog!logimpl_v.impl&%0.untrusted_setup. PM&. PM& pre%pm! device_size!))
   :qid internal_req__pmemlog!logimpl_v.impl&__0.untrusted_setup._definition
   :skolemid skolem_internal_req__pmemlog!logimpl_v.impl&__0.untrusted_setup._definition
)))
(declare-fun ens%pmemlog!logimpl_v.impl&%0.untrusted_setup. (Dcr Type Poly Poly Int
  core!result.Result.
 ) Bool
)
(assert
 (forall ((PM&. Dcr) (PM& Type) (pre%pm! Poly) (pm! Poly) (device_size! Int) (result!
    core!result.Result.
   )
  ) (!
   (= (ens%pmemlog!logimpl_v.impl&%0.untrusted_setup. PM&. PM& pre%pm! pm! device_size!
     result!
    ) (and
     (has_type (Poly%core!result.Result. result!) (TYPE%core!result.Result. $ (UINT 64)
       $ TYPE%pmemlog!main_t.InfiniteLogErr.
     ...
     (has_type pm! PM&)
     (%B (pmemlog!pmemspec_t.PersistentMemory.inv.? PM&. PM& pm!))
     (= (pmemlog!pmemspec_t.PersistentMemory.constants.? PM&. PM& pm!) (pmemlog!pmemspec_t.PersistentMemory.constants.?
       PM&. PM& pre%pm!
     ))
     (= (vstd!seq.Seq.len.? $ (UINT 8) (pmemlog!pmemspec_t.PersistentMemory.view.? PM&. PM&
        pm!
     ...
     (ite
      (is-core!result.Result./Ok result!)
      (let
       ((capacity$ (%I (core!result.Result./Ok/0 $ (UINT 64) $ TYPE%pmemlog!main_t.InfiniteLogErr.
           (%Poly%core!result.Result. (Poly%core!result.Result. result!))
       ))))
       (= (pmemlog!logimpl_v.impl&%0.recover.? (pmemlog!pmemspec_t.PersistentMemory.view.?
          PM&. PM& pm!
         )
        ) (core!option.Option./Some (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (
           pmemlog!infinitelog_t.impl&%0.initialize.? (I capacity$)
      )))))
      (and
       (and
        (is-core!result.Result./Err result!)
        (is-pmemlog!main_t.InfiniteLogErr./InsufficientSpaceForSetup (%Poly%pmemlog!main_t.InfiniteLogErr.
          (core!result.Result./Err/0 $ (UINT 64) $ TYPE%pmemlog!main_t.InfiniteLogErr. (%Poly%core!result.Result.
            (Poly%core!result.Result. result!)
       )))))
       (let
        ((required_space$ (pmemlog!main_t.InfiniteLogErr./InsufficientSpaceForSetup/required_space
           (%Poly%pmemlog!main_t.InfiniteLogErr. (core!result.Result./Err/0 $ (UINT 64) $ TYPE%pmemlog!main_t.InfiniteLogErr.
             (%Poly%core!result.Result. (Poly%core!result.Result. result!))
        )))))
        (< device_size! required_space$)
   )))))
   :pattern ((ens%pmemlog!logimpl_v.impl&%0.untrusted_setup. PM&. PM& pre%pm! pm! device_size!
     result!
   ))
   :qid internal_ens__pmemlog!logimpl_v.impl&__0.untrusted_setup._definition
   :skolemid skolem_internal_ens__pmemlog!logimpl_v.impl&__0.untrusted_setup._definition
)))

;; Function-Specs pmemlog::pmemspec_t::WriteRestrictedPersistentMemory::get_pm_ref
(declare-fun req%pmemlog!pmemspec_t.impl&%0.get_pm_ref. (Dcr Type Dcr Type Poly) Bool)
(declare-const %%global_location_label%%163 Bool)
(assert
 (forall ((Perm&. Dcr) (Perm& Type) (PM&. Dcr) (PM& Type) (self! Poly)) (!
   (= (req%pmemlog!pmemspec_t.impl&%0.get_pm_ref. Perm&. Perm& PM&. PM& self!) (=>
     %%global_location_label%%163
     (pmemlog!pmemspec_t.impl&%0.inv.? Perm&. Perm& PM&. PM& self!)
   ))
   :pattern ((req%pmemlog!pmemspec_t.impl&%0.get_pm_ref. Perm&. Perm& PM&. PM& self!))
   :qid internal_req__pmemlog!pmemspec_t.impl&__0.get_pm_ref._definition
   :skolemid skolem_internal_req__pmemlog!pmemspec_t.impl&__0.get_pm_ref._definition
)))
(declare-fun ens%pmemlog!pmemspec_t.impl&%0.get_pm_ref. (Dcr Type Dcr Type Poly Poly)
 Bool
)
(assert
 (forall ((Perm&. Dcr) (Perm& Type) (PM&. Dcr) (PM& Type) (self! Poly) (pm! Poly))
  (!
   (= (ens%pmemlog!pmemspec_t.impl&%0.get_pm_ref. Perm&. Perm& PM&. PM& self! pm!) (and
     (has_type pm! PM&)
     (%B (pmemlog!pmemspec_t.PersistentMemory.inv.? PM&. PM& pm!))
     (= (%Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.PersistentMemory.view.? PM&. PM& pm!))
      (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& self!)
     )
     (= (%Poly%pmemlog!pmemspec_t.PersistentMemoryConstants. (pmemlog!pmemspec_t.PersistentMemory.constants.?
        PM&. PM& pm!
       )
      ) (pmemlog!pmemspec_t.impl&%0.constants.? Perm&. Perm& PM&. PM& self!)
   )))
   :pattern ((ens%pmemlog!pmemspec_t.impl&%0.get_pm_ref. Perm&. Perm& PM&. PM& self! pm!))
   :qid internal_ens__pmemlog!pmemspec_t.impl&__0.get_pm_ref._definition
   :skolemid skolem_internal_ens__pmemlog!pmemspec_t.impl&__0.get_pm_ref._definition
)))

;; Function-Specs pmemlog::logimpl_v::UntrustedLogImpl::untrusted_start
(declare-fun req%pmemlog!logimpl_v.impl&%0.untrusted_start. (Dcr Type Dcr Type Poly
  Int Poly
 ) Bool
)
...
(assert
 (forall ((Perm&. Dcr) (Perm& Type) (PM&. Dcr) (PM& Type) (pre%wrpm! Poly) (device_size!
    Int
   ) (perm! Poly)
  ) (!
   (= (req%pmemlog!logimpl_v.impl&%0.untrusted_start. Perm&. Perm& PM&. PM& pre%wrpm!
     device_size! perm!
    ) (and
     (=>
     ...
     (=>
      ...
      (pmemlog!pmemspec_t.impl&%0.inv.? Perm&. Perm& PM&. PM& pre%wrpm!)
     )
     (=>
     ...
     (=>
      ...
      (let
       ((tmp%%$ (Add pmemlog!logimpl_v.header_crc_offset.? pmemlog!pmemspec_t.crc_size.?)))
       (let
        ((tmp%%$1 pmemlog!logimpl_v.header_head_offset.?))
        (let
         ((tmp%%$2 pmemlog!logimpl_v.header_tail_offset.?))
         (and
          (and
           (and
            (< pmemlog!logimpl_v.header_crc_offset.? tmp%%$)
            (<= tmp%%$ tmp%%$1)
           )
           (< tmp%%$1 tmp%%$2)
          )
          (< tmp%%$2 pmemlog!logimpl_v.header_log_size_offset.?)
     )))))
     (=>
      ...
      (forall ((pm_state$ Poly)) (!
        (=>
         ...
         (= (%B (pmemlog!sccf.CheckPermission.check_permission.? Perm&. Perm& $ (TYPE%vstd!seq.Seq.
          ...
          ) (= (pmemlog!logimpl_v.impl&%0.recover.? pm_state$) (pmemlog!logimpl_v.impl&%0.recover.?
            (Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& pre%wrpm!))
        ))))
        :pattern ((pmemlog!sccf.CheckPermission.check_permission.? Perm&. Perm& $ (TYPE%vstd!seq.Seq.
           $ (UINT 8)
        ...
        :qid user_pmemlog__logimpl_v__UntrustedLogImpl__untrusted_start_61
        :skolemid skolem_user_pmemlog__logimpl_v__UntrustedLogImpl__untrusted_start_61
   )))))
   :pattern ((req%pmemlog!logimpl_v.impl&%0.untrusted_start. Perm&. Perm& PM&. PM& pre%wrpm!
     device_size! perm!
   ))
   :qid internal_req__pmemlog!logimpl_v.impl&__0.untrusted_start._definition
   :skolemid skolem_internal_req__pmemlog!logimpl_v.impl&__0.untrusted_start._definition
)))
(declare-fun ens%pmemlog!logimpl_v.impl&%0.untrusted_start. (Dcr Type Dcr Type Poly
  Poly Int Poly core!result.Result.
 ) Bool
)
(assert
 (forall ((Perm&. Dcr) (Perm& Type) (PM&. Dcr) (PM& Type) (pre%wrpm! Poly) (wrpm! Poly)
   (device_size! Int) (perm! Poly) (result! core!result.Result.)
  ) (!
   (= (ens%pmemlog!logimpl_v.impl&%0.untrusted_start. Perm&. Perm& PM&. PM& pre%wrpm!
     wrpm! device_size! perm! result!
    ) (and
     (has_type (Poly%core!result.Result. result!) (TYPE%core!result.Result. $ TYPE%pmemlog!logimpl_v.UntrustedLogImpl.
       $ TYPE%pmemlog!main_t.InfiniteLogErr.
     ))
     (has_type wrpm! (TYPE%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. Perm&. Perm&
       PM&. PM&
     ))
     (= (pmemlog!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.impl&%0.view.?
         Perm&. Perm& PM&. PM& pre%wrpm!
       ))
      ) (pmemlog!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.impl&%0.view.?
         Perm&. Perm& PM&. PM& wrpm!
     ...
     (ite
      (is-core!result.Result./Ok result!)
      (let
       ((log_impl$ (%Poly%pmemlog!logimpl_v.UntrustedLogImpl. (core!result.Result./Ok/0 $ TYPE%pmemlog!logimpl_v.UntrustedLogImpl.
           $ TYPE%pmemlog!main_t.InfiniteLogErr. (%Poly%core!result.Result. (Poly%core!result.Result.
             result!
       ))))))
       (pmemlog!logimpl_v.impl&%0.inv.? Perm&. Perm& PM&. PM& (Poly%pmemlog!logimpl_v.UntrustedLogImpl.
         log_impl$
      ...
      (and
       (and
        (is-core!result.Result./Err result!)
        (is-pmemlog!main_t.InfiniteLogErr./CRCMismatch (%Poly%pmemlog!main_t.InfiniteLogErr.
          (core!result.Result./Err/0 $ TYPE%pmemlog!logimpl_v.UntrustedLogImpl. $ TYPE%pmemlog!main_t.InfiniteLogErr.
           (%Poly%core!result.Result. (Poly%core!result.Result. result!))
       ))))
       (not (pmemlog!pmemspec_t.PersistentMemoryConstants./PersistentMemoryConstants/impervious_to_corruption
         (%Poly%pmemlog!pmemspec_t.PersistentMemoryConstants. (Poly%pmemlog!pmemspec_t.PersistentMemoryConstants.
           (pmemlog!pmemspec_t.impl&%0.constants.? Perm&. Perm& PM&. PM& wrpm!)
   ))))))))
   :pattern ((ens%pmemlog!logimpl_v.impl&%0.untrusted_start. Perm&. Perm& PM&. PM& pre%wrpm!
     wrpm! device_size! perm! result!
   ))
   :qid internal_ens__pmemlog!logimpl_v.impl&__0.untrusted_start._definition
   :skolemid skolem_internal_ens__pmemlog!logimpl_v.impl&__0.untrusted_start._definition
)))

;; Function-Specs pmemlog::logimpl_v::UntrustedLogImpl::append_wrap
(declare-fun req%pmemlog!logimpl_v.impl&%0.append_wrap. (Dcr Type Dcr Type pmemlog!logimpl_v.UntrustedLogImpl.
  Poly alloc!vec.Vec<u8./allocator_global%.>. pmemlog!logimpl_v.PersistentHeaderMetadata.
  Poly
 ) Bool
)
...
(assert
 (forall ((Perm&. Dcr) (Perm& Type) (PM&. Dcr) (PM& Type) (pre%self! pmemlog!logimpl_v.UntrustedLogImpl.)
   (pre%wrpm! Poly) (bytes_to_append! alloc!vec.Vec<u8./allocator_global%.>.) (old_header!
    pmemlog!logimpl_v.PersistentHeaderMetadata.
   ) (perm! Poly)
  ) (!
   (= (req%pmemlog!logimpl_v.impl&%0.append_wrap. Perm&. Perm& PM&. PM& pre%self! pre%wrpm!
     bytes_to_append! old_header! perm!
    ) (and
     (=>
     ...
     (=>
      ...
      (= old_header! (pmemlog!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%pmemlog!logimpl_v.PersistentHeader.
         (Poly%pmemlog!logimpl_v.PersistentHeader. (pmemlog!logimpl_v.spec_get_live_header.?
           (Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& pre%wrpm!))
     ))))))
     (=>
       ...
       (let
        ...
        (let
         ...
         (and
          (and
           (and
            (< pmemlog!logimpl_v.contents_offset.? physical_head$)
            (>= (Add physical_tail$ (vstd!seq.Seq.len.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
                 $ (UINT 8) $ ALLOCATOR_GLOBAL
          ...
          (<= (vstd!seq.Seq.len.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT
           ...
           ) (Sub (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/log_size
             (%Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
               old_header!
             ))
            ) (Sub (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/tail (
               ...
               (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. old_header!)
   ))))))))))))
   :pattern ((req%pmemlog!logimpl_v.impl&%0.append_wrap. Perm&. Perm& PM&. PM& pre%self!
     pre%wrpm! bytes_to_append! old_header! perm!
   ))
   :qid internal_req__pmemlog!logimpl_v.impl&__0.append_wrap._definition
   :skolemid skolem_internal_req__pmemlog!logimpl_v.impl&__0.append_wrap._definition
)))
(declare-fun ens%pmemlog!logimpl_v.impl&%0.append_wrap. (Dcr Type Dcr Type pmemlog!logimpl_v.UntrustedLogImpl.
  pmemlog!logimpl_v.UntrustedLogImpl. Poly Poly alloc!vec.Vec<u8./allocator_global%.>.
  pmemlog!logimpl_v.PersistentHeaderMetadata. Poly
 ) Bool
)
(assert
 (forall ((Perm&. Dcr) (Perm& Type) (PM&. Dcr) (PM& Type) (pre%self! pmemlog!logimpl_v.UntrustedLogImpl.)
   (self! pmemlog!logimpl_v.UntrustedLogImpl.) (pre%wrpm! Poly) (wrpm! Poly) (bytes_to_append!
    alloc!vec.Vec<u8./allocator_global%.>.
   ) (old_header! pmemlog!logimpl_v.PersistentHeaderMetadata.) (perm! Poly)
  ) (!
   (= (ens%pmemlog!logimpl_v.impl&%0.append_wrap. Perm&. Perm& PM&. PM& pre%self! self!
     pre%wrpm! wrpm! bytes_to_append! old_header! perm!
    ) (and
     (has_type (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!) TYPE%pmemlog!logimpl_v.UntrustedLogImpl.)
     (has_type wrpm! (TYPE%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. Perm&. Perm&
       PM&. PM&
             ...
             (let
              ...
              (let
               ...
               (let
                ((len1$ (Sub contents_end$ physical_tail$)))
                (let
                 ((len2$ (Sub (vstd!seq.Seq.len.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
                       $ (UINT 8) $ ALLOCATOR_GLOBAL
                      ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. bytes_to_append!)
                     )
                    ) len1$
                  ...
                  (and
                   (and
                    (and
                     ...
                     (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (
                        Poly%vstd!seq.Seq<u8.>. new_data$
                       ) (I (Sub physical_tail$ pmemlog!logimpl_v.contents_offset.?)) (I (Sub contents_end$
                         pmemlog!logimpl_v.contents_offset.?
                       ))
                      ) (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
                         $ (UINT 8) $ ALLOCATOR_GLOBAL
                        ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. bytes_to_append!)
                       ) (I 0) (I len1$)
                    )))
                    (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (
                      ...
                      ) (I len1$) (I (vstd!seq.Seq.len.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
                          $ (UINT 8) $ ALLOCATOR_GLOBAL
                         ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. bytes_to_append!)
                   ))))))
                   (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (
                      Poly%vstd!seq.Seq<u8.>. new_data$
                     ) (I len2$) (I (Sub physical_tail$ pmemlog!logimpl_v.contents_offset.?))
                    ) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. old_data$) (I len2$)
                     (I (Sub physical_tail$ pmemlog!logimpl_v.contents_offset.?))
                  )))
   ...
   :pattern ((ens%pmemlog!logimpl_v.impl&%0.append_wrap. Perm&. Perm& PM&. PM& pre%self!
     self! pre%wrpm! wrpm! bytes_to_append! old_header! perm!
   ))
   :qid internal_ens__pmemlog!logimpl_v.impl&__0.append_wrap._definition
   :skolemid skolem_internal_ens__pmemlog!logimpl_v.impl&__0.append_wrap._definition
)))

;; Function-Specs pmemlog::logimpl_v::UntrustedLogImpl::append_no_wrap
(declare-fun req%pmemlog!logimpl_v.impl&%0.append_no_wrap. (Dcr Type Dcr Type pmemlog!logimpl_v.UntrustedLogImpl.
  Poly alloc!vec.Vec<u8./allocator_global%.>. pmemlog!logimpl_v.PersistentHeaderMetadata.
  Poly
 ) Bool
)
...
(assert
 (forall ((Perm&. Dcr) (Perm& Type) (PM&. Dcr) (PM& Type) (pre%self! pmemlog!logimpl_v.UntrustedLogImpl.)
   ...
   (= (req%pmemlog!logimpl_v.impl&%0.append_no_wrap. Perm&. Perm& PM&. PM& pre%self! pre%wrpm!
     bytes_to_append! old_header! perm!
    ) (and
     (=>
        ...
        (let
         ...
         (and
          ...
          (=>
           (< physical_tail$ physical_head$)
           (let
            ((tmp%%$ (Add physical_tail$ (vstd!seq.Seq.len.? $ (UINT 8) (vstd!view.View.view.? $ (
   ...
   :pattern ((req%pmemlog!logimpl_v.impl&%0.append_no_wrap. Perm&. Perm& PM&. PM& pre%self!
     pre%wrpm! bytes_to_append! old_header! perm!
   ))
   :qid internal_req__pmemlog!logimpl_v.impl&__0.append_no_wrap._definition
   :skolemid skolem_internal_req__pmemlog!logimpl_v.impl&__0.append_no_wrap._definition
)))
(declare-fun ens%pmemlog!logimpl_v.impl&%0.append_no_wrap. (Dcr Type Dcr Type pmemlog!logimpl_v.UntrustedLogImpl.
  pmemlog!logimpl_v.UntrustedLogImpl. Poly Poly alloc!vec.Vec<u8./allocator_global%.>.
  pmemlog!logimpl_v.PersistentHeaderMetadata. Poly
 ) Bool
)
(assert
 (forall ((Perm&. Dcr) (Perm& Type) (PM&. Dcr) (PM& Type) (pre%self! pmemlog!logimpl_v.UntrustedLogImpl.)
   ...
   (= (ens%pmemlog!logimpl_v.impl&%0.append_no_wrap. Perm&. Perm& PM&. PM& pre%self! self!
     pre%wrpm! wrpm! bytes_to_append! old_header! perm!
    ) (and
     (has_type (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!) TYPE%pmemlog!logimpl_v.UntrustedLogImpl.)
     (has_type wrpm! (TYPE%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. Perm&. Perm&
              ...
              (and
               (and
                (and
                 ...
                 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (
                    Poly%vstd!seq.Seq<u8.>. new_data$
                   ) (I (Sub physical_tail$ pmemlog!logimpl_v.contents_offset.?)) (I (Add (Sub physical_tail$
                      pmemlog!logimpl_v.contents_offset.?
                     ) (vstd!seq.Seq.len.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT
                         8
                        ) $ ALLOCATOR_GLOBAL
               ...
               (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (
                  Poly%vstd!seq.Seq<u8.>. new_data$
                 ) (I (Add (Sub physical_tail$ pmemlog!logimpl_v.contents_offset.?) (vstd!seq.Seq.len.?
                    $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL)
                     (Poly%alloc!vec.Vec<u8./allocator_global%.>. bytes_to_append!)
                  )))
                 ) (I (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. new_data$)))
                ) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. old_data$) (I (Add (Sub
                    physical_tail$ pmemlog!logimpl_v.contents_offset.?
                   ) (vstd!seq.Seq.len.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT
                       8
                      ) $ ALLOCATOR_GLOBAL
                     ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. bytes_to_append!)
   ...
   :pattern ((ens%pmemlog!logimpl_v.impl&%0.append_no_wrap. Perm&. Perm& PM&. PM& pre%self!
     self! pre%wrpm! wrpm! bytes_to_append! old_header! perm!
   ))
   :qid internal_ens__pmemlog!logimpl_v.impl&__0.append_no_wrap._definition
   :skolemid skolem_internal_ens__pmemlog!logimpl_v.impl&__0.append_no_wrap._definition
)))

;; Function-Specs pmemlog::logimpl_v::UntrustedLogImpl::untrusted_append
(declare-fun req%pmemlog!logimpl_v.impl&%0.untrusted_append. (Dcr Type Dcr Type pmemlog!logimpl_v.UntrustedLogImpl.
  Poly alloc!vec.Vec<u8./allocator_global%.>. Poly
 ) Bool
)
...
(assert
 (forall ((Perm&. Dcr) (Perm& Type) (PM&. Dcr) (PM& Type) (pre%self! pmemlog!logimpl_v.UntrustedLogImpl.)
   (pre%wrpm! Poly) (bytes_to_append! alloc!vec.Vec<u8./allocator_global%.>.) (perm!
    Poly
   )
  ) (!
   (= (req%pmemlog!logimpl_v.impl&%0.untrusted_append. Perm&. Perm& PM&. PM& pre%self!
     pre%wrpm! bytes_to_append! perm!
    ) (and
     (=>
     ...
     (=>
      ...
      (let
       ((old_log_state$ (pmemlog!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.impl&%0.view.?
            Perm&. Perm& PM&. PM& pre%wrpm!
       )))))
       (forall ((pm_state$ Poly)) (!
         (=>
         ...
         :qid user_pmemlog__logimpl_v__UntrustedLogImpl__untrusted_append_63
         :skolemid skolem_user_pmemlog__logimpl_v__UntrustedLogImpl__untrusted_append_63
   ))))))
   :pattern ((req%pmemlog!logimpl_v.impl&%0.untrusted_append. Perm&. Perm& PM&. PM& pre%self!
     pre%wrpm! bytes_to_append! perm!
   ))
   :qid internal_req__pmemlog!logimpl_v.impl&__0.untrusted_append._definition
   :skolemid skolem_internal_req__pmemlog!logimpl_v.impl&__0.untrusted_append._definition
)))
(declare-fun ens%pmemlog!logimpl_v.impl&%0.untrusted_append. (Dcr Type Dcr Type pmemlog!logimpl_v.UntrustedLogImpl.
  pmemlog!logimpl_v.UntrustedLogImpl. Poly Poly alloc!vec.Vec<u8./allocator_global%.>.
...
(assert
 (forall ((Perm&. Dcr) (Perm& Type) (PM&. Dcr) (PM& Type) (pre%self! pmemlog!logimpl_v.UntrustedLogImpl.)
   (self! pmemlog!logimpl_v.UntrustedLogImpl.) (pre%wrpm! Poly) (wrpm! Poly) (bytes_to_append!
    alloc!vec.Vec<u8./allocator_global%.>.
   ) (perm! Poly) (result! core!result.Result.)
  ) (!
   (= (ens%pmemlog!logimpl_v.impl&%0.untrusted_append. Perm&. Perm& PM&. PM& pre%self!
     self! pre%wrpm! wrpm! bytes_to_append! perm! result!
    ) (and
     (has_type (Poly%core!result.Result. result!) (TYPE%core!result.Result. $ (UINT 64)
       $ TYPE%pmemlog!main_t.InfiniteLogErr.
     ))
     ...
     (let
      ...
      (let
       ((new_log_state$ (pmemlog!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.impl&%0.view.?
            Perm&. Perm& PM&. PM& wrpm!
       )))))
       (let
        ((tmp%%$ (tuple%3./tuple%3 (Poly%core!result.Result. result!) (Poly%core!option.Option.
            old_log_state$
           ) (Poly%core!option.Option. new_log_state$)
        )))
        (ite
         (and
          (and
           (and
            (is-tuple%3./tuple%3 tmp%%$)
            (is-core!result.Result./Ok (%Poly%core!result.Result. (tuple%3./tuple%3/0 (%Poly%tuple%3.
                (Poly%tuple%3. tmp%%$)
           )))))
           (is-core!option.Option./Some (%Poly%core!option.Option. (tuple%3./tuple%3/1 (%Poly%tuple%3.
               (Poly%tuple%3. tmp%%$)
          )))))
          (is-core!option.Option./Some (%Poly%core!option.Option. (tuple%3./tuple%3/2 (%Poly%tuple%3.
              (Poly%tuple%3. tmp%%$)
         )))))
         (let
          ((offset$ (%I (core!result.Result./Ok/0 $ (UINT 64) $ TYPE%pmemlog!main_t.InfiniteLogErr.
              (%Poly%core!result.Result. (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$))))
          ))))
          (let
           ((old_log_state$1 (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (core!option.Option./Some/0
               $ TYPE%pmemlog!infinitelog_t.AbstractInfiniteLogState. (%Poly%core!option.Option.
           ...
           (let
            ...
            (and
             (= offset$ (Add (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (pmemlog!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/log
                  (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
                    old_log_state$1
                ))))
               ) (pmemlog!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/head (
             ...
             (= new_log_state$1 (pmemlog!infinitelog_t.impl&%0.append.? (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
                old_log_state$1
               ) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>.
                 bytes_to_append!
         ))))))))
         (and
          (and
           (is-tuple%3./tuple%3 tmp%%$)
           (and
            (is-core!result.Result./Err (%Poly%core!result.Result. (tuple%3./tuple%3/0 (%Poly%tuple%3.
                (Poly%tuple%3. tmp%%$)
            ))))
            (is-pmemlog!main_t.InfiniteLogErr./InsufficientSpaceForAppend (%Poly%pmemlog!main_t.InfiniteLogErr.
              (core!result.Result./Err/0 $ (UINT 64) $ TYPE%pmemlog!main_t.InfiniteLogErr. (%Poly%core!result.Result.
                (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))
          ))))))
          (let
           ((available_space$ (pmemlog!main_t.InfiniteLogErr./InsufficientSpaceForAppend/available_space
              (%Poly%pmemlog!main_t.InfiniteLogErr. (core!result.Result./Err/0 $ (UINT 64) $ TYPE%pmemlog!main_t.InfiniteLogErr.
                (%Poly%core!result.Result. (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$))))
           )))))
           (and
            (and
             ...
             (< available_space$ (vstd!seq.Seq.len.? $ (UINT 8) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
                 $ (UINT 8) $ ALLOCATOR_GLOBAL
                ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. bytes_to_append!)
            ))))
            (let
             ((log$ (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (core!option.Option./Some/0
                 $ TYPE%pmemlog!infinitelog_t.AbstractInfiniteLogState. (%Poly%core!option.Option.
                  (Poly%core!option.Option. old_log_state$)
             )))))
             (or
              (= available_space$ (Sub (pmemlog!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/capacity
                 (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
                   log$
                 ))
                ) (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (pmemlog!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/log
              ...
              (= available_space$ (Sub (Sub 18446744073709551615 (pmemlog!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/head
                  (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
                    log$
                 )))
                ) (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (pmemlog!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/log
   ...
   :pattern ((ens%pmemlog!logimpl_v.impl&%0.untrusted_append. Perm&. Perm& PM&. PM& pre%self!
     self! pre%wrpm! wrpm! bytes_to_append! perm! result!
   ))
   :qid internal_ens__pmemlog!logimpl_v.impl&__0.untrusted_append._definition
   :skolemid skolem_internal_ens__pmemlog!logimpl_v.impl&__0.untrusted_append._definition
)))

;; Function-Specs pmemlog::logimpl_v::UntrustedLogImpl::untrusted_advance_head
(declare-fun req%pmemlog!logimpl_v.impl&%0.untrusted_advance_head. (Dcr Type Dcr Type
  pmemlog!logimpl_v.UntrustedLogImpl. Poly Int Poly
 ) Bool
)
...
(assert
 (forall ((Perm&. Dcr) (Perm& Type) (PM&. Dcr) (PM& Type) (pre%self! pmemlog!logimpl_v.UntrustedLogImpl.)
   (pre%wrpm! Poly) (new_head! Int) (perm! Poly)
  ) (!
   (= (req%pmemlog!logimpl_v.impl&%0.untrusted_advance_head. Perm&. Perm& PM&. PM& pre%self!
     pre%wrpm! new_head! perm!
    ) (and
     (=>
     ...
     (=>
      ...
      (let
       ...
       (forall ((pm_state$ Poly)) (!
         (=>
          ...
          (= (%B (pmemlog!sccf.CheckPermission.check_permission.? Perm&. Perm& $ (TYPE%vstd!seq.Seq.
            ...
            (or
             (= log_state$ old_log_state$)
             (= log_state$ (core!option.Option./Some (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
                (pmemlog!infinitelog_t.impl&%0.advance_head.? (core!option.Option./Some/0 $ TYPE%pmemlog!infinitelog_t.AbstractInfiniteLogState.
                  (%Poly%core!option.Option. (Poly%core!option.Option. old_log_state$))
                 ) (I new_head!)
         ))))))))
         :pattern ((pmemlog!sccf.CheckPermission.check_permission.? Perm&. Perm& $ (TYPE%vstd!seq.Seq.
         ...
         :qid user_pmemlog__logimpl_v__UntrustedLogImpl__untrusted_advance_head_65
         :skolemid skolem_user_pmemlog__logimpl_v__UntrustedLogImpl__untrusted_advance_head_65
   ))))))
   :pattern ((req%pmemlog!logimpl_v.impl&%0.untrusted_advance_head. Perm&. Perm& PM&.
     PM& pre%self! pre%wrpm! new_head! perm!
   ))
   :qid internal_req__pmemlog!logimpl_v.impl&__0.untrusted_advance_head._definition
   :skolemid skolem_internal_req__pmemlog!logimpl_v.impl&__0.untrusted_advance_head._definition
)))
(declare-fun ens%pmemlog!logimpl_v.impl&%0.untrusted_advance_head. (Dcr Type Dcr Type
  pmemlog!logimpl_v.UntrustedLogImpl. pmemlog!logimpl_v.UntrustedLogImpl. Poly Poly
  Int Poly core!result.Result.
 ) Bool
)
(assert
 (forall ((Perm&. Dcr) (Perm& Type) (PM&. Dcr) (PM& Type) (pre%self! pmemlog!logimpl_v.UntrustedLogImpl.)
   (self! pmemlog!logimpl_v.UntrustedLogImpl.) (pre%wrpm! Poly) (wrpm! Poly) (new_head!
    Int
   ) (perm! Poly) (result! core!result.Result.)
  ) (!
   (= (ens%pmemlog!logimpl_v.impl&%0.untrusted_advance_head. Perm&. Perm& PM&. PM& pre%self!
     self! pre%wrpm! wrpm! new_head! perm! result!
    ) (and
           ...
           (and
            (let
             ...
             (and
              ...
              (<= tmp%%$1 (Add (pmemlog!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/head
                 (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
                   old_log_state$1
                 ))
                ) (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (pmemlog!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/log
            ...
            (= new_log_state$1 (pmemlog!infinitelog_t.impl&%0.advance_head.? (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
               old_log_state$1
              ) (I new_head!)
         )))))
         (ite
           ...
           (and
            (and
             ...
             (and
              ...
              (is-pmemlog!main_t.InfiniteLogErr./CantAdvanceHeadPositionBeforeHead (%Poly%pmemlog!main_t.InfiniteLogErr.
                (core!result.Result./Err/0 $ TYPE%tuple%0. $ TYPE%pmemlog!main_t.InfiniteLogErr. (
                  %Poly%core!result.Result. (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))
            ))))))
            (is-core!option.Option./Some (%Poly%core!option.Option. (tuple%3./tuple%3/1 (%Poly%tuple%3.
                (Poly%tuple%3. tmp%%$)
          ...
          (let
           ((head$ (pmemlog!main_t.InfiniteLogErr./CantAdvanceHeadPositionBeforeHead/head (%Poly%pmemlog!main_t.InfiniteLogErr.
               (core!result.Result./Err/0 $ TYPE%tuple%0. $ TYPE%pmemlog!main_t.InfiniteLogErr. (
                 %Poly%core!result.Result. (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))
           ))))))
           (let
            ((old_log_state$2 (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (core!option.Option./Some/0
                $ TYPE%pmemlog!infinitelog_t.AbstractInfiniteLogState. (%Poly%core!option.Option.
                 (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))
            )))))
            (let
             ((new_log_state$2 (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (core!option.Option./Some/0
                 $ TYPE%pmemlog!infinitelog_t.AbstractInfiniteLogState. (%Poly%core!option.Option.
                  (tuple%3./tuple%3/2 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))
             )))))
             (and
              (and
               (= new_log_state$2 old_log_state$2)
               (= head$ (pmemlog!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/head
                 (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
                   old_log_state$2
              )))))
              (< new_head! head$)
          ...
          (and
            ...
            (and
             (and
              ...
              (and
               ...
               (is-pmemlog!main_t.InfiniteLogErr./CantAdvanceHeadPositionBeyondTail (%Poly%pmemlog!main_t.InfiniteLogErr.
                 (core!result.Result./Err/0 $ TYPE%tuple%0. $ TYPE%pmemlog!main_t.InfiniteLogErr. (
                   %Poly%core!result.Result. (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))
             ))))))
             (is-core!option.Option./Some (%Poly%core!option.Option. (tuple%3./tuple%3/1 (%Poly%tuple%3.
           ...
           (let
            ((tail$ (pmemlog!main_t.InfiniteLogErr./CantAdvanceHeadPositionBeyondTail/tail (%Poly%pmemlog!main_t.InfiniteLogErr.
                (core!result.Result./Err/0 $ TYPE%tuple%0. $ TYPE%pmemlog!main_t.InfiniteLogErr. (
                  %Poly%core!result.Result. (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))
            ))))))
            (let
             ((old_log_state$3 (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (core!option.Option./Some/0
                 $ TYPE%pmemlog!infinitelog_t.AbstractInfiniteLogState. (%Poly%core!option.Option.
                  (tuple%3./tuple%3/1 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))
             )))))
             (let
              ((new_log_state$3 (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (core!option.Option./Some/0
                  $ TYPE%pmemlog!infinitelog_t.AbstractInfiniteLogState. (%Poly%core!option.Option.
                   (tuple%3./tuple%3/2 (%Poly%tuple%3. (Poly%tuple%3. tmp%%$)))
              )))))
              (and
               (and
                (= new_log_state$3 old_log_state$3)
                (= tail$ (Add (pmemlog!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/head
                   (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
                     old_log_state$3
                   ))
                  ) (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (pmemlog!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/log
   ...
   :pattern ((ens%pmemlog!logimpl_v.impl&%0.untrusted_advance_head. Perm&. Perm& PM&.
     PM& pre%self! self! pre%wrpm! wrpm! new_head! perm! result!
   ))
   :qid internal_ens__pmemlog!logimpl_v.impl&__0.untrusted_advance_head._definition
   :skolemid skolem_internal_ens__pmemlog!logimpl_v.impl&__0.untrusted_advance_head._definition
)))

;; Function-Specs pmemlog::math_v::lemma_mod_between
(declare-fun req%pmemlog!math_v.lemma_mod_between. (Int Int Int Int) Bool)
...
(assert
 (forall ((d! Int) (x! Int) (y! Int) (z! Int)) (!
   (= (req%pmemlog!math_v.lemma_mod_between. d! x! y! z!) (and
     (=>
   ...
   :pattern ((req%pmemlog!math_v.lemma_mod_between. d! x! y! z!))
   :qid internal_req__pmemlog!math_v.lemma_mod_between._definition
   :skolemid skolem_internal_req__pmemlog!math_v.lemma_mod_between._definition
)))
(declare-fun ens%pmemlog!math_v.lemma_mod_between. (Int Int Int Int) Bool)
(assert
 (forall ((d! Int) (x! Int) (y! Int) (z! Int)) (!
   (= (ens%pmemlog!math_v.lemma_mod_between. d! x! y! z!) (let
     ((tmp%%$ (EucMod z! d!)))
     (and
      (<= (EucMod x! d!) tmp%%$)
      (<= tmp%%$ (EucMod y! d!))
   )))
   :pattern ((ens%pmemlog!math_v.lemma_mod_between. d! x! y! z!))
   :qid internal_ens__pmemlog!math_v.lemma_mod_between._definition
   :skolemid skolem_internal_ens__pmemlog!math_v.lemma_mod_between._definition
)))

;; Function-Specs pmemlog::math_v::lemma_mod_not_between
(declare-fun req%pmemlog!math_v.lemma_mod_not_between. (Int Int Int Int) Bool)
...
(assert
 (forall ((d! Int) (x! Int) (y! Int) (z! Int)) (!
   (= (req%pmemlog!math_v.lemma_mod_not_between. d! x! y! z!) (and
     (=>
   ...
   :pattern ((req%pmemlog!math_v.lemma_mod_not_between. d! x! y! z!))
   :qid internal_req__pmemlog!math_v.lemma_mod_not_between._definition
   :skolemid skolem_internal_req__pmemlog!math_v.lemma_mod_not_between._definition
)))
(declare-fun ens%pmemlog!math_v.lemma_mod_not_between. (Int Int Int Int) Bool)
(assert
 (forall ((d! Int) (x! Int) (y! Int) (z! Int)) (!
   (= (ens%pmemlog!math_v.lemma_mod_not_between. d! x! y! z!) (or
     (<= (EucMod z! d!) (EucMod y! d!))
     (>= (EucMod z! d!) (EucMod x! d!))
   ))
   :pattern ((ens%pmemlog!math_v.lemma_mod_not_between. d! x! y! z!))
   :qid internal_ens__pmemlog!math_v.lemma_mod_not_between._definition
   :skolemid skolem_internal_ens__pmemlog!math_v.lemma_mod_not_between._definition
)))

;; Function-Specs pmemlog::logimpl_v::UntrustedLogImpl::untrusted_read
(declare-fun req%pmemlog!logimpl_v.impl&%0.untrusted_read. (Dcr Type Dcr Type pmemlog!logimpl_v.UntrustedLogImpl.
  Poly Int Int
 ) Bool
)
...
(assert
 (forall ((Perm&. Dcr) (Perm& Type) (PM&. Dcr) (PM& Type) (self! pmemlog!logimpl_v.UntrustedLogImpl.)
   (wrpm! Poly) (pos! Int) (len! Int)
  ) (!
   (= (req%pmemlog!logimpl_v.impl&%0.untrusted_read. Perm&. Perm& PM&. PM& self! wrpm!
     pos! len!
    ) (and
     (=>
   ...
   :pattern ((req%pmemlog!logimpl_v.impl&%0.untrusted_read. Perm&. Perm& PM&. PM& self!
     wrpm! pos! len!
   ))
   :qid internal_req__pmemlog!logimpl_v.impl&__0.untrusted_read._definition
   :skolemid skolem_internal_req__pmemlog!logimpl_v.impl&__0.untrusted_read._definition
)))
(declare-fun ens%pmemlog!logimpl_v.impl&%0.untrusted_read. (Dcr Type Dcr Type pmemlog!logimpl_v.UntrustedLogImpl.
  Poly Int Int core!result.Result.
 ) Bool
)
(assert
 (forall ((Perm&. Dcr) (Perm& Type) (PM&. Dcr) (PM& Type) (self! pmemlog!logimpl_v.UntrustedLogImpl.)
   (wrpm! Poly) (pos! Int) (len! Int) (result! core!result.Result.)
  ) (!
   (= (ens%pmemlog!logimpl_v.impl&%0.untrusted_read. Perm&. Perm& PM&. PM& self! wrpm!
     pos! len! result!
    ) (and
     (has_type (Poly%core!result.Result. result!) (TYPE%core!result.Result. $ (TYPE%alloc!vec.Vec.
        $ (UINT 8) $ ALLOCATOR_GLOBAL
       ) $ TYPE%pmemlog!main_t.InfiniteLogErr.
     ))
     (let
      ...
      (ite
       (is-core!result.Result./Ok result!)
       (let
        ((bytes$ (%Poly%alloc!vec.Vec<u8./allocator_global%.>. (core!result.Result./Ok/0 $ (TYPE%alloc!vec.Vec.
             $ (UINT 8) $ ALLOCATOR_GLOBAL
            ) $ TYPE%pmemlog!main_t.InfiniteLogErr. (%Poly%core!result.Result. (Poly%core!result.Result.
              result!
        ))))))
        (let
         ((true_bytes$ (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>.
              (pmemlog!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/log (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
                (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. log$)
              ))
             ) (I (Sub pos! (pmemlog!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/head
                (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
                  log$
              ))))
             ) (I (Sub (Add pos! len!) (pmemlog!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/head
                (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
                  log$
         )))))))))
         (and
          (and
           (>= pos! (pmemlog!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/head
             (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
               log$
           ))))
           (<= (Add pos! len!) (Add (pmemlog!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/head
              (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
                log$
              ))
             ) (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (pmemlog!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/log
          ...
          (pmemlog!main_t.read_correct_modulo_corruption.? (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
             $ (UINT 8) $ ALLOCATOR_GLOBAL
            ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. bytes$)
           ) (Poly%vstd!seq.Seq<u8.>. true_bytes$) (B (pmemlog!pmemspec_t.PersistentMemoryConstants./PersistentMemoryConstants/impervious_to_corruption
             (%Poly%pmemlog!pmemspec_t.PersistentMemoryConstants. (Poly%pmemlog!pmemspec_t.PersistentMemoryConstants.
               (pmemlog!pmemspec_t.impl&%0.constants.? Perm&. Perm& PM&. PM& wrpm!)
       ))))))))
       (ite
        (and
         (is-core!result.Result./Err result!)
         (is-pmemlog!main_t.InfiniteLogErr./CantReadBeforeHead (%Poly%pmemlog!main_t.InfiniteLogErr.
           (core!result.Result./Err/0 $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) $
            TYPE%pmemlog!main_t.InfiniteLogErr. (%Poly%core!result.Result. (Poly%core!result.Result.
              result!
        ))))))
        (let
         ((head_pos$ (pmemlog!main_t.InfiniteLogErr./CantReadBeforeHead/head (%Poly%pmemlog!main_t.InfiniteLogErr.
             (core!result.Result./Err/0 $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) $
              TYPE%pmemlog!main_t.InfiniteLogErr. (%Poly%core!result.Result. (Poly%core!result.Result.
                result!
         )))))))
         (and
          ...
          (= head_pos$ (pmemlog!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/head
            (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
              log$
        ))))))
        (and
         (and
          (is-core!result.Result./Err result!)
          (is-pmemlog!main_t.InfiniteLogErr./CantReadPastTail (%Poly%pmemlog!main_t.InfiniteLogErr.
            (core!result.Result./Err/0 $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) $
             TYPE%pmemlog!main_t.InfiniteLogErr. (%Poly%core!result.Result. (Poly%core!result.Result.
               result!
         ))))))
         (let
          ((tail$ (pmemlog!main_t.InfiniteLogErr./CantReadPastTail/tail (%Poly%pmemlog!main_t.InfiniteLogErr.
              (core!result.Result./Err/0 $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) $
               TYPE%pmemlog!main_t.InfiniteLogErr. (%Poly%core!result.Result. (Poly%core!result.Result.
                 result!
          )))))))
   ...
   :pattern ((ens%pmemlog!logimpl_v.impl&%0.untrusted_read. Perm&. Perm& PM&. PM& self!
     wrpm! pos! len! result!
   ))
   :qid internal_ens__pmemlog!logimpl_v.impl&__0.untrusted_read._definition
   :skolemid skolem_internal_ens__pmemlog!logimpl_v.impl&__0.untrusted_read._definition
)))

;; Function-Def pmemlog::logimpl_v::UntrustedLogImpl::untrusted_read
;; src/logimpl_v.rs:1954:9: 1962:37 (#0)
...
(push)
 ...
 (declare-const self! pmemlog!logimpl_v.UntrustedLogImpl.)
 (declare-const wrpm! Poly)
 ...
 (declare-const verus_tmp_log@ pmemlog!infinitelog_t.AbstractInfiniteLogState.)
 ...
 (declare-const buf@ alloc!vec.Vec<u8./allocator_global%.>.)
 (declare-const verus_tmp$2@0 vstd!seq.Seq<int.>.)
 ...
 (declare-const verus_tmp_r1_addrs@ vstd!seq.Seq<int.>.)
 (declare-const verus_tmp_r2_addrs@ vstd!seq.Seq<int.>.)
 (declare-const verus_tmp_addrs$1@ vstd!seq.Seq<int.>.)
 (declare-const tmp%31 Bool)
 (declare-const tmp%32 Bool)
 (declare-const r1_len@ Int)
 (declare-const r2_len@ Int)
 (declare-const r1@0 alloc!vec.Vec<u8./allocator_global%.>.)
 (declare-const r2@0 alloc!vec.Vec<u8./allocator_global%.>.)
 (declare-const verus_tmp$3@0 vstd!seq.Seq<int.>.)
 (declare-const r1_addrs@0 vstd!seq.Seq<int.>.)
 (declare-const verus_tmp$4@0 vstd!seq.Seq<int.>.)
 (declare-const r2_addrs@0 vstd!seq.Seq<int.>.)
 (declare-const verus_tmp$5@0 vstd!seq.Seq<int.>.)
 (declare-const addrs$1@0 vstd!seq.Seq<int.>.)
 (declare-const tmp%33 Bool)
 (declare-const verus_tmp_addrs$2@ vstd!seq.Seq<int.>.)
 (declare-const tmp%34 Poly)
 (declare-const tmp%35 Bool)
 (declare-const verus_tmp$6@0 vstd!seq.Seq<int.>.)
 (declare-const addrs$2@0 vstd!seq.Seq<int.>.)
 (declare-const buf$1@ alloc!vec.Vec<u8./allocator_global%.>.)
 (declare-const tmp%36 core!result.Result.)
 (declare-const tmp%37 core!result.Result.)
 (declare-const physical_head$1@ Int)
 (declare-const physical_tail$1@ Int)
 (declare-const verus_tmp@0 pmemlog!infinitelog_t.AbstractInfiniteLogState.)
 (declare-const log@0 pmemlog!infinitelog_t.AbstractInfiniteLogState.)
 (declare-const verus_tmp$1@0 vstd!seq.Seq<u8.>.)
 (declare-const true_bytes@0 vstd!seq.Seq<u8.>.)
 (declare-const tmp%38 core!result.Result.)
 (declare-const tmp%39 core!result.Result.)
 (declare-const tmp%40 core!result.Result.)
 (declare-const pm@ Poly)
 (declare-const physical_pos@ Int)
 ...
 (assert
  (tr_bound%pmemlog!sccf.CheckPermission. Perm&. Perm& $ (TYPE%vstd!seq.Seq. $ (UINT 8)))
 )
 (assert
  (tr_bound%pmemlog!pmemspec_t.PersistentMemory. PM&. PM&)
 )
 (assert
  (has_type (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!) TYPE%pmemlog!logimpl_v.UntrustedLogImpl.)
 )
 ...
 (declare-const verus_tmp@1 pmemlog!infinitelog_t.AbstractInfiniteLogState.)
 (declare-const log@1 pmemlog!infinitelog_t.AbstractInfiniteLogState.)
 (declare-const verus_tmp$1@1 vstd!seq.Seq<u8.>.)
 (declare-const true_bytes@1 vstd!seq.Seq<u8.>.)
 (declare-const verus_tmp$2@1 vstd!seq.Seq<int.>.)
 (declare-const addrs@1 vstd!seq.Seq<int.>.)
 (declare-const verus_tmp$3@1 vstd!seq.Seq<int.>.)
 (declare-const r1_addrs@1 vstd!seq.Seq<int.>.)
 (declare-const verus_tmp$4@1 vstd!seq.Seq<int.>.)
 (declare-const r2_addrs@1 vstd!seq.Seq<int.>.)
 (declare-const verus_tmp$5@1 vstd!seq.Seq<int.>.)
 (declare-const addrs$1@1 vstd!seq.Seq<int.>.)
 (declare-const r1@1 alloc!vec.Vec<u8./allocator_global%.>.)
 (declare-const r2@1 alloc!vec.Vec<u8./allocator_global%.>.)
 (declare-const verus_tmp$6@1 vstd!seq.Seq<int.>.)
 (declare-const addrs$2@1 vstd!seq.Seq<int.>.)
 ...
 (assert
  (not (and
    (=>
     %%location_label%%0
     (req%pmemlog!pmemspec_t.impl&%0.get_pm_ref. Perm&. Perm& PM&. PM& wrpm!)
    )
    (=>
     (ens%pmemlog!pmemspec_t.impl&%0.get_pm_ref. Perm&. Perm& PM&. PM& wrpm! pm@)
     (=>
      (= tmp%1 (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/log_size (%Poly%pmemlog!logimpl_v.UntrustedLogImpl.
         (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!)
      )))
      (and
       (=>
        %%location_label%%1
        (req%pmemlog!logimpl_v.impl&%0.addr_logical_to_physical. pos! tmp%1)
       )
       (=>
        (ens%pmemlog!logimpl_v.impl&%0.addr_logical_to_physical. pos! tmp%1 physical_pos@)
        (and
         (=>
          %%location_label%%2
          (uInv 64 (Add (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/log_size (%Poly%pmemlog!logimpl_v.UntrustedLogImpl.
              (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!)
             )
            ) pmemlog!logimpl_v.contents_offset.?
         )))
         (=>
          ...
          (=>
           (= contents_end@ (uClip 64 (Add (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/log_size
               (%Poly%pmemlog!logimpl_v.UntrustedLogImpl. (Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                 self!
               ))
              ) pmemlog!logimpl_v.contents_offset.?
           )))
           (or
            (and
             (=>
              (< pos! (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/head (%Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                 (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!)
              )))
              (=>
               (= tmp%40 (core!result.Result./Err (Poly%pmemlog!main_t.InfiniteLogErr. (pmemlog!main_t.InfiniteLogErr./CantReadBeforeHead
                   (%I (I (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/head (%Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                       (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!)
               ))))))))
               (=>
                (= verus_tmp$2@1 verus_tmp$2@0)
                (=>
                 (= addrs@1 addrs@0)
                 (=>
                  (= r1@1 r1@0)
                  (=>
                   (= r2@1 r2@0)
                   (=>
                    (= verus_tmp$3@1 verus_tmp$3@0)
                    (=>
                     (= r1_addrs@1 r1_addrs@0)
                     (=>
                      (= verus_tmp$4@1 verus_tmp$4@0)
                      (=>
                       (= r2_addrs@1 r2_addrs@0)
                       (=>
                        (= verus_tmp$5@1 verus_tmp$5@0)
                        (=>
                         (= addrs$1@1 addrs$1@0)
                         (=>
                          ...
                          (=>
                           (= addrs$2@1 addrs$2@0)
                           (=>
                            (= verus_tmp@1 verus_tmp@0)
                            (=>
                             (= log@1 log@0)
                             (=>
                              (= verus_tmp$1@1 verus_tmp$1@0)
                              (=>
                               (= true_bytes@1 true_bytes@0)
                               %%switch_label%%0
             ))))))))))))))))))
             (=>
              (not (< pos! (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/head (%Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                  (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!)
              ))))
              (=>
               (= tmp%2 pos!)
               (and
                (=>
                 %%location_label%%3
                 (uInv 64 (Sub 18446744073709551615 len!))
                )
                (=>
                 (uInv 64 (Sub 18446744073709551615 len!))
                 (or
                  (and
                   (=>
                    (> tmp%2 (uClip 64 (Sub 18446744073709551615 len!)))
                    (=>
                     (= tmp%39 (core!result.Result./Err (Poly%pmemlog!main_t.InfiniteLogErr. (pmemlog!main_t.InfiniteLogErr./CantReadPastTail
                         (%I (I (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/tail (%Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                             (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!)
                     ))))))))
                     (=>
                      (= verus_tmp$2@1 verus_tmp$2@0)
                   ...
                   (=>
                    (not (> tmp%2 (uClip 64 (Sub 18446744073709551615 len!))))
                    (and
                     (=>
                      %%location_label%%4
                      (uInv 64 (Add pos! len!))
                     ...
                     (=>
                      ...
                      (or
                       (and
                        (=>
                         (> (uClip 64 (Add pos! len!)) (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/tail
                           (%Poly%pmemlog!logimpl_v.UntrustedLogImpl. (Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                             self!
                         ))))
                         (=>
                          (= tmp%38 (core!result.Result./Err (Poly%pmemlog!main_t.InfiniteLogErr. (pmemlog!main_t.InfiniteLogErr./CantReadPastTail
                              (%I (I (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/tail (%Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                                  (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!)
                          ))))))))
                          (=>
                        ...
                        (=>
                         (not (> (uClip 64 (Add pos! len!)) (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/tail
                            (%Poly%pmemlog!logimpl_v.UntrustedLogImpl. (Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                              self!
                         )))))
                         (=>
                          (= physical_head@ (pmemlog!logimpl_v.spec_addr_logical_to_physical.? (I (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/head
                              (%Poly%pmemlog!logimpl_v.UntrustedLogImpl. (Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                                self!
                             )))
                            ) (I (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/log_size (%Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                               (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!)
                          )))))
                          (=>
                           (= physical_tail@ (pmemlog!logimpl_v.spec_addr_logical_to_physical.? (I (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/tail
                               (%Poly%pmemlog!logimpl_v.UntrustedLogImpl. (Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                                 self!
                              )))
                             ) (I (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/log_size (%Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                           ...
                           (or
                            (and
                             (=>
                              (= physical_head@ physical_tail@)
                              (=>
                               (= tmp%3 (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/head (%Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                                  (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!)
                               )))
                               (=>
                                (= tmp%4 (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/tail (%Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                                   (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!)
                                )))
                                (=>
                                 (= tmp%5 (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/log_size (%Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                                    (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!)
                                 )))
                                 (and
                                  (=>
                                   %%location_label%%5
                                   (req%pmemlog!math_v.lemma_mod_equal. tmp%3 tmp%4 tmp%5)
                                  )
                                  (=>
                                   (ens%pmemlog!math_v.lemma_mod_equal. tmp%3 tmp%4 tmp%5)
                                   (=>
                                    (= tmp%6 (= len! 0))
                                    (and
                                     (=>
                             ...
                             (=>
                              (not (= physical_head@ physical_tail@))
                              (or
                               (and
                                (=>
                                 (< physical_head@ physical_tail@)
                                 (=>
                                  (= tmp%7 (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/log_size (%Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                                     (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!)
                                  )))
                                  (=>
                                   (= tmp%8 (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/head (%Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                                      (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!)
                                   )))
                                   (=>
                                    (= tmp%9 (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/tail (%Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                                       (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!)
                                    )))
                                    (and
                                     (=>
                                      %%location_label%%7
                                      (req%pmemlog!math_v.lemma_mod_between. tmp%7 tmp%8 tmp%9 pos!)
                                     )
                                     (=>
                                      (ens%pmemlog!math_v.lemma_mod_between. tmp%7 tmp%8 tmp%9 pos!)
                                      (=>
                                       (= tmp%10 (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/head (%Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                                          (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!)
                                       )))
                                       (=>
                                        (= tmp%11 (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/log_size (%Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                                           (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!)
                                        )))
                                        (and
                                         (=>
                                          %%location_label%%8
                                          (req%pmemlog!math_v.lemma_mod_difference_equal. tmp%10 pos! tmp%11)
                                         )
                                         (=>
                                          (ens%pmemlog!math_v.lemma_mod_difference_equal. tmp%10 pos! tmp%11)
                                          %%switch_label%%7
                                ))))))))))
                                (=>
                                 (not (< physical_head@ physical_tail@))
                                 (=>
                                  (= tmp%12 (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/log_size (%Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                                     (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!)
                                  )))
                                  (=>
                                   (= tmp%13 (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/head (%Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                                      (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!)
                                   )))
                                   (=>
                                    (= tmp%14 (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/tail (%Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                                       (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!)
                                    )))
                                    (and
                                     (=>
                                      %%location_label%%9
                                      (req%pmemlog!math_v.lemma_mod_not_between. tmp%12 tmp%13 tmp%14 pos!)
                                     )
                                     (=>
                                      (ens%pmemlog!math_v.lemma_mod_not_between. tmp%12 tmp%13 tmp%14 pos!)
                                      (or
                                       (and
                                        (=>
                                         (<= physical_pos@ physical_tail@)
                                         (=>
                                          (= tmp%15 (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/head (%Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                                             (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!)
                                          )))
                                          (=>
                                           (= tmp%16 (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/log_size (%Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                                              (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!)
                                           )))
                                           (and
                                            (=>
                                             %%location_label%%10
                                             (req%pmemlog!math_v.lemma_mod_wrapped_len. tmp%15 pos! tmp%16)
                                            )
                                            (=>
                                             (ens%pmemlog!math_v.lemma_mod_wrapped_len. tmp%15 pos! tmp%16)
                                             %%switch_label%%8
                                        )))))
                                        (=>
                                         (not (<= physical_pos@ physical_tail@))
                                         (=>
                                          (= tmp%17 (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/head (%Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                                             (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!)
                                          )))
                                          (=>
                                           (= tmp%18 (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/log_size (%Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                                              (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!)
                                           )))
                                           (and
                                            (=>
                                             %%location_label%%11
                                             (req%pmemlog!math_v.lemma_mod_difference_equal. tmp%17 pos! tmp%18)
                                            )
                                            (=>
                                             (ens%pmemlog!math_v.lemma_mod_difference_equal. tmp%17 pos! tmp%18)
                                             %%switch_label%%8
                                       ))))))
                                       (and
                                        (not %%switch_label%%8)
                            ...
                            (and
                             (not %%switch_label%%6)
                             (=>
                              (= tmp%19 (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/head (%Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                                 (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!)
                              )))
                              (=>
                               (= tmp%20 (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/log_size (%Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                                  (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!)
                               )))
                               (and
                                (=>
                                 %%location_label%%12
                                 (req%pmemlog!logimpl_v.impl&%0.addr_logical_to_physical. tmp%19 tmp%20)
                                )
                                (=>
                                 (ens%pmemlog!logimpl_v.impl&%0.addr_logical_to_physical. tmp%19 tmp%20 physical_head$1@)
                                 (=>
                                  (= tmp%21 (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/tail (%Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                                     (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!)
                                  )))
                                  (=>
                                   (= tmp%22 (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/log_size (%Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                                      (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!)
                                   )))
                                   (and
                                    (=>
                                     %%location_label%%13
                                     (req%pmemlog!logimpl_v.impl&%0.addr_logical_to_physical. tmp%21 tmp%22)
                                    )
                                    (=>
                                     (ens%pmemlog!logimpl_v.impl&%0.addr_logical_to_physical. tmp%21 tmp%22 physical_tail$1@)
                                     (=>
                                      (= verus_tmp@1 (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (core!option.Option./Some/0
                                         $ TYPE%pmemlog!infinitelog_t.AbstractInfiniteLogState. (%Poly%core!option.Option.
                                          (Poly%core!option.Option. (pmemlog!logimpl_v.impl&%0.recover.? (pmemlog!pmemspec_t.PersistentMemory.view.?
                                             PM&. PM& pm@
                                      )))))))
                                      (=>
                                       (= verus_tmp_log@ verus_tmp@1)
                                       (=>
                                        (= log@1 verus_tmp_log@)
                                        (=>
                                         (= verus_tmp$1@1 (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>.
                                             (pmemlog!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/log (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
                                               (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. log@1)
                                             ))
                                            ) (I (Sub pos! (pmemlog!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/head
                                               (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
                                                 log@1
                                         ...
                                         (=>
                                          (= verus_tmp_true_bytes@ verus_tmp$1@1)
                                          (=>
                                           (= true_bytes@1 verus_tmp_true_bytes@)
                                           (or
                                            (and
                                             (=>
                                              (= physical_head$1@ physical_tail$1@)
                                              (=>
                                               (= tmp%23 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.empty.? $ (UINT
                                                   8
                                                  )
                                                 ) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (pmemlog!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/log
                                                    (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
                                                      log@1
                                                   )))
                                                  ) (I (Sub pos! (pmemlog!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/head
                                               ...
                                               (and
                                                ...
                                                (=>
                                                 tmp%23
                                                 (=>
                                                  (ens%alloc!vec.impl&%0.new. $ (UINT 8) tmp%24)
                                                  (=>
                                                   (= buf@ (%Poly%alloc!vec.Vec<u8./allocator_global%.>. tmp%24))
                                                   (=>
                                                    (= verus_tmp$2@1 (%Poly%vstd!seq.Seq<int.>. (vstd!seq.Seq.empty.? $ INT)))
                                                    (=>
                                                     (= verus_tmp_addrs@ verus_tmp$2@1)
                                                     (=>
                                                      (= addrs@1 verus_tmp_addrs@)
                                                      (=>
                                                       (= tmp%25 (ite
                                                         (pmemlog!pmemspec_t.PersistentMemoryConstants./PersistentMemoryConstants/impervious_to_corruption
                                                          (%Poly%pmemlog!pmemspec_t.PersistentMemoryConstants. (Poly%pmemlog!pmemspec_t.PersistentMemoryConstants.
                                                         ...
                                                         (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
                                                            $ (UINT 8) $ ALLOCATOR_GLOBAL
                                                           ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. buf@)
                                                          ) (Poly%vstd!seq.Seq<u8.>. true_bytes@1)
                                                         )
                                                         (pmemlog!pmemspec_t.maybe_corrupted.? (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
                                                            $ (UINT 8) $ ALLOCATOR_GLOBAL
                                                           ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. buf@)
                                                          ) (Poly%vstd!seq.Seq<u8.>. true_bytes@1) (Poly%vstd!seq.Seq<int.>. addrs@1)
                                                       )))
                                                       (and
                                                        (=>
                                                         %%location_label%%15
                                                        ...
                                                        (=>
                                                         tmp%25
                                                         (=>
                                                          (= tmp%37 (core!result.Result./Ok (Poly%alloc!vec.Vec<u8./allocator_global%.>. buf@)))
                                                          (=>
                                                           (= r1@1 r1@0)
                                                           (=>
                                                            (= r2@1 r2@0)
                                             ...
                                             (=>
                                              (not (= physical_head$1@ physical_tail$1@))
                                              (or
                                               (and
                                                (=>
                                                 (>= physical_pos@ physical_head$1@)
                                                 (=>
                                                  (= tmp%26 physical_pos@)
                                                  (and
                                                   (=>
                                                    %%location_label%%16
                                                    (uInv 64 (Sub contents_end@ len!))
                                                   )
                                                   (=>
                                                    (uInv 64 (Sub contents_end@ len!))
                                                    (=>
                                                     (= tmp%27 (>= tmp%26 (uClip 64 (Sub contents_end@ len!))))
                                                     %%switch_label%%5
                                                )))))
                                                (=>
                                                 (not (>= physical_pos@ physical_head$1@))
                                                 (=>
                                                  (= tmp%27 false)
                                                  %%switch_label%%5
                                               )))
                                                 ...
                                                 (and
                                                  (=>
                                                   ...
                                                   (and
                                                    (=>
                                                     %%location_label%%17
                                                     (uInv 64 (Sub contents_end@ physical_pos@))
                                                    )
                                                    (=>
                                                     (uInv 64 (Sub contents_end@ physical_pos@))
                                                     (=>
                                                      (= r1_len@ (uClip 64 (Sub contents_end@ physical_pos@)))
                                                      (and
                                                       (=>
                                                        %%location_label%%18
                                                        (uInv 64 (Sub len! r1_len@))
                                                       )
                                                       (=>
                                                        (uInv 64 (Sub len! r1_len@))
                                                        (=>
                                                         (= r2_len@ (uClip 64 (Sub len! r1_len@)))
                                                         (and
                                                          (=>
                                                           %%location_label%%19
                                                           (req%pmemlog!pmemspec_t.PersistentMemory.read. PM&. PM& pm@ (I physical_pos@) (I r1_len@))
                                                          )
                                                          (=>
                                                           (ens%pmemlog!pmemspec_t.PersistentMemory.read. PM&. PM& pm@ (I physical_pos@) (I r1_len@)
                                                            tmp%28
                                                           )
                                                           (=>
                                                            (= r1@0 (%Poly%alloc!vec.Vec<u8./allocator_global%.>. tmp%28))
                                                            (=>
                                                             (= tmp%30 (I pmemlog!logimpl_v.contents_offset.?))
                                                             (and
                                                              (=>
                                                               %%location_label%%20
                                                               (req%pmemlog!pmemspec_t.PersistentMemory.read. PM&. PM& pm@ tmp%30 (I r2_len@))
                                                              )
                                                              (=>
                                                               (ens%pmemlog!pmemspec_t.PersistentMemory.read. PM&. PM& pm@ tmp%30 (I r2_len@) tmp%29)
                                                               (=>
                                                                (= r2@0 (%Poly%alloc!vec.Vec<u8./allocator_global%.>. tmp%29))
                                                                (=>
                                                                 (= verus_tmp$3@1 (%Poly%vstd!seq.Seq<int.>. (vstd!seq.Seq.new.? $ INT $ (TYPE%fun%1.
                                                                     $ INT $ INT
                                                                    ) (I r1_len@) (Poly%fun%1. (mk_fun (%%lambda%%0 physical_pos@)))
                                                                 )))
                                                                 (=>
                                                                  (= verus_tmp_r1_addrs@ verus_tmp$3@1)
                                                                  (=>
                                                                   (= r1_addrs@1 verus_tmp_r1_addrs@)
                                                                   (=>
                                                                    (= verus_tmp$4@1 (%Poly%vstd!seq.Seq<int.>. (vstd!seq.Seq.new.? $ INT $ (TYPE%fun%1.
                                                                        $ INT $ INT
                                                                       ) (I r2_len@) (Poly%fun%1. (mk_fun (%%lambda%%0 pmemlog!logimpl_v.contents_offset.?)))
                                                                    )))
                                                                    (=>
                                                                     (= verus_tmp_r2_addrs@ verus_tmp$4@1)
                                                                     (=>
                                                                      (= r2_addrs@1 verus_tmp_r2_addrs@)
                                                                      (=>
                                                                       (= verus_tmp$5@1 (%Poly%vstd!seq.Seq<int.>. (vstd!seq.Seq.add.? $ INT (Poly%vstd!seq.Seq<int.>.
                                                                           r1_addrs@1
                                                                          ) (Poly%vstd!seq.Seq<int.>. r2_addrs@1)
                                                                       )))
                                                                       (=>
                                                                        (= verus_tmp_addrs$1@ verus_tmp$5@1)
                                                                        (=>
                                                                         (= addrs$1@1 verus_tmp_addrs$1@)
                                                                         (=>
                                                                          (ens%alloc!vec.impl&%1.append. $ (UINT 8) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u8./allocator_global%.>.
                                                                            r1@0
                                                                           ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. r1@1) (Poly%alloc!vec.Vec<u8./allocator_global%.>.
                                                                            r2@0
                                                                           ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. r2@1)
                                                                          )
                                                                          (=>
                                                                           (= tmp%31 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.add.? $ (UINT 8)
                                                                              (vstd!seq.Seq.subrange.? $ (UINT 8) (pmemlog!pmemspec_t.PersistentMemory.view.? PM&.
                                                                                PM& pm@
                                                                               ) (I physical_pos@) (I (Add physical_pos@ r1_len@))
                                                                              ) (vstd!seq.Seq.subrange.? $ (UINT 8) (pmemlog!pmemspec_t.PersistentMemory.view.? PM&.
                                                                                PM& pm@
                                                                               ) (I pmemlog!logimpl_v.contents_offset.?) (I (Add pmemlog!logimpl_v.contents_offset.?
                                                                                 r2_len@
                                                                            ...
                                                                            (=>
                                                                             ...
                                                                             (=>
                                                                              (= tmp%32 (ite
                                                                                ...
                                                                                (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
                                                                                   $ (UINT 8) $ ALLOCATOR_GLOBAL
                                                                                  ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. r1@1)
                                                                                 ) (Poly%vstd!seq.Seq<u8.>. true_bytes@1)
                                                                                )
                                                                                (pmemlog!pmemspec_t.maybe_corrupted.? (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
                                                                                   $ (UINT 8) $ ALLOCATOR_GLOBAL
                                                                                  ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. r1@1)
                                                                                 ) (Poly%vstd!seq.Seq<u8.>. true_bytes@1) (Poly%vstd!seq.Seq<int.>. addrs$1@1)
                                                                              )))
                                                                              (and
                                                                               (=>
                                                                                %%location_label%%22
                                                                               ...
                                                                               (=>
                                                                                tmp%32
                                                                                (=>
                                                                                 (= tmp%36 (core!result.Result./Ok (Poly%alloc!vec.Vec<u8./allocator_global%.>. r1@1)))
                                                                                 (=>
                                                                                  (= verus_tmp$6@1 verus_tmp$6@0)
                                                                                  (=>
                                                                                   (= addrs$2@1 addrs$2@0)
                                                  ...
                                                  (=>
                                                   (not tmp%27)
                                                   (=>
                                                    (= tmp%33 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (
                                                        UINT 8
                                                       ) (pmemlog!pmemspec_t.PersistentMemory.view.? PM&. PM& pm@) (I physical_pos@) (I (
                                                         Add physical_pos@ len!
                                                       ))
                                                      ) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (pmemlog!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/log
                                                         (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
                                                           log@1
                                                    ...
                                                    (and
                                                     ...
                                                     (=>
                                                      tmp%33
                                                      (=>
                                                       (= verus_tmp$6@1 (%Poly%vstd!seq.Seq<int.>. (vstd!seq.Seq.new.? $ INT $ (TYPE%fun%1.
                                                           $ INT $ INT
                                                          ) (I len!) (Poly%fun%1. (mk_fun (%%lambda%%0 physical_pos@)))
                                                       )))
                                                       (=>
                                                        (= verus_tmp_addrs$2@ verus_tmp$6@1)
                                                        (=>
                                                         (= addrs$2@1 verus_tmp_addrs$2@)
                                                         (and
                                                          (=>
                                                           %%location_label%%24
                                                           (req%pmemlog!pmemspec_t.PersistentMemory.read. PM&. PM& pm@ (I physical_pos@) (I len!))
                                                          )
                                                          (=>
                                                           (ens%pmemlog!pmemspec_t.PersistentMemory.read. PM&. PM& pm@ (I physical_pos@) (I len!)
                                                            tmp%34
                                                           )
                                                           (=>
                                                            (= buf$1@ (%Poly%alloc!vec.Vec<u8./allocator_global%.>. tmp%34))
                                                            (=>
                                                             (= tmp%35 (ite
                                                               (pmemlog!pmemspec_t.PersistentMemoryConstants./PersistentMemoryConstants/impervious_to_corruption
                                                                (%Poly%pmemlog!pmemspec_t.PersistentMemoryConstants. (Poly%pmemlog!pmemspec_t.PersistentMemoryConstants.
                                                               ...
                                                               (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
                                                                  $ (UINT 8) $ ALLOCATOR_GLOBAL
                                                                 ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. buf$1@)
                                                                ) (Poly%vstd!seq.Seq<u8.>. true_bytes@1)
                                                               )
                                                               (pmemlog!pmemspec_t.maybe_corrupted.? (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
                                                                  $ (UINT 8) $ ALLOCATOR_GLOBAL
                                                                 ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. buf$1@)
                                                                ) (Poly%vstd!seq.Seq<u8.>. true_bytes@1) (Poly%vstd!seq.Seq<int.>. addrs$2@1)
                                                             )))
                                                             (and
                                                              (=>
                                                               %%location_label%%25
                                                              ...
                                                              (=>
                                                               tmp%35
                                                               (=>
                                                                (= tmp%36 (core!result.Result./Ok (Poly%alloc!vec.Vec<u8./allocator_global%.>. buf$1@)))
                                                                (=>
                                                                 (= r1@1 r1@0)
                                                                 (=>
                                                                  (= r2@1 r2@0)
