...
;; src/logimpl_v.rs:1317:14: 1326:37 (#0)
...
;; Function-Def pmemlog::logimpl_v::UntrustedLogImpl::update_header
;; src/logimpl_v.rs:1317:14: 1326:37 (#0)
...
(push)
 ...
 (declare-const new_header_bytes! alloc!vec.Vec<u8./allocator_global%.>.)
 (declare-const verus_tmp_original_wrpm@ vstd!seq.Seq<u8.>.)
 ...
 (declare-const live_header_pos@ Int)
 (declare-const verus_tmp@0 vstd!seq.Seq<u8.>.)
 (declare-const original_wrpm@0 vstd!seq.Seq<u8.>.)
 ...
 (declare-const original_wrpm@1 vstd!seq.Seq<u8.>.)
 ...
 (assert
  (not (=>
    ...
    (=>
     (= verus_tmp_original_wrpm@ verus_tmp@1)
     (=>
      (= original_wrpm@1 verus_tmp_original_wrpm@)
      (=>
       (= header_pos@ (ite
         (= (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/incorruptible_bool (%Poly%pmemlog!logimpl_v.UntrustedLogImpl.
            (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!@0)
           )
          ) pmemlog!pmemspec_t.cdb0_val.?
         )
         pmemlog!logimpl_v.header2_pos.?
         pmemlog!logimpl_v.header1_pos.?
       ))
       (=>
        (= new_pm@ (pmemlog!pmemspec_t.update_contents_to_reflect_write.? (Poly%vstd!seq.Seq<u8.>.
           (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!@0)
          ) (I header_pos@) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL)
           (Poly%alloc!vec.Vec<u8./allocator_global%.>. new_header_bytes!)
        )))
        (=>
         (= tmp%1 (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!@0))
         (=>
          (= tmp%2 (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT
               8
              ) $ ALLOCATOR_GLOBAL
             ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. new_header_bytes!)
          )))
          (and
           (=>
            %%location_label%%0
            (req%pmemlog!logimpl_v.lemma_inactive_header_update_view. tmp%1 tmp%2 header_pos@)
           )
           (=>
            (ens%pmemlog!logimpl_v.lemma_inactive_header_update_view. tmp%1 tmp%2 header_pos@)
            (=>
             (= tmp%3 (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!@0))
             (and
              (=>
               %%location_label%%1
               (req%pmemlog!logimpl_v.lemma_same_log_state. tmp%3 new_pm@)
              )
              (=>
               (ens%pmemlog!logimpl_v.lemma_same_log_state. tmp%3 new_pm@)
               (=>
                (= tmp%4 (ext_eq false (TYPE%core!option.Option. $ TYPE%pmemlog!infinitelog_t.AbstractInfiniteLogState.)
                  (Poly%core!option.Option. (pmemlog!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>.
                     (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!@0)
                   ))
                  ) (Poly%core!option.Option. (pmemlog!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>.
                 ...
                 (=>
                  ...
                  (and
                   (=>
                    (has_type chunks_flushed@ (TYPE%vstd!set.Set. $ INT))
                    (=>
                     (= new_pm$1@ (pmemlog!pmemspec_t.update_contents_to_reflect_partially_flushed_write.?
                     ...
                     (=>
                      (= tmp%5 (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!@0))
                      (=>
                       ...
                       (and
                        (=>
                         %%location_label%%3
                         (req%pmemlog!logimpl_v.lemma_inactive_header_update_view_crash. tmp%5 tmp%6 header_pos@
                          (%Poly%vstd!set.Set<int.>. chunks_flushed@)
                        ))
                        (=>
                         (ens%pmemlog!logimpl_v.lemma_inactive_header_update_view_crash. tmp%5 tmp%6 header_pos@
                          (%Poly%vstd!set.Set<int.>. chunks_flushed@)
                         )
                         (=>
                          (= tmp%7 (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!@0))
                          (and
                           (=>
                            %%location_label%%4
                            (req%pmemlog!logimpl_v.lemma_same_log_state. tmp%7 new_pm$1@)
                           )
                           (=>
                            (ens%pmemlog!logimpl_v.lemma_same_log_state. tmp%7 new_pm$1@)
                            (=>
                             (= tmp%8 (pmemlog!logimpl_v.permissions_depend_only_on_recovery_view.? Perm&. Perm&
                               perm!
                             ))
                             (and
                              (=>
                              ...
                              (=>
                               ...
                               (=>
                                ...
                                (and
                                 (=>
                                  %%location_label%%6
                                  (req%pmemlog!logimpl_v.lemma_same_permissions. Perm&. Perm& tmp%9 new_pm$1@ perm!)
                                 )
                                 (=>
                                  (ens%pmemlog!logimpl_v.lemma_same_permissions. Perm&. Perm& tmp%9 new_pm$1@ perm!)
                                  (=>
                                   %%location_label%%7
                                   (%B (let
                                     ((new_pm$2 (pmemlog!pmemspec_t.update_contents_to_reflect_partially_flushed_write.?
                                        (Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!@0))
                                        (I header_pos@) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL)
                                         (Poly%alloc!vec.Vec<u8./allocator_global%.>. new_header_bytes!)
                                        ) chunks_flushed@
                                     ...
                                     (pmemlog!sccf.CheckPermission.check_permission.? Perm&. Perm& $ (TYPE%vstd!seq.Seq.
                                       $ (UINT 8)
                                      ) perm! (Poly%vstd!seq.Seq<u8.>. new_pm$2)
                   )))))))))))))))))))
                   (=>
                    (forall ((chunks_flushed$ Poly)) (!
                      (=>
                       (has_type chunks_flushed$ (TYPE%vstd!set.Set. $ INT))
                       (%B (let
                         ((new_pm$3 (pmemlog!pmemspec_t.update_contents_to_reflect_partially_flushed_write.?
                            (Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!@0))
                            (I header_pos@) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL)
                             (Poly%alloc!vec.Vec<u8./allocator_global%.>. new_header_bytes!)
                            ) chunks_flushed$
                         ...
                         (pmemlog!sccf.CheckPermission.check_permission.? Perm&. Perm& $ (TYPE%vstd!seq.Seq.
                           $ (UINT 8)
                          ) perm! (Poly%vstd!seq.Seq<u8.>. new_pm$3)
                      ))))
                      :pattern ((pmemlog!pmemspec_t.update_contents_to_reflect_partially_flushed_write.?
                        (Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!@0))
                        (I header_pos@) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL)
                      ...
                      :qid user_pmemlog__logimpl_v__UntrustedLogImpl__update_header_60
                      :skolemid skolem_user_pmemlog__logimpl_v__UntrustedLogImpl__update_header_60
                    ))
                    (=>
                     (= tmp%11 header_pos@)
                     (=>
                      ...
                      (and
                       (=>
                        %%location_label%%8
                        (req%pmemlog!pmemspec_t.impl&%0.write. Perm&. Perm& PM&. PM& wrpm!@0 tmp%11 (%Poly%slice%<u8.>.
                          tmp%10
                         ) perm!
                       ))
                       (=>
                        ...
                        (=>
                         (ens%pmemlog!pmemspec_t.impl&%0.write. Perm&. Perm& PM&. PM& wrpm!@0 wrpm!@1 tmp%11
                          (%Poly%slice%<u8.>. tmp%10) perm!
                         )
                         (=>
                          (= tmp%12 (is-core!option.Option./Some (pmemlog!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>.
                              ...
                              (=>
                               ...
                               (and
                                ...
                                (=>
                                 tmp%13
                                 (=>
                                  (= tmp%14 (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!@1))
                                  (=>
                                   ...
                                   (and
                                    (=>
                                     %%location_label%%11
                                     (req%pmemlog!logimpl_v.lemma_header_correct. tmp%14 tmp%15 header_pos@)
                                    )
                                    (=>
                                     (ens%pmemlog!logimpl_v.lemma_header_correct. tmp%14 tmp%15 header_pos@)
                                     (or
                                      (and
                                       (=>
                                        (= header_pos@ pmemlog!logimpl_v.header1_pos.?)
                                        (=>
                                         (= tmp%17 pmemlog!logimpl_v.header2_pos.?)
                                         %%switch_label%%0
                                       ))
                                       (=>
                                        (not (= header_pos@ pmemlog!logimpl_v.header1_pos.?))
                                        (=>
                                         (= tmp%16 (= header_pos@ pmemlog!logimpl_v.header2_pos.?))
                                         (and
                                          (=>
                                           %%location_label%%12
                                           tmp%16
                                          ...
                                          (=>
                                           tmp%16
                                           (=>
                                            (= tmp%17 pmemlog!logimpl_v.header1_pos.?)
                                            %%switch_label%%0
                                      ))))))
                                      (and
                                       (not %%switch_label%%0)
                                       (=>
                                        (= live_header_pos@ tmp%17)
                                        (=>
                                         (= tmp%18 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (
                                             UINT 8
                                            ) (Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM&
                                              wrpm!@0
                                             )
                                            ) (I live_header_pos@) (I (Add live_header_pos@ pmemlog!logimpl_v.header_size.?))
                                         ...
                                         (and
                                          ...
                                          (=>
                                           tmp%18
                                           (=>
                                            (= tmp%19 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (
                                                UINT 8
                                               ) (Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM&
                                                 wrpm!@0
                                                )
                                               ) (I (Add live_header_pos@ pmemlog!logimpl_v.header_crc_offset.?)) (I (Add (Add live_header_pos@
                                                  pmemlog!logimpl_v.header_crc_offset.?
                                                 ) 8
                                               ))
                                              ) (Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.spec_crc_bytes.? (vstd!seq.Seq.subrange.?
                                                 ...
                                                 ) (I (Add live_header_pos@ pmemlog!logimpl_v.header_head_offset.?)) (I (Add live_header_pos@
                                                   pmemlog!logimpl_v.header_size.?
                                            )))))))
                                            (and
                                             (=>
                                             ...
                                             (=>
                                              tmp%19
                                              (=>
                                               (= tmp%20 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (
                                                   UINT 8
                                                  ) (Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM&
                                                    wrpm!@0
                                                   )
                                               ...
                                               (and
                                                ...
                                                (=>
                                                 tmp%20
                                                 (=>
                                                  (= tmp%21 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (
                                                      UINT 8
                                                     ) (Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM&
                                                       wrpm!@0
                                                      )
                                                  ...
                                                  (and
                                                   ...
                                                   (=>
                                                    tmp%21
                                                    (=>
                                                     (= tmp%22 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (
                                                         UINT 8
                                                        ) (Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM&
                                                          wrpm!@1
                                                         )
                                                                        ...
                                                                        (=>
                                                                         ...
                                                                         (and
                                                                          (and
                                                                           (and
                                                                            (ext_eq false TYPE%pmemlog!logimpl_v.PersistentHeader. (Poly%pmemlog!logimpl_v.PersistentHeader.
                                                                              (pmemlog!logimpl_v.HeaderView./HeaderView/header1 (%Poly%pmemlog!logimpl_v.HeaderView.
                                                                               ...
                                                                               (%Poly%pmemlog!logimpl_v.HeaderView. (Poly%pmemlog!logimpl_v.HeaderView. old_metadata$))
                                                                            )))
                                                                            (ext_eq false TYPE%pmemlog!logimpl_v.PersistentHeader. (Poly%pmemlog!logimpl_v.PersistentHeader.
                                                                              (pmemlog!logimpl_v.HeaderView./HeaderView/header2 (%Poly%pmemlog!logimpl_v.HeaderView.
                                                                                (Poly%pmemlog!logimpl_v.HeaderView. new_metadata$)
                                                                           ...
                                                                           (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT 8) (
                                                                              Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!@1)
                                                                             ) (I (Add pmemlog!logimpl_v.header2_pos.? pmemlog!logimpl_v.header_crc_offset.?))
                                                                             (I (Add (Add pmemlog!logimpl_v.header2_pos.? pmemlog!logimpl_v.header_crc_offset.?)
                                                                               8
                                                                             ))
