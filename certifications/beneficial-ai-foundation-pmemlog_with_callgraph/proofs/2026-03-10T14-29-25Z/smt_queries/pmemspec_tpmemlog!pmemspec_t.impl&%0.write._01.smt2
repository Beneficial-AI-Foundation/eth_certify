...
;; src/pmemspec_t.rs:283:9: 283:84 (#0)
...
;; Function-Def pmemlog::pmemspec_t::WriteRestrictedPersistentMemory::write
;; src/pmemspec_t.rs:283:9: 283:84 (#0)
...
(push)
 ...
 (declare-const self!@0 pmemlog!pmemspec_t.WriteRestrictedPersistentMemory.)
 ...
 (assert
  (has_type (Poly%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. self!@0) (TYPE%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory.
    Perm&. Perm& PM&. PM&
 )))
 (assert
  (uInv 64 addr!)
 ...
 (assert
  (<= (Add addr! (vstd!seq.Seq.len.? $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $ (
      ...
      Perm&. Perm& PM&. PM& (Poly%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. self!@0)
 )))))
 (assert
  (<= (Add addr! (vstd!seq.Seq.len.? $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $ (
        UINT 8
  ...
  (forall ((chunks_flushed$ Poly)) (!
    (=>
     ...
     (%B (let
       ((new_contents$ (pmemlog!pmemspec_t.update_contents_to_reflect_partially_flushed_write.?
          (Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& (
             Poly%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. self!@0
           ))
          ) (I addr!) (vstd!view.View.view.? $slice (SLICE $ (UINT 8)) (Poly%slice%<u8.>. bytes!))
          chunks_flushed$
       )))
    ...
    :qid user_pmemlog__pmemspec_t__WriteRestrictedPersistentMemory__write_25
    :skolemid skolem_user_pmemlog__pmemspec_t__WriteRestrictedPersistentMemory__write_25
 )))
 (declare-const self!@1 pmemlog!pmemspec_t.WriteRestrictedPersistentMemory.)
 ...
 (assert
  (not (and
    (=>
     %%location_label%%0
     (req%pmemlog!pmemspec_t.PersistentMemory.write. PM&. PM& (pmemlog!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory/pm
       (%Poly%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. (Poly%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory.
         self!@0
       ))
      ) (I addr!) (Poly%slice%<u8.>. bytes!)
    ))
    (=>
     (and
      (= (pmemlog!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory/perm
     ...
     (=>
      (has_type (Poly%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. self!@1) (TYPE%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory.
        Perm&. Perm& PM&. PM&
      ))
      (=>
       (ens%pmemlog!pmemspec_t.PersistentMemory.write. PM&. PM& (pmemlog!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory/pm
         (%Poly%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. (Poly%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory.
           self!@0
         ))
        ) (pmemlog!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory/pm
        ...
        (and
         ...
         (=>
          ...
          (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.impl&%0.view.?
             Perm&. Perm& PM&. PM& (Poly%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. self!@1)
            )
           ) (Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.update_contents_to_reflect_write.? (
              Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& (
                Poly%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. self!@0
              ))
             ) (I addr!) (vstd!view.View.view.? $slice (SLICE $ (UINT 8)) (Poly%slice%<u8.>. bytes!))
