...
;; src/logimpl_v.rs:1082:5: 1082:70 (#0)
...
;; Function-Def pmemlog::logimpl_v::lemma_subrange_eq
;; src/logimpl_v.rs:1082:5: 1082:70 (#0)
...
(push)
 ...
 (assert
  (has_type bytes1! (TYPE%vstd!seq.Seq. T&. T&))
 )
 (assert
  (has_type bytes2! (TYPE%vstd!seq.Seq. T&. T&))
 )
 (assert
  (ext_eq false (TYPE%vstd!seq.Seq. T&. T&) bytes1! bytes2!)
 )
 ...
 (assert
  (not (=>
    ...
    (forall ((i$ Poly) (j$ Poly)) (!
      ...
      :pattern ((vstd!seq.Seq.subrange.? T&. T& bytes1! i$ j$))
      :pattern ((vstd!seq.Seq.subrange.? T&. T& bytes2! i$ j$))
      :qid user_pmemlog__logimpl_v__lemma_subrange_eq_58
      :skolemid skolem_user_pmemlog__logimpl_v__lemma_subrange_eq_58
 )))))
 (get-info :version)
