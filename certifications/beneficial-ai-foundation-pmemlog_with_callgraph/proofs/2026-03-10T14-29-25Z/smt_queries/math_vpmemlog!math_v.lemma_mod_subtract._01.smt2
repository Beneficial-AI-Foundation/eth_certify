...
;; Function-Specs pmemlog::math_v::lemma_mod_auto_basics
(declare-fun req%pmemlog!math_v.lemma_mod_auto_basics. (Int Int) Bool)
(declare-const %%global_location_label%%27 Bool)
(assert
 (forall ((n! Int) (x! Int)) (!
   (= (req%pmemlog!math_v.lemma_mod_auto_basics. n! x!) (=>
     %%global_location_label%%27
     (> n! 0)
   ))
   :pattern ((req%pmemlog!math_v.lemma_mod_auto_basics. n! x!))
   :qid internal_req__pmemlog!math_v.lemma_mod_auto_basics._definition
   :skolemid skolem_internal_req__pmemlog!math_v.lemma_mod_auto_basics._definition
)))
(declare-fun ens%pmemlog!math_v.lemma_mod_auto_basics. (Int Int) Bool)
(assert
 (forall ((n! Int) (x! Int)) (!
   (= (ens%pmemlog!math_v.lemma_mod_auto_basics. n! x!) (and
   ...
   :pattern ((ens%pmemlog!math_v.lemma_mod_auto_basics. n! x!))
   :qid internal_ens__pmemlog!math_v.lemma_mod_auto_basics._definition
   :skolemid skolem_internal_ens__pmemlog!math_v.lemma_mod_auto_basics._definition
)))

;; Function-Specs pmemlog::math_v::lemma_div_relation_when_mods_have_same_order
(declare-fun req%pmemlog!math_v.lemma_div_relation_when_mods_have_same_order. (Int
  Int Int
 ) Bool
)
...
(assert
 (forall ((d! Int) (x! Int) (y! Int)) (!
   (= (req%pmemlog!math_v.lemma_div_relation_when_mods_have_same_order. d! x! y!) (and
     (=>
   ...
   :pattern ((req%pmemlog!math_v.lemma_div_relation_when_mods_have_same_order. d! x! y!))
   :qid internal_req__pmemlog!math_v.lemma_div_relation_when_mods_have_same_order._definition
   :skolemid skolem_internal_req__pmemlog!math_v.lemma_div_relation_when_mods_have_same_order._definition
)))
(declare-fun ens%pmemlog!math_v.lemma_div_relation_when_mods_have_same_order. (Int
  Int Int
 ) Bool
)
(assert
 (forall ((d! Int) (x! Int) (y! Int)) (!
   (= (ens%pmemlog!math_v.lemma_div_relation_when_mods_have_same_order. d! x! y!) (= (
      EucDiv y! d!
     ) (EucDiv x! d!)
   ))
   :pattern ((ens%pmemlog!math_v.lemma_div_relation_when_mods_have_same_order. d! x! y!))
   :qid internal_ens__pmemlog!math_v.lemma_div_relation_when_mods_have_same_order._definition
   :skolemid skolem_internal_ens__pmemlog!math_v.lemma_div_relation_when_mods_have_same_order._definition
)))
...
;; Function-Specs pmemlog::math_v::lemma_div_relation_when_mods_have_different_order
(declare-fun req%pmemlog!math_v.lemma_div_relation_when_mods_have_different_order.
 (Int Int Int) Bool
)
...
(assert
 (forall ((d! Int) (x! Int) (y! Int)) (!
   (= (req%pmemlog!math_v.lemma_div_relation_when_mods_have_different_order. d! x! y!)
    (and
     (=>
   ...
   :pattern ((req%pmemlog!math_v.lemma_div_relation_when_mods_have_different_order. d!
     x! y!
   ))
   :qid internal_req__pmemlog!math_v.lemma_div_relation_when_mods_have_different_order._definition
   :skolemid skolem_internal_req__pmemlog!math_v.lemma_div_relation_when_mods_have_different_order._definition
)))
(declare-fun ens%pmemlog!math_v.lemma_div_relation_when_mods_have_different_order.
 (Int Int Int) Bool
)
(assert
 (forall ((d! Int) (x! Int) (y! Int)) (!
   (= (ens%pmemlog!math_v.lemma_div_relation_when_mods_have_different_order. d! x! y!)
    (= (EucDiv y! d!) (Add (EucDiv x! d!) 1))
   )
   :pattern ((ens%pmemlog!math_v.lemma_div_relation_when_mods_have_different_order. d!
     x! y!
   ))
   :qid internal_ens__pmemlog!math_v.lemma_div_relation_when_mods_have_different_order._definition
   :skolemid skolem_internal_ens__pmemlog!math_v.lemma_div_relation_when_mods_have_different_order._definition
)))
...
;; Function-Specs pmemlog::math_v::lemma_mod_addition_when_bounded
(declare-fun req%pmemlog!math_v.lemma_mod_addition_when_bounded. (Int Int Int) Bool)
(declare-const %%global_location_label%%44 Bool)
(declare-const %%global_location_label%%45 Bool)
(declare-const %%global_location_label%%46 Bool)
(assert
 (forall ((x! Int) (y! Int) (d! Int)) (!
   (= (req%pmemlog!math_v.lemma_mod_addition_when_bounded. x! y! d!) (and
     (=>
   ...
   :pattern ((req%pmemlog!math_v.lemma_mod_addition_when_bounded. x! y! d!))
   :qid internal_req__pmemlog!math_v.lemma_mod_addition_when_bounded._definition
   :skolemid skolem_internal_req__pmemlog!math_v.lemma_mod_addition_when_bounded._definition
)))
(declare-fun ens%pmemlog!math_v.lemma_mod_addition_when_bounded. (Int Int Int) Bool)
(assert
 (forall ((x! Int) (y! Int) (d! Int)) (!
   (= (ens%pmemlog!math_v.lemma_mod_addition_when_bounded. x! y! d!) (= (EucMod (Add x!
       y!
      ) d!
     ) (Add (EucMod x! d!) y!)
   ))
   :pattern ((ens%pmemlog!math_v.lemma_mod_addition_when_bounded. x! y! d!))
   :qid internal_ens__pmemlog!math_v.lemma_mod_addition_when_bounded._definition
   :skolemid skolem_internal_ens__pmemlog!math_v.lemma_mod_addition_when_bounded._definition
)))

;; Function-Specs pmemlog::math_v::lemma_mod_equal_converse
(declare-fun req%pmemlog!math_v.lemma_mod_equal_converse. (Int Int Int) Bool)
(declare-const %%global_location_label%%47 Bool)
(declare-const %%global_location_label%%48 Bool)
(assert
 (forall ((x! Int) (y! Int) (d! Int)) (!
   (= (req%pmemlog!math_v.lemma_mod_equal_converse. x! y! d!) (and
     (=>
   ...
   :pattern ((req%pmemlog!math_v.lemma_mod_equal_converse. x! y! d!))
   :qid internal_req__pmemlog!math_v.lemma_mod_equal_converse._definition
   :skolemid skolem_internal_req__pmemlog!math_v.lemma_mod_equal_converse._definition
)))
(declare-fun ens%pmemlog!math_v.lemma_mod_equal_converse. (Int Int Int) Bool)
(assert
 (forall ((x! Int) (y! Int) (d! Int)) (!
   (= (ens%pmemlog!math_v.lemma_mod_equal_converse. x! y! d!) (= (EucMod x! d!) (EucMod
      y! d!
   )))
   :pattern ((ens%pmemlog!math_v.lemma_mod_equal_converse. x! y! d!))
   :qid internal_ens__pmemlog!math_v.lemma_mod_equal_converse._definition
   :skolemid skolem_internal_ens__pmemlog!math_v.lemma_mod_equal_converse._definition
)))

;; Function-Specs pmemlog::math_v::lemma_mod_not_equal
(declare-fun req%pmemlog!math_v.lemma_mod_not_equal. (Int Int Int) Bool)
...
(assert
 (forall ((x! Int) (y! Int) (d! Int)) (!
   (= (req%pmemlog!math_v.lemma_mod_not_equal. x! y! d!) (and
     (=>
   ...
   :pattern ((req%pmemlog!math_v.lemma_mod_not_equal. x! y! d!))
   :qid internal_req__pmemlog!math_v.lemma_mod_not_equal._definition
   :skolemid skolem_internal_req__pmemlog!math_v.lemma_mod_not_equal._definition
)))
(declare-fun ens%pmemlog!math_v.lemma_mod_not_equal. (Int Int Int) Bool)
(assert
 (forall ((x! Int) (y! Int) (d! Int)) (!
   (= (ens%pmemlog!math_v.lemma_mod_not_equal. x! y! d!) (not (= (EucMod x! d!) (EucMod
       y! d!
   ))))
   :pattern ((ens%pmemlog!math_v.lemma_mod_not_equal. x! y! d!))
   :qid internal_ens__pmemlog!math_v.lemma_mod_not_equal._definition
   :skolemid skolem_internal_ens__pmemlog!math_v.lemma_mod_not_equal._definition
)))

;; Function-Specs pmemlog::math_v::lemma_mul_div_equal
(declare-fun req%pmemlog!math_v.lemma_mul_div_equal. (Int Int Int) Bool)
(declare-const %%global_location_label%%53 Bool)
(assert
 (forall ((x! Int) (q! Int) (d! Int)) (!
   (= (req%pmemlog!math_v.lemma_mul_div_equal. x! q! d!) (=>
   ...
   :pattern ((req%pmemlog!math_v.lemma_mul_div_equal. x! q! d!))
   :qid internal_req__pmemlog!math_v.lemma_mul_div_equal._definition
   :skolemid skolem_internal_req__pmemlog!math_v.lemma_mul_div_equal._definition
)))
(declare-fun ens%pmemlog!math_v.lemma_mul_div_equal. (Int Int Int) Bool)
(assert
 (forall ((x! Int) (q! Int) (d! Int)) (!
   (= (ens%pmemlog!math_v.lemma_mul_div_equal. x! q! d!) (= (EucDiv x! d!) q!))
   :pattern ((ens%pmemlog!math_v.lemma_mul_div_equal. x! q! d!))
   :qid internal_ens__pmemlog!math_v.lemma_mul_div_equal._definition
   :skolemid skolem_internal_ens__pmemlog!math_v.lemma_mul_div_equal._definition
)))

;; Function-Specs pmemlog::math_v::lemma_mod_subtract
(declare-fun req%pmemlog!math_v.lemma_mod_subtract. (Int Int Int) Bool)
(declare-const %%global_location_label%%54 Bool)
(declare-const %%global_location_label%%55 Bool)
(declare-const %%global_location_label%%56 Bool)
(assert
 (forall ((x! Int) (y! Int) (d! Int)) (!
   (= (req%pmemlog!math_v.lemma_mod_subtract. x! y! d!) (and
     (=>
   ...
   :pattern ((req%pmemlog!math_v.lemma_mod_subtract. x! y! d!))
   :qid internal_req__pmemlog!math_v.lemma_mod_subtract._definition
   :skolemid skolem_internal_req__pmemlog!math_v.lemma_mod_subtract._definition
)))
(declare-fun ens%pmemlog!math_v.lemma_mod_subtract. (Int Int Int) Bool)
(assert
 (forall ((x! Int) (y! Int) (d! Int)) (!
   (= (ens%pmemlog!math_v.lemma_mod_subtract. x! y! d!) (= (Sub (Add (EucMod x! d!) y!)
      d!
     ) (EucMod (Add x! y!) d!)
   ))
   :pattern ((ens%pmemlog!math_v.lemma_mod_subtract. x! y! d!))
   :qid internal_ens__pmemlog!math_v.lemma_mod_subtract._definition
   :skolemid skolem_internal_ens__pmemlog!math_v.lemma_mod_subtract._definition
)))

;; Function-Def pmemlog::math_v::lemma_mod_subtract
;; src/math_v.rs:332:5: 332:60 (#0)
  ...
  (not (=>
    ...
    (and
     ...
     (=>
      ...
      (=>
       (= tmp%2 (let
         ((tmp%%$ (Add (Add (Mul (EucDiv x! d!) d!) (EucMod x! d!)) y!)))
         (and
          (<= (Add (Mul (EucDiv x! d!) d!) d!) tmp%%$)
          (< tmp%%$ (Add (Mul (EucDiv x! d!) d!) (Mul 2 d!)))
       )))
       (and
        (=>
         %%location_label%%1
         ...
         (and
          ...
          (=>
           ...
           (=>
            (= tmp%3 (EucDiv x! d!))
            (=>
             (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. tmp%3 d!)
             (=>
              (= tmp%4 (EucDiv x! d!))
              (=>
               (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. d! tmp%4 1)
               (=>
                (= tmp%5 (EucDiv x! d!))
                (=>
                 (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. d! tmp%5 2)
                 (=>
                  (= tmp%6 (let
                    ((tmp%%$ (Add x! y!)))
                    (and
                     (<= (Mul (Add (EucDiv x! d!) 1) d!) tmp%%$)
                     (< tmp%%$ (Mul (Add (EucDiv x! d!) 2) d!))
                  )))
                  (and
                   (=>
                    %%location_label%%3
                   ...
                   (=>
                    ...
                    (=>
                     (= tmp%7 (Add x! y!))
                     (=>
                      (= tmp%8 (Add (EucDiv x! d!) 1))
                      (and
                       (=>
                        %%location_label%%4
                        (req%pmemlog!math_v.lemma_mul_div_equal. tmp%7 tmp%8 d!)
                       )
                       (=>
                        (ens%pmemlog!math_v.lemma_mul_div_equal. tmp%7 tmp%8 d!)
                        (=>
                         (= tmp%9 (= (Add (EucDiv x! d!) 1) (EucDiv (Add x! y!) d!)))
                         (and
                          (=>
                           %%location_label%%5
                           tmp%9
                          ...
                          (=>
                           ...
                           (=>
                            ...
                            (and
                             (=>
                              %%location_label%%6
                              (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. tmp%10 d!)
                             )
                             (=>
                              (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. tmp%10 d!)
                              (=>
                               (= tmp%11 (= (Add x! y!) (Add (Mul d! (EucDiv (Add x! y!) d!)) (EucMod (Add x! y!) d!))))
                               (and
                                (=>
                                 %%location_label%%7
                                 tmp%11
                                ...
                                (=>
                                 ...
                                 (=>
                                  %%location_label%%8
                                  (= (Sub (Add (EucMod x! d!) y!) d!) (EucMod (Add x! y!) d!))
 )))))))))))))))))))))))))))))))))
 (get-info :version)
