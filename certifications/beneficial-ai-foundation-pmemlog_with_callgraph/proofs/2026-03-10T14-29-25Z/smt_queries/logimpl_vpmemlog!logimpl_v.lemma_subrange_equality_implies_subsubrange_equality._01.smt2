...
;; src/logimpl_v.rs:970:5: 970:113 (#0)
...
;; Function-Def pmemlog::logimpl_v::lemma_subrange_equality_implies_subsubrange_equality
;; src/logimpl_v.rs:970:5: 970:113 (#0)
     ...
     (and
      (=>
       ...
       (=>
        ...
        (=>
         ...
         (=>
          (= tmp%1 (ext_eq false (TYPE%vstd!seq.Seq. T&. T&) (vstd!seq.Seq.subrange.? T&. T& s1!
             k@ m@
      ...
      (=>
       (forall ((k$ Poly) (m$ Poly)) (!
         ...
         :pattern ((vstd!seq.Seq.subrange.? T&. T& s1! k$ m$))
         :pattern ((vstd!seq.Seq.subrange.? T&. T& s2! k$ m$))
         :qid user_pmemlog__logimpl_v__lemma_subrange_equality_implies_subsubrange_equality_42
         :skolemid skolem_user_pmemlog__logimpl_v__lemma_subrange_equality_implies_subsubrange_equality_42
       ))
       (=>
        %%location_label%%3
        (forall ((k$ Poly) (m$ Poly)) (!
          ...
          :pattern ((vstd!seq.Seq.subrange.? T&. T& s1! k$ m$))
          :pattern ((vstd!seq.Seq.subrange.? T&. T& s2! k$ m$))
          :qid user_pmemlog__logimpl_v__lemma_subrange_equality_implies_subsubrange_equality_41
          :skolemid skolem_user_pmemlog__logimpl_v__lemma_subrange_equality_implies_subsubrange_equality_41
 )))))))))
 (get-info :version)
