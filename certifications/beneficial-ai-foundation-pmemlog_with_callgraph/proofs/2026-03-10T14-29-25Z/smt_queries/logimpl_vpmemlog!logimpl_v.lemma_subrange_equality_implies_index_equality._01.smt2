...
;; src/logimpl_v.rs:955:5: 955:107 (#0)
...
;; Function-Def pmemlog::logimpl_v::lemma_subrange_equality_implies_index_equality
;; src/logimpl_v.rs:955:5: 955:107 (#0)
  ...
  (not (and
    (=>
     ...
     (=>
      ...
      (=>
       (= tmp%1 (= (vstd!seq.Seq.index.? T&. T& s1! k@) (vstd!seq.Seq.index.? T&. T& (vstd!seq.Seq.subrange.?
           T&. T& s1! (I i!) (I j!)
          ) (I (Sub (%I k@) i!))
       )))
       (and
        ...
        (=>
         tmp%1
         (=>
          (= tmp%2 (= (vstd!seq.Seq.index.? T&. T& s2! k@) (vstd!seq.Seq.index.? T&. T& (vstd!seq.Seq.subrange.?
              T&. T& s2! (I i!) (I j!)
             ) (I (Sub (%I k@) i!))
          )))
          (and
    ...
    (=>
     (forall ((k$ Poly)) (!
       ...
       :pattern ((vstd!seq.Seq.index.? T&. T& s1! k$))
       :pattern ((vstd!seq.Seq.index.? T&. T& s2! k$))
       :qid user_pmemlog__logimpl_v__lemma_subrange_equality_implies_index_equality_39
       :skolemid skolem_user_pmemlog__logimpl_v__lemma_subrange_equality_implies_index_equality_39
     ))
     (=>
      %%location_label%%3
      (forall ((k$ Poly)) (!
        ...
        :pattern ((vstd!seq.Seq.index.? T&. T& s1! k$))
        :pattern ((vstd!seq.Seq.index.? T&. T& s2! k$))
        :qid user_pmemlog__logimpl_v__lemma_subrange_equality_implies_index_equality_38
        :skolemid skolem_user_pmemlog__logimpl_v__lemma_subrange_equality_implies_index_equality_38
 )))))))
 (get-info :version)
