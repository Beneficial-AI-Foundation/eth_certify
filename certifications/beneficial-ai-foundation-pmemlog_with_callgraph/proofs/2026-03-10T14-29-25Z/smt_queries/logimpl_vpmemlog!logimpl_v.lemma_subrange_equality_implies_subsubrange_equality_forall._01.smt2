...
;; src/logimpl_v.rs:984:5: 984:82 (#0)
...
;; Function-Def pmemlog::logimpl_v::lemma_subrange_equality_implies_subsubrange_equality_forall
;; src/logimpl_v.rs:984:5: 984:82 (#0)
         ...
         (=>
          ...
          (=>
           ...
           (and
            (=>
             %%location_label%%0
             (req%pmemlog!logimpl_v.lemma_subrange_equality_implies_subsubrange_equality. T&. T&
              s1@ s2@ (%I i@) (%I j@)
            ))
            (=>
             (ens%pmemlog!logimpl_v.lemma_subrange_equality_implies_subsubrange_equality. T&. T&
              s1@ s2@ (%I i@) (%I j@)
             )
             (=>
              %%location_label%%1
              (ext_eq false (TYPE%vstd!seq.Seq. T&. T&) (vstd!seq.Seq.subrange.? T&. T& s1@ k@ m@)
               (vstd!seq.Seq.subrange.? T&. T& s2@ k@ m@)
    )))))))))))
    (=>
     (forall ((s1$ Poly) (s2$ Poly) (i$ Poly) (j$ Poly) (k$ Poly) (m$ Poly)) (!
       (=>
       ...
       :qid user_pmemlog__logimpl_v__lemma_subrange_equality_implies_subsubrange_equality_forall_45
       :skolemid skolem_user_pmemlog__logimpl_v__lemma_subrange_equality_implies_subsubrange_equality_forall_45
     ))
     (=>
      %%location_label%%2
      (forall ((s1$ Poly) (s2$ Poly) (i$ Poly) (j$ Poly) (k$ Poly) (m$ Poly)) (!
        ...
        :qid user_pmemlog__logimpl_v__lemma_subrange_equality_implies_subsubrange_equality_forall_44
        :skolemid skolem_user_pmemlog__logimpl_v__lemma_subrange_equality_implies_subsubrange_equality_forall_44
 )))))))
 (get-info :version)
