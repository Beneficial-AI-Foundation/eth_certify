...
;; Function-Def pmemlog::main_t::InfiniteLogImpl::append
;; src/main_t.rs:151:9: 151:105 (#0)
...
(push)
 ...
 (assert
  (forall ((%%hole%%0 Poly) (s1$ Poly) (s2$ Poly)) (!
    (= (%%apply%%1 (%%lambda%%1 %%hole%%0) s1$ s2$) (B (= (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
        s2$
       ) (pmemlog!infinitelog_t.impl&%0.append.? s1$ %%hole%%0)
    )))
 ...
 (assert
  (not (=>
    ...
    (=>
     (= tmp%2 (mk_fun (%%lambda%%1 (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8)
          $ ALLOCATOR_GLOBAL
         ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. bytes_to_append!)
     ))))
     (=>
      ...
      (=>
       ...
       (=>
        ...
        (and
         (=>
          %%location_label%%0
          (req%pmemlog!logimpl_v.impl&%0.untrusted_append. $ TYPE%pmemlog!main_t.TrustedPermission.
           ...
           ) bytes_to_append! (Poly%pmemlog!main_t.TrustedPermission. perm@1)
         ))
         (=>
          ...
          (=>
           (ens%pmemlog!logimpl_v.impl&%0.untrusted_append. $ TYPE%pmemlog!main_t.TrustedPermission.
            PM&. PM& (pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl/untrusted_log_impl (%Poly%pmemlog!main_t.InfiniteLogImpl.
              (Poly%pmemlog!main_t.InfiniteLogImpl. self!@0)
             )
            ...
            ) bytes_to_append! (Poly%pmemlog!main_t.TrustedPermission. perm@1) tmp%3
           )
           (=>
            (= result! tmp%3)
            (and
                     ...
                     (and
                      ...
                      (ext_eq false TYPE%pmemlog!infinitelog_t.AbstractInfiniteLogState. (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
                        new_log$
                         ...
                         (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. old_log$) (vstd!view.View.view.?
