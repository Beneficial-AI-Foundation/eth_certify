...
;; src/logimpl_v.rs:1075:5: 1075:58 (#0)
...
;; Function-Def pmemlog::logimpl_v::lemma_u64_bytes_eq
;; src/logimpl_v.rs:1075:5: 1075:58 (#0)
...
(push)
 ...
 (assert
  (not (=>
    %%location_label%%0
    (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (vstd!bytes.spec_u64_to_le_bytes.?
       (I val1!)
      )
     ) (Poly%vstd!seq.Seq<u8.>. (vstd!bytes.spec_u64_to_le_bytes.? (I val2!)))
 ))))
 (get-info :version)
