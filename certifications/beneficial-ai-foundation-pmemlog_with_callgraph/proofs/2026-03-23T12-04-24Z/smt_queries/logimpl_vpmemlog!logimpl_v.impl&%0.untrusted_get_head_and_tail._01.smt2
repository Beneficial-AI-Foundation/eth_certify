...
;; src/logimpl_v.rs:2063:9: 2069:37 (#0)
...
;; Function-Def pmemlog::logimpl_v::UntrustedLogImpl::untrusted_get_head_and_tail
;; src/logimpl_v.rs:2063:9: 2069:37 (#0)
    ...
    (=>
     ...
     (=>
      ...
      (and
       (=>
        %%location_label%%1
        (req%pmemlog!logimpl_v.lemma_pm_state_header. tmp%1)
       )
       (=>
        (ens%pmemlog!logimpl_v.lemma_pm_state_header. tmp%1)
        (=>
         ...
         (=>
          (= tmp%3 (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/tail (%Poly%pmemlog!logimpl_v.UntrustedLogImpl.
             (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!)
          )))
          (and
           (=>
           ...
           (=>
            ...
            (=>
             (= result! (core!result.Result./Ok (Poly%tuple%3. (tuple%3./tuple%3 (I tmp%2) (I tmp%3)
                 (I (uClip 64 (Sub (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/log_size (%Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                      (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!)
                     )
                    ) 1
             )))))))
