...
;; src/logimpl_v.rs:1173:9: 1173:84 (#0)
...
;; Function-Def pmemlog::logimpl_v::UntrustedLogImpl::addr_logical_to_physical
;; src/logimpl_v.rs:1173:9: 1173:84 (#0)
  ...
  (not (and
    ...
    (=>
     ...
     (and
      (=>
       %%location_label%%1
       (uInv 64 (Add (uClip 64 (EucMod addr! log_size!)) pmemlog!logimpl_v.contents_offset.?))
      )
      (=>
       (uInv 64 (Add (uClip 64 (EucMod addr! log_size!)) pmemlog!logimpl_v.contents_offset.?))
       (=>
        (= out! (uClip 64 (Add (uClip 64 (EucMod addr! log_size!)) pmemlog!logimpl_v.contents_offset.?)))
        (=>
         %%location_label%%2
         (= out! (pmemlog!logimpl_v.spec_addr_logical_to_physical.? (I addr!) (I log_size!)))
 ))))))))
