...
;; src/logimpl_v.rs:632:5: 638:6 (#0)
...
;; Function-Def pmemlog::logimpl_v::lemma_append_ib_update_effect_on_committed
;; src/logimpl_v.rs:632:5: 638:6 (#0)
...
(push)
 ...
 (declare-const old_header@ pmemlog!logimpl_v.PersistentHeader.)
 (declare-const live_header$1@ pmemlog!logimpl_v.PersistentHeader.)
 (declare-const physical_head@ Int)
 (declare-const new_physical_tail@ Int)
 (declare-const old_physical_tail@ Int)
 ...
 (declare-const ib_bytes@ vstd!seq.Seq<u8.>.)
 ...
 (declare-const new_header@ pmemlog!logimpl_v.PersistentHeader.)
 ...
 (assert
  (let
   ...
   (forall ((pm_state$ Poly)) (!
     ...
     :qid user_pmemlog__logimpl_v__lemma_append_ib_update_effect_on_committed_50
     :skolemid skolem_user_pmemlog__logimpl_v__lemma_append_ib_update_effect_on_committed_50
 ))))
        ...
        (=>
         ...
         (=>
          ...
          (and
           (=>
            %%location_label%%0
            (req%pmemlog!logimpl_v.lemma_headers_unchanged. pm! new_pm@)
           )
           (=>
            (ens%pmemlog!logimpl_v.lemma_headers_unchanged. pm! new_pm@)
            (=>
                    ...
                    (=>
                     ...
                     (=>
                      (= tmp%2 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (UINT
                        ...
                        ) (Poly%vstd!seq.Seq<u8.>. new_header_bytes!)
                      ))
                      (and
                       (=>
                        %%location_label%%2
                       ...
                       (=>
                        ...
                        (and
                         (=>
                          %%location_label%%3
                          (req%pmemlog!logimpl_v.lemma_header_match. new_pm@ header_pos@ new_header@)
                         )
                         (=>
                          (ens%pmemlog!logimpl_v.lemma_header_match. new_pm@ header_pos@ new_header@)
                          (and
                           (=>
                            %%location_label%%4
                            (req%pmemlog!logimpl_v.lemma_header_correct. new_pm@ new_header_bytes! header_pos@)
                           )
                           (=>
                            (ens%pmemlog!logimpl_v.lemma_header_correct. new_pm@ new_header_bytes! header_pos@)
                            (=>
                             (= new_log_state@ (pmemlog!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. new_pm@)))
                             (=>
                              (= old_log_state@ (pmemlog!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. pm!)))
                                    ...
                                    (and
                                     ...
                                     (=>
                                      ...
                                      (and
                                       (=>
                                        %%location_label%%6
                                        (req%pmemlog!logimpl_v.lemma_pm_state_header. pm!)
                                       )
                                       (=>
                                        (ens%pmemlog!logimpl_v.lemma_pm_state_header. pm!)
                                        (=>
                                         (= old_header@ (pmemlog!logimpl_v.spec_get_live_header.? (Poly%vstd!seq.Seq<u8.>. pm!)))
                                         (=>
                                          (= live_header$1@ (pmemlog!logimpl_v.spec_get_live_header.? (Poly%vstd!seq.Seq<u8.>.
                                             new_pm@
                                          )))
                                          (=>
                                           (= tmp%3 (ext_eq false TYPE%pmemlog!logimpl_v.PersistentHeader. (Poly%pmemlog!logimpl_v.PersistentHeader.
                                              live_header$1@
                                             ) (Poly%pmemlog!logimpl_v.PersistentHeader. new_header@)
                                           ))
                                           (and
                                            ...
                                            (=>
                                             tmp%3
                                             (=>
                                              (= tmp%4 (= (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/head
                                                 (%Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
                                                   (pmemlog!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%pmemlog!logimpl_v.PersistentHeader.
                                                     (Poly%pmemlog!logimpl_v.PersistentHeader. live_header$1@)
                                                 ))))
                                                ) (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/head (%Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
                                                  (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (pmemlog!logimpl_v.PersistentHeader./PersistentHeader/metadata
                                                    (%Poly%pmemlog!logimpl_v.PersistentHeader. (Poly%pmemlog!logimpl_v.PersistentHeader.
                                              ...
                                              (and
                                               ...
                                               (=>
                                                tmp%4
                                                (=>
                                                 (= tmp%5 (= (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/tail
                                                    (%Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
                                                      (pmemlog!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%pmemlog!logimpl_v.PersistentHeader.
                                                        (Poly%pmemlog!logimpl_v.PersistentHeader. live_header$1@)
                                                    ))))
                                                      ...
                                                      %Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
                                                       (pmemlog!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%pmemlog!logimpl_v.PersistentHeader.
                                                         (Poly%pmemlog!logimpl_v.PersistentHeader. old_header@)
                                                     ))))
                                                    ) (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes_to_append!))
                                                 )))
                                                 (and
                                                  ...
                                                  (=>
                                                   ...
                                                   (=>
                                                    ...
                                                    (=>
                                                     (= new_physical_tail@ (pmemlog!logimpl_v.spec_addr_logical_to_physical.? (I (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/tail
                                                         (%Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
                                                           (pmemlog!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%pmemlog!logimpl_v.PersistentHeader.
                                                             (Poly%pmemlog!logimpl_v.PersistentHeader. live_header$1@)
                                                        )))))
                                                     ...
                                                     (=>
                                                      (= old_physical_tail@ (pmemlog!logimpl_v.spec_addr_logical_to_physical.? (I (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/tail
                                                          (%Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
                                                            (pmemlog!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%pmemlog!logimpl_v.PersistentHeader.
                                                              (Poly%pmemlog!logimpl_v.PersistentHeader. old_header@)
                                                         )))))
                                                      ...
                                                      (=>
                                                       (= tmp%6 (= old_physical_tail@ physical_tail@))
                                                       (and
                                                        (=>
                                                         %%location_label%%10
                                                         tmp%6
                                                        ...
                                                        (=>
                                                         tmp%6
                                                         (=>
                                                          (= tmp%%$2@ (pmemlog!logimpl_v.pm_to_views.? (Poly%vstd!seq.Seq<u8.>. pm!)))
                                                          (=>
                                                           (= old_data@ (%Poly%vstd!seq.Seq<u8.>. (tuple%3./tuple%3/2 (%Poly%tuple%3. (Poly%tuple%3.
                                                                tmp%%$2@
                                                           )))))
                                                           (=>
                                                            (= tmp%%$3@ (pmemlog!logimpl_v.pm_to_views.? (Poly%vstd!seq.Seq<u8.>. pm!)))
                                                            (=>
                                                             (= new_data@ (%Poly%vstd!seq.Seq<u8.>. (tuple%3./tuple%3/2 (%Poly%tuple%3. (Poly%tuple%3.
                                                                  tmp%%$3@
                                                             )))))
                                                             (or
                                                              (and
                                                               (=>
                                                                (<= physical_head@ old_physical_tail@)
                                                                (or
                                                                 (and
                                                                  (=>
                                                                   (>= (Add old_physical_tail@ append_size@) contents_end@)
                                                                   (=>
                                                                    (= tmp%7 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (pmemlog!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/log
                                                                        (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
                                                                          new_log_state$1@
                                                                       )))
                                                                      ) (vstd!seq.Seq.add.? $ (UINT 8) (vstd!seq.Seq.add.? $ (UINT 8) (vstd!seq.Seq.subrange.?
                                                                         $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. new_data@) (I (Sub physical_head@ pmemlog!logimpl_v.contents_offset.?))
                                                                         (I (Sub old_physical_tail@ pmemlog!logimpl_v.contents_offset.?))
                                                                        ) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. new_data@) (I (Sub old_physical_tail@
                                                                           pmemlog!logimpl_v.contents_offset.?
                                                                          )
                                                                         ) (I (Sub contents_end@ pmemlog!logimpl_v.contents_offset.?))
                                                                        )
                                                                       ) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. new_data@) (I 0) (I
                                                                         (Sub new_physical_tail@ pmemlog!logimpl_v.contents_offset.?)
                                                                    )))))
                                                                    (and
                                                                     (=>
                                                                      %%location_label%%11
                                                                     ...
                                                                     (=>
                                                                      tmp%7
                                                                      (=>
                                                                       (= tmp%8 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (pmemlog!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/log
                                                                           (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
                                                                             new_log_state$1@
                                                                          )))
                                                                         ) (vstd!seq.Seq.add.? $ (UINT 8) (vstd!seq.Seq.add.? $ (UINT 8) (vstd!seq.Seq.subrange.?
                                                                            $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. old_data@) (I (Sub physical_head@ pmemlog!logimpl_v.contents_offset.?))
                                                                            (I (Sub old_physical_tail@ pmemlog!logimpl_v.contents_offset.?))
                                                                           ) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. new_data@) (I (Sub old_physical_tail@
                                                                              pmemlog!logimpl_v.contents_offset.?
                                                                             )
                                                                       ...
                                                                       (and
                                                                        ...
                                                                        (=>
                                                                         tmp%8
                                                                         (=>
                                                                          (= len1@ (Sub contents_end@ old_physical_tail@))
                                                                          (=>
                                                                           (= len2@ (Sub (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes_to_append!))
                                                                             len1@
                                                                           ))
                                                                           (=>
                                                                            (= tmp%9 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. bytes_to_append!)
                                                                              (vstd!seq.Seq.add.? $ (UINT 8) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>.
                                                                                 new_data@
                                                                                ) (I (Sub old_physical_tail@ pmemlog!logimpl_v.contents_offset.?)) (I (Sub contents_end@
                                                                                  pmemlog!logimpl_v.contents_offset.?
                                                                                ))
                                                                               ) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. new_data@) (I 0) (I
                                                                                 (Sub new_physical_tail@ pmemlog!logimpl_v.contents_offset.?)
                                                                            ...
                                                                            (and
                                                                             ...
                                                                             (=>
                                                                              tmp%9
                                                                              (=>
                                                                               (= tmp%10 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (pmemlog!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/log
                                                                                   (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
                                                                                     new_log_state$1@
                                                                                  )))
                                                                                 ) (vstd!seq.Seq.add.? $ (UINT 8) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>.
                                                                                    old_data@
                                                                                   ) (I (Sub physical_head@ pmemlog!logimpl_v.contents_offset.?)) (I (Sub old_physical_tail@
                                                                                     pmemlog!logimpl_v.contents_offset.?
                                                                                   ))
                                                                                  ) (Poly%vstd!seq.Seq<u8.>. bytes_to_append!)
                                                                               )))
                                                                  ...
                                                                  (=>
                                                                   (not (>= (Add old_physical_tail@ append_size@) contents_end@))
                                                                   (=>
                                                                    (= tmp%11 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (
                                                                        UINT 8
                                                                       ) (Poly%vstd!seq.Seq<u8.>. old_data@) (I 0) (I (Sub old_physical_tail@ pmemlog!logimpl_v.contents_offset.?))
                                                                      ) (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. new_data@) (I 0) (I
                                                                        (Sub old_physical_tail@ pmemlog!logimpl_v.contents_offset.?)
                                                                    ))))
                                                                    (and
                                                                     (=>
                                                                      %%location_label%%15
                                                                     ...
                                                                     (=>
                                                                      tmp%11
                                                                      (=>
                                                                       (= tmp%12 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (
                                                                           UINT 8
                                                                          ) (Poly%vstd!seq.Seq<u8.>. new_data@) (I (Sub old_physical_tail@ pmemlog!logimpl_v.contents_offset.?))
                                                                          (I (Add (Sub old_physical_tail@ pmemlog!logimpl_v.contents_offset.?) append_size@))
                                                                         ) (Poly%vstd!seq.Seq<u8.>. bytes_to_append!)
                                                                       ))
                                                                       (and
                                                                        (=>
                                                               ...
                                                               (=>
                                                                (not (<= physical_head@ old_physical_tail@))
                                                                (=>
                                                                 (= tmp%13 (< (Add old_physical_tail@ append_size@) physical_head@))
                                                                 (and
                                                                  (=>
                                                                   %%location_label%%17
                                                                   tmp%13
                                                              ...
                                                              (and
                                                               (not %%switch_label%%1)
                                                               (=>
                                                                (= tmp%14 (ext_eq false TYPE%pmemlog!infinitelog_t.AbstractInfiniteLogState. (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
                                                                   new_log_state$1@
                                                                  ) (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (pmemlog!infinitelog_t.impl&%0.append.?
                                                                    (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. old_log_state$1@) (Poly%vstd!seq.Seq<u8.>.
                                                                     bytes_to_append!
                                                                ...
                                                                (and
                                                                 ...
                                                                 (=>
                                                                  tmp%14
                                                                  (=>
                                                                   (= tmp%15 (%B (pmemlog!sccf.CheckPermission.check_permission.? Perm&. Perm& $ (TYPE%vstd!seq.Seq.
                                                                       $ (UINT 8)
                                                                      ) perm! (Poly%vstd!seq.Seq<u8.>. new_pm@)
                                                                   )))
                                                                   (and
                                         ...
                                         (and
                                          (and
                                           ...
                                           (ext_eq false TYPE%pmemlog!logimpl_v.PersistentHeader. (Poly%pmemlog!logimpl_v.PersistentHeader.
                                             new_live_header$
                                            ) (Poly%pmemlog!logimpl_v.PersistentHeader. (pmemlog!logimpl_v.spec_bytes_to_header.?
                                              (Poly%vstd!seq.Seq<u8.>. new_header_bytes!)
                                          ))))
                                          (= new_ib! new_pm_ib$)
 )))))))))))))))))))))))))))))))))))))))))
