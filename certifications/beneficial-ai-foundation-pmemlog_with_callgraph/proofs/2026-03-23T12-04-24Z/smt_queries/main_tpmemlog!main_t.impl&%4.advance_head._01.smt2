...
;; Function-Def pmemlog::main_t::InfiniteLogImpl::advance_head
;; src/main_t.rs:191:9: 191:98 (#0)
...
(push)
 ...
 (declare-const self!@0 pmemlog!main_t.InfiniteLogImpl.)
 (declare-const new_head! Int)
 (declare-const tmp%1 vstd!seq.Seq<u8.>.)
 (declare-const tmp%2 %%Function%%)
 (declare-const verus_tmp_perm@ pmemlog!main_t.TrustedPermission.)
 (declare-const tmp%3 core!result.Result.)
 (declare-const verus_tmp@ pmemlog!main_t.TrustedPermission.)
 (declare-const perm@0 pmemlog!main_t.TrustedPermission.)
 (assert
  fuel_defaults
 )
 (assert
 ...
 (assert
  (has_type (Poly%pmemlog!main_t.InfiniteLogImpl. self!@0) (TYPE%pmemlog!main_t.InfiniteLogImpl.
    PM&. PM&
 )))
 (assert
  (uInv 64 new_head!)
 ...
 (assert
  (pmemlog!main_t.impl&%4.valid.? PM&. PM& (Poly%pmemlog!main_t.InfiniteLogImpl. self!@0))
 )
 (declare-fun %%lambda%%1 (Poly) %%Function%%)
 (assert
  (forall ((%%hole%%0 Poly) (s1$ Poly) (s2$ Poly)) (!
    (= (%%apply%%1 (%%lambda%%1 %%hole%%0) s1$ s2$) (B (= (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
        s2$
       ) (pmemlog!infinitelog_t.impl&%0.advance_head.? s1$ %%hole%%0)
    )))
    :pattern ((%%apply%%1 (%%lambda%%1 %%hole%%0) s1$ s2$))
 )))
 (declare-const perm@1 pmemlog!main_t.TrustedPermission.)
 (declare-const self!@1 pmemlog!main_t.InfiniteLogImpl.)
 ...
 (assert
  (not (=>
    (= tmp%1 (pmemlog!pmemspec_t.impl&%0.view.? $ TYPE%pmemlog!main_t.TrustedPermission.
      PM&. PM& (pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl/wrpm (%Poly%pmemlog!main_t.InfiniteLogImpl.
        (Poly%pmemlog!main_t.InfiniteLogImpl. self!@0)
    ))))
    (=>
     (= tmp%2 (mk_fun (%%lambda%%1 (I new_head!))))
     (=>
      (ens%pmemlog!main_t.impl&%1.new. tmp%1 tmp%2 verus_tmp@)
      (=>
       ...
       (=>
        ...
        (and
         (=>
          %%location_label%%0
          (req%pmemlog!logimpl_v.impl&%0.untrusted_advance_head. $ TYPE%pmemlog!main_t.TrustedPermission.
           PM&. PM& (pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl/untrusted_log_impl (%Poly%pmemlog!main_t.InfiniteLogImpl.
             (Poly%pmemlog!main_t.InfiniteLogImpl. self!@0)
            )
           ) (pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl/wrpm (%Poly%pmemlog!main_t.InfiniteLogImpl.
             (Poly%pmemlog!main_t.InfiniteLogImpl. self!@0)
            )
           ) new_head! (Poly%pmemlog!main_t.TrustedPermission. perm@1)
         ))
         (=>
          (has_type (Poly%pmemlog!main_t.InfiniteLogImpl. self!@1) (TYPE%pmemlog!main_t.InfiniteLogImpl.
            PM&. PM&
          ))
          (=>
           (ens%pmemlog!logimpl_v.impl&%0.untrusted_advance_head. $ TYPE%pmemlog!main_t.TrustedPermission.
            PM&. PM& (pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl/untrusted_log_impl (%Poly%pmemlog!main_t.InfiniteLogImpl.
              (Poly%pmemlog!main_t.InfiniteLogImpl. self!@0)
             )
            ) (pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl/untrusted_log_impl (%Poly%pmemlog!main_t.InfiniteLogImpl.
              (Poly%pmemlog!main_t.InfiniteLogImpl. self!@1)
             )
            ) (pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl/wrpm (%Poly%pmemlog!main_t.InfiniteLogImpl.
              (Poly%pmemlog!main_t.InfiniteLogImpl. self!@0)
             )
            ...
            ) new_head! (Poly%pmemlog!main_t.TrustedPermission. perm@1) tmp%3
           )
           (=>
            (= result! tmp%3)
            (and
             (=>
              %%location_label%%1
              (pmemlog!main_t.impl&%4.valid.? PM&. PM& (Poly%pmemlog!main_t.InfiniteLogImpl. self!@1))
             )
             (and
              (=>
               %%location_label%%2
              ...
              (=>
               ...
               (ite
                ...
                (let
                 ...
                 (let
                  ((tmp%%$ (tuple%2./tuple%2 (Poly%core!option.Option. (pmemlog!main_t.impl&%4.view.? PM&.
                       PM& (Poly%pmemlog!main_t.InfiniteLogImpl. self!@0)
                      )
                     ) (Poly%core!option.Option. (pmemlog!main_t.impl&%4.view.? PM&. PM& (Poly%pmemlog!main_t.InfiniteLogImpl.
                        self!@1
                  ))))))
                    ...
                    (let
                     ...
                     (and
                      ...
                      (ext_eq false TYPE%pmemlog!infinitelog_t.AbstractInfiniteLogState. (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
                        new_log$
                       ) (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (pmemlog!infinitelog_t.impl&%0.advance_head.?
                         (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. old_log$) (I new_head!)
                )))))))))
                (ite
                 (and
                  (is-core!result.Result./Err result!)
