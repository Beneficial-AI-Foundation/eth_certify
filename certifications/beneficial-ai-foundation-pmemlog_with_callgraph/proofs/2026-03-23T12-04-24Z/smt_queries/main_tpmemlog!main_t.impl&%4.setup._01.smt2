...
;; Function-Def pmemlog::main_t::InfiniteLogImpl::setup
;; src/main_t.rs:101:9: 101:97 (#0)
...
(push)
 ...
 (assert
  (%B (pmemlog!pmemspec_t.PersistentMemory.inv.? PM&. PM& pm!@0))
 )
 (assert
  (= (vstd!seq.Seq.len.? $ (UINT 8) (pmemlog!pmemspec_t.PersistentMemory.view.? PM&. PM&
     pm!@0
 ...
 (assert
  (not (and
    (=>
     %%location_label%%0
     (req%pmemlog!logimpl_v.impl&%0.untrusted_setup. PM&. PM& pm!@0 device_size!)
    )
    (=>
     (has_type pm!@1 PM&)
     (=>
      (ens%pmemlog!logimpl_v.impl&%0.untrusted_setup. PM&. PM& pm!@0 pm!@1 device_size!
       tmp%1
      )
      (=>
       (= result! tmp%1)
       (and
        (=>
         %%location_label%%1
         (%B (pmemlog!pmemspec_t.PersistentMemory.inv.? PM&. PM& pm!@1))
        )
        (and
         (=>
          %%location_label%%2
          (= (pmemlog!pmemspec_t.PersistentMemory.constants.? PM&. PM& pm!@1) (pmemlog!pmemspec_t.PersistentMemory.constants.?
            PM&. PM& pm!@0
         )))
         (and
          (=>
           ...
           (ite
            ...
            (let
             ...
             (ext_eq false (TYPE%core!option.Option. $ TYPE%pmemlog!infinitelog_t.AbstractInfiniteLogState.)
              ...
              ) (Poly%core!option.Option. (core!option.Option./Some (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
                 (pmemlog!infinitelog_t.impl&%0.initialize.? (I log_capacity$))
            )))))
            (and
             (and
