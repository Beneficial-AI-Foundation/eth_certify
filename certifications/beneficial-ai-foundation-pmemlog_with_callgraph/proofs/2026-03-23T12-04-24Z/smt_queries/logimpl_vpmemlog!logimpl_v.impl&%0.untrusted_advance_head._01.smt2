...
;; src/logimpl_v.rs:1826:9: 1834:37 (#0)
...
;; Function-Def pmemlog::logimpl_v::UntrustedLogImpl::untrusted_advance_head
;; src/logimpl_v.rs:1826:9: 1834:37 (#0)
...
(push)
 ...
 (declare-const self!@0 pmemlog!logimpl_v.UntrustedLogImpl.)
 (declare-const wrpm!@0 Poly)
 (declare-const new_head! Int)
 (declare-const perm! Poly)
 (declare-const verus_tmp_original_pm@ vstd!seq.Seq<u8.>.)
 (declare-const tmp%1 Bool)
 (declare-const tmp%2 Bool)
 (declare-const tmp%3 pmemlog!logimpl_v.PersistentHeaderMetadata.)
 ...
 (declare-const new_log_state$1@ pmemlog!infinitelog_t.AbstractInfiniteLogState.)
 (declare-const old_log_state$1@ pmemlog!infinitelog_t.AbstractInfiniteLogState.)
 (declare-const tmp%%$1@ tuple%2.)
 (declare-const new_pm@ vstd!seq.Seq<u8.>.)
 (declare-const new_header$1@ pmemlog!logimpl_v.PersistentHeader.)
 (declare-const tmp%%@ tuple%3.)
 (declare-const ib@ Int)
 (declare-const headers@ pmemlog!logimpl_v.HeaderView.)
 (declare-const data@ vstd!seq.Seq<u8.>.)
 (declare-const header_pos@ Int)
 (declare-const new_log_state@ core!option.Option.)
 (declare-const old_log_state@ core!option.Option.)
 (declare-const tmp%20 Poly)
 (declare-const tmp%21 Int)
 (declare-const pm@ Poly)
 (declare-const verus_tmp@0 vstd!seq.Seq<u8.>.)
 (declare-const original_pm@0 vstd!seq.Seq<u8.>.)
 (declare-const live_header@ pmemlog!logimpl_v.PersistentHeader.)
 (declare-const new_header@0 pmemlog!logimpl_v.PersistentHeader.)
 (declare-const metadata_bytes@0 alloc!vec.Vec<u8./allocator_global%.>.)
 (declare-const new_crc_bytes@ alloc!vec.Vec<u8./allocator_global%.>.)
 (declare-const new_crc_val@ Int)
 (declare-const verus_tmp$1@0 vstd!seq.Seq<u8.>.)
 (declare-const old_metadata_bytes@0 vstd!seq.Seq<u8.>.)
 (declare-const new_header_bytes@0 alloc!vec.Vec<u8./allocator_global%.>.)
 (declare-const old_ib@ Int)
 (declare-const new_ib@ Int)
 (declare-const new_ib_bytes@ alloc!vec.Vec<u8./allocator_global%.>.)
 (assert
  fuel_defaults
 )
 (assert
 ...
 (assert
  (has_type (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!@0) TYPE%pmemlog!logimpl_v.UntrustedLogImpl.)
 )
 (assert
  (has_type wrpm!@0 (TYPE%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. Perm&.
    Perm& PM&. PM&
 )))
 (assert
  (uInv 64 new_head!)
 ...
 (assert
  (is-core!option.Option./Some (pmemlog!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>.
     (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!@0)
 ))))
 (assert
  (let
   ((old_log_state$ (pmemlog!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.impl&%0.view.?
        Perm&. Perm& PM&. PM& wrpm!@0
   )))))
   (forall ((pm_state$ Poly)) (!
     (=>
      (has_type pm_state$ (TYPE%vstd!seq.Seq. $ (UINT 8)))
     ...
     :qid user_pmemlog__logimpl_v__UntrustedLogImpl__untrusted_advance_head_66
     :skolemid skolem_user_pmemlog__logimpl_v__UntrustedLogImpl__untrusted_advance_head_66
 ))))
 (declare-const verus_tmp@1 vstd!seq.Seq<u8.>.)
 (declare-const original_pm@1 vstd!seq.Seq<u8.>.)
 (declare-const new_header@1 pmemlog!logimpl_v.PersistentHeader.)
 ...
 (declare-const new_header_bytes@1 alloc!vec.Vec<u8./allocator_global%.>.)
 (declare-const self!@1 pmemlog!logimpl_v.UntrustedLogImpl.)
 (declare-const wrpm!@1 Poly)
 (declare-const wrpm!@2 Poly)
 (declare-const self!@2 pmemlog!logimpl_v.UntrustedLogImpl.)
 (declare-const self!@3 pmemlog!logimpl_v.UntrustedLogImpl.)
 (declare-const self!@4 pmemlog!logimpl_v.UntrustedLogImpl.)
 ...
 (assert
  (not (and
    (=>
     %%location_label%%0
     (req%pmemlog!pmemspec_t.impl&%0.get_pm_ref. Perm&. Perm& PM&. PM& wrpm!@0)
    )
    (=>
     (ens%pmemlog!pmemspec_t.impl&%0.get_pm_ref. Perm&. Perm& PM&. PM& wrpm!@0 pm@)
     (=>
      (= verus_tmp@1 (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!@0))
      (=>
       (= verus_tmp_original_pm@ verus_tmp@1)
       (=>
        (= original_pm@1 verus_tmp_original_pm@)
        (=>
         (= live_header@ (pmemlog!logimpl_v.PersistentHeader./PersistentHeader (%I (I (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/header_crc
              (%Poly%pmemlog!logimpl_v.UntrustedLogImpl. (Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                self!@0
            ))))
           ) (%Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
             (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata (%I (I (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/head
                 (%Poly%pmemlog!logimpl_v.UntrustedLogImpl. (Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                   self!@0
               ))))
              ) (%I (I (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/tail (%Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                  (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!@0)
               )))
              ) (%I (I (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/log_size (%Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                  (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!@0)
         )))))))))
         (or
          (and
           (=>
            (< new_head! (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/head
              (%Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
                (pmemlog!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%pmemlog!logimpl_v.PersistentHeader.
                  (Poly%pmemlog!logimpl_v.PersistentHeader. live_header@)
            ))))))
            (=>
             (= tmp%1 (= (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/header_crc (%Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                 (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!@0)
                )
               ) (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/header_crc (%Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                 (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!@0)
             ...
             (and
              ...
              (=>
               tmp%1
               (=>
                (= result! (core!result.Result./Err (Poly%pmemlog!main_t.InfiniteLogErr. (pmemlog!main_t.InfiniteLogErr./CantAdvanceHeadPositionBeforeHead
                    (%I (I (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/head (%Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
                        (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (pmemlog!logimpl_v.PersistentHeader./PersistentHeader/metadata
                          (%Poly%pmemlog!logimpl_v.PersistentHeader. (Poly%pmemlog!logimpl_v.PersistentHeader.
                            live_header@
                ))))))))))))
                (and
                 ...
                 (and
                  (=>
                   %%location_label%%3
                   (= (pmemlog!pmemspec_t.impl&%0.constants.? Perm&. Perm& PM&. PM& wrpm!@0) (pmemlog!pmemspec_t.impl&%0.constants.?
                     Perm&. Perm& PM&. PM& wrpm!@0
                  )))
                  (=>
                   %%location_label%%4
                         ...
                         (and
                          ...
                          (ext_eq false TYPE%pmemlog!infinitelog_t.AbstractInfiniteLogState. (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
                            new_log_state$1
                             ...
                             (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. old_log_state$1) (I new_head!)
                       ))))))
                       (ite
                        (and
                         (and
                          ...
                          (let
                           ...
                           (and
                            (and
                             (ext_eq false TYPE%pmemlog!infinitelog_t.AbstractInfiniteLogState. (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
                               new_log_state$2
                              ) (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. old_log_state$2)
                             )
                             (= head$ (pmemlog!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/head
                               (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
                                 old_log_state$2
                           ...
                           (let
                            ...
                            (and
                             (and
                              (ext_eq false TYPE%pmemlog!infinitelog_t.AbstractInfiniteLogState. (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
                                new_log_state$3
                               ) (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. old_log_state$3)
                              )
                              (= tail$ (Add (pmemlog!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/head
                                 (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
                                   old_log_state$3
           ...
           (=>
            (not (< new_head! (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/head
               (%Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
                 (pmemlog!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%pmemlog!logimpl_v.PersistentHeader.
                   (Poly%pmemlog!logimpl_v.PersistentHeader. live_header@)
            )))))))
          ...
          (and
           ...
           (or
            (and
             (=>
              (> new_head! (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/tail
                (%Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
                  (pmemlog!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%pmemlog!logimpl_v.PersistentHeader.
                    (Poly%pmemlog!logimpl_v.PersistentHeader. live_header@)
              ))))))
              (=>
               (= tmp%2 (= (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/header_crc (%Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                   (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!@0)
                  )
                 ) (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/header_crc (%Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                   (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!@0)
               ...
               (and
                ...
                (=>
                 tmp%2
                 (=>
                  (= result! (core!result.Result./Err (Poly%pmemlog!main_t.InfiniteLogErr. (pmemlog!main_t.InfiniteLogErr./CantAdvanceHeadPositionBeyondTail
                      (%I (I (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/tail (%Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
                          (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (pmemlog!logimpl_v.PersistentHeader./PersistentHeader/metadata
                            (%Poly%pmemlog!logimpl_v.PersistentHeader. (Poly%pmemlog!logimpl_v.PersistentHeader.
                              live_header@
                  ))))))))))))
             ...
             (=>
              (not (> new_head! (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/tail
                 (%Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
                   (pmemlog!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%pmemlog!logimpl_v.PersistentHeader.
                     (Poly%pmemlog!logimpl_v.PersistentHeader. live_header@)
              )))))))
            ...
            (and
             (not %%switch_label%%2)
             (=>
              (= new_header@0 live_header@)
              (=>
               (= new_header@1 ((_ update-field pmemlog!logimpl_v.PersistentHeader./PersistentHeader/?metadata)
                 (%Poly%pmemlog!logimpl_v.PersistentHeader. (Poly%pmemlog!logimpl_v.PersistentHeader.
                   new_header@0
                  )
                 ) ((_ update-field pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata/?head)
                  (%Poly%pmemlog!logimpl_v.PersistentHeaderMetadata. (Poly%pmemlog!logimpl_v.PersistentHeaderMetadata.
                    (pmemlog!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%pmemlog!logimpl_v.PersistentHeader.
                      (Poly%pmemlog!logimpl_v.PersistentHeader. new_header@0)
                   )))
                  ) new_head!
               )))
               (=>
                (has_type (Poly%pmemlog!logimpl_v.PersistentHeader. new_header@1) TYPE%pmemlog!logimpl_v.PersistentHeader.)
                (=>
                 (= tmp%3 (pmemlog!logimpl_v.PersistentHeader./PersistentHeader/metadata (%Poly%pmemlog!logimpl_v.PersistentHeader.
                    (Poly%pmemlog!logimpl_v.PersistentHeader. new_header@1)
                 )))
                 (=>
                  (ens%pmemlog!logimpl_v.metadata_to_bytes. tmp%3 metadata_bytes@0)
                  (=>
                   (ens%pmemlog!pmemspec_t.bytes_crc. metadata_bytes@0 new_crc_bytes@)
                   (=>
                    ...
                    (and
                     (=>
                      %%location_label%%9
                      (req%vstd!bytes.u64_from_le_bytes. (%Poly%slice%<u8.>. tmp%4))
                     )
                     (=>
                      (ens%vstd!bytes.u64_from_le_bytes. (%Poly%slice%<u8.>. tmp%4) new_crc_val@)
                      (=>
                       (= verus_tmp$1@1 (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
                           $ (UINT 8) $ ALLOCATOR_GLOBAL
                          ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. metadata_bytes@0)
                       )))
                       (=>
                        (= verus_tmp_old_metadata_bytes@ verus_tmp$1@1)
                        (=>
                         (= old_metadata_bytes@1 verus_tmp_old_metadata_bytes@)
                         (=>
                          (= new_header_bytes@0 new_crc_bytes@)
                          (=>
                           (ens%alloc!vec.impl&%1.append. $ (UINT 8) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u8./allocator_global%.>.
                             new_header_bytes@0
                            ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. new_header_bytes@1) (Poly%alloc!vec.Vec<u8./allocator_global%.>.
                             metadata_bytes@0
                            ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. metadata_bytes@1)
                           )
                           (=>
                            (= tmp%5 (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT
                                 8
                                ) $ ALLOCATOR_GLOBAL
                               ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. new_header_bytes@1)
                            )))
                            (=>
                             (= tmp%6 (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT
                                  8
                                 ) $ ALLOCATOR_GLOBAL
                                ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. new_crc_bytes@)
                             )))
                             (and
                              (=>
                               %%location_label%%10
                               (req%pmemlog!logimpl_v.lemma_header_crc_correct. tmp%5 tmp%6 old_metadata_bytes@1)
                              )
                              (=>
                               (ens%pmemlog!logimpl_v.lemma_header_crc_correct. tmp%5 tmp%6 old_metadata_bytes@1)
                               (and
                                (=>
                                 %%location_label%%11
                                 (req%pmemlog!logimpl_v.impl&%0.update_header. Perm&. Perm& PM&. PM& self!@0 wrpm!@0
                                  perm! new_header_bytes@1
                                ))
                                (=>
                                 (has_type (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!@1) TYPE%pmemlog!logimpl_v.UntrustedLogImpl.)
                                 (=>
                                  (has_type wrpm!@1 (TYPE%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. Perm&.
                                    Perm& PM&. PM&
                                  ))
                                  (=>
                                   (ens%pmemlog!logimpl_v.impl&%0.update_header. Perm&. Perm& PM&. PM& self!@0 self!@1
                                    wrpm!@0 wrpm!@1 perm! new_header_bytes@1
                                   )
                                   (=>
                                    (= old_ib@ (pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/incorruptible_bool
                                      (%Poly%pmemlog!logimpl_v.UntrustedLogImpl. (Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                                        self!@1
                                    ))))
                                    (or
                                     (and
                                      (=>
                                       (= old_ib@ pmemlog!pmemspec_t.cdb0_val.?)
                                       (=>
                                        (= tmp%8 pmemlog!pmemspec_t.cdb1_val.?)
                                        %%switch_label%%1
                                      ))
                                      (=>
                                       (not (= old_ib@ pmemlog!pmemspec_t.cdb0_val.?))
                                       (=>
                                        (= tmp%7 (= old_ib@ pmemlog!pmemspec_t.cdb1_val.?))
                                        (and
                                         (=>
                                          %%location_label%%12
                                          tmp%7
                                         ...
                                         (=>
                                          tmp%7
                                          (=>
                                           (= tmp%8 pmemlog!pmemspec_t.cdb0_val.?)
                                           %%switch_label%%1
                                     ))))))
                                     (and
                                      (not %%switch_label%%1)
                                      (=>
                                       (= new_ib@ tmp%8)
                                       (=>
                                        (ens%vstd!bytes.u64_to_le_bytes. new_ib@ new_ib_bytes@)
                                        (=>
                                         (ens%vstd!bytes.lemma_auto_spec_u64_to_from_le_bytes. 0)
                                         (=>
                                          (= tmp%9 (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!@1))
                                          (=>
                                           (= tmp%10 pmemlog!logimpl_v.incorruptible_bool_pos.?)
                                           (=>
                                            (= tmp%11 (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (
                                                 UINT 8
                                                ) $ ALLOCATOR_GLOBAL
                                               ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. new_ib_bytes@)
                                            )))
                                            (and
                                             (=>
                                              %%location_label%%13
                                              (req%pmemlog!logimpl_v.lemma_single_write_crash. tmp%9 tmp%10 tmp%11)
                                             )
                                             (=>
                                              (ens%pmemlog!logimpl_v.lemma_single_write_crash. tmp%9 tmp%10 tmp%11)
                                              (=>
                                               (= tmp%12 (%B (pmemlog!sccf.CheckPermission.check_permission.? Perm&. Perm& $ (TYPE%vstd!seq.Seq.
                                                   $ (UINT 8)
                                                  ) perm! (Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&.
                                                    PM& wrpm!@0
                                               )))))
                                               (and
                                                ...
                                                (=>
                                                 ...
                                                 (=>
                                                  (= new_pm@ (pmemlog!pmemspec_t.update_contents_to_reflect_write.? (Poly%vstd!seq.Seq<u8.>.
                                                     (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!@1)
                                                    ) (I pmemlog!logimpl_v.incorruptible_bool_pos.?) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
                                                      $ (UINT 8) $ ALLOCATOR_GLOBAL
                                                     ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. new_ib_bytes@)
                                                  )))
                                                  (=>
                                                   (= tmp%13 (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!@1))
                                                   (and
                                                    (=>
                                                     %%location_label%%15
                                                     (req%pmemlog!logimpl_v.lemma_headers_unchanged. tmp%13 new_pm@)
                                                    )
                                                    (=>
                                                     (ens%pmemlog!logimpl_v.lemma_headers_unchanged. tmp%13 new_pm@)
                                                     (=>
                                                      (= tmp%14 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (
                                                          UINT 8
                                                         ) (Poly%vstd!seq.Seq<u8.>. new_pm@) (I pmemlog!logimpl_v.incorruptible_bool_pos.?)
                                                         (I (Add pmemlog!logimpl_v.incorruptible_bool_pos.? 8))
                                                        ) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>.
                                                          new_ib_bytes@
                                                      ))))
                                                      (and
                                                       ...
                                                       (=>
                                                        tmp%14
                                                        (=>
                                                         (= new_header$1@ (pmemlog!logimpl_v.spec_bytes_to_header.? (vstd!view.View.view.? $
                                                            (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>.
                                                             new_header_bytes@1
                                                         ))))
                                                         (=>
                                                          ...
                                                          (=>
                                                           (= ib@ (%I (tuple%3./tuple%3/0 (%Poly%tuple%3. (Poly%tuple%3. tmp%%@)))))
                                                           (=>
                                                            (= headers@ (%Poly%pmemlog!logimpl_v.HeaderView. (tuple%3./tuple%3/1 (%Poly%tuple%3.
                                                                (Poly%tuple%3. tmp%%@)
                                                            ))))
                                                            (=>
                                                             (= data@ (%Poly%vstd!seq.Seq<u8.>. (tuple%3./tuple%3/2 (%Poly%tuple%3. (Poly%tuple%3.
                                                                  tmp%%@
                                                             )))))
                                                             (=>
                                                              (= header_pos@ (ite
                                                              ...
                                                              (=>
                                                               (= tmp%15 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (vstd!seq.Seq.subrange.? $ (
                                                                   UINT 8
                                                                  ) (Poly%vstd!seq.Seq<u8.>. new_pm@) (I header_pos@) (I (Add header_pos@ pmemlog!logimpl_v.header_size.?))
                                                                 ) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>.
                                                                   new_header_bytes@1
                                                               ))))
                                                               (and
                                                                ...
                                                                (=>
                                                                 ...
                                                                 (and
                                                                  (=>
                                                                   %%location_label%%18
                                                                   (req%pmemlog!logimpl_v.lemma_header_match. new_pm@ header_pos@ new_header$1@)
                                                                  )
                                                                  (=>
                                                                   (ens%pmemlog!logimpl_v.lemma_header_match. new_pm@ header_pos@ new_header$1@)
                                                                   (=>
                                                                    (= tmp%16 (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (
                                                                         UINT 8
                                                                        ) $ ALLOCATOR_GLOBAL
                                                                       ) (Poly%alloc!vec.Vec<u8./allocator_global%.>. new_header_bytes@1)
                                                                    )))
                                                                    (and
                                                                     (=>
                                                                      %%location_label%%19
                                                                      (req%pmemlog!logimpl_v.lemma_header_correct. new_pm@ tmp%16 header_pos@)
                                                                     )
                                                                     (=>
                                                                      (ens%pmemlog!logimpl_v.lemma_header_correct. new_pm@ tmp%16 header_pos@)
                                                                      (=>
                                                                       (= new_log_state@ (pmemlog!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. new_pm@)))
                                                                       (=>
                                                                        (= old_log_state@ (pmemlog!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.impl&%0.view.?
                                                                        ...
                                                                        (=>
                                                                         (= tmp%%$1@ (tuple%2./tuple%2 (Poly%core!option.Option. new_log_state@) (Poly%core!option.Option.
                                                                            old_log_state@
                                                                         )))
                                                                         (or
                                                                          (and
                                                                            ...
                                                                            (=>
                                                                             ...
                                                                             (=>
                                                                              ...
                                                                              (and
                                                                               (=>
                                                                                %%location_label%%20
                                                                                (req%pmemlog!logimpl_v.lemma_pm_state_header. new_pm@)
                                                                               )
                                                                               (=>
                                                                                (ens%pmemlog!logimpl_v.lemma_pm_state_header. new_pm@)
                                                                                (=>
                                                                                 (= tmp%17 (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!@0))
                                                                                 (and
                                                                                  (=>
                                                                                   %%location_label%%21
                                                                                   (req%pmemlog!logimpl_v.lemma_pm_state_header. tmp%17)
                                                                                  )
                                                                                  (=>
                                                                                   (ens%pmemlog!logimpl_v.lemma_pm_state_header. tmp%17)
                                                                                   (=>
                                                                                    (= tmp%18 (ext_eq false TYPE%pmemlog!infinitelog_t.AbstractInfiniteLogState. (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
                                                                                       new_log_state$1@
                                                                                      ) (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (pmemlog!infinitelog_t.impl&%0.advance_head.?
                                                                                        (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. old_log_state$1@) (I new_head!)
                                                                                    ))))
                                                                                    (and
                                                                                     ...
                                                                                     (=>
                                                                                      tmp%18
                                                                                      (=>
                                                                                       (= tmp%19 (%B (pmemlog!sccf.CheckPermission.check_permission.? Perm&. Perm& $ (TYPE%vstd!seq.Seq.
                                                                                           $ (UINT 8)
                                                                                          ) perm! (Poly%vstd!seq.Seq<u8.>. new_pm@)
                                                                                       )))
                                                                                       (and
                                                                          ...
                                                                          (and
                                                                           (not %%switch_label%%0)
                                                                           (=>
                                                                            (= tmp%21 pmemlog!logimpl_v.incorruptible_bool_pos.?)
                                                                            (=>
                                                                             (ens%alloc!vec.impl&%1.as_slice. $ (UINT 8) $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<u8./allocator_global%.>.
                                                                               new_ib_bytes@
                                                                              ) tmp%20
                                                                             ...
                                                                             (and
                                                                              (=>
                                                                               %%location_label%%25
                                                                               (req%pmemlog!pmemspec_t.impl&%0.write. Perm&. Perm& PM&. PM& wrpm!@1 tmp%21 (%Poly%slice%<u8.>.
                                                                                 tmp%20
                                                                                ) perm!
                                                                              ))
                                                                              (=>
                                                                               (has_type wrpm!@2 (TYPE%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. Perm&.
                                                                                 Perm& PM&. PM&
                                                                               ))
                                                                               (=>
                                                                                (ens%pmemlog!pmemspec_t.impl&%0.write. Perm&. Perm& PM&. PM& wrpm!@1 wrpm!@2 tmp%21
                                                                                 (%Poly%slice%<u8.>. tmp%20) perm!
                                                                                )
                                                                                (=>
                                                                                 (= self!@2 ((_ update-field pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/?incorruptible_bool)
                                                                                   (%Poly%pmemlog!logimpl_v.UntrustedLogImpl. (Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                                                                                     self!@1
                                                                                    )
                                                                                   ) new_ib@
                                                                                 ...
                                                                                 (=>
                                                                                  (has_type (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!@2) TYPE%pmemlog!logimpl_v.UntrustedLogImpl.)
                                                                                  (=>
                                                                                   (= self!@3 ((_ update-field pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/?head)
                                                                                     (%Poly%pmemlog!logimpl_v.UntrustedLogImpl. (Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                                                                                       self!@2
                                                                                      )
                                                                                     ) new_head!
                                                                                   ...
                                                                                   (=>
                                                                                    (has_type (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!@3) TYPE%pmemlog!logimpl_v.UntrustedLogImpl.)
                                                                                    (=>
                                                                                     (= self!@4 ((_ update-field pmemlog!logimpl_v.UntrustedLogImpl./UntrustedLogImpl/?header_crc)
                                                                                       (%Poly%pmemlog!logimpl_v.UntrustedLogImpl. (Poly%pmemlog!logimpl_v.UntrustedLogImpl.
                                                                                         self!@3
                                                                                        )
                                                                                       ) new_crc_val@
                                                                                     ...
                                                                                     (=>
                                                                                      (has_type (Poly%pmemlog!logimpl_v.UntrustedLogImpl. self!@4) TYPE%pmemlog!logimpl_v.UntrustedLogImpl.)
                                                                                      (=>
                                                                                       ...
                                                                                       (and
                                                                                        ...
                                                                                        (and
                                                                                         (=>
                                                                                          %%location_label%%27
                                                                                          (= (pmemlog!pmemspec_t.impl&%0.constants.? Perm&. Perm& PM&. PM& wrpm!@2) (pmemlog!pmemspec_t.impl&%0.constants.?
                                                                                            Perm&. Perm& PM&. PM& wrpm!@0
                                                                                         )))
                                                                                         (=>
                                                                                          %%location_label%%28
