...
;; MODULE 'module main_t'
;; src/main_t.rs:274:9: 274:97 (#0)
...
(declare-const fuel%pmemlog!main_t.impl&%0.check_permission. FuelId)
(declare-const fuel%pmemlog!main_t.impl&%3.arrow_required_space. FuelId)
(declare-const fuel%pmemlog!main_t.impl&%3.arrow_available_space. FuelId)
(declare-const fuel%pmemlog!main_t.impl&%3.arrow_InsufficientSpaceForSetup_required_space.
 FuelId
)
(declare-const fuel%pmemlog!main_t.impl&%3.arrow_CantReadBeforeHead_head. FuelId)
(declare-const fuel%pmemlog!main_t.impl&%3.arrow_CantReadPastTail_tail. FuelId)
(declare-const fuel%pmemlog!main_t.impl&%3.arrow_InsufficientSpaceForAppend_available_space.
 FuelId
)
(declare-const fuel%pmemlog!main_t.impl&%3.arrow_CantAdvanceHeadPositionBeforeHead_head.
 FuelId
)
(declare-const fuel%pmemlog!main_t.impl&%3.arrow_CantAdvanceHeadPositionBeyondTail_tail.
 FuelId
)
(declare-const fuel%pmemlog!main_t.impl&%4.view. FuelId)
(declare-const fuel%pmemlog!main_t.impl&%4.constants. FuelId)
(declare-const fuel%pmemlog!main_t.impl&%4.valid. FuelId)
...
(declare-const fuel%pmemlog!sccf.is_state_allowable. FuelId)
...
(assert
 (distinct fuel%vstd!std_specs.option.impl&%0.arrow_0. fuel%vstd!std_specs.option.spec_unwrap.
  ...
  fuel%vstd!seq.axiom_seq_subrange_decreases. fuel%vstd!seq.axiom_seq_empty. fuel%vstd!seq.axiom_seq_ext_equal.
  fuel%vstd!seq.axiom_seq_ext_equal_deep. fuel%vstd!seq.axiom_seq_subrange_len. fuel%vstd!seq.axiom_seq_subrange_index.
  fuel%vstd!seq.lemma_seq_two_subranges_index. fuel%vstd!seq.axiom_seq_add_len. fuel%vstd!seq.axiom_seq_add_index1.
  ...
  fuel%vstd!view.impl&%46.view. fuel%pmemlog!infinitelog_t.impl&%0.initialize. fuel%pmemlog!infinitelog_t.impl&%0.append.
  ...
  fuel%pmemlog!logimpl_v.spec_bytes_to_metadata. fuel%pmemlog!logimpl_v.spec_addr_logical_to_physical.
  ...
  fuel%pmemlog!main_t.impl&%0.check_permission. fuel%pmemlog!main_t.impl&%3.arrow_required_space.
  fuel%pmemlog!main_t.impl&%3.arrow_available_space. fuel%pmemlog!main_t.impl&%3.arrow_InsufficientSpaceForSetup_required_space.
  fuel%pmemlog!main_t.impl&%3.arrow_CantReadBeforeHead_head. fuel%pmemlog!main_t.impl&%3.arrow_CantReadPastTail_tail.
  fuel%pmemlog!main_t.impl&%3.arrow_InsufficientSpaceForAppend_available_space. fuel%pmemlog!main_t.impl&%3.arrow_CantAdvanceHeadPositionBeforeHead_head.
  fuel%pmemlog!main_t.impl&%3.arrow_CantAdvanceHeadPositionBeyondTail_tail. fuel%pmemlog!main_t.impl&%4.view.
  fuel%pmemlog!main_t.impl&%4.constants. fuel%pmemlog!main_t.impl&%4.valid. fuel%pmemlog!pmemspec_t.all_elements_unique.
  fuel%pmemlog!pmemspec_t.maybe_corrupted. fuel%pmemlog!pmemspec_t.crc_size. fuel%pmemlog!pmemspec_t.cdb0_val.
  fuel%pmemlog!pmemspec_t.cdb1_val. fuel%pmemlog!sccf.is_state_allowable. fuel%vstd!array.group_array_axioms.
...
(declare-datatypes ((core!option.Option. 0) (core!result.Result. 0) (vstd!raw_ptr.PtrData.
  ...
  (pmemlog!logimpl_v.UntrustedLogImpl. 0) (pmemlog!main_t.TrustedPermission. 0) (pmemlog!main_t.InfiniteLogImpl.
   0
  ) (pmemlog!main_t.InfiniteLogErr. 0) (pmemlog!pmemspec_t.PersistentMemoryConstants.
   0
  ...
  ) ((pmemlog!main_t.TrustedPermission./TrustedPermission (pmemlog!main_t.TrustedPermission./TrustedPermission/?is_state_allowable
     %%Function%%
   ))
  ) ((pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl (pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl/?untrusted_log_impl
     pmemlog!logimpl_v.UntrustedLogImpl.
    ) (pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl/?wrpm Poly)
   )
...
(declare-fun pmemlog!main_t.TrustedPermission./TrustedPermission/is_state_allowable
 (pmemlog!main_t.TrustedPermission.) %%Function%%
)
(declare-fun pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl/untrusted_log_impl (pmemlog!main_t.InfiniteLogImpl.)
 pmemlog!logimpl_v.UntrustedLogImpl.
)
(declare-fun pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl/wrpm (pmemlog!main_t.InfiniteLogImpl.)
 Poly
)
...
(declare-const TYPE%pmemlog!main_t.TrustedPermission. Type)
(declare-fun TYPE%pmemlog!main_t.InfiniteLogImpl. (Dcr Type) Type)
...
(declare-fun Poly%pmemlog!main_t.TrustedPermission. (pmemlog!main_t.TrustedPermission.)
 Poly
)
(declare-fun %Poly%pmemlog!main_t.TrustedPermission. (Poly) pmemlog!main_t.TrustedPermission.)
(declare-fun Poly%pmemlog!main_t.InfiniteLogImpl. (pmemlog!main_t.InfiniteLogImpl.)
 Poly
)
(declare-fun %Poly%pmemlog!main_t.InfiniteLogImpl. (Poly) pmemlog!main_t.InfiniteLogImpl.)
...
(assert
 (forall ((x pmemlog!main_t.TrustedPermission.)) (!
   (= x (%Poly%pmemlog!main_t.TrustedPermission. (Poly%pmemlog!main_t.TrustedPermission.
      x
   )))
   :pattern ((Poly%pmemlog!main_t.TrustedPermission. x))
   :qid internal_pmemlog__main_t__TrustedPermission_box_axiom_definition
   :skolemid skolem_internal_pmemlog__main_t__TrustedPermission_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x TYPE%pmemlog!main_t.TrustedPermission.)
    (= x (Poly%pmemlog!main_t.TrustedPermission. (%Poly%pmemlog!main_t.TrustedPermission.
       x
   ))))
   :pattern ((has_type x TYPE%pmemlog!main_t.TrustedPermission.))
   :qid internal_pmemlog__main_t__TrustedPermission_unbox_axiom_definition
   :skolemid skolem_internal_pmemlog__main_t__TrustedPermission_unbox_axiom_definition
)))
(assert
 (forall ((_is_state_allowable! %%Function%%)) (!
   (=>
    (has_type (Poly%fun%1. _is_state_allowable!) (TYPE%fun%1. $ (TYPE%vstd!seq.Seq. $ (UINT
        8
       )
      ) $ BOOL
    ))
    (has_type (Poly%pmemlog!main_t.TrustedPermission. (pmemlog!main_t.TrustedPermission./TrustedPermission
       _is_state_allowable!
      )
     ) TYPE%pmemlog!main_t.TrustedPermission.
   ))
   :pattern ((has_type (Poly%pmemlog!main_t.TrustedPermission. (pmemlog!main_t.TrustedPermission./TrustedPermission
       _is_state_allowable!
      )
     ) TYPE%pmemlog!main_t.TrustedPermission.
   ))
   :qid internal_pmemlog!main_t.TrustedPermission./TrustedPermission_constructor_definition
   :skolemid skolem_internal_pmemlog!main_t.TrustedPermission./TrustedPermission_constructor_definition
)))
(assert
 (forall ((x pmemlog!main_t.TrustedPermission.)) (!
   (= (pmemlog!main_t.TrustedPermission./TrustedPermission/is_state_allowable x) (pmemlog!main_t.TrustedPermission./TrustedPermission/?is_state_allowable
     x
   ))
   :pattern ((pmemlog!main_t.TrustedPermission./TrustedPermission/is_state_allowable x))
   :qid internal_pmemlog!main_t.TrustedPermission./TrustedPermission/is_state_allowable_accessor_definition
   :skolemid skolem_internal_pmemlog!main_t.TrustedPermission./TrustedPermission/is_state_allowable_accessor_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x TYPE%pmemlog!main_t.TrustedPermission.)
    (has_type (Poly%fun%1. (pmemlog!main_t.TrustedPermission./TrustedPermission/is_state_allowable
       (%Poly%pmemlog!main_t.TrustedPermission. x)
      )
     ) (TYPE%fun%1. $ (TYPE%vstd!seq.Seq. $ (UINT 8)) $ BOOL)
   ))
   :pattern ((pmemlog!main_t.TrustedPermission./TrustedPermission/is_state_allowable (
      %Poly%pmemlog!main_t.TrustedPermission. x
     )
    ) (has_type x TYPE%pmemlog!main_t.TrustedPermission.)
   )
   :qid internal_pmemlog!main_t.TrustedPermission./TrustedPermission/is_state_allowable_invariant_definition
   :skolemid skolem_internal_pmemlog!main_t.TrustedPermission./TrustedPermission/is_state_allowable_invariant_definition
)))
(assert
 (forall ((x pmemlog!main_t.InfiniteLogImpl.)) (!
   (= x (%Poly%pmemlog!main_t.InfiniteLogImpl. (Poly%pmemlog!main_t.InfiniteLogImpl. x)))
   :pattern ((Poly%pmemlog!main_t.InfiniteLogImpl. x))
   :qid internal_pmemlog__main_t__InfiniteLogImpl_box_axiom_definition
   :skolemid skolem_internal_pmemlog__main_t__InfiniteLogImpl_box_axiom_definition
)))
(assert
 (forall ((PM&. Dcr) (PM& Type) (x Poly)) (!
   (=>
    (has_type x (TYPE%pmemlog!main_t.InfiniteLogImpl. PM&. PM&))
    (= x (Poly%pmemlog!main_t.InfiniteLogImpl. (%Poly%pmemlog!main_t.InfiniteLogImpl. x)))
   )
   :pattern ((has_type x (TYPE%pmemlog!main_t.InfiniteLogImpl. PM&. PM&)))
   :qid internal_pmemlog__main_t__InfiniteLogImpl_unbox_axiom_definition
   :skolemid skolem_internal_pmemlog__main_t__InfiniteLogImpl_unbox_axiom_definition
)))
(assert
 (forall ((PM&. Dcr) (PM& Type) (_untrusted_log_impl! pmemlog!logimpl_v.UntrustedLogImpl.)
   (_wrpm! Poly)
  ) (!
   (=>
    (and
     (has_type (Poly%pmemlog!logimpl_v.UntrustedLogImpl. _untrusted_log_impl!) TYPE%pmemlog!logimpl_v.UntrustedLogImpl.)
     (has_type _wrpm! (TYPE%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. $ TYPE%pmemlog!main_t.TrustedPermission.
       PM&. PM&
    )))
    (has_type (Poly%pmemlog!main_t.InfiniteLogImpl. (pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl
       _untrusted_log_impl! _wrpm!
      )
     ) (TYPE%pmemlog!main_t.InfiniteLogImpl. PM&. PM&)
   ))
   :pattern ((has_type (Poly%pmemlog!main_t.InfiniteLogImpl. (pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl
       _untrusted_log_impl! _wrpm!
      )
     ) (TYPE%pmemlog!main_t.InfiniteLogImpl. PM&. PM&)
   ))
   :qid internal_pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl_constructor_definition
   :skolemid skolem_internal_pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl_constructor_definition
)))
(assert
 (forall ((x pmemlog!main_t.InfiniteLogImpl.)) (!
   (= (pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl/untrusted_log_impl x) (pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl/?untrusted_log_impl
     x
   ))
   :pattern ((pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl/untrusted_log_impl x))
   :qid internal_pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl/untrusted_log_impl_accessor_definition
   :skolemid skolem_internal_pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl/untrusted_log_impl_accessor_definition
)))
(assert
 (forall ((PM&. Dcr) (PM& Type) (x Poly)) (!
   (=>
    (has_type x (TYPE%pmemlog!main_t.InfiniteLogImpl. PM&. PM&))
    (has_type (Poly%pmemlog!logimpl_v.UntrustedLogImpl. (pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl/untrusted_log_impl
       (%Poly%pmemlog!main_t.InfiniteLogImpl. x)
      )
     ) TYPE%pmemlog!logimpl_v.UntrustedLogImpl.
   ))
   :pattern ((pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl/untrusted_log_impl (%Poly%pmemlog!main_t.InfiniteLogImpl.
      x
     )
    ) (has_type x (TYPE%pmemlog!main_t.InfiniteLogImpl. PM&. PM&))
   )
   :qid internal_pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl/untrusted_log_impl_invariant_definition
   :skolemid skolem_internal_pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl/untrusted_log_impl_invariant_definition
)))
(assert
 (forall ((x pmemlog!main_t.InfiniteLogImpl.)) (!
   (= (pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl/wrpm x) (pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl/?wrpm
     x
   ))
   :pattern ((pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl/wrpm x))
   :qid internal_pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl/wrpm_accessor_definition
   :skolemid skolem_internal_pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl/wrpm_accessor_definition
)))
(assert
 (forall ((PM&. Dcr) (PM& Type) (x Poly)) (!
   (=>
    (has_type x (TYPE%pmemlog!main_t.InfiniteLogImpl. PM&. PM&))
    (has_type (pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl/wrpm (%Poly%pmemlog!main_t.InfiniteLogImpl.
       x
      )
     ) (TYPE%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. $ TYPE%pmemlog!main_t.TrustedPermission.
      PM&. PM&
   )))
   :pattern ((pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl/wrpm (%Poly%pmemlog!main_t.InfiniteLogImpl.
      x
     )
    ) (has_type x (TYPE%pmemlog!main_t.InfiniteLogImpl. PM&. PM&))
   )
   :qid internal_pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl/wrpm_invariant_definition
   :skolemid skolem_internal_pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl/wrpm_invariant_definition
)))
(assert
 (forall ((x pmemlog!main_t.InfiniteLogImpl.)) (!
   (=>
    (is-pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl x)
    (height_lt (height (pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl/wrpm x)) (height
      (Poly%pmemlog!main_t.InfiniteLogImpl. x)
   )))
   :pattern ((height (pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl/wrpm x)))
   :qid prelude_datatype_height_pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl/wrpm
   :skolemid skolem_prelude_datatype_height_pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl/wrpm
)))
(assert
...
;; Function-Decl pmemlog::main_t::InfiniteLogErr::arrow_required_space
(declare-fun pmemlog!main_t.impl&%3.arrow_required_space.? (Poly) Int)

;; Function-Decl pmemlog::main_t::InfiniteLogErr::arrow_available_space
(declare-fun pmemlog!main_t.impl&%3.arrow_available_space.? (Poly) Int)

;; Function-Decl pmemlog::main_t::InfiniteLogErr::arrow_InsufficientSpaceForSetup_required_space
(declare-fun pmemlog!main_t.impl&%3.arrow_InsufficientSpaceForSetup_required_space.?
 (Poly) Int
)

;; Function-Decl pmemlog::main_t::InfiniteLogErr::arrow_CantReadBeforeHead_head
(declare-fun pmemlog!main_t.impl&%3.arrow_CantReadBeforeHead_head.? (Poly) Int)

;; Function-Decl pmemlog::main_t::InfiniteLogErr::arrow_CantReadPastTail_tail
(declare-fun pmemlog!main_t.impl&%3.arrow_CantReadPastTail_tail.? (Poly) Int)

;; Function-Decl pmemlog::main_t::InfiniteLogErr::arrow_InsufficientSpaceForAppend_available_space
(declare-fun pmemlog!main_t.impl&%3.arrow_InsufficientSpaceForAppend_available_space.?
 (Poly) Int
)

;; Function-Decl pmemlog::main_t::InfiniteLogErr::arrow_CantAdvanceHeadPositionBeforeHead_head
(declare-fun pmemlog!main_t.impl&%3.arrow_CantAdvanceHeadPositionBeforeHead_head.?
 (Poly) Int
)

;; Function-Decl pmemlog::main_t::InfiniteLogErr::arrow_CantAdvanceHeadPositionBeyondTail_tail
(declare-fun pmemlog!main_t.impl&%3.arrow_CantAdvanceHeadPositionBeyondTail_tail.?
 (Poly) Int
)

;; Function-Decl pmemlog::main_t::InfiniteLogImpl::view
(declare-fun pmemlog!main_t.impl&%4.view.? (Dcr Type Poly) core!option.Option.)
...
;; Function-Decl pmemlog::main_t::InfiniteLogImpl::constants
(declare-fun pmemlog!main_t.impl&%4.constants.? (Dcr Type Poly) pmemlog!pmemspec_t.PersistentMemoryConstants.)

;; Function-Decl pmemlog::main_t::InfiniteLogImpl::valid
(declare-fun pmemlog!main_t.impl&%4.valid.? (Dcr Type Poly) Bool)

;; Function-Decl pmemlog::sccf::is_state_allowable
(declare-fun pmemlog!sccf.is_state_allowable.? (Dcr Type Dcr Type Poly Poly Poly Poly)
 Bool
)
 ...
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s! Poly) (j! Poly) (k1! Poly) (k2! Poly) (i! Poly))
   (!
    ...
    :qid user_vstd__seq__lemma_seq_two_subranges_index_9
    :skolemid skolem_user_vstd__seq__lemma_seq_two_subranges_index_9
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_add_len_10
    :skolemid skolem_user_vstd__seq__axiom_seq_add_len_10
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly) (i! Poly)) (!
    ...
    :qid user_vstd__seq__axiom_seq_add_index1_11
    :skolemid skolem_user_vstd__seq__axiom_seq_add_index1_11
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (s1! Poly) (s2! Poly) (i! Poly)) (!
    ...
    :pattern ((vstd!seq.Seq.index.? A&. A& (vstd!seq.Seq.add.? A&. A& s1! s2!) i!))
    :qid user_vstd__seq__axiom_seq_add_index2_12
    :skolemid skolem_user_vstd__seq__axiom_seq_add_index2_12
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (a! Poly) (b! Poly)) (!
    ...
    :qid user_vstd__seq_lib__impl&%0__add_empty_left_13
    :skolemid skolem_user_vstd__seq_lib__impl&%0__add_empty_left_13
))))
...
(assert
 (=>
  ...
  (forall ((A&. Dcr) (A& Type) (a! Poly) (b! Poly)) (!
    ...
    :pattern ((vstd!seq.Seq.add.? A&. A& a! b!))
    :qid user_vstd__seq_lib__impl&%0__add_empty_right_14
    :skolemid skolem_user_vstd__seq_lib__impl&%0__add_empty_right_14
))))
...
(assert
 (=>
  ...
  (forall ((T&. Dcr) (T& Type) (a! Poly)) (!
    ...
    :qid user_vstd__raw_ptr__ptrs_mut_eq_19
    :skolemid skolem_user_vstd__raw_ptr__ptrs_mut_eq_19
))))
...
(assert
 (=>
  ...
  (forall ((T&. Dcr) (T& Type) (a! Poly)) (!
    ...
    :pattern ((vstd!view.View.view.? $ (PTR T&. T&) a!))
    :qid user_vstd__raw_ptr__ptrs_mut_eq_sized_20
    :skolemid skolem_user_vstd__raw_ptr__ptrs_mut_eq_sized_20
))))
...
(assert
 (=>
  ...
  (forall ((T&. Dcr) (T& Type) (A&. Dcr) (A& Type) (v! Poly)) (!
    ...
    :pattern ((vstd!std_specs.vec.spec_vec_len.? T&. T& A&. A& v!))
    :qid user_vstd__std_specs__vec__axiom_spec_len_21
    :skolemid skolem_user_vstd__std_specs__vec__axiom_spec_len_21
))))
...
(assert
 (=>
  ...
  (forall ((T&. Dcr) (T& Type) (vec! Poly) (i! Poly)) (!
    ...
    :qid user_vstd__std_specs__vec__axiom_vec_has_resolved_22
    :skolemid skolem_user_vstd__std_specs__vec__axiom_vec_has_resolved_22
))))
  ...
  (forall ((bytes! Poly) (true_bytes! Poly) (addrs! Poly)) (!
    (= (pmemlog!pmemspec_t.maybe_corrupted.? bytes! true_bytes! addrs!) (and
      ...
      (forall ((i$ Poly)) (!
        ...
        :qid user_pmemlog__pmemspec_t__maybe_corrupted_23
        :skolemid skolem_user_pmemlog__pmemspec_t__maybe_corrupted_23
    ))))
 ...
 (=>
  ...
  (forall ((seq! Poly)) (!
    (= (pmemlog!pmemspec_t.all_elements_unique.? seq!) (forall ((i$ Poly) (j$ Poly)) (!
       ...
       :qid user_pmemlog__pmemspec_t__all_elements_unique_24
       :skolemid skolem_user_pmemlog__pmemspec_t__all_elements_unique_24
    )))
...
(assert
 (forall ((c$ Poly)) (!
   (= (%%apply%%0 %%lambda%%0 c$) (Poly%core!option.Option. (pmemlog!logimpl_v.impl&%0.recover.?
      c$
   )))
   :pattern ((%%apply%%0 %%lambda%%0 c$))
)))
(assert
 (=>
  (fuel_bool fuel%pmemlog!main_t.recovery_view.)
  (forall ((no%param Poly)) (!
    (= (pmemlog!main_t.recovery_view.? no%param) (mk_fun %%lambda%%0))
    ...
    (= (pmemlog!main_t.read_correct_modulo_corruption.? bytes! true_bytes! impervious_to_corruption!)
     (ite
      ...
      (exists ((addrs$ Poly)) (!
        ...
        :pattern ((pmemlog!pmemspec_t.maybe_corrupted.? bytes! true_bytes! addrs$))
        :qid user_pmemlog__main_t__read_correct_modulo_corruption_25
        :skolemid skolem_user_pmemlog__main_t__read_correct_modulo_corruption_25
    ))))
...
;; Function-Axioms pmemlog::main_t::TrustedPermission::check_permission
(assert
 (fuel_bool_default fuel%pmemlog!main_t.impl&%0.check_permission.)
)
(assert
 (=>
  (fuel_bool fuel%pmemlog!main_t.impl&%0.check_permission.)
  (forall ((self! Poly) (state! Poly)) (!
    (= (pmemlog!sccf.CheckPermission.check_permission.? $ TYPE%pmemlog!main_t.TrustedPermission.
      $ (TYPE%vstd!seq.Seq. $ (UINT 8)) self! state!
     ) (%%apply%%0 (pmemlog!main_t.TrustedPermission./TrustedPermission/is_state_allowable
       (%Poly%pmemlog!main_t.TrustedPermission. self!)
      ) state!
    ))
    :pattern ((pmemlog!sccf.CheckPermission.check_permission.? $ TYPE%pmemlog!main_t.TrustedPermission.
      $ (TYPE%vstd!seq.Seq. $ (UINT 8)) self! state!
    ))
    :qid internal_pmemlog!sccf.CheckPermission.check_permission.?_definition
    :skolemid skolem_internal_pmemlog!sccf.CheckPermission.check_permission.?_definition
))))

;; Function-Axioms pmemlog::main_t::InfiniteLogErr::arrow_required_space
(assert
 (fuel_bool_default fuel%pmemlog!main_t.impl&%3.arrow_required_space.)
)
(assert
 (=>
  (fuel_bool fuel%pmemlog!main_t.impl&%3.arrow_required_space.)
  (forall ((self! Poly)) (!
    (= (pmemlog!main_t.impl&%3.arrow_required_space.? self!) (pmemlog!main_t.InfiniteLogErr./InsufficientSpaceForSetup/required_space
      (%Poly%pmemlog!main_t.InfiniteLogErr. self!)
    ))
    :pattern ((pmemlog!main_t.impl&%3.arrow_required_space.? self!))
    :qid internal_pmemlog!main_t.impl&__3.arrow_required_space.?_definition
    :skolemid skolem_internal_pmemlog!main_t.impl&__3.arrow_required_space.?_definition
))))
(assert
 (forall ((self! Poly)) (!
   (=>
    (has_type self! TYPE%pmemlog!main_t.InfiniteLogErr.)
    (uInv 64 (pmemlog!main_t.impl&%3.arrow_required_space.? self!))
   )
   :pattern ((pmemlog!main_t.impl&%3.arrow_required_space.? self!))
   :qid internal_pmemlog!main_t.impl&__3.arrow_required_space.?_pre_post_definition
   :skolemid skolem_internal_pmemlog!main_t.impl&__3.arrow_required_space.?_pre_post_definition
)))

;; Function-Axioms pmemlog::main_t::InfiniteLogErr::arrow_available_space
(assert
 (fuel_bool_default fuel%pmemlog!main_t.impl&%3.arrow_available_space.)
)
(assert
 (=>
  (fuel_bool fuel%pmemlog!main_t.impl&%3.arrow_available_space.)
  (forall ((self! Poly)) (!
    (= (pmemlog!main_t.impl&%3.arrow_available_space.? self!) (pmemlog!main_t.InfiniteLogErr./InsufficientSpaceForAppend/available_space
      (%Poly%pmemlog!main_t.InfiniteLogErr. self!)
    ))
    :pattern ((pmemlog!main_t.impl&%3.arrow_available_space.? self!))
    :qid internal_pmemlog!main_t.impl&__3.arrow_available_space.?_definition
    :skolemid skolem_internal_pmemlog!main_t.impl&__3.arrow_available_space.?_definition
))))
(assert
 (forall ((self! Poly)) (!
   (=>
    (has_type self! TYPE%pmemlog!main_t.InfiniteLogErr.)
    (uInv 64 (pmemlog!main_t.impl&%3.arrow_available_space.? self!))
   )
   :pattern ((pmemlog!main_t.impl&%3.arrow_available_space.? self!))
   :qid internal_pmemlog!main_t.impl&__3.arrow_available_space.?_pre_post_definition
   :skolemid skolem_internal_pmemlog!main_t.impl&__3.arrow_available_space.?_pre_post_definition
)))

;; Function-Axioms pmemlog::main_t::InfiniteLogErr::arrow_InsufficientSpaceForSetup_required_space
(assert
 (fuel_bool_default fuel%pmemlog!main_t.impl&%3.arrow_InsufficientSpaceForSetup_required_space.)
)
(assert
 (=>
  (fuel_bool fuel%pmemlog!main_t.impl&%3.arrow_InsufficientSpaceForSetup_required_space.)
  (forall ((self! Poly)) (!
    (= (pmemlog!main_t.impl&%3.arrow_InsufficientSpaceForSetup_required_space.? self!)
     (pmemlog!main_t.InfiniteLogErr./InsufficientSpaceForSetup/required_space (%Poly%pmemlog!main_t.InfiniteLogErr.
       self!
    )))
    :pattern ((pmemlog!main_t.impl&%3.arrow_InsufficientSpaceForSetup_required_space.?
      self!
    ))
    :qid internal_pmemlog!main_t.impl&__3.arrow_InsufficientSpaceForSetup_required_space.?_definition
    :skolemid skolem_internal_pmemlog!main_t.impl&__3.arrow_InsufficientSpaceForSetup_required_space.?_definition
))))
(assert
 (forall ((self! Poly)) (!
   (=>
    (has_type self! TYPE%pmemlog!main_t.InfiniteLogErr.)
    (uInv 64 (pmemlog!main_t.impl&%3.arrow_InsufficientSpaceForSetup_required_space.? self!))
   )
   :pattern ((pmemlog!main_t.impl&%3.arrow_InsufficientSpaceForSetup_required_space.?
     self!
   ))
   :qid internal_pmemlog!main_t.impl&__3.arrow_InsufficientSpaceForSetup_required_space.?_pre_post_definition
   :skolemid skolem_internal_pmemlog!main_t.impl&__3.arrow_InsufficientSpaceForSetup_required_space.?_pre_post_definition
)))

;; Function-Axioms pmemlog::main_t::InfiniteLogErr::arrow_CantReadBeforeHead_head
(assert
 (fuel_bool_default fuel%pmemlog!main_t.impl&%3.arrow_CantReadBeforeHead_head.)
)
(assert
 (=>
  (fuel_bool fuel%pmemlog!main_t.impl&%3.arrow_CantReadBeforeHead_head.)
  (forall ((self! Poly)) (!
    (= (pmemlog!main_t.impl&%3.arrow_CantReadBeforeHead_head.? self!) (pmemlog!main_t.InfiniteLogErr./CantReadBeforeHead/head
      (%Poly%pmemlog!main_t.InfiniteLogErr. self!)
    ))
    :pattern ((pmemlog!main_t.impl&%3.arrow_CantReadBeforeHead_head.? self!))
    :qid internal_pmemlog!main_t.impl&__3.arrow_CantReadBeforeHead_head.?_definition
    :skolemid skolem_internal_pmemlog!main_t.impl&__3.arrow_CantReadBeforeHead_head.?_definition
))))
(assert
 (forall ((self! Poly)) (!
   (=>
    (has_type self! TYPE%pmemlog!main_t.InfiniteLogErr.)
    (uInv 64 (pmemlog!main_t.impl&%3.arrow_CantReadBeforeHead_head.? self!))
   )
   :pattern ((pmemlog!main_t.impl&%3.arrow_CantReadBeforeHead_head.? self!))
   :qid internal_pmemlog!main_t.impl&__3.arrow_CantReadBeforeHead_head.?_pre_post_definition
   :skolemid skolem_internal_pmemlog!main_t.impl&__3.arrow_CantReadBeforeHead_head.?_pre_post_definition
)))

;; Function-Axioms pmemlog::main_t::InfiniteLogErr::arrow_CantReadPastTail_tail
(assert
 (fuel_bool_default fuel%pmemlog!main_t.impl&%3.arrow_CantReadPastTail_tail.)
)
(assert
 (=>
  (fuel_bool fuel%pmemlog!main_t.impl&%3.arrow_CantReadPastTail_tail.)
  (forall ((self! Poly)) (!
    (= (pmemlog!main_t.impl&%3.arrow_CantReadPastTail_tail.? self!) (pmemlog!main_t.InfiniteLogErr./CantReadPastTail/tail
      (%Poly%pmemlog!main_t.InfiniteLogErr. self!)
    ))
    :pattern ((pmemlog!main_t.impl&%3.arrow_CantReadPastTail_tail.? self!))
    :qid internal_pmemlog!main_t.impl&__3.arrow_CantReadPastTail_tail.?_definition
    :skolemid skolem_internal_pmemlog!main_t.impl&__3.arrow_CantReadPastTail_tail.?_definition
))))
(assert
 (forall ((self! Poly)) (!
   (=>
    (has_type self! TYPE%pmemlog!main_t.InfiniteLogErr.)
    (uInv 64 (pmemlog!main_t.impl&%3.arrow_CantReadPastTail_tail.? self!))
   )
   :pattern ((pmemlog!main_t.impl&%3.arrow_CantReadPastTail_tail.? self!))
   :qid internal_pmemlog!main_t.impl&__3.arrow_CantReadPastTail_tail.?_pre_post_definition
   :skolemid skolem_internal_pmemlog!main_t.impl&__3.arrow_CantReadPastTail_tail.?_pre_post_definition
)))

;; Function-Axioms pmemlog::main_t::InfiniteLogErr::arrow_InsufficientSpaceForAppend_available_space
(assert
 (fuel_bool_default fuel%pmemlog!main_t.impl&%3.arrow_InsufficientSpaceForAppend_available_space.)
)
(assert
 (=>
  (fuel_bool fuel%pmemlog!main_t.impl&%3.arrow_InsufficientSpaceForAppend_available_space.)
  (forall ((self! Poly)) (!
    (= (pmemlog!main_t.impl&%3.arrow_InsufficientSpaceForAppend_available_space.? self!)
     (pmemlog!main_t.InfiniteLogErr./InsufficientSpaceForAppend/available_space (%Poly%pmemlog!main_t.InfiniteLogErr.
       self!
    )))
    :pattern ((pmemlog!main_t.impl&%3.arrow_InsufficientSpaceForAppend_available_space.?
      self!
    ))
    :qid internal_pmemlog!main_t.impl&__3.arrow_InsufficientSpaceForAppend_available_space.?_definition
    :skolemid skolem_internal_pmemlog!main_t.impl&__3.arrow_InsufficientSpaceForAppend_available_space.?_definition
))))
(assert
 (forall ((self! Poly)) (!
   (=>
    (has_type self! TYPE%pmemlog!main_t.InfiniteLogErr.)
    (uInv 64 (pmemlog!main_t.impl&%3.arrow_InsufficientSpaceForAppend_available_space.?
      self!
   )))
   :pattern ((pmemlog!main_t.impl&%3.arrow_InsufficientSpaceForAppend_available_space.?
     self!
   ))
   :qid internal_pmemlog!main_t.impl&__3.arrow_InsufficientSpaceForAppend_available_space.?_pre_post_definition
   :skolemid skolem_internal_pmemlog!main_t.impl&__3.arrow_InsufficientSpaceForAppend_available_space.?_pre_post_definition
)))

;; Function-Axioms pmemlog::main_t::InfiniteLogErr::arrow_CantAdvanceHeadPositionBeforeHead_head
(assert
 (fuel_bool_default fuel%pmemlog!main_t.impl&%3.arrow_CantAdvanceHeadPositionBeforeHead_head.)
)
(assert
 (=>
  (fuel_bool fuel%pmemlog!main_t.impl&%3.arrow_CantAdvanceHeadPositionBeforeHead_head.)
  (forall ((self! Poly)) (!
    (= (pmemlog!main_t.impl&%3.arrow_CantAdvanceHeadPositionBeforeHead_head.? self!) (
      pmemlog!main_t.InfiniteLogErr./CantAdvanceHeadPositionBeforeHead/head (%Poly%pmemlog!main_t.InfiniteLogErr.
       self!
    )))
    :pattern ((pmemlog!main_t.impl&%3.arrow_CantAdvanceHeadPositionBeforeHead_head.? self!))
    :qid internal_pmemlog!main_t.impl&__3.arrow_CantAdvanceHeadPositionBeforeHead_head.?_definition
    :skolemid skolem_internal_pmemlog!main_t.impl&__3.arrow_CantAdvanceHeadPositionBeforeHead_head.?_definition
))))
(assert
 (forall ((self! Poly)) (!
   (=>
    (has_type self! TYPE%pmemlog!main_t.InfiniteLogErr.)
    (uInv 64 (pmemlog!main_t.impl&%3.arrow_CantAdvanceHeadPositionBeforeHead_head.? self!))
   )
   :pattern ((pmemlog!main_t.impl&%3.arrow_CantAdvanceHeadPositionBeforeHead_head.? self!))
   :qid internal_pmemlog!main_t.impl&__3.arrow_CantAdvanceHeadPositionBeforeHead_head.?_pre_post_definition
   :skolemid skolem_internal_pmemlog!main_t.impl&__3.arrow_CantAdvanceHeadPositionBeforeHead_head.?_pre_post_definition
)))

;; Function-Axioms pmemlog::main_t::InfiniteLogErr::arrow_CantAdvanceHeadPositionBeyondTail_tail
(assert
 (fuel_bool_default fuel%pmemlog!main_t.impl&%3.arrow_CantAdvanceHeadPositionBeyondTail_tail.)
)
(assert
 (=>
  (fuel_bool fuel%pmemlog!main_t.impl&%3.arrow_CantAdvanceHeadPositionBeyondTail_tail.)
  (forall ((self! Poly)) (!
    (= (pmemlog!main_t.impl&%3.arrow_CantAdvanceHeadPositionBeyondTail_tail.? self!) (
      pmemlog!main_t.InfiniteLogErr./CantAdvanceHeadPositionBeyondTail/tail (%Poly%pmemlog!main_t.InfiniteLogErr.
       self!
    )))
    :pattern ((pmemlog!main_t.impl&%3.arrow_CantAdvanceHeadPositionBeyondTail_tail.? self!))
    :qid internal_pmemlog!main_t.impl&__3.arrow_CantAdvanceHeadPositionBeyondTail_tail.?_definition
    :skolemid skolem_internal_pmemlog!main_t.impl&__3.arrow_CantAdvanceHeadPositionBeyondTail_tail.?_definition
))))
(assert
 (forall ((self! Poly)) (!
   (=>
    (has_type self! TYPE%pmemlog!main_t.InfiniteLogErr.)
    (uInv 64 (pmemlog!main_t.impl&%3.arrow_CantAdvanceHeadPositionBeyondTail_tail.? self!))
   )
   :pattern ((pmemlog!main_t.impl&%3.arrow_CantAdvanceHeadPositionBeyondTail_tail.? self!))
   :qid internal_pmemlog!main_t.impl&__3.arrow_CantAdvanceHeadPositionBeyondTail_tail.?_pre_post_definition
   :skolemid skolem_internal_pmemlog!main_t.impl&__3.arrow_CantAdvanceHeadPositionBeyondTail_tail.?_pre_post_definition
)))

;; Trait-Impl-Axiom
(assert
 (tr_bound%pmemlog!sccf.CheckPermission. $ TYPE%pmemlog!main_t.TrustedPermission. $
  (TYPE%vstd!seq.Seq. $ (UINT 8))
))

;; Function-Axioms pmemlog::main_t::InfiniteLogImpl::view
(assert
 (fuel_bool_default fuel%pmemlog!main_t.impl&%4.view.)
)
(assert
 (=>
  (fuel_bool fuel%pmemlog!main_t.impl&%4.view.)
  (forall ((PM&. Dcr) (PM& Type) (self! Poly)) (!
    (= (pmemlog!main_t.impl&%4.view.? PM&. PM& self!) (%Poly%core!option.Option. (%%apply%%0
       (pmemlog!main_t.recovery_view.? (I 0)) (Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.impl&%0.view.?
         $ TYPE%pmemlog!main_t.TrustedPermission. PM&. PM& (pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl/wrpm
          (%Poly%pmemlog!main_t.InfiniteLogImpl. self!)
    ))))))
    :pattern ((pmemlog!main_t.impl&%4.view.? PM&. PM& self!))
    :qid internal_pmemlog!main_t.impl&__4.view.?_definition
    :skolemid skolem_internal_pmemlog!main_t.impl&__4.view.?_definition
))))
(assert
 (forall ((PM&. Dcr) (PM& Type) (self! Poly)) (!
   (=>
    (has_type self! (TYPE%pmemlog!main_t.InfiniteLogImpl. PM&. PM&))
    (has_type (Poly%core!option.Option. (pmemlog!main_t.impl&%4.view.? PM&. PM& self!))
     (TYPE%core!option.Option. $ TYPE%pmemlog!infinitelog_t.AbstractInfiniteLogState.)
   ))
   :pattern ((pmemlog!main_t.impl&%4.view.? PM&. PM& self!))
   :qid internal_pmemlog!main_t.impl&__4.view.?_pre_post_definition
   :skolemid skolem_internal_pmemlog!main_t.impl&__4.view.?_pre_post_definition
)))

;; Function-Axioms pmemlog::main_t::InfiniteLogImpl::constants
(assert
 (fuel_bool_default fuel%pmemlog!main_t.impl&%4.constants.)
)
(assert
 (=>
  (fuel_bool fuel%pmemlog!main_t.impl&%4.constants.)
  (forall ((PM&. Dcr) (PM& Type) (self! Poly)) (!
    (= (pmemlog!main_t.impl&%4.constants.? PM&. PM& self!) (pmemlog!pmemspec_t.impl&%0.constants.?
      $ TYPE%pmemlog!main_t.TrustedPermission. PM&. PM& (pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl/wrpm
       (%Poly%pmemlog!main_t.InfiniteLogImpl. self!)
    )))
    :pattern ((pmemlog!main_t.impl&%4.constants.? PM&. PM& self!))
    :qid internal_pmemlog!main_t.impl&__4.constants.?_definition
    :skolemid skolem_internal_pmemlog!main_t.impl&__4.constants.?_definition
))))

;; Function-Axioms pmemlog::main_t::InfiniteLogImpl::valid
(assert
 (fuel_bool_default fuel%pmemlog!main_t.impl&%4.valid.)
)
(assert
 (=>
  (fuel_bool fuel%pmemlog!main_t.impl&%4.valid.)
  (forall ((PM&. Dcr) (PM& Type) (self! Poly)) (!
    (= (pmemlog!main_t.impl&%4.valid.? PM&. PM& self!) (and
      (pmemlog!logimpl_v.impl&%0.inv.? $ TYPE%pmemlog!main_t.TrustedPermission. PM&. PM&
       (Poly%pmemlog!logimpl_v.UntrustedLogImpl. (pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl/untrusted_log_impl
         (%Poly%pmemlog!main_t.InfiniteLogImpl. self!)
        )
       ) (pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl/wrpm (%Poly%pmemlog!main_t.InfiniteLogImpl.
         self!
      )))
      (is-core!option.Option./Some (%Poly%core!option.Option. (%%apply%%0 (pmemlog!main_t.recovery_view.?
          (I 0)
         ) (Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.impl&%0.view.? $ TYPE%pmemlog!main_t.TrustedPermission.
           PM&. PM& (pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl/wrpm (%Poly%pmemlog!main_t.InfiniteLogImpl.
             self!
    )))))))))
    :pattern ((pmemlog!main_t.impl&%4.valid.? PM&. PM& self!))
    :qid internal_pmemlog!main_t.impl&__4.valid.?_definition
    :skolemid skolem_internal_pmemlog!main_t.impl&__4.valid.?_definition
))))

;; Function-Axioms pmemlog::sccf::is_state_allowable
(assert
 (fuel_bool_default fuel%pmemlog!sccf.is_state_allowable.)
)
(assert
 (=>
  (fuel_bool fuel%pmemlog!sccf.is_state_allowable.)
  (forall ((AbstractStorage&. Dcr) (AbstractStorage& Type) (AbstractService&. Dcr) (AbstractService&
     Type
    ) (pre_operation_state! Poly) (crash_state! Poly) (recovery_view! Poly) (abstract_next!
     Poly
    )
   ) (!
    (= (pmemlog!sccf.is_state_allowable.? AbstractStorage&. AbstractStorage& AbstractService&.
      AbstractService& pre_operation_state! crash_state! recovery_view! abstract_next!
     ) (let
      ((pre_operation_abstract_state$ (%Poly%core!option.Option. (%%apply%%0 (%Poly%fun%1. recovery_view!)
          pre_operation_state!
      ))))
      (let
       ((crash_abstract_state$ (%Poly%core!option.Option. (%%apply%%0 (%Poly%fun%1. recovery_view!)
           crash_state!
       ))))
       (or
        ...
        (and
         (and
          (is-core!option.Option./Some pre_operation_abstract_state$)
          (is-core!option.Option./Some crash_abstract_state$)
         )
         (%B (%%apply%%1 (%Poly%fun%2. abstract_next!) (core!option.Option./Some/0 AbstractService&.
            AbstractService& (%Poly%core!option.Option. (Poly%core!option.Option. pre_operation_abstract_state$))
           ) (core!option.Option./Some/0 AbstractService&. AbstractService& (%Poly%core!option.Option.
             (Poly%core!option.Option. crash_abstract_state$)
    )))))))))
    :pattern ((pmemlog!sccf.is_state_allowable.? AbstractStorage&. AbstractStorage& AbstractService&.
      AbstractService& pre_operation_state! crash_state! recovery_view! abstract_next!
    ))
    :qid internal_pmemlog!sccf.is_state_allowable.?_definition
    :skolemid skolem_internal_pmemlog!sccf.is_state_allowable.?_definition
))))
   ...
   (= (req%pmemlog!logimpl_v.impl&%0.untrusted_start. Perm&. Perm& PM&. PM& pre%wrpm!
     ...
     (=>
      ...
      (forall ((pm_state$ Poly)) (!
        ...
        :qid user_pmemlog__logimpl_v__UntrustedLogImpl__untrusted_start_26
        :skolemid skolem_user_pmemlog__logimpl_v__UntrustedLogImpl__untrusted_start_26
   )))))
     ...
     (=>
      ...
      (let
       ...
       (forall ((pm_state$ Poly)) (!
         ...
         :qid user_pmemlog__logimpl_v__UntrustedLogImpl__untrusted_append_27
         :skolemid skolem_user_pmemlog__logimpl_v__UntrustedLogImpl__untrusted_append_27
   ))))))
     ...
     (=>
      ...
      (let
       ...
       (forall ((pm_state$ Poly)) (!
         ...
         :qid user_pmemlog__logimpl_v__UntrustedLogImpl__untrusted_advance_head_28
         :skolemid skolem_user_pmemlog__logimpl_v__UntrustedLogImpl__untrusted_advance_head_28
   ))))))
...
;; Function-Specs pmemlog::logimpl_v::UntrustedLogImpl::untrusted_get_head_and_tail
(declare-fun req%pmemlog!logimpl_v.impl&%0.untrusted_get_head_and_tail. (Dcr Type Dcr
  Type pmemlog!logimpl_v.UntrustedLogImpl. Poly
 ) Bool
)
...
(assert
 (forall ((Perm&. Dcr) (Perm& Type) (PM&. Dcr) (PM& Type) (self! pmemlog!logimpl_v.UntrustedLogImpl.)
   ...
   (= (req%pmemlog!logimpl_v.impl&%0.untrusted_get_head_and_tail. Perm&. Perm& PM&. PM&
     self! wrpm!
    ) (and
     (=>
   ...
   :pattern ((req%pmemlog!logimpl_v.impl&%0.untrusted_get_head_and_tail. Perm&. Perm&
     PM&. PM& self! wrpm!
   ))
   :qid internal_req__pmemlog!logimpl_v.impl&__0.untrusted_get_head_and_tail._definition
   :skolemid skolem_internal_req__pmemlog!logimpl_v.impl&__0.untrusted_get_head_and_tail._definition
)))
(declare-fun ens%pmemlog!logimpl_v.impl&%0.untrusted_get_head_and_tail. (Dcr Type Dcr
  Type pmemlog!logimpl_v.UntrustedLogImpl. Poly core!result.Result.
 ) Bool
)
(assert
 (forall ((Perm&. Dcr) (Perm& Type) (PM&. Dcr) (PM& Type) (self! pmemlog!logimpl_v.UntrustedLogImpl.)
   (wrpm! Poly) (result! core!result.Result.)
  ) (!
   (= (ens%pmemlog!logimpl_v.impl&%0.untrusted_get_head_and_tail. Perm&. Perm& PM&. PM&
     self! wrpm! result!
    ) (and
     (has_type (Poly%core!result.Result. result!) (TYPE%core!result.Result. (DST $) (TYPE%tuple%3.
     ...
     (and
      (and
       (is-core!result.Result./Ok result!)
       (is-tuple%3./tuple%3 (%Poly%tuple%3. (core!result.Result./Ok/0 (DST $) (TYPE%tuple%3.
           $ (UINT 64) $ (UINT 64) $ (UINT 64)
          ) $ TYPE%pmemlog!main_t.InfiniteLogErr. (%Poly%core!result.Result. (Poly%core!result.Result.
            result!
      ))))))
      (let
       ((result_head$ (%I (tuple%3./tuple%3/0 (%Poly%tuple%3. (core!result.Result./Ok/0 (DST $)
             (TYPE%tuple%3. $ (UINT 64) $ (UINT 64) $ (UINT 64)) $ TYPE%pmemlog!main_t.InfiniteLogErr.
             (%Poly%core!result.Result. (Poly%core!result.Result. result!))
       ))))))
       (let
        ((result_tail$ (%I (tuple%3./tuple%3/1 (%Poly%tuple%3. (core!result.Result./Ok/0 (DST $)
              (TYPE%tuple%3. $ (UINT 64) $ (UINT 64) $ (UINT 64)) $ TYPE%pmemlog!main_t.InfiniteLogErr.
              (%Poly%core!result.Result. (Poly%core!result.Result. result!))
        ))))))
        (let
         ((result_capacity$ (%I (tuple%3./tuple%3/2 (%Poly%tuple%3. (core!result.Result./Ok/0 (DST
                $
               ) (TYPE%tuple%3. $ (UINT 64) $ (UINT 64) $ (UINT 64)) $ TYPE%pmemlog!main_t.InfiniteLogErr.
               (%Poly%core!result.Result. (Poly%core!result.Result. result!))
         ))))))
         (let
          ((tmp%%$ (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (core!option.Option./Some/0
              $ TYPE%pmemlog!infinitelog_t.AbstractInfiniteLogState. (%Poly%core!option.Option.
               (Poly%core!option.Option. (pmemlog!logimpl_v.impl&%0.recover.? (Poly%vstd!seq.Seq<u8.>.
                  (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!)
          ))))))))
          (let
           ...
           (let
            ((log$ (pmemlog!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/log
               (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
                 tmp%%$
            )))))
            (let
             ((capacity$ (pmemlog!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/capacity
                (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
                  tmp%%$
             )))))
             (and
              (and
               (= result_head$ head$)
               (= result_tail$ (Add head$ (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. log$))))
              )
              (= result_capacity$ capacity$)
   )))))))))))
   :pattern ((ens%pmemlog!logimpl_v.impl&%0.untrusted_get_head_and_tail. Perm&. Perm&
     PM&. PM& self! wrpm! result!
   ))
   :qid internal_ens__pmemlog!logimpl_v.impl&__0.untrusted_get_head_and_tail._definition
   :skolemid skolem_internal_ens__pmemlog!logimpl_v.impl&__0.untrusted_get_head_and_tail._definition
)))

;; Function-Specs pmemlog::main_t::TrustedPermission::new
(declare-fun ens%pmemlog!main_t.impl&%1.new. (vstd!seq.Seq<u8.>. %%Function%% pmemlog!main_t.TrustedPermission.)
 Bool
)
(assert
 (forall ((cur! vstd!seq.Seq<u8.>.) (next! %%Function%%) (perm! pmemlog!main_t.TrustedPermission.))
  (!
   (= (ens%pmemlog!main_t.impl&%1.new. cur! next! perm!) (and
     (has_type (Poly%pmemlog!main_t.TrustedPermission. perm!) TYPE%pmemlog!main_t.TrustedPermission.)
     (forall ((s$ Poly)) (!
       (=>
        (has_type s$ (TYPE%vstd!seq.Seq. $ (UINT 8)))
        (= (%B (pmemlog!sccf.CheckPermission.check_permission.? $ TYPE%pmemlog!main_t.TrustedPermission.
           $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%pmemlog!main_t.TrustedPermission. perm!)
           s$
          )
         ) (pmemlog!sccf.is_state_allowable.? $ (TYPE%vstd!seq.Seq. $ (UINT 8)) $ TYPE%pmemlog!infinitelog_t.AbstractInfiniteLogState.
          (Poly%vstd!seq.Seq<u8.>. cur!) s$ (Poly%fun%1. (pmemlog!main_t.recovery_view.? (I 0)))
          (Poly%fun%2. next!)
       )))
       :pattern ((pmemlog!sccf.CheckPermission.check_permission.? $ TYPE%pmemlog!main_t.TrustedPermission.
         $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%pmemlog!main_t.TrustedPermission. perm!)
       ...
       :qid user_pmemlog__main_t__TrustedPermission__new_29
       :skolemid skolem_user_pmemlog__main_t__TrustedPermission__new_29
   ))))
   :pattern ((ens%pmemlog!main_t.impl&%1.new. cur! next! perm!))
   :qid internal_ens__pmemlog!main_t.impl&__1.new._definition
   :skolemid skolem_internal_ens__pmemlog!main_t.impl&__1.new._definition
)))

;; Function-Specs pmemlog::main_t::InfiniteLogImpl::setup
(declare-fun req%pmemlog!main_t.impl&%4.setup. (Dcr Type Poly Int) Bool)
(declare-const %%global_location_label%%24 Bool)
(declare-const %%global_location_label%%25 Bool)
(assert
 (forall ((PM&. Dcr) (PM& Type) (pre%pm! Poly) (device_size! Int)) (!
   (= (req%pmemlog!main_t.impl&%4.setup. PM&. PM& pre%pm! device_size!) (and
     (=>
   ...
   :pattern ((req%pmemlog!main_t.impl&%4.setup. PM&. PM& pre%pm! device_size!))
   :qid internal_req__pmemlog!main_t.impl&__4.setup._definition
   :skolemid skolem_internal_req__pmemlog!main_t.impl&__4.setup._definition
)))
(declare-fun ens%pmemlog!main_t.impl&%4.setup. (Dcr Type Poly Poly Int core!result.Result.)
 Bool
)
(assert
 (forall ((PM&. Dcr) (PM& Type) (pre%pm! Poly) (pm! Poly) (device_size! Int) (result!
   ...
   (= (ens%pmemlog!main_t.impl&%4.setup. PM&. PM& pre%pm! pm! device_size! result!) (
     and
     (has_type (Poly%core!result.Result. result!) (TYPE%core!result.Result. $ (UINT 64)
       $ TYPE%pmemlog!main_t.InfiniteLogErr.
     ))
     ...
     (ite
      (is-core!result.Result./Ok result!)
      (let
       ((log_capacity$ (%I (core!result.Result./Ok/0 $ (UINT 64) $ TYPE%pmemlog!main_t.InfiniteLogErr.
           (%Poly%core!result.Result. (Poly%core!result.Result. result!))
       ))))
       (= (%Poly%core!option.Option. (%%apply%%0 (pmemlog!main_t.recovery_view.? (I 0)) (pmemlog!pmemspec_t.PersistentMemory.view.?
           PM&. PM& pm!
         ))
        ) (core!option.Option./Some (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (
           pmemlog!infinitelog_t.impl&%0.initialize.? (I log_capacity$)
      )))))
      (and
       (and
        (is-core!result.Result./Err result!)
   ...
   :pattern ((ens%pmemlog!main_t.impl&%4.setup. PM&. PM& pre%pm! pm! device_size! result!))
   :qid internal_ens__pmemlog!main_t.impl&__4.setup._definition
   :skolemid skolem_internal_ens__pmemlog!main_t.impl&__4.setup._definition
)))

;; Function-Specs pmemlog::pmemspec_t::WriteRestrictedPersistentMemory::new
(declare-fun req%pmemlog!pmemspec_t.impl&%0.new. (Dcr Type Dcr Type Poly) Bool)
(declare-const %%global_location_label%%26 Bool)
(assert
 (forall ((Perm&. Dcr) (Perm& Type) (PM&. Dcr) (PM& Type) (pm! Poly)) (!
   (= (req%pmemlog!pmemspec_t.impl&%0.new. Perm&. Perm& PM&. PM& pm!) (=>
     %%global_location_label%%26
     (%B (pmemlog!pmemspec_t.PersistentMemory.inv.? PM&. PM& pm!))
   ))
   :pattern ((req%pmemlog!pmemspec_t.impl&%0.new. Perm&. Perm& PM&. PM& pm!))
   :qid internal_req__pmemlog!pmemspec_t.impl&__0.new._definition
   :skolemid skolem_internal_req__pmemlog!pmemspec_t.impl&__0.new._definition
)))
(declare-fun ens%pmemlog!pmemspec_t.impl&%0.new. (Dcr Type Dcr Type Poly Poly) Bool)
(assert
 (forall ((Perm&. Dcr) (Perm& Type) (PM&. Dcr) (PM& Type) (pm! Poly) (wrpm! Poly))
  (!
   (= (ens%pmemlog!pmemspec_t.impl&%0.new. Perm&. Perm& PM&. PM& pm! wrpm!) (and
     (has_type wrpm! (TYPE%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. Perm&. Perm&
       PM&. PM&
     ))
     (= (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& wrpm!) (%Poly%vstd!seq.Seq<u8.>.
       (pmemlog!pmemspec_t.PersistentMemory.view.? PM&. PM& pm!)
     ))
     (pmemlog!pmemspec_t.impl&%0.inv.? Perm&. Perm& PM&. PM& wrpm!)
     (= (pmemlog!pmemspec_t.impl&%0.constants.? Perm&. Perm& PM&. PM& wrpm!) (%Poly%pmemlog!pmemspec_t.PersistentMemoryConstants.
       (pmemlog!pmemspec_t.PersistentMemory.constants.? PM&. PM& pm!)
   ))))
   :pattern ((ens%pmemlog!pmemspec_t.impl&%0.new. Perm&. Perm& PM&. PM& pm! wrpm!))
   :qid internal_ens__pmemlog!pmemspec_t.impl&__0.new._definition
   :skolemid skolem_internal_ens__pmemlog!pmemspec_t.impl&__0.new._definition
)))

;; Function-Specs pmemlog::main_t::InfiniteLogImpl::start
(declare-fun req%pmemlog!main_t.impl&%4.start. (Dcr Type Poly Int) Bool)
(declare-const %%global_location_label%%27 Bool)
(declare-const %%global_location_label%%28 Bool)
(declare-const %%global_location_label%%29 Bool)
(assert
 (forall ((PM&. Dcr) (PM& Type) (pm! Poly) (device_size! Int)) (!
   (= (req%pmemlog!main_t.impl&%4.start. PM&. PM& pm! device_size!) (and
     (=>
   ...
   :pattern ((req%pmemlog!main_t.impl&%4.start. PM&. PM& pm! device_size!))
   :qid internal_req__pmemlog!main_t.impl&__4.start._definition
   :skolemid skolem_internal_req__pmemlog!main_t.impl&__4.start._definition
)))
(declare-fun ens%pmemlog!main_t.impl&%4.start. (Dcr Type Poly Int core!result.Result.)
 Bool
)
(assert
 (forall ((PM&. Dcr) (PM& Type) (pm! Poly) (device_size! Int) (result! core!result.Result.))
  (!
   (= (ens%pmemlog!main_t.impl&%4.start. PM&. PM& pm! device_size! result!) (and
     (has_type (Poly%core!result.Result. result!) (TYPE%core!result.Result. $ (TYPE%pmemlog!main_t.InfiniteLogImpl.
        PM&. PM&
       ) $ TYPE%pmemlog!main_t.InfiniteLogErr.
     ))
     (ite
      (is-core!result.Result./Ok result!)
      (let
       ((trusted_log_impl$ (%Poly%pmemlog!main_t.InfiniteLogImpl. (core!result.Result./Ok/0
           $ (TYPE%pmemlog!main_t.InfiniteLogImpl. PM&. PM&) $ TYPE%pmemlog!main_t.InfiniteLogErr.
           (%Poly%core!result.Result. (Poly%core!result.Result. result!))
       ))))
       (and
        (and
         (pmemlog!main_t.impl&%4.valid.? PM&. PM& (Poly%pmemlog!main_t.InfiniteLogImpl. trusted_log_impl$))
         (= (pmemlog!main_t.impl&%4.view.? PM&. PM& (Poly%pmemlog!main_t.InfiniteLogImpl. trusted_log_impl$))
          (%Poly%core!option.Option. (%%apply%%0 (pmemlog!main_t.recovery_view.? (I 0)) (pmemlog!pmemspec_t.PersistentMemory.view.?
             PM&. PM& pm!
        )))))
        (= (pmemlog!main_t.impl&%4.constants.? PM&. PM& (Poly%pmemlog!main_t.InfiniteLogImpl.
           trusted_log_impl$
          )
      ...
      (and
       (and
        (is-core!result.Result./Err result!)
        (is-pmemlog!main_t.InfiniteLogErr./CRCMismatch (%Poly%pmemlog!main_t.InfiniteLogErr.
          (core!result.Result./Err/0 $ (TYPE%pmemlog!main_t.InfiniteLogImpl. PM&. PM&) $ TYPE%pmemlog!main_t.InfiniteLogErr.
           (%Poly%core!result.Result. (Poly%core!result.Result. result!))
       ))))
       (not (pmemlog!pmemspec_t.PersistentMemoryConstants./PersistentMemoryConstants/impervious_to_corruption
         (%Poly%pmemlog!pmemspec_t.PersistentMemoryConstants. (pmemlog!pmemspec_t.PersistentMemory.constants.?
   ...
   :pattern ((ens%pmemlog!main_t.impl&%4.start. PM&. PM& pm! device_size! result!))
   :qid internal_ens__pmemlog!main_t.impl&__4.start._definition
   :skolemid skolem_internal_ens__pmemlog!main_t.impl&__4.start._definition
)))

;; Function-Specs pmemlog::main_t::InfiniteLogImpl::append
(declare-fun req%pmemlog!main_t.impl&%4.append. (Dcr Type pmemlog!main_t.InfiniteLogImpl.
  alloc!vec.Vec<u8./allocator_global%.>.
 ) Bool
)
(declare-const %%global_location_label%%30 Bool)
(assert
 (forall ((PM&. Dcr) (PM& Type) (pre%self! pmemlog!main_t.InfiniteLogImpl.) (bytes_to_append!
    alloc!vec.Vec<u8./allocator_global%.>.
   )
  ) (!
   (= (req%pmemlog!main_t.impl&%4.append. PM&. PM& pre%self! bytes_to_append!) (=>
     %%global_location_label%%30
     (pmemlog!main_t.impl&%4.valid.? PM&. PM& (Poly%pmemlog!main_t.InfiniteLogImpl. pre%self!))
   ))
   :pattern ((req%pmemlog!main_t.impl&%4.append. PM&. PM& pre%self! bytes_to_append!))
   :qid internal_req__pmemlog!main_t.impl&__4.append._definition
   :skolemid skolem_internal_req__pmemlog!main_t.impl&__4.append._definition
)))
(declare-fun ens%pmemlog!main_t.impl&%4.append. (Dcr Type pmemlog!main_t.InfiniteLogImpl.
  pmemlog!main_t.InfiniteLogImpl. alloc!vec.Vec<u8./allocator_global%.>. core!result.Result.
 ) Bool
)
(assert
 (forall ((PM&. Dcr) (PM& Type) (pre%self! pmemlog!main_t.InfiniteLogImpl.) (self! pmemlog!main_t.InfiniteLogImpl.)
   (bytes_to_append! alloc!vec.Vec<u8./allocator_global%.>.) (result! core!result.Result.)
  ) (!
   (= (ens%pmemlog!main_t.impl&%4.append. PM&. PM& pre%self! self! bytes_to_append! result!)
    (and
     (has_type (Poly%core!result.Result. result!) (TYPE%core!result.Result. $ (UINT 64)
       $ TYPE%pmemlog!main_t.InfiniteLogErr.
     ))
     (has_type (Poly%pmemlog!main_t.InfiniteLogImpl. self!) (TYPE%pmemlog!main_t.InfiniteLogImpl.
       PM&. PM&
     ))
     (pmemlog!main_t.impl&%4.valid.? PM&. PM& (Poly%pmemlog!main_t.InfiniteLogImpl. self!))
     (= (pmemlog!main_t.impl&%4.constants.? PM&. PM& (Poly%pmemlog!main_t.InfiniteLogImpl.
        self!
       )
      ) (pmemlog!main_t.impl&%4.constants.? PM&. PM& (Poly%pmemlog!main_t.InfiniteLogImpl.
     ...
     (ite
      ...
      (let
       ...
       (let
        ((tmp%%$ (tuple%2./tuple%2 (Poly%core!option.Option. (pmemlog!main_t.impl&%4.view.? PM&.
             PM& (Poly%pmemlog!main_t.InfiniteLogImpl. pre%self!)
            )
           ) (Poly%core!option.Option. (pmemlog!main_t.impl&%4.view.? PM&. PM& (Poly%pmemlog!main_t.InfiniteLogImpl.
              self!
        ))))))
        (and
         (and
         ...
         (let
          ((old_log$ (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (core!option.Option./Some/0
              $ TYPE%pmemlog!infinitelog_t.AbstractInfiniteLogState. (%Poly%core!option.Option.
               (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$)))
          )))))
          (let
           ((new_log$ (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (core!option.Option./Some/0
               $ TYPE%pmemlog!infinitelog_t.AbstractInfiniteLogState. (%Poly%core!option.Option.
           ...
           (and
            ...
            (= new_log$ (pmemlog!infinitelog_t.impl&%0.append.? (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
               old_log$
              ) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (UINT 8) $ ALLOCATOR_GLOBAL) (Poly%alloc!vec.Vec<u8./allocator_global%.>.
                bytes_to_append!
      ))))))))))
      (and
       ...
       (let
        ...
        (and
         (and
          (= (pmemlog!main_t.impl&%4.view.? PM&. PM& (Poly%pmemlog!main_t.InfiniteLogImpl. self!))
           (pmemlog!main_t.impl&%4.view.? PM&. PM& (Poly%pmemlog!main_t.InfiniteLogImpl. pre%self!))
          )
          (< available_space$ (vstd!std_specs.vec.spec_vec_len.? $ (UINT 8) $ ALLOCATOR_GLOBAL
            (Poly%alloc!vec.Vec<u8./allocator_global%.>. bytes_to_append!)
         )))
         (let
          ((log$ (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (core!option.Option./Some/0
   ...
   :pattern ((ens%pmemlog!main_t.impl&%4.append. PM&. PM& pre%self! self! bytes_to_append!
     result!
   ))
   :qid internal_ens__pmemlog!main_t.impl&__4.append._definition
   :skolemid skolem_internal_ens__pmemlog!main_t.impl&__4.append._definition
)))

;; Function-Specs pmemlog::main_t::InfiniteLogImpl::advance_head
(declare-fun req%pmemlog!main_t.impl&%4.advance_head. (Dcr Type pmemlog!main_t.InfiniteLogImpl.
  Int
 ) Bool
)
(declare-const %%global_location_label%%31 Bool)
(assert
 (forall ((PM&. Dcr) (PM& Type) (pre%self! pmemlog!main_t.InfiniteLogImpl.) (new_head!
    Int
   )
  ) (!
   (= (req%pmemlog!main_t.impl&%4.advance_head. PM&. PM& pre%self! new_head!) (=>
     %%global_location_label%%31
     (pmemlog!main_t.impl&%4.valid.? PM&. PM& (Poly%pmemlog!main_t.InfiniteLogImpl. pre%self!))
   ))
   :pattern ((req%pmemlog!main_t.impl&%4.advance_head. PM&. PM& pre%self! new_head!))
   :qid internal_req__pmemlog!main_t.impl&__4.advance_head._definition
   :skolemid skolem_internal_req__pmemlog!main_t.impl&__4.advance_head._definition
)))
(declare-fun ens%pmemlog!main_t.impl&%4.advance_head. (Dcr Type pmemlog!main_t.InfiniteLogImpl.
  pmemlog!main_t.InfiniteLogImpl. Int core!result.Result.
 ) Bool
)
(assert
 (forall ((PM&. Dcr) (PM& Type) (pre%self! pmemlog!main_t.InfiniteLogImpl.) (self! pmemlog!main_t.InfiniteLogImpl.)
   (new_head! Int) (result! core!result.Result.)
  ) (!
   (= (ens%pmemlog!main_t.impl&%4.advance_head. PM&. PM& pre%self! self! new_head! result!)
    (and
     (has_type (Poly%core!result.Result. result!) (TYPE%core!result.Result. $ TYPE%tuple%0.
       $ TYPE%pmemlog!main_t.InfiniteLogErr.
     ))
     ...
     (ite
      (is-core!result.Result./Ok result!)
      (let
       ((offset$ (%Poly%tuple%0. (core!result.Result./Ok/0 $ TYPE%tuple%0. $ TYPE%pmemlog!main_t.InfiniteLogErr.
           (%Poly%core!result.Result. (Poly%core!result.Result. result!))
       ))))
       (let
        ((tmp%%$ (tuple%2./tuple%2 (Poly%core!option.Option. (pmemlog!main_t.impl&%4.view.? PM&.
         ...
         (let
          ...
          (let
           ...
           (and
            ...
            (= new_log$ (pmemlog!infinitelog_t.impl&%0.advance_head.? (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
               old_log$
              ) (I new_head!)
      ))))))))
      (ite
       ...
       (let
        ...
        (and
         (and
          ...
          (= head$ (pmemlog!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/head
            (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (core!option.Option./Some/0
              $ TYPE%pmemlog!infinitelog_t.AbstractInfiniteLogState. (%Poly%core!option.Option.
               (Poly%core!option.Option. (pmemlog!main_t.impl&%4.view.? PM&. PM& (Poly%pmemlog!main_t.InfiniteLogImpl.
                  self!
         )))))))))
   ...
   :pattern ((ens%pmemlog!main_t.impl&%4.advance_head. PM&. PM& pre%self! self! new_head!
     result!
   ))
   :qid internal_ens__pmemlog!main_t.impl&__4.advance_head._definition
   :skolemid skolem_internal_ens__pmemlog!main_t.impl&__4.advance_head._definition
)))

;; Function-Specs pmemlog::main_t::InfiniteLogImpl::read
(declare-fun req%pmemlog!main_t.impl&%4.read. (Dcr Type pmemlog!main_t.InfiniteLogImpl.
  Int Int
 ) Bool
)
...
(assert
 (forall ((PM&. Dcr) (PM& Type) (self! pmemlog!main_t.InfiniteLogImpl.) (pos! Int) (
    len! Int
   )
  ) (!
   (= (req%pmemlog!main_t.impl&%4.read. PM&. PM& self! pos! len!) (and
     (=>
     ...
     (=>
      ...
      (<= (Add pos! len!) 18446744073709551615)
   )))
   :pattern ((req%pmemlog!main_t.impl&%4.read. PM&. PM& self! pos! len!))
   :qid internal_req__pmemlog!main_t.impl&__4.read._definition
   :skolemid skolem_internal_req__pmemlog!main_t.impl&__4.read._definition
)))
(declare-fun ens%pmemlog!main_t.impl&%4.read. (Dcr Type pmemlog!main_t.InfiniteLogImpl.
  Int Int core!result.Result.
 ) Bool
)
(assert
 (forall ((PM&. Dcr) (PM& Type) (self! pmemlog!main_t.InfiniteLogImpl.) (pos! Int) (
   ...
   (= (ens%pmemlog!main_t.impl&%4.read. PM&. PM& self! pos! len! result!) (and
     (has_type (Poly%core!result.Result. result!) (TYPE%core!result.Result. $ (TYPE%alloc!vec.Vec.
        $ (UINT 8) $ ALLOCATOR_GLOBAL
       ) $ TYPE%pmemlog!main_t.InfiniteLogErr.
     ))
     (let
      ((state$ (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (core!option.Option./Some/0
          $ TYPE%pmemlog!infinitelog_t.AbstractInfiniteLogState. (%Poly%core!option.Option.
           (Poly%core!option.Option. (pmemlog!main_t.impl&%4.view.? PM&. PM& (Poly%pmemlog!main_t.InfiniteLogImpl.
              self!
      ))))))))
        ...
        (ite
         ...
         (let
          ...
          (let
           ((true_bytes$ (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>.
                log$
               ) (I (Sub pos! head$)) (I (Sub (Add pos! len!) head$))
           ))))
           (and
            (and
             (>= pos! head$)
             (<= (Add pos! len!) (Add head$ (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>.
                 log$
            )))))
            (pmemlog!main_t.read_correct_modulo_corruption.? (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
               $ (UINT 8) $ ALLOCATOR_GLOBAL
          ...
          (and
           ...
           (let
            ...
            (and
             ...
             (= tail$ (Add head$ (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. log$))))
   ))))))))))
   :pattern ((ens%pmemlog!main_t.impl&%4.read. PM&. PM& self! pos! len! result!))
   :qid internal_ens__pmemlog!main_t.impl&__4.read._definition
   :skolemid skolem_internal_ens__pmemlog!main_t.impl&__4.read._definition
)))

;; Function-Specs pmemlog::main_t::InfiniteLogImpl::get_head_and_tail
(declare-fun req%pmemlog!main_t.impl&%4.get_head_and_tail. (Dcr Type pmemlog!main_t.InfiniteLogImpl.)
 Bool
)
(declare-const %%global_location_label%%34 Bool)
(assert
 (forall ((PM&. Dcr) (PM& Type) (self! pmemlog!main_t.InfiniteLogImpl.)) (!
   (= (req%pmemlog!main_t.impl&%4.get_head_and_tail. PM&. PM& self!) (=>
     %%global_location_label%%34
     (pmemlog!main_t.impl&%4.valid.? PM&. PM& (Poly%pmemlog!main_t.InfiniteLogImpl. self!))
   ))
   :pattern ((req%pmemlog!main_t.impl&%4.get_head_and_tail. PM&. PM& self!))
   :qid internal_req__pmemlog!main_t.impl&__4.get_head_and_tail._definition
   :skolemid skolem_internal_req__pmemlog!main_t.impl&__4.get_head_and_tail._definition
)))
(declare-fun ens%pmemlog!main_t.impl&%4.get_head_and_tail. (Dcr Type pmemlog!main_t.InfiniteLogImpl.
  core!result.Result.
 ) Bool
)
(assert
 (forall ((PM&. Dcr) (PM& Type) (self! pmemlog!main_t.InfiniteLogImpl.) (result! core!result.Result.))
  (!
   (= (ens%pmemlog!main_t.impl&%4.get_head_and_tail. PM&. PM& self! result!) (and
     (has_type (Poly%core!result.Result. result!) (TYPE%core!result.Result. (DST $) (TYPE%tuple%3.
        $ (UINT 64) $ (UINT 64) $ (UINT 64)
       ) $ TYPE%pmemlog!main_t.InfiniteLogErr.
     ))
       ...
       (let
        ...
        (let
         ...
         (let
          ...
          (and
           (and
            (= result_head$ (pmemlog!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/head
              (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
                inf_log$
            ))))
            (= result_tail$ (Add (pmemlog!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/head
               (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
                 inf_log$
               ))
              ) (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (pmemlog!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/log
           ...
           (= result_capacity$ (pmemlog!infinitelog_t.AbstractInfiniteLogState./AbstractInfiniteLogState/capacity
             (%Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState. (Poly%pmemlog!infinitelog_t.AbstractInfiniteLogState.
               inf_log$
   ))))))))))))
   :pattern ((ens%pmemlog!main_t.impl&%4.get_head_and_tail. PM&. PM& self! result!))
   :qid internal_ens__pmemlog!main_t.impl&__4.get_head_and_tail._definition
   :skolemid skolem_internal_ens__pmemlog!main_t.impl&__4.get_head_and_tail._definition
)))

;; Function-Def pmemlog::main_t::InfiniteLogImpl::get_head_and_tail
;; src/main_t.rs:274:9: 274:97 (#0)
...
(push)
 ...
 (declare-const self! pmemlog!main_t.InfiniteLogImpl.)
 (declare-const tmp%1 core!result.Result.)
 (declare-const tmp%2 pmemlog!logimpl_v.UntrustedLogImpl.)
 ...
 (assert
  (not (=>
    (= tmp%2 (pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl/untrusted_log_impl (%Poly%pmemlog!main_t.InfiniteLogImpl.
       (Poly%pmemlog!main_t.InfiniteLogImpl. self!)
    )))
    (=>
     (= tmp%3 (pmemlog!main_t.InfiniteLogImpl./InfiniteLogImpl/wrpm (%Poly%pmemlog!main_t.InfiniteLogImpl.
        (Poly%pmemlog!main_t.InfiniteLogImpl. self!)
     )))
     (and
      (=>
       %%location_label%%0
       (req%pmemlog!logimpl_v.impl&%0.untrusted_get_head_and_tail. $ TYPE%pmemlog!main_t.TrustedPermission.
        PM&. PM& tmp%2 tmp%3
      ))
      (=>
       (ens%pmemlog!logimpl_v.impl&%0.untrusted_get_head_and_tail. $ TYPE%pmemlog!main_t.TrustedPermission.
        PM&. PM& tmp%2 tmp%3 tmp%1
       )
       (=>
        (= result! tmp%1)
        (=>
