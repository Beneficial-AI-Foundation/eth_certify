...
;; MODULE 'module pmemspec_t'
;; src/pmemspec_t.rs:256:9: 256:47 (#0)
...
(declare-const fuel%pmemlog!pmemspec_t.impl&%0.view. FuelId)
(declare-const fuel%pmemlog!pmemspec_t.impl&%0.inv. FuelId)
(declare-const fuel%pmemlog!pmemspec_t.impl&%0.constants. FuelId)
...
(assert
 (distinct fuel%vstd!std_specs.vec.axiom_spec_len. fuel%vstd!std_specs.vec.axiom_vec_has_resolved.
  ...
  fuel%vstd!seq.lemma_seq_two_subranges_index. fuel%vstd!set.axiom_set_ext_equal. fuel%vstd!set.axiom_set_ext_equal_deep.
  ...
  fuel%vstd!view.impl&%22.view. fuel%vstd!view.impl&%26.view. fuel%pmemlog!pmemspec_t.all_elements_unique.
  fuel%pmemlog!pmemspec_t.maybe_corrupted. fuel%pmemlog!pmemspec_t.crc_size. fuel%pmemlog!pmemspec_t.cdb0_val.
  fuel%pmemlog!pmemspec_t.cdb1_val. fuel%pmemlog!pmemspec_t.persistence_chunk_size.
  fuel%pmemlog!pmemspec_t.update_byte_to_reflect_write. fuel%pmemlog!pmemspec_t.update_contents_to_reflect_write.
  fuel%pmemlog!pmemspec_t.update_byte_to_reflect_partially_flushed_write. fuel%pmemlog!pmemspec_t.update_contents_to_reflect_partially_flushed_write.
  fuel%pmemlog!pmemspec_t.impl&%0.view. fuel%pmemlog!pmemspec_t.impl&%0.inv. fuel%pmemlog!pmemspec_t.impl&%0.constants.
...
(declare-datatypes ((core!option.Option. 0) (vstd!raw_ptr.PtrData. 0) (pmemlog!pmemspec_t.PersistentMemoryConstants.
   0
  ) (pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. 0) (tuple%0. 0)
  ...
  ) ((pmemlog!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory
    (pmemlog!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory/?pm
     Poly
    ) (pmemlog!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory/?perm
     core!option.Option.
   ))
  ) ((tuple%0./tuple%0))
))
...
(declare-fun pmemlog!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory/pm
 (pmemlog!pmemspec_t.WriteRestrictedPersistentMemory.) Poly
)
(declare-fun pmemlog!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory/perm
 (pmemlog!pmemspec_t.WriteRestrictedPersistentMemory.) core!option.Option.
)
...
(declare-fun Poly%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. (pmemlog!pmemspec_t.WriteRestrictedPersistentMemory.)
 Poly
)
(declare-fun %Poly%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. (Poly) pmemlog!pmemspec_t.WriteRestrictedPersistentMemory.)
...
(assert
 (forall ((x pmemlog!pmemspec_t.WriteRestrictedPersistentMemory.)) (!
   (= x (%Poly%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. (Poly%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory.
      x
   )))
   :pattern ((Poly%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. x))
   :qid internal_pmemlog__pmemspec_t__WriteRestrictedPersistentMemory_box_axiom_definition
   :skolemid skolem_internal_pmemlog__pmemspec_t__WriteRestrictedPersistentMemory_box_axiom_definition
)))
(assert
 (forall ((Perm&. Dcr) (Perm& Type) (PM&. Dcr) (PM& Type) (x Poly)) (!
   (=>
    (has_type x (TYPE%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. Perm&. Perm&
      PM&. PM&
    ))
    (= x (Poly%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. (%Poly%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory.
       x
   ))))
   :pattern ((has_type x (TYPE%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. Perm&.
      Perm& PM&. PM&
   )))
   :qid internal_pmemlog__pmemspec_t__WriteRestrictedPersistentMemory_unbox_axiom_definition
   :skolemid skolem_internal_pmemlog__pmemspec_t__WriteRestrictedPersistentMemory_unbox_axiom_definition
)))
(assert
 (forall ((Perm&. Dcr) (Perm& Type) (PM&. Dcr) (PM& Type) (_pm! Poly) (_perm! core!option.Option.))
  (!
   (=>
    (and
     (has_type _pm! PM&)
     (has_type (Poly%core!option.Option. _perm!) (TYPE%core!option.Option. Perm&. Perm&))
    )
    (has_type (Poly%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. (pmemlog!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory
       _pm! _perm!
      )
     ) (TYPE%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. Perm&. Perm& PM&. PM&)
   ))
   :pattern ((has_type (Poly%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. (pmemlog!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory
       _pm! _perm!
      )
     ) (TYPE%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. Perm&. Perm& PM&. PM&)
   ))
   :qid internal_pmemlog!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory_constructor_definition
   :skolemid skolem_internal_pmemlog!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory_constructor_definition
)))
(assert
 (forall ((x pmemlog!pmemspec_t.WriteRestrictedPersistentMemory.)) (!
   (= (pmemlog!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory/pm
   ...
   :pattern ((pmemlog!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory/pm
     x
   ))
   :qid internal_pmemlog!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory/pm_accessor_definition
   :skolemid skolem_internal_pmemlog!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory/pm_accessor_definition
)))
(assert
 (forall ((Perm&. Dcr) (Perm& Type) (PM&. Dcr) (PM& Type) (x Poly)) (!
   (=>
    ...
    (has_type (pmemlog!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory/pm
      (%Poly%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. x)
     ) PM&
   ))
   :pattern ((pmemlog!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory/pm
     (%Poly%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. x)
   ...
   :qid internal_pmemlog!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory/pm_invariant_definition
   :skolemid skolem_internal_pmemlog!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory/pm_invariant_definition
)))
(assert
 (forall ((x pmemlog!pmemspec_t.WriteRestrictedPersistentMemory.)) (!
   (= (pmemlog!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory/perm
   ...
   :pattern ((pmemlog!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory/perm
     x
   ))
   :qid internal_pmemlog!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory/perm_accessor_definition
   :skolemid skolem_internal_pmemlog!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory/perm_accessor_definition
)))
(assert
 (forall ((Perm&. Dcr) (Perm& Type) (PM&. Dcr) (PM& Type) (x Poly)) (!
   (=>
    ...
    (has_type (Poly%core!option.Option. (pmemlog!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory/perm
       (%Poly%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. x)
      )
     ) (TYPE%core!option.Option. Perm&. Perm&)
   ))
   :pattern ((pmemlog!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory/perm
     (%Poly%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. x)
    ) (has_type x (TYPE%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. Perm&. Perm&
   ...
   :qid internal_pmemlog!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory/perm_invariant_definition
   :skolemid skolem_internal_pmemlog!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory/perm_invariant_definition
)))
(assert
 (forall ((x pmemlog!pmemspec_t.WriteRestrictedPersistentMemory.)) (!
   (=>
    (is-pmemlog!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory
     x
    )
    (height_lt (height (pmemlog!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory/pm
       x
      )
     ) (height (Poly%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. x))
   ))
   :pattern ((height (pmemlog!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory/pm
      x
   )))
   :qid prelude_datatype_height_pmemlog!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory/pm
   :skolemid skolem_prelude_datatype_height_pmemlog!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory/pm
)))
(assert
 (forall ((x pmemlog!pmemspec_t.WriteRestrictedPersistentMemory.)) (!
   (=>
    ...
    (height_lt (height (Poly%core!option.Option. (pmemlog!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory/perm
        x
      ))
     ) (height (Poly%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. x))
   ))
   :pattern ((height (Poly%core!option.Option. (pmemlog!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory/perm
       x
   ))))
   :qid prelude_datatype_height_pmemlog!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory/perm
   :skolemid skolem_prelude_datatype_height_pmemlog!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory/perm
)))
(assert
 (forall ((x tuple%0.)) (!
...
(assert
 (=>
  ...
  (forall ((T&. Dcr) (T& Type) (a! Poly)) (!
    ...
    :pattern ((vstd!view.View.view.? $ (PTR T&. T&) a!))
    :qid user_vstd__raw_ptr__ptrs_mut_eq_sized_19
    :skolemid skolem_user_vstd__raw_ptr__ptrs_mut_eq_sized_19
))))
...
(assert
 (=>
  ...
  (forall ((T&. Dcr) (T& Type) (A&. Dcr) (A& Type) (v! Poly)) (!
    ...
    :pattern ((vstd!std_specs.vec.spec_vec_len.? T&. T& A&. A& v!))
    :qid user_vstd__std_specs__vec__axiom_spec_len_20
    :skolemid skolem_user_vstd__std_specs__vec__axiom_spec_len_20
))))
...
(assert
 (=>
  ...
  (forall ((T&. Dcr) (T& Type) (vec! Poly) (i! Poly)) (!
    ...
    :qid user_vstd__std_specs__vec__axiom_vec_has_resolved_21
    :skolemid skolem_user_vstd__std_specs__vec__axiom_vec_has_resolved_21
))))
  ...
  (forall ((bytes! Poly) (true_bytes! Poly) (addrs! Poly)) (!
    (= (pmemlog!pmemspec_t.maybe_corrupted.? bytes! true_bytes! addrs!) (and
      ...
      (forall ((i$ Poly)) (!
        ...
        :qid user_pmemlog__pmemspec_t__maybe_corrupted_22
        :skolemid skolem_user_pmemlog__pmemspec_t__maybe_corrupted_22
    ))))
 ...
 (=>
  ...
  (forall ((seq! Poly)) (!
    (= (pmemlog!pmemspec_t.all_elements_unique.? seq!) (forall ((i$ Poly) (j$ Poly)) (!
       ...
       :qid user_pmemlog__pmemspec_t__all_elements_unique_23
       :skolemid skolem_user_pmemlog__pmemspec_t__all_elements_unique_23
    )))
...
;; Function-Axioms pmemlog::pmemspec_t::WriteRestrictedPersistentMemory::inv
(assert
 (fuel_bool_default fuel%pmemlog!pmemspec_t.impl&%0.inv.)
)
(assert
 (=>
  (fuel_bool fuel%pmemlog!pmemspec_t.impl&%0.inv.)
  (forall ((Perm&. Dcr) (Perm& Type) (PM&. Dcr) (PM& Type) (self! Poly)) (!
    (= (pmemlog!pmemspec_t.impl&%0.inv.? Perm&. Perm& PM&. PM& self!) (%B (pmemlog!pmemspec_t.PersistentMemory.inv.?
       PM&. PM& (pmemlog!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory/pm
        (%Poly%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. self!)
    ))))
    :pattern ((pmemlog!pmemspec_t.impl&%0.inv.? Perm&. Perm& PM&. PM& self!))
    :qid internal_pmemlog!pmemspec_t.impl&__0.inv.?_definition
    :skolemid skolem_internal_pmemlog!pmemspec_t.impl&__0.inv.?_definition
))))

;; Function-Axioms pmemlog::pmemspec_t::WriteRestrictedPersistentMemory::view
(assert
 (fuel_bool_default fuel%pmemlog!pmemspec_t.impl&%0.view.)
)
(assert
 (=>
  (fuel_bool fuel%pmemlog!pmemspec_t.impl&%0.view.)
  (forall ((Perm&. Dcr) (Perm& Type) (PM&. Dcr) (PM& Type) (self! Poly)) (!
    (= (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& self!) (%Poly%vstd!seq.Seq<u8.>.
      (pmemlog!pmemspec_t.PersistentMemory.view.? PM&. PM& (pmemlog!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory/pm
        (%Poly%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. self!)
    ))))
    :pattern ((pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& self!))
    :qid internal_pmemlog!pmemspec_t.impl&__0.view.?_definition
    :skolemid skolem_internal_pmemlog!pmemspec_t.impl&__0.view.?_definition
))))

;; Function-Axioms pmemlog::pmemspec_t::WriteRestrictedPersistentMemory::constants
(assert
 (fuel_bool_default fuel%pmemlog!pmemspec_t.impl&%0.constants.)
)
(assert
 (=>
  (fuel_bool fuel%pmemlog!pmemspec_t.impl&%0.constants.)
  (forall ((Perm&. Dcr) (Perm& Type) (PM&. Dcr) (PM& Type) (self! Poly)) (!
    (= (pmemlog!pmemspec_t.impl&%0.constants.? Perm&. Perm& PM&. PM& self!) (%Poly%pmemlog!pmemspec_t.PersistentMemoryConstants.
      (pmemlog!pmemspec_t.PersistentMemory.constants.? PM&. PM& (pmemlog!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory/pm
        (%Poly%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. self!)
    ))))
    :pattern ((pmemlog!pmemspec_t.impl&%0.constants.? Perm&. Perm& PM&. PM& self!))
    :qid internal_pmemlog!pmemspec_t.impl&__0.constants.?_definition
    :skolemid skolem_internal_pmemlog!pmemspec_t.impl&__0.constants.?_definition
))))
...
(declare-fun %%lambda%%2 (Dcr Type Poly Poly Poly Poly) %%Function%%)
(assert
 (forall ((%%hole%%0 Dcr) (%%hole%%1 Type) (%%hole%%2 Poly) (%%hole%%3 Poly) (%%hole%%4
    Poly
   ...
   (!
    (= (pmemlog!pmemspec_t.update_contents_to_reflect_partially_flushed_write.? contents!
      write_addr! write_bytes! chunks_flushed!
       ...
       ) (I (vstd!seq.Seq.len.? $ (UINT 8) contents!)) (Poly%fun%1. (mk_fun (%%lambda%%2 $
...
(declare-fun req%pmemlog!pmemspec_t.impl&%0.write. (Dcr Type Dcr Type pmemlog!pmemspec_t.WriteRestrictedPersistentMemory.
  Int slice%<u8.>. Poly
 ) Bool
)
...
(assert
 (forall ((Perm&. Dcr) (Perm& Type) (PM&. Dcr) (PM& Type) (pre%self! pmemlog!pmemspec_t.WriteRestrictedPersistentMemory.)
   ...
   (= (req%pmemlog!pmemspec_t.impl&%0.write. Perm&. Perm& PM&. PM& pre%self! addr! bytes!
     ...
     (=>
      ...
      (pmemlog!pmemspec_t.impl&%0.inv.? Perm&. Perm& PM&. PM& (Poly%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory.
        pre%self!
     )))
     (=>
      ...
      (<= (Add addr! (vstd!seq.Seq.len.? $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $ (
          ...
          Perm&. Perm& PM&. PM& (Poly%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. pre%self!)
     )))))
     (=>
     ...
     (=>
      ...
      (forall ((chunks_flushed$ Poly)) (!
         ...
         (%B (let
           ((new_contents$ (pmemlog!pmemspec_t.update_contents_to_reflect_partially_flushed_write.?
              (Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& (
                 Poly%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. pre%self!
               ))
        ...
        :qid user_pmemlog__pmemspec_t__WriteRestrictedPersistentMemory__write_24
        :skolemid skolem_user_pmemlog__pmemspec_t__WriteRestrictedPersistentMemory__write_24
   )))))
...
(declare-fun ens%pmemlog!pmemspec_t.impl&%0.write. (Dcr Type Dcr Type pmemlog!pmemspec_t.WriteRestrictedPersistentMemory.
  pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. Int slice%<u8.>. Poly
 ) Bool
)
(assert
 (forall ((Perm&. Dcr) (Perm& Type) (PM&. Dcr) (PM& Type) (pre%self! pmemlog!pmemspec_t.WriteRestrictedPersistentMemory.)
   (self! pmemlog!pmemspec_t.WriteRestrictedPersistentMemory.) (addr! Int) (bytes! slice%<u8.>.)
   (perm! Poly)
  ) (!
   (= (ens%pmemlog!pmemspec_t.impl&%0.write. Perm&. Perm& PM&. PM& pre%self! self! addr!
     bytes! perm!
    ) (and
     (has_type (Poly%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. self!) (TYPE%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory.
       Perm&. Perm& PM&. PM&
     ))
     (pmemlog!pmemspec_t.impl&%0.inv.? Perm&. Perm& PM&. PM& (Poly%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory.
       self!
     ))
     (= (pmemlog!pmemspec_t.impl&%0.constants.? Perm&. Perm& PM&. PM& (Poly%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory.
        self!
       )
      ) (pmemlog!pmemspec_t.impl&%0.constants.? Perm&. Perm& PM&. PM& (Poly%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory.
        pre%self!
     )))
     (= (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& (Poly%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory.
        self!
       )
      ) (pmemlog!pmemspec_t.update_contents_to_reflect_write.? (Poly%vstd!seq.Seq<u8.>. (
         pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& (Poly%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory.
          pre%self!
        ))
       ) (I addr!) (vstd!view.View.view.? $slice (SLICE $ (UINT 8)) (Poly%slice%<u8.>. bytes!))
...
(declare-fun req%pmemlog!pmemspec_t.impl&%0.get_pm_ref. (Dcr Type Dcr Type pmemlog!pmemspec_t.WriteRestrictedPersistentMemory.)
 Bool
)
(declare-const %%global_location_label%%27 Bool)
(assert
 (forall ((Perm&. Dcr) (Perm& Type) (PM&. Dcr) (PM& Type) (self! pmemlog!pmemspec_t.WriteRestrictedPersistentMemory.))
  (!
...
(declare-fun ens%pmemlog!pmemspec_t.impl&%0.get_pm_ref. (Dcr Type Dcr Type pmemlog!pmemspec_t.WriteRestrictedPersistentMemory.
  Poly
 ) Bool
)
(assert
...
(declare-fun ens%pmemlog!pmemspec_t.impl&%0.new. (Dcr Type Dcr Type Poly pmemlog!pmemspec_t.WriteRestrictedPersistentMemory.)
 Bool
)
(assert
 (forall ((Perm&. Dcr) (Perm& Type) (PM&. Dcr) (PM& Type) (pm! Poly) (wrpm! pmemlog!pmemspec_t.WriteRestrictedPersistentMemory.))
  (!
   (= (ens%pmemlog!pmemspec_t.impl&%0.new. Perm&. Perm& PM&. PM& pm! wrpm!) (and
     (has_type (Poly%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. wrpm!) (TYPE%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory.
       Perm&. Perm& PM&. PM&
     ))
     (= (pmemlog!pmemspec_t.impl&%0.view.? Perm&. Perm& PM&. PM& (Poly%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory.
        wrpm!
...
;; Function-Def pmemlog::pmemspec_t::WriteRestrictedPersistentMemory::new
;; src/pmemspec_t.rs:256:9: 256:47 (#0)
...
(push)
 ...
 (declare-const wrpm! pmemlog!pmemspec_t.WriteRestrictedPersistentMemory.)
 ...
 (assert
  (not (=>
    (= wrpm! (pmemlog!pmemspec_t.WriteRestrictedPersistentMemory./WriteRestrictedPersistentMemory
      pm! (%Poly%core!option.Option. (Poly%core!option.Option. core!option.Option./None))
    ))
    (and
     (=>
      %%location_label%%0
      (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (pmemlog!pmemspec_t.impl&%0.view.?
         Perm&. Perm& PM&. PM& (Poly%pmemlog!pmemspec_t.WriteRestrictedPersistentMemory. wrpm!)
        )
