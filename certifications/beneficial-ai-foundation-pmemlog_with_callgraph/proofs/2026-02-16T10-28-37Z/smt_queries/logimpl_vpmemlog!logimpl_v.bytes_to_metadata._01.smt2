...
;; src/logimpl_v.rs:249:10: 249:78 (#0)
...
;; Function-Def pmemlog::logimpl_v::bytes_to_metadata
;; src/logimpl_v.rs:249:10: 249:78 (#0)
(get-info :all-statistics)
(push)
 (declare-const out! pmemlog!logimpl_v.PersistentHeaderMetadata.)
       ...
       (and
        ...
        (=>
         ...
         (and
          (=>
           %%location_label%%2
           (uInv 64 (Add (uClip 64 (Sub pmemlog!logimpl_v.header_head_offset.? 8)) 8))
          )
          (=>
           (uInv 64 (Add (uClip 64 (Sub pmemlog!logimpl_v.header_head_offset.? 8)) 8))
           (=>
            (= tmp%4 (uClip SZ (uClip 64 (Add (uClip 64 (Sub pmemlog!logimpl_v.header_head_offset.?
                  8
                 )
                ) 8
            ))))
                   ...
                   (and
                    ...
                    (=>
                     ...
                     (and
                      (=>
                       %%location_label%%6
                       (uInv 64 (Add (uClip 64 (Sub pmemlog!logimpl_v.header_tail_offset.? 8)) 8))
                      )
                      (=>
                       (uInv 64 (Add (uClip 64 (Sub pmemlog!logimpl_v.header_tail_offset.? 8)) 8))
                       (=>
                        (= tmp%8 (uClip SZ (uClip 64 (Add (uClip 64 (Sub pmemlog!logimpl_v.header_tail_offset.?
                              8
                             )
                            ) 8
                        ))))
                               ...
                               (and
                                ...
                                (=>
                                 ...
                                 (and
                                  (=>
                                   %%location_label%%10
                                   (uInv 64 (Add (uClip 64 (Sub pmemlog!logimpl_v.header_log_size_offset.? 8)) 8))
                                  )
                                  (=>
                                   (uInv 64 (Add (uClip 64 (Sub pmemlog!logimpl_v.header_log_size_offset.? 8)) 8))
                                   (=>
                                    (= tmp%12 (uClip SZ (uClip 64 (Add (uClip 64 (Sub pmemlog!logimpl_v.header_log_size_offset.?
                                          8
                                         )
                                        ) 8
                                    ))))
                                     ...
                                     (=>
                                      ...
                                      (=>
                                       ...
                                       (and
                                        ...
                                        (=>
                                         (ens%vstd!bytes.u64_from_le_bytes. head_bytes@ tmp%13)
                                         (=>
                                          (= tmp%16 tmp%13)
                                          (and
                                           (=>
                                           ...
                                           (=>
                                            (ens%vstd!bytes.u64_from_le_bytes. tail_bytes@ tmp%14)
                                            (=>
                                             (= tmp%17 tmp%14)
                                             (and
                                              (=>
                                              ...
                                              (=>
                                               (ens%vstd!bytes.u64_from_le_bytes. log_size_bytes@ tmp%15)
                                               (=>
                                                (= out! (pmemlog!logimpl_v.PersistentHeaderMetadata./PersistentHeaderMetadata (%I (I
                                                    tmp%16
                                                   )
                                                  ) (%I (I tmp%17)) (%I (I tmp%15))
                                                ))
                                                (=>
                                                 %%location_label%%15
