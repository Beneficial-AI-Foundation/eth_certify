...
;; Function-Def pmemlog::math_v::lemma_mod_equal
;; src/math_v.rs:283:5: 283:57 (#0)
...
(push)
 ...
 (assert
  (not (and
    (=>
     %%location_label%%0
     (req%pmemlog!math_v.lemma_mod_difference_equal. x! y! d!)
    )
    (=>
     (ens%pmemlog!math_v.lemma_mod_difference_equal. x! y! d!)
     (=>
      %%location_label%%1
      (= x! y!)
 )))))
