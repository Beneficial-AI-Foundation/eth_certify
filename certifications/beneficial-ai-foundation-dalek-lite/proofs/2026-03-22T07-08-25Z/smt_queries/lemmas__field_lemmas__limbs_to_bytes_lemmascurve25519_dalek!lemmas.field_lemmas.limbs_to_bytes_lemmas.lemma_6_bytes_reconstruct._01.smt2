...
;; curve25519-dalek/src/lemmas/field_lemmas/limbs_to_bytes_lemmas.rs:564:1: 572:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::limbs_to_bytes_lemmas::lemma_6_bytes_reconstruct
;; curve25519-dalek/src/lemmas/field_lemmas/limbs_to_bytes_lemmas.rs:564:1: 572:2 (#0)
 ...
 (assert
  (not (=>
    ...
    (and
     (=>
      %%location_label%%0
      (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. value! 256)
     )
     (=>
      (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. value! 256)
      (=>
       (= rest1@ (EucDiv value! (vstd!arithmetic.power2.pow2.? (I 8))))
       (=>
        (= tmp%1 (= value! (nClip (Add byte0! (nClip (Mul rest1@ (vstd!arithmetic.power2.pow2.?
               (I 8)
        )))))))
        (and
         (=>
         ...
         (=>
          ...
          (=>
           ...
           (and
            (=>
             %%location_label%%2
             (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. rest1@ 256)
            )
            (=>
             (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. rest1@ 256)
             (=>
              (= rest2@ (EucDiv rest1@ 256))
              (=>
               (ens%vstd!arithmetic.power2.lemma_pow2_adds. 8 8)
               (and
                (=>
                 %%location_label%%3
                 (req%vstd!arithmetic.div_mod.lemma_div_denominator. value! 256 256)
                )
                (=>
                 (ens%vstd!arithmetic.div_mod.lemma_div_denominator. value! 256 256)
                 (and
                  (=>
                   %%location_label%%4
                   (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. rest2@ 256)
                  )
                  (=>
                   (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. rest2@ 256)
                   (=>
                    (= tmp%2 (= byte2! (EucMod (EucDiv value! (vstd!arithmetic.power2.pow2.? (I 16))) 256)))
                    (and
                     (=>
                      %%location_label%%5
                      tmp%2
                     ...
                     (=>
                      tmp%2
                      (=>
                       (= rest3@ (EucDiv rest2@ 256))
                       (=>
                        (ens%vstd!arithmetic.power2.lemma_pow2_adds. 16 8)
                        (=>
                         (= tmp%3 (vstd!arithmetic.power2.pow2.? (I 16)))
                         (and
                          (=>
                           %%location_label%%6
                           (req%vstd!arithmetic.div_mod.lemma_div_denominator. value! tmp%3 256)
                          )
                          (=>
                           (ens%vstd!arithmetic.div_mod.lemma_div_denominator. value! tmp%3 256)
                           (and
                            (=>
                             %%location_label%%7
                             (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. rest3@ 256)
                            )
                            (=>
                             (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. rest3@ 256)
                             (=>
                              (= rest4@ (EucDiv rest3@ 256))
                              (=>
                               (ens%vstd!arithmetic.power2.lemma_pow2_adds. 24 8)
                               (=>
                                (= tmp%4 (vstd!arithmetic.power2.pow2.? (I 24)))
                                (and
                                 (=>
                                  %%location_label%%8
                                  (req%vstd!arithmetic.div_mod.lemma_div_denominator. value! tmp%4 256)
                                 )
                                 (=>
                                  (ens%vstd!arithmetic.div_mod.lemma_div_denominator. value! tmp%4 256)
                                  (=>
                                   (= tmp%5 (= value! (nClip (Add (nClip (Add (nClip (Add (nClip (Add byte0! (nClip (Mul byte1!
                                       ...
                                       ) (nClip (Mul rest4@ (vstd!arithmetic.power2.pow2.? (I 32))))
                                   ))))
                                   (and
                                    (=>
                                     %%location_label%%9
                                    ...
                                    (=>
                                     ...
                                     (and
                                      (=>
                                       %%location_label%%10
                                       (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. rest4@ 256)
                                      )
                                      (=>
                                       (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. rest4@ 256)
                                       (=>
                                        (= rest5@ (EucDiv rest4@ 256))
                                        (=>
                                         (ens%vstd!arithmetic.power2.lemma_pow2_adds. 32 8)
                                         (=>
                                          (= tmp%6 (vstd!arithmetic.power2.pow2.? (I 32)))
                                          (and
                                           (=>
                                            %%location_label%%11
                                            (req%vstd!arithmetic.div_mod.lemma_div_denominator. value! tmp%6 256)
                                           )
                                           (=>
                                            (ens%vstd!arithmetic.div_mod.lemma_div_denominator. value! tmp%6 256)
                                            (=>
                                             (= tmp%7 (= value! (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip (Add byte0! (nClip (
                                                           Mul byte1! (vstd!arithmetic.power2.pow2.? (I 8))
                                                        )))
                                                       ) (nClip (Mul byte2! (vstd!arithmetic.power2.pow2.? (I 16))))
                                                      )
                                                     ) (nClip (Mul byte3! (vstd!arithmetic.power2.pow2.? (I 24))))
                                                 ...
                                                 ) (nClip (Mul rest5@ (vstd!arithmetic.power2.pow2.? (I 40))))
                                             ))))
                                             (and
                                              (=>
                                               %%location_label%%12
                                              ...
                                              (=>
                                               ...
                                               (and
                                                (=>
                                                 %%location_label%%13
                                                 (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_div_bound. value! 40 48)
                                                )
                                                (=>
                                                 (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_div_bound. value! 40 48)
                                                 (=>
                                                  (= tmp%8 (< rest5@ (vstd!arithmetic.power2.pow2.? (I 8))))
                                                  (and
                                                   (=>
                                                    %%location_label%%14
                                                    tmp%8
                                                   ...
                                                   (=>
                                                    ...
                                                    (and
                                                     (=>
                                                      %%location_label%%15
                                                      (req%vstd!arithmetic.div_mod.lemma_mod_bound. rest5@ 256)
                                                     )
                                                     (=>
                                                      (ens%vstd!arithmetic.div_mod.lemma_mod_bound. rest5@ 256)
                                                      (=>
                                                       (= tmp%9 (= value! (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip (Add byte0! (nClip (
                                                                     Mul byte1! (vstd!arithmetic.power2.pow2.? (I 8))
                                                                  )))
                                                                 ) (nClip (Mul byte2! (vstd!arithmetic.power2.pow2.? (I 16))))
                                                                )
