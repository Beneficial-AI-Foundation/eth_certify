...
;; curve25519-dalek/src/lemmas/scalar_lemmas_/naf_lemmas.rs:561:5: 561:11 (#0)
...
;; Function-Def curve25519_dalek::lemmas::scalar_lemmas_::naf_lemmas::lemma_naf_wrapping_sub_correct
;; curve25519-dalek/src/lemmas/scalar_lemmas_/naf_lemmas.rs:561:5: 561:11 (#0)
...
(assert
 (= width! (bvshl ((_ zero_extend 63) (_ bv1 1)) ((_ zero_extend 32) w!)))
)
(assert
 (and
...
(assert
 (not (=>
   %%location_label%%0
   (and
    (bvule width! ((_ zero_extend 55) (_ bv256 9)))
    (bvuge width! ((_ zero_extend 61) (_ bv4 3)))
))))
(get-info :version)
