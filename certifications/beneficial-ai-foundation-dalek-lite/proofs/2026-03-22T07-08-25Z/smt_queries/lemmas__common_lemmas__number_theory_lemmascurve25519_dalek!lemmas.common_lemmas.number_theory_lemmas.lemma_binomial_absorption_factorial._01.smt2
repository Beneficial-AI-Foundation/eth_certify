...
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:576:7: 576:61 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::number_theory_lemmas::lemma_binomial_absorption_factorial
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:576:7: 576:61 (#0)
...
(push)
 ...
 (declare-const binom_n_k@ Int)
 (declare-const binom_nm1_km1@ Int)
 (declare-const fact_k@ Int)
 (declare-const fact_km1@ Int)
 (declare-const fact_nmk@ Int)
 (declare-const fact_n@ Int)
 (declare-const fact_nm1@ Int)
 (declare-const common@ Int)
 (assert
  fuel_defaults
 )
 (assert
      ...
      (=>
       ...
       (and
        ...
        (=>
         ...
         (=>
          (= binom_n_k@ (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial.?
            (I n!) (I k!)
          ))
          (=>
           (= binom_nm1_km1@ (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial.?
             (I (nClip (Sub n! 1))) (I (nClip (Sub k! 1)))
           ))
           (=>
            (= fact_k@ (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.factorial.?
              (I k!)
            ))
            (=>
             (= fact_km1@ (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.factorial.?
               (I (nClip (Sub k! 1)))
             ))
             (=>
              (= fact_nmk@ (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.factorial.?
                (I (nClip (Sub n! k!)))
              ))
              (=>
               ...
               (=>
                (= fact_nm1@ (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.factorial.?
                  (I (nClip (Sub n! 1)))
                ))
                (=>
                 (= tmp%3 (= fact_k@ (nClip (Mul k! fact_km1@))))
                 (and
                  (=>
                   %%location_label%%2
                   tmp%3
                  ...
                  (=>
                   tmp%3
                   (=>
                    (= tmp%4 (= fact_n@ (nClip (Mul n! fact_nm1@))))
                    (and
                     (=>
                      %%location_label%%3
                      tmp%4
                       ...
                       (=>
                        ...
                        (and
                         ...
                         (=>
                          (> fact_nmk@ 0)
                          (=>
                           (= tmp%7 (= (nClip (Mul (nClip (Mul binom_n_k@ fact_k@)) fact_nmk@)) fact_n@))
                           (and
                            (=>
                             %%location_label%%6
                             tmp%7
                            ...
                            (=>
                             tmp%7
                             (=>
                              (= tmp%8 (= (nClip (Mul (nClip (Mul binom_nm1_km1@ fact_km1@)) fact_nmk@)) fact_nm1@))
                              (and
                               (=>
                                %%location_label%%7
                                tmp%8
                               ...
                               (=>
                                tmp%8
                                (=>
                                 (= common@ (nClip (Mul fact_km1@ fact_nmk@)))
                                 (and
                                  (=>
                                   (ens%vstd!arithmetic.mul.lemma_mul_strictly_positive. fact_km1@ fact_nmk@)
                                   (=>
                                    %%location_label%%8
                                    (> common@ 0)
                                  ))
                                  (=>
                                   ...
                                   (and
                                    (=>
                                     (= tmp%9 (= (nClip (Mul (nClip (Mul binom_n_k@ fact_k@)) fact_nmk@)) fact_n@))
                                     (and
                                      (=>
                                       %%location_label%%9
                                       tmp%9
                                      ...
                                      (=>
                                       tmp%9
                                       (=>
                                        (= tmp%10 (= fact_k@ (nClip (Mul k! fact_km1@))))
                                        (and
                                         (=>
                                          %%location_label%%10
                                          tmp%10
                                         ...
                                         (=>
                                          tmp%10
                                          (=>
                                           (ens%vstd!arithmetic.mul.lemma_mul_is_associative. binom_n_k@ k! fact_km1@)
                                           (=>
                                            (= tmp%11 (nClip (Mul binom_n_k@ k!)))
                                            (=>
                                             (ens%vstd!arithmetic.mul.lemma_mul_is_associative. tmp%11 fact_km1@ fact_nmk@)
                                             (=>
                                              (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. binom_n_k@ k!)
                                              (=>
                                               %%location_label%%11
                                               (= (nClip (Mul (nClip (Mul k! binom_n_k@)) common@)) fact_n@)
                                    )))))))))))
                                    (=>
                                     (= (nClip (Mul (nClip (Mul k! binom_n_k@)) common@)) fact_n@)
                                     (and
                                      (=>
                                       (= tmp%12 (= (nClip (Mul (nClip (Mul binom_nm1_km1@ fact_km1@)) fact_nmk@)) fact_nm1@))
                                       (and
                                        (=>
                                         %%location_label%%12
                                         tmp%12
                                        ...
                                        (=>
                                         tmp%12
                                         (=>
                                          (= tmp%13 (= fact_n@ (nClip (Mul n! fact_nm1@))))
                                          (and
                                           (=>
                                            %%location_label%%13
                                            tmp%13
                                           ...
                                           (=>
                                            tmp%13
                                            (=>
                                             (= tmp%14 (nClip (Mul fact_km1@ fact_nmk@)))
                                             (=>
                                              (ens%vstd!arithmetic.mul.lemma_mul_is_associative. n! binom_nm1_km1@ tmp%14)
                                              (=>
                                               (ens%vstd!arithmetic.mul.lemma_mul_is_associative. binom_nm1_km1@ fact_km1@ fact_nmk@)
                                               (=>
                                                %%location_label%%14
                                                (= (nClip (Mul (nClip (Mul n! binom_nm1_km1@)) common@)) fact_n@)
                                      ))))))))))
                                      (=>
                                       (= (nClip (Mul (nClip (Mul n! binom_nm1_km1@)) common@)) fact_n@)
                                       (and
                                        (=>
                                         (= tmp%15 (nClip (Mul k! binom_n_k@)))
                                         (=>
                                          (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. tmp%15 common@)
                                          (=>
                                           (= tmp%16 (nClip (Mul n! binom_nm1_km1@)))
                                           (=>
                                            (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. tmp%16 common@)
                                            (=>
                                             %%location_label%%15
                                             (= (nClip (Mul common@ (nClip (Mul k! binom_n_k@)))) (nClip (Mul common@ (nClip (Mul n!
                                                  binom_nm1_km1@
                                        ))))))))))
                                        (=>
                                         (= (nClip (Mul common@ (nClip (Mul k! binom_n_k@)))) (nClip (Mul common@ (nClip (Mul n!
                                         ...
                                         (=>
                                          (= tmp%17 (nClip (Mul k! binom_n_k@)))
                                          (=>
                                           (= tmp%18 (nClip (Mul n! binom_nm1_km1@)))
                                           (and
                                            (=>
                                             %%location_label%%16
                                             (req%vstd!arithmetic.mul.lemma_mul_equality_converse. common@ tmp%17 tmp%18)
                                            )
                                            (=>
                                             (ens%vstd!arithmetic.mul.lemma_mul_equality_converse. common@ tmp%17 tmp%18)
                                             (=>
                                              %%location_label%%17
                                              (= (nClip (Mul k! (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial.?
                                                  (I n!) (I k!)
