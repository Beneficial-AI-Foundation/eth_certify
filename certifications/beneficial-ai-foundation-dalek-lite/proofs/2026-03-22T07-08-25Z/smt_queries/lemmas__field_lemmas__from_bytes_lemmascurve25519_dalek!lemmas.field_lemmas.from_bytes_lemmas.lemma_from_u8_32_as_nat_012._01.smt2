...
;; curve25519-dalek/src/lemmas/field_lemmas/from_bytes_lemmas.rs:305:9: 305:15 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::from_bytes_lemmas::lemma_from_u8_32_as_nat_012
;; curve25519-dalek/src/lemmas/field_lemmas/from_bytes_lemmas.rs:305:9: 305:15 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= n@ (vstd!arithmetic.power2.pow2.? (I 102)))
    (=>
     (= x1@ y1@)
     (=>
      %%location_label%%0
      (= (Mul n@ x1@) (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 102)) y1@)))
 )))))
 (get-info :version)
