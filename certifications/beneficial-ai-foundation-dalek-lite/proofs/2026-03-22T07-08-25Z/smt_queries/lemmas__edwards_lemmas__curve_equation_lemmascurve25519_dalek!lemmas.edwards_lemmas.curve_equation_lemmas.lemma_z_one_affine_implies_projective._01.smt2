...
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:469:1: 469:67 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::curve_equation_lemmas::lemma_z_one_affine_implies_projective
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:469:1: 469:67 (#0)
     ...
     (=>
      ...
      (and
       ...
       (=>
        ...
        (=>
         %%location_label%%1
         (not (= (EucMod 1 (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0))
     ))))
     (=>
      (not (= (EucMod 1 (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0))
      (=>
        ...
        (=>
         ...
         (=>
          ...
          (and
           (=>
            %%location_label%%2
            (req%vstd!arithmetic.div_mod.lemma_small_mod. x! tmp%2)
           )
           (=>
            (ens%vstd!arithmetic.div_mod.lemma_small_mod. x! tmp%2)
            (=>
             (= tmp%3 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
             (and
              (=>
               %%location_label%%3
               (req%vstd!arithmetic.div_mod.lemma_small_mod. y! tmp%3)
              )
              (=>
               (ens%vstd!arithmetic.div_mod.lemma_small_mod. y! tmp%3)
               (and
                (=>
                 %%location_label%%4
                 (req%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_affine_curve_implies_projective.
