...
;; curve25519-dalek/src/specs/field_specs.rs:158:1: 158:40 (#0)
...
;; Function-Def curve25519_dalek::specs::field_specs::field_inv_property
;; curve25519-dalek/src/specs/field_specs.rs:158:1: 158:40 (#0)
 ...
 (assert
  (not (and
    (=>
     ...
     (=>
      %%location_label%%0
      (> (curve25519_dalek!specs.field_specs_u64.p.? (I 0)) 1)
    ))
    (=>
     (> (curve25519_dalek!specs.field_specs_u64.p.? (I 0)) 1)
     (=>
         ...
         (=>
          ...
          (and
           ...
           (=>
            ...
            (=>
             (= inv@ (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.spec_mod_inverse.?
               (I a!) (I (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
             ))
             (and
              (=>
               ...
               (and
                (=>
                 %%location_label%%3
                 (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. a! inv@ tmp%3)
                )
                (=>
                 (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. a! inv@ tmp%3)
                 (=>
                  %%location_label%%4
                  (= (EucMod (nClip (Mul (EucMod a! (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                      inv@
                     )
                    ) (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
                   ) 1
