...
;; curve25519-dalek/src/lemmas/common_lemmas/bits_as_nat_lemmas.rs:52:9: 52:15 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::bits_as_nat_lemmas::lemma_bits_as_nat_rec_eq_pow2_mul_bits_from_index
;; curve25519-dalek/src/lemmas/common_lemmas/bits_as_nat_lemmas.rs:52:9: 52:15 (#0)
 ...
 (assert
  (not (=>
    (= (curve25519_dalek!specs.core_specs.bits_from_index_to_nat.? (Poly%array%. bits!)
      (I start!) (I (nClip (Sub 256 start!)))
     ) (nClip (Add bit_value@ (nClip (Mul 2 tail@))))
    )
    (=>
     (= (vstd!arithmetic.power2.pow2.? (I (nClip (Add start! 1)))) (nClip (Mul (vstd!arithmetic.power2.pow2.?
         (I start!)
        ) 2
     )))
     (=>
      ...
      (= (nClip (Mul (vstd!arithmetic.power2.pow2.? (I start!)) (curve25519_dalek!specs.core_specs.bits_from_index_to_nat.?
       ...
       ) (nClip (Add (nClip (Mul bit_value@ (vstd!arithmetic.power2.pow2.? (I start!)))) (
          nClip (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Add start! 1)))) tail@)
 )))))))))
 (get-info :version)
