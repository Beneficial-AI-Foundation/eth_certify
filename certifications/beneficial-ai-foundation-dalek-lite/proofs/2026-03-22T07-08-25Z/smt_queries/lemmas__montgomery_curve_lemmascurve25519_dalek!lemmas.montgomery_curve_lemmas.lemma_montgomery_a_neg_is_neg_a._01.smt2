...
;; curve25519-dalek/src/lemmas/montgomery_curve_lemmas.rs:885:1: 885:47 (#0)
...
;; Function-Def curve25519_dalek::lemmas::montgomery_curve_lemmas::lemma_montgomery_a_neg_is_neg_a
;; curve25519-dalek/src/lemmas/montgomery_curve_lemmas.rs:885:1: 885:47 (#0)
  ...
  (not (and
    (=>
     (let
      ...
      (let
       ((neg_a_val$ (EucMod (curve25519_dalek!lemmas.montgomery_curve_lemmas.local_u5_nat_m.?
           (Poly%array%. (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
       ...
       (let
        ((a_val$ (EucMod (curve25519_dalek!lemmas.montgomery_curve_lemmas.local_u5_nat_m.? (Poly%array%.
        ...
        (= neg_a_val$ (EucMod (nClip (Sub lp$ (EucMod a_val$ lp$))) lp$))
     )))
     (=>
