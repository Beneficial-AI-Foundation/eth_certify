...
;; curve25519-dalek/src/lemmas/edwards_lemmas/straus_lemmas.rs:517:5: 517:11 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::straus_lemmas::lemma_naf_digit_positive_select_preconditions
;; curve25519-dalek/src/lemmas/edwards_lemmas/straus_lemmas.rs:517:5: 517:11 (#0)
...
(assert
 (bvslt digit! ((_ zero_extend 3) (_ bv16 5)))
)
(assert
 (not (= (let
