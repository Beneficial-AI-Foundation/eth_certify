...
;; curve25519-dalek/src/lemmas/scalar_lemmas_/radix_2w_lemmas.rs:870:7: 870:70 (#0)
...
;; Function-Def curve25519_dalek::lemmas::scalar_lemmas_::radix_2w_lemmas::lemma_w_digits_count_concrete
;; curve25519-dalek/src/lemmas/scalar_lemmas_/radix_2w_lemmas.rs:870:7: 870:70 (#0)
  ...
  (not (or
    (and
     (=>
      (= w! 5)
      (=>
       (= tmp%1 (= (EucDiv (nClip (Add 256 4)) 5) 52))
       (and
        (=>
         %%location_label%%0
         tmp%1
      ...
      (or
       (and
        (=>
         (= w! 6)
         (=>
          (= tmp%4 (= (EucDiv (nClip (Add 256 5)) 6) 43))
          (and
           (=>
            %%location_label%%3
            tmp%4
         ...
         (or
          (and
           (=>
            (= w! 7)
            (=>
             (= tmp%7 (= (EucDiv (nClip (Add 256 6)) 7) 37))
             (and
              (=>
               %%location_label%%6
               tmp%7
            ...
            (=>
             ...
             (and
              ...
              (=>
               tmp%10
               (=>
                (= tmp%11 (= (EucDiv (nClip (Add 256 7)) 8) 32))
                (and
                 (=>
                  %%location_label%%10
                  tmp%11
