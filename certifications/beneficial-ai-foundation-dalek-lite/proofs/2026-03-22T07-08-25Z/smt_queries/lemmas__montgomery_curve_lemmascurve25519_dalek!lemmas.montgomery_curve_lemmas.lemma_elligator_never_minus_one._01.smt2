...
;; curve25519-dalek/src/lemmas/montgomery_curve_lemmas.rs:1211:1: 1211:53 (#0)
...
;; Function-Def curve25519_dalek::lemmas::montgomery_curve_lemmas::lemma_elligator_never_minus_one
;; curve25519-dalek/src/lemmas/montgomery_curve_lemmas.rs:1211:1: 1211:53 (#0)
...
(push)
 ...
 (declare-const two_a1@ Int)
 (declare-const u@ Int)
 (declare-const A@ Int)
 (declare-const r_sq@ Int)
 (declare-const two_r_sq@ Int)
 (declare-const d_denom@ Int)
 (declare-const d@ Int)
 (declare-const d_sq@ Int)
 (declare-const A_d@ Int)
 (declare-const inner@ Int)
 (declare-const eps@ Int)
 (declare-const minus_one@ Int)
 (assert
  fuel_defaults
 )
 (assert
 ...
 (declare-fun %%choose%%1 (Int Int Int) Poly)
 (assert
  (forall ((%%hole%%0 Int) (%%hole%%1 Int) (%%hole%%2 Int)) (!
    (=>
     (exists ((y$ Int)) (!
       (and
        (<= %%hole%%0 y$)
        (= (EucMod (nClip (Mul y$ y$)) %%hole%%1) %%hole%%2)
       )
       :pattern ((nClip (Mul y$ y$)))
       :qid user_curve25519_dalek__lemmas__montgomery_curve_lemmas__lemma_elligator_never_minus_one_113
       :skolemid skolem_user_curve25519_dalek__lemmas__montgomery_curve_lemmas__lemma_elligator_never_minus_one_113
     ))
     (exists ((y$ Int)) (!
       (and
        (and
        ...
        (= (%%choose%%1 %%hole%%0 %%hole%%1 %%hole%%2) (I y$))
       )
       :pattern ((nClip (Mul y$ y$)))
    )))
 ...
 (assert
  (not (=>
    ...
    (=>
     ...
     (=>
      (= r_sq@ (curve25519_dalek!specs.field_specs.field_square.? (I r!)))
      (=>
       (= two_r_sq@ (curve25519_dalek!specs.field_specs.field_mul.? (I 2) (I r_sq@)))
       (=>
        (= d_denom@ (curve25519_dalek!specs.field_specs.field_add.? (I 1) (I two_r_sq@)))
          ...
          (=>
           ...
           (=>
            ...
            (=>
             (= eps@ (curve25519_dalek!specs.field_specs.field_mul.? (I d@) (I inner@)))
             (=>
              (= minus_one@ (curve25519_dalek!specs.field_specs.field_sub.? (I 0) (I 1)))
              (or
               (and
                (=>
                 (curve25519_dalek!specs.field_specs.is_square.? (I eps@))
                 (or
                  (and
                   (=>
                    (= d@ minus_one@)
                    (and
                     (=>
                      (ens%curve25519_dalek!lemmas.montgomery_curve_lemmas.lemma_montgomery_a_value. 0)
                      (and
                       (=>
                        %%location_label%%0
                        (req%curve25519_dalek!lemmas.montgomery_curve_lemmas.lemma_eps_when_d_is_minus_one.
                      ...
                      (and
                       (=>
                        ...
                        (and
                         (=>
                          %%location_label%%2
                          (req%curve25519_dalek!lemmas.montgomery_curve_lemmas.lemma_p_gt_small. 486660)
                         )
                         (=>
                          (ens%curve25519_dalek!lemmas.montgomery_curve_lemmas.lemma_p_gt_small. 486660)
                          (=>
                           (= tmp%1 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                           (and
                            (=>
                             %%location_label%%3
                             (req%vstd!arithmetic.div_mod.lemma_small_mod. eps@ tmp%1)
                            )
                            (=>
                             (ens%vstd!arithmetic.div_mod.lemma_small_mod. eps@ tmp%1)
                             (=>
                              (= tmp%2 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                              (and
                               (=>
                                %%location_label%%4
                                (req%vstd!arithmetic.div_mod.lemma_small_mod. 486660 tmp%2)
                               )
                               (=>
                                (ens%vstd!arithmetic.div_mod.lemma_small_mod. 486660 tmp%2)
                                (=>
                                 (= y_w@ (%I (as_type (%%choose%%1 0 (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
                                     (EucMod eps@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                                    ) NAT
                                 )))
                                 (=>
                                  %%location_label%%5
                                  (curve25519_dalek!specs.field_specs.is_square.? (I 486660))
                       )))))))))))
                       (=>
                        (curve25519_dalek!specs.field_specs.is_square.? (I 486660))
                        (=>
                ...
                (=>
                 (not (curve25519_dalek!specs.field_specs.is_square.? (I eps@)))
                 (=>
                  (= u@ (curve25519_dalek!specs.field_specs.field_neg.? (I (curve25519_dalek!specs.field_specs.field_add.?
                      (I d@) (I A@)
                  ))))
                  (or
                   (and
                    (=>
                     (= u@ minus_one@)
                     (=>
                      (= two_a1@ (EucMod (nClip (Mul 2 486661)) (curve25519_dalek!specs.field_specs_u64.p.?
                         (I 0)
                      )))
                      (and
                       (=>
                        ...
                        (=>
                         ...
                         (=>
                          ...
                          (and
                           (=>
                            %%location_label%%7
                            (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%3 tmp%4)
                           )
                           (=>
                            (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%3 tmp%4)
                            (=>
                             %%location_label%%8
                             (< r_sq@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                       ))))))
                         ...
                         (=>
                          ...
                          (and
                           ...
                           (=>
                            ...
                            (=>
                             %%location_label%%10
                             (= r_sq@ (curve25519_dalek!specs.field_specs.field_inv.? (I two_a1@)))
                         ))))
                         (=>
                          (= r_sq@ (curve25519_dalek!specs.field_specs.field_inv.? (I two_a1@)))
                          (and
                            ...
                            (and
                             (=>
                              ...
                              (and
                               (=>
                                %%location_label%%11
                                (req%curve25519_dalek!lemmas.montgomery_curve_lemmas.lemma_p_gt_small. 973322)
                               )
                               (=>
                                (ens%curve25519_dalek!lemmas.montgomery_curve_lemmas.lemma_p_gt_small. 973322)
                                (and
                                 (=>
                                  %%location_label%%12
                                  true
                                 ...
                                 (=>
                                  (= (nClip (Mul 2 486661)) 973322)
                                  (=>
                                   (= tmp%5 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                                   (and
                                    (=>
                                     %%location_label%%13
                                     (req%vstd!arithmetic.div_mod.lemma_small_mod. 973322 tmp%5)
                                    )
                                    (=>
                                     (ens%vstd!arithmetic.div_mod.lemma_small_mod. 973322 tmp%5)
                                     (=>
                                      %%location_label%%14
                                      (not (= two_a1@ 0))
                             )))))))))
                             (=>
                              (not (= two_a1@ 0))
                              (=>
                               (= tmp%6 (nClip (Mul 2 486661)))
                               (and
                                (=>
                                 %%location_label%%15
                                 (req%curve25519_dalek!lemmas.montgomery_curve_lemmas.lemma_inv_preserves_non_qr. tmp%6)
                                )
                                (=>
                                 (ens%curve25519_dalek!lemmas.montgomery_curve_lemmas.lemma_inv_preserves_non_qr. tmp%6)
                                 (=>
                                  %%location_label%%16
                                  (not (curve25519_dalek!specs.field_specs.is_square.? (I (curve25519_dalek!specs.field_specs.field_inv.?
                                      (I two_a1@)
                                ...
                                (=>
                                 ...
                                 (=>
                                  ...
                                  (and
                                   (=>
                                    %%location_label%%17
                                    (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%7 tmp%8)
                                   )
                                   (=>
                                    (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%7 tmp%8)
                                    (=>
                                     %%location_label%%18
                                     (< (curve25519_dalek!specs.field_specs.field_mul.? (I r!) (I r!)) (curve25519_dalek!specs.field_specs_u64.p.?
                                       (I 0)
                                )))))))
                                (=>
                                 (< (curve25519_dalek!specs.field_specs.field_mul.? (I r!) (I r!)) (curve25519_dalek!specs.field_specs_u64.p.?
                                 ...
                                 (and
                                  (=>
                                   ...
                                   (and
                                    (=>
                                     %%location_label%%19
                                     (req%vstd!arithmetic.div_mod.lemma_small_mod. r_sq@ tmp%9)
                                    )
                                    (=>
                                     (ens%vstd!arithmetic.div_mod.lemma_small_mod. r_sq@ tmp%9)
                                     (=>
                                      %%location_label%%20
                                      (= r_sq@ (curve25519_dalek!specs.field_specs_u64.field_canonical.? (I r_sq@)))
                                  ))))
                                  (=>
                                   (= r_sq@ (curve25519_dalek!specs.field_specs_u64.field_canonical.? (I r_sq@)))
                                   (=>
                                    ...
                                    (exists ((y$ Poly)) (!
                                      ...
                                      :pattern ((curve25519_dalek!specs.field_specs.field_mul.? y$ y$))
                                      :qid user_curve25519_dalek__lemmas__montgomery_curve_lemmas__lemma_elligator_never_minus_one_121
                                      :skolemid skolem_user_curve25519_dalek__lemmas__montgomery_curve_lemmas__lemma_elligator_never_minus_one_121
                               )))))))
                               (=>
                                (exists ((y$ Poly)) (!
                                  (and
                                  ...
                                  :pattern ((curve25519_dalek!specs.field_specs.field_mul.? y$ y$))
                                  :qid user_curve25519_dalek__lemmas__montgomery_curve_lemmas__lemma_elligator_never_minus_one_122
                                  :skolemid skolem_user_curve25519_dalek__lemmas__montgomery_curve_lemmas__lemma_elligator_never_minus_one_122
                                ))
                                (=>
                                 %%location_label%%22
                                 (curve25519_dalek!specs.field_specs.is_square.? (I r_sq@))
                             ))))
                             (=>
                              (curve25519_dalek!specs.field_specs.is_square.? (I r_sq@))
                              (=>
