...
;; curve25519-dalek/src/lemmas/field_lemmas/invert_lemmas.rs:240:1: 244:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::invert_lemmas::lemma_multiply_by_base_power_addition
;; curve25519-dalek/src/lemmas/field_lemmas/invert_lemmas.rs:240:1: 244:2 (#0)
  ...
  (not (and
    (and
     (=>
      ...
      (=>
       %%location_label%%0
       (= (vstd!arithmetic.power.pow.? (I x!) (I 1)) x!)
     ))
     (=>
      (= (vstd!arithmetic.power.pow.? (I x!) (I 1)) x!)
      (and
       (and
        ...
        (=>
         (> (curve25519_dalek!specs.field_specs_u64.p.? (I 0)) 0)
         (=>
          (= tmp%1 (curve25519_dalek!specs.field_specs.fe51_as_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
             self_fe!
          )))
          (=>
       ...
       (=>
        ...
        (and
         ...
         (=>
          ...
          (=>
           %%location_label%%6
           (= x! (EucMod (nClip (vstd!arithmetic.power.pow.? (I x!) (I 1))) (curve25519_dalek!specs.field_specs_u64.p.?
              (I 0)
    ))))))))))
    (=>
     (= x! (EucMod (nClip (vstd!arithmetic.power.pow.? (I x!) (I 1))) (curve25519_dalek!specs.field_specs_u64.p.?
     ...
     (and
      ...
      (=>
       ...
       (and
        (=>
         (= tmp%4 (= (nClip (Add (Sub (curve25519_dalek!specs.field_specs_u64.p.? (I 0)) 2) 1))
         ...
         (and
          ...
          (=>
           tmp%4
           (=>
            (= tmp%5 (nClip (Sub (curve25519_dalek!specs.field_specs_u64.p.? (I 0)) 2)))
            (=>
