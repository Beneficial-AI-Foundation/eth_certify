...
;; curve25519-dalek/src/lemmas/scalar_lemmas_extra.rs:457:5: 457:11 (#0)
...
;; Function-Def curve25519_dalek::lemmas::scalar_lemmas_extra::lemma_hi_limbs_bounded
;; curve25519-dalek/src/lemmas/scalar_lemmas_extra.rs:457:5: 457:11 (#0)
...
(declare-const word7@ (_ BitVec 64))
(assert
 true
)
...
(assert
 (not (=>
   %%location_label%%0
   (bvule (bvlshr word7@ ((_ zero_extend 59) (_ bv20 5))) ((_ zero_extend 20) (_ bv17592186044415
      44
))))))
(get-info :version)
