...
;; curve25519-dalek/src/backend/serial/u64/field.rs:1302:5: 1302:47 (#0)
...
;; Function-Def curve25519_dalek::backend::serial::u64::field::FieldElement51::square
;; curve25519-dalek/src/backend/serial/u64/field.rs:1302:5: 1302:47 (#0)
 ...
 (assert
  (not (=>
    ...
    (and
     (=>
      %%location_label%%0
      (req%curve25519_dalek!backend.serial.u64.field.impl&%16.pow2k. self! 1)
     )
     (=>
      (ens%curve25519_dalek!backend.serial.u64.field.impl&%16.pow2k. self! 1 tmp%1)
      (=>
       (= r! tmp%1)
       (and
        (=>
