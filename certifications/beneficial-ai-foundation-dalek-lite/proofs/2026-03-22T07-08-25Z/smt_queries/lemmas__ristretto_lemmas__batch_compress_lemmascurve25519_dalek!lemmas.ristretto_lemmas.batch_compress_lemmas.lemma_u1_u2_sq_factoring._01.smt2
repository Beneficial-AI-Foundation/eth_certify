...
;; curve25519-dalek/src/lemmas/ristretto_lemmas/batch_compress_lemmas.rs:931:7: 931:92 (#0)
...
;; Function-Def curve25519_dalek::lemmas::ristretto_lemmas::batch_compress_lemmas::lemma_u1_u2_sq_factoring
;; curve25519-dalek/src/lemmas/ristretto_lemmas/batch_compress_lemmas.rs:931:7: 931:92 (#0)
...
(push)
 ...
 (declare-const big_b@ Int)
 (declare-const sq_h3@ Int)
 (declare-const sq_g3@ Int)
 (declare-const sq_e3@ Int)
 (declare-const inv_sq_h3@ Int)
            ...
            (=>
             ...
             (=>
              ...
              (=>
               ...
               (=>
                (= sq_h3@ (curve25519_dalek!specs.field_specs.field_square.? (I h!)))
                (=>
                 (= sq_g3@ (curve25519_dalek!specs.field_specs.field_square.? (I g!)))
                 (=>
                  (= sq_e3@ (curve25519_dalek!specs.field_specs.field_square.? (I e!)))
                  (=>
                   (= inv_sq_h3@ (curve25519_dalek!specs.field_specs.field_inv.? (I sq_h3@)))
                   (=>
                    (= d_plus_1@ (curve25519_dalek!specs.field_specs.field_add.? (I d!) (I 1)))
                    (=>
                     ...
                     (=>
                      ...
                      (and
                       (=>
                        (= tmp%1 (curve25519_dalek!specs.field_specs.field_add.? (I 1) (I y_aff@)))
                        (=>
                         (= tmp%2 (curve25519_dalek!specs.field_specs.field_sub.? (I 1) (I y_aff@)))
                         (=>
                          (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_comm.
                           tmp%1 tmp%2
                          )
                           ...
                           (and
                            (=>
                             ...
                             (and
                              (=>
                               %%location_label%%1
                               (req%vstd!arithmetic.div_mod.lemma_small_mod. 1 tmp%3)
                              )
                              (=>
                               (ens%vstd!arithmetic.div_mod.lemma_small_mod. 1 tmp%3)
                               (=>
                                %%location_label%%2
                            ...
                            (=>
                             ...
                             (=>
                              %%location_label%%3
                              (= u1@ (curve25519_dalek!specs.field_specs.field_sub.? (I 1) (I (curve25519_dalek!specs.field_specs.field_square.?
                                  (I y_aff@)
                       )))))))))))
                       (=>
                        (= u1@ (curve25519_dalek!specs.field_specs.field_sub.? (I 1) (I (curve25519_dalek!specs.field_specs.field_square.?
                        ...
                        (and
                         (=>
                          ...
                          (=>
                           %%location_label%%4
                           (= (curve25519_dalek!specs.field_specs.field_square.? (I y_aff@)) (curve25519_dalek!specs.field_specs.field_mul.?
                             (I sq_g3@) (I inv_sq_h3@)
                         ))))
                         (=>
                          (= (curve25519_dalek!specs.field_specs.field_square.? (I y_aff@)) (curve25519_dalek!specs.field_specs.field_mul.?
                          ...
                          (and
                           (and
                            ...
                            (=>
                             ...
                             (=>
                              (= tmp%4 (curve25519_dalek!specs.field_specs.field_square.? (I h!)))
                              (and
                               (=>
                                %%location_label%%6
                                (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_element_reduced.
                               ...
                               (=>
                                ...
                                (and
                                 ...
                                 (=>
                                  ...
                                  (=>
                                   (= tmp%5 (curve25519_dalek!specs.field_specs.field_inv.? (I sq_h3@)))
                                   (=>
                                    (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_comm.
                                     tmp%5 sq_h3@
                                    )
                                    (=>
                                     %%location_label%%8
                                     (= (curve25519_dalek!specs.field_specs.field_mul.? (I sq_h3@) (I inv_sq_h3@)) 1)
                           ))))))))))
                           (=>
                            (= (curve25519_dalek!specs.field_specs.field_mul.? (I sq_h3@) (I inv_sq_h3@)) 1)
                            (and
                             (=>
                              (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_distributes_over_sub_right.
                               sq_h3@ sq_g3@ inv_sq_h3@
                              )
                              (=>
                               %%location_label%%9
                               (= u1@ (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_sub.?
                                   (I sq_h3@) (I sq_g3@)
                                  )
                                 ) (I inv_sq_h3@)
                             ))))
                                 ...
                                 (=>
                                  ...
                                  (=>
                                   ...
                                   (and
                                    ...
                                    (= (curve25519_dalek!specs.field_specs.field_square.? (I u2@)) (curve25519_dalek!specs.field_specs.field_mul.?
                                      (I (curve25519_dalek!specs.field_specs.field_square.? (I eg!))) (I (curve25519_dalek!specs.field_specs.field_inv.?
                                        (I (curve25519_dalek!specs.field_specs.field_square.? (I fh!)))
                               )))))))))
                               (=>
                                (and
                                 (= t_aff@ (curve25519_dalek!specs.field_specs.field_mul.? (I eg!) (I inv_fh@)))
                                ...
                                (and
                                 (=>
                                  (= tmp%6 (curve25519_dalek!specs.field_specs.field_sub.? (I sq_h3@) (I sq_g3@)))
                                  (=>
                                   (= tmp%7 (curve25519_dalek!specs.field_specs.field_square.? (I eg!)))
                                   (=>
                                    (= tmp%8 (curve25519_dalek!specs.field_specs.field_inv.? (I (curve25519_dalek!specs.field_specs.field_square.?
                                        (I fh!)
                                    ))))
                                    (=>
                                     (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_exchange.
                                      tmp%6 inv_sq_h3@ tmp%7 tmp%8
                                     )
                                     (=>
                                      (= tmp%9 (curve25519_dalek!specs.field_specs.field_square.? (I fh!)))
                                      (=>
                                       (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_inv_of_product.
                                        sq_h3@ tmp%9
                                       )
                                       (=>
                                        ...
                                        (=>
                                         ...
                                         (= (curve25519_dalek!specs.field_specs.field_mul.? (I u1@) (I (curve25519_dalek!specs.field_specs.field_square.?
                                             ...
                                             (I (curve25519_dalek!specs.field_specs.field_sub.? (I sq_h3@) (I sq_g3@))) (I (curve25519_dalek!specs.field_specs.field_square.?
                                               (I eg!)
                                            )))
                                           ) (I (curve25519_dalek!specs.field_specs.field_inv.? (I (curve25519_dalek!specs.field_specs.field_square.?
                                               (I h_fh@)
                                  ...
                                  (and
                                   (=>
                                    ...
                                    (=>
                                     ...
                                     (=>
                                      (= tmp%10 (curve25519_dalek!specs.field_specs.field_mul.? (I sq_e3@) (I (curve25519_dalek!specs.field_specs.field_square.?
                                          (I eg!)
                                      ))))
                                      (=>
                                       (= tmp%11 (curve25519_dalek!specs.field_specs.field_inv.? (I (curve25519_dalek!specs.field_specs.field_square.?
                                           (I h_fh@)
                                       ))))
                                       (=>
                                        (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_assoc.
                                         neg_one_minus_d@ tmp%10 tmp%11
                                        )
                                        (=>
                                         %%location_label%%12
                                         (= (curve25519_dalek!specs.field_specs.field_mul.? (I neg_one_minus_d@) (I (curve25519_dalek!specs.field_specs.field_square.?
                                             ...
                                             (I neg_one_minus_d@) (I (curve25519_dalek!specs.field_specs.field_mul.? (I sq_e3@)
                                               (I (curve25519_dalek!specs.field_specs.field_square.? (I eg!)))
                                            )))
                                           ) (I (curve25519_dalek!specs.field_specs.field_inv.? (I (curve25519_dalek!specs.field_specs.field_square.?
                                               (I h_fh@)
                                   ))))))))))))
                                    ...
                                    (and
                                     (=>
                                      ...
                                      (=>
                                       ...
                                       (=>
                                        (= tmp%12 (curve25519_dalek!specs.field_specs.field_neg.? (I 1)))
                                        (=>
                                         (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_distributes_over_add.
                                          tmp%12 d! 1
                                         )
                                         (=>
                                          ...
                                          (=>
                                           ...
                                           (=>
                                            (= tmp%13 (curve25519_dalek!specs.field_specs.field_neg.? (I 1)))
                                            (=>
                                             (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_one_right.
                                              tmp%13
                                             )
                                             (=>
                                              (= tmp%14 (curve25519_dalek!specs.field_specs.field_neg.? (I 1)))
                                              (and
                                               (=>
                                                %%location_label%%13
                                                (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_element_reduced.
                                               ...
                                               (=>
                                                ...
                                                (=>
                                                 (= tmp%15 (curve25519_dalek!specs.field_specs.field_neg.? (I d!)))
                                                 (=>
                                                  (= tmp%16 (curve25519_dalek!specs.field_specs.field_neg.? (I 1)))
                                                  (=>
                                                   (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_add_comm.
                                                    tmp%15 tmp%16
                                                   )
                                                   (=>
                                                    (= tmp%17 (curve25519_dalek!specs.field_specs.field_neg.? (I 1)))
                                                    (=>
                                                     (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_sub_eq_add_neg.
                                                      tmp%17 d!
                                                     )
                                                     (=>
                                                      (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_comm.
                                                       sq_e3@ neg_one_minus_d@
                                                      )
                                                      (=>
                                                       %%location_label%%14
                                                       (= (curve25519_dalek!specs.field_specs.field_sub.? (I sq_h3@) (I sq_g3@)) (curve25519_dalek!specs.field_specs.field_mul.?
                                                         (I neg_one_minus_d@) (I sq_e3@)
                                     ))))))))))))))))))))
                                     (=>
                                      (= (curve25519_dalek!specs.field_specs.field_sub.? (I sq_h3@) (I sq_g3@)) (curve25519_dalek!specs.field_specs.field_mul.?
                                        (I neg_one_minus_d@) (I sq_e3@)
                                      ...
                                      (and
                                       (=>
                                        (= tmp%18 (curve25519_dalek!specs.field_specs.field_square.? (I eg!)))
                                        (=>
                                         (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_assoc.
                                          neg_one_minus_d@ sq_e3@ tmp%18
                                         )
                                         (=>
                                          %%location_label%%15
                                          (= (curve25519_dalek!specs.field_specs.field_mul.? (I neg_one_minus_d@) (I (curve25519_dalek!specs.field_specs.field_mul.?
                                              (I sq_e3@) (I (curve25519_dalek!specs.field_specs.field_square.? (I eg!)))
                                            ))
                                           ) (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_sub.?
                                              (I sq_h3@) (I sq_g3@)
                                             )
