...
;; curve25519-dalek/src/lemmas/field_lemmas/negate_lemmas.rs:27:1: 27:53 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::negate_lemmas::lemma_neg_no_underflow
;; curve25519-dalek/src/lemmas/field_lemmas/negate_lemmas.rs:27:1: 27:53 (#0)
...
(push)
 ...
 (assert
  (forall ((i$ Poly)) (!
    ...
    :qid user_curve25519_dalek__lemmas__field_lemmas__negate_lemmas__lemma_neg_no_underflow_40
    :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__negate_lemmas__lemma_neg_no_underflow_40
 )))
     ...
     (=>
      ...
      (=>
       ...
       (and
        (=>
         %%location_label%%0
         (req%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u64_shift_is_pow2. 54)
        )
        (=>
         (ens%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u64_shift_is_pow2. 54)
         (=>
          %%location_label%%1
          (< (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $
               (CONST_INT 5)
           ...
           ) (Mul 16 (Sub (vstd!arithmetic.power2.pow2.? (I 51)) 19))
     ))))))
     (=>
      (forall ((i$ Poly)) (!
        (=>
        ...
        :qid user_curve25519_dalek__lemmas__field_lemmas__negate_lemmas__lemma_neg_no_underflow_39
        :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__negate_lemmas__lemma_neg_no_underflow_39
      ))
      (=>
       %%location_label%%2
       (curve25519_dalek!lemmas.field_lemmas.negate_lemmas.all_neg_limbs_positive.? (Poly%array%.
