...
;; curve25519-dalek/src/scalar_helpers.rs:38:1: 38:38 (#0)
...
;; Function-Def curve25519_dalek::scalar_helpers::lemma_u8_32_as_nat_one
;; curve25519-dalek/src/scalar_helpers.rs:38:1: 38:38 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= bytes@ (curve25519_dalek!scalar.Scalar./Scalar/bytes (%Poly%curve25519_dalek!scalar.Scalar.
       (Poly%curve25519_dalek!scalar.Scalar. curve25519_dalek!scalar.impl&%50.ONE.?)
    )))
    (=>
        ...
        (and
         (=>
          ...
          (=>
           ...
           (=>
            (= tmp%2 (vstd!arithmetic.power2.pow2.? (I (nClip (Mul i@ 8)))))
            (=>
             (ens%vstd!arithmetic.mul.lemma_mul_basics. tmp%2)
             (=>
              %%location_label%%1
              (= (nClip (Mul 0 (vstd!arithmetic.power2.pow2.? (I (nClip (Mul i@ 8)))))) 0)
         )))))
         (=>
          (forall ((i$ Int)) (!
            (=>
            ...
            :pattern ((vstd!arithmetic.power2.pow2.? (I (nClip (Mul i$ 8)))))
            :qid user_curve25519_dalek__scalar_helpers__lemma_u8_32_as_nat_one_42
            :skolemid skolem_user_curve25519_dalek__scalar_helpers__lemma_u8_32_as_nat_one_42
          ))
          (=>
           %%location_label%%2
           (= (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. (curve25519_dalek!scalar.Scalar./Scalar/bytes
               (%Poly%curve25519_dalek!scalar.Scalar. (Poly%curve25519_dalek!scalar.Scalar. curve25519_dalek!scalar.impl&%50.ONE.?))
             ))
            ) 1
 )))))))))))
 (get-info :version)
