...
;; curve25519-dalek/src/lemmas/common_lemmas/bits_as_nat_lemmas.rs:73:1: 73:69 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::bits_as_nat_lemmas::lemma_bits_as_nat_eq_bits_from_index
;; curve25519-dalek/src/lemmas/common_lemmas/bits_as_nat_lemmas.rs:73:1: 73:69 (#0)
  ...
  (not (and
    (and
     ...
     (=>
      ...
      (=>
       %%location_label%%1
       (= (curve25519_dalek!specs.core_specs.bits_as_nat_rec.? (Poly%array%. bits!) (I 0))
        (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 0)) (curve25519_dalek!specs.core_specs.bits_from_index_to_nat.?
           (Poly%array%. bits!) (I 0) (I 256)
    )))))))
    (=>
     (= (curve25519_dalek!specs.core_specs.bits_as_nat_rec.? (Poly%array%. bits!) (I 0))
     ...
     (and
      ...
      (=>
       (= (vstd!arithmetic.power2.pow2.? (I 0)) 1)
       (=>
        (= tmp%1 (= (curve25519_dalek!specs.core_specs.bits_as_nat.? (Poly%array%. bits!))
          (curve25519_dalek!specs.core_specs.bits_as_nat_rec.? (Poly%array%. bits!) (I 0))
        ))
        (and
         (=>
         ...
         (=>
          ...
          (and
           (=>
            (= tmp%2 (curve25519_dalek!specs.core_specs.bits_from_index_to_nat.? (Poly%array%. bits!)
              (I 0) (I 256)
            ))
            (=>
             (ens%vstd!arithmetic.mul.lemma_mul_basics_3. tmp%2)
             (=>
              %%location_label%%4
              (= (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 0)) (curve25519_dalek!specs.core_specs.bits_from_index_to_nat.?
                  (Poly%array%. bits!) (I 0) (I 256)
