...
;; curve25519-dalek/src/lemmas/montgomery_curve_lemmas.rs:394:1: 394:82 (#0)
...
;; Function-Def curve25519_dalek::lemmas::montgomery_curve_lemmas::lemma_montgomery_scalar_mul_add
;; curve25519-dalek/src/lemmas/montgomery_curve_lemmas.rs:394:1: 394:82 (#0)
...
(push)
 ...
 (declare-const tmp%2 curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.)
 (declare-const tmp%3 Bool)
 (declare-const tmp%4 Bool)
 (declare-const tmp%5 Bool)
 (declare-const tmp%6 Bool)
 (declare-const tmp%7 Bool)
 (declare-const tmp%8 curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.)
 (declare-const tmp%9 curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.)
    ...
    (or
     (and
      (=>
       (= m! 0)
       (=>
        (= tmp%1 (= (curve25519_dalek!specs.montgomery_specs.montgomery_scalar_mul.? (Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.
            P!
           ) (I 0)
          ) curve25519_dalek!specs.montgomery_specs.MontgomeryAffine./Infinity
        ))
        (and
         ...
         (=>
          tmp%1
          (=>
           (= tmp%2 (curve25519_dalek!specs.montgomery_specs.montgomery_scalar_mul.? (Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.
              P!
             ) (I n!)
           ))
           (=>
                 ...
                 (=>
                  ...
                  (and
                   ...
                   (=>
                    ...
                    (=>
                     %%location_label%%5
                     (= (Sub (nClip (Add m! n!)) 1) (nClip (Add m_minus_1@ n!)))
              )))))))
              (=>
               (= (Sub (nClip (Add m! n!)) 1) (nClip (Add m_minus_1@ n!)))
               (=>
                (= tmp%6 (= (curve25519_dalek!specs.montgomery_specs.montgomery_scalar_mul.? (Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.
                    P!
                   ) (I (nClip (Add m! n!)))
                  ) (curve25519_dalek!specs.montgomery_specs.montgomery_add.? (Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.
                    P!
                   ) (Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine. (curve25519_dalek!specs.montgomery_specs.montgomery_scalar_mul.?
                     (Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine. P!) (I (nClip (Add m_minus_1@
                        n!
                ))))))))
                (and
                 (=>
                 ...
                 (=>
                  tmp%6
                  (=>
                   (= tmp%7 (= (curve25519_dalek!specs.montgomery_specs.montgomery_scalar_mul.? (Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.
                       P!
                      ) (I (nClip (Add m_minus_1@ n!)))
                     ) (curve25519_dalek!specs.montgomery_specs.montgomery_add.? (Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.
                       (curve25519_dalek!specs.montgomery_specs.montgomery_scalar_mul.? (Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.
                         P!
                        ) (I m_minus_1@)
                   ...
                   (and
                    ...
                    (=>
                     tmp%7
                     (=>
                      (= tmp%8 (curve25519_dalek!specs.montgomery_specs.montgomery_scalar_mul.? (Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.
                         P!
                        ) (I m_minus_1@)
                      ))
                      (=>
                       (= tmp%9 (curve25519_dalek!specs.montgomery_specs.montgomery_scalar_mul.? (Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.
                          P!
                         ) (I n!)
                       ))
                       (=>
                        ...
                        (=>
                         (= tmp%10 (= (curve25519_dalek!specs.montgomery_specs.montgomery_add.? (Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.
                             P!
                            ) (Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine. (curve25519_dalek!specs.montgomery_specs.montgomery_add.?
                              (Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine. (curve25519_dalek!specs.montgomery_specs.montgomery_scalar_mul.?
                                (Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine. P!) (I m_minus_1@)
                               )
                              ) (Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine. (curve25519_dalek!specs.montgomery_specs.montgomery_scalar_mul.?
                                (Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine. P!) (I n!)
                            ))))
                         ...
                         (and
                          ...
                          (=>
                           tmp%10
                           (=>
                            (= tmp%11 (= (curve25519_dalek!specs.montgomery_specs.montgomery_scalar_mul.? (Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.
                                P!
                               ) (I m!)
                              ) (curve25519_dalek!specs.montgomery_specs.montgomery_add.? (Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.
                                P!
                            ...
                            (and
                             ...
                             (=>
                              tmp%11
                              (=>
                               (= tmp%12 (= (curve25519_dalek!specs.montgomery_specs.montgomery_scalar_mul.? (Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.
                                   P!
                                  ) (I (nClip (Add m! n!)))
                                 ) (curve25519_dalek!specs.montgomery_specs.montgomery_add.? (Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.
                                   (curve25519_dalek!specs.montgomery_specs.montgomery_scalar_mul.? (Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.
