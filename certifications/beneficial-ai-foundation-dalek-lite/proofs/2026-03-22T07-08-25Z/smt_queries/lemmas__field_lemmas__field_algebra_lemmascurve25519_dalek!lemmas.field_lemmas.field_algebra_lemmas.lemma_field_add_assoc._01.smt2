...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:200:1: 200:59 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_field_add_assoc
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:200:1: 200:59 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= m@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
    (=>
     ...
     (and
      ...
      (=>
       (> pn@ 2)
       (=>
        (= ab@ (curve25519_dalek!specs.field_specs.field_add.? (I a!) (I b!)))
        (=>
         (= bc@ (curve25519_dalek!specs.field_specs.field_add.? (I b!) (I c!)))
         (and
          (and
           (=>
            (= tmp%1 (nClip (Add a! b!)))
            (and
             (=>
              %%location_label%%1
              (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%1 m@)
             )
             (=>
              (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%1 m@)
              (=>
               %%location_label%%2
               (< ab@ pn@)
           ))))
           (=>
            ...
            (and
             (=>
              %%location_label%%3
              (req%vstd!arithmetic.div_mod.lemma_small_mod. ab@ pn@)
             )
             (=>
              (ens%vstd!arithmetic.div_mod.lemma_small_mod. ab@ pn@)
              (and
               (=>
                %%location_label%%4
                (req%vstd!arithmetic.div_mod.lemma_add_mod_noop. ab@ c! m@)
               )
               (=>
                (ens%vstd!arithmetic.div_mod.lemma_add_mod_noop. ab@ c! m@)
                (=>
                 (= tmp%2 (nClip (Add a! b!)))
                 (and
                  (=>
                   %%location_label%%5
                   (req%vstd!arithmetic.div_mod.lemma_add_mod_noop. tmp%2 c! m@)
                  )
                  (=>
                   (ens%vstd!arithmetic.div_mod.lemma_add_mod_noop. tmp%2 c! m@)
                   (=>
                    %%location_label%%6
                    (= (curve25519_dalek!specs.field_specs.field_add.? (I ab@) (I c!)) (nClip (EucMod (nClip
                        (Add (nClip (Add a! b!)) c!)
                       ) m@
          )))))))))))))
          (=>
            ...
            (and
             (=>
              ...
              (and
               (=>
                %%location_label%%7
                (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%3 m@)
               )
               (=>
                (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%3 m@)
                (=>
                 %%location_label%%8
                 (< bc@ pn@)
             ))))
             (=>
              ...
              (and
               (=>
                %%location_label%%9
                (req%vstd!arithmetic.div_mod.lemma_small_mod. bc@ pn@)
               )
               (=>
                (ens%vstd!arithmetic.div_mod.lemma_small_mod. bc@ pn@)
                (and
                 (=>
                  %%location_label%%10
                  (req%vstd!arithmetic.div_mod.lemma_add_mod_noop. a! bc@ m@)
                 )
                 (=>
                  (ens%vstd!arithmetic.div_mod.lemma_add_mod_noop. a! bc@ m@)
                  (=>
                   (= tmp%4 (nClip (Add b! c!)))
                   (and
                    (=>
                     %%location_label%%11
                     (req%vstd!arithmetic.div_mod.lemma_add_mod_noop. a! tmp%4 m@)
                    )
                    (=>
                     (ens%vstd!arithmetic.div_mod.lemma_add_mod_noop. a! tmp%4 m@)
                     (=>
                      %%location_label%%12
                      (= (curve25519_dalek!specs.field_specs.field_add.? (I a!) (I bc@)) (nClip (EucMod (nClip
                          (Add (nClip (Add a! b!)) c!)
                         ) m@
            )))))))))))))
            (=>
