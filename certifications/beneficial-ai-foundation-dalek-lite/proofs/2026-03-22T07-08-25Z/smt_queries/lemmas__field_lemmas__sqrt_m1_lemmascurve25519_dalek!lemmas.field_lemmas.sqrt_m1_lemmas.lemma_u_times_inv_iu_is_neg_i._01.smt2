...
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_m1_lemmas.rs:376:1: 376:59 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::sqrt_m1_lemmas::lemma_u_times_inv_iu_is_neg_i
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_m1_lemmas.rs:376:1: 376:59 (#0)
           ...
           (and
            (and
             ...
             (=>
              ...
              (=>
               %%location_label%%2
               (= (curve25519_dalek!specs.field_specs.field_mul.? (I u!) (I inv_ui@)) inv_i@)
            )))
            (=>
             (= (curve25519_dalek!specs.field_specs.field_mul.? (I u!) (I inv_ui@)) inv_i@)
             (and
              (=>
               ...
               (=>
                %%location_label%%3
                (= inv_i@ (curve25519_dalek!specs.field_specs.field_neg.? (I i!)))
              ))
              (=>
               (= inv_i@ (curve25519_dalek!specs.field_specs.field_neg.? (I i!)))
               (=>
