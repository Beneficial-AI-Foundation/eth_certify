...
;; curve25519-dalek/src/lemmas/field_lemmas/to_bytes_reduction_lemmas.rs:451:1: 451:69 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::to_bytes_reduction_lemmas::lemma_carry_out_equals_q
;; curve25519-dalek/src/lemmas/field_lemmas/to_bytes_reduction_lemmas.rs:451:1: 451:69 (#0)
...
(push)
 ...
 (assert
  (forall ((i$ Poly)) (!
    ...
    :qid user_curve25519_dalek__lemmas__field_lemmas__to_bytes_reduction_lemmas__lemma_carry_out_equals_q_57
    :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__to_bytes_reduction_lemmas__lemma_carry_out_equals_q_57
 )))
 (assert
  (or
   (= q! 0)
             ...
             (=>
              ...
              (and
               ...
               (=>
                ...
                (and
                 (=>
                  (= val@ (Add (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. input_limbs!))
                    (Mul 19 q!)
                  ))
                  (and
                   (=>
                    (ens%vstd!arithmetic.mul.lemma_mul_basics_3. 19)
                    (=>
                     %%location_label%%4
                     (= 19 (Mul 19 q!))
                   ))
                   (=>
                    ...
                    (=>
                     ...
                     (=>
                      (= tmp%3 (>= (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. input_limbs!))
                        (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
                      ))
                      (and
                       (=>
                       ...
                       (=>
                        tmp%3
                        (=>
                         (= tmp%4 (>= val@ (vstd!arithmetic.power2.pow2.? (I 255))))
                         (and
                          (=>
                           %%location_label%%6
                           tmp%4
                             ...
                             (and
                              (and
                               (and
                                (=>
                                 %%location_label%%9
                                 (req%vstd!arithmetic.div_mod.lemma_div_is_ordered_by_denominator. val@ divisor@ val@)
                                )
                                (=>
                                 (ens%vstd!arithmetic.div_mod.lemma_div_is_ordered_by_denominator. val@ divisor@ val@)
                                 (=>
                                  %%location_label%%10
                                  (>= (EucDiv val@ divisor@) (EucDiv val@ val@))
                               )))
                               (=>
                                (>= (EucDiv val@ divisor@) (EucDiv val@ val@))
                                (and
                                 (=>
                                  (ens%vstd!arithmetic.div_mod.lemma_div_basics_3. val@)
                                  (=>
                                   %%location_label%%11
                                   (= (EucDiv val@ val@) 1)
                                 ))
                                 (=>
                                  ...
                                  (=>
                                   %%location_label%%12
                                   (>= (EucDiv val@ divisor@) 1)
                              )))))
                              (=>
                               (>= (EucDiv val@ divisor@) 1)
                               (=>
                                %%location_label%%13
                                (= (EucDiv (Add (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. input_limbs!))
                                   (Mul 19 q!)
                                  ) (vstd!arithmetic.power2.pow2.? (I 255))
                                 ) 1
                 ))))))))))))))))
