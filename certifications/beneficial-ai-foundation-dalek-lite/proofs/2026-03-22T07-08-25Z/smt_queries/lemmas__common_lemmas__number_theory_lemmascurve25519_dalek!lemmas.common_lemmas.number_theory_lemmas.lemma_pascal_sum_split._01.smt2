...
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:904:9: 904:15 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::number_theory_lemmas::lemma_pascal_sum_split
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:904:9: 904:15 (#0)
...
(push)
 ...
 (declare-const jm1@ Int)
 (declare-const cn1j1@ Int)
 (declare-const cn1j@ Int)
 ...
 (assert
  (not (=>
    %%location_label%%0
    (= (Mul (Add cn1j1@ cn1j@) pj@) (Add (Mul cn1j1@ pj@) (Mul cn1j@ pj@)))
 )))
 (get-info :version)
