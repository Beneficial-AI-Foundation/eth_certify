...
;; curve25519-dalek/src/lemmas/field_lemmas/load8_lemmas.rs:756:1: 763:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::load8_lemmas::lemma_load8_at_limb_X
;; curve25519-dalek/src/lemmas/field_lemmas/load8_lemmas.rs:756:1: 763:2 (#0)
...
(push)
 ...
 (assert
  (forall ((j$ Poly)) (!
    ...
    :qid user_curve25519_dalek__lemmas__field_lemmas__load8_lemmas__lemma_load8_at_limb_X_129
    :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__load8_lemmas__lemma_load8_at_limb_X_129
 )))
 (assert
  (forall ((j$ Poly)) (!
    (=>
    ...
    :qid user_curve25519_dalek__lemmas__field_lemmas__load8_lemmas__lemma_load8_at_limb_X_130
    :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__load8_lemmas__lemma_load8_at_limb_X_130
 )))
 (assert
  (forall ((j$ Poly)) (!
    (=>
    ...
    :qid user_curve25519_dalek__lemmas__field_lemmas__load8_lemmas__lemma_load8_at_limb_X_131
    :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__load8_lemmas__lemma_load8_at_limb_X_131
 )))
 (assert
  (forall ((j$ Poly)) (!
    (=>
    ...
    :qid user_curve25519_dalek__lemmas__field_lemmas__load8_lemmas__lemma_load8_at_limb_X_132
    :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__load8_lemmas__lemma_load8_at_limb_X_132
 )))
 ...
 (assert
  (not (=>
    (= p51@ (uClip 64 (vstd!arithmetic.power2.pow2.? (I 51))))
    (and
     (=>
      (ens%vstd!arithmetic.power2.lemma_pow2_pos. k!)
      (and
       (=>
        %%location_label%%0
        (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_u64_pow2_le_max. k!)
       ...
       (=>
        ...
        (=>
         %%location_label%%1
         (let
          ((tmp%%$ (vstd!arithmetic.power2.pow2.? (I k!))))
          (and
           (< 0 tmp%%$)
           (<= tmp%%$ 18446744073709551615)
     ))))))
     (=>
      ...
      (=>
       (= pk@ (uClip 64 (vstd!arithmetic.power2.pow2.? (I k!))))
       (and
        (=>
         %%location_label%%2
         (req%curve25519_dalek!lemmas.field_lemmas.load8_lemmas.lemma_load8_at_limb_base. input!
          i! (uClip 64 k!)
        ))
        (=>
         (ens%curve25519_dalek!lemmas.field_lemmas.load8_lemmas.lemma_load8_at_limb_base. input!
          i! (uClip 64 k!)
         )
         (and
          (=>
           ...
           (=>
            ...
            (=>
             (= tmp%1 (curve25519_dalek!lemmas.field_lemmas.load8_lemmas.pow2_mul_div_mod_small_mul_u8_t51_cond.?
               (I k!) (I j@)
             ))
             (and
              (=>
          ...
          (=>
           (forall ((j$ Int)) (!
             ...
             :qid user_curve25519_dalek__lemmas__field_lemmas__load8_lemmas__lemma_load8_at_limb_X_125
             :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__load8_lemmas__lemma_load8_at_limb_X_125
           ))
           (and
            (=>
             (<= 0 j$1@)
             (=>
              ...
              (=>
               (= tmp%4 (curve25519_dalek!lemmas.field_lemmas.load8_lemmas.pow2_mul_div_mod_small_div_u8_t51_cond.?
                 (I k!) (I j$1@)
               ))
               (and
                (=>
                    ...
                    (=>
                     ...
                     (=>
                      ...
                      (= (EucMod (EucDiv (uClip 64 (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.?
                           ...
                           ) (vstd!arithmetic.power2.pow2.? (I (nClip (Mul j$1@ 8))))
                          )
                         ) pk@
                        ) p51@
                       ) (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $ (UINT
                        ...
                        ) (vstd!arithmetic.power2.pow2.? (I (nClip (Sub (nClip (Mul j$1@ 8)) k!))))
            ))))))))))))
            (=>
             (forall ((j$ Int)) (!
               (=>
               ...
               :qid user_curve25519_dalek__lemmas__field_lemmas__load8_lemmas__lemma_load8_at_limb_X_126
               :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__load8_lemmas__lemma_load8_at_limb_X_126
             ))
             (and
              (=>
               (<= 0 j$2@)
               (=>
                ...
                (=>
                 (= tmp%7 (curve25519_dalek!lemmas.field_lemmas.load8_lemmas.pow2_mul_div_mod_close_mod_u8_t51_cond.?
                   (I k!) (I j$2@)
                 ))
                 (and
                  (=>
                  ...
                  (=>
                   tmp%7
                   (=>
                    (= tmp%8 (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $ (
                          UINT 8
                         )
                        ) (Poly%slice%<u8.>. input!)
                       ) (I (Add i! j$2@))
                      ...
                      (=>
                       ...
                       (=>
                        ...
                        (= (EucMod (EucDiv (uClip 64 (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.?
                             ...
                             ) (vstd!arithmetic.power2.pow2.? (I (nClip (Mul j$2@ 8))))
                            )
                           ) pk@
                          ) p51@
                         ) (nClip (Mul (EucMod (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $slice
                            ...
                            ) (vstd!arithmetic.power2.pow2.? (I (nClip (Sub 51 (Sub (nClip (Mul j$2@ 8)) k!)))))
                           ) (vstd!arithmetic.power2.pow2.? (I (nClip (Sub (nClip (Mul j$2@ 8)) k!))))
              )))))))))))))
              (=>
               (forall ((j$ Int)) (!
                 (=>
                 ...
                 :qid user_curve25519_dalek__lemmas__field_lemmas__load8_lemmas__lemma_load8_at_limb_X_127
                 :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__load8_lemmas__lemma_load8_at_limb_X_127
               ))
               (and
                (=>
                 (<= 0 j$3@)
                 (=>
                  ...
                  (=>
                   (= tmp%10 (curve25519_dalek!lemmas.field_lemmas.load8_lemmas.pow2_mul_div_mod_small_mod_u8_t51_cond.?
                     (I k!) (I j$3@)
                   ))
                   (and
                    (=>
                ...
                (=>
                 (forall ((j$ Int)) (!
                   ...
                   :qid user_curve25519_dalek__lemmas__field_lemmas__load8_lemmas__lemma_load8_at_limb_X_128
                   :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__load8_lemmas__lemma_load8_at_limb_X_128
                 ))
                 (and
                  (=>
                   %%location_label%%15
                   (forall ((j$ Int)) (!
                     ...
                     :qid user_curve25519_dalek__lemmas__field_lemmas__load8_lemmas__lemma_load8_at_limb_X_120
                     :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__load8_lemmas__lemma_load8_at_limb_X_120
                  )))
                  (and
                   (=>
                    %%location_label%%16
                    (forall ((j$ Int)) (!
                      ...
                      :qid user_curve25519_dalek__lemmas__field_lemmas__load8_lemmas__lemma_load8_at_limb_X_121
                      :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__load8_lemmas__lemma_load8_at_limb_X_121
                   )))
                   (and
                    (=>
                     %%location_label%%17
                     (forall ((j$ Int)) (!
                       ...
                       :qid user_curve25519_dalek__lemmas__field_lemmas__load8_lemmas__lemma_load8_at_limb_X_122
                       :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__load8_lemmas__lemma_load8_at_limb_X_122
                    )))
                    (and
                     (=>
                      %%location_label%%18
                      (forall ((j$ Int)) (!
                        ...
                        :qid user_curve25519_dalek__lemmas__field_lemmas__load8_lemmas__lemma_load8_at_limb_X_123
                        :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__load8_lemmas__lemma_load8_at_limb_X_123
                     )))
                     (=>
                      %%location_label%%19
                      (= (uClip 64 (bitand (I (uClip 64 (bitshr (I (uClip 64 (curve25519_dalek!specs.core_specs.spec_load8_at.?
