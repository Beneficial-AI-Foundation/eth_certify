...
;; MODULE 'module specs::montgomery_specs'
;; curve25519-dalek/src/specs/montgomery_specs.rs:547:1: 547:45 (#0)
...
(declare-const fuel%curve25519_dalek!specs.montgomery_specs.impl&%0.arrow_u. FuelId)
(declare-const fuel%curve25519_dalek!specs.montgomery_specs.impl&%0.arrow_v. FuelId)
(declare-const fuel%curve25519_dalek!specs.montgomery_specs.impl&%0.arrow_Finite_u.
 FuelId
)
(declare-const fuel%curve25519_dalek!specs.montgomery_specs.impl&%0.arrow_Finite_v.
 FuelId
)
(declare-const fuel%curve25519_dalek!specs.montgomery_specs.on_montgomery_curve. FuelId)
(declare-const fuel%curve25519_dalek!specs.montgomery_specs.is_valid_montgomery_affine.
 FuelId
)
...
(declare-const fuel%curve25519_dalek!specs.montgomery_specs.montgomery_corresponds_to_edwards.
 FuelId
)
(declare-const fuel%curve25519_dalek!specs.montgomery_specs.affine_projective_point_montgomery.
 FuelId
)
(declare-const fuel%curve25519_dalek!specs.montgomery_specs.projective_point_montgomery_as_nat.
 FuelId
)
...
(declare-const fuel%curve25519_dalek!specs.montgomery_specs.projective_represents_montgomery.
 FuelId
)
...
(assert
 (distinct fuel%vstd!arithmetic.power2.lemma_pow2_strictly_increases. fuel%vstd!array.array_view.
  ...
  fuel%curve25519_dalek!backend.serial.u64.constants.MONTGOMERY_A. fuel%curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.spec_gcd.
  ...
  fuel%curve25519_dalek!specs.core_specs.u8_32_as_nat. fuel%curve25519_dalek!specs.edwards_specs.edwards_point_as_nat.
  fuel%curve25519_dalek!specs.edwards_specs.edwards_point_as_affine. fuel%curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.
  ...
  fuel%curve25519_dalek!specs.field_specs.field_sqrt. fuel%curve25519_dalek!specs.field_specs_u64.p.
  ...
  fuel%curve25519_dalek!specs.field_specs_u64.u64_5_as_nat. fuel%curve25519_dalek!specs.montgomery_specs.impl&%0.arrow_u.
  fuel%curve25519_dalek!specs.montgomery_specs.impl&%0.arrow_v. fuel%curve25519_dalek!specs.montgomery_specs.impl&%0.arrow_Finite_u.
  fuel%curve25519_dalek!specs.montgomery_specs.impl&%0.arrow_Finite_v. fuel%curve25519_dalek!specs.montgomery_specs.on_montgomery_curve.
  fuel%curve25519_dalek!specs.montgomery_specs.is_valid_montgomery_affine. fuel%curve25519_dalek!specs.montgomery_specs.montgomery_rhs.
  fuel%curve25519_dalek!specs.montgomery_specs.canonical_sqrt. fuel%curve25519_dalek!specs.montgomery_specs.is_valid_u_coordinate.
  fuel%curve25519_dalek!specs.montgomery_specs.canonical_montgomery_lift. fuel%curve25519_dalek!specs.montgomery_specs.is_valid_montgomery_point.
  ...
  fuel%curve25519_dalek!specs.montgomery_specs.montgomery_point_as_nat. fuel%curve25519_dalek!specs.montgomery_specs.montgomery_corresponds_to_edwards.
  fuel%curve25519_dalek!specs.montgomery_specs.affine_projective_point_montgomery.
  fuel%curve25519_dalek!specs.montgomery_specs.projective_point_montgomery_as_nat.
  ...
  fuel%curve25519_dalek!specs.montgomery_specs.projective_represents_montgomery. fuel%curve25519_dalek!specs.montgomery_specs.projective_represents_montgomery_or_infinity.
  ...
  fuel%curve25519_dalek!specs.montgomery_specs.spec_elligator_encode. fuel%curve25519_dalek!specs.montgomery_specs.montgomery_ladder_invariant.
...
;; Function-Decl curve25519_dalek::specs::montgomery_specs::MontgomeryAffine::arrow_u
(declare-fun curve25519_dalek!specs.montgomery_specs.impl&%0.arrow_u.? (Poly) Int)

;; Function-Decl curve25519_dalek::specs::montgomery_specs::MontgomeryAffine::arrow_v
(declare-fun curve25519_dalek!specs.montgomery_specs.impl&%0.arrow_v.? (Poly) Int)

;; Function-Decl curve25519_dalek::specs::montgomery_specs::MontgomeryAffine::arrow_Finite_u
(declare-fun curve25519_dalek!specs.montgomery_specs.impl&%0.arrow_Finite_u.? (Poly)
 Int
)

;; Function-Decl curve25519_dalek::specs::montgomery_specs::MontgomeryAffine::arrow_Finite_v
(declare-fun curve25519_dalek!specs.montgomery_specs.impl&%0.arrow_Finite_v.? (Poly)
 Int
)

;; Function-Decl curve25519_dalek::specs::montgomery_specs::on_montgomery_curve
(declare-fun curve25519_dalek!specs.montgomery_specs.on_montgomery_curve.? (Poly Poly)
 Bool
)

;; Function-Decl curve25519_dalek::specs::montgomery_specs::is_valid_montgomery_affine
(declare-fun curve25519_dalek!specs.montgomery_specs.is_valid_montgomery_affine.?
 (Poly) Bool
)
...
;; Function-Decl curve25519_dalek::specs::montgomery_specs::montgomery_corresponds_to_edwards
(declare-fun curve25519_dalek!specs.montgomery_specs.montgomery_corresponds_to_edwards.?
 (Poly Poly) Bool
)

;; Function-Decl curve25519_dalek::specs::montgomery_specs::projective_point_montgomery_as_nat
(declare-fun curve25519_dalek!specs.montgomery_specs.projective_point_montgomery_as_nat.?
 (Poly) tuple%2.
)

;; Function-Decl curve25519_dalek::specs::montgomery_specs::affine_projective_point_montgomery
(declare-fun curve25519_dalek!specs.montgomery_specs.affine_projective_point_montgomery.?
 (Poly) Int
)
...
;; Function-Decl curve25519_dalek::specs::montgomery_specs::projective_represents_montgomery
(declare-fun curve25519_dalek!specs.montgomery_specs.projective_represents_montgomery.?
 (Poly Poly) Bool
)
...
(assert
 (=>
  ...
  (forall ((e1! Poly) (e2! Poly)) (!
    ...
    :qid user_vstd__arithmetic__power2__lemma_pow2_strictly_increases_18
    :skolemid skolem_user_vstd__arithmetic__power2__lemma_pow2_strictly_increases_18
))))
 ...
 (=>
  ...
  (forall ((a! Poly)) (!
    (= (curve25519_dalek!specs.field_specs.is_square.? a!) (exists ((y$ Poly)) (!
       ...
       :qid user_curve25519_dalek__specs__field_specs__is_square_19
       :skolemid skolem_user_curve25519_dalek__specs__field_specs__is_square_19
    )))
 ...
 (forall ((%%hole%%0 Type) (%%hole%%1 Int) (%%hole%%2 Int)) (!
   (=>
    (exists ((y$ Poly)) (!
      ...
      :pattern ((curve25519_dalek!specs.field_specs.field_mul.? y$ y$))
      :qid user_curve25519_dalek__specs__field_specs__field_sqrt_20
      :skolemid skolem_user_curve25519_dalek__specs__field_specs__field_sqrt_20
    ))
    (exists ((y$ Poly)) (!
      (and
       (and
...
;; Function-Axioms curve25519_dalek::specs::montgomery_specs::MontgomeryAffine::arrow_u
(assert
 (fuel_bool_default fuel%curve25519_dalek!specs.montgomery_specs.impl&%0.arrow_u.)
)
(assert
 (=>
  (fuel_bool fuel%curve25519_dalek!specs.montgomery_specs.impl&%0.arrow_u.)
  (forall ((self! Poly)) (!
    (= (curve25519_dalek!specs.montgomery_specs.impl&%0.arrow_u.? self!) (curve25519_dalek!specs.montgomery_specs.MontgomeryAffine./Finite/u
      (%Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine. self!)
    ))
    :pattern ((curve25519_dalek!specs.montgomery_specs.impl&%0.arrow_u.? self!))
    :qid internal_curve25519_dalek!specs.montgomery_specs.impl&__0.arrow_u.?_definition
    :skolemid skolem_internal_curve25519_dalek!specs.montgomery_specs.impl&__0.arrow_u.?_definition
))))
(assert
 (forall ((self! Poly)) (!
   (=>
    (has_type self! TYPE%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.)
    (<= 0 (curve25519_dalek!specs.montgomery_specs.impl&%0.arrow_u.? self!))
   )
   :pattern ((curve25519_dalek!specs.montgomery_specs.impl&%0.arrow_u.? self!))
   :qid internal_curve25519_dalek!specs.montgomery_specs.impl&__0.arrow_u.?_pre_post_definition
   :skolemid skolem_internal_curve25519_dalek!specs.montgomery_specs.impl&__0.arrow_u.?_pre_post_definition
)))

;; Function-Axioms curve25519_dalek::specs::montgomery_specs::MontgomeryAffine::arrow_v
(assert
 (fuel_bool_default fuel%curve25519_dalek!specs.montgomery_specs.impl&%0.arrow_v.)
)
(assert
 (=>
  (fuel_bool fuel%curve25519_dalek!specs.montgomery_specs.impl&%0.arrow_v.)
  (forall ((self! Poly)) (!
    (= (curve25519_dalek!specs.montgomery_specs.impl&%0.arrow_v.? self!) (curve25519_dalek!specs.montgomery_specs.MontgomeryAffine./Finite/v
      (%Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine. self!)
    ))
    :pattern ((curve25519_dalek!specs.montgomery_specs.impl&%0.arrow_v.? self!))
    :qid internal_curve25519_dalek!specs.montgomery_specs.impl&__0.arrow_v.?_definition
    :skolemid skolem_internal_curve25519_dalek!specs.montgomery_specs.impl&__0.arrow_v.?_definition
))))
(assert
 (forall ((self! Poly)) (!
   (=>
    (has_type self! TYPE%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.)
    (<= 0 (curve25519_dalek!specs.montgomery_specs.impl&%0.arrow_v.? self!))
   )
   :pattern ((curve25519_dalek!specs.montgomery_specs.impl&%0.arrow_v.? self!))
   :qid internal_curve25519_dalek!specs.montgomery_specs.impl&__0.arrow_v.?_pre_post_definition
   :skolemid skolem_internal_curve25519_dalek!specs.montgomery_specs.impl&__0.arrow_v.?_pre_post_definition
)))

;; Function-Axioms curve25519_dalek::specs::montgomery_specs::MontgomeryAffine::arrow_Finite_u
(assert
 (fuel_bool_default fuel%curve25519_dalek!specs.montgomery_specs.impl&%0.arrow_Finite_u.)
)
(assert
 (=>
  (fuel_bool fuel%curve25519_dalek!specs.montgomery_specs.impl&%0.arrow_Finite_u.)
  (forall ((self! Poly)) (!
    (= (curve25519_dalek!specs.montgomery_specs.impl&%0.arrow_Finite_u.? self!) (curve25519_dalek!specs.montgomery_specs.MontgomeryAffine./Finite/u
      (%Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine. self!)
    ))
    :pattern ((curve25519_dalek!specs.montgomery_specs.impl&%0.arrow_Finite_u.? self!))
    :qid internal_curve25519_dalek!specs.montgomery_specs.impl&__0.arrow_Finite_u.?_definition
    :skolemid skolem_internal_curve25519_dalek!specs.montgomery_specs.impl&__0.arrow_Finite_u.?_definition
))))
(assert
 (forall ((self! Poly)) (!
   (=>
    (has_type self! TYPE%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.)
    (<= 0 (curve25519_dalek!specs.montgomery_specs.impl&%0.arrow_Finite_u.? self!))
   )
   :pattern ((curve25519_dalek!specs.montgomery_specs.impl&%0.arrow_Finite_u.? self!))
   :qid internal_curve25519_dalek!specs.montgomery_specs.impl&__0.arrow_Finite_u.?_pre_post_definition
   :skolemid skolem_internal_curve25519_dalek!specs.montgomery_specs.impl&__0.arrow_Finite_u.?_pre_post_definition
)))

;; Function-Axioms curve25519_dalek::specs::montgomery_specs::MontgomeryAffine::arrow_Finite_v
(assert
 (fuel_bool_default fuel%curve25519_dalek!specs.montgomery_specs.impl&%0.arrow_Finite_v.)
)
(assert
 (=>
  (fuel_bool fuel%curve25519_dalek!specs.montgomery_specs.impl&%0.arrow_Finite_v.)
  (forall ((self! Poly)) (!
    (= (curve25519_dalek!specs.montgomery_specs.impl&%0.arrow_Finite_v.? self!) (curve25519_dalek!specs.montgomery_specs.MontgomeryAffine./Finite/v
      (%Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine. self!)
    ))
    :pattern ((curve25519_dalek!specs.montgomery_specs.impl&%0.arrow_Finite_v.? self!))
    :qid internal_curve25519_dalek!specs.montgomery_specs.impl&__0.arrow_Finite_v.?_definition
    :skolemid skolem_internal_curve25519_dalek!specs.montgomery_specs.impl&__0.arrow_Finite_v.?_definition
))))
(assert
 (forall ((self! Poly)) (!
   (=>
    (has_type self! TYPE%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.)
    (<= 0 (curve25519_dalek!specs.montgomery_specs.impl&%0.arrow_Finite_v.? self!))
   )
   :pattern ((curve25519_dalek!specs.montgomery_specs.impl&%0.arrow_Finite_v.? self!))
   :qid internal_curve25519_dalek!specs.montgomery_specs.impl&__0.arrow_Finite_v.?_pre_post_definition
   :skolemid skolem_internal_curve25519_dalek!specs.montgomery_specs.impl&__0.arrow_Finite_v.?_pre_post_definition
)))

;; Function-Axioms curve25519_dalek::specs::montgomery_specs::on_montgomery_curve
(assert
 (fuel_bool_default fuel%curve25519_dalek!specs.montgomery_specs.on_montgomery_curve.)
)
(assert
 (=>
  (fuel_bool fuel%curve25519_dalek!specs.montgomery_specs.on_montgomery_curve.)
  (forall ((u! Poly) (v! Poly)) (!
    (= (curve25519_dalek!specs.montgomery_specs.on_montgomery_curve.? u! v!) (let
      ((a$ (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
          curve25519_dalek!backend.serial.u64.constants.MONTGOMERY_A.?
      ))))
      (let
       ((u2$ (curve25519_dalek!specs.field_specs.field_square.? u!)))
       (let
        ((u3$ (curve25519_dalek!specs.field_specs.field_mul.? u! (I u2$))))
        (let
         ((v2$ (curve25519_dalek!specs.field_specs.field_square.? v!)))
         (let
          ((rhs$ (curve25519_dalek!specs.field_specs.field_add.? (I (curve25519_dalek!specs.field_specs.field_add.?
               (I u3$) (I (curve25519_dalek!specs.field_specs.field_mul.? (I a$) (I u2$)))
              )
             ) u!
          )))
          (= v2$ rhs$)
    ))))))
    :pattern ((curve25519_dalek!specs.montgomery_specs.on_montgomery_curve.? u! v!))
    :qid internal_curve25519_dalek!specs.montgomery_specs.on_montgomery_curve.?_definition
    :skolemid skolem_internal_curve25519_dalek!specs.montgomery_specs.on_montgomery_curve.?_definition
))))

;; Function-Axioms curve25519_dalek::specs::montgomery_specs::is_valid_montgomery_affine
(assert
 (fuel_bool_default fuel%curve25519_dalek!specs.montgomery_specs.is_valid_montgomery_affine.)
)
(assert
 (=>
  (fuel_bool fuel%curve25519_dalek!specs.montgomery_specs.is_valid_montgomery_affine.)
  (forall ((point! Poly)) (!
    (= (curve25519_dalek!specs.montgomery_specs.is_valid_montgomery_affine.? point!) (
      =>
      (not (is-curve25519_dalek!specs.montgomery_specs.MontgomeryAffine./Infinity (%Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.
         point!
      )))
      (let
       ...
       (let
        ...
        (curve25519_dalek!specs.montgomery_specs.on_montgomery_curve.? (I u$) (I v$))
    ))))
    :pattern ((curve25519_dalek!specs.montgomery_specs.is_valid_montgomery_affine.? point!))
    :qid internal_curve25519_dalek!specs.montgomery_specs.is_valid_montgomery_affine.?_definition
    :skolemid skolem_internal_curve25519_dalek!specs.montgomery_specs.is_valid_montgomery_affine.?_definition
))))
...
;; Function-Axioms curve25519_dalek::specs::montgomery_specs::montgomery_corresponds_to_edwards
(assert
 (fuel_bool_default fuel%curve25519_dalek!specs.montgomery_specs.montgomery_corresponds_to_edwards.)
)
(assert
 (=>
  (fuel_bool fuel%curve25519_dalek!specs.montgomery_specs.montgomery_corresponds_to_edwards.)
  (forall ((montgomery! Poly) (edwards! Poly)) (!
    (= (curve25519_dalek!specs.montgomery_specs.montgomery_corresponds_to_edwards.? montgomery!
      edwards!
     ) (let
      ((u$ (curve25519_dalek!specs.montgomery_specs.montgomery_point_as_nat.? montgomery!)))
      (let
       ((tmp%%$ (curve25519_dalek!specs.edwards_specs.edwards_point_as_affine.? edwards!)))
       (let
        ((x$ (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$))))))
        (let
         ((y$ (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$))))))
         (let
          ((denominator$ (curve25519_dalek!specs.field_specs.field_sub.? (I 1) (I y$))))
          (ite
           (= denominator$ 0)
           (= u$ 0)
           (let
            ((numerator$ (curve25519_dalek!specs.field_specs.field_add.? (I 1) (I y$))))
            (= u$ (curve25519_dalek!specs.field_specs.field_mul.? (I numerator$) (I (curve25519_dalek!specs.field_specs.field_inv.?
                (I denominator$)
    ))))))))))))
    :pattern ((curve25519_dalek!specs.montgomery_specs.montgomery_corresponds_to_edwards.?
      montgomery! edwards!
    ))
    :qid internal_curve25519_dalek!specs.montgomery_specs.montgomery_corresponds_to_edwards.?_definition
    :skolemid skolem_internal_curve25519_dalek!specs.montgomery_specs.montgomery_corresponds_to_edwards.?_definition
))))

;; Function-Axioms curve25519_dalek::specs::montgomery_specs::projective_point_montgomery_as_nat
(assert
 (fuel_bool_default fuel%curve25519_dalek!specs.montgomery_specs.projective_point_montgomery_as_nat.)
)
(assert
 (=>
  (fuel_bool fuel%curve25519_dalek!specs.montgomery_specs.projective_point_montgomery_as_nat.)
  (forall ((point! Poly)) (!
    (= (curve25519_dalek!specs.montgomery_specs.projective_point_montgomery_as_nat.? point!)
     (let
      ...
      (let
       ...
       (tuple%2./tuple%2 (I u$) (I w$))
    )))
    :pattern ((curve25519_dalek!specs.montgomery_specs.projective_point_montgomery_as_nat.?
      point!
    ))
    :qid internal_curve25519_dalek!specs.montgomery_specs.projective_point_montgomery_as_nat.?_definition
    :skolemid skolem_internal_curve25519_dalek!specs.montgomery_specs.projective_point_montgomery_as_nat.?_definition
))))
(assert
 (forall ((point! Poly)) (!
   (=>
    (has_type point! TYPE%curve25519_dalek!montgomery.ProjectivePoint.)
    (has_type (Poly%tuple%2. (curve25519_dalek!specs.montgomery_specs.projective_point_montgomery_as_nat.?
       point!
      )
     ) (TYPE%tuple%2. $ NAT $ NAT)
   ))
   ...
   :qid internal_curve25519_dalek!specs.montgomery_specs.projective_point_montgomery_as_nat.?_pre_post_definition
   :skolemid skolem_internal_curve25519_dalek!specs.montgomery_specs.projective_point_montgomery_as_nat.?_pre_post_definition
)))

;; Function-Axioms curve25519_dalek::specs::montgomery_specs::affine_projective_point_montgomery
(assert
 (fuel_bool_default fuel%curve25519_dalek!specs.montgomery_specs.affine_projective_point_montgomery.)
)
(assert
 (=>
  (fuel_bool fuel%curve25519_dalek!specs.montgomery_specs.affine_projective_point_montgomery.)
  (forall ((point! Poly)) (!
    (= (curve25519_dalek!specs.montgomery_specs.affine_projective_point_montgomery.? point!)
     (let
      ((tmp%%$ (curve25519_dalek!specs.montgomery_specs.projective_point_montgomery_as_nat.?
         point!
      )))
      (let
       ((u$ (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$))))))
       (let
        ((w$ (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$))))))
        (ite
         (= w$ 0)
         0
    ...
    :pattern ((curve25519_dalek!specs.montgomery_specs.affine_projective_point_montgomery.?
      point!
    ))
    :qid internal_curve25519_dalek!specs.montgomery_specs.affine_projective_point_montgomery.?_definition
    :skolemid skolem_internal_curve25519_dalek!specs.montgomery_specs.affine_projective_point_montgomery.?_definition
))))
(assert
 (forall ((point! Poly)) (!
   (=>
    (has_type point! TYPE%curve25519_dalek!montgomery.ProjectivePoint.)
    (<= 0 (curve25519_dalek!specs.montgomery_specs.affine_projective_point_montgomery.?
      point!
   )))
   :pattern ((curve25519_dalek!specs.montgomery_specs.affine_projective_point_montgomery.?
     point!
   ))
   :qid internal_curve25519_dalek!specs.montgomery_specs.affine_projective_point_montgomery.?_pre_post_definition
   :skolemid skolem_internal_curve25519_dalek!specs.montgomery_specs.affine_projective_point_montgomery.?_pre_post_definition
)))
...
;; Function-Axioms curve25519_dalek::specs::montgomery_specs::projective_represents_montgomery
(assert
 (fuel_bool_default fuel%curve25519_dalek!specs.montgomery_specs.projective_represents_montgomery.)
)
(assert
 (=>
  (fuel_bool fuel%curve25519_dalek!specs.montgomery_specs.projective_represents_montgomery.)
  (forall ((P_proj! Poly) (P_aff! Poly)) (!
    (= (curve25519_dalek!specs.montgomery_specs.projective_represents_montgomery.? P_proj!
      P_aff!
     ) (and
      (not (is-curve25519_dalek!specs.montgomery_specs.MontgomeryAffine./Infinity (%Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.
         P_aff!
    ...
    :pattern ((curve25519_dalek!specs.montgomery_specs.projective_represents_montgomery.?
      P_proj! P_aff!
    ))
    :qid internal_curve25519_dalek!specs.montgomery_specs.projective_represents_montgomery.?_definition
    :skolemid skolem_internal_curve25519_dalek!specs.montgomery_specs.projective_represents_montgomery.?_definition
))))
 ...
 (forall ((bytes! %%Function%%)) (!
   (= (req%curve25519_dalek!lemmas.common_lemmas.to_nat_lemmas.lemma_u8_32_as_nat_first_byte_only.
     ...
     (forall ((i$ Poly)) (!
       ...
       :qid user_curve25519_dalek__lemmas__common_lemmas__to_nat_lemmas__lemma_u8_32_as_nat_first_byte_only_21
       :skolemid skolem_user_curve25519_dalek__lemmas__common_lemmas__to_nat_lemmas__lemma_u8_32_as_nat_first_byte_only_21
   ))))
...
;; Function-Specs curve25519_dalek::specs::montgomery_specs::lemma_x25519_basepoint_u_is_9
(declare-fun ens%curve25519_dalek!specs.montgomery_specs.lemma_x25519_basepoint_u_is_9.
 (Int) Bool
)
(assert
 (forall ((no%param Int)) (!
   (= (ens%curve25519_dalek!specs.montgomery_specs.lemma_x25519_basepoint_u_is_9. no%param)
    (= (curve25519_dalek!specs.montgomery_specs.spec_x25519_basepoint_u.? (I 0)) 9)
   )
   :pattern ((ens%curve25519_dalek!specs.montgomery_specs.lemma_x25519_basepoint_u_is_9.
     no%param
   ))
   :qid internal_ens__curve25519_dalek!specs.montgomery_specs.lemma_x25519_basepoint_u_is_9._definition
   :skolemid skolem_internal_ens__curve25519_dalek!specs.montgomery_specs.lemma_x25519_basepoint_u_is_9._definition
)))

;; Function-Def curve25519_dalek::specs::montgomery_specs::lemma_x25519_basepoint_u_is_9
;; curve25519-dalek/src/specs/montgomery_specs.rs:547:1: 547:45 (#0)
...
(push)
 ...
 (declare-const bp_bytes@ %%Function%%)
 (assert
  fuel_defaults
 )
 ...
 (assert
  (not (=>
    (= bp_bytes@ (curve25519_dalek!montgomery.MontgomeryPoint./MontgomeryPoint/0 (%Poly%curve25519_dalek!montgomery.MontgomeryPoint.
       (Poly%curve25519_dalek!montgomery.MontgomeryPoint. curve25519_dalek!constants.X25519_BASEPOINT.?)
    )))
    (and
     (=>
     ...
     (=>
      ...
      (=>
       (= tmp%1 (= (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. bp_bytes@))
         9
       ))
       (and
        (=>
        ...
        (=>
         ...
         (=>
          ...
          (=>
           (= tmp%2 (vstd!arithmetic.power2.pow2.? (I 255)))
           (and
            (=>
             %%location_label%%2
             (req%vstd!arithmetic.div_mod.lemma_small_mod. 9 tmp%2)
            )
            (=>
             (ens%vstd!arithmetic.div_mod.lemma_small_mod. 9 tmp%2)
             (and
              (=>
               ...
               (and
                (=>
                 %%location_label%%3
                 (req%vstd!arithmetic.power2.lemma_pow2_strictly_increases. 5 255)
                )
                (=>
                 (ens%vstd!arithmetic.power2.lemma_pow2_strictly_increases. 5 255)
                 (=>
                  %%location_label%%4
                  (> (curve25519_dalek!specs.field_specs_u64.p.? (I 0)) 9)
              ))))
              (=>
               (> (curve25519_dalek!specs.field_specs_u64.p.? (I 0)) 9)
               (=>
                ...
                (and
                 (=>
                  %%location_label%%5
                  (req%vstd!arithmetic.div_mod.lemma_small_mod. 9 tmp%3)
                 )
                 (=>
                  (ens%vstd!arithmetic.div_mod.lemma_small_mod. 9 tmp%3)
                  (=>
                   %%location_label%%6
                   (= (curve25519_dalek!specs.montgomery_specs.spec_x25519_basepoint_u.? (I 0)) 9)
 ))))))))))))))))))
