...
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:1655:1: 1655:82 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::curve_equation_lemmas::lemma_edwards_scalar_mul_canonical
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:1655:1: 1655:82 (#0)
                 ...
                 (and
                  (=>
                   ...
                   (check_decrease_int (let
                     ((point_affine!$0 point_affine!) (n!$1 tmp%1))
                     n!$1
                  ...
                  (and
                   ...
                   (=>
                    ...
                    (=>
                     (= tmp%2 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. half@)))))
                     (=>
                      (= tmp%3 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. half@)))))
                      (=>
                       (= tmp%4 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. half@)))))
                       (=>
                        (= tmp%5 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. half@)))))
                        (=>
                         (ens%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_edwards_add_canonical.
                ...
                (=>
                 ...
                 (and
                  (=>
                   %%location_label%%2
                   (check_decrease_int (let
                     ((point_affine!$0 point_affine!) (n!$1 tmp%6))
                     n!$1
                    ) decrease%init0 false
                  ))
                  (and
                   ...
                   (=>
                    ...
                    (=>
                     (= tmp%7 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. prev@)))))
                     (=>
                      (= tmp%8 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. prev@)))))
                      (=>
                       (= tmp%9 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. point_affine!)))))
                       (=>
                        (= tmp%10 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. point_affine!)))))
                        (=>
                         (ens%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_edwards_add_canonical.
