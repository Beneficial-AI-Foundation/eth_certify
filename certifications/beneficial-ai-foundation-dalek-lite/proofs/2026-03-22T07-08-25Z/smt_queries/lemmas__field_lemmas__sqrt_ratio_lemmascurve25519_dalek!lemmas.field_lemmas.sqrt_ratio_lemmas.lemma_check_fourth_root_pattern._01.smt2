...
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_ratio_lemmas.rs:787:1: 792:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::sqrt_ratio_lemmas::lemma_check_fourth_root_pattern
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_ratio_lemmas.rs:787:1: 792:2 (#0)
                                  ...
                                  (=>
                                   ...
                                   (and
                                    ...
                                    (=>
                                     ...
                                     (=>
                                      (= tmp%3 (nClip (Sub pn@ i@)))
                                      (and
                                       (=>
                                        %%location_label%%8
                                        (req%vstd!arithmetic.div_mod.lemma_small_mod. tmp%3 pn@)
                                       )
                                       (=>
                                        (ens%vstd!arithmetic.div_mod.lemma_small_mod. tmp%3 pn@)
                                        (=>
                                         (= tmp%4 (= (curve25519_dalek!specs.field_specs.field_neg.? (I i@)) (nClip (Sub pn@ i@))))
                                         (and
                                          (=>
                                           %%location_label%%9
                                           tmp%4
                                             ...
                                             (=>
                                              ...
                                              (or
                                               (or
                                                ...
                                                (= check_nat! (curve25519_dalek!specs.field_specs.field_mul.? (I u_nat!) (I i@)))
                                               )
                                               (= check_nat! (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_neg.?
                                                   (I u_nat!)
                                                  )
