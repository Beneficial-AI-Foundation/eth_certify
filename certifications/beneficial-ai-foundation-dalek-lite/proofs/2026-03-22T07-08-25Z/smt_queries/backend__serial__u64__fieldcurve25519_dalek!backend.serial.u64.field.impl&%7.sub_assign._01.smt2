...
;; curve25519-dalek/src/backend/serial/u64/field.rs:291:5: 291:55 (#0)
...
;; Function-Def curve25519_dalek::backend::serial::u64::field::FieldElement51::sub_assign
;; curve25519-dalek/src/backend/serial/u64/field.rs:291:5: 291:55 (#0)
  ...
  (not (and
    ...
    (=>
     (ens%curve25519_dalek!backend.serial.u64.field.impl&%9.sub. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
       self!@0
      ) (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. _rhs!) tmp%1
     )
     (=>
      (= result@ (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. tmp%1))
      (=>
       ...
       (=>
        ...
        (=>
         ...
         (=>
          (= tmp%3 (ext_eq false TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.
            (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. self!@1) (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
             result@
          )))
          (and
           (=>
           ...
           (=>
            ...
            (and
             ...
             (and
              (=>
               %%location_label%%3
               (= self!@1 (curve25519_dalek!specs.field_specs.spec_sub_limbs.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                  self!@0
                 ) (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. _rhs!)
              )))
              (=>
