...
;; curve25519-dalek/src/lemmas/field_lemmas/load8_lemmas.rs:388:7: 396:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::load8_lemmas::lemma_load8_shift_mod_aux
;; curve25519-dalek/src/lemmas/field_lemmas/load8_lemmas.rs:388:7: 396:2 (#0)
(get-info :all-statistics)
(push)
 (declare-const s_jplus1! Int)
 (declare-const s_j! Int)
 (declare-const a_jplus1! Int)
 (declare-const x! Int)
 (declare-const j! Int)
 (declare-const s! Int)
 (declare-const t! Int)
     ...
     (and
      (or
         ...
         (and
          (or
            ...
            (=>
             ...
             (=>
              ...
              (and
               (=>
                %%location_label%%0
                (req%vstd!arithmetic.power2.lemma_pow2_strictly_increases. s! tmp%1)
               )
               (=>
                (ens%vstd!arithmetic.power2.lemma_pow2_strictly_increases. s! tmp%1)
                %%switch_label%%1
            ))))
            (=>
             (not (< s! (nClip (Mul j! 8))))
           ...
           (and
            ...
            (=>
             %%location_label%%1
             (<= (vstd!arithmetic.power2.pow2.? (I s!)) (vstd!arithmetic.power2.pow2.? (I (nClip (
                  Mul j! 8
          ))))))))
          (=>
           (<= (vstd!arithmetic.power2.pow2.? (I s!)) (vstd!arithmetic.power2.pow2.? (I (nClip (
           ...
           (and
            (=>
             (= tmp%2 (vstd!arithmetic.power2.pow2.? (I s!)))
             (=>
              (= tmp%3 (vstd!arithmetic.power2.pow2.? (I (nClip (Mul j! 8)))))
              (and
               (=>
                %%location_label%%2
               ...
               (=>
                ...
                (=>
                 %%location_label%%3
                 (<= (Mul x! (vstd!arithmetic.power2.pow2.? (I s!))) a_jplus1!)
            )))))
            (=>
             (<= (Mul x! (vstd!arithmetic.power2.pow2.? (I s!))) a_jplus1!)
             (=>
              (= tmp%4 (let
                ((tmp%%$ (Add s_j! a_jplus1!)))
                (and
                 (<= (Add s_j! (Mul x! (vstd!arithmetic.power2.pow2.? (I s!)))) tmp%%$)
                 (<= tmp%%$ 18446744073709551615)
              )))
              (and
               (=>
                   ...
                   (and
                    ...
                    (=>
                     ...
                     (=>
                      ...
                      (and
                       (and
                        (< (EucDiv s_j! ps64@) (vstd!arithmetic.power2.pow2.? (I d@)))
                        (= (EucDiv a_jplus1! ps64@) (Mul x! (vstd!arithmetic.power2.pow2.? (I d@))))
                       )
                       (<= (Add (EucDiv s_j! ps64@) (Mul x! (vstd!arithmetic.power2.pow2.? (I d@)))) 18446744073709551615)
                  )))))
                  (=>
                   (and
                    (and
                     ...
                     (and
                      ...
                      (=>
                       ...
                       (=>
                        %%location_label%%8
                        (let
                         ((tmp%%$ (Add (EucMod (EucDiv s_j! ps64@) pt64@) (EucMod (uClip 64 (Mul x! (vstd!arithmetic.power2.pow2.?
                                (I d@)
                              ))
                             ) pt64@
                         ))))
                         (and
                          (= (EucMod (uClip 64 (Add (EucDiv s_j! ps64@) (Mul x! (vstd!arithmetic.power2.pow2.? (I
                                 d@
                             ))))
                            ) pt64@
                           ) tmp%%$
                          )
                          (= tmp%%$ (Add (EucMod (EucDiv s_j! ps64@) pt64@) (EucMod (EucDiv a_jplus1! ps64@) pt64@)))
                    ))))))
                    (=>
                     (let
                      ((tmp%%$ (Add (EucMod (EucDiv s_j! ps64@) pt64@) (EucMod (uClip 64 (Mul x! (vstd!arithmetic.power2.pow2.?
         ...
         (and
          (=>
           ...
           (and
            (=>
             %%location_label%%9
             (req%vstd!arithmetic.power2.lemma_pow2_strictly_increases. tmp%7 s!)
            )
            (=>
             (ens%vstd!arithmetic.power2.lemma_pow2_strictly_increases. tmp%7 s!)
             (=>
              %%location_label%%10
              (< (vstd!arithmetic.power2.pow2.? (I (nClip (Mul j! 8)))) (vstd!arithmetic.power2.pow2.?
                (I s!)
          ))))))
          (=>
           (< (vstd!arithmetic.power2.pow2.? (I (nClip (Mul j! 8)))) (vstd!arithmetic.power2.pow2.?
           ...
           (and
            (and
             (=>
              %%location_label%%11
              (req%vstd!arithmetic.div_mod.lemma_basic_div. s_j! ps64@)
             )
             (=>
              (ens%vstd!arithmetic.div_mod.lemma_basic_div. s_j! ps64@)
              (=>
               %%location_label%%12
               (= (EucDiv s_j! ps64@) 0)
            )))
            (=>
             ...
             (and
              (=>
               (= tmp%8 (vstd!arithmetic.power2.pow2.? (I t!)))
               (and
                (=>
                 %%location_label%%13
                 (req%vstd!arithmetic.div_mod.lemma_small_mod. 0 tmp%8)
                )
                (=>
                 (ens%vstd!arithmetic.div_mod.lemma_small_mod. 0 tmp%8)
                 (=>
                  %%location_label%%14
                  (= (EucMod 0 pt64@) 0)
              ))))
       ...
       (and
        ...
        (=>
         %%location_label%%15
         (= (EucMod (EucDiv s_jplus1! ps64@) pt64@) (Add (EucMod (EucDiv s_j! ps64@) pt64@)
           (EucMod (EucDiv a_jplus1! ps64@) pt64@)
      )))))
      (=>
       (= (EucMod (EucDiv s_jplus1! ps64@) pt64@) (Add (EucMod (EucDiv s_j! ps64@) pt64@)
         (EucMod (EucDiv a_jplus1! ps64@) pt64@)
       ...
       (=>
        %%location_label%%16
        (= (EucMod (EucDiv s_jplus1! (uClip 64 (vstd!arithmetic.power2.pow2.? (I s!)))) (uClip
           64 (vstd!arithmetic.power2.pow2.? (I t!))
          )
         ) (Add (EucMod (EucDiv s_j! (uClip 64 (vstd!arithmetic.power2.pow2.? (I s!)))) (uClip
            64 (vstd!arithmetic.power2.pow2.? (I t!))
