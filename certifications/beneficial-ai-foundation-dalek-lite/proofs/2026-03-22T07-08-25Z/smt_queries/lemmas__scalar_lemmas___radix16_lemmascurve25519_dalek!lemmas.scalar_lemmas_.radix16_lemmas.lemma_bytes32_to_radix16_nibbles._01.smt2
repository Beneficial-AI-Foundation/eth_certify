...
;; curve25519-dalek/src/lemmas/scalar_lemmas_/radix16_lemmas.rs:124:1: 124:81 (#0)
...
;; Function-Def curve25519_dalek::lemmas::scalar_lemmas_::radix16_lemmas::lemma_bytes32_to_radix16_nibbles
;; curve25519-dalek/src/lemmas/scalar_lemmas_/radix16_lemmas.rs:124:1: 124:81 (#0)
(get-info :all-statistics)
(push)
 (declare-const output! %%Function%%)
 ...
 (declare-const out_seq@ vstd!seq.Seq<i8.>.)
 (declare-const byte_seq@ vstd!seq.Seq<u8.>.)
 (assert
  fuel_defaults
 )
 (assert
  (has_type (Poly%array%. output!) (ARRAY $ (SINT 8) $ (CONST_INT 64)))
 )
 (assert
 ...
 (assert
  (forall ((i$ Int)) (!
    ...
    :qid user_curve25519_dalek__lemmas__scalar_lemmas___radix16_lemmas__lemma_bytes32_to_radix16_nibbles_38
    :skolemid skolem_user_curve25519_dalek__lemmas__scalar_lemmas___radix16_lemmas__lemma_bytes32_to_radix16_nibbles_38
 )))
 (assert
  (forall ((i$ Poly)) (!
    (=>
    ...
    :qid user_curve25519_dalek__lemmas__scalar_lemmas___radix16_lemmas__lemma_bytes32_to_radix16_nibbles_39
    :skolemid skolem_user_curve25519_dalek__lemmas__scalar_lemmas___radix16_lemmas__lemma_bytes32_to_radix16_nibbles_39
 )))
 ;; assertion failed
 ...
 (assert
  (not (=>
    (= out_seq@ (%Poly%vstd!seq.Seq<i8.>. (vstd!view.View.view.? $ (ARRAY $ (SINT 8) $ (CONST_INT
         64
        )
       ) (Poly%array%. output!)
    )))
    (=>
     (= byte_seq@ (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (
          CONST_INT 32
         )
        ) (Poly%array%. bytes!)
     )))
     (and
      (=>
       ...
       (=>
        (= tmp%1 (= (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. out_seq@) (I (Mul
             2 i@
           ))
          ) (vstd!seq.Seq.index.? $ (SINT 8) (vstd!view.View.view.? $ (ARRAY $ (SINT 8) $ (CONST_INT
              64
        ...
        (and
         ...
         (=>
          tmp%1
          (=>
           (= tmp%2 (= (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. out_seq@) (I (Add
                (Mul 2 i@) 1
              ))
             ) (vstd!seq.Seq.index.? $ (SINT 8) (vstd!view.View.view.? $ (ARRAY $ (SINT 8) $ (CONST_INT
                 64
           ...
           (and
            ...
            (=>
             tmp%2
             (=>
              (= tmp%3 (= (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. byte_seq@) (I i@))
              ...
              (and
               ...
               (=>
                ...
                (=>
                 %%location_label%%3
                 (= (Add (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. out_seq@) (I (Mul
                       2 i@
                    )))
                   ) (Mul 16 (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. out_seq@) (I
                       (Add (Mul 2 i@) 1)
                   ))))
                  ) (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. byte_seq@) (I i@)))
      ))))))))))))
      (=>
       (forall ((i$ Int)) (!
         (=>
         ...
         :pattern ((vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. out_seq@) (I (Mul
             2 i$
           ))
          ) (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. out_seq@) (I (Add (Mul 2
              i$
             ) 1
         ))))
         :qid user_curve25519_dalek__lemmas__scalar_lemmas___radix16_lemmas__lemma_bytes32_to_radix16_nibbles_36
         :skolemid skolem_user_curve25519_dalek__lemmas__scalar_lemmas___radix16_lemmas__lemma_bytes32_to_radix16_nibbles_36
       ))
       (and
        (=>
         (has_type i$1@ INT)
         (=>
          ...
          (=>
           (= tmp%4 (= (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. out_seq@) i$1@)
             (vstd!seq.Seq.index.? $ (SINT 8) (vstd!view.View.view.? $ (ARRAY $ (SINT 8) $ (CONST_INT
                 64
                )
               ) (Poly%array%. output!)
           ...
           (and
            ...
            (=>
             ...
             (=>
              %%location_label%%5
              (>= (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. out_seq@) i$1@))
               0
        )))))))
        (=>
         (forall ((i$ Poly)) (!
           (=>
            ...
            (=>
             ...
             (>= (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. out_seq@) i$)) 0)
           ))
           :pattern ((vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. out_seq@) i$))
           :qid user_curve25519_dalek__lemmas__scalar_lemmas___radix16_lemmas__lemma_bytes32_to_radix16_nibbles_37
           :skolemid skolem_user_curve25519_dalek__lemmas__scalar_lemmas___radix16_lemmas__lemma_bytes32_to_radix16_nibbles_37
         ))
         (and
          (=>
           %%location_label%%6
          ...
          (=>
           ...
           (=>
            (= tmp%5 (ext_eq false (TYPE%vstd!seq.Seq. $ (SINT 8)) (vstd!seq.Seq.subrange.? $ (SINT
                8
               ) (Poly%vstd!seq.Seq<i8.>. out_seq@) (I 0) (I 64)
              ) (Poly%vstd!seq.Seq<i8.>. out_seq@)
            ))
            (and
             (=>
              %%location_label%%7
