...
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:3015:1: 3015:72 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::curve_equation_lemmas::lemma_edwards_to_montgomery_correspondence
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:3015:1: 3015:72 (#0)
...
(push)
 ...
 (declare-const zpy@ Int)
 (declare-const zmy@ Int)
 (declare-const one_plus_y@ Int)
 (declare-const one_minus_y@ Int)
 (declare-const proj@ Int)
 (declare-const affi@ Int)
 (assert
  fuel_defaults
 )
 (assert
 ...
 (assert
  (not (=>
    ...
    (=>
     (= y_aff@ (curve25519_dalek!specs.field_specs.field_mul.? (I y!) (I inv_z@)))
     (and
      (=>
         ...
         (=>
          ...
          (=>
           ...
           (or
            (and
             (=>
              (= (EucMod inv_z@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0)
              (=>
               (= tmp%1 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
               (and
                (=>
                 %%location_label%%2
                 (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. inv_z@ z! tmp%1)
                )
                (=>
                 (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. inv_z@ z! tmp%1)
                 (and
                  (=>
                   ...
                   (and
                    (=>
                     %%location_label%%3
                     (req%vstd!arithmetic.div_mod.lemma_mod_self_0. tmp%2)
                    )
                    (=>
                     (ens%vstd!arithmetic.div_mod.lemma_mod_self_0. tmp%2)
                     (=>
                      %%location_label%%4
                      (= (curve25519_dalek!specs.field_specs.field_mul.? (I inv_z@) (I z!)) 0)
                  ))))
                  (=>
                   (= (curve25519_dalek!specs.field_specs.field_mul.? (I inv_z@) (I z!)) 0)
                   %%switch_label%%1
             ...
             (=>
              (not (= (EucMod inv_z@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0))
              %%switch_label%%1
            ))
            (and
             (not %%switch_label%%1)
          ...
          (and
           ...
           (=>
            ...
            (=>
             ...
             (=>
              %%location_label%%7
              (= (curve25519_dalek!specs.field_specs.field_mul.? (I z!) (I inv_z@)) 1)
          ))))
          (=>
           (= (curve25519_dalek!specs.field_specs.field_mul.? (I z!) (I inv_z@)) 1)
           (and
            (=>
             ...
             (=>
              (= tmp%3 (curve25519_dalek!specs.field_specs.field_add.? (I z!) (I y!)))
              (=>
               (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_comm.
                inv_z@ tmp%3
               )
               (=>
                ...
                (=>
                 ...
                 (= (curve25519_dalek!specs.field_specs.field_add.? (I 1) (I y_aff@)) (curve25519_dalek!specs.field_specs.field_mul.?
                   (I (curve25519_dalek!specs.field_specs.field_add.? (I z!) (I y!))) (I inv_z@)
            )))))))
            (=>
             (= (curve25519_dalek!specs.field_specs.field_add.? (I 1) (I y_aff@)) (curve25519_dalek!specs.field_specs.field_mul.?
               (I (curve25519_dalek!specs.field_specs.field_add.? (I z!) (I y!))) (I inv_z@)
                ...
                (=>
                 ...
                 (=>
                  ...
                  (= (curve25519_dalek!specs.field_specs.field_sub.? (I 1) (I y_aff@)) (curve25519_dalek!specs.field_specs.field_mul.?
                    (I (curve25519_dalek!specs.field_specs.field_sub.? (I z!) (I y!))) (I inv_z@)
              ))))))
              (=>
               (= (curve25519_dalek!specs.field_specs.field_sub.? (I 1) (I y_aff@)) (curve25519_dalek!specs.field_specs.field_mul.?
                 (I (curve25519_dalek!specs.field_specs.field_sub.? (I z!) (I y!))) (I inv_z@)
               ...
               (=>
                (= zpy@ (curve25519_dalek!specs.field_specs.field_add.? (I z!) (I y!)))
                (=>
                 (= zmy@ (curve25519_dalek!specs.field_specs.field_sub.? (I z!) (I y!)))
                 (=>
                  (= one_plus_y@ (curve25519_dalek!specs.field_specs.field_add.? (I 1) (I y_aff@)))
                  (=>
                   (= one_minus_y@ (curve25519_dalek!specs.field_specs.field_sub.? (I 1) (I y_aff@)))
                   (=>
                    (= proj@ (curve25519_dalek!specs.field_specs.field_mul.? (I zpy@) (I (curve25519_dalek!specs.field_specs.field_inv.?
                        (I zmy@)
                    ))))
                    (=>
                     (= affi@ (curve25519_dalek!specs.field_specs.field_mul.? (I one_plus_y@) (I (curve25519_dalek!specs.field_specs.field_inv.?
                         (I one_minus_y@)
                     ))))
                     (or
                      (and
                       (=>
                        (not (= (EucMod zmy@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0))
                        (and
                         (and
                          (=>
                           %%location_label%%10
                       ...
                       (=>
                        (not (not (= (EucMod zmy@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0)))
                        (and
                         (=>
                          ...
                          (and
                           (=>
                            %%location_label%%12
                            (req%vstd!arithmetic.div_mod.lemma_mod_bound. z! tmp%4)
                           )
                           (=>
                            (ens%vstd!arithmetic.div_mod.lemma_mod_bound. z! tmp%4)
                            (=>
                             (= tmp%5 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                             (and
                              (=>
                               %%location_label%%13
                               (req%vstd!arithmetic.div_mod.lemma_mod_bound. y! tmp%5)
                              )
                              (=>
                               (ens%vstd!arithmetic.div_mod.lemma_mod_bound. y! tmp%5)
                               (=>
                                (= tmp%6 (Sub (nClip (Add (EucMod z! (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                                    (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
                                   )
                                  ) (EucMod y! (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                                ))
                                  ...
                                  (=>
                                   ...
                                   (=>
                                    ...
                                    (and
                                     (=>
                                      %%location_label%%15
                                      (req%vstd!arithmetic.div_mod.lemma_small_mod. zmy@ tmp%8)
                                     )
                                     (=>
                                      (ens%vstd!arithmetic.div_mod.lemma_small_mod. zmy@ tmp%8)
                                      (=>
                                       %%location_label%%16
                                       (= zmy@ 0)
                         ))))))))))))))
                           ...
                           (and
                            (=>
                             ...
                             (=>
                              ...
                              (=>
                               %%location_label%%17
                               (= (curve25519_dalek!specs.field_specs.field_mul.? (I 0) (I inv_z@)) 0)
                            )))
                            (=>
                             (= (curve25519_dalek!specs.field_specs.field_mul.? (I 0) (I inv_z@)) 0)
                             (=>
