...
;; curve25519-dalek/src/lemmas/field_lemmas/mul_lemmas.rs:158:1: 158:79 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::mul_lemmas::lemma_mul_c_i_shift_bounded
;; curve25519-dalek/src/lemmas/field_lemmas/mul_lemmas.rs:158:1: 158:79 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= tmp%1 (curve25519_dalek!lemmas.field_lemmas.mul_lemmas.mul_c0_val.? (Poly%array%.
       a!
      ) (Poly%array%. b!)
    ))
    (and
     ...
     (=>
      ...
      (=>
       (= tmp%2 (curve25519_dalek!lemmas.field_lemmas.mul_lemmas.mul_c1_val.? (Poly%array%.
          a!
         ) (Poly%array%. b!)
       ))
       (and
        ...
        (=>
         ...
         (=>
          (= tmp%3 (curve25519_dalek!lemmas.field_lemmas.mul_lemmas.mul_c2_val.? (Poly%array%.
             a!
            ) (Poly%array%. b!)
          ))
          (and
           ...
           (=>
            ...
            (=>
             (= tmp%4 (curve25519_dalek!lemmas.field_lemmas.mul_lemmas.mul_c3_val.? (Poly%array%.
                a!
               ) (Poly%array%. b!)
             ))
             (and
              ...
              (=>
               ...
               (=>
                (= tmp%5 (curve25519_dalek!lemmas.field_lemmas.mul_lemmas.mul_c4_val.? (Poly%array%.
                   a!
                  ) (Poly%array%. b!)
                ))
                (and
