...
;; curve25519-dalek/src/lemmas/field_lemmas/add_lemmas.rs:16:1: 16:75 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::add_lemmas::lemma_field51_add
;; curve25519-dalek/src/lemmas/field_lemmas/add_lemmas.rs:16:1: 16:75 (#0)
(get-info :all-statistics)
(push)
 (declare-const lhs! curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const rhs! curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 ...
 (assert
  (has_type (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. lhs!) TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 )
 (assert
  (has_type (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. rhs!) TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 )
 (assert
  (curve25519_dalek!specs.field_specs.sum_of_limbs_bounded.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
    lhs!
         ...
         (=>
          ...
          (=>
           ...
           (and
            (=>
             %%location_label%%3
             (req%vstd!arithmetic.div_mod.lemma_add_mod_noop. tmp%3 tmp%4 tmp%5)
            )
            (=>
             (ens%vstd!arithmetic.div_mod.lemma_add_mod_noop. tmp%3 tmp%4 tmp%5)
             (=>
              %%location_label%%4
              (= (EucMod (nClip (Add (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%.
               ...
               ) (EucMod (nClip (Add (EucMod (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (
                     Poly%array%. (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
                      (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                        lhs!
                    ))))
