...
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_m1_lemmas.rs:173:1: 173:52 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::sqrt_m1_lemmas::lemma_multiply_by_i_flips_sign
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_m1_lemmas.rs:173:1: 173:52 (#0)
...
(push)
 ...
 (declare-const ri_mod@ Int)
 (declare-const r2@ Int)
 (declare-const r2_mod@ Int)
 (declare-const i2@ Int)
 (declare-const pn_minus_1@ Int)
 (declare-const neg_r2@ Int)
 (assert
  fuel_defaults
 )
 (assert
    ...
    (=>
     ...
     (=>
      ...
      (=>
       (= ri@ (nClip (Mul r! i@)))
       (=>
        (= ri_mod@ (curve25519_dalek!specs.field_specs.field_mul.? (I r!) (I i@)))
        (=>
         (= r2@ (nClip (Mul r! r!)))
         (=>
          (= r2_mod@ (curve25519_dalek!specs.field_specs.field_square.? (I r!)))
          (=>
           (= i2@ (nClip (Mul i@ i@)))
           (=>
            (= pn_minus_1@ (nClip (Sub pn@ 1)))
            (and
             (and
              (=>
               (ens%curve25519_dalek!lemmas.common_lemmas.mul_lemmas.lemma_product_square_factorize.
               ...
               (=>
                %%location_label%%0
                (= (nClip (Mul ri@ ri@)) (nClip (Mul r2@ i2@)))
              ))
              (=>
               (= (nClip (Mul ri@ ri@)) (nClip (Mul r2@ i2@)))
               (and
                ...
                (=>
                 ...
                 (and
                  (=>
                   %%location_label%%2
                   (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. r2@ i2@ pn@)
                  )
                  (=>
                   (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. r2@ i2@ pn@)
                   (=>
                    %%location_label%%3
                    (= (EucMod (nClip (Mul ri@ ri@)) pn@) (EucMod (nClip (Mul r2@ pn_minus_1@)) pn@))
             )))))))
             (=>
              (= (EucMod (nClip (Mul ri@ ri@)) pn@) (EucMod (nClip (Mul r2@ pn_minus_1@)) pn@))
              (and
               (and
                (=>
                 %%location_label%%4
                 (req%vstd!arithmetic.div_mod.lemma_mod_bound. r2@ pn@)
                )
                (=>
                 (ens%vstd!arithmetic.div_mod.lemma_mod_bound. r2@ pn@)
                 (=>
                  %%location_label%%5
                  (< r2_mod@ pn@)
               )))
               (=>
                (< r2_mod@ pn@)
                (=>
                 (= neg_r2@ (nClip (EucMod (Sub pn@ r2_mod@) pn@)))
                 (and
                  (and
                   (=>
                    %%location_label%%6
                   ...
                   (=>
                    ...
                    (=>
                     %%location_label%%7
                     (= (EucMod (nClip (Mul r2@ pn_minus_1@)) pn@) neg_r2@)
                  )))
                  (=>
                   (= (EucMod (nClip (Mul r2@ pn_minus_1@)) pn@) neg_r2@)
                   (and
                    (and
                     (=>
                      %%location_label%%8
                      (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. ri@ ri@ pn@)
                     )
                     (=>
                      (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. ri@ ri@ pn@)
                      (=>
                       (= tmp%1 (EucMod ri@ pn@))
                       (and
                        (=>
                         %%location_label%%9
                         (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. tmp%1 ri@ pn@)
                        )
                        (=>
                         (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. tmp%1 ri@ pn@)
                         (=>
                          %%location_label%%10
                          (= (curve25519_dalek!specs.field_specs.field_square.? (I ri_mod@)) (EucMod (nClip (Mul
                              ri@ ri@
                             )
                            ) pn@
                    ))))))))
                    (=>
                     ...
                     (and
                      (and
                       (=>
                        %%location_label%%11
                        (req%vstd!arithmetic.div_mod.lemma_small_mod. r2_mod@ pn@)
                       )
                       (=>
                        (ens%vstd!arithmetic.div_mod.lemma_small_mod. r2_mod@ pn@)
                        (=>
                         %%location_label%%12
                         (= (curve25519_dalek!specs.field_specs.field_neg.? (I r2_mod@)) neg_r2@)
                      )))
                      (=>
                       (= (curve25519_dalek!specs.field_specs.field_neg.? (I r2_mod@)) neg_r2@)
                       (and
                        (and
                         (and
                          ...
                          (=>
                           ...
                           (=>
                            %%location_label%%14
                            (= (EucMod (nClip (Mul (EucMod ri@ pn@) ri@)) pn@) (EucMod (nClip (Mul ri@ ri@)) pn@))
                         )))
                         (=>
                          (= (EucMod (nClip (Mul (EucMod ri@ pn@) ri@)) pn@) (EucMod (nClip (Mul ri@ ri@)) pn@))
                          (=>
                           (= tmp%2 (nClip (Mul (EucMod ri@ pn@) ri@)))
                           (and
                            (=>
                             %%location_label%%15
                             (req%vstd!arithmetic.div_mod.lemma_mod_twice. tmp%2 pn@)
                            )
                            (=>
                             (ens%vstd!arithmetic.div_mod.lemma_mod_twice. tmp%2 pn@)
                             (=>
                              %%location_label%%16
                              (= (EucMod (EucMod (nClip (Mul (EucMod ri@ pn@) ri@)) pn@) pn@) (EucMod (nClip (Mul ri@
                                  ri@
                                 )
                                ) pn@
                        ))))))))
