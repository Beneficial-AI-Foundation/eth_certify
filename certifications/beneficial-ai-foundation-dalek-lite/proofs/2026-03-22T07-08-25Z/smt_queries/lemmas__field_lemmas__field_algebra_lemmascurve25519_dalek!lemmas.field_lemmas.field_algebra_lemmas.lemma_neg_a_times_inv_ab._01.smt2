...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:1932:1: 1932:54 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_neg_a_times_inv_ab
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:1932:1: 1932:54 (#0)
                ...
                (=>
                 ...
                 (and
                  ...
                  (=>
                   ...
                   (=>
                    %%location_label%%5
                    (= (curve25519_dalek!specs.field_specs.field_mul.? (I neg_a@) (I inv_ab@)) 0)
               )))))
               (=>
                (= (curve25519_dalek!specs.field_specs.field_mul.? (I neg_a@) (I inv_ab@)) 0)
                (and
                   ...
                   (=>
                    ...
                    (and
                     ...
                     (=>
                      ...
                      (=>
                       %%location_label%%9
                       (= (curve25519_dalek!specs.field_specs.field_mul.? (I neg_one@) (I inv_b@)) 0)
                 ))))))
                 (=>
                  (= (curve25519_dalek!specs.field_specs.field_mul.? (I neg_one@) (I inv_b@)) 0)
                  (=>
            ...
            (and
             ...
             (and
              (=>
               ...
               (=>
                %%location_label%%11
                (= (curve25519_dalek!specs.field_specs.field_mul.? (I neg_one@) (I a!)) neg_a@)
              ))
              (=>
               (= (curve25519_dalek!specs.field_specs.field_mul.? (I neg_one@) (I a!)) neg_a@)
               (and
                  ...
                  (=>
                   ...
                   (=>
                    ...
                    (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                     ...
                     ) (curve25519_dalek!specs.field_specs.field_mul.? (I neg_one@) (I (curve25519_dalek!specs.field_specs.field_mul.?
                        (I a!) (I inv_ab@)
                  ))))))
                  (=>
                   (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                   ...
                   (=>
                    (= tmp%2 (= (curve25519_dalek!specs.field_specs.field_mul.? (I neg_a@) (I inv_ab@))
                      (curve25519_dalek!specs.field_specs.field_mul.? (I neg_one@) (I inv_b@))
                    ))
                    (and
                     (=>
                      %%location_label%%15
