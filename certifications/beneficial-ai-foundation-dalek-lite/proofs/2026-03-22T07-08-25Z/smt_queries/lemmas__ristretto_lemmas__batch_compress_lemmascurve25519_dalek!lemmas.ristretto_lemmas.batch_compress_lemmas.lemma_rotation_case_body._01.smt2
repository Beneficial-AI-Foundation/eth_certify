...
;; curve25519-dalek/src/lemmas/ristretto_lemmas/batch_compress_lemmas.rs:2138:7: 2156:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::ristretto_lemmas::batch_compress_lemmas::lemma_rotation_case_body
;; curve25519-dalek/src/lemmas/ristretto_lemmas/batch_compress_lemmas.rs:2138:7: 2156:2 (#0)
...
(push)
 ...
 (declare-const invsqrt@ Int)
 (declare-const i1@ Int)
 (declare-const i2@ Int)
 (declare-const z_inv@ Int)
 (assert
  fuel_defaults
 )
 (assert
          ...
          (and
           ...
           (=>
            ...
            (=>
             (= i1@ (curve25519_dalek!specs.field_specs.field_mul.? (I invsqrt@) (I u1!)))
             (=>
              (= i2@ (curve25519_dalek!specs.field_specs.field_mul.? (I invsqrt@) (I t_aff!)))
              (=>
               (= z_inv@ (curve25519_dalek!specs.field_specs.field_mul.? (I i1@) (I (curve25519_dalek!specs.field_specs.field_mul.?
                   (I i2@) (I t_aff!)
               ))))
                     ...
                     (and
                      ...
                      (=>
                       ...
                       (=>
                        %%location_label%%8
                        (and
                         (= (curve25519_dalek!specs.field_specs.field_mul.? (I t_aff!) (I z_inv@)) t_aff!)
                         (= (curve25519_dalek!specs.field_specs.field_mul.? (I x_aff!) (I z_inv@)) x_aff!)
                   ))))))
                   (=>
                    (and
                     (= (curve25519_dalek!specs.field_specs.field_mul.? (I t_aff!) (I z_inv@)) t_aff!)
