...
;; curve25519-dalek/src/lemmas/montgomery_curve_lemmas.rs:852:7: 852:37 (#0)
...
;; Function-Def curve25519_dalek::lemmas::montgomery_curve_lemmas::lemma_bridge_local_pow2_m
;; curve25519-dalek/src/lemmas/montgomery_curve_lemmas.rs:852:7: 852:37 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= (curve25519_dalek!lemmas.montgomery_curve_lemmas.local_pow2_m.? (I 51)) 2251799813685248)
    (and
     (=>
     ...
     (=>
      (= (vstd!arithmetic.power2.pow2.? (I 51)) 2251799813685248)
      (=>
       (= (curve25519_dalek!lemmas.montgomery_curve_lemmas.local_pow2_m.? (I 102)) (nClip
         (Mul (curve25519_dalek!lemmas.montgomery_curve_lemmas.local_pow2_m.? (I 51)) (curve25519_dalek!lemmas.montgomery_curve_lemmas.local_pow2_m.?
           (I 51)
       ))))
       (and
        (=>
        ...
        (=>
         ...
         (=>
          (= (curve25519_dalek!lemmas.montgomery_curve_lemmas.local_pow2_m.? (I 153)) (nClip
            (Mul (curve25519_dalek!lemmas.montgomery_curve_lemmas.local_pow2_m.? (I 51)) (curve25519_dalek!lemmas.montgomery_curve_lemmas.local_pow2_m.?
              (I 102)
          ))))
          (and
           ...
           (=>
            ...
            (=>
             (= (curve25519_dalek!lemmas.montgomery_curve_lemmas.local_pow2_m.? (I 204)) (nClip
               (Mul (curve25519_dalek!lemmas.montgomery_curve_lemmas.local_pow2_m.? (I 51)) (curve25519_dalek!lemmas.montgomery_curve_lemmas.local_pow2_m.?
                 (I 153)
             ))))
             (and
              ...
              (=>
               ...
               (=>
                (= (curve25519_dalek!lemmas.montgomery_curve_lemmas.local_pow2_m.? (I 255)) (nClip
                  (Mul (curve25519_dalek!lemmas.montgomery_curve_lemmas.local_pow2_m.? (I 51)) (curve25519_dalek!lemmas.montgomery_curve_lemmas.local_pow2_m.?
                    (I 204)
                ))))
                (and
