...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:3291:1: 3291:62 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_field_abs_mul_sign
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:3291:1: 3291:62 (#0)
       ...
       (=>
        ...
        (and
         (=>
          ...
          (=>
           %%location_label%%1
           (= (curve25519_dalek!specs.field_specs.field_mul.? (I a!) (I x!)) (curve25519_dalek!specs.field_specs.field_neg.?
             (I (curve25519_dalek!specs.field_specs.field_mul.? (I b!) (I x!)))
         ))))
         (=>
          (= (curve25519_dalek!specs.field_specs.field_mul.? (I a!) (I x!)) (curve25519_dalek!specs.field_specs.field_neg.?
            (I (curve25519_dalek!specs.field_specs.field_mul.? (I b!) (I x!)))
           ...
           (=>
            ...
            (=>
             ...
             (and
              (=>
               %%location_label%%2
               (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%1 tmp%2)
              )
              (=>
               (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%1 tmp%2)
               (=>
                (= tmp%3 (curve25519_dalek!specs.field_specs.field_mul.? (I b!) (I x!)))
                (and
                 (=>
                  %%location_label%%3
                  (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_abs_neg.
