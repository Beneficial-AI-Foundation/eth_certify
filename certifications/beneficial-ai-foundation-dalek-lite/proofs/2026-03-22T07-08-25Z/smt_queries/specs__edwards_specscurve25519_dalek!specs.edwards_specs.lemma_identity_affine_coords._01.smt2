...
;; curve25519-dalek/src/specs/edwards_specs.rs:984:1: 984:63 (#0)
...
;; Function-Def curve25519_dalek::specs::edwards_specs::lemma_identity_affine_coords
;; curve25519-dalek/src/specs/edwards_specs.rs:984:1: 984:63 (#0)
                      ...
                      (=>
                       ...
                       (and
                        ...
                        (=>
                         ...
                         (=>
                          %%location_label%%6
                          (= (curve25519_dalek!specs.field_specs.field_mul.? (I 0) (I z_inv@)) 0)
                   )))))))
                   (=>
                    (= (curve25519_dalek!specs.field_specs.field_mul.? (I 0) (I z_inv@)) 0)
                    (=>
                     (= tmp%6 (= (curve25519_dalek!specs.field_specs.field_mul.? (I x@) (I z_inv@)) 0))
                     (and
                      (=>
                       %%location_label%%7
                       tmp%6
                         ...
                         (and
                          (=>
                           ...
                           (and
                            (=>
                             %%location_label%%10
                             (req%vstd!arithmetic.div_mod.lemma_small_mod. z@ tmp%9)
                            )
                            (=>
                             (ens%vstd!arithmetic.div_mod.lemma_small_mod. z@ tmp%9)
                             (=>
                              %%location_label%%11
                              (= (EucMod z@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) z@)
                          ))))
                          (=>
                           (= (EucMod z@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) z@)
                           (=>
                            (= tmp%10 (not (= (EucMod z@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0)))
                            (and
                             (=>
                              %%location_label%%12
                              tmp%10
                             ...
                             (=>
                              ...
                              (and
                               (=>
                                %%location_label%%13
                                (req%curve25519_dalek!specs.field_specs.field_inv_property. z@)
                               )
                               (=>
                                (ens%curve25519_dalek!specs.field_specs.field_inv_property. z@)
                                (=>
                                 (= tmp%11 (= (curve25519_dalek!specs.field_specs.field_mul.? (I z@) (I z_inv@)) 1))
                                 (and
                                  (=>
                                   %%location_label%%14
                                   tmp%11
                                  ...
                                  (=>
                                   tmp%11
                                   (=>
                                    (= tmp%12 (= (curve25519_dalek!specs.field_specs.field_mul.? (I y@) (I z_inv@)) 1))
                                    (and
                                     (=>
                                      %%location_label%%15
                                      tmp%12
