...
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:1362:1: 1362:51 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::number_theory_lemmas::lemma_bezout_identity
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:1362:1: 1362:51 (#0)
...
(push)
 ...
 (declare-const r_prev@ curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult.)
 (declare-const r@ curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult.)
 (declare-const x_prime@ Int)
 (declare-const y_prime@ Int)
       ...
       (=>
        ...
        (and
         ...
         (=>
          ...
          (=>
           (= r_prev@ (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.spec_extended_gcd.?
             (I b!) (I (EucMod a! b!))
           ))
           (=>
            (= r@ (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.spec_extended_gcd.?
            ...
            (=>
             (= x_prime@ (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult./ExtGcdResult/x
               (%Poly%curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult. (Poly%curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult.
                 r_prev@
             ))))
             (=>
              (= y_prime@ (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult./ExtGcdResult/y
                (%Poly%curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult. (Poly%curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult.
                  r_prev@
              ))))
              (=>
               (= remainder@ (EucMod a! b!))
               (=>
                (= quotient@ (EucDiv a! b!))
                (and
                 (=>
                  %%location_label%%1
                  (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. a! b!)
                 )
                 (=>
                  (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. a! b!)
                  (=>
                   (= lhs@ (Add (Mul a! y_prime@) (Mul b! (Sub x_prime@ (Mul quotient@ y_prime@)))))
                   (=>
                    (= tmp%2 (Mul quotient@ y_prime@))
                    (=>
                     (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub. b! x_prime@ tmp%2)
                     (=>
                      (ens%vstd!arithmetic.mul.lemma_mul_is_associative. b! quotient@ y_prime@)
                      (=>
                       (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. a! y_prime@)
                       (=>
                        (= tmp%3 (Mul b! quotient@))
                        (=>
                         (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. tmp%3 y_prime@)
                         (=>
                          (= tmp%4 (Mul b! quotient@))
                          (=>
                           (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub. y_prime@ a! tmp%4)
                           (=>
                            (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. y_prime@ remainder@)
                            %%switch_label%%0
     )))))))))))))))))))))))
     (and
      (not %%switch_label%%0)
