...
;; curve25519-dalek/src/lemmas/montgomery_curve_lemmas.rs:692:7: 692:97 (#0)
...
;; Function-Def curve25519_dalek::lemmas::montgomery_curve_lemmas::lemma_montgomery_add_u_coord_reduced
;; curve25519-dalek/src/lemmas/montgomery_curve_lemmas.rs:692:7: 692:97 (#0)
(get-info :all-statistics)
(push)
 (declare-const P! curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.)
 (declare-const Q! curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.)
 ...
 (declare-const u@ Int)
 (declare-const v@ Int)
 (declare-const R@ curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.)
 (assert
  fuel_defaults
 )
 (assert
 ...
 (assert
  (has_type (Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine. Q!) TYPE%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.)
 )
 (assert
  (<= 0 u0!)
 )
 ...
 (assert
  (not (=>
    ...
    (=>
     (= R@ (curve25519_dalek!specs.montgomery_specs.montgomery_add.? (Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.
        P!
       ) (Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine. Q!)
     ))
     (and
      (=>
       ...
       (and
        (=>
         %%location_label%%0
         (req%vstd!arithmetic.div_mod.lemma_mod_division_less_than_divisor. u0! tmp%1)
        )
        (=>
         (ens%vstd!arithmetic.div_mod.lemma_mod_division_less_than_divisor. u0! tmp%1)
         (=>
          %%location_label%%1
          (< (curve25519_dalek!specs.montgomery_specs.u_coordinate.? (Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.
             P!
      ...
      (=>
       ...
       (or
        (and
         (=>
          (is-curve25519_dalek!specs.montgomery_specs.MontgomeryAffine./Infinity R@)
          (=>
           (= tmp%2 (= (curve25519_dalek!specs.montgomery_specs.u_coordinate.? (Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.
               R@
              )
             ) 0
           ))
         ...
         (=>
          (not (is-curve25519_dalek!specs.montgomery_specs.MontgomeryAffine./Infinity R@))
          (=>
           (= u@ (curve25519_dalek!specs.montgomery_specs.MontgomeryAffine./Finite/u (%Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.
              (Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine. R@)
           )))
            ...
            (and
             (=>
              ...
              (and
               (=>
                %%location_label%%3
                (req%vstd!arithmetic.div_mod.lemma_mod_division_less_than_divisor. u@ tmp%3)
               )
               (=>
                (ens%vstd!arithmetic.div_mod.lemma_mod_division_less_than_divisor. u@ tmp%3)
                (=>
                 %%location_label%%4
