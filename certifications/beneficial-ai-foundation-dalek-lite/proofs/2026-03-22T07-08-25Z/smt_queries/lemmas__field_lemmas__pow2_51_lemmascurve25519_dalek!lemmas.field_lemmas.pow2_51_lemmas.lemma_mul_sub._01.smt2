...
;; curve25519-dalek/src/lemmas/field_lemmas/pow2_51_lemmas.rs:88:1: 88:64 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::pow2_51_lemmas::lemma_mul_sub
;; curve25519-dalek/src/lemmas/field_lemmas/pow2_51_lemmas.rs:88:1: 88:64 (#0)
(get-info :all-statistics)
(push)
 (declare-const ci! Int)
 (declare-const cj! Int)
 (declare-const cj_0! Int)
 (declare-const k! Int)
 ...
 (assert
  (not (=>
    ...
    (=>
     (= tmp%2 (Mul (vstd!arithmetic.power2.pow2.? (I 51)) (Sub cj! cj_0!)))
     (=>
      (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub. tmp%1 ci! tmp%2)
      (=>
       (= tmp%3 (vstd!arithmetic.power2.pow2.? (I k!)))
       (=>
        (= tmp%4 (vstd!arithmetic.power2.pow2.? (I 51)))
        (=>
         (= tmp%5 (Sub cj! cj_0!))
         (=>
          (ens%vstd!arithmetic.mul.lemma_mul_is_associative. tmp%3 tmp%4 tmp%5)
          (=>
           (ens%vstd!arithmetic.power2.lemma_pow2_adds. k! 51)
           (=>
            (= tmp%6 (vstd!arithmetic.power2.pow2.? (I (nClip (Add k! 51)))))
            (=>
             (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub. tmp%6 cj! cj_0!)
             (=>
              %%location_label%%0
              (= (Mul (vstd!arithmetic.power2.pow2.? (I k!)) (Sub ci! (Mul (vstd!arithmetic.power2.pow2.?
                   (I 51)
