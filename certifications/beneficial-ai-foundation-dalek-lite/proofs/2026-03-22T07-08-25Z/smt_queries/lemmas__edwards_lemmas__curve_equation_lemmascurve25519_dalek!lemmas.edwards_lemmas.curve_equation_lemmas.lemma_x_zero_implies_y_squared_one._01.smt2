...
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:376:1: 376:64 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::curve_equation_lemmas::lemma_x_zero_implies_y_squared_one
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:376:1: 376:64 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= modulus@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
    (=>
     (= d@ (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
        curve25519_dalek!backend.serial.u64.constants.EDWARDS_D.?
     )))
       ...
       (=>
        ...
        (=>
         ...
         (=>
          (= lhs@ (curve25519_dalek!specs.field_specs.field_sub.? (I y2@) (I x2@)))
          (=>
           (= rhs@ (curve25519_dalek!specs.field_specs.field_add.? (I 1) (I d_x2y2@)))
           (and
            (=>
            ...
            (=>
             ...
             (and
              (=>
               (ens%vstd!arithmetic.mul.lemma_mul_basics_2. 0)
               (=>
                %%location_label%%1
                (= x2@ 0)
              ))
                ...
                (=>
                 ...
                 (and
                  ...
                  (=>
                   tmp%1
                   (=>
                    (ens%vstd!arithmetic.mul.lemma_mul_by_zero_is_zero. y2@)
                    (and
                     (=>
                      %%location_label%%3
                      (req%vstd!arithmetic.div_mod.lemma_small_mod. 0 modulus@)
                     )
                     (=>
                      (ens%vstd!arithmetic.div_mod.lemma_small_mod. 0 modulus@)
                      (=>
                       %%location_label%%4
                       (= x2y2@ 0)
                )))))))
                  ...
                  (=>
                   ...
                   (and
                    ...
                    (=>
                     tmp%2
                     (=>
                      (ens%vstd!arithmetic.mul.lemma_mul_by_zero_is_zero. d@)
                      (=>
                       %%location_label%%6
                       (= d_x2y2@ 0)
                  )))))
                     ...
                     (and
                      ...
                      (=>
                       ...
                       (and
                        (=>
                         %%location_label%%8
                         (req%vstd!arithmetic.div_mod.lemma_small_mod. 1 modulus@)
                        )
                        (=>
                         (ens%vstd!arithmetic.div_mod.lemma_small_mod. 1 modulus@)
                         (=>
                          %%location_label%%9
                          (= rhs@ 1)
                    ))))))
                               ...
                               (and
                                (=>
                                 ...
                                 (and
                                  (=>
                                   %%location_label%%13
                                   (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%7 modulus@)
                                  )
                                  (=>
                                   (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%7 modulus@)
                                   (=>
                                    %%location_label%%14
                                    (< y2@ modulus@)
                                ))))
                                (=>
                                 ...
                                 (and
                                  (=>
                                   %%location_label%%15
                                   (req%vstd!arithmetic.div_mod.lemma_small_mod. y2@ modulus@)
                                  )
                                  (=>
                                   (ens%vstd!arithmetic.div_mod.lemma_small_mod. y2@ modulus@)
                                   (and
                                    (=>
                                     %%location_label%%16
                                     (req%vstd!arithmetic.div_mod.lemma_mod_multiples_vanish. 1 y2@ modulus@)
                                    )
                                    (=>
                                     (ens%vstd!arithmetic.div_mod.lemma_mod_multiples_vanish. 1 y2@ modulus@)
                                     (=>
                                      %%location_label%%17
                                      (= lhs@ y2@)
                            ))))))))))
