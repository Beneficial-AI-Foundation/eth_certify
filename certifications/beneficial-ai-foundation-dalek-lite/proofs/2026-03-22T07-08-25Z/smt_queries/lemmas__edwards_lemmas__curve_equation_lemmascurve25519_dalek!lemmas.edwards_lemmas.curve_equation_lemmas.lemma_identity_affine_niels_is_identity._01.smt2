...
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:1750:1: 1750:55 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::curve_equation_lemmas::lemma_identity_affine_niels_is_identity
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:1750:1: 1750:55 (#0)
...
(push)
 ...
 (declare-const id@ curve25519_dalek!backend.serial.curve_models.AffineNielsPoint.)
 ...
 (assert
  (not (=>
    (= id@ (curve25519_dalek!specs.edwards_specs.identity_affine_niels.? (I 0)))
    (=>
     (= y_plus_x@ (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
        (curve25519_dalek!backend.serial.curve_models.AffineNielsPoint./AffineNielsPoint/y_plus_x
         (%Poly%curve25519_dalek!backend.serial.curve_models.AffineNielsPoint. (Poly%curve25519_dalek!backend.serial.curve_models.AffineNielsPoint.
     ...
     (=>
      ...
      (and
       (=>
        (= tmp%1 (curve25519_dalek!backend.serial.curve_models.AffineNielsPoint./AffineNielsPoint/y_plus_x
          (%Poly%curve25519_dalek!backend.serial.curve_models.AffineNielsPoint. (Poly%curve25519_dalek!backend.serial.curve_models.AffineNielsPoint.
            id@
        ))))
        (and
       ...
       (=>
        ...
        (and
         (=>
          (= tmp%2 (curve25519_dalek!backend.serial.curve_models.AffineNielsPoint./AffineNielsPoint/y_minus_x
            (%Poly%curve25519_dalek!backend.serial.curve_models.AffineNielsPoint. (Poly%curve25519_dalek!backend.serial.curve_models.AffineNielsPoint.
              id@
          ))))
          (and
          ...
          (=>
           ...
           (and
               ...
               (=>
                ...
                (=>
                 ...
                 (and
                  (=>
                   %%location_label%%5
                   (req%vstd!arithmetic.div_mod.lemma_mod_self_0. tmp%4)
                  )
                  (=>
                   (ens%vstd!arithmetic.div_mod.lemma_mod_self_0. tmp%4)
                   (=>
                    %%location_label%%6
                    (= diff@ 0)
            ))))))))
            (=>
             (= diff@ 0)
             (=>
              (= x@ (curve25519_dalek!specs.field_specs.field_mul.? (I diff@) (I (curve25519_dalek!specs.field_specs.field_inv.?
                  (I 2)
              ))))
              (and
               (=>
                ...
                (=>
                 ...
                 (and
                  ...
                  (=>
                   ...
                   (=>
                    (= tmp%6 (= (EucMod diff@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0))
                    (and
                     (=>
                      %%location_label%%8
                      tmp%6
                     ...
                     (=>
                      tmp%6
                      (=>
                       (= tmp%7 (curve25519_dalek!specs.field_specs.field_inv.? (I 2)))
                       (and
                        (=>
                         %%location_label%%9
                         (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_zero_left.
                ...
                (=>
                 ...
                 (and
                  ...
                  (=>
                   (= sum@ 2)
                   (=>
                    (= y@ (curve25519_dalek!specs.field_specs.field_mul.? (I sum@) (I (curve25519_dalek!specs.field_specs.field_inv.?
                        (I 2)
                    ))))
                    (and
                     (=>
                      ...
                      (and
                       (=>
                        ...
                        (and
                         (=>
                          %%location_label%%13
                          (req%vstd!arithmetic.div_mod.lemma_small_mod. 2 tmp%9)
                         )
                         (=>
                          (ens%vstd!arithmetic.div_mod.lemma_small_mod. 2 tmp%9)
                          (=>
                           %%location_label%%14
                       ...
                       (=>
                        ...
                        (and
                         ...
                         (=>
                          ...
                          (=>
                           (= tmp%10 (curve25519_dalek!specs.field_specs.field_inv.? (I 2)))
                           (=>
                            (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_comm.
                             2 tmp%10
                            )
