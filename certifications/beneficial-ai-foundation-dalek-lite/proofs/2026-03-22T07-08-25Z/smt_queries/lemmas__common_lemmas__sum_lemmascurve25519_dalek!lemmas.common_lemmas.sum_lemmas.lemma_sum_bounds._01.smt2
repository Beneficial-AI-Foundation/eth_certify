...
;; MODULE 'module lemmas::common_lemmas::sum_lemmas'
;; curve25519-dalek/src/lemmas/common_lemmas/sum_lemmas.rs:28:1: 28:63 (#0)
...
(declare-const fuel%curve25519_dalek!lemmas.common_lemmas.sum_lemmas.add. FuelId)
(declare-const fuel%curve25519_dalek!lemmas.common_lemmas.sum_lemmas.seq_sum. FuelId)
...
(assert
 (distinct fuel%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. fuel%vstd!arithmetic.mul.lemma_mul_strictly_positive.
  ...
  fuel%curve25519_dalek!lemmas.common_lemmas.sum_lemmas.add. fuel%curve25519_dalek!lemmas.common_lemmas.sum_lemmas.seq_sum.
...
;; Function-Decl curve25519_dalek::lemmas::common_lemmas::sum_lemmas::add
(declare-fun curve25519_dalek!lemmas.common_lemmas.sum_lemmas.add.? (Poly Poly) Int)

;; Function-Decl curve25519_dalek::lemmas::common_lemmas::sum_lemmas::seq_sum
(declare-fun curve25519_dalek!lemmas.common_lemmas.sum_lemmas.seq_sum.? (Poly Poly)
 Int
)
(declare-fun curve25519_dalek!lemmas.common_lemmas.sum_lemmas.rec%seq_sum.? (Poly Poly
  Fuel
 ) Int
)
...
(assert
 (=>
  ...
  (forall ((x! Int) (y! Int) (z! Int)) (!
    ...
    :qid user_vstd__arithmetic__mul__lemma_mul_is_distributive_add_other_way_5
    :skolemid skolem_user_vstd__arithmetic__mul__lemma_mul_is_distributive_add_other_way_5
))))
...
(assert
 (=>
  ...
  (forall ((x! Int) (y! Int)) (!
    ...
    :pattern ((Mul x! y!))
    :qid user_vstd__arithmetic__mul__lemma_mul_strictly_positive_6
    :skolemid skolem_user_vstd__arithmetic__mul__lemma_mul_strictly_positive_6
))))
...
(assert
 (=>
  ...
  (forall ((e1! Poly) (e2! Poly)) (!
    ...
    :qid user_vstd__arithmetic__power2__lemma_pow2_strictly_increases_7
    :skolemid skolem_user_vstd__arithmetic__power2__lemma_pow2_strictly_increases_7
))))
...
;; Function-Axioms curve25519_dalek::lemmas::common_lemmas::sum_lemmas::add
(assert
 (fuel_bool_default fuel%curve25519_dalek!lemmas.common_lemmas.sum_lemmas.add.)
)
(assert
 (=>
  (fuel_bool fuel%curve25519_dalek!lemmas.common_lemmas.sum_lemmas.add.)
  (forall ((a! Poly) (b! Poly)) (!
    (= (curve25519_dalek!lemmas.common_lemmas.sum_lemmas.add.? a! b!) (nClip (Add (%I a!)
       (%I b!)
    )))
    :pattern ((curve25519_dalek!lemmas.common_lemmas.sum_lemmas.add.? a! b!))
    :qid internal_curve25519_dalek!lemmas.common_lemmas.sum_lemmas.add.?_definition
    :skolemid skolem_internal_curve25519_dalek!lemmas.common_lemmas.sum_lemmas.add.?_definition
))))
(assert
 (forall ((a! Poly) (b! Poly)) (!
   (=>
    ...
    (<= 0 (curve25519_dalek!lemmas.common_lemmas.sum_lemmas.add.? a! b!))
   )
   :pattern ((curve25519_dalek!lemmas.common_lemmas.sum_lemmas.add.? a! b!))
   :qid internal_curve25519_dalek!lemmas.common_lemmas.sum_lemmas.add.?_pre_post_definition
   :skolemid skolem_internal_curve25519_dalek!lemmas.common_lemmas.sum_lemmas.add.?_pre_post_definition
)))

;; Function-Axioms curve25519_dalek::lemmas::common_lemmas::sum_lemmas::seq_sum
(assert
 (fuel_bool_default fuel%curve25519_dalek!lemmas.common_lemmas.sum_lemmas.seq_sum.)
)
(declare-const fuel_nat%curve25519_dalek!lemmas.common_lemmas.sum_lemmas.seq_sum.
 Fuel
)
(assert
 (forall ((coefs! Poly) (k! Poly) (fuel% Fuel)) (!
   (= (curve25519_dalek!lemmas.common_lemmas.sum_lemmas.rec%seq_sum.? coefs! k! fuel%)
    (curve25519_dalek!lemmas.common_lemmas.sum_lemmas.rec%seq_sum.? coefs! k! zero)
   )
   :pattern ((curve25519_dalek!lemmas.common_lemmas.sum_lemmas.rec%seq_sum.? coefs! k!
     fuel%
   ))
   :qid internal_curve25519_dalek!lemmas.common_lemmas.sum_lemmas.seq_sum._fuel_to_zero_definition
   :skolemid skolem_internal_curve25519_dalek!lemmas.common_lemmas.sum_lemmas.seq_sum._fuel_to_zero_definition
)))
(assert
 (forall ((coefs! Poly) (k! Poly) (fuel% Fuel)) (!
   (=>
    (and
     (has_type coefs! (TYPE%vstd!seq.Seq. $ NAT))
     (has_type k! NAT)
    )
    (= (curve25519_dalek!lemmas.common_lemmas.sum_lemmas.rec%seq_sum.? coefs! k! (succ fuel%))
     (ite
      (= (%I k!) 0)
      (%I (vstd!seq.Seq.index.? $ NAT coefs! (I 0)))
      (nClip (Add (curve25519_dalek!lemmas.common_lemmas.sum_lemmas.rec%seq_sum.? coefs! (
          I (nClip (Sub (%I k!) 1))
         ) fuel%
        ) (%I (vstd!seq.Seq.index.? $ NAT coefs! k!))
   )))))
   :pattern ((curve25519_dalek!lemmas.common_lemmas.sum_lemmas.rec%seq_sum.? coefs! k!
     (succ fuel%)
   ))
   :qid internal_curve25519_dalek!lemmas.common_lemmas.sum_lemmas.seq_sum._fuel_to_body_definition
   :skolemid skolem_internal_curve25519_dalek!lemmas.common_lemmas.sum_lemmas.seq_sum._fuel_to_body_definition
)))
(assert
 (=>
  (fuel_bool fuel%curve25519_dalek!lemmas.common_lemmas.sum_lemmas.seq_sum.)
  (forall ((coefs! Poly) (k! Poly)) (!
    (=>
     (and
      (has_type coefs! (TYPE%vstd!seq.Seq. $ NAT))
      (has_type k! NAT)
     )
     (= (curve25519_dalek!lemmas.common_lemmas.sum_lemmas.seq_sum.? coefs! k!) (curve25519_dalek!lemmas.common_lemmas.sum_lemmas.rec%seq_sum.?
       coefs! k! (succ fuel_nat%curve25519_dalek!lemmas.common_lemmas.sum_lemmas.seq_sum.)
    )))
    :pattern ((curve25519_dalek!lemmas.common_lemmas.sum_lemmas.seq_sum.? coefs! k!))
    :qid internal_curve25519_dalek!lemmas.common_lemmas.sum_lemmas.seq_sum.?_definition
    :skolemid skolem_internal_curve25519_dalek!lemmas.common_lemmas.sum_lemmas.seq_sum.?_definition
))))
(assert
 (forall ((coefs! Poly) (k! Poly)) (!
   (=>
    ...
    (<= 0 (curve25519_dalek!lemmas.common_lemmas.sum_lemmas.seq_sum.? coefs! k!))
   )
   :pattern ((curve25519_dalek!lemmas.common_lemmas.sum_lemmas.seq_sum.? coefs! k!))
   :qid internal_curve25519_dalek!lemmas.common_lemmas.sum_lemmas.seq_sum.?_pre_post_definition
   :skolemid skolem_internal_curve25519_dalek!lemmas.common_lemmas.sum_lemmas.seq_sum.?_pre_post_definition
)))
(assert
 (forall ((coefs! Poly) (k! Poly) (fuel% Fuel)) (!
   (=>
    ...
    (<= 0 (curve25519_dalek!lemmas.common_lemmas.sum_lemmas.rec%seq_sum.? coefs! k! fuel%))
   )
   :pattern ((curve25519_dalek!lemmas.common_lemmas.sum_lemmas.rec%seq_sum.? coefs! k!
     fuel%
   ))
   :qid internal_curve25519_dalek!lemmas.common_lemmas.sum_lemmas.rec__seq_sum.?_pre_post_rec_definition
   :skolemid skolem_internal_curve25519_dalek!lemmas.common_lemmas.sum_lemmas.rec__seq_sum.?_pre_post_rec_definition
)))

;; Function-Specs curve25519_dalek::lemmas::common_lemmas::sum_lemmas::lemma_sub_symmetric_bound
(declare-fun req%curve25519_dalek!lemmas.common_lemmas.sum_lemmas.lemma_sub_symmetric_bound.
 (Int Int Int) Bool
)
...
(assert
 (forall ((a! Int) (b! Int) (L! Int)) (!
   (= (req%curve25519_dalek!lemmas.common_lemmas.sum_lemmas.lemma_sub_symmetric_bound.
     a! b! L!
    ) (and
     (=>
   ...
   :pattern ((req%curve25519_dalek!lemmas.common_lemmas.sum_lemmas.lemma_sub_symmetric_bound.
     a! b! L!
   ))
   :qid internal_req__curve25519_dalek!lemmas.common_lemmas.sum_lemmas.lemma_sub_symmetric_bound._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.common_lemmas.sum_lemmas.lemma_sub_symmetric_bound._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.common_lemmas.sum_lemmas.lemma_sub_symmetric_bound.
 (Int Int Int) Bool
)
(assert
 (forall ((a! Int) (b! Int) (L! Int)) (!
   (= (ens%curve25519_dalek!lemmas.common_lemmas.sum_lemmas.lemma_sub_symmetric_bound.
     a! b! L!
    ) (and
     (< (Sub 0 L!) (Sub a! b!))
     (< (Sub a! b!) L!)
   ))
   :pattern ((ens%curve25519_dalek!lemmas.common_lemmas.sum_lemmas.lemma_sub_symmetric_bound.
     a! b! L!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.common_lemmas.sum_lemmas.lemma_sub_symmetric_bound._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.common_lemmas.sum_lemmas.lemma_sub_symmetric_bound._definition
)))

;; Function-Specs curve25519_dalek::lemmas::common_lemmas::sum_lemmas::lemma_sum_bounds
(declare-fun req%curve25519_dalek!lemmas.common_lemmas.sum_lemmas.lemma_sum_bounds.
 (vstd!seq.Seq<nat.>. Int Int) Bool
)
(declare-const %%global_location_label%%6 Bool)
(declare-const %%global_location_label%%7 Bool)
(assert
 (forall ((coefs! vstd!seq.Seq<nat.>.) (k! Int) (s! Int)) (!
   (= (req%curve25519_dalek!lemmas.common_lemmas.sum_lemmas.lemma_sum_bounds. coefs! k!
     s!
    ) (and
     (=>
      %%global_location_label%%6
      (<= k! (vstd!seq.Seq.len.? $ NAT (Poly%vstd!seq.Seq<nat.>. coefs!)))
     )
     (=>
      ...
      (forall ((i$ Poly)) (!
        (=>
         ...
         (=>
          ...
          (<= (%I (vstd!seq.Seq.index.? $ NAT (Poly%vstd!seq.Seq<nat.>. coefs!) i$)) (Sub (vstd!arithmetic.power2.pow2.?
             (I (nClip (Mul (nClip (Add (%I i$) 1)) s!)))
            ) (vstd!arithmetic.power2.pow2.? (I (nClip (Mul (%I i$) s!))))
        ))))
        :pattern ((vstd!seq.Seq.index.? $ NAT (Poly%vstd!seq.Seq<nat.>. coefs!) i$))
        :qid user_curve25519_dalek__lemmas__common_lemmas__sum_lemmas__lemma_sum_bounds_8
        :skolemid skolem_user_curve25519_dalek__lemmas__common_lemmas__sum_lemmas__lemma_sum_bounds_8
   )))))
   :pattern ((req%curve25519_dalek!lemmas.common_lemmas.sum_lemmas.lemma_sum_bounds. coefs!
     k! s!
   ))
   :qid internal_req__curve25519_dalek!lemmas.common_lemmas.sum_lemmas.lemma_sum_bounds._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.common_lemmas.sum_lemmas.lemma_sum_bounds._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.common_lemmas.sum_lemmas.lemma_sum_bounds.
 (vstd!seq.Seq<nat.>. Int Int) Bool
)
(assert
 (forall ((coefs! vstd!seq.Seq<nat.>.) (k! Int) (s! Int)) (!
   (= (ens%curve25519_dalek!lemmas.common_lemmas.sum_lemmas.lemma_sum_bounds. coefs! k!
     s!
    ) (<= (curve25519_dalek!lemmas.common_lemmas.sum_lemmas.seq_sum.? (Poly%vstd!seq.Seq<nat.>.
       coefs!
      ) (I k!)
     ) (Sub (vstd!arithmetic.power2.pow2.? (I (nClip (Mul (nClip (Add k! 1)) s!)))) 1)
   ))
   :pattern ((ens%curve25519_dalek!lemmas.common_lemmas.sum_lemmas.lemma_sum_bounds. coefs!
     k! s!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.common_lemmas.sum_lemmas.lemma_sum_bounds._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.common_lemmas.sum_lemmas.lemma_sum_bounds._definition
)))

;; Function-Def curve25519_dalek::lemmas::common_lemmas::sum_lemmas::lemma_sum_bounds
;; curve25519-dalek/src/lemmas/common_lemmas/sum_lemmas.rs:28:1: 28:63 (#0)
(get-info :all-statistics)
(push)
 (declare-const coefs! vstd!seq.Seq<nat.>.)
 (declare-const k! Int)
 (declare-const s! Int)
 ...
 (assert
  (forall ((i$ Poly)) (!
    ...
    :pattern ((vstd!seq.Seq.index.? $ NAT (Poly%vstd!seq.Seq<nat.>. coefs!) i$))
    :qid user_curve25519_dalek__lemmas__common_lemmas__sum_lemmas__lemma_sum_bounds_18
    :skolemid skolem_user_curve25519_dalek__lemmas__common_lemmas__sum_lemmas__lemma_sum_bounds_18
 )))
        ...
        (=>
         ...
         (=>
          ...
          (= (curve25519_dalek!lemmas.common_lemmas.sum_lemmas.seq_sum.? (Poly%vstd!seq.Seq<nat.>.
           ...
           ) (nClip (Add (curve25519_dalek!lemmas.common_lemmas.sum_lemmas.seq_sum.? (Poly%vstd!seq.Seq<nat.>.
               coefs!
              ) (I (nClip (Sub k! 1)))
             ) (%I (vstd!seq.Seq.index.? $ NAT (Poly%vstd!seq.Seq<nat.>. coefs!) (I k!)))
        )))))
        (=>
         (= (curve25519_dalek!lemmas.common_lemmas.sum_lemmas.seq_sum.? (Poly%vstd!seq.Seq<nat.>.
            coefs!
          ...
          (=>
           ...
           (and
            ...
            (and
             (=>
              %%location_label%%3
              (req%curve25519_dalek!lemmas.common_lemmas.sum_lemmas.lemma_sum_bounds. coefs! tmp%1
               s!
             ))
             (=>
              (ens%curve25519_dalek!lemmas.common_lemmas.sum_lemmas.lemma_sum_bounds. coefs! tmp%1
               s!
              )
              (=>
               %%location_label%%4
               (<= (curve25519_dalek!lemmas.common_lemmas.sum_lemmas.seq_sum.? (Poly%vstd!seq.Seq<nat.>.
                ...
                ) (Sub (vstd!arithmetic.power2.pow2.? (I (nClip (Mul k! s!)))) 1)
          ))))))
          (=>
           (<= (curve25519_dalek!lemmas.common_lemmas.sum_lemmas.seq_sum.? (Poly%vstd!seq.Seq<nat.>.
              coefs!
           ...
           (=>
            (= tmp%2 (<= (%I (vstd!seq.Seq.index.? $ NAT (Poly%vstd!seq.Seq<nat.>. coefs!) (I k!)))
              (Sub (vstd!arithmetic.power2.pow2.? (I (nClip (Mul (nClip (Add k! 1)) s!)))) (vstd!arithmetic.power2.pow2.?
                (I (nClip (Mul k! s!)))
            ))))
            (and
             (=>
                ...
                (or
                 (and
                  (=>
                   ...
                   (and
                    (=>
                     (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. s! k! 1)
                     (=>
                      %%location_label%%6
                      (= (nClip (Mul (nClip (Add k! 1)) s!)) (nClip (Add (nClip (Mul k! s!)) s!)))
                    ))
                    (=>
                     (= (nClip (Mul (nClip (Add k! 1)) s!)) (nClip (Add (nClip (Mul k! s!)) s!)))
                     (=>
                      (= tmp%3 (nClip (Mul k! s!)))
                      (=>
                       (= tmp%4 (nClip (Mul (nClip (Add k! 1)) s!)))
                       (and
                        (=>
                         %%location_label%%7
                         (req%vstd!arithmetic.power2.lemma_pow2_strictly_increases. tmp%3 tmp%4)
                        )
                        (=>
                         (ens%vstd!arithmetic.power2.lemma_pow2_strictly_increases. tmp%3 tmp%4)
                         %%switch_label%%2
                  )))))))
                  (=>
                   (not (> s! 0))
                 ...
                 (and
                  ...
                  (=>
                   %%location_label%%8
                   (>= (vstd!arithmetic.power2.pow2.? (I (nClip (Mul (nClip (Add k! 1)) s!)))) (vstd!arithmetic.power2.pow2.?
                     (I (nClip (Mul k! s!)))
                )))))
                (=>
                 (>= (vstd!arithmetic.power2.pow2.? (I (nClip (Mul (nClip (Add k! 1)) s!)))) (vstd!arithmetic.power2.pow2.?
                 ...
                 (and
                  (and
                   (=>
                    ...
                    (=>
                     %%location_label%%9
                     (= 1 (vstd!arithmetic.power2.pow2.? (I 0)))
                   ))
                   (=>
                    (= 1 (vstd!arithmetic.power2.pow2.? (I 0)))
                    (or
                      ...
                      (=>
                       ...
                       (and
                        (=>
                         (= tmp%5 (nClip (Add k! 1)))
                         (=>
                          (ens%vstd!arithmetic.mul.lemma_mul_strictly_positive. tmp%5 s!)
                          (=>
                           %%location_label%%10
                           (< 0 (nClip (Mul (nClip (Add k! 1)) s!)))
                        )))
                        (=>
                         (< 0 (nClip (Mul (nClip (Add k! 1)) s!)))
                         (=>
                          (= tmp%6 (nClip (Mul (nClip (Add k! 1)) s!)))
                          (and
                           (=>
                            %%location_label%%11
                            (req%vstd!arithmetic.power2.lemma_pow2_strictly_increases. 0 tmp%6)
                           )
                           (=>
                            (ens%vstd!arithmetic.power2.lemma_pow2_strictly_increases. 0 tmp%6)
                            %%switch_label%%1
                      ))))))
                      (=>
                       (not (> s! 0))
                     ...
                     (and
                      ...
                      (=>
                       %%location_label%%12
                       (>= (vstd!arithmetic.power2.pow2.? (I (nClip (Mul (nClip (Add k! 1)) s!)))) 1)
                  )))))
                  (=>
                   (>= (vstd!arithmetic.power2.pow2.? (I (nClip (Mul (nClip (Add k! 1)) s!)))) 1)
                   (=>
                    %%location_label%%13
                    (= (Add (Sub (vstd!arithmetic.power2.pow2.? (I (nClip (Mul (nClip (Add k! 1)) s!))))
                       (vstd!arithmetic.power2.pow2.? (I (nClip (Mul k! s!))))
                      ) (Sub (vstd!arithmetic.power2.pow2.? (I (nClip (Mul k! s!)))) 1)
                     ) (Sub (vstd!arithmetic.power2.pow2.? (I (nClip (Mul (nClip (Add k! 1)) s!)))) 1)
               ))))))
               (=>
