...
;; curve25519-dalek/src/lemmas/edwards_lemmas/pippenger_lemmas.rs:886:7: 886:86 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::pippenger_lemmas::lemma_running_sum_eq_weighted_from
;; curve25519-dalek/src/lemmas/edwards_lemmas/pippenger_lemmas.rs:886:7: 886:86 (#0)
...
(push)
 ...
 (assert
  (forall ((j$ Poly)) (!
    ...
    :qid user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_running_sum_eq_weighted_from_57
    :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_running_sum_eq_weighted_from_57
 )))
       ...
       (or
        (and
         (=>
          (= b! (Sub B! 1))
          (=>
           (= tmp%1 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.pippenger_running_sum.?
               (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. buckets!) (I b!) (I B!)
              )
             ) (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2. $ NAT $ NAT) (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>.
               buckets!
           ...
           (and
            ...
            (=>
             tmp%1
             (=>
              (= tmp%2 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.pippenger_weighted_from.?
                  (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. buckets!) (I b!) (I (Sub B! 1))
                 )
               ...
               (=>
                ...
                (=>
                 ...
                 (and
                     ...
                     (=>
                      ...
                      (=>
                       ...
                       (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_add.?
                          (I 0) (I 1) (tuple%2./tuple%2/0 (%Poly%tuple%2. (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2.
                              $ NAT $ NAT
                             ) (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. buckets!) (I b!)
                           ))
                          ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2. $
                        ...
                        ) (Poly%tuple%2. (tuple%2./tuple%2 (I (EucMod (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (vstd!seq.Seq.index.?
                                (DST $) (TYPE%tuple%2. $ NAT $ NAT) (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. buckets!)
                                (I b!)
                             )))
                            ) (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
                           )
                          ) (I (EucMod (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2.
                                 $ NAT $ NAT
                                ) (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. buckets!) (I b!)
                             )))
                            ) (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
                  ...
                  (=>
                   (= (curve25519_dalek!specs.edwards_specs.edwards_add.? (I 0) (I 1) (tuple%2./tuple%2/0
                    ...
                    ) (tuple%2./tuple%2 (I (EucMod (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (vstd!seq.Seq.index.?
                           (DST $) (TYPE%tuple%2. $ NAT $ NAT) (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. buckets!)
                           (I b!)
                        )))
                       ) (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
                   ...
                   (and
                     ...
                     (=>
                      ...
                      (and
                       ...
                       (=>
                        ...
                        (=>
                         %%location_label%%4
                         (= (EucMod (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2.
                                $ NAT $ NAT
                               ) (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. buckets!) (I b!)
                            )))
                           ) (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
                    ...
                    (=>
                     ...
                     (and
                      (=>
                       (= tmp%7 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2.
                             $ NAT $ NAT
                            ) (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. buckets!) (I b!)
                       )))))
                       (=>
                        ...
                        (and
                         ...
                         (=>
                          ...
                          (=>
                           %%location_label%%6
                           (= (EucMod (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2.
                                  $ NAT $ NAT
                                 ) (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. buckets!) (I b!)
                              )))
                             ) (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
            ...
            (and
             (=>
              ...
              (check_decrease_int (let
                ((buckets!$0 buckets!) (b!$1 tmp%9) (B!$2 B!))
                (Sub B!$2 b!$1)
             ...
             (and
              ...
              (=>
               ...
               (=>
                %%location_label%%9
                (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.pippenger_running_sum.?
                   (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. buckets!) (I (Add b! 1)) (I B!)
                  )
                 ) (Poly%tuple%2. (curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.pippenger_weighted_from.?
                   (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. buckets!) (I (Add b! 1)) (I B!)
           ))))))))
           (=>
            (= (curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.pippenger_running_sum.?
