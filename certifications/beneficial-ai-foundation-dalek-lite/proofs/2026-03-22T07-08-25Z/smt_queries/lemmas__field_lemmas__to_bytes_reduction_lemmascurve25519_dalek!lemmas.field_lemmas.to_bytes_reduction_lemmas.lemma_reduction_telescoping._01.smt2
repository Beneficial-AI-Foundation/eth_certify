...
;; curve25519-dalek/src/lemmas/field_lemmas/to_bytes_reduction_lemmas.rs:27:1: 36:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::to_bytes_reduction_lemmas::lemma_reduction_telescoping
;; curve25519-dalek/src/lemmas/field_lemmas/to_bytes_reduction_lemmas.rs:27:1: 36:2 (#0)
     ...
     (=>
      ...
      (=>
       ...
       (=>
        ...
        (=>
         (= lhs@ (Add (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. input_limbs!))
           (Mul 19 q!)
         ))
         (=>
          (= tmp%1 (= (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. input_limbs!))
            (nClip (Add (nClip (Add (nClip (Add (nClip (Add (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                       $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. input_limbs!)
                      ) (I 0)
                     )
                    ) (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 51)) (%I (vstd!seq.Seq.index.? $ (UINT
                         64
                        ) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. input_limbs!))
                        (I 1)
                   )))))
                  ) (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 102)) (%I (vstd!seq.Seq.index.? $ (UINT
                       64
           ...
           (=>
            ...
            (and
             ...
             (=>
              ...
              (=>
               (= tmp%10 (= lhs@ (Add (Add (Add (Add (Add (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                         $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. input_limbs!)
                        ) (I 0)
                       )
                      ) (Mul (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64)
                ...
                (=>
                 ...
                 (and
                  (=>
                   ...
                   (=>
                    (= tmp%12 (Add (Mul c1! (vstd!arithmetic.power2.pow2.? (I 51))) (%I (vstd!seq.Seq.index.?
                        $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%.
                          final_limbs!
                         )
                        ) (I 1)
                    ...
                    (=>
                     (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub_other_way. tmp%11 tmp%12 c0!)
                     (=>
                      (= tmp%13 (vstd!arithmetic.power2.pow2.? (I 51)))
                      (=>
                       (= tmp%14 (Mul c1! (vstd!arithmetic.power2.pow2.? (I 51))))
                       (=>
                        ...
                        (=>
                         (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. tmp%13 tmp%14 tmp%15)
                         (=>
                          (= tmp%16 (vstd!arithmetic.power2.pow2.? (I 51)))
                          (=>
                           (= tmp%17 (vstd!arithmetic.power2.pow2.? (I 51)))
                           (=>
                            (ens%vstd!arithmetic.mul.lemma_mul_is_associative. c1! tmp%16 tmp%17)
                            (=>
                             %%location_label%%3
                             (= (Mul (Sub (Add (Mul c1! (vstd!arithmetic.power2.pow2.? (I 51))) (%I (vstd!seq.Seq.index.?
                                   $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%.
                                     final_limbs!
                                    )
                                   ) (I 1)
                              ...
                              ) (Sub (Add (Mul c1! (vstd!arithmetic.power2.pow2.? (I 102))) (Mul (%I (vstd!seq.Seq.index.?
                                   $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%.
                                     final_limbs!
                                    )
                                   ) (I 1)
                               ...
                               ) (Mul c0! (vstd!arithmetic.power2.pow2.? (I 51)))
                  )))))))))))))
                  (=>
                   (= (Mul (Sub (Add (Mul c1! (vstd!arithmetic.power2.pow2.? (I 51))) (%I (vstd!seq.Seq.index.?
                         $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%.
                   ...
                   (and
                    (=>
                     (= tmp%18 (vstd!arithmetic.power2.pow2.? (I 102)))
                     (=>
                      (= tmp%19 (Add (Mul c2! (vstd!arithmetic.power2.pow2.? (I 51))) (%I (vstd!seq.Seq.index.?
                          $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%.
                            final_limbs!
                           )
                          ) (I 2)
                      ...
                      (=>
                       (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub_other_way. tmp%18 tmp%19 c1!)
                       (=>
                        (= tmp%20 (vstd!arithmetic.power2.pow2.? (I 102)))
                        (=>
                         (= tmp%21 (Mul c2! (vstd!arithmetic.power2.pow2.? (I 51))))
                         (=>
                          ...
                          (=>
                           (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. tmp%20 tmp%21 tmp%22)
                           (=>
                            (= tmp%23 (vstd!arithmetic.power2.pow2.? (I 51)))
                            (=>
                             (= tmp%24 (vstd!arithmetic.power2.pow2.? (I 102)))
                             (=>
                              (ens%vstd!arithmetic.mul.lemma_mul_is_associative. c2! tmp%23 tmp%24)
                              (=>
                               %%location_label%%4
                               (= (Mul (Sub (Add (Mul c2! (vstd!arithmetic.power2.pow2.? (I 51))) (%I (vstd!seq.Seq.index.?
                                     $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%.
                                       final_limbs!
                                      )
                                     ) (I 2)
                                ...
                                ) (Sub (Add (Mul c2! (vstd!arithmetic.power2.pow2.? (I 153))) (Mul (%I (vstd!seq.Seq.index.?
                                     $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%.
                                       final_limbs!
                                      )
                                     ) (I 2)
                                 ...
                                 ) (Mul c1! (vstd!arithmetic.power2.pow2.? (I 102)))
                    )))))))))))))
                    (=>
                     (= (Mul (Sub (Add (Mul c2! (vstd!arithmetic.power2.pow2.? (I 51))) (%I (vstd!seq.Seq.index.?
                           $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%.
                     ...
                     (and
                      (=>
                       (= tmp%25 (vstd!arithmetic.power2.pow2.? (I 153)))
                       (=>
                        (= tmp%26 (Add (Mul c3! (vstd!arithmetic.power2.pow2.? (I 51))) (%I (vstd!seq.Seq.index.?
                            $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%.
                              final_limbs!
                             )
                            ) (I 3)
                        ...
                        (=>
                         (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub_other_way. tmp%25 tmp%26 c2!)
                         (=>
                          (= tmp%27 (vstd!arithmetic.power2.pow2.? (I 153)))
                          (=>
                           (= tmp%28 (Mul c3! (vstd!arithmetic.power2.pow2.? (I 51))))
                           (=>
                            ...
                            (=>
                             ...
                             (=>
                              (= tmp%30 (vstd!arithmetic.power2.pow2.? (I 51)))
                              (=>
                               (= tmp%31 (vstd!arithmetic.power2.pow2.? (I 153)))
                               (=>
                                (ens%vstd!arithmetic.mul.lemma_mul_is_associative. c3! tmp%30 tmp%31)
                                (=>
                                 %%location_label%%5
                                 (= (Mul (Sub (Add (Mul c3! (vstd!arithmetic.power2.pow2.? (I 51))) (%I (vstd!seq.Seq.index.?
                                       $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%.
                                         final_limbs!
                                        )
                                       ) (I 3)
                                  ...
                                  ) (Sub (Add (Mul c3! (vstd!arithmetic.power2.pow2.? (I 204))) (Mul (%I (vstd!seq.Seq.index.?
                                       $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%.
                                         final_limbs!
                                        )
                                       ) (I 3)
                                   ...
                                   ) (Mul c2! (vstd!arithmetic.power2.pow2.? (I 153)))
                      )))))))))))))
                      (=>
                       (= (Mul (Sub (Add (Mul c3! (vstd!arithmetic.power2.pow2.? (I 51))) (%I (vstd!seq.Seq.index.?
                             $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%.
                       ...
                       (and
                        (=>
                         (= tmp%32 (vstd!arithmetic.power2.pow2.? (I 204)))
                         (=>
                          (= tmp%33 (Add (Mul c4! (vstd!arithmetic.power2.pow2.? (I 51))) (%I (vstd!seq.Seq.index.?
                              $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%.
                                final_limbs!
                               )
                              ) (I 4)
                          ...
                          (=>
                           (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub_other_way. tmp%32 tmp%33 c3!)
                           (=>
                            (= tmp%34 (vstd!arithmetic.power2.pow2.? (I 204)))
                            (=>
                             (= tmp%35 (Mul c4! (vstd!arithmetic.power2.pow2.? (I 51))))
                             (=>
                              ...
                              (=>
                               (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. tmp%34 tmp%35 tmp%36)
                               (=>
                                (= tmp%37 (vstd!arithmetic.power2.pow2.? (I 51)))
                                (=>
                                 (= tmp%38 (vstd!arithmetic.power2.pow2.? (I 204)))
                                 (=>
                                  (ens%vstd!arithmetic.mul.lemma_mul_is_associative. c4! tmp%37 tmp%38)
                                  (=>
                                   %%location_label%%6
                                   (= (Mul (Sub (Add (Mul c4! (vstd!arithmetic.power2.pow2.? (I 51))) (%I (vstd!seq.Seq.index.?
                                         $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%.
                                           final_limbs!
                                          )
                                         ) (I 4)
                                    ...
                                    ) (Sub (Add (Mul c4! (vstd!arithmetic.power2.pow2.? (I 255))) (Mul (%I (vstd!seq.Seq.index.?
                                         $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%.
                                           final_limbs!
                                          )
                                         ) (I 4)
                                     ...
                                     ) (Mul c3! (vstd!arithmetic.power2.pow2.? (I 204)))
                        )))))))))))))
                        (=>
                         (= (Mul (Sub (Add (Mul c4! (vstd!arithmetic.power2.pow2.? (I 51))) (%I (vstd!seq.Seq.index.?
                               $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%.
                         ...
                         (=>
                          (= rhs@ (Add (Add (Add (Add (Add (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                                   $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. final_limbs!)
                                  ) (I 0)
                                 )
                                ) (Mul (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64)
                                     $ (CONST_INT 5)
                          ...
                          (=>
                           (= tmp%39 (= lhs@ (Add (Add (Add (Add (Add (Sub (Add (Mul c0! (vstd!arithmetic.power2.pow2.?
                                      (I 51)
                                     )
                                    ) (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $
                                        (CONST_INT 5)
                           ...
                           (and
                            ...
                            (=>
                             tmp%39
                             (=>
                              (= tmp%40 (= lhs@ (Add (Add (Add (Add (Add (Sub (Add (Mul c0! (vstd!arithmetic.power2.pow2.?
                                         (I 51)
                                        )
                                       ) (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $
                                           (CONST_INT 5)
                              ...
                              (and
                               ...
                               (=>
                                tmp%40
                                (=>
                                 (= tmp%41 (= lhs@ (Add (Add (Add (Add (Add (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                                           $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. final_limbs!)
                                          ) (I 0)
                                         )
                                        ) (Mul (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64)
