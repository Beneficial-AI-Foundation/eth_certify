...
;; curve25519-dalek/src/lemmas/field_lemmas/compute_q_lemmas.rs:249:1: 249:88 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::compute_q_lemmas::lemma_radix51_remainder_bound
;; curve25519-dalek/src/lemmas/field_lemmas/compute_q_lemmas.rs:249:1: 249:88 (#0)
     ...
     (=>
      ...
      (=>
       ...
       (=>
        ...
        (=>
         (= sum@ (Add (Add (Add (Add r0! (Mul r1! (vstd!arithmetic.power2.pow2.? (I 51)))) (Mul
         ...
         (and
          (and
           ...
           (=>
            ...
            (=>
             %%location_label%%1
             (<= (Mul r1! (vstd!arithmetic.power2.pow2.? (I 51))) (Sub (vstd!arithmetic.power2.pow2.?
                (I 102)
           ...
           (and
            (and
             ...
             (=>
              ...
              (=>
               %%location_label%%3
               (<= (Mul r2! (vstd!arithmetic.power2.pow2.? (I 102))) (Sub (vstd!arithmetic.power2.pow2.?
                  (I 153)
                 ) (vstd!arithmetic.power2.pow2.? (I 102))
            )))))
            (=>
             ...
             (and
              (and
               ...
               (=>
                ...
                (=>
                 %%location_label%%5
                 (<= (Mul r3! (vstd!arithmetic.power2.pow2.? (I 153))) (Sub (vstd!arithmetic.power2.pow2.?
                    (I 204)
               ...
               (and
                (and
                 ...
                 (=>
                  ...
                  (=>
                   %%location_label%%7
                   (<= (Mul r4! (vstd!arithmetic.power2.pow2.? (I 204))) (Sub (vstd!arithmetic.power2.pow2.?
                      (I 255)
