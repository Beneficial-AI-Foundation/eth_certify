...
;; curve25519-dalek/src/lemmas/edwards_lemmas/straus_lemmas.rs:174:1: 179:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::straus_lemmas::lemma_select_is_signed_scalar_mul_projective
;; curve25519-dalek/src/lemmas/edwards_lemmas/straus_lemmas.rs:174:1: 179:2 (#0)
(get-info :all-statistics)
(push)
 (declare-const table! %%Function%%)
 (declare-const x! Int)
 (declare-const result! curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.)
 (declare-const basepoint! tuple%2.)
 ...
 (declare-const tmp%8 curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.)
 ...
 (assert
  (has_type (Poly%array%. table!) (ARRAY $ TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
    $ (CONST_INT 8)
 )))
 (assert
  (iInv 8 x!)
 ...
 (assert
  (has_type (Poly%tuple%2. basepoint!) (TYPE%tuple%2. $ NAT $ NAT))
 )
 (assert
  (let
   ((tmp%%$ x!))
 ...
 (assert
  (forall ((j$ Poly)) (!
    ...
    :qid user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_select_is_signed_scalar_mul_projective_86
    :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_select_is_signed_scalar_mul_projective_86
 )))
 (assert
  (=>
   (> x! 0)
        ...
        (=>
         ...
         (and
          ...
          (=>
           tmp%1
           (=>
            (= tmp%2 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.projective_niels_point_as_affine_edwards.?
                (vstd!seq.Seq.index.? $ TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
                 (vstd!view.View.view.? $ (ARRAY $ TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
                   $ (CONST_INT 8)
                  ) (Poly%array%. table!)
              ...
              ) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2.
                 basepoint!
                ) (I (nClip (Add j@ 1)))
            ))))
            (and
         ...
         (=>
          ...
          (=>
           ...
           (=>
            (fuel_bool fuel%curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.)
            (=>
             (= tmp%4 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.?
                 (Poly%tuple%2. basepoint!) (I 0)
                )
           ...
           (=>
            ...
            (and
             ...
             (=>
              tmp%5
              (=>
               (= tmp%6 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.projective_niels_point_as_affine_edwards.?
                   (vstd!seq.Seq.index.? $ TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
                    (vstd!view.View.view.? $ (ARRAY $ TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
                      $ (CONST_INT 8)
                     ) (Poly%array%. table!)
               ...
               (and
                ...
                (=>
                 tmp%6
                 (=>
                  (= tmp%7 (= (nClip (Add j$1@ 1)) (nClip (Sub 0 x!))))
                  (and
                   (=>
                    %%location_label%%6
                    tmp%7
                   ...
                   (=>
                    tmp%7
                    (=>
                     (= tmp%8 (%Poly%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
                       (vstd!seq.Seq.index.? $ TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
                        (vstd!view.View.view.? $ (ARRAY $ TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
                          $ (CONST_INT 8)
                         ) (Poly%array%. table!)
                     ...
                     (=>
                      ...
                      (=>
                       (= tmp%9 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.projective_niels_point_as_affine_edwards.?
                           (Poly%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint. (curve25519_dalek!specs.edwards_specs.negate_projective_niels.?
                             (vstd!seq.Seq.index.? $ TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
                              (vstd!view.View.view.? $ (ARRAY $ TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
                                $ (CONST_INT 8)
                         ...
                         ) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_neg.? (Poly%tuple%2.
                            (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2. basepoint!)
                             (I (nClip (Sub 0 x!)))
                       ))))))
                       (and
