...
;; curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:91:1: 91:41 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::pow_lemmas::lemma_pow2_plus_one
;; curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:91:1: 91:41 (#0)
...
(push)
 ...
 (assert
  (not (and
    (=>
     (ens%vstd!arithmetic.power2.lemma_pow2_adds. n! 1)
     (=>
      %%location_label%%0
      (= (vstd!arithmetic.power2.pow2.? (I (nClip (Add n! 1)))) (nClip (Mul (vstd!arithmetic.power2.pow2.?
          (I n!)
    ...
    (=>
     ...
     (and
      (=>
       ...
       (=>
        %%location_label%%1
        (= (vstd!arithmetic.power2.pow2.? (I 1)) (nClip (Add 1 1)))
      ))
      (=>
       (= (vstd!arithmetic.power2.pow2.? (I 1)) (nClip (Add 1 1)))
       (and
        (=>
         (= tmp%1 (vstd!arithmetic.power2.pow2.? (I n!)))
         (=>
          (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add. tmp%1 1 1)
          (=>
           ...
           (=>
            ...
            (=>
             %%location_label%%2
             (= (nClip (Mul (vstd!arithmetic.power2.pow2.? (I n!)) (nClip (Add 1 1)))) (nClip (Add
                (vstd!arithmetic.power2.pow2.? (I n!)) (vstd!arithmetic.power2.pow2.? (I n!))
        ))))))))
        (=>
         (= (nClip (Mul (vstd!arithmetic.power2.pow2.? (I n!)) (nClip (Add 1 1)))) (nClip (Add
            (vstd!arithmetic.power2.pow2.? (I n!)) (vstd!arithmetic.power2.pow2.? (I n!))
