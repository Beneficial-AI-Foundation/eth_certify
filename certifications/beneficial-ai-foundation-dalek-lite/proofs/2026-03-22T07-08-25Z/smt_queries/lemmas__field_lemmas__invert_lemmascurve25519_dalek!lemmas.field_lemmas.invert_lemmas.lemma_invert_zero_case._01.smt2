...
;; curve25519-dalek/src/lemmas/field_lemmas/invert_lemmas.rs:82:1: 87:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::invert_lemmas::lemma_invert_zero_case
;; curve25519-dalek/src/lemmas/field_lemmas/invert_lemmas.rs:82:1: 87:2 (#0)
    ...
    (=>
     ...
     (=>
      ...
      (and
       (=>
        %%location_label%%0
        (req%vstd!arithmetic.div_mod.lemma_mod_is_mod_recursive. 0 tmp%1)
       )
       (=>
        (ens%vstd!arithmetic.div_mod.lemma_mod_is_mod_recursive. 0 tmp%1)
        (=>
         %%location_label%%1
     ...
     (and
      (and
       (and
        (=>
         %%location_label%%2
         (req%vstd!arithmetic.power.lemma0_pow. 11)
        )
        (=>
         (ens%vstd!arithmetic.power.lemma0_pow. 11)
         (=>
          %%location_label%%3
          (= (vstd!arithmetic.power.pow.? (I 0) (I 11)) 0)
       )))
       (=>
        (= (vstd!arithmetic.power.pow.? (I 0) (I 11)) 0)
        (=>
        ...
        (=>
         ...
         (and
          ...
          (=>
           tmp%2
           (=>
            (= tmp%3 (= (nClip (Mul (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                  t20!
                 )
                ) 0
               )
