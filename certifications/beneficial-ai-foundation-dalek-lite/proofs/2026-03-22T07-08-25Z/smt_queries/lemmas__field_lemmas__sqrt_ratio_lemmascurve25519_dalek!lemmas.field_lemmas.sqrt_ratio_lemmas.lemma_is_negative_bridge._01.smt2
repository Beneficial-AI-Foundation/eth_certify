...
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_ratio_lemmas.rs:1714:1: 1714:65 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::sqrt_ratio_lemmas::lemma_is_negative_bridge
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_ratio_lemmas.rs:1714:1: 1714:65 (#0)
      ...
      (and
       (=>
        ...
        (and
         (=>
          %%location_label%%1
          (req%vstd!arithmetic.div_mod.lemma_small_mod. n! tmp%1)
         )
         (=>
          (ens%vstd!arithmetic.div_mod.lemma_small_mod. n! tmp%1)
          (=>
           %%location_label%%2
           (= (curve25519_dalek!specs.field_specs_u64.field_canonical.? (I n!)) n!)
       ))))
       (=>
        (= (curve25519_dalek!specs.field_specs_u64.field_canonical.? (I n!)) n!)
        (=>
