...
;; curve25519-dalek/src/lemmas/ristretto_lemmas/batch_compress_lemmas.rs:2436:7: 2436:98 (#0)
...
;; Function-Def curve25519_dalek::lemmas::ristretto_lemmas::batch_compress_lemmas::lemma_encoding_equality_core
;; curve25519-dalek/src/lemmas/ristretto_lemmas/batch_compress_lemmas.rs:2436:7: 2436:98 (#0)
...
(push)
 ...
 (declare-const i1_std@ Int)
 (declare-const i2_std@ Int)
 (declare-const z_inv_std@ Int)
           ...
           (=>
            ...
            (and
             ...
             (=>
              (> (curve25519_dalek!specs.field_specs_u64.p.? (I 0)) 2)
              (=>
               (= i1_std@ (curve25519_dalek!specs.field_specs.field_mul.? (I invsqrt_std@) (I u1@)))
               (=>
                (= i2_std@ (curve25519_dalek!specs.field_specs.field_mul.? (I invsqrt_std@) (I t_aff@)))
                (=>
                 (= z_inv_std@ (curve25519_dalek!specs.field_specs.field_mul.? (I i1_std@) (I (curve25519_dalek!specs.field_specs.field_mul.?
                     (I i2_std@) (I t_aff@)
                 ))))
                 (and
                  (and
                   (=>
                    %%location_label%%1
                    (req%curve25519_dalek!lemmas.ristretto_lemmas.batch_compress_lemmas.lemma_z_inv_std_is_one.
                     invsqrt_std@ u1@ t_aff@ c_iad@ B@ neg_one_minus_d@
                   ))
                   (=>
                    (ens%curve25519_dalek!lemmas.ristretto_lemmas.batch_compress_lemmas.lemma_z_inv_std_is_one.
                     invsqrt_std@ u1@ t_aff@ c_iad@ B@ neg_one_minus_d@
                      ...
                      (and
                       ...
                       (=>
                        ...
                        (=>
                         %%location_label%%5
                         (and
                          (= (curve25519_dalek!specs.field_specs.field_mul.? (I t_aff@) (I z_inv_std@)) t_aff@)
                          (= (curve25519_dalek!specs.field_specs.field_mul.? (I x_aff@) (I z_inv_std@)) x_aff@)
                    ))))))
                    (=>
                     (and
                      (= (curve25519_dalek!specs.field_specs.field_mul.? (I t_aff@) (I z_inv_std@)) t_aff@)
                     ...
                     (=>
                      ...
                      (=>
                       (= tinv@ (curve25519_dalek!specs.field_specs.field_mul.? (I fh!) (I inv!)))
                       (=>
                        (= tmp%1 (= zinv@ (curve25519_dalek!specs.field_specs.field_inv.? (I fh!))))
                        (and
                         (=>
                          %%location_label%%6
                          tmp%1
                         ...
                         (=>
                          tmp%1
                          (=>
                           (= tmp%2 (= tinv@ (curve25519_dalek!specs.field_specs.field_inv.? (I eg!))))
                           (and
                            (=>
                             %%location_label%%7
                             tmp%2
                             ...
                             (and
                              (or
                               (and
                                ...
                                (=>
                                 (not (not (curve25519_dalek!specs.field_specs.is_negative.? (I t_aff@))))
                                 (and
                                  (=>
                                   %%location_label%%9
                                   (req%curve25519_dalek!lemmas.ristretto_lemmas.batch_compress_lemmas.lemma_rotation_case.
