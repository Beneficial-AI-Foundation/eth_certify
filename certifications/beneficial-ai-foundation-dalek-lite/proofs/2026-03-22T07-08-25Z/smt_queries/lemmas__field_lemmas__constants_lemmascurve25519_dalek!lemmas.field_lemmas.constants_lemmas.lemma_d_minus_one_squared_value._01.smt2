...
;; curve25519-dalek/src/lemmas/field_lemmas/constants_lemmas.rs:332:1: 332:47 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::constants_lemmas::lemma_d_minus_one_squared_value
;; curve25519-dalek/src/lemmas/field_lemmas/constants_lemmas.rs:332:1: 332:47 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (let
     ((lp$ (curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_p.? (I 0))))
     (let
      ((dmo_val$ (EucMod (curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_u5_nat.?
          (Poly%array%. (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
      ...
      (let
       ((d_val$ (EucMod (curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_u5_nat.?
           (Poly%array%. (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
             (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
               curve25519_dalek!backend.serial.u64.constants.EDWARDS_D.?
           ))))
       ...
       (let
        ((d_minus_one$ (EucMod (nClip (Sub (nClip (Add (EucMod d_val$ lp$) lp$)) (EucMod 1 lp$)))
           lp$
        )))
        (= dmo_val$ (EucMod (nClip (Mul d_minus_one$ d_minus_one$)) lp$))
    ))))
    (=>
     (ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_bridge_local_pow2.
      0
