...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:2688:1: 2688:45 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_field_neg_nonzero
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:2688:1: 2688:45 (#0)
    ...
    (=>
     ...
     (=>
      ...
      (and
       (=>
        %%location_label%%0
        (req%vstd!arithmetic.div_mod.lemma_mod_bound. a! pn@)
       )
       (=>
        (ens%vstd!arithmetic.div_mod.lemma_mod_bound. a! pn@)
        (=>
         (= tmp%1 (> a_mod@ 0))
         (and
          (=>
                   ...
                   (and
                    ...
                    (=>
                     ...
                     (and
                      (=>
                       %%location_label%%5
                       (req%vstd!arithmetic.div_mod.lemma_small_mod. neg_a@ pn@)
                      )
                      (=>
                       (ens%vstd!arithmetic.div_mod.lemma_small_mod. neg_a@ pn@)
                       (=>
                        (= tmp%5 (= (curve25519_dalek!specs.field_specs.field_neg.? (I a!)) neg_a@))
                        (and
                         (=>
                          %%location_label%%6
                          tmp%5
