...
;; curve25519-dalek/src/lemmas/edwards_lemmas/torsion_lemmas.rs:298:1: 298:72 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::torsion_lemmas::lemma_edwards_add_two_torsion_four_torsion_neg
;; curve25519-dalek/src/lemmas/edwards_lemmas/torsion_lemmas.rs:298:1: 298:72 (#0)
...
(push)
 ...
 (assert
  (not (=>
    ...
    (=>
     (= neg_i@ (curve25519_dalek!specs.field_specs.field_neg.? (I i_val!)))
     (=>
            ...
            (and
             (and
              ...
              (=>
               ...
               (=>
                %%location_label%%3
                (= (curve25519_dalek!specs.field_specs.field_mul.? (I 0) (I neg_i@)) 0)
             )))
             (=>
              (= (curve25519_dalek!specs.field_specs.field_mul.? (I 0) (I neg_i@)) 0)
              (and
               (and
                ...
                (=>
                 ...
                 (=>
                  %%location_label%%5
                  (= (curve25519_dalek!specs.field_specs.field_mul.? (I neg1@) (I 0)) 0)
               )))
               (=>
                (= (curve25519_dalek!specs.field_specs.field_mul.? (I neg1@) (I 0)) 0)
                (and
                  ...
                  (and
                   (=>
                    ...
                    (and
                     (=>
                      %%location_label%%8
                      (req%vstd!arithmetic.div_mod.lemma_mod_bound. neg_i@ tmp%3)
                     )
                     (=>
                      (ens%vstd!arithmetic.div_mod.lemma_mod_bound. neg_i@ tmp%3)
                      (=>
                       %%location_label%%9
                   ...
                   (=>
                    ...
                    (=>
                     ...
                     (and
                      (=>
                       %%location_label%%10
                       (req%vstd!arithmetic.div_mod.lemma_small_mod. neg_i@ tmp%4)
                      )
                      (=>
                       (ens%vstd!arithmetic.div_mod.lemma_small_mod. neg_i@ tmp%4)
                       (and
                        (=>
                         (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_neg_mul_left.
                          1 neg_i@
                         ...
                         (=>
                          ...
                          (=>
                           ...
                           (=>
                            %%location_label%%11
                            (= (curve25519_dalek!specs.field_specs.field_mul.? (I neg1@) (I neg_i@)) (EucMod i_val!
                              (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
                        ))))))
                        (=>
                         (= (curve25519_dalek!specs.field_specs.field_mul.? (I neg1@) (I neg_i@)) (EucMod i_val!
                         ...
                         (=>
                          (= x1x2@ (curve25519_dalek!specs.field_specs.field_mul.? (I 0) (I neg_i@)))
                          (=>
                           (= y1y2@ (curve25519_dalek!specs.field_specs.field_mul.? (I neg1@) (I 0)))
                           (=>
                            (= x1y2@ (curve25519_dalek!specs.field_specs.field_mul.? (I 0) (I 0)))
                            (=>
                             (= y1x2@ (curve25519_dalek!specs.field_specs.field_mul.? (I neg1@) (I neg_i@)))
                             (=>
                              (= tmp%5 (and
                                (and
                                 (= x1x2@ 0)
                                   ...
                                   (=>
                                    ...
                                    (=>
                                     ...
                                     (and
                                      (=>
                                       %%location_label%%16
                                       (req%vstd!arithmetic.div_mod.lemma_small_mod. i_val! tmp%6)
                                      )
                                      (=>
                                       (ens%vstd!arithmetic.div_mod.lemma_small_mod. i_val! tmp%6)
                                       (=>
                                        (= tmp%7 (< (EucMod i_val! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) (curve25519_dalek!specs.field_specs_u64.p.?
                                           (I 0)
                                        )))
                                        (and
                                         (=>
                                         ...
                                         (=>
                                          tmp%7
                                          (=>
                                           (= tmp%8 (EucMod i_val! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))))
                                           (=>
                                            ...
                                            (and
                                             ...
                                             (=>
                                              ...
                                              (=>
                                               (= tmp%10 (= (curve25519_dalek!specs.field_specs.field_add.? (I x1y2@) (I y1x2@)) (
                                                  EucMod i_val! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
                                               )))
                                               (and
                                                (=>
                                                 %%location_label%%19
                                                ...
                                                (=>
                                                 ...
                                                 (and
                                                  (=>
                                                   (= tmp%11 (EucMod i_val! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))))
                                                   (=>
                                                    (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_one_right.
                                                     tmp%11
                                                    )
                                                    (=>
                                                     (= tmp%12 (EucMod i_val! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))))
                                                     (=>
                                                      ...
                                                      (and
                                                       ...
                                                       (=>
                                                        ...
                                                        (=>
                                                         %%location_label%%21
                                                         (= (curve25519_dalek!specs.field_specs.field_mul.? (I (EucMod i_val! (curve25519_dalek!specs.field_specs_u64.p.?
                                                              (I 0)
                                                            ))
                                                           ) (I 1)
                                                          ) (EucMod i_val! (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                                                  ...
                                                  (=>
                                                   ...
                                                   (=>
                                                    (= tmp%14 (= (curve25519_dalek!specs.field_specs.field_add.? (I y1y2@) (I x1x2@)) 0))
                                                    (and
                                                     (=>
                                                      %%location_label%%22
                                                      tmp%14
                                                       ...
                                                       (=>
                                                        ...
                                                        (=>
                                                         ...
                                                         (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_add.?
                                                            (I 0) (I (curve25519_dalek!specs.field_specs.field_neg.? (I 1))) (I (curve25519_dalek!specs.field_specs.field_neg.?
                                                              (I i_val!)
                                                             )
                                                            ) (I 0)
                                                           )
