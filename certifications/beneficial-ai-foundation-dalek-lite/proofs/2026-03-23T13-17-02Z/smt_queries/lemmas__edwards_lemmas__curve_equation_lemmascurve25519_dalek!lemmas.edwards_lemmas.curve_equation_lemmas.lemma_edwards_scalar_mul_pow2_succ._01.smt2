...
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:1095:1: 1095:82 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::curve_equation_lemmas::lemma_edwards_scalar_mul_pow2_succ
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:1095:1: 1095:82 (#0)
     ...
     (=>
      ...
      (=>
       ...
       (=>
        ...
        (=>
         %%location_label%%0
         (not (= (vstd!arithmetic.power2.pow2.? (I (nClip (Add k! 1)))) 0))
     ))))
     (=>
      (not (= (vstd!arithmetic.power2.pow2.? (I (nClip (Add k! 1)))) 0))
      (and
       (=>
        ...
        (and
         (=>
          %%location_label%%1
          (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_even. tmp%2)
         )
         (=>
          (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_even. tmp%2)
          (=>
           (ens%vstd!arithmetic.power2.lemma2_to64. 0)
           (=>
            %%location_label%%2
            (= (EucMod (vstd!arithmetic.power2.pow2.? (I (nClip (Add k! 1)))) 2) 0)
       )))))
       (=>
        (= (EucMod (vstd!arithmetic.power2.pow2.? (I (nClip (Add k! 1)))) 2) 0)
        (and
         (=>
          ...
          (=>
           ...
           (=>
            ...
            (=>
             %%location_label%%3
             (not (= (vstd!arithmetic.power2.pow2.? (I (nClip (Add k! 1)))) 1))
         ))))
         (=>
          (not (= (vstd!arithmetic.power2.pow2.? (I (nClip (Add k! 1)))) 1))
          (and
           (=>
            ...
            (and
             (=>
              %%location_label%%4
              (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.pow2_MUL_div. 1 tmp%4 1)
             )
             (=>
              (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.pow2_MUL_div. 1 tmp%4 1)
              (=>
               (ens%vstd!arithmetic.power2.lemma2_to64. 0)
               (=>
                %%location_label%%5
                (= (EucDiv (vstd!arithmetic.power2.pow2.? (I (nClip (Add k! 1)))) 2) (vstd!arithmetic.power2.pow2.?
                  (I k!)
           )))))))
           (=>
            (= (EucDiv (vstd!arithmetic.power2.pow2.? (I (nClip (Add k! 1)))) 2) (vstd!arithmetic.power2.pow2.?
            ...
            (=>
             ...
             (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.?
                (Poly%tuple%2. point_affine!) (I (vstd!arithmetic.power2.pow2.? (I (nClip (Add k! 1)))))
               )
              ) (Poly%tuple%2. (let
                ((half$ (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2. point_affine!)
                   (I (vstd!arithmetic.power2.pow2.? (I k!)))
