...
;; curve25519-dalek/src/lemmas/scalar_lemmas_/radix_2w_lemmas.rs:1177:5: 1177:11 (#0)
...
;; Function-Def curve25519_dalek::lemmas::scalar_lemmas_::radix_2w_lemmas::lemma_radix_2w_digit_bounds
;; curve25519-dalek/src/lemmas/scalar_lemmas_/radix_2w_lemmas.rs:1177:5: 1177:11 (#0)
...
(declare-const radix@ (_ BitVec 64))
(declare-const half_radix@ (_ BitVec 64))
(declare-const tmp$$$$bitvectmp1 (_ BitVec 64))
(declare-const coef! (_ BitVec 64))
(declare-const new_carry! (_ BitVec 64))
(assert
 (and
  (bvule ((_ zero_extend 29) (_ bv5 3)) w!)
  (bvule w! ((_ zero_extend 28) (_ bv8 4)))
))
(assert
 (= radix@ (bvshl ((_ zero_extend 63) (_ bv1 1)) ((_ zero_extend 32) w!)))
)
(assert
 (= half_radix@ (let
   ...
   (ite
    ...
    tmp$$$$bitvectmp1
    (bvudiv radix@ ((_ zero_extend 62) tmp$$$$bitvectmp0))
))))
(assert
 (bvule coef! radix@)
)
(assert
 (= new_carry! (bvlshr (bvadd coef! half_radix@) ((_ zero_extend 32) w!)))
)
...
(assert
 (not (=>
   ...
   (and
    (and
     (bvule new_carry! ((_ zero_extend 63) (_ bv1 1)))
     (=>
      (= new_carry! ((_ zero_extend 63) (_ bv0 1)))
      (bvult coef! half_radix@)
    ))
    (=>
     (= new_carry! ((_ zero_extend 63) (_ bv1 1)))
     (bvuge coef! half_radix@)
)))))
(get-info :version)
