...
;; curve25519-dalek/src/lemmas/scalar_batch_invert_lemmas.rs:98:1: 98:74 (#0)
...
;; Function-Def curve25519_dalek::lemmas::scalar_batch_invert_lemmas::lemma_mul_congruence
;; curve25519-dalek/src/lemmas/scalar_batch_invert_lemmas.rs:98:1: 98:74 (#0)
...
(push)
 ...
 (assert
  (not (and
    (=>
     %%location_label%%0
     (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_general. a! b! L!)
    )
    (=>
     (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_general. a! b! L!)
     (and
      (=>
       %%location_label%%1
       (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_general. c! d! L!)
      )
      (=>
       (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_general. c! d! L!)
       (=>
        %%location_label%%2
        (= (EucMod (nClip (Mul a! b!)) L!) (EucMod (nClip (Mul c! d!)) L!))
 )))))))
