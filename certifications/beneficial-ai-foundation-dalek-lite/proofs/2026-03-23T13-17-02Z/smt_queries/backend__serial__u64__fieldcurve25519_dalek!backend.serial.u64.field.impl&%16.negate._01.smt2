...
;; curve25519-dalek/src/backend/serial/u64/field.rs:808:5: 808:29 (#0)
...
;; Function-Def curve25519_dalek::backend::serial::u64::field::FieldElement51::negate
;; curve25519-dalek/src/backend/serial/u64/field.rs:808:5: 808:29 (#0)
...
(push)
 ...
 (declare-const neg@ curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (assert
  fuel_defaults
 )
 (assert
     ...
     (=>
      ...
      (=>
       ...
       (and
        (=>
         %%location_label%%1
         (req%curve25519_dalek!lemmas.field_lemmas.negate_lemmas.proof_negate. tmp%2)
        )
        (=>
         (ens%curve25519_dalek!lemmas.field_lemmas.negate_lemmas.proof_negate. tmp%2)
         (=>
          (= tmp%5 36028797018963664)
          (=>
           ...
           (and
            ...
            (=>
             ...
             (and
              (=>
               %%location_label%%3
               (uInv 64 (Sub tmp%5 (%I tmp%3)))
              )
              (=>
               (uInv 64 (Sub tmp%5 (%I tmp%3)))
               (=>
                (= tmp%18 (uClip 64 (Sub tmp%5 (%I tmp%3))))
                (=>
                 (= tmp%8 36028797018963952)
                 (=>
                  (= tmp%7 (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
                    (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                      self!@0
                  ))))
                  (and
                   (=>
                    %%location_label%%4
                    (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) tmp%7 1)
                   )
                   (=>
                    (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) tmp%7 1 tmp%6)
                    (and
                     (=>
                      %%location_label%%5
                      (uInv 64 (Sub tmp%8 (%I tmp%6)))
                     )
                     (=>
                      (uInv 64 (Sub tmp%8 (%I tmp%6)))
                      (=>
                       (= tmp%19 (uClip 64 (Sub tmp%8 (%I tmp%6))))
                       (=>
                        (= tmp%11 36028797018963952)
                        (=>
                         ...
                         (and
                          ...
                          (=>
                           ...
                           (and
                            (=>
                             %%location_label%%7
                             (uInv 64 (Sub tmp%11 (%I tmp%9)))
                            )
                            (=>
                             (uInv 64 (Sub tmp%11 (%I tmp%9)))
                             (=>
                              (= tmp%20 (uClip 64 (Sub tmp%11 (%I tmp%9))))
                              (=>
                               (= tmp%14 36028797018963952)
                               (=>
                                ...
                                (and
                                 (=>
                                  %%location_label%%8
                                  (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) tmp%13 3)
                                 )
                                 (=>
                                  (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) tmp%13 3 tmp%12)
                                  (and
                                   (=>
                                    %%location_label%%9
                                    (uInv 64 (Sub tmp%14 (%I tmp%12)))
                                   )
                                   (=>
                                    (uInv 64 (Sub tmp%14 (%I tmp%12)))
                                    (=>
                                     (= tmp%21 (uClip 64 (Sub tmp%14 (%I tmp%12))))
                                     (=>
                                      (= tmp%17 36028797018963952)
                                      (=>
                                       ...
                                       (and
                                        (=>
                                         %%location_label%%10
                                         (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) tmp%16 4)
                                        )
                                        (=>
                                         (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) tmp%16 4 tmp%15)
                                         (and
                                          (=>
                                           %%location_label%%11
                                           (uInv 64 (Sub tmp%17 (%I tmp%15)))
                                          )
                                          (=>
                                           (uInv 64 (Sub tmp%17 (%I tmp%15)))
                                           (=>
                                            (= tmp%22 (%Poly%array%. (array_new $ (UINT 64) 5 (%%array%%0 (I tmp%18) (I tmp%19) (
                                                 I tmp%20
                                                ) (I tmp%21) (I (uClip 64 (Sub tmp%17 (%I tmp%15))))
                                            ))))
                                            (=>
                                             (ens%curve25519_dalek!backend.serial.u64.field.impl&%16.reduce. tmp%22 neg@)
                                             (=>
                                              ...
                                              (=>
                                               (= self!@1 ((_ update-field curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/?limbs)
                                                 (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                                   self!@0
                                                  )
                                                 ) tmp%23
                                                   ...
                                                   (=>
                                                    ...
                                                    (ext_eq false (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
                                                       (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                                        ...
                                                        (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                                          (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. self!@0)
 )))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 (get-info :version)
