...
;; curve25519-dalek/src/lemmas/edwards_lemmas/torsion_lemmas.rs:357:1: 357:61 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::torsion_lemmas::lemma_edwards_add_four_torsion_with_neg
;; curve25519-dalek/src/lemmas/edwards_lemmas/torsion_lemmas.rs:357:1: 357:61 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= neg_x@ (curve25519_dalek!specs.field_specs.field_neg.? (I x!)))
    (=>
          ...
          (=>
           ...
           (and
            (=>
             ...
             (=>
              %%location_label%%2
              (= (curve25519_dalek!specs.field_specs.field_mul.? (I x!) (I neg_x@)) (curve25519_dalek!specs.field_specs.field_neg.?
                (I (curve25519_dalek!specs.field_specs.field_mul.? (I x!) (I x!)))
            ))))
            (=>
             (= (curve25519_dalek!specs.field_specs.field_mul.? (I x!) (I neg_x@)) (curve25519_dalek!specs.field_specs.field_neg.?
               (I (curve25519_dalek!specs.field_specs.field_mul.? (I x!) (I x!)))
             ...
             (=>
              (= tmp%3 (= (curve25519_dalek!specs.field_specs.field_neg.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                   (I x!) (I x!)
                 ))
                ) (curve25519_dalek!specs.field_specs.field_neg.? (I (curve25519_dalek!specs.field_specs.field_neg.?
                   (I 1)
               ...
               (=>
                ...
                (and
                 (=>
                  ...
                  (=>
                   ...
                   (and
                    (=>
                     %%location_label%%4
                     (req%vstd!arithmetic.div_mod.lemma_small_mod. 1 tmp%4)
                    )
                    (=>
                     (ens%vstd!arithmetic.div_mod.lemma_small_mod. 1 tmp%4)
                     (=>
                      %%location_label%%5
                      (= (curve25519_dalek!specs.field_specs.field_neg.? (I (curve25519_dalek!specs.field_specs.field_neg.?
                          (I 1)
                 ...
                 (=>
                  ...
                  (=>
                   (= tmp%5 (= (curve25519_dalek!specs.field_specs.field_mul.? (I x!) (I neg_x@)) 1))
                   (and
                    (=>
                     %%location_label%%6
                     tmp%5
                         ...
                         (and
                          (and
                           ...
                           (=>
                            ...
                            (=>
                             %%location_label%%12
                             (= (curve25519_dalek!specs.field_specs.field_mul.? (I 0) (I neg_x@)) 0)
                          )))
                          (=>
                           (= (curve25519_dalek!specs.field_specs.field_mul.? (I 0) (I neg_x@)) 0)
                           (=>
                            (= x1x2@ (curve25519_dalek!specs.field_specs.field_mul.? (I x!) (I neg_x@)))
                            (=>
                             (= y1y2@ (curve25519_dalek!specs.field_specs.field_mul.? (I 0) (I 0)))
                             (=>
                              (= x1y2@ (curve25519_dalek!specs.field_specs.field_mul.? (I x!) (I 0)))
                              (=>
                               (= y1x2@ (curve25519_dalek!specs.field_specs.field_mul.? (I 0) (I neg_x@)))
                               (=>
                                (= tmp%6 (and
                                  (and
                                   (and
                                   ...
                                   (=>
                                    ...
                                    (=>
                                     ...
                                     (and
                                      (=>
                                       %%location_label%%14
                                       (req%vstd!arithmetic.div_mod.lemma_small_mod. 0 tmp%7)
                                      )
                                      (=>
                                       (ens%vstd!arithmetic.div_mod.lemma_small_mod. 0 tmp%7)
                                       (=>
                                        %%location_label%%15
                                        (= (curve25519_dalek!specs.field_specs.field_mul.? (I x1x2@) (I y1y2@)) 0)
                                   )))))
                                   (=>
                                    ...
                                    (and
                                     ...
                                     (=>
                                      ...
                                      (=>
                                       (= tmp%8 (= (curve25519_dalek!specs.field_specs.field_add.? (I x1y2@) (I y1x2@)) 0))
                                       (and
                                        (=>
                                         %%location_label%%17
                                         tmp%8
                                        ...
                                        (=>
                                         ...
                                         (and
                                          ...
                                          (=>
                                           (= (curve25519_dalek!specs.field_specs.field_mul.? (I 0) (I 1)) 0)
                                           (=>
                                            (= tmp%9 (= (curve25519_dalek!specs.field_specs.field_add.? (I y1y2@) (I x1x2@)) 1))
                                            (and
                                             (=>
                                              %%location_label%%20
                                              tmp%9
                                               ...
                                               (=>
                                                ...
                                                (=>
                                                 ...
                                                 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_add.?
                                                    (I x!) (I 0) (I (curve25519_dalek!specs.field_specs.field_neg.? (I x!))) (I 0)
                                                   )
