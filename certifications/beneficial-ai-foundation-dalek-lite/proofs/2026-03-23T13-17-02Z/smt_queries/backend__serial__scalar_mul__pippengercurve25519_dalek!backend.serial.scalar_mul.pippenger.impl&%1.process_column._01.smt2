...
;; curve25519-dalek/src/backend/serial/scalar_mul/pippenger.rs:339:9: 339:41 (#3443)
...
;; Function-Def curve25519_dalek::backend::serial::scalar_mul::pippenger::Pippenger::process_column
;; curve25519-dalek/src/backend/serial/scalar_mul/pippenger.rs:339:9: 339:41 (#3443)
(get-info :all-statistics)
(push)
 (declare-const column! curve25519_dalek!edwards.EdwardsPoint.)
 (declare-const buckets!@0 alloc!vec.Vec<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>.)
 (declare-const scalars_points! Poly)
 (declare-const digit_index! Int)
 (declare-const w! Int)
 (declare-const buckets_count! Int)
 ...
 (declare-const verus_tmp_dc@ Int)
 (declare-const verus_tmp_n_ghost@ Int)
 (declare-const verus_tmp_B@ Int)
 ...
 (declare-const verus_tmp_col@ Int)
 (declare-const verus_tmp_d_val@ Int)
 (declare-const tmp%9 Poly)
 (declare-const tmp%10 Poly)
 (declare-const bb@ Poly)
 (declare-const tmp%11 Bool)
 (declare-const tmp%12 Bool)
 (declare-const b$1@ Int)
 (declare-const completed@ curve25519_dalek!backend.serial.curve_models.CompletedPoint.)
 (declare-const new_bucket@ curve25519_dalek!edwards.EdwardsPoint.)
 (declare-const tmp%13 Poly)
 (declare-const tmp%14 Poly)
 (declare-const bb$1@ Poly)
 (declare-const b$2@ Int)
 (declare-const completed$1@ curve25519_dalek!backend.serial.curve_models.CompletedPoint.)
 (declare-const new_bucket$1@ curve25519_dalek!edwards.EdwardsPoint.)
 (declare-const bb$2@ Poly)
 (declare-const sp@ tuple%2.)
 (declare-const digits_arr@ %%Function%%)
 (declare-const pt@ curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.)
 (declare-const digit@ Int)
 (declare-const verus_tmp$5@0 Int)
 (declare-const col@0 Int)
 (declare-const verus_tmp$6@0 Int)
 (declare-const d_val@0 Int)
 (declare-const decrease%init1%0 Int)
 (declare-const verus_tmp_buckets_affine@ vstd!seq.Seq<tuple%2<nat./nat.>.>.)
 (declare-const tmp%15 alloc!vec.Vec<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>.)
 (declare-const tmp%16 Poly)
 (declare-const tmp%17 Int)
 (declare-const tmp%18 alloc!vec.Vec<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>.)
 ...
 (declare-const tmp%25 curve25519_dalek!edwards.EdwardsPoint.)
 (declare-const tmp%26 Bool)
 (declare-const k@ Poly)
 (declare-const bucket_contents_seq@ vstd!seq.Seq<tuple%2<nat./nat.>.>.)
 (declare-const verus_tmp@0 vstd!seq.Seq<tuple%2<nat./nat.>.>.)
 (declare-const pts_affine@0 vstd!seq.Seq<tuple%2<nat./nat.>.>.)
 (declare-const verus_tmp$1@0 vstd!seq.Seq<vstd!seq.Seq<i8.>.>.)
 (declare-const digits_seqs@0 vstd!seq.Seq<vstd!seq.Seq<i8.>.>.)
 (declare-const verus_tmp$2@0 Int)
 (declare-const dc@0 Int)
 (declare-const verus_tmp$3@0 Int)
 (declare-const n_ghost@0 Int)
 (declare-const verus_tmp$4@0 Int)
 (declare-const B@0 Int)
 (declare-const bucket_idx@0 Int)
 (declare-const sp_idx@0 Int)
 (declare-const verus_tmp$7@0 vstd!seq.Seq<tuple%2<nat./nat.>.>.)
 (declare-const buckets_affine@0 vstd!seq.Seq<tuple%2<nat./nat.>.>.)
 (declare-const buckets_intermediate_sum@0 curve25519_dalek!edwards.EdwardsPoint.)
 (declare-const column@0 curve25519_dalek!edwards.EdwardsPoint.)
 (declare-const j@0 Int)
 (assert
  fuel_defaults
 )
 (assert
  (has_type scalars_points! (TYPE%alloc!vec.Vec. (DST $) (TYPE%tuple%2. $ (ARRAY $ (SINT
       8
      ) $ (CONST_INT 64)
     ) $ TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
    ) $ ALLOCATOR_GLOBAL
 ...
 (assert
  (uInv SZ bucket_idx@0)
 )
 (declare-const buckets!@1 alloc!vec.Vec<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>.)
 (declare-const buckets!@2 alloc!vec.Vec<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>.)
 (declare-const bucket_idx@1 Int)
 ...
 (assert
  (not (=>
    ...
    (=>
     (= (vstd!seq.Seq.len.? $ TYPE%curve25519_dalek!edwards.EdwardsPoint. (vstd!view.View.view.?
        $ (TYPE%alloc!vec.Vec. $ TYPE%curve25519_dalek!edwards.EdwardsPoint. $ ALLOCATOR_GLOBAL)
        (Poly%alloc!vec.Vec<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>. buckets!@1)
       )
      ) buckets_count!
     )
     (=>
      (forall ((k$ Poly)) (!
        ...
        :qid user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__process_column_60
        :skolemid skolem_user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__process_column_60
      ))
      (=>
       (forall ((k$ Poly)) (!
         (=>
          ...
          (=>
           ...
           (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_point_as_affine.?
         ...
         :qid user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__process_column_61
         :skolemid skolem_user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__process_column_61
       ))
       (=>
        (= decrease%init0%0 (Sub buckets_count! bucket_idx@0))
        (=>
         (< bucket_idx@0 buckets_count!)
         (=>
          (ens%curve25519_dalek!edwards.impl&%19.identity. tmp%2)
          (=>
           (= ep@ (%Poly%curve25519_dalek!edwards.EdwardsPoint. tmp%2))
           (and
            (=>
             %%location_label%%0
             (req%curve25519_dalek!specs.edwards_specs.lemma_identity_affine_coords. ep@)
            )
            (=>
             (ens%curve25519_dalek!specs.edwards_specs.lemma_identity_affine_coords. ep@)
             (and
              (=>
               %%location_label%%1
               (req%vstd!pervasive.impl&%1.set. $ TYPE%curve25519_dalek!edwards.EdwardsPoint. (Poly%alloc!vec.Vec<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>.
                 buckets!@1
                ) bucket_idx@0 (Poly%curve25519_dalek!edwards.EdwardsPoint. ep@)
              ))
              (=>
               (ens%vstd!pervasive.impl&%1.set. $ TYPE%curve25519_dalek!edwards.EdwardsPoint. (Poly%alloc!vec.Vec<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>.
                 buckets!@1
                ) (Poly%alloc!vec.Vec<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>.
                 buckets!@2
                ) bucket_idx@0 (Poly%curve25519_dalek!edwards.EdwardsPoint. ep@)
               ...
               (and
                (=>
                 %%location_label%%2
                 (uInv SZ (Add bucket_idx@0 1))
                )
                (=>
                 (uInv SZ (Add bucket_idx@0 1))
                 (=>
                  (= bucket_idx@1 (uClip SZ (Add bucket_idx@0 1)))
                  (and
                   (=>
                    %%location_label%%3
                    (let
                   ...
                   (and
                    (=>
                     ...
                     (= (vstd!seq.Seq.len.? $ TYPE%curve25519_dalek!edwards.EdwardsPoint. (vstd!view.View.view.?
                        $ (TYPE%alloc!vec.Vec. $ TYPE%curve25519_dalek!edwards.EdwardsPoint. $ ALLOCATOR_GLOBAL)
                        (Poly%alloc!vec.Vec<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>. buckets!@2)
                       )
                      ) buckets_count!
                    ))
                    (and
                     ...
                     (and
                      ...
                      (=>
                       %%location_label%%7
                       (check_decrease_int (Sub buckets_count! bucket_idx@1) decrease%init0%0 false)
 ))))))))))))))))))))))
 (get-info :version)
