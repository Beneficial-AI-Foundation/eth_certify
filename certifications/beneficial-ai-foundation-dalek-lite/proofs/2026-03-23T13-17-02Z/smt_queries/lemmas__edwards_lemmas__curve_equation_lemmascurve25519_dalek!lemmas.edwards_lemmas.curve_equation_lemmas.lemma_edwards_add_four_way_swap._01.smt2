...
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:867:1: 872:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::curve_equation_lemmas::lemma_edwards_add_four_way_swap
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:867:1: 872:2 (#0)
...
(push)
 ...
 (assert
  (has_type (Poly%tuple%2. a!) (TYPE%tuple%2. $ NAT $ NAT))
 )
 (assert
  (has_type (Poly%tuple%2. b!) (TYPE%tuple%2. $ NAT $ NAT))
 )
 (assert
  (has_type (Poly%tuple%2. c!) (TYPE%tuple%2. $ NAT $ NAT))
 )
 (assert
  (has_type (Poly%tuple%2. d!) (TYPE%tuple%2. $ NAT $ NAT))
 )
 ...
 (assert
  (not (=>
    ...
    (=>
     ...
     (=>
      (= tmp%1 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. a!)))))
      (=>
       (= tmp%2 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. a!)))))
       (=>
        (= tmp%3 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. b!)))))
        (=>
         (= tmp%4 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. b!)))))
         (=>
          (= tmp%5 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. cd@)))))
          (=>
           (= tmp%6 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. cd@)))))
           (=>
            (ens%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.axiom_edwards_add_associative.
             tmp%1 tmp%2 tmp%3 tmp%4 tmp%5 tmp%6
            )
            (=>
             (= tmp%7 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. b!)))))
             (=>
              (= tmp%8 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. b!)))))
              (=>
               (= tmp%9 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. c!)))))
               (=>
                (= tmp%10 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. c!)))))
                (=>
                 (= tmp%11 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. d!)))))
                 (=>
                  (= tmp%12 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. d!)))))
                  (=>
                   (ens%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.axiom_edwards_add_associative.
                         ...
                         (=>
                          ...
                          (=>
                           ...
                           (=>
                            ...
                            (=>
                             (= tmp%21 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. d!)))))
                             (=>
                              (= tmp%22 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. d!)))))
                              (=>
                               (ens%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.axiom_edwards_add_associative.
                                tmp%17 tmp%18 tmp%19 tmp%20 tmp%21 tmp%22
                               )
                               (=>
                                (= tmp%23 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. a!)))))
                                (=>
                                 (= tmp%24 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. a!)))))
                                 (=>
                                  (= tmp%25 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. c!)))))
                                  (=>
                                   (= tmp%26 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. c!)))))
                                   (=>
                                    (= tmp%27 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. bd@)))))
                                    (=>
                                     (= tmp%28 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. bd@)))))
                                     (=>
                                      (ens%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.axiom_edwards_add_associative.
