...
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:490:1: 490:75 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::curve_equation_lemmas::lemma_affine_curve_implies_projective
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:490:1: 490:75 (#0)
                      ...
                      (=>
                       ...
                       (and
                        ...
                        (=>
                         (= y_div_z_sq@ (curve25519_dalek!specs.field_specs.field_mul.? (I y2@) (I inv_z2@)))
                         (=>
                          (= proj_lhs@ (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_sub.?
                              (I y2@) (I x2@)
                             )
                            ) (I z2@)
                          ))
                                ...
                                (=>
                                 ...
                                 (and
                                  ...
                                  (=>
                                   ...
                                   (and
                                    (=>
                                     (= tmp%2 (curve25519_dalek!specs.field_specs.field_mul.? (I y2@) (I inv_z2@)))
                                     (=>
                                      (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_assoc.
                                       x2@ inv_z2@ tmp%2
                                      )
                                      (=>
                                       (= tmp%3 (curve25519_dalek!specs.field_specs.field_mul.? (I y2@) (I inv_z2@)))
                                       (=>
                                        (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_comm.
                                         inv_z2@ tmp%3
                                        )
                                        (=>
                                         ...
                                         (=>
                                          (= tmp%4 (curve25519_dalek!specs.field_specs.field_mul.? (I inv_z2@) (I inv_z2@)))
                                          (=>
                                           (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_assoc.
                                            x2@ y2@ tmp%4
                                           )
                                    ...
                                    (=>
                                     ...
                                     (=>
                                      (= tmp%5 (= affine_rhs@ (curve25519_dalek!specs.field_specs.field_add.? (I 1) (I (curve25519_dalek!specs.field_specs.field_mul.?
                                           (I d@) (I x2_y2_inv_z4@)
                                      )))))
                                      (and
                                       (=>
                                                ...
                                                (=>
                                                 ...
                                                 (and
                                                  ...
                                                  (=>
                                                   ...
                                                   (and
                                                    (=>
                                                     (= tmp%8 (nClip (Mul z2@ z2@)))
                                                     (and
                                                      (=>
                                                       %%location_label%%13
                                                       (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%8 p@)
                                                      )
                                                      (=>
                                                       (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%8 p@)
                                                       (=>
                                                        %%location_label%%14
                                                        (< z4@ p@)
                                                    ))))
                                                            ...
                                                            (and
                                                             ...
                                                             (=>
                                                              ...
                                                              (=>
                                                               ...
                                                               (=>
                                                                %%location_label%%18
                                                                (= (curve25519_dalek!specs.field_specs.field_mul.? (I inv_z2@) (I z4@)) z2@)
                                                           )))))
                                                           (=>
                                                            (= (curve25519_dalek!specs.field_specs.field_mul.? (I inv_z2@) (I z4@)) z2@)
                                                            (and
                                                             (=>
                                                              (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_assoc.
                                                               y2_minus_x2@ inv_z2@ z4@
                                                              )
                                                              (=>
                                                               %%location_label%%19
                                                               (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                                                                   (I y2_minus_x2@) (I inv_z2@)
                                                                  )
                                                                 ) (I z4@)
                                                                ) proj_lhs@
                                                             )))
                                                                        ...
                                                                        (=>
                                                                         ...
                                                                         (=>
                                                                          ...
                                                                          (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                                                                           ...
                                                                           ) (curve25519_dalek!specs.field_specs.field_mul.? (I d@) (I x2_y2@))
                                                                 ))))))))))
                                                                 (=>
                                                                  (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                                                                      (I d@) (I x2_y2_inv_z4@)
                                                                  ...
                                                                  (and
                                                                   (=>
                                                                    ...
                                                                    (=>
                                                                     (= tmp%11 (curve25519_dalek!specs.field_specs.field_mul.? (I d@) (I x2_y2_inv_z4@)))
                                                                     (=>
                                                                      (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_distributes_over_add.
                                                                       z4@ 1 tmp%11
                                                                      )
                                                                      (=>
                                                                       ...
                                                                       (and
                                                                        (=>
                                                                         %%location_label%%25
                                                                         (req%vstd!arithmetic.div_mod.lemma_small_mod. z4@ p@)
                                                                        )
                                                                        (=>
                                                                         (ens%vstd!arithmetic.div_mod.lemma_small_mod. z4@ p@)
                                                                         (=>
                                                                          (= tmp%12 (curve25519_dalek!specs.field_specs.field_mul.? (I d@) (I x2_y2_inv_z4@)))
                                                                          (=>
                                                                           (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_comm.
                                                                            z4@ tmp%12
                                                                           )
                                                                           (=>
                                                                            %%location_label%%26
                                                                            (= (curve25519_dalek!specs.field_specs.field_mul.? (I affine_rhs@) (I z4@)) proj_rhs@)
                                                                   )))))))))
                                                                   (=>
                                                                    (= (curve25519_dalek!specs.field_specs.field_mul.? (I affine_rhs@) (I z4@)) proj_rhs@)
                                                                    (=>
                                                                     (= tmp%13 (= (curve25519_dalek!specs.field_specs.field_mul.? (I affine_lhs@) (I z4@))
                                                                       (curve25519_dalek!specs.field_specs.field_mul.? (I affine_rhs@) (I z4@))
                                                                     ))
                                                                     (and
                                                                      (=>
                                                                       %%location_label%%27
                                                                      ...
                                                                      (=>
                                                                       ...
                                                                       (and
                                                                        (=>
                                                                         ...
                                                                         (=>
                                                                          %%location_label%%28
                                                                          (= (curve25519_dalek!specs.field_specs.field_mul.? (I affine_lhs@) (I z4@)) proj_lhs@)
                                                                        ))
                                                                        (=>
                                                                         (= (curve25519_dalek!specs.field_specs.field_mul.? (I affine_lhs@) (I z4@)) proj_lhs@)
                                                                         (=>
                                                                          (= tmp%14 (= proj_lhs@ proj_rhs@))
                                                                          (and
                                                                           (=>
                                                                            %%location_label%%29
                                                                            tmp%14
