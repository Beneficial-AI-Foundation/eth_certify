...
;; curve25519-dalek/src/lemmas/edwards_lemmas/straus_lemmas.rs:1128:1: 1128:97 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::straus_lemmas::lemma_straus_vt_partial_peel_last
;; curve25519-dalek/src/lemmas/edwards_lemmas/straus_lemmas.rs:1128:1: 1128:97 (#0)
...
(push)
 ...
 (declare-const doubled_prefix@ tuple%2.)
 (declare-const doubled_single@ tuple%2.)
 ...
 (declare-const nafs_single@ vstd!seq.Seq<vstd!seq.Seq<i8.>.>.)
 ...
 (assert
  (forall ((k$ Poly)) (!
    ...
    :qid user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_straus_vt_partial_peel_last_75
    :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_straus_vt_partial_peel_last_75
 )))
 (assert
  (forall ((k$ Poly)) (!
    (=>
    ...
    :qid user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_straus_vt_partial_peel_last_76
    :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_straus_vt_partial_peel_last_76
 )))
     ...
     (=>
      ...
      (=>
       ...
       (=>
        ...
        (=>
         (= nafs_single@ (%Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>. (vstd!seq.Seq.push.? $ (TYPE%vstd!seq.Seq.
             $ (SINT 8)
          ...
          (and
           (=>
            ...
            (=>
             ...
             (=>
              (ens%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_vt_base. pts_prefix@
               nafs_prefix@
              )
              (=>
               (ens%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_vt_base. pts_single@
                nafs_single@
               )
               (=>
            ...
            (and
             ...
             (=>
              ...
              (and
               (=>
                %%location_label%%2
                (req%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_vt_step. pts_prefix@
                 nafs_prefix@ i!
               ))
               (=>
                (ens%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_vt_step. pts_prefix@
                 nafs_prefix@ i!
                )
                (and
                 (=>
                  %%location_label%%3
                  (req%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_vt_step. pts_single@
                   nafs_single@ i!
                 ))
                 (=>
                  (ens%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_vt_step. pts_single@
                   nafs_single@ i!
                  )
                  (=>
                   (= tmp%2 (Add i! 1))
                   (and
                    (=>
                     ...
                     (check_decrease_int (let
                       ((pts!$0 pts!) (nafs!$1 nafs!) (i!$2 tmp%2))
                       (Sub 256 i!$2)
                    ...
                    (and
                     ...
                     (=>
                      ...
                      (=>
                       (= prev_full@ (curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.straus_vt_partial.?
                         (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. pts!) (Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>.
                          nafs!
                         ) (I (Add i! 1))
                       ))
                       (=>
                        (= prev_prefix@ (curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.straus_vt_partial.?
                          (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. pts_prefix@) (Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>.
                           nafs_prefix@
                          ) (I (Add i! 1))
                        ))
                        (=>
                         (= prev_single@ (curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.straus_vt_partial.?
                         ...
                         (=>
                          (ens%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_double_distributes.
                           prev_prefix@ prev_single@
                          )
                          (=>
                           (= doubled_prefix@ (curve25519_dalek!specs.edwards_specs.edwards_double.? (tuple%2./tuple%2/0
                              (%Poly%tuple%2. (Poly%tuple%2. prev_prefix@))
                             ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. prev_prefix@)))
                           ))
                           (=>
                            (= doubled_single@ (curve25519_dalek!specs.edwards_specs.edwards_double.? (tuple%2./tuple%2/0
                               (%Poly%tuple%2. (Poly%tuple%2. prev_single@))
                              ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. prev_single@)))
                            ))
                            (=>
                              ...
                              (=>
                               ...
                               (and
                                (=>
                                 %%location_label%%6
                                 (req%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_column_sum_prefix_eq.
                                  pts! nafs! pts_prefix@ nafs_prefix@ i! tmp%3
                                ))
                                (=>
                                 (ens%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_column_sum_prefix_eq.
                                  pts! nafs! pts_prefix@ nafs_prefix@ i! tmp%3
                                  ...
                                  (=>
                                   ...
                                   (and
                                    ...
                                    (=>
                                     ...
                                     (=>
                                      (ens%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_edwards_add_four_way_swap.
                                       doubled_prefix@ doubled_single@ col_prefix@ col_single@
                                      )
                                      %%switch_label%%0
          ))))))))))))))))))))))))))))
          (and
