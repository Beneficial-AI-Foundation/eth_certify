...
;; curve25519-dalek/src/lemmas/edwards_lemmas/pippenger_lemmas.rs:1172:1: 1178:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::pippenger_lemmas::lemma_bucket_weighted_sum_equals_column_sum
;; curve25519-dalek/src/lemmas/edwards_lemmas/pippenger_lemmas.rs:1172:1: 1178:2 (#0)
(get-info :all-statistics)
(push)
 (declare-const points_affine! vstd!seq.Seq<tuple%2<nat./nat.>.>.)
 (declare-const all_digits! vstd!seq.Seq<vstd!seq.Seq<i8.>.>.)
 (declare-const col! Int)
 (declare-const n! Int)
 (declare-const num_buckets! Int)
 ...
 (declare-const neg_pt@ tuple%2.)
 (declare-const bb$2@ Poly)
 (declare-const tmp%6 Int)
 (declare-const cs@ tuple%2.)
 (declare-const buckets_prev@ vstd!seq.Seq<tuple%2<nat./nat.>.>.)
 (declare-const d@ Int)
 (declare-const pt@ tuple%2.)
 (declare-const B@ Int)
 (declare-const buckets_n@ vstd!seq.Seq<tuple%2<nat./nat.>.>.)
 ...
 (assert
  (forall ((k$ Poly)) (!
    ...
    :qid user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_bucket_weighted_sum_equals_column_sum_93
    :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_bucket_weighted_sum_equals_column_sum_93
 )))
 (assert
  (forall ((k$ Poly)) (!
    (=>
    ...
    :qid user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_bucket_weighted_sum_equals_column_sum_94
    :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_bucket_weighted_sum_equals_column_sum_94
 )))
 (assert
  (forall ((k$ Poly)) (!
    (=>
    ...
    :qid user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_bucket_weighted_sum_equals_column_sum_95
    :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_bucket_weighted_sum_equals_column_sum_95
 )))
 ...
 (assert
  (not (=>
    ...
    (=>
     (= B@ num_buckets!)
     (=>
      (= buckets_n@ (%Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. (vstd!seq.Seq.new.? (DST $)
         (TYPE%tuple%2. $ NAT $ NAT) $ (TYPE%fun%1. $ INT (DST $) (TYPE%tuple%2. $ NAT $ NAT))
         (I (nClip B@)) (Poly%fun%1. (mk_fun (%%lambda%%3 (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>.
             points_affine!
            ) (Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>. all_digits!) (I col!) (I n!)
      ))))))
      (or
       (and
         ...
         (and
           ...
           (=>
            ...
            (=>
             ...
             (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2.
                $ NAT $ NAT
               ) (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. buckets_n@) b@
          ...
          (=>
           (forall ((b$ Poly)) (!
             ...
             :qid user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_bucket_weighted_sum_equals_column_sum_81
             :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_bucket_weighted_sum_equals_column_sum_81
           ))
           (and
            (and
             (=>
             ...
             (=>
              ...
              (=>
               %%location_label%%2
               (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.pippenger_weighted_bucket_sum.?
                  (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. buckets_n@) (I B@)
                 )
                ) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_identity.? (I 0)))
            ))))
            (=>
        ...
        (=>
         (not (<= n! 0))
         (=>
          (= buckets_prev@ (%Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. (vstd!seq.Seq.new.? (DST $)
             (TYPE%tuple%2. $ NAT $ NAT) $ (TYPE%fun%1. $ INT (DST $) (TYPE%tuple%2. $ NAT $ NAT))
             (I (nClip B@)) (Poly%fun%1. (mk_fun (%%lambda%%3 (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>.
                 points_affine!
                ) (Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>. all_digits!) (I col!) (I (Sub n! 1))
          ))))))
          (and
           (=>
            (= tmp%1 (Sub n! 1))
            (and
             (=>
              ...
              (check_decrease_int (let
                ((points_affine!$0 points_affine!) (all_digits!$1 all_digits!) (col!$2 col!) (n!$3
                  tmp%1
             ...
             (and
              (=>
               %%location_label%%4
               (req%curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.lemma_bucket_weighted_sum_equals_column_sum.
                points_affine! all_digits! col! tmp%1 num_buckets!
              ))
              (=>
               (ens%curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.lemma_bucket_weighted_sum_equals_column_sum.
                points_affine! all_digits! col! tmp%1 num_buckets!
               ...
               (=>
                %%location_label%%5
                (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.pippenger_weighted_bucket_sum.?
                   (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. buckets_prev@) (I num_buckets!)
                  )
           ...
           (=>
            ...
            (=>
             (= d@ (%I (vstd!seq.Seq.index.? $ (SINT 8) (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq.
                  $ (SINT 8)
                 ) (Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>. all_digits!) (I (Sub n! 1))
                ) (I col!)
             )))
             (=>
              (= pt@ (%Poly%tuple%2. (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2. $ NAT $ NAT) (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>.
                  points_affine!
                 ) (I (Sub n! 1))
              )))
              (or
                  ...
                  (and
                   (=>
                    ...
                    (=>
                     ...
                     (=>
                      ...
                      (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2.
                         $ NAT $ NAT
                        ) (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. buckets_n@) bb@
                       ) (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2. $ NAT $ NAT) (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>.
                         buckets_prev@
                        ) bb@
                   )))))
                   (=>
                    (forall ((bb$ Poly)) (!
                      ...
                      :qid user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_bucket_weighted_sum_equals_column_sum_84
                      :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_bucket_weighted_sum_equals_column_sum_84
                    ))
                    (=>
                     (= tmp%2 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2.
                         $ NAT $ NAT
                        ) (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. buckets_n@) (I idx@)
                          ...
                          (%Poly%tuple%2. (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2. $ NAT $ NAT) (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>.
                             ...
                             NAT $ NAT
                            ) (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. buckets_prev@) (I idx@)
                          ))
                         ) (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. pt@))) (tuple%2./tuple%2/1 (%Poly%tuple%2.
                           (Poly%tuple%2. pt@)
                     ))))))
                     (and
                      (=>
                       ...
                       (and
                        (and
                         (=>
                          %%location_label%%8
                          (req%curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.lemma_weighted_bucket_sum_add_to_bucket.
                           buckets_prev@ buckets_n@ idx@ pt@ B@
                         ))
                         (=>
                          (ens%curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.lemma_weighted_bucket_sum_add_to_bucket.
                           buckets_prev@ buckets_n@ idx@ pt@ B@
                          ...
                          (=>
                           ...
                           (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.pippenger_weighted_bucket_sum.?
                              ...
                              ((prev$ (curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.pippenger_weighted_bucket_sum.?
                                 (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. buckets_prev@) (I B@)
                              )))
                              (let
                               ((delta$ (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2. pt@)
                                  (I (nClip (Add idx@ 1)))
                               )))
                               (curve25519_dalek!specs.edwards_specs.edwards_add.? (tuple%2./tuple%2/0 (%Poly%tuple%2.
                                  (Poly%tuple%2. prev$)
                     ...
                     (and
                      (=>
                       ...
                       (=>
                        ...
                        (=>
                         ...
                         (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2.
                            $ NAT $ NAT
                           ) (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. buckets_n@) bb$1@
                          ) (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2. $ NAT $ NAT) (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>.
                            buckets_prev@
                           ) bb$1@
                      )))))
                      (=>
                       (forall ((bb$ Poly)) (!
                         ...
                         :qid user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_bucket_weighted_sum_equals_column_sum_86
                         :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_bucket_weighted_sum_equals_column_sum_86
                       ))
                       (=>
                        (= neg_pt@ (curve25519_dalek!specs.edwards_specs.edwards_neg.? (Poly%tuple%2. pt@)))
                        (=>
                         (= tmp%3 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2.
                             $ NAT $ NAT
                            ) (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. buckets_n@) (I idx$1@)
                           ) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_sub.? (tuple%2./tuple%2/0
                              (%Poly%tuple%2. (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2. $ NAT $ NAT) (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>.
                                 buckets_prev@
                                ) (I idx$1@)
                              ))
                                 ...
                                 NAT $ NAT
                                ) (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. buckets_prev@) (I idx$1@)
                              ))
                             ) (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. pt@))) (tuple%2./tuple%2/1 (%Poly%tuple%2.
                               (Poly%tuple%2. pt@)
                         ))))))
                         (and
                          ...
                          (=>
                           tmp%3
                           (=>
                            (= tmp%4 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2.
                                $ NAT $ NAT
                               ) (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. buckets_n@) (I idx$1@)
                              ) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_add.? (tuple%2./tuple%2/0
                                 (%Poly%tuple%2. (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2. $ NAT $ NAT) (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>.
                                ...
                                ) (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. neg_pt@))) (tuple%2./tuple%2/1
                                 (%Poly%tuple%2. (Poly%tuple%2. neg_pt@))
                            )))))
                            (and
                             (=>
                              %%location_label%%12
                              ...
                              (and
                               (and
                                (=>
                                 %%location_label%%13
                                 (req%curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.lemma_weighted_bucket_sum_add_to_bucket.
                                  buckets_prev@ buckets_n@ idx$1@ neg_pt@ B@
                                ))
                                (=>
                                 (ens%curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.lemma_weighted_bucket_sum_add_to_bucket.
                                  buckets_prev@ buckets_n@ idx$1@ neg_pt@ B@
                                 ...
                                 (=>
                                  ...
                                  (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.pippenger_weighted_bucket_sum.?
                                     ...
                                     (let
                                      ((delta$ (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2. neg_pt@)
                                         (I (nClip (Add idx$1@ 1)))
                                      )))
                                      (curve25519_dalek!specs.edwards_specs.edwards_add.? (tuple%2./tuple%2/0 (%Poly%tuple%2.
                                         (Poly%tuple%2. prev$)
                                  ...
                                  (=>
                                   ...
                                   (=>
                                    ...
                                    (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.?
                                       (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_neg.? (Poly%tuple%2. pt@)))
                                       (I (nClip (Sub 0 d@)))
                                      )
                                     ) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_neg.? (Poly%tuple%2.
                                        (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2. pt@) (I (
                                           nClip (Sub 0 d@)
                                 ))))))))))
                                 (=>
                                  (= (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_neg.?
                                      ...
                                      (Poly%tuple%2. pt@) (I (nClip (Sub 0 d@)))
                                  ))))
                                  (=>
                                   (fuel_bool fuel%curve25519_dalek!specs.edwards_specs.edwards_scalar_mul_signed.)
                                   %%switch_label%%2
                    ...
                    (and
                     (=>
                      ...
                      (=>
                       ...
                       (=>
                        ...
                        (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2.
                           $ NAT $ NAT
                          ) (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. buckets_n@) bb$2@
                         ) (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2. $ NAT $ NAT) (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>.
                           buckets_prev@
                          ) bb$2@
                     )))))
                     (=>
                      (forall ((bb$ Poly)) (!
                        ...
                        :qid user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_bucket_weighted_sum_equals_column_sum_89
                        :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_bucket_weighted_sum_equals_column_sum_89
                      ))
                      (and
                       (and
                        (=>
                        ...
                        (=>
                         ...
                         (=>
                          ...
                          (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.pippenger_weighted_bucket_sum.?
                           ...
                           ) (Poly%tuple%2. (curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.pippenger_weighted_bucket_sum.?
                             (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. buckets_prev@) (I B@)
                       ))))))
                       (=>
                        (= (curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.pippenger_weighted_bucket_sum.?
                        ...
                        (=>
                         ...
                         (=>
                          (fuel_bool fuel%curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.)
                          (=>
                           (= cs@ (curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.straus_column_sum.? (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>.
                              points_affine!
                             ) (Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>. all_digits!) (I col!) (I (Sub n! 1))
                           ))
                           (and
                            (=>
                             ...
                             (and
                              (=>
                               %%location_label%%19
                               (req%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_column_sum_canonical.
                                points_affine! all_digits! col! tmp%6
                              ))
                              (=>
                               (ens%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_column_sum_canonical.
                                points_affine! all_digits! col! tmp%6
                               ...
                               (=>
                                %%location_label%%20
                                (and
                                 (< (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. cs@)))) (curve25519_dalek!specs.field_specs_u64.p.?
                                   (I 0)
                                 ))
                                 (< (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. cs@)))) (curve25519_dalek!specs.field_specs_u64.p.?
                                   (I 0)
                            )))))))
                            (=>
                             (and
                             ...
                             (and
                                ...
                                (=>
                                 ...
                                 (=>
                                  ...
                                  (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_add.?
                                     (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. cs@))) (tuple%2./tuple%2/1 (%Poly%tuple%2.
                                       (Poly%tuple%2. cs@)
                                      )
                                     ) (I 0) (I 1)
                                    )
                              ...
                              (=>
                               (= (curve25519_dalek!specs.edwards_specs.edwards_add.? (tuple%2./tuple%2/0 (%Poly%tuple%2.
                                 ...
                                 ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. cs@))) (I 0) (I 1)
                                ) cs@
                               )
                               %%switch_label%%2
                  )))))))))))))
