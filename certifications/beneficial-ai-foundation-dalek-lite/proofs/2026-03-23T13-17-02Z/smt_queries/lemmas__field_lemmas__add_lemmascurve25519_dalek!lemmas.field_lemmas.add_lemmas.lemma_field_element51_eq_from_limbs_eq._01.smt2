...
;; MODULE 'module lemmas::field_lemmas::add_lemmas'
;; curve25519-dalek/src/lemmas/field_lemmas/add_lemmas.rs:53:1: 53:90 (#0)
...
(assert
 (distinct fuel%vstd!arithmetic.div_mod.lemma_add_mod_noop. fuel%vstd!array.array_view.
  ...
  fuel%curve25519_dalek!specs.edwards_specs.edwards_point_limbs_bounded. fuel%curve25519_dalek!specs.field_specs.u64_5_bounded.
  fuel%curve25519_dalek!specs.field_specs.fe51_limbs_bounded. fuel%curve25519_dalek!specs.field_specs.sum_of_limbs_bounded.
  fuel%curve25519_dalek!specs.field_specs.spec_add_fe51_limbs. fuel%curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.
  fuel%curve25519_dalek!specs.field_specs.field_add. fuel%curve25519_dalek!specs.field_specs_u64.p.
...
(declare-datatypes ((vstd!raw_ptr.PtrData. 0) (curve25519_dalek!backend.serial.u64.field.FieldElement51.
   0
  ) (curve25519_dalek!edwards.EdwardsPoint. 0) (tuple%0. 0)
...
(assert
 (=>
  ...
  (forall ((x! Int) (y! Int) (m! Int)) (!
    ...
    :qid user_vstd__arithmetic__div_mod__lemma_add_mod_noop_22
    :skolemid skolem_user_vstd__arithmetic__div_mod__lemma_add_mod_noop_22
))))
 ...
 (forall ((a! %%Function%%) (b! %%Function%%)) (!
   (= (req%curve25519_dalek!lemmas.field_lemmas.u64_5_as_nat_lemmas.lemma_u64_5_as_nat_add.
     ...
     (forall ((i$ Poly)) (!
       ...
       :qid user_curve25519_dalek__lemmas__field_lemmas__u64_5_as_nat_lemmas__lemma_u64_5_as_nat_add_27
       :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__u64_5_as_nat_lemmas__lemma_u64_5_as_nat_add_27
   ))))
...
;; Function-Specs curve25519_dalek::lemmas::field_lemmas::add_lemmas::lemma_field_element51_eq_from_limbs_eq
(declare-fun req%curve25519_dalek!lemmas.field_lemmas.add_lemmas.lemma_field_element51_eq_from_limbs_eq.
 (curve25519_dalek!backend.serial.u64.field.FieldElement51. curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 Bool
)
...
(assert
 (forall ((a! curve25519_dalek!backend.serial.u64.field.FieldElement51.) (b! curve25519_dalek!backend.serial.u64.field.FieldElement51.))
  (!
   (= (req%curve25519_dalek!lemmas.field_lemmas.add_lemmas.lemma_field_element51_eq_from_limbs_eq.
     a! b!
    ) (=>
     ...
     (forall ((i$ Poly)) (!
       ...
       :qid user_curve25519_dalek__lemmas__field_lemmas__add_lemmas__lemma_field_element51_eq_from_limbs_eq_42
       :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__add_lemmas__lemma_field_element51_eq_from_limbs_eq_42
   ))))
   :pattern ((req%curve25519_dalek!lemmas.field_lemmas.add_lemmas.lemma_field_element51_eq_from_limbs_eq.
     a! b!
   ))
   :qid internal_req__curve25519_dalek!lemmas.field_lemmas.add_lemmas.lemma_field_element51_eq_from_limbs_eq._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.field_lemmas.add_lemmas.lemma_field_element51_eq_from_limbs_eq._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.field_lemmas.add_lemmas.lemma_field_element51_eq_from_limbs_eq.
 (curve25519_dalek!backend.serial.u64.field.FieldElement51. curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 Bool
)
(assert
 (forall ((a! curve25519_dalek!backend.serial.u64.field.FieldElement51.) (b! curve25519_dalek!backend.serial.u64.field.FieldElement51.))
  (!
   (= (ens%curve25519_dalek!lemmas.field_lemmas.add_lemmas.lemma_field_element51_eq_from_limbs_eq.
     a! b!
    ) (= a! b!)
   )
   :pattern ((ens%curve25519_dalek!lemmas.field_lemmas.add_lemmas.lemma_field_element51_eq_from_limbs_eq.
     a! b!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.field_lemmas.add_lemmas.lemma_field_element51_eq_from_limbs_eq._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.field_lemmas.add_lemmas.lemma_field_element51_eq_from_limbs_eq._definition
)))

;; Function-Def curve25519_dalek::lemmas::field_lemmas::add_lemmas::lemma_field_element51_eq_from_limbs_eq
;; curve25519-dalek/src/lemmas/field_lemmas/add_lemmas.rs:53:1: 53:90 (#0)
(get-info :all-statistics)
(push)
 (declare-const a! curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const b! curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 ...
 (assert
  (forall ((i$ Poly)) (!
    ...
    :qid user_curve25519_dalek__lemmas__field_lemmas__add_lemmas__lemma_field_element51_eq_from_limbs_eq_43
    :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__add_lemmas__lemma_field_element51_eq_from_limbs_eq_43
 )))
 ;; assertion failed
 ...
 (assert
  (not (=>
    (= tmp%1 (ext_eq false (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
        (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
          a!
       )))
      ) (Poly%array%. (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
