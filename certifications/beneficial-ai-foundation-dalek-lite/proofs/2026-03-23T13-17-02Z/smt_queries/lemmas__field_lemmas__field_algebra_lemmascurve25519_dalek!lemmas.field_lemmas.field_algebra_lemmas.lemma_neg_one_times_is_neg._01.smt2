...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:1821:1: 1821:48 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_neg_one_times_is_neg
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:1821:1: 1821:48 (#0)
...
(push)
 ...
 (declare-const p@ Int)
 (declare-const neg_one@ Int)
 (declare-const neg_a@ Int)
 (declare-const a_mod_p@ Int)
 (assert
  fuel_defaults
 )
 (assert
  ...
  (not (=>
    ...
    (=>
     ...
     (=>
      ...
      (=>
       (= neg_a@ (curve25519_dalek!specs.field_specs.field_neg.? (I a!)))
       (=>
        (= a_mod_p@ (EucMod a! p@))
        (and
         (and
          ...
          (=>
           ...
           (=>
            ...
            (and
             (=>
              %%location_label%%1
              (req%vstd!arithmetic.div_mod.lemma_small_mod. tmp%1 p@)
             )
             (=>
              (ens%vstd!arithmetic.div_mod.lemma_small_mod. tmp%1 p@)
              (=>
               %%location_label%%2
               (= neg_one@ (Sub p@ 1))
         ))))))
          ...
          (and
           (=>
            ...
            (and
             (=>
              %%location_label%%3
              (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. tmp%2 a! p@)
             )
             (=>
              (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. tmp%2 a! p@)
              (=>
               %%location_label%%4
               (= (EucMod (Mul (Sub p@ 1) a!) p@) (EucMod (Mul (Sub p@ 1) a_mod_p@) p@))
           ))))
           (=>
            (= (EucMod (Mul (Sub p@ 1) a!) p@) (EucMod (Mul (Sub p@ 1) a_mod_p@) p@))
            (and
             (=>
              (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub_other_way. a_mod_p@ p@ 1)
              (=>
               %%location_label%%5
               (= (Mul (Sub p@ 1) a_mod_p@) (Sub (nClip (Mul p@ a_mod_p@)) a_mod_p@))
             ))
             (=>
              (= (Mul (Sub p@ 1) a_mod_p@) (Sub (nClip (Mul p@ a_mod_p@)) a_mod_p@))
              (and
                 ...
                 (and
                  (=>
                   ...
                   (and
                    (=>
                     %%location_label%%8
                     (req%vstd!arithmetic.div_mod.lemma_mod_self_0. p@)
                    )
                    (=>
                     (ens%vstd!arithmetic.div_mod.lemma_mod_self_0. p@)
                     (=>
                      (= tmp%3 (= neg_a@ 0))
                      (and
                       (=>
                       ...
                       (=>
                        ...
                        (and
                         (=>
                          (= tmp%4 (Sub p@ 1))
                          (=>
                           (ens%vstd!arithmetic.mul.lemma_mul_basics_2. tmp%4)
                           (=>
                            %%location_label%%10
                            (= (Mul (Sub p@ 1) a_mod_p@) 0)
                         )))
                         (=>
                          (= (Mul (Sub p@ 1) a_mod_p@) 0)
                          (and
                           (and
                            ...
                            (=>
                             ...
                             (=>
                              %%location_label%%12
                              (= (EucMod (Mul (Sub p@ 1) a_mod_p@) p@) 0)
                           )))
                           (=>
                            (= (EucMod (Mul (Sub p@ 1) a_mod_p@) p@) 0)
                            (and
                             (=>
                              (= tmp%5 (= neg_one@ (Sub p@ 1)))
                              (and
                               (=>
                                %%location_label%%13
                                tmp%5
                               ...
                               (=>
                                tmp%5
                                (=>
                                 (= tmp%6 (= (nClip (Mul neg_one@ a!)) (Mul (Sub p@ 1) a!)))
                                 (and
                                  (=>
                                   %%location_label%%14
                                   tmp%6
                                  ...
                                  (=>
                                   ...
                                   (=>
                                    ...
                                    (and
                                     (=>
                                      %%location_label%%15
                                      (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. tmp%7 a! p@)
                                     )
                                     (=>
                                      (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. tmp%7 a! p@)
                                      (=>
                                       (= tmp%8 (= a_mod_p@ 0))
                                       (and
                                        (=>
                                        ...
                                        (=>
                                         ...
                                         (=>
                                          (= tmp%9 (Sub p@ 1))
                                          (=>
                                           (ens%vstd!arithmetic.mul.lemma_mul_basics. tmp%9)
                                           (=>
                                            %%location_label%%17
                                            (= (EucMod (nClip (Mul neg_one@ a!)) p@) neg_a@)
                             )))))))))))))))
                             (=>
                              (= (EucMod (nClip (Mul neg_one@ a!)) p@) neg_a@)
                              %%switch_label%%0
                  ...
                  (=>
                   (not (= a_mod_p@ 0))
                   (=>
                    (= k@ (nClip (Sub a_mod_p@ 1)))
                    (=>
                     (= remainder@ (nClip (Sub p@ a_mod_p@)))
                     (and
                      (=>
                       (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub. p@ a_mod_p@ 1)
                       (=>
                        %%location_label%%18
                        (= (Sub (nClip (Mul p@ a_mod_p@)) a_mod_p@) (nClip (Add (nClip (Mul p@ k@)) remainder@)))
                      ))
                      (=>
                       (= (Sub (nClip (Mul p@ a_mod_p@)) a_mod_p@) (nClip (Add (nClip (Mul p@ k@)) remainder@)))
                       (=>
                        ...
                        (and
                         ...
                         (=>
                          ...
                          (and
                           (=>
                            %%location_label%%20
                            (req%vstd!arithmetic.div_mod.lemma_mod_multiples_vanish. k@ remainder@ p@)
                           )
                           (=>
                            (ens%vstd!arithmetic.div_mod.lemma_mod_multiples_vanish. k@ remainder@ p@)
                            (=>
                             (= tmp%11 (= (EucMod (nClip (Add (nClip (Mul p@ k@)) remainder@)) p@) (EucMod remainder@
                                p@
                             )))
                             (and
                              (=>
                              ...
                              (=>
                               ...
                               (and
                                (=>
                                 %%location_label%%22
                                 (req%vstd!arithmetic.div_mod.lemma_small_mod. remainder@ p@)
                                )
                                (=>
                                 (ens%vstd!arithmetic.div_mod.lemma_small_mod. remainder@ p@)
                                 (=>
                                  (= tmp%12 (= (EucMod remainder@ p@) remainder@))
                                  (and
                                   (=>
                                    %%location_label%%23
                                    tmp%12
                                   ...
                                   (=>
                                    ...
                                    (and
                                     (=>
                                      (= tmp%13 (nClip (Sub p@ a_mod_p@)))
                                      (and
                                       (=>
                                        %%location_label%%24
                                        (req%vstd!arithmetic.div_mod.lemma_small_mod. tmp%13 p@)
                                       )
                                       (=>
                                        (ens%vstd!arithmetic.div_mod.lemma_small_mod. tmp%13 p@)
                                        (=>
                                         %%location_label%%25
                                         (= neg_a@ remainder@)
                                     ))))
                                     (=>
                                      ...
                                      (and
                                       (=>
                                        (= tmp%14 (= (Mul (Sub p@ 1) a_mod_p@) (Sub (nClip (Mul p@ a_mod_p@)) a_mod_p@)))
                                        (and
                                         (=>
                                          %%location_label%%26
                                          tmp%14
                                         ...
                                         (=>
                                          tmp%14
                                          (=>
                                           (= tmp%15 (= (Sub (nClip (Mul p@ a_mod_p@)) a_mod_p@) (nClip (Add (nClip (Mul p@ k@))
                                               remainder@
                                           ))))
                                           (and
                                            (=>
                                            ...
                                            (=>
                                             ...
                                             (=>
                                              %%location_label%%28
                                              (= (EucMod (Mul (Sub p@ 1) a_mod_p@) p@) remainder@)
                                       )))))))
                                       (=>
                                        (= (EucMod (Mul (Sub p@ 1) a_mod_p@) p@) remainder@)
                                        (and
                                         (=>
                                          (= tmp%16 (= (nClip (Mul neg_one@ a!)) (Mul (Sub p@ 1) a!)))
                                          (and
                                           (=>
                                            %%location_label%%29
                                            tmp%16
                                           ...
                                           (=>
                                            ...
                                            (=>
                                             ...
                                             (and
                                              (=>
                                               %%location_label%%30
                                               (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. tmp%17 a! p@)
                                              )
                                              (=>
                                               (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. tmp%17 a! p@)
                                               (=>
                                                %%location_label%%31
                                                (= (EucMod (nClip (Mul neg_one@ a!)) p@) neg_a@)
                                         )))))))
