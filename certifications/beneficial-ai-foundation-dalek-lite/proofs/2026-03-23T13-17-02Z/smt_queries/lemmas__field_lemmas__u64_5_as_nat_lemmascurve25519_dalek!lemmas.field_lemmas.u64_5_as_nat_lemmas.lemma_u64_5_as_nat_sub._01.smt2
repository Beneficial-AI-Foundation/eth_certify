...
;; curve25519-dalek/src/lemmas/field_lemmas/u64_5_as_nat_lemmas.rs:102:1: 102:62 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::u64_5_as_nat_lemmas::lemma_u64_5_as_nat_sub
;; curve25519-dalek/src/lemmas/field_lemmas/u64_5_as_nat_lemmas.rs:102:1: 102:62 (#0)
...
(push)
 ...
 (assert
  (forall ((i$ Poly)) (!
    ...
    :qid user_curve25519_dalek__lemmas__field_lemmas__u64_5_as_nat_lemmas__lemma_u64_5_as_nat_sub_29
    :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__u64_5_as_nat_lemmas__lemma_u64_5_as_nat_sub_29
 )))
 ;; assertion failed
 ...
 (assert
  (not (=>
    (= c@ (%Poly%array%. (array_new $ (UINT 64) 5 (%%array%%0 (I (uClip 64 (Sub (%I (vstd!seq.Seq.index.?
    ...
    (and
     (=>
      (= tmp%1 (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 1 51)))))
      (=>
       ...
       (=>
        ...
        (=>
         (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub. tmp%1 tmp%2 tmp%3)
         (=>
          (= tmp%4 (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 2 51)))))
          (=>
           ...
           (=>
            ...
            (=>
             (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub. tmp%4 tmp%5 tmp%6)
             (=>
              (= tmp%7 (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 3 51)))))
              (=>
               ...
               (=>
                ...
                (=>
                 (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub. tmp%7 tmp%8 tmp%9)
                 (=>
                  (= tmp%10 (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 4 51)))))
                  (=>
                   ...
                   (=>
                    ...
                    (=>
                     (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub. tmp%10 tmp%11 tmp%12)
                     (=>
                      %%location_label%%0
                      (= (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. c@)) (Sub (
                         Add (Sub (Add (Sub (Add (Sub (Add (Sub (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                                   $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. a!)
                                  ) (I 0)
                                 )
                                ) (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $
                                 ...
                                 (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. b!)) (
                                  I 1
                              ))))
