...
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:2145:1: 2145:66 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::number_theory_lemmas::lemma_product_of_complements
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:2145:1: 2145:66 (#0)
...
(push)
 ...
 (declare-const p_minus_a@ Int)
 (declare-const p_minus_b@ Int)
 (declare-const k@ Int)
 (assert
  fuel_defaults
 )
     ...
     (=>
      ...
      (=>
       ...
       (=>
        ...
        (and
         (=>
          (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub. p_minus_b@ p_int@ a_int@)
          (=>
           (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub. p_int@ p_int@ b_int@)
           (=>
            (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub. a_int@ p_int@ b_int@)
            (=>
             (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. a_int@ p_int@)
             (=>
              (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub. p_int@ p_int@ b_int@)
              (=>
               (= tmp%1 (Sub p_int@ b_int@))
               (=>
                (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub. p_int@ tmp%1 a_int@)
                (=>
                 %%location_label%%0
                 (= (Mul p_minus_a@ p_minus_b@) (Add (Mul p_int@ (Sub (Sub p_int@ a_int@) b_int@)) (
                    Mul a_int@ b_int@
         )))))))))))
         (=>
          (= (Mul p_minus_a@ p_minus_b@) (Add (Mul p_int@ (Sub (Sub p_int@ a_int@) b_int@)) (
          ...
          (=>
           (= k@ (Sub (Sub p_int@ a_int@) b_int@))
           (and
            (=>
             (= tmp%2 (Mul a_int@ b_int@))
             (and
              (=>
               %%location_label%%1
               (req%vstd!arithmetic.div_mod.lemma_mod_multiples_vanish. k@ tmp%2 p_int@)
              )
              (=>
               (ens%vstd!arithmetic.div_mod.lemma_mod_multiples_vanish. k@ tmp%2 p_int@)
               (=>
                %%location_label%%2
                (= (EucMod (Add (Mul p_int@ k@) (Mul a_int@ b_int@)) p_int@) (EucMod (Mul a_int@ b_int@)
                  p_int@
            ))))))
            (=>
             (= (EucMod (Add (Mul p_int@ k@) (Mul a_int@ b_int@)) p_int@) (EucMod (Mul a_int@ b_int@)
             ...
             (=>
              %%location_label%%3
              (= (EucMod (nClip (Mul (Sub p! a!) (Sub p! b!))) p!) (EucMod (nClip (Mul a! b!)) p!))
 )))))))))))))
 (get-info :version)
