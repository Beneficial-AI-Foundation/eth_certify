...
;; curve25519-dalek/src/lemmas/field_lemmas/load8_lemmas.rs:457:1: 457:77 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::load8_lemmas::lemma_load8_shift_mod
;; curve25519-dalek/src/lemmas/field_lemmas/load8_lemmas.rs:457:1: 457:77 (#0)
(get-info :all-statistics)
(push)
 (declare-const input! slice%<u8.>.)
 (declare-const i! Int)
 (declare-const s64! Int)
 (declare-const t! Int)
 (declare-const j@ Int)
 ...
 (declare-const y@ Int)
 (declare-const s@ Int)
 (declare-const ps64@ Int)
 (declare-const pt64@ Int)
 (declare-const z@ Int)
 ...
 (declare-const s0_0@ Int)
 (declare-const s0@ Int)
 (declare-const s1_0@ Int)
 (declare-const s1@ Int)
 (declare-const s2_0@ Int)
 (declare-const s2@ Int)
 (declare-const s3_0@ Int)
 (declare-const s3@ Int)
 (declare-const s4_0@ Int)
 (declare-const s4@ Int)
 (declare-const s5_0@ Int)
 (declare-const s5@ Int)
 (declare-const s6_0@ Int)
 (declare-const s6@ Int)
 (declare-const s7_0@ Int)
 ...
 (assert
  (not (=>
    (= x@ (uClip 64 (curve25519_dalek!specs.core_specs.spec_load8_at.? (Poly%slice%<u8.>.
        input!
       ) (I i!)
    )))
    (=>
     (= y@ (curve25519_dalek!lemmas.field_lemmas.load8_lemmas.load8_at_plus_version_rec.?
       (Poly%slice%<u8.>. input!) (I i!) (I 7)
     ))
     (=>
      (= s@ s64!)
      (=>
       (= ps64@ (uClip 64 (vstd!arithmetic.power2.pow2.? (I s@))))
       (and
        (=>
         (ens%vstd!arithmetic.power2.lemma_pow2_pos. s@)
         (and
          (=>
           %%location_label%%0
           (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_u64_pow2_le_max. s@)
          )
          (=>
           (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_u64_pow2_le_max. s@)
           (=>
            %%location_label%%1
            (let
             ((tmp%%$ (vstd!arithmetic.power2.pow2.? (I s@))))
        ...
        (=>
         ...
         (and
          (and
           (=>
            %%location_label%%2
            (req%vstd!bits.lemma_u64_shr_is_div. x@ s64!)
           )
           (=>
            (ens%vstd!bits.lemma_u64_shr_is_div. x@ s64!)
            (=>
             %%location_label%%3
             (= (uClip 64 (bitshr (I x@) (I s64!))) (EucDiv x@ ps64@))
          )))
          (=>
           (= (uClip 64 (bitshr (I x@) (I s64!))) (EucDiv x@ ps64@))
           (and
             ...
             (and
              (=>
               ...
               (=>
                (<= j@ 7)
                (=>
                 (= tmp%1 (= (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul j@ 8)))) (%I (vstd!seq.Seq.index.?
                      $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $ (UINT 8)) (Poly%slice%<u8.>. input!))
                      (I (Add i! j@))
                    ))
                   ) (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $ (UINT
              ...
              (=>
               (forall ((j$ Int)) (!
                 ...
                 :pattern ((vstd!arithmetic.power2.pow2.? (I (nClip (Mul j$ 8)))))
                 :qid user_curve25519_dalek__lemmas__field_lemmas__load8_lemmas__lemma_load8_shift_mod_84
                 :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__load8_lemmas__lemma_load8_shift_mod_84
               ))
               (and
                (and
                 (=>
                           ...
                           (=>
                            ...
                            (and
                             ...
                             (=>
                              ...
                              (and
                               (=>
                                (= tmp%4 (= (curve25519_dalek!lemmas.field_lemmas.load8_lemmas.load8_at_plus_version_rec.?
                                 ...
                                 (=>
                                  ...
                                  (and
                                   (=>
                                    ...
                                    (=>
                                     %%location_label%%16
                                     (= (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 0 8)))) 1)
                                   ))
                                   (=>
                                    (= (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 0 8)))) 1)
                                    (and
                                     (=>
                                      (= tmp%5 (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $ (
                                            UINT 8
                                           )
                                          ) (Poly%slice%<u8.>. input!)
                                         ) (I i!)
                                      ...
                                      (=>
                                       (ens%vstd!arithmetic.mul.lemma_mul_basics_4. tmp%5)
                                       (=>
                                        %%location_label%%17
                                        (= (uClip 64 (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 0 8)))) (%I (vstd!seq.Seq.index.?
                                             $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $ (UINT 8)) (Poly%slice%<u8.>. input!))
                                             (I (Add i! 0))
                                          )))
                                         ) (uClip 64 (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $slice (SLICE
                               ...
                               (=>
                                ...
                                (=>
                                 %%location_label%%19
                                 (= (EucDiv y@ ps64@) (Add (Add (Add (Add (Add (Add (Add (EucDiv (uClip 64 (Mul (vstd!arithmetic.power2.pow2.?
                                             (I (nClip (Mul 0 8)))
                                            ) (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $ (UINT 8))
                                               (Poly%slice%<u8.>. input!)
                                              ) (I (Add i! 0))
                                         ...
                                         ) (EucDiv (uClip 64 (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 1 8)))) (%I (vstd!seq.Seq.index.?
                                              $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $ (UINT 8)) (Poly%slice%<u8.>. input!))
                                              (I (Add i! 1))
                                           )))
                                          ) ps64@
                                         )
                                        ) (EucDiv (uClip 64 (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 2 8)))) (%I (vstd!seq.Seq.index.?
                                             $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $ (UINT 8)) (Poly%slice%<u8.>. input!))
                                             (I (Add i! 2))
                                          )))
                                         ) ps64@
                                        )
                                       ) (EucDiv (uClip 64 (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 3 8)))) (%I (vstd!seq.Seq.index.?
                                            $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $ (UINT 8)) (Poly%slice%<u8.>. input!))
                                            (I (Add i! 3))
                                         )))
                                        ) ps64@
                                       )
                                      ) (EucDiv (uClip 64 (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 4 8)))) (%I (vstd!seq.Seq.index.?
                                           $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $ (UINT 8)) (Poly%slice%<u8.>. input!))
                                           (I (Add i! 4))
                                        )))
                                       ) ps64@
                                      )
                                     ) (EucDiv (uClip 64 (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 5 8)))) (%I (vstd!seq.Seq.index.?
                                          $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $ (UINT 8)) (Poly%slice%<u8.>. input!))
                                          (I (Add i! 5))
                                       )))
                                      ) ps64@
                                     )
                                    ) (EucDiv (uClip 64 (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 6 8)))) (%I (vstd!seq.Seq.index.?
                                         $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $ (UINT 8)) (Poly%slice%<u8.>. input!))
                                         (I (Add i! 6))
                                      )))
                                     ) ps64@
                                    )
                                   ) (EucDiv (uClip 64 (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 7 8)))) (%I (vstd!seq.Seq.index.?
                                        $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $ (UINT 8)) (Poly%slice%<u8.>. input!))
                                        (I (Add i! 7))
                                     )))
                                    ) ps64@
                ...
                (=>
                 ...
                 (=>
                  (= pt64@ (uClip 64 (vstd!arithmetic.power2.pow2.? (I t!))))
                  (=>
                   (= z@ (EucDiv y@ ps64@))
                   (and
                    (and
                     ...
                     (=>
                      ...
                      (=>
                       %%location_label%%21
                       (<= (vstd!bits.low_bits_mask.? (I t!)) 18446744073709551615)
                    )))
                    (=>
                     (<= (vstd!bits.low_bits_mask.? (I t!)) 18446744073709551615)
                     (and
                      (and
                       (=>
                        %%location_label%%22
                        (req%vstd!bits.lemma_u64_low_bits_mask_is_mod. z@ t!)
                       )
                       (=>
                        (ens%vstd!bits.lemma_u64_low_bits_mask_is_mod. z@ t!)
                        (=>
                         %%location_label%%23
                         (= (uClip 64 (bitand (I z@) (I (uClip 64 (vstd!bits.low_bits_mask.? (I t!)))))) (EucMod
                           z@ pt64@
                      )))))
                      (=>
                       (= (uClip 64 (bitand (I z@) (I (uClip 64 (vstd!bits.low_bits_mask.? (I t!)))))) (EucMod
                       ...
                       (and
                        (=>
                         ...
                         (=>
                          ...
                          (=>
                           (= tmp%6 (nClip (Mul j$1@ 8)))
                           (=>
                            (ens%vstd!arithmetic.power2.lemma_pow2_pos. tmp%6)
                            (=>
                             %%location_label%%24
                             (> (vstd!arithmetic.power2.pow2.? (I (nClip (Mul j$1@ 8)))) 0)
                        )))))
                        (=>
                         (forall ((j$ Int)) (!
                           (=>
                            ...
                            (=>
                             ...
                             (> (vstd!arithmetic.power2.pow2.? (I (nClip (Mul j$ 8)))) 0)
                           ))
                           :pattern ((vstd!arithmetic.power2.pow2.? (I (nClip (Mul j$ 8)))))
                           :qid user_curve25519_dalek__lemmas__field_lemmas__load8_lemmas__lemma_load8_shift_mod_91
                           :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__load8_lemmas__lemma_load8_shift_mod_91
                         ))
                         (and
                          (=>
                           (<= 0 j$2@)
                           (=>
                            ...
                            (and
                             (=>
                              (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. 8 j$2@ 1)
                              (=>
                               %%location_label%%25
                               (= (nClip (Add (nClip (Mul j$2@ 8)) 8)) (nClip (Mul (nClip (Add j$2@ 1)) 8)))
                             ))
                             (=>
                              (= (nClip (Add (nClip (Mul j$2@ 8)) 8)) (nClip (Mul (nClip (Add j$2@ 1)) 8)))
                              (=>
                               (= tmp%7 (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $ (
                                     UINT 8
                                    )
                                   ) (Poly%slice%<u8.>. input!)
                                  ) (I (Add i! j$2@))
                               ...
                               (=>
                                (= tmp%8 (nClip (Mul j$2@ 8)))
                                (=>
                                 (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_u8_pow2_mul_bound. tmp%7
                                  tmp%8
                                 )
                                 (=>
                                  %%location_label%%26
                                  (<= (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul j$2@ 8)))) (%I (vstd!seq.Seq.index.?
                                      $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $ (UINT 8)) (Poly%slice%<u8.>. input!))
                                      (I (Add i! j$2@))
                                    ))
                                   ) (Sub (vstd!arithmetic.power2.pow2.? (I (nClip (Mul (nClip (Add j$2@ 1)) 8)))) (vstd!arithmetic.power2.pow2.?
                                     (I (nClip (Mul j$2@ 8)))
                          )))))))))))
                          (=>
                           (forall ((j$ Int)) (!
                             (=>
                              ...
                              (=>
                               ...
                               (<= (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul j$ 8)))) (%I (vstd!seq.Seq.index.?
                                ...
                                ) (Sub (vstd!arithmetic.power2.pow2.? (I (nClip (Mul (nClip (Add j$ 1)) 8)))) (vstd!arithmetic.power2.pow2.?
                                  (I (nClip (Mul j$ 8)))
                             )))))
                             :pattern ((Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul j$ 8)))) (%I (vstd!seq.Seq.index.?
                                 $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $ (UINT 8)) (Poly%slice%<u8.>. input!))
                                 (I (Add i! j$))
                             ))))
                             :qid user_curve25519_dalek__lemmas__field_lemmas__load8_lemmas__lemma_load8_shift_mod_93
                             :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__load8_lemmas__lemma_load8_shift_mod_93
                           ))
                           (=>
                            (ens%vstd!arithmetic.power2.lemma2_to64. 0)
                            (=>
                             ...
                             (and
                              (=>
                               (ens%vstd!arithmetic.power2.lemma_pow2_pos. t!)
                               (and
                                (=>
                                 %%location_label%%27
                                 (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_u64_pow2_le_max. t!)
                                )
                                (=>
                                 (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_u64_pow2_le_max. t!)
                                 (=>
                                  %%location_label%%28
                                  (let
                                   ((tmp%%$ (vstd!arithmetic.power2.pow2.? (I t!))))
                               ...
                               (and
                                (=>
                                 ...
                                 (=>
                                  ...
                                  (=>
                                   (= tmp%9 (vstd!arithmetic.power2.pow2.? (I (nClip (Mul j$3@ 8)))))
                                   (=>
                                    (= tmp%10 (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $
                                         (UINT 8)
                                        ) (Poly%slice%<u8.>. input!)
                                       ) (I (Add i! j$3@))
                                    )))
                                    (=>
                                     (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. tmp%9 tmp%10)
                                     (=>
                                      %%location_label%%29
                                      (= (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul j$3@ 8)))) (%I (vstd!seq.Seq.index.?
                                          $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $ (UINT 8)) (Poly%slice%<u8.>. input!))
                                          (I (Add i! j$3@))
                                        ))
                                       ) (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $ (UINT
                                        ...
                                        ) (vstd!arithmetic.power2.pow2.? (I (nClip (Mul j$3@ 8))))
                                ))))))))
                                (=>
                                 (forall ((j$ Int)) (!
                                   (=>
                                   ...
                                   :pattern ((vstd!arithmetic.power2.pow2.? (I (nClip (Mul j$ 8)))) (vstd!seq.Seq.index.?
                                     $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $ (UINT 8)) (Poly%slice%<u8.>. input!))
                                     (I (Add i! j$))
                                   ))
                                   :qid user_curve25519_dalek__lemmas__field_lemmas__load8_lemmas__lemma_load8_shift_mod_95
                                   :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__load8_lemmas__lemma_load8_shift_mod_95
                                 ))
                                 (and
                                  (=>
                                   (<= 0 j$4@)
                                   (=>
                                    ...
                                    (and
                                     (=>
                                      (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. 8 j$4@ 1)
                                      (=>
                                       %%location_label%%30
                                       (= (nClip (Add (nClip (Mul j$4@ 8)) 8)) (nClip (Mul (nClip (Add j$4@ 1)) 8)))
                                     ))
                                     (=>
                                      (= (nClip (Add (nClip (Mul j$4@ 8)) 8)) (nClip (Mul (nClip (Add j$4@ 1)) 8)))
                                      (=>
                                       (= tmp%11 (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $
                                            (UINT 8)
                                           ) (Poly%slice%<u8.>. input!)
                                          ) (I (Add i! j$4@))
                                       )))
                                       (=>
                                        (= tmp%12 (nClip (Mul j$4@ 8)))
                                        (=>
                                         (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_u8_pow2_mul_bound. tmp%11
                                          tmp%12
                                         )
                                         (and
                                          (=>
                                           (= tmp%13 (nClip (Mul j$4@ 8)))
                                           (=>
                                            (= tmp%14 (nClip (Add (nClip (Mul j$4@ 8)) 8)))
                                            (and
                                             (=>
                                              %%location_label%%31
                                              (req%vstd!arithmetic.power2.lemma_pow2_strictly_increases. tmp%13 tmp%14)
                                             )
                                             (=>
                                              (ens%vstd!arithmetic.power2.lemma_pow2_strictly_increases. tmp%13 tmp%14)
                                              (=>
                                               %%location_label%%32
                                               (> (vstd!arithmetic.power2.pow2.? (I (nClip (Mul (nClip (Add j$4@ 1)) 8)))) (vstd!arithmetic.power2.pow2.?
                                                 (I (nClip (Mul j$4@ 8)))
                                          )))))))
                                          (=>
                                           (> (vstd!arithmetic.power2.pow2.? (I (nClip (Mul (nClip (Add j$4@ 1)) 8)))) (vstd!arithmetic.power2.pow2.?
                                           ...
                                           (=>
                                            %%location_label%%33
                                            (and
                                             (<= (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul j$4@ 8)))) (%I (vstd!seq.Seq.index.?
                                                 $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $ (UINT 8)) (Poly%slice%<u8.>. input!))
                                                 (I (Add i! j$4@))
                                               ))
                                              ) (Sub (vstd!arithmetic.power2.pow2.? (I (nClip (Mul (nClip (Add j$4@ 1)) 8)))) (vstd!arithmetic.power2.pow2.?
                                                (I (nClip (Mul j$4@ 8)))
                                             )))
                                             (> (vstd!arithmetic.power2.pow2.? (I (nClip (Mul (nClip (Add j$4@ 1)) 8)))) (vstd!arithmetic.power2.pow2.?
                                               (I (nClip (Mul j$4@ 8)))
                                  ...
                                  (=>
                                   (forall ((j$ Int)) (!
                                     (=>
                                      ...
                                      (=>
                                       ...
                                       (and
                                        ...
                                        (> (vstd!arithmetic.power2.pow2.? (I (nClip (Mul (nClip (Add j$ 1)) 8)))) (vstd!arithmetic.power2.pow2.?
                                          (I (nClip (Mul j$ 8)))
                                     )))))
                                     :pattern ((Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul j$ 8)))) (%I (vstd!seq.Seq.index.?
                                         $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $ (UINT 8)) (Poly%slice%<u8.>. input!))
                                     ...
                                     :qid user_curve25519_dalek__lemmas__field_lemmas__load8_lemmas__lemma_load8_shift_mod_98
                                     :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__load8_lemmas__lemma_load8_shift_mod_98
                                   ))
                                   (=>
                                    (= a0@ (uClip 64 (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 0 8)))) (%I (vstd!seq.Seq.index.?
                                         $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $ (UINT 8)) (Poly%slice%<u8.>. input!))
                                         (I (Add i! 0))
                                    )))))
                                    (=>
                                     (= a1@ (uClip 64 (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 1 8)))) (%I (vstd!seq.Seq.index.?
                                          $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $ (UINT 8)) (Poly%slice%<u8.>. input!))
                                          (I (Add i! 1))
                                     )))))
                                     (=>
                                      (= a2@ (uClip 64 (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 2 8)))) (%I (vstd!seq.Seq.index.?
                                           $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $ (UINT 8)) (Poly%slice%<u8.>. input!))
                                           (I (Add i! 2))
                                      )))))
                                      (=>
                                       (= a3@ (uClip 64 (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 3 8)))) (%I (vstd!seq.Seq.index.?
                                            $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $ (UINT 8)) (Poly%slice%<u8.>. input!))
                                            (I (Add i! 3))
                                       )))))
                                       (=>
                                        (= a4@ (uClip 64 (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 4 8)))) (%I (vstd!seq.Seq.index.?
                                             $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $ (UINT 8)) (Poly%slice%<u8.>. input!))
                                             (I (Add i! 4))
                                        )))))
                                        (=>
                                         (= a5@ (uClip 64 (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 5 8)))) (%I (vstd!seq.Seq.index.?
                                              $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $ (UINT 8)) (Poly%slice%<u8.>. input!))
                                              (I (Add i! 5))
                                         )))))
                                         (=>
                                          (= a6@ (uClip 64 (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 6 8)))) (%I (vstd!seq.Seq.index.?
                                               $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $ (UINT 8)) (Poly%slice%<u8.>. input!))
                                               (I (Add i! 6))
                                          )))))
                                          (=>
                                           (= a7@ (uClip 64 (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 7 8)))) (%I (vstd!seq.Seq.index.?
                                                $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $ (UINT 8)) (Poly%slice%<u8.>. input!))
                                                (I (Add i! 7))
                                           )))))
                                           (=>
                                            (= tmp%15 (= a0@ (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $slice
                                            ...
                                            (and
                                             ...
                                             (=>
                                              tmp%15
                                              (=>
                                               (= tmp%16 (= a1@ (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $slice
                                                     (SLICE $ (UINT 8)) (Poly%slice%<u8.>. input!)
                                                    ) (I (Add i! 1))
                                                   )
                                               ...
                                               (and
                                                ...
                                                (=>
                                                 tmp%16
                                                 (=>
                                                  (= tmp%17 (= a2@ (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $slice
                                                        (SLICE $ (UINT 8)) (Poly%slice%<u8.>. input!)
                                                       ) (I (Add i! 2))
                                                      )
                                                  ...
                                                  (and
                                                   ...
                                                   (=>
                                                    tmp%17
                                                    (=>
                                                     (= tmp%18 (= a3@ (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $slice
                                                           (SLICE $ (UINT 8)) (Poly%slice%<u8.>. input!)
                                                          ) (I (Add i! 3))
                                                         )
                                                     ...
                                                     (and
                                                      ...
                                                      (=>
                                                       tmp%18
                                                       (=>
                                                        (= tmp%19 (= a4@ (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $slice
                                                              (SLICE $ (UINT 8)) (Poly%slice%<u8.>. input!)
                                                             ) (I (Add i! 4))
                                                            )
                                                        ...
                                                        (and
                                                         ...
                                                         (=>
                                                          tmp%19
                                                          (=>
                                                           (= tmp%20 (= a5@ (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $slice
                                                                 (SLICE $ (UINT 8)) (Poly%slice%<u8.>. input!)
                                                                ) (I (Add i! 5))
                                                               )
                                                           ...
                                                           (and
                                                            ...
                                                            (=>
                                                             tmp%20
                                                             (=>
                                                              (= tmp%21 (= a6@ (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $slice
                                                                    (SLICE $ (UINT 8)) (Poly%slice%<u8.>. input!)
                                                                   ) (I (Add i! 6))
                                                                  )
                                                              ...
                                                              (and
                                                               ...
                                                               (=>
                                                                tmp%21
                                                                (=>
                                                                 (= tmp%22 (= a7@ (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $slice
                                                                       (SLICE $ (UINT 8)) (Poly%slice%<u8.>. input!)
                                                                      ) (I (Add i! 7))
                                                                     )
                                                                  ...
                                                                  (=>
                                                                   ...
                                                                   (=>
                                                                    ...
                                                                    (=>
                                                                     (= s0@ (EucDiv s0_0@ ps64@))
                                                                     (=>
                                                                      (= tmp%23 (< s0_0@ (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 1 8))))))
                                                                      (and
                                                                       (=>
                                                                        %%location_label%%42
                                                                        tmp%23
                                                                       ...
                                                                       (=>
                                                                        tmp%23
                                                                        (=>
                                                                         (= tmp%24 (<= (Add s0_0@ a1@) 18446744073709551615))
                                                                         (and
                                                                          (=>
                                                                           %%location_label%%43
                                                                           tmp%24
                                                                          ...
                                                                          (=>
                                                                           tmp%24
                                                                           (=>
                                                                            (= s1_0@ (uClip 64 (Add s0_0@ a1@)))
                                                                            (=>
                                                                             (= s1@ (EucDiv s1_0@ ps64@))
                                                                             (=>
                                                                              (= tmp%25 (< s1_0@ (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 2 8))))))
                                                                              (and
                                                                               (=>
                                                                                %%location_label%%44
                                                                                tmp%25
                                                                               ...
                                                                               (=>
                                                                                ...
                                                                                (and
                                                                                 (=>
                                                                                  (= tmp%26 (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $
                                                                                       (UINT 8)
                                                                                      ) (Poly%slice%<u8.>. input!)
                                                                                     ) (I (Add i! 1))
                                                                                  )))
                                                                                  (=>
                                                                                   (= tmp%27 (nClip (Mul 1 8)))
                                                                                   (and
                                                                                    (=>
                                                                                     %%location_label%%45
                                                                                     (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_binary_sum_div_decomposition.
                                                                                      s0_0@ tmp%26 tmp%27 s@
                                                                                    ))
                                                                                    (=>
                                                                                     (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_binary_sum_div_decomposition.
                                                                                      s0_0@ tmp%26 tmp%27 s@
                                                                                     ...
                                                                                     (=>
                                                                                      %%location_label%%46
                                                                                      (= s1@ (Add (EucDiv s0_0@ ps64@) (EucDiv a1@ ps64@)))
                                                                                 )))))
                                                                                 (=>
                                                                                  (= s1@ (Add (EucDiv s0_0@ ps64@) (EucDiv a1@ ps64@)))
                                                                                  (=>
                                                                                   (= tmp%28 (<= (Add s1_0@ a2@) 18446744073709551615))
                                                                                   (and
                                                                                    (=>
                                                                                     %%location_label%%47
                                                                                     tmp%28
                                                                                    ...
                                                                                    (=>
                                                                                     tmp%28
                                                                                     (=>
                                                                                      (= s2_0@ (uClip 64 (Add s1_0@ a2@)))
                                                                                      (=>
                                                                                       (= s2@ (EucDiv s2_0@ ps64@))
                                                                                       (=>
                                                                                        (= tmp%29 (< s2_0@ (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 3 8))))))
                                                                                        (and
                                                                                         (=>
                                                                                          %%location_label%%48
                                                                                          tmp%29
                                                                                         ...
                                                                                         (=>
                                                                                          ...
                                                                                          (and
                                                                                           (=>
                                                                                            (= tmp%30 (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $
                                                                                                 (UINT 8)
                                                                                                ) (Poly%slice%<u8.>. input!)
                                                                                               ) (I (Add i! 2))
                                                                                            )))
                                                                                            (=>
                                                                                             (= tmp%31 (nClip (Mul 2 8)))
                                                                                             (and
                                                                                              (=>
                                                                                               %%location_label%%49
                                                                                               (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_binary_sum_div_decomposition.
                                                                                                s1_0@ tmp%30 tmp%31 s@
                                                                                              ))
                                                                                              (=>
                                                                                               (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_binary_sum_div_decomposition.
                                                                                                s1_0@ tmp%30 tmp%31 s@
                                                                                               ...
                                                                                               (=>
                                                                                                %%location_label%%50
                                                                                                (= s2@ (Add (EucDiv s1_0@ ps64@) (EucDiv a2@ ps64@)))
                                                                                           )))))
                                                                                           (=>
                                                                                            (= s2@ (Add (EucDiv s1_0@ ps64@) (EucDiv a2@ ps64@)))
                                                                                            (=>
                                                                                             (= tmp%32 (<= (Add s2_0@ a3@) 18446744073709551615))
                                                                                             (and
                                                                                              (=>
                                                                                               %%location_label%%51
                                                                                               tmp%32
                                                                                              ...
                                                                                              (=>
                                                                                               tmp%32
                                                                                               (=>
                                                                                                (= s3_0@ (uClip 64 (Add s2_0@ a3@)))
                                                                                                (=>
                                                                                                 (= s3@ (EucDiv s3_0@ ps64@))
                                                                                                 (=>
                                                                                                  (= tmp%33 (< s3_0@ (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 4 8))))))
                                                                                                  (and
                                                                                                   (=>
                                                                                                    %%location_label%%52
                                                                                                    tmp%33
                                                                                                   ...
                                                                                                   (=>
                                                                                                    ...
                                                                                                    (and
                                                                                                     (=>
                                                                                                      (= tmp%34 (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $
                                                                                                           (UINT 8)
                                                                                                          ) (Poly%slice%<u8.>. input!)
                                                                                                         ) (I (Add i! 3))
                                                                                                      )))
                                                                                                      (=>
                                                                                                       (= tmp%35 (nClip (Mul 3 8)))
                                                                                                       (and
                                                                                                        (=>
                                                                                                         %%location_label%%53
                                                                                                         (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_binary_sum_div_decomposition.
                                                                                                          s2_0@ tmp%34 tmp%35 s@
                                                                                                        ))
                                                                                                        (=>
                                                                                                         (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_binary_sum_div_decomposition.
                                                                                                          s2_0@ tmp%34 tmp%35 s@
                                                                                                         ...
                                                                                                         (=>
                                                                                                          %%location_label%%54
                                                                                                          (= s3@ (Add (EucDiv s2_0@ ps64@) (EucDiv a3@ ps64@)))
                                                                                                     )))))
                                                                                                     (=>
                                                                                                      (= s3@ (Add (EucDiv s2_0@ ps64@) (EucDiv a3@ ps64@)))
                                                                                                      (=>
                                                                                                       (= tmp%36 (<= (Add s3_0@ a4@) 18446744073709551615))
                                                                                                       (and
                                                                                                        (=>
                                                                                                         %%location_label%%55
                                                                                                         tmp%36
                                                                                                        ...
                                                                                                        (=>
                                                                                                         tmp%36
                                                                                                         (=>
                                                                                                          (= s4_0@ (uClip 64 (Add s3_0@ a4@)))
                                                                                                          (=>
                                                                                                           (= s4@ (EucDiv s4_0@ ps64@))
                                                                                                           (=>
                                                                                                            (= tmp%37 (< s4_0@ (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 5 8))))))
                                                                                                            (and
                                                                                                             (=>
                                                                                                              %%location_label%%56
                                                                                                              tmp%37
                                                                                                             ...
                                                                                                             (=>
                                                                                                              ...
                                                                                                              (and
                                                                                                               (=>
                                                                                                                (= tmp%38 (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $
                                                                                                                     (UINT 8)
                                                                                                                    ) (Poly%slice%<u8.>. input!)
                                                                                                                   ) (I (Add i! 4))
                                                                                                                )))
                                                                                                                (=>
                                                                                                                 (= tmp%39 (nClip (Mul 4 8)))
                                                                                                                 (and
                                                                                                                  (=>
                                                                                                                   %%location_label%%57
                                                                                                                   (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_binary_sum_div_decomposition.
                                                                                                                    s3_0@ tmp%38 tmp%39 s@
                                                                                                                  ))
                                                                                                                  (=>
                                                                                                                   (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_binary_sum_div_decomposition.
                                                                                                                    s3_0@ tmp%38 tmp%39 s@
                                                                                                                   ...
                                                                                                                   (=>
                                                                                                                    %%location_label%%58
                                                                                                                    (= s4@ (Add (EucDiv s3_0@ ps64@) (EucDiv a4@ ps64@)))
                                                                                                               )))))
                                                                                                               (=>
                                                                                                                (= s4@ (Add (EucDiv s3_0@ ps64@) (EucDiv a4@ ps64@)))
                                                                                                                (=>
                                                                                                                 (= tmp%40 (<= (Add s4_0@ a5@) 18446744073709551615))
                                                                                                                 (and
                                                                                                                  (=>
                                                                                                                   %%location_label%%59
                                                                                                                   tmp%40
                                                                                                                  ...
                                                                                                                  (=>
                                                                                                                   tmp%40
                                                                                                                   (=>
                                                                                                                    (= s5_0@ (uClip 64 (Add s4_0@ a5@)))
                                                                                                                    (=>
                                                                                                                     (= s5@ (EucDiv s5_0@ ps64@))
                                                                                                                     (=>
                                                                                                                      (= tmp%41 (< s5_0@ (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 6 8))))))
                                                                                                                      (and
                                                                                                                       (=>
                                                                                                                        %%location_label%%60
                                                                                                                        tmp%41
                                                                                                                       ...
                                                                                                                       (=>
                                                                                                                        ...
                                                                                                                        (and
                                                                                                                         (=>
                                                                                                                          (= tmp%42 (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $
                                                                                                                               (UINT 8)
                                                                                                                              ) (Poly%slice%<u8.>. input!)
                                                                                                                             ) (I (Add i! 5))
                                                                                                                          )))
                                                                                                                          (=>
                                                                                                                           (= tmp%43 (nClip (Mul 5 8)))
                                                                                                                           (and
                                                                                                                            (=>
                                                                                                                             %%location_label%%61
                                                                                                                             (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_binary_sum_div_decomposition.
                                                                                                                              s4_0@ tmp%42 tmp%43 s@
                                                                                                                            ))
                                                                                                                            (=>
                                                                                                                             (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_binary_sum_div_decomposition.
                                                                                                                              s4_0@ tmp%42 tmp%43 s@
                                                                                                                             ...
                                                                                                                             (=>
                                                                                                                              %%location_label%%62
                                                                                                                              (= s5@ (Add (EucDiv s4_0@ ps64@) (EucDiv a5@ ps64@)))
                                                                                                                         )))))
                                                                                                                         (=>
                                                                                                                          (= s5@ (Add (EucDiv s4_0@ ps64@) (EucDiv a5@ ps64@)))
                                                                                                                          (=>
                                                                                                                           (= tmp%44 (<= (Add s5_0@ a6@) 18446744073709551615))
                                                                                                                           (and
                                                                                                                            (=>
                                                                                                                             %%location_label%%63
                                                                                                                             tmp%44
                                                                                                                            ...
                                                                                                                            (=>
                                                                                                                             tmp%44
                                                                                                                             (=>
                                                                                                                              (= s6_0@ (uClip 64 (Add s5_0@ a6@)))
                                                                                                                              (=>
                                                                                                                               (= s6@ (EucDiv s6_0@ ps64@))
                                                                                                                               (=>
                                                                                                                                (= tmp%45 (< s6_0@ (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 7 8))))))
                                                                                                                                (and
                                                                                                                                 (=>
                                                                                                                                  %%location_label%%64
                                                                                                                                  tmp%45
                                                                                                                                 ...
                                                                                                                                 (=>
                                                                                                                                  ...
                                                                                                                                  (and
                                                                                                                                   (=>
                                                                                                                                    (= tmp%46 (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $
                                                                                                                                         (UINT 8)
                                                                                                                                        ) (Poly%slice%<u8.>. input!)
                                                                                                                                       ) (I (Add i! 6))
                                                                                                                                    )))
                                                                                                                                    (=>
                                                                                                                                     (= tmp%47 (nClip (Mul 6 8)))
                                                                                                                                     (and
                                                                                                                                      (=>
                                                                                                                                       %%location_label%%65
                                                                                                                                       (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_binary_sum_div_decomposition.
                                                                                                                                        s5_0@ tmp%46 tmp%47 s@
                                                                                                                                      ))
                                                                                                                                      (=>
                                                                                                                                       (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_binary_sum_div_decomposition.
                                                                                                                                        s5_0@ tmp%46 tmp%47 s@
                                                                                                                                       ...
                                                                                                                                       (=>
                                                                                                                                        %%location_label%%66
                                                                                                                                        (= s6@ (Add (EucDiv s5_0@ ps64@) (EucDiv a6@ ps64@)))
                                                                                                                                   )))))
                                                                                                                                   (=>
                                                                                                                                    (= s6@ (Add (EucDiv s5_0@ ps64@) (EucDiv a6@ ps64@)))
                                                                                                                                    (=>
                                                                                                                                     (= tmp%48 (<= (Add s6_0@ a7@) 18446744073709551615))
                                                                                                                                     (and
                                                                                                                                      (=>
                                                                                                                                       %%location_label%%67
                                                                                                                                       tmp%48
                                                                                                                                      ...
                                                                                                                                      (=>
                                                                                                                                       tmp%48
                                                                                                                                       (=>
                                                                                                                                        (= s7_0@ (uClip 64 (Add s6_0@ a7@)))
                                                                                                                                        (=>
                                                                                                                                         (= s7@ (EucDiv s7_0@ ps64@))
                                                                                                                                         (and
                                                                                                                                          (=>
                                                                                                                                           (= tmp%49 (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $
                                                                                                                                                (UINT 8)
                                                                                                                                               ) (Poly%slice%<u8.>. input!)
                                                                                                                                              ) (I (Add i! 7))
                                                                                                                                           )))
                                                                                                                                           (=>
                                                                                                                                            (= tmp%50 (nClip (Mul 7 8)))
                                                                                                                                            (and
                                                                                                                                             (=>
                                                                                                                                              %%location_label%%68
                                                                                                                                              (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_binary_sum_div_decomposition.
                                                                                                                                               s6_0@ tmp%49 tmp%50 s@
                                                                                                                                             ))
                                                                                                                                             (=>
                                                                                                                                              (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_binary_sum_div_decomposition.
                                                                                                                                               s6_0@ tmp%49 tmp%50 s@
                                                                                                                                              ...
                                                                                                                                              (=>
                                                                                                                                               %%location_label%%69
                                                                                                                                               (= s7@ (Add (EucDiv s6_0@ ps64@) (EucDiv a7@ ps64@)))
                                                                                                                                          )))))
                                                                                                                                          (=>
                                                                                                                                           (= s7@ (Add (EucDiv s6_0@ ps64@) (EucDiv a7@ ps64@)))
                                                                                                                                           (=>
                                                                                                                                            ...
                                                                                                                                            (and
                                                                                                                                             ...
                                                                                                                                             (=>
                                                                                                                                              tmp%51
                                                                                                                                              (=>
                                                                                                                                               (= tmp%52 (<= s6_0@ (Sub (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 7 8)))) 1)))
                                                                                                                                               (and
                                                                                                                                                (=>
                                                                                                                                                 %%location_label%%71
                                                                                                                                                 tmp%52
                                                                                                                                                ...
                                                                                                                                                (=>
                                                                                                                                                 tmp%52
                                                                                                                                                 (=>
                                                                                                                                                  (= tmp%53 (<= s5_0@ (Sub (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 6 8)))) 1)))
                                                                                                                                                  (and
                                                                                                                                                   (=>
                                                                                                                                                    %%location_label%%72
                                                                                                                                                    tmp%53
                                                                                                                                                   ...
                                                                                                                                                   (=>
                                                                                                                                                    tmp%53
                                                                                                                                                    (=>
                                                                                                                                                     (= tmp%54 (<= s4_0@ (Sub (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 5 8)))) 1)))
                                                                                                                                                     (and
                                                                                                                                                      (=>
                                                                                                                                                       %%location_label%%73
                                                                                                                                                       tmp%54
                                                                                                                                                      ...
                                                                                                                                                      (=>
                                                                                                                                                       tmp%54
                                                                                                                                                       (=>
                                                                                                                                                        (= tmp%55 (<= s3_0@ (Sub (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 4 8)))) 1)))
                                                                                                                                                        (and
                                                                                                                                                         (=>
                                                                                                                                                          %%location_label%%74
                                                                                                                                                          tmp%55
                                                                                                                                                         ...
                                                                                                                                                         (=>
                                                                                                                                                          tmp%55
                                                                                                                                                          (=>
                                                                                                                                                           (= tmp%56 (<= s2_0@ (Sub (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 3 8)))) 1)))
                                                                                                                                                           (and
                                                                                                                                                            (=>
                                                                                                                                                             %%location_label%%75
                                                                                                                                                             tmp%56
                                                                                                                                                            ...
                                                                                                                                                            (=>
                                                                                                                                                             tmp%56
                                                                                                                                                             (=>
                                                                                                                                                              (= tmp%57 (<= s1_0@ (Sub (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 2 8)))) 1)))
                                                                                                                                                              (and
                                                                                                                                                               (=>
                                                                                                                                                                %%location_label%%76
                                                                                                                                                                tmp%57
                                                                                                                                                               ...
                                                                                                                                                               (=>
                                                                                                                                                                tmp%57
                                                                                                                                                                (=>
                                                                                                                                                                 (= tmp%58 (<= s0_0@ (Sub (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 1 8)))) 1)))
                                                                                                                                                                 (and
                                                                                                                                                                  (=>
                                                                                                                                                                   %%location_label%%77
                                                                                                                                                                   tmp%58
                                                                                                                                                                  ...
                                                                                                                                                                  (=>
                                                                                                                                                                   ...
                                                                                                                                                                   (and
                                                                                                                                                                    (=>
                                                                                                                                                                     (= tmp%59 (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $
                                                                                                                                                                          (UINT 8)
                                                                                                                                                                         ) (Poly%slice%<u8.>. input!)
                                                                                                                                                                        ) (I (Add i! 7))
                                                                                                                                                                     )))
                                                                                                                                                                     (and
                                                                                                                                                                      ...
                                                                                                                                                                      (=>
                                                                                                                                                                       ...
                                                                                                                                                                       (=>
                                                                                                                                                                        (= tmp%60 (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $
                                                                                                                                                                             (UINT 8)
                                                                                                                                                                            ) (Poly%slice%<u8.>. input!)
                                                                                                                                                                           ) (I (Add i! 6))
                                                                                                                                                                        )))
                                                                                                                                                                        (and
                                                                                                                                                                         ...
                                                                                                                                                                         (=>
                                                                                                                                                                          ...
                                                                                                                                                                          (=>
                                                                                                                                                                           (= tmp%61 (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $
                                                                                                                                                                                (UINT 8)
                                                                                                                                                                               ) (Poly%slice%<u8.>. input!)
                                                                                                                                                                              ) (I (Add i! 5))
                                                                                                                                                                           )))
                                                                                                                                                                           (and
                                                                                                                                                                            ...
                                                                                                                                                                            (=>
                                                                                                                                                                             ...
                                                                                                                                                                             (=>
                                                                                                                                                                              (= tmp%62 (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $
                                                                                                                                                                                   (UINT 8)
                                                                                                                                                                                  ) (Poly%slice%<u8.>. input!)
                                                                                                                                                                                 ) (I (Add i! 4))
                                                                                                                                                                              )))
                                                                                                                                                                              (and
                                                                                                                                                                               ...
                                                                                                                                                                               (=>
                                                                                                                                                                                ...
                                                                                                                                                                                (=>
                                                                                                                                                                                 (= tmp%63 (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $
                                                                                                                                                                                      (UINT 8)
                                                                                                                                                                                     ) (Poly%slice%<u8.>. input!)
                                                                                                                                                                                    ) (I (Add i! 3))
                                                                                                                                                                                 )))
                                                                                                                                                                                 (and
                                                                                                                                                                                  ...
                                                                                                                                                                                  (=>
                                                                                                                                                                                   ...
                                                                                                                                                                                   (=>
                                                                                                                                                                                    (= tmp%64 (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $
                                                                                                                                                                                         (UINT 8)
                                                                                                                                                                                        ) (Poly%slice%<u8.>. input!)
                                                                                                                                                                                       ) (I (Add i! 2))
                                                                                                                                                                                    )))
                                                                                                                                                                                    (and
                                                                                                                                                                                     ...
                                                                                                                                                                                     (=>
                                                                                                                                                                                      ...
                                                                                                                                                                                      (=>
                                                                                                                                                                                       (= tmp%65 (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $
                                                                                                                                                                                            (UINT 8)
                                                                                                                                                                                           ) (Poly%slice%<u8.>. input!)
                                                                                                                                                                                          ) (I (Add i! 1))
                                                                                                                                                                                       )))
                                                                                                                                                                                       (and
                                                                                                                                                                                        ...
                                                                                                                                                                                        (=>
                                                                                                                                                                                         ...
                                                                                                                                                                                         (=>
                                                                                                                                                                                          %%location_label%%85
                                                                                                                                                                                          (= (EucMod z@ pt64@) (Add (Add (Add (Add (Add (Add (Add (EucMod (EucDiv (uClip 64 (Mul (vstd!arithmetic.power2.pow2.?
                                                                                                                                                                                                       (I (nClip (Mul 0 8)))
                                                                                                                                                                                                      ) (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $ (UINT 8))
                                                                                                                                                                                                         (Poly%slice%<u8.>. input!)
                                                                                                                                                                                                        ) (I (Add i! 0))
