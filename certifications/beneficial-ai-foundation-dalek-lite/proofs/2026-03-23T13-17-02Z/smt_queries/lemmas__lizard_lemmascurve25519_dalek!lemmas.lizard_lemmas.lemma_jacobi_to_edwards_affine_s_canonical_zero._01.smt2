...
;; curve25519-dalek/src/lemmas/lizard_lemmas.rs:941:7: 941:73 (#0)
...
;; Function-Def curve25519_dalek::lemmas::lizard_lemmas::lemma_jacobi_to_edwards_affine_s_canonical_zero
;; curve25519-dalek/src/lemmas/lizard_lemmas.rs:941:7: 941:73 (#0)
...
(push)
 ...
 (assert
  (not (=>
    ...
    (and
     (=>
      (= tmp%1 (= (EucMod s! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0))
      (and
       (=>
        %%location_label%%0
        tmp%1
       ...
       (=>
        tmp%1
        (=>
         (= tmp%2 (EucDiv s! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))))
         (=>
          (= tmp%3 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
          (and
           (=>
            %%location_label%%1
            (req%vstd!arithmetic.div_mod.lemma_mod_multiples_basic. tmp%2 tmp%3)
           )
           (=>
            (ens%vstd!arithmetic.div_mod.lemma_mod_multiples_basic. tmp%2 tmp%3)
            (and
             (and
              (=>
               %%location_label%%2
              ...
              (=>
               ...
               (=>
                %%location_label%%3
                (= (EucMod (nClip (Mul s! s!)) (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                 0
             ))))
             (=>
              (= (EucMod (nClip (Mul s! s!)) (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
              ...
              (=>
               %%location_label%%4
               (= (curve25519_dalek!specs.field_specs.field_square.? (I s!)) 0)
     ))))))))))
     (=>
      (= (curve25519_dalek!specs.field_specs.field_square.? (I s!)) 0)
      (=>
       ...
       (and
        (and
         ...
         (=>
          ...
          (=>
           %%location_label%%6
           (= (curve25519_dalek!specs.field_specs.field_mul.? (I 2) (I s!)) 0)
        )))
        (=>
         (= (curve25519_dalek!specs.field_specs.field_mul.? (I 2) (I s!)) 0)
         (=>
          (= denom@ (curve25519_dalek!specs.field_specs.field_inv.? (I (curve25519_dalek!specs.field_specs.field_mul.?
              (I t!) (I (curve25519_dalek!specs.ristretto_specs.spec_sqrt_ad_minus_one.? (I 0)))
          ))))
          (and
           (=>
            (= tmp%4 (curve25519_dalek!specs.field_specs.field_mul.? (I 2) (I s!)))
            (and
             (=>
              %%location_label%%7
              (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_zero_left.
             ...
             (=>
              ...
              (=>
               ...
               (and
                (=>
                 %%location_label%%8
                 (req%vstd!arithmetic.div_mod.lemma_small_mod. 0 tmp%5)
                )
                (=>
                 (ens%vstd!arithmetic.div_mod.lemma_small_mod. 0 tmp%5)
                 (=>
                  %%location_label%%9
            ...
            (and
             (=>
              ...
              (and
               (=>
                %%location_label%%10
                (req%vstd!arithmetic.div_mod.lemma_small_mod. 1 tmp%6)
               )
               (=>
                (ens%vstd!arithmetic.div_mod.lemma_small_mod. 1 tmp%6)
                (=>
                 (= tmp%7 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                 (and
                  (=>
                   %%location_label%%11
                   (req%vstd!arithmetic.div_mod.lemma_mod_add_multiples_vanish. 1 tmp%7)
                  )
                  (=>
                   (ens%vstd!arithmetic.div_mod.lemma_mod_add_multiples_vanish. 1 tmp%7)
                   (=>
                    %%location_label%%12
                    (= (curve25519_dalek!specs.field_specs.field_sub.? (I 1) (I 0)) 1)
             )))))))
             (=>
              (= (curve25519_dalek!specs.field_specs.field_sub.? (I 1) (I 0)) 1)
              (and
               (=>
                ...
                (and
                 (=>
                  %%location_label%%13
                  (req%vstd!arithmetic.div_mod.lemma_small_mod. 1 tmp%8)
                 )
                 (=>
                  (ens%vstd!arithmetic.div_mod.lemma_small_mod. 1 tmp%8)
                  (=>
                   %%location_label%%14
                   (= (curve25519_dalek!specs.field_specs.field_add.? (I 1) (I 0)) 1)
               ))))
               (=>
                (= (curve25519_dalek!specs.field_specs.field_add.? (I 1) (I 0)) 1)
                (and
                   ...
                   (=>
                    ...
                    (=>
                     ...
                     (and
                      (=>
                       %%location_label%%16
                       (req%vstd!arithmetic.div_mod.lemma_small_mod. 1 tmp%9)
                      )
                      (=>
                       (ens%vstd!arithmetic.div_mod.lemma_small_mod. 1 tmp%9)
                       (=>
                        %%location_label%%17
                        (= (curve25519_dalek!specs.field_specs.field_mul.? (I 1) (I 1)) 1)
                   )))))
                   (=>
                    (= (curve25519_dalek!specs.field_specs.field_mul.? (I 1) (I 1)) 1)
                    (=>
