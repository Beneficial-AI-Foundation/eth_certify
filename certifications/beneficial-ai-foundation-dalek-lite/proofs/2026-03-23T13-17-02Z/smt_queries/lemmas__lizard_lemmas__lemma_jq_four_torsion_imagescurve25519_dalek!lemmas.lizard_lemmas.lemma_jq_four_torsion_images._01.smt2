...
;; MODULE 'module lemmas::lizard_lemmas, function curve25519_dalek::lemmas::lizard_lemmas::lemma_jq_four_torsion_images'
;; curve25519-dalek/src/lemmas/lizard_lemmas.rs:694:1: 694:44 (#0)
...
(assert
 (distinct fuel%vstd!arithmetic.div_mod.lemma_mod_bound. fuel%vstd!array.array_view.
  ...
  fuel%vstd!view.impl&%44.view. fuel%curve25519_dalek!backend.serial.u64.constants.SQRT_AD_MINUS_ONE.
  ...
  fuel%curve25519_dalek!lizard.u64_constants.MIDOUBLE_INVSQRT_A_MINUS_D. fuel%curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.
  ...
  fuel%curve25519_dalek!specs.lizard_specs.jacobi_to_edwards_affine. fuel%curve25519_dalek!specs.lizard_specs.midouble_invsqrt_a_minus_d.
...
;; Function-Def curve25519_dalek::lemmas::lizard_lemmas::lemma_jq_four_torsion_images
;; curve25519-dalek/src/lemmas/lizard_lemmas.rs:694:1: 694:44 (#0)
...
(push)
 ...
 (declare-const sqrt_ad_m1@ Int)
 (declare-const i@ Int)
 (declare-const two_i@ Int)
 (declare-const inv_two_i@ Int)
 (assert
  fuel_defaults
 )
             ...
             (=>
              ...
              (and
               ...
               (=>
                ...
                (=>
                 (= tmp%3 (curve25519_dalek!specs.field_specs.field_neg.? (I 1)))
                 (and
                  (=>
                   %%location_label%%3
                   (req%curve25519_dalek!lemmas.lizard_lemmas.lemma_jacobi_to_edwards_affine_y_zero_when_s_sq_one.
                  ...
                  (=>
                   ...
                   (=>
                    ...
                    (=>
                     ...
                     (=>
                      (= tmp%4 (= (curve25519_dalek!specs.field_specs.field_mul.? (I i@) (I (curve25519_dalek!specs.field_specs.field_neg.?
                           (I i@)
                         ))
                        ) (curve25519_dalek!specs.field_specs.field_neg.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                           (I i@) (I i@)
                      ...
                      (and
                       ...
                       (=>
                        ...
                        (=>
                         ...
                         (=>
                          (= tmp%5 (nClip (Sub (curve25519_dalek!specs.field_specs_u64.p.? (I 0)) 1)))
                          (=>
                           (= tmp%6 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                           (and
                            (=>
                             %%location_label%%5
                             (req%vstd!arithmetic.div_mod.lemma_small_mod. tmp%5 tmp%6)
                            )
                            (=>
                             (ens%vstd!arithmetic.div_mod.lemma_small_mod. tmp%5 tmp%6)
                             (=>
                              (= tmp%7 (= (curve25519_dalek!specs.field_specs.field_neg.? (I 1)) (nClip (Sub (curve25519_dalek!specs.field_specs_u64.p.?
                                   (I 0)
                                  ) 1
                              ))))
                              (and
                               ...
                               (=>
                                tmp%7
                                (=>
                                 (= tmp%8 (= (curve25519_dalek!specs.field_specs.field_square.? (I i@)) (EucMod (nClip
                                     (Mul i@ i@)
                                    ) (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
                                 )))
                                 (and
                                  ...
                                  (=>
                                   tmp%8
                                   (=>
                                    (= tmp%9 (= (curve25519_dalek!specs.field_specs.field_square.? (I i@)) (curve25519_dalek!specs.field_specs.field_neg.?
                                       (I 1)
                                    )))
                                    (and
                                     (=>
                                      ...
                                      (=>
                                       ...
                                       (=>
                                        ...
                                        (and
                                         (=>
                                          %%location_label%%9
                                          (req%vstd!arithmetic.div_mod.lemma_small_mod. 1 tmp%10)
                                         )
                                         (=>
                                          (ens%vstd!arithmetic.div_mod.lemma_small_mod. 1 tmp%10)
                                          (=>
                                           (= tmp%11 (= (curve25519_dalek!specs.field_specs.field_neg.? (I (curve25519_dalek!specs.field_specs.field_neg.?
                                                (I 1)
                                              ))
                                             ) 1
                                           ))
                                           (and
                                            ...
                                            (=>
                                             tmp%11
                                             (=>
                                              (= tmp%12 (= (curve25519_dalek!specs.field_specs.field_mul.? (I i@) (I (curve25519_dalek!specs.field_specs.field_neg.?
                                                   (I i@)
                                                 ))
                                                ) 1
                                              ))
                                              (and
                                               ...
                                               (=>
                                                ...
                                                (and
                                                 (=>
                                                  (= tmp%13 (Sub (curve25519_dalek!specs.field_specs_u64.p.? (I 0)) (EucMod i@ (curve25519_dalek!specs.field_specs_u64.p.?
                                                      (I 0)
                                                  ))))
                                                  (=>
                                                   ...
                                                   (and
                                                    ...
                                                    (=>
                                                     ...
                                                     (=>
                                                      %%location_label%%13
                                                      (< (curve25519_dalek!specs.field_specs.field_neg.? (I i@)) (curve25519_dalek!specs.field_specs_u64.p.?
                                                        (I 0)
                                                 )))))))
                                                 (=>
                                                  (< (curve25519_dalek!specs.field_specs.field_neg.? (I i@)) (curve25519_dalek!specs.field_specs_u64.p.?
                                                  ...
                                                  (=>
                                                   ...
                                                   (and
                                                    (=>
                                                     %%location_label%%14
                                                     (req%vstd!arithmetic.div_mod.lemma_small_mod. i@ tmp%15)
                                                    )
                                                    (=>
                                                     (ens%vstd!arithmetic.div_mod.lemma_small_mod. i@ tmp%15)
                                                     (=>
                                                      (= tmp%16 (curve25519_dalek!specs.field_specs.field_neg.? (I i@)))
                                                      (and
                                                       (=>
                                                        %%location_label%%15
                                                        (req%curve25519_dalek!specs.field_specs.field_inv_unique. i@ tmp%16)
                                                       )
                                                       (=>
                                                        (ens%curve25519_dalek!specs.field_specs.field_inv_unique. i@ tmp%16)
                                                        (and
                                                         (=>
                                                          (ens%curve25519_dalek!specs.field_specs_u64.pow255_gt_19. 0)
                                                          (=>
                                                           %%location_label%%16
                                                           (< 2 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                                                         ))
                                                         (=>
                                                          (< 2 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                                                          (and
                                                           (=>
                                                            ...
                                                            (=>
                                                             ...
                                                             (and
                                                              (=>
                                                               %%location_label%%17
                                                               (req%vstd!arithmetic.div_mod.lemma_small_mod. 2 tmp%17)
                                                              )
                                                              (=>
                                                               (ens%vstd!arithmetic.div_mod.lemma_small_mod. 2 tmp%17)
                                                               (=>
                                                                %%location_label%%18
                                                                (= (curve25519_dalek!specs.field_specs.field_mul.? (I 2) (I 1)) 2)
                                                           )))))
                                                           (=>
                                                            (= (curve25519_dalek!specs.field_specs.field_mul.? (I 2) (I 1)) 2)
                                                            (=>
                                                             (ens%curve25519_dalek!lemmas.lizard_lemmas.axiom_mc_times_sqrt_ad_m1. 0)
                                                             (=>
                                                              (= two_i@ (curve25519_dalek!specs.field_specs.field_mul.? (I 2) (I i@)))
                                                              (=>
                                                               (= tmp%18 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                                                               (and
                                                                (=>
                                                                 %%location_label%%19
                                                                 (req%vstd!arithmetic.div_mod.lemma_small_mod. 2 tmp%18)
                                                                )
                                                                (=>
                                                                 (ens%vstd!arithmetic.div_mod.lemma_small_mod. 2 tmp%18)
                                                                 (and
                                                                  (=>
                                                                   %%location_label%%20
                                                                   (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_a_times_inv_ab_is_inv_b.
                                                                  ...
                                                                  (=>
                                                                   ...
                                                                   (=>
                                                                    ...
                                                                    (=>
                                                                     (= inv_two_i@ (curve25519_dalek!specs.field_specs.field_inv.? (I two_i@)))
                                                                     (=>
                                                                      (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_neg_mul_left.
                                                                       2 inv_two_i@
                                                                      )
                                                                        ...
                                                                        (=>
                                                                         ...
                                                                         (and
                                                                          ...
                                                                          (=>
                                                                           ...
                                                                           (=>
                                                                            (= tmp%21 (curve25519_dalek!specs.field_specs.field_mul.? (I 2) (I inv_two_i@)))
                                                                            (=>
                                                                             (= tmp%22 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                                                                             (and
                                                                              (=>
                                                                               %%location_label%%22
                                                                               (req%vstd!arithmetic.div_mod.lemma_small_mod. tmp%21 tmp%22)
                                                                              )
                                                                              (=>
                                                                               (ens%vstd!arithmetic.div_mod.lemma_small_mod. tmp%21 tmp%22)
                                                                               (and
                                                                                (=>
                                                                                 %%location_label%%23
                                                                                 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.lizard_specs.jacobi_to_edwards_affine.?
                                                                                    (I 1) (I (curve25519_dalek!specs.lizard_specs.midouble_invsqrt_a_minus_d.? (I 0)))
                                                                                   )
                                                                                ...
                                                                                (=>
                                                                                 %%location_label%%24
                                                                                 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.lizard_specs.jacobi_to_edwards_affine.?
                                                                                    (I (curve25519_dalek!specs.field_specs.field_neg.? (I 1))) (I (curve25519_dalek!specs.lizard_specs.midouble_invsqrt_a_minus_d.?
                                                                                      (I 0)
                                                                                   )))
                                                                                  ) (Poly%tuple%2. (tuple%2./tuple%2 (I (curve25519_dalek!specs.field_specs.sqrt_m1.? (
                                                                                       I 0
                                                                                     ))
                                                                                    ) (I 0)
 )))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
