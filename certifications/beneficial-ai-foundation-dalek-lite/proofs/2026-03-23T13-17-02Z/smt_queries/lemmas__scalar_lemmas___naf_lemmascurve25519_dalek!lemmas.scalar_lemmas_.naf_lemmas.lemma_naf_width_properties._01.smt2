...
;; curve25519-dalek/src/lemmas/scalar_lemmas_/naf_lemmas.rs:643:5: 643:11 (#0)
...
;; Function-Def curve25519_dalek::lemmas::scalar_lemmas_::naf_lemmas::lemma_naf_width_properties
;; curve25519-dalek/src/lemmas/scalar_lemmas_/naf_lemmas.rs:643:5: 643:11 (#0)
...
(assert
 (not (=>
   %%location_label%%0
   (and
    (bvuge (bvshl ((_ zero_extend 63) (_ bv1 1)) ((_ zero_extend 32) w!)) ((_ zero_extend
       61
      ) (_ bv4 3)
    ))
    (bvule (bvshl ((_ zero_extend 63) (_ bv1 1)) ((_ zero_extend 32) w!)) ((_ zero_extend
       55
      ) (_ bv256 9)
))))))
(get-info :version)
