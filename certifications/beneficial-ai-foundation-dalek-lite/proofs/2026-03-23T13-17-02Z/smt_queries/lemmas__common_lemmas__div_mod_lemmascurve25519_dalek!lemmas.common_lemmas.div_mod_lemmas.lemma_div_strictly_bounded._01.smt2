...
;; curve25519-dalek/src/lemmas/common_lemmas/div_mod_lemmas.rs:118:1: 118:64 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::div_mod_lemmas::lemma_div_strictly_bounded
;; curve25519-dalek/src/lemmas/common_lemmas/div_mod_lemmas.rs:118:1: 118:64 (#0)
...
(push)
 ...
 (assert
  (not (and
    (=>
     %%location_label%%0
     (req%vstd!arithmetic.div_mod.lemma_div_by_multiple. b! a!)
    )
    (=>
     (ens%vstd!arithmetic.div_mod.lemma_div_by_multiple. b! a!)
     (=>
      (= tmp%1 (Mul a! b!))
      (and
       (=>
        %%location_label%%1
        (req%vstd!arithmetic.div_mod.lemma_div_by_multiple_is_strongly_ordered. x! tmp%1 b!
         a!
       ))
       (=>
        (ens%vstd!arithmetic.div_mod.lemma_div_by_multiple_is_strongly_ordered. x! tmp%1 b!
         a!
        )
        (=>
         %%location_label%%2
