...
;; curve25519-dalek/src/lemmas/scalar_lemmas_/montgomery_reduce_part1_chain_lemmas.rs:640:1: 652:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::scalar_lemmas_::montgomery_reduce_part1_chain_lemmas::lemma_part1_chain_divisibility
;; curve25519-dalek/src/lemmas/scalar_lemmas_/montgomery_reduce_part1_chain_lemmas.rs:640:1: 652:2 (#0)
...
(push)
 ...
 (declare-const term1@ Int)
 (declare-const term2@ Int)
 (declare-const term3@ Int)
 (declare-const term4@ Int)
 ...
 (declare-const l0_val@ Int)
 (declare-const l1@ Int)
 (declare-const l2@ Int)
 (declare-const l3@ Int)
 (declare-const l4@ Int)
 (declare-const t_low@ Int)
 (declare-const n@ Int)
 ...
 (declare-const nl_low_coeffs@ Int)
              ...
              (=>
               ...
               (=>
                ...
                (=>
                 ...
                 (=>
                  (= l_low@ (nClip (Add (nClip (Add (nClip (Add (nClip (Add l0_val@ (nClip (Mul l1@ (vstd!arithmetic.power2.pow2.?
                              (I 52)
                          ))))
                         ) (nClip (Mul l2@ (vstd!arithmetic.power2.pow2.? (I 104))))
                        )
                          ...
                          (=>
                           ...
                           (=>
                            ...
                            (=>
                             ...
                             (=>
                              (= s0@ (%I (vstd!seq.Seq.index.? $ (UINT 128) (vstd!view.View.view.? $ (ARRAY $ (UINT 128)
                                   $ (CONST_INT 9)
                                  ) (Poly%array%. limbs!)
                                 ) (I 0)
                              )))
                              (=>
                               (= s1@ (nClip (Add (nClip (Add carry0! (%I (vstd!seq.Seq.index.? $ (UINT 128) (vstd!view.View.view.?
                                       $ (ARRAY $ (UINT 128) $ (CONST_INT 9)) (Poly%array%. limbs!)
                                      ) (I 1)
                                   )))
                                  ) (nClip (Mul n0! l1@))
                               ...
                               (=>
                                (= s2@ (nClip (Add (nClip (Add (nClip (Add carry1! (%I (vstd!seq.Seq.index.? $ (UINT 128)
                                         (vstd!view.View.view.? $ (ARRAY $ (UINT 128) $ (CONST_INT 9)) (Poly%array%. limbs!))
                                         (I 2)
                                      )))
                                     ) (nClip (Mul n0! l2@))
                                ...
                                (=>
                                 (= s3@ (nClip (Add (nClip (Add (nClip (Add carry2! (%I (vstd!seq.Seq.index.? $ (UINT 128)
                                          (vstd!view.View.view.? $ (ARRAY $ (UINT 128) $ (CONST_INT 9)) (Poly%array%. limbs!))
                                          (I 3)
                                       )))
                                      ) (nClip (Mul n1! l2@))
                                 ...
                                 (=>
                                  (= s4@ (nClip (Add (nClip (Add (nClip (Add (nClip (Add carry3! (%I (vstd!seq.Seq.index.? $ (
                                              UINT 128
                                             ) (vstd!view.View.view.? $ (ARRAY $ (UINT 128) $ (CONST_INT 9)) (Poly%array%. limbs!))
                                             (I 4)
                                          )))
                                  ...
                                  (and
                                   (=>
                                    %%location_label%%0
                                    (req%curve25519_dalek!lemmas.scalar_lemmas_.montgomery_reduce_part1_chain_lemmas.lemma_part1_telescoping_expansion.
                                     s0@ s1@ s2@ s3@ s4@ n0! n1! n2! n3! n4! carry0! carry1! carry2! carry3! carry4! l0_val@
                                   ))
                                   (=>
                                    (ens%curve25519_dalek!lemmas.scalar_lemmas_.montgomery_reduce_part1_chain_lemmas.lemma_part1_telescoping_expansion.
                                     s0@ s1@ s2@ s3@ s4@ n0! n1! n2! n3! n4! carry0! carry1! carry2! carry3! carry4! l0_val@
                                    ...
                                    (=>
                                     (= val@ (nClip (Add t_low@ nl_low_coeffs@)))
                                     (and
                                      (=>
                                       (= term0@ (nClip (Add s0@ (nClip (Mul n0! l0_val@)))))
                                       (=>
                                        (= term1@ (Mul (Add (Sub s1@ carry0!) (nClip (Mul n1! l0_val@))) (vstd!arithmetic.power2.pow2.?
                                           (I 52)
                                        )))
                                        (=>
                                         (= term2@ (Mul (Add (Sub s2@ carry1!) (nClip (Mul n2! l0_val@))) (vstd!arithmetic.power2.pow2.?
                                            (I 104)
                                         )))
                                         (=>
                                          (= term3@ (Mul (Add (Sub s3@ carry2!) (nClip (Mul n3! l0_val@))) (vstd!arithmetic.power2.pow2.?
                                             (I 156)
                                          )))
                                          (=>
                                           (= term4@ (Mul (Add (Sub s4@ carry3!) (nClip (Mul n4! l0_val@))) (vstd!arithmetic.power2.pow2.?
                                              (I 208)
                                           )))
                                           (=>
                                            (= tmp%1 (= (Sub s1@ carry0!) (nClip (Add (%I (vstd!seq.Seq.index.? $ (UINT 128) (vstd!view.View.view.?
                                                   $ (ARRAY $ (UINT 128) $ (CONST_INT 9)) (Poly%array%. limbs!)
                                                  ) (I 1)
                                                 )
                                                ) (nClip (Mul n0! l1@))
                                            ...
                                            (and
                                             ...
                                             (=>
                                              tmp%1
                                              (=>
                                               (= tmp%2 (= (Sub s2@ carry1!) (nClip (Add (nClip (Add (%I (vstd!seq.Seq.index.? $ (UINT 128)
                                                       (vstd!view.View.view.? $ (ARRAY $ (UINT 128) $ (CONST_INT 9)) (Poly%array%. limbs!))
                                                       (I 2)
                                                      )
                                                     ) (nClip (Mul n0! l2@))
                                               ...
                                               (and
                                                ...
                                                (=>
                                                 tmp%2
                                                 (=>
                                                  (= tmp%3 (= (Sub s3@ carry2!) (nClip (Add (nClip (Add (%I (vstd!seq.Seq.index.? $ (UINT 128)
                                                          (vstd!view.View.view.? $ (ARRAY $ (UINT 128) $ (CONST_INT 9)) (Poly%array%. limbs!))
                                                          (I 3)
                                                         )
                                                        ) (nClip (Mul n1! l2@))
                                                  ...
                                                  (and
                                                   ...
                                                   (=>
                                                    tmp%3
                                                    (=>
                                                     (= tmp%4 (= (Sub s4@ carry3!) (nClip (Add (nClip (Add (nClip (Add (%I (vstd!seq.Seq.index.?
                                                               $ (UINT 128) (vstd!view.View.view.? $ (ARRAY $ (UINT 128) $ (CONST_INT 9)) (Poly%array%.
                                                                 limbs!
                                                                )
                                                               ) (I 4)
                                                      ...
                                                      (=>
                                                       ...
                                                       (and
                                                        (=>
                                                         ...
                                                         (=>
                                                          (= tmp%6 (%I (vstd!seq.Seq.index.? $ (UINT 128) (vstd!view.View.view.? $ (ARRAY $ (UINT
                                                                128
                                                               ) $ (CONST_INT 9)
                                                              ) (Poly%array%. limbs!)
                                                             ) (I 1)
                                                          ...
                                                          (=>
                                                           (= tmp%7 (nClip (Add (nClip (Mul n0! l1@)) (nClip (Mul n1! l0_val@)))))
                                                           (=>
                                                            (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. tmp%5 tmp%6 tmp%7)
                                                            (=>
                                                             %%location_label%%5
                                                             (= term1@ (nClip (Add (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 128) (vstd!view.View.view.?
                                                                     $ (ARRAY $ (UINT 128) $ (CONST_INT 9)) (Poly%array%. limbs!)
                                                                    ) (I 1)
                                                                   )
                                                                  ) (vstd!arithmetic.power2.pow2.? (I 52))
                                                                 )
                                                                ) (nClip (Mul coeff1@ (vstd!arithmetic.power2.pow2.? (I 52))))
                                                        ))))))))
                                                        (=>
                                                         (= term1@ (nClip (Add (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 128) (vstd!view.View.view.?
                                                                 $ (ARRAY $ (UINT 128) $ (CONST_INT 9)) (Poly%array%. limbs!)
                                                         ...
                                                         (and
                                                          (=>
                                                           (= tmp%8 (vstd!arithmetic.power2.pow2.? (I 104)))
                                                           (=>
                                                            (= tmp%9 (%I (vstd!seq.Seq.index.? $ (UINT 128) (vstd!view.View.view.? $ (ARRAY $ (UINT
                                                                  128
                                                                 ) $ (CONST_INT 9)
                                                                ) (Poly%array%. limbs!)
                                                               ) (I 2)
                                                            ...
                                                            (=>
                                                             (= tmp%10 (nClip (Add (nClip (Add (nClip (Mul n0! l2@)) (nClip (Mul n1! l1@)))) (nClip
                                                                 (Mul n2! l0_val@)
                                                             ))))
                                                             (=>
                                                              (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. tmp%8 tmp%9 tmp%10)
                                                              (=>
                                                               %%location_label%%6
                                                               (= term2@ (nClip (Add (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 128) (vstd!view.View.view.?
                                                                       $ (ARRAY $ (UINT 128) $ (CONST_INT 9)) (Poly%array%. limbs!)
                                                                      ) (I 2)
                                                                     )
                                                                    ) (vstd!arithmetic.power2.pow2.? (I 104))
                                                          ...
                                                          (=>
                                                           ...
                                                           (and
                                                            (=>
                                                             ...
                                                             (=>
                                                              (= tmp%12 (%I (vstd!seq.Seq.index.? $ (UINT 128) (vstd!view.View.view.? $ (ARRAY $ (UINT
                                                                    128
                                                                   ) $ (CONST_INT 9)
                                                                  ) (Poly%array%. limbs!)
                                                                 ) (I 3)
                                                              ...
                                                              (=>
                                                               (= tmp%13 (nClip (Add (nClip (Add (nClip (Mul n1! l2@)) (nClip (Mul n2! l1@)))) (nClip
                                                                   (Mul n3! l0_val@)
                                                               ))))
                                                               (=>
                                                                ...
                                                                (=>
                                                                 %%location_label%%7
                                                                 (= term3@ (nClip (Add (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 128) (vstd!view.View.view.?
                                                                         $ (ARRAY $ (UINT 128) $ (CONST_INT 9)) (Poly%array%. limbs!)
                                                                        ) (I 3)
                                                                       )
                                                                      ) (vstd!arithmetic.power2.pow2.? (I 156))
                                                            ...
                                                            (=>
                                                             ...
                                                             (and
                                                              (=>
                                                               (= tmp%14 (vstd!arithmetic.power2.pow2.? (I 208)))
                                                               (=>
                                                                (= tmp%15 (%I (vstd!seq.Seq.index.? $ (UINT 128) (vstd!view.View.view.? $ (ARRAY $ (UINT
                                                                      128
                                                                     ) $ (CONST_INT 9)
                                                                    ) (Poly%array%. limbs!)
                                                                   ) (I 4)
                                                                ...
                                                                (=>
                                                                 (= tmp%16 (nClip (Add (nClip (Add (nClip (Add (nClip (Mul n0! l4@)) (nClip (Mul n2! l2@))))
                                                                      (nClip (Mul n3! l1@))
                                                                     )
                                                                    ) (nClip (Mul n4! l0_val@))
                                                                 )))
                                                                 (=>
                                                                  (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. tmp%14 tmp%15 tmp%16)
                                                                  (=>
                                                                   %%location_label%%8
                                                                   (= term4@ (nClip (Add (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 128) (vstd!view.View.view.?
                                                                           $ (ARRAY $ (UINT 128) $ (CONST_INT 9)) (Poly%array%. limbs!)
                                                                          ) (I 4)
                                                                         )
                                                                        ) (vstd!arithmetic.power2.pow2.? (I 208))
                                                              ...
                                                              (=>
                                                               ...
                                                               (=>
                                                                (= tmp%17 (= (Add (Add (Add (Add term0@ term1@) term2@) term3@) term4@) (nClip (Add t_low@
                                                                    nl_low_coeffs@
                                                                ))))
                                                                (and
                                                                 (=>
                                                                 ...
                                                                 (=>
                                                                  ...
                                                                  (=>
                                                                   %%location_label%%10
                                                                   (= val@ (nClip (Mul carry4! (vstd!arithmetic.power2.pow2.? (I 260)))))
                                      )))))))))))))))))))))))))))))
                                      (=>
                                       (= val@ (nClip (Mul carry4! (vstd!arithmetic.power2.pow2.? (I 260)))))
                                       (and
                                        (=>
                                         %%location_label%%11
                                         (req%curve25519_dalek!lemmas.scalar_lemmas_.montgomery_reduce_part1_chain_lemmas.lemma_n_times_l_expansion.
                                          n0! n1! n2! n3! n4! l0_val@ l1@ l2@ l3@ l4@
                                        ))
                                        (=>
                                         (ens%curve25519_dalek!lemmas.scalar_lemmas_.montgomery_reduce_part1_chain_lemmas.lemma_n_times_l_expansion.
                                          n0! n1! n2! n3! n4! l0_val@ l1@ l2@ l3@ l4@
                                         ...
                                         (=>
                                          (= tmp%18 (= (EucMod (nClip (Mul n@ l_low@)) (vstd!arithmetic.power2.pow2.? (I 260)))
                                            (EucMod nl_low_coeffs@ (vstd!arithmetic.power2.pow2.? (I 260)))
                                          ))
                                          (and
                                           (=>
                                            %%location_label%%12
                                           ...
                                           (=>
                                            tmp%18
                                            (=>
                                             (= tmp%19 (= (nClip (Mul n@ l_low@)) (nClip (Add nl_low_coeffs@ high_part@))))
                                             (and
                                              (=>
                                               %%location_label%%13
                                               tmp%19
                                              ...
                                              (=>
                                               tmp%19
                                               (=>
                                                (= tmp%20 (= (EucMod high_part@ (vstd!arithmetic.power2.pow2.? (I 260))) 0))
                                                (and
                                                 (=>
                                                  %%location_label%%14
                                                  tmp%20
                                                 ...
                                                 (=>
                                                  ...
                                                  (and
                                                   (=>
                                                    ...
                                                    (=>
                                                     (= tmp%21 (vstd!arithmetic.power2.pow2.? (I 260)))
                                                     (and
                                                      (=>
                                                       %%location_label%%15
                                                       (req%vstd!arithmetic.div_mod.lemma_mod_self_0. tmp%21)
                                                      )
                                                      (=>
                                                       (ens%vstd!arithmetic.div_mod.lemma_mod_self_0. tmp%21)
                                                       (=>
                                                        (= tmp%22 (vstd!arithmetic.power2.pow2.? (I 260)))
                                                        (=>
                                                         (= tmp%23 (vstd!arithmetic.power2.pow2.? (I 260)))
                                                         (and
                                                          (=>
                                                           %%location_label%%16
                                                           (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. carry4! tmp%22 tmp%23)
                                                          )
                                                          (=>
                                                           (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. carry4! tmp%22 tmp%23)
                                                           (=>
                                                            (ens%vstd!arithmetic.mul.lemma_mul_basics. carry4!)
                                                            (=>
                                                             (= tmp%24 (vstd!arithmetic.power2.pow2.? (I 260)))
                                                             (and
                                                              (=>
                                                               %%location_label%%17
                                                               (req%vstd!arithmetic.div_mod.lemma_small_mod. 0 tmp%24)
                                                              )
                                                              (=>
                                                               (ens%vstd!arithmetic.div_mod.lemma_small_mod. 0 tmp%24)
                                                               (=>
                                                                %%location_label%%18
                                                                (= (EucMod val@ (vstd!arithmetic.power2.pow2.? (I 260))) 0)
                                                   )))))))))))))
                                                   (=>
                                                    (= (EucMod val@ (vstd!arithmetic.power2.pow2.? (I 260))) 0)
                                                    (and
                                                     (=>
                                                      (ens%vstd!arithmetic.power2.lemma_pow2_pos. 260)
                                                      (=>
                                                       (= tmp%25 (= (nClip (Add t_low@ (nClip (Mul n@ l_low@)))) (nClip (Add val@ high_part@))))
                                                       (and
                                                        (=>
                                                         %%location_label%%19
                                                         tmp%25
                                                        ...
                                                        (=>
                                                         tmp%25
                                                         (=>
                                                          (= tmp%26 (vstd!arithmetic.power2.pow2.? (I 260)))
                                                          (and
                                                           (=>
                                                            %%location_label%%20
                                                            (req%vstd!arithmetic.div_mod.lemma_add_mod_noop. val@ high_part@ tmp%26)
                                                           )
                                                           (=>
                                                            (ens%vstd!arithmetic.div_mod.lemma_add_mod_noop. val@ high_part@ tmp%26)
                                                            (=>
                                                             (= tmp%27 (vstd!arithmetic.power2.pow2.? (I 260)))
                                                             (and
                                                              (=>
                                                               %%location_label%%21
                                                               (req%vstd!arithmetic.div_mod.lemma_small_mod. 0 tmp%27)
                                                              )
                                                              (=>
                                                               (ens%vstd!arithmetic.div_mod.lemma_small_mod. 0 tmp%27)
                                                               (=>
                                                                %%location_label%%22
                                                                (= (EucMod (nClip (Add t_low@ (nClip (Mul n@ l_low@)))) (vstd!arithmetic.power2.pow2.?
                                                                   (I 260)
