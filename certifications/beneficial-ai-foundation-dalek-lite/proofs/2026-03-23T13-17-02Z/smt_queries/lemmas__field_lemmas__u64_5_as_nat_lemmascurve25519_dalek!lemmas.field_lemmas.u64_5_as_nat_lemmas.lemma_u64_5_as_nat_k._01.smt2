...
;; curve25519-dalek/src/lemmas/field_lemmas/u64_5_as_nat_lemmas.rs:134:1: 134:55 (#0)
 ...
 (forall ((a! %%Function%%) (k! Int)) (!
   (= (req%curve25519_dalek!lemmas.field_lemmas.u64_5_as_nat_lemmas.lemma_u64_5_as_nat_k.
     ...
     (forall ((i$ Poly)) (!
       ...
       :qid user_curve25519_dalek__lemmas__field_lemmas__u64_5_as_nat_lemmas__lemma_u64_5_as_nat_k_71
       :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__u64_5_as_nat_lemmas__lemma_u64_5_as_nat_k_71
   ))))
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::u64_5_as_nat_lemmas::lemma_u64_5_as_nat_k
;; curve25519-dalek/src/lemmas/field_lemmas/u64_5_as_nat_lemmas.rs:134:1: 134:55 (#0)
...
(push)
 ...
 (assert
  (forall ((i$ Poly)) (!
    ...
    :qid user_curve25519_dalek__lemmas__field_lemmas__u64_5_as_nat_lemmas__lemma_u64_5_as_nat_k_74
    :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__u64_5_as_nat_lemmas__lemma_u64_5_as_nat_k_74
 )))
 ;; assertion failed
 ...
 (assert
  (not (=>
    (= ka@ (%Poly%array%. (array_new $ (UINT 64) 5 (%%array%%0 (I (uClip 64 (Mul k! (%I (vstd!seq.Seq.index.?
             $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%.
               a!
              )
             ) (I 0)
    ...
    (and
     (=>
      ...
      (=>
       ...
       (=>
        (ens%vstd!arithmetic.mul.lemma_mul_is_associative. tmp%1 tmp%2 k!)
        (=>
         (= tmp%3 (vstd!arithmetic.power2.pow2.? (I 102)))
         (=>
          ...
          (=>
           (ens%vstd!arithmetic.mul.lemma_mul_is_associative. tmp%3 tmp%4 k!)
           (=>
            (= tmp%5 (vstd!arithmetic.power2.pow2.? (I 153)))
            (=>
             ...
             (=>
              (ens%vstd!arithmetic.mul.lemma_mul_is_associative. tmp%5 tmp%6 k!)
              (=>
               (= tmp%7 (vstd!arithmetic.power2.pow2.? (I 204)))
               (=>
                ...
                (=>
                 (ens%vstd!arithmetic.mul.lemma_mul_is_associative. tmp%7 tmp%8 k!)
                 (=>
                  %%location_label%%0
                  (= (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. ka@)) (Add
                    (Add (Add (Add (Mul k! (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY
                            $ (UINT 64) $ (CONST_INT 5)
                           ) (Poly%array%. a!)
                          ) (I 0)
                        ))
                       ) (Mul k! (Mul (vstd!arithmetic.power2.pow2.? (I 51)) (%I (vstd!seq.Seq.index.? $ (UINT
                            64
                           ) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. a!))
                           (I 1)
                       ))))
                      ) (Mul k! (Mul (vstd!arithmetic.power2.pow2.? (I 102)) (%I (vstd!seq.Seq.index.? $ (UINT
                           64
                          ) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. a!))
                          (I 2)
                      ))))
                     ) (Mul k! (Mul (vstd!arithmetic.power2.pow2.? (I 153)) (%I (vstd!seq.Seq.index.? $ (UINT
                          64
                         ) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. a!))
                         (I 3)
                     ))))
                    ) (Mul k! (Mul (vstd!arithmetic.power2.pow2.? (I 204)) (%I (vstd!seq.Seq.index.? $ (UINT
                         64
                        ) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. a!))
                        (I 4)
     )))))))))))))))))))
     (=>
      ...
      (and
       (=>
        ...
        (=>
         (= tmp%10 (Mul (vstd!arithmetic.power2.pow2.? (I 51)) (%I (vstd!seq.Seq.index.? $ (UINT
              64
             ) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. a!))
             (I 1)
         ))))
         (=>
          (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add. k! tmp%9 tmp%10)
          (=>
           (= tmp%11 (Add (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $
                 (UINT 64) $ (CONST_INT 5)
                ) (Poly%array%. a!)
               ) (I 0)
              )
           ...
           (=>
            (= tmp%12 (Mul (vstd!arithmetic.power2.pow2.? (I 102)) (%I (vstd!seq.Seq.index.? $ (UINT
                 64
                ) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. a!))
                (I 2)
            ))))
            (=>
             (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add. k! tmp%11 tmp%12)
             (=>
              (= tmp%13 (Add (Add (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY
                     $ (UINT 64) $ (CONST_INT 5)
                    ) (Poly%array%. a!)
                   ) (I 0)
                  )
              ...
              (=>
               (= tmp%14 (Mul (vstd!arithmetic.power2.pow2.? (I 153)) (%I (vstd!seq.Seq.index.? $ (UINT
                    64
                   ) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. a!))
                   (I 3)
               ))))
               (=>
                (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add. k! tmp%13 tmp%14)
                (=>
                 (= tmp%15 (Add (Add (Add (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $
                        (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. a!)
                       ) (I 0)
                      )
                     ) (Mul (vstd!arithmetic.power2.pow2.? (I 51)) (%I (vstd!seq.Seq.index.? $ (UINT 64)
                 ...
                 (=>
                  (= tmp%16 (Mul (vstd!arithmetic.power2.pow2.? (I 204)) (%I (vstd!seq.Seq.index.? $ (UINT
                       64
                      ) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. a!))
                      (I 4)
                  ))))
                  (=>
                   (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add. k! tmp%15 tmp%16)
                   (=>
                    %%location_label%%1
                    (= (Add (Add (Add (Add (Mul k! (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                             $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. a!)
                            ) (I 0)
                          ))
                         ) (Mul k! (Mul (vstd!arithmetic.power2.pow2.? (I 51)) (%I (vstd!seq.Seq.index.? $ (UINT
                     ...
                     ) (Mul k! (Add (Add (Add (Add (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                             $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. a!)
                            ) (I 0)
                           )
                          ) (Mul (vstd!arithmetic.power2.pow2.? (I 51)) (%I (vstd!seq.Seq.index.? $ (UINT 64)
