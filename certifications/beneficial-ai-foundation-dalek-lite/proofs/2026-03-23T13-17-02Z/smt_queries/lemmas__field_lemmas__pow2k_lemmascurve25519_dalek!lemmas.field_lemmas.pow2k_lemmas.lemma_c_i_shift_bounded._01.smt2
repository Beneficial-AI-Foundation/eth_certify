...
;; curve25519-dalek/src/lemmas/field_lemmas/pow2k_lemmas.rs:171:1: 171:62 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::pow2k_lemmas::lemma_c_i_shift_bounded
;; curve25519-dalek/src/lemmas/field_lemmas/pow2k_lemmas.rs:171:1: 171:62 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= tmp%1 (curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.c0_val.? (Poly%array%. a!)))
    (and
     (=>
      %%location_label%%0
      (req%curve25519_dalek!lemmas.field_lemmas.pow2_51_lemmas.lemma_shr_51_fits_u64. tmp%1)
     )
     (=>
      (ens%curve25519_dalek!lemmas.field_lemmas.pow2_51_lemmas.lemma_shr_51_fits_u64. tmp%1)
      (=>
       (= tmp%2 (curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.c1_val.? (Poly%array%. a!)))
       (and
        (=>
         %%location_label%%1
         (req%curve25519_dalek!lemmas.field_lemmas.pow2_51_lemmas.lemma_shr_51_fits_u64. tmp%2)
        )
        (=>
         (ens%curve25519_dalek!lemmas.field_lemmas.pow2_51_lemmas.lemma_shr_51_fits_u64. tmp%2)
         (=>
          (= tmp%3 (curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.c2_val.? (Poly%array%. a!)))
          (and
           (=>
            %%location_label%%2
            (req%curve25519_dalek!lemmas.field_lemmas.pow2_51_lemmas.lemma_shr_51_fits_u64. tmp%3)
           )
           (=>
            (ens%curve25519_dalek!lemmas.field_lemmas.pow2_51_lemmas.lemma_shr_51_fits_u64. tmp%3)
            (=>
             (= tmp%4 (curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.c3_val.? (Poly%array%. a!)))
             (and
              (=>
               %%location_label%%3
               (req%curve25519_dalek!lemmas.field_lemmas.pow2_51_lemmas.lemma_shr_51_fits_u64. tmp%4)
              )
              (=>
               (ens%curve25519_dalek!lemmas.field_lemmas.pow2_51_lemmas.lemma_shr_51_fits_u64. tmp%4)
               (=>
                (= tmp%5 (curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.c4_val.? (Poly%array%. a!)))
                (and
                 (=>
                  %%location_label%%4
                  (req%curve25519_dalek!lemmas.field_lemmas.pow2_51_lemmas.lemma_shr_51_fits_u64. tmp%5)
                 )
                 (=>
                  (ens%curve25519_dalek!lemmas.field_lemmas.pow2_51_lemmas.lemma_shr_51_fits_u64. tmp%5)
                  (=>
                   %%location_label%%5
                   (curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.ci_val_boundaries.? (Poly%array%.
                     a!
