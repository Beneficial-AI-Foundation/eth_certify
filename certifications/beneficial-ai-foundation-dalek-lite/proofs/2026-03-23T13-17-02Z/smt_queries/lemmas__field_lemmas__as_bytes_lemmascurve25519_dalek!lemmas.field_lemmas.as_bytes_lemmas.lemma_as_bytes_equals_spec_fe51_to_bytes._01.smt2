...
;; curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:153:1: 153:93 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::as_bytes_lemmas::lemma_as_bytes_equals_spec_fe51_to_bytes
;; curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:153:1: 153:93 (#0)
     ...
     (=>
      ...
      (=>
       ...
       (and
        (=>
         %%location_label%%0
         (req%vstd!arithmetic.div_mod.lemma_mod_is_mod_recursive. tmp%1 tmp%2)
        )
        (=>
         (ens%vstd!arithmetic.div_mod.lemma_mod_is_mod_recursive. tmp%1 tmp%2)
         (=>
          %%location_label%%1
    ...
    (=>
     ...
     (and
      ...
      (=>
       ...
       (=>
        (= tmp%3 (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
             (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
           ))
          ) 32
        ))
        (and
         ...
         (=>
          tmp%3
          (=>
           (= tmp%4 (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!core_assumes.seq_from32.?
                (Poly%array%. bytes!)
              ))
             ) 32
           ))
             ...
             (and
              (=>
               ...
               (=>
                ...
                (=>
                 (= tmp%5 (= (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!core_assumes.seq_from32.?
                      (Poly%array%. bytes!)
                     )
                    ) i@
                   ) (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT
              ...
              (=>
               (forall ((i$ Poly)) (!
                 ...
                 :qid user_curve25519_dalek__lemmas__field_lemmas__as_bytes_lemmas__lemma_as_bytes_equals_spec_fe51_to_bytes_53
                 :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__as_bytes_lemmas__lemma_as_bytes_equals_spec_fe51_to_bytes_53
               ))
               (=>
                (= tmp%7 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!core_assumes.seq_from32.?
                    (Poly%array%. bytes!)
                   )
