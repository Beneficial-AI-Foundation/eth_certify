...
;; curve25519-dalek/src/lemmas/field_lemmas/compute_q_lemmas.rs:39:7: 50:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::compute_q_lemmas::lemma_radix51_telescoping_expansion
;; curve25519-dalek/src/lemmas/field_lemmas/compute_q_lemmas.rs:39:7: 50:2 (#0)
    ...
    (=>
     ...
     (=>
      ...
      (=>
       ...
       (=>
        (= lhs@ (Add (Add (Add (Add (Add (Sub (Add (Mul q0! (vstd!arithmetic.power2.pow2.? (I 51)))
                r0!
               ) 19
              ) (Mul (Sub (Add (Mul q1! (vstd!arithmetic.power2.pow2.? (I 51))) r1!) q0!) (vstd!arithmetic.power2.pow2.?
                (I 51)
        ...
        (and
         (=>
          ...
          (=>
           (= tmp%2 (Add (Mul q1! (vstd!arithmetic.power2.pow2.? (I 51))) r1!))
           (=>
            (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub_other_way. tmp%1 tmp%2 q0!)
            (=>
             (= tmp%3 (vstd!arithmetic.power2.pow2.? (I 51)))
             (=>
              (= tmp%4 (Mul q1! (vstd!arithmetic.power2.pow2.? (I 51))))
              (=>
               (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. tmp%3 tmp%4 r1!)
               (=>
                %%location_label%%0
                (= (Mul (Sub (Add (Mul q1! (vstd!arithmetic.power2.pow2.? (I 51))) r1!) q0!) (vstd!arithmetic.power2.pow2.?
                   (I 51)
         ...
         (=>
          ...
          (and
           (=>
            (= tmp%5 (vstd!arithmetic.power2.pow2.? (I 102)))
            (=>
             (= tmp%6 (Add (Mul q2! (vstd!arithmetic.power2.pow2.? (I 51))) r2!))
             (=>
              (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub_other_way. tmp%5 tmp%6 q1!)
              (=>
               (= tmp%7 (vstd!arithmetic.power2.pow2.? (I 102)))
               (=>
                (= tmp%8 (Mul q2! (vstd!arithmetic.power2.pow2.? (I 51))))
                (=>
                 (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. tmp%7 tmp%8 r2!)
                 (=>
                  %%location_label%%1
                  (= (Mul (Sub (Add (Mul q2! (vstd!arithmetic.power2.pow2.? (I 51))) r2!) q1!) (vstd!arithmetic.power2.pow2.?
                     (I 102)
           ...
           (=>
            ...
            (and
             (=>
              ...
              (=>
               (= tmp%10 (Add (Mul q3! (vstd!arithmetic.power2.pow2.? (I 51))) r3!))
               (=>
                (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub_other_way. tmp%9 tmp%10 q2!)
                (=>
                 (= tmp%11 (vstd!arithmetic.power2.pow2.? (I 153)))
                 (=>
                  (= tmp%12 (Mul q3! (vstd!arithmetic.power2.pow2.? (I 51))))
                  (=>
                   (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. tmp%11 tmp%12 r3!)
                   (=>
                    %%location_label%%2
                    (= (Mul (Sub (Add (Mul q3! (vstd!arithmetic.power2.pow2.? (I 51))) r3!) q2!) (vstd!arithmetic.power2.pow2.?
                       (I 153)
             ...
             (=>
              ...
              (and
               (=>
                (= tmp%13 (vstd!arithmetic.power2.pow2.? (I 204)))
                (=>
                 (= tmp%14 (Add (Mul q4! (vstd!arithmetic.power2.pow2.? (I 51))) r4!))
                 (=>
                  (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub_other_way. tmp%13 tmp%14 q3!)
                  (=>
                   (= tmp%15 (vstd!arithmetic.power2.pow2.? (I 204)))
                   (=>
                    (= tmp%16 (Mul q4! (vstd!arithmetic.power2.pow2.? (I 51))))
                    (=>
                     (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. tmp%15 tmp%16 r4!)
                     (=>
                      %%location_label%%3
                      (= (Mul (Sub (Add (Mul q4! (vstd!arithmetic.power2.pow2.? (I 51))) r4!) q3!) (vstd!arithmetic.power2.pow2.?
                         (I 204)
               ...
               (=>
                ...
                (and
                 (=>
                  ...
                  (=>
                   (= tmp%18 (vstd!arithmetic.power2.pow2.? (I 51)))
                   (=>
                    (ens%vstd!arithmetic.mul.lemma_mul_is_associative. q1! tmp%17 tmp%18)
                    (=>
                     %%location_label%%4
                     (= (Mul (Mul q1! (vstd!arithmetic.power2.pow2.? (I 51))) (vstd!arithmetic.power2.pow2.?
                        (I 51)
                       )
                      ) (Mul q1! (vstd!arithmetic.power2.pow2.? (I 102)))
                 )))))
                 (=>
                  ...
                  (and
                   (=>
                    (= tmp%19 (vstd!arithmetic.power2.pow2.? (I 51)))
                    (=>
                     (= tmp%20 (vstd!arithmetic.power2.pow2.? (I 102)))
                     (=>
                      (ens%vstd!arithmetic.mul.lemma_mul_is_associative. q2! tmp%19 tmp%20)
                      (=>
                       %%location_label%%5
                       (= (Mul (Mul q2! (vstd!arithmetic.power2.pow2.? (I 51))) (vstd!arithmetic.power2.pow2.?
                          (I 102)
                         )
                        ) (Mul q2! (vstd!arithmetic.power2.pow2.? (I 153)))
                   )))))
                   (=>
                    ...
                    (and
                     (=>
                      (= tmp%21 (vstd!arithmetic.power2.pow2.? (I 51)))
                      (=>
                       (= tmp%22 (vstd!arithmetic.power2.pow2.? (I 153)))
                       (=>
                        (ens%vstd!arithmetic.mul.lemma_mul_is_associative. q3! tmp%21 tmp%22)
                        (=>
                         %%location_label%%6
                         (= (Mul (Mul q3! (vstd!arithmetic.power2.pow2.? (I 51))) (vstd!arithmetic.power2.pow2.?
                            (I 153)
                           )
                          ) (Mul q3! (vstd!arithmetic.power2.pow2.? (I 204)))
                     )))))
