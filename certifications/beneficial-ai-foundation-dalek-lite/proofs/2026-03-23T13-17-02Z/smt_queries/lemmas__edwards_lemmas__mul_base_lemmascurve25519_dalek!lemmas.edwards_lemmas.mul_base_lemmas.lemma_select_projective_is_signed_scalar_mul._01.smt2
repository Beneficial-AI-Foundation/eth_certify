...
;; curve25519-dalek/src/lemmas/edwards_lemmas/mul_base_lemmas.rs:1132:1: 1137:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::mul_base_lemmas::lemma_select_projective_is_signed_scalar_mul
;; curve25519-dalek/src/lemmas/edwards_lemmas/mul_base_lemmas.rs:1132:1: 1137:2 (#0)
...
(push)
 ...
 (assert
  (has_type (Poly%curve25519_dalek!edwards.EdwardsPoint. P!) TYPE%curve25519_dalek!edwards.EdwardsPoint.)
 )
 (assert
  (let
   ((tmp%%$ x!))
 ...
 (assert
  (not (=>
    (= P_affine@ (curve25519_dalek!specs.edwards_specs.edwards_point_as_affine.? (Poly%curve25519_dalek!edwards.EdwardsPoint.
       P!
    )))
    (=>
     (fuel_bool fuel%curve25519_dalek!specs.edwards_specs.edwards_scalar_mul_signed.)
