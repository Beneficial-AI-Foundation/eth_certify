...
;; curve25519-dalek/src/lemmas/scalar_lemmas_/radix_2w_lemmas.rs:460:5: 460:11 (#0)
...
;; Function-Def curve25519_dalek::lemmas::scalar_lemmas_::radix_2w_lemmas::lemma_u64_shl_low_bits
;; curve25519-dalek/src/lemmas/scalar_lemmas_/radix_2w_lemmas.rs:460:5: 460:11 (#0)
...
(declare-const cross_u@ (_ BitVec 64))
(declare-const w_mask@ (_ BitVec 64))
(declare-const c_mask@ (_ BitVec 64))
(declare-const b! (_ BitVec 64))
(assert
 (bvugt k! ((_ zero_extend 63) (_ bv0 1)))
)
(assert
 (bvult k! ((_ zero_extend 57) (_ bv64 7)))
)
(assert
 (bvugt w! k!)
)
(assert
 (bvule w! ((_ zero_extend 60) (_ bv8 4)))
)
(assert
 (= cross_u@ (bvsub w! k!))
)
(assert
 (= w_mask@ (bvsub (bvshl ((_ zero_extend 63) (_ bv1 1)) w!) ((_ zero_extend 63) (_ bv1
     1
)))))
(assert
 (= c_mask@ (bvsub (bvshl ((_ zero_extend 63) (_ bv1 1)) cross_u@) ((_ zero_extend 63)
    (_ bv1 1)
))))
...
(assert
 (not (=>
   %%location_label%%0
   (= (bvand (bvshl b! k!) w_mask@) (bvshl (bvand b! c_mask@) k!))
)))
(get-info :version)
