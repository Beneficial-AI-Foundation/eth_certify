...
;; curve25519-dalek/src/lemmas/scalar_lemmas_/montgomery_reduce_part1_chain_lemmas.rs:65:1: 76:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::scalar_lemmas_::montgomery_reduce_part1_chain_lemmas::lemma_poly_mul_5x5_decomposition
;; curve25519-dalek/src/lemmas/scalar_lemmas_/montgomery_reduce_part1_chain_lemmas.rs:65:1: 76:2 (#0)
...
(push)
 ...
 (declare-const low_coeffs@ Int)
 (declare-const high_coeffs@ Int)
 (declare-const full@ Int)
 (assert
  fuel_defaults
 )
 (assert
          ...
          (=>
           ...
           (=>
            ...
            (=>
             ...
             (=>
              (ens%vstd!arithmetic.power2.lemma_pow2_adds. 260 104)
              (=>
               (ens%vstd!arithmetic.power2.lemma_pow2_adds. 260 156)
               (=>
                (= a@ (nClip (Add (nClip (Add (nClip (Add (nClip (Add a0! (nClip (Mul a1! (vstd!arithmetic.power2.pow2.?
                            (I 52)
                        ))))
                ...
                (=>
                 ...
                 (=>
                  ...
                  (=>
                   (= c1@ (nClip (Add (nClip (Mul a0! b1!)) (nClip (Mul a1! b0!)))))
                   (=>
                    (= c2@ (nClip (Add (nClip (Add (nClip (Mul a0! b2!)) (nClip (Mul a1! b1!)))) (nClip (
                         Mul a2! b0!
                    )))))
                    (=>
                     (= c3@ (nClip (Add (nClip (Add (nClip (Add (nClip (Mul a0! b3!)) (nClip (Mul a1! b2!))))
                     ...
                     (=>
                      (= c4@ (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip (Mul a0! b4!)) (nClip (Mul a1!
                                 b3!
                              )))
                             ) (nClip (Mul a2! b2!))
                            )
                      ...
                      (=>
                       ...
                       (=>
                        (= c6@ (nClip (Add (nClip (Add (nClip (Mul a2! b4!)) (nClip (Mul a3! b3!)))) (nClip (
                             Mul a4! b2!
                        )))))
                        (=>
                         (= c7@ (nClip (Add (nClip (Mul a3! b4!)) (nClip (Mul a4! b3!)))))
                         (=>
                          ...
                          (=>
                           ...
                           (=>
                            ...
                            (=>
                             (= full@ (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip
                                             (Add c0@ (nClip (Mul c1@ (vstd!arithmetic.power2.pow2.? (I 52)))))
                                            ) (nClip (Mul c2@ (vstd!arithmetic.power2.pow2.? (I 104))))
                                           )
                                          ) (nClip (Mul c3@ (vstd!arithmetic.power2.pow2.? (I 156))))
                                         )
                                      ...
                                      ) (nClip (Mul c5@ (vstd!arithmetic.power2.pow2.? (I 260))))
                                     )
                                    ) (nClip (Mul c6@ (vstd!arithmetic.power2.pow2.? (I 312))))
                                   )
                                  ) (nClip (Mul c7@ (vstd!arithmetic.power2.pow2.? (I 364))))
                                 )
                                ) (nClip (Mul c8@ (vstd!arithmetic.power2.pow2.? (I 416))))
                             )))
                             (and
                              (=>
                              ...
                              (=>
                               ...
                               (and
                                (=>
                                 (= tmp%1 (vstd!arithmetic.power2.pow2.? (I 260)))
                                 (=>
                                  (= tmp%2 (nClip (Add (nClip (Add (nClip (Mul c6@ (vstd!arithmetic.power2.pow2.? (I 52))))
                                       (nClip (Mul c7@ (vstd!arithmetic.power2.pow2.? (I 104))))
                                      )
                                     ) (nClip (Mul c8@ (vstd!arithmetic.power2.pow2.? (I 156))))
                                  )))
                                  (=>
                                   (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. tmp%1 c5@ tmp%2)
                                   (=>
                                    (= tmp%3 (vstd!arithmetic.power2.pow2.? (I 260)))
                                    (=>
                                     (= tmp%4 (nClip (Mul c6@ (vstd!arithmetic.power2.pow2.? (I 52)))))
                                     (=>
                                      (= tmp%5 (nClip (Add (nClip (Mul c7@ (vstd!arithmetic.power2.pow2.? (I 104)))) (nClip
                                          (Mul c8@ (vstd!arithmetic.power2.pow2.? (I 156)))
                                      ))))
                                      (=>
                                       (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. tmp%3 tmp%4 tmp%5)
                                       (=>
                                        (= tmp%6 (vstd!arithmetic.power2.pow2.? (I 260)))
                                        (=>
                                         (= tmp%7 (nClip (Mul c7@ (vstd!arithmetic.power2.pow2.? (I 104)))))
                                         (=>
                                          (= tmp%8 (nClip (Mul c8@ (vstd!arithmetic.power2.pow2.? (I 156)))))
                                          (=>
                                           (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. tmp%6 tmp%7 tmp%8)
                                           (and
                                            (=>
                                             ...
                                             (=>
                                              ...
                                              (=>
                                               ...
                                               (=>
                                                %%location_label%%1
                                                (= (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 52)) (vstd!arithmetic.power2.pow2.?
                                                    (I 260)
                                                  ))
                                            ...
                                            (=>
                                             ...
                                             (and
                                              (=>
                                               (= tmp%11 (vstd!arithmetic.power2.pow2.? (I 104)))
                                               (=>
                                                (= tmp%12 (vstd!arithmetic.power2.pow2.? (I 260)))
                                                (=>
                                                 (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. tmp%11 tmp%12)
                                                 (=>
                                                  %%location_label%%2
                                                  (= (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 104)) (vstd!arithmetic.power2.pow2.?
                                                      (I 260)
                                                    ))
                                              ...
                                              (=>
                                               ...
                                               (and
                                                (=>
                                                 (= tmp%13 (vstd!arithmetic.power2.pow2.? (I 156)))
                                                 (=>
                                                  ...
                                                  (=>
                                                   ...
                                                   (=>
                                                    %%location_label%%3
                                                    (= (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 156)) (vstd!arithmetic.power2.pow2.?
                                                        (I 260)
                                                      ))
                                                ...
                                                (=>
                                                 ...
                                                 (and
                                                  (=>
                                                   (= tmp%15 (vstd!arithmetic.power2.pow2.? (I 52)))
                                                   (=>
                                                    (= tmp%16 (vstd!arithmetic.power2.pow2.? (I 260)))
                                                    (=>
                                                     (ens%vstd!arithmetic.mul.lemma_mul_is_associative. c6@ tmp%15 tmp%16)
                                                     (=>
                                                      %%location_label%%4
                                                      (= (nClip (Mul (nClip (Mul c6@ (vstd!arithmetic.power2.pow2.? (I 52)))) (vstd!arithmetic.power2.pow2.?
                                                          (I 260)
                                                        ))
                                                       ) (nClip (Mul c6@ (vstd!arithmetic.power2.pow2.? (I 312))))
                                                  )))))
                                                  (=>
                                                   ...
                                                   (and
                                                    (=>
                                                     (= tmp%17 (vstd!arithmetic.power2.pow2.? (I 104)))
                                                     (=>
                                                      (= tmp%18 (vstd!arithmetic.power2.pow2.? (I 260)))
                                                      (=>
                                                       (ens%vstd!arithmetic.mul.lemma_mul_is_associative. c7@ tmp%17 tmp%18)
                                                       (=>
                                                        %%location_label%%5
                                                        (= (nClip (Mul (nClip (Mul c7@ (vstd!arithmetic.power2.pow2.? (I 104)))) (vstd!arithmetic.power2.pow2.?
                                                            (I 260)
                                                          ))
                                                         ) (nClip (Mul c7@ (vstd!arithmetic.power2.pow2.? (I 364))))
                                                    )))))
                                                     ...
                                                     (and
                                                      (=>
                                                       ...
                                                       (=>
                                                        ...
                                                        (=>
                                                         (ens%vstd!arithmetic.mul.lemma_mul_is_associative. c8@ tmp%19 tmp%20)
                                                         (=>
                                                          %%location_label%%6
                                                          (= (nClip (Mul (nClip (Mul c8@ (vstd!arithmetic.power2.pow2.? (I 156)))) (vstd!arithmetic.power2.pow2.?
                                                              (I 260)
                                                            ))
                                                           ) (nClip (Mul c8@ (vstd!arithmetic.power2.pow2.? (I 416))))
                                                      )))))
                                                      (=>
                                                       ...
                                                       (=>
                                                        %%location_label%%7
                                                        (= (nClip (Add (nClip (Add (nClip (Add (nClip (Mul c5@ (vstd!arithmetic.power2.pow2.? (I 260))))
                                                               (nClip (Mul c6@ (vstd!arithmetic.power2.pow2.? (I 312))))
                                                              )
                                                             ) (nClip (Mul c7@ (vstd!arithmetic.power2.pow2.? (I 364))))
                                                            )
                                                         ...
                                                         ) (nClip (Mul high_coeffs@ (vstd!arithmetic.power2.pow2.? (I 260))))
                                )))))))))))))))))))))))))
                                (=>
                                 (= (nClip (Add (nClip (Add (nClip (Add (nClip (Mul c5@ (vstd!arithmetic.power2.pow2.? (I 260))))
                                        (nClip (Mul c6@ (vstd!arithmetic.power2.pow2.? (I 312))))
                                 ...
                                 (=>
                                  (= tmp%21 (= (nClip (Mul a@ b@)) (nClip (Add low_coeffs@ (nClip (Mul high_coeffs@ (vstd!arithmetic.power2.pow2.?
                                         (I 260)
                                  )))))))
                                  (and
                                   (=>
