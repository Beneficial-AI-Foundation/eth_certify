...
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_ratio_lemmas.rs:117:7: 117:76 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::sqrt_ratio_lemmas::lemma_algebraic_chain_base
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_ratio_lemmas.rs:117:7: 117:76 (#0)
...
(push)
 ...
 (declare-const inv_v@ Int)
 (declare-const inv_x@ Int)
 (declare-const q@ Int)
 (declare-const q2@ Int)
 (declare-const iu@ Int)
 (declare-const r_squared_v@ Int)
 (declare-const inv_x2@ Int)
 (declare-const iu_times_inv_v@ Int)
 (declare-const inv_iu@ Int)
 (declare-const r_squared_v_times_inv_v@ Int)
 (declare-const r_squared_v_times_inv_iu@ Int)
 (assert
  fuel_defaults
 )
 (assert
 ...
 (assert
  (not (=>
    ...
    (=>
     ...
     (=>
      (= r2@ (curve25519_dalek!specs.field_specs.field_square.? (I r!)))
      (=>
       (= x2@ (curve25519_dalek!specs.field_specs.field_square.? (I x!)))
       (=>
        (= inv_v@ (curve25519_dalek!specs.field_specs.field_inv.? (I v!)))
        (=>
         (= inv_x@ (curve25519_dalek!specs.field_specs.field_inv.? (I x!)))
         (=>
          (= q@ (curve25519_dalek!specs.field_specs.field_mul.? (I r!) (I inv_x@)))
          (=>
           (= q2@ (curve25519_dalek!specs.field_specs.field_square.? (I q@)))
           (=>
            (= iu@ (curve25519_dalek!specs.field_specs.field_mul.? (I i!) (I u!)))
            (=>
             (= r_squared_v@ (curve25519_dalek!specs.field_specs.field_mul.? (I r2@) (I v!)))
             (=>
              (= inv_x2@ (curve25519_dalek!specs.field_specs.field_inv.? (I x2@)))
              (and
               (=>
                (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_quotient_of_squares.
                 r! x!
                ...
                (=>
                 %%location_label%%0
                 (= q2@ (curve25519_dalek!specs.field_specs.field_mul.? (I r2@) (I inv_x2@)))
               ))
               (=>
                (= q2@ (curve25519_dalek!specs.field_specs.field_mul.? (I r2@) (I inv_x2@)))
                (and
                 (=>
                  (= tmp%1 (nClip (Mul r2@ v!)))
                  (and
                   (=>
                    %%location_label%%1
                 ...
                 (=>
                  ...
                  (and
                   (and
                    (=>
                     %%location_label%%3
                     (req%vstd!arithmetic.div_mod.lemma_small_mod. r_squared_v@ p@)
                    )
                    (=>
                     (ens%vstd!arithmetic.div_mod.lemma_small_mod. r_squared_v@ p@)
                     (=>
                      (= tmp%2 (= (curve25519_dalek!specs.field_specs.field_mul.? (I r2@) (I v!)) (EucMod
                         r_squared_v@ p@
                      )))
                      (and
                       (=>
                       ...
                       (=>
                        ...
                        (and
                         ...
                         (=>
                          ...
                          (=>
                           %%location_label%%6
                           (= (EucMod r2@ p@) (curve25519_dalek!specs.field_specs.field_mul.? (I r_squared_v@)
                             (I inv_v@)
                   ))))))))))
                   (=>
                    (= (EucMod r2@ p@) (curve25519_dalek!specs.field_specs.field_mul.? (I r_squared_v@)
                     ...
                     (=>
                      ...
                      (and
                       ...
                       (=>
                        ...
                        (=>
                         (= tmp%4 (= (EucMod iu@ p@) (EucMod (nClip (Mul i! u!)) p@)))
                         (and
                          (=>
                           %%location_label%%8
                           tmp%4
                            ...
                            (=>
                             ...
                             (=>
                              ...
                              (and
                               (=>
                                %%location_label%%10
                                (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. tmp%5 inv_v@ p@)
                               )
                               (=>
                                (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. tmp%5 inv_v@ p@)
                                (=>
                                 %%location_label%%11
                                 (= (EucMod x2@ p@) (curve25519_dalek!specs.field_specs.field_mul.? (I iu@) (I inv_v@)))
                     ))))))))))))
                     (=>
                      (= (EucMod x2@ p@) (curve25519_dalek!specs.field_specs.field_mul.? (I iu@) (I inv_v@)))
                      (and
                         ...
                         (=>
                          ...
                          (=>
                           ...
                           (and
                            (=>
                             %%location_label%%13
                             (req%vstd!arithmetic.div_mod.lemma_mod_twice. tmp%7 p@)
                            )
                            (=>
                             (ens%vstd!arithmetic.div_mod.lemma_mod_twice. tmp%7 p@)
                             (or
                              (and
                               (=>
                                (= (EucMod (nClip (Mul i! u!)) p@) 0)
                                (=>
                       ...
                       (=>
                        ...
                        (and
                         (and
                          (=>
                           %%location_label%%17
                           (req%curve25519_dalek!specs.field_specs.field_inv_property. v!)
                          )
                          (=>
                           (ens%curve25519_dalek!specs.field_specs.field_inv_property. v!)
                           (and
                            (=>
                             %%location_label%%18
                             (req%vstd!arithmetic.div_mod.lemma_small_mod. inv_v@ p@)
                            )
                            (=>
                             (ens%vstd!arithmetic.div_mod.lemma_small_mod. inv_v@ p@)
                             (or
                              (and
                               (=>
                                (= inv_v@ 0)
                                (=>
                                 (= tmp%8 (= (EucMod (nClip (Mul (EucMod v! p@) 0)) p@) 0))
                                 (and
                                  (=>
                                   %%location_label%%19
                                   tmp%8
                              ...
                              (and
                               ...
                               (=>
                                %%location_label%%22
                                (not (= (EucMod inv_v@ p@) 0))
                         )))))))
                         (=>
                          (not (= (EucMod inv_v@ p@) 0))
                          (=>
                           (= iu_times_inv_v@ (curve25519_dalek!specs.field_specs.field_mul.? (I iu@) (I inv_v@)))
                           (and
                            (=>
                             (= tmp%9 (nClip (Mul x! x!)))
                             (and
                              (=>
                               %%location_label%%23
                               (req%vstd!arithmetic.div_mod.lemma_mod_twice. tmp%9 p@)
                              )
                              (=>
                               (ens%vstd!arithmetic.div_mod.lemma_mod_twice. tmp%9 p@)
                               (=>
                                %%location_label%%24
                                (= x2@ iu_times_inv_v@)
                            ))))
                             ...
                             (=>
                              ...
                              (and
                               (=>
                                ...
                                (=>
                                 (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_inv_of_inv. v!)
                                 (and
                                  (=>
                                   %%location_label%%25
                                   (req%vstd!arithmetic.div_mod.lemma_mod_bound. v! p@)
                                  )
                                  (=>
                                   (ens%vstd!arithmetic.div_mod.lemma_mod_bound. v! p@)
                                   (and
                                    (=>
                                     %%location_label%%26
                                     (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. inv_iu@ v! p@)
                                    )
                                    (=>
                                     (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. inv_iu@ v! p@)
                                     (=>
                                      %%location_label%%27
                                      (= inv_x2@ (curve25519_dalek!specs.field_specs.field_mul.? (I inv_iu@) (I v!)))
                               )))))))
                               (=>
                                (= inv_x2@ (curve25519_dalek!specs.field_specs.field_mul.? (I inv_iu@) (I v!)))
                                (=>
                                 (= r_squared_v_times_inv_v@ (curve25519_dalek!specs.field_specs.field_mul.? (I r_squared_v@)
                                   (I inv_v@)
                                 ))
                                 (and
                                  (=>
                                   (= tmp%10 (nClip (Mul r! r!)))
                                   (and
                                    (=>
                                     %%location_label%%28
                                     (req%vstd!arithmetic.div_mod.lemma_mod_twice. tmp%10 p@)
                                    )
                                    (=>
                                     (ens%vstd!arithmetic.div_mod.lemma_mod_twice. tmp%10 p@)
                                     (=>
                                      %%location_label%%29
                                      (= r2@ r_squared_v_times_inv_v@)
                                  ))))
                                  (=>
                                   (= r2@ r_squared_v_times_inv_v@)
                                   (=>
                                    (= r_squared_v_times_inv_iu@ (curve25519_dalek!specs.field_specs.field_mul.? (I r_squared_v@)
                                      (I inv_iu@)
                                    ))
                                    (and
                                     (and
                                      (and
                                       ...
                                       (=>
                                        ...
                                        (and
                                         (=>
                                          %%location_label%%31
                                          (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. v! inv_v@ p@)
                                         )
                                         (=>
                                          (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. v! inv_v@ p@)
                                          (=>
                                           (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_comm.
                                            inv_v@ v!
                                           )
                                           (=>
                                            %%location_label%%32
                                            (= (curve25519_dalek!specs.field_specs.field_mul.? (I inv_v@) (I v!)) 1)
                                      ))))))
                                      (=>
                                       (= (curve25519_dalek!specs.field_specs.field_mul.? (I inv_v@) (I v!)) 1)
                                       (=>
                                        (= tmp%11 (nClip (Mul r_squared_v@ inv_v@)))
                                        (=>
                                         (= tmp%12 (nClip (Mul inv_iu@ v!)))
                                         (and
                                          (=>
                                           %%location_label%%33
                                           (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop. tmp%11 tmp%12 p@)
                                          )
                                          (=>
                                           (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop. tmp%11 tmp%12 p@)
                                           (and
                                            (=>
                                             (= tmp%13 (nClip (Mul inv_iu@ v!)))
                                             (=>
                                              (ens%vstd!arithmetic.mul.lemma_mul_is_associative. r_squared_v@ inv_v@ tmp%13)
                                              (=>
                                               (ens%vstd!arithmetic.mul.lemma_mul_is_associative. inv_v@ inv_iu@ v!)
                                               (=>
                                                (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. inv_v@ inv_iu@)
                                                (=>
                                                 (ens%vstd!arithmetic.mul.lemma_mul_is_associative. inv_iu@ inv_v@ v!)
                                                 (=>
                                                  (= tmp%14 (nClip (Mul inv_v@ v!)))
                                                  (=>
                                                   (ens%vstd!arithmetic.mul.lemma_mul_is_associative. r_squared_v@ inv_iu@ tmp%14)
                                                   (=>
                                                    %%location_label%%34
                                                    (= (nClip (Mul (nClip (Mul r_squared_v@ inv_v@)) (nClip (Mul inv_iu@ v!)))) (nClip
                                                      (Mul (nClip (Mul r_squared_v@ inv_iu@)) (nClip (Mul inv_v@ v!)))
                                            ))))))))))
                                            (=>
                                             (= (nClip (Mul (nClip (Mul r_squared_v@ inv_v@)) (nClip (Mul inv_iu@ v!)))) (nClip
                                               (Mul (nClip (Mul r_squared_v@ inv_iu@)) (nClip (Mul inv_v@ v!)))
                                               ...
                                               (=>
                                                ...
                                                (and
                                                 ...
                                                 (=>
                                                  (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. v! inv_v@ p@)
                                                  (=>
                                                   (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. inv_v@ v!)
                                                   (=>
                                                    %%location_label%%37
                                                    (= (EucMod (nClip (Mul inv_v@ v!)) p@) 1)
                                              ))))))
                                              (=>
                                               (= (EucMod (nClip (Mul inv_v@ v!)) p@) 1)
                                               (and
                                                (=>
                                                 (= tmp%15 (nClip (Mul r_squared_v@ inv_iu@)))
                                                 (=>
                                                  (= tmp%16 (nClip (Mul inv_v@ v!)))
                                                  (and
                                                   (=>
                                                    %%location_label%%38
                                                    (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. tmp%15 tmp%16 p@)
                                                   )
                                                   (=>
                                                    (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. tmp%15 tmp%16 p@)
                                                    (=>
                                                     (= tmp%17 (nClip (Mul r_squared_v@ inv_iu@)))
                                                     (=>
                                                      (ens%vstd!arithmetic.mul.lemma_mul_basics. tmp%17)
                                                      (=>
                                                       %%location_label%%39
                                                       (= (EucMod (nClip (Mul (nClip (Mul r_squared_v@ inv_iu@)) (nClip (Mul inv_v@ v!))))
                                                         p@
                                                        ) (EucMod (nClip (Mul r_squared_v@ inv_iu@)) p@)
                                                ))))))))
                                                (=>
                                                 (= (EucMod (nClip (Mul (nClip (Mul r_squared_v@ inv_iu@)) (nClip (Mul inv_v@ v!))))
                                                   p@
