...
;; curve25519-dalek/src/lemmas/edwards_lemmas/straus_lemmas.rs:1248:1: 1253:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::straus_lemmas::lemma_straus_vt_correct
;; curve25519-dalek/src/lemmas/edwards_lemmas/straus_lemmas.rs:1248:1: 1253:2 (#0)
...
(push)
 ...
 (declare-const nafs! vstd!seq.Seq<vstd!seq.Seq<i8.>.>.)
 ...
 (declare-const nafs_prefix@ vstd!seq.Seq<vstd!seq.Seq<i8.>.>.)
 ...
 (declare-const naf_last@ vstd!seq.Seq<i8.>.)
 ...
 (assert
  (forall ((k$ Poly)) (!
    ...
    :qid user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_straus_vt_correct_84
    :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_straus_vt_correct_84
 )))
    ...
    (=>
     ...
     (or
       ...
       (=>
        ...
        (=>
         ...
         (=>
          ...
          (=>
           (= nafs_prefix@ (%Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>. (vstd!seq_lib.impl&%0.drop_last.?
              $ (TYPE%vstd!seq.Seq. $ (SINT 8)) (Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>. nafs!)
           )))
           (=>
             ...
             (and
              ...
              (=>
               (forall ((k$ Poly)) (!
                 ...
                 :qid user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_straus_vt_correct_80
                 :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_straus_vt_correct_80
               ))
               (and
                (=>
                 (has_type k$1@ INT)
                 (=>
                  ...
                  (=>
                   (= tmp%3 (ext_eq false (TYPE%vstd!seq.Seq. $ (SINT 8)) (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq.
                       $ (SINT 8)
                      ) (Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>. nafs_prefix@) k$1@
                     ) (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq. $ (SINT 8)) (Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>.
                       nafs!
                      ) k$1@
                   )))
                ...
                (=>
                 (forall ((k$ Poly)) (!
                     ...
                     (and
                      (and
                       (= (vstd!seq.Seq.len.? $ (SINT 8) (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq. $ (SINT
                          ...
                          ) (Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>. nafs_prefix@) k$
                         )
                        ) 256
                       )
                       (curve25519_dalek!specs.scalar_specs.is_valid_naf.? (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq.
                   ...
                   :qid user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_straus_vt_correct_81
                   :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_straus_vt_correct_81
                 ))
                 (and
                  (=>
                   %%location_label%%7
                  ...
                  (and
                   (=>
                    %%location_label%%8
                    (req%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_vt_correct.
                     scalars_prefix@ points_prefix@ pts_prefix@ nafs_prefix@
                   ))
                   (=>
                    (ens%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_vt_correct.
                     scalars_prefix@ points_prefix@ pts_prefix@ nafs_prefix@
                      ...
                      (and
                       ...
                       (=>
                        ...
                        (=>
                         ...
                         (=>
                          (= naf_last@ (%Poly%vstd!seq.Seq<i8.>. (vstd!seq.Seq.last.? $ (TYPE%vstd!seq.Seq. $ (
                               SINT 8
                              )
                             ) (Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>. nafs!)
                          )))
                          (and
                           (=>
                            %%location_label%%11
                            ...
                            (and
                             ...
                             (=>
                              ...
                              (=>
                               ...
                               (=>
                                (= tmp%5 (= (curve25519_dalek!specs.scalar_specs.reconstruct.? (Poly%vstd!seq.Seq<i8.>.
                                    naf_last@
                                   )
                                  ) scalar_nat@
                                ))
      ...
      (and
       ...
       (=>
        %%location_label%%14
        (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.straus_vt_partial.?
           (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. points_affine!) (Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>.
            nafs!
           ) (I 0)
          )
