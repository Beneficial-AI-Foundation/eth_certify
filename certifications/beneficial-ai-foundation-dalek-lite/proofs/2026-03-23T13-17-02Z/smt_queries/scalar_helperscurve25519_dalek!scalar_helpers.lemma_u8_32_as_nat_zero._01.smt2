...
;; curve25519-dalek/src/scalar_helpers.rs:27:1: 27:39 (#0)
...
;; Function-Def curve25519_dalek::scalar_helpers::lemma_u8_32_as_nat_zero
;; curve25519-dalek/src/scalar_helpers.rs:27:1: 27:39 (#0)
  ...
  (not (and
    (=>
     ...
     (=>
      (< i@ 32)
      (=>
       (= tmp%1 (vstd!arithmetic.power2.pow2.? (I (nClip (Mul i@ 8)))))
       (=>
        (ens%vstd!arithmetic.mul.lemma_mul_basics. tmp%1)
        (=>
         %%location_label%%0
    ...
    (=>
     (forall ((i$ Int)) (!
       ...
       :qid user_curve25519_dalek__scalar_helpers__lemma_u8_32_as_nat_zero_41
       :skolemid skolem_user_curve25519_dalek__scalar_helpers__lemma_u8_32_as_nat_zero_41
     ))
     (=>
      %%location_label%%1
      (= (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. (curve25519_dalek!scalar.Scalar./Scalar/bytes
          (%Poly%curve25519_dalek!scalar.Scalar. (Poly%curve25519_dalek!scalar.Scalar. curve25519_dalek!scalar.impl&%50.ZERO.?))
        ))
       ) 0
 ))))))
 (get-info :version)
