...
;; curve25519-dalek/src/lemmas/scalar_lemmas_/radix_2w_lemmas.rs:46:1: 46:73 (#0)
...
;; Function-Def curve25519_dalek::lemmas::scalar_lemmas_::radix_2w_lemmas::lemma_u64x4_mod_strip_above
;; curve25519-dalek/src/lemmas/scalar_lemmas_/radix_2w_lemmas.rs:46:1: 46:73 (#0)
(get-info :all-statistics)
(push)
 (declare-const words! %%Function%%)
 (declare-const boundary! Int)
 ...
 (declare-const partial@ Int)
 (declare-const r64@ Int)
 ...
 (declare-const partial$1@ Int)
 (declare-const r128$1@ Int)
 (declare-const r192$1@ Int)
 (declare-const w2i$1@ Int)
 (declare-const w3i$1@ Int)
 (declare-const upper$1@ Int)
 (declare-const tmp%12 Int)
 (declare-const tmp%13 Int)
 (declare-const partial$2@ Int)
 (declare-const r192$2@ Int)
 ...
 (assert
  (not (=>
    ...
    (=>
     (= pb@ (vstd!arithmetic.power2.pow2.? (I boundary!)))
     (=>
      (ens%vstd!arithmetic.power2.lemma_pow2_pos. boundary!)
      (or
       (and
        (=>
         (<= boundary! 64)
         (=>
          (= partial@ (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT
                64
               ) $ (CONST_INT 4)
              ) (Poly%array%. words!)
             ) (I 0)
          ...
          (=>
           (= tmp%1 (nClip (Sub 64 boundary!)))
           (=>
            (ens%vstd!arithmetic.power2.lemma_pow2_adds. tmp%1 boundary!)
            (=>
             (= tmp%2 (nClip (Sub 128 boundary!)))
             (=>
              (ens%vstd!arithmetic.power2.lemma_pow2_adds. tmp%2 boundary!)
              (=>
               (= tmp%3 (nClip (Sub 192 boundary!)))
               (=>
                (ens%vstd!arithmetic.power2.lemma_pow2_adds. tmp%3 boundary!)
                (=>
                 (= r64@ (vstd!arithmetic.power2.pow2.? (I (nClip (Sub 64 boundary!)))))
                 (=>
                  (= r128@ (vstd!arithmetic.power2.pow2.? (I (nClip (Sub 128 boundary!)))))
                  (=>
                   (= r192@ (vstd!arithmetic.power2.pow2.? (I (nClip (Sub 192 boundary!)))))
                   (=>
                    ...
                    (=>
                     ...
                     (=>
                      ...
                      (and
                       (=>
                        (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. pb@ r64@)
                        (=>
                         (ens%vstd!arithmetic.mul.lemma_mul_is_associative. w1i@ r64@ pb@)
                         (=>
                          %%location_label%%0
                          (= (Mul w1i@ (vstd!arithmetic.power2.pow2.? (I 64))) (Mul (Mul w1i@ r64@) pb@))
                       )))
                       (=>
                        (= (Mul w1i@ (vstd!arithmetic.power2.pow2.? (I 64))) (Mul (Mul w1i@ r64@) pb@))
                        (and
                         (=>
                          (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. pb@ r128@)
                          (=>
                           (ens%vstd!arithmetic.mul.lemma_mul_is_associative. w2i@ r128@ pb@)
                           (=>
                            %%location_label%%1
                            (= (Mul w2i@ (vstd!arithmetic.power2.pow2.? (I 128))) (Mul (Mul w2i@ r128@) pb@))
                         )))
                         (=>
                          (= (Mul w2i@ (vstd!arithmetic.power2.pow2.? (I 128))) (Mul (Mul w2i@ r128@) pb@))
                          (and
                           (=>
                            (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. pb@ r192@)
                            (=>
                             (ens%vstd!arithmetic.mul.lemma_mul_is_associative. w3i@ r192@ pb@)
                             (=>
                              %%location_label%%2
                              (= (Mul w3i@ (vstd!arithmetic.power2.pow2.? (I 192))) (Mul (Mul w3i@ r192@) pb@))
                           )))
                           (=>
                            (= (Mul w3i@ (vstd!arithmetic.power2.pow2.? (I 192))) (Mul (Mul w3i@ r192@) pb@))
                            (=>
                             (= upper@ (Add (Add (Mul w1i@ r64@) (Mul w2i@ r128@)) (Mul w3i@ r192@)))
                             (and
                              (=>
                               (= tmp%4 (Mul w1i@ r64@))
                               (=>
                                (= tmp%5 (Add (Mul w2i@ r128@) (Mul w3i@ r192@)))
                                (=>
                                 (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. pb@ tmp%4 tmp%5)
                                 (=>
                                  (= tmp%6 (Mul w2i@ r128@))
                                  (=>
                                   (= tmp%7 (Mul w3i@ r192@))
                                   (=>
                                    (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. pb@ tmp%6 tmp%7)
                                    (=>
                                     %%location_label%%3
                                     (= (Add (Add (Mul (Mul w1i@ r64@) pb@) (Mul (Mul w2i@ r128@) pb@)) (Mul (Mul w3i@ r192@)
                                        pb@
                                       )
                                      ) (Mul upper@ pb@)
                              ))))))))
                              (=>
                               ...
                               (and
                                (=>
                                 %%location_label%%4
                                 (req%curve25519_dalek!lemmas.common_lemmas.div_mod_lemmas.lemma_mod_sum_factor. upper@
                                  partial@ pb@
                                ))
                                (=>
                                 (ens%curve25519_dalek!lemmas.common_lemmas.div_mod_lemmas.lemma_mod_sum_factor. upper@
                                  partial@ pb@
                                 )
                                 %%switch_label%%0
        )))))))))))))))))))))))))
         ...
         (or
          (and
           (=>
            (<= boundary! 128)
            (=>
             (= partial$1@ (nClip (Add (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
             ...
             (=>
              (= tmp%8 (nClip (Sub 128 boundary!)))
              (=>
               (ens%vstd!arithmetic.power2.lemma_pow2_adds. tmp%8 boundary!)
               (=>
                (= tmp%9 (nClip (Sub 192 boundary!)))
                (=>
                 (ens%vstd!arithmetic.power2.lemma_pow2_adds. tmp%9 boundary!)
                 (=>
                  (= r128$1@ (vstd!arithmetic.power2.pow2.? (I (nClip (Sub 128 boundary!)))))
                  (=>
                   (= r192$1@ (vstd!arithmetic.power2.pow2.? (I (nClip (Sub 192 boundary!)))))
                   (=>
                    ...
                    (=>
                     ...
                     (and
                      (=>
                       (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. pb@ r128$1@)
                       (=>
                        (ens%vstd!arithmetic.mul.lemma_mul_is_associative. w2i$1@ r128$1@ pb@)
                        (=>
                         %%location_label%%5
                         (= (Mul w2i$1@ (vstd!arithmetic.power2.pow2.? (I 128))) (Mul (Mul w2i$1@ r128$1@) pb@))
                      )))
                      (=>
                       (= (Mul w2i$1@ (vstd!arithmetic.power2.pow2.? (I 128))) (Mul (Mul w2i$1@ r128$1@) pb@))
                       (and
                        (=>
                         (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. pb@ r192$1@)
                         (=>
                          (ens%vstd!arithmetic.mul.lemma_mul_is_associative. w3i$1@ r192$1@ pb@)
                          (=>
                           %%location_label%%6
                           (= (Mul w3i$1@ (vstd!arithmetic.power2.pow2.? (I 192))) (Mul (Mul w3i$1@ r192$1@) pb@))
                        )))
                        (=>
                         (= (Mul w3i$1@ (vstd!arithmetic.power2.pow2.? (I 192))) (Mul (Mul w3i$1@ r192$1@) pb@))
                         (=>
                          (= upper$1@ (Add (Mul w2i$1@ r128$1@) (Mul w3i$1@ r192$1@)))
                          (and
                           (=>
                            (= tmp%10 (Mul w2i$1@ r128$1@))
                            (=>
                             (= tmp%11 (Mul w3i$1@ r192$1@))
                             (=>
                              (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. pb@ tmp%10 tmp%11)
                              (=>
                               %%location_label%%7
                               (= (Add (Mul (Mul w2i$1@ r128$1@) pb@) (Mul (Mul w3i$1@ r192$1@) pb@)) (Mul upper$1@
                                 pb@
                           ))))))
                           (=>
                            (= (Add (Mul (Mul w2i$1@ r128$1@) pb@) (Mul (Mul w3i$1@ r192$1@) pb@)) (Mul upper$1@
                            ...
                            (and
                             (=>
                              %%location_label%%8
                              (req%curve25519_dalek!lemmas.common_lemmas.div_mod_lemmas.lemma_mod_sum_factor. upper$1@
                               partial$1@ pb@
                             ))
                             (=>
                              (ens%curve25519_dalek!lemmas.common_lemmas.div_mod_lemmas.lemma_mod_sum_factor. upper$1@
                               partial$1@ pb@
                              )
                              %%switch_label%%1
           )))))))))))))))))))
            ...
            (or
             (and
              (=>
               (<= boundary! 192)
               (=>
                (= partial$2@ (nClip (Add (nClip (Add (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                        $ (ARRAY $ (UINT 64) $ (CONST_INT 4)) (Poly%array%. words!)
                       ) (I 0)
                      )
                     ) (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (
                ...
                (=>
                 (= tmp%12 (nClip (Sub 192 boundary!)))
                 (=>
                  (ens%vstd!arithmetic.power2.lemma_pow2_adds. tmp%12 boundary!)
                  (=>
                   (= r192$2@ (vstd!arithmetic.power2.pow2.? (I (nClip (Sub 192 boundary!)))))
                   (=>
                    ...
                    (and
                     (=>
                      (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. pb@ r192$2@)
                      (=>
                       (ens%vstd!arithmetic.mul.lemma_mul_is_associative. w3i$2@ r192$2@ pb@)
                       (=>
                        %%location_label%%9
                        (= (Mul w3i$2@ (vstd!arithmetic.power2.pow2.? (I 192))) (Mul (Mul w3i$2@ r192$2@) pb@))
                     )))
                     (=>
                      (= (Mul w3i$2@ (vstd!arithmetic.power2.pow2.? (I 192))) (Mul (Mul w3i$2@ r192$2@) pb@))
                      (=>
                       (= tmp%13 (Mul w3i$2@ r192$2@))
                       (and
                        (=>
                         %%location_label%%10
                         (req%curve25519_dalek!lemmas.common_lemmas.div_mod_lemmas.lemma_mod_sum_factor. tmp%13
                          partial$2@ pb@
                        ))
                        (=>
                         (ens%curve25519_dalek!lemmas.common_lemmas.div_mod_lemmas.lemma_mod_sum_factor. tmp%13
                          partial$2@ pb@
                         )
                         %%switch_label%%2
              )))))))))))
