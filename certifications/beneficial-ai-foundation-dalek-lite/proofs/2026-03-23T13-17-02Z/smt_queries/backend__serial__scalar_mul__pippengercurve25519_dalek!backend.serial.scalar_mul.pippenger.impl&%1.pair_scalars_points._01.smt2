...
;; MODULE 'module backend::serial::scalar_mul::pippenger'
;; curve25519-dalek/src/backend/serial/scalar_mul/pippenger.rs:614:9: 614:28 (#3446)
...
(declare-const fuel%vstd!std_specs.ops.impl&%51.obeys_sub_spec. FuelId)
(declare-const fuel%vstd!std_specs.ops.impl&%51.sub_req. FuelId)
(declare-const fuel%vstd!std_specs.ops.impl&%51.sub_spec. FuelId)
...
(assert
 (distinct fuel%vstd!arithmetic.power2.lemma_pow2_pos. fuel%vstd!std_specs.ops.impl&%31.obeys_add_spec.
  ...
  fuel%vstd!std_specs.ops.impl&%35.add_spec. fuel%vstd!std_specs.ops.impl&%38.obeys_add_spec.
  fuel%vstd!std_specs.ops.impl&%38.add_req. fuel%vstd!std_specs.ops.impl&%38.add_spec.
  fuel%vstd!std_specs.ops.impl&%39.obeys_add_spec. fuel%vstd!std_specs.ops.impl&%39.add_req.
  fuel%vstd!std_specs.ops.impl&%39.add_spec. fuel%vstd!std_specs.ops.impl&%40.obeys_add_spec.
  ...
  fuel%vstd!std_specs.ops.impl&%50.sub_spec. fuel%vstd!std_specs.ops.impl&%51.obeys_sub_spec.
  fuel%vstd!std_specs.ops.impl&%51.sub_req. fuel%vstd!std_specs.ops.impl&%51.sub_spec.
  fuel%vstd!std_specs.ops.impl&%52.obeys_sub_spec. fuel%vstd!std_specs.ops.impl&%52.sub_req.
  fuel%vstd!std_specs.ops.impl&%52.sub_spec. fuel%vstd!std_specs.option.impl&%0.arrow_0.
  fuel%vstd!std_specs.option.is_some. fuel%vstd!std_specs.option.spec_unwrap. fuel%vstd!std_specs.vec.axiom_spec_len.
  ...
  fuel%vstd!seq.impl&%0.spec_index. fuel%vstd!seq.impl&%0.take. fuel%vstd!seq.impl&%0.skip.
  ...
  fuel%vstd!view.impl&%30.view. fuel%vstd!view.impl&%32.view. fuel%vstd!view.impl&%44.view.
  ...
  fuel%curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.pippenger_horner. fuel%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.straus_column_sum.
  ...
  fuel%curve25519_dalek!specs.edwards_specs.is_valid_completed_point. fuel%curve25519_dalek!specs.edwards_specs.completed_to_extended.
  ...
  fuel%curve25519_dalek!specs.edwards_specs.sum_of_scalar_muls. fuel%curve25519_dalek!specs.edwards_specs.points_to_affine.
  ...
  fuel%curve25519_dalek!specs.field_specs_u64.spec_reduce. fuel%curve25519_dalek!specs.iterator_specs.all_points_some.
...
(assert
 (= (proj%%core!ops.arith.Sub./Output (REF $) (SINT 16) $ (SINT 16)) $)
)
(assert
 (= (proj%core!ops.arith.Sub./Output (REF $) (SINT 16) $ (SINT 16)) (SINT 16))
)
(assert
 (= (proj%%core!ops.arith.Sub./Output (REF $) (SINT 16) (REF $) (SINT 16)) $)
)
(assert
 (= (proj%core!ops.arith.Sub./Output (REF $) (SINT 16) (REF $) (SINT 16)) (SINT 16))
)
(assert
...
(assert
 (= (proj%%core!ops.arith.Sub./Output $ (SINT 16) $ (SINT 16)) $)
)
(assert
 (= (proj%core!ops.arith.Sub./Output $ (SINT 16) $ (SINT 16)) (SINT 16))
)
(assert
 (= (proj%%core!ops.arith.Sub./Output $ (SINT 16) (REF $) (SINT 16)) $)
)
(assert
 (= (proj%core!ops.arith.Sub./Output $ (SINT 16) (REF $) (SINT 16)) (SINT 16))
)
(assert
...
(assert
 (=>
  ...
  (forall ((T&. Dcr) (T& Type) (N&. Dcr) (N& Type) (array! Poly) (i! Poly)) (!
    ...
    :qid user_vstd__array__axiom_array_has_resolved_26
    :skolemid skolem_user_vstd__array__axiom_array_has_resolved_26
))))
...
(assert
 (=>
  ...
  (forall ((T&. Dcr) (T& Type) (A&. Dcr) (A& Type) (v! Poly)) (!
    ...
    :pattern ((vstd!std_specs.vec.spec_vec_len.? T&. T& A&. A& v!))
    :qid user_vstd__std_specs__vec__axiom_spec_len_29
    :skolemid skolem_user_vstd__std_specs__vec__axiom_spec_len_29
))))
...
(assert
 (=>
  ...
  (forall ((T&. Dcr) (T& Type) (vec! Poly) (i! Poly)) (!
    ...
    :qid user_vstd__std_specs__vec__axiom_vec_has_resolved_30
    :skolemid skolem_user_vstd__std_specs__vec__axiom_vec_has_resolved_30
))))
...
(assert
 (=>
  ...
  (forall ((e! Poly)) (!
    ...
    :pattern ((vstd!arithmetic.power2.pow2.? e!))
    :qid user_vstd__arithmetic__power2__lemma_pow2_pos_31
    :skolemid skolem_user_vstd__arithmetic__power2__lemma_pow2_pos_31
))))
...
;; Function-Specs vstd::pervasive::impl&%1::set
(declare-fun req%vstd!pervasive.impl&%1.set. (Dcr Type Poly Int Poly) Bool)
(declare-const %%global_location_label%%13 Bool)
(assert
 (forall ((T&. Dcr) (T& Type) (pre%self! Poly) (i! Int) (value! Poly)) (!
   (= (req%vstd!pervasive.impl&%1.set. T&. T& pre%self! i! value!) (=>
     %%global_location_label%%13
     (< i! (vstd!std_specs.vec.spec_vec_len.? T&. T& $ ALLOCATOR_GLOBAL pre%self!))
   ))
   :pattern ((req%vstd!pervasive.impl&%1.set. T&. T& pre%self! i! value!))
   :qid internal_req__vstd!pervasive.impl&__1.set._definition
   :skolemid skolem_internal_req__vstd!pervasive.impl&__1.set._definition
)))
(declare-fun ens%vstd!pervasive.impl&%1.set. (Dcr Type Poly Poly Int Poly) Bool)
(assert
 (forall ((T&. Dcr) (T& Type) (pre%self! Poly) (self! Poly) (i! Int) (value! Poly))
  (!
   (= (ens%vstd!pervasive.impl&%1.set. T&. T& pre%self! self! i! value!) (and
     (has_type self! (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL))
     (= (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $ ALLOCATOR_GLOBAL) self!)
      (vstd!seq.Seq.update.? T&. T& (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. T&. T& $
         ALLOCATOR_GLOBAL
        ) pre%self!
       ) (I i!) value!
   ))))
   :pattern ((ens%vstd!pervasive.impl&%1.set. T&. T& pre%self! self! i! value!))
   :qid internal_ens__vstd!pervasive.impl&__1.set._definition
   :skolemid skolem_internal_ens__vstd!pervasive.impl&__1.set._definition
)))
  ...
  (!
   (= (ens%curve25519_dalek!specs.iterator_specs.collect_scalars_from_iter. S&. S& I&.
     ...
     (forall ((i$ Poly)) (!
       ...
       :qid user_curve25519_dalek__specs__iterator_specs__collect_scalars_from_iter_33
       :skolemid skolem_user_curve25519_dalek__specs__iterator_specs__collect_scalars_from_iter_33
   ))))
  ...
  (forall ((fe1! Poly) (fe2! Poly) (bound! Poly)) (!
    (= (curve25519_dalek!specs.field_specs.sum_of_limbs_bounded.? fe1! fe2! bound!) (forall
      ((i$ Poly)) (!
       ...
       :qid user_curve25519_dalek__specs__field_specs__sum_of_limbs_bounded_34
       :skolemid skolem_user_curve25519_dalek__specs__field_specs__sum_of_limbs_bounded_34
    )))
...
;; Function-Axioms vstd::std_specs::ops::impl&%51::obeys_sub_spec
(assert
 (fuel_bool_default fuel%vstd!std_specs.ops.impl&%51.obeys_sub_spec.)
)
(assert
 (=>
  (fuel_bool fuel%vstd!std_specs.ops.impl&%51.obeys_sub_spec.)
  (= (vstd!std_specs.ops.SubSpec.obeys_sub_spec.? $ (SINT 16) $ (SINT 16)) (B true))
))

;; Function-Axioms vstd::std_specs::ops::impl&%51::sub_req
(assert
 (fuel_bool_default fuel%vstd!std_specs.ops.impl&%51.sub_req.)
)
(assert
 (=>
  (fuel_bool fuel%vstd!std_specs.ops.impl&%51.sub_req.)
  (forall ((self! Poly) (rhs! Poly)) (!
    (= (vstd!std_specs.ops.SubSpec.sub_req.? $ (SINT 16) $ (SINT 16) self! rhs!) (B (= (
        iClip 16 (Sub (%I self!) (%I rhs!))
       ) (Sub (%I self!) (%I rhs!))
    )))
    :pattern ((vstd!std_specs.ops.SubSpec.sub_req.? $ (SINT 16) $ (SINT 16) self! rhs!))
    :qid internal_vstd!std_specs.ops.SubSpec.sub_req.?_definition
    :skolemid skolem_internal_vstd!std_specs.ops.SubSpec.sub_req.?_definition
))))

;; Function-Axioms vstd::std_specs::ops::impl&%51::sub_spec
(assert
 (fuel_bool_default fuel%vstd!std_specs.ops.impl&%51.sub_spec.)
)
(assert
 (=>
  (fuel_bool fuel%vstd!std_specs.ops.impl&%51.sub_spec.)
  (forall ((self! Poly) (rhs! Poly)) (!
    (= (vstd!std_specs.ops.SubSpec.sub_spec.? $ (SINT 16) $ (SINT 16) self! rhs!) (I (iClip
       16 (Sub (%I self!) (%I rhs!))
    )))
    :pattern ((vstd!std_specs.ops.SubSpec.sub_spec.? $ (SINT 16) $ (SINT 16) self! rhs!))
    :qid internal_vstd!std_specs.ops.SubSpec.sub_spec.?_definition
    :skolemid skolem_internal_vstd!std_specs.ops.SubSpec.sub_spec.?_definition
))))
...
(assert
 (forall ((%%hole%%0 Dcr) (%%hole%%1 Type) (%%hole%%2 Poly) (i$ Poly)) (!
   (= (%%apply%%0 (%%lambda%%2 %%hole%%0 %%hole%%1 %%hole%%2) i$) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.projective_niels_point_as_affine_edwards.?
      (tuple%2./tuple%2/1 (%Poly%tuple%2. (vstd!seq.Seq.index.? %%hole%%0 %%hole%%1 %%hole%%2
         i$
   ))))))
   :pattern ((%%apply%%0 (%%lambda%%2 %%hole%%0 %%hole%%1 %%hole%%2) i$))
)))
(assert
 (=>
...
(declare-fun %%lambda%%3 (Dcr Type Poly Dcr Type) %%Function%%)
(assert
  ...
  (forall ((sp! Poly)) (!
    (= (curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.sp_digits_seqs.? sp!)
     (%Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>. (vstd!seq.Seq.new.? $ (TYPE%vstd!seq.Seq. $
       ...
       ) (Poly%fun%1. (mk_fun (%%lambda%%3 (DST $) (TYPE%tuple%2. $ (ARRAY $ (SINT 8) $ (CONST_INT
             64
            )
           ) $ TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
    ...
    (= (curve25519_dalek!specs.scalar_specs.is_valid_radix_2w.? digits! w! digits_count!)
     (and
      ...
      (forall ((i$ Poly)) (!
        ...
        :qid user_curve25519_dalek__specs__scalar_specs__is_valid_radix_2w_35
        :skolemid skolem_user_curve25519_dalek__specs__scalar_specs__is_valid_radix_2w_35
    ))))
  ...
  (forall ((niels! Poly)) (!
    (= (curve25519_dalek!specs.edwards_specs.is_valid_projective_niels_point.? niels!)
     (exists ((point$ Poly)) (!
       ...
       :qid user_curve25519_dalek__specs__edwards_specs__is_valid_projective_niels_point_36
       :skolemid skolem_user_curve25519_dalek__specs__edwards_specs__is_valid_projective_niels_point_36
    )))
            ...
            (and
             (and
              ...
              (forall ((k$ Poly)) (!
                ...
                :qid user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__pippenger_input_valid_38
                :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__pippenger_input_valid_38
             )))
             (forall ((k$ Poly)) (!
               (=>
                (has_type k$ INT)
               ...
               :qid user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__pippenger_input_valid_39
               :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__pippenger_input_valid_39
            )))
            (forall ((k$ Poly)) (!
              (=>
               (has_type k$ INT)
              ...
              :qid user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__pippenger_input_valid_40
              :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__pippenger_input_valid_40
           )))
           (forall ((k$ Poly)) (!
             (=>
              (has_type k$ INT)
             ...
             :qid user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__pippenger_input_valid_41
             :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__pippenger_input_valid_41
          )))
          (forall ((k$ Poly)) (!
            (=>
             (has_type k$ INT)
            ...
            :qid user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__pippenger_input_valid_42
            :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__pippenger_input_valid_42
         )))
         (forall ((k$ Poly)) (!
           (=>
            (has_type k$ INT)
           ...
           :qid user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__pippenger_input_valid_43
           :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__pippenger_input_valid_43
        )))
        (forall ((k$ Poly)) (!
          (=>
           (has_type k$ INT)
          ...
          :qid user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__pippenger_input_valid_44
          :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__pippenger_input_valid_44
       )))
       (forall ((k$ Poly)) (!
         (=>
          (has_type k$ INT)
         ...
         :qid user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__pippenger_input_valid_45
         :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__pippenger_input_valid_45
    )))))
  ...
  (forall ((niels! Poly)) (!
    (= (curve25519_dalek!specs.edwards_specs.is_valid_affine_niels_point.? niels!) (exists
      ((point$ Poly)) (!
       ...
       :qid user_curve25519_dalek__specs__edwards_specs__is_valid_affine_niels_point_46
       :skolemid skolem_user_curve25519_dalek__specs__edwards_specs__is_valid_affine_niels_point_46
    )))
...
(assert
 (forall ((_i$ Poly) (p$ Poly)) (!
   (= (%%apply%%1 %%lambda%%4 _i$ p$) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_point_as_affine.?
      p$
   )))
   :pattern ((%%apply%%1 %%lambda%%4 _i$ p$))
)))
(assert
 (=>
  ...
  (forall ((points! Poly)) (!
    (= (curve25519_dalek!specs.edwards_specs.points_to_affine.? points!) (%Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>.
      (vstd!seq_lib.impl&%0.map.? $ TYPE%curve25519_dalek!edwards.EdwardsPoint. (DST $)
       (TYPE%tuple%2. $ NAT $ NAT) points! (Poly%fun%2. (mk_fun %%lambda%%4))
    )))
  ...
  (forall ((points! Poly)) (!
    (= (curve25519_dalek!specs.iterator_specs.all_points_some.? points!) (forall ((i$ Poly))
      (!
       ...
       :qid user_curve25519_dalek__specs__iterator_specs__all_points_some_47
       :skolemid skolem_user_curve25519_dalek__specs__iterator_specs__all_points_some_47
    )))
...
(assert
 (forall ((%%hole%%0 Dcr) (%%hole%%1 Type) (_i$ Poly) (opt$ Poly)) (!
   (= (%%apply%%1 (%%lambda%%5 %%hole%%0 %%hole%%1) _i$ opt$) (core!option.Option./Some/0
     %%hole%%0 %%hole%%1 (%Poly%core!option.Option. opt$)
   ))
   :pattern ((%%apply%%1 (%%lambda%%5 %%hole%%0 %%hole%%1) _i$ opt$))
)))
(assert
 (=>
  ...
  (forall ((points! Poly)) (!
    (= (curve25519_dalek!specs.iterator_specs.unwrap_points.? points!) (%Poly%vstd!seq.Seq<curve25519_dalek!edwards.EdwardsPoint.>.
      (vstd!seq_lib.impl&%0.map.? $ (TYPE%core!option.Option. $ TYPE%curve25519_dalek!edwards.EdwardsPoint.)
       $ TYPE%curve25519_dalek!edwards.EdwardsPoint. points! (Poly%fun%2. (mk_fun (%%lambda%%5
          $ TYPE%curve25519_dalek!edwards.EdwardsPoint.
    ))))))
...
;; Trait-Impl-Axiom
(assert
 (tr_bound%core!ops.arith.Sub. $ (SINT 16) $ (SINT 16))
)

;; Trait-Impl-Axiom
(assert
 (tr_bound%vstd!std_specs.ops.SubSpec. $ (SINT 16) $ (SINT 16))
)
...
;; Trait-Impl-Axiom
(assert
 (tr_bound%core!ops.arith.Sub. (REF $) (SINT 16) $ (SINT 16))
)

;; Trait-Impl-Axiom
(assert
 (tr_bound%core!ops.arith.Sub. (REF $) (SINT 16) (REF $) (SINT 16))
)
...
;; Trait-Impl-Axiom
(assert
 (tr_bound%core!ops.arith.Sub. $ (SINT 16) (REF $) (SINT 16))
)
...
;; Function-Specs curve25519_dalek::scalar::Scalar::as_radix_2w
(declare-fun req%curve25519_dalek!scalar.impl&%52.as_radix_2w. (curve25519_dalek!scalar.Scalar.
  Int
 ) Bool
)
...
(assert
 (forall ((self! curve25519_dalek!scalar.Scalar.) (w! Int)) (!
   (= (req%curve25519_dalek!scalar.impl&%52.as_radix_2w. self! w!) (and
     (=>
   ...
   :pattern ((req%curve25519_dalek!scalar.impl&%52.as_radix_2w. self! w!))
   :qid internal_req__curve25519_dalek!scalar.impl&__52.as_radix_2w._definition
   :skolemid skolem_internal_req__curve25519_dalek!scalar.impl&__52.as_radix_2w._definition
)))
(declare-fun ens%curve25519_dalek!scalar.impl&%52.as_radix_2w. (curve25519_dalek!scalar.Scalar.
  Int %%Function%%
 ) Bool
)
(assert
 (forall ((self! curve25519_dalek!scalar.Scalar.) (w! Int) (result! %%Function%%))
  (!
   (= (ens%curve25519_dalek!scalar.impl&%52.as_radix_2w. self! w! result!) (and
     ...
     (let
      ...
      (and
       (curve25519_dalek!specs.scalar_specs.is_valid_radix_2w.? (Poly%array%. result!) (I
         w!
        ) (I (nClip digits_count$))
       )
   ...
   :pattern ((ens%curve25519_dalek!scalar.impl&%52.as_radix_2w. self! w! result!))
   :qid internal_ens__curve25519_dalek!scalar.impl&__52.as_radix_2w._definition
   :skolemid skolem_internal_ens__curve25519_dalek!scalar.impl&__52.as_radix_2w._definition
)))
   ...
   (= (req%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_column_sum_canonical.
     ...
     (=>
      ...
      (forall ((k$ Poly)) (!
        ...
        :qid user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_column_sum_canonical_48
        :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_column_sum_canonical_48
     )))
     (=>
...
;; Function-Specs curve25519_dalek::backend::serial::scalar_mul::pippenger::Pippenger::init_buckets
(declare-fun ens%curve25519_dalek!backend.serial.scalar_mul.pippenger.impl&%1.init_buckets.
 (Int alloc!vec.Vec<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>.) Bool
)
(assert
 (forall ((count! Int) (buckets! alloc!vec.Vec<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>.))
  (!
   (= (ens%curve25519_dalek!backend.serial.scalar_mul.pippenger.impl&%1.init_buckets.
     count! buckets!
    ) (and
     (= (vstd!seq.Seq.len.? $ TYPE%curve25519_dalek!edwards.EdwardsPoint. (vstd!view.View.view.?
        $ (TYPE%alloc!vec.Vec. $ TYPE%curve25519_dalek!edwards.EdwardsPoint. $ ALLOCATOR_GLOBAL)
        (Poly%alloc!vec.Vec<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>. buckets!)
       )
      ) count!
     )
     (forall ((k$ Poly)) (!
       ...
       :qid user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__init_buckets_50
       :skolemid skolem_user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__init_buckets_50
     ))
     (forall ((k$ Poly)) (!
       (=>
        (has_type k$ INT)
       ...
       :qid user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__init_buckets_51
       :skolemid skolem_user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__init_buckets_51
   ))))
   :pattern ((ens%curve25519_dalek!backend.serial.scalar_mul.pippenger.impl&%1.init_buckets.
     count! buckets!
   ))
   :qid internal_ens__curve25519_dalek!backend.serial.scalar_mul.pippenger.impl&__1.init_buckets._definition
   :skolemid skolem_internal_ens__curve25519_dalek!backend.serial.scalar_mul.pippenger.impl&__1.init_buckets._definition
)))
   ...
   (= (req%curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.lemma_running_sum_equals_weighted.
     ...
     (=>
      ...
      (forall ((j$ Poly)) (!
        ...
        :qid user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_running_sum_equals_weighted_56
        :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_running_sum_equals_weighted_56
   )))))
   ...
   (= (req%curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.lemma_bucket_weighted_sum_equals_column_sum.
     ...
     (=>
      ...
      (forall ((k$ Poly)) (!
        ...
        :qid user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_bucket_weighted_sum_equals_column_sum_57
        :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_bucket_weighted_sum_equals_column_sum_57
     )))
     (=>
      ...
      (forall ((k$ Poly)) (!
        ...
        :qid user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_bucket_weighted_sum_equals_column_sum_58
        :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_bucket_weighted_sum_equals_column_sum_58
     )))
     (=>
      ...
      (forall ((k$ Poly)) (!
        ...
        :qid user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_bucket_weighted_sum_equals_column_sum_59
        :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_bucket_weighted_sum_equals_column_sum_59
   )))))
...
(declare-fun %%lambda%%6 (Poly Poly Poly Poly) %%Function%%)
(assert
 (forall ((%%hole%%0 Poly) (%%hole%%1 Poly) (%%hole%%2 Poly) (%%hole%%3 Poly) (b$ Poly))
  (!
   (= (%%apply%%0 (%%lambda%%6 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3) b$) (Poly%tuple%2.
     (curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.pippenger_bucket_contents.?
      %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 b$
   )))
   :pattern ((%%apply%%0 (%%lambda%%6 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3) b$))
)))
(assert
 (forall ((points_affine! vstd!seq.Seq<tuple%2<nat./nat.>.>.) (all_digits! vstd!seq.Seq<vstd!seq.Seq<i8.>.>.)
   (col! Int) (n! Int) (num_buckets! Int)
   ...
   (= (ens%curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.lemma_bucket_weighted_sum_equals_column_sum.
     points_affine! all_digits! col! n! num_buckets!
      ...
      ((buckets$ (%Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. (vstd!seq.Seq.new.? (DST $) (TYPE%tuple%2.
          ...
          (Poly%fun%1. (mk_fun (%%lambda%%6 (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. points_affine!)
...
;; Function-Specs curve25519_dalek::backend::serial::scalar_mul::pippenger::Pippenger::process_column
(declare-fun req%curve25519_dalek!backend.serial.scalar_mul.pippenger.impl&%1.process_column.
 (alloc!vec.Vec<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>. Poly Int
  Int Int
 ) Bool
)
...
(assert
 (forall ((pre%buckets! alloc!vec.Vec<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>.)
   (scalars_points! Poly) (digit_index! Int) (w! Int) (buckets_count! Int)
  ) (!
   (= (req%curve25519_dalek!backend.serial.scalar_mul.pippenger.impl&%1.process_column.
     pre%buckets! scalars_points! digit_index! w! buckets_count!
    ) (and
     (=>
      %%global_location_label%%48
      (curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.pippenger_input_valid.? (
        vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. (DST $) (TYPE%tuple%2. $ (ARRAY $ (SINT
            8
           ) $ (CONST_INT 64)
          ) $ TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
         ) $ ALLOCATOR_GLOBAL
        ) scalars_points!
       ) (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. (curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.sp_points_affine.?
         (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. (DST $) (TYPE%tuple%2. $ (ARRAY $ (SINT
              8
             ) $ (CONST_INT 64)
            ) $ TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
       ...
       ) (Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>. (curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.sp_digits_seqs.?
         (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. (DST $) (TYPE%tuple%2. $ (ARRAY $ (SINT
              8
             ) $ (CONST_INT 64)
            ) $ TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
       ...
       ) (I w!) (I (curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.sp_digit_count.?
         (I w!)
     ))))
     (=>
      ...
      (= (vstd!seq.Seq.len.? $ TYPE%curve25519_dalek!edwards.EdwardsPoint. (vstd!view.View.view.?
         $ (TYPE%alloc!vec.Vec. $ TYPE%curve25519_dalek!edwards.EdwardsPoint. $ ALLOCATOR_GLOBAL)
         (Poly%alloc!vec.Vec<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>. pre%buckets!)
        )
       ) buckets_count!
     ))
     (=>
      %%global_location_label%%50
      (= buckets_count! (vstd!arithmetic.power2.pow2.? (I (nClip (Sub w! 1)))))
     )
     (=>
     ...
     (=>
      ...
      (< digit_index! (curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.sp_digit_count.?
        (I w!)
     )))
     (=>
      %%global_location_label%%53
      (>= (curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.sp_digit_count.? (I w!))
       1
     ))
     (=>
   ...
   :pattern ((req%curve25519_dalek!backend.serial.scalar_mul.pippenger.impl&%1.process_column.
     pre%buckets! scalars_points! digit_index! w! buckets_count!
   ))
   :qid internal_req__curve25519_dalek!backend.serial.scalar_mul.pippenger.impl&__1.process_column._definition
   :skolemid skolem_internal_req__curve25519_dalek!backend.serial.scalar_mul.pippenger.impl&__1.process_column._definition
)))
(declare-fun ens%curve25519_dalek!backend.serial.scalar_mul.pippenger.impl&%1.process_column.
 (alloc!vec.Vec<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>. alloc!vec.Vec<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>.
  Poly Int Int Int curve25519_dalek!edwards.EdwardsPoint.
 ) Bool
)
(assert
 (forall ((pre%buckets! alloc!vec.Vec<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>.)
   (buckets! alloc!vec.Vec<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>.)
   (scalars_points! Poly) (digit_index! Int) (w! Int) (buckets_count! Int) (column! curve25519_dalek!edwards.EdwardsPoint.)
  ) (!
   (= (ens%curve25519_dalek!backend.serial.scalar_mul.pippenger.impl&%1.process_column.
     pre%buckets! buckets! scalars_points! digit_index! w! buckets_count! column!
    ) (and
     (has_type (Poly%curve25519_dalek!edwards.EdwardsPoint. column!) TYPE%curve25519_dalek!edwards.EdwardsPoint.)
     (curve25519_dalek!specs.edwards_specs.is_well_formed_edwards_point.? (Poly%curve25519_dalek!edwards.EdwardsPoint.
       column!
     ))
     (= (curve25519_dalek!specs.edwards_specs.edwards_point_as_affine.? (Poly%curve25519_dalek!edwards.EdwardsPoint.
        ...
        (curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.sp_points_affine.? (vstd!view.View.view.?
          $ (TYPE%alloc!vec.Vec. (DST $) (TYPE%tuple%2. $ (ARRAY $ (SINT 8) $ (CONST_INT 64))
            $ TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
           ) $ ALLOCATOR_GLOBAL
          ) scalars_points!
        ))
       ...
       ) (I digit_index!) (I (vstd!seq.Seq.len.? (DST $) (TYPE%tuple%2. $ (ARRAY $ (SINT 8)
           $ (CONST_INT 64)
          ) $ TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
         ) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. (DST $) (TYPE%tuple%2. $ (ARRAY $ (SINT
              8
   ...
   :pattern ((ens%curve25519_dalek!backend.serial.scalar_mul.pippenger.impl&%1.process_column.
     pre%buckets! buckets! scalars_points! digit_index! w! buckets_count! column!
   ))
   :qid internal_ens__curve25519_dalek!backend.serial.scalar_mul.pippenger.impl&__1.process_column._definition
   :skolemid skolem_internal_ens__curve25519_dalek!backend.serial.scalar_mul.pippenger.impl&__1.process_column._definition
)))

;; Function-Specs curve25519_dalek::backend::serial::scalar_mul::pippenger::Pippenger::pair_scalars_points
(declare-fun req%curve25519_dalek!backend.serial.scalar_mul.pippenger.impl&%1.pair_scalars_points.
 (alloc!vec.Vec<curve25519_dalek!scalar.Scalar./allocator_global%.>. alloc!vec.Vec<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>./allocator_global%.>.
  Int
 ) Bool
)
...
(assert
 (forall ((scalars_vec! alloc!vec.Vec<curve25519_dalek!scalar.Scalar./allocator_global%.>.)
   (points_vec! alloc!vec.Vec<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>./allocator_global%.>.)
   (w! Int)
  ) (!
   (= (req%curve25519_dalek!backend.serial.scalar_mul.pippenger.impl&%1.pair_scalars_points.
     scalars_vec! points_vec! w!
    ) (and
     (=>
      %%global_location_label%%55
      (= (vstd!seq.Seq.len.? $ TYPE%curve25519_dalek!scalar.Scalar. (vstd!view.View.view.?
         $ (TYPE%alloc!vec.Vec. $ TYPE%curve25519_dalek!scalar.Scalar. $ ALLOCATOR_GLOBAL)
         (Poly%alloc!vec.Vec<curve25519_dalek!scalar.Scalar./allocator_global%.>. scalars_vec!)
        )
     ...
     (=>
      ...
      (forall ((k$ Poly)) (!
        ...
        :qid user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_72
        :skolemid skolem_user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_72
     )))
     (=>
      ...
      (forall ((k$ Poly)) (!
        ...
        :qid user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_73
        :skolemid skolem_user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_73
   )))))
   :pattern ((req%curve25519_dalek!backend.serial.scalar_mul.pippenger.impl&%1.pair_scalars_points.
     scalars_vec! points_vec! w!
   ))
   :qid internal_req__curve25519_dalek!backend.serial.scalar_mul.pippenger.impl&__1.pair_scalars_points._definition
   :skolemid skolem_internal_req__curve25519_dalek!backend.serial.scalar_mul.pippenger.impl&__1.pair_scalars_points._definition
)))
(declare-fun ens%curve25519_dalek!backend.serial.scalar_mul.pippenger.impl&%1.pair_scalars_points.
 (alloc!vec.Vec<curve25519_dalek!scalar.Scalar./allocator_global%.>. alloc!vec.Vec<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>./allocator_global%.>.
  Int core!option.Option.
 ) Bool
)
(assert
 (forall ((scalars_vec! alloc!vec.Vec<curve25519_dalek!scalar.Scalar./allocator_global%.>.)
   (points_vec! alloc!vec.Vec<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>./allocator_global%.>.)
   (w! Int) (result! core!option.Option.)
  ) (!
   (= (ens%curve25519_dalek!backend.serial.scalar_mul.pippenger.impl&%1.pair_scalars_points.
     scalars_vec! points_vec! w! result!
    ) (and
     (has_type (Poly%core!option.Option. result!) (TYPE%core!option.Option. $ (TYPE%alloc!vec.Vec.
        (DST $) (TYPE%tuple%2. $ (ARRAY $ (SINT 8) $ (CONST_INT 64)) $ TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.)
        $ ALLOCATOR_GLOBAL
     )))
     ...
     (=>
      ...
      (let
       ((sp$ (core!option.Option./Some/0 $ (TYPE%alloc!vec.Vec. (DST $) (TYPE%tuple%2. $ (ARRAY
             $ (SINT 8) $ (CONST_INT 64)
            ) $ TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
           ) $ ALLOCATOR_GLOBAL
          ) (%Poly%core!option.Option. (Poly%core!option.Option. result!))
       )))
       (let
        ((dc$ (ite
           (< w! 8)
             ...
             (and
              (and
               ...
               (forall ((k$ Poly)) (!
                 (=>
                  ...
                  (=>
                   (let
                    ...
                    (and
                     (<= 0 tmp%%$)
                     (< tmp%%$ (vstd!seq.Seq.len.? (DST $) (TYPE%tuple%2. $ (ARRAY $ (SINT 8) $ (CONST_INT
                          64
                         )
                        ) $ TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
                       ) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. (DST $) (TYPE%tuple%2. $ (ARRAY $ (SINT
                   ...
                   (and
                    ...
                    (= (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.? (vstd!seq.Seq.subrange.?
                       $ (SINT 8) (vstd!view.View.view.? $ (ARRAY $ (SINT 8) $ (CONST_INT 64)) (tuple%2./tuple%2/0
                         (%Poly%tuple%2. (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2. $ (ARRAY $ (SINT 8) $ (CONST_INT
                              64
                             )
                            ) $ TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
                       ...
                       (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%curve25519_dalek!scalar.Scalar.
                         $ ALLOCATOR_GLOBAL
                        ) (Poly%alloc!vec.Vec<curve25519_dalek!scalar.Scalar./allocator_global%.>. scalars_vec!)
                       ) k$
                 ))))))
                 ...
                 :qid user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_74
                 :skolemid skolem_user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_74
              )))
              (forall ((k$ Poly)) (!
                (=>
                 (has_type k$ INT)
                ...
                :qid user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_75
                :skolemid skolem_user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_75
             )))
             (forall ((k$ Poly)) (!
               (=>
                (has_type k$ INT)
               ...
               :qid user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_76
               :skolemid skolem_user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_76
            )))
            (forall ((k$ Poly)) (!
              (=>
               (has_type k$ INT)
              ...
              :qid user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_77
              :skolemid skolem_user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_77
           )))
           (forall ((k$ Poly)) (!
             (=>
              (has_type k$ INT)
             ...
             :qid user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_78
             :skolemid skolem_user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_78
          )))
          (forall ((k$ Poly)) (!
            (=>
             (has_type k$ INT)
            ...
            :qid user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_79
            :skolemid skolem_user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_79
         )))
         (forall ((k$ Poly)) (!
           (=>
            (has_type k$ INT)
            (=>
             ...
             (curve25519_dalek!specs.edwards_specs.projective_niels_corresponds_to_edwards.? (tuple%2./tuple%2/1
               (%Poly%tuple%2. (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2. $ (ARRAY $ (SINT 8) $ (CONST_INT
                    64
                   )
                  ) $ TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
           ...
           :qid user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_80
           :skolemid skolem_user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_80
   ))))))))
   :pattern ((ens%curve25519_dalek!backend.serial.scalar_mul.pippenger.impl&%1.pair_scalars_points.
     scalars_vec! points_vec! w! result!
   ))
   :qid internal_ens__curve25519_dalek!backend.serial.scalar_mul.pippenger.impl&__1.pair_scalars_points._definition
   :skolemid skolem_internal_ens__curve25519_dalek!backend.serial.scalar_mul.pippenger.impl&__1.pair_scalars_points._definition
)))

;; Function-Def curve25519_dalek::backend::serial::scalar_mul::pippenger::Pippenger::pair_scalars_points
;; curve25519-dalek/src/backend/serial/scalar_mul/pippenger.rs:614:9: 614:28 (#3446)
...
(push)
 ...
 (declare-const points_vec! alloc!vec.Vec<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>./allocator_global%.>.)
 (declare-const w! Int)
 ...
 (declare-const niels@ curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.)
 (declare-const P@ curve25519_dalek!edwards.EdwardsPoint.)
 ...
 (declare-const scalars_points@0 Poly)
 ...
 (assert
  (has_type scalars_points@0 (TYPE%alloc!vec.Vec. (DST $) (TYPE%tuple%2. $ (ARRAY $ (SINT
       8
      ) $ (CONST_INT 64)
     ) $ TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
    ) $ ALLOCATOR_GLOBAL
 ...
 (declare-const scalars_points@1 Poly)
 ...
 (assert
  (not (=>
    ...
    (=>
     (= min_len@ (vstd!seq.Seq.len.? $ TYPE%curve25519_dalek!scalar.Scalar. (vstd!view.View.view.?
        $ (TYPE%alloc!vec.Vec. $ TYPE%curve25519_dalek!scalar.Scalar. $ ALLOCATOR_GLOBAL)
        (Poly%alloc!vec.Vec<curve25519_dalek!scalar.Scalar./allocator_global%.>. scalars_vec!)
     )))
     (=>
       ...
       (=>
        ...
        (=>
         (forall ((k$ Poly)) (!
           ...
           :qid user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_88
           :skolemid skolem_user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_88
         ))
         (=>
          (forall ((k$ Poly)) (!
            (=>
            ...
            :qid user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_89
            :skolemid skolem_user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_89
          ))
          (=>
           (forall ((k$ Poly)) (!
             (=>
             ...
             :qid user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_90
             :skolemid skolem_user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_90
           ))
           (=>
            (forall ((k$ Poly)) (!
              (=>
              ...
              :qid user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_91
              :skolemid skolem_user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_91
            ))
            (=>
             (forall ((k$ Poly)) (!
               (=>
               ...
               :qid user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_92
               :skolemid skolem_user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_92
             ))
             (=>
              (forall ((k$ Poly)) (!
                (=>
                ...
                :qid user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_93
                :skolemid skolem_user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_93
              ))
              (=>
               (forall ((k$ Poly)) (!
                 (=>
                 ...
                 :qid user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_94
                 :skolemid skolem_user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_94
               ))
               (=>
                (forall ((k$ Poly)) (!
                  (=>
                  ...
                  :qid user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_95
                  :skolemid skolem_user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_95
                ))
                (=>
                 (forall ((k$ Poly)) (!
                   (=>
                   ...
                   :qid user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_96
                   :skolemid skolem_user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_96
                 ))
                 (=>
                  (forall ((k$ Poly)) (!
                    (=>
                    ...
                    :qid user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_97
                    :skolemid skolem_user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_97
                  ))
                  (=>
                   (= decrease%init0%0 (Sub min_len@ idx@0))
                   (=>
                    (< idx@0 min_len@)
                    (and
                     (=>
                      %%location_label%%0
                      (req%vstd!std_specs.vec.vec_index. $ (TYPE%core!option.Option. $ TYPE%curve25519_dalek!edwards.EdwardsPoint.)
                       $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>./allocator_global%.>.
                        points_vec!
                       ) idx@0
                     ))
                     (=>
                      (ens%vstd!std_specs.vec.vec_index. $ (TYPE%core!option.Option. $ TYPE%curve25519_dalek!edwards.EdwardsPoint.)
                       $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>./allocator_global%.>.
                        points_vec!
                       ) idx@0 tmp%8
                      )
                      (=>
                       (= tmp%%@ (%Poly%core!option.Option. tmp%8))
                       (or
                        (and
                         (=>
                          (is-core!option.Option./Some tmp%%@)
                          (=>
                           (= P@ (%Poly%curve25519_dalek!edwards.EdwardsPoint. (core!option.Option./Some/0 $ TYPE%curve25519_dalek!edwards.EdwardsPoint.
                              (%Poly%core!option.Option. (Poly%core!option.Option. tmp%%@))
                           )))
                           (=>
                            (ens%curve25519_dalek!specs.edwards_specs.lemma_unfold_edwards. P@)
                            (and
                             (=>
                              %%location_label%%1
                              (req%vstd!std_specs.vec.vec_index. $ TYPE%curve25519_dalek!scalar.Scalar. $ ALLOCATOR_GLOBAL
                               (Poly%alloc!vec.Vec<curve25519_dalek!scalar.Scalar./allocator_global%.>. scalars_vec!)
                               idx@0
                             ))
                             (=>
                              (ens%vstd!std_specs.vec.vec_index. $ TYPE%curve25519_dalek!scalar.Scalar. $ ALLOCATOR_GLOBAL
                               (Poly%alloc!vec.Vec<curve25519_dalek!scalar.Scalar./allocator_global%.>. scalars_vec!)
                               idx@0 tmp%9
                              )
                              (and
                               (=>
                                %%location_label%%2
                                (req%curve25519_dalek!scalar.impl&%52.as_radix_2w. (%Poly%curve25519_dalek!scalar.Scalar.
                                  tmp%9
                                 ) w!
                               ))
                               (=>
                                (ens%curve25519_dalek!scalar.impl&%52.as_radix_2w. (%Poly%curve25519_dalek!scalar.Scalar.
                                  tmp%9
                                 ) w! digits@
                                )
                                (and
                                 (=>
                                  %%location_label%%3
                                  (req%curve25519_dalek!edwards.impl&%29.as_projective_niels. P@)
                                 )
                                 (=>
                                  (ens%curve25519_dalek!edwards.impl&%29.as_projective_niels. P@ niels@)
                                  (=>
                                   (= tmp%10 (tuple%2./tuple%2 (Poly%array%. digits@) (Poly%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
                                      niels@
                                   )))
                                   (=>
                                    (has_type scalars_points@1 (TYPE%alloc!vec.Vec. (DST $) (TYPE%tuple%2. $ (ARRAY $ (SINT
                                         8
                                        ) $ (CONST_INT 64)
                                       ) $ TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
                                      ) $ ALLOCATOR_GLOBAL
                                    ...
                                    (=>
                                     (ens%alloc!vec.impl&%1.push. (DST $) (TYPE%tuple%2. $ (ARRAY $ (SINT 8) $ (CONST_INT
                                         64
                                        )
                                       ) $ TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
                                      ) $ ALLOCATOR_GLOBAL scalars_points@0 scalars_points@1 (Poly%tuple%2. tmp%10)
                                     )
                                     %%switch_label%%0
                         ))))))))))))
                         (=>
                          ...
                          (=>
                           (= tmp%11 (not (curve25519_dalek!specs.iterator_specs.all_points_some.? (vstd!view.View.view.?
                               $ (TYPE%alloc!vec.Vec. $ (TYPE%core!option.Option. $ TYPE%curve25519_dalek!edwards.EdwardsPoint.)
                                $ ALLOCATOR_GLOBAL
                               ) (Poly%alloc!vec.Vec<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>./allocator_global%.>.
                                points_vec!
                                        ...
                                        (and
                                         (and
                                          ...
                                          (forall ((k$ Poly)) (!
                                            ...
                                            :qid user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_81
                                            :skolemid skolem_user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_81
                                         )))
                                         (forall ((k$ Poly)) (!
                                           (=>
                                            (has_type k$ INT)
                                           ...
                                           :qid user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_82
                                           :skolemid skolem_user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_82
                                        )))
                                        (forall ((k$ Poly)) (!
                                          (=>
                                           (has_type k$ INT)
                                          ...
                                          :qid user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_83
                                          :skolemid skolem_user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_83
                                       )))
                                       (forall ((k$ Poly)) (!
                                         (=>
                                          (has_type k$ INT)
                                         ...
                                         :qid user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_84
                                         :skolemid skolem_user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_84
                                      )))
                                      (forall ((k$ Poly)) (!
                                        (=>
                                         (has_type k$ INT)
                                        ...
                                        :qid user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_85
                                        :skolemid skolem_user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_85
                                     )))
                                     (forall ((k$ Poly)) (!
                                       (=>
                                        (has_type k$ INT)
                                       ...
                                       :qid user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_86
                                       :skolemid skolem_user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_86
                                    )))
                                    (forall ((k$ Poly)) (!
                                      (=>
                                       (has_type k$ INT)
                                      ...
                                      :qid user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_87
                                      :skolemid skolem_user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__pair_scalars_points_87
                        ))))))))))))))
                        (and
                         (not %%switch_label%%0)
                         (and
                                        ...
                                        (and
                                         ...
                                         (and
                                          ...
                                          (and
                                           ...
                                           (=>
                                            %%location_label%%23
                                            (check_decrease_int (Sub min_len@ idx@1) decrease%init0%0 false)
 )))))))))))))))))))))))))))))))))))))))))))
 (get-info :version)
