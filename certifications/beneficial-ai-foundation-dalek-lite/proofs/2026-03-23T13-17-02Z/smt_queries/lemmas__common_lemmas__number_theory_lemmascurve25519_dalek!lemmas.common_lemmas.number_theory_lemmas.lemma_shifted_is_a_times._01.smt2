...
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:833:9: 833:15 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::number_theory_lemmas::lemma_shifted_is_a_times
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:833:9: 833:15 (#0)
...
(push)
 ...
 (declare-const sj1@ Int)
 (declare-const bsj1@ Int)
 (declare-const ai$1@ Int)
 (declare-const bj@ Int)
 (declare-const pj@ Int)
 (declare-const pj1@ Int)
 ...
 (assert
  (not (=>
    %%location_label%%0
    (= (Mul b0@ (Mul ai@ 1)) (Mul ai@ (Mul b0@ 1)))
 )))
 (get-info :version)
