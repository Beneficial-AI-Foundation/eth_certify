...
;; curve25519-dalek/src/lemmas/montgomery_curve_lemmas.rs:535:1: 535:52 (#0)
...
;; Function-Def curve25519_dalek::lemmas::montgomery_curve_lemmas::lemma_canonical_montgomery_lift_zero
;; curve25519-dalek/src/lemmas/montgomery_curve_lemmas.rs:535:1: 535:52 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (ens%curve25519_dalek!lemmas.montgomery_curve_lemmas.lemma_canonical_sqrt_zero. 0)
    (and
     (=>
      (= A@ (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
         curve25519_dalek!backend.serial.u64.constants.MONTGOMERY_A.?
      ...
      (=>
       (= u2@ (curve25519_dalek!specs.field_specs.field_mul.? (I 0) (I 0)))
       (=>
        (= u3@ (curve25519_dalek!specs.field_specs.field_mul.? (I u2@) (I 0)))
        (=>
         (= Au2@ (curve25519_dalek!specs.field_specs.field_mul.? (I A@) (I u2@)))
         (=>
          (= tmp%1 (= (curve25519_dalek!specs.montgomery_specs.montgomery_rhs.? (I 0)) (curve25519_dalek!specs.field_specs.field_add.?
             (I (curve25519_dalek!specs.field_specs.field_add.? (I u3@) (I Au2@))) (I 0)
          )))
          (and
           (=>
            %%location_label%%0
             ...
             (=>
              ...
              (and
               ...
               (=>
                ...
                (=>
                 (= tmp%3 (= (EucMod 0 (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0))
                 (and
                  (=>
                   %%location_label%%2
                   tmp%3
                        ...
                        (=>
                         ...
                         (and
                          (=>
                           (ens%curve25519_dalek!specs.field_specs_u64.p_gt_2. 0)
                           (=>
                            (= tmp%4 (= (curve25519_dalek!specs.field_specs.field_add.? (I 0) (I 0)) (EucMod (nClip
                                (Add 0 0)
                               ) (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
                            )))
                            (and
                             ...
                             (=>
                              tmp%4
                              (=>
                               (= tmp%5 (= (curve25519_dalek!specs.field_specs.field_add.? (I 0) (I 0)) 0))
                               (and
                                (=>
                                 %%location_label%%10
                                 tmp%5
                                ...
                                (=>
                                 tmp%5
                                 (=>
                                  (= tmp%6 (= (nClip (Add (curve25519_dalek!specs.field_specs.field_add.? (I 0) (I 0))
                                      0
                                     )
                                    ) 0
                                  ))
                                  (and
                                   ...
                                   (=>
                                    tmp%6
                                    (=>
                                     (= tmp%7 (= (curve25519_dalek!specs.field_specs.field_add.? (I (curve25519_dalek!specs.field_specs.field_add.?
                                          (I 0) (I 0)
                                         )
                                        ) (I 0)
                                       ) (EucMod (nClip (Add 0 0)) (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                                     ))
                                     (and
                                      (=>
                                       %%location_label%%12
                                      ...
                                      (=>
                                       tmp%7
                                       (=>
                                        (= tmp%8 (= (curve25519_dalek!specs.field_specs.field_add.? (I (curve25519_dalek!specs.field_specs.field_add.?
                                             (I 0) (I 0)
                                            )
                                           ) (I 0)
                                          ) 0
                          ...
                          (=>
                           ...
                           (=>
                            (= tmp%9 (= (curve25519_dalek!specs.montgomery_specs.montgomery_rhs.? (I 0)) 0))
                            (and
                             (=>
                              %%location_label%%15
                              tmp%9
                             ...
                             (=>
                              ...
                              (=>
                               %%location_label%%16
                               (= (curve25519_dalek!specs.montgomery_specs.montgomery_rhs.? (I 0)) 0)
     ))))))))))))))))))))))))))
     (=>
      (= (curve25519_dalek!specs.montgomery_specs.montgomery_rhs.? (I 0)) 0)
      (=>
       (= tmp%10 (= (curve25519_dalek!specs.montgomery_specs.canonical_montgomery_lift.? (I
           0
          )
         ) (curve25519_dalek!specs.montgomery_specs.MontgomeryAffine./Finite (%I (I (EucMod 0
             (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
           ))
          ) (%I (I (curve25519_dalek!specs.montgomery_specs.canonical_sqrt.? (I (curve25519_dalek!specs.montgomery_specs.montgomery_rhs.?
               (I 0)
       ))))))))
       (and
        (=>
        ...
        (=>
         ...
         (and
          (=>
           ...
           (=>
            ...
            (and
             (=>
              %%location_label%%18
              (req%vstd!arithmetic.div_mod.lemma_mod_self_0. tmp%11)
             )
             (=>
              (ens%vstd!arithmetic.div_mod.lemma_mod_self_0. tmp%11)
              (=>
               %%location_label%%19
          ...
          (=>
           (= (EucMod 0 (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0)
           (=>
            (= tmp%12 (= (curve25519_dalek!specs.montgomery_specs.canonical_sqrt.? (I (curve25519_dalek!specs.montgomery_specs.montgomery_rhs.?
                 (I 0)
               ))
              ) 0
            ))
            (and
             ...
             (=>
              ...
              (=>
               %%location_label%%21
               (= (curve25519_dalek!specs.montgomery_specs.canonical_montgomery_lift.? (I 0)) (curve25519_dalek!specs.montgomery_specs.MontgomeryAffine./Finite
                 (%I (I 0)) (%I (I 0))
 ))))))))))))))))
 (get-info :version)
