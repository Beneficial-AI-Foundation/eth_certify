...
;; curve25519-dalek/src/specs/field_specs.rs:313:1: 313:40 (#0)
...
;; Function-Def curve25519_dalek::specs::field_specs::lemma_fermat_for_p
;; curve25519-dalek/src/specs/field_specs.rs:313:1: 313:40 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (ens%curve25519_dalek!specs.primality_specs.axiom_p_is_prime. 0)
    (=>
      ...
      (=>
       ...
       (=>
        ...
        (= (curve25519_dalek!specs.field_specs_u64.field_canonical.? (I (nClip (vstd!arithmetic.power.pow.?
             (I x!) (I (nClip (Sub (curve25519_dalek!specs.field_specs_u64.p.? (I 0)) 1)))
          )))
         ) 1
 ))))))))
 (get-info :version)
