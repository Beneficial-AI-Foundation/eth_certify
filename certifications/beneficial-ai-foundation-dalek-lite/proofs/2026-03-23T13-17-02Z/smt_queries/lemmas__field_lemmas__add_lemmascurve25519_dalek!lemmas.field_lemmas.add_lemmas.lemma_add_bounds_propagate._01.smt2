...
;; curve25519-dalek/src/lemmas/field_lemmas/add_lemmas.rs:175:9: 175:15 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::add_lemmas::lemma_add_bounds_propagate
;; curve25519-dalek/src/lemmas/field_lemmas/add_lemmas.rs:175:9: 175:15 (#0)
...
(assert
 (bvult n! ((_ zero_extend 58) (_ bv63 6)))
)
...
(assert
 (not (=>
   %%location_label%%0
   (= (bvadd ((_ zero_extend 1) (bvshl ((_ zero_extend 63) (_ bv1 1)) n!)) ((_ zero_extend
       1
      ) (bvshl ((_ zero_extend 63) (_ bv1 1)) n!)
     )
    ) ((_ zero_extend 1) (bvshl ((_ zero_extend 63) (_ bv1 1)) (bvadd n! ((_ zero_extend 63)
        (_ bv1 1)
))))))))
(get-info :version)
