...
;; curve25519-dalek/src/lemmas/common_lemmas/to_nat_lemmas.rs:731:1: 731:70 (#0)
...
;; Function-Specs curve25519_dalek::lemmas::common_lemmas::to_nat_lemmas::lemma_u8_32_as_nat_eq_bytes_seq_as_nat
(declare-fun ens%curve25519_dalek!lemmas.common_lemmas.to_nat_lemmas.lemma_u8_32_as_nat_eq_bytes_seq_as_nat.
 (%%Function%%) Bool
)
(assert
 (forall ((bytes! %%Function%%)) (!
   (= (ens%curve25519_dalek!lemmas.common_lemmas.to_nat_lemmas.lemma_u8_32_as_nat_eq_bytes_seq_as_nat.
     bytes!
    ) (= (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. bytes!)) (curve25519_dalek!specs.core_specs.bytes_seq_as_nat.?
      (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT 32)) (Poly%array%. bytes!))
   )))
   :pattern ((ens%curve25519_dalek!lemmas.common_lemmas.to_nat_lemmas.lemma_u8_32_as_nat_eq_bytes_seq_as_nat.
     bytes!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.common_lemmas.to_nat_lemmas.lemma_u8_32_as_nat_eq_bytes_seq_as_nat._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.common_lemmas.to_nat_lemmas.lemma_u8_32_as_nat_eq_bytes_seq_as_nat._definition
)))

;; Function-Def curve25519_dalek::lemmas::common_lemmas::to_nat_lemmas::lemma_u8_32_as_nat_eq_bytes_seq_as_nat
;; curve25519-dalek/src/lemmas/common_lemmas/to_nat_lemmas.rs:731:1: 731:70 (#0)
    ...
    (and
     ...
     (=>
      ...
      (=>
       (fuel_bool fuel%curve25519_dalek!specs.core_specs.u8_32_as_nat_rec.)
       (=>
        (exists ((fuel% Fuel)) (= fuel_nat%curve25519_dalek!specs.core_specs.u8_32_as_nat_rec.
          (succ (succ (succ (succ (succ (succ (succ (succ (succ (succ (succ (succ (succ (succ (succ (succ (
                           succ (succ (succ (succ (succ (succ (succ (succ (succ (succ (succ (succ (succ (succ (succ (succ fuel%)))))))))))))))
        )))))))))))))))))))
        (=>
