...
;; curve25519-dalek/src/lemmas/scalar_lemmas_/radix_2w_lemmas.rs:325:7: 331:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::scalar_lemmas_::radix_2w_lemmas::lemma_u64x4_single_word_decompose_generic
;; curve25519-dalek/src/lemmas/scalar_lemmas_/radix_2w_lemmas.rs:325:7: 331:2 (#0)
...
(push)
 ...
 (assert
  (not (=>
    ...
    (=>
     (= biw@ (nClip (Add bit_idx_nat! w_nat!)))
     (=>
      ...
      (or
         ...
         (and
          ...
          (=>
           ...
           (=>
            ...
            (=>
             (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_div_mod. tmp%1 bit_idx_nat!
              w_nat!
             )
             %%switch_label%%0
        )))))
         ...
         (or
          (and
           (=>
            (= u64_idx! 1)
            (=>
             (= lower@ (nClip (Add (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY
                    $ (UINT 64) $ (CONST_INT 4)
                   ) (Poly%array%. words!)
                  ) (I 0)
                 )
               ...
               (and
                ...
                (=>
                 ...
                 (=>
                  ...
                  (=>
                   (= tmp%2 (vstd!arithmetic.power2.pow2.? (I 64)))
                   (=>
                    ...
                    (=>
                     ...
                     (and
                      (=>
                       %%location_label%%3
                       (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod_converse_div. lower@ tmp%2
                        tmp%3 tmp%4
                      ))
                      (=>
                       (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod_converse_div. lower@ tmp%2
                        tmp%3 tmp%4
                       )
                       (=>
                        ...
                        (=>
                         ...
                         (=>
                          (ens%vstd!arithmetic.power2.lemma_pow2_pos. biw_total@)
                          (=>
                           (= tmp%5 (vstd!arithmetic.power2.pow2.? (I biw_total@)))
                           (and
                            (=>
                             %%location_label%%4
                             (req%vstd!arithmetic.div_mod.lemma_mod_bound. lower@ tmp%5)
                            )
                            (=>
                             (ens%vstd!arithmetic.div_mod.lemma_mod_bound. lower@ tmp%5)
                             (=>
                              (= tmp%6 (EucMod lower@ (vstd!arithmetic.power2.pow2.? (I biw_total@))))
                              (=>
                               (= tmp%7 (vstd!arithmetic.power2.pow2.? (I 64)))
                               (=>
                                (= tmp%8 (vstd!arithmetic.power2.pow2.? (I bit_idx_nat!)))
                                (and
                                 (=>
                                  %%location_label%%5
                                  (req%vstd!arithmetic.div_mod.lemma_div_denominator. tmp%6 tmp%7 tmp%8)
                                 )
                                 (=>
                                  (ens%vstd!arithmetic.div_mod.lemma_div_denominator. tmp%6 tmp%7 tmp%8)
                                  (=>
                                   (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_div_mod. lower@ 64
                                    biw@
                                   )
                                   (=>
                                    ...
                                    (=>
                                     (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_div_mod. tmp%9 bit_idx_nat!
                                      w_nat!
                                     )
                                     %%switch_label%%1
           ))))))))))))))))))))))))))
            ...
            (or
             (and
              (=>
               (= u64_idx! 2)
               (=>
                (= lower$1@ (nClip (Add (nClip (Add (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                  ...
                  (and
                   ...
                   (=>
                    ...
                    (=>
                     ...
                     (=>
                      (= tmp%10 (vstd!arithmetic.power2.pow2.? (I 128)))
                      (=>
                       ...
                       (=>
                        (= tmp%12 (nClip (Add (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY
                               $ (UINT 64) $ (CONST_INT 4)
                              ) (Poly%array%. words!)
                             ) (I 0)
                            )
                        ...
                        (and
                         (=>
                          %%location_label%%8
                          (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod_converse_div. lower$1@ tmp%10
                           tmp%11 tmp%12
                         ))
                         (=>
                          (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod_converse_div. lower$1@ tmp%10
                           tmp%11 tmp%12
                          )
                          (=>
                           (ens%vstd!arithmetic.power2.lemma_pow2_pos. bit_idx_nat!)
                           (=>
                            ...
                            (=>
                             (ens%vstd!arithmetic.power2.lemma_pow2_pos. biw_total@)
                             (=>
                              (= tmp%13 (vstd!arithmetic.power2.pow2.? (I biw_total@)))
                              (and
                               (=>
                                %%location_label%%9
                                (req%vstd!arithmetic.div_mod.lemma_mod_bound. lower$1@ tmp%13)
                               )
                               (=>
                                (ens%vstd!arithmetic.div_mod.lemma_mod_bound. lower$1@ tmp%13)
                                (=>
                                 (= tmp%14 (EucMod lower$1@ (vstd!arithmetic.power2.pow2.? (I biw_total@))))
                                 (=>
                                  (= tmp%15 (vstd!arithmetic.power2.pow2.? (I 128)))
                                  (=>
                                   (= tmp%16 (vstd!arithmetic.power2.pow2.? (I bit_idx_nat!)))
                                   (and
                                    (=>
                                     %%location_label%%10
                                     (req%vstd!arithmetic.div_mod.lemma_div_denominator. tmp%14 tmp%15 tmp%16)
                                    )
                                    (=>
                                     (ens%vstd!arithmetic.div_mod.lemma_div_denominator. tmp%14 tmp%15 tmp%16)
                                     (=>
                                      (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_div_mod. lower$1@
                                       128 biw@
                                      )
                                      (=>
                                       ...
                                       (=>
                                        (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_div_mod. tmp%17 bit_idx_nat!
                                         w_nat!
                                        )
                                        %%switch_label%%2
              ))))))))))))))))))))))))))
              (=>
               ...
               (and
                ...
                (=>
                 ...
                 (=>
                  (ens%vstd!arithmetic.power2.lemma_pow2_pos. 192)
                  (=>
                   (= tmp%18 (vstd!arithmetic.power2.pow2.? (I 192)))
                   (=>
                    ...
                    (=>
                     (= tmp%20 (nClip (Add (nClip (Add (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                             $ (ARRAY $ (UINT 64) $ (CONST_INT 4)) (Poly%array%. words!)
                            ) (I 0)
                           )
                          ) (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (
                     ...
                     (and
                      (=>
                       %%location_label%%12
                       (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod_converse_div. val@ tmp%18 tmp%19
                        tmp%20
                      ))
                      (=>
                       (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod_converse_div. val@ tmp%18 tmp%19
                        tmp%20
                       )
                       (=>
                        (ens%vstd!arithmetic.power2.lemma_pow2_pos. bit_idx_nat!)
                        (=>
                         (ens%vstd!arithmetic.power2.lemma_pow2_adds. 192 bit_idx_nat!)
                         (=>
                          (= tmp%21 (vstd!arithmetic.power2.pow2.? (I 192)))
                          (=>
       ...
       (and
        ...
        (=>
         %%location_label%%14
         (= (EucDiv (EucMod (curve25519_dalek!specs.scalar_specs.u64_4_as_nat.? (Poly%array%. words!))
            (vstd!arithmetic.power2.pow2.? (I (nClip (Add bit_off_nat! w_nat!))))
           ) (vstd!arithmetic.power2.pow2.? (I bit_off_nat!))
          ) (EucMod (EucDiv (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY
                $ (UINT 64) $ (CONST_INT 4)
