...
;; curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:875:13: 875:19 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::as_bytes_lemmas::lemma_canonical_bytes_bit255_zero
;; curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:875:13: 875:19 (#0)
...
(push)
 ...
 (assert
  (not (=>
    ...
    (=>
     %%location_label%%0
     (>= (nClip (Mul byte31@ (vstd!arithmetic.power2.pow2.? (I 248)))) (nClip (Mul 128 (vstd!arithmetic.power2.pow2.?
         (I 248)
 ))))))))
 (get-info :version)
