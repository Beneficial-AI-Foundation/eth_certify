...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:167:1: 167:74 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_field_mul_distributes_over_add
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:167:1: 167:74 (#0)
     ...
     (and
      (=>
       ...
       (and
        (=>
         %%location_label%%0
         (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. a! tmp%1 p@)
        )
        (=>
         (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. a! tmp%1 p@)
         (=>
          (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add. a! b! c!)
          (=>
           (= tmp%2 (nClip (Mul a! b!)))
           (=>
            (= tmp%3 (nClip (Mul a! c!)))
            (and
             (=>
              %%location_label%%1
              (req%vstd!arithmetic.div_mod.lemma_add_mod_noop. tmp%2 tmp%3 p@)
             )
             (=>
              (ens%vstd!arithmetic.div_mod.lemma_add_mod_noop. tmp%2 tmp%3 p@)
              (=>
               %%location_label%%2
               (= (curve25519_dalek!specs.field_specs.field_mul.? (I a!) (I (curve25519_dalek!specs.field_specs.field_add.?
                   (I b!) (I c!)
