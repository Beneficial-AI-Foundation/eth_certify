...
;; curve25519-dalek/src/lemmas/field_lemmas/load8_lemmas.rs:280:1: 280:74 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::load8_lemmas::lemma_load8_at_plus_fits_u64
;; curve25519-dalek/src/lemmas/field_lemmas/load8_lemmas.rs:280:1: 280:74 (#0)
          ...
          (or
            ...
            (=>
             ...
             (=>
              ...
              (and
               (=>
                %%location_label%%1
                (req%vstd!arithmetic.power2.lemma_pow2_strictly_increases. tmp%2 56)
               )
               (=>
                (ens%vstd!arithmetic.power2.lemma_pow2_strictly_increases. tmp%2 56)
                %%switch_label%%0
            ))))
            (=>
             (not (< k! 7))
           ...
           (and
            ...
            (=>
             ...
             (=>
              %%location_label%%2
              (<= (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 8 k!)))) 72057594037927936)
          ))))
          (=>
           (<= (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 8 k!)))) 72057594037927936)
           (and
            ...
            (=>
             (< xk_1@ (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 8 k!)))))
             (=>
              (= tmp%4 (<= xk_1@ (Sub 72057594037927936 1)))
              (and
               (=>
                %%location_label%%5
                tmp%4
               ...
               (=>
                ...
                (and
                 (=>
                  (= tmp%5 (vstd!arithmetic.power2.pow2.? (I (nClip (Mul k! 8)))))
                  (and
                   (=>
                    %%location_label%%6
                    (req%curve25519_dalek!lemmas.common_lemmas.mul_lemmas.lemma_mul_le. tmp%5 72057594037927936
                     v@ 255
                   ))
                   (=>
                    (ens%curve25519_dalek!lemmas.common_lemmas.mul_lemmas.lemma_mul_le. tmp%5 72057594037927936
                     v@ 255
                    )
                    (=>
                     %%location_label%%7
                     (<= (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul k! 8)))) v@) (Mul 72057594037927936
                       255
                 ))))))
                 (=>
                  (<= (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul k! 8)))) v@) (Mul 72057594037927936
                  ...
                  (and
                   ...
                   (=>
                    (<= (Add (Sub 72057594037927936 1) (Mul 72057594037927936 255)) 18446744073709551615)
                    (=>
                     %%location_label%%9
