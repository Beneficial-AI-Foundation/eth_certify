...
;; curve25519-dalek/src/lemmas/field_lemmas/load8_lemmas.rs:59:1: 59:88 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::load8_lemmas::lemma_load8_at_plus_version_rec_is_bounded
;; curve25519-dalek/src/lemmas/field_lemmas/load8_lemmas.rs:59:1: 59:88 (#0)
  ...
  (not (=>
    ...
    (and
     (=>
      ...
      (=>
       %%location_label%%0
       (< 255 (vstd!arithmetic.power2.pow2.? (I 8)))
     ))
     (=>
      (< 255 (vstd!arithmetic.power2.pow2.? (I 8)))
      (or
             ...
             (=>
              ...
              (=>
               ...
               (< (curve25519_dalek!lemmas.field_lemmas.load8_lemmas.load8_at_plus_version_rec.? (
                ...
                ) (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 8 k!))))
          ))))))
          (=>
           (< (curve25519_dalek!lemmas.field_lemmas.load8_lemmas.load8_at_plus_version_rec.? (
              Poly%slice%<u8.>. input!
           ...
           (=>
            (= c@ (uClip 64 (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $slice (SLICE
                  $ (UINT 8)
                 ) (Poly%slice%<u8.>. input!)
                ) (I (Add i! k!))
            ))))
            (=>
             (= tmp%2 (< c@ (vstd!arithmetic.power2.pow2.? (I 8))))
             (and
              (=>
               %%location_label%%4
               tmp%2
                ...
                (and
                 (and
                  (=>
                   ...
                   (=>
                    %%location_label%%5
                    (= 18446744073709551615 (Sub (vstd!arithmetic.power2.pow2.? (I 64)) 1))
                  ))
                  (=>
                   (= 18446744073709551615 (Sub (vstd!arithmetic.power2.pow2.? (I 64)) 1))
                   (and
                    (and
                     (=>
                      ...
                      (=>
                       (= tmp%4 (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 8 k!)))))
                       (and
                        (=>
                         %%location_label%%6
                         (req%vstd!arithmetic.mul.lemma_mul_strict_inequality. c@ tmp%3 tmp%4)
                        )
                        (=>
                         (ens%vstd!arithmetic.mul.lemma_mul_strict_inequality. c@ tmp%3 tmp%4)
                         (=>
                          %%location_label%%7
                          (< (Mul c@ (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 8 k!))))) (nClip (Mul (vstd!arithmetic.power2.pow2.?
                              (I 8)
                             ) (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 8 k!))))
                     ))))))))
                     (=>
                      ...
                      (and
                       (and
                        (or
                          ...
                          (=>
                           ...
                           (=>
                            ...
                            (and
                             (=>
                              %%location_label%%8
                              (req%vstd!arithmetic.power2.lemma_pow2_strictly_increases. tmp%5 56)
                             )
                             (=>
                              (ens%vstd!arithmetic.power2.lemma_pow2_strictly_increases. tmp%5 56)
                              %%switch_label%%1
                          ))))
                          (=>
                           (not (< k! 7))
                         ...
                         (and
                          ...
                          (=>
                           %%location_label%%9
                           (<= (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 8 k!)))) (vstd!arithmetic.power2.pow2.?
                             (I 56)
                        )))))
                        (=>
                         (<= (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 8 k!)))) (vstd!arithmetic.power2.pow2.?
                         ...
                         (=>
                          ...
                          (=>
                           (= tmp%6 (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 8 k!)))))
                           (=>
                            (= tmp%7 (vstd!arithmetic.power2.pow2.? (I 56)))
                            (=>
                             (= tmp%8 (vstd!arithmetic.power2.pow2.? (I 8)))
                             (and
                              (=>
                               %%location_label%%10
                               (req%vstd!arithmetic.mul.lemma_mul_inequality. tmp%6 tmp%7 tmp%8)
                              )
                              (=>
                               (ens%vstd!arithmetic.mul.lemma_mul_inequality. tmp%6 tmp%7 tmp%8)
                               (=>
                       ...
                       (=>
                        ...
                        (=>
                         %%location_label%%12
                         (< (Mul c@ (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 8 k!))))) (vstd!arithmetic.power2.pow2.?
                           (I 64)
                    )))))))
                    (=>
                     (< (Mul c@ (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 8 k!))))) (vstd!arithmetic.power2.pow2.?
                 ...
                 (=>
                  ...
                  (=>
                   (= tmp%9 (uClip 64 (nClip (Mul 8 k!))))
                   (and
                    (=>
                     %%location_label%%14
                     (req%vstd!bits.lemma_u64_shl_is_mul. c@ tmp%9)
                    )
                    (=>
                     (ens%vstd!bits.lemma_u64_shl_is_mul. c@ tmp%9)
                     (=>
                      %%location_label%%15
                      (= (uClip 64 (bitshl (I c@) (I (nClip (Mul 8 k!))))) (Mul c@ (vstd!arithmetic.power2.pow2.?
                         (I (nClip (Mul 8 k!)))
                )))))))))
                (=>
                 (= (uClip 64 (bitshl (I c@) (I (nClip (Mul 8 k!))))) (Mul c@ (vstd!arithmetic.power2.pow2.?
                 ...
                 (=>
                  (= tmp%10 (< (curve25519_dalek!lemmas.field_lemmas.load8_lemmas.load8_at_plus_version_rec.?
                     (Poly%slice%<u8.>. input!) (I i!) (I k!)
                    ) (Add (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 8 k!)))) (Mul c@ (vstd!arithmetic.power2.pow2.?
                       (I (nClip (Mul 8 k!)))
                  )))))
                  (and
                   (=>
                   ...
                   (=>
                    ...
                    (and
                     (and
                      (=>
                       (= tmp%11 (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 8 k!)))))
                       (=>
                        (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add. tmp%11 c@ 1)
                        (=>
                         %%location_label%%17
                         (= (Add (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 8 k!)))) (Mul c@ (vstd!arithmetic.power2.pow2.?
                             (I (nClip (Mul 8 k!)))
                           ))
                          ) (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 8 k!)))) (Add c@ 1))
                      ))))
                      (=>
                       (= (Add (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 8 k!)))) (Mul c@ (vstd!arithmetic.power2.pow2.?
                           (I (nClip (Mul 8 k!)))
                       ...
                       (=>
                        (= tmp%12 (<= (Add c@ 1) (vstd!arithmetic.power2.pow2.? (I 8))))
                        (and
                         (=>
                          %%location_label%%18
                          tmp%12
                         ...
                         (=>
                          ...
                          (and
                           (=>
                            (= tmp%13 (Add c@ 1))
                            (=>
                             (= tmp%14 (vstd!arithmetic.power2.pow2.? (I 8)))
                             (=>
                              (= tmp%15 (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 8 k!)))))
                              (and
                               (=>
                                %%location_label%%19
                                (req%vstd!arithmetic.mul.lemma_mul_inequality. tmp%13 tmp%14 tmp%15)
                               )
                               (=>
                                (ens%vstd!arithmetic.mul.lemma_mul_inequality. tmp%13 tmp%14 tmp%15)
                                (=>
                                 (= tmp%16 (nClip (Mul 8 k!)))
                                 (=>
                                  (ens%vstd!arithmetic.power2.lemma_pow2_adds. 8 tmp%16)
                                  (=>
                                   (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add. 8 1 k!)
                                   (=>
                                    %%location_label%%20
                                    (<= (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 8 k!)))) (Add c@ 1)) (vstd!arithmetic.power2.pow2.?
                                      (I (nClip (Mul 8 (nClip (Add k! 1)))))
                           )))))))))))
                           (=>
                            (<= (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 8 k!)))) (Add c@ 1)) (vstd!arithmetic.power2.pow2.?
                              (I (nClip (Mul 8 (nClip (Add k! 1)))))
