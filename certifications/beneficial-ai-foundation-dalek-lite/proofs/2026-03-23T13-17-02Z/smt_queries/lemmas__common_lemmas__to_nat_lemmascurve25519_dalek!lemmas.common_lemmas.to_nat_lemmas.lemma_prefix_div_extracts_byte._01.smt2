...
;; curve25519-dalek/src/lemmas/common_lemmas/to_nat_lemmas.rs:422:1: 422:70 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::to_nat_lemmas::lemma_prefix_div_extracts_byte
;; curve25519-dalek/src/lemmas/common_lemmas/to_nat_lemmas.rs:422:1: 422:70 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= low@ (curve25519_dalek!specs.core_specs.bytes_as_nat_prefix.? (vstd!view.View.view.?
       $ (ARRAY $ (UINT 8) $ (CONST_INT 32)) (Poly%array%. bytes!)
      ) (I i!)
    ))
    (=>
     ...
     (=>
      (= byte_val@ (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT
            8
           ) $ (CONST_INT 32)
          ) (Poly%array%. bytes!)
         ) (I i!)
      ...
      (=>
       (= goal@ (= (EucMod (EucDiv (curve25519_dalek!specs.core_specs.bytes_as_nat_prefix.? (
             vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT 32)) (Poly%array%. bytes!)
            ) (I (nClip (Add i! 1)))
           ) d@
          ) (vstd!arithmetic.power2.pow2.? (I 8))
        ...
        (=>
         ...
         (=>
          ...
          (=>
           ...
           (=>
            (= tmp%2 (= (curve25519_dalek!specs.core_specs.bytes_as_nat_prefix.? (vstd!view.View.view.?
                $ (ARRAY $ (UINT 8) $ (CONST_INT 32)) (Poly%array%. bytes!)
               ) (I (nClip (Add i! 1)))
              ) (nClip (Add low@ (nClip (Mul d@ byte_val@))))
            ))
            (and
             (=>
              %%location_label%%0
               ...
               (=>
                ...
                (and
                 (and
                  (=>
                   %%location_label%%3
                   (req%vstd!arithmetic.div_mod.lemma_basic_div. low@ d@)
                  )
                  (=>
                   (ens%vstd!arithmetic.div_mod.lemma_basic_div. low@ d@)
                   (=>
                    %%location_label%%4
                    (= (EucDiv low@ d@) 0)
                 )))
                 (=>
                  ...
                  (and
                   (=>
                    (= tmp%4 (= (nClip (Add low@ (nClip (Mul d@ byte_val@)))) (nClip (Add (nClip (Mul d@ byte_val@))
                        low@
                    ))))
                    (and
                     (=>
                     ...
                     (=>
                      ...
                      (and
                       (=>
                        %%location_label%%6
                        (req%vstd!arithmetic.div_mod.lemma_div_multiples_vanish_fancy. byte_val@ low@ d@)
                       )
                       (=>
                        (ens%vstd!arithmetic.div_mod.lemma_div_multiples_vanish_fancy. byte_val@ low@ d@)
                        (=>
                         %%location_label%%7
                         (= (EucDiv (nClip (Add low@ (nClip (Mul d@ byte_val@)))) d@) byte_val@)
                   ))))))
                   (=>
                    (= (EucDiv (nClip (Add low@ (nClip (Mul d@ byte_val@)))) d@) byte_val@)
                    (and
                     (=>
                      ...
                      (=>
                       (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_u8_lt_pow2_8. tmp%5)
                       (=>
                        (= tmp%6 (vstd!arithmetic.power2.pow2.? (I 8)))
                        (and
                         (=>
                          %%location_label%%8
                          (req%vstd!arithmetic.div_mod.lemma_small_mod. byte_val@ tmp%6)
                         )
                         (=>
                          (ens%vstd!arithmetic.div_mod.lemma_small_mod. byte_val@ tmp%6)
                          (=>
                           %%location_label%%9
                           (= (EucMod byte_val@ (vstd!arithmetic.power2.pow2.? (I 8))) byte_val@)
                     ))))))
                     (=>
                      (= (EucMod byte_val@ (vstd!arithmetic.power2.pow2.? (I 8))) byte_val@)
                      (=>
