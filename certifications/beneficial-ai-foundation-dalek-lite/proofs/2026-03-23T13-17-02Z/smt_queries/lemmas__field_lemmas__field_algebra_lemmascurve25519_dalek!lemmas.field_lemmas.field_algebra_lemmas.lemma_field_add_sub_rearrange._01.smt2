...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:602:1: 602:67 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_field_add_sub_rearrange
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:602:1: 602:67 (#0)
...
(push)
 ...
 (declare-const a_int@ Int)
 (declare-const b_int@ Int)
 (declare-const c_int@ Int)
 ...
 (assert
  (not (=>
    ...
    (=>
     (= tmp%%@ (tuple%4./tuple%4 (I a!) (I b!) (I c!) (I p@)))
     (=>
      (= a_int@ (%I (tuple%4./tuple%4/0 (%Poly%tuple%4. (Poly%tuple%4. tmp%%@)))))
      (=>
       (= b_int@ (%I (tuple%4./tuple%4/1 (%Poly%tuple%4. (Poly%tuple%4. tmp%%@)))))
       (=>
        (= c_int@ (%I (tuple%4./tuple%4/2 (%Poly%tuple%4. (Poly%tuple%4. tmp%%@)))))
        (=>
         (= p_int@ (%I (tuple%4./tuple%4/3 (%Poly%tuple%4. (Poly%tuple%4. tmp%%@)))))
         (=>
          ...
          (and
           (and
            (=>
             %%location_label%%0
             (req%vstd!arithmetic.div_mod.lemma_small_mod. c! p@)
            )
            (=>
             (ens%vstd!arithmetic.div_mod.lemma_small_mod. c! p@)
             (and
              (=>
               %%location_label%%1
              ...
              (=>
               ...
               (and
                (=>
                 %%location_label%%2
                 (req%vstd!arithmetic.div_mod.lemma_small_mod. b! p@)
                )
                (=>
                 (ens%vstd!arithmetic.div_mod.lemma_small_mod. b! p@)
                 (=>
                  (= tmp%1 (Add a_int@ b_int@))
                  (and
                   (=>
                    %%location_label%%3
                    (req%vstd!arithmetic.div_mod.lemma_add_mod_noop. tmp%1 1 p_int@)
                   )
                   (=>
                    (ens%vstd!arithmetic.div_mod.lemma_add_mod_noop. tmp%1 1 p_int@)
                    (=>
                     (= tmp%2 (Sub (Add c_int@ p_int@) 1))
                     (and
                      (=>
                       %%location_label%%4
                       (req%vstd!arithmetic.div_mod.lemma_add_mod_noop. tmp%2 1 p_int@)
                      )
                      (=>
                       (ens%vstd!arithmetic.div_mod.lemma_add_mod_noop. tmp%2 1 p_int@)
                       (and
                        (=>
                         %%location_label%%5
                         (req%vstd!arithmetic.div_mod.lemma_mod_add_multiples_vanish. c_int@ p_int@)
                        )
                        (=>
                         (ens%vstd!arithmetic.div_mod.lemma_mod_add_multiples_vanish. c_int@ p_int@)
                         (=>
                          (= tmp%3 (= (EucMod (Add (Add a_int@ b_int@) 1) p_int@) c_int@))
                          (and
                           (=>
                            %%location_label%%6
                            tmp%3
                           ...
                           (=>
                            tmp%3
                            (=>
                             (= tmp%4 (Add (Add a_int@ b_int@) 1))
                             (and
                              (=>
                               %%location_label%%7
                               (req%vstd!arithmetic.div_mod.lemma_sub_mod_noop. tmp%4 b_int@ p_int@)
                              )
                              (=>
                               (ens%vstd!arithmetic.div_mod.lemma_sub_mod_noop. tmp%4 b_int@ p_int@)
                               (=>
                                (= tmp%5 (Sub c_int@ b_int@))
                                (and
                                 (=>
                                  %%location_label%%8
                                  (req%vstd!arithmetic.div_mod.lemma_mod_add_multiples_vanish. tmp%5 p_int@)
                                 )
                                 (=>
                                  (ens%vstd!arithmetic.div_mod.lemma_mod_add_multiples_vanish. tmp%5 p_int@)
                                  (=>
                                   %%location_label%%9
                                   (= (curve25519_dalek!specs.field_specs.field_add.? (I a!) (I 1)) (curve25519_dalek!specs.field_specs.field_sub.?
                                     (I c!) (I b!)
