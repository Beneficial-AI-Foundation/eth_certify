...
;; curve25519-dalek/src/lemmas/common_lemmas/to_nat_lemmas.rs:663:1: 663:76 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::to_nat_lemmas::lemma_from_le_bytes
;; curve25519-dalek/src/lemmas/common_lemmas/to_nat_lemmas.rs:663:1: 663:76 (#0)
(get-info :all-statistics)
(push)
 (declare-const le_seq! vstd!seq.Seq<u8.>.)
 ...
 (assert
  (forall ((i$ Poly)) (!
    ...
    :pattern ((vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. le_seq!) i$))
    :qid user_curve25519_dalek__lemmas__common_lemmas__to_nat_lemmas__lemma_from_le_bytes_58
    :skolemid skolem_user_curve25519_dalek__lemmas__common_lemmas__to_nat_lemmas__lemma_from_le_bytes_58
 )))
 (assert
  (forall ((i$ Poly)) (!
    (=>
    ...
    :qid user_curve25519_dalek__lemmas__common_lemmas__to_nat_lemmas__lemma_from_le_bytes_59
    :skolemid skolem_user_curve25519_dalek__lemmas__common_lemmas__to_nat_lemmas__lemma_from_le_bytes_59
 )))
