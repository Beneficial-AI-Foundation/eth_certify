...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:3167:1: 3167:48 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_field_square_nonzero
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:3167:1: 3167:48 (#0)
      ...
      (=>
       ...
       (and
        ...
        (=>
         ...
         (=>
          %%location_label%%3
          (not (= (curve25519_dalek!specs.field_specs.field_square.? (I z!)) 0))
      ))))
      (=>
       (not (= (curve25519_dalek!specs.field_specs.field_square.? (I z!)) 0))
       (and
        (=>
         (= tmp%1 (curve25519_dalek!specs.field_specs.field_square.? (I z!)))
         (and
          (=>
           %%location_label%%4
           (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_element_reduced.
          ...
          (=>
           ...
           (=>
            %%location_label%%5
            (= (EucMod (curve25519_dalek!specs.field_specs.field_square.? (I z!)) (curve25519_dalek!specs.field_specs_u64.p.?
               (I 0)
              )
             ) (curve25519_dalek!specs.field_specs.field_square.? (I z!))
        )))))
        (=>
         (= (EucMod (curve25519_dalek!specs.field_specs.field_square.? (I z!)) (curve25519_dalek!specs.field_specs_u64.p.?
            (I 0)
