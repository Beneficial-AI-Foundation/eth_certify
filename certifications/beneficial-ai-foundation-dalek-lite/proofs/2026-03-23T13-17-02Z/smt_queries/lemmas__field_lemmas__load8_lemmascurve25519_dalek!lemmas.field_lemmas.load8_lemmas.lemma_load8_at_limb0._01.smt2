...
;; curve25519-dalek/src/lemmas/field_lemmas/load8_lemmas.rs:846:1: 846:48 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::load8_lemmas::lemma_load8_at_limb0
;; curve25519-dalek/src/lemmas/field_lemmas/load8_lemmas.rs:846:1: 846:48 (#0)
     ...
     (=>
      ...
      (=>
       ...
       (=>
        ...
        (and
         (=>
          (= tmp%1 (uClip 64 (curve25519_dalek!specs.core_specs.spec_load8_at.? (Poly%slice%<u8.>.
              input!
             ) (I 0)
          )))
          (=>
           ...
           (=>
            %%location_label%%0
            (= (uClip 64 (curve25519_dalek!specs.core_specs.spec_load8_at.? (Poly%slice%<u8.>. input!)
               (I 0)
              )
             ) (uClip 64 (bitshr (I (uClip 64 (curve25519_dalek!specs.core_specs.spec_load8_at.? (Poly%slice%<u8.>.
                   input!
                  ) (I 0)
                ))
               ) (I 0)
         ...
         (=>
          ...
          (and
           ...
           (=>
            ...
            (=>
             (= tmp%2 (= (uClip 64 (bitand (I (uClip 64 (bitshr (I (uClip 64 (curve25519_dalek!specs.core_specs.spec_load8_at.?
                       (Poly%slice%<u8.>. input!) (I i@)
                     ))
                    ) (I k@)
                  ))
