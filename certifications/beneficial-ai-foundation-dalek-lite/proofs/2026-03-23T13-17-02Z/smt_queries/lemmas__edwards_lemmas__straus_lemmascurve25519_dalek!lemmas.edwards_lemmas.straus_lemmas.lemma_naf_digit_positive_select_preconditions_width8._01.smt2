...
;; curve25519-dalek/src/lemmas/edwards_lemmas/straus_lemmas.rs:537:5: 537:11 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::straus_lemmas::lemma_naf_digit_positive_select_preconditions_width8
;; curve25519-dalek/src/lemmas/edwards_lemmas/straus_lemmas.rs:537:5: 537:11 (#0)
...
(assert
 (bvsgt digit! ((_ zero_extend 7) (_ bv0 1)))
)
(assert
 (not (= (let
...
(assert
 (not (=>
   %%location_label%%0
   (= (bvand ((_ sign_extend 24) digit!) ((_ zero_extend 31) (_ bv1 1))) ((_ zero_extend
      31
     ) (_ bv1 1)
)))))
(get-info :version)
