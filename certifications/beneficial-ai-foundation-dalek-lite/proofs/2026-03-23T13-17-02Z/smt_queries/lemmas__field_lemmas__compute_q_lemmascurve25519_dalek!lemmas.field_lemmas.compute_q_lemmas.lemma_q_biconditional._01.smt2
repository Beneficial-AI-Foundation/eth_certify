...
;; curve25519-dalek/src/lemmas/field_lemmas/compute_q_lemmas.rs:508:1: 508:60 (#0)
...
;; Function-Specs curve25519_dalek::lemmas::field_lemmas::compute_q_lemmas::lemma_carry_propagation_is_division
(declare-fun req%curve25519_dalek!lemmas.field_lemmas.compute_q_lemmas.lemma_carry_propagation_is_division.
 (%%Function%% Int) Bool
)
...
(assert
 (forall ((limbs! %%Function%%) (q! Int)) (!
   (= (req%curve25519_dalek!lemmas.field_lemmas.compute_q_lemmas.lemma_carry_propagation_is_division.
     limbs! q!
    ) (and
     (=>
      ...
      (forall ((i$ Poly)) (!
        ...
        :qid user_curve25519_dalek__lemmas__field_lemmas__compute_q_lemmas__lemma_carry_propagation_is_division_53
        :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__compute_q_lemmas__lemma_carry_propagation_is_division_53
     )))
     (=>
      %%global_location_label%%41
      (= q! (curve25519_dalek!specs.field_specs_u64.compute_q_spec.? (Poly%array%. limbs!)))
   )))
   :pattern ((req%curve25519_dalek!lemmas.field_lemmas.compute_q_lemmas.lemma_carry_propagation_is_division.
     limbs! q!
   ))
   :qid internal_req__curve25519_dalek!lemmas.field_lemmas.compute_q_lemmas.lemma_carry_propagation_is_division._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.field_lemmas.compute_q_lemmas.lemma_carry_propagation_is_division._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.field_lemmas.compute_q_lemmas.lemma_carry_propagation_is_division.
 (%%Function%% Int) Bool
)
(assert
 (forall ((limbs! %%Function%%) (q! Int)) (!
   (= (ens%curve25519_dalek!lemmas.field_lemmas.compute_q_lemmas.lemma_carry_propagation_is_division.
     limbs! q!
    ) (= q! (EucDiv (nClip (Add (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%.
          limbs!
         )
        ) 19
       )
   ...
   :pattern ((ens%curve25519_dalek!lemmas.field_lemmas.compute_q_lemmas.lemma_carry_propagation_is_division.
     limbs! q!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.field_lemmas.compute_q_lemmas.lemma_carry_propagation_is_division._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.field_lemmas.compute_q_lemmas.lemma_carry_propagation_is_division._definition
)))

;; Function-Specs curve25519_dalek::lemmas::field_lemmas::compute_q_lemmas::lemma_q_is_binary
(declare-fun req%curve25519_dalek!lemmas.field_lemmas.compute_q_lemmas.lemma_q_is_binary.
 (%%Function%% Int) Bool
)
...
(assert
 (forall ((limbs! %%Function%%) (q! Int)) (!
   (= (req%curve25519_dalek!lemmas.field_lemmas.compute_q_lemmas.lemma_q_is_binary. limbs!
     q!
    ) (and
     (=>
      ...
      (forall ((i$ Poly)) (!
        ...
        :qid user_curve25519_dalek__lemmas__field_lemmas__compute_q_lemmas__lemma_q_is_binary_55
        :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__compute_q_lemmas__lemma_q_is_binary_55
     )))
     (=>
   ...
   :pattern ((req%curve25519_dalek!lemmas.field_lemmas.compute_q_lemmas.lemma_q_is_binary.
     limbs! q!
   ))
   :qid internal_req__curve25519_dalek!lemmas.field_lemmas.compute_q_lemmas.lemma_q_is_binary._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.field_lemmas.compute_q_lemmas.lemma_q_is_binary._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.field_lemmas.compute_q_lemmas.lemma_q_is_binary.
 (%%Function%% Int) Bool
)
(assert
 (forall ((limbs! %%Function%%) (q! Int)) (!
   (= (ens%curve25519_dalek!lemmas.field_lemmas.compute_q_lemmas.lemma_q_is_binary. limbs!
     q!
    ) (and
     (or
      (= q! 0)
   ...
   :pattern ((ens%curve25519_dalek!lemmas.field_lemmas.compute_q_lemmas.lemma_q_is_binary.
     limbs! q!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.field_lemmas.compute_q_lemmas.lemma_q_is_binary._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.field_lemmas.compute_q_lemmas.lemma_q_is_binary._definition
)))

;; Function-Specs curve25519_dalek::lemmas::field_lemmas::compute_q_lemmas::lemma_q_biconditional
(declare-fun req%curve25519_dalek!lemmas.field_lemmas.compute_q_lemmas.lemma_q_biconditional.
 (%%Function%% Int) Bool
)
...
(assert
 (forall ((limbs! %%Function%%) (q! Int)) (!
   (= (req%curve25519_dalek!lemmas.field_lemmas.compute_q_lemmas.lemma_q_biconditional.
     limbs! q!
    ) (and
     (=>
      ...
      (forall ((i$ Poly)) (!
        ...
        :qid user_curve25519_dalek__lemmas__field_lemmas__compute_q_lemmas__lemma_q_biconditional_58
        :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__compute_q_lemmas__lemma_q_biconditional_58
     )))
     (=>
   ...
   :pattern ((req%curve25519_dalek!lemmas.field_lemmas.compute_q_lemmas.lemma_q_biconditional.
     limbs! q!
   ))
   :qid internal_req__curve25519_dalek!lemmas.field_lemmas.compute_q_lemmas.lemma_q_biconditional._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.field_lemmas.compute_q_lemmas.lemma_q_biconditional._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.field_lemmas.compute_q_lemmas.lemma_q_biconditional.
 (%%Function%% Int) Bool
)
(assert
 (forall ((limbs! %%Function%%) (q! Int)) (!
   (= (ens%curve25519_dalek!lemmas.field_lemmas.compute_q_lemmas.lemma_q_biconditional.
     limbs! q!
    ) (and
     (= (>= (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. limbs!))
   ...
   :pattern ((ens%curve25519_dalek!lemmas.field_lemmas.compute_q_lemmas.lemma_q_biconditional.
     limbs! q!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.field_lemmas.compute_q_lemmas.lemma_q_biconditional._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.field_lemmas.compute_q_lemmas.lemma_q_biconditional._definition
)))

;; Function-Def curve25519_dalek::lemmas::field_lemmas::compute_q_lemmas::lemma_q_biconditional
;; curve25519-dalek/src/lemmas/field_lemmas/compute_q_lemmas.rs:508:1: 508:60 (#0)
...
(push)
 ...
 (assert
  (forall ((i$ Poly)) (!
    ...
    :qid user_curve25519_dalek__lemmas__field_lemmas__compute_q_lemmas__lemma_q_biconditional_59
    :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__compute_q_lemmas__lemma_q_biconditional_59
 )))
 (assert
  (< (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. limbs!)) (
    nClip (Mul 2 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
      ...
      (or
       (and
        (=>
         ...
         (=>
          (= tmp%1 (nClip (Add (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%.
               limbs!
              )
             ) 19
          )))
        ...
        (=>
         (not (< (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. limbs!))
           (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
         ))
         %%switch_label%%4
       ))
        ...
        (or
         (and
          (=>
           (= q! 0)
           (=>
            (= tmp%3 (nClip (Add (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%.
                 limbs!
                )
               ) 19
            )))
            (=>
             (= tmp%4 (vstd!arithmetic.power2.pow2.? (I 255)))
             (and
              (=>
               %%location_label%%1
              ...
              (=>
               ...
               (=>
                (= tmp%5 (nClip (Add (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%.
                     limbs!
                    )
                   ) 19
                )))
             ...
             (or
              (and
               (=>
                (= q! 0)
                (=>
                 (= tmp%7 (nClip (Add (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%.
                      limbs!
                     )
                    ) 19
                 )))
                 (=>
                  (= tmp%8 (vstd!arithmetic.power2.pow2.? (I 255)))
                  (and
                   (=>
                    %%location_label%%3
                    (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. tmp%7 tmp%8)
                   )
                   (=>
                    (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. tmp%7 tmp%8)
                    (=>
                     (= tmp%9 (nClip (Add (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%.
                          limbs!
                         )
                        ) 19
                     )))
                     (=>
                      ...
                      (and
                       (=>
                        %%location_label%%4
                        (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%9 tmp%10)
                       )
                       (=>
                        (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%9 tmp%10)
                        %%switch_label%%2
               )))))))))
               (=>
                (not (= q! 0))
            ...
            (or
             (and
              (=>
               (= q! 1)
               (=>
                (= tmp%11 (nClip (Add (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%.
                     limbs!
                    )
                   ) 19
                )))
                (=>
                 (= tmp%12 (vstd!arithmetic.power2.pow2.? (I 255)))
                 (and
                  (=>
                   %%location_label%%5
                   (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. tmp%11 tmp%12)
                  )
                  (=>
                   (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. tmp%11 tmp%12)
                   %%switch_label%%0
              )))))
              (=>
               (not (= q! 1))
