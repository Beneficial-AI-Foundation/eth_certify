...
;; curve25519-dalek/src/lemmas/ristretto_lemmas/batch_compress_lemmas.rs:615:1: 624:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::ristretto_lemmas::batch_compress_lemmas::lemma_degenerate_double_compresses_to_zero
;; curve25519-dalek/src/lemmas/ristretto_lemmas/batch_compress_lemmas.rs:615:1: 624:2 (#0)
     ...
     (=>
      ...
      (and
       (=>
        ...
        (=>
         %%location_label%%1
         (curve25519_dalek!specs.primality_specs.is_prime.? (I pn@))
       ))
       (=>
        (curve25519_dalek!specs.primality_specs.is_prime.? (I pn@))
        (=>
         ...
         (=>
          (= dx@ (curve25519_dalek!specs.field_specs.field_mul.? (I e!) (I (curve25519_dalek!specs.field_specs.field_inv.?
              (I f!)
          ))))
          (=>
           (= dy@ (curve25519_dalek!specs.field_specs.field_mul.? (I g!) (I (curve25519_dalek!specs.field_specs.field_inv.?
               (I h!)
           ))))
           (and
            (and
             ...
             (=>
              ...
              (=>
               ...
               (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. doubled@) (Poly%tuple%2. (
                  tuple%2./tuple%2 (I dx@) (I dy@)
            ))))))
            (=>
             (= doubled@ (tuple%2./tuple%2 (I dx@) (I dy@)))
             (=>
               ...
               (and
                (and
                 (=>
                  ...
                  (=>
                   (= tmp%1 (nClip (Mul eg@ fh@)))
                   (and
                    (=>
                     %%location_label%%4
                     (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%1 pn@)
                    )
                    (=>
                     (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%1 pn@)
                     (or
                      (and
                       (=>
                        (not (= egfh@ 0))
                        (and
                         (=>
                          %%location_label%%5
                          (req%vstd!arithmetic.div_mod.lemma_small_mod. egfh@ pn@)
                         )
                         (=>
                          (ens%vstd!arithmetic.div_mod.lemma_small_mod. egfh@ pn@)
                          %%switch_label%%9
                       )))
                       (=>
                        (not (not (= egfh@ 0)))
                      ...
                      (and
                       ...
                       (and
                        (=>
                         %%location_label%%6
                         (req%vstd!arithmetic.div_mod.lemma_small_mod. eg@ pn@)
                        )
                        (=>
                         (ens%vstd!arithmetic.div_mod.lemma_small_mod. eg@ pn@)
                         (and
                          (=>
                           %%location_label%%7
                           (req%vstd!arithmetic.div_mod.lemma_small_mod. fh@ pn@)
                          )
                          (=>
                           (ens%vstd!arithmetic.div_mod.lemma_small_mod. fh@ pn@)
                           (and
                            (=>
                             %%location_label%%8
                             (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. eg@ fh@ pn@)
                            )
                            (=>
                             (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. eg@ fh@ pn@)
                             (=>
                              (= tmp%2 (EucMod eg@ pn@))
                              (and
                               (=>
                                %%location_label%%9
                                (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. tmp%2 fh@ pn@)
                               )
                               (=>
                                (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. tmp%2 fh@ pn@)
                                (=>
                                 %%location_label%%10
                                 (= (EucMod (nClip (Mul eg@ fh@)) pn@) 0)
                 ))))))))))))))))
                 (=>
                  (= (EucMod (nClip (Mul eg@ fh@)) pn@) 0)
                  (and
                 ...
                 (and
                  (or
                      ...
                      (=>
                       ...
                       (and
                        (and
                         (=>
                          %%location_label%%15
                          (req%vstd!arithmetic.div_mod.lemma_small_mod. e! pn@)
                         )
                         (=>
                          (ens%vstd!arithmetic.div_mod.lemma_small_mod. e! pn@)
                          (and
                           (=>
                            %%location_label%%16
                            (req%vstd!arithmetic.div_mod.lemma_small_mod. g! pn@)
                           )
                           (=>
                            (ens%vstd!arithmetic.div_mod.lemma_small_mod. g! pn@)
                            (and
                             (=>
                              %%location_label%%17
                              (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. e! g! pn@)
                             )
                             (=>
                              (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. e! g! pn@)
                              (=>
                               (= tmp%3 (EucMod e! pn@))
                               (and
                                (=>
                                 %%location_label%%18
                                 (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. tmp%3 g! pn@)
                                )
                                (=>
                                 (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. tmp%3 g! pn@)
                                 (=>
                                  %%location_label%%19
                                  (= (EucMod (nClip (Mul e! g!)) pn@) 0)
                        ))))))))))
                        (=>
                         (= (EucMod (nClip (Mul e! g!)) pn@) 0)
                         (and
                      ...
                      (=>
                       ...
                       (and
                        (and
                         (=>
                          %%location_label%%33
                          (req%vstd!arithmetic.div_mod.lemma_small_mod. f! pn@)
                         )
                         (=>
                          (ens%vstd!arithmetic.div_mod.lemma_small_mod. f! pn@)
                          (and
                           (=>
                            %%location_label%%34
                            (req%vstd!arithmetic.div_mod.lemma_small_mod. h! pn@)
                           )
                           (=>
                            (ens%vstd!arithmetic.div_mod.lemma_small_mod. h! pn@)
                            (and
                             (=>
                              %%location_label%%35
                              (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. f! h! pn@)
                             )
                             (=>
                              (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. f! h! pn@)
                              (=>
                               (= tmp%6 (EucMod f! pn@))
                               (and
                                (=>
                                 %%location_label%%36
                                 (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. tmp%6 h! pn@)
                                )
                                (=>
                                 (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. tmp%6 h! pn@)
                                 (=>
                                  %%location_label%%37
                                  (= (EucMod (nClip (Mul f! h!)) pn@) 0)
                        ))))))))))
                        (=>
                         (= (EucMod (nClip (Mul f! h!)) pn@) 0)
                         (and
                               ...
                               (=>
                                ...
                                (and
                                 ...
                                 (=>
                                  ...
                                  (and
                                   (=>
                                    (= tmp%7 (curve25519_dalek!specs.field_specs.field_inv.? (I f!)))
                                    (and
                                     (=>
                                      %%location_label%%42
                                      (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_zero_right.
                               ...
                               (=>
                                ...
                                (and
                                 ...
                                 (=>
                                  ...
                                  (and
                                   (=>
                                    (= tmp%8 (curve25519_dalek!specs.field_specs.field_inv.? (I h!)))
                                    (and
                                     (=>
                                      %%location_label%%48
                                      (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_zero_right.
                   ...
                   (and
                    ...
                    (=>
                     %%location_label%%51
                     (= (curve25519_dalek!specs.field_specs.field_mul.? (I dx@) (I dy@)) 0)
                  )))
                  (=>
                   (= (curve25519_dalek!specs.field_specs.field_mul.? (I dx@) (I dy@)) 0)
                   (and
                    (and
                     (and
                      ...
                      (=>
                       ...
                       (=>
                        %%location_label%%53
                        (= (EucMod (curve25519_dalek!specs.field_specs.field_mul.? (I dx@) (I dy@)) pn@) 0)
                     )))
                     (=>
                      (= (EucMod (curve25519_dalek!specs.field_specs.field_mul.? (I dx@) (I dy@)) pn@) 0)
                      (and
