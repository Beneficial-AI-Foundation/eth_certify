...
;; curve25519-dalek/src/lemmas/lizard_lemmas.rs:500:1: 500:81 (#0)
...
;; Function-Def curve25519_dalek::lemmas::lizard_lemmas::lemma_jacobi_to_edwards_affine_y_zero_when_s_sq_one
;; curve25519-dalek/src/lemmas/lizard_lemmas.rs:500:1: 500:81 (#0)
  ...
  (not (=>
    ...
    (and
     (=>
      ...
      (=>
       %%location_label%%0
       (= (curve25519_dalek!specs.field_specs.field_sub.? (I 1) (I (curve25519_dalek!specs.field_specs.field_square.?
           (I s!)
         ))
        ) 0
     )))
     (=>
      ...
      (and
       ...
       (=>
        ...
        (and
         (=>
          (= tmp%2 (curve25519_dalek!specs.field_specs.field_sub.? (I 1) (I (curve25519_dalek!specs.field_specs.field_square.?
              (I s!)
          ))))
          (=>
           (= tmp%3 (curve25519_dalek!specs.field_specs.field_inv.? (I (curve25519_dalek!specs.field_specs.field_add.?
               (I 1) (I (curve25519_dalek!specs.field_specs.field_square.? (I s!)))
           ))))
           (and
            (=>
             %%location_label%%3
