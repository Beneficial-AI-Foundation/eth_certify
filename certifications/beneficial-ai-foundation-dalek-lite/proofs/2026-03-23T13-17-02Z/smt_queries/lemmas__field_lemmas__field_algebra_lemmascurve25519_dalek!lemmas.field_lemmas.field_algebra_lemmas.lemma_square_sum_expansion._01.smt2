...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:3086:5: 3086:11 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_square_sum_expansion
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:3086:5: 3086:11 (#0)
...
(push)
 ...
 (assert
  (not (=>
    %%location_label%%0
    (= (Sub (nClip (Mul (nClip (Add a! b!)) (nClip (Add a! b!)))) (nClip (Add (nClip (Mul a!
          a!
         )
        ) (nClip (Mul b! b!))
      ))
     ) (nClip (Mul 2 (nClip (Mul a! b!))))
 ))))
 (get-info :version)
