...
;; curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:254:1: 254:80 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::pow_lemmas::lemma_binary_sum_mod_decomposition
;; curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:254:1: 254:80 (#0)
        ...
        (=>
         ...
         (and
          (and
           (=>
            %%location_label%%1
            (req%vstd!arithmetic.div_mod.lemma_add_mod_noop. x@ y@ pk@)
           )
           (=>
            (ens%vstd!arithmetic.div_mod.lemma_add_mod_noop. x@ y@ pk@)
            (=>
             %%location_label%%2
             (= (EucMod (nClip (Add x@ y@)) pk@) (EucMod (nClip (Add (EucMod x@ pk@) (EucMod y@ pk@)))
               pk@
          )))))
          (=>
           (= (EucMod (nClip (Add x@ y@)) pk@) (EucMod (nClip (Add (EucMod x@ pk@) (EucMod y@ pk@)))
            ...
            (and
             (=>
              ...
              (=>
               ...
               (and
                (and
                 (=>
                  (ens%vstd!arithmetic.power2.lemma_pow2_adds. d@ k!)
                  (=>
                   (= tmp%1 (vstd!arithmetic.power2.pow2.? (I d@)))
                   (=>
                    (ens%vstd!arithmetic.mul.lemma_mul_is_associative. b! tmp%1 pk@)
                    (=>
                     %%location_label%%3
                     (= y@ (nClip (Mul (nClip (Mul b! (vstd!arithmetic.power2.pow2.? (I d@)))) pk@)))
                 ))))
                 (=>
                  (= y@ (nClip (Mul (nClip (Mul b! (vstd!arithmetic.power2.pow2.? (I d@)))) pk@)))
                  (and
                   (=>
                    (= tmp%2 (nClip (Mul b! (vstd!arithmetic.power2.pow2.? (I d@)))))
                    (and
                     (=>
                      %%location_label%%4
                      (req%vstd!arithmetic.div_mod.lemma_mod_multiples_basic. tmp%2 pk@)
                     )
                     (=>
                      (ens%vstd!arithmetic.div_mod.lemma_mod_multiples_basic. tmp%2 pk@)
                      (=>
                       %%location_label%%5
                       (= (EucMod y@ pk@) 0)
                   ))))
                ...
                (=>
                 ...
                 (and
                  (and
                   (=>
                    %%location_label%%7
                    (req%vstd!arithmetic.div_mod.lemma_mod_twice. x@ pk@)
                   )
                   (=>
                    (ens%vstd!arithmetic.div_mod.lemma_mod_twice. x@ pk@)
                    (=>
                     %%location_label%%8
                     (= (EucMod (EucMod x@ pk@) pk@) (EucMod x@ pk@))
                  )))
                  (=>
                   (= (EucMod (EucMod x@ pk@) pk@) (EucMod x@ pk@))
                   %%switch_label%%0
             ...
             (=>
              ...
              (=>
               ...
               (and
                (=>
                 (ens%vstd!arithmetic.power2.lemma_pow2_pos. d$1@)
                 (=>
                  %%location_label%%9
                  (> (vstd!arithmetic.power2.pow2.? (I d$1@)) 0)
                ))
                (=>
                 (> (vstd!arithmetic.power2.pow2.? (I d$1@)) 0)
                 (=>
                  (= z@ (EucMod b! (vstd!arithmetic.power2.pow2.? (I d$1@))))
                  (and
                   (and
                    (=>
                     %%location_label%%10
                     (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_mul_mod. b! s! k!)
                    )
                    (=>
                     (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_mul_mod. b! s! k!)
                     (=>
                      %%location_label%%11
                      (= (EucMod y@ pk@) (nClip (Mul z@ ps@)))
                   )))
                   (=>
                    (= (EucMod y@ pk@) (nClip (Mul z@ ps@)))
                    (and
                     (and
                      (and
                       (=>
                        %%location_label%%12
                        (req%vstd!arithmetic.power2.lemma_pow2_strictly_increases. s! k!)
                       )
                       (=>
                        (ens%vstd!arithmetic.power2.lemma_pow2_strictly_increases. s! k!)
                        (=>
                         %%location_label%%13
                         (< ps@ pk@)
                      )))
                      (=>
                       ...
                       (and
                        (=>
                         %%location_label%%14
                         (req%vstd!arithmetic.div_mod.lemma_small_mod. x@ pk@)
                        )
                        (=>
                         (ens%vstd!arithmetic.div_mod.lemma_small_mod. x@ pk@)
                         (=>
                          %%location_label%%15
                          (= (EucMod x@ pk@) x@)
                     )))))
                      ...
                      (and
                       (and
                        (and
                         (and
                          (=>
                           (= tmp%3 (vstd!arithmetic.power2.pow2.? (I d$1@)))
                           (and
                            (=>
                             %%location_label%%16
                             (req%vstd!arithmetic.div_mod.lemma_small_mod. z@ tmp%3)
                            )
                            (=>
                             (ens%vstd!arithmetic.div_mod.lemma_small_mod. z@ tmp%3)
                             (=>
                              %%location_label%%17
                              (< z@ (vstd!arithmetic.power2.pow2.? (I d$1@)))
                          ))))
                          (=>
                           (< z@ (vstd!arithmetic.power2.pow2.? (I d$1@)))
                           (and
                            ...
                            (=>
                             ...
                             (=>
                              %%location_label%%19
                              (<= (nClip (Mul z@ ps@)) (Sub pk@ ps@))
                         )))))
                         (=>
                          (<= (nClip (Mul z@ ps@)) (Sub pk@ ps@))
                          (=>
                           %%location_label%%20
                           (< (nClip (Add x@ (nClip (Mul z@ ps@)))) pk@)
                        )))
                        (=>
                         (< (nClip (Add x@ (nClip (Mul z@ ps@)))) pk@)
                         (=>
                          (= tmp%4 (nClip (Add x@ (nClip (Mul z@ ps@)))))
                          (and
                           (=>
                            %%location_label%%21
                            (req%vstd!arithmetic.div_mod.lemma_small_mod. tmp%4 pk@)
                           )
                           (=>
                            (ens%vstd!arithmetic.div_mod.lemma_small_mod. tmp%4 pk@)
                            (=>
                             %%location_label%%22
                             (= (EucMod (nClip (Add x@ (nClip (Mul z@ ps@)))) pk@) (nClip (Add x@ (nClip (Mul z@ ps@)))))
                       ))))))
                       (=>
                        (= (EucMod (nClip (Add x@ (nClip (Mul z@ ps@)))) pk@) (nClip (Add x@ (nClip (Mul z@ ps@)))))
                        %%switch_label%%0
