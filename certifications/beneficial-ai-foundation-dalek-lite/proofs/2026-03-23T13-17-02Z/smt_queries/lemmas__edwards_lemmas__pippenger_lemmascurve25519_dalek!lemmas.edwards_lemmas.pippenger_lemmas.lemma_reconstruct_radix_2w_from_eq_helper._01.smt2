...
;; curve25519-dalek/src/lemmas/edwards_lemmas/pippenger_lemmas.rs:539:7: 539:98 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::pippenger_lemmas::lemma_reconstruct_radix_2w_from_eq_helper
;; curve25519-dalek/src/lemmas/edwards_lemmas/pippenger_lemmas.rs:539:7: 539:98 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= decrease%init0 (Sub digits_count! k!))
    (=>
         ...
         (and
          (=>
           ...
           (check_decrease_int (let
             ((d!$0 d!) (w!$1 w!) (k!$2 tmp%1) (digits_count!$3 digits_count!))
             (Sub digits_count!$3 k!$2)
             ...
             (and
              ...
              (=>
               (forall ((i$ Poly)) (!
                 ...
                 :pattern ((vstd!seq.Seq.index.? $ (SINT 8) (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
                     sub@
                    ) (I 1) (I (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. sub@)))
                   ) i$
                 ))
                 :qid user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_reconstruct_radix_2w_from_eq_helper_96
                 :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_reconstruct_radix_2w_from_eq_helper_96
               ))
               (=>
                (= tmp%2 (ext_eq false (TYPE%vstd!seq.Seq. $ (SINT 8)) (vstd!seq.Seq.subrange.? $ (SINT
                    8
