...
;; MODULE 'module lemmas::lizard_lemmas, function curve25519_dalek::lemmas::lizard_lemmas::lemma_invsqrt_bridge'
;; curve25519-dalek/src/lemmas/lizard_lemmas.rs:254:1: 259:2 (#0)
...
(assert
 (distinct fuel%vstd!array.array_view. fuel%vstd!array.impl&%0.view. fuel%vstd!array.impl&%2.spec_index.
  ...
  fuel%vstd!view.impl&%22.view. fuel%vstd!view.impl&%26.view. fuel%curve25519_dalek!backend.serial.u64.constants.SQRT_M1.
  ...
  fuel%curve25519_dalek!specs.field_specs.is_negative. fuel%curve25519_dalek!specs.field_specs.nat_invsqrt.
...
;; Function-Def curve25519_dalek::lemmas::lizard_lemmas::lemma_invsqrt_bridge
;; curve25519-dalek/src/lemmas/lizard_lemmas.rs:254:1: 259:2 (#0)
(get-info :all-statistics)
(push)
 (declare-const gamma_arg_nat! Int)
 (declare-const gamma_nat! Int)
 (declare-const gamma_sq_val! Bool)
 (declare-const one_canonical! Int)
 ...
 (assert
  (not (or
    (and
     (=>
      (not (= (EucMod gamma_arg_nat! (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
        0
      ))
      (and
       (=>
        ...
        (and
         (=>
          %%location_label%%0
          (req%vstd!arithmetic.div_mod.lemma_small_mod. gamma_nat! tmp%1)
         )
         (=>
          (ens%vstd!arithmetic.div_mod.lemma_small_mod. gamma_nat! tmp%1)
          (=>
           %%location_label%%1
           (not (curve25519_dalek!specs.field_specs.is_negative.? (I gamma_nat!)))
       ))))
       (=>
        (not (curve25519_dalek!specs.field_specs.is_negative.? (I gamma_nat!)))
        (or
         (and
          (=>
           gamma_sq_val!
           (=>
            (= tmp%2 (curve25519_dalek!specs.field_specs.is_sqrt_ratio.? (I 1) (I gamma_arg_nat!)
              (I gamma_nat!)
            ))
            (and
             (=>
           ...
           (and
            (=>
             ...
             (and
              (=>
               %%location_label%%3
               (req%vstd!arithmetic.div_mod.lemma_small_mod. gamma_arg_nat! tmp%3)
              )
              (=>
               (ens%vstd!arithmetic.div_mod.lemma_small_mod. gamma_arg_nat! tmp%3)
               (=>
                %%location_label%%4
                (not (= gamma_arg_nat! 0))
            ))))
            (=>
             (not (= gamma_arg_nat! 0))
             (=>
              (= tmp%4 (curve25519_dalek!specs.field_specs.is_sqrt_ratio_times_i.? (I 1) (I gamma_arg_nat!)
                (I gamma_nat!)
              ))
              (and
               (=>
     ...
     (=>
      (not (not (= (EucMod gamma_arg_nat! (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
         0
      )))
      (and
       (=>
        ...
        (and
         (=>
          %%location_label%%7
          (req%vstd!arithmetic.div_mod.lemma_small_mod. gamma_arg_nat! tmp%5)
         )
         (=>
          (ens%vstd!arithmetic.div_mod.lemma_small_mod. gamma_arg_nat! tmp%5)
          (=>
           %%location_label%%8
           (= gamma_arg_nat! 0)
       ))))
