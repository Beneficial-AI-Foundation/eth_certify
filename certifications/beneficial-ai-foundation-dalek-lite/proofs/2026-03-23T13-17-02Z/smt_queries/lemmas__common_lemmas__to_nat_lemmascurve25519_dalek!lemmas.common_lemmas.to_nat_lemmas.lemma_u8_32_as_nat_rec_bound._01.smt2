...
;; curve25519-dalek/src/lemmas/common_lemmas/to_nat_lemmas.rs:697:7: 697:85 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::to_nat_lemmas::lemma_u8_32_as_nat_rec_bound
;; curve25519-dalek/src/lemmas/common_lemmas/to_nat_lemmas.rs:697:7: 697:85 (#0)
    ...
    (or
     (and
      ...
      (=>
       (not (= start! target!))
       (=>
        (= tmp%1 (uClip SZ (Add start! 1)))
        (and
         (=>
          %%location_label%%0
          (check_decrease_int (let
            ((bytes!$0 bytes!) (start!$1 tmp%1) (target!$2 target!))
            (Sub 32 start!$1)
     ...
     (and
      ...
      (=>
       %%location_label%%2
       (>= (curve25519_dalek!specs.core_specs.u8_32_as_nat_rec.? (Poly%array%. bytes!) (I start!))
        (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT
               8
              ) $ (CONST_INT 32)
             ) (Poly%array%. bytes!)
