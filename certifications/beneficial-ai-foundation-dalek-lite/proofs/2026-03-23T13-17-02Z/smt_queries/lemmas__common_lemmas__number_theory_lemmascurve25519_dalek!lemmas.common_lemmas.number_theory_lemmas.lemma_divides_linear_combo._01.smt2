...
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:38:1: 38:72 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::number_theory_lemmas::lemma_divides_linear_combo
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:38:1: 38:72 (#0)
                        ...
                        (=>
                         ...
                         (=>
                          ...
                          (and
                           (=>
                            %%location_label%%8
                            (req%vstd!arithmetic.div_mod.lemma_add_mod_noop. x! tmp%7 d!)
                           )
                           (=>
                            (ens%vstd!arithmetic.div_mod.lemma_add_mod_noop. x! tmp%7 d!)
                            (=>
                             %%location_label%%9
                             (= (EucMod (nClip (Add x! (nClip (Mul k! y!)))) d!) 0)
 ))))))))))))))))))))))))))))
