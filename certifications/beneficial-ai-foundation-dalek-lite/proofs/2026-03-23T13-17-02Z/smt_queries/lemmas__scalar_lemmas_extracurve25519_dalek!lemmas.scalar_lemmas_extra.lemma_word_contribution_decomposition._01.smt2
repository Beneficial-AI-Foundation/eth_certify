...
;; curve25519-dalek/src/lemmas/scalar_lemmas_extra.rs:68:5: 68:11 (#0)
...
;; Function-Def curve25519_dalek::lemmas::scalar_lemmas_extra::lemma_word_contribution_decomposition
;; curve25519-dalek/src/lemmas/scalar_lemmas_extra.rs:68:5: 68:11 (#0)
...
(declare-const split_pos! (_ BitVec 64))
(declare-const mask_shift! (_ BitVec 64))
(declare-const low_mask@ (_ BitVec 64))
(declare-const word! (_ BitVec 64))
(assert
 (and
  (and
   (and
    (bvugt split_pos! ((_ zero_extend 63) (_ bv0 1)))
    (bvult split_pos! ((_ zero_extend 57) (_ bv64 7)))
   )
   (= (bvadd ((_ zero_extend 1) mask_shift!) ((_ zero_extend 1) split_pos!)) ((_ zero_extend
      58
     ) (_ bv64 7)
  )))
  (= low_mask@ (bvlshr (_ bv18446744073709551615 64) mask_shift!))
))
...
(assert
 (not (=>
   %%location_label%%0
   (bvult (bvand word! low_mask@) (bvshl ((_ zero_extend 63) (_ bv1 1)) split_pos!))
)))
(get-info :version)
