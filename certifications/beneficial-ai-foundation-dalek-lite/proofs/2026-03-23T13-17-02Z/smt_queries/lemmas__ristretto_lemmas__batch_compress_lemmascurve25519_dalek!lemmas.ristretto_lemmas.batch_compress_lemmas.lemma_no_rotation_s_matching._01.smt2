...
;; curve25519-dalek/src/lemmas/ristretto_lemmas/batch_compress_lemmas.rs:1362:7: 1372:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::ristretto_lemmas::batch_compress_lemmas::lemma_no_rotation_s_matching
;; curve25519-dalek/src/lemmas/ristretto_lemmas/batch_compress_lemmas.rs:1362:7: 1372:2 (#0)
...
(push)
 ...
 (declare-const ciad_inv_e@ Int)
 (declare-const inv_h@ Int)
 (declare-const K@ Int)
 (declare-const den_inv@ Int)
 (assert
  fuel_defaults
 )
 (assert
  ...
  (not (=>
    ...
    (=>
     ...
     (=>
      (= inv_h@ (curve25519_dalek!specs.field_specs.field_inv.? (I h!)))
      (=>
       (= K@ (curve25519_dalek!specs.field_specs.field_mul.? (I t_aff!) (I inv_h@)))
       (and
        (and
         (=>
          %%location_label%%0
         ...
         (=>
          ...
          (=>
           (= tmp%1 (curve25519_dalek!specs.field_specs.field_inv.? (I h!)))
           (=>
            (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_comm.
             tmp%1 h!
            )
             ...
             (=>
              ...
              (and
               ...
               (=>
                ...
                (=>
                 %%location_label%%2
                 (= (curve25519_dalek!specs.field_specs.field_sub.? (I 1) (I y_aff!)) (curve25519_dalek!specs.field_specs.field_mul.?
                   (I (curve25519_dalek!specs.field_specs.field_sub.? (I h!) (I g!))) (I inv_h@)
        )))))))))))
        (=>
         (= (curve25519_dalek!specs.field_specs.field_sub.? (I 1) (I y_aff!)) (curve25519_dalek!specs.field_specs.field_mul.?
           (I (curve25519_dalek!specs.field_specs.field_sub.? (I h!) (I g!))) (I inv_h@)
         ...
         (=>
          ...
          (and
           (=>
            (= tmp%2 (curve25519_dalek!specs.field_specs.field_sub.? (I h!) (I g!)))
            (=>
             (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_exchange.
              invsqrt_std! t_aff! tmp%2 inv_h@
             )
             (=>
              (= tmp%3 (curve25519_dalek!specs.field_specs.field_sub.? (I h!) (I g!)))
              (=>
               (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_assoc.
                invsqrt_std! tmp%3 K@
               )
               (=>
                (= tmp%4 (curve25519_dalek!specs.field_specs.field_sub.? (I h!) (I g!)))
                (=>
                 (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_comm.
                  tmp%4 K@
                 )
                 (=>
                  (= tmp%5 (curve25519_dalek!specs.field_specs.field_sub.? (I h!) (I g!)))
                  (=>
                   (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_assoc.
                    invsqrt_std! K@ tmp%5
                   )
                   (=>
                    %%location_label%%3
                    (= (curve25519_dalek!specs.field_specs.field_mul.? (I den_inv@) (I (curve25519_dalek!specs.field_specs.field_sub.?
                        (I 1) (I y_aff!)
                      ))
                     ) (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                        (I invsqrt_std!) (I K@)
                       )
                      ) (I (curve25519_dalek!specs.field_specs.field_sub.? (I h!) (I g!)))
           )))))))))))
           (=>
            (= (curve25519_dalek!specs.field_specs.field_mul.? (I den_inv@) (I (curve25519_dalek!specs.field_specs.field_sub.?
                (I 1) (I y_aff!)
            ...
            (and
             (=>
              (= tmp%6 (curve25519_dalek!specs.field_specs.field_sub.? (I h!) (I g!)))
              (=>
               (= tmp%7 (curve25519_dalek!specs.field_specs.field_mul.? (I c_iad!) (I (curve25519_dalek!specs.field_specs.field_mul.?
                   (I g!) (I tinv!)
               ))))
               (=>
                (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_comm.
                ...
                (=>
                 (= tmp%8 (curve25519_dalek!specs.field_specs.field_mul.? (I invsqrt_std!) (I K@)))
                 (=>
                  (= tmp%9 (curve25519_dalek!specs.field_specs.field_sub.? (I h!) (I g!)))
                  (and
                   (=>
                    %%location_label%%4
                    (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_abs_mul_sign.
                     tmp%8 ciad_inv_e@ tmp%9
                   ))
                   (=>
                    (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_abs_mul_sign.
                     tmp%8 ciad_inv_e@ tmp%9
                ...
                (and
                 (and
                  ...
                  (=>
                   ...
                   (=>
                    (= tmp%10 (curve25519_dalek!specs.field_specs.field_inv.? (I h!)))
                    (=>
                     (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_comm.
                      tmp%10 h!
                     )
                     (=>
                      (= tmp%11 (curve25519_dalek!specs.field_specs.field_add.? (I h!) (I g!)))
                      (=>
                       (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_comm.
                        tmp%11 inv_h@
                       )
                       (=>
                        ...
                        (=>
                         ...
                         (=>
                          %%location_label%%8
                          (= (curve25519_dalek!specs.field_specs.field_add.? (I 1) (I y_aff!)) (curve25519_dalek!specs.field_specs.field_mul.?
                            (I (curve25519_dalek!specs.field_specs.field_add.? (I h!) (I g!))) (I inv_h@)
                 )))))))))))
                 (=>
                  (= (curve25519_dalek!specs.field_specs.field_add.? (I 1) (I y_aff!)) (curve25519_dalek!specs.field_specs.field_mul.?
                    (I (curve25519_dalek!specs.field_specs.field_add.? (I h!) (I g!))) (I inv_h@)
                  ...
                  (and
                   ...
                   (=>
                    ...
                    (and
                     (=>
                      (= tmp%12 (curve25519_dalek!specs.field_specs.field_inv.? (I e!)))
                      (=>
                       (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_neg.
                        c_iad! tmp%12
                       )
                       (=>
                        ...
                        (= (curve25519_dalek!specs.field_specs.field_mul.? (I c_iad!) (I (curve25519_dalek!specs.field_specs.field_mul.?
                         ...
                         ) (curve25519_dalek!specs.field_specs.field_neg.? (I ciad_inv_e@))
                     ))))
                     (=>
                      (= (curve25519_dalek!specs.field_specs.field_mul.? (I c_iad!) (I (curve25519_dalek!specs.field_specs.field_mul.?
                          (I (curve25519_dalek!specs.field_specs.field_neg.? (I g!))) (I tinv!)
                      ...
                      (and
                       ...
                       (=>
                        ...
                        (and
                         (=>
                          (= tmp%13 (curve25519_dalek!specs.field_specs.field_add.? (I h!) (I g!)))
                          (=>
                           (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_exchange.
                            invsqrt_std! t_aff! tmp%13 inv_h@
                           )
                           (=>
                            (= tmp%14 (curve25519_dalek!specs.field_specs.field_add.? (I h!) (I g!)))
                            (=>
                             (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_assoc.
                              invsqrt_std! tmp%14 K@
                             )
                             (=>
                              (= tmp%15 (curve25519_dalek!specs.field_specs.field_add.? (I h!) (I g!)))
                              (=>
                               (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_comm.
                                tmp%15 K@
                               )
                               (=>
                                (= tmp%16 (curve25519_dalek!specs.field_specs.field_add.? (I h!) (I g!)))
                                (=>
                                 (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_assoc.
                                  invsqrt_std! K@ tmp%16
                                 )
                                 (=>
                                  %%location_label%%12
                                  (= (curve25519_dalek!specs.field_specs.field_mul.? (I den_inv@) (I (curve25519_dalek!specs.field_specs.field_sub.?
                                      (I 1) (I (curve25519_dalek!specs.field_specs.field_neg.? (I y_aff!)))
                                    ))
                                   ) (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                                      (I invsqrt_std!) (I K@)
                                     )
                                    ) (I (curve25519_dalek!specs.field_specs.field_add.? (I h!) (I g!)))
                         )))))))))))
                         (=>
                          (= (curve25519_dalek!specs.field_specs.field_mul.? (I den_inv@) (I (curve25519_dalek!specs.field_specs.field_sub.?
                              (I 1) (I (curve25519_dalek!specs.field_specs.field_neg.? (I y_aff!)))
                          ...
                          (and
                           (=>
                            (= tmp%17 (curve25519_dalek!specs.field_specs.field_add.? (I h!) (I g!)))
                            (=>
                             (= tmp%18 (curve25519_dalek!specs.field_specs.field_neg.? (I ciad_inv_e@)))
                             (=>
                              (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_comm.
                               tmp%17 tmp%18
                              )
                              (=>
                               (= tmp%19 (nClip (Mul ciad_inv_e@ (curve25519_dalek!specs.field_specs.field_add.? (I h!)
                                   (I g!)
                               ))))
                               (=>
                                ...
                                (and
                                 ...
                                 (=>
                                  ...
                                  (=>
                                   (= tmp%21 (curve25519_dalek!specs.field_specs.field_mul.? (I invsqrt_std!) (I K@)))
                                   (=>
                                    (= tmp%22 (curve25519_dalek!specs.field_specs.field_add.? (I h!) (I g!)))
                                    (and
                                     (=>
                                      %%location_label%%14
                                      (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_abs_mul_sign.
                                       tmp%21 ciad_inv_e@ tmp%22
                                     ))
                                     (=>
                                      (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_abs_mul_sign.
                                       tmp%21 ciad_inv_e@ tmp%22
                                      ...
                                      (=>
                                       (= tmp%23 (curve25519_dalek!specs.field_specs.field_neg.? (I ciad_inv_e@)))
                                       (=>
                                        (= tmp%24 (curve25519_dalek!specs.field_specs.field_add.? (I h!) (I g!)))
                                        (and
                                         (=>
                                          %%location_label%%15
                                          (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_abs_mul_sign.
                                           tmp%23 ciad_inv_e@ tmp%24
                                         ))
                                         (=>
                                          (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_abs_mul_sign.
                                           tmp%23 ciad_inv_e@ tmp%24
