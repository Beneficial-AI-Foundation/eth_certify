...
;; curve25519-dalek/src/backend/serial/u64/field.rs:162:1: 162:33 (#0)
...
;; Function-Def curve25519_dalek::backend::serial::u64::field::m
;; curve25519-dalek/src/backend/serial/u64/field.rs:162:1: 162:33 (#0)
    ...
    (=>
     ...
     (and
      ...
      (=>
       (uInv 128 (Mul (uClip 128 x!) (uClip 128 y!)))
       (=>
        (= r! (uClip 128 (Mul (uClip 128 x!) (uClip 128 y!))))
        (and
         (=>
          %%location_label%%2
          (= r! (nClip (Mul x! y!)))
