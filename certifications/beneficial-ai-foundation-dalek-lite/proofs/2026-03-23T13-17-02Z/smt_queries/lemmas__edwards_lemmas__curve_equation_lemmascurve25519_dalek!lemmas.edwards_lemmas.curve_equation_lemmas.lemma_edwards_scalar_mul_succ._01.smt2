...
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:896:1: 896:77 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::curve_equation_lemmas::lemma_edwards_scalar_mul_succ
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:896:1: 896:77 (#0)
(get-info :all-statistics)
(push)
 (declare-const point_affine! tuple%2.)
 (declare-const n! Int)
 ...
 (declare-const p_n@ tuple%2.)
 (declare-const d_p$2@ tuple%2.)
 (declare-const m@ Int)
 (declare-const mm1@ Int)
 (declare-const nm1@ Int)
 (declare-const p_mm1@ tuple%2.)
 (declare-const lhs_as_sum@ tuple%2.)
 (declare-const p_nm1@ tuple%2.)
 (declare-const rhs_as_sum@ tuple%2.)
 (declare-const np1@ Int)
 (declare-const decrease%init0 Int)
 (assert
  fuel_defaults
 )
 (assert
  (has_type (Poly%tuple%2. point_affine!) (TYPE%tuple%2. $ NAT $ NAT))
 )
 (assert
  (<= 0 n!)
 )
    ...
    (or
        ...
        (=>
         ...
         (and
          ...
          (=>
           tmp%1
           (=>
            (= tmp%2 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.?
                (Poly%tuple%2. point_affine!) (I 1)
               )
              ) (Poly%tuple%2. point_affine!)
            ))
            (and
            ...
            (and
               ...
               (=>
                ...
                (and
                 ...
                 (=>
                  tmp%4
                  (=>
                   (= tmp%5 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.?
                       (Poly%tuple%2. point_affine!) (I np1@)
                      )
                     ) (Poly%tuple%2. (let
                       ((prev$ (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2. point_affine!)
                          (I (nClip (Sub np1@ 1)))
             ...
             (=>
              ...
              (and
               (=>
                %%location_label%%6
                (req%vstd!arithmetic.div_mod.lemma_add_mod_noop. n! 1 2)
               )
               (=>
                (ens%vstd!arithmetic.div_mod.lemma_add_mod_noop. n! 1 2)
                (and
                 (=>
                  %%location_label%%7
                  (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. np1@ 2)
                 )
                 (=>
                  (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. np1@ 2)
                  (=>
                   (= tmp%7 (= (EucMod np1@ 2) 0))
                   (and
                    (=>
                     %%location_label%%8
                     tmp%7
                                    ...
                                    (=>
                                     ...
                                     (and
                                      ...
                                      (=>
                                       tmp%12
                                       (=>
                                        (= tmp%13 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.?
                                            (Poly%tuple%2. point_affine!) (I np1@)
                                           )
                                          ) (Poly%tuple%2. (let
                                              ...
                                              (=>
                                               ...
                                               (and
                                                ...
                                                (=>
                                                 tmp%15
                                                 (=>
                                                  (= tmp%16 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.?
                                                         ...
                                                         (=>
                                                          ...
                                                          (and
                                                           ...
                                                           (=>
                                                            tmp%18
                                                            (=>
                                                             (= tmp%19 (= (nClip (Add nm1@ 2)) (nClip (Mul m@ 2))))
                                                             (and
                                                              (=>
                                                               %%location_label%%20
                                                               tmp%19
                                                              ...
                                                              (=>
                                                               tmp%19
                                                               (=>
                                                                (= tmp%20 (= nm1@ (Sub (nClip (Mul m@ 2)) 2)))
                                                                (and
                                                                 (=>
                                                                  %%location_label%%21
                                                                  tmp%20
                                                                 ...
                                                                 (=>
                                                                  ...
                                                                  (and
                                                                   (=>
                                                                    (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub_other_way. 2 m@ 1)
                                                                    (=>
                                                                     %%location_label%%22
                                                                     (= (Sub (nClip (Mul m@ 2)) 2) (Mul (Sub m@ 1) 2))
                                                                   ))
                                                                   (=>
                                                                    (= (Sub (nClip (Mul m@ 2)) 2) (Mul (Sub m@ 1) 2))
                                                                    (=>
                                                      ...
                                                      (=>
                                                       ...
                                                       (and
                                                        (and
                                                         (=>
                                                          %%location_label%%24
                                                          (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. mm1@ 2 2)
                                                         )
                                                         (=>
                                                          (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. mm1@ 2 2)
                                                          (=>
                                                           (ens%vstd!arithmetic.mul.lemma_mul_by_zero_is_zero. mm1@)
                                                           (=>
                                                            %%location_label%%25
                                                            (= (EucMod nm1@ 2) 0)
                                                        ))))
                                                          ...
                                                          (=>
                                                           ...
                                                           (and
                                                            ...
                                                            (=>
                                                             tmp%21
                                                             (=>
                                                              (= tmp%22 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.?
                                                                  (Poly%tuple%2. point_affine!) (I nm1@)
                                                                 )
                                                                ) (Poly%tuple%2. (let
                                                                  ((half$ (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2. point_affine!)
                                                                     (I (EucDiv nm1@ 2))
                                                               ...
                                                               (=>
                                                                ...
                                                                (and
                                                                 (and
                                                                  (=>
                                                                   %%location_label%%28
                                                                   (req%vstd!arithmetic.div_mod.lemma_div_by_multiple. mm1@ 2)
                                                                  )
                                                                  (=>
                                                                   (ens%vstd!arithmetic.div_mod.lemma_div_by_multiple. mm1@ 2)
                                                                   (=>
                                                                    %%location_label%%29
                                                                    (= (EucDiv nm1@ 2) mm1@)
                                                                 )))
                                                                  ...
                                                                  (and
                                                                   (=>
                                                                    ...
                                                                    (check_decrease_int (let
                                                                      ((point_affine!$0 point_affine!) (n!$1 mm1@))
                                                                      n!$1
                                                                   ...
                                                                   (and
                                                                    ...
                                                                    (=>
                                                                     ...
                                                                     (=>
                                                                      (= p_mm1@ (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2.
                                                                         point_affine!
                                                                        ) (I mm1@)
                                                                      ))
                                                                      (and
                                                                       (=>
                                                                        (= tmp%23 (= m@ (nClip (Add mm1@ 1))))
                                                                        (and
                                                                         (=>
                                                                          %%location_label%%32
                                                                          tmp%23
                                                                         ...
                                                                         (=>
                                                                          ...
                                                                          (=>
                                                                           ...
                                                                           (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.?
                                                                              (Poly%tuple%2. point_affine!) (I m@)
                                                                             )
                                                                            ) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_add.? (tuple%2./tuple%2/0
                                                                               (%Poly%tuple%2. (Poly%tuple%2. p_mm1@))
                                                                              ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. p_mm1@))) (tuple%2./tuple%2/0
                                                                               (%Poly%tuple%2. (Poly%tuple%2. point_affine!))
                                                                              ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. point_affine!)))
                                                                       )))))))
                                                                       (=>
                                                                        ...
                                                                        (=>
                                                                         (= tmp%24 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. p_mm1@)))))
                                                                         (=>
                                                                          (= tmp%25 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. p_mm1@)))))
                                                                          (=>
                                                                           (= tmp%26 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. point_affine!)))))
                                                                           (=>
                                                                            (= tmp%27 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. point_affine!)))))
                                                                            (=>
                                                                             (ens%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_edwards_double_of_add.
                                                                             ...
                                                                             (=>
                                                                              (= lhs_as_sum@ (let
                                                                                ((d_mm1$ (curve25519_dalek!specs.edwards_specs.edwards_double.? (tuple%2./tuple%2/0 (
                                                                                     %Poly%tuple%2. (Poly%tuple%2. p_mm1@)
                                                                                    )
                                                                                   ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. p_mm1@)))
                                                                                )))
                                                                                (let
                                                                                 ((d_p$ (curve25519_dalek!specs.edwards_specs.edwards_double.? (tuple%2./tuple%2/0 (%Poly%tuple%2.
                                                                                      (Poly%tuple%2. point_affine!)
                                                                                     )
                                                                                    ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. point_affine!)))
                                                                                 )))
                                                                                 (curve25519_dalek!specs.edwards_specs.edwards_add.? (tuple%2./tuple%2/0 (%Poly%tuple%2.
                                                                                  ...
                                                                                  ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. d_mm1$))) (tuple%2./tuple%2/0
                                                                                   (%Poly%tuple%2. (Poly%tuple%2. d_p$))
                                                                                  ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. d_p$)))
                                                                              ))))
                                                                              (and
                                                                               (=>
                                                                                (= tmp%28 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.?
                                                                                    (Poly%tuple%2. point_affine!) (I m@)
                                                                                   )
                                                                                  ) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_add.? (tuple%2./tuple%2/0
                                                                                     (%Poly%tuple%2. (Poly%tuple%2. p_mm1@))
                                                                                 ...
                                                                                 (=>
                                                                                  ...
                                                                                  (=>
                                                                                   ...
                                                                                   (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_double.?
                                                                                      (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.?
                                                                                          (Poly%tuple%2. point_affine!) (I m@)
                                                                                       )))
                                                                                      ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.?
                                                                                          (Poly%tuple%2. point_affine!) (I m@)
                                                                                     )))))
                                                                                    ) (Poly%tuple%2. lhs_as_sum@)
                                                                               )))))
                                                                               (=>
                                                                                (= (curve25519_dalek!specs.edwards_specs.edwards_double.? (tuple%2./tuple%2/0 (%Poly%tuple%2.
                                                                                ...
                                                                                (=>
                                                                                 (= p_nm1@ (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2.
                                                                                    point_affine!
                                                                                   ) (I nm1@)
                                                                                 ))
                                                                                 (and
                                                                                  (=>
                                                                                   (= tmp%29 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.?
                                                                                       (Poly%tuple%2. point_affine!) (I nm1@)
                                                                                      )
                                                                                     ) (Poly%tuple%2. (let
                                                                                       ((half$ (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2. point_affine!)
                                                                                     ...
                                                                                     (=>
                                                                                      ...
                                                                                      (and
                                                                                       ...
                                                                                       (=>
                                                                                        tmp%30
                                                                                        (=>
                                                                                         (= tmp%31 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. p_mm1@) (Poly%tuple%2.
                                                                                            (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2. point_affine!)
                                                                                             (I mm1@)
                                                                                         ))))
                                                                                         (and
                                                                                          ...
                                                                                          (=>
                                                                                           ...
                                                                                           (=>
                                                                                            %%location_label%%39
                                                                                            (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. p_nm1@) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_double.?
                                                                                               (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. p_mm1@))) (tuple%2./tuple%2/1 (
                                                                                                 %Poly%tuple%2. (Poly%tuple%2. p_mm1@)
                                                                                  )))))))))))))))
                                                                                  (=>
                                                                                   (= p_nm1@ (curve25519_dalek!specs.edwards_specs.edwards_double.? (tuple%2./tuple%2/0
                                                                                      (%Poly%tuple%2. (Poly%tuple%2. p_mm1@))
                                                                                     ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. p_mm1@)))
                                                                                   ))
                                                                                   (=>
                                                                                    (= rhs_as_sum@ (let
                                                                                      ...
                                                                                      (curve25519_dalek!specs.edwards_specs.edwards_add.? (tuple%2./tuple%2/0 (%Poly%tuple%2.
                                                                                       ...
                                                                                       ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. p_nm1@))) (tuple%2./tuple%2/0
                                                                                        (%Poly%tuple%2. (Poly%tuple%2. d_p$))
                                                                                       ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. d_p$)))
                                                                                    )))
                                                                                    (and
                                                                                     (and
                                                                                      ...
                                                                                      (=>
                                                                                       ...
                                                                                       (and
                                                                                        (=>
                                                                                         (= tmp%32 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_double.?
                                                                                             (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.?
                                                                                                 (Poly%tuple%2. point_affine!) (I m@)
                                                                                              )))
                                                                                             ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.?
                                                                                        ...
                                                                                        (=>
                                                                                         ...
                                                                                         (and
                                                                                          (=>
                                                                                           (= tmp%33 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. p_nm1@) (Poly%tuple%2.
                                                                                              (curve25519_dalek!specs.edwards_specs.edwards_double.? (tuple%2./tuple%2/0 (%Poly%tuple%2.
                                                                                                 (Poly%tuple%2. p_mm1@)
                                                                                                )
                                                                                               ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. p_mm1@)))
                                                                                           ...
                                                                                           (and
                                                                                            ...
                                                                                            (=>
                                                                                             ...
                                                                                             (and
                                                                                              (=>
                                                                                               (= tmp%34 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. p_nm1@) (Poly%tuple%2.
                                                                                                  (curve25519_dalek!specs.edwards_specs.edwards_double.? (tuple%2./tuple%2/0 (%Poly%tuple%2.
                                                                                                     (Poly%tuple%2. p_mm1@)
                                                                                                    )
                                                                                                   ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. p_mm1@)))
                                                                                               ...
                                                                                               (and
                                                                                                ...
                                                                                                (=>
                                                                                                 ...
                                                                                                 (=>
                                                                                                  %%location_label%%45
                                                                                                  (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. lhs_as_sum@) (Poly%tuple%2.
                                                                                                    rhs_as_sum@
                                                                                              ))))))
                                                                                              (=>
                                                                                               (= lhs_as_sum@ rhs_as_sum@)
                                                                                               (=>
                                                                                                %%location_label%%46
                                                                                                (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. lhs_as_sum@) (Poly%tuple%2.
                                                                                                  rhs_as_sum@
                                                                                          ...
                                                                                          (=>
                                                                                           ...
                                                                                           (and
                                                                                            (=>
                                                                                             (= p_n@ (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2. point_affine!)
                                                                                               (I n!)
                                                                                             ))
                                                                                             (=>
                                                                                              (= d_p$2@ (curve25519_dalek!specs.edwards_specs.edwards_double.? (tuple%2./tuple%2/0
                                                                                                 (%Poly%tuple%2. (Poly%tuple%2. point_affine!))
                                                                                                ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. point_affine!)))
                                                                                              ))
                                                                                              (=>
                                                                                               (= tmp%35 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. p_nm1@)))))
                                                                                               (=>
                                                                                                (= tmp%36 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. p_nm1@)))))
                                                                                                (=>
                                                                                                 (= tmp%37 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. point_affine!)))))
                                                                                                 (=>
                                                                                                  (= tmp%38 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. point_affine!)))))
                                                                                                  (=>
                                                                                                   (= tmp%39 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. point_affine!)))))
                                                                                                   (=>
                                                                                                    (= tmp%40 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. point_affine!)))))
                                                                                                    (=>
                                                                                                     (ens%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.axiom_edwards_add_associative.
                                                                                                      tmp%35 tmp%36 tmp%37 tmp%38 tmp%39 tmp%40
                                                                                                     )
                                                                                                     (=>
                                                                                                      (= tmp%41 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_add.?
                                                                                                          (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_add.?
                                                                                                              (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. p_nm1@))) (tuple%2./tuple%2/1 (
                                                                                                                %Poly%tuple%2. (Poly%tuple%2. p_nm1@)
                                                                                                               )
                                                                                                              ) (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. point_affine!))) (tuple%2./tuple%2/1
                                                                                                               (%Poly%tuple%2. (Poly%tuple%2. point_affine!))
                                                                                                           ))))
                                                                                                          ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_add.?
                                                                                                              (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. p_nm1@))) (tuple%2./tuple%2/1 (
                                                                                                           ...
                                                                                                           (%Poly%tuple%2. (Poly%tuple%2. d_p$2@))
                                                                                                          ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. d_p$2@)))
                                                                                                      ))))
                                                                                                      (and
                                                                                                       (=>
                                                                                                        %%location_label%%47
                                                                                                       ...
                                                                                                       (=>
                                                                                                        tmp%41
                                                                                                        (=>
                                                                                                         (= tmp%42 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. p_n@) (Poly%tuple%2.
                                                                                                            (curve25519_dalek!specs.edwards_specs.edwards_add.? (tuple%2./tuple%2/0 (%Poly%tuple%2.
                                                                                                               (Poly%tuple%2. p_nm1@)
                                                                                                              )
                                                                                                             ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. p_nm1@))) (tuple%2./tuple%2/0
                                                                                                         ...
                                                                                                         (and
                                                                                                          ...
                                                                                                          (=>
                                                                                                           ...
                                                                                                           (=>
                                                                                                            %%location_label%%49
                                                                                                            (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. rhs_as_sum@) (Poly%tuple%2.
                                                                                                              (curve25519_dalek!specs.edwards_specs.edwards_add.? (tuple%2./tuple%2/0 (%Poly%tuple%2.
                                                                                                                 (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2.
                                                                                                                    point_affine!
                                                                                                                   ) (I n!)
                                                                                            ...
                                                                                            (=>
                                                                                             (= rhs_as_sum@ (curve25519_dalek!specs.edwards_specs.edwards_add.? (tuple%2./tuple%2/0
                                                                                                (%Poly%tuple%2. (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.?
                                                                                                   (Poly%tuple%2. point_affine!) (I n!)
                                                                                                )))
                                                                                               ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.?
     ...
     (and
      ...
      (=>
       %%location_label%%51
       (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.?
          (Poly%tuple%2. point_affine!) (I (nClip (Add n! 1)))
         )
        ) (Poly%tuple%2. (let
          ((prev$ (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2. point_affine!)
             (I n!)
