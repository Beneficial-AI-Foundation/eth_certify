...
;; curve25519-dalek/src/lemmas/edwards_lemmas/straus_lemmas.rs:1055:7: 1055:71 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::straus_lemmas::lemma_reconstruct_radix_16_from_eq_helper
;; curve25519-dalek/src/lemmas/edwards_lemmas/straus_lemmas.rs:1055:7: 1055:71 (#0)
...
(push)
 ...
 (declare-const sub_next@ vstd!seq.Seq<i8.>.)
 (declare-const sub@ vstd!seq.Seq<i8.>.)
 ...
 (assert
  (not (=>
    (= decrease%init0 (Sub 64 k!))
    (=>
     (= sub@ (%Poly%vstd!seq.Seq<i8.>. (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
         d!
        ) (I k!) (I 64)
     )))
     (or
      (and
       (=>
        (>= k! 64)
        (=>
         (= tmp%1 (= (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. sub@)) 0))
         (and
          (=>
           %%location_label%%0
           tmp%1
         ...
         (and
          ...
          (and
           ...
           (=>
            ...
            (=>
             (= sub_next@ (%Poly%vstd!seq.Seq<i8.>. (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
                 d!
                ) (I (Add k! 1)) (I 64)
             )))
             (=>
              (= tmp%3 (= (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. sub@) (I 0))
                (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. d!) (I k!))
              ))
              (and
               (=>
                %%location_label%%3
               ...
               (=>
                tmp%3
                (=>
                 (= tmp%4 (= (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. sub@)) (Sub 64 k!)))
                 (and
                  (=>
                   %%location_label%%4
                   tmp%4
                    ...
                    (=>
                     ...
                     (=>
                      (let
                       ...
                       (and
                        (<= 0 tmp%%$)
                        (< tmp%%$ (vstd!seq.Seq.len.? $ (SINT 8) (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
                            sub@
                           ) (I 1) (I (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. sub@)))
                      )))))
                      (=>
                       (= tmp%5 (= (vstd!seq.Seq.index.? $ (SINT 8) (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
                            sub@
                           ) (I 1) (I (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. sub@)))
                          ) i@
                         ) (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. sub@) (I (Add (%I i@) 1)))
                       ))
                       (and
                        (=>
                         %%location_label%%5
                        ...
                        (=>
                         tmp%5
                         (=>
                          (= tmp%6 (= (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. sub@) (I (Add (%I
                                i@
                               ) 1
                             ))
                            ) (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. d!) (I (Add (Add k! 1) (
                                %I i@
                          ))))))
                          (and
                           (=>
                           ...
                           (=>
                            tmp%6
                            (=>
                             (= tmp%7 (= (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. sub_next@) i@)
                               (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. d!) (I (Add (Add k! 1) (%I
                                   i@
                             ))))))
                             (and
                              (=>
                              ...
                              (=>
                               ...
                               (=>
                                %%location_label%%8
                                (= (vstd!seq.Seq.index.? $ (SINT 8) (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
                                    sub@
                                   ) (I 1) (I (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. sub@)))
                                  ) i@
                                 ) (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. sub_next@) i@)
                    )))))))))))))
                    (=>
                     (forall ((i$ Poly)) (!
                       (=>
                       ...
                       :pattern ((vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. sub_next@) i$))
                       :qid user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_reconstruct_radix_16_from_eq_helper_91
                       :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_reconstruct_radix_16_from_eq_helper_91
                     ))
                     (=>
                      (= tmp%8 (ext_eq false (TYPE%vstd!seq.Seq. $ (SINT 8)) (vstd!seq.Seq.subrange.? $ (SINT
                          8
                         ) (Poly%vstd!seq.Seq<i8.>. sub@) (I 1) (I (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
                            sub@
                         )))
                        ) (Poly%vstd!seq.Seq<i8.>. sub_next@)
                      ))
                      (and
                       (=>
                        %%location_label%%9
