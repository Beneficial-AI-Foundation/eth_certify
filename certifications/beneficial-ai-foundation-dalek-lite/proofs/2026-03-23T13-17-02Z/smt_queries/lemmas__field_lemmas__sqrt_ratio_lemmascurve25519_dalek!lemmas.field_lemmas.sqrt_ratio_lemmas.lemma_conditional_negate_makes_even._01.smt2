...
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_ratio_lemmas.rs:573:1: 573:76 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::sqrt_ratio_lemmas::lemma_conditional_negate_makes_even
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_ratio_lemmas.rs:573:1: 573:76 (#0)
(get-info :all-statistics)
(push)
 (declare-const r_nat! Int)
 (declare-const negated! Bool)
          ...
          (=>
           ...
           (=>
            ...
            (and
             (=>
              %%location_label%%2
              (req%vstd!arithmetic.div_mod.lemma_small_mod. r_nat! tmp%2)
             )
             (=>
              (ens%vstd!arithmetic.div_mod.lemma_small_mod. r_nat! tmp%2)
              (=>
               (= tmp%3 (< 0 (Sub (curve25519_dalek!specs.field_specs_u64.p.? (I 0)) r_nat!)))
               (and
                (=>
                 %%location_label%%3
                 tmp%3
                ...
                (=>
                 tmp%3
                 (=>
                  (= tmp%4 (< (Sub (curve25519_dalek!specs.field_specs_u64.p.? (I 0)) r_nat!) (curve25519_dalek!specs.field_specs_u64.p.?
                     (I 0)
                  )))
                  (and
                   (=>
                   ...
                   (=>
                    tmp%4
                    (=>
                     (= tmp%5 (nClip (Sub (curve25519_dalek!specs.field_specs_u64.p.? (I 0)) r_nat!)))
                     (=>
                      ...
                      (and
                       ...
                       (=>
                        ...
                        (=>
                         (= tmp%7 (= (curve25519_dalek!specs.field_specs.field_neg.? (I r_nat!)) (nClip (Sub (
                              curve25519_dalek!specs.field_specs_u64.p.? (I 0)
                             ) r_nat!
                         ))))
                         (and
                          ...
                          (=>
                           ...
                           (=>
                            ...
                            (=>
                             (= tmp%8 (= (EucMod (curve25519_dalek!specs.field_specs_u64.p.? (I 0)) 2) 1))
                             (and
                              (=>
                               %%location_label%%7
                               tmp%8
                               ...
                               (and
                                (=>
                                 ...
                                 (and
                                  (=>
                                   %%location_label%%8
                                   (req%vstd!arithmetic.div_mod.lemma_sub_mod_noop. tmp%9 r_nat! 2)
                                  )
                                  (=>
                                   (ens%vstd!arithmetic.div_mod.lemma_sub_mod_noop. tmp%9 r_nat! 2)
                                   (=>
                                    %%location_label%%9
                                    (= (EucMod (nClip (Sub (curve25519_dalek!specs.field_specs_u64.p.? (I 0)) r_nat!))
                                      2
                                     ) 0
                                )))))
                                (=>
