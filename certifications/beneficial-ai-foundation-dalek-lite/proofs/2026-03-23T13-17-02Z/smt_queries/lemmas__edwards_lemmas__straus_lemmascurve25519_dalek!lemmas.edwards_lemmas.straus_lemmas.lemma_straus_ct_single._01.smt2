...
;; curve25519-dalek/src/lemmas/edwards_lemmas/straus_lemmas.rs:798:1: 798:71 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::straus_lemmas::lemma_straus_ct_single
;; curve25519-dalek/src/lemmas/edwards_lemmas/straus_lemmas.rs:798:1: 798:71 (#0)
...
(push)
 ...
 (declare-const j! Int)
 (declare-const tmp%1 vstd!seq.Seq<tuple%2<nat./nat.>.>.)
 (declare-const tmp%2 vstd!seq.Seq<vstd!seq.Seq<i8.>.>.)
 (declare-const tmp%3 vstd!seq.Seq<tuple%2<nat./nat.>.>.)
 (declare-const tmp%4 vstd!seq.Seq<vstd!seq.Seq<i8.>.>.)
    ...
    (or
     (and
      (=>
       (>= j! 64)
       (=>
        (= tmp%1 (%Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. (vstd!seq.Seq.push.? (DST $) (TYPE%tuple%2.
            $ NAT $ NAT
           ) (vstd!seq.Seq.empty.? (DST $) (TYPE%tuple%2. $ NAT $ NAT)) (Poly%tuple%2. P!)
        )))
        (=>
         (= tmp%2 (%Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>. (vstd!seq.Seq.push.? $ (TYPE%vstd!seq.Seq.
             $ (SINT 8)
            ) (vstd!seq.Seq.empty.? $ (TYPE%vstd!seq.Seq. $ (SINT 8))) (Poly%vstd!seq.Seq<i8.>.
             d!
         ))))
         (=>
          (ens%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_ct_base. tmp%1
           tmp%2
          )
          (=>
           (fuel_bool fuel%curve25519_dalek!specs.edwards_specs.edwards_scalar_mul_signed.)
      ...
      (=>
       (not (>= j! 64))
       (=>
        (= tmp%3 (%Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. (vstd!seq.Seq.push.? (DST $) (TYPE%tuple%2.
            $ NAT $ NAT
           ) (vstd!seq.Seq.empty.? (DST $) (TYPE%tuple%2. $ NAT $ NAT)) (Poly%tuple%2. P!)
        )))
        (=>
         (= tmp%4 (%Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>. (vstd!seq.Seq.push.? $ (TYPE%vstd!seq.Seq.
             $ (SINT 8)
            ) (vstd!seq.Seq.empty.? $ (TYPE%vstd!seq.Seq. $ (SINT 8))) (Poly%vstd!seq.Seq<i8.>.
             d!
         ))))
         (and
          (=>
           %%location_label%%0
           (req%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_ct_step. tmp%3
            tmp%4 j!
          ))
          (=>
           (ens%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_ct_step. tmp%3
            tmp%4 j!
           )
           (=>
            (= tmp%5 (Add j! 1))
            (and
             ...
             (and
              ...
              (=>
               ...
               (=>
                (= r_next@ (curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.reconstruct_radix_16_from.?
                  (Poly%vstd!seq.Seq<i8.>. d!) (I (Add j! 1))
                ))
                (=>
                 (ens%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_edwards_scalar_mul_signed_composition.
                  P! r_next@ 16
                 ...
                 (and
                  ...
                  (=>
                   ...
                   (=>
                    (= tmp%6 (Mul 16 r_next@))
                    (=>
                     (= tmp%7 (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. d!) (I j!))))
                     (=>
                      (ens%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.axiom_edwards_scalar_mul_signed_additive.
                       P! tmp%6 tmp%7
                      )
                      (=>
                       (= tmp%8 (= (Add (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. d!) (I j!)))
                          (Mul 16 r_next@)
                         ) (curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.reconstruct_radix_16_from.?
                          (Poly%vstd!seq.Seq<i8.>. d!) (I j!)
                       )))
     ...
     (and
      ...
      (=>
       ...
       (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.straus_ct_partial.?
          ...
          (Poly%tuple%2. P!) (I (curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.reconstruct_radix_16_from.?
            (Poly%vstd!seq.Seq<i8.>. d!) (I j!)
 )))))))))))
 (get-info :version)
