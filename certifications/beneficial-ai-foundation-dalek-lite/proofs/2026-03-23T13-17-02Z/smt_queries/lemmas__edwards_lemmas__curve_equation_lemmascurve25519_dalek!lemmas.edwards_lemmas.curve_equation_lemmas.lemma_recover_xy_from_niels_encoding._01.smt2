...
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:2353:7: 2353:93 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::curve_equation_lemmas::lemma_recover_xy_from_niels_encoding
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:2353:7: 2353:93 (#0)
 ...
 (assert
  (not (and
    (=>
     ...
     (=>
      %%location_label%%0
      (= (curve25519_dalek!specs.field_specs.field_sub.? (I y_plus_x!) (I y_minus_x!)) (
        curve25519_dalek!specs.field_specs.field_mul.? (I 2) (I x!)
    ))))
    (=>
     (= (curve25519_dalek!specs.field_specs.field_sub.? (I y_plus_x!) (I y_minus_x!)) (
       curve25519_dalek!specs.field_specs.field_mul.? (I 2) (I x!)
      ...
      (=>
       ...
       (and
        (=>
         ...
         (=>
          %%location_label%%2
          (= (curve25519_dalek!specs.field_specs.field_add.? (I y_plus_x!) (I y_minus_x!)) (
            curve25519_dalek!specs.field_specs.field_mul.? (I 2) (I y!)
        ))))
        (=>
         (= (curve25519_dalek!specs.field_specs.field_add.? (I y_plus_x!) (I y_minus_x!)) (
           curve25519_dalek!specs.field_specs.field_mul.? (I 2) (I y!)
