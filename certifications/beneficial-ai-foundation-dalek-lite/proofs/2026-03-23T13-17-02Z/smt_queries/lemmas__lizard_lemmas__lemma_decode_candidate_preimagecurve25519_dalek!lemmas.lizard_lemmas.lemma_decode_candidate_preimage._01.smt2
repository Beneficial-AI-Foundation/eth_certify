...
;; MODULE 'module lemmas::lizard_lemmas, function curve25519_dalek::lemmas::lizard_lemmas::lemma_decode_candidate_preimage'
;; curve25519-dalek/src/lemmas/lizard_lemmas.rs:183:1: 188:2 (#0)
...
(assert
 (distinct fuel%vstd!array.array_view. fuel%vstd!array.impl&%0.view. fuel%vstd!array.impl&%2.spec_index.
  ...
  fuel%vstd!view.impl&%46.view. fuel%curve25519_dalek!backend.serial.u64.constants.SQRT_AD_MINUS_ONE.
  ...
  fuel%curve25519_dalek!specs.ristretto_specs.spec_elligator_ristretto_flavor. fuel%curve25519_dalek!specs.ristretto_specs.elligator_intermediates.
  fuel%curve25519_dalek!specs.lizard_specs.spec_lizard_fe_bytes. fuel%curve25519_dalek!specs.lizard_specs.spec_lizard_r.
  fuel%curve25519_dalek!specs.lizard_specs.spec_lizard_encode. fuel%curve25519_dalek!specs.lizard_specs.is_lizard_preimage_coset.
...
;; Function-Def curve25519_dalek::lemmas::lizard_lemmas::lemma_decode_candidate_preimage
;; curve25519-dalek/src/lemmas/lizard_lemmas.rs:183:1: 188:2 (#0)
(get-info :all-statistics)
(push)
 (declare-const fe_j! curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const buf2! %%Function%%)
 (declare-const msg_spec! vstd!seq.Seq<u8.>.)
  ...
  (not (and
    (=>
     ...
     (=>
      ...
      (=>
       (= tmp%1 (curve25519_dalek!specs.field_specs.spec_fe51_from_bytes.? (Poly%array%. buf2!)))
       (and
        (=>
         %%location_label%%0
         (req%curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_from_bytes_as_bytes_roundtrip.
