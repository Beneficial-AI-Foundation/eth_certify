...
;; curve25519-dalek/src/lemmas/scalar_lemmas_/naf_lemmas.rs:174:1: 181:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::scalar_lemmas_::naf_lemmas::lemma_naf_even_step
;; curve25519-dalek/src/lemmas/scalar_lemmas_/naf_lemmas.rs:174:1: 181:2 (#0)
...
(push)
 ...
 (declare-const c@ Int)
 (declare-const sv_mod_pos@ Int)
 (declare-const bit_at_pos@ Int)
 (assert
  fuel_defaults
 )
 (assert
 ...
 (assert
  (not (=>
    ...
    (=>
     (= c@ carry!)
     (=>
      (= sv_mod_pos@ (EucMod scalar_val! (vstd!arithmetic.power2.pow2.? (I pos!))))
      (=>
       (= bit_at_pos@ (EucMod (EucDiv scalar_val! (vstd!arithmetic.power2.pow2.? (I pos!)))
         2
       ))
       (and
        (=>
         (= tmp%1 (nClip (Add pos! 1)))
         (and
          (=>
           %%location_label%%0
           (req%curve25519_dalek!lemmas.scalar_lemmas_.naf_lemmas.lemma_reconstruct_zero_extend.
          ...
          (=>
           ...
           (=>
            ...
            (= (curve25519_dalek!specs.scalar_specs.reconstruct.? (vstd!seq.Seq.subrange.? $ (SINT
                8
               ) (Poly%vstd!seq.Seq<i8.>. naf!) (I 0) (I (nClip (Add pos! 1)))
              )
             ) (curve25519_dalek!specs.scalar_specs.reconstruct.? (vstd!seq.Seq.subrange.? $ (SINT
                8
               ) (Poly%vstd!seq.Seq<i8.>. naf!) (I 0) (I pos!)
        )))))))
        (=>
         (= (curve25519_dalek!specs.scalar_specs.reconstruct.? (vstd!seq.Seq.subrange.? $ (SINT
             8
         ...
         (and
          (=>
           (= sv_shifted@ (EucDiv scalar_val! (vstd!arithmetic.power2.pow2.? (I pos!))))
           (and
            (and
             (=>
             ...
             (=>
              ...
              (=>
               (= tmp%2 (nClip (Sub w! 1)))
               (=>
                (ens%vstd!arithmetic.power2.lemma_pow2_adds. 1 tmp%2)
                (=>
                 %%location_label%%3
                 (= (vstd!arithmetic.power2.pow2.? (I w!)) (nClip (Mul 2 (vstd!arithmetic.power2.pow2.?
                     (I (nClip (Sub w! 1)))
            )))))))))
            (=>
             (= (vstd!arithmetic.power2.pow2.? (I w!)) (nClip (Mul 2 (vstd!arithmetic.power2.pow2.?
             ...
             (=>
              ...
              (=>
               ...
               (=>
                (= tmp%4 (vstd!arithmetic.power2.pow2.? (I (nClip (Sub w! 1)))))
                (and
                 (=>
                  %%location_label%%4
                  (req%vstd!arithmetic.div_mod.lemma_mod_mod. sv_shifted@ 2 tmp%4)
                 )
                 (=>
                  (ens%vstd!arithmetic.div_mod.lemma_mod_mod. sv_shifted@ 2 tmp%4)
                  (=>
                   %%location_label%%5
                   (= (EucMod extracted! 2) bit_at_pos@)
          )))))))))
          (=>
           (= (EucMod extracted! 2) bit_at_pos@)
           (and
            (or
             (and
              (=>
               (not (= carry! bit_at_pos@))
               (=>
                (= tmp%5 (not (= (EucMod (nClip (Add carry! extracted!)) 2) 0)))
                (and
                 (=>
                  %%location_label%%6
                  tmp%5
               ...
               (and
                (and
                 ...
                 (=>
                  (= (vstd!arithmetic.power2.pow2.? (I 1)) 2)
                  (=>
                   (ens%vstd!arithmetic.power2.lemma_pow2_adds. pos! 1)
                   (=>
                    %%location_label%%9
                    (= (nClip (Mul (vstd!arithmetic.power2.pow2.? (I pos!)) 2)) (vstd!arithmetic.power2.pow2.?
                      (I (nClip (Add pos! 1)))
                ))))))
                (=>
                 (= (nClip (Mul (vstd!arithmetic.power2.pow2.? (I pos!)) 2)) (vstd!arithmetic.power2.pow2.?
                 ...
                 (=>
                  (= tmp%6 (vstd!arithmetic.power2.pow2.? (I pos!)))
                  (and
                   (=>
                    %%location_label%%10
                    (req%vstd!arithmetic.div_mod.lemma_mod_breakdown. scalar_val! tmp%6 2)
                   )
                   (=>
                    (ens%vstd!arithmetic.div_mod.lemma_mod_breakdown. scalar_val! tmp%6 2)
                    (=>
                     (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. p_pos@ bit_at_pos@)
                     (=>
                      %%location_label%%11
                      (= (EucMod scalar_val! (vstd!arithmetic.power2.pow2.? (I (nClip (Add pos! 1))))) (
                        Add (Mul c@ p_pos@) sv_mod_pos@
              ))))))))))
              (=>
               (= (EucMod scalar_val! (vstd!arithmetic.power2.pow2.? (I (nClip (Add pos! 1))))) (
                 Add (Mul c@ p_pos@) sv_mod_pos@
               ...
               (and
                (and
                 ...
                 (=>
                  (= (vstd!arithmetic.power2.pow2.? (I 1)) 2)
                  (=>
                   (ens%vstd!arithmetic.power2.lemma_pow2_adds. 1 pos!)
                   (=>
                    (= tmp%7 (vstd!arithmetic.power2.pow2.? (I 1)))
                    (=>
                     (= tmp%8 (vstd!arithmetic.power2.pow2.? (I pos!)))
                     (=>
                      (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. tmp%7 tmp%8)
                      (=>
                       %%location_label%%13
                       (= (vstd!arithmetic.power2.pow2.? (I (nClip (Add pos! 1)))) (nClip (Mul 2 (vstd!arithmetic.power2.pow2.?
                           (I pos!)
                )))))))))))
                (=>
                 (= (vstd!arithmetic.power2.pow2.? (I (nClip (Add pos! 1)))) (nClip (Mul 2 (vstd!arithmetic.power2.pow2.?
                 ...
                 (and
                  (=>
                   (ens%vstd!arithmetic.mul.lemma_mul_is_associative. c@ 2 p_pos@)
                   (=>
                    %%location_label%%14
                    (= (Mul c@ (vstd!arithmetic.power2.pow2.? (I (nClip (Add pos! 1))))) (Mul (Mul c@ 2)
                      p_pos@
                  ))))
                  (=>
                   (= (Mul c@ (vstd!arithmetic.power2.pow2.? (I (nClip (Add pos! 1))))) (Mul (Mul c@ 2)
