...
;; curve25519-dalek/src/lemmas/edwards_lemmas/mul_base_lemmas.rs:951:1: 951:98 (#0)
...
;; Function-Specs curve25519_dalek::lemmas::edwards_lemmas::mul_base_lemmas::lemma_pippenger_sum_correct
(declare-fun req%curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.lemma_pippenger_sum_correct.
 (vstd!seq.Seq<i8.>. tuple%2. Int) Bool
)
(declare-const %%global_location_label%%47 Bool)
(declare-const %%global_location_label%%48 Bool)
(assert
 (forall ((digits! vstd!seq.Seq<i8.>.) (basepoint! tuple%2.) (scalar_nat! Int)) (!
   (= (req%curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.lemma_pippenger_sum_correct.
     digits! basepoint! scalar_nat!
    ) (and
     (=>
   ...
   :pattern ((req%curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.lemma_pippenger_sum_correct.
     digits! basepoint! scalar_nat!
   ))
   :qid internal_req__curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.lemma_pippenger_sum_correct._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.lemma_pippenger_sum_correct._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.lemma_pippenger_sum_correct.
 (vstd!seq.Seq<i8.>. tuple%2. Int) Bool
)
(assert
 (forall ((digits! vstd!seq.Seq<i8.>.) (basepoint! tuple%2.) (scalar_nat! Int)) (!
   (= (ens%curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.lemma_pippenger_sum_correct.
     digits! basepoint! scalar_nat!
    ) (= (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.pippenger_partial.? (Poly%vstd!seq.Seq<i8.>.
       digits!
      ) (I 64) (Poly%tuple%2. basepoint!)
   ...
   :pattern ((ens%curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.lemma_pippenger_sum_correct.
     digits! basepoint! scalar_nat!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.lemma_pippenger_sum_correct._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.lemma_pippenger_sum_correct._definition
)))

;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::mul_base_lemmas::lemma_pippenger_sum_correct
;; curve25519-dalek/src/lemmas/edwards_lemmas/mul_base_lemmas.rs:951:1: 951:98 (#0)
 ...
 (assert
  (not (and
    ...
    (=>
     ...
     (=>
      (= tmp%1 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul_signed.?
          ...
          (Poly%tuple%2. basepoint!) (I scalar_nat!)
      ))))
      (and
       (=>
        %%location_label%%1
       ...
       (=>
        ...
        (and
         (=>
          ...
          (=>
           %%location_label%%2
           (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul_signed.?
              (Poly%tuple%2. basepoint!) (I scalar_nat!)
             )
