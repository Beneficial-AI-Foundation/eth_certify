...
;; curve25519-dalek/src/backend/serial/u64/field.rs:985:13: 985:19 (#0)
...
;; Function-Def curve25519_dalek::backend::serial::u64::field::FieldElement51::from_bytes
;; curve25519-dalek/src/backend/serial/u64/field.rs:985:13: 985:19 (#0)
...
(assert
 (not (=>
   ...
   (forall ((x$ (_ BitVec 64))) (!
     (bvult (bvand x$ ((_ zero_extend 13) (_ bv2251799813685247 51))) ((_ zero_extend 12)
       (_ bv2251799813685248 52)
     ))
     :qid user_curve25519_dalek__backend__serial__u64__field__FieldElement51__from_bytes_68
     :skolemid skolem_user_curve25519_dalek__backend__serial__u64__field__FieldElement51__from_bytes_68
)))))
(get-info :version)
