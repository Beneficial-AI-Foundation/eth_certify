...
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_ratio_lemmas.rs:1494:1: 1494:50 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::sqrt_ratio_lemmas::lemma_invsqrt_unique
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_ratio_lemmas.rs:1494:1: 1494:50 (#0)
             ...
             (and
              ...
              (and
               ...
               (=>
                ...
                (and
                 (=>
                  (= tmp%1 (curve25519_dalek!specs.field_specs.field_square.? (I r!)))
                  (=>
                   (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_comm.
                    tmp%1 a!
                   )
                   (=>
                    ...
                    (=>
                     ...
                     (=>
                      (= tmp%3 (curve25519_dalek!specs.field_specs.field_square.? (I r!)))
                      (=>
                            ...
                            (=>
                             ...
                             (and
                              ...
                              (=>
                               ...
                               (=>
                                %%location_label%%18
                                (< (curve25519_dalek!specs.field_specs.field_square.? (I s@)) pn@)
                            ))))
                            (=>
                             (< (curve25519_dalek!specs.field_specs.field_square.? (I s@)) pn@)
                             (=>
                              ...
                              (and
                               (=>
                                %%location_label%%19
                                (req%vstd!arithmetic.div_mod.lemma_small_mod. tmp%7 pn@)
                               )
                               (=>
                                (ens%vstd!arithmetic.div_mod.lemma_small_mod. tmp%7 pn@)
                                (=>
                                 (= tmp%8 (curve25519_dalek!specs.field_specs.field_square.? (I s@)))
                                 (and
                                  (=>
                                   %%location_label%%20
