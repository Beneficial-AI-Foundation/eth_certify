...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:355:1: 355:43 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_square_mod_noop
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:355:1: 355:43 (#0)
    ...
    (=>
     ...
     (and
      (and
       (=>
        %%location_label%%0
        (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. x! x! p@)
       )
       (=>
        (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. x! x! p@)
        (=>
         (= tmp%1 (EucMod x! p@))
         (and
          (=>
           %%location_label%%1
           (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. tmp%1 x! p@)
          )
          (=>
           (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. tmp%1 x! p@)
           (=>
            %%location_label%%2
            (= (curve25519_dalek!specs.field_specs.field_square.? (I (EucMod x! p@))) (curve25519_dalek!specs.field_specs.field_square.?
              (I x!)
      ))))))))
      (=>
       (= (curve25519_dalek!specs.field_specs.field_square.? (I (EucMod x! p@))) (curve25519_dalek!specs.field_specs.field_square.?
