...
;; curve25519-dalek/src/lemmas/field_lemmas/u64_5_as_nat_lemmas.rs:20:1: 24:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::u64_5_as_nat_lemmas::lemma_bridge_pow_as_nat_to_spec
;; curve25519-dalek/src/lemmas/field_lemmas/u64_5_as_nat_lemmas.rs:20:1: 24:2 (#0)
(get-info :all-statistics)
(push)
 (declare-const result! curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const base! curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 ...
 (assert
  (has_type (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. base!) TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 )
 (assert
  (<= 0 exp!)
 )
    ...
    (=>
     ...
     (=>
      ...
      (and
       (=>
        %%location_label%%0
        (req%vstd!arithmetic.power.lemma_pow_mod_noop. tmp%1 exp! tmp%2)
       )
       (=>
        (ens%vstd!arithmetic.power.lemma_pow_mod_noop. tmp%1 exp! tmp%2)
        (=>
         (= x@ (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
             (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
               base!
         ))))))
         (=>
          ...
          (=>
           (= tmp%3 (= y@ (EucMod x@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))))
           (and
            (=>
             %%location_label%%1
             tmp%3
            ...
            (=>
             tmp%3
             (=>
              (= tmp%4 (= (EucMod (vstd!arithmetic.power.pow.? (I x@) (I exp!)) (curve25519_dalek!specs.field_specs_u64.p.?
                  (I 0)
                 )
                ) (EucMod (vstd!arithmetic.power.pow.? (I (EucMod x@ (curve25519_dalek!specs.field_specs_u64.p.?
                     (I 0)
                   ))
                  ) (I exp!)
                 ) (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
              ...
              (and
               ...
               (=>
                tmp%4
                (=>
                 (= tmp%5 (= (EucMod (vstd!arithmetic.power.pow.? (I x@) (I exp!)) (curve25519_dalek!specs.field_specs_u64.p.?
                     (I 0)
                    )
                   ) (EucMod (vstd!arithmetic.power.pow.? (I y@) (I exp!)) (curve25519_dalek!specs.field_specs_u64.p.?
                     (I 0)
                 ))))
                 (and
                  (=>
                  ...
                  (=>
                   ...
                   (and
                    (and
                     (=>
                      %%location_label%%4
                      (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow_nonnegative. x@ exp!)
                     )
                     (=>
                      (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow_nonnegative. x@ exp!)
                      (=>
                       %%location_label%%5
                       (>= (vstd!arithmetic.power.pow.? (I x@) (I exp!)) 0)
                    )))
                    (=>
                     (>= (vstd!arithmetic.power.pow.? (I x@) (I exp!)) 0)
                     (and
                      (and
                       (=>
                        %%location_label%%6
                        (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow_nonnegative. y@ exp!)
                       )
                       (=>
                        (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow_nonnegative. y@ exp!)
                        (=>
                         %%location_label%%7
                         (>= (vstd!arithmetic.power.pow.? (I y@) (I exp!)) 0)
                      )))
                      (=>
                       (>= (vstd!arithmetic.power.pow.? (I y@) (I exp!)) 0)
                       (=>
                        (= tmp%6 (= (EucMod (nClip (vstd!arithmetic.power.pow.? (I x@) (I exp!))) (curve25519_dalek!specs.field_specs_u64.p.?
                            (I 0)
                           )
                          ) (EucMod (nClip (vstd!arithmetic.power.pow.? (I y@) (I exp!))) (curve25519_dalek!specs.field_specs_u64.p.?
                            (I 0)
                        ))))
                        (and
                         (=>
