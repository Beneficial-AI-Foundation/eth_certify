...
;; curve25519-dalek/src/lemmas/common_lemmas/to_nat_lemmas.rs:120:5: 120:11 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::to_nat_lemmas::lemma_u8_32_as_nat_lt_pow2_255
;; curve25519-dalek/src/lemmas/common_lemmas/to_nat_lemmas.rs:120:5: 120:11 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (< prefix31@ (vstd!arithmetic.power2.pow2.? (I 248)))
    (=>
     (<= (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $
          (CONST_INT 32)
         ) (Poly%array%. bytes!)
     ...
     (=>
      (= (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. bytes!)) (nClip
        (Add prefix31@ (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.?
              $ (ARRAY $ (UINT 8) $ (CONST_INT 32)) (Poly%array%. bytes!)
             ) (I 31)
            )
