...
;; MODULE 'module lemmas::field_lemmas::sqrt_m1_lemmas'
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_m1_lemmas.rs:518:1: 518:58 (#0)
...
(assert
 (distinct fuel%vstd!arithmetic.div_mod.lemma_mod_twice. fuel%vstd!arithmetic.div_mod.lemma_mod_multiples_basic.
  fuel%vstd!arithmetic.div_mod.lemma_mod_sub_multiples_vanish. fuel%vstd!arithmetic.div_mod.lemma_sub_mod_noop.
  fuel%vstd!arithmetic.div_mod.lemma_mod_bound. fuel%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left.
  fuel%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. fuel%vstd!arithmetic.div_mod.lemma_mul_mod_noop.
  fuel%vstd!arithmetic.mul.lemma_mul_is_associative. fuel%vstd!arithmetic.mul.lemma_mul_is_commutative.
  fuel%vstd!arithmetic.mul.lemma_mul_is_distributive_sub. fuel%vstd!arithmetic.power.lemma_pow_multiplies.
  ...
  fuel%curve25519_dalek!backend.serial.u64.constants.SQRT_M1. fuel%curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.spec_gcd.
  ...
  fuel%curve25519_dalek!specs.field_specs.is_square. fuel%curve25519_dalek!specs.field_specs.sqrt_m1.
...
(assert
 (=>
  ...
  (forall ((x! Int) (m! Int)) (!
    ...
    :qid user_vstd__arithmetic__div_mod__lemma_mod_multiples_basic_19
    :skolemid skolem_user_vstd__arithmetic__div_mod__lemma_mod_multiples_basic_19
))))
...
(assert
 (=>
  ...
  (forall ((b! Int) (m! Int)) (!
    ...
    :pattern ((EucMod b! m!))
    :qid user_vstd__arithmetic__div_mod__lemma_mod_sub_multiples_vanish_20
    :skolemid skolem_user_vstd__arithmetic__div_mod__lemma_mod_sub_multiples_vanish_20
))))
...
(assert
 (=>
  ...
  (forall ((x! Int) (y! Int) (m! Int)) (!
    ...
    :qid user_vstd__arithmetic__div_mod__lemma_sub_mod_noop_21
    :skolemid skolem_user_vstd__arithmetic__div_mod__lemma_sub_mod_noop_21
))))
...
(assert
 (=>
  ...
  (forall ((x! Int) (y! Int) (m! Int)) (!
    ...
    :pattern ((EucMod (Mul x! y!) m!))
    :qid user_vstd__arithmetic__div_mod__lemma_mul_mod_noop_25
    :skolemid skolem_user_vstd__arithmetic__div_mod__lemma_mul_mod_noop_25
))))
...
(assert
 (=>
  ...
  (forall ((x! Int) (y! Int) (z! Int)) (!
    ...
    :qid user_vstd__arithmetic__mul__lemma_mul_is_distributive_sub_28
    :skolemid skolem_user_vstd__arithmetic__mul__lemma_mul_is_distributive_sub_28
))))
...
(assert
 (=>
  ...
  (forall ((a! Poly) (b! Poly) (c! Poly)) (!
    ...
    :qid user_vstd__arithmetic__power__lemma_pow_multiplies_29
    :skolemid skolem_user_vstd__arithmetic__power__lemma_pow_multiplies_29
))))
 ...
 (=>
  ...
  (forall ((limbs! Poly) (bit_limit! Poly)) (!
    (= (curve25519_dalek!specs.field_specs.u64_5_bounded.? limbs! bit_limit!) (forall (
       ...
       :qid user_curve25519_dalek__specs__field_specs__u64_5_bounded_30
       :skolemid skolem_user_curve25519_dalek__specs__field_specs__u64_5_bounded_30
    )))
...
;; Function-Specs curve25519_dalek::lemmas::common_lemmas::mul_lemmas::lemma_product_square_factorize
(declare-fun ens%curve25519_dalek!lemmas.common_lemmas.mul_lemmas.lemma_product_square_factorize.
 (Int Int) Bool
)
(assert
 (forall ((a! Int) (b! Int)) (!
   (= (ens%curve25519_dalek!lemmas.common_lemmas.mul_lemmas.lemma_product_square_factorize.
     a! b!
    ) (= (Mul (Mul a! b!) (Mul a! b!)) (Mul (Mul a! a!) (Mul b! b!)))
   )
   :pattern ((ens%curve25519_dalek!lemmas.common_lemmas.mul_lemmas.lemma_product_square_factorize.
     a! b!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.common_lemmas.mul_lemmas.lemma_product_square_factorize._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.common_lemmas.mul_lemmas.lemma_product_square_factorize._definition
)))
...
;; Function-Specs curve25519_dalek::lemmas::field_lemmas::sqrt_m1_lemmas::lemma_i_inverse_is_neg_i
(declare-fun ens%curve25519_dalek!lemmas.field_lemmas.sqrt_m1_lemmas.lemma_i_inverse_is_neg_i.
 (Int) Bool
)
(assert
 (forall ((no%param Int)) (!
   (= (ens%curve25519_dalek!lemmas.field_lemmas.sqrt_m1_lemmas.lemma_i_inverse_is_neg_i.
     no%param
    ) (and
     (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.sqrt_m1.?
         (I 0)
        )
       ) (I (curve25519_dalek!specs.field_specs.field_neg.? (I (curve25519_dalek!specs.field_specs.sqrt_m1.?
           (I 0)
       ))))
      ) 1
     )
     (= (curve25519_dalek!specs.field_specs.field_inv.? (I (curve25519_dalek!specs.field_specs.sqrt_m1.?
         (I 0)
       ))
      ) (curve25519_dalek!specs.field_specs.field_neg.? (I (curve25519_dalek!specs.field_specs.sqrt_m1.?
         (I 0)
   ))))))
   :pattern ((ens%curve25519_dalek!lemmas.field_lemmas.sqrt_m1_lemmas.lemma_i_inverse_is_neg_i.
     no%param
   ))
   :qid internal_ens__curve25519_dalek!lemmas.field_lemmas.sqrt_m1_lemmas.lemma_i_inverse_is_neg_i._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.field_lemmas.sqrt_m1_lemmas.lemma_i_inverse_is_neg_i._definition
)))
...
;; Function-Specs curve25519_dalek::lemmas::field_lemmas::sqrt_m1_lemmas::lemma_q_times_i_eq_y
(declare-fun req%curve25519_dalek!lemmas.field_lemmas.sqrt_m1_lemmas.lemma_q_times_i_eq_y.
...
(assert
 (forall ((y! Int) (i! Int) (inv_i! Int) (q! Int) (pn! Int)) (!
   (= (req%curve25519_dalek!lemmas.field_lemmas.sqrt_m1_lemmas.lemma_q_times_i_eq_y. y!
     i! inv_i! q! pn!
    ) (and
     (=>
     ...
     (=>
      ...
      (= q! (curve25519_dalek!specs.field_specs.field_mul.? (I y!) (I inv_i!)))
     )
     (=>
      %%global_location_label%%35
      (= (EucMod (nClip (Mul (EucMod i! pn!) inv_i!)) pn!) 1)
     )
     (=>
      %%global_location_label%%36
      (< i! pn!)
   )))
   :pattern ((req%curve25519_dalek!lemmas.field_lemmas.sqrt_m1_lemmas.lemma_q_times_i_eq_y.
     y! i! inv_i! q! pn!
   ))
   :qid internal_req__curve25519_dalek!lemmas.field_lemmas.sqrt_m1_lemmas.lemma_q_times_i_eq_y._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.field_lemmas.sqrt_m1_lemmas.lemma_q_times_i_eq_y._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.field_lemmas.sqrt_m1_lemmas.lemma_q_times_i_eq_y.
 (Int Int Int Int Int) Bool
)
(assert
 (forall ((y! Int) (i! Int) (inv_i! Int) (q! Int) (pn! Int)) (!
   (= (ens%curve25519_dalek!lemmas.field_lemmas.sqrt_m1_lemmas.lemma_q_times_i_eq_y. y!
     i! inv_i! q! pn!
    ) (= (EucMod (nClip (Mul q! i!)) pn!) (EucMod y! pn!))
   )
   :pattern ((ens%curve25519_dalek!lemmas.field_lemmas.sqrt_m1_lemmas.lemma_q_times_i_eq_y.
     y! i! inv_i! q! pn!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.field_lemmas.sqrt_m1_lemmas.lemma_q_times_i_eq_y._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.field_lemmas.sqrt_m1_lemmas.lemma_q_times_i_eq_y._definition
)))
...
;; Function-Specs curve25519_dalek::lemmas::field_lemmas::sqrt_m1_lemmas::lemma_square_root_of_neg_one
(declare-fun req%curve25519_dalek!lemmas.field_lemmas.sqrt_m1_lemmas.lemma_square_root_of_neg_one.
 (Int Int) Bool
)
...
(assert
 (forall ((y! Int) (i! Int)) (!
   (= (req%curve25519_dalek!lemmas.field_lemmas.sqrt_m1_lemmas.lemma_square_root_of_neg_one.
     y! i!
    ) (and
     (=>
     ...
     (=>
      ...
      (= (EucMod (nClip (Mul y! y!)) (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
       (nClip (Sub (curve25519_dalek!specs.field_specs_u64.p.? (I 0)) 1))
   ))))
   :pattern ((req%curve25519_dalek!lemmas.field_lemmas.sqrt_m1_lemmas.lemma_square_root_of_neg_one.
     y! i!
   ))
   :qid internal_req__curve25519_dalek!lemmas.field_lemmas.sqrt_m1_lemmas.lemma_square_root_of_neg_one._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.field_lemmas.sqrt_m1_lemmas.lemma_square_root_of_neg_one._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.field_lemmas.sqrt_m1_lemmas.lemma_square_root_of_neg_one.
 (Int Int) Bool
)
(assert
 (forall ((y! Int) (i! Int)) (!
   (= (ens%curve25519_dalek!lemmas.field_lemmas.sqrt_m1_lemmas.lemma_square_root_of_neg_one.
     y! i!
    ) (or
     (= (EucMod y! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) i!)
     (= (EucMod y! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) (nClip (Sub (curve25519_dalek!specs.field_specs_u64.p.?
         (I 0)
        ) i!
   )))))
   :pattern ((ens%curve25519_dalek!lemmas.field_lemmas.sqrt_m1_lemmas.lemma_square_root_of_neg_one.
     y! i!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.field_lemmas.sqrt_m1_lemmas.lemma_square_root_of_neg_one._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.field_lemmas.sqrt_m1_lemmas.lemma_square_root_of_neg_one._definition
)))

;; Function-Def curve25519_dalek::lemmas::field_lemmas::sqrt_m1_lemmas::lemma_square_root_of_neg_one
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_m1_lemmas.rs:518:1: 518:58 (#0)
...
(push)
 ...
 (declare-const inv_i@ Int)
 (declare-const q@ Int)
 (declare-const i_sq@ Int)
 (declare-const y_sq_mod@ Int)
 (declare-const inv_i_sq@ Int)
 (assert
  fuel_defaults
 )
 (assert
  ...
  (not (=>
    ...
    (=>
     ...
     (=>
      ...
      (=>
       (ens%curve25519_dalek!lemmas.field_lemmas.sqrt_m1_lemmas.axiom_sqrt_m1_squared. 0)
       (=>
        (= neg_one@ (nClip (Sub pn@ 1)))
        (=>
         (= tmp%1 (= (EucMod (nClip (Mul y! y!)) pn@) (EucMod (nClip (Mul i! i!)) pn@)))
         (and
          (=>
           %%location_label%%0
           tmp%1
          ...
          (=>
           tmp%1
           (=>
            (= inv_i@ (curve25519_dalek!specs.field_specs.field_inv.? (I i!)))
            (and
             (=>
              %%location_label%%1
              (req%curve25519_dalek!specs.field_specs.field_inv_property. i!)
             )
             (=>
              (ens%curve25519_dalek!specs.field_specs.field_inv_property. i!)
              (=>
               (= tmp%2 (< inv_i@ pn@))
               (and
                (=>
                 ...
                 (=>
                  ...
                  (and
                   ...
                   (=>
                    (< q@ pn@)
                    (=>
                     (= i_sq@ (curve25519_dalek!specs.field_specs.field_square.? (I i!)))
                     (and
                      (and
                       (=>
                        %%location_label%%5
                        (req%vstd!arithmetic.div_mod.lemma_small_mod. neg_one@ pn@)
                       )
                       (=>
                        (ens%vstd!arithmetic.div_mod.lemma_small_mod. neg_one@ pn@)
                        (=>
                         %%location_label%%6
                         (= i_sq@ neg_one@)
                      )))
                      (=>
                       ...
                       (and
                        (=>
                         (= tmp%4 (nClip (Mul y! inv_i@)))
                         (=>
                          (= tmp%5 (nClip (Mul y! inv_i@)))
                          (and
                           (=>
                            %%location_label%%7
                            (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop. tmp%4 tmp%5 pn@)
                           )
                           (=>
                            (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop. tmp%4 tmp%5 pn@)
                            (=>
                             %%location_label%%8
                             (= (EucMod (nClip (Mul q@ q@)) pn@) (EucMod (nClip (Mul (nClip (Mul y! inv_i@)) (nClip
                                  (Mul y! inv_i@)
                                ))
                               ) pn@
                        )))))))
                        (=>
                         ...
                         (and
                          (=>
                           ...
                           (=>
                            %%location_label%%9
                            (= (nClip (Mul (nClip (Mul y! inv_i@)) (nClip (Mul y! inv_i@)))) (nClip (Mul (nClip (
                                 Mul y! y!
                                )
                               ) (nClip (Mul inv_i@ inv_i@))
                          )))))
                          (=>
                           (= (nClip (Mul (nClip (Mul y! inv_i@)) (nClip (Mul y! inv_i@)))) (nClip (Mul (nClip (
                                Mul y! y!
                           ...
                           (=>
                            (= y_sq_mod@ (EucMod (nClip (Mul y! y!)) pn@))
                            (=>
                             (= tmp%6 (= y_sq_mod@ neg_one@))
                             (and
                              (=>
                               %%location_label%%10
                               tmp%6
                              ...
                              (=>
                               tmp%6
                               (=>
                                (= inv_i_sq@ (EucMod (nClip (Mul inv_i@ inv_i@)) pn@))
                                (and
                                 (=>
                                  (= product@ (curve25519_dalek!specs.field_specs.field_mul.? (I (EucMod i! pn@)) (I inv_i@)))
                                  (=>
                                   (= tmp%7 (= product@ 1))
                                   (and
                                    (=>
                                    ...
                                    (=>
                                     ...
                                     (and
                                      (=>
                                       %%location_label%%12
                                       (req%vstd!arithmetic.div_mod.lemma_small_mod. i! pn@)
                                      )
                                      (=>
                                       (ens%vstd!arithmetic.div_mod.lemma_small_mod. i! pn@)
                                       (=>
                                        (= tmp%8 (= product@ (EucMod (nClip (Mul i! inv_i@)) pn@)))
                                        (and
                                         (=>
                                          %%location_label%%13
                                          tmp%8
                                         ...
                                         (=>
                                          ...
                                          (and
                                           (and
                                            (=>
                                             %%location_label%%14
                                             (req%vstd!arithmetic.div_mod.lemma_small_mod. 1 pn@)
                                            )
                                            (=>
                                             (ens%vstd!arithmetic.div_mod.lemma_small_mod. 1 pn@)
                                             (=>
                                              %%location_label%%15
                                              (= (EucMod (nClip (Mul product@ product@)) pn@) 1)
                                           )))
                                           (=>
                                            (= (EucMod (nClip (Mul product@ product@)) pn@) 1)
                                            (=>
                                             (= tmp%9 (nClip (Mul i! inv_i@)))
                                             (=>
                                              (= tmp%10 (nClip (Mul i! inv_i@)))
                                              (and
                                               (=>
                                                %%location_label%%16
                                                (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop. tmp%9 tmp%10 pn@)
                                               )
                                               (=>
                                                (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop. tmp%9 tmp%10 pn@)
                                                (=>
                                                 %%location_label%%17
                                                 (= (EucMod (nClip (Mul (nClip (Mul i! inv_i@)) (nClip (Mul i! inv_i@)))) pn@) 1)
                                 ))))))))))))))))
                                 (=>
                                  (= (EucMod (nClip (Mul (nClip (Mul i! inv_i@)) (nClip (Mul i! inv_i@)))) pn@) 1)
                                  (and
                                   (=>
                                    ...
                                    (=>
                                     %%location_label%%18
                                     (= (nClip (Mul (nClip (Mul i! inv_i@)) (nClip (Mul i! inv_i@)))) (nClip (Mul (nClip (
                                          Mul i! i!
                                         )
                                        ) (nClip (Mul inv_i@ inv_i@))
                                   )))))
                                   (=>
                                    ...
                                    (=>
                                     (= tmp%11 (= (EucMod (nClip (Mul (nClip (Mul i! i!)) (nClip (Mul inv_i@ inv_i@)))) pn@)
                                       1
                                     ))
                                     (and
                                      (=>
                                      ...
                                      (=>
                                       ...
                                       (and
                                        (=>
                                         (= tmp%12 (nClip (Mul y! y!)))
                                         (=>
                                          (= tmp%13 (nClip (Mul inv_i@ inv_i@)))
                                          (and
                                           (=>
                                            %%location_label%%20
                                            (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. tmp%12 tmp%13 pn@)
                                           )
                                           (=>
                                            (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. tmp%12 tmp%13 pn@)
                                            (=>
                                             (= tmp%14 (nClip (Mul i! i!)))
                                             (=>
                                              (= tmp%15 (nClip (Mul inv_i@ inv_i@)))
                                              (and
                                               (=>
                                                %%location_label%%21
                                                (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. tmp%14 tmp%15 pn@)
                                               )
                                               (=>
                                                (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. tmp%14 tmp%15 pn@)
                                                (=>
                                                 %%location_label%%22
                                                 (= (EucMod (nClip (Mul (nClip (Mul y! y!)) (nClip (Mul inv_i@ inv_i@)))) pn@) 1)
                                        )))))))))
                                        (=>
                                         (= (EucMod (nClip (Mul (nClip (Mul y! y!)) (nClip (Mul inv_i@ inv_i@)))) pn@) 1)
                                         (=>
                                          (= tmp%16 (= (EucMod (nClip (Mul q@ q@)) pn@) 1))
                                          (and
                                           (=>
                                            %%location_label%%23
                                            tmp%16
                                            ...
                                            (and
                                             ...
                                             (=>
                                              ...
                                              (and
                                               (=>
                                                %%location_label%%25
                                                (req%vstd!arithmetic.div_mod.lemma_small_mod. q@ pn@)
                                               )
                                               (=>
                                                (ens%vstd!arithmetic.div_mod.lemma_small_mod. q@ pn@)
                                                (and
                                                 (=>
                                                  %%location_label%%26
                                                  (req%curve25519_dalek!lemmas.field_lemmas.sqrt_m1_lemmas.lemma_q_times_i_eq_y. y!
                                                  ...
                                                  (or
                                                   (and
                                                    (=>
                                                     ...
                                                     (and
                                                      (=>
                                                       (ens%vstd!arithmetic.mul.lemma_mul_basics. i!)
                                                       (and
                                                        (=>
                                                         %%location_label%%27
                                                         (req%vstd!arithmetic.div_mod.lemma_small_mod. i! pn@)
                                                          ...
                                                          (=>
                                                           ...
                                                           (and
                                                            ...
                                                            (=>
                                                             (ens%vstd!arithmetic.div_mod.lemma_small_mod. i! pn@)
                                                             (=>
                                                              (= tmp%18 (nClip (Sub pn@ i!)))
                                                              (and
                                                               (=>
                                                                %%location_label%%32
                                                                (req%vstd!arithmetic.div_mod.lemma_small_mod. tmp%18 pn@)
                                                               )
                                                               (=>
                                                                (ens%vstd!arithmetic.div_mod.lemma_small_mod. tmp%18 pn@)
                                                                (=>
                                                                 %%location_label%%33
                                                                 (= (EucMod (nClip (Mul i! (nClip (Sub pn@ 1)))) pn@) (nClip (Sub pn@ i!)))
                                                         ))))))))
                                                         (=>
                                                          (= (EucMod (nClip (Mul i! (nClip (Sub pn@ 1)))) pn@) (nClip (Sub pn@ i!)))
                                                          (and
                                                           (=>
                                                            (= tmp%19 (nClip (Sub pn@ 1)))
                                                            (=>
                                                             (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. tmp%19 i!)
                                                             (=>
                                                              %%location_label%%34
                                                              (= (nClip (Mul (nClip (Sub pn@ 1)) i!)) (nClip (Mul i! (nClip (Sub pn@ 1)))))
                                                           )))
                                                           (=>
                                                            (= (nClip (Mul (nClip (Sub pn@ 1)) i!)) (nClip (Mul i! (nClip (Sub pn@ 1)))))
                                                            (=>
                                                             (= tmp%20 (= (EucMod y! pn@) (nClip (Sub pn@ i!))))
                                                             (and
                                                              (=>
                                                               %%location_label%%35
                                                               tmp%20
