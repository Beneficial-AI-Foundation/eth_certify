...
;; curve25519-dalek/src/lemmas/field_lemmas/to_bytes_reduction_lemmas.rs:349:1: 349:99 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::to_bytes_reduction_lemmas::lemma_reduction_carry_propagation_is_division
;; curve25519-dalek/src/lemmas/field_lemmas/to_bytes_reduction_lemmas.rs:349:1: 349:99 (#0)
...
(push)
 ...
 (assert
  (forall ((i$ Poly)) (!
    ...
    :qid user_curve25519_dalek__lemmas__field_lemmas__to_bytes_reduction_lemmas__lemma_reduction_carry_propagation_is_division_48
    :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__to_bytes_reduction_lemmas__lemma_reduction_carry_propagation_is_division_48
 )))
 (assert
  (or
   (= q! 0)
                ...
                (=>
                 ...
                 (=>
                  ...
                  (and
                   (=>
                    %%location_label%%0
                    (= 4503599627370496 (vstd!arithmetic.power2.pow2.? (I 52)))
                   )
                   (=>
                              ...
                              (=>
                               ...
                               (and
                                ...
                                (=>
                                 ...
                                 (=>
                                  (= final_limbs@ (%Poly%array%. (array_new $ (UINT 64) 5 (%%array%%0 (I l0_masked@) (I
                                       l1_masked@
                                      ) (I l2_masked@) (I l3_masked@) (I l4_masked@)
                                  ))))
                                  (=>
                                        ...
                                        (=>
                                         ...
                                         (and
                                          ...
                                          (=>
                                           ...
                                           (=>
                                            (= dividend@ (Add (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%.
                                                input_limbs!
                                               )
                                              ) (Mul 19 q!)
                                            ))
                                            (=>
                                             (= divisor@ (vstd!arithmetic.power2.pow2.? (I 255)))
                                             (and
                                              (=>
                                               %%location_label%%9
                                               (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. dividend@ divisor@)
                                              )
                                              (=>
                                               (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. dividend@ divisor@)
                                               (=>
                                                (ens%vstd!arithmetic.power2.lemma_pow2_pos. 255)
                                                (=>
                                                 (= remainder@ (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. final_limbs@)))
                                                 (=>
                                                  (= tmp%1 (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. final_limbs@)))
                                                  (and
                                                   (=>
                                                    %%location_label%%10
                                                    (req%vstd!arithmetic.div_mod.lemma_div_multiples_vanish_fancy. c4! tmp%1 divisor@)
                                                   )
                                                   (=>
                                                    (ens%vstd!arithmetic.div_mod.lemma_div_multiples_vanish_fancy. c4! tmp%1 divisor@)
                                                    (=>
                                                     %%location_label%%11
                                                     (= c4! (EucDiv (Add (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%.
                                                          input_limbs!
