...
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:1455:1: 1455:92 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::curve_equation_lemmas::lemma_edwards_scalar_mul_composition
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:1455:1: 1455:92 (#0)
...
(push)
 ...
 (declare-const half$1@ tuple%2.)
 (declare-const tmp%6 Bool)
 (declare-const bm1@ Int)
 ...
 (declare-const bm1$1@ Int)
 (declare-const pa@ tuple%2.)
 (declare-const prev$1@ tuple%2.)
     ...
     (and
      (=>
       ...
       (=>
        (fuel_bool fuel%curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.)
        (=>
         (= tmp%1 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.?
             (Poly%tuple%2. point_affine!) (I 0)
            )
                 ...
                 (or
                  (and
                   (=>
                    (= b! 1)
                    (=>
                     (= tmp%3 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.?
                         (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_identity.? (I 0))) (
                          I 1
                        ))
                       ) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_identity.? (I 0)))
                        ...
                        (and
                         (=>
                          ...
                          (check_decrease_int (let
                            ((point_affine!$0 point_affine!) (a!$1 0) (b!$2 hb@))
                            b!$2
                         ...
                         (=>
                          ...
                          (=>
                           (= tmp%4 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.?
                               ...
                               ((half$ (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.?
                                    (Poly%tuple%2. point_affine!) (I 0)
                                   )
                                  ) (I hb@)
                               )))
                           ...
                           (and
                            ...
                            (=>
                             tmp%4
                             (=>
                              (= half$1@ (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2.
                                 (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2. point_affine!)
                                  (I 0)
                                 )
                                ) (I hb@)
                              ...
                              (=>
                               (= tmp%5 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. half$1@) (Poly%tuple%2.
                                  (curve25519_dalek!specs.edwards_specs.edwards_identity.? (I 0))
                               )))
                               (and
                                (=>
                                  ...
                                  (=>
                                   ...
                                   (=>
                                    ...
                                    (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_double.?
                                       (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. half$1@))) (tuple%2./tuple%2/1
                                        (%Poly%tuple%2. (Poly%tuple%2. half$1@))
                                      ))
                                     ) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_identity.? (I 0)))
                                  )))
                                  (=>
                                   (= (curve25519_dalek!specs.edwards_specs.edwards_double.? (tuple%2./tuple%2/0 (%Poly%tuple%2.
                                     ...
                                     ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. half$1@)))
                                    ) (curve25519_dalek!specs.edwards_specs.edwards_identity.? (I 0))
                                   )
                                   %%switch_label%%3
                      )))))))))))))
                       ...
                       (=>
                        ...
                        (and
                         (=>
                          %%location_label%%7
                          (check_decrease_int (let
                            ((point_affine!$0 point_affine!) (a!$1 0) (b!$2 bm1@))
                            b!$2
                           ) decrease%init0 false
                         ))
                         (=>
                          ...
                          (=>
                           (= prev@ (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2. (
                               curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2. point_affine!)
                               (I 0)
                              )
                             ) (I bm1@)
                           ...
                           (=>
                            (= tmp%6 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. prev@) (Poly%tuple%2.
                               (curve25519_dalek!specs.edwards_specs.edwards_identity.? (I 0))
                            )))
                            (and
                             (=>
                             ...
                             (=>
                              ...
                              (and
                               ...
                               (=>
                                (= (curve25519_dalek!specs.edwards_specs.edwards_add.? (I 0) (I 1) (I 0) (I 1)) (curve25519_dalek!specs.edwards_specs.edwards_identity.?
                                  (I 0)
                                ))
                                %%switch_label%%3
                     )))))))))))
                ...
                (=>
                 ...
                 (and
                  (=>
                   %%location_label%%12
                   (check_decrease_int (let
                     ((point_affine!$0 point_affine!) (a!$1 a!) (b!$2 hb$1@))
                     b!$2
                    ) decrease%init0 false
                  ))
                  (=>
                   ...
                   (=>
                    (fuel_bool fuel%curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.)
                    (=>
                     (= tmp%9 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.?
                         (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2.
                            point_affine!
                           ) (I a!)
                          )
                      ...
                      (=>
                       ...
                       (and
                        (and
                         (=>
                          %%location_label%%14
                          (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. a! b! 2)
                         )
                         (=>
                          (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. a! b! 2)
                          (=>
                           (= tmp%10 (= (EucMod (nClip (Mul a! b!)) 2) (EucMod (nClip (Mul a! (EucMod b! 2))) 2)))
                           (and
                            (=>
                             %%location_label%%15
                             tmp%10
                        ...
                        (=>
                         ...
                         (and
                          (and
                           (=>
                            %%location_label%%20
                            (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. b! 2)
                           )
                           (=>
                            (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. b! 2)
                            (=>
                             (ens%vstd!arithmetic.mul.lemma_mul_is_associative. a! hb$1@ 2)
                             (=>
                              (= tmp%13 (nClip (Mul a! hb$1@)))
                              (and
                               (=>
                                %%location_label%%21
                                (req%vstd!arithmetic.div_mod.lemma_div_by_multiple. tmp%13 2)
                               )
                               (=>
                                (ens%vstd!arithmetic.div_mod.lemma_div_by_multiple. tmp%13 2)
                                (=>
                                 %%location_label%%22
                                 (= (EucDiv (nClip (Mul a! b!)) 2) (nClip (Mul a! hb$1@)))
                          )))))))
                          (=>
                           (= (EucDiv (nClip (Mul a! b!)) 2) (nClip (Mul a! hb$1@)))
                           (and
                            (=>
                             (ens%vstd!arithmetic.mul.lemma_mul_nonzero. a! b!)
                             (=>
                              %%location_label%%23
                              (not (= (nClip (Mul a! b!)) 0))
                            ))
                             ...
                             (=>
                              ...
                              (and
                               ...
                               (=>
                                tmp%14
                                (=>
                                 (= tmp%15 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.?
                                     (Poly%tuple%2. point_affine!) (I (nClip (Mul a! b!)))
                                    )
                                   ) (Poly%tuple%2. (let
                                     ((half$ (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2. point_affine!)
                                        (I (EucDiv (nClip (Mul a! b!)) 2))
                                     )))
                                     (curve25519_dalek!specs.edwards_specs.edwards_double.? (tuple%2./tuple%2/0 (%Poly%tuple%2.
                                        (Poly%tuple%2. half$)
                                       )
                                     ...
                                     (=>
                                      ...
                                      (and
                                       ...
                                       (=>
                                        ...
                                        (and
                                         (=>
                                          (= tmp%17 (= (EucDiv (nClip (Mul a! b!)) 2) (nClip (Mul a! hb$1@))))
                                          (and
                                           (=>
                                            %%location_label%%29
                                            tmp%17
                ...
                (=>
                 ...
                 (and
                  (=>
                   %%location_label%%32
                   (check_decrease_int (let
                     ((point_affine!$0 point_affine!) (a!$1 a!) (b!$2 bm1$1@))
                     b!$2
                    ) decrease%init0 false
                  ))
                  (=>
                   (ens%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_edwards_scalar_mul_composition.
                    point_affine! a! bm1$1@
                   )
                   (=>
                    (= pa@ (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2. point_affine!)
                      (I a!)
                    ))
                    (=>
                     (= prev$1@ (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2.
                        pa@
                       ) (I bm1$1@)
                     ))
                     (=>
                         ...
                         (=>
                          ...
                          (and
                           ...
                           (=>
                            tmp%19
                            (=>
                             (= tmp%20 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.?
                                 (Poly%tuple%2. pa@) (I b!)
                                )
                               ) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_add.? (tuple%2./tuple%2/0
                                  (%Poly%tuple%2. (Poly%tuple%2. prev$1@))
                                 ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. prev$1@))) (tuple%2./tuple%2/0
                                  (%Poly%tuple%2. (Poly%tuple%2. pa@))
                                 ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. pa@)))
                             ))))
                             (and
                              (=>
                               %%location_label%%35
                              ...
                              (=>
                               ...
                               (and
                                (=>
                                 (= tmp%21 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.?
                                     (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2.
                                        point_affine!
                                       ) (I a!)
                                      )
                                 ...
                                 (and
                                  ...
                                  (=>
                                   ...
                                   (=>
                                    %%location_label%%37
                                    (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. prev$1@) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.?
                                       (Poly%tuple%2. point_affine!) (I (nClip (Mul a! bm1$1@)))
                                )))))))
                                (=>
                                 (= prev$1@ (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2.
                                    point_affine!
                                    ...
                                    (=>
                                     ...
                                     (and
                                      ...
                                      (=>
                                       ...
                                       (and
                                        (=>
                                         (ens%vstd!arithmetic.mul.lemma_mul_nonzero. a! bm1$1@)
                                         (=>
                                          %%location_label%%40
                                          (>= (nClip (Mul a! bm1$1@)) 1)
                                        ))
                                        (=>
                                         ...
                                         (and
                                          (=>
                                           (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add. a! bm1$1@ 1)
                                           (=>
                                            (ens%vstd!arithmetic.mul.lemma_mul_basics. a!)
                                            (=>
                                             %%location_label%%41
                                             (= (nClip (Add (nClip (Mul a! bm1$1@)) a!)) (nClip (Mul a! b!)))
                                          )))
                                          (=>
                                           (= (nClip (Add (nClip (Mul a! bm1$1@)) a!)) (nClip (Mul a! b!)))
                                           (and
                                            (and
                                             (=>
                                              (= tmp%24 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.?
                                                  (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2.
                                                     point_affine!
                                                    ) (I a!)
                                                   )
                                             ...
                                             (=>
                                              (= (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.?
                                               ...
                                               ) (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2. pa@) (
                                                 I b!
                                              )))
                                              (and
                                               (=>
                                               ...
                                               (=>
                                                ...
                                                (and
                                                 (=>
                                                  (= tmp%25 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. prev$1@) (Poly%tuple%2.
                                                     (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2. point_affine!)
                                                      (I (nClip (Mul a! bm1$1@)))
                                                  ))))
                                                  (and
                                                   ...
                                                   (=>
                                                    ...
                                                    (=>
                                                     %%location_label%%46
                                                     (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_add.?
                                                        (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. prev$1@))) (tuple%2./tuple%2/1
                                                         (%Poly%tuple%2. (Poly%tuple%2. prev$1@))
                                                        ) (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. pa@))) (tuple%2./tuple%2/1 (%Poly%tuple%2.
                                                          (Poly%tuple%2. pa@)
                                                       )))
                                                      ) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_add.? (tuple%2./tuple%2/0
                                                 ...
                                                 (=>
                                                  ...
                                                  (and
                                                   (=>
                                                    (= tmp%26 (nClip (Mul a! bm1$1@)))
                                                    (and
                                                     (=>
                                                      %%location_label%%47
                                                      (req%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_edwards_scalar_mul_additive.
                                                       point_affine! tmp%26 a!
                                                     ))
                                                     (=>
                                                      (ens%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_edwards_scalar_mul_additive.
                                                       point_affine! tmp%26 a!
                                                      ...
                                                      (=>
                                                       ...
                                                       (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_add.?
                                                          (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.?
                                                           ...
                                                           point_affine!
                                                          ) (I (nClip (Add (nClip (Mul a! bm1$1@)) a!)))
                                                   )))))))
                                                   (=>
                                                    (= (curve25519_dalek!specs.edwards_specs.edwards_add.? (tuple%2./tuple%2/0 (%Poly%tuple%2.
                                                        (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2.
                                                    ...
                                                    (and
                                                     (=>
                                                      (= tmp%27 (= (nClip (Add (nClip (Mul a! bm1$1@)) a!)) (nClip (Mul a! b!))))
                                                      (and
                                                       (=>
                                                        %%location_label%%49
                                                        tmp%27
                                                       ...
                                                       (=>
                                                        ...
                                                        (=>
                                                         %%location_label%%50
                                                         (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.?
                                                            (Poly%tuple%2. point_affine!) (I (nClip (Add (nClip (Mul a! bm1$1@)) a!)))
                                                           )
                                                          ) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2.
                                                             point_affine!
                                                            ) (I (nClip (Mul a! b!)))
