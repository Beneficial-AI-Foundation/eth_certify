...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:188:1: 188:50 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_field_add_comm
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:188:1: 188:50 (#0)
 ...
 (assert
  (not (=>
    ...
    (=>
     ...
     (=>
      (= tmp%1 (= (curve25519_dalek!specs.field_specs.field_add.? (I a!) (I b!)) (EucMod (
          nClip (Add a! b!)
         ) p@
      )))
      (and
       ...
       (=>
        tmp%1
        (=>
         (= tmp%2 (= (curve25519_dalek!specs.field_specs.field_add.? (I b!) (I a!)) (EucMod (
             nClip (Add b! a!)
            ) p@
         )))
         (and
          ...
          (=>
           tmp%2
           (=>
            (= tmp%3 (= (nClip (Add a! b!)) (nClip (Add b! a!))))
            (and
             (=>
              %%location_label%%2
              tmp%3
