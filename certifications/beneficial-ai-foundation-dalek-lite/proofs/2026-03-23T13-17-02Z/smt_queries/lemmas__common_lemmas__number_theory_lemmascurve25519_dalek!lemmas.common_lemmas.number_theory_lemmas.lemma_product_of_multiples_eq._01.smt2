...
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:1222:1: 1222:59 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::number_theory_lemmas::lemma_product_of_multiples_eq
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:1222:1: 1222:59 (#0)
...
(push)
 ...
 (declare-const prev_prod@ Int)
 (declare-const prev_pow@ Int)
 (declare-const prev_fact@ Int)
 (declare-const curr_pow@ Int)
      ...
      (=>
       ...
       (and
        (=>
         ...
         (=>
          %%location_label%%0
          (= (vstd!arithmetic.power.pow.? (I a!) (I 0)) 1)
        ))
        (=>
         (= (vstd!arithmetic.power.pow.? (I a!) (I 0)) 1)
         (=>
       ...
       (=>
        ...
        (and
         ...
         (=>
          ...
          (=>
           (= prev_prod@ (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.product_of_multiples.?
             (I a!) (I (nClip (Sub n! 1)))
           ))
           (=>
            (= prev_pow@ (nClip (vstd!arithmetic.power.pow.? (I a!) (I (nClip (Sub n! 1))))))
            (=>
             (= prev_fact@ (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.factorial.?
               (I (nClip (Sub n! 1)))
             ))
             (=>
              (= tmp%4 (= (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.product_of_multiples.?
                 (I a!) (I n!)
                ) (nClip (Mul (nClip (Mul n! a!)) prev_prod@))
              ))
              (and
               (=>
                %%location_label%%4
               ...
               (=>
                tmp%4
                (=>
                 (= tmp%5 (= (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.factorial.?
                    (I n!)
                 ...
                 (and
                  ...
                  (=>
                   tmp%5
                   (=>
                    (= tmp%6 (= (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.factorial.?
                       (I n!)
                      ) (nClip (Mul n! prev_fact@))
                    ))
                    (and
                     (=>
                      %%location_label%%6
                     ...
                     (=>
                      tmp%6
                      (=>
                       (= tmp%7 (= prev_prod@ (nClip (Mul prev_pow@ prev_fact@))))
                       (and
                        (=>
                         %%location_label%%7
                         tmp%7
                        ...
                        (=>
                         ...
                         (and
                          (=>
                           ...
                           (=>
                            %%location_label%%8
                            (= (vstd!arithmetic.power.pow.? (I a!) (I n!)) (Mul a! (vstd!arithmetic.power.pow.?
                               (I a!) (I (nClip (Sub n! 1)))
                          )))))
                          (=>
                           (= (vstd!arithmetic.power.pow.? (I a!) (I n!)) (Mul a! (vstd!arithmetic.power.pow.?
                           ...
                           (=>
                            (= curr_pow@ (nClip (vstd!arithmetic.power.pow.? (I a!) (I n!))))
                            (and
                             (and
                              (or
                               (and
                                (=>
                                 ...
                                 (=>
                                  ...
                                  (and
                                   (=>
                                    %%location_label%%9
                                    (req%vstd!arithmetic.power.lemma_pow_positive. a! tmp%8)
                                   )
                                   (=>
                                    (ens%vstd!arithmetic.power.lemma_pow_positive. a! tmp%8)
                                    %%switch_label%%1
                                ))))
                                (=>
                                 (not (> a! 0))
                               ...
                               (and
                                ...
                                (=>
                                 %%location_label%%10
                                 (>= (vstd!arithmetic.power.pow.? (I a!) (I (nClip (Sub n! 1)))) 0)
                              )))
                              (=>
                               (>= (vstd!arithmetic.power.pow.? (I a!) (I (nClip (Sub n! 1)))) 0)
                               (=>
                                (= tmp%9 (vstd!arithmetic.power.pow.? (I a!) (I (nClip (Sub n! 1)))))
                                (and
                                 (=>
                                  %%location_label%%11
                                  (req%vstd!arithmetic.mul.lemma_mul_nonnegative. a! tmp%9)
                                 )
                                 (=>
                                  (ens%vstd!arithmetic.mul.lemma_mul_nonnegative. a! tmp%9)
                                  (=>
                                   %%location_label%%12
                                   (= curr_pow@ (nClip (Mul a! prev_pow@)))
                             ))))))
                             (=>
                              (= curr_pow@ (nClip (Mul a! prev_pow@)))
                              (and
                               (=>
                                (= tmp%10 (nClip (Mul prev_pow@ prev_fact@)))
                                (=>
                                 (ens%vstd!arithmetic.mul.lemma_mul_is_associative. n! a! tmp%10)
                                 (=>
                                  (ens%vstd!arithmetic.mul.lemma_mul_is_associative. a! prev_pow@ prev_fact@)
                                  (=>
                                   (= tmp%11 (nClip (Mul a! prev_pow@)))
                                   (=>
                                    (ens%vstd!arithmetic.mul.lemma_mul_is_associative. n! tmp%11 prev_fact@)
                                    (=>
                                     (= tmp%12 (nClip (Mul a! prev_pow@)))
                                     (=>
                                      (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. n! tmp%12)
                                      (=>
                                       (= tmp%13 (nClip (Mul a! prev_pow@)))
                                       (=>
                                        (ens%vstd!arithmetic.mul.lemma_mul_is_associative. tmp%13 n! prev_fact@)
                                        (=>
                                         %%location_label%%13
                                         (= (nClip (Mul (nClip (Mul n! a!)) (nClip (Mul prev_pow@ prev_fact@)))) (nClip (Mul
                                            (nClip (Mul a! prev_pow@)) (nClip (Mul n! prev_fact@))
                               )))))))))))))
                               (=>
                                (= (nClip (Mul (nClip (Mul n! a!)) (nClip (Mul prev_pow@ prev_fact@)))) (nClip (Mul
                                   (nClip (Mul a! prev_pow@)) (nClip (Mul n! prev_fact@))
                                ...
                                (and
                                 (=>
                                  %%location_label%%14
                                  (= (nClip (Mul (nClip (Mul a! prev_pow@)) (nClip (Mul n! prev_fact@)))) (nClip (Mul
                                     curr_pow@ (nClip (Mul n! prev_fact@))
                                 ))))
                                 (=>
                                  (= (nClip (Mul (nClip (Mul a! prev_pow@)) (nClip (Mul n! prev_fact@)))) (nClip (Mul
                                     curr_pow@ (nClip (Mul n! prev_fact@))
                                  ...
                                  (and
                                   (=>
                                    %%location_label%%15
                                    (= (nClip (Mul curr_pow@ (nClip (Mul n! prev_fact@)))) (nClip (Mul curr_pow@ (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.factorial.?
                                        (I n!)
                                   )))))
                                   (=>
                                    (= (nClip (Mul curr_pow@ (nClip (Mul n! prev_fact@)))) (nClip (Mul curr_pow@ (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.factorial.?
                                    ...
                                    (=>
                                     (= tmp%14 (= (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.product_of_multiples.?
                                        (I a!) (I n!)
                                       ) (nClip (Mul curr_pow@ (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.factorial.?
                                          (I n!)
                                     )))))
                                     (and
                                      (=>
