...
;; curve25519-dalek/src/lemmas/edwards_lemmas/straus_lemmas.rs:235:1: 241:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::straus_lemmas::lemma_naf_select_is_signed_scalar_mul_projective
;; curve25519-dalek/src/lemmas/edwards_lemmas/straus_lemmas.rs:235:1: 241:2 (#0)
...
(push)
 ...
 (declare-const tmp%7 curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.)
 ...
 (assert
  (forall ((j$ Poly)) (!
    ...
    :qid user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_naf_select_is_signed_scalar_mul_projective_66
    :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_naf_select_is_signed_scalar_mul_projective_66
 )))
 (assert
  (=>
   is_add!
    ...
    (or
     (and
      ...
      (=>
       (not is_add!)
       (=>
        (= abs_digit@ (Sub 0 digit!))
        (=>
         (= j$1@ (EucDiv abs_digit@ 2))
         (=>
          (= tmp%4 (let
            ((tmp%%$ j$1@))
            (and
          ...
          (and
           ...
           (=>
            tmp%4
            (=>
             (= tmp%5 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.projective_niels_point_as_affine_edwards.?
                 (vstd!seq.Seq.index.? $ TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
                  (vstd!view.View.view.? $ (ARRAY $ TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
                    $ (CONST_INT 8)
                   ) (Poly%array%. table!)
             ...
             (and
              ...
              (=>
               tmp%5
               (=>
                (= tmp%6 (= (nClip (Add (Mul 2 j$1@) 1)) (nClip abs_digit@)))
                (and
                 (=>
                  %%location_label%%5
                  tmp%6
                 ...
                 (=>
                  tmp%6
                  (=>
                   (= tmp%7 (%Poly%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
                     (vstd!seq.Seq.index.? $ TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
                      (vstd!view.View.view.? $ (ARRAY $ TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
                        $ (CONST_INT 8)
                       ) (Poly%array%. table!)
                   ...
                   (=>
                    ...
                    (=>
                     (= tmp%8 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.projective_niels_point_as_affine_edwards.?
                         (Poly%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint. (curve25519_dalek!specs.edwards_specs.negate_projective_niels.?
                           (vstd!seq.Seq.index.? $ TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
                            (vstd!view.View.view.? $ (ARRAY $ TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
                              $ (CONST_INT 8)
