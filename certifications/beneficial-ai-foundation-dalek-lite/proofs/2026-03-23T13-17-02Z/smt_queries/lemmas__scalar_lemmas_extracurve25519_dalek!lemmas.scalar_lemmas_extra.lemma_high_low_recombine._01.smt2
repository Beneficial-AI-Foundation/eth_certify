...
;; curve25519-dalek/src/lemmas/scalar_lemmas_extra.rs:510:1: 521:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::scalar_lemmas_extra::lemma_high_low_recombine
;; curve25519-dalek/src/lemmas/scalar_lemmas_extra.rs:510:1: 521:2 (#0)
...
(push)
 ...
 (declare-const w4_low! Int)
 (declare-const w4_high! Int)
 (assert
  fuel_defaults
 )
 (assert
 ...
 (assert
  (not (=>
    (ens%vstd!arithmetic.power2.lemma_pow2_adds. 256 4)
    (=>
     (ens%vstd!arithmetic.power2.lemma2_to64. 0)
     (and
      (=>
       (ens%vstd!arithmetic.power2.lemma_pow2_adds. 1 1)
       (=>
        %%location_label%%0
        (= (vstd!arithmetic.power2.pow2.? (I 2)) (nClip (Mul (vstd!arithmetic.power2.pow2.? (
             I 1
            )
       ...
       (and
        ...
        (=>
         ...
         (and
          (=>
           %%location_label%%2
           (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. w4! 16)
          )
          (=>
           (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. w4! 16)
           (=>
            (ens%vstd!arithmetic.power2.lemma_pow2_adds. 260 60)
            (=>
             (ens%vstd!arithmetic.power2.lemma_pow2_adds. 260 124)
             (=>
              (ens%vstd!arithmetic.power2.lemma_pow2_adds. 260 188)
              (=>
