...
;; curve25519-dalek/src/lemmas/lizard_lemmas.rs:384:1: 384:60 (#0)
...
;; Function-Def curve25519_dalek::lemmas::lizard_lemmas::lemma_jacobi_dual_same_edwards
;; curve25519-dalek/src/lemmas/lizard_lemmas.rs:384:1: 384:60 (#0)
...
(push)
 ...
 (declare-const c@ Int)
 (declare-const two_s@ Int)
 (declare-const tc@ Int)
 (assert
  fuel_defaults
 )
 (assert
 ...
 (assert
  (not (=>
    ...
    (=>
     ...
     (=>
      (= c@ (curve25519_dalek!specs.ristretto_specs.spec_sqrt_ad_minus_one.? (I 0)))
      (=>
       (= two_s@ (curve25519_dalek!specs.field_specs.field_mul.? (I 2) (I s!)))
       (=>
        (= tc@ (curve25519_dalek!specs.field_specs.field_mul.? (I t!) (I c@)))
        (and
         (=>
          (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_neg_square_eq.
           s!
          ...
          (=>
           ...
           (=>
            %%location_label%%0
            (= (curve25519_dalek!specs.field_specs.field_square.? (I ns@)) (curve25519_dalek!specs.field_specs.field_square.?
              (I s!)
         )))))
         (=>
          (= (curve25519_dalek!specs.field_specs.field_square.? (I ns@)) (curve25519_dalek!specs.field_specs.field_square.?
          ...
          (and
           (=>
            ...
            (=>
             %%location_label%%1
             (= (curve25519_dalek!specs.field_specs.field_mul.? (I 2) (I ns@)) (curve25519_dalek!specs.field_specs.field_neg.?
               (I two_s@)
           ))))
           (=>
            (= (curve25519_dalek!specs.field_specs.field_mul.? (I 2) (I ns@)) (curve25519_dalek!specs.field_specs.field_neg.?
            ...
            (and
             (=>
              ...
              (=>
               %%location_label%%2
               (= (curve25519_dalek!specs.field_specs.field_mul.? (I nt@) (I c@)) (curve25519_dalek!specs.field_specs.field_neg.?
                 (I tc@)
             ))))
             (=>
              (= (curve25519_dalek!specs.field_specs.field_mul.? (I nt@) (I c@)) (curve25519_dalek!specs.field_specs.field_neg.?
              ...
              (and
               ...
               (=>
                ...
                (and
                 (=>
                  (= tmp%1 (curve25519_dalek!specs.field_specs.field_neg.? (I (curve25519_dalek!specs.field_specs.field_inv.?
                      (I tc@)
                  ))))
                  (=>
                   (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_neg_mul_left.
                   ...
                   (=>
                    ...
                    (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_neg.?
                      ...
                      ) (I (curve25519_dalek!specs.field_specs.field_neg.? (I (curve25519_dalek!specs.field_specs.field_inv.?
                          (I tc@)
                      ))))
                     ) (curve25519_dalek!specs.field_specs.field_neg.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                        (I two_s@) (I (curve25519_dalek!specs.field_specs.field_neg.? (I (curve25519_dalek!specs.field_specs.field_inv.?
                            (I tc@)
                 )))))))))))
                 (=>
                  (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_neg.?
                  ...
                  (and
                   (=>
                    (= tmp%2 (curve25519_dalek!specs.field_specs.field_inv.? (I tc@)))
                    (=>
                     (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_neg.
                      two_s@ tmp%2
                     )
                     (=>
                      %%location_label%%5
                      (= (curve25519_dalek!specs.field_specs.field_mul.? (I two_s@) (I (curve25519_dalek!specs.field_specs.field_neg.?
                          (I (curve25519_dalek!specs.field_specs.field_inv.? (I tc@)))
                        ))
                       ) (curve25519_dalek!specs.field_specs.field_neg.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                          (I two_s@) (I (curve25519_dalek!specs.field_specs.field_inv.? (I tc@)))
                   )))))))
                   (=>
                    (= (curve25519_dalek!specs.field_specs.field_mul.? (I two_s@) (I (curve25519_dalek!specs.field_specs.field_neg.?
                        (I (curve25519_dalek!specs.field_specs.field_inv.? (I tc@)))
                    ...
                    (and
                     (=>
                      (= tmp%3 (curve25519_dalek!specs.field_specs.field_mul.? (I two_s@) (I (curve25519_dalek!specs.field_specs.field_inv.?
                          (I tc@)
                      ))))
                      (=>
                       (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_neg_neg.
                       ...
                       (=>
                        %%location_label%%6
                        (= (curve25519_dalek!specs.field_specs.field_neg.? (I (curve25519_dalek!specs.field_specs.field_neg.?
                            (I (curve25519_dalek!specs.field_specs.field_mul.? (I two_s@) (I (curve25519_dalek!specs.field_specs.field_inv.?
                                (I tc@)
                          ))))))
                         ) (EucMod (curve25519_dalek!specs.field_specs.field_mul.? (I two_s@) (I (curve25519_dalek!specs.field_specs.field_inv.?
                             (I tc@)
                           ))
                          ) (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
                     )))))
                     (=>
                      ...
                      (and
                       (=>
                        ...
                        (=>
                         (= tmp%4 (nClip (Mul two_s@ (curve25519_dalek!specs.field_specs.field_inv.? (I tc@)))))
                         (=>
                          (= tmp%5 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                          (and
                           (=>
                            %%location_label%%7
                            (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%4 tmp%5)
                           )
                           (=>
                            (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%4 tmp%5)
                            (=>
                             %%location_label%%8
                             (< (curve25519_dalek!specs.field_specs.field_mul.? (I two_s@) (I (curve25519_dalek!specs.field_specs.field_inv.?
                                 (I tc@)
                               ))
                              ) (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
                       )))))))
                       (=>
                        ...
                        (=>
                         (= tmp%6 (curve25519_dalek!specs.field_specs.field_mul.? (I two_s@) (I (curve25519_dalek!specs.field_specs.field_inv.?
                             (I tc@)
                         ))))
                         (=>
                          ...
                          (and
                           ...
                           (=>
                            ...
                            (=>
                             (= tmp%8 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.lizard_specs.jacobi_to_edwards_affine.?
                                 (I ns@) (I nt@)
                                )
                               ) (Poly%tuple%2. (curve25519_dalek!specs.lizard_specs.jacobi_to_edwards_affine.? (I
                                  s!
                                 ) (I t!)
                             ))))
                             (and
                              ...
                              (=>
                               ...
                               (=>
                                %%location_label%%11
                                (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.lizard_specs.jacobi_to_edwards_affine.?
                                   (I (curve25519_dalek!specs.field_specs.field_neg.? (I s!))) (I (curve25519_dalek!specs.field_specs.field_neg.?
                                     (I t!)
                                  )))
                                 ) (Poly%tuple%2. (curve25519_dalek!specs.lizard_specs.jacobi_to_edwards_affine.? (I
                                    s!
