...
;; curve25519-dalek/src/lemmas/edwards_lemmas/mul_base_lemmas.rs:449:1: 449:81 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::mul_base_lemmas::lemma_odd_sum_up_to_correct
;; curve25519-dalek/src/lemmas/edwards_lemmas/mul_base_lemmas.rs:449:1: 449:81 (#0)
  ...
  (not (=>
    ...
    (or
          ...
          (=>
           ...
           (and
            ...
            (=>
             tmp%1
             (=>
              (= tmp%2 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.odd_sum_up_to.?
                  ...
                  (and
                   ...
                   (=>
                    ...
                    (=>
                     (fuel_bool fuel%curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.odd_sum_up_to.)
                     (=>
                      (= prev_full@ (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.odd_sum_up_to.?
                        (Poly%vstd!seq.Seq<i8.>. digits!) (I idx@) (Poly%tuple%2. B!)
                      ))
                      (=>
                       (= base@ (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2. B!)
                       ...
                       (=>
                        (= term@ (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul_signed.? (Poly%tuple%2.
                           base@
                          ) (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I idx@))
                        ))
                        (=>
                         (= tmp%5 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.odd_sum_up_to.?
                             (Poly%vstd!seq.Seq<i8.>. digits!) (I upper@) (Poly%tuple%2. B!)
                              ...
                              (%Poly%tuple%2. (Poly%tuple%2. prev_full@))
                             ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. prev_full@))) (tuple%2./tuple%2/0
                              (%Poly%tuple%2. (Poly%tuple%2. term@))
                             ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. term@)))
                         ))))
                         (and
                          ...
                          (=>
                           ...
                           (=>
                            (fuel_bool fuel%curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.odd_sum_up_to.)
                            (=>
                             (= tmp%6 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. prev_full@) (Poly%tuple%2.
                                (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.odd_sum_up_to.? (Poly%vstd!seq.Seq<i8.>.
                                  digits!
                                 ) (I prev_u@) (Poly%tuple%2. B!)
                             ))))
                             (and
                              (=>
                               %%location_label%%7
                               ...
                               (=>
                                ...
                                (and
                                 ...
                                 (=>
                                  tmp%7
                                  (=>
                                   (= prev@ (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.odd_sum_up_to.? (Poly%vstd!seq.Seq<i8.>.
                                      digits!
                                     ) (I (nClip (Mul 2 nm1@))) (Poly%tuple%2. B!)
                                   ))
                                   (=>
                                    (= tmp%8 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. prev_full@) (Poly%tuple%2.
                                       prev@
                                    )))
                                    (and
                                     (=>
                                        ...
                                        (=>
                                         ...
                                         (and
                                          (=>
                                           (fuel_bool fuel%curve25519_dalek!specs.edwards_specs.pow256.)
                                           (=>
                                            (= tmp%10 (nClip (Mul 8 nm1@)))
                                            (=>
                                             (ens%vstd!arithmetic.power2.lemma_pow2_pos. tmp%10)
                                             (=>
                                              %%location_label%%11
                                          ...
                                          (=>
                                           (> (curve25519_dalek!specs.edwards_specs.pow256.? (I nm1@)) 0)
                                           (=>
                                            (= tmp%11 (curve25519_dalek!specs.edwards_specs.pow256.? (I nm1@)))
                                            (=>
                                             (= tmp%12 (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I idx@))))
                                             (and
                                              (=>
                                               %%location_label%%12
                                               (req%curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.lemma_edwards_scalar_mul_signed_of_scalar_mul.
                                              ...
                                              (=>
                                               ...
                                               (=>
                                                (= tmp%13 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. term@) (Poly%tuple%2.
                                                   (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul_signed.? (Poly%tuple%2. B!)
                                                    (I (Mul (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I idx@)))
                                                ...
                                                (and
                                                 ...
                                                 (=>
                                                  tmp%13
                                                  (=>
                                                   (= tmp%14 (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_odd_scalar.?
                                                     (Poly%vstd!seq.Seq<i8.>. digits!) (I nm1@)
                                                   ))
                                                   (=>
                                                    (= tmp%15 (Mul (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!)
                                                        (I idx@)
                                                       )
                                                      ) (curve25519_dalek!specs.edwards_specs.pow256.? (I nm1@))
                                                    ))
                                                    (=>
                                                     ...
                                                     (=>
                                                      (= tmp%16 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_add.?
                                                          (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. prev_full@))) (tuple%2./tuple%2/1
                                                           (%Poly%tuple%2. (Poly%tuple%2. prev_full@))
                                                          ...
                                                          (Poly%tuple%2. B!) (I (Add (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_odd_scalar.?
                                                             (Poly%vstd!seq.Seq<i8.>. digits!) (I nm1@)
                                                            ) (Mul (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I idx@)))
                                                             (curve25519_dalek!specs.edwards_specs.pow256.? (I nm1@))
                                                      )))))))
                                                      (and
                                                       (=>
     ...
     (and
      ...
      (=>
       %%location_label%%17
       (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.odd_sum_up_to.?
          (Poly%vstd!seq.Seq<i8.>. digits!) (I (nClip (Mul 2 n!))) (Poly%tuple%2. B!)
         )
        ) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul_signed.?
          (Poly%tuple%2. B!) (I (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_odd_scalar.?
