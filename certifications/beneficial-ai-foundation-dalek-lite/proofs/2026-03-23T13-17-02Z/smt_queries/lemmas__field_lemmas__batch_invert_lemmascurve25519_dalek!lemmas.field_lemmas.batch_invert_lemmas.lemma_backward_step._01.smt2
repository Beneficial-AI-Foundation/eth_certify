...
;; MODULE 'module lemmas::field_lemmas::batch_invert_lemmas'
;; curve25519-dalek/src/lemmas/field_lemmas/batch_invert_lemmas.rs:132:1: 132:94 (#0)
...
(assert
 (distinct fuel%vstd!arithmetic.div_mod.lemma_mod_bound. fuel%vstd!arithmetic.power2.lemma_pow2_pos.
  ...
  fuel%vstd!view.impl&%32.view. fuel%curve25519_dalek!specs.core_specs.u8_32_as_nat.
  fuel%curve25519_dalek!specs.core_specs.u8_32_as_nat_rec. fuel%curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.
  fuel%curve25519_dalek!specs.field_specs.field_mul. fuel%curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.
  fuel%curve25519_dalek!specs.field_specs.partial_product_nonzeros. fuel%curve25519_dalek!specs.field_specs_u64.p.
  ...
  fuel%curve25519_dalek!specs.field_specs_u64.spec_reduce. fuel%curve25519_dalek!core_assumes.seq_to_array_32.
...
(assert
 (=>
  ...
  (forall ((e! Poly)) (!
    ...
    :pattern ((vstd!arithmetic.power2.pow2.? e!))
    :qid user_vstd__arithmetic__power2__lemma_pow2_pos_19
    :skolemid skolem_user_vstd__arithmetic__power2__lemma_pow2_pos_19
))))
   ...
   (= (req%curve25519_dalek!lemmas.common_lemmas.to_nat_lemmas.lemma_suffix_zero_when_bytes_zero.
     ...
     (=>
      ...
      (forall ((i$ Poly)) (!
        ...
        :qid user_curve25519_dalek__lemmas__common_lemmas__to_nat_lemmas__lemma_suffix_zero_when_bytes_zero_20
        :skolemid skolem_user_curve25519_dalek__lemmas__common_lemmas__to_nat_lemmas__lemma_suffix_zero_when_bytes_zero_20
   )))))
...
;; Function-Specs curve25519_dalek::lemmas::field_lemmas::batch_invert_lemmas::lemma_nat_zero_implies_all_zero_bytes
(declare-fun req%curve25519_dalek!lemmas.field_lemmas.batch_invert_lemmas.lemma_nat_zero_implies_all_zero_bytes.
 (%%Function%%) Bool
)
(declare-const %%global_location_label%%13 Bool)
(assert
 (forall ((bytes! %%Function%%)) (!
   (= (req%curve25519_dalek!lemmas.field_lemmas.batch_invert_lemmas.lemma_nat_zero_implies_all_zero_bytes.
     bytes!
    ) (=>
     %%global_location_label%%13
     (= (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. bytes!)) 0)
   ))
   :pattern ((req%curve25519_dalek!lemmas.field_lemmas.batch_invert_lemmas.lemma_nat_zero_implies_all_zero_bytes.
     bytes!
   ))
   :qid internal_req__curve25519_dalek!lemmas.field_lemmas.batch_invert_lemmas.lemma_nat_zero_implies_all_zero_bytes._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.field_lemmas.batch_invert_lemmas.lemma_nat_zero_implies_all_zero_bytes._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.field_lemmas.batch_invert_lemmas.lemma_nat_zero_implies_all_zero_bytes.
 (%%Function%%) Bool
)
(assert
 (forall ((bytes! %%Function%%)) (!
   (= (ens%curve25519_dalek!lemmas.field_lemmas.batch_invert_lemmas.lemma_nat_zero_implies_all_zero_bytes.
     bytes!
    ) (forall ((i$ Poly)) (!
      (=>
       (has_type i$ INT)
      ...
      :qid user_curve25519_dalek__lemmas__field_lemmas__batch_invert_lemmas__lemma_nat_zero_implies_all_zero_bytes_21
      :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__batch_invert_lemmas__lemma_nat_zero_implies_all_zero_bytes_21
   )))
   :pattern ((ens%curve25519_dalek!lemmas.field_lemmas.batch_invert_lemmas.lemma_nat_zero_implies_all_zero_bytes.
     bytes!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.field_lemmas.batch_invert_lemmas.lemma_nat_zero_implies_all_zero_bytes._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.field_lemmas.batch_invert_lemmas.lemma_nat_zero_implies_all_zero_bytes._definition
)))
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::batch_invert_lemmas::lemma_backward_step
;; curve25519-dalek/src/lemmas/field_lemmas/batch_invert_lemmas.rs:132:1: 132:94 (#0)
(get-info :all-statistics)
(push)
 (declare-const old_acc! Int)
 (declare-const a_i! Int)
 (declare-const fields! vstd!seq.Seq<curve25519_dalek!backend.serial.u64.field.FieldElement51.>.)
 (declare-const i! Int)
 (declare-const tmp%1 Bool)
 (declare-const pp_i@ Int)
 (declare-const pp_i1@ Int)
 (assert
  fuel_defaults
 )
 (assert
 ...
 (assert
  (not (=>
    (= pp_i@ (curve25519_dalek!specs.field_specs.partial_product_nonzeros.? (Poly%vstd!seq.Seq<curve25519_dalek!backend.serial.u64.field.FieldElement51.>.
       fields!
      ) (I i!)
    ))
    (=>
     (= pp_i1@ (curve25519_dalek!specs.field_specs.partial_product_nonzeros.? (Poly%vstd!seq.Seq<curve25519_dalek!backend.serial.u64.field.FieldElement51.>.
        fields!
       ) (I (Add i! 1))
     ))
     (=>
      (= tmp%1 (= pp_i1@ (curve25519_dalek!specs.field_specs.field_mul.? (I pp_i@) (I a_i!))))
      (and
       (=>
        %%location_label%%0
        tmp%1
