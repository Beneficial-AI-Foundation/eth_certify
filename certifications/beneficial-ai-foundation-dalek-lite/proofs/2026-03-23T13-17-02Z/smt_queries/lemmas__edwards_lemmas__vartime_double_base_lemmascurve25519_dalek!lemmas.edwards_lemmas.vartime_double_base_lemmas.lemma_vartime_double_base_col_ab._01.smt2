...
;; MODULE 'module lemmas::edwards_lemmas::vartime_double_base_lemmas'
;; curve25519-dalek/src/lemmas/edwards_lemmas/vartime_double_base_lemmas.rs:87:1: 93:2 (#0)
...
(assert
 (distinct fuel%vstd!array.array_view. fuel%vstd!array.impl&%0.view. fuel%vstd!array.impl&%2.spec_index.
  ...
  fuel%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.straus_column_sum. fuel%curve25519_dalek!lemmas.edwards_lemmas.vartime_double_base_lemmas.vartime_double_base_shared_input_valid.
  ...
  fuel%curve25519_dalek!specs.field_specs_u64.u64_5_as_nat. fuel%curve25519_dalek!specs.scalar_specs.is_valid_naf.
  ...
  (forall ((niels! Poly)) (!
    (= (curve25519_dalek!specs.edwards_specs.is_valid_projective_niels_point.? niels!)
     (exists ((point$ Poly)) (!
       ...
       :qid user_curve25519_dalek__specs__edwards_specs__is_valid_projective_niels_point_23
       :skolemid skolem_user_curve25519_dalek__specs__edwards_specs__is_valid_projective_niels_point_23
    )))
         ...
         (let
          ...
          (and
           ...
           (forall ((j$ Int)) (!
             ...
             :qid user_curve25519_dalek__specs__scalar_specs__is_valid_naf_24
             :skolemid skolem_user_curve25519_dalek__specs__scalar_specs__is_valid_naf_24
       ))))))
       :pattern ((vstd!seq.Seq.index.? $ (SINT 8) naf! i$))
       :qid user_curve25519_dalek__specs__scalar_specs__is_valid_naf_25
       :skolemid skolem_user_curve25519_dalek__specs__scalar_specs__is_valid_naf_25
    )))
  ...
  (forall ((table! Poly) (A! Poly)) (!
    (= (curve25519_dalek!specs.window_specs.is_valid_naf_lookup_table5_projective.? table!
      A!
       ...
       :qid user_curve25519_dalek__specs__window_specs__is_valid_naf_lookup_table5_projective_26
       :skolemid skolem_user_curve25519_dalek__specs__window_specs__is_valid_naf_lookup_table5_projective_26
    )))
  ...
  (forall ((table! Poly)) (!
    (= (curve25519_dalek!specs.window_specs.naf_lookup_table5_projective_limbs_bounded.?
      table!
       ...
       :qid user_curve25519_dalek__specs__window_specs__naf_lookup_table5_projective_limbs_bounded_27
       :skolemid skolem_user_curve25519_dalek__specs__window_specs__naf_lookup_table5_projective_limbs_bounded_27
    )))
  ...
  (forall ((A_affine! Poly) (B_affine! Poly) (pts_affine! Poly) (a_naf! Poly) (b_naf!
    ...
    (= (curve25519_dalek!lemmas.edwards_lemmas.vartime_double_base_lemmas.vartime_double_base_shared_input_valid.?
      ...
      (forall ((j$ Poly)) (!
        ...
        :qid user_curve25519_dalek__lemmas__edwards_lemmas__vartime_double_base_lemmas__vartime_double_base_shared_input_valid_28
        :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__vartime_double_base_lemmas__vartime_double_base_shared_input_valid_28
    ))))
   ...
   (= (req%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_column_sum_prefix_eq.
     ...
     (=>
      ...
      (forall ((k$ Poly)) (!
        ...
        :qid user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_column_sum_prefix_eq_29
        :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_column_sum_prefix_eq_29
     )))
     (=>
      ...
      (forall ((k$ Poly)) (!
        ...
        :qid user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_column_sum_prefix_eq_30
        :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_column_sum_prefix_eq_30
   )))))
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::vartime_double_base_lemmas::lemma_vartime_double_base_col_ab
;; curve25519-dalek/src/lemmas/edwards_lemmas/vartime_double_base_lemmas.rs:87:1: 93:2 (#0)
(get-info :all-statistics)
(push)
 (declare-const pts_affine! vstd!seq.Seq<tuple%2<nat./nat.>.>.)
 (declare-const nafs! vstd!seq.Seq<vstd!seq.Seq<i8.>.>.)
 (declare-const B_affine! tuple%2.)
 (declare-const b_naf! vstd!seq.Seq<i8.>.)
 (declare-const i! Int)
 (assert
  fuel_defaults
 )
 (assert
  (has_type (Poly%tuple%2. B_affine!) (TYPE%tuple%2. $ NAT $ NAT))
 )
 (assert
  (let
   ((tmp%%$ i!))
    ...
    (=>
     ...
     (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.straus_column_sum.?
        (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. pts_affine!) (Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>.
         ...
         (%Poly%tuple%2. (Poly%tuple%2. (curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.straus_column_sum.?
            (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. pts_affine!) (Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>.
             nafs!
            ) (I i!) (I 1)
         )))
