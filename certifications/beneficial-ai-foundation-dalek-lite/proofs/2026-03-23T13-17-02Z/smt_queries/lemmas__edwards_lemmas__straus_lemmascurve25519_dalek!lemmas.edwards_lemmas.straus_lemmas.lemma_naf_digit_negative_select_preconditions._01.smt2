...
;; curve25519-dalek/src/lemmas/edwards_lemmas/straus_lemmas.rs:556:5: 556:11 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::straus_lemmas::lemma_naf_digit_negative_select_preconditions
;; curve25519-dalek/src/lemmas/edwards_lemmas/straus_lemmas.rs:556:5: 556:11 (#0)
...
(assert
 (bvsgt digit! ((_ sign_extend 3) (_ bv16 5)))
)
(assert
 (not (= (let
