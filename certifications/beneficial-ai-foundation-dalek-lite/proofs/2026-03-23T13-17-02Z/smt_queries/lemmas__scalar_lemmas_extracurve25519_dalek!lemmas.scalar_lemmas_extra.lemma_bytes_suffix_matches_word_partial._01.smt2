...
;; curve25519-dalek/src/lemmas/scalar_lemmas_extra.rs:215:9: 215:15 (#0)
...
;; Function-Def curve25519_dalek::lemmas::scalar_lemmas_extra::lemma_bytes_suffix_matches_word_partial
;; curve25519-dalek/src/lemmas/scalar_lemmas_extra.rs:215:9: 215:15 (#0)
(set-option :smt.arith.solver 6)
(get-info :all-statistics)
(push)
 (declare-const bytes! %%Function%%)
 (declare-const word_idx! Int)
 (declare-const upto! Int)
 (declare-const tmp%1 Bool)
 (declare-const tmp%2 Int)
 (declare-const tmp%3 Int)
 (declare-const prev@ Int)
 (declare-const partial_prev@ Int)
 (declare-const byte_val@ Int)
 (declare-const base@ Int)
 (declare-const pow_base@ Int)
 ...
 (assert
  (not (=>
    %%location_label%%0
    (= (nClip (Mul byte_val@ (nClip (Mul pow_base@ (vstd!arithmetic.power2.pow2.? (I (nClip (
             Mul prev@ 8
      )))))))
     ) (nClip (Mul (nClip (Mul pow_base@ byte_val@)) (vstd!arithmetic.power2.pow2.? (I (nClip
          (Mul prev@ 8)
 )))))))))
 (get-info :version)
