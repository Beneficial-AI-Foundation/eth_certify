...
;; MODULE 'module lemmas::ristretto_lemmas::elligator_lemmas'
;; curve25519-dalek/src/lemmas/ristretto_lemmas/elligator_lemmas.rs:28:1: 35:2 (#0)
...
(assert
 (distinct fuel%vstd!array.array_view. fuel%vstd!array.impl&%0.view. fuel%vstd!array.impl&%2.spec_index.
  ...
  fuel%vstd!view.impl&%22.view. fuel%vstd!view.impl&%26.view. fuel%vstd!view.impl&%46.view.
  ...
  fuel%curve25519_dalek!backend.serial.u64.constants.EDWARDS_D. fuel%curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.
  ...
  fuel%curve25519_dalek!specs.ristretto_specs.spec_sqrt_ad_minus_one. fuel%curve25519_dalek!specs.ristretto_specs.elligator_intermediates.
...
;; Function-Specs curve25519_dalek::lemmas::ristretto_lemmas::elligator_lemmas::lemma_elligator_nonzero_denominators
(declare-fun req%curve25519_dalek!lemmas.ristretto_lemmas.elligator_lemmas.lemma_elligator_nonzero_denominators.
...
(assert
 (forall ((z_completed! Int) (t_completed! Int) (r_0! Int) (s_nat! Int) (n_t_nat! Int)
   (d_val_nat! Int)
  ) (!
   (= (req%curve25519_dalek!lemmas.ristretto_lemmas.elligator_lemmas.lemma_elligator_nonzero_denominators.
     z_completed! t_completed! r_0! s_nat! n_t_nat! d_val_nat!
    ) (and
     (=>
     ...
     (=>
      ...
      (< n_t_nat! (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
     )
     (=>
      %%global_location_label%%10
      (= t_completed! (curve25519_dalek!specs.field_specs.field_add.? (I 1) (I (curve25519_dalek!specs.field_specs.field_square.?
          (I s_nat!)
     )))))
     (=>
      %%global_location_label%%11
      (= z_completed! (curve25519_dalek!specs.field_specs.field_mul.? (I n_t_nat!) (I (curve25519_dalek!specs.ristretto_specs.spec_sqrt_ad_minus_one.?
          (I 0)
     )))))
     (=>
   ...
   :pattern ((req%curve25519_dalek!lemmas.ristretto_lemmas.elligator_lemmas.lemma_elligator_nonzero_denominators.
     z_completed! t_completed! r_0! s_nat! n_t_nat! d_val_nat!
   ))
   :qid internal_req__curve25519_dalek!lemmas.ristretto_lemmas.elligator_lemmas.lemma_elligator_nonzero_denominators._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.ristretto_lemmas.elligator_lemmas.lemma_elligator_nonzero_denominators._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.ristretto_lemmas.elligator_lemmas.lemma_elligator_nonzero_denominators.
 (Int Int Int Int Int Int) Bool
)
(assert
 (forall ((z_completed! Int) (t_completed! Int) (r_0! Int) (s_nat! Int) (n_t_nat! Int)
   ...
   (= (ens%curve25519_dalek!lemmas.ristretto_lemmas.elligator_lemmas.lemma_elligator_nonzero_denominators.
     z_completed! t_completed! r_0! s_nat! n_t_nat! d_val_nat!
    ) (and
     (not (= z_completed! 0))
     (not (= t_completed! 0))
   ))
   :pattern ((ens%curve25519_dalek!lemmas.ristretto_lemmas.elligator_lemmas.lemma_elligator_nonzero_denominators.
     z_completed! t_completed! r_0! s_nat! n_t_nat! d_val_nat!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.ristretto_lemmas.elligator_lemmas.lemma_elligator_nonzero_denominators._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.ristretto_lemmas.elligator_lemmas.lemma_elligator_nonzero_denominators._definition
)))

;; Function-Def curve25519_dalek::lemmas::ristretto_lemmas::elligator_lemmas::lemma_elligator_nonzero_denominators
;; curve25519-dalek/src/lemmas/ristretto_lemmas/elligator_lemmas.rs:28:1: 35:2 (#0)
(get-info :all-statistics)
(push)
 (declare-const z_completed! Int)
 (declare-const t_completed! Int)
    ...
    (=>
     ...
     (and
      (=>
       ...
       (=>
        (= tmp%1 (curve25519_dalek!specs.ristretto_specs.spec_sqrt_ad_minus_one.? (I 0)))
        (and
         (=>
          %%location_label%%2
          (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_nonzero_product.
