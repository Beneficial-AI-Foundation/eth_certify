...
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_ratio_lemmas.rs:925:7: 925:46 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::sqrt_ratio_lemmas::lemma_zero_is_sqrt_ratio
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_ratio_lemmas.rs:925:7: 925:46 (#0)
    ...
    (=>
     ...
     (and
      ...
      (=>
       ...
       (and
        (=>
         (ens%vstd!arithmetic.mul.lemma_mul_basics. v_nat!)
         (=>
          %%location_label%%1
          (= (nClip (Mul (nClip (Mul 0 0)) v_nat!)) 0)
        ))
        (=>
         (= (nClip (Mul (nClip (Mul 0 0)) v_nat!)) 0)
         (=>
