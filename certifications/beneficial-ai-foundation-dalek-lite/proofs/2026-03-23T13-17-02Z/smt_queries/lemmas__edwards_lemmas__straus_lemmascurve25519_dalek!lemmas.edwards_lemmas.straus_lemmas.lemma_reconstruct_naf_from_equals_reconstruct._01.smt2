...
;; curve25519-dalek/src/lemmas/edwards_lemmas/straus_lemmas.rs:1211:1: 1211:73 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::straus_lemmas::lemma_reconstruct_naf_from_equals_reconstruct
;; curve25519-dalek/src/lemmas/edwards_lemmas/straus_lemmas.rs:1211:1: 1211:73 (#0)
    ...
    (=>
     ...
     (=>
      (= tmp%1 (ext_eq false (TYPE%vstd!seq.Seq. $ (SINT 8)) (vstd!seq.Seq.subrange.? $ (SINT
          8
         ) (Poly%vstd!seq.Seq<i8.>. naf!) (I 0) (I 256)
        ) (Poly%vstd!seq.Seq<i8.>. naf!)
      ))
      (and
       (=>
