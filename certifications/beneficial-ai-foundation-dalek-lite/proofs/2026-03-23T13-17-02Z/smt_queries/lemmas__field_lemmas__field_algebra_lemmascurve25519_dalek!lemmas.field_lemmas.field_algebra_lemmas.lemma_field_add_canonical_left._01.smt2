...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:233:1: 233:60 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_field_add_canonical_left
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:233:1: 233:60 (#0)
  ...
  (not (=>
    ...
    (=>
     ...
     (and
      (=>
       %%location_label%%0
       (req%vstd!arithmetic.div_mod.lemma_mod_bound. a! m@)
      )
      (=>
       (ens%vstd!arithmetic.div_mod.lemma_mod_bound. a! m@)
       (=>
        (= tmp%1 (EucMod a! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))))
        (=>
         ...
         (and
          ...
          (=>
           ...
           (and
            (=>
             %%location_label%%2
             (req%vstd!arithmetic.div_mod.lemma_add_mod_noop. a! b! m@)
            )
            (=>
             (ens%vstd!arithmetic.div_mod.lemma_add_mod_noop. a! b! m@)
             (=>
              (= tmp%3 (EucMod a! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))))
              (and
               (=>
                %%location_label%%3
                (req%vstd!arithmetic.div_mod.lemma_add_mod_noop. tmp%3 b! m@)
               )
               (=>
                (ens%vstd!arithmetic.div_mod.lemma_add_mod_noop. tmp%3 b! m@)
                (=>
                 %%location_label%%4
                 (= (curve25519_dalek!specs.field_specs.field_add.? (I (EucMod a! (curve25519_dalek!specs.field_specs_u64.p.?
                      (I 0)
