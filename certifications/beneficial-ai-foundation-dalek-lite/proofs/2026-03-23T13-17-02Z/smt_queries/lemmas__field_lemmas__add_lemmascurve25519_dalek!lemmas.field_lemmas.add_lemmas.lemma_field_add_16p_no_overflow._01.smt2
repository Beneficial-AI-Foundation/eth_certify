...
;; curve25519-dalek/src/lemmas/field_lemmas/add_lemmas.rs:64:1: 64:89 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::add_lemmas::lemma_field_add_16p_no_overflow
;; curve25519-dalek/src/lemmas/field_lemmas/add_lemmas.rs:64:1: 64:89 (#0)
    ...
    (=>
     ...
     (and
      (and
       (=>
        %%location_label%%0
        (<= 18014398509481983 (Sub 18446744073709551615 c0@))
       )
       (=>
        (<= (Sub (uClip 64 (bitshl (I 1) (I 54))) 1) (Sub 18446744073709551615 c0@))
        (=>
         %%location_label%%1
         (<= (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64)
              $ (CONST_INT 5)
      ...
      (=>
       ...
       (and
        (and
         (=>
          %%location_label%%2
          (<= 18014398509481983 (Sub 18446744073709551615 c@))
         )
         (=>
          (<= (Sub (uClip 64 (bitshl (I 1) (I 54))) 1) (Sub 18446744073709551615 c@))
          (=>
           %%location_label%%3
           (<= (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64)
                $ (CONST_INT 5)
              ...
              (=>
               ...
               (and
                (and
                 (=>
                  %%location_label%%10
                  (<= 18014398509481984 c0@)
                 )
                 (=>
                  (<= (uClip 64 (bitshl (I 1) (I 54))) c0@)
                  (=>
                   %%location_label%%11
                   (< (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $
                        (CONST_INT 5)
