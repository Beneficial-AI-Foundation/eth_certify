...
;; MODULE 'module lemmas::field_lemmas::pow_chain_lemmas'
;; curve25519-dalek/src/lemmas/field_lemmas/pow_chain_lemmas.rs:87:1: 94:2 (#0)
...
(assert
 (distinct fuel%vstd!arithmetic.div_mod.lemma_mul_mod_noop_general. fuel%vstd!arithmetic.power.lemma_pow_adds.
  fuel%vstd!arithmetic.power.lemma_pow_multiplies. fuel%curve25519_dalek!specs.field_specs_u64.p.
...
(assert
 (=>
  ...
  (forall ((x! Int) (y! Int) (m! Int)) (!
    ...
    :qid user_vstd__arithmetic__div_mod__lemma_mul_mod_noop_general_0
    :skolemid skolem_user_vstd__arithmetic__div_mod__lemma_mul_mod_noop_general_0
))))
...
(assert
 (=>
  ...
  (forall ((b! Poly) (e1! Int) (e2! Int)) (!
    ...
    :qid user_vstd__arithmetic__power__lemma_pow_adds_1
    :skolemid skolem_user_vstd__arithmetic__power__lemma_pow_adds_1
))))
...
(assert
 (=>
  ...
  (forall ((a! Poly) (b! Poly) (c! Poly)) (!
    ...
    :qid user_vstd__arithmetic__power__lemma_pow_multiplies_2
    :skolemid skolem_user_vstd__arithmetic__power__lemma_pow_multiplies_2
))))
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::pow_chain_lemmas::lemma_prove_geometric_mul_step
;; curve25519-dalek/src/lemmas/field_lemmas/pow_chain_lemmas.rs:87:1: 94:2 (#0)
(get-info :all-statistics)
(push)
 (declare-const base! Int)
 (declare-const val_a! Int)
 (declare-const val_b! Int)
 (declare-const val_result! Int)
 (declare-const exp_a! Int)
 (declare-const exp_b! Int)
  ...
  (not (and
    (and
     ...
     (=>
      ...
      (=>
       %%location_label%%1
       (>= (vstd!arithmetic.power.pow.? (I base!) (I exp_a!)) 0)
    )))
    (=>
     (>= (vstd!arithmetic.power.pow.? (I base!) (I exp_a!)) 0)
     (and
      (and
       ...
       (=>
        ...
        (=>
         %%location_label%%3
         (>= (vstd!arithmetic.power.pow.? (I base!) (I exp_b!)) 0)
      )))
      (=>
       (>= (vstd!arithmetic.power.pow.? (I base!) (I exp_b!)) 0)
       (and
        (=>
         ...
         (and
          (=>
           %%location_label%%4
           (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_general. val_a! val_b! tmp%1)
          )
          (=>
           (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_general. val_a! val_b! tmp%1)
           (=>
            %%location_label%%5
            (= (EucMod val_result! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) (EucMod
              (nClip (Mul (EucMod val_a! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) (EucMod
                 val_b! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
               ))
              ) (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
        ))))))
        (=>
         ...
         (=>
          (= tmp%2 (= (EucMod val_result! (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
            (EucMod (nClip (Mul (EucMod (nClip (vstd!arithmetic.power.pow.? (I base!) (I exp_a!)))
                (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
               ) (EucMod (nClip (vstd!arithmetic.power.pow.? (I base!) (I exp_b!))) (curve25519_dalek!specs.field_specs_u64.p.?
                 (I 0)
              )))
             ) (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
          )))
          (and
           ...
           (=>
            ...
            (and
             (=>
              (= tmp%3 (nClip (vstd!arithmetic.power.pow.? (I base!) (I exp_a!))))
              (=>
               (= tmp%4 (nClip (vstd!arithmetic.power.pow.? (I base!) (I exp_b!))))
               (=>
                (= tmp%5 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                (and
                 (=>
                  %%location_label%%7
                  (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_general. tmp%3 tmp%4 tmp%5)
                 )
                 (=>
                  (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_general. tmp%3 tmp%4 tmp%5)
                  (=>
                   %%location_label%%8
                   (= (EucMod val_result! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) (EucMod
                     (nClip (Mul (nClip (vstd!arithmetic.power.pow.? (I base!) (I exp_a!))) (nClip (vstd!arithmetic.power.pow.?
                         (I base!) (I exp_b!)
                      )))
                     ) (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
             ))))))))
             (=>
              ...
              (and
               (=>
                (ens%vstd!arithmetic.power.lemma_pow_adds. base! exp_a! exp_b!)
                (=>
                 %%location_label%%9
                 (= (Mul (vstd!arithmetic.power.pow.? (I base!) (I exp_a!)) (vstd!arithmetic.power.pow.?
                    (I base!) (I exp_b!)
                   )
                  ) (vstd!arithmetic.power.pow.? (I base!) (I (nClip (Add exp_a! exp_b!))))
               )))
               (=>
                (= (Mul (vstd!arithmetic.power.pow.? (I base!) (I exp_a!)) (vstd!arithmetic.power.pow.?
                   (I base!) (I exp_b!)
                 ...
                 (=>
                  ...
                  (and
                   ...
                   (=>
                    ...
                    (=>
                     %%location_label%%11
                     (>= (vstd!arithmetic.power.pow.? (I base!) (I (nClip (Add exp_a! exp_b!)))) 0)
                 ))))
                 (=>
                  (>= (vstd!arithmetic.power.pow.? (I base!) (I (nClip (Add exp_a! exp_b!)))) 0)
                  (=>
                   (= tmp%7 (= (nClip (EucMod (vstd!arithmetic.power.pow.? (I base!) (I (nClip (Add exp_a! exp_b!))))
                       (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
                      )
                     ) (EucMod (nClip (vstd!arithmetic.power.pow.? (I base!) (I (nClip (Add exp_a! exp_b!)))))
                      (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
                   )))
                   (and
                    (=>
                    ...
                    (=>
                     tmp%7
                     (=>
                      (= tmp%8 (= (EucMod val_result! (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                        (EucMod (nClip (Mul (nClip (vstd!arithmetic.power.pow.? (I base!) (I exp_a!))) (nClip
                            (vstd!arithmetic.power.pow.? (I base!) (I exp_b!))
                          ))
                         ) (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
                      )))
                      (and
                       ...
                       (=>
                        tmp%8
                        (=>
                         (= tmp%9 (= (nClip (Mul (nClip (vstd!arithmetic.power.pow.? (I base!) (I exp_a!))) (nClip
                              (vstd!arithmetic.power.pow.? (I base!) (I exp_b!))
                            ))
                           ) (nClip (Mul (vstd!arithmetic.power.pow.? (I base!) (I exp_a!)) (vstd!arithmetic.power.pow.?
                              (I base!) (I exp_b!)
                         )))))
                         (and
                          (=>
                          ...
                          (=>
                           tmp%9
                           (=>
                            (= tmp%10 (= (EucMod val_result! (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                              (EucMod (nClip (vstd!arithmetic.power.pow.? (I base!) (I (nClip (Add exp_a! exp_b!)))))
                               (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
                            )))
                            (and
