...
;; curve25519-dalek/src/lemmas/field_lemmas/load8_lemmas.rs:683:1: 683:70 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::load8_lemmas::lemma_load8_at_limb_base
;; curve25519-dalek/src/lemmas/field_lemmas/load8_lemmas.rs:683:1: 683:70 (#0)
  ...
  (not (and
    (=>
     ...
     (and
      (=>
       %%location_label%%0
       (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_u64_pow2_le_max. 51)
      )
      (=>
       (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_u64_pow2_le_max. 51)
       (=>
        %%location_label%%1
        (let
         ((tmp%%$ (vstd!arithmetic.power2.pow2.? (I 51))))
               ...
               (=>
                ...
                (=>
                 ...
                 (= (uClip 64 (bitand (I (uClip 64 (bitshr (I (uClip 64 (curve25519_dalek!specs.core_specs.spec_load8_at.?
                    ...
                    ) (I (uClip 64 (vstd!bits.low_bits_mask.? (I 51))))
                   )
                  ) (Add (Add (Add (Add (Add (Add (Add (EucMod (EucDiv (uClip 64 (Mul (%I (vstd!seq.Seq.index.?
                               $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $ (UINT 8)) (Poly%slice%<u8.>. input!))
                               (I (Add i! 0))
