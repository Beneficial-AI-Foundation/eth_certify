...
;; curve25519-dalek/src/lemmas/edwards_lemmas/torsion_lemmas.rs:243:1: 243:68 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::torsion_lemmas::lemma_edwards_add_two_torsion_four_torsion
;; curve25519-dalek/src/lemmas/edwards_lemmas/torsion_lemmas.rs:243:1: 243:68 (#0)
           ...
           (and
            (and
             ...
             (=>
              ...
              (=>
               %%location_label%%3
               (= (curve25519_dalek!specs.field_specs.field_mul.? (I 0) (I i_val!)) 0)
            )))
            (=>
             (= (curve25519_dalek!specs.field_specs.field_mul.? (I 0) (I i_val!)) 0)
             (and
                   ...
                   (=>
                    ...
                    (=>
                     ...
                     (and
                      (=>
                       %%location_label%%8
                       (req%vstd!arithmetic.div_mod.lemma_small_mod. i_val! tmp%3)
                      )
                      (=>
                       (ens%vstd!arithmetic.div_mod.lemma_small_mod. i_val! tmp%3)
                       (=>
                        %%location_label%%9
                        (= (curve25519_dalek!specs.field_specs.field_mul.? (I neg1@) (I i_val!)) (curve25519_dalek!specs.field_specs.field_neg.?
                          (I i_val!)
                  ))))))))
                  (=>
                   (= (curve25519_dalek!specs.field_specs.field_mul.? (I neg1@) (I i_val!)) (curve25519_dalek!specs.field_specs.field_neg.?
                   ...
                   (=>
                    (= x1x2@ (curve25519_dalek!specs.field_specs.field_mul.? (I 0) (I i_val!)))
                    (=>
                     (= y1y2@ (curve25519_dalek!specs.field_specs.field_mul.? (I neg1@) (I 0)))
                     (=>
                      (= x1y2@ (curve25519_dalek!specs.field_specs.field_mul.? (I 0) (I 0)))
                      (=>
                       (= y1x2@ (curve25519_dalek!specs.field_specs.field_mul.? (I neg1@) (I i_val!)))
                       (=>
                        (= tmp%4 (and
                          (and
                           (= x1x2@ 0)
                           ...
                           (=>
                            ...
                            (and
                             ...
                             (=>
                              ...
                              (and
                               (=>
                                (= tmp%5 (curve25519_dalek!specs.field_specs.field_neg.? (I i_val!)))
                                (=>
                                 ...
                                 (and
                                  ...
                                  (=>
                                   ...
                                   (=>
                                    %%location_label%%15
                                    (< (curve25519_dalek!specs.field_specs.field_neg.? (I i_val!)) (curve25519_dalek!specs.field_specs_u64.p.?
                                      (I 0)
                               )))))))
                               (=>
                                (< (curve25519_dalek!specs.field_specs.field_neg.? (I i_val!)) (curve25519_dalek!specs.field_specs_u64.p.?
                                ...
                                (=>
                                 (= tmp%7 (curve25519_dalek!specs.field_specs.field_neg.? (I i_val!)))
                                 (=>
                                    ...
                                    (=>
                                     ...
                                     (and
                                      ...
                                      (=>
                                       ...
                                       (and
                                        (=>
                                         (= tmp%10 (curve25519_dalek!specs.field_specs.field_neg.? (I i_val!)))
                                         (=>
                                          (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_one_right.
                                           tmp%10
                                          )
                                          (=>
                                           ...
                                           (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_neg.?
                                            ...
                                            ) (curve25519_dalek!specs.field_specs.field_neg.? (I i_val!))
                                        ))))
                                        (=>
                                         (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_neg.?
                                             (I i_val!)
                                             ...
                                             (=>
                                              ...
                                              (=>
                                               ...
                                               (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_add.?
                                                  (I 0) (I (curve25519_dalek!specs.field_specs.field_neg.? (I 1))) (I i_val!) (I 0)
                                                 )
