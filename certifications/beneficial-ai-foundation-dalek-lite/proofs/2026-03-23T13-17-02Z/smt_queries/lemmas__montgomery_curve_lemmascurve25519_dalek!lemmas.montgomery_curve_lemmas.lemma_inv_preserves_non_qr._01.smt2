...
;; curve25519-dalek/src/lemmas/montgomery_curve_lemmas.rs:754:1: 754:48 (#0)
...
;; Function-Def curve25519_dalek::lemmas::montgomery_curve_lemmas::lemma_inv_preserves_non_qr
;; curve25519-dalek/src/lemmas/montgomery_curve_lemmas.rs:754:1: 754:48 (#0)
...
(push)
  ...
  (forall ((%%hole%%0 Type) (%%hole%%1 Int)) (!
    (=>
     (exists ((y$1 Poly)) (!
       (and
        (has_type y$1 %%hole%%0)
        (= (curve25519_dalek!specs.field_specs.field_mul.? y$1 y$1) %%hole%%1)
       )
       :pattern ((curve25519_dalek!specs.field_specs.field_mul.? y$1 y$1))
       :qid user_curve25519_dalek__lemmas__montgomery_curve_lemmas__lemma_inv_preserves_non_qr_67
       :skolemid skolem_user_curve25519_dalek__lemmas__montgomery_curve_lemmas__lemma_inv_preserves_non_qr_67
     ))
     (exists ((y$1 Poly)) (!
       (and
        (and
 ...
 (assert
  (not (=>
    (= a_mod@ (curve25519_dalek!specs.field_specs_u64.field_canonical.? (I a!)))
    (=>
     (= inv_a@ (curve25519_dalek!specs.field_specs.field_inv.? (I a_mod@)))
     (or
      (and
       (=>
        (curve25519_dalek!specs.field_specs.is_square.? (I inv_a@))
        (=>
         (= y@ (%I (as_type (%%choose%%1 NAT (curve25519_dalek!specs.field_specs_u64.field_canonical.?
              (I inv_a@)
             )
            ) NAT
         )))
          ...
          (=>
           ...
           (and
              ...
              (=>
               ...
               (=>
                ...
                (and
                 (=>
                  %%location_label%%1
                  (req%vstd!arithmetic.div_mod.lemma_small_mod. a_mod@ tmp%2)
                 )
                 (=>
                  (ens%vstd!arithmetic.div_mod.lemma_small_mod. a_mod@ tmp%2)
                  (and
                   (and
                    (=>
                     %%location_label%%2
                     (req%curve25519_dalek!specs.field_specs.field_inv_property. a_mod@)
                    )
                    (=>
                     (ens%curve25519_dalek!specs.field_specs.field_inv_property. a_mod@)
                     (=>
                      %%location_label%%3
                      (< inv_a@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                   )))
                   (=>
                    (< inv_a@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                    (=>
                     ...
                     (and
                      (=>
                       %%location_label%%4
                       (req%vstd!arithmetic.div_mod.lemma_small_mod. inv_a@ tmp%3)
                      )
                      (=>
                       (ens%vstd!arithmetic.div_mod.lemma_small_mod. inv_a@ tmp%3)
                       (=>
                        %%location_label%%5
                        (= y2@ inv_a@)
            ))))))))))))
            (=>
             ...
             (and
              (=>
               (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_inv_of_inv. a_mod@)
               (=>
                (= tmp%4 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                (and
                 (=>
                  %%location_label%%6
                  (req%vstd!arithmetic.div_mod.lemma_mod_bound. a! tmp%4)
                 )
                 (=>
                  (ens%vstd!arithmetic.div_mod.lemma_mod_bound. a! tmp%4)
                  (=>
                   (= tmp%5 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                   (and
                    (=>
                     %%location_label%%7
                     (req%vstd!arithmetic.div_mod.lemma_small_mod. a_mod@ tmp%5)
                    )
                    (=>
                     (ens%vstd!arithmetic.div_mod.lemma_small_mod. a_mod@ tmp%5)
                     (=>
                      %%location_label%%8
                      (= (curve25519_dalek!specs.field_specs.field_inv.? (I y2@)) a_mod@)
              ))))))))
              (=>
               (= (curve25519_dalek!specs.field_specs.field_inv.? (I y2@)) a_mod@)
               (and
                (=>
                 ...
                 (=>
                  %%location_label%%9
                  (= (curve25519_dalek!specs.field_specs.field_inv.? (I y2@)) (curve25519_dalek!specs.field_specs.field_square.?
                    (I (curve25519_dalek!specs.field_specs.field_inv.? (I y@)))
                ))))
                (=>
                 (= (curve25519_dalek!specs.field_specs.field_inv.? (I y2@)) (curve25519_dalek!specs.field_specs.field_square.?
                   (I (curve25519_dalek!specs.field_specs.field_inv.? (I y@)))
                 ...
                 (and
                  (and
                   (=>
                    (= w@ (curve25519_dalek!specs.field_specs.field_inv.? (I y@)))
                    (=>
                     (= tmp%6 (= (curve25519_dalek!specs.field_specs.field_mul.? (I w@) (I w@)) (curve25519_dalek!specs.field_specs.field_square.?
                        (I w@)
                     )))
                     (and
                      (=>
                       ...
                       (and
                        (=>
                         ...
                         (and
                          (=>
                           %%location_label%%11
                           (req%vstd!arithmetic.div_mod.lemma_small_mod. a_mod@ tmp%7)
                          )
                          (=>
                           (ens%vstd!arithmetic.div_mod.lemma_small_mod. a_mod@ tmp%7)
                           (=>
                            %%location_label%%12
                            (= a_mod@ (curve25519_dalek!specs.field_specs_u64.field_canonical.? (I a_mod@)))
                        ))))
                        (=>
                         (= a_mod@ (curve25519_dalek!specs.field_specs_u64.field_canonical.? (I a_mod@)))
                         (=>
                          ...
                          (exists ((w$ Poly)) (!
                            (and
                             (has_type w$ NAT)
                             (= (curve25519_dalek!specs.field_specs.field_mul.? w$ w$) (curve25519_dalek!specs.field_specs_u64.field_canonical.?
                               (I a_mod@)
                            )))
                            :pattern ((curve25519_dalek!specs.field_specs.field_mul.? w$ w$))
                            :qid user_curve25519_dalek__lemmas__montgomery_curve_lemmas__lemma_inv_preserves_non_qr_73
                            :skolemid skolem_user_curve25519_dalek__lemmas__montgomery_curve_lemmas__lemma_inv_preserves_non_qr_73
                   )))))))))
                   (=>
                    (exists ((w$ Poly)) (!
                      (and
                      ...
                      :pattern ((curve25519_dalek!specs.field_specs.field_mul.? w$ w$))
                      :qid user_curve25519_dalek__lemmas__montgomery_curve_lemmas__lemma_inv_preserves_non_qr_74
                      :skolemid skolem_user_curve25519_dalek__lemmas__montgomery_curve_lemmas__lemma_inv_preserves_non_qr_74
                    ))
                    (=>
                     %%location_label%%14
                     (curve25519_dalek!specs.field_specs.is_square.? (I a_mod@))
                  )))
                  (=>
                   (curve25519_dalek!specs.field_specs.is_square.? (I a_mod@))
                   (=>
       ...
       (=>
        (not (curve25519_dalek!specs.field_specs.is_square.? (I inv_a@)))
        %%switch_label%%0
      ))
      (and
       (not %%switch_label%%0)
