...
;; curve25519-dalek/src/lemmas/common_lemmas/div_mod_lemmas.rs:133:1: 133:65 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::div_mod_lemmas::lemma_mul_le_implies_div_le
;; curve25519-dalek/src/lemmas/common_lemmas/div_mod_lemmas.rs:133:1: 133:65 (#0)
 ...
 (assert
  (not (=>
    ...
    (and
     (=>
      %%location_label%%0
      (req%vstd!arithmetic.div_mod.lemma_div_is_ordered. tmp%1 c! b!)
     )
     (=>
      (ens%vstd!arithmetic.div_mod.lemma_div_is_ordered. tmp%1 c! b!)
      (and
       (=>
        %%location_label%%1
        (req%vstd!arithmetic.div_mod.lemma_div_by_multiple. a! b!)
       )
       (=>
        (ens%vstd!arithmetic.div_mod.lemma_div_by_multiple. a! b!)
        (=>
         %%location_label%%2
         (<= a! (EucDiv c! b!))
 ))))))))
