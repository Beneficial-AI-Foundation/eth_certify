...
;; curve25519-dalek/src/lemmas/common_lemmas/mul_lemmas.rs:28:1: 28:62 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::mul_lemmas::lemma_mul_le
;; curve25519-dalek/src/lemmas/common_lemmas/mul_lemmas.rs:28:1: 28:62 (#0)
...
(push)
 ...
 (assert
  (not (and
    (=>
     %%location_label%%0
     (req%vstd!arithmetic.mul.lemma_mul_inequality. a1! b1! a2!)
    )
    (=>
     (ens%vstd!arithmetic.mul.lemma_mul_inequality. a1! b1! a2!)
     (and
      (=>
       %%location_label%%1
       (req%vstd!arithmetic.mul.lemma_mul_inequality. a2! b2! b1!)
      )
      (=>
       (ens%vstd!arithmetic.mul.lemma_mul_inequality. a2! b2! b1!)
       (=>
        %%location_label%%2
        (<= (nClip (Mul a1! a2!)) (nClip (Mul b1! b2!)))
 )))))))
