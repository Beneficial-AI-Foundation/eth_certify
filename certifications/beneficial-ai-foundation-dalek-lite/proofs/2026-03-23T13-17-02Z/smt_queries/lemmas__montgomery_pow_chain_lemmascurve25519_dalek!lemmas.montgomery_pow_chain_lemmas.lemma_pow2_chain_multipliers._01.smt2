...
;; curve25519-dalek/src/lemmas/montgomery_pow_chain_lemmas.rs:571:1: 571:44 (#0)
...
;; Function-Specs curve25519_dalek::lemmas::montgomery_pow_chain_lemmas::lemma_chain_exp_is_l_minus_2
(declare-fun ens%curve25519_dalek!lemmas.montgomery_pow_chain_lemmas.lemma_chain_exp_is_l_minus_2.
 (Int) Bool
)
(assert
 (forall ((no%param Int)) (!
   (= (ens%curve25519_dalek!lemmas.montgomery_pow_chain_lemmas.lemma_chain_exp_is_l_minus_2.
     no%param
    ) (= (curve25519_dalek!lemmas.montgomery_pow_chain_lemmas.montgomery_invert_chain_exponent.?
      (I 0)
     ) (Sub (curve25519_dalek!specs.scalar52_specs.group_order.? (I 0)) 2)
   ))
   :pattern ((ens%curve25519_dalek!lemmas.montgomery_pow_chain_lemmas.lemma_chain_exp_is_l_minus_2.
     no%param
   ))
   :qid internal_ens__curve25519_dalek!lemmas.montgomery_pow_chain_lemmas.lemma_chain_exp_is_l_minus_2._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.montgomery_pow_chain_lemmas.lemma_chain_exp_is_l_minus_2._definition
)))

;; Function-Specs curve25519_dalek::lemmas::montgomery_pow_chain_lemmas::lemma_pow2_chain_multipliers
(declare-fun ens%curve25519_dalek!lemmas.montgomery_pow_chain_lemmas.lemma_pow2_chain_multipliers.
 (Int) Bool
)
(assert
 (forall ((no%param Int)) (!
   (= (ens%curve25519_dalek!lemmas.montgomery_pow_chain_lemmas.lemma_pow2_chain_multipliers.
     no%param
    ) (and
     (= (vstd!arithmetic.power2.pow2.? (I 2)) 4)
     (= (vstd!arithmetic.power2.pow2.? (I 3)) 8)
     ...
     (= (vstd!arithmetic.power2.pow2.? (I 6)) 64)
     (= (vstd!arithmetic.power2.pow2.? (I 10)) 1024)
     (= (vstd!arithmetic.power2.pow2.? (I 126)) 85070591730234615865843651857942052864)
   ))
   :pattern ((ens%curve25519_dalek!lemmas.montgomery_pow_chain_lemmas.lemma_pow2_chain_multipliers.
     no%param
   ))
   :qid internal_ens__curve25519_dalek!lemmas.montgomery_pow_chain_lemmas.lemma_pow2_chain_multipliers._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.montgomery_pow_chain_lemmas.lemma_pow2_chain_multipliers._definition
)))

;; Function-Def curve25519_dalek::lemmas::montgomery_pow_chain_lemmas::lemma_pow2_chain_multipliers
;; curve25519-dalek/src/lemmas/montgomery_pow_chain_lemmas.rs:571:1: 571:44 (#0)
 ...
 (assert
  (not (=>
    ...
    (=>
     ...
     (=>
      (ens%vstd!arithmetic.power2.lemma_pow2_adds. 64 62)
      (and
       (=>
        %%location_label%%0
        (= (vstd!arithmetic.power2.pow2.? (I 2)) 4)
