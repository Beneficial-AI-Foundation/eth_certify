...
;; curve25519-dalek/src/lemmas/common_lemmas/mul_lemmas.rs:199:1: 199:69 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::mul_lemmas::lemma_mul_quad_prod
;; curve25519-dalek/src/lemmas/common_lemmas/mul_lemmas.rs:199:1: 199:69 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= tmp%1 (Mul a1! b1!))
    (=>
     (ens%vstd!arithmetic.mul.lemma_mul_is_associative. tmp%1 a2! b2!)
     (=>
      (ens%vstd!arithmetic.mul.lemma_mul_is_associative. a2! a1! b1!)
      (=>
       (= tmp%2 (Mul a2! a1!))
       (=>
        (ens%vstd!arithmetic.mul.lemma_mul_is_associative. tmp%2 b1! b2!)
        (=>
         %%location_label%%0
         (= (Mul (Mul a1! b1!) (Mul a2! b2!)) (Mul (Mul a1! a2!) (Mul b1! b2!)))
 ))))))))
