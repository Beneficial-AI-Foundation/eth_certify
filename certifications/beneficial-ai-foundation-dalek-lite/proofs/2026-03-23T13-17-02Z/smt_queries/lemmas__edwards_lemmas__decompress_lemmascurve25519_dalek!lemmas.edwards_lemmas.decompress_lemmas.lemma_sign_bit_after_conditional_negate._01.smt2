...
;; curve25519-dalek/src/lemmas/edwards_lemmas/decompress_lemmas.rs:63:1: 63:75 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::decompress_lemmas::lemma_sign_bit_after_conditional_negate
;; curve25519-dalek/src/lemmas/edwards_lemmas/decompress_lemmas.rs:63:1: 63:75 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= pval@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
    (=>
     (= result@ (ite
       (= sign_bit! 1)
       (curve25519_dalek!specs.field_specs.field_neg.? (I x!))
             ...
             (and
              (and
               (and
                (=>
                 %%location_label%%1
                 (req%vstd!arithmetic.div_mod.lemma_small_mod. x! pval@)
                )
                (=>
                 (ens%vstd!arithmetic.div_mod.lemma_small_mod. x! pval@)
                 (=>
                  %%location_label%%2
                  (= x! (curve25519_dalek!specs.field_specs_u64.field_canonical.? (I x!)))
               )))
               (=>
                (= x! (curve25519_dalek!specs.field_specs_u64.field_canonical.? (I x!)))
                (and
                 ...
                 (=>
                  ...
                  (and
                   (=>
                    (= tmp%3 (nClip (Sub pval@ x!)))
                    (and
                     (=>
                      %%location_label%%5
                      (req%vstd!arithmetic.div_mod.lemma_small_mod. tmp%3 pval@)
                     )
                     (=>
                      (ens%vstd!arithmetic.div_mod.lemma_small_mod. tmp%3 pval@)
                      (=>
                       %%location_label%%6
                       (= (EucMod (nClip (Sub pval@ x!)) pval@) (Sub pval@ x!))
                   ))))
                   (=>
                    (= (EucMod (nClip (Sub pval@ x!)) pval@) (Sub pval@ x!))
                    (=>
                     %%location_label%%7
                     (= neg_x@ (nClip (Sub pval@ x!)))
              )))))))
              (=>
               (= neg_x@ (nClip (Sub pval@ x!)))
               (and
                (and
                 (and
                  (=>
                   %%location_label%%8
                   (req%vstd!arithmetic.div_mod.lemma_sub_mod_noop. pval@ x! 2)
                  )
                  (=>
                   (ens%vstd!arithmetic.div_mod.lemma_sub_mod_noop. pval@ x! 2)
                   (=>
                    %%location_label%%9
                    (= (EucMod (Sub pval@ x!) 2) (EucMod (Sub (EucMod pval@ 2) (EucMod x! 2)) 2))
                 )))
                 (=>
                  (= (EucMod (Sub pval@ x!) 2) (EucMod (Sub (EucMod pval@ 2) (EucMod x! 2)) 2))
                  (=>
                   (= tmp%4 (= (EucMod pval@ 2) 1))
                   (and
                    (=>
                     %%location_label%%10
                     tmp%4
