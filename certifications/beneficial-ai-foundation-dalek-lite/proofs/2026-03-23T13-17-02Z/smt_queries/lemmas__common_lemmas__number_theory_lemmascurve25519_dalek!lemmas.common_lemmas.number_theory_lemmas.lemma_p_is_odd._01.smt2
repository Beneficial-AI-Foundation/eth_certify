...
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:2189:1: 2189:30 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::number_theory_lemmas::lemma_p_is_odd
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:2189:1: 2189:30 (#0)
 ...
 (assert
  (not (and
    (and
     (=>
      %%location_label%%0
      (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_even. 255)
     )
     (=>
      (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_even. 255)
      (=>
       %%location_label%%1
       (= (EucMod (vstd!arithmetic.power2.pow2.? (I 255)) 2) 0)
    )))
    (=>
     (= (EucMod (vstd!arithmetic.power2.pow2.? (I 255)) 2) 0)
     (and
      (and
       ...
       (=>
        (= (EucMod 19 2) 1)
        (=>
         (= tmp%1 (vstd!arithmetic.power2.pow2.? (I 255)))
         (and
          (=>
           %%location_label%%3
           (req%vstd!arithmetic.div_mod.lemma_sub_mod_noop. tmp%1 19 2)
          )
          (=>
           (ens%vstd!arithmetic.div_mod.lemma_sub_mod_noop. tmp%1 19 2)
           (and
            (=>
             %%location_label%%4
             true
            ...
            (=>
             ...
             (=>
              %%location_label%%5
              (= (EucMod (Sub (vstd!arithmetic.power2.pow2.? (I 255)) 19) 2) 1)
      ))))))))
      (=>
       (= (EucMod (Sub (vstd!arithmetic.power2.pow2.? (I 255)) 19) 2) 1)
       (and
        (=>
         ...
         (=>
          %%location_label%%6
          (> (vstd!arithmetic.power2.pow2.? (I 255)) 19)
        ))
        (=>
         (> (vstd!arithmetic.power2.pow2.? (I 255)) 19)
         (=>
