...
;; curve25519-dalek/src/lemmas/scalar_byte_lemmas/scalar_to_bytes_lemmas.rs:517:9: 517:15 (#0)
...
;; Function-Def curve25519_dalek::lemmas::scalar_byte_lemmas::scalar_to_bytes_lemmas::lemma_boundary_byte_combines_52
;; curve25519-dalek/src/lemmas/scalar_byte_lemmas/scalar_to_bytes_lemmas.rs:517:9: 517:15 (#0)
...
(push)
 ...
 (assert
  (not (=>
    %%location_label%%0
    (= (Add (Sub (vstd!arithmetic.power2.pow2.? (I k@)) 1) (Mul (Sub (vstd!arithmetic.power2.pow2.?
         (I (nClip (Sub 8 k@)))
        ) 1
       ) (vstd!arithmetic.power2.pow2.? (I k@))
      )
     ) (Sub (nClip (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Sub 8 k@)))) (vstd!arithmetic.power2.pow2.?
         (I k@)
       ))
      ) 1
 )))))
