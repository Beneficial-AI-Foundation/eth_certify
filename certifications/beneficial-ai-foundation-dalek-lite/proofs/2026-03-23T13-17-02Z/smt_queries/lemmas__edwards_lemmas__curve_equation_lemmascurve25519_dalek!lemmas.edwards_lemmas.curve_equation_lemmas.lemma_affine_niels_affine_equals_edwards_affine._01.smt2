...
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:2792:1: 2795:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::curve_equation_lemmas::lemma_affine_niels_affine_equals_edwards_affine
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:2792:1: 2795:2 (#0)
(get-info :all-statistics)
(push)
 (declare-const niels! curve25519_dalek!backend.serial.curve_models.AffineNielsPoint.)
 ...
 (declare-const x_niels@ Int)
 (declare-const y_niels@ Int)
 (assert
  fuel_defaults
 )
 (assert
  (has_type (Poly%curve25519_dalek!backend.serial.curve_models.AffineNielsPoint. niels!)
   TYPE%curve25519_dalek!backend.serial.curve_models.AffineNielsPoint.
 ))
 (assert
 ...
 (assert
  (not (=>
    ...
    (=>
     (= x_proj@ (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
        (curve25519_dalek!edwards.EdwardsPoint./EdwardsPoint/X (%Poly%curve25519_dalek!edwards.EdwardsPoint.
          (Poly%curve25519_dalek!edwards.EdwardsPoint. point!)
     )))))
     (=>
      (= y_proj@ (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
         (curve25519_dalek!edwards.EdwardsPoint./EdwardsPoint/Y (%Poly%curve25519_dalek!edwards.EdwardsPoint.
           (Poly%curve25519_dalek!edwards.EdwardsPoint. point!)
      )))))
      (=>
       (= z_proj@ (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
          (curve25519_dalek!edwards.EdwardsPoint./EdwardsPoint/Z (%Poly%curve25519_dalek!edwards.EdwardsPoint.
            (Poly%curve25519_dalek!edwards.EdwardsPoint. point!)
       )))))
       (=>
         ...
         (=>
          ...
          (=>
           ...
           (=>
            ...
            (=>
             (= tmp%1 (= y_plus_x@ (curve25519_dalek!specs.field_specs.field_add.? (I y@) (I x@))))
             (and
              (=>
               %%location_label%%0
               tmp%1
              ...
              (=>
               tmp%1
               (=>
                (= tmp%2 (= y_minus_x@ (curve25519_dalek!specs.field_specs.field_sub.? (I y@) (I x@))))
                (and
                 (=>
                  %%location_label%%1
                  tmp%2
                 ...
                 (=>
                  ...
                  (=>
                   ...
                   (=>
                    (= x_niels@ (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_sub.?
                        (I y_plus_x@) (I y_minus_x@)
                       )
                      ) (I inv2@)
                    ))
                    (=>
                     (= y_niels@ (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_add.?
                         (I y_plus_x@) (I y_minus_x@)
                        )
                       ) (I inv2@)
                     ))
                      ...
                      (=>
                       ...
                       (and
                        (=>
                         ...
                         (=>
                          (= tmp%3 (curve25519_dalek!specs.field_specs.fe51_as_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                             (curve25519_dalek!edwards.EdwardsPoint./EdwardsPoint/X (%Poly%curve25519_dalek!edwards.EdwardsPoint.
                               (Poly%curve25519_dalek!edwards.EdwardsPoint. point!)
                          )))))
                          (=>
                        ...
                        (=>
                         ...
                         (and
                          (=>
                           (ens%curve25519_dalek!specs.field_specs_u64.p_gt_2. 0)
                           (=>
                            (= tmp%7 (curve25519_dalek!specs.field_specs.fe51_as_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                               (curve25519_dalek!edwards.EdwardsPoint./EdwardsPoint/Y (%Poly%curve25519_dalek!edwards.EdwardsPoint.
                                 (Poly%curve25519_dalek!edwards.EdwardsPoint. point!)
                            )))))
                            (=>
                           ...
                           (and
                            (=>
                             ...
                             (and
                              (=>
                               %%location_label%%9
                               (req%vstd!arithmetic.div_mod.lemma_small_mod. x@ tmp%11)
                              )
                              (=>
                               (ens%vstd!arithmetic.div_mod.lemma_small_mod. x@ tmp%11)
                               (=>
                                %%location_label%%10
                                (= x_niels@ x@)
                            ))))
                             ...
                             (and
                              (=>
                               ...
                               (and
                                (=>
                                 %%location_label%%11
                                 (req%vstd!arithmetic.div_mod.lemma_small_mod. y@ tmp%12)
                                )
                                (=>
                                 (ens%vstd!arithmetic.div_mod.lemma_small_mod. y@ tmp%12)
                                 (=>
                                  %%location_label%%12
                                  (= y_niels@ y@)
                              ))))
