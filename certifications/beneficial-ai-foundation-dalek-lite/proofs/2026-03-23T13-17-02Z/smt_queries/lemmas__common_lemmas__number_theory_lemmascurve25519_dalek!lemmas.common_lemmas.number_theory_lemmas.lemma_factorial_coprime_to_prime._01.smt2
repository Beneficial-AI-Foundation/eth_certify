...
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:2018:7: 2018:62 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::number_theory_lemmas::lemma_factorial_coprime_to_prime
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:2018:7: 2018:62 (#0)
    ...
    (or
     (and
      (=>
       (= n! 0)
       (=>
        (= tmp%1 (= (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.factorial.?
           (I 0)
          ) 1
        ))
        (and
      ...
      (=>
       (not (= n! 0))
       (=>
        (= tmp%2 (= (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.factorial.?
           (I n!)
          ) (nClip (Mul n! (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.factorial.?
             (I (nClip (Sub n! 1)))
        )))))
        (and
         (=>
            ...
            (=>
             ...
             (and
              (and
               (=>
                %%location_label%%5
                (req%vstd!arithmetic.div_mod.lemma_small_mod. n! prime!)
               )
               (=>
                (ens%vstd!arithmetic.div_mod.lemma_small_mod. n! prime!)
                (=>
                 %%location_label%%6
                 (= (EucMod n! prime!) n!)
              )))
                   ...
                   (and
                    ...
                    (and
                     ...
                     (=>
                      ...
                      (=>
                       (= tmp%6 (not (= (EucMod (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.factorial.?
                            (I (nClip (Sub n! 1)))
                           ) prime!
                          ) 0
                       )))
                         ...
                         (or
                          (and
                           (=>
                            ...
                            (=>
                             (= tmp%7 (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.factorial.? (I
                                (nClip (Sub n! 1))
                             )))
                             (and
                              (=>
