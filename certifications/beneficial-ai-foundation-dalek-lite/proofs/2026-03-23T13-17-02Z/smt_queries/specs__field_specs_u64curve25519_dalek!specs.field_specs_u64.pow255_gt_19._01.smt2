...
;; MODULE 'module specs::field_specs_u64'
;; curve25519-dalek/src/specs/field_specs_u64.rs:24:1: 24:28 (#0)
...
(declare-const fuel%curve25519_dalek!specs.field_specs_u64.spec_as_bytes. FuelId)
...
(assert
 (distinct fuel%vstd!arithmetic.power2.lemma_pow2_strictly_increases. fuel%vstd!array.array_view.
  ...
  fuel%vstd!bits.low_bits_mask. fuel%vstd!raw_ptr.impl&%3.view. fuel%vstd!raw_ptr.ptrs_mut_eq.
  ...
  fuel%vstd!view.impl&%32.view. fuel%curve25519_dalek!specs.field_specs_u64.p. fuel%curve25519_dalek!specs.field_specs_u64.field_canonical.
  ...
  fuel%curve25519_dalek!specs.field_specs_u64.spec_negate. fuel%curve25519_dalek!specs.field_specs_u64.compute_q_arr.
  ...
  fuel%curve25519_dalek!specs.field_specs_u64.reduce_with_q_spec. fuel%curve25519_dalek!specs.field_specs_u64.bit_arrange.
  fuel%curve25519_dalek!specs.field_specs_u64.spec_as_bytes. fuel%vstd!array.group_array_axioms.
...
;; Function-Decl curve25519_dalek::specs::field_specs_u64::spec_as_bytes
(declare-fun curve25519_dalek!specs.field_specs_u64.spec_as_bytes.? (Poly) %%Function%%)
...
;; Function-Axioms curve25519_dalek::specs::field_specs_u64::spec_as_bytes
(assert
 (fuel_bool_default fuel%curve25519_dalek!specs.field_specs_u64.spec_as_bytes.)
)
(assert
 (=>
  (fuel_bool fuel%curve25519_dalek!specs.field_specs_u64.spec_as_bytes.)
  (forall ((limbs! Poly)) (!
    (= (curve25519_dalek!specs.field_specs_u64.spec_as_bytes.? limbs!) (let
      ((reduced_limbs$ (curve25519_dalek!specs.field_specs_u64.spec_reduce.? limbs!)))
      (let
       ((q$ (curve25519_dalek!specs.field_specs_u64.compute_q_spec.? (Poly%array%. reduced_limbs$))))
       (curve25519_dalek!specs.field_specs_u64.bit_arrange.? (Poly%array%. (curve25519_dalek!specs.field_specs_u64.reduce_with_q_spec.?
          (Poly%array%. reduced_limbs$) (I q$)
    ))))))
    :pattern ((curve25519_dalek!specs.field_specs_u64.spec_as_bytes.? limbs!))
    :qid internal_curve25519_dalek!specs.field_specs_u64.spec_as_bytes.?_definition
    :skolemid skolem_internal_curve25519_dalek!specs.field_specs_u64.spec_as_bytes.?_definition
))))
(assert
 (forall ((limbs! Poly)) (!
   (=>
    (has_type limbs! (ARRAY $ (UINT 64) $ (CONST_INT 5)))
    (has_type (Poly%array%. (curve25519_dalek!specs.field_specs_u64.spec_as_bytes.? limbs!))
     (ARRAY $ (UINT 8) $ (CONST_INT 32))
   ))
   :pattern ((curve25519_dalek!specs.field_specs_u64.spec_as_bytes.? limbs!))
   :qid internal_curve25519_dalek!specs.field_specs_u64.spec_as_bytes.?_pre_post_definition
   :skolemid skolem_internal_curve25519_dalek!specs.field_specs_u64.spec_as_bytes.?_pre_post_definition
)))
...
;; Function-Def curve25519_dalek::specs::field_specs_u64::pow255_gt_19
;; curve25519-dalek/src/specs/field_specs_u64.rs:24:1: 24:28 (#0)
