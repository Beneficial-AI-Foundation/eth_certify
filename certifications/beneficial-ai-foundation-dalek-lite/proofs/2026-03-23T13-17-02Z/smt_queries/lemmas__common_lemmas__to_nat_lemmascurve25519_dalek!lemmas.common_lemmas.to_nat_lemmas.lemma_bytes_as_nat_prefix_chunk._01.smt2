...
;; curve25519-dalek/src/lemmas/common_lemmas/to_nat_lemmas.rs:926:1: 926:101 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::to_nat_lemmas::lemma_bytes_as_nat_prefix_chunk
;; curve25519-dalek/src/lemmas/common_lemmas/to_nat_lemmas.rs:926:1: 926:101 (#0)
(get-info :all-statistics)
(push)
 (declare-const bytes! vstd!seq.Seq<u8.>.)
 (declare-const chunk! vstd!seq.Seq<u8.>.)
 (declare-const k! Int)
 ...
 (declare-const rm1@ Int)
 (declare-const idx@ Int)
 (declare-const p@ Int)
 (declare-const bv@ Int)
 (declare-const pw_rm1@ Int)
 (declare-const pw_k@ Int)
 ...
 (assert
  (forall ((j$ Poly)) (!
    ...
    :pattern ((vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. chunk!) j$))
    :qid user_curve25519_dalek__lemmas__common_lemmas__to_nat_lemmas__lemma_bytes_as_nat_prefix_chunk_106
    :skolemid skolem_user_curve25519_dalek__lemmas__common_lemmas__to_nat_lemmas__lemma_bytes_as_nat_prefix_chunk_106
 )))
 ...
 (assert
  (not (=>
    (= decrease%init0 remaining!)
    (or
     (and
      (=>
       (= remaining! 0)
       (=>
        (= tmp%1 (= (curve25519_dalek!specs.core_specs.bytes_as_nat_prefix.? (Poly%vstd!seq.Seq<u8.>.
            chunk!
           ) (I 0)
          ) 0
        ))
        (and
         ...
         (=>
          ...
          (and
           (=>
            (= tmp%2 (vstd!arithmetic.power2.pow2.? (I (nClip (Mul k! 64)))))
            (=>
             (ens%vstd!arithmetic.mul.lemma_mul_basics. tmp%2)
             (=>
              %%location_label%%1
              (= (nClip (Mul 0 (vstd!arithmetic.power2.pow2.? (I (nClip (Mul k! 64)))))) 0)
           )))
           (=>
            (= (nClip (Mul 0 (vstd!arithmetic.power2.pow2.? (I (nClip (Mul k! 64)))))) 0)
            %%switch_label%%0
      ...
      (=>
       (not (= remaining! 0))
       (=>
        (= rm1@ (nClip (Sub remaining! 1)))
        (and
         (=>
          %%location_label%%2
          (check_decrease_int (let
            ((bytes!$0 bytes!) (chunk!$1 chunk!) (k!$2 k!) (remaining!$3 rm1@))
            remaining!$3
         ...
         (and
          ...
          (=>
           ...
           (=>
            (= idx@ (nClip (Add (nClip (Mul k! 8)) rm1@)))
            (=>
             (= tmp%3 (= (curve25519_dalek!specs.core_specs.bytes_as_nat_prefix.? (Poly%vstd!seq.Seq<u8.>.
                 bytes!
                ) (I (nClip (Add (nClip (Mul k! 8)) remaining!)))
               ) (nClip (Add (curve25519_dalek!specs.core_specs.bytes_as_nat_prefix.? (Poly%vstd!seq.Seq<u8.>.
                   bytes!
                  ) (I idx@)
                 ) (nClip (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul idx@ 8)))) (%I (vstd!seq.Seq.index.?
                     $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes!) (I idx@)
             ))))))))
             (and
              (=>
               %%location_label%%4
              ...
              (=>
               tmp%3
               (=>
                (= tmp%4 (= (curve25519_dalek!specs.core_specs.bytes_as_nat_prefix.? (Poly%vstd!seq.Seq<u8.>.
                    chunk!
                   ) (I remaining!)
                  ) (nClip (Add (curve25519_dalek!specs.core_specs.bytes_as_nat_prefix.? (Poly%vstd!seq.Seq<u8.>.
                      chunk!
                     ) (I rm1@)
                    ) (nClip (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul rm1@ 8)))) (%I (vstd!seq.Seq.index.?
                        $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. chunk!) (I rm1@)
                ))))))))
                (and
                 (=>
                  %%location_label%%5
                 ...
                 (=>
                  tmp%4
                  (=>
                   (= tmp%5 (= (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. chunk!) (I rm1@))
                     (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes!) (I (nClip (Add (nClip
                          (Mul k! 8)
                         ) rm1@
                   ))))))
                   (and
                    ...
                    (=>
                     ...
                     (and
                      (=>
                       (= tmp%6 (nClip (Mul k! 8)))
                       (=>
                        (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add. 8 tmp%6 rm1@)
                        (=>
                         (ens%vstd!arithmetic.mul.lemma_mul_is_associative. 8 k! 8)
                         (=>
                          %%location_label%%7
                          (= (nClip (Mul (nClip (Add (nClip (Mul k! 8)) rm1@)) 8)) (nClip (Add (nClip (Mul k! 64))
                             (nClip (Mul rm1@ 8))
                      )))))))
                      (=>
                       (= (nClip (Mul (nClip (Add (nClip (Mul k! 8)) rm1@)) 8)) (nClip (Add (nClip (Mul k! 64))
                       ...
                       (and
                        (=>
                         (= tmp%7 (nClip (Mul rm1@ 8)))
                         (=>
                          (= tmp%8 (nClip (Mul k! 64)))
                          (=>
                           (ens%vstd!arithmetic.power2.lemma_pow2_adds. tmp%7 tmp%8)
                           (=>
                            %%location_label%%8
                            (= (vstd!arithmetic.power2.pow2.? (I (nClip (Mul (nClip (Add (nClip (Mul k! 8)) rm1@))
                                 8
                              )))
                             ) (nClip (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul rm1@ 8)))) (vstd!arithmetic.power2.pow2.?
                                (I (nClip (Mul k! 64)))
                        ))))))))
                        (=>
                         (= (vstd!arithmetic.power2.pow2.? (I (nClip (Mul (nClip (Add (nClip (Mul k! 8)) rm1@))
                         ...
                         (=>
                          (= p@ (curve25519_dalek!specs.core_specs.bytes_as_nat_prefix.? (Poly%vstd!seq.Seq<u8.>.
                             chunk!
                            ) (I rm1@)
                          ))
                          (=>
                           (= bv@ (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. chunk!) (I rm1@))))
                           (=>
                            (= pw_rm1@ (vstd!arithmetic.power2.pow2.? (I (nClip (Mul rm1@ 8)))))
                            (=>
                             (= pw_k@ (vstd!arithmetic.power2.pow2.? (I (nClip (Mul k! 64)))))
                             (and
                              (=>
                               (= tmp%9 (Mul pw_rm1@ bv@))
                               (=>
                                (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add. pw_k@ p@ tmp%9)
                                (=>
                                 %%location_label%%9
                                 (= (Mul (Add p@ (Mul pw_rm1@ bv@)) pw_k@) (Add (Mul p@ pw_k@) (Mul (Mul pw_rm1@ bv@)
                                    pw_k@
                              ))))))
                              (=>
                               (= (Mul (Add p@ (Mul pw_rm1@ bv@)) pw_k@) (Add (Mul p@ pw_k@) (Mul (Mul pw_rm1@ bv@)
                               ...
                               (and
                                (=>
                                 (ens%vstd!arithmetic.mul.lemma_mul_is_associative. pw_rm1@ bv@ pw_k@)
                                 (=>
                                  (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. bv@ pw_k@)
                                  (=>
                                   (ens%vstd!arithmetic.mul.lemma_mul_is_associative. pw_rm1@ pw_k@ bv@)
                                   (=>
                                    %%location_label%%10
                                    (= (Mul (Mul pw_rm1@ bv@) pw_k@) (Mul (Mul pw_rm1@ pw_k@) bv@))
                                ))))
                                (=>
                                 (= (Mul (Mul pw_rm1@ bv@) pw_k@) (Mul (Mul pw_rm1@ pw_k@) bv@))
                                 %%switch_label%%0
