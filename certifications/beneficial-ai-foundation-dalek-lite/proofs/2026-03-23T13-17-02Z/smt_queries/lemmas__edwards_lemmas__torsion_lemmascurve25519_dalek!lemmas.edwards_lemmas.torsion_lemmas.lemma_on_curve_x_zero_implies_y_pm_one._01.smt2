...
;; curve25519-dalek/src/lemmas/edwards_lemmas/torsion_lemmas.rs:112:1: 112:68 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::torsion_lemmas::lemma_on_curve_x_zero_implies_y_pm_one
;; curve25519-dalek/src/lemmas/edwards_lemmas/torsion_lemmas.rs:112:1: 112:68 (#0)
                   ...
                   (and
                    (and
                     ...
                     (=>
                      ...
                      (=>
                       %%location_label%%6
                       (= (curve25519_dalek!specs.field_specs.field_mul.? (I d@) (I x2y2@)) 0)
                    )))
                    (=>
                     (= (curve25519_dalek!specs.field_specs.field_mul.? (I d@) (I x2y2@)) 0)
                     (=>
                      ...
                      (=>
                       (= tmp%4 (= (curve25519_dalek!specs.field_specs.field_add.? (I 1) (I 0)) 1))
                       (and
                        (=>
                         %%location_label%%7
                         tmp%4
                         ...
                         (and
                          (=>
                           ...
                           (and
                            (=>
                             %%location_label%%8
                             (req%vstd!arithmetic.div_mod.lemma_mod_self_0. tmp%5)
                            )
                            (=>
                             (ens%vstd!arithmetic.div_mod.lemma_mod_self_0. tmp%5)
                             (=>
                              %%location_label%%9
                              (= (curve25519_dalek!specs.field_specs.field_neg.? (I x2@)) 0)
                          ))))
                          (=>
                           (= (curve25519_dalek!specs.field_specs.field_neg.? (I x2@)) 0)
                           (and
                             ...
                             (=>
                              ...
                              (and
                               ...
                               (=>
                                ...
                                (=>
                                 %%location_label%%11
                                 (< y2@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                            )))))
                            (=>
                             (< y2@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                             (=>
                              ...
                              (and
                               (=>
                                %%location_label%%12
                                (req%vstd!arithmetic.div_mod.lemma_small_mod. y2@ tmp%8)
                               )
                               (=>
                                (ens%vstd!arithmetic.div_mod.lemma_small_mod. y2@ tmp%8)
                                (=>
                                 (= tmp%9 (= (curve25519_dalek!specs.field_specs.field_square.? (I y!)) 1))
                                 (and
                                  (=>
                                   %%location_label%%13
                                   tmp%9
                                      ...
                                      (=>
                                       ...
                                       (=>
                                        ...
                                        (and
                                         (=>
                                          %%location_label%%15
                                          (req%vstd!arithmetic.div_mod.lemma_small_mod. y! tmp%11)
                                         )
                                         (=>
                                          (ens%vstd!arithmetic.div_mod.lemma_small_mod. y! tmp%11)
                                          (=>
                                           (= tmp%12 (nClip (Sub (curve25519_dalek!specs.field_specs_u64.p.? (I 0)) 1)))
                                           (=>
