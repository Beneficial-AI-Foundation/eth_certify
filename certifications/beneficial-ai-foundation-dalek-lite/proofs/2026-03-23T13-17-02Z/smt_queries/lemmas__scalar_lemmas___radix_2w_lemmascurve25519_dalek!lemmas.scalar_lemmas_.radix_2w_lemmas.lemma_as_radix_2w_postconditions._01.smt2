...
;; MODULE 'module lemmas::scalar_lemmas_::radix_2w_lemmas'
;; curve25519-dalek/src/lemmas/scalar_lemmas_/radix_2w_lemmas.rs:906:1: 912:2 (#0)
...
(declare-const fuel%curve25519_dalek!specs.scalar_specs.u64_4_as_nat. FuelId)
...
(assert
 (distinct fuel%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. fuel%vstd!arithmetic.div_mod.lemma_div_denominator.
  fuel%vstd!arithmetic.div_mod.lemma_fundamental_div_mod_converse_div. fuel%vstd!arithmetic.div_mod.lemma_mod_bound.
  ...
  fuel%vstd!view.impl&%14.view. fuel%vstd!view.impl&%20.view. fuel%vstd!view.impl&%22.view.
  fuel%vstd!view.impl&%26.view. fuel%vstd!view.impl&%28.view. fuel%curve25519_dalek!specs.scalar_specs.u64_4_as_nat.
  fuel%curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w. fuel%curve25519_dalek!specs.scalar_specs.is_valid_radix_2w.
...
;; Function-Decl curve25519_dalek::specs::scalar_specs::u64_4_as_nat
(declare-fun curve25519_dalek!specs.scalar_specs.u64_4_as_nat.? (Poly) Int)
...
(assert
 (=>
  ...
  (forall ((x! Int) (c! Int) (d! Int)) (!
    ...
    :qid user_vstd__arithmetic__div_mod__lemma_div_denominator_23
    :skolemid skolem_user_vstd__arithmetic__div_mod__lemma_div_denominator_23
))))

;; Function-Specs vstd::arithmetic::div_mod::lemma_fundamental_div_mod_converse_div
...
;; Broadcast vstd::arithmetic::div_mod::lemma_fundamental_div_mod_converse_div
(assert
 (=>
  ...
  (forall ((x! Int) (d! Int) (q! Int) (r! Int)) (!
    ...
    :qid user_vstd__arithmetic__div_mod__lemma_fundamental_div_mod_converse_div_24
    :skolemid skolem_user_vstd__arithmetic__div_mod__lemma_fundamental_div_mod_converse_div_24
))))
...
(assert
 (=>
  ...
  (forall ((x! Int) (y! Int) (z! Int)) (!
    ...
    :qid user_vstd__arithmetic__div_mod__lemma_mod_breakdown_26
    :skolemid skolem_user_vstd__arithmetic__div_mod__lemma_mod_breakdown_26
))))
...
(assert
 (=>
  ...
  (forall ((x! Int) (y! Int) (z! Int)) (!
    ...
    :qid user_vstd__arithmetic__mul__lemma_mul_is_associative_27
    :skolemid skolem_user_vstd__arithmetic__mul__lemma_mul_is_associative_27
))))
...
(assert
 (=>
  ...
  (forall ((x! Int) (y! Int)) (!
    (= (Mul x! y!) (Mul y! x!))
    :pattern ((Mul x! y!))
    :qid user_vstd__arithmetic__mul__lemma_mul_is_commutative_28
    :skolemid skolem_user_vstd__arithmetic__mul__lemma_mul_is_commutative_28
))))
...
(assert
 (=>
  ...
  (forall ((x! Int) (y! Int) (z! Int)) (!
    ...
    :qid user_vstd__arithmetic__mul__lemma_mul_inequality_29
    :skolemid skolem_user_vstd__arithmetic__mul__lemma_mul_inequality_29
))))
...
(assert
 (=>
  ...
  (forall ((x! Int) (y! Int) (z! Int)) (!
    ...
    :qid user_vstd__arithmetic__mul__lemma_mul_is_distributive_add_30
    :skolemid skolem_user_vstd__arithmetic__mul__lemma_mul_is_distributive_add_30
))))
...
(assert
 (=>
  ...
  (forall ((x! Int) (y! Int) (z! Int)) (!
    ...
    :qid user_vstd__arithmetic__mul__lemma_mul_is_distributive_add_other_way_31
    :skolemid skolem_user_vstd__arithmetic__mul__lemma_mul_is_distributive_add_other_way_31
))))
...
(assert
 (=>
  ...
  (forall ((x! Int) (y! Int) (z! Int)) (!
    ...
    :qid user_vstd__arithmetic__mul__lemma_mul_is_distributive_sub_other_way_32
    :skolemid skolem_user_vstd__arithmetic__mul__lemma_mul_is_distributive_sub_other_way_32
))))
...
(assert
 (=>
  ...
  (forall ((e1! Poly) (e2! Poly)) (!
    ...
    :qid user_vstd__arithmetic__power2__lemma_pow2_strictly_increases_35
    :skolemid skolem_user_vstd__arithmetic__power2__lemma_pow2_strictly_increases_35
))))
...
(assert
 (=>
  ...
  (forall ((x! Poly) (shift! Poly)) (!
    ...
    :qid user_vstd__bits__lemma_u64_shr_is_div_36
    :skolemid skolem_user_vstd__bits__lemma_u64_shr_is_div_36
))))
...
(assert
 (=>
  ...
  (forall ((x! Poly) (shift! Poly)) (!
    ...
    :qid user_vstd__bits__lemma_u64_shl_is_mul_37
    :skolemid skolem_user_vstd__bits__lemma_u64_shl_is_mul_37
))))
...
(assert
 (=>
  ...
  (forall ((x! Poly) (n! Poly)) (!
    ...
    :qid user_vstd__bits__lemma_u64_low_bits_mask_is_mod_38
    :skolemid skolem_user_vstd__bits__lemma_u64_low_bits_mask_is_mod_38
))))
    ...
    (= (curve25519_dalek!specs.scalar_specs.is_valid_radix_2w.? digits! w! digits_count!)
     (and
      ...
      (forall ((i$ Poly)) (!
        ...
        :qid user_curve25519_dalek__specs__scalar_specs__is_valid_radix_2w_39
        :skolemid skolem_user_curve25519_dalek__specs__scalar_specs__is_valid_radix_2w_39
    ))))
...
;; Function-Axioms curve25519_dalek::specs::scalar_specs::u64_4_as_nat
(assert
 (fuel_bool_default fuel%curve25519_dalek!specs.scalar_specs.u64_4_as_nat.)
)
(assert
 (=>
  (fuel_bool fuel%curve25519_dalek!specs.scalar_specs.u64_4_as_nat.)
  (forall ((words! Poly)) (!
    (= (curve25519_dalek!specs.scalar_specs.u64_4_as_nat.? words!) (nClip (Add (nClip (Add
         (nClip (Add (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT
                64
               ) $ (CONST_INT 4)
              ) words!
             ) (I 0)
    ...
    :pattern ((curve25519_dalek!specs.scalar_specs.u64_4_as_nat.? words!))
    :qid internal_curve25519_dalek!specs.scalar_specs.u64_4_as_nat.?_definition
    :skolemid skolem_internal_curve25519_dalek!specs.scalar_specs.u64_4_as_nat.?_definition
))))
(assert
 (forall ((words! Poly)) (!
   (=>
    (has_type words! (ARRAY $ (UINT 64) $ (CONST_INT 4)))
    (<= 0 (curve25519_dalek!specs.scalar_specs.u64_4_as_nat.? words!))
   )
   :pattern ((curve25519_dalek!specs.scalar_specs.u64_4_as_nat.? words!))
   :qid internal_curve25519_dalek!specs.scalar_specs.u64_4_as_nat.?_pre_post_definition
   :skolemid skolem_internal_curve25519_dalek!specs.scalar_specs.u64_4_as_nat.?_pre_post_definition
)))
...
;; Function-Specs curve25519_dalek::lemmas::common_lemmas::mask_lemmas::lemma_u64_low_bits_masks_fit
(declare-fun req%curve25519_dalek!lemmas.common_lemmas.mask_lemmas.lemma_u64_low_bits_masks_fit.
 (Int) Bool
)
(declare-const %%global_location_label%%33 Bool)
(assert
 (forall ((k! Int)) (!
   (= (req%curve25519_dalek!lemmas.common_lemmas.mask_lemmas.lemma_u64_low_bits_masks_fit.
     k!
    ) (=>
     %%global_location_label%%33
     (<= k! 64)
   ))
   :pattern ((req%curve25519_dalek!lemmas.common_lemmas.mask_lemmas.lemma_u64_low_bits_masks_fit.
     k!
   ))
   :qid internal_req__curve25519_dalek!lemmas.common_lemmas.mask_lemmas.lemma_u64_low_bits_masks_fit._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.common_lemmas.mask_lemmas.lemma_u64_low_bits_masks_fit._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.common_lemmas.mask_lemmas.lemma_u64_low_bits_masks_fit.
 (Int) Bool
)
(assert
 (forall ((k! Int)) (!
   (= (ens%curve25519_dalek!lemmas.common_lemmas.mask_lemmas.lemma_u64_low_bits_masks_fit.
     k!
    ) (<= (vstd!bits.low_bits_mask.? (I k!)) 18446744073709551615)
   )
   :pattern ((ens%curve25519_dalek!lemmas.common_lemmas.mask_lemmas.lemma_u64_low_bits_masks_fit.
     k!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.common_lemmas.mask_lemmas.lemma_u64_low_bits_masks_fit._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.common_lemmas.mask_lemmas.lemma_u64_low_bits_masks_fit._definition
)))
...
;; Function-Specs curve25519_dalek::lemmas::scalar_lemmas_::radix_2w_lemmas::lemma_reconstruct_radix_2w_split
(declare-fun req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_reconstruct_radix_2w_split.
 (vstd!seq.Seq<i8.>. Int Int) Bool
)
(declare-const %%global_location_label%%35 Bool)
(declare-const %%global_location_label%%36 Bool)
(assert
 (forall ((digits! vstd!seq.Seq<i8.>.) (k! Int) (w! Int)) (!
   (= (req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_reconstruct_radix_2w_split.
     digits! k! w!
    ) (and
     (=>
      %%global_location_label%%35
      (<= k! (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!)))
     )
     (=>
      %%global_location_label%%36
      (> w! 0)
   )))
   :pattern ((req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_reconstruct_radix_2w_split.
     digits! k! w!
   ))
   :qid internal_req__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_reconstruct_radix_2w_split._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_reconstruct_radix_2w_split._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_reconstruct_radix_2w_split.
 (vstd!seq.Seq<i8.>. Int Int) Bool
)
(assert
 (forall ((digits! vstd!seq.Seq<i8.>.) (k! Int) (w! Int)) (!
   (= (ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_reconstruct_radix_2w_split.
     digits! k! w!
    ) (= (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.? (Poly%vstd!seq.Seq<i8.>.
       digits!
      ) (I w!)
     ) (Add (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.? (vstd!seq.Seq.subrange.?
        $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I 0) (I k!)
       ) (I w!)
      ) (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul w! k!)))) (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.?
        (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I k!) (I (vstd!seq.Seq.len.?
           $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!)
         ))
        ) (I w!)
   )))))
   :pattern ((ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_reconstruct_radix_2w_split.
     digits! k! w!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_reconstruct_radix_2w_split._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_reconstruct_radix_2w_split._definition
)))

;; Function-Specs curve25519_dalek::lemmas::scalar_lemmas_::radix_2w_lemmas::lemma_w_digits_count_concrete
(declare-fun req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_w_digits_count_concrete.
 (Int Int) Bool
)
(declare-const %%global_location_label%%37 Bool)
(declare-const %%global_location_label%%38 Bool)
(assert
 (forall ((w! Int) (digits_count! Int)) (!
   (= (req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_w_digits_count_concrete.
     w! digits_count!
    ) (and
     (=>
     ...
     (=>
      ...
      (= digits_count! (EucDiv (Sub (Add 256 w!) 1) w!))
   )))
   :pattern ((req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_w_digits_count_concrete.
     w! digits_count!
   ))
   :qid internal_req__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_w_digits_count_concrete._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_w_digits_count_concrete._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_w_digits_count_concrete.
 (Int Int) Bool
)
(assert
 (forall ((w! Int) (digits_count! Int)) (!
   (= (ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_w_digits_count_concrete.
     w! digits_count!
    ) (and
     (=>
      (= w! 5)
     ...
     (> digits_count! 0)
     (<= digits_count! 52)
     (>= (Mul digits_count! w!) 256)
     (<= (Mul digits_count! w!) (Sub (Add 256 w!) 1))
   ))
   :pattern ((ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_w_digits_count_concrete.
     w! digits_count!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_w_digits_count_concrete._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_w_digits_count_concrete._definition
)))

;; Function-Specs curve25519_dalek::lemmas::scalar_lemmas_::radix_2w_lemmas::lemma_digits_count_radix_bounds
(declare-fun req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_digits_count_radix_bounds.
 (Int Int) Bool
)
...
(assert
 (forall ((w! Int) (digits_count! Int)) (!
   (= (req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_digits_count_radix_bounds.
     w! digits_count!
    ) (and
     (=>
   ...
   :pattern ((req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_digits_count_radix_bounds.
     w! digits_count!
   ))
   :qid internal_req__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_digits_count_radix_bounds._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_digits_count_radix_bounds._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_digits_count_radix_bounds.
 (Int Int) Bool
)
(assert
 (forall ((w! Int) (digits_count! Int)) (!
   (= (ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_digits_count_radix_bounds.
     w! digits_count!
    ) (and
     (<= digits_count! 52)
     (> digits_count! 0)
   ...
   :pattern ((ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_digits_count_radix_bounds.
     w! digits_count!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_digits_count_radix_bounds._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_digits_count_radix_bounds._definition
)))

;; Function-Specs curve25519_dalek::lemmas::scalar_lemmas_::radix_2w_lemmas::lemma_u64x4_mod_strip_above
(declare-fun req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_mod_strip_above.
 (%%Function%% Int) Bool
)
(declare-const %%global_location_label%%41 Bool)
(assert
 (forall ((words! %%Function%%) (boundary! Int)) (!
   (= (req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_mod_strip_above.
     words! boundary!
    ) (=>
   ...
   :pattern ((req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_mod_strip_above.
     words! boundary!
   ))
   :qid internal_req__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_mod_strip_above._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_mod_strip_above._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_mod_strip_above.
 (%%Function%% Int) Bool
)
(assert
 (forall ((words! %%Function%%) (boundary! Int)) (!
   (= (ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_mod_strip_above.
     words! boundary!
    ) (= (EucMod (curve25519_dalek!specs.scalar_specs.u64_4_as_nat.? (Poly%array%. words!))
      (vstd!arithmetic.power2.pow2.? (I boundary!))
     ) (EucMod (ite
       (<= boundary! 64)
       ...
       (ite
        ...
        (ite
         (<= boundary! 192)
         (nClip (Add (nClip (Add (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (
         ...
         (curve25519_dalek!specs.scalar_specs.u64_4_as_nat.? (Poly%array%. words!))
       ))
      ) (vstd!arithmetic.power2.pow2.? (I boundary!))
   )))
   :pattern ((ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_mod_strip_above.
     words! boundary!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_mod_strip_above._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_mod_strip_above._definition
)))
...
;; Function-Specs curve25519_dalek::lemmas::scalar_lemmas_::radix_2w_lemmas::lemma_u64x4_lower_words_bounded
(declare-fun req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_lower_words_bounded.
 (%%Function%% Int) Bool
)
(declare-const %%global_location_label%%42 Bool)
(assert
 (forall ((words! %%Function%%) (base_idx! Int)) (!
   (= (req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_lower_words_bounded.
     words! base_idx!
    ) (=>
   ...
   :pattern ((req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_lower_words_bounded.
     words! base_idx!
   ))
   :qid internal_req__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_lower_words_bounded._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_lower_words_bounded._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_lower_words_bounded.
 (%%Function%% Int) Bool
)
(assert
 (forall ((words! %%Function%%) (base_idx! Int)) (!
   (= (ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_lower_words_bounded.
     words! base_idx!
    ) (let
     ((lower$ (ite
        (= base_idx! 1)
     ...
     (< lower$ (vstd!arithmetic.power2.pow2.? (I (nClip (Mul base_idx! 64)))))
   ))
   :pattern ((ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_lower_words_bounded.
     words! base_idx!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_lower_words_bounded._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_lower_words_bounded._definition
)))

;; Function-Specs curve25519_dalek::lemmas::scalar_lemmas_::radix_2w_lemmas::lemma_u64x4_single_word_decompose_generic
(declare-fun req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_single_word_decompose_generic.
...
(assert
 (forall ((words! %%Function%%) (u64_idx! Int) (bit_off_nat! Int) (w_nat! Int) (bit_idx_nat!
    Int
   )
  ) (!
   (= (req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_single_word_decompose_generic.
     words! u64_idx! bit_off_nat! w_nat! bit_idx_nat!
    ) (and
     (=>
      %%global_location_label%%43
      (= u64_idx! (EucDiv bit_off_nat! 64))
     )
     (=>
      %%global_location_label%%44
      (= bit_idx_nat! (EucMod bit_off_nat! 64))
     )
     (=>
      %%global_location_label%%45
      (or
       (<= (nClip (Add bit_idx_nat! w_nat!)) 64)
       (= u64_idx! 3)
     ))
     (=>
   ...
   :pattern ((req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_single_word_decompose_generic.
     words! u64_idx! bit_off_nat! w_nat! bit_idx_nat!
   ))
   :qid internal_req__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_single_word_decompose_generic._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_single_word_decompose_generic._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_single_word_decompose_generic.
 (%%Function%% Int Int Int Int) Bool
)
(assert
 (forall ((words! %%Function%%) (u64_idx! Int) (bit_off_nat! Int) (w_nat! Int) (bit_idx_nat!
   ...
   (= (ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_single_word_decompose_generic.
     words! u64_idx! bit_off_nat! w_nat! bit_idx_nat!
    ) (= (EucDiv (EucMod (curve25519_dalek!specs.scalar_specs.u64_4_as_nat.? (Poly%array%.
         words!
        )
       ) (vstd!arithmetic.power2.pow2.? (I (nClip (Add bit_off_nat! w_nat!))))
      ) (vstd!arithmetic.power2.pow2.? (I bit_off_nat!))
     ) (EucMod (EucDiv (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY
           $ (UINT 64) $ (CONST_INT 4)
          ) (Poly%array%. words!)
         ) (I u64_idx!)
        )
       ) (vstd!arithmetic.power2.pow2.? (I bit_idx_nat!))
      ) (vstd!arithmetic.power2.pow2.? (I w_nat!))
   )))
   :pattern ((ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_single_word_decompose_generic.
     words! u64_idx! bit_off_nat! w_nat! bit_idx_nat!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_single_word_decompose_generic._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_single_word_decompose_generic._definition
)))

;; Function-Specs curve25519_dalek::lemmas::scalar_lemmas_::radix_2w_lemmas::lemma_u64x4_cross_word_reduce_to_two
(declare-fun req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_cross_word_reduce_to_two.
...
(assert
 (forall ((words! %%Function%%) (bit_idx_nat! Int) (w_nat! Int) (u64_idx! Int)) (!
   (= (req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_cross_word_reduce_to_two.
     words! bit_idx_nat! w_nat! u64_idx!
    ) (and
     (=>
      %%global_location_label%%48
      (= bit_idx_nat! (EucMod (nClip (Add (nClip (Mul u64_idx! 64)) bit_idx_nat!)) 64))
     )
     (=>
     ...
     (=>
      ...
      (<= (nClip (Add (nClip (Mul u64_idx! 64)) bit_idx_nat!)) 255)
     )
     (=>
      %%global_location_label%%53
      (< bit_idx_nat! 64)
   )))
   :pattern ((req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_cross_word_reduce_to_two.
     words! bit_idx_nat! w_nat! u64_idx!
   ))
   :qid internal_req__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_cross_word_reduce_to_two._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_cross_word_reduce_to_two._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_cross_word_reduce_to_two.
 (%%Function%% Int Int Int) Bool
)
(assert
 (forall ((words! %%Function%%) (bit_idx_nat! Int) (w_nat! Int) (u64_idx! Int)) (!
   (= (ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_cross_word_reduce_to_two.
     words! bit_idx_nat! w_nat! u64_idx!
    ) (let
     ((val$ (curve25519_dalek!specs.scalar_specs.u64_4_as_nat.? (Poly%array%. words!))))
     (let
      ((two_val$ (nClip (Add (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY
              $ (UINT 64) $ (CONST_INT 4)
             ) (Poly%array%. words!)
            ) (I u64_idx!)
           )
      ...
      (let
       ((bit_off_nat$ (nClip (Add (nClip (Mul u64_idx! 64)) bit_idx_nat!))))
       (= (EucDiv (EucMod val$ (vstd!arithmetic.power2.pow2.? (I (nClip (Add bit_off_nat$ w_nat!)))))
         (vstd!arithmetic.power2.pow2.? (I bit_off_nat$))
        ) (EucMod (EucDiv two_val$ (vstd!arithmetic.power2.pow2.? (I bit_idx_nat!))) (vstd!arithmetic.power2.pow2.?
          (I w_nat!)
   )))))))
   :pattern ((ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_cross_word_reduce_to_two.
     words! bit_idx_nat! w_nat! u64_idx!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_cross_word_reduce_to_two._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_cross_word_reduce_to_two._definition
)))

;; Function-Specs curve25519_dalek::lemmas::common_lemmas::bit_lemmas::lemma_u64_distribute_over_bit_or
(declare-fun req%curve25519_dalek!lemmas.common_lemmas.bit_lemmas.lemma_u64_distribute_over_bit_or.
 (Int Int Int) Bool
)
(declare-const %%global_location_label%%54 Bool)
(assert
 (forall ((a! Int) (b! Int) (c! Int)) (!
   (= (req%curve25519_dalek!lemmas.common_lemmas.bit_lemmas.lemma_u64_distribute_over_bit_or.
     a! b! c!
    ) (=>
     %%global_location_label%%54
     (< c! 64)
   ))
   :pattern ((req%curve25519_dalek!lemmas.common_lemmas.bit_lemmas.lemma_u64_distribute_over_bit_or.
     a! b! c!
   ))
   :qid internal_req__curve25519_dalek!lemmas.common_lemmas.bit_lemmas.lemma_u64_distribute_over_bit_or._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.common_lemmas.bit_lemmas.lemma_u64_distribute_over_bit_or._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.common_lemmas.bit_lemmas.lemma_u64_distribute_over_bit_or.
 (Int Int Int) Bool
)
(assert
 (forall ((a! Int) (b! Int) (c! Int)) (!
   (= (ens%curve25519_dalek!lemmas.common_lemmas.bit_lemmas.lemma_u64_distribute_over_bit_or.
     a! b! c!
    ) (and
     (= (uClip 64 (bitshr (I (uClip 64 (bitor (I a!) (I b!)))) (I c!))) (uClip 64 (bitor
        (I (uClip 64 (bitshr (I a!) (I c!)))) (I (uClip 64 (bitshr (I b!) (I c!))))
     )))
     (= (uClip 64 (bitand (I (uClip 64 (bitor (I a!) (I b!)))) (I (uClip 64 (vstd!bits.low_bits_mask.?
           (I c!)
       ))))
      ) (uClip 64 (bitor (I (uClip 64 (bitand (I a!) (I (uClip 64 (vstd!bits.low_bits_mask.? (I
               c!
         ))))))
        ) (I (uClip 64 (bitand (I b!) (I (uClip 64 (vstd!bits.low_bits_mask.? (I c!)))))))
   )))))
   :pattern ((ens%curve25519_dalek!lemmas.common_lemmas.bit_lemmas.lemma_u64_distribute_over_bit_or.
     a! b! c!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.common_lemmas.bit_lemmas.lemma_u64_distribute_over_bit_or._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.common_lemmas.bit_lemmas.lemma_u64_distribute_over_bit_or._definition
)))

;; Function-Specs curve25519_dalek::lemmas::scalar_lemmas_::radix_2w_lemmas::lemma_u64_shl_low_bits
(declare-fun req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64_shl_low_bits.
 (Int Int Int) Bool
)
...
(assert
 (forall ((b! Int) (k! Int) (w! Int)) (!
   (= (req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64_shl_low_bits.
     b! k! w!
    ) (and
     (=>
   ...
   :pattern ((req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64_shl_low_bits.
     b! k! w!
   ))
   :qid internal_req__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64_shl_low_bits._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64_shl_low_bits._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64_shl_low_bits.
 (Int Int Int) Bool
)
(assert
 (forall ((b! Int) (k! Int) (w! Int)) (!
   (= (ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64_shl_low_bits.
     b! k! w!
    ) (let
     ((cross$ (nClip (Sub w! k!))))
     (let
      ((mask$ (uClip 64 (vstd!bits.low_bits_mask.? (I w!)))))
      (let
       ((b_lo$ (uClip 64 (EucMod b! (vstd!arithmetic.power2.pow2.? (I cross$))))))
       (= (uClip 64 (bitand (I (uClip 64 (bitshl (I b!) (I k!)))) (I mask$))) (uClip 64 (bitshl
          (I b_lo$) (I k!)
   )))))))
   :pattern ((ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64_shl_low_bits.
     b! k! w!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64_shl_low_bits._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64_shl_low_bits._definition
)))

;; Function-Specs curve25519_dalek::lemmas::scalar_lemmas_::radix_2w_lemmas::lemma_u64x4_cross_word_decompose
(declare-fun req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_cross_word_decompose.
...
(assert
 (forall ((words! %%Function%%) (bit_off_nat! Int) (w_nat! Int) (bit_idx_nat! Int) (
    u64_idx! Int
   ) (bit_buf! Int)
  ) (!
   (= (req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_cross_word_decompose.
     words! bit_off_nat! w_nat! bit_idx_nat! u64_idx! bit_buf!
    ) (and
     (=>
     ...
     (=>
      ...
      (= bit_buf! (uClip 64 (bitor (I (uClip 64 (bitshr (I (%I (vstd!seq.Seq.index.? $ (UINT 64)
               (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $ (CONST_INT 4)) (Poly%array%. words!))
               (I u64_idx!)
             ))
            ) (I (uClip 64 bit_idx_nat!))
          ))
         ) (I (uClip 64 (bitshl (I (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $
                (ARRAY $ (UINT 64) $ (CONST_INT 4)) (Poly%array%. words!)
               ) (I (Add 1 u64_idx!))
             ))
            ) (I (uClip 64 (Sub 64 bit_idx_nat!)))
   )))))))))
   :pattern ((req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_cross_word_decompose.
     words! bit_off_nat! w_nat! bit_idx_nat! u64_idx! bit_buf!
   ))
   :qid internal_req__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_cross_word_decompose._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_cross_word_decompose._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_cross_word_decompose.
 (%%Function%% Int Int Int Int Int) Bool
)
(assert
 (forall ((words! %%Function%%) (bit_off_nat! Int) (w_nat! Int) (bit_idx_nat! Int) (
   ...
   (= (ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_cross_word_decompose.
     words! bit_off_nat! w_nat! bit_idx_nat! u64_idx! bit_buf!
    ) (= (EucDiv (EucMod (curve25519_dalek!specs.scalar_specs.u64_4_as_nat.? (Poly%array%.
         words!
        )
     ...
     ) (EucMod bit_buf! (vstd!arithmetic.power2.pow2.? (I w_nat!)))
   ))
   :pattern ((ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_cross_word_decompose.
     words! bit_off_nat! w_nat! bit_idx_nat! u64_idx! bit_buf!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_cross_word_decompose._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_cross_word_decompose._definition
)))

;; Function-Specs curve25519_dalek::lemmas::scalar_lemmas_::radix_2w_lemmas::lemma_u64x4_cross_word_extraction
(declare-fun req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_cross_word_extraction.
...
(assert
 (forall ((words! %%Function%%) (bit_buf! Int) (window_mask! Int) (w! Int) (bit_offset!
    Int
   ) (u64_idx! Int) (bit_idx! Int)
  ) (!
   (= (req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_cross_word_extraction.
     words! bit_buf! window_mask! w! bit_offset! u64_idx! bit_idx!
    ) (and
     (=>
     ...
     (=>
      ...
      (= u64_idx! (EucDiv bit_offset! 64))
     )
     (=>
      %%global_location_label%%69
      (= bit_idx! (EucMod bit_offset! 64))
     )
     (=>
     ...
     (=>
      ...
      (= bit_buf! (uClip 64 (bitor (I (uClip 64 (bitshr (I (%I (vstd!seq.Seq.index.? $ (UINT 64)
            ...
            ) (I (uClip 64 (Sub 64 bit_idx!)))
   )))))))))
   :pattern ((req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_cross_word_extraction.
     words! bit_buf! window_mask! w! bit_offset! u64_idx! bit_idx!
   ))
   :qid internal_req__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_cross_word_extraction._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_cross_word_extraction._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_cross_word_extraction.
 (%%Function%% Int Int Int Int Int Int) Bool
)
(assert
 (forall ((words! %%Function%%) (bit_buf! Int) (window_mask! Int) (w! Int) (bit_offset!
   ...
   (= (ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_cross_word_extraction.
     words! bit_buf! window_mask! w! bit_offset! u64_idx! bit_idx!
    ) (= (uClip 64 (bitand (I bit_buf!) (I window_mask!))) (EucMod (EucDiv (curve25519_dalek!specs.scalar_specs.u64_4_as_nat.?
        (Poly%array%. words!)
       ) (vstd!arithmetic.power2.pow2.? (I bit_offset!))
      ) (vstd!arithmetic.power2.pow2.? (I w!))
   )))
   :pattern ((ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_cross_word_extraction.
     words! bit_buf! window_mask! w! bit_offset! u64_idx! bit_idx!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_cross_word_extraction._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_cross_word_extraction._definition
)))

;; Function-Specs curve25519_dalek::lemmas::scalar_lemmas_::radix_2w_lemmas::lemma_u64x4_bit_extraction
(declare-fun req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_bit_extraction.
 (%%Function%% Int Int Int Int Int Int) Bool
)
...
(assert
 (forall ((words! %%Function%%) (bit_buf! Int) (window_mask! Int) (w! Int) (bit_offset!
   ...
   (= (req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_bit_extraction.
     words! bit_buf! window_mask! w! bit_offset! u64_idx! bit_idx!
    ) (and
     (=>
     ...
     (=>
      ...
      (=>
       ...
       (= bit_buf! (uClip 64 (bitshr (I (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
              $ (ARRAY $ (UINT 64) $ (CONST_INT 4)) (Poly%array%. words!)
             ) (I u64_idx!)
           ))
          ) (I (uClip 64 bit_idx!))
   ...
   :pattern ((req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_bit_extraction.
     words! bit_buf! window_mask! w! bit_offset! u64_idx! bit_idx!
   ))
   :qid internal_req__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_bit_extraction._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_bit_extraction._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_bit_extraction.
 (%%Function%% Int Int Int Int Int Int) Bool
)
(assert
 (forall ((words! %%Function%%) (bit_buf! Int) (window_mask! Int) (w! Int) (bit_offset!
   ...
   (= (ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_bit_extraction.
     words! bit_buf! window_mask! w! bit_offset! u64_idx! bit_idx!
    ) (= (uClip 64 (bitand (I bit_buf!) (I window_mask!))) (EucMod (EucDiv (curve25519_dalek!specs.scalar_specs.u64_4_as_nat.?
        (Poly%array%. words!)
       ) (vstd!arithmetic.power2.pow2.? (I bit_offset!))
   ...
   :pattern ((ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_bit_extraction.
     words! bit_buf! window_mask! w! bit_offset! u64_idx! bit_idx!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_bit_extraction._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_bit_extraction._definition
)))

;; Function-Specs curve25519_dalek::lemmas::scalar_lemmas_::radix_2w_lemmas::lemma_radix_2w_digit_bounds
(declare-fun req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_radix_2w_digit_bounds.
 (Int Int Int) Bool
)
...
(assert
 (forall ((coef! Int) (w! Int) (new_carry! Int)) (!
   (= (req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_radix_2w_digit_bounds.
     coef! w! new_carry!
    ) (and
     (=>
      %%global_location_label%%80
      (<= coef! (uClip 64 (bitshl (I 1) (I (uClip 64 w!)))))
     )
     (=>
     ...
     (=>
      ...
      (= new_carry! (uClip 64 (bitshr (I (uClip 64 (Add coef! (EucDiv (uClip 64 (bitshl (I 1) (I
                (uClip 64 w!)
              ))
             ) 2
          )))
   ...
   :pattern ((req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_radix_2w_digit_bounds.
     coef! w! new_carry!
   ))
   :qid internal_req__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_radix_2w_digit_bounds._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_radix_2w_digit_bounds._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_radix_2w_digit_bounds.
 (Int Int Int) Bool
)
(assert
 (forall ((coef! Int) (w! Int) (new_carry! Int)) (!
   (= (ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_radix_2w_digit_bounds.
     coef! w! new_carry!
    ) (let
     ((digit_val$ (Sub coef! (Mul new_carry! (vstd!arithmetic.power2.pow2.? (I w!))))))
     (and
      (<= (Sub 0 (vstd!arithmetic.power2.pow2.? (I (nClip (Sub w! 1))))) digit_val$)
      (< digit_val$ (vstd!arithmetic.power2.pow2.? (I (nClip (Sub w! 1)))))
   )))
   :pattern ((ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_radix_2w_digit_bounds.
     coef! w! new_carry!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_radix_2w_digit_bounds._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_radix_2w_digit_bounds._definition
)))

;; Function-Specs curve25519_dalek::lemmas::scalar_lemmas_::radix_2w_lemmas::lemma_radix_2w_loop_reconstruction_step
(declare-fun req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_radix_2w_loop_reconstruction_step.
...
(assert
 (forall ((digits_new! vstd!seq.Seq<i8.>.) (i! Int) (w! Int) (scalar_val! Int) (old_carry!
    Int
   ) (new_carry! Int) (extracted! Int)
  ) (!
   (= (req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_radix_2w_loop_reconstruction_step.
     digits_new! i! w! scalar_val! old_carry! new_carry! extracted!
    ) (and
     (=>
     ...
     (=>
      ...
      (= (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits_new!)) (Add i! 1))
     )
     (=>
      %%global_location_label%%87
      (= (Add (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.? (vstd!seq.Seq.subrange.?
          $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits_new!) (I 0) (I i!)
         ) (I w!)
        ) (Mul old_carry! (vstd!arithmetic.power2.pow2.? (I (nClip (Mul w! i!)))))
       ) (EucMod scalar_val! (vstd!arithmetic.power2.pow2.? (I (nClip (Mul w! i!)))))
     ))
     (=>
      %%global_location_label%%88
      (= (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits_new!) (I i!)))
       (Sub (Add old_carry! extracted!) (Mul new_carry! (vstd!arithmetic.power2.pow2.? (I w!))))
     ))
     (=>
      %%global_location_label%%89
      (= extracted! (EucMod (EucDiv scalar_val! (vstd!arithmetic.power2.pow2.? (I (nClip (Mul
             w! i!
         ))))
        ) (vstd!arithmetic.power2.pow2.? (I w!))
     )))
   ...
   :pattern ((req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_radix_2w_loop_reconstruction_step.
     digits_new! i! w! scalar_val! old_carry! new_carry! extracted!
   ))
   :qid internal_req__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_radix_2w_loop_reconstruction_step._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_radix_2w_loop_reconstruction_step._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_radix_2w_loop_reconstruction_step.
 (vstd!seq.Seq<i8.>. Int Int Int Int Int Int) Bool
)
(assert
 (forall ((digits_new! vstd!seq.Seq<i8.>.) (i! Int) (w! Int) (scalar_val! Int) (old_carry!
   ...
   (= (ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_radix_2w_loop_reconstruction_step.
     digits_new! i! w! scalar_val! old_carry! new_carry! extracted!
    ) (= (Add (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.? (Poly%vstd!seq.Seq<i8.>.
        digits_new!
       ) (I w!)
      ) (Mul new_carry! (vstd!arithmetic.power2.pow2.? (I (nClip (Mul w! (Add i! 1))))))
     ) (EucMod scalar_val! (vstd!arithmetic.power2.pow2.? (I (nClip (Mul w! (Add i! 1))))))
   ))
   :pattern ((ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_radix_2w_loop_reconstruction_step.
     digits_new! i! w! scalar_val! old_carry! new_carry! extracted!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_radix_2w_loop_reconstruction_step._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_radix_2w_loop_reconstruction_step._definition
)))

;; Function-Specs curve25519_dalek::lemmas::scalar_lemmas_::radix_2w_lemmas::lemma_last_iter_carry_zero
(declare-fun req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_last_iter_carry_zero.
...
(assert
 (forall ((scalar_val! Int) (old_carry! Int) (extracted! Int) (w! Int) (i! Int)) (!
   (= (req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_last_iter_carry_zero.
     scalar_val! old_carry! extracted! w! i!
    ) (and
     (=>
     ...
     (=>
      ...
      (= (Add i! 1) (EucDiv (Sub (Add 256 w!) 1) w!))
     )
     (=>
      %%global_location_label%%93
      (< scalar_val! (vstd!arithmetic.power2.pow2.? (I 256)))
     )
     (=>
   ...
   :pattern ((req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_last_iter_carry_zero.
     scalar_val! old_carry! extracted! w! i!
   ))
   :qid internal_req__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_last_iter_carry_zero._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_last_iter_carry_zero._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_last_iter_carry_zero.
 (Int Int Int Int Int) Bool
)
(assert
 (forall ((scalar_val! Int) (old_carry! Int) (extracted! Int) (w! Int) (i! Int)) (!
   (= (ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_last_iter_carry_zero.
     scalar_val! old_carry! extracted! w! i!
    ) (< (Add old_carry! extracted!) (EucDiv (uClip 64 (bitshl (I 1) (I (uClip 64 w!))))
      2
   )))
   :pattern ((ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_last_iter_carry_zero.
     scalar_val! old_carry! extracted! w! i!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_last_iter_carry_zero._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_last_iter_carry_zero._definition
)))

;; Function-Specs curve25519_dalek::lemmas::scalar_lemmas_::radix_2w_lemmas::lemma_as_radix_2w_postconditions
(declare-fun req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_as_radix_2w_postconditions.
 (%%Function%% Int Int Int Int) Bool
)
...
(assert
 (forall ((digits! %%Function%%) (w! Int) (digits_count! Int) (carry! Int) (scalar_val!
    Int
   )
  ) (!
   (= (req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_as_radix_2w_postconditions.
     digits! w! digits_count! carry! scalar_val!
    ) (and
     (=>
     ...
     (=>
      ...
      (= (Add (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.? (vstd!seq.Seq.subrange.?
        ...
        ) (Mul carry! (vstd!arithmetic.power2.pow2.? (I (nClip (Mul w! digits_count!)))))
       ) (EucMod scalar_val! (vstd!arithmetic.power2.pow2.? (I (nClip (Mul w! digits_count!)))))
     ))
     (=>
      ...
      (forall ((j$ Poly)) (!
        (=>
         ...
         (=>
          ...
          (let
           ((bound$ (vstd!arithmetic.power2.pow2.? (I (nClip (Sub w! 1))))))
           (and
            (<= (Sub 0 bound$) (%I (vstd!seq.Seq.index.? $ (SINT 8) (vstd!view.View.view.? $ (ARRAY
                 $ (SINT 8) $ (CONST_INT 64)
                ) (Poly%array%. digits!)
        ...
        :qid user_curve25519_dalek__lemmas__scalar_lemmas___radix_2w_lemmas__lemma_as_radix_2w_postconditions_106
        :skolemid skolem_user_curve25519_dalek__lemmas__scalar_lemmas___radix_2w_lemmas__lemma_as_radix_2w_postconditions_106
     )))
     (=>
   ...
   :pattern ((req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_as_radix_2w_postconditions.
     digits! w! digits_count! carry! scalar_val!
   ))
   :qid internal_req__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_as_radix_2w_postconditions._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_as_radix_2w_postconditions._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_as_radix_2w_postconditions.
 (%%Function%% Int Int Int Int) Bool
)
(assert
 (forall ((digits! %%Function%%) (w! Int) (digits_count! Int) (carry! Int) (scalar_val!
   ...
   (= (ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_as_radix_2w_postconditions.
     digits! w! digits_count! carry! scalar_val!
    ) (let
     ((final_digits_count$ (ite
        (< w! 8)
        (EucDiv (Sub (Add 256 w!) 1) w!)
        (Add (EucDiv (Sub (Add 256 w!) 1) w!) 1)
     )))
     (and
      (curve25519_dalek!specs.scalar_specs.is_valid_radix_2w.? (Poly%array%. digits!) (I
        w!
       ) (I (nClip final_digits_count$))
      )
      (= (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.? (vstd!seq.Seq.subrange.?
         $ (SINT 8) (vstd!view.View.view.? $ (ARRAY $ (SINT 8) $ (CONST_INT 64)) (Poly%array%.
           digits!
          )
         ) (I 0) (I final_digits_count$)
        ) (I w!)
       ) scalar_val!
   ))))
   :pattern ((ens%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_as_radix_2w_postconditions.
     digits! w! digits_count! carry! scalar_val!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_as_radix_2w_postconditions._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_as_radix_2w_postconditions._definition
)))

;; Function-Def curve25519_dalek::lemmas::scalar_lemmas_::radix_2w_lemmas::lemma_as_radix_2w_postconditions
;; curve25519-dalek/src/lemmas/scalar_lemmas_/radix_2w_lemmas.rs:906:1: 912:2 (#0)
(get-info :all-statistics)
(push)
 (declare-const digits! %%Function%%)
 (declare-const w! Int)
 ...
 (declare-const tmp%3 vstd!seq.Seq<i8.>.)
 ...
 (declare-const final_digits_count@ Int)
 (assert
  fuel_defaults
 )
 (assert
  (has_type (Poly%array%. digits!) (ARRAY $ (SINT 8) $ (CONST_INT 64)))
 )
 (assert
  (uInv SZ w!)
 )
 (assert
  (uInv SZ digits_count!)
 )
 (assert
  (uInv 64 carry!)
 )
 ...
 (assert
  (forall ((j$ Poly)) (!
    ...
    :qid user_curve25519_dalek__lemmas__scalar_lemmas___radix_2w_lemmas__lemma_as_radix_2w_postconditions_114
    :skolemid skolem_user_curve25519_dalek__lemmas__scalar_lemmas___radix_2w_lemmas__lemma_as_radix_2w_postconditions_114
 )))
 (assert
  (< scalar_val! (vstd!arithmetic.power2.pow2.? (I 256)))
 )
     ...
     (=>
      ...
      (and
       (or
        (and
         (=>
          (> (Mul w! digits_count!) 256)
          (=>
           (= tmp%1 (nClip (Mul w! digits_count!)))
           (and
            (=>
             %%location_label%%1
             (req%vstd!arithmetic.power2.lemma_pow2_strictly_increases. 256 tmp%1)
            )
            (=>
             (ens%vstd!arithmetic.power2.lemma_pow2_strictly_increases. 256 tmp%1)
             %%switch_label%%2
         ))))
         (=>
          (not (> (Mul w! digits_count!) 256))
          %%switch_label%%2
        ))
        (and
         (not %%switch_label%%2)
         (=>
          (= tmp%2 (vstd!arithmetic.power2.pow2.? (I (nClip (Mul w! digits_count!)))))
          (and
           (=>
            %%location_label%%2
            (req%vstd!arithmetic.div_mod.lemma_small_mod. scalar_val! tmp%2)
           )
           (=>
            (ens%vstd!arithmetic.div_mod.lemma_small_mod. scalar_val! tmp%2)
            (=>
             %%location_label%%3
             (= (EucMod scalar_val! (vstd!arithmetic.power2.pow2.? (I (nClip (Mul w! digits_count!)))))
              scalar_val!
        ...
        (or
         (and
          (=>
           ...
           (and
            (=>
             (= tmp%3 (%Poly%vstd!seq.Seq<i8.>. (vstd!seq.Seq.subrange.? $ (SINT 8) (vstd!view.View.view.?
                 $ (ARRAY $ (SINT 8) $ (CONST_INT 64)) (Poly%array%. digits!)
                ) (I 0) (I 33)
             )))
             (and
              (=>
               ...
               (=>
                ...
                (= (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.? (vstd!seq.Seq.subrange.?
                   $ (SINT 8) (vstd!view.View.view.? $ (ARRAY $ (SINT 8) $ (CONST_INT 64)) (Poly%array%.
                    ...
                    $ (SINT 8) (vstd!seq.Seq.subrange.? $ (SINT 8) (vstd!view.View.view.? $ (ARRAY $ (SINT
                        8
                       ) $ (CONST_INT 64)
                      ) (Poly%array%. digits!)
                     ) (I 0) (I 33)
                  ...
                  ) (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul w! 32)))) (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.?
                    (vstd!seq.Seq.subrange.? $ (SINT 8) (vstd!seq.Seq.subrange.? $ (SINT 8) (vstd!view.View.view.?
                       $ (ARRAY $ (SINT 8) $ (CONST_INT 64)) (Poly%array%. digits!)
                      ) (I 0) (I 33)
                     ) (I 32) (I (vstd!seq.Seq.len.? $ (SINT 8) (vstd!seq.Seq.subrange.? $ (SINT 8) (vstd!view.View.view.?
                         $ (ARRAY $ (SINT 8) $ (CONST_INT 64)) (Poly%array%. digits!)
                        ) (I 0) (I 33)
                     )))
                    ) (I w!)
            ...
            (=>
             ...
             (=>
              (= tmp%4 (ext_eq false (TYPE%vstd!seq.Seq. $ (SINT 8)) (vstd!seq.Seq.subrange.? $ (SINT
                  8
              ...
              (and
               ...
               (=>
                tmp%4
                (=>
                 (= tail@ (%Poly%vstd!seq.Seq<i8.>. (vstd!seq.Seq.subrange.? $ (SINT 8) (vstd!seq.Seq.subrange.?
                     $ (SINT 8) (vstd!view.View.view.? $ (ARRAY $ (SINT 8) $ (CONST_INT 64)) (Poly%array%.
                       digits!
                      )
                     ) (I 0) (I 33)
                 ...
                 (and
                  (=>
                   (= tmp%5 (and
                     (= (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. tail@)) 1)
                     (= (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. tail@) (I 0)) (vstd!seq.Seq.index.?
                       $ (SINT 8) (vstd!view.View.view.? $ (ARRAY $ (SINT 8) $ (CONST_INT 64)) (Poly%array%.
                         digits!
                        )
                       ) (I 32)
                   ...
                   (and
                    ...
                    (=>
                     tmp%5
                     (=>
                      (= tmp%6 (= (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.? (vstd!seq.Seq.subrange.?
                          $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. tail@) (I 1) (I (vstd!seq.Seq.len.? $ (SINT 8)
                      ...
                      (and
                       ...
                       (=>
                        tmp%6
                        (=>
                         (= tmp%7 (vstd!arithmetic.power2.pow2.? (I w!)))
                         (=>
                          (ens%vstd!arithmetic.mul.lemma_mul_basics. tmp%7)
                          (=>
                           %%location_label%%9
                           (= (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.? (Poly%vstd!seq.Seq<i8.>.
                              tail@
                  ...
                  (=>
                   ...
                   (and
                    (=>
                     (= tmp%8 (vstd!arithmetic.power2.pow2.? (I (nClip (Mul w! 32)))))
                     (=>
                      (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. tmp%8 carry!)
                      (=>
                       %%location_label%%10
                       (= (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul w! 32)))) carry!) (Mul carry!
                         (vstd!arithmetic.power2.pow2.? (I (nClip (Mul w! 32))))
                    )))))
                    (=>
                     (= (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul w! 32)))) carry!) (Mul carry!
                       (vstd!arithmetic.power2.pow2.? (I (nClip (Mul w! 32))))
          ...
          (and
              ...
              (or
               (and
                (=>
                 (>= (%I j@) digits_count!)
                 (=>
                  (= tmp%9 (= (%I (vstd!seq.Seq.index.? $ (SINT 8) (vstd!view.View.view.? $ (ARRAY $ (SINT
                         8
                        ) $ (CONST_INT 64)
                       ) (Poly%array%. digits!)
                      ) j@
           ...
           (=>
            (forall ((j$ Poly)) (!
              ...
              :qid user_curve25519_dalek__lemmas__scalar_lemmas___radix_2w_lemmas__lemma_as_radix_2w_postconditions_113
              :skolemid skolem_user_curve25519_dalek__lemmas__scalar_lemmas___radix_2w_lemmas__lemma_as_radix_2w_postconditions_113
            ))
            (=>
             %%location_label%%15
             (let
