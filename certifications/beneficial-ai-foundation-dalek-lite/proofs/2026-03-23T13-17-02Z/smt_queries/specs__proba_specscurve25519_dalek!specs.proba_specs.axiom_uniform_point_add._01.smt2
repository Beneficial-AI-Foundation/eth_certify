...
;; curve25519-dalek/src/specs/proba_specs.rs:265:1: 265:101 (#0)
...
;; Function-Def curve25519_dalek::specs::proba_specs::axiom_uniform_point_add
;; curve25519-dalek/src/specs/proba_specs.rs:265:1: 265:101 (#0)
(get-info :all-statistics)
(push)
 (declare-const p1! curve25519_dalek!ristretto.RistrettoPoint.)
 (declare-const p2! curve25519_dalek!ristretto.RistrettoPoint.)
 (declare-const sum! curve25519_dalek!ristretto.RistrettoPoint.)
 (assert
  fuel_defaults
 )
 (assert
  (has_type (Poly%curve25519_dalek!ristretto.RistrettoPoint. p1!) TYPE%curve25519_dalek!ristretto.RistrettoPoint.)
 )
 (assert
  (has_type (Poly%curve25519_dalek!ristretto.RistrettoPoint. p2!) TYPE%curve25519_dalek!ristretto.RistrettoPoint.)
 )
 (assert
  (has_type (Poly%curve25519_dalek!ristretto.RistrettoPoint. sum!) TYPE%curve25519_dalek!ristretto.RistrettoPoint.)
 )
 (assert
  (= (curve25519_dalek!specs.edwards_specs.edwards_point_as_affine.? (Poly%curve25519_dalek!edwards.EdwardsPoint.
     (curve25519_dalek!ristretto.RistrettoPoint./RistrettoPoint/0 (%Poly%curve25519_dalek!ristretto.RistrettoPoint.
