...
;; curve25519-dalek/src/lemmas/ristretto_lemmas/batch_compress_lemmas.rs:519:1: 519:69 (#0)
...
;; Function-Def curve25519_dalek::lemmas::ristretto_lemmas::batch_compress_lemmas::lemma_ristretto_compress_affine_zero_xy
;; curve25519-dalek/src/lemmas/ristretto_lemmas/batch_compress_lemmas.rs:519:1: 519:69 (#0)
...
(push)
 ...
 (declare-const isq@ Int)
 (declare-const i1@ Int)
 (declare-const i2@ Int)
 (declare-const z_inv@ Int)
 (declare-const invsqrt_a_minus_d@ Int)
 (assert
  fuel_defaults
 )
 (assert
         ...
         (=>
          ...
          (=>
           (= u1@ (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_add.?
             ...
             ) (I (curve25519_dalek!specs.field_specs.field_sub.? (I z@) (I y!)))
           ))
           (=>
            (= u2@ (curve25519_dalek!specs.field_specs.field_square.? (I t@)))
            (and
             (and
              (and
               (=>
              ...
              (=>
               ...
               (and
                ...
                (=>
                 ...
                 (=>
                  %%location_label%%7
                  (= (curve25519_dalek!specs.field_specs.field_mul.? (I u1@) (I u2@)) 0)
             )))))
             (=>
              (= (curve25519_dalek!specs.field_specs.field_mul.? (I u1@) (I u2@)) 0)
              (=>
               (= isq@ (curve25519_dalek!specs.field_specs.nat_invsqrt.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                   (I u1@) (I u2@)
               ))))
               (and
                (and
                 ...
                 (and
                  (and
                   ...
                   (=>
                    ...
                    (=>
                     %%location_label%%11
                     (= (curve25519_dalek!specs.field_specs.field_mul.? (I isq@) (I u1@)) 0)
                  )))
                  (=>
                   (= (curve25519_dalek!specs.field_specs.field_mul.? (I isq@) (I u1@)) 0)
                   (and
                    (and
                     ...
                     (=>
                      ...
                      (=>
                       %%location_label%%13
                       (= (curve25519_dalek!specs.field_specs.field_mul.? (I isq@) (I t@)) 0)
                    )))
                    (=>
                     (= (curve25519_dalek!specs.field_specs.field_mul.? (I isq@) (I t@)) 0)
                     (=>
                      (= i1@ (curve25519_dalek!specs.field_specs.field_mul.? (I isq@) (I u1@)))
                      (=>
                       (= i2@ (curve25519_dalek!specs.field_specs.field_mul.? (I isq@) (I t@)))
                       (and
                        (and
                         (=>
                          %%location_label%%14
                         ...
                         (=>
                          ...
                          (=>
                           %%location_label%%15
                           (= (curve25519_dalek!specs.field_specs.field_mul.? (I i2@) (I t@)) 0)
                        )))
                        (=>
                         (= (curve25519_dalek!specs.field_specs.field_mul.? (I i2@) (I t@)) 0)
                         (and
                          (=>
                           (= tmp%2 (curve25519_dalek!specs.field_specs.field_mul.? (I i2@) (I t@)))
                           (and
                            (=>
                             %%location_label%%16
                             (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_zero_left.
                          ...
                          (=>
                           ...
                           (=>
                            ...
                            (=>
                             (= invsqrt_a_minus_d@ (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (
                                Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. curve25519_dalek!backend.serial.u64.constants.INVSQRT_A_MINUS_D.?
                             )))
                             (and
                              (and
                               (=>
                               ...
                               (=>
                                ...
                                (=>
                                 %%location_label%%19
                                 (= (curve25519_dalek!specs.field_specs.field_mul.? (I i1@) (I invsqrt_a_minus_d@))
                                  0
                              ))))
                              (=>
                               (= (curve25519_dalek!specs.field_specs.field_mul.? (I i1@) (I invsqrt_a_minus_d@))
                                ...
                                (and
                                 (and
                                  ...
                                  (=>
                                   ...
                                   (=>
                                    %%location_label%%21
                                    (= (curve25519_dalek!specs.field_specs.field_mul.? (I t@) (I z_inv@)) 0)
                                 )))
                                 (=>
                                  (= (curve25519_dalek!specs.field_specs.field_mul.? (I t@) (I z_inv@)) 0)
                                  (=>
                                   %%location_label%%22
                                   (not (curve25519_dalek!specs.field_specs.is_negative.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                                       (I t@) (I z_inv@)
                                )))))))
                                (=>
                                 (not (curve25519_dalek!specs.field_specs.is_negative.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                                 ...
                                 (and
                                  (and
                                   (and
                                    ...
                                    (=>
                                     ...
                                     (=>
                                      %%location_label%%24
                                      (= (curve25519_dalek!specs.field_specs.field_mul.? (I x!) (I z_inv@)) 0)
                                   )))
                                   (=>
                                    (= (curve25519_dalek!specs.field_specs.field_mul.? (I x!) (I z_inv@)) 0)
                                    (=>
                                  ...
                                  (=>
                                   ...
                                   (and
                                    (=>
                                     (= tmp%3 (curve25519_dalek!specs.field_specs.field_sub.? (I z@) (I y!)))
                                     (and
                                      (=>
                                       %%location_label%%26
                                       (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_zero_left.
                                      ...
                                      (=>
                                       ...
                                       (=>
                                        %%location_label%%27
                                        (= (curve25519_dalek!specs.field_specs.field_mul.? (I i2@) (I (curve25519_dalek!specs.field_specs.field_sub.?
                                            (I z@) (I y!)
                                          ))
                                         ) 0
                                    )))))
