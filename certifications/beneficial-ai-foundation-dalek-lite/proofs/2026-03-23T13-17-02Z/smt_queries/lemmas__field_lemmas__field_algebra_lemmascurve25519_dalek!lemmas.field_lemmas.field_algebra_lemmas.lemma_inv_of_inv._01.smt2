...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:1298:1: 1298:38 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_inv_of_inv
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:1298:1: 1298:38 (#0)
 ...
 (assert
  (not (=>
    ...
    (=>
     ...
     (=>
      (= inv_x@ (curve25519_dalek!specs.field_specs.field_inv.? (I x!)))
      (=>
       (= x_mod@ (EucMod x! p@))
       (or
        (and
             ...
             (=>
              ...
              (and
               ...
               (=>
                ...
                (=>
                 %%location_label%%4
                 (= (curve25519_dalek!specs.field_specs.field_inv.? (I inv_x@)) x_mod@)
           ))))))
           (=>
            (= (curve25519_dalek!specs.field_specs.field_inv.? (I inv_x@)) x_mod@)
            (=>
        ...
        (and
         ...
         (and
          (and
           (=>
            %%location_label%%6
            (req%curve25519_dalek!specs.field_specs.field_inv_property. x!)
           )
           (=>
            (ens%curve25519_dalek!specs.field_specs.field_inv_property. x!)
            (=>
             %%location_label%%7
             (and
              (< inv_x@ p@)
              (= (EucMod (nClip (Mul (EucMod x! p@) inv_x@)) p@) 1)
          ))))
          (=>
           (and
            (< inv_x@ p@)
           ...
           (and
            (and
             (=>
              %%location_label%%8
              (req%vstd!arithmetic.div_mod.lemma_small_mod. inv_x@ p@)
             )
             (=>
              (ens%vstd!arithmetic.div_mod.lemma_small_mod. inv_x@ p@)
              (or
               (and
                (=>
                 (= inv_x@ 0)
            ...
            (=>
             ...
             (and
              (and
               (=>
                %%location_label%%12
                (req%vstd!arithmetic.div_mod.lemma_mod_bound. x! p@)
               )
               (=>
                (ens%vstd!arithmetic.div_mod.lemma_mod_bound. x! p@)
                (=>
                 %%location_label%%13
                 (< x_mod@ p@)
              )))
               ...
               (and
                (and
                 ...
                 (=>
                  (ens%vstd!arithmetic.div_mod.lemma_small_mod. inv_x@ p@)
                  (=>
                   (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. inv_x@ x_mod@)
                   (=>
                    %%location_label%%15
                    (= (EucMod (nClip (Mul (EucMod inv_x@ p@) x_mod@)) p@) 1)
                ))))
                (=>
                 (= (EucMod (nClip (Mul (EucMod inv_x@ p@) x_mod@)) p@) 1)
                 (and
                  (and
                   (=>
                    %%location_label%%16
                    (req%curve25519_dalek!specs.field_specs.field_inv_unique. inv_x@ x_mod@)
                   )
                   (=>
                    (ens%curve25519_dalek!specs.field_specs.field_inv_unique. inv_x@ x_mod@)
                    (=>
                     %%location_label%%17
                     (= (curve25519_dalek!specs.field_specs.field_inv.? (I inv_x@)) x_mod@)
                  )))
