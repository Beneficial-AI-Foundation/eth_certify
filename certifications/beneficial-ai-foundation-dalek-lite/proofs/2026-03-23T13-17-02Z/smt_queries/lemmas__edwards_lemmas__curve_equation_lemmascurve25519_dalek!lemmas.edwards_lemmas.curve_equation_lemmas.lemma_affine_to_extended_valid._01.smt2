...
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:296:1: 296:68 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::curve_equation_lemmas::lemma_affine_to_extended_valid
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:296:1: 296:68 (#0)
       ...
       (and
        (=>
         ...
         (=>
          ...
          (=>
           (= z2@ (curve25519_dalek!specs.field_specs.field_square.? (I 1)))
           (=>
            (= z4@ (curve25519_dalek!specs.field_specs.field_square.? (I z2@)))
            (=>
             (= d@ (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
               ...
               (and
                ...
                (=>
                 ...
                 (=>
                  ...
                  (and
                   (=>
                    (= tmp%1 (curve25519_dalek!specs.field_specs.field_sub.? (I y2@) (I x2@)))
                    (=>
                     (ens%vstd!arithmetic.mul.lemma_mul_basics. tmp%1)
                     (=>
                      (= tmp%2 (Sub (nClip (Add (EucMod y2@ p@) p@)) (EucMod x2@ p@)))
                      (and
                       (=>
                        %%location_label%%6
                   ...
                   (=>
                    ...
                    (=>
                     ...
                     (=>
                      (= tmp%3 (= rhs@ (curve25519_dalek!specs.field_specs.field_add.? (I 1) (I (curve25519_dalek!specs.field_specs.field_mul.?
                           (I d@) (I (curve25519_dalek!specs.field_specs.field_mul.? (I x2@) (I y2@)))
                      )))))
                      (and
                       (=>
                       ...
                       (=>
                        tmp%3
                        (=>
                         (= tmp%4 (= (curve25519_dalek!specs.field_specs.field_sub.? (I y2@) (I x2@)) (curve25519_dalek!specs.field_specs.field_add.?
                            (I 1) (I (curve25519_dalek!specs.field_specs.field_mul.? (I d@) (I (curve25519_dalek!specs.field_specs.field_mul.?
                                (I x2@) (I y2@)
                         )))))))
                         (and
                          (=>
        ...
        (=>
         ...
         (and
          (=>
           (= tmp%6 (= t! (curve25519_dalek!specs.field_specs.field_mul.? (I x!) (I y!))))
           (and
            (=>
             %%location_label%%12
             tmp%6
              ...
              (=>
               ...
               (and
                ...
                (=>
                 ...
                 (=>
                  (ens%vstd!arithmetic.mul.lemma_mul_basics. t!)
                  (=>
                   %%location_label%%16
