...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:2607:1: 2607:62 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_pm_plus_mp
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:2607:1: 2607:62 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= neg_d@ (curve25519_dalek!specs.field_specs.field_neg.? (I d!)))
    (=>
     (= ac@ (curve25519_dalek!specs.field_specs.field_mul.? (I a!) (I c!)))
     (=>
      (= bd@ (curve25519_dalek!specs.field_specs.field_mul.? (I b!) (I d!)))
      (=>
       ...
       (and
        (=>
         (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_pp_plus_mm. a!
          b! c! neg_d@
         )
         (=>
          %%location_label%%0
          (= (curve25519_dalek!specs.field_specs.field_add.? (I (curve25519_dalek!specs.field_specs.field_mul.?
              ...
              ) (I (curve25519_dalek!specs.field_specs.field_sub.? (I c!) (I neg_d@)))
            ))
           ) (curve25519_dalek!specs.field_specs.field_mul.? (I 2) (I (curve25519_dalek!specs.field_specs.field_add.?
              (I ac@) (I (curve25519_dalek!specs.field_specs.field_mul.? (I b!) (I neg_d@)))
        ))))))
        (=>
         (= (curve25519_dalek!specs.field_specs.field_add.? (I (curve25519_dalek!specs.field_specs.field_mul.?
             (I (curve25519_dalek!specs.field_specs.field_add.? (I a!) (I b!))) (I (curve25519_dalek!specs.field_specs.field_add.?
         ...
         (and
          (=>
           ...
           (=>
            %%location_label%%1
            (= (curve25519_dalek!specs.field_specs.field_mul.? (I b!) (I neg_d@)) (curve25519_dalek!specs.field_specs.field_neg.?
              (I bd@)
          ))))
          (=>
           (= (curve25519_dalek!specs.field_specs.field_mul.? (I b!) (I neg_d@)) (curve25519_dalek!specs.field_specs.field_neg.?
           ...
           (and
            (=>
             ...
             (=>
              %%location_label%%2
              (= (curve25519_dalek!specs.field_specs.field_add.? (I ac@) (I (curve25519_dalek!specs.field_specs.field_neg.?
                  (I bd@)
                ))
               ) (curve25519_dalek!specs.field_specs.field_sub.? (I ac@) (I bd@))
            )))
            (=>
             (= (curve25519_dalek!specs.field_specs.field_add.? (I ac@) (I (curve25519_dalek!specs.field_specs.field_neg.?
                 (I bd@)
