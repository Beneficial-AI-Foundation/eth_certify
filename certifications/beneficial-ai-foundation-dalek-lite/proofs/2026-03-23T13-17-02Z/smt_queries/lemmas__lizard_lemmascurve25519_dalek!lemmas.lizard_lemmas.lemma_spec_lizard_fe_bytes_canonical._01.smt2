...
;; curve25519-dalek/src/lemmas/lizard_lemmas.rs:1202:5: 1202:11 (#0)
...
;; Function-Specs curve25519_dalek::lemmas::lizard_lemmas::lemma_mdouble_invsqrt_a_minus_d_bounded_51
(declare-fun ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_mdouble_invsqrt_a_minus_d_bounded_51.
 (Int) Bool
)
(assert
 (forall ((no%param Int)) (!
   (= (ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_mdouble_invsqrt_a_minus_d_bounded_51.
     no%param
    ) (curve25519_dalek!specs.field_specs.fe51_limbs_bounded.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
      curve25519_dalek!lizard.u64_constants.MDOUBLE_INVSQRT_A_MINUS_D.?
     ) (I 51)
   ))
   :pattern ((ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_mdouble_invsqrt_a_minus_d_bounded_51.
     no%param
   ))
   :qid internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_mdouble_invsqrt_a_minus_d_bounded_51._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_mdouble_invsqrt_a_minus_d_bounded_51._definition
)))

;; Function-Specs curve25519_dalek::lemmas::lizard_lemmas::lemma_minvsqrt_one_plus_d_bounded_51
(declare-fun ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_minvsqrt_one_plus_d_bounded_51.
 (Int) Bool
)
(assert
 (forall ((no%param Int)) (!
   (= (ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_minvsqrt_one_plus_d_bounded_51.
     no%param
    ) (curve25519_dalek!specs.field_specs.fe51_limbs_bounded.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
      curve25519_dalek!lizard.u64_constants.MINVSQRT_ONE_PLUS_D.?
     ) (I 51)
   ))
   :pattern ((ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_minvsqrt_one_plus_d_bounded_51.
     no%param
   ))
   :qid internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_minvsqrt_one_plus_d_bounded_51._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_minvsqrt_one_plus_d_bounded_51._definition
)))

;; Function-Specs curve25519_dalek::lemmas::lizard_lemmas::lemma_midouble_invsqrt_a_minus_d_bounded_51
(declare-fun ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_midouble_invsqrt_a_minus_d_bounded_51.
 (Int) Bool
)
(assert
 (forall ((no%param Int)) (!
   (= (ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_midouble_invsqrt_a_minus_d_bounded_51.
     no%param
    ) (curve25519_dalek!specs.field_specs.fe51_limbs_bounded.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
      curve25519_dalek!lizard.u64_constants.MIDOUBLE_INVSQRT_A_MINUS_D.?
     ) (I 51)
   ))
   :pattern ((ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_midouble_invsqrt_a_minus_d_bounded_51.
     no%param
   ))
   :qid internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_midouble_invsqrt_a_minus_d_bounded_51._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_midouble_invsqrt_a_minus_d_bounded_51._definition
)))

;; Function-Specs curve25519_dalek::lemmas::lizard_lemmas::lemma_invsqrt_bridge
(declare-fun req%curve25519_dalek!lemmas.lizard_lemmas.lemma_invsqrt_bridge. (Int Int
  Bool Int
 ) Bool
)
...
(assert
 (forall ((gamma_arg_nat! Int) (gamma_nat! Int) (gamma_sq_val! Bool) (one_canonical!
    Int
   )
  ) (!
   (= (req%curve25519_dalek!lemmas.lizard_lemmas.lemma_invsqrt_bridge. gamma_arg_nat!
     gamma_nat! gamma_sq_val! one_canonical!
    ) (and
     (=>
      %%global_location_label%%57
      (< gamma_arg_nat! (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
     )
     (=>
      %%global_location_label%%58
      (< gamma_nat! (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
     )
     (=>
      %%global_location_label%%59
      (= (EucMod gamma_nat! 2) 0)
     )
     (=>
     ...
     (=>
      ...
      (=>
       gamma_sq_val!
       (curve25519_dalek!specs.field_specs.is_sqrt_ratio.? (I one_canonical!) (I gamma_arg_nat!)
        (I gamma_nat!)
     )))
     (=>
      ...
      (=>
       ...
       (curve25519_dalek!specs.field_specs.is_sqrt_ratio_times_i.? (I one_canonical!) (I gamma_arg_nat!)
        (I gamma_nat!)
     )))
     (=>
   ...
   :pattern ((req%curve25519_dalek!lemmas.lizard_lemmas.lemma_invsqrt_bridge. gamma_arg_nat!
     gamma_nat! gamma_sq_val! one_canonical!
   ))
   :qid internal_req__curve25519_dalek!lemmas.lizard_lemmas.lemma_invsqrt_bridge._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.lizard_lemmas.lemma_invsqrt_bridge._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_invsqrt_bridge. (Int Int
  Bool Int
 ) Bool
)
(assert
 (forall ((gamma_arg_nat! Int) (gamma_nat! Int) (gamma_sq_val! Bool) (one_canonical!
   ...
   (= (ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_invsqrt_bridge. gamma_arg_nat!
     gamma_nat! gamma_sq_val! one_canonical!
    ) (= gamma_nat! (curve25519_dalek!specs.field_specs.nat_invsqrt.? (I gamma_arg_nat!)))
   )
   :pattern ((ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_invsqrt_bridge. gamma_arg_nat!
     gamma_nat! gamma_sq_val! one_canonical!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_invsqrt_bridge._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_invsqrt_bridge._definition
)))

;; Function-Specs curve25519_dalek::lemmas::lizard_lemmas::axiom_jacobi_quartic_birational_pair01
(declare-fun req%curve25519_dalek!lemmas.lizard_lemmas.axiom_jacobi_quartic_birational_pair01.
...
(assert
 (forall ((point! curve25519_dalek!edwards.EdwardsPoint.)) (!
   (= (req%curve25519_dalek!lemmas.lizard_lemmas.axiom_jacobi_quartic_birational_pair01.
     point!
    ) (=>
   ...
   :pattern ((req%curve25519_dalek!lemmas.lizard_lemmas.axiom_jacobi_quartic_birational_pair01.
     point!
   ))
   :qid internal_req__curve25519_dalek!lemmas.lizard_lemmas.axiom_jacobi_quartic_birational_pair01._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.lizard_lemmas.axiom_jacobi_quartic_birational_pair01._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.lizard_lemmas.axiom_jacobi_quartic_birational_pair01.
 (curve25519_dalek!edwards.EdwardsPoint.) Bool
)
(assert
 (forall ((point! curve25519_dalek!edwards.EdwardsPoint.)) (!
   (= (ens%curve25519_dalek!lemmas.lizard_lemmas.axiom_jacobi_quartic_birational_pair01.
     point!
    ) (let
     ((tmp%%$ (curve25519_dalek!specs.edwards_specs.edwards_point_as_affine.? (Poly%curve25519_dalek!edwards.EdwardsPoint.
         point!
     ))))
     (let
      ...
      (let
       ...
       (let
        ((coset$ (curve25519_dalek!specs.ristretto_specs.ristretto_coset_affine.? (I x$) (I y$))))
        (let
         ((jcs$ (curve25519_dalek!specs.lizard_specs.spec_to_jacobi_quartic_ristretto.? (Poly%curve25519_dalek!edwards.EdwardsPoint.
             point!
         ))))
         (=>
          (and
          ...
          (and
           (= (curve25519_dalek!specs.lizard_specs.jacobi_to_edwards_affine.? (tuple%2./tuple%2/0
              (%Poly%tuple%2. (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2. $ NAT $ NAT) (vstd!view.View.view.?
                 $ (ARRAY (DST $) (TYPE%tuple%2. $ NAT $ NAT) $ (CONST_INT 4)) (Poly%array%. jcs$)
                ) (I 0)
              ))
   ...
   :pattern ((ens%curve25519_dalek!lemmas.lizard_lemmas.axiom_jacobi_quartic_birational_pair01.
     point!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.lizard_lemmas.axiom_jacobi_quartic_birational_pair01._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.lizard_lemmas.axiom_jacobi_quartic_birational_pair01._definition
)))

;; Function-Specs curve25519_dalek::lemmas::lizard_lemmas::axiom_jacobi_quartic_torsion_pair23
(declare-fun req%curve25519_dalek!lemmas.lizard_lemmas.axiom_jacobi_quartic_torsion_pair23.
 (curve25519_dalek!edwards.EdwardsPoint.) Bool
)
(declare-const %%global_location_label%%65 Bool)
(assert
 (forall ((point! curve25519_dalek!edwards.EdwardsPoint.)) (!
   (= (req%curve25519_dalek!lemmas.lizard_lemmas.axiom_jacobi_quartic_torsion_pair23.
     point!
    ) (=>
   ...
   :pattern ((req%curve25519_dalek!lemmas.lizard_lemmas.axiom_jacobi_quartic_torsion_pair23.
     point!
   ))
   :qid internal_req__curve25519_dalek!lemmas.lizard_lemmas.axiom_jacobi_quartic_torsion_pair23._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.lizard_lemmas.axiom_jacobi_quartic_torsion_pair23._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.lizard_lemmas.axiom_jacobi_quartic_torsion_pair23.
 (curve25519_dalek!edwards.EdwardsPoint.) Bool
)
(assert
 (forall ((point! curve25519_dalek!edwards.EdwardsPoint.)) (!
   (= (ens%curve25519_dalek!lemmas.lizard_lemmas.axiom_jacobi_quartic_torsion_pair23.
     point!
    ) (let
     ((tmp%%$ (curve25519_dalek!specs.edwards_specs.edwards_point_as_affine.? (Poly%curve25519_dalek!edwards.EdwardsPoint.
         point!
   ...
   :pattern ((ens%curve25519_dalek!lemmas.lizard_lemmas.axiom_jacobi_quartic_torsion_pair23.
     point!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.lizard_lemmas.axiom_jacobi_quartic_torsion_pair23._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.lizard_lemmas.axiom_jacobi_quartic_torsion_pair23._definition
)))

;; Function-Specs curve25519_dalek::lemmas::lizard_lemmas::lemma_jq_edge_case_values
(declare-fun req%curve25519_dalek!lemmas.lizard_lemmas.lemma_jq_edge_case_values.
 (curve25519_dalek!edwards.EdwardsPoint.) Bool
)
(declare-const %%global_location_label%%66 Bool)
(assert
 (forall ((point! curve25519_dalek!edwards.EdwardsPoint.)) (!
   (= (req%curve25519_dalek!lemmas.lizard_lemmas.lemma_jq_edge_case_values. point!) (
     =>
     %%global_location_label%%66
     (curve25519_dalek!specs.edwards_specs.is_well_formed_edwards_point.? (Poly%curve25519_dalek!edwards.EdwardsPoint.
       point!
   ))))
   :pattern ((req%curve25519_dalek!lemmas.lizard_lemmas.lemma_jq_edge_case_values. point!))
   :qid internal_req__curve25519_dalek!lemmas.lizard_lemmas.lemma_jq_edge_case_values._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.lizard_lemmas.lemma_jq_edge_case_values._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_jq_edge_case_values.
 (curve25519_dalek!edwards.EdwardsPoint.) Bool
)
(assert
 (forall ((point! curve25519_dalek!edwards.EdwardsPoint.)) (!
   (= (ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_jq_edge_case_values. point!) (
     let
     ((tmp%%$ (curve25519_dalek!specs.edwards_specs.edwards_point_as_nat.? (Poly%curve25519_dalek!edwards.EdwardsPoint.
         point!
     ))))
     (let
      ((xn$ (%I (tuple%4./tuple%4/0 (%Poly%tuple%4. (Poly%tuple%4. tmp%%$))))))
            ...
            (and
             (and
              ...
              (= (%Poly%tuple%2. (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2. $ NAT $ NAT) (vstd!view.View.view.?
               ...
               ) (tuple%2./tuple%2 (I 1) (I mc$))
             ))
             (= (%Poly%tuple%2. (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2. $ NAT $ NAT) (vstd!view.View.view.?
                 $ (ARRAY (DST $) (TYPE%tuple%2. $ NAT $ NAT) $ (CONST_INT 4)) (Poly%array%. jcs$)
                ) (I 3)
               )
              ) (tuple%2./tuple%2 (I (curve25519_dalek!specs.field_specs.field_neg.? (I 1))) (I mc$))
   )))))))))))
   :pattern ((ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_jq_edge_case_values. point!))
   :qid internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_jq_edge_case_values._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_jq_edge_case_values._definition
)))

;; Function-Specs curve25519_dalek::lemmas::lizard_lemmas::lemma_jacobi_to_edwards_affine_s_zero
(declare-fun ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_jacobi_to_edwards_affine_s_zero.
 (Int) Bool
)
(assert
 (forall ((t! Int)) (!
   (= (ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_jacobi_to_edwards_affine_s_zero.
     t!
    ) (= (curve25519_dalek!specs.lizard_specs.jacobi_to_edwards_affine.? (I 0) (I t!))
     (tuple%2./tuple%2 (I 0) (I 1))
   ))
   :pattern ((ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_jacobi_to_edwards_affine_s_zero.
     t!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_jacobi_to_edwards_affine_s_zero._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_jacobi_to_edwards_affine_s_zero._definition
)))

;; Function-Specs curve25519_dalek::lemmas::lizard_lemmas::lemma_jacobi_to_edwards_affine_y_zero_when_s_sq_one
(declare-fun req%curve25519_dalek!lemmas.lizard_lemmas.lemma_jacobi_to_edwards_affine_y_zero_when_s_sq_one.
 (Int Int) Bool
)
(declare-const %%global_location_label%%67 Bool)
(assert
 (forall ((s! Int) (t! Int)) (!
   (= (req%curve25519_dalek!lemmas.lizard_lemmas.lemma_jacobi_to_edwards_affine_y_zero_when_s_sq_one.
     s! t!
    ) (=>
     %%global_location_label%%67
     (= (curve25519_dalek!specs.field_specs.field_square.? (I s!)) 1)
   ))
   :pattern ((req%curve25519_dalek!lemmas.lizard_lemmas.lemma_jacobi_to_edwards_affine_y_zero_when_s_sq_one.
     s! t!
   ))
   :qid internal_req__curve25519_dalek!lemmas.lizard_lemmas.lemma_jacobi_to_edwards_affine_y_zero_when_s_sq_one._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.lizard_lemmas.lemma_jacobi_to_edwards_affine_y_zero_when_s_sq_one._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_jacobi_to_edwards_affine_y_zero_when_s_sq_one.
 (Int Int) Bool
)
(assert
 (forall ((s! Int) (t! Int)) (!
   (= (ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_jacobi_to_edwards_affine_y_zero_when_s_sq_one.
     s! t!
    ) (= (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. (curve25519_dalek!specs.lizard_specs.jacobi_to_edwards_affine.?
          (I s!) (I t!)
      ))))
     ) 0
   ))
   :pattern ((ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_jacobi_to_edwards_affine_y_zero_when_s_sq_one.
     s! t!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_jacobi_to_edwards_affine_y_zero_when_s_sq_one._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_jacobi_to_edwards_affine_y_zero_when_s_sq_one._definition
)))

;; Function-Specs curve25519_dalek::lemmas::lizard_lemmas::axiom_mc_times_sqrt_ad_m1
(declare-fun ens%curve25519_dalek!lemmas.lizard_lemmas.axiom_mc_times_sqrt_ad_m1.
 (Int) Bool
)
(assert
 (forall ((no%param Int)) (!
   (= (ens%curve25519_dalek!lemmas.lizard_lemmas.axiom_mc_times_sqrt_ad_m1. no%param)
    (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.lizard_specs.midouble_invsqrt_a_minus_d.?
        (I 0)
       )
      ) (I (curve25519_dalek!specs.ristretto_specs.spec_sqrt_ad_minus_one.? (I 0)))
     ) (curve25519_dalek!specs.field_specs.field_mul.? (I 2) (I (curve25519_dalek!specs.field_specs.sqrt_m1.?
        (I 0)
   )))))
   :pattern ((ens%curve25519_dalek!lemmas.lizard_lemmas.axiom_mc_times_sqrt_ad_m1. no%param))
   :qid internal_ens__curve25519_dalek!lemmas.lizard_lemmas.axiom_mc_times_sqrt_ad_m1._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.lizard_lemmas.axiom_mc_times_sqrt_ad_m1._definition
)))

;; Function-Specs curve25519_dalek::lemmas::lizard_lemmas::lemma_jq_four_torsion_images
(declare-fun ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_jq_four_torsion_images.
 (Int) Bool
)
(assert
 (forall ((no%param Int)) (!
   (= (ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_jq_four_torsion_images. no%param)
    (and
     (= (curve25519_dalek!specs.lizard_specs.jacobi_to_edwards_affine.? (I 1) (I (curve25519_dalek!specs.lizard_specs.midouble_invsqrt_a_minus_d.?
         (I 0)
       ))
      ) (tuple%2./tuple%2 (I (curve25519_dalek!specs.field_specs.field_neg.? (I (curve25519_dalek!specs.field_specs.sqrt_m1.?
           (I 0)
        )))
       ) (I 0)
     ))
     (= (curve25519_dalek!specs.lizard_specs.jacobi_to_edwards_affine.? (I (curve25519_dalek!specs.field_specs.field_neg.?
         (I 1)
        )
       ) (I (curve25519_dalek!specs.lizard_specs.midouble_invsqrt_a_minus_d.? (I 0)))
      ) (tuple%2./tuple%2 (I (curve25519_dalek!specs.field_specs.sqrt_m1.? (I 0))) (I 0))
   )))
   :pattern ((ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_jq_four_torsion_images.
     no%param
   ))
   :qid internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_jq_four_torsion_images._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_jq_four_torsion_images._definition
)))

;; Function-Specs curve25519_dalek::lemmas::lizard_lemmas::lemma_jacobi_quartic_edge_values
(declare-fun req%curve25519_dalek!lemmas.lizard_lemmas.lemma_jacobi_quartic_edge_values.
 (curve25519_dalek!edwards.EdwardsPoint.) Bool
)
(declare-const %%global_location_label%%68 Bool)
(assert
 (forall ((point! curve25519_dalek!edwards.EdwardsPoint.)) (!
   (= (req%curve25519_dalek!lemmas.lizard_lemmas.lemma_jacobi_quartic_edge_values. point!)
    (=>
     %%global_location_label%%68
     (curve25519_dalek!specs.edwards_specs.is_well_formed_edwards_point.? (Poly%curve25519_dalek!edwards.EdwardsPoint.
       point!
   ))))
   :pattern ((req%curve25519_dalek!lemmas.lizard_lemmas.lemma_jacobi_quartic_edge_values.
     point!
   ))
   :qid internal_req__curve25519_dalek!lemmas.lizard_lemmas.lemma_jacobi_quartic_edge_values._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.lizard_lemmas.lemma_jacobi_quartic_edge_values._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_jacobi_quartic_edge_values.
 (curve25519_dalek!edwards.EdwardsPoint.) Bool
)
(assert
 (forall ((point! curve25519_dalek!edwards.EdwardsPoint.)) (!
   (= (ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_jacobi_quartic_edge_values. point!)
    (let
     ((tmp%%$ (curve25519_dalek!specs.edwards_specs.edwards_point_as_affine.? (Poly%curve25519_dalek!edwards.EdwardsPoint.
         point!
     ))))
          ...
          (forall ((i$ Poly)) (!
            (=>
             ...
             (=>
              ...
              (let
               ((ji$ (curve25519_dalek!specs.lizard_specs.jacobi_to_edwards_affine.? (tuple%2./tuple%2/0
                   (%Poly%tuple%2. (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2. $ NAT $ NAT) (vstd!view.View.view.?
                      $ (ARRAY (DST $) (TYPE%tuple%2. $ NAT $ NAT) $ (CONST_INT 4)) (Poly%array%. jcs$)
                     ) i$
                   ))
               ...
               (or
                (or
                 (or
                  (= ji$ (%Poly%tuple%2. (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2. $ NAT $ NAT) (vstd!view.View.view.?
                      $ (ARRAY (DST $) (TYPE%tuple%2. $ NAT $ NAT) $ (CONST_INT 4)) (Poly%array%. coset$)
                     ) (I 0)
                  )))
                  (= ji$ (%Poly%tuple%2. (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2. $ NAT $ NAT) (vstd!view.View.view.?
            ...
            :pattern ((vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2. $ NAT $ NAT) (vstd!view.View.view.?
               $ (ARRAY (DST $) (TYPE%tuple%2. $ NAT $ NAT) $ (CONST_INT 4)) (Poly%array%. coset$)
              ) i$
            ))
            :qid user_curve25519_dalek__lemmas__lizard_lemmas__lemma_jacobi_quartic_edge_values_45
            :skolemid skolem_user_curve25519_dalek__lemmas__lizard_lemmas__lemma_jacobi_quartic_edge_values_45
   )))))))))
   :pattern ((ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_jacobi_quartic_edge_values.
     point!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_jacobi_quartic_edge_values._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_jacobi_quartic_edge_values._definition
)))

;; Function-Specs curve25519_dalek::lemmas::lizard_lemmas::lemma_coset_bridge
(declare-fun req%curve25519_dalek!lemmas.lizard_lemmas.lemma_coset_bridge. (curve25519_dalek!edwards.EdwardsPoint.
...
(assert
 (forall ((point! curve25519_dalek!edwards.EdwardsPoint.) (s0! Int) (t0! Int) (s1! Int)
   (t1! Int) (s2! Int) (t2! Int) (s3! Int) (t3! Int)
  ) (!
   (= (req%curve25519_dalek!lemmas.lizard_lemmas.lemma_coset_bridge. point! s0! t0! s1!
     t1! s2! t2! s3! t3!
    ) (and
     (=>
     ...
     (=>
      ...
      (= (curve25519_dalek!specs.lizard_specs.spec_to_jacobi_quartic_ristretto.? (Poly%curve25519_dalek!edwards.EdwardsPoint.
         point!
        )
       ) (%Poly%array%. (array_new (DST $) (TYPE%tuple%2. $ NAT $ NAT) 4 (%%array%%1 (Poly%tuple%2.
           (tuple%2./tuple%2 (I s0!) (I t0!))
          ) (Poly%tuple%2. (tuple%2./tuple%2 (I s1!) (I t1!))) (Poly%tuple%2. (tuple%2./tuple%2
            (I s2!) (I t2!)
           )
          ) (Poly%tuple%2. (tuple%2./tuple%2 (I s3!) (I t3!)))
   )))))))
   :pattern ((req%curve25519_dalek!lemmas.lizard_lemmas.lemma_coset_bridge. point! s0!
     t0! s1! t1! s2! t2! s3! t3!
   ))
   :qid internal_req__curve25519_dalek!lemmas.lizard_lemmas.lemma_coset_bridge._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.lizard_lemmas.lemma_coset_bridge._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_coset_bridge. (curve25519_dalek!edwards.EdwardsPoint.
  Int Int Int Int Int Int Int Int
 ) Bool
)
(assert
 (forall ((point! curve25519_dalek!edwards.EdwardsPoint.) (s0! Int) (t0! Int) (s1! Int)
   ...
   (= (ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_coset_bridge. point! s0! t0! s1!
     t1! s2! t2! s3! t3!
    ) (let
     ((tmp%%$ (curve25519_dalek!specs.edwards_specs.edwards_point_as_affine.? (Poly%curve25519_dalek!edwards.EdwardsPoint.
         point!
       ...
       (let
        ...
        (and
         (and
          (and
           (let
            ((ji$ (curve25519_dalek!specs.lizard_specs.jacobi_to_edwards_affine.? (I s0!) (I t0!))))
            (or
             (or
              (or
               (= ji$ (%Poly%tuple%2. (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2. $ NAT $ NAT) (vstd!view.View.view.?
           ...
           (let
            ((ji$ (curve25519_dalek!specs.lizard_specs.jacobi_to_edwards_affine.? (I s1!) (I t1!))))
            (or
             (or
              (or
               (= ji$ (%Poly%tuple%2. (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2. $ NAT $ NAT) (vstd!view.View.view.?
          ...
          (let
           ((ji$ (curve25519_dalek!specs.lizard_specs.jacobi_to_edwards_affine.? (I s2!) (I t2!))))
           (or
            (or
             (or
              (= ji$ (%Poly%tuple%2. (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2. $ NAT $ NAT) (vstd!view.View.view.?
         ...
         (let
          ((ji$ (curve25519_dalek!specs.lizard_specs.jacobi_to_edwards_affine.? (I s3!) (I t3!))))
          (or
           (or
            (or
             (= ji$ (%Poly%tuple%2. (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2. $ NAT $ NAT) (vstd!view.View.view.?
   ...
   :pattern ((ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_coset_bridge. point! s0!
     t0! s1! t1! s2! t2! s3! t3!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_coset_bridge._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_coset_bridge._definition
)))

;; Function-Specs curve25519_dalek::lemmas::lizard_lemmas::lemma_jacobi_to_edwards_affine_s_canonical_zero
(declare-fun req%curve25519_dalek!lemmas.lizard_lemmas.lemma_jacobi_to_edwards_affine_s_canonical_zero.
 (Int Int) Bool
)
(declare-const %%global_location_label%%71 Bool)
(assert
 (forall ((s! Int) (t! Int)) (!
   (= (req%curve25519_dalek!lemmas.lizard_lemmas.lemma_jacobi_to_edwards_affine_s_canonical_zero.
     s! t!
    ) (=>
     %%global_location_label%%71
     (= (curve25519_dalek!specs.field_specs_u64.field_canonical.? (I s!)) 0)
   ))
   :pattern ((req%curve25519_dalek!lemmas.lizard_lemmas.lemma_jacobi_to_edwards_affine_s_canonical_zero.
     s! t!
   ))
   :qid internal_req__curve25519_dalek!lemmas.lizard_lemmas.lemma_jacobi_to_edwards_affine_s_canonical_zero._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.lizard_lemmas.lemma_jacobi_to_edwards_affine_s_canonical_zero._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_jacobi_to_edwards_affine_s_canonical_zero.
 (Int Int) Bool
)
(assert
 (forall ((s! Int) (t! Int)) (!
   (= (ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_jacobi_to_edwards_affine_s_canonical_zero.
     s! t!
    ) (= (curve25519_dalek!specs.lizard_specs.jacobi_to_edwards_affine.? (I s!) (I t!))
     (tuple%2./tuple%2 (I 0) (I 1))
   ))
   :pattern ((ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_jacobi_to_edwards_affine_s_canonical_zero.
     s! t!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_jacobi_to_edwards_affine_s_canonical_zero._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_jacobi_to_edwards_affine_s_canonical_zero._definition
)))

;; Function-Specs curve25519_dalek::lemmas::lizard_lemmas::axiom_elligator_forward_sqrt_id
(declare-fun ens%curve25519_dalek!lemmas.lizard_lemmas.axiom_elligator_forward_sqrt_id.
 (Int) Bool
)
(assert
 (forall ((no%param Int)) (!
   (= (ens%curve25519_dalek!lemmas.lizard_lemmas.axiom_elligator_forward_sqrt_id. no%param)
    (= (curve25519_dalek!specs.ristretto_specs.spec_elligator_ristretto_flavor.? (I (curve25519_dalek!specs.lizard_specs.sqrt_id.?
        (I 0)
      ))
     ) (tuple%2./tuple%2 (I 0) (I 1))
   ))
   :pattern ((ens%curve25519_dalek!lemmas.lizard_lemmas.axiom_elligator_forward_sqrt_id.
     no%param
   ))
   :qid internal_ens__curve25519_dalek!lemmas.lizard_lemmas.axiom_elligator_forward_sqrt_id._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.lizard_lemmas.axiom_elligator_forward_sqrt_id._definition
)))

;; Function-Specs curve25519_dalek::lemmas::lizard_lemmas::axiom_elligator_forward_zero
(declare-fun ens%curve25519_dalek!lemmas.lizard_lemmas.axiom_elligator_forward_zero.
 (Int) Bool
)
(assert
 (forall ((no%param Int)) (!
   (= (ens%curve25519_dalek!lemmas.lizard_lemmas.axiom_elligator_forward_zero. no%param)
    (= (curve25519_dalek!specs.ristretto_specs.spec_elligator_ristretto_flavor.? (I 0))
     (tuple%2./tuple%2 (I 0) (I 1))
   ))
   :pattern ((ens%curve25519_dalek!lemmas.lizard_lemmas.axiom_elligator_forward_zero.
     no%param
   ))
   :qid internal_ens__curve25519_dalek!lemmas.lizard_lemmas.axiom_elligator_forward_zero._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.lizard_lemmas.axiom_elligator_forward_zero._definition
)))

;; Function-Specs curve25519_dalek::lemmas::lizard_lemmas::axiom_elligator_inv_square_case
(declare-fun req%curve25519_dalek!lemmas.lizard_lemmas.axiom_elligator_inv_square_case.
...
(assert
 (forall ((s! Int) (t! Int) (a! Int) (s2! Int) (s4! Int) (inv_sq_y! Int) (y! Int) (pms2!
    Int
   ) (x! Int) (r0! Int)
  ) (!
   (= (req%curve25519_dalek!lemmas.lizard_lemmas.axiom_elligator_inv_square_case. s! t!
     a! s2! s4! inv_sq_y! y! pms2! x! r0!
    ) (and
     (=>
      %%global_location_label%%72
      (not (= (curve25519_dalek!specs.field_specs_u64.field_canonical.? (I s!)) 0))
     )
     (=>
     ...
     (=>
      ...
      (= s2! (curve25519_dalek!specs.field_specs.field_square.? (I s!)))
     )
     (=>
     ...
     (=>
      ...
      (= r0! (curve25519_dalek!specs.field_specs.field_abs.? (I x!)))
   )))
   :pattern ((req%curve25519_dalek!lemmas.lizard_lemmas.axiom_elligator_inv_square_case.
     s! t! a! s2! s4! inv_sq_y! y! pms2! x! r0!
   ))
   :qid internal_req__curve25519_dalek!lemmas.lizard_lemmas.axiom_elligator_inv_square_case._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.lizard_lemmas.axiom_elligator_inv_square_case._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.lizard_lemmas.axiom_elligator_inv_square_case.
 (Int Int Int Int Int Int Int Int Int Int) Bool
)
(assert
 (forall ((s! Int) (t! Int) (a! Int) (s2! Int) (s4! Int) (inv_sq_y! Int) (y! Int) (pms2!
   ...
   (= (ens%curve25519_dalek!lemmas.lizard_lemmas.axiom_elligator_inv_square_case. s! t!
     a! s2! s4! inv_sq_y! y! pms2! x! r0!
    ) (= (curve25519_dalek!specs.ristretto_specs.spec_elligator_ristretto_flavor.? (I r0!))
     (curve25519_dalek!specs.lizard_specs.jacobi_to_edwards_affine.? (I s!) (I t!))
   ))
   :pattern ((ens%curve25519_dalek!lemmas.lizard_lemmas.axiom_elligator_inv_square_case.
     s! t! a! s2! s4! inv_sq_y! y! pms2! x! r0!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.lizard_lemmas.axiom_elligator_inv_square_case._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.lizard_lemmas.axiom_elligator_inv_square_case._definition
)))

;; Function-Specs curve25519_dalek::lemmas::lizard_lemmas::lemma_elligator_inv_algebraic
(declare-fun ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_elligator_inv_algebraic.
 (Int Int) Bool
)
(assert
 (forall ((s! Int) (t! Int)) (!
   (= (ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_elligator_inv_algebraic. s! t!)
    (=>
     (%B (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. (curve25519_dalek!specs.lizard_specs.spec_elligator_inv.?
          (I s!) (I t!)
     )))))
     (= (curve25519_dalek!specs.ristretto_specs.spec_elligator_ristretto_flavor.? (tuple%2./tuple%2/1
        (%Poly%tuple%2. (Poly%tuple%2. (curve25519_dalek!specs.lizard_specs.spec_elligator_inv.?
           (I s!) (I t!)
       ))))
      ) (curve25519_dalek!specs.lizard_specs.jacobi_to_edwards_affine.? (I s!) (I t!))
   )))
   :pattern ((ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_elligator_inv_algebraic.
     s! t!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_elligator_inv_algebraic._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_elligator_inv_algebraic._definition
)))

;; Function-Specs curve25519_dalek::lemmas::lizard_lemmas::lemma_even_is_slot_in_coset
(declare-fun req%curve25519_dalek!lemmas.lizard_lemmas.lemma_even_is_slot_in_coset.
 (Int Int Int %%Function%%) Bool
)
...
(assert
 (forall ((fe_val! Int) (s! Int) (t! Int) (coset! %%Function%%)) (!
   (= (req%curve25519_dalek!lemmas.lizard_lemmas.lemma_even_is_slot_in_coset. fe_val!
     s! t! coset!
    ) (and
     (=>
     ...
     (=>
      ...
      (let
       ((ji$ (curve25519_dalek!specs.lizard_specs.jacobi_to_edwards_affine.? (I s!) (I t!))))
       (or
        (or
         (or
          (= ji$ (%Poly%tuple%2. (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2. $ NAT $ NAT) (vstd!view.View.view.?
   ...
   :pattern ((req%curve25519_dalek!lemmas.lizard_lemmas.lemma_even_is_slot_in_coset. fe_val!
     s! t! coset!
   ))
   :qid internal_req__curve25519_dalek!lemmas.lizard_lemmas.lemma_even_is_slot_in_coset._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.lizard_lemmas.lemma_even_is_slot_in_coset._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_even_is_slot_in_coset.
 (Int Int Int %%Function%%) Bool
)
(assert
 (forall ((fe_val! Int) (s! Int) (t! Int) (coset! %%Function%%)) (!
   (= (ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_even_is_slot_in_coset. fe_val!
     s! t! coset!
    ) (curve25519_dalek!lemmas.lizard_lemmas.is_slot_in_coset.? (I fe_val!) (Poly%array%.
      coset!
   )))
   :pattern ((ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_even_is_slot_in_coset. fe_val!
     s! t! coset!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_even_is_slot_in_coset._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_even_is_slot_in_coset._definition
)))

;; Function-Specs curve25519_dalek::lemmas::lizard_lemmas::lemma_candidate_from_jq_spec
(declare-fun ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_candidate_from_jq_spec.
 (curve25519_dalek!edwards.EdwardsPoint.) Bool
)
(assert
 (forall ((point! curve25519_dalek!edwards.EdwardsPoint.)) (!
   (= (ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_candidate_from_jq_spec. point!)
    (let
     ((spec_jcs$ (curve25519_dalek!specs.lizard_specs.spec_to_jacobi_quartic_ristretto.?
        (Poly%curve25519_dalek!edwards.EdwardsPoint. point!)
     )))
     (let
      ((c$ (curve25519_dalek!specs.lizard_specs.spec_lizard_decode_candidates.? (Poly%curve25519_dalek!edwards.EdwardsPoint.
          point!
      ))))
      (and
       (and
           ...
           (and
            (and
             (= (%Poly%tuple%2. (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2. $ BOOL $ NAT) (vstd!view.View.view.?
              ...
              ) (curve25519_dalek!specs.lizard_specs.spec_elligator_inv.? (tuple%2./tuple%2/0 (%Poly%tuple%2.
                 (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2. $ NAT $ NAT) (vstd!view.View.view.? $
                   (ARRAY (DST $) (TYPE%tuple%2. $ NAT $ NAT) $ (CONST_INT 4)) (Poly%array%. spec_jcs$)
                  ) (I 0)
                ))
               ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2. $
                   NAT $ NAT
             ...
             (= (%Poly%tuple%2. (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2. $ BOOL $ NAT) (vstd!view.View.view.?
              ...
              ) (curve25519_dalek!specs.lizard_specs.spec_elligator_inv.? (I (curve25519_dalek!specs.field_specs.field_neg.?
                 (tuple%2./tuple%2/0 (%Poly%tuple%2. (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2. $ NAT
                     $ NAT
                    ) (vstd!view.View.view.? $ (ARRAY (DST $) (TYPE%tuple%2. $ NAT $ NAT) $ (CONST_INT 4))
                     (Poly%array%. spec_jcs$)
   ...
   :pattern ((ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_candidate_from_jq_spec.
     point!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_candidate_from_jq_spec._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_candidate_from_jq_spec._definition
)))

;; Function-Specs curve25519_dalek::lemmas::lizard_lemmas::lemma_jacobi_dual_same_edwards
(declare-fun ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_jacobi_dual_same_edwards.
 (Int Int) Bool
)
(assert
 (forall ((s! Int) (t! Int)) (!
   (= (ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_jacobi_dual_same_edwards. s! t!)
    (= (curve25519_dalek!specs.lizard_specs.jacobi_to_edwards_affine.? (I (curve25519_dalek!specs.field_specs.field_neg.?
        (I s!)
       )
      ) (I (curve25519_dalek!specs.field_specs.field_neg.? (I t!)))
     ) (curve25519_dalek!specs.lizard_specs.jacobi_to_edwards_affine.? (I s!) (I t!))
   ))
   :pattern ((ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_jacobi_dual_same_edwards.
     s! t!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_jacobi_dual_same_edwards._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_jacobi_dual_same_edwards._definition
)))

;; Function-Specs curve25519_dalek::lemmas::lizard_lemmas::lemma_odd_is_slot_in_coset
(declare-fun req%curve25519_dalek!lemmas.lizard_lemmas.lemma_odd_is_slot_in_coset.
 (Int Int Int Int Int %%Function%%) Bool
)
...
(assert
 (forall ((fe_val! Int) (ns! Int) (nt! Int) (s! Int) (t! Int) (coset! %%Function%%))
  (!
   (= (req%curve25519_dalek!lemmas.lizard_lemmas.lemma_odd_is_slot_in_coset. fe_val! ns!
     nt! s! t! coset!
    ) (and
     (=>
     ...
     (=>
      ...
      (= ns! (curve25519_dalek!specs.field_specs.field_neg.? (I s!)))
     )
     (=>
      %%global_location_label%%89
      (= nt! (curve25519_dalek!specs.field_specs.field_neg.? (I t!)))
     )
     (=>
   ...
   :pattern ((req%curve25519_dalek!lemmas.lizard_lemmas.lemma_odd_is_slot_in_coset. fe_val!
     ns! nt! s! t! coset!
   ))
   :qid internal_req__curve25519_dalek!lemmas.lizard_lemmas.lemma_odd_is_slot_in_coset._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.lizard_lemmas.lemma_odd_is_slot_in_coset._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_odd_is_slot_in_coset.
 (Int Int Int Int Int %%Function%%) Bool
)
(assert
 (forall ((fe_val! Int) (ns! Int) (nt! Int) (s! Int) (t! Int) (coset! %%Function%%))
  (!
   (= (ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_odd_is_slot_in_coset. fe_val! ns!
     nt! s! t! coset!
    ) (curve25519_dalek!lemmas.lizard_lemmas.is_slot_in_coset.? (I fe_val!) (Poly%array%.
      coset!
   )))
   :pattern ((ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_odd_is_slot_in_coset. fe_val!
     ns! nt! s! t! coset!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_odd_is_slot_in_coset._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_odd_is_slot_in_coset._definition
)))

;; Function-Specs curve25519_dalek::lemmas::lizard_lemmas::lemma_h_equals_spec_lizard_fe_bytes
(declare-fun req%curve25519_dalek!lemmas.lizard_lemmas.lemma_h_equals_spec_lizard_fe_bytes.
 (%%Function%% vstd!seq.Seq<u8.>.) Bool
)
...
(assert
 (forall ((h! %%Function%%) (msg! vstd!seq.Seq<u8.>.)) (!
   (= (req%curve25519_dalek!lemmas.lizard_lemmas.lemma_h_equals_spec_lizard_fe_bytes.
     h! msg!
    ) (and
     (=>
      %%global_location_label%%91
      (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. msg!)) 16)
     )
     (=>
      ...
      (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (
       ...
       ) (uClip 8 (bitand (I (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!core_assumes.spec_sha256.?
              (Poly%vstd!seq.Seq<u8.>. msg!)
             )
            ) (I 0)
          ))
         ) (I 254)
     ...
     (=>
      ...
      (forall ((i$ Poly)) (!
        (=>
         ...
         (=>
          ...
          (= (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT
           ...
           ) (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!core_assumes.spec_sha256.?
              (Poly%vstd!seq.Seq<u8.>. msg!)
             )
            ) i$
        ))))
        ...
        :pattern ((vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!core_assumes.spec_sha256.?
            (Poly%vstd!seq.Seq<u8.>. msg!)
           )
          ) i$
        ))
        :qid user_curve25519_dalek__lemmas__lizard_lemmas__lemma_h_equals_spec_lizard_fe_bytes_68
        :skolemid skolem_user_curve25519_dalek__lemmas__lizard_lemmas__lemma_h_equals_spec_lizard_fe_bytes_68
     )))
     (=>
        ...
        (=>
         ...
         (=>
          ...
          (= (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT
           ...
           ) (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. msg!) i$)
        )))
        :pattern ((vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. msg!) i$))
        :qid user_curve25519_dalek__lemmas__lizard_lemmas__lemma_h_equals_spec_lizard_fe_bytes_69
        :skolemid skolem_user_curve25519_dalek__lemmas__lizard_lemmas__lemma_h_equals_spec_lizard_fe_bytes_69
     )))
     (=>
      ...
      (forall ((i$ Poly)) (!
        ...
        :qid user_curve25519_dalek__lemmas__lizard_lemmas__lemma_h_equals_spec_lizard_fe_bytes_70
        :skolemid skolem_user_curve25519_dalek__lemmas__lizard_lemmas__lemma_h_equals_spec_lizard_fe_bytes_70
     )))
     (=>
   ...
   :pattern ((req%curve25519_dalek!lemmas.lizard_lemmas.lemma_h_equals_spec_lizard_fe_bytes.
     h! msg!
   ))
   :qid internal_req__curve25519_dalek!lemmas.lizard_lemmas.lemma_h_equals_spec_lizard_fe_bytes._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.lizard_lemmas.lemma_h_equals_spec_lizard_fe_bytes._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_h_equals_spec_lizard_fe_bytes.
 (%%Function%% vstd!seq.Seq<u8.>.) Bool
)
(assert
 (forall ((h! %%Function%%) (msg! vstd!seq.Seq<u8.>.)) (!
   (= (ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_h_equals_spec_lizard_fe_bytes.
     h! msg!
    ) (= h! (curve25519_dalek!specs.lizard_specs.spec_lizard_fe_bytes.? (Poly%vstd!seq.Seq<u8.>.
       msg!
   ))))
   :pattern ((ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_h_equals_spec_lizard_fe_bytes.
     h! msg!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_h_equals_spec_lizard_fe_bytes._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_h_equals_spec_lizard_fe_bytes._definition
)))

;; Function-Specs curve25519_dalek::lemmas::lizard_lemmas::lemma_exec_ok_matches_spec_slot
(declare-fun req%curve25519_dalek!lemmas.lizard_lemmas.lemma_exec_ok_matches_spec_slot.
 (Bool Bool %%Function%% vstd!seq.Seq<u8.>. %%Function%% curve25519_dalek!backend.serial.u64.field.FieldElement51.
  tuple%2.
 ) Bool
)
...
(assert
 (forall ((mask_bit_set! Bool) (sha_match! Bool) (buf2! %%Function%%) (msg! vstd!seq.Seq<u8.>.)
   (h! %%Function%%) (fe_j! curve25519_dalek!backend.serial.u64.field.FieldElement51.)
   (cj! tuple%2.)
  ) (!
   (= (req%curve25519_dalek!lemmas.lizard_lemmas.lemma_exec_ok_matches_spec_slot. mask_bit_set!
     sha_match! buf2! msg! h! fe_j! cj!
    ) (and
     (=>
      ...
      (forall ((i$ Poly)) (!
        (=>
         ...
         (=>
          ...
          (= (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. msg!) i$) (vstd!seq.Seq.index.?
        ...
        :pattern ((vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. msg!) i$))
        :qid user_curve25519_dalek__lemmas__lizard_lemmas__lemma_exec_ok_matches_spec_slot_71
        :skolemid skolem_user_curve25519_dalek__lemmas__lizard_lemmas__lemma_exec_ok_matches_spec_slot_71
     )))
     (=>
     ...
     (=>
      ...
      (= (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. buf2!)) (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.?
        (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe_j!)
     )))
     (=>
      %%global_location_label%%102
      (= mask_bit_set! (%B (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. cj!)))))
     )
     (=>
      %%global_location_label%%103
      (=>
       (%B (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. cj!))))
       (= (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
          fe_j!
         )
        ) (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. cj!))))
   )))))
   :pattern ((req%curve25519_dalek!lemmas.lizard_lemmas.lemma_exec_ok_matches_spec_slot.
     mask_bit_set! sha_match! buf2! msg! h! fe_j! cj!
   ))
   :qid internal_req__curve25519_dalek!lemmas.lizard_lemmas.lemma_exec_ok_matches_spec_slot._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.lizard_lemmas.lemma_exec_ok_matches_spec_slot._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_exec_ok_matches_spec_slot.
 (Bool Bool %%Function%% vstd!seq.Seq<u8.>. %%Function%% curve25519_dalek!backend.serial.u64.field.FieldElement51.
  tuple%2.
 ) Bool
)
(assert
 (forall ((mask_bit_set! Bool) (sha_match! Bool) (buf2! %%Function%%) (msg! vstd!seq.Seq<u8.>.)
   ...
   (= (ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_exec_ok_matches_spec_slot. mask_bit_set!
     sha_match! buf2! msg! h! fe_j! cj!
    ) (= (and
      mask_bit_set!
      sha_match!
      ...
      (%B (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. cj!))))
      (curve25519_dalek!specs.lizard_specs.spec_candidate_sha_consistent.? (tuple%2./tuple%2/1
        (%Poly%tuple%2. (Poly%tuple%2. cj!))
   )))))
   :pattern ((ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_exec_ok_matches_spec_slot.
     mask_bit_set! sha_match! buf2! msg! h! fe_j! cj!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_exec_ok_matches_spec_slot._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_exec_ok_matches_spec_slot._definition
)))

;; Function-Specs curve25519_dalek::lemmas::lizard_lemmas::lemma_decode_candidate_preimage
(declare-fun req%curve25519_dalek!lemmas.lizard_lemmas.lemma_decode_candidate_preimage.
 (curve25519_dalek!backend.serial.u64.field.FieldElement51. %%Function%% vstd!seq.Seq<u8.>.
  %%Function%%
 ) Bool
)
...
(assert
 (forall ((fe_j! curve25519_dalek!backend.serial.u64.field.FieldElement51.) (buf2! %%Function%%)
   (msg_spec! vstd!seq.Seq<u8.>.) (coset! %%Function%%)
  ) (!
   (= (req%curve25519_dalek!lemmas.lizard_lemmas.lemma_decode_candidate_preimage. fe_j!
     buf2! msg_spec! coset!
    ) (and
     (=>
      %%global_location_label%%104
      (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. msg_spec!)) 16)
     )
     (=>
     ...
     (=>
      ...
      (= buf2! (curve25519_dalek!specs.lizard_specs.spec_lizard_fe_bytes.? (Poly%vstd!seq.Seq<u8.>.
         msg_spec!
     ))))
     (=>
      %%global_location_label%%107
      (let
       ((ej$ (curve25519_dalek!specs.ristretto_specs.spec_elligator_ristretto_flavor.? (I (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.?
            (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe_j!)
       )))))
       (or
        (or
   ...
   :pattern ((req%curve25519_dalek!lemmas.lizard_lemmas.lemma_decode_candidate_preimage.
     fe_j! buf2! msg_spec! coset!
   ))
   :qid internal_req__curve25519_dalek!lemmas.lizard_lemmas.lemma_decode_candidate_preimage._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.lizard_lemmas.lemma_decode_candidate_preimage._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_decode_candidate_preimage.
 (curve25519_dalek!backend.serial.u64.field.FieldElement51. %%Function%% vstd!seq.Seq<u8.>.
  %%Function%%
 ) Bool
)
(assert
 (forall ((fe_j! curve25519_dalek!backend.serial.u64.field.FieldElement51.) (buf2! %%Function%%)
   ...
   (= (ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_decode_candidate_preimage. fe_j!
     buf2! msg_spec! coset!
    ) (curve25519_dalek!specs.lizard_specs.is_lizard_preimage_coset.? (Poly%vstd!seq.Seq<u8.>.
      msg_spec!
     ) (Poly%array%. coset!)
   ))
   :pattern ((ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_decode_candidate_preimage.
     fe_j! buf2! msg_spec! coset!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_decode_candidate_preimage._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_decode_candidate_preimage._definition
)))

;; Function-Specs curve25519_dalek::lemmas::lizard_lemmas::lemma_partial_count_full
(declare-fun req%curve25519_dalek!lemmas.lizard_lemmas.lemma_partial_count_full. (
...
(assert
 (forall ((point! curve25519_dalek!edwards.EdwardsPoint.)) (!
   (= (req%curve25519_dalek!lemmas.lizard_lemmas.lemma_partial_count_full. point!) (=>
     %%global_location_label%%108
     (curve25519_dalek!specs.edwards_specs.is_well_formed_edwards_point.? (Poly%curve25519_dalek!edwards.EdwardsPoint.
       point!
   ))))
   :pattern ((req%curve25519_dalek!lemmas.lizard_lemmas.lemma_partial_count_full. point!))
   :qid internal_req__curve25519_dalek!lemmas.lizard_lemmas.lemma_partial_count_full._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.lizard_lemmas.lemma_partial_count_full._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_partial_count_full. (
  curve25519_dalek!edwards.EdwardsPoint.
 ) Bool
)
(assert
 (forall ((point! curve25519_dalek!edwards.EdwardsPoint.)) (!
   (= (ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_partial_count_full. point!) (=
     (curve25519_dalek!specs.lizard_specs.partial_sha_consistent_count.? (Poly%array%. (
        curve25519_dalek!specs.lizard_specs.spec_lizard_decode_candidates.? (Poly%curve25519_dalek!edwards.EdwardsPoint.
         point!
       ))
      ) (I 8)
     ) (curve25519_dalek!specs.lizard_specs.spec_sha_consistent_count.? (Poly%curve25519_dalek!edwards.EdwardsPoint.
       point!
   ))))
   :pattern ((ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_partial_count_full. point!))
   :qid internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_partial_count_full._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_partial_count_full._definition
)))

;; Function-Specs curve25519_dalek::lemmas::lizard_lemmas::axiom_decode_from_point
(declare-fun req%curve25519_dalek!lemmas.lizard_lemmas.axiom_decode_from_point. (curve25519_dalek!edwards.EdwardsPoint.
  core!option.Option.
 ) Bool
)
...
(assert
 (forall ((point! curve25519_dalek!edwards.EdwardsPoint.) (passed_data! core!option.Option.))
  (!
   (= (req%curve25519_dalek!lemmas.lizard_lemmas.axiom_decode_from_point. point! passed_data!)
    (and
     (=>
     ...
     (=>
      ...
      (= (>= (curve25519_dalek!specs.lizard_specs.spec_sha_consistent_count.? (Poly%curve25519_dalek!edwards.EdwardsPoint.
       ...
       ) (is-core!option.Option./Some passed_data!)
     ))
     (=>
       ...
       (let
        ...
        (let
         ...
         (let
          ((y$ (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$))))))
          (and
           (= (vstd!seq.Seq.len.? $ (UINT 8) (core!option.Option./Some/0 $ (TYPE%vstd!seq.Seq. $
               (UINT 8)
              ) (%Poly%core!option.Option. (Poly%core!option.Option. passed_data!))
             )
            ) 16
           )
           (curve25519_dalek!specs.lizard_specs.is_lizard_preimage_coset.? (core!option.Option./Some/0
             $ (TYPE%vstd!seq.Seq. $ (UINT 8)) (%Poly%core!option.Option. (Poly%core!option.Option.
               passed_data!
             ))
            ) (Poly%array%. (curve25519_dalek!specs.ristretto_specs.ristretto_coset_affine.? (I
               x$
              ) (I y$)
   )))))))))))
   :pattern ((req%curve25519_dalek!lemmas.lizard_lemmas.axiom_decode_from_point. point!
     passed_data!
   ))
   :qid internal_req__curve25519_dalek!lemmas.lizard_lemmas.axiom_decode_from_point._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.lizard_lemmas.axiom_decode_from_point._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.lizard_lemmas.axiom_decode_from_point. (curve25519_dalek!edwards.EdwardsPoint.
  core!option.Option.
 ) Bool
)
(assert
 (forall ((point! curve25519_dalek!edwards.EdwardsPoint.) (passed_data! core!option.Option.))
  (!
   (= (ens%curve25519_dalek!lemmas.lizard_lemmas.axiom_decode_from_point. point! passed_data!)
    (let
     ((tmp%%$ (curve25519_dalek!specs.edwards_specs.edwards_point_as_affine.? (Poly%curve25519_dalek!edwards.EdwardsPoint.
         point!
     ))))
     (let
      ...
      (let
       ((y$ (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$))))))
       (let
        ((c$ (curve25519_dalek!specs.lizard_specs.spec_sha_consistent_count.? (Poly%curve25519_dalek!edwards.EdwardsPoint.
            point!
        ))))
        (and
         (=>
          (= c$ 1)
          (curve25519_dalek!specs.lizard_specs.lizard_ristretto_has_unique_preimage.? (I x$)
           (I y$)
         ))
         (=>
          (not (= c$ 1))
          (not (curve25519_dalek!specs.lizard_specs.lizard_ristretto_has_unique_preimage.? (I
             x$
            ) (I y$)
   )))))))))
   :pattern ((ens%curve25519_dalek!lemmas.lizard_lemmas.axiom_decode_from_point. point!
     passed_data!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.lizard_lemmas.axiom_decode_from_point._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.lizard_lemmas.axiom_decode_from_point._definition
)))

;; Function-Specs curve25519_dalek::lemmas::lizard_lemmas::lemma_spec_lizard_fe_bytes_injective
(declare-fun req%curve25519_dalek!lemmas.lizard_lemmas.lemma_spec_lizard_fe_bytes_injective.
 (vstd!seq.Seq<u8.>. vstd!seq.Seq<u8.>.) Bool
)
...
(assert
 (forall ((m1! vstd!seq.Seq<u8.>.) (m2! vstd!seq.Seq<u8.>.)) (!
   (= (req%curve25519_dalek!lemmas.lizard_lemmas.lemma_spec_lizard_fe_bytes_injective.
     m1! m2!
    ) (and
     (=>
      %%global_location_label%%112
      (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. m1!)) 16)
     )
     (=>
      %%global_location_label%%113
      (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. m2!)) 16)
     )
     (=>
      %%global_location_label%%114
      (= (curve25519_dalek!specs.lizard_specs.spec_lizard_fe_bytes.? (Poly%vstd!seq.Seq<u8.>.
         m1!
        )
       ) (curve25519_dalek!specs.lizard_specs.spec_lizard_fe_bytes.? (Poly%vstd!seq.Seq<u8.>.
         m2!
   ))))))
   :pattern ((req%curve25519_dalek!lemmas.lizard_lemmas.lemma_spec_lizard_fe_bytes_injective.
     m1! m2!
   ))
   :qid internal_req__curve25519_dalek!lemmas.lizard_lemmas.lemma_spec_lizard_fe_bytes_injective._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.lizard_lemmas.lemma_spec_lizard_fe_bytes_injective._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_spec_lizard_fe_bytes_injective.
 (vstd!seq.Seq<u8.>. vstd!seq.Seq<u8.>.) Bool
)
(assert
 (forall ((m1! vstd!seq.Seq<u8.>.) (m2! vstd!seq.Seq<u8.>.)) (!
   (= (ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_spec_lizard_fe_bytes_injective.
     m1! m2!
    ) (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. m1!) (Poly%vstd!seq.Seq<u8.>.
      m2!
   )))
   :pattern ((ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_spec_lizard_fe_bytes_injective.
     m1! m2!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_spec_lizard_fe_bytes_injective._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_spec_lizard_fe_bytes_injective._definition
)))

;; Function-Specs curve25519_dalek::lemmas::lizard_lemmas::axiom_elligator_fiber_complete
(declare-fun req%curve25519_dalek!lemmas.lizard_lemmas.axiom_elligator_fiber_complete.
 (curve25519_dalek!edwards.EdwardsPoint. Int) Bool
)
(declare-const %%global_location_label%%115 Bool)
(declare-const %%global_location_label%%116 Bool)
(assert
 (forall ((point! curve25519_dalek!edwards.EdwardsPoint.) (r! Int)) (!
   (= (req%curve25519_dalek!lemmas.lizard_lemmas.axiom_elligator_fiber_complete. point!
     r!
    ) (and
     (=>
   ...
   :pattern ((req%curve25519_dalek!lemmas.lizard_lemmas.axiom_elligator_fiber_complete.
     point! r!
   ))
   :qid internal_req__curve25519_dalek!lemmas.lizard_lemmas.axiom_elligator_fiber_complete._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.lizard_lemmas.axiom_elligator_fiber_complete._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.lizard_lemmas.axiom_elligator_fiber_complete.
 (curve25519_dalek!edwards.EdwardsPoint. Int) Bool
)
(assert
 (forall ((point! curve25519_dalek!edwards.EdwardsPoint.) (r! Int)) (!
   (= (ens%curve25519_dalek!lemmas.lizard_lemmas.axiom_elligator_fiber_complete. point!
     r!
    ) (let
     ((tmp%%$ (curve25519_dalek!specs.edwards_specs.edwards_point_as_affine.? (Poly%curve25519_dalek!edwards.EdwardsPoint.
         point!
     ...
     (let
      ...
      (let
       ...
       (let
        ((coset$ (curve25519_dalek!specs.ristretto_specs.ristretto_coset_affine.? (I x$) (I y$))))
        (let
         ((ej$ (curve25519_dalek!specs.ristretto_specs.spec_elligator_ristretto_flavor.? (I r!))))
         (let
          ((candidates$ (curve25519_dalek!specs.lizard_specs.spec_lizard_decode_candidates.? (
              Poly%curve25519_dalek!edwards.EdwardsPoint. point!
          ))))
          (=>
           (or
           ...
           (exists ((j$ Poly)) (!
             ...
             :pattern ((vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2. $ BOOL $ NAT) (vstd!view.View.view.?
                $ (ARRAY (DST $) (TYPE%tuple%2. $ BOOL $ NAT) $ (CONST_INT 8)) (Poly%array%. candidates$)
               ) j$
             ))
             :qid user_curve25519_dalek__lemmas__lizard_lemmas__axiom_elligator_fiber_complete_72
             :skolemid skolem_user_curve25519_dalek__lemmas__lizard_lemmas__axiom_elligator_fiber_complete_72
   ))))))))))
   :pattern ((ens%curve25519_dalek!lemmas.lizard_lemmas.axiom_elligator_fiber_complete.
     point! r!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.lizard_lemmas.axiom_elligator_fiber_complete._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.lizard_lemmas.axiom_elligator_fiber_complete._definition
)))

;; Function-Specs curve25519_dalek::lemmas::lizard_lemmas::lemma_spec_lizard_fe_bytes_canonical
(declare-fun req%curve25519_dalek!lemmas.lizard_lemmas.lemma_spec_lizard_fe_bytes_canonical.
 (vstd!seq.Seq<u8.>.) Bool
)
(declare-const %%global_location_label%%117 Bool)
(assert
 (forall ((m! vstd!seq.Seq<u8.>.)) (!
   (= (req%curve25519_dalek!lemmas.lizard_lemmas.lemma_spec_lizard_fe_bytes_canonical.
     m!
    ) (=>
     %%global_location_label%%117
     (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. m!)) 16)
   ))
   :pattern ((req%curve25519_dalek!lemmas.lizard_lemmas.lemma_spec_lizard_fe_bytes_canonical.
     m!
   ))
   :qid internal_req__curve25519_dalek!lemmas.lizard_lemmas.lemma_spec_lizard_fe_bytes_canonical._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.lizard_lemmas.lemma_spec_lizard_fe_bytes_canonical._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_spec_lizard_fe_bytes_canonical.
 (vstd!seq.Seq<u8.>.) Bool
)
(assert
 (forall ((m! vstd!seq.Seq<u8.>.)) (!
   (= (ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_spec_lizard_fe_bytes_canonical.
     m!
    ) (< (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. (curve25519_dalek!specs.lizard_specs.spec_lizard_fe_bytes.?
        (Poly%vstd!seq.Seq<u8.>. m!)
      ))
     ) (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
   ))
   :pattern ((ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_spec_lizard_fe_bytes_canonical.
     m!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_spec_lizard_fe_bytes_canonical._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.lizard_lemmas.lemma_spec_lizard_fe_bytes_canonical._definition
)))

;; Function-Def curve25519_dalek::lemmas::lizard_lemmas::lemma_spec_lizard_fe_bytes_canonical
;; curve25519-dalek/src/lemmas/lizard_lemmas.rs:1202:5: 1202:11 (#0)
...
(declare-const b31_after@ (_ BitVec 8))
(declare-const b31_before@ (_ BitVec 8))
(assert
 (= b31_after@ (bvand b31_before@ ((_ zero_extend 2) (_ bv63 6))))
)
...
(assert
 (not (=>
   %%location_label%%0
   (bvule b31_after@ ((_ zero_extend 2) (_ bv63 6)))
)))
(get-info :version)
