...
;; curve25519-dalek/src/lemmas/field_lemmas/pow2_51_lemmas.rs:66:1: 66:44 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::pow2_51_lemmas::lemma_shr_51_fits_u64
;; curve25519-dalek/src/lemmas/field_lemmas/pow2_51_lemmas.rs:66:1: 66:44 (#0)
...
(push)
 ...
 (assert
  (not (and
    ...
    (=>
     (= (uClip 128 (bitshr (I (uClip 128 (bitshl (I (uClip 128 18446744073709551615)) (I 51))))
        (I 51)
       )
      ) (uClip 128 18446744073709551615)
     )
     (=>
      (= tmp%1 (uClip 128 (bitshl (I (uClip 128 18446744073709551615)) (I 51))))
      (and
       (=>
        %%location_label%%1
        (req%curve25519_dalek!lemmas.field_lemmas.pow2_51_lemmas.lemma_shr_51_le. a! tmp%1)
       )
       (=>
        (ens%curve25519_dalek!lemmas.field_lemmas.pow2_51_lemmas.lemma_shr_51_le. a! tmp%1)
        (=>
         %%location_label%%2
         (<= (uClip 128 (bitshr (I a!) (I 51))) (uClip 128 18446744073709551615))
 ))))))))
