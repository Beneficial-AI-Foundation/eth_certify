...
;; curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:1165:1: 1165:83 (#0)
...
;; Function-Specs curve25519_dalek::lemmas::field_lemmas::as_bytes_lemmas::lemma_as_bytes_from_bytes_roundtrip
(declare-fun req%curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip.
 (%%Function%% curve25519_dalek!backend.serial.u64.field.FieldElement51. %%Function%%)
 Bool
)
...
(assert
 (forall ((bytes_orig! %%Function%%) (fe! curve25519_dalek!backend.serial.u64.field.FieldElement51.)
   (bytes_decoded! %%Function%%)
  ) (!
   (= (req%curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip.
     bytes_orig! fe! bytes_decoded!
    ) (and
     (=>
      %%global_location_label%%41
      (< (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. bytes_orig!)) (
        curve25519_dalek!specs.field_specs_u64.p.? (I 0)
     )))
     (=>
      %%global_location_label%%42
      (curve25519_dalek!specs.field_specs.from_bytes_post.? (Poly%array%. bytes_orig!) (
        Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!
     )))
     (=>
      ...
      (curve25519_dalek!specs.field_specs.as_bytes_post.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
        fe!
       ) (Poly%array%. bytes_decoded!)
   ))))
   :pattern ((req%curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip.
     bytes_orig! fe! bytes_decoded!
   ))
   :qid internal_req__curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip.
 (%%Function%% curve25519_dalek!backend.serial.u64.field.FieldElement51. %%Function%%)
 Bool
)
(assert
 (forall ((bytes_orig! %%Function%%) (fe! curve25519_dalek!backend.serial.u64.field.FieldElement51.)
   ...
   (= (ens%curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip.
     bytes_orig! fe! bytes_decoded!
    ) (= (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. bytes_decoded!))
     (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. bytes_orig!))
   ))
   :pattern ((ens%curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip.
     bytes_orig! fe! bytes_decoded!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip._definition
)))

;; Function-Specs curve25519_dalek::lemmas::field_lemmas::as_bytes_lemmas::lemma_canonical_bytes_bit255_zero
(declare-fun req%curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_canonical_bytes_bit255_zero.
 (%%Function%% Int) Bool
)
(declare-const %%global_location_label%%44 Bool)
(declare-const %%global_location_label%%45 Bool)
(assert
 (forall ((bytes! %%Function%%) (val! Int)) (!
   (= (req%curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_canonical_bytes_bit255_zero.
     bytes! val!
    ) (and
     (=>
      %%global_location_label%%44
      (= (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. bytes!)) val!)
     )
     (=>
      %%global_location_label%%45
      (< val! (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
   )))
   :pattern ((req%curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_canonical_bytes_bit255_zero.
     bytes! val!
   ))
   :qid internal_req__curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_canonical_bytes_bit255_zero._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_canonical_bytes_bit255_zero._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_canonical_bytes_bit255_zero.
 (%%Function%% Int) Bool
)
(assert
 (forall ((bytes! %%Function%%) (val! Int)) (!
   (= (ens%curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_canonical_bytes_bit255_zero.
     bytes! val!
    ) (= (uClip 8 (bitshr (I (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (
   ...
   :pattern ((ens%curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_canonical_bytes_bit255_zero.
     bytes! val!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_canonical_bytes_bit255_zero._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_canonical_bytes_bit255_zero._definition
)))
...
;; Function-Specs curve25519_dalek::lemmas::field_lemmas::as_bytes_lemmas::lemma_xor_sign_bit_preserves_y
(declare-fun req%curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_xor_sign_bit_preserves_y.
...
(assert
 (forall ((s_before! %%Function%%) (s_after! %%Function%%) (y_val! Int) (sign_bit! Int))
  (!
   (= (req%curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_xor_sign_bit_preserves_y.
     s_before! s_after! y_val! sign_bit!
    ) (and
     (=>
      %%global_location_label%%46
      (= (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. s_before!)) y_val!)
     )
     (=>
      %%global_location_label%%47
      (< y_val! (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
     )
     (=>
     ...
     (=>
      ...
      (forall ((i$ Poly)) (!
        ...
        :qid user_curve25519_dalek__lemmas__field_lemmas__as_bytes_lemmas__lemma_xor_sign_bit_preserves_y_85
        :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__as_bytes_lemmas__lemma_xor_sign_bit_preserves_y_85
     )))
     (=>
      ...
      (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (
       ...
       ) (uClip 8 (bitxor (I (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY
              $ (UINT 8) $ (CONST_INT 32)
             ) (Poly%array%. s_before!)
            ) (I 31)
          ))
         ) (I (uClip 8 (bitshl (I sign_bit!) (I 7))))
   ))))))
   :pattern ((req%curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_xor_sign_bit_preserves_y.
     s_before! s_after! y_val! sign_bit!
   ))
   :qid internal_req__curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_xor_sign_bit_preserves_y._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_xor_sign_bit_preserves_y._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_xor_sign_bit_preserves_y.
 (%%Function%% %%Function%% Int Int) Bool
)
(assert
 (forall ((s_before! %%Function%%) (s_after! %%Function%%) (y_val! Int) (sign_bit! Int))
  (!
   (= (ens%curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_xor_sign_bit_preserves_y.
     s_before! s_after! y_val! sign_bit!
    ) (and
     (= (curve25519_dalek!specs.field_specs.field_element_from_bytes.? (Poly%array%. s_after!))
      y_val!
     )
     (= (uClip 8 (bitshr (I (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY
             $ (UINT 8) $ (CONST_INT 32)
   ...
   :pattern ((ens%curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_xor_sign_bit_preserves_y.
     s_before! s_after! y_val! sign_bit!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_xor_sign_bit_preserves_y._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_xor_sign_bit_preserves_y._definition
)))

;; Function-Specs curve25519_dalek::lemmas::field_lemmas::as_bytes_lemmas::lemma_canonical_check_backward
(declare-fun req%curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_canonical_check_backward.
 (%%Function%% curve25519_dalek!backend.serial.u64.field.FieldElement51.) Bool
)
...
(assert
 (forall ((bytes! %%Function%%) (fe! curve25519_dalek!backend.serial.u64.field.FieldElement51.))
  (!
   (= (req%curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_canonical_check_backward.
     bytes! fe!
    ) (and
     (=>
      ...
      (= (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
       ...
       ) (curve25519_dalek!specs.field_specs.field_element_from_bytes.? (Poly%array%. bytes!))
     ))
     (=>
      %%global_location_label%%53
      (< (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. bytes!)) (curve25519_dalek!specs.field_specs_u64.p.?
        (I 0)
   )))))
   :pattern ((req%curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_canonical_check_backward.
     bytes! fe!
   ))
   :qid internal_req__curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_canonical_check_backward._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_canonical_check_backward._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_canonical_check_backward.
 (%%Function%% curve25519_dalek!backend.serial.u64.field.FieldElement51.) Bool
)
(assert
 (forall ((bytes! %%Function%%) (fe! curve25519_dalek!backend.serial.u64.field.FieldElement51.))
  (!
   (= (ens%curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_canonical_check_backward.
     bytes! fe!
    ) (= (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
       fe!
      )
     ) (curve25519_dalek!core_assumes.seq_from32.? (Poly%array%. bytes!))
   ))
   :pattern ((ens%curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_canonical_check_backward.
     bytes! fe!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_canonical_check_backward._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_canonical_check_backward._definition
)))

;; Function-Def curve25519_dalek::lemmas::field_lemmas::as_bytes_lemmas::lemma_canonical_check_backward
;; curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:1165:1: 1165:83 (#0)
...
(push)
 ...
 (declare-const spec_arr@ %%Function%%)
 (assert
  fuel_defaults
 )
 (assert
    ...
    (=>
     ...
     (and
      (=>
       ...
       (=>
        ...
        (and
         (=>
          %%location_label%%1
          (req%vstd!arithmetic.div_mod.lemma_small_mod. tmp%1 tmp%2)
         )
         (=>
          (ens%vstd!arithmetic.div_mod.lemma_small_mod. tmp%1 tmp%2)
          (=>
           %%location_label%%2
           (= (EucMod (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. bytes!))
      ...
      (=>
       ...
       (and
        (=>
         (= tmp%3 (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. bytes!)))
         (=>
          (= tmp%4 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
          (and
           (=>
            %%location_label%%3
            (req%vstd!arithmetic.div_mod.lemma_small_mod. tmp%3 tmp%4)
           )
           (=>
            (ens%vstd!arithmetic.div_mod.lemma_small_mod. tmp%3 tmp%4)
            (=>
             %%location_label%%4
             (= (EucMod (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. bytes!))
               (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
        ...
        (=>
         ...
         (=>
          (= spec_arr@ (curve25519_dalek!core_assumes.seq_to_array_32.? (Poly%vstd!seq.Seq<u8.>.
             (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
               fe!
          )))))
          (and
           (=>
            ...
            (=>
             %%location_label%%5
             (= (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. spec_arr@)) (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.?
               (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
           ))))
           (=>
            (= (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. spec_arr@)) (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.?
              ...
              (=>
               ...
               (=>
                ...
                (forall ((i$ Poly)) (!
                  ...
                  :qid user_curve25519_dalek__lemmas__field_lemmas__as_bytes_lemmas__lemma_canonical_check_backward_104
                  :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__as_bytes_lemmas__lemma_canonical_check_backward_104
             )))))
             (=>
              (forall ((i$ Poly)) (!
                (=>
                ...
                :qid user_curve25519_dalek__lemmas__field_lemmas__as_bytes_lemmas__lemma_canonical_check_backward_105
                :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__as_bytes_lemmas__lemma_canonical_check_backward_105
              ))
              (and
               (=>
                (= tmp%5 (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
                     (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
                   ))
                  ) 32
                ))
                  ...
                  (and
                   (=>
                    ...
                    (=>
                     ...
                     (=>
                      (= tmp%6 (= (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
                           (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
                          )
                         ) i@
                        ) (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT
                      ...
                      (and
                       ...
                       (=>
                        tmp%6
                        (=>
                         (= tmp%7 (= (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!core_assumes.seq_from32.?
                              (Poly%array%. bytes!)
                             )
                            ) i@
                           ) (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT
                         ...
                         (and
                          ...
                          (=>
                           tmp%7
                           (=>
                            (= tmp%8 (= (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT 8)
                                 $ (CONST_INT 32)
                                ) (Poly%array%. spec_arr@)
                               ) i@
                              ) (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT
                             ...
                             (=>
                              ...
                              (=>
                               ...
                               (= (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
                                ...
                                ) (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!core_assumes.seq_from32.?
                                   (Poly%array%. bytes!)
                                  )
                                 ) i@
                   ))))))))))))))
                   (=>
                    (forall ((i$ Poly)) (!
                      ...
                      :pattern ((vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!core_assumes.seq_from32.?
                          (Poly%array%. bytes!)
                         )
                        ) i$
                      ))
                      :qid user_curve25519_dalek__lemmas__field_lemmas__as_bytes_lemmas__lemma_canonical_check_backward_107
                      :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__as_bytes_lemmas__lemma_canonical_check_backward_107
                    ))
                    (=>
                     %%location_label%%13
