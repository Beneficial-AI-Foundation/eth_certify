...
;; MODULE 'module lemmas::edwards_lemmas::step1_lemmas'
;; curve25519-dalek/src/lemmas/edwards_lemmas/step1_lemmas.rs:462:1: 468:2 (#0)
...
(assert
 (distinct fuel%vstd!arithmetic.div_mod.lemma_mod_self_0. fuel%vstd!arithmetic.div_mod.lemma_mod_multiples_vanish.
  fuel%vstd!arithmetic.div_mod.lemma_add_mod_noop. fuel%vstd!arithmetic.div_mod.lemma_mod_adds.
  fuel%vstd!arithmetic.div_mod.lemma_mod_bound. fuel%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left.
  fuel%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. fuel%vstd!arithmetic.mul.lemma_mul_is_associative.
  fuel%vstd!arithmetic.mul.lemma_mul_is_commutative. fuel%vstd!array.array_view. fuel%vstd!array.impl&%0.view.
  ...
  fuel%curve25519_dalek!specs.edwards_specs.is_on_edwards_curve. fuel%curve25519_dalek!specs.edwards_specs.is_valid_edwards_y_coordinate.
...
(assert
 (=>
  ...
  (forall ((m! Int)) (!
    ...
    :pattern ((EucMod m! m!))
    :qid user_vstd__arithmetic__div_mod__lemma_mod_self_0_18
    :skolemid skolem_user_vstd__arithmetic__div_mod__lemma_mod_self_0_18
))))
...
(assert
 (=>
  ...
  (forall ((a! Int) (b! Int) (m! Int)) (!
    ...
    :qid user_vstd__arithmetic__div_mod__lemma_mod_multiples_vanish_19
    :skolemid skolem_user_vstd__arithmetic__div_mod__lemma_mod_multiples_vanish_19
))))
...
(assert
 (=>
  ...
  (forall ((x! Int) (y! Int) (m! Int)) (!
    ...
    :qid user_vstd__arithmetic__div_mod__lemma_add_mod_noop_20
    :skolemid skolem_user_vstd__arithmetic__div_mod__lemma_add_mod_noop_20
))))
...
(assert
 (=>
  ...
  (forall ((a! Int) (b! Int) (d! Int)) (!
    ...
    :qid user_vstd__arithmetic__div_mod__lemma_mod_adds_21
    :skolemid skolem_user_vstd__arithmetic__div_mod__lemma_mod_adds_21
))))
...
(assert
 (=>
  ...
  (forall ((x! Int) (y! Int) (m! Int)) (!
    ...
    :qid user_vstd__arithmetic__div_mod__lemma_mul_mod_noop_left_23
    :skolemid skolem_user_vstd__arithmetic__div_mod__lemma_mul_mod_noop_left_23
))))
...
(assert
 (=>
  ...
  (forall ((x! Int) (y! Int) (m! Int)) (!
    ...
    :pattern ((EucMod (Mul x! y!) m!))
    :qid user_vstd__arithmetic__div_mod__lemma_mul_mod_noop_right_24
    :skolemid skolem_user_vstd__arithmetic__div_mod__lemma_mul_mod_noop_right_24
))))
         ...
         (=>
          ...
          (and
           ...
           (exists ((r$ Poly)) (!
             ...
             :qid user_curve25519_dalek__specs__edwards_specs__is_valid_edwards_y_coordinate_27
             :skolemid skolem_user_curve25519_dalek__specs__edwards_specs__is_valid_edwards_y_coordinate_27
    )))))))))
   ...
   (= (req%curve25519_dalek!lemmas.field_lemmas.sqrt_ratio_lemmas.lemma_no_square_root_when_times_i.
     ...
     (=>
      ...
      (exists ((x$ Poly)) (!
        ...
        :qid user_curve25519_dalek__lemmas__field_lemmas__sqrt_ratio_lemmas__lemma_no_square_root_when_times_i_28
        :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__sqrt_ratio_lemmas__lemma_no_square_root_when_times_i_28
   )))))
...
;; Function-Specs curve25519_dalek::lemmas::edwards_lemmas::step1_lemmas::lemma_sqrt_ratio_implies_on_curve
(declare-fun req%curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_sqrt_ratio_implies_on_curve.
 (Int Int) Bool
)
(declare-const %%global_location_label%%22 Bool)
(assert
 (forall ((x! Int) (y! Int)) (!
   (= (req%curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_sqrt_ratio_implies_on_curve.
     x! y!
    ) (=>
   ...
   :pattern ((req%curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_sqrt_ratio_implies_on_curve.
     x! y!
   ))
   :qid internal_req__curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_sqrt_ratio_implies_on_curve._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_sqrt_ratio_implies_on_curve._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_sqrt_ratio_implies_on_curve.
 (Int Int) Bool
)
(assert
 (forall ((x! Int) (y! Int)) (!
   (= (ens%curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_sqrt_ratio_implies_on_curve.
     x! y!
    ) (curve25519_dalek!specs.edwards_specs.is_on_edwards_curve.? (I x!) (I y!))
   )
   :pattern ((ens%curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_sqrt_ratio_implies_on_curve.
     x! y!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_sqrt_ratio_implies_on_curve._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_sqrt_ratio_implies_on_curve._definition
)))

;; Function-Specs curve25519_dalek::lemmas::edwards_lemmas::step1_lemmas::lemma_sqrt_ratio_success_means_valid_y
(declare-fun req%curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_sqrt_ratio_success_means_valid_y.
 (Int Int) Bool
)
(declare-const %%global_location_label%%23 Bool)
(assert
 (forall ((y! Int) (r! Int)) (!
   (= (req%curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_sqrt_ratio_success_means_valid_y.
     y! r!
    ) (=>
   ...
   :pattern ((req%curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_sqrt_ratio_success_means_valid_y.
     y! r!
   ))
   :qid internal_req__curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_sqrt_ratio_success_means_valid_y._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_sqrt_ratio_success_means_valid_y._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_sqrt_ratio_success_means_valid_y.
 (Int Int) Bool
)
(assert
 (forall ((y! Int) (r! Int)) (!
   (= (ens%curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_sqrt_ratio_success_means_valid_y.
     y! r!
    ) (curve25519_dalek!specs.edwards_specs.is_valid_edwards_y_coordinate.? (I y!))
   )
   :pattern ((ens%curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_sqrt_ratio_success_means_valid_y.
     y! r!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_sqrt_ratio_success_means_valid_y._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_sqrt_ratio_success_means_valid_y._definition
)))

;; Function-Specs curve25519_dalek::lemmas::edwards_lemmas::step1_lemmas::lemma_step1_curve_semantics
(declare-fun req%curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_step1_curve_semantics.
 (Int Int) Bool
)
(declare-const %%global_location_label%%24 Bool)
(assert
 (forall ((y! Int) (x! Int)) (!
   (= (req%curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_step1_curve_semantics.
     y! x!
    ) (=>
   ...
   :pattern ((req%curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_step1_curve_semantics.
     y! x!
   ))
   :qid internal_req__curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_step1_curve_semantics._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_step1_curve_semantics._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_step1_curve_semantics.
 (Int Int) Bool
)
(assert
 (forall ((y! Int) (x! Int)) (!
   (= (ens%curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_step1_curve_semantics.
     y! x!
    ) (and
     (curve25519_dalek!specs.edwards_specs.is_valid_edwards_y_coordinate.? (I y!))
     (curve25519_dalek!specs.edwards_specs.is_on_edwards_curve.? (I x!) (I y!))
   ))
   :pattern ((ens%curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_step1_curve_semantics.
     y! x!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_step1_curve_semantics._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_step1_curve_semantics._definition
)))

;; Function-Specs curve25519_dalek::lemmas::edwards_lemmas::step1_lemmas::lemma_u_zero_implies_identity_point
(declare-fun req%curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_u_zero_implies_identity_point.
 (Int) Bool
)
(declare-const %%global_location_label%%25 Bool)
(assert
 (forall ((y! Int)) (!
   (= (req%curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_u_zero_implies_identity_point.
     y!
    ) (=>
   ...
   :pattern ((req%curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_u_zero_implies_identity_point.
     y!
   ))
   :qid internal_req__curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_u_zero_implies_identity_point._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_u_zero_implies_identity_point._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_u_zero_implies_identity_point.
 (Int) Bool
)
(assert
 (forall ((y! Int)) (!
   (= (ens%curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_u_zero_implies_identity_point.
     y!
    ) (and
     (= (curve25519_dalek!specs.field_specs.field_square.? (I y!)) 1)
     (curve25519_dalek!specs.edwards_specs.is_on_edwards_curve.? (I 0) (I y!))
     (curve25519_dalek!specs.edwards_specs.is_valid_edwards_y_coordinate.? (I y!))
   ))
   :pattern ((ens%curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_u_zero_implies_identity_point.
     y!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_u_zero_implies_identity_point._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_u_zero_implies_identity_point._definition
)))

;; Function-Specs curve25519_dalek::lemmas::edwards_lemmas::step1_lemmas::lemma_sqrt_ratio_failure_means_invalid_y
(declare-fun req%curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_sqrt_ratio_failure_means_invalid_y.
 (Int Int Int) Bool
)
...
(assert
 (forall ((y! Int) (u! Int) (v! Int)) (!
   (= (req%curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_sqrt_ratio_failure_means_invalid_y.
     y! u! v!
    ) (and
     (=>
     ...
     (=>
      ...
      (exists ((x$ Poly)) (!
        (and
         ...
         (and
          ...
          (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_square.?
           ...
           ) (EucMod (nClip (Mul (curve25519_dalek!specs.field_specs.sqrt_m1.? (I 0)) u!)) (curve25519_dalek!specs.field_specs_u64.p.?
             (I 0)
        )))))
        :pattern ((curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_square.?
            x$
        ...
        :qid user_curve25519_dalek__lemmas__edwards_lemmas__step1_lemmas__lemma_sqrt_ratio_failure_means_invalid_y_62
        :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__step1_lemmas__lemma_sqrt_ratio_failure_means_invalid_y_62
   )))))
   :pattern ((req%curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_sqrt_ratio_failure_means_invalid_y.
     y! u! v!
   ))
   :qid internal_req__curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_sqrt_ratio_failure_means_invalid_y._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_sqrt_ratio_failure_means_invalid_y._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_sqrt_ratio_failure_means_invalid_y.
 (Int Int Int) Bool
)
(assert
 (forall ((y! Int) (u! Int) (v! Int)) (!
   (= (ens%curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_sqrt_ratio_failure_means_invalid_y.
     y! u! v!
    ) (not (curve25519_dalek!specs.edwards_specs.is_valid_edwards_y_coordinate.? (I y!)))
   )
   :pattern ((ens%curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_sqrt_ratio_failure_means_invalid_y.
     y! u! v!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_sqrt_ratio_failure_means_invalid_y._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.edwards_lemmas.step1_lemmas.lemma_sqrt_ratio_failure_means_invalid_y._definition
)))
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::step1_lemmas::lemma_step1_case_analysis
;; curve25519-dalek/src/lemmas/edwards_lemmas/step1_lemmas.rs:462:1: 468:2 (#0)
(get-info :all-statistics)
(push)
 (declare-const y! Int)
 (declare-const x! Int)
 (declare-const u_math! Int)
 (declare-const v_math! Int)
 (declare-const sqrt_ratio_succeeded! Bool)
      ...
      (or
       (and
        (=>
         ...
         (and
          (=>
           (= tmp%1 (curve25519_dalek!specs.field_specs.is_sqrt_ratio.? (I u_math!) (I v_math!)
             (I x!)
           ))
           (and
            (=>
              ...
              (and
               (=>
                ...
                (and
                 (=>
                  %%location_label%%1
                  (req%vstd!arithmetic.div_mod.lemma_small_mod. u_math! tmp%2)
                 )
                 (=>
                  (ens%vstd!arithmetic.div_mod.lemma_small_mod. u_math! tmp%2)
                  (=>
                   %%location_label%%2
                   (= u_math! (curve25519_dalek!specs.field_specs_u64.field_canonical.? (I u_math!)))
               ))))
               (=>
                (= u_math! (curve25519_dalek!specs.field_specs_u64.field_canonical.? (I u_math!)))
                (=>
                 %%location_label%%3
                 (= (EucMod (nClip (Mul (nClip (Mul x! x!)) v_math!)) (curve25519_dalek!specs.field_specs_u64.p.?
                    (I 0)
                   )
                  ) u_math!
              ))))
         ...
         (=>
          ...
          (=>
           ...
           (and
            (=>
             %%location_label%%12
             (req%vstd!arithmetic.div_mod.lemma_small_mod. u_math! tmp%6)
            )
            (=>
             (ens%vstd!arithmetic.div_mod.lemma_small_mod. u_math! tmp%6)
             (=>
              (= tmp%7 (not (= (EucMod u_math! (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                 0
              )))
              (and
               (=>
               ...
               (=>
                ...
                (or
                 (and
                  (=>
                   (= (EucMod v_math! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0)
                   %%switch_label%%2
                  )
                  (=>
                   (not (= (EucMod v_math! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0))
                   (and
                    (=>
                     (= tmp%8 (not (= (EucMod v_math! (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                        0
                     )))
                     (and
                      (=>
                      ...
                      (=>
                       ...
                       (=>
                        ...
                        (and
                         (=>
                          %%location_label%%15
                          (req%vstd!arithmetic.div_mod.lemma_small_mod. v_math! tmp%9)
                         )
                         (=>
                          (ens%vstd!arithmetic.div_mod.lemma_small_mod. v_math! tmp%9)
                          (=>
                           %%location_label%%16
                           (not (= v_math! 0))
                    )))))))
                       ...
                       (=>
                        ...
                        (and
                         ...
                         (=>
                          tmp%10
                          (=>
                           (= tmp%11 (curve25519_dalek!specs.field_specs.is_sqrt_ratio_times_i.? (I u_math!) (
                              I v_math!
                             ) (I x!)
                           ))
                           (and
                            ...
                            (=>
                             tmp%11
                             (=>
                              (= tmp%12 (= (EucMod (nClip (Mul (nClip (Mul x! x!)) v_math!)) (curve25519_dalek!specs.field_specs_u64.p.?
                                  (I 0)
                                 )
                                ) (EucMod (nClip (Mul (curve25519_dalek!specs.field_specs.sqrt_m1.? (I 0)) u_math!))
                                 (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
                              )))
                              (and
                               (=>
                               ...
                               (=>
                                tmp%12
                                (=>
                                 (= x_sq@ (curve25519_dalek!specs.field_specs.field_square.? (I x!)))
                                 (=>
                                  (= lhs@ (curve25519_dalek!specs.field_specs.field_mul.? (I x_sq@) (I v_math!)))
                                  (=>
                                   (= rhs@ (EucMod (nClip (Mul (curve25519_dalek!specs.field_specs.sqrt_m1.? (I 0)) u_math!))
                                     (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
                                   ))
                                   (and
                                    (=>
                                     (= tmp%13 (nClip (Mul x! x!)))
                                     (=>
                                      (= tmp%14 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                                      (and
                                       (=>
                                        %%location_label%%21
                                        (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. tmp%13 v_math! tmp%14)
                                       )
                                       (=>
                                        (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. tmp%13 v_math! tmp%14)
                                        (=>
                                         %%location_label%%22
                                         (= lhs@ rhs@)
                                    )))))
