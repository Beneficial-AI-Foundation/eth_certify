...
;; curve25519-dalek/src/lemmas/scalar_lemmas_/radix_2w_lemmas.rs:259:1: 267:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::scalar_lemmas_::radix_2w_lemmas::lemma_u64x4_bit_extraction
;; curve25519-dalek/src/lemmas/scalar_lemmas_/radix_2w_lemmas.rs:259:1: 267:2 (#0)
(get-info :all-statistics)
(push)
 (declare-const words! %%Function%%)
 (declare-const bit_buf! Int)
 (declare-const window_mask! Int)
 (declare-const w! Int)
 (declare-const bit_offset! Int)
 (declare-const u64_idx! Int)
 (declare-const bit_idx! Int)
 (declare-const tmp%1 Int)
 (declare-const tmp%2 Bool)
 (declare-const val@ Int)
 (declare-const bit_off_nat@ Int)
 (declare-const w_nat@ Int)
 (declare-const bit_idx_nat@ Int)
 (assert
  fuel_defaults
 )
 (assert
    ...
    (and
     (=>
      ...
      (=>
       (= val@ (curve25519_dalek!specs.scalar_specs.u64_4_as_nat.? (Poly%array%. words!)))
       (=>
        (= bit_off_nat@ bit_offset!)
        (=>
         (= w_nat@ w!)
         (=>
          (= bit_idx_nat@ bit_idx!)
          (=>
           (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_div_mod. val@ bit_off_nat@
            w_nat@
           )
           (and
            (=>
             %%location_label%%0
             (req%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u64_shift_is_pow2. bit_idx_nat@)
            )
            (=>
             (ens%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u64_shift_is_pow2. bit_idx_nat@)
             (=>
              ...
              (and
               (=>
                %%location_label%%1
                (req%vstd!bits.lemma_u64_shr_is_div. tmp%1 (uClip 64 bit_idx!))
               )
               (=>
                (ens%vstd!bits.lemma_u64_shr_is_div. tmp%1 (uClip 64 bit_idx!))
                (=>
                 (= tmp%2 (= bit_buf! (EucDiv (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                       $ (ARRAY $ (UINT 64) $ (CONST_INT 4)) (Poly%array%. words!)
                      ) (I u64_idx!)
                     )
                    ) (vstd!arithmetic.power2.pow2.? (I bit_idx_nat@))
                 ...
                 (and
                  ...
                  (=>
                   ...
                   (and
                    (=>
                     %%location_label%%3
                     (req%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u64_shift_is_pow2. w_nat@)
                    )
                    (=>
                     (ens%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u64_shift_is_pow2. w_nat@)
                     (and
                      (=>
                       (fuel_bool fuel%vstd!bits.low_bits_mask.)
                       (=>
                        %%location_label%%4
                        (= (vstd!bits.low_bits_mask.? (I w_nat@)) (Sub (vstd!arithmetic.power2.pow2.? (I w_nat@))
                          1
                      ))))
                      (=>
                       (= (vstd!bits.low_bits_mask.? (I w_nat@)) (Sub (vstd!arithmetic.power2.pow2.? (I w_nat@))
                       ...
                       (and
                        ...
                        (=>
                         ...
                         (and
                          (=>
                           %%location_label%%6
                           (req%vstd!bits.lemma_u64_low_bits_mask_is_mod. bit_buf! w_nat@)
                          )
                          (=>
                           (ens%vstd!bits.lemma_u64_low_bits_mask_is_mod. bit_buf! w_nat@)
                           (and
                            (=>
                             %%location_label%%7
                             (req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_u64x4_single_word_decompose_generic.
