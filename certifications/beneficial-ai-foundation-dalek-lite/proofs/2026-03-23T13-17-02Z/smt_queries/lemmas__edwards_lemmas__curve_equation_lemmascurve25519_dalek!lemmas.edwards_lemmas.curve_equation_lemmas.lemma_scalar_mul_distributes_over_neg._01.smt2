...
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:1178:1: 1178:74 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::curve_equation_lemmas::lemma_scalar_mul_distributes_over_neg
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:1178:1: 1178:74 (#0)
...
(push)
 ...
 (declare-const half_n@ Int)
 (declare-const H@ tuple%2.)
 (declare-const prev_n@ Int)
           ...
           (and
            (=>
             ...
             (=>
              (= half_n@ (EucDiv n! 2))
              (=>
               (= H@ (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2. P!)
                 (I half_n@)
               ))
               (and
                (and
                ...
                (=>
                 (= (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_neg.?
                  ...
                  ) (curve25519_dalek!specs.edwards_specs.edwards_neg.? (Poly%tuple%2. H@))
                 )
                 (and
                  (=>
                   (ens%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_neg_distributes_over_add.
                    ...
                    (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_add.?
                       (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_neg.?
                        ...
                        (curve25519_dalek!specs.edwards_specs.edwards_add.? (tuple%2./tuple%2/0 (%Poly%tuple%2.
                         ...
                         ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. H@))) (tuple%2./tuple%2/0 (%Poly%tuple%2.
                           (Poly%tuple%2. H@)
                          )
                         ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. H@)))
                  )))))))
                  (=>
                   (= (curve25519_dalek!specs.edwards_specs.edwards_add.? (tuple%2./tuple%2/0 (%Poly%tuple%2.
                       (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_neg.? (Poly%tuple%2. H@)))
                      )
                     ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_neg.?
                         (Poly%tuple%2. H@)
                      )))
                       ...
                       (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. H@))) (tuple%2./tuple%2/1 (%Poly%tuple%2.
                         (Poly%tuple%2. H@)
                        )
                       ) (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. H@))) (tuple%2./tuple%2/1 (%Poly%tuple%2.
                         (Poly%tuple%2. H@)
            ...
            (=>
             (not (= (EucMod n! 2) 0))
             (=>
              (= prev_n@ (nClip (Sub n! 1)))
              (=>
               (= prev@ (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2. P!)
                 (I prev_n@)
               ))
               (and
                (and
                ...
                (=>
                 (= (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_neg.?
                  ...
                  ) (curve25519_dalek!specs.edwards_specs.edwards_neg.? (Poly%tuple%2. prev@))
                 )
                 (and
                  (=>
                   (ens%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_neg_distributes_over_add.
                    ...
                    (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_add.?
                       (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_neg.?
                        ...
                        (curve25519_dalek!specs.edwards_specs.edwards_add.? (tuple%2./tuple%2/0 (%Poly%tuple%2.
                          ...
                          (%Poly%tuple%2. (Poly%tuple%2. P!))
                         ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. P!)))
                  )))))))
                  (=>
                   (= (curve25519_dalek!specs.edwards_specs.edwards_add.? (tuple%2./tuple%2/0 (%Poly%tuple%2.
                       (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_neg.? (Poly%tuple%2. prev@)))
                      )
                     ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_neg.?
                         (Poly%tuple%2. prev@)
                      )))
      ...
      (=>
       ...
       (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.?
          ...
          (I n!)
           ...
           (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2. P!) (I n!))
 ))))))))))
 (get-info :version)
