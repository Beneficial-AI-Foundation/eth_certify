...
;; curve25519-dalek/src/lemmas/montgomery_curve_lemmas.rs:596:1: 596:67 (#0)
...
;; Function-Def curve25519_dalek::lemmas::montgomery_curve_lemmas::lemma_montgomery_scalar_mul_zero_point_closed
;; curve25519-dalek/src/lemmas/montgomery_curve_lemmas.rs:596:1: 596:67 (#0)
...
(push)
 ...
 (declare-const R_prev@ curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.)
        ...
        (=>
         ...
         (and
          ...
          (=>
           ...
           (=>
            (= R_prev@ (curve25519_dalek!specs.montgomery_specs.montgomery_scalar_mul.? (Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.
               P@
              ) (I (nClip (Sub n! 1)))
            ))
            (=>
             (= tmp%3 (or
               (= R_prev@ curve25519_dalek!specs.montgomery_specs.MontgomeryAffine./Infinity)
               (= R_prev@ P@)
             ))
             (and
              (=>
              ...
              (=>
               tmp%3
               (=>
                (= tmp%4 (= (curve25519_dalek!specs.montgomery_specs.montgomery_scalar_mul.? (Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.
                    P@
                   ) (I n!)
                  ) (curve25519_dalek!specs.montgomery_specs.montgomery_add.? (Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.
                    P@
                   ) (Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine. R_prev@)
                )))
                (and
                 (=>
                  %%location_label%%3
                  ...
                  (or
                   (and
                    (=>
                     (= R_prev@ curve25519_dalek!specs.montgomery_specs.MontgomeryAffine./Infinity)
                     (=>
                      (= tmp%5 (= (curve25519_dalek!specs.montgomery_specs.montgomery_add.? (Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.
                          P@
                         ) (Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine. curve25519_dalek!specs.montgomery_specs.MontgomeryAffine./Infinity)
                        ) P@
                      ))
                    ...
                    (=>
                     (not (= R_prev@ curve25519_dalek!specs.montgomery_specs.MontgomeryAffine./Infinity))
                     (and
                      (=>
                       (ens%curve25519_dalek!lemmas.montgomery_curve_lemmas.lemma_montgomery_add_zero_point_doubles_to_infinity.
                        0
