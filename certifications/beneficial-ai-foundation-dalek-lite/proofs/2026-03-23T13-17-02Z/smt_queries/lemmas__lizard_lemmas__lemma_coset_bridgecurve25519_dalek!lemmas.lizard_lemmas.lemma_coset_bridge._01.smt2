...
;; MODULE 'module lemmas::lizard_lemmas, function curve25519_dalek::lemmas::lizard_lemmas::lemma_coset_bridge'
;; curve25519-dalek/src/lemmas/lizard_lemmas.rs:214:1: 224:2 (#0)
 ...
 (=>
  ...
  (forall ((limbs! Poly) (bit_limit! Poly)) (!
    (= (curve25519_dalek!specs.field_specs.u64_5_bounded.? limbs! bit_limit!) (forall (
       ...
       :qid user_curve25519_dalek__specs__field_specs__u64_5_bounded_18
       :skolemid skolem_user_curve25519_dalek__specs__field_specs__u64_5_bounded_18
    )))
  ...
  (forall ((fe1! Poly) (fe2! Poly) (bound! Poly)) (!
    (= (curve25519_dalek!specs.field_specs.sum_of_limbs_bounded.? fe1! fe2! bound!) (forall
      ((i$ Poly)) (!
       ...
       :qid user_curve25519_dalek__specs__field_specs__sum_of_limbs_bounded_19
       :skolemid skolem_user_curve25519_dalek__specs__field_specs__sum_of_limbs_bounded_19
    )))
        ...
        (let
         ...
         (=>
          ...
          (forall ((i$ Poly)) (!
            ...
            :qid user_curve25519_dalek__lemmas__lizard_lemmas__lemma_jacobi_quartic_edge_values_20
            :skolemid skolem_user_curve25519_dalek__lemmas__lizard_lemmas__lemma_jacobi_quartic_edge_values_20
   )))))))))
...
;; Function-Def curve25519_dalek::lemmas::lizard_lemmas::lemma_coset_bridge
;; curve25519-dalek/src/lemmas/lizard_lemmas.rs:214:1: 224:2 (#0)
  ...
  (not (and
    ...
    (=>
     ...
     (and
      (=>
       %%location_label%%1
       (req%curve25519_dalek!lemmas.lizard_lemmas.axiom_jacobi_quartic_torsion_pair23. point!)
      )
      (=>
       (ens%curve25519_dalek!lemmas.lizard_lemmas.axiom_jacobi_quartic_torsion_pair23. point!)
       (and
        (=>
         %%location_label%%2
         (req%curve25519_dalek!lemmas.lizard_lemmas.lemma_jacobi_quartic_edge_values. point!)
