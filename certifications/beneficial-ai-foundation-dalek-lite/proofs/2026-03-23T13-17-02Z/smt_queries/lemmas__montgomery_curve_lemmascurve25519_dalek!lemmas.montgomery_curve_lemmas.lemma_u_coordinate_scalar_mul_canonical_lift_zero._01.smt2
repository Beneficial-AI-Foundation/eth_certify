...
;; curve25519-dalek/src/lemmas/montgomery_curve_lemmas.rs:628:1: 628:71 (#0)
...
;; Function-Def curve25519_dalek::lemmas::montgomery_curve_lemmas::lemma_u_coordinate_scalar_mul_canonical_lift_zero
;; curve25519-dalek/src/lemmas/montgomery_curve_lemmas.rs:628:1: 628:71 (#0)
       ...
       (or
        (and
         (=>
          (= R@ curve25519_dalek!specs.montgomery_specs.MontgomeryAffine./Infinity)
          (=>
           (= tmp%1 (= (curve25519_dalek!specs.montgomery_specs.u_coordinate.? (Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.
               curve25519_dalek!specs.montgomery_specs.MontgomeryAffine./Infinity
              )
             ) 0
           ))
         ...
         (=>
          (not (= R@ curve25519_dalek!specs.montgomery_specs.MontgomeryAffine./Infinity))
          (=>
           (= tmp%2 (= R@ P@))
           (and
            (=>
            ...
            (=>
             tmp%2
             (=>
              (= tmp%3 (= P@ (curve25519_dalek!specs.montgomery_specs.MontgomeryAffine./Finite (%I
                  (I 0)
                 ) (%I (I 0))
              )))
              (and
