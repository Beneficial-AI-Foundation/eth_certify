...
;; curve25519-dalek/src/lemmas/field_lemmas/compute_q_lemmas.rs:428:1: 428:61 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::compute_q_lemmas::lemma_all_carries_bounded_by_3
;; curve25519-dalek/src/lemmas/field_lemmas/compute_q_lemmas.rs:428:1: 428:61 (#0)
...
(push)
 ...
 (assert
  (forall ((i$ Poly)) (!
    ...
    :qid user_curve25519_dalek__lemmas__field_lemmas__compute_q_lemmas__lemma_all_carries_bounded_by_3_34
    :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__compute_q_lemmas__lemma_all_carries_bounded_by_3_34
 )))
 ;; assertion failed
          ...
          (=>
           ...
           (=>
            ...
            (and
             (=>
              %%location_label%%1
              (req%curve25519_dalek!lemmas.field_lemmas.compute_q_lemmas.lemma_bounded_shr_51. tmp%1)
             )
             (=>
              (ens%curve25519_dalek!lemmas.field_lemmas.compute_q_lemmas.lemma_bounded_shr_51. tmp%1)
              (=>
               ...
               (and
                (=>
                 %%location_label%%2
                 (req%curve25519_dalek!lemmas.field_lemmas.compute_q_lemmas.lemma_bounded_shr_51. tmp%2)
                )
                (=>
                 (ens%curve25519_dalek!lemmas.field_lemmas.compute_q_lemmas.lemma_bounded_shr_51. tmp%2)
                 (=>
                  ...
                  (and
                   (=>
                    %%location_label%%3
                    (req%curve25519_dalek!lemmas.field_lemmas.compute_q_lemmas.lemma_bounded_shr_51. tmp%3)
                   )
                   (=>
                    (ens%curve25519_dalek!lemmas.field_lemmas.compute_q_lemmas.lemma_bounded_shr_51. tmp%3)
                    (=>
                     (= tmp%4 (uClip 64 (Add (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $
                           (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. limbs!)
                          ) (I 3)
                         )
                        ) q2@
                     ...
                     (and
                      (=>
                       %%location_label%%4
                       (req%curve25519_dalek!lemmas.field_lemmas.compute_q_lemmas.lemma_bounded_shr_51. tmp%4)
                      )
                      (=>
                       (ens%curve25519_dalek!lemmas.field_lemmas.compute_q_lemmas.lemma_bounded_shr_51. tmp%4)
                       (=>
                        ...
                        (and
                         (=>
                          %%location_label%%5
                          (req%curve25519_dalek!lemmas.field_lemmas.compute_q_lemmas.lemma_bounded_shr_51. tmp%5)
                         )
                         (=>
                          (ens%curve25519_dalek!lemmas.field_lemmas.compute_q_lemmas.lemma_bounded_shr_51. tmp%5)
                          (=>
                           %%location_label%%6
                           (let
                            ((q0$ (uClip 64 (uClip 64 (bitshr (I (uClip 64 (Add (%I (vstd!seq.Seq.index.? $ (UINT 64) (
