...
;; curve25519-dalek/src/lemmas/field_lemmas/to_bytes_reduction_lemmas.rs:224:7: 224:39 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::to_bytes_reduction_lemmas::lemma_geometric_sum_5_terms
;; curve25519-dalek/src/lemmas/field_lemmas/to_bytes_reduction_lemmas.rs:224:7: 224:39 (#0)
    ...
    (=>
     ...
     (=>
      ...
      (=>
       ...
       (=>
        (= sum@ (nClip (Add (nClip (Add (nClip (Add (nClip (Add 1 (vstd!arithmetic.power2.pow2.? (I
                   51
                )))
        ...
        (=>
         (= lhs@ (Mul (Sub (vstd!arithmetic.power2.pow2.? (I 51)) 1) sum@))
         (and
          (=>
           (= tmp%1 (vstd!arithmetic.power2.pow2.? (I 51)))
           (=>
            (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub. sum@ tmp%1 1)
            (=>
             %%location_label%%0
             (= lhs@ (Sub (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 51)) sum@)) (nClip (Mul 1
                 sum@
          )))))))
          (=>
           (= lhs@ (Sub (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 51)) sum@)) (nClip (Mul 1
           ...
           (and
            (=>
             ...
             (=>
              ...
              (=>
               (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add. tmp%2 1 tmp%3)
               (=>
                (= tmp%4 (vstd!arithmetic.power2.pow2.? (I 51)))
                (=>
                 (= tmp%5 (Add 1 (vstd!arithmetic.power2.pow2.? (I 51))))
                 (=>
                  (= tmp%6 (vstd!arithmetic.power2.pow2.? (I 102)))
                  (=>
                   (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add. tmp%4 tmp%5 tmp%6)
                   (=>
                    (= tmp%7 (vstd!arithmetic.power2.pow2.? (I 51)))
                    (=>
                     (= tmp%8 (Add (nClip (Add 1 (vstd!arithmetic.power2.pow2.? (I 51)))) (vstd!arithmetic.power2.pow2.?
                        (I 102)
                     )))
                     (=>
                      (= tmp%9 (vstd!arithmetic.power2.pow2.? (I 153)))
                      (=>
                       (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add. tmp%7 tmp%8 tmp%9)
                       (=>
                        (= tmp%10 (vstd!arithmetic.power2.pow2.? (I 51)))
                        (=>
                         (= tmp%11 (Add (nClip (Add (nClip (Add 1 (vstd!arithmetic.power2.pow2.? (I 51)))) (vstd!arithmetic.power2.pow2.?
                              (I 102)
                            ))
                           ) (vstd!arithmetic.power2.pow2.? (I 153))
                         ))
                         (=>
                          (= tmp%12 (vstd!arithmetic.power2.pow2.? (I 204)))
                          (=>
                           (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add. tmp%10 tmp%11 tmp%12)
                           (=>
                            %%location_label%%1
                            (= (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 51)) sum@)) (nClip (Add (nClip (Add (
                                  nClip (Add (nClip (Add (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 51)) 1)) (nClip
                                      (Mul (vstd!arithmetic.power2.pow2.? (I 51)) (vstd!arithmetic.power2.pow2.? (I 51)))
                                    ))
                                   ) (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 51)) (vstd!arithmetic.power2.pow2.?
                                      (I 102)
                                  ))))
                                 ) (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 51)) (vstd!arithmetic.power2.pow2.?
                                    (I 153)
            ...
            (=>
             ...
             (=>
              (= tmp%13 (= (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 51)) (vstd!arithmetic.power2.pow2.?
                   (I 153)
                 ))
                ) (vstd!arithmetic.power2.pow2.? (I 204))
              ))
              (and
               ...
               (=>
                tmp%13
                (=>
                 (= tmp%14 (= (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 51)) (vstd!arithmetic.power2.pow2.?
                      (I 204)
                    ))
                 ...
                 (and
                  ...
                  (=>
                   ...
                   (=>
                    %%location_label%%4
                    (= (Mul (Sub (vstd!arithmetic.power2.pow2.? (I 51)) 1) (nClip (Add (nClip (Add (nClip (Add
                            (nClip (Add 1 (vstd!arithmetic.power2.pow2.? (I 51)))) (vstd!arithmetic.power2.pow2.?
                             (I 102)
                           ))
                          ) (vstd!arithmetic.power2.pow2.? (I 153))
                         )
