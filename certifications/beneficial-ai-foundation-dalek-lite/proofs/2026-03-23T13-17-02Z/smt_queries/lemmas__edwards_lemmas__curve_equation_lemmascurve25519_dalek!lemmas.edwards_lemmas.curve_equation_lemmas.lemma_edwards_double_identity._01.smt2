...
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:671:1: 671:45 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::curve_equation_lemmas::lemma_edwards_double_identity
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:671:1: 671:45 (#0)
          ...
          (=>
           ...
           (=>
            ...
            (and
             (=>
              %%location_label%%2
              (req%vstd!arithmetic.div_mod.lemma_mod_multiples_vanish. 1 1 tmp%3)
             )
             (=>
              (ens%vstd!arithmetic.div_mod.lemma_mod_multiples_vanish. 1 1 tmp%3)
              (=>
               (= x1x2@ (curve25519_dalek!specs.field_specs.field_mul.? (I 0) (I 0)))
               (=>
                (= y1y2@ (curve25519_dalek!specs.field_specs.field_mul.? (I 1) (I 1)))
                (=>
                 (= tmp%4 (= x1x2@ 0))
                 (and
                  (=>
                       ...
                       (and
                        (and
                         (=>
                          ...
                          (=>
                           (ens%vstd!arithmetic.mul.lemma_mul_basics_2. tmp%6)
                           (=>
                            %%location_label%%5
