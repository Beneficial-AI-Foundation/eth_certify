...
;; curve25519-dalek/src/lemmas/scalar_lemmas_/radix_2w_lemmas.rs:844:9: 844:15 (#0)
...
;; Function-Def curve25519_dalek::lemmas::scalar_lemmas_::radix_2w_lemmas::lemma_u64x4_cross_word_extraction
;; curve25519-dalek/src/lemmas/scalar_lemmas_/radix_2w_lemmas.rs:844:9: 844:15 (#0)
...
(declare-const bit_buf! (_ BitVec 64))
(declare-const low_w@ (_ BitVec 64))
(declare-const b@ (_ BitVec 64))
(declare-const w_u64@ (_ BitVec 64))
(declare-const mask_u64@ (_ BitVec 64))
(assert
 (= bit_buf! (bvor low_w@ (bvshl b@ w_u64@)))
)
(assert
 (= mask_u64@ (bvsub (bvshl ((_ zero_extend 63) (_ bv1 1)) w_u64@) ((_ zero_extend 63)
    (_ bv1 1)
))))
(assert
 (bvult low_w@ (bvshl ((_ zero_extend 63) (_ bv1 1)) w_u64@))
)
(assert
 (bvuge w_u64@ ((_ zero_extend 62) (_ bv2 2)))
)
(assert
 (bvule w_u64@ ((_ zero_extend 60) (_ bv8 4)))
)
