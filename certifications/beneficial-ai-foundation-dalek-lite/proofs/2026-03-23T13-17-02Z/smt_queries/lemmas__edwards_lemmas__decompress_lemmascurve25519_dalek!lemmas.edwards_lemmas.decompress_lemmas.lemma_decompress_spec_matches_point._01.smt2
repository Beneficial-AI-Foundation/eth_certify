...
;; curve25519-dalek/src/lemmas/edwards_lemmas/decompress_lemmas.rs:285:1: 285:79 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::decompress_lemmas::lemma_decompress_spec_matches_point
;; curve25519-dalek/src/lemmas/edwards_lemmas/decompress_lemmas.rs:285:1: 285:79 (#0)
         ...
         (=>
          ...
          (=>
           ...
           (and
            (=>
             %%location_label%%1
             (req%vstd!arithmetic.div_mod.lemma_small_mod. u@ tmp%1)
            )
            (=>
             (ens%vstd!arithmetic.div_mod.lemma_small_mod. u@ tmp%1)
             (=>
                      ...
                      (=>
                       ...
                       (and
                        ...
                        (=>
                         tmp%4
                         (=>
                          (= tmp%5 (< x! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))))
                          (and
                           (=>
                            %%location_label%%5
                            tmp%5
     ...
     (or
      (and
       (=>
        ...
        (and
         (=>
          (= d$1@ (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
             curve25519_dalek!backend.serial.u64.constants.EDWARDS_D.?
          )))
          (=>
           (ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_d_plus_one_nonzero.
      ...
      (and
       (not %%switch_label%%0)
       (=>
        (= x_chosen@ (%I (as_type (%%choose%%0 NAT (I y!) (curve25519_dalek!specs.field_specs_u64.p.?
             (I 0)
            ) 2 sign_bit! (I y!)
           ) NAT
        )))
