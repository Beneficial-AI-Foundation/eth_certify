...
;; curve25519-dalek/src/lemmas/edwards_lemmas/mul_base_lemmas.rs:529:1: 529:69 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::mul_base_lemmas::lemma_radix16_even_scalar_step
;; curve25519-dalek/src/lemmas/edwards_lemmas/mul_base_lemmas.rs:529:1: 529:69 (#0)
          ...
          (=>
           ...
           (and
            ...
            (=>
             (= (curve25519_dalek!specs.edwards_specs.pow256.? (I 0)) 1)
             (=>
              (= tmp%2 (= (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_even_scalar.?
              ...
              (and
               ...
               (=>
                tmp%2
                (=>
                 (= tmp%3 (= (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_even_scalar.?
                    (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I 2) (I (vstd!seq.Seq.len.?
                       $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!)
                     ))
                    ) (I 0)
                  ...
                  (=>
                   ...
                   (=>
                    ...
                    (=>
                     ...
                     (=>
                      (= tmp%5 (= (Mul (curve25519_dalek!specs.edwards_specs.pow256.? (I 1)) (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_even_scalar.?
                          (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I 2) (I (vstd!seq.Seq.len.?
                             $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!)
                           ))
                          ) (I 0)
                      ...
                      (and
                       ...
                       (=>
                        tmp%5
                        (=>
                         (= tmp%6 (= (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_even_scalar.?
                            (Poly%vstd!seq.Seq<i8.>. digits!) (I 1)
                           ) (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I 0)))
                         ))
                         (and
                          (=>
                           %%location_label%%5
                          ...
                          (=>
                           tmp%6
                           (=>
                            (= tmp%7 (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I 0))))
                            (=>
                             (ens%vstd!arithmetic.mul.lemma_mul_basics_3. tmp%7)
                             (=>
                              (= tmp%8 (= (Add (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_even_scalar.?
                                  (Poly%vstd!seq.Seq<i8.>. digits!) (I 0)
                                 ) (Mul (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I 0)))
           ...
           (and
            ...
            (=>
             ...
             (=>
              ...
              (and
               (=>
                (= tmp%10 (>= (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!)) (nClip
                   (Mul 2 n!)
                )))
                (and
                 (=>
                 ...
                 (=>
                  ...
                  (=>
                   %%location_label%%10
                   (>= (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. suf@)) (nClip (Mul 2 nm1@)))
               ))))
               (=>
                (>= (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. suf@)) (nClip (Mul 2 nm1@)))
                (=>
                 (= suf_idx@ (nClip (Mul 2 nm2@)))
                 (=>
                    ...
                    (=>
                     ...
                     (and
                      ...
                      (=>
                       tmp%12
                       (=>
                        (= tmp%13 (= (Add suf_idx@ 2) (nClip (Mul 2 nm1@))))
                        (and
                         (=>
                          %%location_label%%13
                          tmp%13
                         ...
                         (=>
                          ...
                          (=>
                           (= tmp%14 (= (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. suf@) (I suf_idx@))
                             (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I (nClip (Mul 2 nm1@))))
                           ))
                           (and
                            (=>
                             %%location_label%%14
                                ...
                                (and
                                 (and
                                  ...
                                  (=>
                                   ...
                                   (and
                                    (=>
                                     (= tmp%19 (= (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_even_scalar.?
                                        (Poly%vstd!seq.Seq<i8.>. suf@) (I nm1@)
                                       ) (Add (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_even_scalar.?
                                     ...
                                     (and
                                      ...
                                      (=>
                                       ...
                                       (=>
                                        ...
                                        (=>
                                         (= tmp%21 (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_even_scalar.?
                                           (Poly%vstd!seq.Seq<i8.>. suf@) (I nm2@)
                                         ))
                                         (=>
                                    ...
                                    (=>
                                     ...
                                     (and
                                      ...
                                      (=>
                                       ...
                                       (and
                                        (=>
                                         (= tmp%26 (= (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_even_scalar.?
