...
;; curve25519-dalek/src/lemmas/scalar_byte_lemmas/scalar_to_bytes_lemmas.rs:866:1: 866:87 (#0)
...
;; Function-Def curve25519_dalek::lemmas::scalar_byte_lemmas::scalar_to_bytes_lemmas::lemma_limb2_contribution_correctness_52
;; curve25519-dalek/src/lemmas/scalar_byte_lemmas/scalar_to_bytes_lemmas.rs:866:1: 866:87 (#0)
...
(push)
 ...
 (declare-const l2_low@ Int)
 (declare-const l2_high@ Int)
  ...
  (not (=>
    ...
    (and
     ...
     (=>
      ...
      (=>
       (= l2_low@ (EucMod (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY
             $ (UINT 64) $ (CONST_INT 5)
            ) (Poly%array%. limbs!)
           ) (I 2)
          )
       ...
       (=>
        (= l2_high@ (EucDiv (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY
              $ (UINT 64) $ (CONST_INT 5)
             ) (Poly%array%. limbs!)
            ) (I 2)
           )
        ...
        (=>
         ...
         (and
          (=>
           %%location_label%%1
           (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_div_bound. tmp%1 48 52)
          )
          (=>
           (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_div_bound. tmp%1 48 52)
           (=>
            (= tmp%2 (< l2_high@ (vstd!arithmetic.power2.pow2.? (I 4))))
            (and
             (=>
              %%location_label%%2
              tmp%2
             ...
             (=>
              ...
              (and
               (=>
                %%location_label%%3
                (req%vstd!arithmetic.div_mod.lemma_small_mod. l2_high@ 16)
               )
               (=>
                (ens%vstd!arithmetic.div_mod.lemma_small_mod. l2_high@ 16)
                (=>
                 (= tmp%3 (= (EucMod l2_high@ 16) l2_high@))
                 (and
                  (=>
                   %%location_label%%4
                   tmp%3
                  ...
                  (=>
                   ...
                   (=>
                    ...
                    (=>
                     ...
                     (=>
                      (= tmp%5 (vstd!arithmetic.power2.pow2.? (I 48)))
                      (and
                       (=>
                        %%location_label%%5
                        (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. tmp%4 tmp%5)
                       )
                       (=>
                        (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. tmp%4 tmp%5)
                        (and
                         (=>
                          (= tmp%6 (vstd!arithmetic.power2.pow2.? (I 48)))
                          (=>
                           (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. tmp%6 l2_high@)
                           (=>
                            %%location_label%%6
                            (= (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 48)) l2_high@)) (nClip (Mul l2_high@
                               (vstd!arithmetic.power2.pow2.? (I 48))
                         ))))))
                         (=>
                          (= (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 48)) l2_high@)) (nClip (Mul l2_high@
                          ...
                          (=>
                           (= tmp%7 (= (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT
                             ...
                             ) (nClip (Add l2_low@ (nClip (Mul l2_high@ (vstd!arithmetic.power2.pow2.? (I 48))))))
                           ))
                           (and
                            (=>
                             %%location_label%%7
                                                    ...
                                                    (=>
                                                     ...
                                                     (and
                                                      ...
                                                      (=>
                                                       ...
                                                       (=>
                                                        (= tmp%21 (vstd!arithmetic.power2.pow2.? (I 48)))
                                                        (and
                                                         (=>
                                                          %%location_label%%14
                                                          (req%vstd!arithmetic.div_mod.lemma_mod_bound. l2_low@ tmp%21)
                                                         )
                                                         (=>
                                                          (ens%vstd!arithmetic.div_mod.lemma_mod_bound. l2_low@ tmp%21)
                                                          (=>
                                                             ...
                                                             (=>
                                                              ...
                                                              (and
                                                               ...
                                                               (=>
                                                                ...
                                                                (=>
                                                                 (= tmp%24 (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT
                                                                       64
                                                                      ) $ (CONST_INT 5)
                                                                     ) (Poly%array%. limbs!)
                                                                    ) (I 2)
                                                                 ...
                                                                 (and
                                                                  ...
                                                                  (=>
                                                                   ...
                                                                   (=>
                                                                    (= tmp%25 (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT
                                                                          64
                                                                         ) $ (CONST_INT 5)
                                                                        ) (Poly%array%. limbs!)
                                                                       ) (I 2)
                                                                                 ...
                                                                                 (=>
                                                                                  ...
                                                                                  (and
                                                                                   (=>
                                                                                    %%location_label%%21
                                                                                    (req%curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.lemma_6_bytes_reconstruct.
                                                                                     l2_low@ tmp%28 tmp%29 tmp%30 tmp%31 tmp%32 tmp%33
                                                                                   ))
                                                                                   (=>
                                                                                    (ens%curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.lemma_6_bytes_reconstruct.
                                                                                     l2_low@ tmp%28 tmp%29 tmp%30 tmp%31 tmp%32 tmp%33
                                                                                    ...
                                                                                    (=>
                                                                                     ...
                                                                                     (=>
                                                                                      (= tmp%34 (= bytes_at_offset_0@ l2_low@))
                                                                                      (and
                                                                                       (=>
                                                                                        %%location_label%%22
                                                                                        tmp%34
                                                                                       ...
                                                                                       (=>
                                                                                        tmp%34
                                                                                        (=>
                                                                                         (= tmp%35 (= (nClip (Mul (nClip (Add l2_low@ (nClip (Mul l2_high@ (vstd!arithmetic.power2.pow2.?
                                                                                                  (I 48)
                                                                                              ))))
                                                                                             ) (vstd!arithmetic.power2.pow2.? (I 104))
                                                                                            )
                                                                                         ...
                                                                                         (and
                                                                                          ...
                                                                                          (=>
                                                                                           ...
                                                                                           (and
                                                                                            (=>
                                                                                             (= tmp%36 (vstd!arithmetic.power2.pow2.? (I 104)))
                                                                                             (=>
                                                                                              (= tmp%37 (nClip (Mul l2_high@ (vstd!arithmetic.power2.pow2.? (I 48)))))
                                                                                              (=>
                                                                                               (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. tmp%36 l2_low@ tmp%37)
                                                                                               (=>
                                                                                                %%location_label%%24
                                                                                                (= (nClip (Mul (nClip (Add l2_low@ (nClip (Mul l2_high@ (vstd!arithmetic.power2.pow2.? (I
                                                                                                         48
                                                                                                    )))))
                                                                                                   ) (vstd!arithmetic.power2.pow2.? (I 104))
                                                                                                  )
                                                                                                 ) (nClip (Add (nClip (Mul l2_low@ (vstd!arithmetic.power2.pow2.? (I 104)))) (nClip (
                                                                                                     Mul (nClip (Mul l2_high@ (vstd!arithmetic.power2.pow2.? (I 48)))) (vstd!arithmetic.power2.pow2.?
                                                                                                      (I 104)
                                                                                            ))))))))))
                                                                                            (=>
                                                                                             (= (nClip (Mul (nClip (Add l2_low@ (nClip (Mul l2_high@ (vstd!arithmetic.power2.pow2.? (I
                                                                                             ...
                                                                                             (=>
                                                                                              (ens%vstd!arithmetic.power2.lemma_pow2_adds. 48 104)
                                                                                              (and
                                                                                               (=>
                                                                                                (= tmp%38 (vstd!arithmetic.power2.pow2.? (I 48)))
                                                                                                (=>
                                                                                                 (= tmp%39 (vstd!arithmetic.power2.pow2.? (I 104)))
                                                                                                 (=>
                                                                                                  (ens%vstd!arithmetic.mul.lemma_mul_is_associative. l2_high@ tmp%38 tmp%39)
                                                                                                  (=>
                                                                                                   %%location_label%%25
                                                                                                   (= (nClip (Mul (nClip (Mul l2_high@ (vstd!arithmetic.power2.pow2.? (I 48)))) (vstd!arithmetic.power2.pow2.?
                                                                                                       (I 104)
                                                                                                     ))
                                                                                                    ) (nClip (Mul l2_high@ (vstd!arithmetic.power2.pow2.? (I 152))))
                                                                                               )))))
                                                                                               (=>
                                                                                                (= (nClip (Mul (nClip (Mul l2_high@ (vstd!arithmetic.power2.pow2.? (I 48)))) (vstd!arithmetic.power2.pow2.?
                                                                                                    (I 104)
                                                                                                ...
                                                                                                (=>
                                                                                                 (= tmp%40 (= (nClip (Mul bytes_at_offset_0@ (vstd!arithmetic.power2.pow2.? (I 104))))
                                                                                                   (nClip (Mul l2_low@ (vstd!arithmetic.power2.pow2.? (I 104))))
                                                                                                 ))
                                                                                                 (and
                                                                                                  (=>
                                                                                                   %%location_label%%26
                                                                                                  ...
                                                                                                  (=>
                                                                                                   ...
                                                                                                   (and
                                                                                                    (=>
                                                                                                     (= tmp%41 (vstd!arithmetic.power2.pow2.? (I 104)))
                                                                                                     (=>
                                                                                                      (= tmp%42 (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY
                                                                                                             $ (UINT 8) $ (CONST_INT 32)
                                                                                                            ) (Poly%array%. bytes!)
                                                                                                           ) (I 13)
                                                                                                          )
                                                                                                      ...
                                                                                                      (=>
                                                                                                       (= tmp%43 (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY
                                                                                                              $ (UINT 8) $ (CONST_INT 32)
                                                                                                             ) (Poly%array%. bytes!)
                                                                                                            ) (I 14)
                                                                                                           )
                                                                                                       ...
                                                                                                       (=>
                                                                                                        (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. tmp%41 tmp%42 tmp%43)
                                                                                                        (=>
                                                                                                         (= tmp%44 (vstd!arithmetic.power2.pow2.? (I 104)))
                                                                                                         (=>
                                                                                                          (= tmp%45 (nClip (Add (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.?
                                                                                                          ...
                                                                                                          (=>
                                                                                                           (= tmp%46 (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY
                                                                                                                  $ (UINT 8) $ (CONST_INT 32)
                                                                                                                 ) (Poly%array%. bytes!)
                                                                                                                ) (I 15)
                                                                                                               )
                                                                                                           ...
                                                                                                           (=>
                                                                                                            (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. tmp%44 tmp%45 tmp%46)
                                                                                                            (=>
                                                                                                             (= tmp%47 (vstd!arithmetic.power2.pow2.? (I 104)))
                                                                                                             (=>
                                                                                                              (= tmp%48 (nClip (Add (nClip (Add (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.?
                                                                                                                        $ (ARRAY $ (UINT 8) $ (CONST_INT 32)) (Poly%array%. bytes!)
                                                                                                                       ) (I 13)
                                                                                                                      )
                                                                                                                     ) (vstd!arithmetic.power2.pow2.? (I 0))
                                                                                                              ...
                                                                                                              (=>
                                                                                                               ...
                                                                                                               (=>
                                                                                                                (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. tmp%47 tmp%48 tmp%49)
                                                                                                                (=>
                                                                                                                 (= tmp%50 (vstd!arithmetic.power2.pow2.? (I 104)))
                                                                                                                 (=>
                                                                                                                  (= tmp%51 (nClip (Add (nClip (Add (nClip (Add (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8)
                                                                                                                  ...
                                                                                                                  (=>
                                                                                                                   ...
                                                                                                                   (=>
                                                                                                                    (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. tmp%50 tmp%51 tmp%52)
                                                                                                                    (=>
                                                                                                                     (= tmp%53 (vstd!arithmetic.power2.pow2.? (I 104)))
                                                                                                                     (=>
                                                                                                                      (= tmp%54 (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip (Mul (%I (vstd!seq.Seq.index.?
                                                                                                                      ...
                                                                                                                      (=>
                                                                                                                       ...
                                                                                                                       (=>
                                                                                                                        (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. tmp%53 tmp%54 tmp%55)
                                                                                                                        (=>
                                                                                                                         (= tmp%56 (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT
                                                                                                                               8
                                                                                                                              ) $ (CONST_INT 32)
                                                                                                                             ) (Poly%array%. bytes!)
                                                                                                                            ) (I 13)
                                                                                                                         ...
                                                                                                                         (=>
                                                                                                                          (= tmp%57 (vstd!arithmetic.power2.pow2.? (I 0)))
                                                                                                                          (=>
                                                                                                                           (= tmp%58 (vstd!arithmetic.power2.pow2.? (I 104)))
                                                                                                                           (=>
                                                                                                                            (ens%vstd!arithmetic.mul.lemma_mul_is_associative. tmp%56 tmp%57 tmp%58)
                                                                                                                            (=>
                                                                                                                             ...
                                                                                                                             (=>
                                                                                                                              (= tmp%60 (vstd!arithmetic.power2.pow2.? (I 8)))
                                                                                                                              (=>
                                                                                                                               (= tmp%61 (vstd!arithmetic.power2.pow2.? (I 104)))
                                                                                                                               (=>
                                                                                                                                (ens%vstd!arithmetic.mul.lemma_mul_is_associative. tmp%59 tmp%60 tmp%61)
                                                                                                                                (=>
                                                                                                                                 (= tmp%62 (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT
                                                                                                                                       8
                                                                                                                                      ) $ (CONST_INT 32)
                                                                                                                                     ) (Poly%array%. bytes!)
                                                                                                                                    ) (I 15)
                                                                                                                                 ...
                                                                                                                                 (=>
                                                                                                                                  (= tmp%63 (vstd!arithmetic.power2.pow2.? (I 16)))
                                                                                                                                  (=>
                                                                                                                                   (= tmp%64 (vstd!arithmetic.power2.pow2.? (I 104)))
                                                                                                                                   (=>
                                                                                                                                    (ens%vstd!arithmetic.mul.lemma_mul_is_associative. tmp%62 tmp%63 tmp%64)
                                                                                                                                    (=>
                                                                                                                                     ...
                                                                                                                                     (=>
                                                                                                                                      (= tmp%66 (vstd!arithmetic.power2.pow2.? (I 24)))
                                                                                                                                      (=>
                                                                                                                                       ...
                                                                                                                                       (=>
                                                                                                                                        ...
                                                                                                                                        (=>
                                                                                                                                         ...
                                                                                                                                         (=>
                                                                                                                                          (= tmp%69 (vstd!arithmetic.power2.pow2.? (I 32)))
                                                                                                                                          (=>
                                                                                                                                             ...
                                                                                                                                             (=>
                                                                                                                                              ...
                                                                                                                                              (=>
                                                                                                                                               ...
                                                                                                                                               (=>
                                                                                                                                                ...
                                                                                                                                                (=>
                                                                                                                                                 %%location_label%%27
                                                                                                                                                 (= (nClip (Mul bytes_at_offset_0@ (vstd!arithmetic.power2.pow2.? (I 104)))) (nClip
                                                                                                    ...
                                                                                                    (=>
                                                                                                     ...
                                                                                                     (and
                                                                                                      (=>
                                                                                                       ...
                                                                                                       (=>
                                                                                                        (= tmp%75 (vstd!arithmetic.power2.pow2.? (I 0)))
                                                                                                        (=>
                                                                                                         ...
                                                                                                         (=>
                                                                                                          ...
                                                                                                          (=>
                                                                                                           ...
                                                                                                           (=>
                                                                                                            (= tmp%78 (vstd!arithmetic.power2.pow2.? (I 8)))
                                                                                                            (=>
                                                                                                                ...
                                                                                                                (=>
                                                                                                                 ...
                                                                                                                 (=>
                                                                                                                  ...
                                                                                                                  (=>
                                                                                                                   ...
                                                                                                                   (=>
                                                                                                                    (= tmp%84 (vstd!arithmetic.power2.pow2.? (I 24)))
                                                                                                                    (=>
                                                                                                                     (= tmp%85 (vstd!arithmetic.power2.pow2.? (I 104)))
                                                                                                                     (=>
                                                                                                                      ...
                                                                                                                      (=>
                                                                                                                       ...
                                                                                                                       (=>
                                                                                                                        (= tmp%87 (vstd!arithmetic.power2.pow2.? (I 32)))
                                                                                                                        (=>
                                                                                                                         (= tmp%88 (vstd!arithmetic.power2.pow2.? (I 104)))
                                                                                                                         (=>
                                                                                                                          ...
                                                                                                                          (=>
                                                                                                                           ...
                                                                                                                           (=>
                                                                                                                            (= tmp%90 (vstd!arithmetic.power2.pow2.? (I 40)))
                                                                                                                            (=>
                                                                                                                             (= tmp%91 (vstd!arithmetic.power2.pow2.? (I 104)))
                                                                                                                             (=>
                                                                                                                              (ens%vstd!arithmetic.mul.lemma_mul_is_associative. tmp%89 tmp%90 tmp%91)
                                                                                                                              (=>
                                                                                                                               (ens%vstd!arithmetic.power2.lemma_pow2_adds. 0 104)
                                                                                                                               (=>
                                                                                                                                (ens%vstd!arithmetic.power2.lemma_pow2_adds. 8 104)
                                                                                                                                (=>
                                                                                                                                 (ens%vstd!arithmetic.power2.lemma_pow2_adds. 16 104)
                                                                                                                                 (=>
                                                                                                                                  (ens%vstd!arithmetic.power2.lemma_pow2_adds. 24 104)
                                                                                                                                  (=>
                                                                                                                                   (ens%vstd!arithmetic.power2.lemma_pow2_adds. 32 104)
                                                                                                                                   (=>
                                                                                                                                    (ens%vstd!arithmetic.power2.lemma_pow2_adds. 40 104)
                                                                                                                                    (=>
                                                                                                                                     %%location_label%%28
                                                                                                                                     (= (nClip (Mul bytes_at_offset_0@ (vstd!arithmetic.power2.pow2.? (I 104)))) (nClip
                                                                                                                                       (Add (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip (Mul (%I (vstd!seq.Seq.index.? $ (
                                                                                                                                                  ...
                                                                                                                                                  ) (vstd!arithmetic.power2.pow2.? (I 112))
                                                                                                                                               )))
                                                                                                                                              ) (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT
                                                                                                                                                     8
                                                                                                                                                    ) $ (CONST_INT 32)
                                                                                                                                                ...
                                                                                                                                                ) (vstd!arithmetic.power2.pow2.? (I 120))
                                                                                                                                             )))
                                                                                                                                            ) (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT
                                                                                                                                                   8
                                                                                                                                                  ) $ (CONST_INT 32)
                                                                                                                                            ...
                                                                                                                                            ) (vstd!arithmetic.power2.pow2.? (I 136))
                                                                                                                                         )))
                                                                                                                                        ) (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT
                                                                                                                                               8
                                                                                                                                              ) $ (CONST_INT 32)
                                                                                                                                          ...
                                                                                                                                          ) (vstd!arithmetic.power2.pow2.? (I 144))
                                                                                                      ))))))))))))))))))))))))))))))))))))
                                                                                                      (=>
                                                                                                       (= (nClip (Mul bytes_at_offset_0@ (vstd!arithmetic.power2.pow2.? (I 104)))) (nClip
                                                                                                         (Add (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip (Mul (%I (vstd!seq.Seq.index.? $ (
