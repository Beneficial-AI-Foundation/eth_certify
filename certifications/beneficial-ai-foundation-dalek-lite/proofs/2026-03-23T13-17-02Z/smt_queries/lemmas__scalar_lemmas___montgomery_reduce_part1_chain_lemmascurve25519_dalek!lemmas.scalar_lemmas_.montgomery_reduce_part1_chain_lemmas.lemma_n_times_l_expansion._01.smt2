...
;; MODULE 'module lemmas::scalar_lemmas_::montgomery_reduce_part1_chain_lemmas'
;; curve25519-dalek/src/lemmas/scalar_lemmas_/montgomery_reduce_part1_chain_lemmas.rs:251:1: 262:2 (#0)
...
(assert
 (distinct fuel%vstd!arithmetic.div_mod.lemma_mod_self_0. fuel%vstd!arithmetic.div_mod.lemma_mod_twice.
  fuel%vstd!arithmetic.div_mod.lemma_add_mod_noop. fuel%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right.
  ...
  fuel%curve25519_dalek!backend.serial.u64.constants.L. fuel%curve25519_dalek!lemmas.scalar_lemmas_.montgomery_reduce_part1_chain_lemmas.l0.
  fuel%curve25519_dalek!specs.scalar52_specs.five_u64_limbs_to_nat. fuel%vstd!arithmetic.mul.group_mul_is_distributive.
...
(assert
 (=>
  ...
  (forall ((x! Int) (y! Int) (m! Int)) (!
    ...
    :qid user_vstd__arithmetic__div_mod__lemma_mul_mod_noop_right_21
    :skolemid skolem_user_vstd__arithmetic__div_mod__lemma_mul_mod_noop_right_21
))))
...
(assert
 (=>
  ...
  (forall ((x! Int) (y! Int) (z! Int)) (!
    ...
    :qid user_vstd__arithmetic__mul__lemma_mul_is_distributive_add_other_way_25
    :skolemid skolem_user_vstd__arithmetic__mul__lemma_mul_is_distributive_add_other_way_25
))))
...
(assert
 (=>
  ...
  (forall ((e! Poly)) (!
    ...
    :pattern ((vstd!arithmetic.power2.pow2.? e!))
    :qid user_vstd__arithmetic__power2__lemma_pow2_pos_28
    :skolemid skolem_user_vstd__arithmetic__power2__lemma_pow2_pos_28
))))
...
(assert
 (=>
  ...
  (forall ((e1! Int) (e2! Int)) (!
    ...
    :qid user_vstd__arithmetic__power2__lemma_pow2_adds_29
    :skolemid skolem_user_vstd__arithmetic__power2__lemma_pow2_adds_29
))))
...
;; Function-Specs curve25519_dalek::lemmas::scalar_lemmas_::montgomery_reduce_part1_chain_lemmas::lemma_part1_telescoping_expansion
(declare-fun req%curve25519_dalek!lemmas.scalar_lemmas_.montgomery_reduce_part1_chain_lemmas.lemma_part1_telescoping_expansion.
...
(assert
 (forall ((s0! Int) (s1! Int) (s2! Int) (s3! Int) (s4! Int) (n0! Int) (n1! Int) (n2!
    Int
   ) (n3! Int) (n4! Int) (c0! Int) (c1! Int) (c2! Int) (c3! Int) (c4! Int) (l0! Int)
  ) (!
   (= (req%curve25519_dalek!lemmas.scalar_lemmas_.montgomery_reduce_part1_chain_lemmas.lemma_part1_telescoping_expansion.
     s0! s1! s2! s3! s4! n0! n1! n2! n3! n4! c0! c1! c2! c3! c4! l0!
    ) (and
     (=>
      %%global_location_label%%10
      (= (nClip (Add s0! (nClip (Mul n0! l0!)))) (nClip (Mul c0! (vstd!arithmetic.power2.pow2.?
          (I 52)
     )))))
     (=>
      %%global_location_label%%11
      (= (nClip (Add s1! (nClip (Mul n1! l0!)))) (nClip (Mul c1! (vstd!arithmetic.power2.pow2.?
          (I 52)
     )))))
     (=>
      %%global_location_label%%12
      (= (nClip (Add s2! (nClip (Mul n2! l0!)))) (nClip (Mul c2! (vstd!arithmetic.power2.pow2.?
          (I 52)
     )))))
     (=>
      %%global_location_label%%13
      (= (nClip (Add s3! (nClip (Mul n3! l0!)))) (nClip (Mul c3! (vstd!arithmetic.power2.pow2.?
          (I 52)
     )))))
     (=>
      %%global_location_label%%14
      (= (nClip (Add s4! (nClip (Mul n4! l0!)))) (nClip (Mul c4! (vstd!arithmetic.power2.pow2.?
          (I 52)
   )))))))
   :pattern ((req%curve25519_dalek!lemmas.scalar_lemmas_.montgomery_reduce_part1_chain_lemmas.lemma_part1_telescoping_expansion.
     s0! s1! s2! s3! s4! n0! n1! n2! n3! n4! c0! c1! c2! c3! c4! l0!
   ))
   :qid internal_req__curve25519_dalek!lemmas.scalar_lemmas_.montgomery_reduce_part1_chain_lemmas.lemma_part1_telescoping_expansion._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.scalar_lemmas_.montgomery_reduce_part1_chain_lemmas.lemma_part1_telescoping_expansion._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.scalar_lemmas_.montgomery_reduce_part1_chain_lemmas.lemma_part1_telescoping_expansion.
 (Int Int Int Int Int Int Int Int Int Int Int Int Int Int Int Int) Bool
)
(assert
 (forall ((s0! Int) (s1! Int) (s2! Int) (s3! Int) (s4! Int) (n0! Int) (n1! Int) (n2!
   ...
   (= (ens%curve25519_dalek!lemmas.scalar_lemmas_.montgomery_reduce_part1_chain_lemmas.lemma_part1_telescoping_expansion.
     s0! s1! s2! s3! s4! n0! n1! n2! n3! n4! c0! c1! c2! c3! c4! l0!
    ) (= (Add (Add (Add (Add (nClip (Add s0! (nClip (Mul n0! l0!)))) (Mul (Add (Sub s1! c0!)
           (nClip (Mul n1! l0!))
          ) (vstd!arithmetic.power2.pow2.? (I 52))
         )
        ) (Mul (Add (Sub s2! c1!) (nClip (Mul n2! l0!))) (vstd!arithmetic.power2.pow2.? (I 104)))
       ) (Mul (Add (Sub s3! c2!) (nClip (Mul n3! l0!))) (vstd!arithmetic.power2.pow2.? (I 156)))
      ) (Mul (Add (Sub s4! c3!) (nClip (Mul n4! l0!))) (vstd!arithmetic.power2.pow2.? (I 208)))
     ) (nClip (Mul c4! (vstd!arithmetic.power2.pow2.? (I 260))))
   ))
   :pattern ((ens%curve25519_dalek!lemmas.scalar_lemmas_.montgomery_reduce_part1_chain_lemmas.lemma_part1_telescoping_expansion.
     s0! s1! s2! s3! s4! n0! n1! n2! n3! n4! c0! c1! c2! c3! c4! l0!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.scalar_lemmas_.montgomery_reduce_part1_chain_lemmas.lemma_part1_telescoping_expansion._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.scalar_lemmas_.montgomery_reduce_part1_chain_lemmas.lemma_part1_telescoping_expansion._definition
)))
...
;; Function-Specs curve25519_dalek::lemmas::scalar_lemmas_::montgomery_reduce_part1_chain_lemmas::lemma_n_times_l_expansion
(declare-fun req%curve25519_dalek!lemmas.scalar_lemmas_.montgomery_reduce_part1_chain_lemmas.lemma_n_times_l_expansion.
 (Int Int Int Int Int Int Int Int Int Int) Bool
)
(declare-const %%global_location_label%%15 Bool)
(assert
 (forall ((n0! Int) (n1! Int) (n2! Int) (n3! Int) (n4! Int) (l0! Int) (l1! Int) (l2!
    Int
   ) (l3! Int) (l4! Int)
  ) (!
   (= (req%curve25519_dalek!lemmas.scalar_lemmas_.montgomery_reduce_part1_chain_lemmas.lemma_n_times_l_expansion.
     n0! n1! n2! n3! n4! l0! l1! l2! l3! l4!
    ) (=>
     %%global_location_label%%15
     (= l3! 0)
   ))
   :pattern ((req%curve25519_dalek!lemmas.scalar_lemmas_.montgomery_reduce_part1_chain_lemmas.lemma_n_times_l_expansion.
     n0! n1! n2! n3! n4! l0! l1! l2! l3! l4!
   ))
   :qid internal_req__curve25519_dalek!lemmas.scalar_lemmas_.montgomery_reduce_part1_chain_lemmas.lemma_n_times_l_expansion._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.scalar_lemmas_.montgomery_reduce_part1_chain_lemmas.lemma_n_times_l_expansion._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.scalar_lemmas_.montgomery_reduce_part1_chain_lemmas.lemma_n_times_l_expansion.
 (Int Int Int Int Int Int Int Int Int Int) Bool
)
(assert
 (forall ((n0! Int) (n1! Int) (n2! Int) (n3! Int) (n4! Int) (l0! Int) (l1! Int) (l2!
   ...
   (= (ens%curve25519_dalek!lemmas.scalar_lemmas_.montgomery_reduce_part1_chain_lemmas.lemma_n_times_l_expansion.
     n0! n1! n2! n3! n4! l0! l1! l2! l3! l4!
    ) (and
     (let
      ((n$ (nClip (Add (nClip (Add (nClip (Add (nClip (Add n0! (nClip (Mul n1! (vstd!arithmetic.power2.pow2.?
                   (I 52)
               ))))
              ) (nClip (Mul n2! (vstd!arithmetic.power2.pow2.? (I 104))))
             )
            ) (nClip (Mul n3! (vstd!arithmetic.power2.pow2.? (I 156))))
           )
          ) (nClip (Mul n4! (vstd!arithmetic.power2.pow2.? (I 208))))
      ))))
      (let
       ((l_low$ (nClip (Add (nClip (Add (nClip (Add (nClip (Add l0! (nClip (Mul l1! (vstd!arithmetic.power2.pow2.?
                    (I 52)
                ))))
               ) (nClip (Mul l2! (vstd!arithmetic.power2.pow2.? (I 104))))
              )
             ) (nClip (Mul l3! (vstd!arithmetic.power2.pow2.? (I 156))))
            )
           ) (nClip (Mul l4! (vstd!arithmetic.power2.pow2.? (I 208))))
       ))))
       (let
        ((coeff0$ (nClip (Mul n0! l0!))))
        (let
         ((coeff1$ (nClip (Add (nClip (Mul n0! l1!)) (nClip (Mul n1! l0!))))))
         (let
          ...
          (let
           ...
           (let
            ...
            (= (EucMod (nClip (Mul n$ l_low$)) (vstd!arithmetic.power2.pow2.? (I 260))) (EucMod
              (nClip (Add (nClip (Add (nClip (Add (nClip (Add coeff0$ (nClip (Mul coeff1$ (vstd!arithmetic.power2.pow2.?
                         (I 52)
                     ))))
         ...
         (let
          ...
          (let
           ...
           (let
            ...
            (let
             ((low_part$ (nClip (Add (nClip (Add (nClip (Add (nClip (Add coeff0$ (nClip (Mul coeff1$ (vstd!arithmetic.power2.pow2.?
                          (I 52)
                      ))))
                     ) (nClip (Mul coeff2$ (vstd!arithmetic.power2.pow2.? (I 104))))
                    )
             ...
             (let
              ((coeff5$ (nClip (Add (nClip (Add (nClip (Mul n1! l4!)) (nClip (Mul n3! l2!)))) (nClip
                   (Mul n4! l1!)
              )))))
              (let
               ((coeff6$ (nClip (Add (nClip (Mul n2! l4!)) (nClip (Mul n4! l2!))))))
               (let
                ((coeff7$ (nClip (Mul n3! l4!))))
                (let
                 ((coeff8$ (nClip (Mul n4! l4!))))
                 (let
                  ((high_part$ (nClip (Add (nClip (Add (nClip (Add (nClip (Mul coeff5$ (vstd!arithmetic.power2.pow2.?
                             (I 260)
                           ))
                          ) (nClip (Mul coeff6$ (vstd!arithmetic.power2.pow2.? (I 312))))
                         )
                        ) (nClip (Mul coeff7$ (vstd!arithmetic.power2.pow2.? (I 364))))
                       )
                      ) (nClip (Mul coeff8$ (vstd!arithmetic.power2.pow2.? (I 416))))
                  ))))
                  (and
                   (= (nClip (Mul n$ l_low$)) (nClip (Add low_part$ high_part$)))
                   (= (EucMod high_part$ (vstd!arithmetic.power2.pow2.? (I 260))) 0)
   ))))))))))))))))
   :pattern ((ens%curve25519_dalek!lemmas.scalar_lemmas_.montgomery_reduce_part1_chain_lemmas.lemma_n_times_l_expansion.
     n0! n1! n2! n3! n4! l0! l1! l2! l3! l4!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.scalar_lemmas_.montgomery_reduce_part1_chain_lemmas.lemma_n_times_l_expansion._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.scalar_lemmas_.montgomery_reduce_part1_chain_lemmas.lemma_n_times_l_expansion._definition
)))

;; Function-Def curve25519_dalek::lemmas::scalar_lemmas_::montgomery_reduce_part1_chain_lemmas::lemma_n_times_l_expansion
;; curve25519-dalek/src/lemmas/scalar_lemmas_/montgomery_reduce_part1_chain_lemmas.rs:251:1: 262:2 (#0)
...
(push)
 ...
 (declare-const gen_c0@ Int)
 (declare-const gen_c1@ Int)
 (declare-const gen_c2@ Int)
 (declare-const gen_c3@ Int)
 (declare-const gen_c4@ Int)
 (declare-const gen_c5@ Int)
 (declare-const gen_c6@ Int)
 (declare-const gen_c7@ Int)
 (declare-const gen_c8@ Int)
 (declare-const gen_low@ Int)
 (declare-const gen_high@ Int)
 ...
 (declare-const n@ Int)
 (declare-const l_low@ Int)
 (declare-const coeff0@ Int)
 (declare-const coeff1@ Int)
 (declare-const coeff2@ Int)
 (declare-const coeff3@ Int)
 (declare-const coeff4@ Int)
 (declare-const low_part@ Int)
 (declare-const coeff5@ Int)
 (declare-const coeff6@ Int)
 (declare-const coeff7@ Int)
 (declare-const coeff8@ Int)
 (declare-const high_part@ Int)
 (declare-const gen_high$1@ Int)
 (assert
  fuel_defaults
 )
 (assert
  ...
  (not (=>
    ...
    (=>
     ...
     (=>
      ...
      (=>
       (ens%vstd!arithmetic.power2.lemma_pow2_adds. 52 208)
       (=>
        (ens%vstd!arithmetic.power2.lemma_pow2_adds. 104 104)
        (=>
         (ens%vstd!arithmetic.power2.lemma_pow2_adds. 104 156)
         (=>
          (ens%vstd!arithmetic.power2.lemma_pow2_adds. 156 52)
          (=>
           (ens%vstd!arithmetic.power2.lemma_pow2_adds. 156 104)
           (=>
            (ens%vstd!arithmetic.power2.lemma_pow2_adds. 208 52)
            (=>
             (ens%vstd!arithmetic.power2.lemma_pow2_adds. 52 260)
             (=>
              (ens%vstd!arithmetic.power2.lemma_pow2_adds. 104 260)
              (=>
               (ens%vstd!arithmetic.power2.lemma_pow2_adds. 156 260)
               (=>
                (= n@ (nClip (Add (nClip (Add (nClip (Add (nClip (Add n0! (nClip (Mul n1! (vstd!arithmetic.power2.pow2.?
                            (I 52)
                        ))))
                ...
                (=>
                 (= l_low@ (nClip (Add (nClip (Add (nClip (Add l0! (nClip (Mul l1! (vstd!arithmetic.power2.pow2.?
                           (I 52)
                       ))))
                      ) (nClip (Mul l2! (vstd!arithmetic.power2.pow2.? (I 104))))
                     )
                           ...
                           (=>
                            ...
                            (and
                             (=>
                              ...
                              (=>
                               (= gen_c0@ (nClip (Mul n0! l0!)))
                               (=>
                                (= gen_c1@ (nClip (Add (nClip (Mul n0! l1!)) (nClip (Mul n1! l0!)))))
                                (=>
                                 (= gen_c2@ (nClip (Add (nClip (Add (nClip (Mul n0! l2!)) (nClip (Mul n1! l1!)))) (nClip
                                     (Mul n2! l0!)
                                 ))))
                                 (=>
                                  (= gen_c3@ (nClip (Add (nClip (Add (nClip (Add (nClip (Mul n0! l3!)) (nClip (Mul n1! l2!))))
                                       (nClip (Mul n2! l1!))
                                      )
                                     ) (nClip (Mul n3! l0!))
                                  )))
                                  (=>
                                   (= gen_c4@ (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip (Mul n0! l4!)) (nClip (Mul
                                              n1! l3!
                                           )))
                                          ) (nClip (Mul n2! l2!))
                                         )
                                   ...
                                   (=>
                                    (= gen_c5@ (nClip (Add (nClip (Add (nClip (Add (nClip (Mul n1! l4!)) (nClip (Mul n2! l3!))))
                                         (nClip (Mul n3! l2!))
                                        )
                                       ) (nClip (Mul n4! l1!))
                                    )))
                                    (=>
                                     (= gen_c6@ (nClip (Add (nClip (Add (nClip (Mul n2! l4!)) (nClip (Mul n3! l3!)))) (nClip
                                         (Mul n4! l2!)
                                     ))))
                                     (=>
                                      (= gen_c7@ (nClip (Add (nClip (Mul n3! l4!)) (nClip (Mul n4! l3!)))))
                                      (=>
                                       (= gen_c8@ (nClip (Mul n4! l4!)))
                                       (=>
                                        (= gen_low@ (nClip (Add (nClip (Add (nClip (Add (nClip (Add gen_c0@ (nClip (Mul gen_c1@ (vstd!arithmetic.power2.pow2.?
                                                    (I 52)
                                                ))))
                                               ) (nClip (Mul gen_c2@ (vstd!arithmetic.power2.pow2.? (I 104))))
                                              )
                                             ) (nClip (Mul gen_c3@ (vstd!arithmetic.power2.pow2.? (I 156))))
                                            )
                                           ) (nClip (Mul gen_c4@ (vstd!arithmetic.power2.pow2.? (I 208))))
                                        )))
                                        (=>
                                         (= gen_high@ (nClip (Add (nClip (Add (nClip (Add gen_c5@ (nClip (Mul gen_c6@ (vstd!arithmetic.power2.pow2.?
                                                   (I 52)
                                               ))))
                                              ) (nClip (Mul gen_c7@ (vstd!arithmetic.power2.pow2.? (I 104))))
                                             )
                                            ) (nClip (Mul gen_c8@ (vstd!arithmetic.power2.pow2.? (I 156))))
                                         )))
                                         (=>
                                          (= tmp%1 (and
                                            (and
                                                  ...
                                                  (=>
                                                   ...
                                                   (and
                                                    ...
                                                    (=>
                                                     ...
                                                     (and
                                                      (=>
                                                       (= tmp%5 (vstd!arithmetic.power2.pow2.? (I 260)))
                                                       (=>
                                                        (= tmp%6 (nClip (Add (nClip (Add (nClip (Mul coeff6@ (vstd!arithmetic.power2.pow2.? (I 52))))
                                                             (nClip (Mul coeff7@ (vstd!arithmetic.power2.pow2.? (I 104))))
                                                            )
                                                           ) (nClip (Mul coeff8@ (vstd!arithmetic.power2.pow2.? (I 156))))
                                                        )))
                                                        (=>
                                                         (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. tmp%5 coeff5@ tmp%6)
                                                         (=>
                                                          (= tmp%7 (vstd!arithmetic.power2.pow2.? (I 260)))
                                                          (=>
                                                           (= tmp%8 (nClip (Mul coeff6@ (vstd!arithmetic.power2.pow2.? (I 52)))))
                                                           (=>
                                                            (= tmp%9 (nClip (Add (nClip (Mul coeff7@ (vstd!arithmetic.power2.pow2.? (I 104)))) (
                                                                nClip (Mul coeff8@ (vstd!arithmetic.power2.pow2.? (I 156)))
                                                            ))))
                                                            (=>
                                                             (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. tmp%7 tmp%8 tmp%9)
                                                             (=>
                                                              (= tmp%10 (vstd!arithmetic.power2.pow2.? (I 260)))
                                                              (=>
                                                               (= tmp%11 (nClip (Mul coeff7@ (vstd!arithmetic.power2.pow2.? (I 104)))))
                                                               (=>
                                                                (= tmp%12 (nClip (Mul coeff8@ (vstd!arithmetic.power2.pow2.? (I 156)))))
                                                                (=>
                                                                 (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. tmp%10 tmp%11 tmp%12)
                                                                 (=>
                                                                  (= tmp%13 (vstd!arithmetic.power2.pow2.? (I 52)))
                                                                  (=>
                                                                   (= tmp%14 (vstd!arithmetic.power2.pow2.? (I 260)))
                                                                   (=>
                                                                    (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. tmp%13 tmp%14)
                                                                    (=>
                                                                     (= tmp%15 (vstd!arithmetic.power2.pow2.? (I 104)))
                                                                     (=>
                                                                      (= tmp%16 (vstd!arithmetic.power2.pow2.? (I 260)))
                                                                      (=>
                                                                       (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. tmp%15 tmp%16)
                                                                       (=>
                                                                        (= tmp%17 (vstd!arithmetic.power2.pow2.? (I 156)))
                                                                        (=>
                                                                         (= tmp%18 (vstd!arithmetic.power2.pow2.? (I 260)))
                                                                         (=>
                                                                          (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. tmp%17 tmp%18)
                                                                          (=>
                                                                           (= tmp%19 (vstd!arithmetic.power2.pow2.? (I 52)))
                                                                           (=>
                                                                            (= tmp%20 (vstd!arithmetic.power2.pow2.? (I 260)))
                                                                            (=>
                                                                             (ens%vstd!arithmetic.mul.lemma_mul_is_associative. coeff6@ tmp%19 tmp%20)
                                                                             (=>
                                                                              (= tmp%21 (vstd!arithmetic.power2.pow2.? (I 104)))
                                                                              (=>
                                                                               (= tmp%22 (vstd!arithmetic.power2.pow2.? (I 260)))
                                                                               (=>
                                                                                (ens%vstd!arithmetic.mul.lemma_mul_is_associative. coeff7@ tmp%21 tmp%22)
                                                                                (=>
                                                                                 (= tmp%23 (vstd!arithmetic.power2.pow2.? (I 156)))
                                                                                 (=>
                                                                                  (= tmp%24 (vstd!arithmetic.power2.pow2.? (I 260)))
                                                                                  (=>
                                                                                   (ens%vstd!arithmetic.mul.lemma_mul_is_associative. coeff8@ tmp%23 tmp%24)
                                                                                   (=>
                                                                                    %%location_label%%4
                                                                                    (= (nClip (Mul gen_high@ (vstd!arithmetic.power2.pow2.? (I 260)))) high_part@)
                                                      ))))))))))))))))))))))))))))))
                                                      (=>
                                                       (= (nClip (Mul gen_high@ (vstd!arithmetic.power2.pow2.? (I 260)))) high_part@)
                                                       (=>
                             ...
                             (=>
                              (= (nClip (Mul n@ l_low@)) (nClip (Add low_part@ high_part@)))
                              (=>
                               (ens%vstd!arithmetic.power2.lemma_pow2_pos. 260)
                               (=>
                                (= gen_high$1@ (nClip (Add (nClip (Add (nClip (Add coeff5@ (nClip (Mul coeff6@ (vstd!arithmetic.power2.pow2.?
                                          (I 52)
                                      ))))
                                     ) (nClip (Mul coeff7@ (vstd!arithmetic.power2.pow2.? (I 104))))
                                    )
                                ...
                                (and
                                 (and
                                  (=>
                                   (= tmp%25 (vstd!arithmetic.power2.pow2.? (I 260)))
                                   (=>
                                    (= tmp%26 (nClip (Add (nClip (Add (nClip (Mul coeff6@ (vstd!arithmetic.power2.pow2.? (I 52))))
                                         (nClip (Mul coeff7@ (vstd!arithmetic.power2.pow2.? (I 104))))
                                        )
                                       ) (nClip (Mul coeff8@ (vstd!arithmetic.power2.pow2.? (I 156))))
                                    )))
                                    (=>
                                     (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. tmp%25 coeff5@ tmp%26)
                                     (=>
                                      (= tmp%27 (vstd!arithmetic.power2.pow2.? (I 260)))
                                      (=>
                                       (= tmp%28 (nClip (Mul coeff6@ (vstd!arithmetic.power2.pow2.? (I 52)))))
                                       (=>
                                        (= tmp%29 (nClip (Add (nClip (Mul coeff7@ (vstd!arithmetic.power2.pow2.? (I 104))))
                                           (nClip (Mul coeff8@ (vstd!arithmetic.power2.pow2.? (I 156))))
                                        )))
                                        (=>
                                         (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. tmp%27 tmp%28 tmp%29)
                                         (=>
                                          (= tmp%30 (vstd!arithmetic.power2.pow2.? (I 260)))
                                          (=>
                                           (= tmp%31 (nClip (Mul coeff7@ (vstd!arithmetic.power2.pow2.? (I 104)))))
                                           (=>
                                            (= tmp%32 (nClip (Mul coeff8@ (vstd!arithmetic.power2.pow2.? (I 156)))))
                                            (=>
                                             (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. tmp%30 tmp%31 tmp%32)
                                             (=>
                                              (= tmp%33 (vstd!arithmetic.power2.pow2.? (I 52)))
                                              (=>
                                               (= tmp%34 (vstd!arithmetic.power2.pow2.? (I 260)))
                                               (=>
                                                (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. tmp%33 tmp%34)
                                                (=>
                                                 (= tmp%35 (vstd!arithmetic.power2.pow2.? (I 104)))
                                                 (=>
                                                  (= tmp%36 (vstd!arithmetic.power2.pow2.? (I 260)))
                                                  (=>
                                                   (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. tmp%35 tmp%36)
                                                   (=>
                                                    (= tmp%37 (vstd!arithmetic.power2.pow2.? (I 156)))
                                                    (=>
                                                     (= tmp%38 (vstd!arithmetic.power2.pow2.? (I 260)))
                                                     (=>
                                                      (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. tmp%37 tmp%38)
                                                      (=>
                                                       (= tmp%39 (vstd!arithmetic.power2.pow2.? (I 52)))
                                                       (=>
                                                        (= tmp%40 (vstd!arithmetic.power2.pow2.? (I 260)))
                                                        (=>
                                                         (ens%vstd!arithmetic.mul.lemma_mul_is_associative. coeff6@ tmp%39 tmp%40)
                                                         (=>
                                                          (= tmp%41 (vstd!arithmetic.power2.pow2.? (I 104)))
                                                          (=>
                                                           (= tmp%42 (vstd!arithmetic.power2.pow2.? (I 260)))
                                                           (=>
                                                            (ens%vstd!arithmetic.mul.lemma_mul_is_associative. coeff7@ tmp%41 tmp%42)
                                                            (=>
                                                             (= tmp%43 (vstd!arithmetic.power2.pow2.? (I 156)))
                                                             (=>
                                                              (= tmp%44 (vstd!arithmetic.power2.pow2.? (I 260)))
                                                              (=>
                                                               (ens%vstd!arithmetic.mul.lemma_mul_is_associative. coeff8@ tmp%43 tmp%44)
                                                               (=>
                                                                %%location_label%%6
                                                                (= (nClip (Mul gen_high$1@ (vstd!arithmetic.power2.pow2.? (I 260)))) high_part@)
                                  ))))))))))))))))))))))))))))))
                                  (=>
                                   (= (nClip (Mul gen_high$1@ (vstd!arithmetic.power2.pow2.? (I 260)))) high_part@)
                                   (=>
                                    (= tmp%45 (vstd!arithmetic.power2.pow2.? (I 260)))
                                    (and
                                     (=>
                                      %%location_label%%7
                                      (req%vstd!arithmetic.div_mod.lemma_mod_self_0. tmp%45)
                                     )
                                     (=>
                                      (ens%vstd!arithmetic.div_mod.lemma_mod_self_0. tmp%45)
                                      (=>
                                       (= tmp%46 (vstd!arithmetic.power2.pow2.? (I 260)))
                                       (=>
                                        (= tmp%47 (vstd!arithmetic.power2.pow2.? (I 260)))
                                        (and
                                         (=>
                                          %%location_label%%8
                                          (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. gen_high$1@ tmp%46 tmp%47)
                                         )
                                         (=>
                                          (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. gen_high$1@ tmp%46 tmp%47)
                                          (=>
                                           (ens%vstd!arithmetic.mul.lemma_mul_basics. gen_high$1@)
                                           (=>
                                            (= tmp%48 (vstd!arithmetic.power2.pow2.? (I 260)))
                                            (and
                                             (=>
                                              %%location_label%%9
                                              (req%vstd!arithmetic.div_mod.lemma_small_mod. 0 tmp%48)
                                             )
                                             (=>
                                              (ens%vstd!arithmetic.div_mod.lemma_small_mod. 0 tmp%48)
                                              (=>
                                               %%location_label%%10
                                               (= (EucMod high_part@ (vstd!arithmetic.power2.pow2.? (I 260))) 0)
                                 ))))))))))))))
                                 (=>
                                  (= (EucMod high_part@ (vstd!arithmetic.power2.pow2.? (I 260))) 0)
                                  (=>
                                   (= tmp%49 (vstd!arithmetic.power2.pow2.? (I 260)))
                                   (and
                                    (=>
                                     %%location_label%%11
                                     (req%vstd!arithmetic.div_mod.lemma_add_mod_noop. low_part@ high_part@ tmp%49)
                                    )
                                    (=>
                                     (ens%vstd!arithmetic.div_mod.lemma_add_mod_noop. low_part@ high_part@ tmp%49)
                                     (and
                                      (and
                                       (=>
                                        (= tmp%50 (vstd!arithmetic.power2.pow2.? (I 260)))
                                        (and
                                         (=>
                                          %%location_label%%12
                                          (req%vstd!arithmetic.div_mod.lemma_mod_twice. low_part@ tmp%50)
                                         )
                                         (=>
                                          (ens%vstd!arithmetic.div_mod.lemma_mod_twice. low_part@ tmp%50)
                                          (=>
                                           %%location_label%%13
                                           (= (EucMod (nClip (Add (EucMod low_part@ (vstd!arithmetic.power2.pow2.? (I 260))) 0))
                                             (vstd!arithmetic.power2.pow2.? (I 260))
                                            ) (EucMod low_part@ (vstd!arithmetic.power2.pow2.? (I 260)))
                                       )))))
                                       (=>
                                        (= (EucMod (nClip (Add (EucMod low_part@ (vstd!arithmetic.power2.pow2.? (I 260))) 0))
                                          (vstd!arithmetic.power2.pow2.? (I 260))
                                        ...
                                        (=>
                                         %%location_label%%14
                                         (= (EucMod (nClip (Add low_part@ high_part@)) (vstd!arithmetic.power2.pow2.? (I 260)))
                                          (EucMod low_part@ (vstd!arithmetic.power2.pow2.? (I 260)))
                                      ))))
                                      (=>
                                       (= (EucMod (nClip (Add low_part@ high_part@)) (vstd!arithmetic.power2.pow2.? (I 260)))
                                       ...
                                       (=>
                                        (= tmp%51 (= (EucMod (nClip (Mul n@ l_low@)) (vstd!arithmetic.power2.pow2.? (I 260)))
                                          (EucMod low_part@ (vstd!arithmetic.power2.pow2.? (I 260)))
                                        ))
                                        (and
                                         (=>
