...
;; curve25519-dalek/src/specs/lizard_specs.rs:668:1: 668:73 (#0)
...
;; Function-Def curve25519_dalek::specs::lizard_specs::lemma_lizard_decode_sound
;; curve25519-dalek/src/specs/lizard_specs.rs:668:1: 668:73 (#0)
(get-info :all-statistics)
(push)
 (declare-const point! tuple%2.)
 (declare-const data! vstd!seq.Seq<u8.>.)
 (assert
  fuel_defaults
 )
 (assert
  (has_type (Poly%tuple%2. point!) (TYPE%tuple%2. $ NAT $ NAT))
 )
  ...
  (not (=>
    ...
    (=>
     ...
     (=>
      ...
      (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.lizard_specs.spec_lizard_encode.?
