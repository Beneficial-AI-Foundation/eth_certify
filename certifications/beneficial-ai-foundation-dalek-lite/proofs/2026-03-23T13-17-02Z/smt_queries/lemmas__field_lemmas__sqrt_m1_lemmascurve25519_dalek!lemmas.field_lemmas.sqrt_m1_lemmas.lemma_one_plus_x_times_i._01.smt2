...
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_m1_lemmas.rs:809:1: 809:54 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::sqrt_m1_lemmas::lemma_one_plus_x_times_i
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_m1_lemmas.rs:809:1: 809:54 (#0)
        ...
        (and
         ...
         (=>
          ...
          (=>
           ...
           (=>
            %%location_label%%2
            (= 1 (curve25519_dalek!specs.field_specs.field_mul.? (I f!) (I inv_f@)))
        ))))
        (=>
         (= 1 (curve25519_dalek!specs.field_specs.field_mul.? (I f!) (I inv_f@)))
         (and
          ...
          (=>
           ...
           (and
            (=>
             (= tmp%1 (curve25519_dalek!specs.field_specs.field_add.? (I f!) (I (curve25519_dalek!specs.field_specs.field_mul.?
                 (I e!) (I i@)
             ))))
             (=>
              (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_comm.
              ...
              (=>
               (= tmp%2 (curve25519_dalek!specs.field_specs.field_mul.? (I e!) (I i@)))
               (=>
                (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_distributes_over_add.
                 inv_f@ f! tmp%2
                )
                (=>
                 ...
                 (=>
                  (= tmp%3 (curve25519_dalek!specs.field_specs.field_mul.? (I e!) (I i@)))
                  (=>
                   (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_comm.
                    inv_f@ tmp%3
                   )
                   (=>
                    ...
                    (= (curve25519_dalek!specs.field_specs.field_add.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                        ...
                        (I f!) (I (curve25519_dalek!specs.field_specs.field_mul.? (I e!) (I i@)))
                       )
                      ) (I inv_f@)
            ))))))))))
            (=>
