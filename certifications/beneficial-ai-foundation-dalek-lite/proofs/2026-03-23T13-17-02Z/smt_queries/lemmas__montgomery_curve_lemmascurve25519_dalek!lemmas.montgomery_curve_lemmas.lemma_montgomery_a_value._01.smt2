...
;; curve25519-dalek/src/lemmas/montgomery_curve_lemmas.rs:807:7: 807:36 (#0)
...
;; Function-Def curve25519_dalek::lemmas::montgomery_curve_lemmas::lemma_montgomery_a_value
;; curve25519-dalek/src/lemmas/montgomery_curve_lemmas.rs:807:7: 807:36 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= limbs@ (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
           ...
           (=>
            ...
            (and
             (and
              (=>
               %%location_label%%2
               (req%vstd!arithmetic.power2.lemma_pow2_strictly_increases. 5 51)
              )
              (=>
               (ens%vstd!arithmetic.power2.lemma_pow2_strictly_increases. 5 51)
               (and
                (=>
                 %%location_label%%3
                 (req%vstd!arithmetic.power2.lemma_pow2_strictly_increases. 5 102)
                )
                (=>
                 (ens%vstd!arithmetic.power2.lemma_pow2_strictly_increases. 5 102)
                 (and
                  (=>
                   %%location_label%%4
                   (req%vstd!arithmetic.power2.lemma_pow2_strictly_increases. 5 153)
                  )
                  (=>
                   (ens%vstd!arithmetic.power2.lemma_pow2_strictly_increases. 5 153)
                   (and
                    (=>
                     %%location_label%%5
                     (req%vstd!arithmetic.power2.lemma_pow2_strictly_increases. 5 204)
                    )
                    (=>
                     (ens%vstd!arithmetic.power2.lemma_pow2_strictly_increases. 5 204)
                     (=>
                      %%location_label%%6
                      (and
                       (and
                        (and
                         (> (vstd!arithmetic.power2.pow2.? (I 51)) 0)
                         (> (vstd!arithmetic.power2.pow2.? (I 102)) 0)
                        )
                        (> (vstd!arithmetic.power2.pow2.? (I 153)) 0)
                       )
                       (> (vstd!arithmetic.power2.pow2.? (I 204)) 0)
             ))))))))))
             (=>
              (and
               (and
              ...
              (=>
               %%location_label%%7
               (= (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. limbs@)) 486662)
           ))))
           (=>
            (= (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. limbs@)) 486662)
            (and
              ...
              (=>
               ...
               (=>
                ...
                (and
                 (=>
                  %%location_label%%9
                  (req%vstd!arithmetic.div_mod.lemma_small_mod. 486662 tmp%3)
                 )
                 (=>
                  (ens%vstd!arithmetic.div_mod.lemma_small_mod. 486662 tmp%3)
                  (=>
                   %%location_label%%10
                   (= (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                      curve25519_dalek!backend.serial.u64.constants.MONTGOMERY_A.?
