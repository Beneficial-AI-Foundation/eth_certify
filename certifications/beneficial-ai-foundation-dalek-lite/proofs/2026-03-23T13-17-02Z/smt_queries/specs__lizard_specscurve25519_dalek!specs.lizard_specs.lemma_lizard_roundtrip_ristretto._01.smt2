...
;; MODULE 'module specs::lizard_specs'
;; curve25519-dalek/src/specs/lizard_specs.rs:703:1: 703:61 (#0)
...
(declare-const fuel%curve25519_dalek!specs.lizard_specs.is_lizard_preimage. FuelId)
(declare-const fuel%curve25519_dalek!specs.lizard_specs.lizard_has_unique_preimage.
 FuelId
)
(declare-const fuel%curve25519_dalek!specs.lizard_specs.spec_lizard_decode. FuelId)
...
(declare-const fuel%curve25519_dalek!specs.lizard_specs.spec_lizard_decode_ristretto.
 FuelId
)
...
(assert
 (distinct fuel%vstd!std_specs.option.impl&%0.is_None. fuel%vstd!array.array_view.
  ...
  fuel%vstd!view.impl&%46.view. fuel%vstd!view.impl&%48.view. fuel%curve25519_dalek!backend.serial.u64.constants.SQRT_AD_MINUS_ONE.
  ...
  fuel%curve25519_dalek!lizard.u64_constants.MINVSQRT_ONE_PLUS_D. fuel%curve25519_dalek!specs.core_specs.u8_32_as_nat.
  fuel%curve25519_dalek!specs.core_specs.spec_load8_at. fuel%curve25519_dalek!specs.edwards_specs.is_on_edwards_curve_projective.
  ...
  fuel%curve25519_dalek!specs.field_specs.field_inv. fuel%curve25519_dalek!specs.field_specs.spec_fe51_from_bytes.
  ...
  fuel%curve25519_dalek!specs.lizard_specs.is_lizard_preimage. fuel%curve25519_dalek!specs.lizard_specs.lizard_has_unique_preimage.
  fuel%curve25519_dalek!specs.lizard_specs.spec_lizard_decode. fuel%curve25519_dalek!specs.lizard_specs.is_lizard_preimage_coset.
  fuel%curve25519_dalek!specs.lizard_specs.lizard_ristretto_has_unique_preimage. fuel%curve25519_dalek!specs.lizard_specs.spec_lizard_decode_ristretto.
...
;; Function-Decl curve25519_dalek::specs::lizard_specs::is_lizard_preimage
(declare-fun curve25519_dalek!specs.lizard_specs.is_lizard_preimage.? (Poly Poly)
 Bool
)

;; Function-Decl curve25519_dalek::specs::lizard_specs::lizard_has_unique_preimage
(declare-fun curve25519_dalek!specs.lizard_specs.lizard_has_unique_preimage.? (Poly)
 Bool
)

;; Function-Decl curve25519_dalek::specs::lizard_specs::spec_lizard_decode
(declare-fun curve25519_dalek!specs.lizard_specs.spec_lizard_decode.? (Poly) core!option.Option.)
...
;; Function-Decl curve25519_dalek::specs::lizard_specs::spec_lizard_decode_ristretto
(declare-fun curve25519_dalek!specs.lizard_specs.spec_lizard_decode_ristretto.? (Poly
  Poly
 ) core!option.Option.
)
 ...
 (=>
  ...
  (forall ((limbs! Poly) (bit_limit! Poly)) (!
    (= (curve25519_dalek!specs.field_specs.u64_5_bounded.? limbs! bit_limit!) (forall (
       ...
       :qid user_curve25519_dalek__specs__field_specs__u64_5_bounded_22
       :skolemid skolem_user_curve25519_dalek__specs__field_specs__u64_5_bounded_22
    )))
  ...
  (forall ((fe1! Poly) (fe2! Poly) (bound! Poly)) (!
    (= (curve25519_dalek!specs.field_specs.sum_of_limbs_bounded.? fe1! fe2! bound!) (forall
      ((i$ Poly)) (!
       ...
       :qid user_curve25519_dalek__specs__field_specs__sum_of_limbs_bounded_23
       :skolemid skolem_user_curve25519_dalek__specs__field_specs__sum_of_limbs_bounded_23
    )))
 ...
 (forall ((%%hole%%0 Type) (%%hole%%1 Int)) (!
   (=>
    (exists ((b$ Poly)) (!
      ...
      :qid user_curve25519_dalek__specs__field_specs__u8_32_from_nat_24
      :skolemid skolem_user_curve25519_dalek__specs__field_specs__u8_32_from_nat_24
    ))
    (exists ((b$ Poly)) (!
      (and
       (and
...
;; Function-Specs curve25519_dalek::specs::lizard_specs::is_lizard_preimage
(declare-fun req%curve25519_dalek!specs.lizard_specs.is_lizard_preimage. (Poly Poly)
 Bool
)
(declare-const %%global_location_label%%17 Bool)
(assert
 (forall ((data! Poly) (point! Poly)) (!
   (= (req%curve25519_dalek!specs.lizard_specs.is_lizard_preimage. data! point!) (=>
     %%global_location_label%%17
     (= (vstd!seq.Seq.len.? $ (UINT 8) data!) 16)
   ))
   :pattern ((req%curve25519_dalek!specs.lizard_specs.is_lizard_preimage. data! point!))
   :qid internal_req__curve25519_dalek!specs.lizard_specs.is_lizard_preimage._definition
   :skolemid skolem_internal_req__curve25519_dalek!specs.lizard_specs.is_lizard_preimage._definition
)))

;; Function-Axioms curve25519_dalek::specs::lizard_specs::is_lizard_preimage
(assert
 (fuel_bool_default fuel%curve25519_dalek!specs.lizard_specs.is_lizard_preimage.)
)
(assert
 (=>
  (fuel_bool fuel%curve25519_dalek!specs.lizard_specs.is_lizard_preimage.)
  (forall ((data! Poly) (point! Poly)) (!
    (= (curve25519_dalek!specs.lizard_specs.is_lizard_preimage.? data! point!) (= (curve25519_dalek!specs.lizard_specs.spec_lizard_encode.?
       data!
      ) (%Poly%tuple%2. point!)
    ))
    :pattern ((curve25519_dalek!specs.lizard_specs.is_lizard_preimage.? data! point!))
    :qid internal_curve25519_dalek!specs.lizard_specs.is_lizard_preimage.?_definition
    :skolemid skolem_internal_curve25519_dalek!specs.lizard_specs.is_lizard_preimage.?_definition
))))

;; Function-Axioms curve25519_dalek::specs::lizard_specs::lizard_has_unique_preimage
(assert
 (fuel_bool_default fuel%curve25519_dalek!specs.lizard_specs.lizard_has_unique_preimage.)
)
(assert
 (=>
  (fuel_bool fuel%curve25519_dalek!specs.lizard_specs.lizard_has_unique_preimage.)
  (forall ((point! Poly)) (!
    (= (curve25519_dalek!specs.lizard_specs.lizard_has_unique_preimage.? point!) (exists
      ((data$ Poly)) (!
       (and
        (has_type data$ (TYPE%vstd!seq.Seq. $ (UINT 8)))
        (and
         (and
          (= (vstd!seq.Seq.len.? $ (UINT 8) data$) 16)
          (curve25519_dalek!specs.lizard_specs.is_lizard_preimage.? data$ point!)
         )
         (forall ((data2$ Poly)) (!
           (=>
            ...
            (=>
             (and
              ...
              (curve25519_dalek!specs.lizard_specs.is_lizard_preimage.? data2$ point!)
             )
             (= data2$ data$)
           ))
           :pattern ((curve25519_dalek!specs.lizard_specs.is_lizard_preimage.? data2$ point!))
           :qid user_curve25519_dalek__specs__lizard_specs__lizard_has_unique_preimage_25
           :skolemid skolem_user_curve25519_dalek__specs__lizard_specs__lizard_has_unique_preimage_25
       ))))
       :pattern ((curve25519_dalek!specs.lizard_specs.is_lizard_preimage.? data$ point!))
       :qid user_curve25519_dalek__specs__lizard_specs__lizard_has_unique_preimage_26
       :skolemid skolem_user_curve25519_dalek__specs__lizard_specs__lizard_has_unique_preimage_26
    )))
    :pattern ((curve25519_dalek!specs.lizard_specs.lizard_has_unique_preimage.? point!))
    :qid internal_curve25519_dalek!specs.lizard_specs.lizard_has_unique_preimage.?_definition
    :skolemid skolem_internal_curve25519_dalek!specs.lizard_specs.lizard_has_unique_preimage.?_definition
))))

;; Function-Axioms curve25519_dalek::specs::lizard_specs::spec_lizard_decode
(assert
 (fuel_bool_default fuel%curve25519_dalek!specs.lizard_specs.spec_lizard_decode.)
)
(declare-fun %%choose%%1 (Type Dcr Type Int Poly Poly) Poly)
(assert
 (forall ((%%hole%%0 Type) (%%hole%%1 Dcr) (%%hole%%2 Type) (%%hole%%3 Int) (%%hole%%4
    Poly
   ) (%%hole%%5 Poly)
  ) (!
   (=>
    (exists ((data$ Poly)) (!
      (and
       (has_type data$ %%hole%%0)
       (and
        (= (vstd!seq.Seq.len.? %%hole%%1 %%hole%%2 data$) %%hole%%3)
        (curve25519_dalek!specs.lizard_specs.is_lizard_preimage.? data$ %%hole%%4)
      ))
      :pattern ((curve25519_dalek!specs.lizard_specs.is_lizard_preimage.? data$ %%hole%%5))
      :qid user_curve25519_dalek__specs__lizard_specs__spec_lizard_decode_27
      :skolemid skolem_user_curve25519_dalek__specs__lizard_specs__spec_lizard_decode_27
    ))
    (exists ((data$ Poly)) (!
      (and
       (and
       ...
       (= (%%choose%%1 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5) data$)
      )
      :pattern ((curve25519_dalek!specs.lizard_specs.is_lizard_preimage.? data$ %%hole%%5))
   )))
...
(assert
 (=>
  (fuel_bool fuel%curve25519_dalek!specs.lizard_specs.spec_lizard_decode.)
  (forall ((point! Poly)) (!
    (= (curve25519_dalek!specs.lizard_specs.spec_lizard_decode.? point!) (ite
      (curve25519_dalek!specs.lizard_specs.lizard_has_unique_preimage.? point!)
      (core!option.Option./Some (as_type (%%choose%%1 (TYPE%vstd!seq.Seq. $ (UINT 8)) $ (UINT
          8
         ) 16 point! point!
    ...
    :pattern ((curve25519_dalek!specs.lizard_specs.spec_lizard_decode.? point!))
    :qid internal_curve25519_dalek!specs.lizard_specs.spec_lizard_decode.?_definition
    :skolemid skolem_internal_curve25519_dalek!specs.lizard_specs.spec_lizard_decode.?_definition
))))
(assert
 (forall ((point! Poly)) (!
   (=>
    (has_type point! (TYPE%tuple%2. $ NAT $ NAT))
    (has_type (Poly%core!option.Option. (curve25519_dalek!specs.lizard_specs.spec_lizard_decode.?
       point!
      )
     ) (TYPE%core!option.Option. $ (TYPE%vstd!seq.Seq. $ (UINT 8)))
   ))
   :pattern ((curve25519_dalek!specs.lizard_specs.spec_lizard_decode.? point!))
   :qid internal_curve25519_dalek!specs.lizard_specs.spec_lizard_decode.?_pre_post_definition
   :skolemid skolem_internal_curve25519_dalek!specs.lizard_specs.spec_lizard_decode.?_pre_post_definition
)))
        ...
        (and
         ...
         (and
          ...
          (forall ((data2$ Poly)) (!
            ...
            :qid user_curve25519_dalek__specs__lizard_specs__lizard_ristretto_has_unique_preimage_28
            :skolemid skolem_user_curve25519_dalek__specs__lizard_specs__lizard_ristretto_has_unique_preimage_28
        ))))
        :pattern ((curve25519_dalek!specs.lizard_specs.is_lizard_preimage_coset.? data$ (Poly%array%.
           coset$
        )))
        :qid user_curve25519_dalek__specs__lizard_specs__lizard_ristretto_has_unique_preimage_29
        :skolemid skolem_user_curve25519_dalek__specs__lizard_specs__lizard_ristretto_has_unique_preimage_29
    ))))
...
;; Function-Axioms curve25519_dalek::specs::lizard_specs::spec_lizard_decode_ristretto
(assert
 (fuel_bool_default fuel%curve25519_dalek!specs.lizard_specs.spec_lizard_decode_ristretto.)
)
(declare-fun %%choose%%2 (Type Dcr Type Int Poly Poly) Poly)
(assert
 (forall ((%%hole%%0 Type) (%%hole%%1 Dcr) (%%hole%%2 Type) (%%hole%%3 Int) (%%hole%%4
    Poly
   ) (%%hole%%5 Poly)
   ...
   (=>
    (exists ((data$ Poly)) (!
      (and
       ...
       (and
        (= (vstd!seq.Seq.len.? %%hole%%1 %%hole%%2 data$) %%hole%%3)
        (curve25519_dalek!specs.lizard_specs.is_lizard_preimage_coset.? data$ %%hole%%4)
      ))
      :pattern ((curve25519_dalek!specs.lizard_specs.is_lizard_preimage_coset.? data$ %%hole%%5))
      :qid user_curve25519_dalek__specs__lizard_specs__spec_lizard_decode_ristretto_30
      :skolemid skolem_user_curve25519_dalek__specs__lizard_specs__spec_lizard_decode_ristretto_30
    ))
    (exists ((data$ Poly)) (!
      (and
       (and
       ...
       (= (%%choose%%2 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4 %%hole%%5) data$)
      )
      :pattern ((curve25519_dalek!specs.lizard_specs.is_lizard_preimage_coset.? data$ %%hole%%5))
   )))
...
(assert
 (=>
  (fuel_bool fuel%curve25519_dalek!specs.lizard_specs.spec_lizard_decode_ristretto.)
  (forall ((x! Poly) (y! Poly)) (!
    (= (curve25519_dalek!specs.lizard_specs.spec_lizard_decode_ristretto.? x! y!) (let
      ((coset$ (curve25519_dalek!specs.ristretto_specs.ristretto_coset_affine.? x! y!)))
      (ite
       (curve25519_dalek!specs.lizard_specs.lizard_ristretto_has_unique_preimage.? x! y!)
       (core!option.Option./Some (as_type (%%choose%%2 (TYPE%vstd!seq.Seq. $ (UINT 8)) $ (UINT
           8
          ) 16 (Poly%array%. coset$) (Poly%array%. coset$)
         ) (TYPE%vstd!seq.Seq. $ (UINT 8))
       ))
       core!option.Option./None
    )))
    :pattern ((curve25519_dalek!specs.lizard_specs.spec_lizard_decode_ristretto.? x! y!))
    :qid internal_curve25519_dalek!specs.lizard_specs.spec_lizard_decode_ristretto.?_definition
    :skolemid skolem_internal_curve25519_dalek!specs.lizard_specs.spec_lizard_decode_ristretto.?_definition
))))
(assert
 (forall ((x! Poly) (y! Poly)) (!
   (=>
    ...
    (has_type (Poly%core!option.Option. (curve25519_dalek!specs.lizard_specs.spec_lizard_decode_ristretto.?
       x! y!
      )
     ) (TYPE%core!option.Option. $ (TYPE%vstd!seq.Seq. $ (UINT 8)))
   ))
   :pattern ((curve25519_dalek!specs.lizard_specs.spec_lizard_decode_ristretto.? x! y!))
   :qid internal_curve25519_dalek!specs.lizard_specs.spec_lizard_decode_ristretto.?_pre_post_definition
   :skolemid skolem_internal_curve25519_dalek!specs.lizard_specs.spec_lizard_decode_ristretto.?_pre_post_definition
)))
...
;; Function-Specs curve25519_dalek::specs::lizard_specs::lemma_lizard_decode_ristretto_witness
(declare-fun req%curve25519_dalek!specs.lizard_specs.lemma_lizard_decode_ristretto_witness.
 (Int Int vstd!seq.Seq<u8.>.) Bool
)
(declare-const %%global_location_label%%19 Bool)
(declare-const %%global_location_label%%20 Bool)
(declare-const %%global_location_label%%21 Bool)
(assert
 (forall ((x! Int) (y! Int) (data! vstd!seq.Seq<u8.>.)) (!
   (= (req%curve25519_dalek!specs.lizard_specs.lemma_lizard_decode_ristretto_witness.
     x! y! data!
    ) (and
     (=>
      %%global_location_label%%19
      (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. data!)) 16)
     )
     (=>
   ...
   :pattern ((req%curve25519_dalek!specs.lizard_specs.lemma_lizard_decode_ristretto_witness.
     x! y! data!
   ))
   :qid internal_req__curve25519_dalek!specs.lizard_specs.lemma_lizard_decode_ristretto_witness._definition
   :skolemid skolem_internal_req__curve25519_dalek!specs.lizard_specs.lemma_lizard_decode_ristretto_witness._definition
)))
(declare-fun ens%curve25519_dalek!specs.lizard_specs.lemma_lizard_decode_ristretto_witness.
 (Int Int vstd!seq.Seq<u8.>.) Bool
)
(assert
 (forall ((x! Int) (y! Int) (data! vstd!seq.Seq<u8.>.)) (!
   (= (ens%curve25519_dalek!specs.lizard_specs.lemma_lizard_decode_ristretto_witness.
     x! y! data!
    ) (= (curve25519_dalek!specs.lizard_specs.spec_lizard_decode_ristretto.? (I x!) (I y!))
     (core!option.Option./Some (Poly%vstd!seq.Seq<u8.>. data!))
   ))
   :pattern ((ens%curve25519_dalek!specs.lizard_specs.lemma_lizard_decode_ristretto_witness.
     x! y! data!
   ))
   :qid internal_ens__curve25519_dalek!specs.lizard_specs.lemma_lizard_decode_ristretto_witness._definition
   :skolemid skolem_internal_ens__curve25519_dalek!specs.lizard_specs.lemma_lizard_decode_ristretto_witness._definition
)))

;; Function-Specs curve25519_dalek::specs::lizard_specs::lemma_lizard_decode_ristretto_none
(declare-fun req%curve25519_dalek!specs.lizard_specs.lemma_lizard_decode_ristretto_none.
 (Int Int) Bool
)
(declare-const %%global_location_label%%22 Bool)
(assert
 (forall ((x! Int) (y! Int)) (!
   (= (req%curve25519_dalek!specs.lizard_specs.lemma_lizard_decode_ristretto_none. x!
     y!
    ) (=>
   ...
   :pattern ((req%curve25519_dalek!specs.lizard_specs.lemma_lizard_decode_ristretto_none.
     x! y!
   ))
   :qid internal_req__curve25519_dalek!specs.lizard_specs.lemma_lizard_decode_ristretto_none._definition
   :skolemid skolem_internal_req__curve25519_dalek!specs.lizard_specs.lemma_lizard_decode_ristretto_none._definition
)))
(declare-fun ens%curve25519_dalek!specs.lizard_specs.lemma_lizard_decode_ristretto_none.
 (Int Int) Bool
)
(assert
 (forall ((x! Int) (y! Int)) (!
   (= (ens%curve25519_dalek!specs.lizard_specs.lemma_lizard_decode_ristretto_none. x!
     y!
    ) (is-core!option.Option./None (curve25519_dalek!specs.lizard_specs.spec_lizard_decode_ristretto.?
      (I x!) (I y!)
   )))
   :pattern ((ens%curve25519_dalek!specs.lizard_specs.lemma_lizard_decode_ristretto_none.
     x! y!
   ))
   :qid internal_ens__curve25519_dalek!specs.lizard_specs.lemma_lizard_decode_ristretto_none._definition
   :skolemid skolem_internal_ens__curve25519_dalek!specs.lizard_specs.lemma_lizard_decode_ristretto_none._definition
)))

;; Function-Specs curve25519_dalek::specs::lizard_specs::lemma_lizard_decode_sound
(declare-fun ens%curve25519_dalek!specs.lizard_specs.lemma_lizard_decode_sound. (tuple%2.
  vstd!seq.Seq<u8.>.
 ) Bool
)
(assert
 (forall ((point! tuple%2.) (data! vstd!seq.Seq<u8.>.)) (!
   (= (ens%curve25519_dalek!specs.lizard_specs.lemma_lizard_decode_sound. point! data!)
    (=>
     (= (curve25519_dalek!specs.lizard_specs.spec_lizard_decode.? (Poly%tuple%2. point!))
      (core!option.Option./Some (Poly%vstd!seq.Seq<u8.>. data!))
     )
     (= (curve25519_dalek!specs.lizard_specs.spec_lizard_encode.? (Poly%vstd!seq.Seq<u8.>.
        data!
       )
      ) point!
   )))
   :pattern ((ens%curve25519_dalek!specs.lizard_specs.lemma_lizard_decode_sound. point!
     data!
   ))
   :qid internal_ens__curve25519_dalek!specs.lizard_specs.lemma_lizard_decode_sound._definition
   :skolemid skolem_internal_ens__curve25519_dalek!specs.lizard_specs.lemma_lizard_decode_sound._definition
)))

;; Function-Specs curve25519_dalek::specs::lizard_specs::lemma_lizard_roundtrip
(declare-fun req%curve25519_dalek!specs.lizard_specs.lemma_lizard_roundtrip. (vstd!seq.Seq<u8.>.)
 Bool
)
(declare-const %%global_location_label%%23 Bool)
(assert
 (forall ((data! vstd!seq.Seq<u8.>.)) (!
   (= (req%curve25519_dalek!specs.lizard_specs.lemma_lizard_roundtrip. data!) (=>
     %%global_location_label%%23
     (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. data!)) 16)
   ))
   :pattern ((req%curve25519_dalek!specs.lizard_specs.lemma_lizard_roundtrip. data!))
   :qid internal_req__curve25519_dalek!specs.lizard_specs.lemma_lizard_roundtrip._definition
   :skolemid skolem_internal_req__curve25519_dalek!specs.lizard_specs.lemma_lizard_roundtrip._definition
)))
(declare-fun ens%curve25519_dalek!specs.lizard_specs.lemma_lizard_roundtrip. (vstd!seq.Seq<u8.>.)
 Bool
)
(assert
 (forall ((data! vstd!seq.Seq<u8.>.)) (!
   (= (ens%curve25519_dalek!specs.lizard_specs.lemma_lizard_roundtrip. data!) (=>
     (curve25519_dalek!specs.lizard_specs.lizard_has_unique_preimage.? (Poly%tuple%2. (curve25519_dalek!specs.lizard_specs.spec_lizard_encode.?
        (Poly%vstd!seq.Seq<u8.>. data!)
     )))
     (= (curve25519_dalek!specs.lizard_specs.spec_lizard_decode.? (Poly%tuple%2. (curve25519_dalek!specs.lizard_specs.spec_lizard_encode.?
         (Poly%vstd!seq.Seq<u8.>. data!)
       ))
      ) (core!option.Option./Some (Poly%vstd!seq.Seq<u8.>. data!))
   )))
   :pattern ((ens%curve25519_dalek!specs.lizard_specs.lemma_lizard_roundtrip. data!))
   :qid internal_ens__curve25519_dalek!specs.lizard_specs.lemma_lizard_roundtrip._definition
   :skolemid skolem_internal_ens__curve25519_dalek!specs.lizard_specs.lemma_lizard_roundtrip._definition
)))

;; Function-Specs curve25519_dalek::specs::lizard_specs::lemma_lizard_decode_ristretto_sound
(declare-fun ens%curve25519_dalek!specs.lizard_specs.lemma_lizard_decode_ristretto_sound.
 (Int Int vstd!seq.Seq<u8.>.) Bool
)
(assert
 (forall ((x! Int) (y! Int) (data! vstd!seq.Seq<u8.>.)) (!
   (= (ens%curve25519_dalek!specs.lizard_specs.lemma_lizard_decode_ristretto_sound. x!
     y! data!
    ) (=>
     (= (curve25519_dalek!specs.lizard_specs.spec_lizard_decode_ristretto.? (I x!) (I y!))
      (core!option.Option./Some (Poly%vstd!seq.Seq<u8.>. data!))
   ...
   :pattern ((ens%curve25519_dalek!specs.lizard_specs.lemma_lizard_decode_ristretto_sound.
     x! y! data!
   ))
   :qid internal_ens__curve25519_dalek!specs.lizard_specs.lemma_lizard_decode_ristretto_sound._definition
   :skolemid skolem_internal_ens__curve25519_dalek!specs.lizard_specs.lemma_lizard_decode_ristretto_sound._definition
)))

;; Function-Specs curve25519_dalek::specs::lizard_specs::lemma_lizard_roundtrip_ristretto
(declare-fun req%curve25519_dalek!specs.lizard_specs.lemma_lizard_roundtrip_ristretto.
 (vstd!seq.Seq<u8.>.) Bool
)
(declare-const %%global_location_label%%24 Bool)
(assert
 (forall ((data! vstd!seq.Seq<u8.>.)) (!
   (= (req%curve25519_dalek!specs.lizard_specs.lemma_lizard_roundtrip_ristretto. data!)
    (=>
     %%global_location_label%%24
     (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. data!)) 16)
   ))
   :pattern ((req%curve25519_dalek!specs.lizard_specs.lemma_lizard_roundtrip_ristretto.
     data!
   ))
   :qid internal_req__curve25519_dalek!specs.lizard_specs.lemma_lizard_roundtrip_ristretto._definition
   :skolemid skolem_internal_req__curve25519_dalek!specs.lizard_specs.lemma_lizard_roundtrip_ristretto._definition
)))
(declare-fun ens%curve25519_dalek!specs.lizard_specs.lemma_lizard_roundtrip_ristretto.
 (vstd!seq.Seq<u8.>.) Bool
)
(assert
 (forall ((data! vstd!seq.Seq<u8.>.)) (!
   (= (ens%curve25519_dalek!specs.lizard_specs.lemma_lizard_roundtrip_ristretto. data!)
    (=>
     (curve25519_dalek!specs.lizard_specs.lizard_ristretto_has_unique_preimage.? (tuple%2./tuple%2/0
       (%Poly%tuple%2. (Poly%tuple%2. (curve25519_dalek!specs.lizard_specs.spec_lizard_encode.?
          (Poly%vstd!seq.Seq<u8.>. data!)
       )))
      ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. (curve25519_dalek!specs.lizard_specs.spec_lizard_encode.?
          (Poly%vstd!seq.Seq<u8.>. data!)
     )))))
     (= (curve25519_dalek!specs.lizard_specs.spec_lizard_decode_ristretto.? (tuple%2./tuple%2/0
        (%Poly%tuple%2. (Poly%tuple%2. (curve25519_dalek!specs.lizard_specs.spec_lizard_encode.?
           (Poly%vstd!seq.Seq<u8.>. data!)
        )))
       ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. (curve25519_dalek!specs.lizard_specs.spec_lizard_encode.?
   ...
   :pattern ((ens%curve25519_dalek!specs.lizard_specs.lemma_lizard_roundtrip_ristretto.
     data!
   ))
   :qid internal_ens__curve25519_dalek!specs.lizard_specs.lemma_lizard_roundtrip_ristretto._definition
   :skolemid skolem_internal_ens__curve25519_dalek!specs.lizard_specs.lemma_lizard_roundtrip_ristretto._definition
)))

;; Function-Def curve25519_dalek::specs::lizard_specs::lemma_lizard_roundtrip_ristretto
;; curve25519-dalek/src/specs/lizard_specs.rs:703:1: 703:61 (#0)
(get-info :all-statistics)
(push)
 (declare-const data! vstd!seq.Seq<u8.>.)
 (declare-const tmp%1 Bool)
 (declare-const enc@ tuple%2.)
 ...
 (assert
  (not (=>
    (fuel_bool fuel%curve25519_dalek!specs.lizard_specs.spec_lizard_decode_ristretto.)
    (=>
     (= enc@ (curve25519_dalek!specs.lizard_specs.spec_lizard_encode.? (Poly%vstd!seq.Seq<u8.>.
        data!
     )))
     (=>
      (= coset@ (curve25519_dalek!specs.ristretto_specs.ristretto_coset_affine.? (tuple%2./tuple%2/0
         (%Poly%tuple%2. (Poly%tuple%2. enc@))
        ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. enc@)))
      ))
      (=>
       (= tmp%1 (curve25519_dalek!specs.lizard_specs.is_lizard_preimage_coset.? (Poly%vstd!seq.Seq<u8.>.
          data!
         ) (Poly%array%. coset@)
       ))
       (and
        ...
        (=>
         ...
         (=>
          ...
          (=>
           ...
           (ext_eq false (TYPE%core!option.Option. $ (TYPE%vstd!seq.Seq. $ (UINT 8))) (Poly%core!option.Option.
             (curve25519_dalek!specs.lizard_specs.spec_lizard_decode_ristretto.? (tuple%2./tuple%2/0
               (%Poly%tuple%2. (Poly%tuple%2. (curve25519_dalek!specs.lizard_specs.spec_lizard_encode.?
                  (Poly%vstd!seq.Seq<u8.>. data!)
               )))
            ...
            ) (Poly%core!option.Option. (core!option.Option./Some (Poly%vstd!seq.Seq<u8.>. data!)))
 )))))))))))
 (get-info :version)
