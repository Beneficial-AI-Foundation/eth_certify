...
;; curve25519-dalek/src/specs/field_specs.rs:286:1: 286:30 (#0)
...
;; Function-Def curve25519_dalek::specs::field_specs::field_inv_zero
;; curve25519-dalek/src/specs/field_specs.rs:286:1: 286:30 (#0)
 ...
 (assert
  (not (and
    ...
    (=>
     (> (curve25519_dalek!specs.field_specs_u64.p.? (I 0)) 0)
     (=>
      (= tmp%1 (= (EucMod 0 (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0))
      (and
       (=>
        %%location_label%%1
        tmp%1
       ...
       (=>
        ...
        (=>
         %%location_label%%2
         (= (curve25519_dalek!specs.field_specs.field_inv.? (I 0)) 0)
 ))))))))
 (get-info :version)
