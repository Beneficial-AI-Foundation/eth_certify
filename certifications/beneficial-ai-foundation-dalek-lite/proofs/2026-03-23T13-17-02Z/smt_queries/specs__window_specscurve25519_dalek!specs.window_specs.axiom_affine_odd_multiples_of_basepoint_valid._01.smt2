...
;; MODULE 'module specs::window_specs'
;; curve25519-dalek/src/specs/window_specs.rs:205:1: 205:61 (#0)
...
(assert
 (distinct fuel%vstd!std_specs.convert.impl&%6.obeys_from_spec. fuel%vstd!std_specs.convert.impl&%6.from_spec.
  ...
  fuel%curve25519_dalek!specs.field_specs_u64.u64_5_as_nat. fuel%curve25519_dalek!specs.window_specs.is_valid_lookup_table_projective.
...
(declare-datatypes ((vstd!raw_ptr.PtrData. 0) (curve25519_dalek!backend.serial.u64.field.FieldElement51.
   ...
   0
  ) (curve25519_dalek!window.NafLookupTable8. 0) (tuple%0. 0) (tuple%2. 0) (tuple%4.
   0
  )
  ...
  (forall ((table! Poly) (A! Poly)) (!
    (= (curve25519_dalek!specs.window_specs.is_valid_naf_lookup_table5_projective.? table!
      A!
       ...
       :qid user_curve25519_dalek__specs__window_specs__is_valid_naf_lookup_table5_projective_21
       :skolemid skolem_user_curve25519_dalek__specs__window_specs__is_valid_naf_lookup_table5_projective_21
    )))
  ...
  (forall ((table! Poly)) (!
    (= (curve25519_dalek!specs.window_specs.naf_lookup_table5_projective_limbs_bounded.?
      table!
       ...
       :qid user_curve25519_dalek__specs__window_specs__naf_lookup_table5_projective_limbs_bounded_22
       :skolemid skolem_user_curve25519_dalek__specs__window_specs__naf_lookup_table5_projective_limbs_bounded_22
    )))
  ...
  (forall ((N&. Dcr) (N& Type) (table! Poly) (P! Poly) (size! Poly)) (!
    (= (curve25519_dalek!specs.window_specs.is_valid_lookup_table_projective.? N&. N& table!
      ...
      (forall ((j$ Poly)) (!
        ...
        :qid user_curve25519_dalek__specs__window_specs__is_valid_lookup_table_projective_23
        :skolemid skolem_user_curve25519_dalek__specs__window_specs__is_valid_lookup_table_projective_23
    ))))
  ...
  (forall ((N&. Dcr) (N& Type) (table! Poly)) (!
    (= (curve25519_dalek!specs.window_specs.lookup_table_projective_limbs_bounded.? N&.
      N& table!
       ...
       :qid user_curve25519_dalek__specs__window_specs__lookup_table_projective_limbs_bounded_24
       :skolemid skolem_user_curve25519_dalek__specs__window_specs__lookup_table_projective_limbs_bounded_24
    )))
  ...
  (forall ((niels! Poly)) (!
    (= (curve25519_dalek!specs.edwards_specs.is_valid_affine_niels_point.? niels!) (exists
      ((point$ Poly)) (!
       ...
       :qid user_curve25519_dalek__specs__edwards_specs__is_valid_affine_niels_point_25
       :skolemid skolem_user_curve25519_dalek__specs__edwards_specs__is_valid_affine_niels_point_25
    )))
  ...
  (forall ((N&. Dcr) (N& Type) (table! Poly) (basepoint! Poly) (size! Poly)) (!
    (= (curve25519_dalek!specs.window_specs.is_valid_lookup_table_affine_coords.? N&. N&
      ...
      (forall ((j$ Poly)) (!
        ...
        :qid user_curve25519_dalek__specs__window_specs__is_valid_lookup_table_affine_coords_26
        :skolemid skolem_user_curve25519_dalek__specs__window_specs__is_valid_lookup_table_affine_coords_26
    ))))
  ...
  (forall ((N&. Dcr) (N& Type) (table! Poly)) (!
    (= (curve25519_dalek!specs.window_specs.lookup_table_affine_limbs_bounded.? N&. N&
      table!
       ...
       :qid user_curve25519_dalek__specs__window_specs__lookup_table_affine_limbs_bounded_27
       :skolemid skolem_user_curve25519_dalek__specs__window_specs__lookup_table_affine_limbs_bounded_27
    )))
  ...
  (forall ((table! Poly)) (!
    (= (curve25519_dalek!specs.window_specs.naf_lookup_table5_affine_limbs_bounded.? table!)
     (forall ((j$ Poly)) (!
       ...
       :qid user_curve25519_dalek__specs__window_specs__naf_lookup_table5_affine_limbs_bounded_28
       :skolemid skolem_user_curve25519_dalek__specs__window_specs__naf_lookup_table5_affine_limbs_bounded_28
    )))
  ...
  (forall ((table! Poly) (A! Poly)) (!
    (= (curve25519_dalek!specs.window_specs.is_valid_naf_lookup_table5_affine.? table!
      A!
       ...
       :qid user_curve25519_dalek__specs__window_specs__is_valid_naf_lookup_table5_affine_29
       :skolemid skolem_user_curve25519_dalek__specs__window_specs__is_valid_naf_lookup_table5_affine_29
    )))
  ...
  (forall ((table! Poly)) (!
    (= (curve25519_dalek!specs.window_specs.naf_lookup_table8_projective_limbs_bounded.?
      table!
       ...
       :qid user_curve25519_dalek__specs__window_specs__naf_lookup_table8_projective_limbs_bounded_30
       :skolemid skolem_user_curve25519_dalek__specs__window_specs__naf_lookup_table8_projective_limbs_bounded_30
    )))
  ...
  (forall ((table! Poly)) (!
    (= (curve25519_dalek!specs.window_specs.naf_lookup_table8_affine_limbs_bounded.? table!)
     (forall ((j$ Poly)) (!
       ...
       :qid user_curve25519_dalek__specs__window_specs__naf_lookup_table8_affine_limbs_bounded_31
       :skolemid skolem_user_curve25519_dalek__specs__window_specs__naf_lookup_table8_affine_limbs_bounded_31
    )))
  ...
  (forall ((table! Poly) (A! Poly)) (!
    (= (curve25519_dalek!specs.window_specs.is_valid_naf_lookup_table8_projective.? table!
      A!
       ...
       :qid user_curve25519_dalek__specs__window_specs__is_valid_naf_lookup_table8_projective_32
       :skolemid skolem_user_curve25519_dalek__specs__window_specs__is_valid_naf_lookup_table8_projective_32
    )))
  ...
  (forall ((table! Poly) (A! Poly)) (!
    (= (curve25519_dalek!specs.window_specs.is_valid_naf_lookup_table8_affine.? table!
      A!
       ...
       :qid user_curve25519_dalek__specs__window_specs__is_valid_naf_lookup_table8_affine_33
       :skolemid skolem_user_curve25519_dalek__specs__window_specs__is_valid_naf_lookup_table8_affine_33
    )))
  ...
  (forall ((table! Poly) (basepoint! Poly)) (!
    (= (curve25519_dalek!specs.window_specs.is_valid_naf_lookup_table8_affine_coords.?
      table! basepoint!
       ...
       :qid user_curve25519_dalek__specs__window_specs__is_valid_naf_lookup_table8_affine_coords_34
       :skolemid skolem_user_curve25519_dalek__specs__window_specs__is_valid_naf_lookup_table8_affine_coords_34
    )))
 ...
 (forall ((no%param Int)) (!
   (= (ens%curve25519_dalek!specs.window_specs.axiom_affine_odd_multiples_of_basepoint_valid.
     ...
     (forall ((j$ Poly)) (!
       ...
       :qid user_curve25519_dalek__specs__window_specs__axiom_affine_odd_multiples_of_basepoint_valid_35
       :skolemid skolem_user_curve25519_dalek__specs__window_specs__axiom_affine_odd_multiples_of_basepoint_valid_35
     ))
...
;; Function-Def curve25519_dalek::specs::window_specs::axiom_affine_odd_multiples_of_basepoint_valid
;; curve25519-dalek/src/specs/window_specs.rs:205:1: 205:61 (#0)
