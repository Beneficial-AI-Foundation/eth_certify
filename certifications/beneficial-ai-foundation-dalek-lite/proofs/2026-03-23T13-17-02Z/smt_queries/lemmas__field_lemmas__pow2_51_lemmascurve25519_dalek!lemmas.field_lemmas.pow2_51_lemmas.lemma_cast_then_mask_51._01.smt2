...
;; curve25519-dalek/src/lemmas/field_lemmas/pow2_51_lemmas.rs:131:5: 131:11 (#0)
...
;; Function-Specs curve25519_dalek::lemmas::field_lemmas::pow2_51_lemmas::lemma_add_then_shift
(declare-fun req%curve25519_dalek!lemmas.field_lemmas.pow2_51_lemmas.lemma_add_then_shift.
 (Int Int) Bool
)
...
(assert
 (forall ((a! Int) (b! Int)) (!
   (= (req%curve25519_dalek!lemmas.field_lemmas.pow2_51_lemmas.lemma_add_then_shift. a!
     b!
    ) (and
     (=>
      %%global_location_label%%16
      (< a! (uClip 64 (bitshl (I 1) (I 52))))
     )
     (=>
      %%global_location_label%%17
      (< b! (uClip 64 (bitshl (I 1) (I 52))))
   )))
   :pattern ((req%curve25519_dalek!lemmas.field_lemmas.pow2_51_lemmas.lemma_add_then_shift.
     a! b!
   ))
   :qid internal_req__curve25519_dalek!lemmas.field_lemmas.pow2_51_lemmas.lemma_add_then_shift._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.field_lemmas.pow2_51_lemmas.lemma_add_then_shift._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.field_lemmas.pow2_51_lemmas.lemma_add_then_shift.
 (Int Int) Bool
)
(assert
 (forall ((a! Int) (b! Int)) (!
   (= (ens%curve25519_dalek!lemmas.field_lemmas.pow2_51_lemmas.lemma_add_then_shift. a!
     b!
    ) (and
     (< (Add a! b!) (uClip 64 (bitshl (I 1) (I 53))))
     (< (uClip 64 (bitshr (I (uClip 64 (Add a! b!))) (I 51))) 4)
   ))
   :pattern ((ens%curve25519_dalek!lemmas.field_lemmas.pow2_51_lemmas.lemma_add_then_shift.
     a! b!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.field_lemmas.pow2_51_lemmas.lemma_add_then_shift._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.field_lemmas.pow2_51_lemmas.lemma_add_then_shift._definition
)))

;; Function-Def curve25519_dalek::lemmas::field_lemmas::pow2_51_lemmas::lemma_cast_then_mask_51
;; curve25519-dalek/src/lemmas/field_lemmas/pow2_51_lemmas.rs:131:5: 131:11 (#0)
...
(assert
 (not (=>
   %%location_label%%0
   (= ((_ zero_extend 64) (bvand ((_ extract 63 0) x!) ((_ zero_extend 13) (_ bv2251799813685247
        51
     )))
    ) (bvand x! ((_ zero_extend 77) (_ bv2251799813685247 51)))
))))
(get-info :version)
