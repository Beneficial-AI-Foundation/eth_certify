...
;; curve25519-dalek/src/lemmas/edwards_lemmas/straus_lemmas.rs:294:1: 299:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::straus_lemmas::lemma_naf_select_is_signed_scalar_mul_affine8
;; curve25519-dalek/src/lemmas/edwards_lemmas/straus_lemmas.rs:294:1: 299:2 (#0)
(get-info :all-statistics)
(push)
 (declare-const table! %%Function%%)
 (declare-const digit! Int)
 (declare-const result! curve25519_dalek!backend.serial.curve_models.AffineNielsPoint.)
 ...
 (assert
  (has_type (Poly%array%. table!) (ARRAY $ TYPE%curve25519_dalek!backend.serial.curve_models.AffineNielsPoint.
    $ (CONST_INT 64)
 )))
 (assert
  (iInv 8 digit!)
 ...
 (assert
  (forall ((j$ Poly)) (!
    ...
    :qid user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_naf_select_is_signed_scalar_mul_affine8_72
    :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_naf_select_is_signed_scalar_mul_affine8_72
 )))
 (assert
  (= result! (%Poly%curve25519_dalek!backend.serial.curve_models.AffineNielsPoint. (vstd!seq.Seq.index.?
     $ TYPE%curve25519_dalek!backend.serial.curve_models.AffineNielsPoint. (vstd!view.View.view.?
     ...
     (=>
      ...
      (and
       ...
       (=>
        tmp%1
        (=>
         (= tmp%2 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.affine_niels_point_as_affine_edwards.?
         ...
         (and
          ...
          (=>
           tmp%2
           (=>
            (= tmp%3 (= (nClip (Add (Mul 2 j@) 1)) (nClip digit!)))
            (and
             (=>
              %%location_label%%2
              tmp%3
             ...
             (=>
              ...
              (=>
               ...
               (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.affine_niels_point_as_affine_edwards.?
                  ...
                  (Poly%tuple%2. basepoint!) (I digit!)
 )))))))))))))))))
 (get-info :version)
