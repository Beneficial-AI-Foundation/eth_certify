...
;; curve25519-dalek/src/lemmas/lizard_lemmas.rs:353:1: 360:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::lizard_lemmas::lemma_odd_is_slot_in_coset
;; curve25519-dalek/src/lemmas/lizard_lemmas.rs:353:1: 360:2 (#0)
(get-info :all-statistics)
(push)
 (declare-const fe_val! Int)
 (declare-const ns! Int)
 (declare-const nt! Int)
 (declare-const s! Int)
 (declare-const t! Int)
 (declare-const coset! %%Function%%)
 (assert
  fuel_defaults
 )
 (assert
 ...
 (assert
  (has_type (Poly%array%. coset!) (ARRAY (DST $) (TYPE%tuple%2. $ NAT $ NAT) $ (CONST_INT
     4
 ))))
 (assert
  (%B (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. (curve25519_dalek!specs.lizard_specs.spec_elligator_inv.?
 ...
 (assert
  (not (=>
    ...
    (and
     (=>
      (ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_elligator_inv_algebraic. ns! nt!)
      (=>
       %%location_label%%0
       (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.ristretto_specs.spec_elligator_ristretto_flavor.?
          (I fe_val!)
         )
     ...
     (=>
      (= (curve25519_dalek!specs.ristretto_specs.spec_elligator_ristretto_flavor.? (I fe_val!))
       (curve25519_dalek!specs.lizard_specs.jacobi_to_edwards_affine.? (I ns!) (I nt!))
      )
      (=>
       (ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_jacobi_dual_same_edwards. s! t!)
       (=>
