...
;; curve25519-dalek/src/backend/serial/curve_models/mod.rs:987:13: 987:19 (#0)
...
;; Function-Specs curve25519_dalek::lemmas::edwards_lemmas::double_correctness::lemma_double_projective_completed_valid
(declare-fun req%curve25519_dalek!lemmas.edwards_lemmas.double_correctness.lemma_double_projective_completed_valid.
 (curve25519_dalek!backend.serial.curve_models.ProjectivePoint. curve25519_dalek!backend.serial.curve_models.CompletedPoint.
  Int Int Int Int
 ) Bool
)
...
(assert
 (forall ((self_point! curve25519_dalek!backend.serial.curve_models.ProjectivePoint.)
   (result! curve25519_dalek!backend.serial.curve_models.CompletedPoint.) (xx_val! Int)
   (yy_val! Int) (zz2_val! Int) (xpy_sq_val! Int)
  ) (!
   (= (req%curve25519_dalek!lemmas.edwards_lemmas.double_correctness.lemma_double_projective_completed_valid.
     self_point! result! xx_val! yy_val! zz2_val! xpy_sq_val!
    ) (and
     (=>
     ...
     (=>
      ...
      (= xx_val! (curve25519_dalek!specs.field_specs.field_square.? (I (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.?
          (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (curve25519_dalek!backend.serial.curve_models.ProjectivePoint./ProjectivePoint/X
            (%Poly%curve25519_dalek!backend.serial.curve_models.ProjectivePoint. (Poly%curve25519_dalek!backend.serial.curve_models.ProjectivePoint.
              self_point!
     )))))))))
     (=>
      %%global_location_label%%74
      (= yy_val! (curve25519_dalek!specs.field_specs.field_square.? (I (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.?
          (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (curve25519_dalek!backend.serial.curve_models.ProjectivePoint./ProjectivePoint/Y
            (%Poly%curve25519_dalek!backend.serial.curve_models.ProjectivePoint. (Poly%curve25519_dalek!backend.serial.curve_models.ProjectivePoint.
              self_point!
     )))))))))
     (=>
      ...
      (= zz2_val! (curve25519_dalek!specs.field_specs.field_mul.? (I 2) (I (curve25519_dalek!specs.field_specs.field_square.?
          (I (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
             (curve25519_dalek!backend.serial.curve_models.ProjectivePoint./ProjectivePoint/Z (
               %Poly%curve25519_dalek!backend.serial.curve_models.ProjectivePoint. (Poly%curve25519_dalek!backend.serial.curve_models.ProjectivePoint.
                self_point!
     ...
     (=>
      ...
      (= xpy_sq_val! (curve25519_dalek!specs.field_specs.field_square.? (I (curve25519_dalek!specs.field_specs.field_add.?
          (I (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
             (curve25519_dalek!backend.serial.curve_models.ProjectivePoint./ProjectivePoint/X (
               %Poly%curve25519_dalek!backend.serial.curve_models.ProjectivePoint. (Poly%curve25519_dalek!backend.serial.curve_models.ProjectivePoint.
                self_point!
     ...
     (=>
      ...
      (= (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
       ...
       ) (curve25519_dalek!specs.field_specs.field_sub.? (I xpy_sq_val!) (I (curve25519_dalek!specs.field_specs.field_add.?
          (I yy_val!) (I xx_val!)
     )))))
     (=>
      ...
      (= (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
       ...
       ) (curve25519_dalek!specs.field_specs.field_add.? (I yy_val!) (I xx_val!))
     ))
     (=>
      ...
      (= (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
       ...
       ) (curve25519_dalek!specs.field_specs.field_sub.? (I yy_val!) (I xx_val!))
     ))
     (=>
      ...
      (= (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
       ...
       ) (curve25519_dalek!specs.field_specs.field_sub.? (I zz2_val!) (I (curve25519_dalek!specs.field_specs.field_sub.?
          (I yy_val!) (I xx_val!)
   )))))))
   :pattern ((req%curve25519_dalek!lemmas.edwards_lemmas.double_correctness.lemma_double_projective_completed_valid.
     self_point! result! xx_val! yy_val! zz2_val! xpy_sq_val!
   ))
   :qid internal_req__curve25519_dalek!lemmas.edwards_lemmas.double_correctness.lemma_double_projective_completed_valid._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.edwards_lemmas.double_correctness.lemma_double_projective_completed_valid._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.edwards_lemmas.double_correctness.lemma_double_projective_completed_valid.
 (curve25519_dalek!backend.serial.curve_models.ProjectivePoint. curve25519_dalek!backend.serial.curve_models.CompletedPoint.
  Int Int Int Int
 ) Bool
)
(assert
 (forall ((self_point! curve25519_dalek!backend.serial.curve_models.ProjectivePoint.)
   ...
   (= (ens%curve25519_dalek!lemmas.edwards_lemmas.double_correctness.lemma_double_projective_completed_valid.
     self_point! result! xx_val! yy_val! zz2_val! xpy_sq_val!
    ) (and
     (curve25519_dalek!specs.edwards_specs.is_valid_completed_point.? (Poly%curve25519_dalek!backend.serial.curve_models.CompletedPoint.
       result!
     ...
     (= (curve25519_dalek!specs.edwards_specs.completed_point_as_affine_edwards.? (Poly%curve25519_dalek!backend.serial.curve_models.CompletedPoint.
        result!
         ...
         (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.projective_point_as_affine_edwards.?
           (Poly%curve25519_dalek!backend.serial.curve_models.ProjectivePoint. self_point!)
        )))
       ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.projective_point_as_affine_edwards.?
           (Poly%curve25519_dalek!backend.serial.curve_models.ProjectivePoint. self_point!)
   ))))))))
   :pattern ((ens%curve25519_dalek!lemmas.edwards_lemmas.double_correctness.lemma_double_projective_completed_valid.
     self_point! result! xx_val! yy_val! zz2_val! xpy_sq_val!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.edwards_lemmas.double_correctness.lemma_double_projective_completed_valid._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.edwards_lemmas.double_correctness.lemma_double_projective_completed_valid._definition
)))
...
;; Function-Def curve25519_dalek::backend::serial::curve_models::ProjectivePoint::double
;; curve25519-dalek/src/backend/serial/curve_models/mod.rs:987:13: 987:19 (#0)
