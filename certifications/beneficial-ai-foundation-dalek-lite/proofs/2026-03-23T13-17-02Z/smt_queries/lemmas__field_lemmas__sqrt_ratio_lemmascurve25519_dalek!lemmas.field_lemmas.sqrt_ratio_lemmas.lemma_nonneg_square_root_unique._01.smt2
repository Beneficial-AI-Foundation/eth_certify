...
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_ratio_lemmas.rs:1243:13: 1243:19 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::sqrt_ratio_lemmas::lemma_nonneg_square_root_unique
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_ratio_lemmas.rs:1243:13: 1243:19 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= sum@ (Add (Mul pp@ (EucDiv sum@ pp@)) (EucMod sum@ pp@)))
    (=>
     (= (EucMod sum@ pp@) 0)
     (=>
      (= sum@ (Add r! s!))
