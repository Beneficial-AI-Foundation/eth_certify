...
;; curve25519-dalek/src/lemmas/common_lemmas/to_nat_lemmas.rs:777:7: 777:74 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::to_nat_lemmas::lemma_prefix_equals_suffix_full
;; curve25519-dalek/src/lemmas/common_lemmas/to_nat_lemmas.rs:777:7: 777:74 (#0)
...
(push)
 ...
 (assert
  (has_type (Poly%array%. bytes!) (ARRAY $ (UINT 8) N&. N&))
 )
 ;; assertion failed
 ...
 (assert
  (not (=>
    (= tmp%1 (= (curve25519_dalek!specs.core_specs.bytes_as_nat_suffix.? N&. N& (Poly%array%.
        bytes!
       ) (I (const_int N&))
      ) 0
    ))
