...
;; curve25519-dalek/src/lemmas/common_lemmas/to_nat_lemmas.rs:603:1: 603:66 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::to_nat_lemmas::lemma_u8_32_as_nat_first_byte_only
;; curve25519-dalek/src/lemmas/common_lemmas/to_nat_lemmas.rs:603:1: 603:66 (#0)
...
(push)
 ...
 (assert
  (forall ((i$ Poly)) (!
    ...
    :qid user_curve25519_dalek__lemmas__common_lemmas__to_nat_lemmas__lemma_u8_32_as_nat_first_byte_only_51
    :skolemid skolem_user_curve25519_dalek__lemmas__common_lemmas__to_nat_lemmas__lemma_u8_32_as_nat_first_byte_only_51
 )))
 ...
 (assert
  (not (=>
    (= goal@ (= (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. bytes!))
    ...
    (and
             ...
             (=>
              ...
              (and
               ...
               (=>
                tmp%2
                (=>
                 (= tmp%3 (= (vstd!arithmetic.power2.pow2.? (I 0)) 1))
                 (and
                  (=>
                   %%location_label%%3
                   tmp%3
                  ...
                  (=>
                   tmp%3
                   (=>
                    (= tmp%4 (= (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 0)) (%I (vstd!seq.Seq.index.?
     ...
     (=>
      ...
      (=>
       %%location_label%%6
       (= (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. bytes!)) (%I (vstd!seq.Seq.index.?
          $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT 32)) (Poly%array%.
            bytes!
           )
          ) (I 0)
