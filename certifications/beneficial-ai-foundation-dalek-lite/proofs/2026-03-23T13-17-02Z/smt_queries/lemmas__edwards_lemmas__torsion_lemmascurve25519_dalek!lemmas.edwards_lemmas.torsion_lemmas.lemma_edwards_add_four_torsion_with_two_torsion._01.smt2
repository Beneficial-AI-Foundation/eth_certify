...
;; MODULE 'module lemmas::edwards_lemmas::torsion_lemmas'
;; curve25519-dalek/src/lemmas/edwards_lemmas/torsion_lemmas.rs:412:1: 412:69 (#0)
...
(assert
 (distinct fuel%vstd!arithmetic.div_mod.lemma_mod_self_0. fuel%vstd!arithmetic.div_mod.lemma_mod_add_multiples_vanish.
  fuel%vstd!arithmetic.div_mod.lemma_mod_bound. fuel%vstd!array.array_view. fuel%vstd!array.impl&%0.view.
  ...
  fuel%vstd!view.impl&%44.view. fuel%vstd!view.impl&%48.view. fuel%curve25519_dalek!backend.serial.u64.constants.SQRT_M1.
  ...
  fuel%curve25519_dalek!specs.edwards_specs.is_on_edwards_curve. fuel%curve25519_dalek!specs.edwards_specs.edwards_point_as_nat.
  ...
  fuel%curve25519_dalek!specs.field_specs.field_inv. fuel%curve25519_dalek!specs.field_specs.sqrt_m1.
...
(assert
 (=>
  ...
  (forall ((b! Int) (m! Int)) (!
    ...
    :pattern ((EucMod b! m!))
    :qid user_vstd__arithmetic__div_mod__lemma_mod_add_multiples_vanish_19
    :skolemid skolem_user_vstd__arithmetic__div_mod__lemma_mod_add_multiples_vanish_19
))))
  ...
  (forall ((n! Poly)) (!
    (= (curve25519_dalek!specs.primality_specs.is_prime.? n!) (and
      ...
      (forall ((d$ Int)) (!
        ...
        :qid user_curve25519_dalek__specs__primality_specs__is_prime_21
        :skolemid skolem_user_curve25519_dalek__specs__primality_specs__is_prime_21
    ))))
...
;; Function-Specs curve25519_dalek::lemmas::edwards_lemmas::torsion_lemmas::axiom_four_torsion_affine
(declare-fun ens%curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.axiom_four_torsion_affine.
 (Int) Bool
)
(assert
 (forall ((no%param Int)) (!
   (= (ens%curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.axiom_four_torsion_affine.
     no%param
    ) (and
     ...
     (= (curve25519_dalek!specs.edwards_specs.edwards_point_as_affine.? (vstd!seq.Seq.index.?
      ...
      ) (tuple%2./tuple%2 (I 0) (I (curve25519_dalek!specs.field_specs.field_neg.? (I 1))))
     )
     (= (curve25519_dalek!specs.edwards_specs.edwards_point_as_affine.? (vstd!seq.Seq.index.?
        $ TYPE%curve25519_dalek!edwards.EdwardsPoint. (vstd!view.View.view.? $ (ARRAY $ TYPE%curve25519_dalek!edwards.EdwardsPoint.
          $ (CONST_INT 8)
   ...
   :pattern ((ens%curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.axiom_four_torsion_affine.
     no%param
   ))
   :qid internal_ens__curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.axiom_four_torsion_affine._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.axiom_four_torsion_affine._definition
)))
...
;; Function-Specs curve25519_dalek::lemmas::edwards_lemmas::torsion_lemmas::lemma_edwards_add_zero_coord_denom
(declare-fun req%curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_zero_coord_denom.
 (Int Int) Bool
)
(declare-const %%global_location_label%%20 Bool)
(assert
 (forall ((x1x2! Int) (y1y2! Int)) (!
   (= (req%curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_zero_coord_denom.
     x1x2! y1y2!
    ) (=>
     %%global_location_label%%20
     (= (curve25519_dalek!specs.field_specs.field_mul.? (I x1x2!) (I y1y2!)) 0)
   ))
   :pattern ((req%curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_zero_coord_denom.
     x1x2! y1y2!
   ))
   :qid internal_req__curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_zero_coord_denom._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_zero_coord_denom._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_zero_coord_denom.
 (Int Int) Bool
)
(assert
 (forall ((x1x2! Int) (y1y2! Int)) (!
   (= (ens%curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_zero_coord_denom.
     x1x2! y1y2!
    ) (let
     ((d$ (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
         curve25519_dalek!backend.serial.u64.constants.EDWARDS_D.?
      ...
      (and
       (and
        (and
         (and
          (= t$ 0)
          (= (curve25519_dalek!specs.field_specs.field_add.? (I 1) (I t$)) 1)
         )
         (= (curve25519_dalek!specs.field_specs.field_sub.? (I 1) (I t$)) 1)
        )
   ...
   :pattern ((ens%curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_zero_coord_denom.
     x1x2! y1y2!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_zero_coord_denom._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_zero_coord_denom._definition
)))

;; Function-Specs curve25519_dalek::lemmas::edwards_lemmas::torsion_lemmas::lemma_edwards_add_two_torsion_self
(declare-fun ens%curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_two_torsion_self.
 (Int) Bool
)
(assert
 (forall ((no%param Int)) (!
   (= (ens%curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_two_torsion_self.
     no%param
    ) (= (curve25519_dalek!specs.edwards_specs.edwards_add.? (I 0) (I (curve25519_dalek!specs.field_specs.field_neg.?
        (I 1)
       )
      ) (I 0) (I (curve25519_dalek!specs.field_specs.field_neg.? (I 1)))
     ) (tuple%2./tuple%2 (I 0) (I 1))
   ))
   :pattern ((ens%curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_two_torsion_self.
     no%param
   ))
   :qid internal_ens__curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_two_torsion_self._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_two_torsion_self._definition
)))

;; Function-Specs curve25519_dalek::lemmas::edwards_lemmas::torsion_lemmas::lemma_edwards_add_two_torsion_four_torsion
(declare-fun req%curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_two_torsion_four_torsion.
 (Int) Bool
)
...
(assert
 (forall ((i_val! Int)) (!
   (= (req%curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_two_torsion_four_torsion.
     i_val!
    ) (and
     (=>
      %%global_location_label%%21
      (< i_val! (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
     )
     (=>
      %%global_location_label%%22
      (= (curve25519_dalek!specs.field_specs.field_square.? (I i_val!)) (curve25519_dalek!specs.field_specs.field_neg.?
        (I 1)
   )))))
   :pattern ((req%curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_two_torsion_four_torsion.
     i_val!
   ))
   :qid internal_req__curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_two_torsion_four_torsion._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_two_torsion_four_torsion._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_two_torsion_four_torsion.
 (Int) Bool
)
(assert
 (forall ((i_val! Int)) (!
   (= (ens%curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_two_torsion_four_torsion.
     i_val!
    ) (= (curve25519_dalek!specs.edwards_specs.edwards_add.? (I 0) (I (curve25519_dalek!specs.field_specs.field_neg.?
        (I 1)
       )
      ) (I i_val!) (I 0)
     ) (tuple%2./tuple%2 (I (curve25519_dalek!specs.field_specs.field_neg.? (I i_val!)))
      (I 0)
   )))
   :pattern ((ens%curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_two_torsion_four_torsion.
     i_val!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_two_torsion_four_torsion._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_two_torsion_four_torsion._definition
)))

;; Function-Specs curve25519_dalek::lemmas::edwards_lemmas::torsion_lemmas::lemma_edwards_add_two_torsion_four_torsion_neg
(declare-fun req%curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_two_torsion_four_torsion_neg.
 (Int) Bool
)
...
(assert
 (forall ((i_val! Int)) (!
   (= (req%curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_two_torsion_four_torsion_neg.
     i_val!
    ) (and
     (=>
   ...
   :pattern ((req%curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_two_torsion_four_torsion_neg.
     i_val!
   ))
   :qid internal_req__curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_two_torsion_four_torsion_neg._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_two_torsion_four_torsion_neg._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_two_torsion_four_torsion_neg.
 (Int) Bool
)
(assert
 (forall ((i_val! Int)) (!
   (= (ens%curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_two_torsion_four_torsion_neg.
     i_val!
    ) (= (curve25519_dalek!specs.edwards_specs.edwards_add.? (I 0) (I (curve25519_dalek!specs.field_specs.field_neg.?
        (I 1)
       )
      ) (I (curve25519_dalek!specs.field_specs.field_neg.? (I i_val!))) (I 0)
     ) (tuple%2./tuple%2 (I (EucMod i_val! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))))
      (I 0)
   )))
   :pattern ((ens%curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_two_torsion_four_torsion_neg.
     i_val!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_two_torsion_four_torsion_neg._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_two_torsion_four_torsion_neg._definition
)))

;; Function-Specs curve25519_dalek::lemmas::edwards_lemmas::torsion_lemmas::lemma_edwards_add_four_torsion_with_neg
(declare-fun req%curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_four_torsion_with_neg.
 (Int) Bool
)
...
(assert
 (forall ((x! Int)) (!
   (= (req%curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_four_torsion_with_neg.
     x!
    ) (and
     (=>
   ...
   :pattern ((req%curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_four_torsion_with_neg.
     x!
   ))
   :qid internal_req__curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_four_torsion_with_neg._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_four_torsion_with_neg._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_four_torsion_with_neg.
 (Int) Bool
)
(assert
 (forall ((x! Int)) (!
   (= (ens%curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_four_torsion_with_neg.
     x!
    ) (= (curve25519_dalek!specs.edwards_specs.edwards_add.? (I x!) (I 0) (I (curve25519_dalek!specs.field_specs.field_neg.?
        (I x!)
       )
      ) (I 0)
     ) (tuple%2./tuple%2 (I 0) (I 1))
   ))
   :pattern ((ens%curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_four_torsion_with_neg.
     x!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_four_torsion_with_neg._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_four_torsion_with_neg._definition
)))

;; Function-Specs curve25519_dalek::lemmas::edwards_lemmas::torsion_lemmas::lemma_edwards_add_four_torsion_with_two_torsion
(declare-fun req%curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_four_torsion_with_two_torsion.
 (Int) Bool
)
(declare-const %%global_location_label%%27 Bool)
(assert
 (forall ((x! Int)) (!
   (= (req%curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_four_torsion_with_two_torsion.
     x!
    ) (=>
     %%global_location_label%%27
     (< x! (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
   ))
   :pattern ((req%curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_four_torsion_with_two_torsion.
     x!
   ))
   :qid internal_req__curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_four_torsion_with_two_torsion._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_four_torsion_with_two_torsion._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_four_torsion_with_two_torsion.
 (Int) Bool
)
(assert
 (forall ((x! Int)) (!
   (= (ens%curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_four_torsion_with_two_torsion.
     x!
    ) (= (curve25519_dalek!specs.edwards_specs.edwards_add.? (I x!) (I 0) (I 0) (I (curve25519_dalek!specs.field_specs.field_neg.?
        (I 1)
      ))
     ) (tuple%2./tuple%2 (I (curve25519_dalek!specs.field_specs.field_neg.? (I x!))) (I
       0
   ))))
   :pattern ((ens%curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_four_torsion_with_two_torsion.
     x!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_four_torsion_with_two_torsion._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.edwards_lemmas.torsion_lemmas.lemma_edwards_add_four_torsion_with_two_torsion._definition
)))

;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::torsion_lemmas::lemma_edwards_add_four_torsion_with_two_torsion
;; curve25519-dalek/src/lemmas/edwards_lemmas/torsion_lemmas.rs:412:1: 412:69 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= neg1@ (curve25519_dalek!specs.field_specs.field_neg.? (I 1)))
    (=>
       ...
       (=>
        ...
        (=>
         ...
         (and
          (=>
           %%location_label%%1
           (req%vstd!arithmetic.div_mod.lemma_small_mod. 1 tmp%2)
          )
          (=>
           (ens%vstd!arithmetic.div_mod.lemma_small_mod. 1 tmp%2)
           (and
            (and
             (=>
              %%location_label%%2
             ...
             (=>
              ...
              (=>
               %%location_label%%3
               (= (curve25519_dalek!specs.field_specs.field_mul.? (I x!) (I 0)) 0)
            )))
            (=>
             (= (curve25519_dalek!specs.field_specs.field_mul.? (I x!) (I 0)) 0)
             (and
              (and
               ...
               (=>
                ...
                (=>
                 %%location_label%%5
                 (= (curve25519_dalek!specs.field_specs.field_mul.? (I 0) (I neg1@)) 0)
              )))
              (=>
               (= (curve25519_dalek!specs.field_specs.field_mul.? (I 0) (I neg1@)) 0)
               (and
                (and
                 ...
                 (=>
                  ...
                  (=>
                   %%location_label%%7
                   (= (curve25519_dalek!specs.field_specs.field_mul.? (I 0) (I 0)) 0)
                )))
                (=>
                 (= (curve25519_dalek!specs.field_specs.field_mul.? (I 0) (I 0)) 0)
                 (and
                   ...
                   (=>
                    ...
                    (=>
                     ...
                     (and
                      (=>
                       %%location_label%%8
                       (req%vstd!arithmetic.div_mod.lemma_small_mod. x! tmp%3)
                      )
                      (=>
                       (ens%vstd!arithmetic.div_mod.lemma_small_mod. x! tmp%3)
                       (=>
                        %%location_label%%9
                        (= (curve25519_dalek!specs.field_specs.field_mul.? (I x!) (I neg1@)) (curve25519_dalek!specs.field_specs.field_neg.?
                          (I x!)
                  ))))))))
                  (=>
                   (= (curve25519_dalek!specs.field_specs.field_mul.? (I x!) (I neg1@)) (curve25519_dalek!specs.field_specs.field_neg.?
                   ...
                   (=>
                    (= x1x2@ (curve25519_dalek!specs.field_specs.field_mul.? (I x!) (I 0)))
                    (=>
                     (= y1y2@ (curve25519_dalek!specs.field_specs.field_mul.? (I 0) (I neg1@)))
                     (=>
                      (= x1y2@ (curve25519_dalek!specs.field_specs.field_mul.? (I x!) (I neg1@)))
                      (=>
                       (= y1x2@ (curve25519_dalek!specs.field_specs.field_mul.? (I 0) (I 0)))
                       (=>
                        (= tmp%4 (and
                          (and
                           (= x1x2@ 0)
                           ...
                           (=>
                            ...
                            (and
                             ...
                             (=>
                              ...
                              (and
                               (=>
                                (= tmp%5 (curve25519_dalek!specs.field_specs.field_neg.? (I x!)))
                                (=>
                                 (= tmp%6 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                                 (and
                                  (=>
                                   %%location_label%%14
                                   (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%5 tmp%6)
                                  )
                                  (=>
                                   (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%5 tmp%6)
                                   (=>
                                    %%location_label%%15
                                    (< (curve25519_dalek!specs.field_specs.field_neg.? (I x!)) (curve25519_dalek!specs.field_specs_u64.p.?
                                      (I 0)
                               )))))))
                               (=>
                                (< (curve25519_dalek!specs.field_specs.field_neg.? (I x!)) (curve25519_dalek!specs.field_specs_u64.p.?
                                ...
                                (=>
                                 (= tmp%7 (curve25519_dalek!specs.field_specs.field_neg.? (I x!)))
                                 (=>
                                  (= tmp%8 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                                  (and
                                   (=>
                                    %%location_label%%16
                                    (req%vstd!arithmetic.div_mod.lemma_small_mod. tmp%7 tmp%8)
                                   )
                                   (=>
                                    (ens%vstd!arithmetic.div_mod.lemma_small_mod. tmp%7 tmp%8)
                                    (=>
                                     (= tmp%9 (= (curve25519_dalek!specs.field_specs.field_add.? (I x1y2@) (I y1x2@)) (curve25519_dalek!specs.field_specs.field_neg.?
                                        (I x!)
                                     )))
                                     (and
                                      (=>
                                      ...
                                      (=>
                                       ...
                                       (and
                                        (=>
                                         (= tmp%10 (curve25519_dalek!specs.field_specs.field_neg.? (I x!)))
                                         (=>
                                          (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_one_right.
                                           tmp%10
                                          )
                                        ...
                                        (=>
                                         ...
                                         (=>
                                          (= tmp%11 (= (curve25519_dalek!specs.field_specs.field_add.? (I y1y2@) (I x1x2@)) 0))
                                          (and
                                           (=>
                                            %%location_label%%19
                                            tmp%11
                                            ...
                                            (and
                                             (and
                                              ...
                                              (=>
                                               ...
                                               (=>
                                                %%location_label%%21
                                                (= (curve25519_dalek!specs.field_specs.field_mul.? (I 0) (I 1)) 0)
                                             )))
                                             (=>
                                              (= (curve25519_dalek!specs.field_specs.field_mul.? (I 0) (I 1)) 0)
                                              (=>
                                               %%location_label%%22
                                               (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_add.?
                                                  (I x!) (I 0) (I 0) (I (curve25519_dalek!specs.field_specs.field_neg.? (I 1)))
                                                 )
                                                ) (Poly%tuple%2. (tuple%2./tuple%2 (I (curve25519_dalek!specs.field_specs.field_neg.?
                                                    (I x!)
                                                   )
                                                  ) (I 0)
 )))))))))))))))))))))))))))))))))))))))))))))))))
