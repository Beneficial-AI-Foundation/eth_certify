...
;; MODULE 'module scalar_helpers'
;; curve25519-dalek/src/scalar_helpers.rs:67:1: 67:43 (#0)
...
(declare-const fuel%curve25519_dalek!specs.scalar_specs.sum_of_scalars. FuelId)
(declare-const fuel%curve25519_dalek!specs.scalar_specs.scalar_congruent_nat. FuelId)
...
(declare-const fuel%curve25519_dalek!scalar.impl&%50.ZERO. FuelId)
(declare-const fuel%curve25519_dalek!scalar.impl&%50.ONE. FuelId)
...
(assert
 (distinct fuel%vstd!arithmetic.div_mod.lemma_mod_twice. fuel%vstd!arithmetic.div_mod.lemma_add_mod_noop.
  ...
  fuel%vstd!std_specs.ops.impl&%59.mul_spec. fuel%vstd!std_specs.option.impl&%0.arrow_0.
  ...
  fuel%vstd!std_specs.range.axiom_spec_range_next_u8. fuel%vstd!std_specs.range.impl&%9.spec_is_lt.
  ...
  fuel%vstd!std_specs.range.impl&%11.spec_is_lt. fuel%vstd!std_specs.range.impl&%11.spec_steps_between_int.
  fuel%vstd!std_specs.range.impl&%11.spec_forward_checked. fuel%vstd!std_specs.range.impl&%11.spec_forward_checked_int.
  fuel%vstd!std_specs.range.axiom_spec_range_next_usize. fuel%vstd!array.array_view.
  ...
  fuel%curve25519_dalek!backend.serial.u64.field.impl&%11.mul_spec. fuel%curve25519_dalek!backend.serial.u64.constants.MONTGOMERY_A.
  ...
  fuel%curve25519_dalek!specs.field_specs.spec_add_fe51_limbs. fuel%curve25519_dalek!specs.field_specs.fe51_as_nat.
  ...
  fuel%curve25519_dalek!specs.arithm_trait_specs.impl&%3.add_spec. fuel%curve25519_dalek!specs.arithm_trait_specs.impl&%8.obeys_mul_spec.
  ...
  fuel%curve25519_dalek!specs.scalar_specs.product_of_scalars. fuel%curve25519_dalek!specs.scalar_specs.sum_of_scalars.
  fuel%curve25519_dalek!specs.scalar_specs.scalar_congruent_nat. fuel%curve25519_dalek!specs.scalar52_specs.group_order.
  fuel%curve25519_dalek!specs.scalar52_specs.group_canonical. fuel%curve25519_dalek!specs.window_specs.lookup_table_affine_limbs_bounded.
  fuel%curve25519_dalek!specs.window_specs.is_valid_lookup_table_affine_coords. fuel%curve25519_dalek!scalar.impl&%12.obeys_mul_spec.
  ...
  fuel%curve25519_dalek!scalar.impl&%17.add_spec. fuel%curve25519_dalek!scalar.impl&%50.ZERO.
  fuel%curve25519_dalek!scalar.impl&%50.ONE. fuel%curve25519_dalek!edwards.impl&%31.obeys_add_spec.
...
(declare-sort slice%<curve25519_dalek!scalar.Scalar.>. 0)
...
(declare-datatypes ((core!option.Option. 0) (core!ops.range.Range. 0) (vstd!std_specs.range.RangeGhostIterator.
   ...
   0
  ) (curve25519_dalek!montgomery.MontgomeryPoint. 0) (curve25519_dalek!edwards.EdwardsPoint.
   0
  ) (curve25519_dalek!edwards.EdwardsBasepointTable. 0) (curve25519_dalek!ristretto.RistrettoPoint.
   0
  ) (curve25519_dalek!ristretto.RistrettoBasepointTable. 0) (curve25519_dalek!window.LookupTable.
   0
...
(declare-fun Poly%slice%<curve25519_dalek!scalar.Scalar.>. (slice%<curve25519_dalek!scalar.Scalar.>.)
 Poly
)
(declare-fun %Poly%slice%<curve25519_dalek!scalar.Scalar.>. (Poly) slice%<curve25519_dalek!scalar.Scalar.>.)
...
(assert
 (forall ((x slice%<curve25519_dalek!scalar.Scalar.>.)) (!
   (= x (%Poly%slice%<curve25519_dalek!scalar.Scalar.>. (Poly%slice%<curve25519_dalek!scalar.Scalar.>.
      x
   )))
   :pattern ((Poly%slice%<curve25519_dalek!scalar.Scalar.>. x))
   :qid internal_crate__slice__<curve25519_dalek!scalar.Scalar.>_box_axiom_definition
   :skolemid skolem_internal_crate__slice__<curve25519_dalek!scalar.Scalar.>_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x (SLICE $ TYPE%curve25519_dalek!scalar.Scalar.))
    (= x (Poly%slice%<curve25519_dalek!scalar.Scalar.>. (%Poly%slice%<curve25519_dalek!scalar.Scalar.>.
       x
   ))))
   :pattern ((has_type x (SLICE $ TYPE%curve25519_dalek!scalar.Scalar.)))
   :qid internal_crate__slice__<curve25519_dalek!scalar.Scalar.>_unbox_axiom_definition
   :skolemid skolem_internal_crate__slice__<curve25519_dalek!scalar.Scalar.>_unbox_axiom_definition
)))
(assert
 (forall ((x slice%<curve25519_dalek!scalar.Scalar.>.)) (!
   (has_type (Poly%slice%<curve25519_dalek!scalar.Scalar.>. x) (SLICE $ TYPE%curve25519_dalek!scalar.Scalar.))
   :pattern ((has_type (Poly%slice%<curve25519_dalek!scalar.Scalar.>. x) (SLICE $ TYPE%curve25519_dalek!scalar.Scalar.)))
   :qid internal_crate__slice__<curve25519_dalek!scalar.Scalar.>_has_type_always_definition
   :skolemid skolem_internal_crate__slice__<curve25519_dalek!scalar.Scalar.>_has_type_always_definition
)))
(assert
...
;; Function-Decl curve25519_dalek::specs::scalar_specs::sum_of_scalars
(declare-fun curve25519_dalek!specs.scalar_specs.sum_of_scalars.? (Poly) Int)
(declare-fun curve25519_dalek!specs.scalar_specs.rec%sum_of_scalars.? (Poly Fuel)
 Int
)

;; Function-Decl curve25519_dalek::specs::scalar_specs::scalar_congruent_nat
(declare-fun curve25519_dalek!specs.scalar_specs.scalar_congruent_nat.? (Poly Poly)
 Bool
)

;; Function-Decl curve25519_dalek::scalar::impl&%50::ZERO
(declare-fun curve25519_dalek!scalar.impl&%50.ZERO.? () curve25519_dalek!scalar.Scalar.)

;; Function-Decl curve25519_dalek::scalar::impl&%50::ONE
(declare-fun curve25519_dalek!scalar.impl&%50.ONE.? () curve25519_dalek!scalar.Scalar.)
...
(assert
 (=>
  ...
  (forall ((T&. Dcr) (T& Type) (slice! Poly)) (!
    ...
    :pattern ((vstd!slice.spec_slice_len.? T&. T& slice!))
    :qid user_vstd__slice__axiom_spec_len_12
    :skolemid skolem_user_vstd__slice__axiom_spec_len_12
))))
...
(assert
 (=>
  ...
  (forall ((T&. Dcr) (T& Type) (a1! Poly) (a2! Poly)) (!
    ...
    :qid user_vstd__slice__axiom_slice_ext_equal_14
...
(assert
 (=>
  ...
  (forall ((T&. Dcr) (T& Type) (slice! Poly) (i! Poly)) (!
    ...
    :qid user_vstd__slice__axiom_slice_has_resolved_15
    :skolemid skolem_user_vstd__slice__axiom_slice_has_resolved_15
))))
...
(assert
 (=>
  ...
  (forall ((T&. Dcr) (T& Type) (N&. Dcr) (N& Type) (ar! Poly)) (!
    ...
    :qid user_vstd__array__array_len_matches_n_16
    :skolemid skolem_user_vstd__array__array_len_matches_n_16
))))
...
(assert
 (=>
  ...
  (forall ((T&. Dcr) (T& Type) (N&. Dcr) (N& Type) (a! Poly) (i! Poly)) (!
    ...
    :qid user_vstd__array__lemma_array_index_17
    :skolemid skolem_user_vstd__array__lemma_array_index_17
))))
...
(assert
 (=>
  ...
  (forall ((T&. Dcr) (T& Type) (N&. Dcr) (N& Type) (ar! Poly)) (!
    ...
    :pattern ((vstd!array.spec_array_as_slice.? T&. T& N&. N& ar!))
    :qid user_vstd__array__axiom_spec_array_as_slice_18
    :skolemid skolem_user_vstd__array__axiom_spec_array_as_slice_18
))))
...
(assert
 (=>
  ...
  (forall ((T&. Dcr) (T& Type) (a! Poly)) (!
    ...
    :pattern ((vstd!view.View.view.? $ (PTR T&. T&) a!))
    :qid user_vstd__raw_ptr__ptrs_mut_eq_sized_23
    :skolemid skolem_user_vstd__raw_ptr__ptrs_mut_eq_sized_23
))))
...
(assert
 (=>
  ...
  (forall ((range! Poly)) (!
    ...
    :qid user_vstd__std_specs__range__axiom_spec_range_next_u8_24
    :skolemid skolem_user_vstd__std_specs__range__axiom_spec_range_next_u8_24
))))
...
(assert
 (=>
  ...
  (forall ((range! Poly)) (!
    ...
    :qid user_vstd__std_specs__range__axiom_spec_range_next_u64_25
    :skolemid skolem_user_vstd__std_specs__range__axiom_spec_range_next_u64_25
))))
...
(assert
 (=>
  ...
  (forall ((range! Poly)) (!
    ...
    :qid user_vstd__std_specs__range__axiom_spec_range_next_usize_26
    :skolemid skolem_user_vstd__std_specs__range__axiom_spec_range_next_usize_26
))))
...
(assert
 (=>
  ...
  (forall ((x! Int) (m! Int)) (!
    ...
    :qid user_vstd__arithmetic__div_mod__lemma_mod_twice_27
    :skolemid skolem_user_vstd__arithmetic__div_mod__lemma_mod_twice_27
))))
...
(assert
 (=>
  ...
  (forall ((x! Int) (y! Int) (m! Int)) (!
    ...
    :qid user_vstd__arithmetic__div_mod__lemma_add_mod_noop_28
    :skolemid skolem_user_vstd__arithmetic__div_mod__lemma_add_mod_noop_28
))))
...
(assert
 (=>
  ...
  (forall ((x! Int) (m! Int)) (!
    ...
    :pattern ((EucMod x! m!))
    :qid user_vstd__arithmetic__div_mod__lemma_mod_bound_29
    :skolemid skolem_user_vstd__arithmetic__div_mod__lemma_mod_bound_29
))))
...
(assert
 (=>
  ...
  (forall ((x! Int) (y! Int) (m! Int)) (!
    ...
    :qid user_vstd__arithmetic__div_mod__lemma_mul_mod_noop_general_30
    :skolemid skolem_user_vstd__arithmetic__div_mod__lemma_mul_mod_noop_general_30
))))
  ...
  (forall ((niels! Poly)) (!
    (= (curve25519_dalek!specs.edwards_specs.is_valid_projective_niels_point.? niels!)
     (exists ((point$ Poly)) (!
       ...
       :qid user_curve25519_dalek__specs__edwards_specs__is_valid_projective_niels_point_33
       :skolemid skolem_user_curve25519_dalek__specs__edwards_specs__is_valid_projective_niels_point_33
    )))
  ...
  (forall ((niels! Poly)) (!
    (= (curve25519_dalek!specs.edwards_specs.is_valid_affine_niels_point.? niels!) (exists
      ((point$ Poly)) (!
       ...
       :qid user_curve25519_dalek__specs__edwards_specs__is_valid_affine_niels_point_34
       :skolemid skolem_user_curve25519_dalek__specs__edwards_specs__is_valid_affine_niels_point_34
    )))
  ...
  (forall ((N&. Dcr) (N& Type) (table! Poly) (basepoint! Poly) (size! Poly)) (!
    (= (curve25519_dalek!specs.window_specs.is_valid_lookup_table_affine_coords.? N&. N&
      ...
      (forall ((j$ Poly)) (!
        ...
        :qid user_curve25519_dalek__specs__window_specs__is_valid_lookup_table_affine_coords_35
        :skolemid skolem_user_curve25519_dalek__specs__window_specs__is_valid_lookup_table_affine_coords_35
    ))))
  ...
  (forall ((N&. Dcr) (N& Type) (table! Poly)) (!
    (= (curve25519_dalek!specs.window_specs.lookup_table_affine_limbs_bounded.? N&. N&
      table!
       ...
       :qid user_curve25519_dalek__specs__window_specs__lookup_table_affine_limbs_bounded_36
       :skolemid skolem_user_curve25519_dalek__specs__window_specs__lookup_table_affine_limbs_bounded_36
    )))
        ...
        (=>
         ...
         (and
          ...
          (forall ((j$ Poly)) (!
            ...
            :qid user_curve25519_dalek__specs__edwards_specs__is_valid_edwards_basepoint_table_37
            :skolemid skolem_user_curve25519_dalek__specs__edwards_specs__is_valid_edwards_basepoint_table_37
       )))))
 ...
 (=>
  ...
  (forall ((a! Poly)) (!
    (= (curve25519_dalek!specs.field_specs.is_square.? a!) (exists ((y$ Poly)) (!
       ...
       :qid user_curve25519_dalek__specs__field_specs__is_square_39
       :skolemid skolem_user_curve25519_dalek__specs__field_specs__is_square_39
    )))
 ...
 (forall ((%%hole%%0 Type) (%%hole%%1 Int) (%%hole%%2 Int)) (!
   (=>
    (exists ((y$ Poly)) (!
      ...
      :pattern ((curve25519_dalek!specs.field_specs.field_mul.? y$ y$))
      :qid user_curve25519_dalek__specs__field_specs__field_sqrt_40
      :skolemid skolem_user_curve25519_dalek__specs__field_specs__field_sqrt_40
    ))
    (exists ((y$ Poly)) (!
      (and
       (and
...
;; Function-Axioms curve25519_dalek::specs::scalar_specs::sum_of_scalars
(assert
 (fuel_bool_default fuel%curve25519_dalek!specs.scalar_specs.sum_of_scalars.)
)
(declare-const fuel_nat%curve25519_dalek!specs.scalar_specs.sum_of_scalars. Fuel)
(assert
 (forall ((scalars! Poly) (fuel% Fuel)) (!
   (= (curve25519_dalek!specs.scalar_specs.rec%sum_of_scalars.? scalars! fuel%) (curve25519_dalek!specs.scalar_specs.rec%sum_of_scalars.?
     scalars! zero
   ))
   :pattern ((curve25519_dalek!specs.scalar_specs.rec%sum_of_scalars.? scalars! fuel%))
   :qid internal_curve25519_dalek!specs.scalar_specs.sum_of_scalars._fuel_to_zero_definition
   :skolemid skolem_internal_curve25519_dalek!specs.scalar_specs.sum_of_scalars._fuel_to_zero_definition
)))
(assert
 (forall ((scalars! Poly) (fuel% Fuel)) (!
   (=>
    (has_type scalars! (TYPE%vstd!seq.Seq. $ TYPE%curve25519_dalek!scalar.Scalar.))
    (= (curve25519_dalek!specs.scalar_specs.rec%sum_of_scalars.? scalars! (succ fuel%))
     (ite
      (= (vstd!seq.Seq.len.? $ TYPE%curve25519_dalek!scalar.Scalar. scalars!) 0)
      0
      (let
       ((last$ (Sub (vstd!seq.Seq.len.? $ TYPE%curve25519_dalek!scalar.Scalar. scalars!) 1)))
       (curve25519_dalek!specs.scalar52_specs.group_canonical.? (I (nClip (Add (curve25519_dalek!specs.scalar_specs.rec%sum_of_scalars.?
            (vstd!seq.Seq.subrange.? $ TYPE%curve25519_dalek!scalar.Scalar. scalars! (I 0) (I last$))
            fuel%
           ) (curve25519_dalek!specs.scalar_specs.scalar_as_nat.? (vstd!seq.Seq.index.? $ TYPE%curve25519_dalek!scalar.Scalar.
             scalars! (I last$)
   ))))))))))
   :pattern ((curve25519_dalek!specs.scalar_specs.rec%sum_of_scalars.? scalars! (succ fuel%)))
   :qid internal_curve25519_dalek!specs.scalar_specs.sum_of_scalars._fuel_to_body_definition
   :skolemid skolem_internal_curve25519_dalek!specs.scalar_specs.sum_of_scalars._fuel_to_body_definition
)))
(assert
 (=>
  (fuel_bool fuel%curve25519_dalek!specs.scalar_specs.sum_of_scalars.)
  (forall ((scalars! Poly)) (!
    (=>
     (has_type scalars! (TYPE%vstd!seq.Seq. $ TYPE%curve25519_dalek!scalar.Scalar.))
     (= (curve25519_dalek!specs.scalar_specs.sum_of_scalars.? scalars!) (curve25519_dalek!specs.scalar_specs.rec%sum_of_scalars.?
       scalars! (succ fuel_nat%curve25519_dalek!specs.scalar_specs.sum_of_scalars.)
    )))
    :pattern ((curve25519_dalek!specs.scalar_specs.sum_of_scalars.? scalars!))
    :qid internal_curve25519_dalek!specs.scalar_specs.sum_of_scalars.?_definition
    :skolemid skolem_internal_curve25519_dalek!specs.scalar_specs.sum_of_scalars.?_definition
))))
(assert
 (forall ((scalars! Poly)) (!
   (=>
    (has_type scalars! (TYPE%vstd!seq.Seq. $ TYPE%curve25519_dalek!scalar.Scalar.))
    (<= 0 (curve25519_dalek!specs.scalar_specs.sum_of_scalars.? scalars!))
   )
   :pattern ((curve25519_dalek!specs.scalar_specs.sum_of_scalars.? scalars!))
   :qid internal_curve25519_dalek!specs.scalar_specs.sum_of_scalars.?_pre_post_definition
   :skolemid skolem_internal_curve25519_dalek!specs.scalar_specs.sum_of_scalars.?_pre_post_definition
)))
(assert
 (forall ((scalars! Poly) (fuel% Fuel)) (!
   (=>
    (has_type scalars! (TYPE%vstd!seq.Seq. $ TYPE%curve25519_dalek!scalar.Scalar.))
    (<= 0 (curve25519_dalek!specs.scalar_specs.rec%sum_of_scalars.? scalars! fuel%))
   )
   :pattern ((curve25519_dalek!specs.scalar_specs.rec%sum_of_scalars.? scalars! fuel%))
   :qid internal_curve25519_dalek!specs.scalar_specs.rec__sum_of_scalars.?_pre_post_rec_definition
   :skolemid skolem_internal_curve25519_dalek!specs.scalar_specs.rec__sum_of_scalars.?_pre_post_rec_definition
)))

;; Function-Axioms curve25519_dalek::specs::scalar_specs::scalar_congruent_nat
(assert
 (fuel_bool_default fuel%curve25519_dalek!specs.scalar_specs.scalar_congruent_nat.)
)
(assert
 (=>
  (fuel_bool fuel%curve25519_dalek!specs.scalar_specs.scalar_congruent_nat.)
  (forall ((s! Poly) (n! Poly)) (!
    (= (curve25519_dalek!specs.scalar_specs.scalar_congruent_nat.? s! n!) (= (curve25519_dalek!specs.scalar_specs.scalar_as_canonical.?
       s!
      ) (curve25519_dalek!specs.scalar52_specs.group_canonical.? n!)
    ))
    :pattern ((curve25519_dalek!specs.scalar_specs.scalar_congruent_nat.? s! n!))
    :qid internal_curve25519_dalek!specs.scalar_specs.scalar_congruent_nat.?_definition
    :skolemid skolem_internal_curve25519_dalek!specs.scalar_specs.scalar_congruent_nat.?_definition
))))
...
;; Function-Axioms curve25519_dalek::scalar::impl&%50::ZERO
(assert
 (fuel_bool_default fuel%curve25519_dalek!scalar.impl&%50.ZERO.)
)
...
(assert
 (=>
  (fuel_bool fuel%curve25519_dalek!scalar.impl&%50.ZERO.)
  (= curve25519_dalek!scalar.impl&%50.ZERO.? (curve25519_dalek!scalar.Scalar./Scalar
    (%Poly%array%. (array_new $ (UINT 8) 32 (%%array%%1 (I 0) (I 0) (I 0) (I 0) (I 0) (I
        0
...
(assert
 (has_type (Poly%curve25519_dalek!scalar.Scalar. curve25519_dalek!scalar.impl&%50.ZERO.?)
  TYPE%curve25519_dalek!scalar.Scalar.
))

;; Function-Axioms curve25519_dalek::scalar::impl&%50::ONE
(assert
 (fuel_bool_default fuel%curve25519_dalek!scalar.impl&%50.ONE.)
)
(assert
 (=>
  (fuel_bool fuel%curve25519_dalek!scalar.impl&%50.ONE.)
  (= curve25519_dalek!scalar.impl&%50.ONE.? (curve25519_dalek!scalar.Scalar./Scalar (
     %Poly%array%. (array_new $ (UINT 8) 32 (%%array%%1 (I 1) (I 0) (I 0) (I 0) (I 0) (I
        0
       ) (I 0) (I 0) (I 0) (I 0) (I 0) (I 0) (I 0) (I 0) (I 0) (I 0) (I 0) (I 0) (I 0) (
        I 0
       ) (I 0) (I 0) (I 0) (I 0) (I 0) (I 0) (I 0) (I 0) (I 0) (I 0) (I 0) (I 0)
...
(assert
 (has_type (Poly%curve25519_dalek!scalar.Scalar. curve25519_dalek!scalar.impl&%50.ONE.?)
  TYPE%curve25519_dalek!scalar.Scalar.
))
...
;; Function-Specs curve25519_dalek::scalar_helpers::lemma_u8_32_as_nat_zero
(declare-fun ens%curve25519_dalek!scalar_helpers.lemma_u8_32_as_nat_zero. (Int) Bool)
(assert
 (forall ((no%param Int)) (!
   (= (ens%curve25519_dalek!scalar_helpers.lemma_u8_32_as_nat_zero. no%param) (= (curve25519_dalek!specs.core_specs.u8_32_as_nat.?
      (Poly%array%. (curve25519_dalek!scalar.Scalar./Scalar/bytes (%Poly%curve25519_dalek!scalar.Scalar.
         (Poly%curve25519_dalek!scalar.Scalar. curve25519_dalek!scalar.impl&%50.ZERO.?)
      )))
     ) 0
   ))
   :pattern ((ens%curve25519_dalek!scalar_helpers.lemma_u8_32_as_nat_zero. no%param))
   :qid internal_ens__curve25519_dalek!scalar_helpers.lemma_u8_32_as_nat_zero._definition
   :skolemid skolem_internal_ens__curve25519_dalek!scalar_helpers.lemma_u8_32_as_nat_zero._definition
)))

;; Function-Specs curve25519_dalek::scalar_helpers::lemma_scalar_zero_properties
(declare-fun ens%curve25519_dalek!scalar_helpers.lemma_scalar_zero_properties. (Int)
 Bool
)
(assert
 (forall ((no%param Int)) (!
   (= (ens%curve25519_dalek!scalar_helpers.lemma_scalar_zero_properties. no%param) (and
     (= (curve25519_dalek!specs.scalar_specs.scalar_as_nat.? (Poly%curve25519_dalek!scalar.Scalar.
        curve25519_dalek!scalar.impl&%50.ZERO.?
       )
      ) 0
     )
     (< (curve25519_dalek!specs.scalar_specs.scalar_as_nat.? (Poly%curve25519_dalek!scalar.Scalar.
     ...
     (curve25519_dalek!specs.scalar_specs.is_canonical_scalar.? (Poly%curve25519_dalek!scalar.Scalar.
       curve25519_dalek!scalar.impl&%50.ZERO.?
     ))
     (curve25519_dalek!specs.scalar_specs.scalar_congruent_nat.? (Poly%curve25519_dalek!scalar.Scalar.
       curve25519_dalek!scalar.impl&%50.ZERO.?
      ) (I 0)
   )))
   :pattern ((ens%curve25519_dalek!scalar_helpers.lemma_scalar_zero_properties. no%param))
   :qid internal_ens__curve25519_dalek!scalar_helpers.lemma_scalar_zero_properties._definition
   :skolemid skolem_internal_ens__curve25519_dalek!scalar_helpers.lemma_scalar_zero_properties._definition
)))
...
;; Trait-Impl-Axiom
(assert
 (tr_bound%core!clone.Clone. $ TYPE%curve25519_dalek!edwards.EdwardsBasepointTable.)
)
...
;; Trait-Impl-Axiom
(assert
 (tr_bound%core!clone.Clone. $ TYPE%curve25519_dalek!ristretto.RistrettoPoint.)
)

;; Trait-Impl-Axiom
(assert
 (tr_bound%core!cmp.PartialEq. $ TYPE%curve25519_dalek!ristretto.RistrettoPoint. $
  TYPE%curve25519_dalek!ristretto.RistrettoPoint.
))
...
;; Trait-Impl-Axiom
(assert
 (tr_bound%core!clone.Clone. $ TYPE%curve25519_dalek!ristretto.RistrettoBasepointTable.)
)
...
;; Function-Specs curve25519_dalek::scalar_helpers::lemma_u8_32_as_nat_one
(declare-fun ens%curve25519_dalek!scalar_helpers.lemma_u8_32_as_nat_one. (Int) Bool)
(assert
 (forall ((no%param Int)) (!
   (= (ens%curve25519_dalek!scalar_helpers.lemma_u8_32_as_nat_one. no%param) (= (curve25519_dalek!specs.core_specs.u8_32_as_nat.?
      (Poly%array%. (curve25519_dalek!scalar.Scalar./Scalar/bytes (%Poly%curve25519_dalek!scalar.Scalar.
         (Poly%curve25519_dalek!scalar.Scalar. curve25519_dalek!scalar.impl&%50.ONE.?)
      )))
     ) 1
   ))
   :pattern ((ens%curve25519_dalek!scalar_helpers.lemma_u8_32_as_nat_one. no%param))
   :qid internal_ens__curve25519_dalek!scalar_helpers.lemma_u8_32_as_nat_one._definition
   :skolemid skolem_internal_ens__curve25519_dalek!scalar_helpers.lemma_u8_32_as_nat_one._definition
)))

;; Function-Specs curve25519_dalek::scalar_helpers::lemma_scalar_one_properties
(declare-fun ens%curve25519_dalek!scalar_helpers.lemma_scalar_one_properties. (Int)
 Bool
)
(assert
 (forall ((no%param Int)) (!
   (= (ens%curve25519_dalek!scalar_helpers.lemma_scalar_one_properties. no%param) (and
     (= (curve25519_dalek!specs.scalar_specs.scalar_as_nat.? (Poly%curve25519_dalek!scalar.Scalar.
        curve25519_dalek!scalar.impl&%50.ONE.?
       )
      ) 1
     )
     (< (curve25519_dalek!specs.scalar_specs.scalar_as_nat.? (Poly%curve25519_dalek!scalar.Scalar.
   ...
   :pattern ((ens%curve25519_dalek!scalar_helpers.lemma_scalar_one_properties. no%param))
   :qid internal_ens__curve25519_dalek!scalar_helpers.lemma_scalar_one_properties._definition
   :skolemid skolem_internal_ens__curve25519_dalek!scalar_helpers.lemma_scalar_one_properties._definition
)))

;; Function-Def curve25519_dalek::scalar_helpers::lemma_scalar_one_properties
;; curve25519-dalek/src/scalar_helpers.rs:67:1: 67:43 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (ens%curve25519_dalek!scalar_helpers.lemma_u8_32_as_nat_one. 0)
    (=>
     (= tmp%1 (curve25519_dalek!specs.scalar52_specs.group_order.? (I 0)))
     (and
      (=>
       %%location_label%%0
       (req%vstd!arithmetic.div_mod.lemma_small_mod. 1 tmp%1)
      )
      (=>
       (ens%vstd!arithmetic.div_mod.lemma_small_mod. 1 tmp%1)
       (and
        (=>
         %%location_label%%1
         (= (curve25519_dalek!specs.scalar_specs.scalar_as_nat.? (Poly%curve25519_dalek!scalar.Scalar.
