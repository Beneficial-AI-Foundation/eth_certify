...
;; curve25519-dalek/src/lemmas/edwards_lemmas/mul_base_lemmas.rs:975:1: 975:89 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::mul_base_lemmas::lemma_odd_sum_up_to_canonical
;; curve25519-dalek/src/lemmas/edwards_lemmas/mul_base_lemmas.rs:975:1: 975:89 (#0)
(get-info :all-statistics)
(push)
 (declare-const digits! vstd!seq.Seq<i8.>.)
 (declare-const upper_i! Int)
             ...
             (and
              (=>
               ...
               (check_decrease_int (let
                 ((digits!$0 digits!) (upper_i!$1 i@) (B!$2 B!))
                 upper_i!$1
               ...
               (=>
                ...
                (=>
                 ...
                 (=>
                  ...
                  (=>
                   (= tmp%1 (curve25519_dalek!specs.edwards_specs.pow256.? (I (nClip (EucDiv i@ 2)))))
                   (and
                    (=>
                     %%location_label%%2
                     (req%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_edwards_scalar_mul_canonical.
                    ...
                    (=>
                     ...
                     (=>
                      ...
                      (=>
                       (= tmp%2 (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I i@))))
                       (and
                        (=>
                         %%location_label%%3
                         (req%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_edwards_scalar_mul_signed_canonical.
                        ...
                        (=>
                         ...
                         (=>
                          (= tmp%3 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. prev@)))))
                          (=>
                           (= tmp%4 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. prev@)))))
                           (=>
                            (= tmp%5 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. term@)))))
                            (=>
                             (= tmp%6 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. term@)))))
                             (=>
                              (ens%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_edwards_add_canonical.
