...
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_ratio_lemmas.rs:732:1: 732:55 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::sqrt_ratio_lemmas::lemma_uv7_nonzero
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_ratio_lemmas.rs:732:1: 732:55 (#0)
  ...
  (not (=>
    ...
    (=>
     ...
     (and
      (=>
       %%location_label%%0
       (req%vstd!arithmetic.div_mod.lemma_small_mod. v_nat! pn@)
      )
      (=>
       (ens%vstd!arithmetic.div_mod.lemma_small_mod. v_nat! pn@)
       (and
        (=>
         %%location_label%%1
        ...
        (=>
         ...
         (=>
          (= v_sq@ (curve25519_dalek!specs.field_specs.field_square.? (I v_nat!)))
          (and
           (and
            (=>
             %%location_label%%2
            ...
            (=>
             ...
             (and
              (=>
               %%location_label%%3
               (req%vstd!arithmetic.div_mod.lemma_mod_bound. v_sq@ pn@)
              )
              (=>
               (ens%vstd!arithmetic.div_mod.lemma_mod_bound. v_sq@ pn@)
               (and
                (=>
                 %%location_label%%4
                 (req%vstd!arithmetic.div_mod.lemma_small_mod. v_sq@ pn@)
                )
                (=>
                 (ens%vstd!arithmetic.div_mod.lemma_small_mod. v_sq@ pn@)
                 (=>
                  %%location_label%%5
                  (not (= (EucMod v_sq@ pn@) 0))
           )))))))
           (=>
            (not (= (EucMod v_sq@ pn@) 0))
            (=>
             (= v3@ (curve25519_dalek!specs.field_specs.field_mul.? (I v_sq@) (I v_nat!)))
             (and
              (and
               (=>
                %%location_label%%6
               ...
               (=>
                ...
                (and
                 (=>
                  %%location_label%%7
                  (req%vstd!arithmetic.div_mod.lemma_mod_bound. v3@ pn@)
                 )
                 (=>
                  (ens%vstd!arithmetic.div_mod.lemma_mod_bound. v3@ pn@)
                  (and
                   (=>
                    %%location_label%%8
                    (req%vstd!arithmetic.div_mod.lemma_small_mod. v3@ pn@)
                   )
                   (=>
                    (ens%vstd!arithmetic.div_mod.lemma_small_mod. v3@ pn@)
                    (=>
                     %%location_label%%9
                     (not (= (EucMod v3@ pn@) 0))
              )))))))
                 ...
                 (and
                  ...
                  (=>
                   ...
                   (and
                    (=>
                     %%location_label%%11
                     (req%vstd!arithmetic.div_mod.lemma_mod_bound. v3_sq@ pn@)
                    )
                    (=>
                     (ens%vstd!arithmetic.div_mod.lemma_mod_bound. v3_sq@ pn@)
                     (and
                      (=>
                       %%location_label%%12
                       (req%vstd!arithmetic.div_mod.lemma_small_mod. v3_sq@ pn@)
                      )
                      (=>
                       (ens%vstd!arithmetic.div_mod.lemma_small_mod. v3_sq@ pn@)
                       (=>
                        %%location_label%%13
                        (not (= (EucMod v3_sq@ pn@) 0))
                 )))))))
                 (=>
                  (not (= (EucMod v3_sq@ pn@) 0))
                  (=>
                   (= v7@ (curve25519_dalek!specs.field_specs.field_mul.? (I v3_sq@) (I v_nat!)))
                   (and
                    (and
                     (=>
                      %%location_label%%14
                     ...
                     (=>
                      ...
                      (and
                       (=>
                        %%location_label%%15
                        (req%vstd!arithmetic.div_mod.lemma_mod_bound. v7@ pn@)
                       )
                       (=>
                        (ens%vstd!arithmetic.div_mod.lemma_mod_bound. v7@ pn@)
                        (and
                         (=>
                          %%location_label%%16
                          (req%vstd!arithmetic.div_mod.lemma_small_mod. v7@ pn@)
                         )
                         (=>
                          (ens%vstd!arithmetic.div_mod.lemma_small_mod. v7@ pn@)
                          (=>
                           %%location_label%%17
                           (not (= (EucMod v7@ pn@) 0))
                    )))))))
                       ...
                       (and
                        ...
                        (=>
                         ...
                         (and
                          (=>
                           %%location_label%%19
                           (req%vstd!arithmetic.div_mod.lemma_mod_bound. w@ pn@)
                          )
                          (=>
                           (ens%vstd!arithmetic.div_mod.lemma_mod_bound. w@ pn@)
                           (and
                            (=>
                             %%location_label%%20
                             (req%vstd!arithmetic.div_mod.lemma_small_mod. w@ pn@)
                            )
                            (=>
                             (ens%vstd!arithmetic.div_mod.lemma_small_mod. w@ pn@)
                             (=>
                              %%location_label%%21
                              (not (= (EucMod w@ pn@) 0))
                       )))))))
