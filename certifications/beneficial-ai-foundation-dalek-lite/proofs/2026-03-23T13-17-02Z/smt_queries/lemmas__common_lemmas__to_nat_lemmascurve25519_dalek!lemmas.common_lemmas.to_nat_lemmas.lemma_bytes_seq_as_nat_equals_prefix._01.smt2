...
;; curve25519-dalek/src/lemmas/common_lemmas/to_nat_lemmas.rs:142:1: 142:64 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::to_nat_lemmas::lemma_bytes_seq_as_nat_equals_prefix
;; curve25519-dalek/src/lemmas/common_lemmas/to_nat_lemmas.rs:142:1: 142:64 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= decrease%init0 (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. seq!)))
    (=>
     (= goal@ (= (curve25519_dalek!specs.core_specs.bytes_seq_as_nat.? (Poly%vstd!seq.Seq<u8.>.
         seq!
        )
       ) (curve25519_dalek!specs.core_specs.bytes_as_nat_prefix.? (Poly%vstd!seq.Seq<u8.>.
         seq!
     ...
     (and
      (or
       (and
        ...
        (=>
         (not (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. seq!)) 0))
         (=>
          ...
          (and
           (and
            ...
            (=>
             ...
             (=>
              %%location_label%%1
              (= (curve25519_dalek!specs.core_specs.bytes_seq_as_nat.? (Poly%vstd!seq.Seq<u8.>. tail@))
               (curve25519_dalek!specs.core_specs.bytes_as_nat_prefix.? (Poly%vstd!seq.Seq<u8.>. tail@)
                (I (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. tail@)))
           )))))
           (=>
            (= (curve25519_dalek!specs.core_specs.bytes_seq_as_nat.? (Poly%vstd!seq.Seq<u8.>. tail@))
             (curve25519_dalek!specs.core_specs.bytes_as_nat_prefix.? (Poly%vstd!seq.Seq<u8.>. tail@)
            ...
            (and
             (=>
              (= tmp%1 (nClip (Sub (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. seq!))
                 1
              )))
              (and
               (=>
               ...
               (=>
                ...
                (=>
                 ...
                 (=>
                  %%location_label%%3
                  (= (nClip (Add (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. seq!) (I 0)))
                     (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 8)) (curve25519_dalek!specs.core_specs.bytes_as_nat_prefix.?
                        (Poly%vstd!seq.Seq<u8.>. tail@) (I (nClip (Sub (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>.
                             seq!
                            )
                           ) 1
                    )))))))
      ...
      (=>
       ...
       (=>
        %%location_label%%5
        (= (curve25519_dalek!specs.core_specs.bytes_seq_as_nat.? (Poly%vstd!seq.Seq<u8.>. seq!))
         (curve25519_dalek!specs.core_specs.bytes_as_nat_prefix.? (Poly%vstd!seq.Seq<u8.>. seq!)
          (I (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. seq!)))
 )))))))))
 (get-info :version)
