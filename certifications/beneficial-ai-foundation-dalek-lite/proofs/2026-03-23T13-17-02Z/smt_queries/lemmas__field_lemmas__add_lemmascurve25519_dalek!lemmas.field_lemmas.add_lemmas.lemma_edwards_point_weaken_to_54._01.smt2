...
;; curve25519-dalek/src/lemmas/field_lemmas/add_lemmas.rs:142:1: 142:75 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::add_lemmas::lemma_edwards_point_weaken_to_54
;; curve25519-dalek/src/lemmas/field_lemmas/add_lemmas.rs:142:1: 142:75 (#0)
...
(push)
 ...
 (assert
  (not (=>
    ...
    (=>
     (= tmp%1 (curve25519_dalek!edwards.EdwardsPoint./EdwardsPoint/X (%Poly%curve25519_dalek!edwards.EdwardsPoint.
        (Poly%curve25519_dalek!edwards.EdwardsPoint. point!)
     )))
     (and
      (=>
      ...
      (=>
       ...
       (=>
        (= tmp%2 (curve25519_dalek!edwards.EdwardsPoint./EdwardsPoint/Y (%Poly%curve25519_dalek!edwards.EdwardsPoint.
           (Poly%curve25519_dalek!edwards.EdwardsPoint. point!)
        )))
        (and
         (=>
         ...
         (=>
          ...
          (=>
           (= tmp%3 (curve25519_dalek!edwards.EdwardsPoint./EdwardsPoint/Z (%Poly%curve25519_dalek!edwards.EdwardsPoint.
              (Poly%curve25519_dalek!edwards.EdwardsPoint. point!)
           )))
           (and
            (=>
            ...
            (=>
             ...
             (=>
              (= tmp%4 (curve25519_dalek!edwards.EdwardsPoint./EdwardsPoint/T (%Poly%curve25519_dalek!edwards.EdwardsPoint.
                 (Poly%curve25519_dalek!edwards.EdwardsPoint. point!)
              )))
              (and
               (=>
