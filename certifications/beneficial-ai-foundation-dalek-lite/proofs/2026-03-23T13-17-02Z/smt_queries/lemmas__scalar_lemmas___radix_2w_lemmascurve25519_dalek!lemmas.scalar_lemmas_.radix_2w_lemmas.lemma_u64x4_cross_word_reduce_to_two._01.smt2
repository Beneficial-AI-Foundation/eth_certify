...
;; curve25519-dalek/src/lemmas/scalar_lemmas_/radix_2w_lemmas.rs:478:7: 483:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::scalar_lemmas_::radix_2w_lemmas::lemma_u64x4_cross_word_reduce_to_two
;; curve25519-dalek/src/lemmas/scalar_lemmas_/radix_2w_lemmas.rs:478:7: 483:2 (#0)
...
(push)
 ...
 (declare-const w1i@ Int)
 (declare-const w2i@ Int)
 (declare-const w3i@ Int)
 ...
 (declare-const shifted_val@ Int)
 (declare-const biw_local@ Int)
 (declare-const r128@ Int)
 (declare-const w3i$1@ Int)
 (declare-const tmp%15 Int)
 (declare-const tmp%16 Int)
 (declare-const p128@ Int)
 (declare-const w2i$1@ Int)
 (declare-const w3i$2@ Int)
 ...
 (declare-const two_val@ Int)
 (declare-const bit_off_nat@ Int)
 (declare-const biw_total@ Int)
 (assert
  fuel_defaults
 )
 (assert
 ...
 (assert
  (not (=>
    (= val@ (curve25519_dalek!specs.scalar_specs.u64_4_as_nat.? (Poly%array%. words!)))
    (=>
     (= base@ (nClip (Mul u64_idx! 64)))
     (=>
      (= two_val@ (nClip (Add (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $
      ...
      (=>
       (= bit_off_nat@ (nClip (Add base@ bit_idx_nat!)))
       (=>
        (= biw_total@ (nClip (Add bit_off_nat@ w_nat!)))
        (=>
         (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_div_mod. val@ bit_off_nat@
          w_nat!
         )
         (=>
          (ens%vstd!arithmetic.power2.lemma_pow2_pos. bit_idx_nat!)
          (or
           (and
            (=>
             (= u64_idx! 0)
             (and
              ...
              (=>
               ...
               (=>
                (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_div_mod. two_val@
                 bit_idx_nat! w_nat!
                )
                %%switch_label%%0
            ))))
               ...
               (=>
                ...
                (and
                 ...
                 (=>
                  ...
                  (=>
                   (ens%vstd!arithmetic.power2.lemma_pow2_pos. 64)
                   (=>
                    (ens%vstd!arithmetic.power2.lemma_pow2_adds. 64 64)
                    (=>
                     (ens%vstd!arithmetic.power2.lemma_pow2_adds. 128 64)
                     (=>
                      (= shifted_val@ (nClip (Add (nClip (Add (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                              $ (ARRAY $ (UINT 64) $ (CONST_INT 4)) (Poly%array%. words!)
                             ) (I 1)
                            )
                           ) (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (
                      ...
                      (and
                       (=>
                        (= p64@ (vstd!arithmetic.power2.pow2.? (I 64)))
                        (=>
                         (= w1i@ (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64)
                              $ (CONST_INT 4)
                             ) (Poly%array%. words!)
                            ) (I 1)
                         )))
                         (=>
                          (= w2i@ (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64)
                               $ (CONST_INT 4)
                              ) (Poly%array%. words!)
                             ) (I 2)
                          )))
                          (=>
                           (= w3i@ (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64)
                                $ (CONST_INT 4)
                               ) (Poly%array%. words!)
                              ) (I 3)
                           )))
                           (and
                            (=>
                             (ens%vstd!arithmetic.mul.lemma_mul_is_associative. w2i@ p64@ p64@)
                             (=>
                              %%location_label%%2
                              (= (Mul w2i@ (vstd!arithmetic.power2.pow2.? (I 128))) (Mul (Mul w2i@ p64@) p64@))
                            ))
                            (=>
                             (= (Mul w2i@ (vstd!arithmetic.power2.pow2.? (I 128))) (Mul (Mul w2i@ p64@) p64@))
                             (and
                              (=>
                               (= tmp%1 (vstd!arithmetic.power2.pow2.? (I 128)))
                               (=>
                                (ens%vstd!arithmetic.mul.lemma_mul_is_associative. w3i@ tmp%1 p64@)
                                (=>
                                 (= tmp%2 (vstd!arithmetic.power2.pow2.? (I 128)))
                                 (=>
                                  (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. tmp%2 p64@)
                                  (=>
                                   %%location_label%%3
                                   (= (Mul w3i@ (vstd!arithmetic.power2.pow2.? (I 192))) (Mul (Mul w3i@ (vstd!arithmetic.power2.pow2.?
                                       (I 128)
                                      )
                                     ) p64@
                              )))))))
                              (=>
                               ...
                               (=>
                                (= tmp%3 (Add (Mul w2i@ p64@) (Mul w3i@ (vstd!arithmetic.power2.pow2.? (I 128)))))
                                (=>
                                 (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. p64@ w1i@ tmp%3)
                                 (=>
                                  (= tmp%4 (Mul w2i@ p64@))
                                  (=>
                                   (= tmp%5 (Mul w3i@ (vstd!arithmetic.power2.pow2.? (I 128))))
                                   (=>
                                    (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. p64@ tmp%4 tmp%5)
                                    (=>
                                     %%location_label%%4
                                     (= val@ (Add (Mul shifted_val@ (vstd!arithmetic.power2.pow2.? (I 64))) (%I (vstd!seq.Seq.index.?
                       ...
                       (=>
                        ...
                        (=>
                         (= tmp%6 (vstd!arithmetic.power2.pow2.? (I 64)))
                         (=>
                          ...
                          (and
                           (=>
                            %%location_label%%5
                            (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod_converse_div. val@ tmp%6 shifted_val@
                             tmp%7
                           ))
                           (=>
                            (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod_converse_div. val@ tmp%6 shifted_val@
                             tmp%7
                            )
                            (=>
                             (= biw_local@ (nClip (Add bit_idx_nat! w_nat!)))
                             (=>
                              (ens%vstd!arithmetic.power2.lemma_pow2_pos. biw_local@)
                              (=>
                               (= tmp%8 (nClip (Sub 128 biw_local@)))
                               (=>
                                (ens%vstd!arithmetic.power2.lemma_pow2_adds. biw_local@ tmp%8)
                                (=>
                                 (= r128@ (vstd!arithmetic.power2.pow2.? (I (nClip (Sub 128 biw_local@)))))
                                 (=>
                                  (= w3i$1@ (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT
                                        64
                                       ) $ (CONST_INT 4)
                                      ) (Poly%array%. words!)
                                     ) (I 3)
                                  ...
                                  (and
                                   (=>
                                    (= tmp%9 (vstd!arithmetic.power2.pow2.? (I biw_local@)))
                                    (=>
                                     (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. tmp%9 r128@)
                                     (=>
                                      (= tmp%10 (vstd!arithmetic.power2.pow2.? (I biw_local@)))
                                      (=>
                                       (ens%vstd!arithmetic.mul.lemma_mul_is_associative. w3i$1@ r128@ tmp%10)
                                       (=>
                                        %%location_label%%6
                                        (= (Mul w3i$1@ (vstd!arithmetic.power2.pow2.? (I 128))) (Mul (Mul w3i$1@ r128@) (vstd!arithmetic.power2.pow2.?
                                           (I biw_local@)
                                   ))))))))
                                   (=>
                                    (= (Mul w3i$1@ (vstd!arithmetic.power2.pow2.? (I 128))) (Mul (Mul w3i$1@ r128@) (vstd!arithmetic.power2.pow2.?
                                    ...
                                    (=>
                                     (= tmp%11 (Mul w3i$1@ r128@))
                                     (=>
                                      (= tmp%12 (vstd!arithmetic.power2.pow2.? (I biw_local@)))
                                      (and
                                       (=>
                                        %%location_label%%7
                                        (req%curve25519_dalek!lemmas.common_lemmas.div_mod_lemmas.lemma_mod_sum_factor. tmp%11
                                         two_val@ tmp%12
                                       ))
                                       (=>
                                        (ens%curve25519_dalek!lemmas.common_lemmas.div_mod_lemmas.lemma_mod_sum_factor. tmp%11
                                         two_val@ tmp%12
                                        )
                                        (=>
                                         (ens%vstd!arithmetic.power2.lemma_pow2_adds. 64 bit_idx_nat!)
                                         (=>
                                          (= tmp%13 (vstd!arithmetic.power2.pow2.? (I 64)))
                                          (=>
                                           (= tmp%14 (vstd!arithmetic.power2.pow2.? (I bit_idx_nat!)))
                                           (and
                                            (=>
                                             %%location_label%%8
                                             (req%vstd!arithmetic.div_mod.lemma_div_denominator. val@ tmp%13 tmp%14)
                                            )
                                            (=>
                                             (ens%vstd!arithmetic.div_mod.lemma_div_denominator. val@ tmp%13 tmp%14)
                                             (=>
                                              (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_div_mod. two_val@
                                               bit_idx_nat! w_nat!
                                              )
                                              (=>
                                               (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_div_mod. shifted_val@
                                                bit_idx_nat! w_nat!
                                               )
                                               %%switch_label%%1
               ))))))))))))))))))))))))))))))))
               (=>
                ...
                (and
                 ...
                 (=>
                  ...
                  (=>
                   (ens%vstd!arithmetic.power2.lemma_pow2_pos. 128)
                   (=>
                    (ens%vstd!arithmetic.power2.lemma_pow2_adds. 64 128)
                    (and
                     (=>
                      (= p128@ (vstd!arithmetic.power2.pow2.? (I 128)))
                      (=>
                       (= w2i$1@ (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT
                             64
                            ) $ (CONST_INT 4)
                           ) (Poly%array%. words!)
                          ) (I 2)
                       ...
                       (=>
                        (= w3i$2@ (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT
                              64
                             ) $ (CONST_INT 4)
                            ) (Poly%array%. words!)
                           ) (I 3)
                        ...
                        (and
                         (=>
                          (= tmp%15 (vstd!arithmetic.power2.pow2.? (I 64)))
                          (=>
                           (ens%vstd!arithmetic.mul.lemma_mul_is_associative. w3i$2@ tmp%15 p128@)
                           (=>
                            %%location_label%%10
                            (= (Mul w3i$2@ (vstd!arithmetic.power2.pow2.? (I 192))) (Mul (Mul w3i$2@ (vstd!arithmetic.power2.pow2.?
                                (I 64)
                               )
                              ) p128@
                         )))))
                         (=>
                          ...
                          (=>
                           (= tmp%16 (Mul w3i$2@ (vstd!arithmetic.power2.pow2.? (I 64))))
                           (=>
                            (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. p128@ w2i$1@ tmp%16)
                            (=>
                             %%location_label%%11
                             (= val@ (Add (Mul two_val@ (vstd!arithmetic.power2.pow2.? (I 128))) (nClip (Add (%I (vstd!seq.Seq.index.?
                                   $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $ (CONST_INT 4)) (Poly%array%.
                                     words!
                                    )
                                   ) (I 0)
                     ...
                     (=>
                      ...
                      (=>
                       (= tmp%17 (vstd!arithmetic.power2.pow2.? (I 128)))
                       (=>
                        (= tmp%18 (nClip (Add (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY
                               $ (UINT 64) $ (CONST_INT 4)
                              ) (Poly%array%. words!)
                             ) (I 0)
                            )
                        ...
                        (and
                         (=>
                          %%location_label%%12
                          (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod_converse_div. val@ tmp%17 two_val@
                           tmp%18
                         ))
                         (=>
                          (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod_converse_div. val@ tmp%17 two_val@
                           tmp%18
                          )
                          (=>
                           (= tmp%19 (nClip (Add bit_idx_nat! w_nat!)))
                           (=>
                            (ens%vstd!arithmetic.power2.lemma_pow2_pos. tmp%19)
                            (=>
                             (= tmp%20 (vstd!arithmetic.power2.pow2.? (I (nClip (Add bit_idx_nat! w_nat!)))))
                             (and
                              (=>
                               %%location_label%%13
                               (req%curve25519_dalek!lemmas.common_lemmas.div_mod_lemmas.lemma_mod_sum_factor. 0
                                two_val@ tmp%20
                              ))
                              (=>
                               (ens%curve25519_dalek!lemmas.common_lemmas.div_mod_lemmas.lemma_mod_sum_factor. 0
                                two_val@ tmp%20
                               )
                               (=>
                                (ens%vstd!arithmetic.power2.lemma_pow2_adds. 128 bit_idx_nat!)
                                (=>
                                 (= tmp%21 (vstd!arithmetic.power2.pow2.? (I 128)))
                                 (=>
                                  (= tmp%22 (vstd!arithmetic.power2.pow2.? (I bit_idx_nat!)))
                                  (and
                                   (=>
                                    %%location_label%%14
                                    (req%vstd!arithmetic.div_mod.lemma_div_denominator. val@ tmp%21 tmp%22)
                                   )
                                   (=>
                                    (ens%vstd!arithmetic.div_mod.lemma_div_denominator. val@ tmp%21 tmp%22)
                                    (=>
                                     (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_div_mod. two_val@
                                      bit_idx_nat! w_nat!
                                     )
                                     (=>
                                      (= tmp%23 (EucDiv val@ (vstd!arithmetic.power2.pow2.? (I 128))))
                                      (=>
                                       (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_div_mod. tmp%23 bit_idx_nat!
                                        w_nat!
                                       )
                                       %%switch_label%%1
              )))))))))))))))))))))))))
