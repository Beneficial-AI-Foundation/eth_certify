...
;; MODULE 'module lemmas::scalar_montgomery_lemmas'
;; curve25519-dalek/src/lemmas/scalar_montgomery_lemmas.rs:32:5: 32:11 (#0)
...
(assert
 (distinct fuel%vstd!array.array_view. fuel%vstd!array.impl&%0.view. fuel%vstd!array.impl&%2.spec_index.
  ...
  fuel%vstd!view.impl&%32.view. fuel%curve25519_dalek!specs.scalar52_specs.seq_as_nat_52.
  ...
  fuel%curve25519_dalek!specs.scalar52_specs.limbs_bounded. fuel%curve25519_dalek!specs.scalar52_specs.limb_prod_bounded_u128.
  fuel%curve25519_dalek!specs.scalar52_specs.spec_mul_internal. fuel%vstd!array.group_array_axioms.
 ...
 (=>
  ...
  (forall ((s! Poly)) (!
    (= (curve25519_dalek!specs.scalar52_specs.limbs_bounded.? s!) (forall ((i$ Poly)) (
       ...
       :qid user_curve25519_dalek__specs__scalar52_specs__limbs_bounded_23
       :skolemid skolem_user_curve25519_dalek__specs__scalar52_specs__limbs_bounded_23
    )))
  ...
  (forall ((limbs1! Poly) (limbs2! Poly) (k! Poly)) (!
    (= (curve25519_dalek!specs.scalar52_specs.limb_prod_bounded_u128.? limbs1! limbs2!
      k!
       ...
       :qid user_curve25519_dalek__specs__scalar52_specs__limb_prod_bounded_u128_24
       :skolemid skolem_user_curve25519_dalek__specs__scalar52_specs__limb_prod_bounded_u128_24
    )))
...
(declare-fun %%array%%0 (Poly Poly Poly Poly Poly Poly Poly Poly Poly) %%Function%%)
(assert
 ...
 (=>
  ...
  (forall ((a! Poly) (b! Poly)) (!
    (= (curve25519_dalek!specs.scalar52_specs.spec_mul_internal.? a! b!) (%Poly%array%.
      (array_new $ (UINT 128) 9 (%%array%%0 (I (uClip 128 (Mul (uClip 128 (%I (vstd!seq.Seq.index.?
 ...
 (forall ((one! curve25519_dalek!backend.serial.u64.scalar.Scalar52.)) (!
   (= (req%curve25519_dalek!lemmas.scalar_lemmas.lemma_one_bounded. one!) (=>
     ...
     (= one! (curve25519_dalek!backend.serial.u64.scalar.Scalar52./Scalar52 (%Poly%array%.
        (array_new $ (UINT 64) 5 (%%array%%1 (I 1) (I 0) (I 0) (I 0) (I 0)))
   )))))
   ...
   (= (req%curve25519_dalek!lemmas.scalar_montgomery_lemmas.lemma_from_montgomery_is_product_with_one.
     ...
     (=>
      ...
      (forall ((j$ Poly)) (!
        ...
        :qid user_curve25519_dalek__lemmas__scalar_montgomery_lemmas__lemma_from_montgomery_is_product_with_one_25
        :skolemid skolem_user_curve25519_dalek__lemmas__scalar_montgomery_lemmas__lemma_from_montgomery_is_product_with_one_25
     )))
     (=>
      ...
      (forall ((j$ Poly)) (!
        ...
        :qid user_curve25519_dalek__lemmas__scalar_montgomery_lemmas__lemma_from_montgomery_is_product_with_one_26
        :skolemid skolem_user_curve25519_dalek__lemmas__scalar_montgomery_lemmas__lemma_from_montgomery_is_product_with_one_26
   )))))
...
;; Function-Def curve25519_dalek::lemmas::scalar_montgomery_lemmas::lemma_from_montgomery_is_product_with_one
;; curve25519-dalek/src/lemmas/scalar_montgomery_lemmas.rs:32:5: 32:11 (#0)
