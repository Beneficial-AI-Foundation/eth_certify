...
;; curve25519-dalek/src/lemmas/scalar_lemmas_/naf_lemmas.rs:122:7: 122:69 (#0)
...
;; Function-Def curve25519_dalek::lemmas::scalar_lemmas_::naf_lemmas::lemma_reconstruct_zero_extend
;; curve25519-dalek/src/lemmas/scalar_lemmas_/naf_lemmas.rs:122:7: 122:69 (#0)
...
(push)
 ...
 (assert
  (forall ((j$ Poly)) (!
    ...
    :pattern ((vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. naf!) j$))
    :qid user_curve25519_dalek__lemmas__scalar_lemmas___naf_lemmas__lemma_reconstruct_zero_extend_34
    :skolemid skolem_user_curve25519_dalek__lemmas__scalar_lemmas___naf_lemmas__lemma_reconstruct_zero_extend_34
 )))
       ...
       (=>
        ...
        (=>
         (= suffix@ (%Poly%vstd!seq.Seq<i8.>. (vstd!seq.Seq.subrange.? $ (SINT 8) (vstd!seq.Seq.subrange.?
             $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. naf!) (I 0) (I n!)
            ) (I nm1@) (I (vstd!seq.Seq.len.? $ (SINT 8) (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
                naf!
               ) (I 0) (I n!)
         ))))))
         (and
          (=>
           (= tmp%1 (= (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. suffix@)) 1))
           (and
            (=>
             %%location_label%%0
             tmp%1
            ...
            (=>
             tmp%1
             (=>
              (= tmp%2 (= (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. suffix@) (I 0))
                (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. naf!) (I nm1@))
              ))
              (and
               (=>
                %%location_label%%1
               ...
               (=>
                tmp%2
                (=>
                 (= tmp%3 (= (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. naf!) (I nm1@)))
                   0
                 ))
                 (and
                  (=>
                  ...
                  (=>
                   ...
                   (=>
                    (= tmp%4 (= (vstd!seq.Seq.len.? $ (SINT 8) (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
                         suffix@
                        ) (I 1) (I (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. suffix@)))
                       )
                      ) 0
                    ))
                    (and
                     ...
                     (=>
                      ...
                      (=>
                       (= tmp%5 (= (curve25519_dalek!specs.scalar_specs.reconstruct.? (vstd!seq.Seq.subrange.?
                           $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. suffix@) (I 1) (I (vstd!seq.Seq.len.? $ (SINT 8)
              ...
              (=>
               ...
               (=>
                (= tmp%7 (ext_eq false (TYPE%vstd!seq.Seq. $ (SINT 8)) (vstd!seq.Seq.subrange.? $ (SINT
                    8
                   ) (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. naf!) (I 0) (I n!))
                   (I 0) (I nm1@)
                  ) (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. naf!) (I 0) (I nm1@))
                ))
                (and
                 (=>
                  %%location_label%%7
                 ...
                 (=>
                  ...
                  (and
                   (=>
                    (= tmp%8 (vstd!arithmetic.power2.pow2.? (I nm1@)))
                    (=>
                     (ens%vstd!arithmetic.mul.lemma_mul_basics. tmp%8)
                     (=>
                      %%location_label%%8
                      (= (Mul (vstd!arithmetic.power2.pow2.? (I nm1@)) (curve25519_dalek!specs.scalar_specs.reconstruct.?
                         (Poly%vstd!seq.Seq<i8.>. suffix@)
                        )
                       ) 0
                   ))))
                   (=>
                    ...
                    (=>
                     ...
                     (= (curve25519_dalek!specs.scalar_specs.reconstruct.? (vstd!seq.Seq.subrange.? $ (SINT
                         ...
                         8
                        ) (Poly%vstd!seq.Seq<i8.>. naf!) (I 0) (I nm1@)
            ))))))))))))
            (=>
             (= (curve25519_dalek!specs.scalar_specs.reconstruct.? (vstd!seq.Seq.subrange.? $ (SINT
                 8
