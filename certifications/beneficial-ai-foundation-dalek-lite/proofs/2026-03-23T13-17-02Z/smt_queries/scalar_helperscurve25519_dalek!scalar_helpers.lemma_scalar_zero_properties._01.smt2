...
;; curve25519-dalek/src/scalar_helpers.rs:53:1: 53:44 (#0)
...
;; Function-Def curve25519_dalek::scalar_helpers::lemma_scalar_zero_properties
;; curve25519-dalek/src/scalar_helpers.rs:53:1: 53:44 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (ens%curve25519_dalek!scalar_helpers.lemma_u8_32_as_nat_zero. 0)
    (=>
     (= tmp%1 (curve25519_dalek!specs.scalar52_specs.group_order.? (I 0)))
     (and
      (=>
       %%location_label%%0
       (req%vstd!arithmetic.div_mod.lemma_small_mod. 0 tmp%1)
      )
      (=>
       (ens%vstd!arithmetic.div_mod.lemma_small_mod. 0 tmp%1)
       (=>
