...
;; curve25519-dalek/src/lemmas/field_lemmas/to_bytes_reduction_lemmas.rs:747:1: 747:44 (#0)
...
;; Function-Specs curve25519_dalek::lemmas::field_lemmas::to_bytes_reduction_lemmas::lemma_p_radix_representation
(declare-fun ens%curve25519_dalek!lemmas.field_lemmas.to_bytes_reduction_lemmas.lemma_p_radix_representation.
 (Int) Bool
)
(assert
 (forall ((no%param Int)) (!
   (= (ens%curve25519_dalek!lemmas.field_lemmas.to_bytes_reduction_lemmas.lemma_p_radix_representation.
     no%param
    ) (= (Add (Add (Add (Add (Sub (vstd!arithmetic.power2.pow2.? (I 51)) 19) (Mul (vstd!arithmetic.power2.pow2.?
           (I 51)
          ) (Sub (vstd!arithmetic.power2.pow2.? (I 51)) 1)
         )
        ) (Mul (vstd!arithmetic.power2.pow2.? (I 102)) (Sub (vstd!arithmetic.power2.pow2.? (
            I 51
           )
          ) 1
        ))
       ) (Mul (vstd!arithmetic.power2.pow2.? (I 153)) (Sub (vstd!arithmetic.power2.pow2.? (
           I 51
          )
         ) 1
       ))
      ) (Mul (vstd!arithmetic.power2.pow2.? (I 204)) (Sub (vstd!arithmetic.power2.pow2.? (
          I 51
         )
        ) 1
      ))
   ...
   :pattern ((ens%curve25519_dalek!lemmas.field_lemmas.to_bytes_reduction_lemmas.lemma_p_radix_representation.
     no%param
   ))
   :qid internal_ens__curve25519_dalek!lemmas.field_lemmas.to_bytes_reduction_lemmas.lemma_p_radix_representation._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.field_lemmas.to_bytes_reduction_lemmas.lemma_p_radix_representation._definition
)))

;; Function-Def curve25519_dalek::lemmas::field_lemmas::to_bytes_reduction_lemmas::lemma_p_radix_representation
;; curve25519-dalek/src/lemmas/field_lemmas/to_bytes_reduction_lemmas.rs:747:1: 747:44 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= r1@ (vstd!arithmetic.power2.pow2.? (I 51)))
    (=>
     (= r2@ (vstd!arithmetic.power2.pow2.? (I 102)))
     (=>
      (= r3@ (vstd!arithmetic.power2.pow2.? (I 153)))
      (=>
       (= r4@ (vstd!arithmetic.power2.pow2.? (I 204)))
       (=>
        (= r5@ (vstd!arithmetic.power2.pow2.? (I 255)))
        (and
         (and
          (and
           (=>
            (= tmp%1 (Sub r1@ 1))
            (=>
             (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. r1@ tmp%1)
             (=>
              %%location_label%%0
              (= (Mul r1@ (Sub r1@ 1)) (Mul (Sub r1@ 1) r1@))
           )))
           (=>
            (= (Mul r1@ (Sub r1@ 1)) (Mul (Sub r1@ 1) r1@))
            (and
             (=>
              (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub. r1@ r1@ 1)
              (=>
               %%location_label%%1
               (= (Mul (Sub r1@ 1) r1@) (Sub (nClip (Mul r1@ r1@)) (nClip (Mul r1@ 1))))
             ))
             (=>
              (= (Mul (Sub r1@ 1) r1@) (Sub (nClip (Mul r1@ r1@)) (nClip (Mul r1@ 1))))
              (and
               (=>
                ...
                (=>
                 (ens%vstd!arithmetic.mul.lemma_mul_basics. r1@)
                 (=>
                  (= tmp%2 (= (nClip (Mul r1@ r1@)) r2@))
                  (and
                   (=>
                    %%location_label%%2
                    tmp%2
                    ...
                    (=>
                     ...
                     (and
                      ...
                      (=>
                       ...
                       (=>
                        %%location_label%%4
                        (= (Sub (nClip (Mul r1@ r1@)) (nClip (Mul r1@ 1))) (Sub r2@ r1@))
               )))))))))
               (=>
                (= (Sub (nClip (Mul r1@ r1@)) (nClip (Mul r1@ 1))) (Sub r2@ r1@))
                (=>
                 %%location_label%%5
                 (= (Mul r1@ (Sub r1@ 1)) (Sub r2@ r1@))
          )))))))
          (=>
           (= (Mul r1@ (Sub r1@ 1)) (Sub r2@ r1@))
           (=>
            %%location_label%%6
            (= (Mul (vstd!arithmetic.power2.pow2.? (I 51)) (Sub (vstd!arithmetic.power2.pow2.? (I
                 51
                )
               ) 1
              )
         ...
         (=>
          ...
          (and
           (and
            (and
             (=>
              (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub. r2@ r1@ 1)
              (=>
               %%location_label%%7
               (= (Mul r2@ (Sub r1@ 1)) (Sub (nClip (Mul r2@ r1@)) (nClip (Mul r2@ 1))))
             ))
             (=>
              (= (Mul r2@ (Sub r1@ 1)) (Sub (nClip (Mul r2@ r1@)) (nClip (Mul r2@ 1))))
              (and
               (=>
                (ens%vstd!arithmetic.power2.lemma_pow2_adds. 102 51)
                (=>
                 (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. r2@ r1@)
                 (=>
                  (ens%vstd!arithmetic.mul.lemma_mul_basics. r2@)
                  (=>
                   (= tmp%4 (= (nClip (Mul r2@ r1@)) r3@))
                   (and
                    (=>
                     %%location_label%%8
                     tmp%4
                     ...
                     (=>
                      ...
                      (and
                       ...
                       (=>
                        ...
                        (=>
                         %%location_label%%10
                         (= (Sub (nClip (Mul r2@ r1@)) (nClip (Mul r2@ 1))) (Sub r3@ r2@))
               ))))))))))
               (=>
                (= (Sub (nClip (Mul r2@ r1@)) (nClip (Mul r2@ 1))) (Sub r3@ r2@))
                (=>
                 %%location_label%%11
                 (= (Mul r2@ (Sub r1@ 1)) (Sub r3@ r2@))
            )))))
            (=>
             (= (Mul r2@ (Sub r1@ 1)) (Sub r3@ r2@))
             (=>
           ...
           (=>
            ...
            (and
             (and
              (and
               (=>
                (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub. r3@ r1@ 1)
                (=>
                 %%location_label%%13
                 (= (Mul r3@ (Sub r1@ 1)) (Sub (nClip (Mul r3@ r1@)) (nClip (Mul r3@ 1))))
               ))
               (=>
                (= (Mul r3@ (Sub r1@ 1)) (Sub (nClip (Mul r3@ r1@)) (nClip (Mul r3@ 1))))
                (and
                 (=>
                  (ens%vstd!arithmetic.power2.lemma_pow2_adds. 153 51)
                  (=>
                   (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. r3@ r1@)
                   (=>
                    (ens%vstd!arithmetic.mul.lemma_mul_basics. r3@)
                    (=>
                     (= tmp%6 (= (nClip (Mul r3@ r1@)) r4@))
                     (and
                      (=>
                       %%location_label%%14
                       tmp%6
                       ...
                       (=>
                        ...
                        (and
                         ...
                         (=>
                          ...
                          (=>
                           %%location_label%%16
                           (= (Sub (nClip (Mul r3@ r1@)) (nClip (Mul r3@ 1))) (Sub r4@ r3@))
                 ))))))))))
                 (=>
                  (= (Sub (nClip (Mul r3@ r1@)) (nClip (Mul r3@ 1))) (Sub r4@ r3@))
                  (=>
                   %%location_label%%17
                   (= (Mul r3@ (Sub r1@ 1)) (Sub r4@ r3@))
              )))))
              (=>
               (= (Mul r3@ (Sub r1@ 1)) (Sub r4@ r3@))
               (=>
             ...
             (=>
              ...
              (and
               (and
                (and
                 (=>
                  (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub. r4@ r1@ 1)
                  (=>
                   %%location_label%%19
                   (= (Mul r4@ (Sub r1@ 1)) (Sub (nClip (Mul r4@ r1@)) (nClip (Mul r4@ 1))))
                 ))
                 (=>
                  (= (Mul r4@ (Sub r1@ 1)) (Sub (nClip (Mul r4@ r1@)) (nClip (Mul r4@ 1))))
                  (and
                   (=>
                    ...
                    (=>
                     (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. r4@ r1@)
                     (=>
                      (ens%vstd!arithmetic.mul.lemma_mul_basics. r4@)
                      (=>
                       (= tmp%8 (= (nClip (Mul r4@ r1@)) r5@))
                       (and
                        (=>
                         %%location_label%%20
                         tmp%8
                         ...
                         (=>
                          ...
                          (and
                           ...
                           (=>
                            ...
                            (=>
                             %%location_label%%22
                             (= (Sub (nClip (Mul r4@ r1@)) (nClip (Mul r4@ 1))) (Sub r5@ r4@))
                   ))))))))))
                   (=>
                    (= (Sub (nClip (Mul r4@ r1@)) (nClip (Mul r4@ 1))) (Sub r5@ r4@))
                    (=>
                     %%location_label%%23
                     (= (Mul r4@ (Sub r1@ 1)) (Sub r5@ r4@))
                )))))
                (=>
                 (= (Mul r4@ (Sub r1@ 1)) (Sub r5@ r4@))
                 (=>
               ...
               (=>
                ...
                (and
                 (and
                  (=>
                   ...
                   (= (Add (Add (Add (Add (Sub (vstd!arithmetic.power2.pow2.? (I 51)) 19) (Mul (vstd!arithmetic.power2.pow2.?
                    ...
                    ) (Add (Add (Add (Add (Sub r1@ 19) (Sub r2@ r1@)) (Sub r3@ r2@)) (Sub r4@ r3@)) (Sub
                      r5@ r4@
                  ))))
                  (=>
                   (= (Add (Add (Add (Add (Sub (vstd!arithmetic.power2.pow2.? (I 51)) 19) (Mul (vstd!arithmetic.power2.pow2.?
                   ...
                   (and
                    (=>
                     (= tmp%10 (= (Mul (vstd!arithmetic.power2.pow2.? (I 51)) (Sub (vstd!arithmetic.power2.pow2.?
                          (I 51)
                         ) 1
                        )
                       ) (Sub r2@ r1@)
                     ...
                     (and
                      ...
                      (=>
                       tmp%10
                       (=>
                        (= tmp%11 (= (Mul (vstd!arithmetic.power2.pow2.? (I 102)) (Sub (vstd!arithmetic.power2.pow2.?
                             (I 51)
                            ) 1
                           )
                          ) (Sub r3@ r2@)
                        ...
                        (and
                         ...
                         (=>
                          tmp%11
                          (=>
                           (= tmp%12 (= (Mul (vstd!arithmetic.power2.pow2.? (I 153)) (Sub (vstd!arithmetic.power2.pow2.?
                                (I 51)
                               ) 1
                              )
                             ) (Sub r4@ r3@)
                           ...
                           (and
                            ...
                            (=>
                             tmp%12
                             (=>
                              (= tmp%13 (= (Mul (vstd!arithmetic.power2.pow2.? (I 204)) (Sub (vstd!arithmetic.power2.pow2.?
                                   (I 51)
                                  ) 1
                                 )
                                ) (Sub r5@ r4@)
                 ...
                 (=>
                  ...
                  (and
                   (=>
                    (= tmp%14 (= r5@ (vstd!arithmetic.power2.pow2.? (I 255))))
                    (and
                     (=>
                      %%location_label%%32
                      tmp%14
                     ...
                     (=>
                      ...
                      (=>
                       ...
                       (and
                        (=>
                         (= tmp%15 (> (vstd!arithmetic.power2.pow2.? (I 255)) 19))
                         (and
                          (=>
                           %%location_label%%33
                           tmp%15
                        ...
                        (=>
                         ...
                         (and
                          (and
                           (and
                            (=>
                             (= tmp%16 (>= (vstd!arithmetic.power2.pow2.? (I 255)) 19))
                             (and
                              (=>
                               %%location_label%%35
                               tmp%16
                              ...
                              (=>
                               ...
                               (=>
                                %%location_label%%36
                                (>= (Sub (vstd!arithmetic.power2.pow2.? (I 255)) 19) 0)
                            ))))
                            (=>
                             (>= (Sub (vstd!arithmetic.power2.pow2.? (I 255)) 19) 0)
                             (=>
                              %%location_label%%37
                              (= (Sub (vstd!arithmetic.power2.pow2.? (I 255)) 19) (nClip (Sub (vstd!arithmetic.power2.pow2.?
                                  (I 255)
                                 ) 19
                           ))))))
                           (=>
                            ...
                            (=>
                             (= tmp%17 (= (curve25519_dalek!specs.field_specs_u64.p.? (I 0)) (nClip (Sub (vstd!arithmetic.power2.pow2.?
                                  (I 255)
                                 ) 19
                             ))))
                             (and
                              ...
                              (=>
                               ...
                               (=>
                                %%location_label%%39
                                (= (Sub (vstd!arithmetic.power2.pow2.? (I 255)) 19) (curve25519_dalek!specs.field_specs_u64.p.?
                                  (I 0)
                          ))))))))
                          (=>
                           (= (Sub (vstd!arithmetic.power2.pow2.? (I 255)) 19) (curve25519_dalek!specs.field_specs_u64.p.?
                           ...
                           (and
                            (=>
                             (= tmp%18 (= r5@ (vstd!arithmetic.power2.pow2.? (I 255))))
                             (and
                              (=>
                               %%location_label%%40
                               tmp%18
                              ...
                              (=>
                               ...
                               (=>
                                %%location_label%%41
                                (= (Sub r5@ 19) (Sub (vstd!arithmetic.power2.pow2.? (I 255)) 19))
                            ))))
                            (=>
                             (= (Sub r5@ 19) (Sub (vstd!arithmetic.power2.pow2.? (I 255)) 19))
                             (=>
                              %%location_label%%42
                              (= (Sub r5@ 19) (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                   )))))))))))
                   (=>
                    (= (Sub r5@ 19) (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                    (=>
