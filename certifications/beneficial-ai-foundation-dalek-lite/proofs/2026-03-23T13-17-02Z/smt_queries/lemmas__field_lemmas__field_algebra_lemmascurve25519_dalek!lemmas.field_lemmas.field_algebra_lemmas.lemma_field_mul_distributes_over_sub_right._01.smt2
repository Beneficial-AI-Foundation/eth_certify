...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:999:1: 999:80 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_field_mul_distributes_over_sub_right
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:999:1: 999:80 (#0)
 ...
 (assert
  (not (=>
    ...
    (=>
     ...
     (=>
      (= neg_b@ (curve25519_dalek!specs.field_specs.field_neg.? (I b!)))
      (=>
       ...
       (=>
        ...
        (=>
         ...
         (=>
          (= tmp%1 (= (curve25519_dalek!specs.field_specs.field_sub.? (I a!) (I b!)) (curve25519_dalek!specs.field_specs.field_add.?
             (I a!) (I neg_b@)
          )))
          (and
           (=>
           ...
           (=>
            tmp%1
            (=>
             (= tmp%2 (curve25519_dalek!specs.field_specs.field_sub.? (I a!) (I b!)))
             (=>
              (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_comm.
               tmp%2 c!
              )
              (=>
               (= tmp%3 (curve25519_dalek!specs.field_specs.field_add.? (I a!) (I neg_b@)))
               (=>
                (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_comm.
                 tmp%3 c!
                )
                (=>
                 ...
                 (=>
                  (= tmp%4 (= (curve25519_dalek!specs.field_specs.field_mul.? (I c!) (I (curve25519_dalek!specs.field_specs.field_add.?
                       (I a!) (I neg_b@)
                     ))
                    ) (curve25519_dalek!specs.field_specs.field_add.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                       (I c!) (I a!)
                      )
                     ) (I (curve25519_dalek!specs.field_specs.field_mul.? (I c!) (I neg_b@)))
                  )))
                  (and
                   (=>
                    %%location_label%%1
                    ...
                    (=>
                     ...
                     (=>
                      ...
                      (=>
                       ...
                       (=>
                        (= tmp%5 (= (curve25519_dalek!specs.field_specs.field_mul.? (I c!) (I neg_b@)) (curve25519_dalek!specs.field_specs.field_neg.?
                           (I bc@)
                        )))
                        (and
                         (=>
                            ...
                            (and
                             ...
                             (=>
                              ...
                              (=>
                               ...
                               (=>
                                (= tmp%8 (= (curve25519_dalek!specs.field_specs.field_add.? (I ac@) (I (curve25519_dalek!specs.field_specs.field_neg.?
                                     (I bc@)
                                   ))
                                  ) (curve25519_dalek!specs.field_specs.field_sub.? (I ac@) (I bc@))
                                ))
                                (and
                                 (=>
                                  %%location_label%%7
