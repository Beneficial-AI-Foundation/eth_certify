...
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:1712:7: 1712:50 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::number_theory_lemmas::lemma_mod_sub_eq
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:1712:7: 1712:50 (#0)
     ...
     (=>
      ...
      (and
       (and
        (=>
         %%location_label%%0
         (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. a! m!)
        )
        (=>
         (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. a! m!)
         (=>
          %%location_label%%1
          (= a! (Add (Mul q1@ m!) r@))
       )))
       (=>
        ...
        (and
         (and
          (=>
           %%location_label%%2
           (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. b! m!)
          )
          (=>
           (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. b! m!)
           (=>
            %%location_label%%3
            (= b! (Add (Mul q2@ m!) r@))
         )))
         (=>
          ...
          (and
           (=>
            (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub_other_way. m! q1@ q2@)
            (=>
             %%location_label%%4
             (= (Sub a! b!) (Mul (Sub q1@ q2@) m!))
           ))
           (=>
            (= (Sub a! b!) (Mul (Sub q1@ q2@) m!))
            (and
                    ...
                    (and
                     ...
                     (=>
                      ...
                      (=>
                       (= tmp%3 (Sub q2@ q1@))
                       (=>
                        (ens%vstd!arithmetic.mul.lemma_mul_strictly_positive. tmp%3 m!)
                        (=>
                         (= tmp%4 (> (Mul (Sub q2@ q1@) m!) 0))
                         (and
                          (=>
                           %%location_label%%7
                           tmp%4
                          ...
                          (=>
                           ...
                           (and
                            (=>
                             (= tmp%5 (Sub q2@ q1@))
                             (=>
                              (ens%vstd!arithmetic.mul.lemma_mul_unary_negation. tmp%5 m!)
                              (=>
                               %%location_label%%8
                               (= (Mul (Sub q1@ q2@) m!) (Sub 0 (Mul (Sub q2@ q1@) m!)))
                            )))
                            (=>
                             (= (Mul (Sub q1@ q2@) m!) (Sub 0 (Mul (Sub q2@ q1@) m!)))
                             (=>
                              (= tmp%6 (< (Mul (Sub q1@ q2@) m!) 0))
                              (and
                               (=>
                                %%location_label%%9
                                tmp%6
             ...
             (=>
              ...
              (and
               (=>
                (= tmp%7 (= (Sub a! b!) (Sub (Add (Mul q1@ m!) r@) (Add (Mul q2@ m!) r@))))
                (and
                 (=>
                  %%location_label%%11
                  tmp%7
               ...
               (=>
                ...
                (=>
                 ...
                 (and
                  (=>
                   %%location_label%%13
                   (req%vstd!arithmetic.div_mod.lemma_mod_multiples_basic. tmp%8 m!)
                  )
                  (=>
                   (ens%vstd!arithmetic.div_mod.lemma_mod_multiples_basic. tmp%8 m!)
                   (=>
                    %%location_label%%14
                    (= (EucMod (nClip (Sub a! b!)) m!) 0)
 )))))))))))))))))))
