...
;; curve25519-dalek/src/lemmas/scalar_lemmas_extra.rs:469:1: 474:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::scalar_lemmas_extra::lemma_montgomery_reduce_cancels_r
;; curve25519-dalek/src/lemmas/scalar_lemmas_extra.rs:469:1: 474:2 (#0)
(get-info :all-statistics)
(push)
 (declare-const after_nat! Int)
 (declare-const before_nat! Int)
 (declare-const const_nat! Int)
 (declare-const extra_factor! Int)
 ...
 (assert
  (not (=>
    (= tmp%1 (nClip (Mul extra_factor! (curve25519_dalek!specs.scalar52_specs.montgomery_radix.?
        (I 0)
    ))))
    (=>
     (= tmp%2 (curve25519_dalek!specs.scalar52_specs.group_order.? (I 0)))
     (and
      (=>
       %%location_label%%0
       (req%curve25519_dalek!lemmas.scalar_lemmas.lemma_mul_factors_congruent_implies_products_congruent.
        before_nat! tmp%1 const_nat! tmp%2
      ))
      (=>
       (ens%curve25519_dalek!lemmas.scalar_lemmas.lemma_mul_factors_congruent_implies_products_congruent.
        before_nat! tmp%1 const_nat! tmp%2
       ...
       (=>
        (= tmp%3 (curve25519_dalek!specs.scalar52_specs.montgomery_radix.? (I 0)))
        (=>
         (ens%vstd!arithmetic.mul.lemma_mul_is_associative. before_nat! extra_factor! tmp%3)
         (=>
          (= tmp%4 (nClip (Mul before_nat! extra_factor!)))
          (=>
           (= tmp%5 (curve25519_dalek!specs.scalar52_specs.montgomery_radix.? (I 0)))
           (and
            (=>
             %%location_label%%1
             (req%curve25519_dalek!lemmas.scalar_lemmas.lemma_cancel_mul_pow2_mod. after_nat! tmp%4
              tmp%5
            ))
            (=>
             (ens%curve25519_dalek!lemmas.scalar_lemmas.lemma_cancel_mul_pow2_mod. after_nat! tmp%4
              tmp%5
             )
             (and
              (=>
