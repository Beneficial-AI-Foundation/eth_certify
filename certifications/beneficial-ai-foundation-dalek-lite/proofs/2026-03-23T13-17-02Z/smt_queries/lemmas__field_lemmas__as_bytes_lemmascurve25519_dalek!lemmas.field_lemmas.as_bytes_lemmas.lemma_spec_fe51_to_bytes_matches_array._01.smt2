...
;; curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:182:7: 182:87 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::as_bytes_lemmas::lemma_spec_fe51_to_bytes_matches_array
;; curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:182:7: 182:87 (#0)
...
(push)
 ...
 (declare-const q@ Int)
 (declare-const canonical_limbs@ %%Function%%)
 (declare-const limbs0_canon@ Int)
 (declare-const limbs1_canon@ Int)
 (declare-const limbs2_canon@ Int)
 (declare-const limbs3_canon@ Int)
 (declare-const limbs4_canon@ Int)
 (declare-const spec_bytes@ %%Function%%)
 (assert
  fuel_defaults
 )
 (assert
 ...
 (assert
  (not (=>
    ...
    (=>
     (ens%curve25519_dalek!lemmas.field_lemmas.reduce_lemmas.proof_reduce. tmp%1)
     (=>
      (= limbs@ (curve25519_dalek!specs.field_specs_u64.spec_reduce.? (Poly%array%. (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
          (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
            fe!
      ...
      (=>
       ...
       (=>
        (ens%curve25519_dalek!lemmas.field_lemmas.reduce_lemmas.lemma_reduce_bound_2p. tmp%2)
        (=>
         (= q@ (curve25519_dalek!specs.field_specs_u64.compute_q_spec.? (Poly%array%. limbs@)))
         (and
          (=>
          ...
          (=>
           ...
           (=>
            (= canonical_limbs@ (curve25519_dalek!specs.field_specs_u64.reduce_with_q_spec.? (Poly%array%.
               limbs@
              ) (I q@)
            ))
            (=>
             (= limbs0_canon@ (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY
                  $ (UINT 64) $ (CONST_INT 5)
                 ) (Poly%array%. canonical_limbs@)
                ) (I 0)
             )))
             (=>
              (= limbs1_canon@ (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY
                   $ (UINT 64) $ (CONST_INT 5)
                  ) (Poly%array%. canonical_limbs@)
                 ) (I 1)
              )))
              (=>
               (= limbs2_canon@ (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY
                    $ (UINT 64) $ (CONST_INT 5)
                   ) (Poly%array%. canonical_limbs@)
                  ) (I 2)
               )))
               (=>
                (= limbs3_canon@ (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY
                     $ (UINT 64) $ (CONST_INT 5)
                    ) (Poly%array%. canonical_limbs@)
                   ) (I 3)
                )))
                (=>
                 (= limbs4_canon@ (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY
                      $ (UINT 64) $ (CONST_INT 5)
                     ) (Poly%array%. canonical_limbs@)
                    ) (I 4)
                 )))
                 (=>
                  (= tmp%3 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
                        (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
                       )
                      ) (I 0)
                     )
                    ) (uClip 8 limbs0_canon@)
                  ))
                  (and
                   (=>
                    %%location_label%%1
                   ...
                   (=>
                    tmp%3
                    (=>
                     (= tmp%4 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
                           (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
                          )
                         ) (I 1)
                        )
                       ) (uClip 8 (uClip 64 (bitshr (I limbs0_canon@) (I 8))))
                     ))
                     (and
                      (=>
                       %%location_label%%2
                      ...
                      (=>
                       tmp%4
                       (=>
                        (= tmp%5 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
                              (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
                             )
                            ) (I 2)
                           )
                          ) (uClip 8 (uClip 64 (bitshr (I limbs0_canon@) (I 16))))
                        ))
                        (and
                         (=>
                          %%location_label%%3
                         ...
                         (=>
                          tmp%5
                          (=>
                           (= tmp%6 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
                                 (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
                                )
                               ) (I 3)
                              )
                             ) (uClip 8 (uClip 64 (bitshr (I limbs0_canon@) (I 24))))
                           ))
                           (and
                            (=>
                             %%location_label%%4
                            ...
                            (=>
                             tmp%6
                             (=>
                              (= tmp%7 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
                                    (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
                                   )
                                  ) (I 4)
                                 )
                                ) (uClip 8 (uClip 64 (bitshr (I limbs0_canon@) (I 32))))
                              ))
                              (and
                               (=>
                                %%location_label%%5
                               ...
                               (=>
                                tmp%7
                                (=>
                                 (= tmp%8 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
                                       (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
                                      )
                                     ) (I 5)
                                    )
                                   ) (uClip 8 (uClip 64 (bitshr (I limbs0_canon@) (I 40))))
                                 ))
                                 (and
                                  (=>
                                   %%location_label%%6
                                  ...
                                  (=>
                                   tmp%8
                                   (=>
                                    (= tmp%9 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
                                          (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
                                         )
                                        ) (I 6)
                                       )
                                      ) (uClip 8 (uClip 64 (bitor (I (uClip 64 (bitshr (I limbs0_canon@) (I 48)))) (I (uClip
                                           64 (bitshl (I limbs1_canon@) (I 3))
                                    )))))))
                                    (and
                                     (=>
                                     ...
                                     (=>
                                      tmp%9
                                      (=>
                                       (= tmp%10 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
                                             (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
                                            )
                                           ) (I 7)
                                          )
                                         ) (uClip 8 (uClip 64 (bitshr (I limbs1_canon@) (I 5))))
                                       ))
                                       (and
                                        (=>
                                         %%location_label%%8
                                        ...
                                        (=>
                                         tmp%10
                                         (=>
                                          (= tmp%11 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
                                                (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
                                               )
                                              ) (I 8)
                                             )
                                            ) (uClip 8 (uClip 64 (bitshr (I limbs1_canon@) (I 13))))
                                          ))
                                          (and
                                           (=>
                                            %%location_label%%9
                                           ...
                                           (=>
                                            tmp%11
                                            (=>
                                             (= tmp%12 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
                                                   (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
                                                  )
                                                 ) (I 9)
                                                )
                                               ) (uClip 8 (uClip 64 (bitshr (I limbs1_canon@) (I 21))))
                                             ))
                                             (and
                                              (=>
                                               %%location_label%%10
                                              ...
                                              (=>
                                               tmp%12
                                               (=>
                                                (= tmp%13 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
                                                      (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
                                                     )
                                                    ) (I 10)
                                                   )
                                                  ) (uClip 8 (uClip 64 (bitshr (I limbs1_canon@) (I 29))))
                                                ))
                                                (and
                                                 (=>
                                                  %%location_label%%11
                                                 ...
                                                 (=>
                                                  tmp%13
                                                  (=>
                                                   (= tmp%14 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
                                                         (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
                                                        )
                                                       ) (I 11)
                                                      )
                                                     ) (uClip 8 (uClip 64 (bitshr (I limbs1_canon@) (I 37))))
                                                   ))
                                                   (and
                                                    (=>
                                                     %%location_label%%12
                                                    ...
                                                    (=>
                                                     tmp%14
                                                     (=>
                                                      (= tmp%15 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
                                                            (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
                                                           )
                                                          ) (I 12)
                                                         )
                                                        ) (uClip 8 (uClip 64 (bitor (I (uClip 64 (bitshr (I limbs1_canon@) (I 45)))) (I (uClip
                                                             64 (bitshl (I limbs2_canon@) (I 6))
                                                      )))))))
                                                      (and
                                                       (=>
                                                        %%location_label%%13
                                                       ...
                                                       (=>
                                                        tmp%15
                                                        (=>
                                                         (= tmp%16 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
                                                               (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
                                                              )
                                                             ) (I 13)
                                                            )
                                                           ) (uClip 8 (uClip 64 (bitshr (I limbs2_canon@) (I 2))))
                                                         ))
                                                         (and
                                                          (=>
                                                           %%location_label%%14
                                                          ...
                                                          (=>
                                                           tmp%16
                                                           (=>
                                                            (= tmp%17 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
                                                                  (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
                                                                 )
                                                                ) (I 14)
                                                               )
                                                              ) (uClip 8 (uClip 64 (bitshr (I limbs2_canon@) (I 10))))
                                                            ))
                                                            (and
                                                             (=>
                                                              %%location_label%%15
                                                             ...
                                                             (=>
                                                              tmp%17
                                                              (=>
                                                               (= tmp%18 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
                                                                     (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
                                                                    )
                                                                   ) (I 15)
                                                                  )
                                                                 ) (uClip 8 (uClip 64 (bitshr (I limbs2_canon@) (I 18))))
                                                               ))
                                                               (and
                                                                (=>
                                                                 %%location_label%%16
                                                                ...
                                                                (=>
                                                                 tmp%18
                                                                 (=>
                                                                  (= tmp%19 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
                                                                        (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
                                                                       )
                                                                      ) (I 16)
                                                                     )
                                                                    ) (uClip 8 (uClip 64 (bitshr (I limbs2_canon@) (I 26))))
                                                                  ))
                                                                  (and
                                                                   (=>
                                                                    %%location_label%%17
                                                                   ...
                                                                   (=>
                                                                    tmp%19
                                                                    (=>
                                                                     (= tmp%20 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
                                                                           (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
                                                                          )
                                                                         ) (I 17)
                                                                        )
                                                                       ) (uClip 8 (uClip 64 (bitshr (I limbs2_canon@) (I 34))))
                                                                     ))
                                                                     (and
                                                                      (=>
                                                                       %%location_label%%18
                                                                      ...
                                                                      (=>
                                                                       tmp%20
                                                                       (=>
                                                                        (= tmp%21 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
                                                                              (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
                                                                             )
                                                                            ) (I 18)
                                                                           )
                                                                          ) (uClip 8 (uClip 64 (bitshr (I limbs2_canon@) (I 42))))
                                                                        ))
                                                                        (and
                                                                         (=>
                                                                          %%location_label%%19
                                                                         ...
                                                                         (=>
                                                                          tmp%21
                                                                          (=>
                                                                           (= tmp%22 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
                                                                                 (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
                                                                                )
                                                                               ) (I 19)
                                                                              )
                                                                             ) (uClip 8 (uClip 64 (bitor (I (uClip 64 (bitshr (I limbs2_canon@) (I 50)))) (I (uClip
                                                                                  64 (bitshl (I limbs3_canon@) (I 1))
                                                                           )))))))
                                                                           (and
                                                                            (=>
                                                                            ...
                                                                            (=>
                                                                             tmp%22
                                                                             (=>
                                                                              (= tmp%23 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
                                                                                    (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
                                                                                   )
                                                                                  ) (I 20)
                                                                                 )
                                                                                ) (uClip 8 (uClip 64 (bitshr (I limbs3_canon@) (I 7))))
                                                                              ))
                                                                              (and
                                                                               (=>
                                                                                %%location_label%%21
                                                                               ...
                                                                               (=>
                                                                                tmp%23
                                                                                (=>
                                                                                 (= tmp%24 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
                                                                                       (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
                                                                                      )
                                                                                     ) (I 21)
                                                                                    )
                                                                                   ) (uClip 8 (uClip 64 (bitshr (I limbs3_canon@) (I 15))))
                                                                                 ))
                                                                                 (and
                                                                                  (=>
                                                                                   %%location_label%%22
                                                                                  ...
                                                                                  (=>
                                                                                   tmp%24
                                                                                   (=>
                                                                                    (= tmp%25 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
                                                                                          (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
                                                                                         )
                                                                                        ) (I 22)
                                                                                       )
                                                                                      ) (uClip 8 (uClip 64 (bitshr (I limbs3_canon@) (I 23))))
                                                                                    ))
                                                                                    (and
                                                                                     (=>
                                                                                      %%location_label%%23
                                                                                     ...
                                                                                     (=>
                                                                                      tmp%25
                                                                                      (=>
                                                                                       (= tmp%26 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
                                                                                             (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
                                                                                            )
                                                                                           ) (I 23)
                                                                                          )
                                                                                         ) (uClip 8 (uClip 64 (bitshr (I limbs3_canon@) (I 31))))
                                                                                       ))
                                                                                       (and
                                                                                        (=>
                                                                                         %%location_label%%24
                                                                                        ...
                                                                                        (=>
                                                                                         tmp%26
                                                                                         (=>
                                                                                          (= tmp%27 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
                                                                                                (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
                                                                                               )
                                                                                              ) (I 24)
                                                                                             )
                                                                                            ) (uClip 8 (uClip 64 (bitshr (I limbs3_canon@) (I 39))))
                                                                                          ))
                                                                                          (and
                                                                                           (=>
                                                                                            %%location_label%%25
                                                                                           ...
                                                                                           (=>
                                                                                            tmp%27
                                                                                            (=>
                                                                                             (= tmp%28 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
                                                                                                   (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
                                                                                                  )
                                                                                                 ) (I 25)
                                                                                                )
                                                                                               ) (uClip 8 (uClip 64 (bitor (I (uClip 64 (bitshr (I limbs3_canon@) (I 47)))) (I (uClip
                                                                                                    64 (bitshl (I limbs4_canon@) (I 4))
                                                                                             )))))))
                                                                                             (and
                                                                                              (=>
                                                                                               %%location_label%%26
                                                                                              ...
                                                                                              (=>
                                                                                               tmp%28
                                                                                               (=>
                                                                                                (= tmp%29 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
                                                                                                      (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
                                                                                                     )
                                                                                                    ) (I 26)
                                                                                                   )
                                                                                                  ) (uClip 8 (uClip 64 (bitshr (I limbs4_canon@) (I 4))))
                                                                                                ))
                                                                                                (and
                                                                                                 (=>
                                                                                                  %%location_label%%27
                                                                                                 ...
                                                                                                 (=>
                                                                                                  tmp%29
                                                                                                  (=>
                                                                                                   (= tmp%30 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
                                                                                                         (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
                                                                                                        )
                                                                                                       ) (I 27)
                                                                                                      )
                                                                                                     ) (uClip 8 (uClip 64 (bitshr (I limbs4_canon@) (I 12))))
                                                                                                   ))
                                                                                                   (and
                                                                                                    (=>
                                                                                                     %%location_label%%28
                                                                                                    ...
                                                                                                    (=>
                                                                                                     tmp%30
                                                                                                     (=>
                                                                                                      (= tmp%31 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
                                                                                                            (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
                                                                                                           )
                                                                                                          ) (I 28)
                                                                                                         )
                                                                                                        ) (uClip 8 (uClip 64 (bitshr (I limbs4_canon@) (I 20))))
                                                                                                      ))
                                                                                                      (and
                                                                                                       (=>
                                                                                                        %%location_label%%29
                                                                                                       ...
                                                                                                       (=>
                                                                                                        tmp%31
                                                                                                        (=>
                                                                                                         (= tmp%32 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
                                                                                                               (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
                                                                                                              )
                                                                                                             ) (I 29)
                                                                                                            )
                                                                                                           ) (uClip 8 (uClip 64 (bitshr (I limbs4_canon@) (I 28))))
                                                                                                         ))
                                                                                                         (and
                                                                                                          (=>
                                                                                                           %%location_label%%30
                                                                                                          ...
                                                                                                          (=>
                                                                                                           tmp%32
                                                                                                           (=>
                                                                                                            (= tmp%33 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
                                                                                                                  (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
                                                                                                                 )
                                                                                                                ) (I 30)
                                                                                                               )
                                                                                                              ) (uClip 8 (uClip 64 (bitshr (I limbs4_canon@) (I 36))))
                                                                                                            ))
                                                                                                            (and
                                                                                                             (=>
                                                                                                              %%location_label%%31
                                                                                                             ...
                                                                                                             (=>
                                                                                                              tmp%33
                                                                                                              (=>
                                                                                                               (= tmp%34 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
                                                                                                                     (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
                                                                                                                    )
                                                                                                                   ) (I 31)
                                                                                                                  )
                                                                                                                 ) (uClip 8 (uClip 64 (bitshr (I limbs4_canon@) (I 44))))
                                                                                                               ))
                                                                                                               (and
                                                                                                                (=>
                                                                                                                 %%location_label%%32
                                                                                                                ...
                                                                                                                (=>
                                                                                                                 tmp%34
                                                                                                                 (=>
                                                                                                                  (= spec_bytes@ (%Poly%array%. (array_new $ (UINT 8) 32 (%%array%%1 (I (uClip 8 limbs0_canon@))
                                                                                                                      (I (uClip 8 (uClip 64 (bitshr (I limbs0_canon@) (I 8))))) (I (uClip 8 (uClip 64 (bitshr
                                                                                                                          (I limbs0_canon@) (I 16)
                                                                                                                       )))
                                                                                                                      ) (I (uClip 8 (uClip 64 (bitshr (I limbs0_canon@) (I 24))))) (I (uClip 8 (uClip 64 (
                                                                                                                          bitshr (I limbs0_canon@) (I 32)
                                                                                                                       )))
                                                                                                                      ) (I (uClip 8 (uClip 64 (bitshr (I limbs0_canon@) (I 40))))) (I (uClip 8 (uClip 64 (
                                                                                                                          bitor (I (uClip 64 (bitshr (I limbs0_canon@) (I 48)))) (I (uClip 64 (bitshl (I limbs1_canon@)
                                                                                                                             (I 3)
                                                                                                                       ))))))
                                                                                                                      ) (I (uClip 8 (uClip 64 (bitshr (I limbs1_canon@) (I 5))))) (I (uClip 8 (uClip 64 (bitshr
                                                                                                                          (I limbs1_canon@) (I 13)
                                                                                                                  ...
                                                                                                                  (=>
                                                                                                                   (= tmp%35 (curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.bytes_match_limbs_packing.?
                                                                                                                     (Poly%array%. canonical_limbs@) (Poly%array%. spec_bytes@)
                                                                                                                   ))
                                                                                                                   (and
                                                                                                                    (=>
                                                                                                                     %%location_label%%33
                                                                                                                      ...
                                                                                                                      (=>
                                                                                                                       ...
                                                                                                                       (and
                                                                                                                        ...
                                                                                                                        (=>
                                                                                                                         ...
                                                                                                                         (=>
                                                                                                                          (= tmp%36 (= (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. spec_bytes@))
                                                                                                                            (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. canonical_limbs@))
                                                                                                                          ))
                                                                                                                          (and
                                                                                                                           (=>
                                                                                                                            %%location_label%%36
                                                                                                                           ...
                                                                                                                           (=>
                                                                                                                            tmp%36
                                                                                                                            (=>
                                                                                                                             (= tmp%37 (= (EucMod (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%.
                                                                                                                                  limbs@
                                                                                                                                 )
                                                                                                                                ) (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
                                                                                                                             ...
                                                                                                                             (and
                                                                                                                              ...
                                                                                                                              (=>
                                                                                                                               tmp%37
                                                                                                                               (=>
                                                                                                                                (= tmp%38 (= (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. spec_bytes@))
                                                                                                                                  (EucMod (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
                                                                                                                                      (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                                                                                                                        fe!
                                                                                                                                    ))))
                                                                                                                                ...
                                                                                                                                (and
                                                                                                                                 ...
                                                                                                                                 (=>
                                                                                                                                  tmp%38
                                                                                                                                  (=>
                                                                                                                                   (= tmp%39 (= (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. bytes!))
                                                                                                                                     (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. spec_bytes@))
                                                                                                                                   ))
                                                                                                                                   (and
                                                                                                                                    (=>
                                                                                                                                     %%location_label%%39
                                                                                                                                      ...
                                                                                                                                      (=>
                                                                                                                                       ...
                                                                                                                                       (=>
                                                                                                                                        ...
                                                                                                                                        (forall ((i$ Poly)) (!
                                                                                                                                          ...
                                                                                                                                          :qid user_curve25519_dalek__lemmas__field_lemmas__as_bytes_lemmas__lemma_spec_fe51_to_bytes_matches_array_51
                                                                                                                                          :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__as_bytes_lemmas__lemma_spec_fe51_to_bytes_matches_array_51
 )))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 (get-info :version)
