...
;; curve25519-dalek/src/lemmas/common_lemmas/to_nat_lemmas.rs:356:1: 356:72 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::to_nat_lemmas::lemma_u8_32_as_nat_mod_truncates
;; curve25519-dalek/src/lemmas/common_lemmas/to_nat_lemmas.rs:356:1: 356:72 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= d@ (vstd!arithmetic.power2.pow2.? (I (nClip (Mul n! 8)))))
    (=>
     (= goal@ (= (EucMod (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. bytes!))
        d@
       ) (curve25519_dalek!specs.core_specs.bytes_as_nat_prefix.? (vstd!view.View.view.? $
         (ARRAY $ (UINT 8) $ (CONST_INT 32)) (Poly%array%. bytes!)
        ) (I n!)
       ...
       (or
        (and
         (=>
          (= n! 0)
          (=>
           (= tmp%1 (= (vstd!arithmetic.power2.pow2.? (I 0)) 1))
           (and
            (=>
             %%location_label%%0
             tmp%1
             ...
             (=>
              ...
              (and
               ...
               (=>
                tmp%2
                (=>
                 (= tmp%3 (= (curve25519_dalek!specs.core_specs.bytes_as_nat_prefix.? (vstd!view.View.view.?
                     $ (ARRAY $ (UINT 8) $ (CONST_INT 32)) (Poly%array%. bytes!)
                    ) (I 0)
                   ) 0
                 ))
         ...
         (=>
          (not (= n! 0))
          (=>
           (= prefix@ (curve25519_dalek!specs.core_specs.bytes_as_nat_prefix.? (vstd!view.View.view.?
              $ (ARRAY $ (UINT 8) $ (CONST_INT 32)) (Poly%array%. bytes!)
             ) (I n!)
           ))
           (=>
            (= suffix@ (curve25519_dalek!specs.core_specs.u8_32_as_nat_rec.? (Poly%array%. bytes!)
              (I n!)
            ))
            (=>
             (= tmp%4 (nClip (Mul n! 8)))
               ...
               (=>
                ...
                (and
                 ...
                 (=>
                  ...
                  (and
                   (=>
                    (= tmp%5 (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT
                         32
                        )
                       ) (Poly%array%. bytes!)
                    )))
                   ...
                   (=>
                    ...
                    (and
                     (and
                      (=>
                       %%location_label%%8
                       (req%vstd!arithmetic.div_mod.lemma_small_mod. prefix@ d@)
                      )
                      (=>
                       (ens%vstd!arithmetic.div_mod.lemma_small_mod. prefix@ d@)
                       (=>
                        %%location_label%%9
                        (= (EucMod prefix@ d@) prefix@)
                     )))
                     (=>
                      (= (EucMod prefix@ d@) prefix@)
                      (and
                       ...
                       (=>
                        ...
                        (and
                         (=>
                          %%location_label%%12
                          (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. suffix@ d@)
                         )
                         (=>
                          (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. suffix@ d@)
                          (=>
                           (= k@ (EucDiv suffix@ d@))
                           (=>
                            (= tmp%6 (= suffix@ (nClip (Mul d@ k@))))
                            (and
                             (=>
                              %%location_label%%13
                              tmp%6
                             ...
                             (=>
                              ...
                              (and
                               (and
                                (=>
                                 (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. d@ k@)
                                 (=>
                                  %%location_label%%14
                                  (= (nClip (Mul d@ k@)) (nClip (Mul k@ d@)))
                                ))
                                (=>
                                 (= (nClip (Mul d@ k@)) (nClip (Mul k@ d@)))
                                 (=>
                                  (= tmp%7 (= (nClip (Add prefix@ suffix@)) (nClip (Add (nClip (Mul k@ d@)) prefix@))))
                                  (and
                                   (=>
                                    %%location_label%%15
                                    tmp%7
                                   ...
                                   (=>
                                    ...
                                    (and
                                     ...
                                     (=>
                                      ...
                                      (=>
                                       %%location_label%%17
                                       (= (EucMod (nClip (Add prefix@ suffix@)) d@) prefix@)
                               ))))))))
                               (=>
                                (= (EucMod (nClip (Add prefix@ suffix@)) d@) prefix@)
                                %%switch_label%%0
