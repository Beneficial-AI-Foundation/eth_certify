...
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_ratio_lemmas.rs:1914:1: 1914:76 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::sqrt_ratio_lemmas::lemma_nonneg_sqrt_ratio_unique
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_ratio_lemmas.rs:1914:1: 1914:76 (#0)
           ...
           (=>
            ...
            (and
             (and
              (=>
               %%location_label%%4
               (req%vstd!arithmetic.div_mod.lemma_small_mod. t! pn@)
              )
              (=>
               (ens%vstd!arithmetic.div_mod.lemma_small_mod. t! pn@)
               (=>
                %%location_label%%5
                (= (EucMod t! 2) 0)
             )))
                ...
                (or
                 (and
                  (=>
                   ...
                   (=>
                    (= tmp%2 (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_square.?
                         (I r!)
                        )
                       ) (I v!)
                      ) (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.sqrt_m1.?
                  ...
                  (or
                   (and
                    (=>
                     (curve25519_dalek!specs.field_specs.is_sqrt_ratio.? (I u!) (I v!) (I r!))
                     (=>
                      (= tmp%3 (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_square.?
                           (I r!)
                          )
                         ) (I v!)
                        ) (curve25519_dalek!specs.field_specs_u64.field_canonical.? (I u!))
                    ...
                    (=>
                     (not (curve25519_dalek!specs.field_specs.is_sqrt_ratio.? (I u!) (I v!) (I r!)))
                     (=>
                      (= tmp%5 (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_square.?
                           (I r!)
                          )
                         ) (I v!)
                        ) (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.sqrt_m1.?
                      ...
                      (and
                       ...
                       (=>
                        tmp%5
                        (=>
                         (= tmp%6 (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_square.?
                              (I t!)
                             )
                            ) (I v!)
                           ) (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.sqrt_m1.?
                   ...
                   (and
                    ...
                    (and
                     (=>
                      (= tmp%7 (curve25519_dalek!specs.field_specs.field_square.? (I r!)))
                      (=>
                       (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_comm.
                        tmp%7 v!
                       )
                       (=>
                        (= tmp%8 (curve25519_dalek!specs.field_specs.field_square.? (I t!)))
                        (=>
                         (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_comm.
                          tmp%8 v!
                         )
                         (=>
                          (= tmp%9 (curve25519_dalek!specs.field_specs.field_square.? (I r!)))
                          (=>
                           (= tmp%10 (curve25519_dalek!specs.field_specs.field_square.? (I t!)))
                           (and
                            (=>
                             %%location_label%%16
                             (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_left_cancel.
                              ...
                              (=>
                               ...
                               (and
                                ...
                                (=>
                                 ...
                                 (=>
                                  %%location_label%%18
                                  (< (curve25519_dalek!specs.field_specs.field_square.? (I r!)) pn@)
                              ))))
                              (=>
                               (< (curve25519_dalek!specs.field_specs.field_square.? (I r!)) pn@)
                               (and
                                (=>
                                 (= tmp%12 (nClip (Mul t! t!)))
                                 (and
                                  (=>
                                   %%location_label%%19
                                   (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%12 pn@)
                                  )
                                  (=>
                                   (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%12 pn@)
                                   (=>
                                    %%location_label%%20
                                    (< (curve25519_dalek!specs.field_specs.field_square.? (I t!)) pn@)
                                ))))
                                (=>
                                 (< (curve25519_dalek!specs.field_specs.field_square.? (I t!)) pn@)
                                 (=>
                                  (= tmp%13 (curve25519_dalek!specs.field_specs.field_square.? (I r!)))
                                  (and
                                   (=>
                                    %%location_label%%21
                                    (req%vstd!arithmetic.div_mod.lemma_small_mod. tmp%13 pn@)
                                   )
                                   (=>
                                    (ens%vstd!arithmetic.div_mod.lemma_small_mod. tmp%13 pn@)
                                    (=>
                                     (= tmp%14 (curve25519_dalek!specs.field_specs.field_square.? (I t!)))
                                     (and
                                      (=>
                                       %%location_label%%22
                                       (req%vstd!arithmetic.div_mod.lemma_small_mod. tmp%14 pn@)
                                      )
                                      (=>
                                       (ens%vstd!arithmetic.div_mod.lemma_small_mod. tmp%14 pn@)
                                       (=>
                                        %%location_label%%23
                                        (= (curve25519_dalek!specs.field_specs.field_square.? (I r!)) (curve25519_dalek!specs.field_specs.field_square.?
                                          (I t!)
