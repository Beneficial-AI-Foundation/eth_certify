...
;; curve25519-dalek/src/lemmas/edwards_lemmas/pippenger_lemmas.rs:805:7: 805:81 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::pippenger_lemmas::lemma_weighted_from_decompose
;; curve25519-dalek/src/lemmas/edwards_lemmas/pippenger_lemmas.rs:805:7: 805:81 (#0)
(get-info :all-statistics)
(push)
 (declare-const buckets! vstd!seq.Seq<tuple%2<nat./nat.>.>.)
 (declare-const b! Int)
 (declare-const B! Int)
 ...
 (declare-const W@ tuple%2.)
 (declare-const IS_prev@ tuple%2.)
 (declare-const C@ tuple%2.)
 (declare-const m@ Int)
 (declare-const mC@ tuple%2.)
 (declare-const mC_plus_C@ tuple%2.)
 (declare-const W_plus_mC@ tuple%2.)
 (declare-const IS_prev_plus_C@ tuple%2.)
 ...
 (assert
  (forall ((j$ Poly)) (!
    ...
    :qid user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_weighted_from_decompose_50
    :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_weighted_from_decompose_50
 )))
 ...
 (assert
  (not (=>
    (= decrease%init0 (Sub B! b!))
    (or
     (and
      (=>
       (= b! (Sub B! 1))
       (=>
        (= tmp%1 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.pippenger_weighted_from.?
            (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. buckets!) (I (Add b! 1)) (I B!)
           )
        ...
        (and
         ...
         (=>
          tmp%1
          (=>
           (= tmp%2 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.pippenger_intermediate_sum.?
               (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. buckets!) (I b!) (I B!)
              )
             ) (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2. $ NAT $ NAT) (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>.
               buckets!
           ...
           (and
            ...
            (=>
             tmp%2
             (=>
              (= tmp%3 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.pippenger_weighted_from.?
                  (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. buckets!) (I b!) (I (Sub B! 1))
                 )
                ) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_identity.? (I 0)))
              ))
      ...
      (=>
       ...
       (=>
        (= W@ (curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.pippenger_weighted_from.?
          (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. buckets!) (I (Add b! 1)) (I (Sub B! 1))
        ))
        (=>
         (= IS_prev@ (curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.pippenger_intermediate_sum.?
           (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. buckets!) (I b!) (I (Sub B! 1))
         ))
         (=>
          (= C@ (%Poly%tuple%2. (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2. $ NAT $ NAT) (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>.
              buckets!
             ) (I (Sub B! 1))
          )))
          (=>
           (= m@ (nClip (Sub (Sub B! b!) 1)))
           (=>
            (= mC@ (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2. C@)
              (I m@)
            ))
            (=>
             (= mC_plus_C@ (curve25519_dalek!specs.edwards_specs.edwards_add.? (tuple%2./tuple%2/0
                (%Poly%tuple%2. (Poly%tuple%2. mC@))
               ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. mC@))) (tuple%2./tuple%2/0 (%Poly%tuple%2.
                 (Poly%tuple%2. C@)
                )
               ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. C@)))
             ))
             (=>
              (= W_plus_mC@ (curve25519_dalek!specs.edwards_specs.edwards_add.? (tuple%2./tuple%2/0
                 (%Poly%tuple%2. (Poly%tuple%2. W@))
                ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. W@))) (tuple%2./tuple%2/0 (%Poly%tuple%2.
                  (Poly%tuple%2. mC@)
                 )
                ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. mC@)))
              ))
              (=>
               (= IS_prev_plus_C@ (curve25519_dalek!specs.edwards_specs.edwards_add.? (tuple%2./tuple%2/0
                  (%Poly%tuple%2. (Poly%tuple%2. IS_prev@))
                 ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. IS_prev@))) (tuple%2./tuple%2/0
                  (%Poly%tuple%2. (Poly%tuple%2. C@))
                 ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. C@)))
               ))
               (and
                (=>
                 ...
                 (and
                  (=>
                   ...
                   (check_decrease_int (let
                     ((buckets!$0 buckets!) (b!$1 b!) (B!$2 tmp%4))
                     (Sub B!$2 b!$1)
                  ...
                  (and
                   ...
                   (=>
                    ...
                    (=>
                     %%location_label%%5
                     (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.pippenger_weighted_from.?
                        (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. buckets!) (I b!) (I (Sub B! 1))
                       )
                      ) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_add.? (tuple%2./tuple%2/0
                         (%Poly%tuple%2. (Poly%tuple%2. W@))
                        ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. W@))) (tuple%2./tuple%2/0 (%Poly%tuple%2.
                          (Poly%tuple%2. IS_prev@)
                         )
                        ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. IS_prev@)))
                ))))))))
                (=>
                 (= (curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.pippenger_weighted_from.?
                   (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. buckets!) (I b!) (I (Sub B! 1))
                 ...
                 (and
                  (and
                   ...
                   (=>
                    ...
                    (=>
                     %%location_label%%7
                     (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.pippenger_intermediate_sum.?
                        (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. buckets!) (I b!) (I B!)
                       )
                      ) (Poly%tuple%2. IS_prev_plus_C@)
                  ))))
                  (=>
                   (= (curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.pippenger_intermediate_sum.?
                     (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. buckets!) (I b!) (I B!)
                     ...
                     (=>
                      ...
                      (=>
                       ...
                       (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.?
                          (Poly%tuple%2. C@) (I (nClip (Add m@ 1)))
                         )
                        ) (Poly%tuple%2. mC_plus_C@)
                    ))))
                    (=>
                     (= (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2. C@) (I
                        (nClip (Add m@ 1))
                       )
                      ) mC_plus_C@
                     )
                     (=>
                      (= tmp%5 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.pippenger_weighted_from.?
                          (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. buckets!) (I b!) (I B!)
                         )
                        ) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_add.? (tuple%2./tuple%2/0
                           (%Poly%tuple%2. (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_add.? (
                               tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. W@))
                              ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. W@))) (tuple%2./tuple%2/0 (%Poly%tuple%2.
                                (Poly%tuple%2. IS_prev@)
                               )
                              ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. IS_prev@)))
                              ...
                              (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. W@))) (tuple%2./tuple%2/1 (%Poly%tuple%2.
                                (Poly%tuple%2. W@)
                               )
                              ) (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. IS_prev@))) (tuple%2./tuple%2/1
                               (%Poly%tuple%2. (Poly%tuple%2. IS_prev@))
                           ))))
                          ) (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. mC_plus_C@))) (tuple%2./tuple%2/1
                           (%Poly%tuple%2. (Poly%tuple%2. mC_plus_C@))
                      )))))
                      (and
                       (=>
                        %%location_label%%10
                       ...
                       (=>
                        tmp%5
                        (=>
                         (= tmp%6 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.pippenger_weighted_from.?
                             (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. buckets!) (I (Add b! 1)) (I B!)
                            )
                           ) (Poly%tuple%2. W_plus_mC@)
                         ))
                         (and
                          (=>
                           %%location_label%%11
                          ...
                          (=>
                           ...
                           (and
                            (=>
                             (= tmp%7 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. W@)))))
                             (=>
                              (= tmp%8 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. W@)))))
                              (=>
                               (= tmp%9 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. IS_prev@)))))
                               (=>
                                (= tmp%10 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. IS_prev@)))))
                                (=>
                                 (= tmp%11 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. mC_plus_C@)))))
                                 (=>
                                  (= tmp%12 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. mC_plus_C@)))))
                                  (=>
                                   (ens%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.axiom_edwards_add_associative.
                                    tmp%7 tmp%8 tmp%9 tmp%10 tmp%11 tmp%12
                                   )
                                   (=>
                                    (= tmp%13 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. IS_prev@)))))
                                    (=>
                                     (= tmp%14 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. IS_prev@)))))
                                     (=>
                                      (= tmp%15 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. mC@)))))
                                      (=>
                                       (= tmp%16 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. mC@)))))
                                       (=>
                                        (= tmp%17 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. C@)))))
                                        (=>
                                         (= tmp%18 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. C@)))))
                                         (=>
                                          (ens%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.axiom_edwards_add_associative.
                                           tmp%13 tmp%14 tmp%15 tmp%16 tmp%17 tmp%18
                                          )
                                          (=>
                                           (= tmp%19 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. IS_prev@)))))
                                           (=>
                                            (= tmp%20 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. IS_prev@)))))
                                            (=>
                                             (= tmp%21 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. mC@)))))
                                             (=>
                                              (= tmp%22 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. mC@)))))
                                              (=>
                                               (ens%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_edwards_add_commutative.
                                                tmp%19 tmp%20 tmp%21 tmp%22
                                               )
                                               (=>
                                                (= tmp%23 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. mC@)))))
                                                (=>
                                                 (= tmp%24 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. mC@)))))
                                                 (=>
                                                  (= tmp%25 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. IS_prev@)))))
                                                  (=>
                                                   (= tmp%26 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. IS_prev@)))))
                                                   (=>
                                                    (= tmp%27 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. C@)))))
                                                    (=>
                                                     (= tmp%28 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. C@)))))
                                                     (=>
                                                      (ens%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.axiom_edwards_add_associative.
                                                       tmp%23 tmp%24 tmp%25 tmp%26 tmp%27 tmp%28
                                                      )
                                                      (=>
                                                       (= tmp%29 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. W@)))))
                                                       (=>
                                                        (= tmp%30 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. W@)))))
                                                        (=>
                                                         (= tmp%31 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. mC@)))))
                                                         (=>
                                                          (= tmp%32 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. mC@)))))
                                                          (=>
                                                           (= tmp%33 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. IS_prev_plus_C@)))))
                                                           (=>
                                                            (= tmp%34 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. IS_prev_plus_C@)))))
                                                            (=>
                                                             (ens%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.axiom_edwards_add_associative.
                                                             ...
                                                             (=>
                                                              ...
                                                              (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_add.?
                                                                 (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_add.?
                                                                  ...
                                                                  (%Poly%tuple%2. (Poly%tuple%2. W_plus_mC@))
                                                                 ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. W_plus_mC@))) (tuple%2./tuple%2/0
                                                                  (%Poly%tuple%2. (Poly%tuple%2. IS_prev_plus_C@))
                                                                 ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. IS_prev_plus_C@)))
                            )))))))))))))))))))))))))))))))))))))
                            (=>
                             (= (curve25519_dalek!specs.edwards_specs.edwards_add.? (tuple%2./tuple%2/0 (%Poly%tuple%2.
                                 (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_add.? (tuple%2./tuple%2/0
