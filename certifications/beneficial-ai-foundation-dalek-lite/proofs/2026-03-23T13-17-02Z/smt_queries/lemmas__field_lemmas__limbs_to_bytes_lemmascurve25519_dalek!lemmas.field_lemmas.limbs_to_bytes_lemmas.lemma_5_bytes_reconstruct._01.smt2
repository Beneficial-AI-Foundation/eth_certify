...
;; curve25519-dalek/src/lemmas/field_lemmas/limbs_to_bytes_lemmas.rs:413:7: 420:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::limbs_to_bytes_lemmas::lemma_5_bytes_reconstruct
;; curve25519-dalek/src/lemmas/field_lemmas/limbs_to_bytes_lemmas.rs:413:7: 420:2 (#0)
...
(push)
 ...
 (assert
  (not (=>
    ...
    (and
     (=>
      (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_div_mod. value! 0
       8
      )
      (=>
       (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_div_mod. value! 8
        8
       )
       (=>
        (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_div_mod. value! 16
         8
        )
        (=>
         (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_div_mod. value! 24
          8
         )
         (=>
          (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_div_mod. value! 32
           8
          )
          (and
           (=>
            (= tmp%1 (EucMod value! (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 1 8))))))
            (=>
             (ens%vstd!arithmetic.div_mod.lemma_div_basics_2. tmp%1)
             (=>
              %%location_label%%0
              (= byte0! (EucMod value! (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 1 8))))))
           )))
           (=>
            (= byte0! (EucMod value! (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 1 8))))))
            (=>
             ...
             (and
              (and
               (and
                (and
                 (= byte0! (EucMod value! (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 1 8))))))
                 (= byte1! (EucDiv (EucMod value! (vstd!arithmetic.power2.pow2.? (I (nClip (Add (nClip (Mul
                          1 8
                         )
                        ) 8
                    ))))
                ...
                (= byte2! (EucDiv (EucMod value! (vstd!arithmetic.power2.pow2.? (I (nClip (Add (nClip (Mul
                         2 8
                        )
                       ) 8
                   ))))
               ...
               (= byte3! (EucDiv (EucMod value! (vstd!arithmetic.power2.pow2.? (I (nClip (Add (nClip (Mul
                        3 8
                       )
                      ) 8
                  ))))
              ...
              (= byte4! (EucDiv (EucMod value! (vstd!arithmetic.power2.pow2.? (I (nClip (Add (nClip (Mul
                       4 8
                      )
                     ) 8
                 ))))
      ...
      (and
       (=>
        ...
        (=>
         ...
         (=>
          (= v@ (EucMod value! (vstd!arithmetic.power2.pow2.? (I (nClip (Add (nClip (Mul i@ 8)) 8))))))
          (=>
           (= d@ (vstd!arithmetic.power2.pow2.? (I (nClip (Mul i@ 8)))))
           (and
            (and
             (=>
              %%location_label%%2
              (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. v@ d@)
             )
             (=>
              (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. v@ d@)
              (=>
               %%location_label%%3
               (= v@ (nClip (Add (nClip (Mul (EucDiv v@ d@) d@)) (EucMod v@ d@))))
            )))
            (=>
             (= v@ (nClip (Add (nClip (Mul (EucDiv v@ d@) d@)) (EucMod v@ d@))))
             (and
              (=>
               (= tmp%2 (nClip (Mul i@ 8)))
               (=>
                (ens%vstd!arithmetic.power2.lemma_pow2_adds. tmp%2 8)
                (=>
                 %%location_label%%4
                 (= (vstd!arithmetic.power2.pow2.? (I (nClip (Add (nClip (Mul i@ 8)) 8)))) (nClip (Mul
                    (vstd!arithmetic.power2.pow2.? (I (nClip (Mul i@ 8)))) (vstd!arithmetic.power2.pow2.?
                     (I 8)
              )))))))
              (=>
               (= (vstd!arithmetic.power2.pow2.? (I (nClip (Add (nClip (Mul i@ 8)) 8)))) (nClip (Mul
               ...
               (and
                (=>
                 (= tmp%3 (nClip (Mul i@ 8)))
                 (=>
                  (ens%vstd!arithmetic.power2.lemma_pow2_pos. tmp%3)
                  (=>
                   ...
                   (and
                    (=>
                     ...
                     (and
                      (=>
                       %%location_label%%5
                       (req%vstd!arithmetic.div_mod.lemma_mod_mod. value! d@ tmp%4)
                      )
                      (=>
                       (ens%vstd!arithmetic.div_mod.lemma_mod_mod. value! d@ tmp%4)
                       (=>
                        %%location_label%%6
                        (= (EucMod (EucMod value! (nClip (Mul d@ (vstd!arithmetic.power2.pow2.? (I 8))))) d@)
                         (EucMod value! d@)
                    )))))
                    (=>
                     (= (EucMod (EucMod value! (nClip (Mul d@ (vstd!arithmetic.power2.pow2.? (I 8))))) d@)
                     ...
                     (=>
                      %%location_label%%7
                      (= (EucMod v@ d@) (EucMod value! d@))
                ))))))
                (=>
                 (= (EucMod v@ d@) (EucMod value! d@))
                 (=>
                  %%location_label%%8
                  (= (nClip (Add (EucMod value! (vstd!arithmetic.power2.pow2.? (I (nClip (Mul i@ 8)))))
                     (nClip (Mul (EucDiv (EucMod value! (vstd!arithmetic.power2.pow2.? (I (nClip (Add (nClip (Mul
                               i@ 8
                              )
                             ) 8
                         ))))
                   ...
                   ) (EucMod value! (vstd!arithmetic.power2.pow2.? (I (nClip (Add (nClip (Mul i@ 8)) 8)))))
       ))))))))))))
       (=>
        (forall ((i$ Int)) (!
          (=>
          ...
          :pattern ((EucMod value! (vstd!arithmetic.power2.pow2.? (I (nClip (Mul i$ 8))))))
          :qid user_curve25519_dalek__lemmas__field_lemmas__limbs_to_bytes_lemmas__lemma_5_bytes_reconstruct_45
          :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__limbs_to_bytes_lemmas__lemma_5_bytes_reconstruct_45
        ))
        (and
         (=>
          (= tmp%5 (vstd!arithmetic.power2.pow2.? (I 40)))
          (and
           (=>
            %%location_label%%9
            (req%vstd!arithmetic.div_mod.lemma_small_mod. value! tmp%5)
           )
           (=>
            (ens%vstd!arithmetic.div_mod.lemma_small_mod. value! tmp%5)
            (=>
             %%location_label%%10
             (= (EucMod value! (vstd!arithmetic.power2.pow2.? (I (nClip (Add (nClip (Mul 4 8)) 8)))))
              value!
         )))))
         (=>
          (= (EucMod value! (vstd!arithmetic.power2.pow2.? (I (nClip (Add (nClip (Mul 4 8)) 8)))))
