...
;; curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:390:1: 394:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::as_bytes_lemmas::lemma_from_bytes_as_bytes_roundtrip
;; curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:390:1: 394:2 (#0)
(get-info :all-statistics)
(push)
 (declare-const fe_orig! curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const bytes! %%Function%%)
 (declare-const fe_decoded! curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 ...
 (assert
  (has_type (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe_orig!)
   TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.
 ))
 (assert
 ...
 (assert
  (has_type (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe_decoded!)
   TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.
 ))
 (assert
  (curve25519_dalek!specs.field_specs.as_bytes_post.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
 ...
 (assert
  (not (=>
    (= v@ (curve25519_dalek!specs.field_specs.fe51_as_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
       fe_orig!
    )))
    (and
     (and
        ...
        (and
         (=>
          ...
          (and
           (=>
            %%location_label%%1
            (req%vstd!arithmetic.div_mod.lemma_mod_bound. v@ tmp%1)
           )
           (=>
            (ens%vstd!arithmetic.div_mod.lemma_mod_bound. v@ tmp%1)
            (=>
             %%location_label%%2
             (< (EucMod v@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) (curve25519_dalek!specs.field_specs_u64.p.?
               (I 0)
         ))))))
         (=>
          (< (EucMod v@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) (curve25519_dalek!specs.field_specs_u64.p.?
          ...
          (=>
           (= tmp%2 (EucMod v@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))))
           (=>
            (= tmp%3 (vstd!arithmetic.power2.pow2.? (I 255)))
            (and
             (=>
              %%location_label%%3
             ...
             (=>
              ...
              (=>
               %%location_label%%4
               (= (EucMod (EucMod v@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) (vstd!arithmetic.power2.pow2.?
                  (I 255)
                 )
                ) (EucMod v@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
        ))))))))
        (=>
         (= (EucMod (EucMod v@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) (vstd!arithmetic.power2.pow2.?
            (I 255)
         ...
         (and
          (=>
           ...
           (and
            (=>
             %%location_label%%5
             (req%vstd!arithmetic.div_mod.lemma_mod_twice. v@ tmp%4)
            )
            (=>
             (ens%vstd!arithmetic.div_mod.lemma_mod_twice. v@ tmp%4)
             (=>
              %%location_label%%6
              (= (EucMod (EucMod v@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) (curve25519_dalek!specs.field_specs_u64.p.?
                 (I 0)
                )
               ) (EucMod v@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
          )))))
