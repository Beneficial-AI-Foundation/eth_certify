...
;; curve25519-dalek/src/window.rs:725:5: 725:68 (#0)
...
;; Trait-Impl-Axiom
(assert
 (tr_bound%core!default.Default. $ (TYPE%curve25519_dalek!window.LookupTable. $ TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.))
)
...
(assert
 (forall ((T&. Dcr) (T& Type)) (!
   (=>
    ...
    (tr_bound%core!fmt.Debug. $ (TYPE%curve25519_dalek!window.LookupTable. T&. T&))
   )
   :pattern ((tr_bound%core!fmt.Debug. $ (TYPE%curve25519_dalek!window.LookupTable. T&.
      T&
   )))
   :qid internal_curve25519_dalek__window__impl&__11_trait_impl_definition
   :skolemid skolem_internal_curve25519_dalek__window__impl&__11_trait_impl_definition
)))
...
(assert
 (forall ((T&. Dcr) (T& Type)) (!
   (=>
    (sized T&.)
    (tr_bound%core!clone.Clone. $ (TYPE%curve25519_dalek!window.NafLookupTable8. T&. T&))
   )
   :pattern ((tr_bound%core!clone.Clone. $ (TYPE%curve25519_dalek!window.NafLookupTable8.
      T&. T&
   )))
   :qid internal_curve25519_dalek__window__impl&__3_trait_impl_definition
   :skolemid skolem_internal_curve25519_dalek__window__impl&__3_trait_impl_definition
)))
...
;; Trait-Impl-Axiom
(assert
 (tr_bound%core!fmt.Debug. $ TYPE%curve25519_dalek!edwards.EdwardsPoint.)
)

;; Trait-Impl-Axiom
(assert
 (tr_bound%core!fmt.Debug. $ TYPE%curve25519_dalek!backend.serial.curve_models.CompletedPoint.)
)

;; Trait-Impl-Axiom
(assert
 (tr_bound%core!fmt.Debug. $ TYPE%curve25519_dalek!backend.serial.curve_models.AffineNielsPoint.)
)

;; Trait-Impl-Axiom
(assert
 (tr_bound%core!fmt.Debug. $ TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.)
)
...
(assert
 (forall ((T&. Dcr) (T& Type)) (!
   (=>
    ...
    (tr_bound%core!fmt.Debug. $ (TYPE%curve25519_dalek!window.NafLookupTable5. T&. T&))
   )
   :pattern ((tr_bound%core!fmt.Debug. $ (TYPE%curve25519_dalek!window.NafLookupTable5.
      T&. T&
   )))
   :qid internal_curve25519_dalek__window__impl&__2_trait_impl_definition
   :skolemid skolem_internal_curve25519_dalek__window__impl&__2_trait_impl_definition
)))
...
(assert
 (forall ((T&. Dcr) (T& Type)) (!
   (=>
    ...
    (tr_bound%core!fmt.Debug. $ (TYPE%curve25519_dalek!window.NafLookupTable8. T&. T&))
   )
   :pattern ((tr_bound%core!fmt.Debug. $ (TYPE%curve25519_dalek!window.NafLookupTable8.
      T&. T&
   )))
   :qid internal_curve25519_dalek__window__impl&__4_trait_impl_definition
   :skolemid skolem_internal_curve25519_dalek__window__impl&__4_trait_impl_definition
)))
   ...
   (= (req%curve25519_dalek!window.impl&%15.select. self! x!) (and
     ...
     (=>
      ...
      (forall ((j$ Poly)) (!
        ...
        :qid user_curve25519_dalek__window__NafLookupTable5__select_198
        :skolemid skolem_user_curve25519_dalek__window__NafLookupTable5__select_198
   )))))
...
;; Function-Def curve25519_dalek::window::NafLookupTable5::select
;; curve25519-dalek/src/window.rs:725:5: 725:68 (#0)
(get-info :all-statistics)
(push)
 (declare-const result! curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.)
 (declare-const self! curve25519_dalek!window.NafLookupTable5.)
 (declare-const x! Int)
 ...
 (assert
  (has_type (Poly%curve25519_dalek!window.NafLookupTable5. self!) (TYPE%curve25519_dalek!window.NafLookupTable5.
    $ TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
 )))
 (assert
  (uInv SZ x!)
 ...
 (assert
  (forall ((j$ Poly)) (!
    ...
    :qid user_curve25519_dalek__window__NafLookupTable5__select_199
    :skolemid skolem_user_curve25519_dalek__window__NafLookupTable5__select_199
 )))
 ...
 (assert
  (not (=>
    (= tmp%1 (curve25519_dalek!window.NafLookupTable5./NafLookupTable5/0 (%Poly%curve25519_dalek!window.NafLookupTable5.
       (Poly%curve25519_dalek!window.NafLookupTable5. self!)
    )))
    (and
     (=>
