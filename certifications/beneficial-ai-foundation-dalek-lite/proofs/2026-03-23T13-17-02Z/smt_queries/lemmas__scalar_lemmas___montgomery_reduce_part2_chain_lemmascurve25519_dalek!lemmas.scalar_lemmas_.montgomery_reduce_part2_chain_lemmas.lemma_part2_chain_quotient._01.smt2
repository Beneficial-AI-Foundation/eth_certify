...
;; curve25519-dalek/src/lemmas/scalar_lemmas_/montgomery_reduce_part2_chain_lemmas.rs:333:1: 358:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::scalar_lemmas_::montgomery_reduce_part2_chain_lemmas::lemma_part2_chain_quotient
;; curve25519-dalek/src/lemmas/scalar_lemmas_/montgomery_reduce_part2_chain_lemmas.rs:333:1: 358:2 (#0)
...
(push)
 ...
 (declare-const l_poly@ Int)
 (declare-const n_poly@ Int)
     ...
     (=>
      ...
      (=>
       ...
       (=>
        ...
        (=>
         (= t_high@ (nClip (Add (nClip (Add (nClip (Add (%I (vstd!seq.Seq.index.? $ (UINT 128) (vstd!view.View.view.?
                   $ (ARRAY $ (UINT 128) $ (CONST_INT 9)) (Poly%array%. limbs!)
                  ) (I 5)
                 )
                ) (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 128) (vstd!view.View.view.? $ (ARRAY $
                        ...
                        (=>
                         ...
                         (and
                          (=>
                           ...
                           (=>
                            (= tmp%2 (%I (vstd!seq.Seq.index.? $ (UINT 128) (vstd!view.View.view.? $ (ARRAY $ (UINT
                                  128
                                 ) $ (CONST_INT 9)
                                ) (Poly%array%. limbs!)
                               ) (I 5)
                            ...
                            (=>
                             (= tmp%3 (nClip (Add (nClip (Add (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 128) (vstd!view.View.view.?
                                       $ (ARRAY $ (UINT 128) $ (CONST_INT 9)) (Poly%array%. limbs!)
                                      ) (I 6)
                                     )
                                    ) (vstd!arithmetic.power2.pow2.? (I 52))
                             ...
                             (=>
                              (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. tmp%1 tmp%2 tmp%3)
                              (=>
                               (= tmp%4 (vstd!arithmetic.power2.pow2.? (I 260)))
                               (=>
                                (= tmp%5 (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 128) (vstd!view.View.view.? $ (ARRAY
                                       $ (UINT 128) $ (CONST_INT 9)
                                      ) (Poly%array%. limbs!)
                                     ) (I 6)
                                    )
                                ...
                                (=>
                                 (= tmp%6 (nClip (Add (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 128) (vstd!view.View.view.?
                                         $ (ARRAY $ (UINT 128) $ (CONST_INT 9)) (Poly%array%. limbs!)
                                        ) (I 7)
                                       )
                                      ) (vstd!arithmetic.power2.pow2.? (I 104))
                                 ...
                                 (=>
                                  ...
                                  (=>
                                   ...
                                   (=>
                                    (= tmp%8 (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 128) (vstd!view.View.view.? $ (ARRAY
                                           $ (UINT 128) $ (CONST_INT 9)
                                          ) (Poly%array%. limbs!)
                                         ) (I 7)
                                        )
                                    ...
                                    (=>
                                     (= tmp%9 (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 128) (vstd!view.View.view.? $ (ARRAY
                                            $ (UINT 128) $ (CONST_INT 9)
                                           ) (Poly%array%. limbs!)
                                          ) (I 8)
                                         )
                                     ...
                                     (=>
                                      ...
                                      (and
                                       (=>
                                        (= tmp%10 (%I (vstd!seq.Seq.index.? $ (UINT 128) (vstd!view.View.view.? $ (ARRAY $ (UINT
                                              128
                                             ) $ (CONST_INT 9)
                                            ) (Poly%array%. limbs!)
                                           ) (I 6)
                                        ...
                                        (=>
                                         ...
                                         (=>
                                          ...
                                          (=>
                                           (ens%vstd!arithmetic.mul.lemma_mul_is_associative. tmp%10 tmp%11 tmp%12)
                                           (=>
                                            %%location_label%%0
                                            (= (nClip (Mul (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 128) (vstd!view.View.view.?
                                                    $ (ARRAY $ (UINT 128) $ (CONST_INT 9)) (Poly%array%. limbs!)
                                                   ) (I 6)
                                                  )
                                                 ) (vstd!arithmetic.power2.pow2.? (I 52))
                                       ...
                                       (=>
                                        ...
                                        (and
                                         (=>
                                          (= tmp%13 (%I (vstd!seq.Seq.index.? $ (UINT 128) (vstd!view.View.view.? $ (ARRAY $ (UINT
                                                128
                                               ) $ (CONST_INT 9)
                                              ) (Poly%array%. limbs!)
                                             ) (I 7)
                                          ...
                                          (=>
                                           (= tmp%14 (vstd!arithmetic.power2.pow2.? (I 104)))
                                           (=>
                                            (= tmp%15 (vstd!arithmetic.power2.pow2.? (I 260)))
                                            (=>
                                             (ens%vstd!arithmetic.mul.lemma_mul_is_associative. tmp%13 tmp%14 tmp%15)
                                             (=>
                                              %%location_label%%1
                                              (= (nClip (Mul (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 128) (vstd!view.View.view.?
                                                      $ (ARRAY $ (UINT 128) $ (CONST_INT 9)) (Poly%array%. limbs!)
                                         ...
                                         (=>
                                          ...
                                          (and
                                           (=>
                                            (= tmp%16 (%I (vstd!seq.Seq.index.? $ (UINT 128) (vstd!view.View.view.? $ (ARRAY $ (UINT
                                                  128
                                                 ) $ (CONST_INT 9)
                                                ) (Poly%array%. limbs!)
                                               ) (I 8)
                                            ...
                                            (=>
                                             ...
                                             (=>
                                              ...
                                              (=>
                                               (ens%vstd!arithmetic.mul.lemma_mul_is_associative. tmp%16 tmp%17 tmp%18)
                                               (=>
                                                %%location_label%%2
                                                (= (nClip (Mul (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 128) (vstd!view.View.view.?
                                                        $ (ARRAY $ (UINT 128) $ (CONST_INT 9)) (Poly%array%. limbs!)
                                           ...
                                           (=>
                                            ...
                                            (=>
                                             %%location_label%%3
                                             (= (nClip (Mul t_high@ (vstd!arithmetic.power2.pow2.? (I 260)))) (nClip (Add (nClip (
                                                  Add (nClip (Add (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 128) (vstd!view.View.view.?
                                                         $ (ARRAY $ (UINT 128) $ (CONST_INT 9)) (Poly%array%. limbs!)
                                                        ) (I 5)
                                                       )
                                                      ) (vstd!arithmetic.power2.pow2.? (I 260))
                          ...
                          (=>
                           ...
                           (=>
                            %%location_label%%4
                            (= t@ (nClip (Add t_low@ (nClip (Mul t_high@ (vstd!arithmetic.power2.pow2.? (I 260)))))))
                     )))))))
                     (=>
                      (= t@ (nClip (Add t_low@ (nClip (Mul t_high@ (vstd!arithmetic.power2.pow2.? (I 260)))))))
                      (and
                       (and
                        ...
                        (=>
                         ...
                         (=>
                          %%location_label%%6
                          (= intermediate@ (nClip (Add (nClip (Add carry4! t_high@)) nl_high@)))
                       )))
                       (=>
                        (= intermediate@ (nClip (Add (nClip (Add carry4! t_high@)) nl_high@)))
                        (and
                         (=>
                          (ens%curve25519_dalek!lemmas.scalar_lemmas.lemma_l_equals_group_order. 0)
                          (=>
                           (= tmp%19 (curve25519_dalek!backend.serial.u64.scalar.Scalar52./Scalar52/limbs (%Poly%curve25519_dalek!backend.serial.u64.scalar.Scalar52.
                              (Poly%curve25519_dalek!backend.serial.u64.scalar.Scalar52. curve25519_dalek!backend.serial.u64.constants.L.?)
                           )))
                           (=>
                            (ens%curve25519_dalek!lemmas.scalar_lemmas.lemma_five_limbs_equals_to_nat. tmp%19)
                            (=>
                             (= tmp%20 (vstd!arithmetic.power2.pow2.? (I 52)))
                             (=>
                              ...
                              (=>
                               ...
                               (=>
                                (= tmp%22 (vstd!arithmetic.power2.pow2.? (I 104)))
                                (=>
                                 ...
                                 (=>
                                  (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. tmp%22 tmp%23)
                                  (=>
                                   (= tmp%24 (vstd!arithmetic.power2.pow2.? (I 156)))
                                   (=>
                                    ...
                                    (=>
                                     (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. tmp%24 tmp%25)
                                     (=>
                                      (= tmp%26 (vstd!arithmetic.power2.pow2.? (I 208)))
                                      (=>
                                       ...
                                       (=>
                                        (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. tmp%26 tmp%27)
                                        (=>
                                         (= l_poly@ (nClip (Add (nClip (Add (nClip (Add (nClip (Add l0_val@ (nClip (Mul l1@ (vstd!arithmetic.power2.pow2.?
                                                     (I 52)
                                                 ))))
                                                ) (nClip (Mul l2@ (vstd!arithmetic.power2.pow2.? (I 104))))
                                               )
                                              ) (nClip (Mul 0 (vstd!arithmetic.power2.pow2.? (I 156))))
                                             )
                                         ...
                                         (=>
                                          ...
                                          (and
                                           ...
                                           (=>
                                            ...
                                            (=>
                                             (ens%curve25519_dalek!lemmas.scalar_lemmas_.montgomery_reduce_part1_chain_lemmas.lemma_poly_mul_5x5_decomposition.
                                              n0! n1! n2! n3! n4! l0_val@ l1@ l2@ 0 l4@
                                             )
                                             (=>
                                              (= n_poly@ (nClip (Add (nClip (Add (nClip (Add (nClip (Add n0! (nClip (Mul n1! (vstd!arithmetic.power2.pow2.?
                                                          (I 52)
                                                      ))))
                                              ...
                                              (=>
                                               ...
                                               (and
                                                ...
                                                (=>
                                                 ...
                                                 (=>
                                                  %%location_label%%9
                                                  (= (nClip (Mul n@ l@)) (nClip (Add nl_low_coeffs@ (nClip (Mul nl_high@ (vstd!arithmetic.power2.pow2.?
                                                        (I 260)
                         )))))))))))))))))))))))))))))))
                         (=>
                          (= (nClip (Mul n@ l@)) (nClip (Add nl_low_coeffs@ (nClip (Mul nl_high@ (vstd!arithmetic.power2.pow2.?
                          ...
                          (=>
                           (= tmp%30 (= (nClip (Add t_low@ nl_low_coeffs@)) (nClip (Mul carry4! (vstd!arithmetic.power2.pow2.?
                                (I 260)
                           )))))
                           (and
                            (=>
                            ...
                            (=>
                             ...
                             (and
                              (and
                               (=>
                                (= tmp%31 (vstd!arithmetic.power2.pow2.? (I 260)))
                                (=>
                                 (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. tmp%31 t_high@ nl_high@)
                                 (=>
                                  %%location_label%%11
                                  (= (nClip (Add t@ (nClip (Mul n@ l@)))) (nClip (Add (nClip (Add t_low@ nl_low_coeffs@))
                                     (nClip (Mul (nClip (Add t_high@ nl_high@)) (vstd!arithmetic.power2.pow2.? (I 260))))
                               ))))))
                               (=>
                                (= (nClip (Add t@ (nClip (Mul n@ l@)))) (nClip (Add (nClip (Add t_low@ nl_low_coeffs@))
                                   (nClip (Mul (nClip (Add t_high@ nl_high@)) (vstd!arithmetic.power2.pow2.? (I 260))))
                                ...
                                (and
                                 (=>
                                  (= tmp%32 (vstd!arithmetic.power2.pow2.? (I 260)))
                                  (=>
                                   (= tmp%33 (nClip (Add t_high@ nl_high@)))
                                   (=>
                                    (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. tmp%32 carry4! tmp%33)
                                    (=>
                                     %%location_label%%12
                                     (= (nClip (Add t@ (nClip (Mul n@ l@)))) (nClip (Mul (nClip (Add (nClip (Add carry4! t_high@))
                                          nl_high@
                                         )
                                        ) (vstd!arithmetic.power2.pow2.? (I 260))
                                 )))))))
                                 (=>
                                  ...
                                  (=>
                                   %%location_label%%13
                                   (= (nClip (Add t@ (nClip (Mul n@ l@)))) (nClip (Mul intermediate@ (vstd!arithmetic.power2.pow2.?
                                       (I 260)
                              )))))))))
                              (=>
                               (= (nClip (Add t@ (nClip (Mul n@ l@)))) (nClip (Mul intermediate@ (vstd!arithmetic.power2.pow2.?
                               ...
                               (=>
                                (= tmp%34 (= (nClip (Add (nClip (Mul intermediate@ (vstd!arithmetic.power2.pow2.? (I 260))))
                                    0
                                   )
                                  ) (nClip (Add t@ (nClip (Mul n@ l@))))
                                ))
