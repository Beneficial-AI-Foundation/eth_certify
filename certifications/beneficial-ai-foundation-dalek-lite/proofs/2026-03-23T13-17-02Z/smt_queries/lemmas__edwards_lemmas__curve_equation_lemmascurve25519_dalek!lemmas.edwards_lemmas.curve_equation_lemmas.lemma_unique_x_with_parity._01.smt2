...
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:2523:9: 2523:15 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::curve_equation_lemmas::lemma_unique_x_with_parity
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:2523:9: 2523:15 (#0)
...
(push)
 ...
 (declare-const b@ Int)
 (declare-const d@ Int)
 (declare-const x1sq@ Int)
 (declare-const x2sq@ Int)
 ...
 (assert
  (not (=>
    (= su@ (Add (Mul pu@ (EucDiv su@ pu@)) (EucMod su@ pu@)))
    (=>
     (= (EucMod su@ pu@) 0)
     (=>
      (= su@ (Sub (Add y2@ pu@) 1))
