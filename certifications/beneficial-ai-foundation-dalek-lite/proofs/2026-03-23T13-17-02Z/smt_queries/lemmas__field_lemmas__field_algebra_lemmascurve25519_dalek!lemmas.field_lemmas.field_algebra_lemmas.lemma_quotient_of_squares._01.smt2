...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:1211:1: 1211:55 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_quotient_of_squares
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:1211:1: 1211:55 (#0)
...
(push)
 ...
 (declare-const inv_b2@ Int)
 (declare-const a_div_b@ Int)
 (assert
  fuel_defaults
 )
 (assert
    ...
    (=>
     ...
     (=>
      ...
      (=>
       ...
       (=>
        (= inv_b2@ (curve25519_dalek!specs.field_specs.field_inv.? (I b2@)))
        (=>
         (= a_div_b@ (curve25519_dalek!specs.field_specs.field_mul.? (I a!) (I inv_b@)))
         (and
          (=>
           (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_inv_of_product.
            b! b!
           ...
           (=>
            %%location_label%%0
            (= inv_b2@ (curve25519_dalek!specs.field_specs.field_square.? (I inv_b@)))
          ))
          (=>
           (= inv_b2@ (curve25519_dalek!specs.field_specs.field_square.? (I inv_b@)))
           (and
            (=>
             ...
             (=>
              %%location_label%%1
              (= (curve25519_dalek!specs.field_specs.field_mul.? (I a2@) (I (curve25519_dalek!specs.field_specs.field_square.?
                  (I inv_b@)
                ))
               ) (curve25519_dalek!specs.field_specs.field_square.? (I a_div_b@))
            )))
            (=>
             (= (curve25519_dalek!specs.field_specs.field_mul.? (I a2@) (I (curve25519_dalek!specs.field_specs.field_square.?
                 (I inv_b@)
             ...
             (=>
              (= tmp%1 (= (curve25519_dalek!specs.field_specs.field_mul.? (I a2@) (I inv_b2@)) (curve25519_dalek!specs.field_specs.field_mul.?
                 (I a2@) (I (curve25519_dalek!specs.field_specs.field_square.? (I inv_b@)))
              )))
              (and
               (=>
                %%location_label%%2
