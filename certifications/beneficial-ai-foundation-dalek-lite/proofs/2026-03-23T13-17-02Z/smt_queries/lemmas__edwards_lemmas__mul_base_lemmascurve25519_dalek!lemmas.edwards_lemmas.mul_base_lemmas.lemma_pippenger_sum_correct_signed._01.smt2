...
;; curve25519-dalek/src/lemmas/edwards_lemmas/mul_base_lemmas.rs:875:1: 875:88 (#0)
...
;; Function-Specs curve25519_dalek::lemmas::edwards_lemmas::mul_base_lemmas::lemma_pippenger_sum_correct_signed
(declare-fun req%curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.lemma_pippenger_sum_correct_signed.
 (vstd!seq.Seq<i8.>. tuple%2.) Bool
)
(declare-const %%global_location_label%%46 Bool)
(assert
 (forall ((digits! vstd!seq.Seq<i8.>.) (basepoint! tuple%2.)) (!
   (= (req%curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.lemma_pippenger_sum_correct_signed.
     digits! basepoint!
    ) (=>
     %%global_location_label%%46
     (= (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!)) 64)
   ))
   :pattern ((req%curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.lemma_pippenger_sum_correct_signed.
     digits! basepoint!
   ))
   :qid internal_req__curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.lemma_pippenger_sum_correct_signed._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.lemma_pippenger_sum_correct_signed._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.lemma_pippenger_sum_correct_signed.
 (vstd!seq.Seq<i8.>. tuple%2.) Bool
)
(assert
 (forall ((digits! vstd!seq.Seq<i8.>.) (basepoint! tuple%2.)) (!
   (= (ens%curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.lemma_pippenger_sum_correct_signed.
     digits! basepoint!
    ) (= (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.pippenger_partial.? (Poly%vstd!seq.Seq<i8.>.
       digits!
      ) (I 64) (Poly%tuple%2. basepoint!)
     ) (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul_signed.? (Poly%tuple%2.
       basepoint!
      ) (I (curve25519_dalek!specs.scalar_specs.reconstruct_radix_16.? (Poly%vstd!seq.Seq<i8.>.
         digits!
   ))))))
   :pattern ((ens%curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.lemma_pippenger_sum_correct_signed.
     digits! basepoint!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.lemma_pippenger_sum_correct_signed._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.lemma_pippenger_sum_correct_signed._definition
)))

;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::mul_base_lemmas::lemma_pippenger_sum_correct_signed
;; curve25519-dalek/src/lemmas/edwards_lemmas/mul_base_lemmas.rs:875:1: 875:88 (#0)
...
(push)
 ...
 (declare-const n@ Int)
 (declare-const odd_sum@ tuple%2.)
 (declare-const even_sum@ tuple%2.)
 (declare-const scaled@ tuple%2.)
 (assert
  fuel_defaults
 )
 (assert
 ...
 (assert
  (not (=>
    (= n@ 32)
    (=>
     (= tmp%1 (>= (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!)) (nClip
        (Mul 2 n@)
     )))
     (and
      (=>
      ...
      (=>
       ...
       (=>
        (fuel_bool fuel%curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.pippenger_partial.)
        (=>
         (= odd_sum@ (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.odd_sum_up_to.?
           (Poly%vstd!seq.Seq<i8.>. digits!) (I 64) (Poly%tuple%2. basepoint!)
         ))
         (=>
          (= even_sum@ (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.even_sum_up_to.?
            (Poly%vstd!seq.Seq<i8.>. digits!) (I 64) (Poly%tuple%2. basepoint!)
          ...
          (and
           (and
            ...
            (=>
             ...
             (=>
              %%location_label%%2
              (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. odd_sum@) (Poly%tuple%2. (
                 curve25519_dalek!specs.edwards_specs.edwards_scalar_mul_signed.? (Poly%tuple%2. basepoint!)
                 (I (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_odd_scalar.? (Poly%vstd!seq.Seq<i8.>.
                    digits!
                   ) (I n@)
           ))))))))
           (=>
            (= odd_sum@ (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul_signed.? (Poly%tuple%2.
               basepoint!
              ) (I (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_odd_scalar.? (
                 Poly%vstd!seq.Seq<i8.>. digits!
                ) (I n@)
            ...
            (and
             (and
              ...
              (=>
               ...
               (=>
                %%location_label%%4
                (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. even_sum@) (Poly%tuple%2.
                  (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul_signed.? (Poly%tuple%2. basepoint!)
             ...
             (=>
              (= even_sum@ (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul_signed.? (Poly%tuple%2.
                 basepoint!
                ) (I (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_even_scalar.?
                  (Poly%vstd!seq.Seq<i8.>. digits!) (I n@)
              ))))
              (=>
               (= scaled@ (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2.
                  odd_sum@
                 ) (I 16)
               ))
               (and
                (=>
                 (= tmp%2 (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_odd_scalar.?
                   (Poly%vstd!seq.Seq<i8.>. digits!) (I n@)
                 ))
                 (=>
                  (ens%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_edwards_scalar_mul_signed_composition.
                  ...
                  (=>
                   %%location_label%%5
                   (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. scaled@) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul_signed.?
                      (Poly%tuple%2. basepoint!) (I (Mul (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_odd_scalar.?
                         (Poly%vstd!seq.Seq<i8.>. digits!) (I n@)
                        ) 16
                ))))))))
                (=>
                 (= scaled@ (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul_signed.? (Poly%tuple%2.
                    basepoint!
                   ) (I (Mul (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_odd_scalar.?
                      (Poly%vstd!seq.Seq<i8.>. digits!) (I n@)
                     ) 16
                 ))))
                 (and
                  (=>
                   (= tmp%3 (Mul (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_odd_scalar.?
                      (Poly%vstd!seq.Seq<i8.>. digits!) (I n@)
                     ) 16
                   ))
                   (=>
                    (= tmp%4 (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_even_scalar.?
                      (Poly%vstd!seq.Seq<i8.>. digits!) (I n@)
                    ))
                    (=>
                     (ens%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.axiom_edwards_scalar_mul_signed_additive.
                      basepoint! tmp%3 tmp%4
                     )
                     (=>
                      %%location_label%%6
                      (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_add.?
                         (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. scaled@))) (tuple%2./tuple%2/1
                          (%Poly%tuple%2. (Poly%tuple%2. scaled@))
                         ) (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. even_sum@))) (tuple%2./tuple%2/1
                          (%Poly%tuple%2. (Poly%tuple%2. even_sum@))
                        ))
                       ) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul_signed.?
                         (Poly%tuple%2. basepoint!) (I (Add (Mul (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_odd_scalar.?
                             (Poly%vstd!seq.Seq<i8.>. digits!) (I n@)
                            ) 16
                  ...
                  (=>
                   (= (curve25519_dalek!specs.edwards_specs.edwards_add.? (tuple%2./tuple%2/0 (%Poly%tuple%2.
                      ...
                      basepoint!
                     ) (I (Add (Mul (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_odd_scalar.?
                         (Poly%vstd!seq.Seq<i8.>. digits!) (I n@)
                        ) 16
                       ) (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_even_scalar.? (Poly%vstd!seq.Seq<i8.>.
                         digits!
                   ...
                   (=>
                    (= tmp%5 (ext_eq false (TYPE%vstd!seq.Seq. $ (SINT 8)) (vstd!seq.Seq.subrange.? $ (SINT
                        8
                       ) (Poly%vstd!seq.Seq<i8.>. digits!) (I 0) (I 64)
                      ) (Poly%vstd!seq.Seq<i8.>. digits!)
                    ))
                    (and
                     (=>
                       ...
                       (and
                        ...
                        (=>
                         ...
                         (=>
                          %%location_label%%9
                          (= (curve25519_dalek!specs.scalar_specs.reconstruct_radix_16.? (vstd!seq.Seq.subrange.?
                             $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I 0) (I 64)
                            )
                           ) (Add (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_even_scalar.?
                             (Poly%vstd!seq.Seq<i8.>. digits!) (I n@)
                            ) (Mul 16 (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_odd_scalar.?
                        ...
                        (=>
                         ...
                         (and
                          ...
                          (=>
                           ...
                           (and
                            (=>
                             (= tmp%7 (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_odd_scalar.?
                               (Poly%vstd!seq.Seq<i8.>. digits!) (I n@)
                             ))
                             (=>
                              (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. tmp%7 16)
                              (=>
                               %%location_label%%11
                               (= (Add (Mul (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_odd_scalar.?
                                   (Poly%vstd!seq.Seq<i8.>. digits!) (I n@)
                                  ) 16
                                 ) (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_even_scalar.? (Poly%vstd!seq.Seq<i8.>.
                                   digits!
                            ...
                            (=>
                             ...
                             (=>
                              (= tmp%8 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.pippenger_partial.?
                                  (Poly%vstd!seq.Seq<i8.>. digits!) (I 64) (Poly%tuple%2. basepoint!)
                                 )
                              ...
                              (and
                               ...
                               (=>
                                tmp%8
                                (=>
                                 (= tmp%9 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul_signed.?
                                     (Poly%tuple%2. basepoint!) (I (Add (Mul (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_odd_scalar.?
                                         (Poly%vstd!seq.Seq<i8.>. digits!) (I n@)
                                        ) 16
                                       ) (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_even_scalar.? (Poly%vstd!seq.Seq<i8.>.
                                     ...
                                     (Poly%tuple%2. basepoint!) (I (curve25519_dalek!specs.scalar_specs.reconstruct_radix_16.?
                                       (Poly%vstd!seq.Seq<i8.>. digits!)
                                 ))))))
                                 (and
                                  (=>
                                  ...
                                  (=>
                                   ...
                                   (=>
                                    %%location_label%%14
                                    (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.pippenger_partial.?
                                       (Poly%vstd!seq.Seq<i8.>. digits!) (I 64) (Poly%tuple%2. basepoint!)
                                      )
                                     ) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul_signed.?
                                       (Poly%tuple%2. basepoint!) (I (curve25519_dalek!specs.scalar_specs.reconstruct_radix_16.?
