...
;; curve25519-dalek/src/backend/serial/u64/field.rs:736:5: 736:77 (#0)
...
;; Function-Def curve25519_dalek::backend::serial::u64::field::FieldElement51::conditional_assign
;; curve25519-dalek/src/backend/serial/u64/field.rs:736:5: 736:77 (#0)
(get-info :all-statistics)
(push)
 (declare-const self!@0 curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const other! curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 ...
 (declare-const self0@0 Int)
 (declare-const self1@0 Int)
 (declare-const self2@0 Int)
 (declare-const self3@0 Int)
 (declare-const self4@0 Int)
 (assert
  fuel_defaults
 )
 (assert
  (has_type (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. self!@0)
   TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.
 ))
 (assert
  (has_type (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. other!)
   TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.
 ))
 (declare-const self0@1 Int)
 (declare-const self!@1 curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const self1@1 Int)
 (declare-const self!@2 curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const self2@1 Int)
 (declare-const self!@3 curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const self3@1 Int)
 (declare-const self!@4 curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const self4@1 Int)
 (declare-const self!@5 curve25519_dalek!backend.serial.u64.field.FieldElement51.)
        ...
        (and
         ...
         (=>
          ...
          (=>
           (uInv 64 self0@1)
           (=>
            (ens%curve25519_dalek!backend.serial.u64.subtle_assumes.conditional_assign_u64. self0@0
             self0@1 (%I tmp%3) choice!
            )
            (and
             (=>
              %%location_label%%2
             ...
             (=>
              (has_type (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. self!@1)
               TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.
              )
              (=>
                    ...
                    (and
                     ...
                     (=>
                      ...
                      (=>
                       (uInv 64 self1@1)
                       (=>
                        (ens%curve25519_dalek!backend.serial.u64.subtle_assumes.conditional_assign_u64. self1@0
                         self1@1 (%I tmp%7) choice!
                        )
                        (and
                         (=>
                          %%location_label%%5
                         ...
                         (=>
                          (has_type (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. self!@2)
                           TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                          )
                          (=>
                           (ens%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                ...
                                (and
                                 ...
                                 (=>
                                  ...
                                  (=>
                                   (uInv 64 self2@1)
                                   (=>
                                    (ens%curve25519_dalek!backend.serial.u64.subtle_assumes.conditional_assign_u64. self2@0
                                     self2@1 (%I tmp%11) choice!
                                    )
                                    (and
                                     (=>
                                      %%location_label%%8
                                     ...
                                     (=>
                                      (has_type (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. self!@3)
                                       TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                      )
                                      (=>
                                       (ens%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                            ...
                                            (and
                                             ...
                                             (=>
                                              ...
                                              (=>
                                               (uInv 64 self3@1)
                                               (=>
                                                (ens%curve25519_dalek!backend.serial.u64.subtle_assumes.conditional_assign_u64. self3@0
                                                 self3@1 (%I tmp%15) choice!
                                                )
                                                (and
                                                 (=>
                                                  %%location_label%%11
                                                 ...
                                                 (=>
                                                  (has_type (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. self!@4)
                                                   TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                                  )
                                                  (=>
                                                   (ens%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                                        ...
                                                        (and
                                                         ...
                                                         (=>
                                                          ...
                                                          (=>
                                                           (uInv 64 self4@1)
                                                           (=>
                                                            (ens%curve25519_dalek!backend.serial.u64.subtle_assumes.conditional_assign_u64. self4@0
                                                             self4@1 (%I tmp%19) choice!
                                                            )
                                                            (and
                                                             (=>
                                                              %%location_label%%14
                                                             ...
                                                             (=>
                                                              (has_type (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. self!@5)
                                                               TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                                              )
                                                              (=>
                                                               (ens%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
