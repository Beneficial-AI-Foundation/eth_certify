...
;; curve25519-dalek/src/lemmas/scalar_lemmas_/radix16_lemmas.rs:234:1: 234:72 (#0)
...
;; Function-Specs curve25519_dalek::lemmas::scalar_lemmas_::radix16_lemmas::lemma_valid_radix_16_implies_all_bounded
(declare-fun req%curve25519_dalek!lemmas.scalar_lemmas_.radix16_lemmas.lemma_valid_radix_16_implies_all_bounded.
 (%%Function%%) Bool
)
(declare-const %%global_location_label%%22 Bool)
(assert
 (forall ((digits! %%Function%%)) (!
   (= (req%curve25519_dalek!lemmas.scalar_lemmas_.radix16_lemmas.lemma_valid_radix_16_implies_all_bounded.
     digits!
    ) (=>
     %%global_location_label%%22
     (curve25519_dalek!specs.scalar_specs.is_valid_radix_16.? (Poly%array%. digits!))
   ))
   :pattern ((req%curve25519_dalek!lemmas.scalar_lemmas_.radix16_lemmas.lemma_valid_radix_16_implies_all_bounded.
     digits!
   ))
   :qid internal_req__curve25519_dalek!lemmas.scalar_lemmas_.radix16_lemmas.lemma_valid_radix_16_implies_all_bounded._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.scalar_lemmas_.radix16_lemmas.lemma_valid_radix_16_implies_all_bounded._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.scalar_lemmas_.radix16_lemmas.lemma_valid_radix_16_implies_all_bounded.
 (%%Function%%) Bool
)
(assert
 (forall ((digits! %%Function%%)) (!
   (= (ens%curve25519_dalek!lemmas.scalar_lemmas_.radix16_lemmas.lemma_valid_radix_16_implies_all_bounded.
     digits!
    ) (curve25519_dalek!specs.scalar_specs.radix_16_all_bounded.? (Poly%array%. digits!))
   )
   :pattern ((ens%curve25519_dalek!lemmas.scalar_lemmas_.radix16_lemmas.lemma_valid_radix_16_implies_all_bounded.
     digits!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.scalar_lemmas_.radix16_lemmas.lemma_valid_radix_16_implies_all_bounded._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.scalar_lemmas_.radix16_lemmas.lemma_valid_radix_16_implies_all_bounded._definition
)))

;; Function-Def curve25519_dalek::lemmas::scalar_lemmas_::radix16_lemmas::lemma_valid_radix_16_implies_all_bounded
;; curve25519-dalek/src/lemmas/scalar_lemmas_/radix16_lemmas.rs:234:1: 234:72 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= tmp%1 (curve25519_dalek!specs.scalar_specs.is_valid_radix_2w.? (Poly%array%. digits!)
      (I 4) (I 64)
    ))
    (and
     (=>
      ...
      (and
           ...
           (or
            (and
             (=>
              ...
              (=>
               (= tmp%2 (and
                 (<= (Sub 0 8) (%I (vstd!seq.Seq.index.? $ (SINT 8) (vstd!view.View.view.? $ (ARRAY $ (
                       SINT 8
                      ) $ (CONST_INT 64)
                     ) (Poly%array%. digits!)
                    ) i@
               ...
               (and
                ...
                (=>
                 tmp%2
                 (=>
                  (= tmp%3 (<= (%I (vstd!seq.Seq.index.? $ (SINT 8) (vstd!view.View.view.? $ (ARRAY $ (SINT
                         8
                        ) $ (CONST_INT 64)
                       ) (Poly%array%. digits!)
                      ) i@
       ...
       (=>
        (forall ((i$ Poly)) (!
          ...
          :qid user_curve25519_dalek__lemmas__scalar_lemmas___radix16_lemmas__lemma_valid_radix_16_implies_all_bounded_50
          :skolemid skolem_user_curve25519_dalek__lemmas__scalar_lemmas___radix16_lemmas__lemma_valid_radix_16_implies_all_bounded_50
        ))
        (=>
         (= tmp%6 (curve25519_dalek!specs.scalar_specs.radix_16_all_bounded.? (Poly%array%. digits!)))
         (and
          (=>
           %%location_label%%7
           tmp%6
