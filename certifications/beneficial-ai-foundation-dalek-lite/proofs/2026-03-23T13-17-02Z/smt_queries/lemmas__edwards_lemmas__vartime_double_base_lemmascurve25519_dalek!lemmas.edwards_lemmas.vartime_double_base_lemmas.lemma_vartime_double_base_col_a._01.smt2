...
;; curve25519-dalek/src/lemmas/edwards_lemmas/vartime_double_base_lemmas.rs:61:1: 67:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::vartime_double_base_lemmas::lemma_vartime_double_base_col_a
;; curve25519-dalek/src/lemmas/edwards_lemmas/vartime_double_base_lemmas.rs:61:1: 67:2 (#0)
(get-info :all-statistics)
(push)
 (declare-const pts_affine! vstd!seq.Seq<tuple%2<nat./nat.>.>.)
 (declare-const nafs! vstd!seq.Seq<vstd!seq.Seq<i8.>.>.)
 (declare-const A_affine! tuple%2.)
 (declare-const a_naf! vstd!seq.Seq<i8.>.)
 (declare-const i! Int)
 ...
 (assert
  (has_type (Poly%tuple%2. A_affine!) (TYPE%tuple%2. $ NAT $ NAT))
 )
 (assert
  (let
   ((tmp%%$ i!))
    ...
    (=>
     ...
     (=>
      (= tmp%1 (%Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. (vstd!seq.Seq.push.? (DST $) (TYPE%tuple%2.
          $ NAT $ NAT
         ) (vstd!seq.Seq.empty.? (DST $) (TYPE%tuple%2. $ NAT $ NAT)) (Poly%tuple%2. A_affine!)
      )))
      (=>
       ...
       (and
        (=>
         %%location_label%%1
         (req%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_column_sum_prefix_eq.
          tmp%1 tmp%2 pts_affine! nafs! i! 1
        ))
        (=>
         (ens%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_column_sum_prefix_eq.
          tmp%1 tmp%2 pts_affine! nafs! i! 1
         ...
         (=>
          ...
          (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.straus_column_sum.?
             ...
             (Poly%tuple%2. A_affine!) (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
               a_naf!
              ) (I i!)
 )))))))))))))
 (get-info :version)
