...
;; curve25519-dalek/src/lemmas/edwards_lemmas/straus_lemmas.rs:1087:1: 1087:73 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::straus_lemmas::lemma_straus_vt_single
;; curve25519-dalek/src/lemmas/edwards_lemmas/straus_lemmas.rs:1087:1: 1087:73 (#0)
...
(push)
 ...
 (declare-const prev_result@ tuple%2.)
      ...
      (=>
       ...
       (=>
        ...
        (=>
         ...
         (=>
          (ens%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_vt_base. tmp%1
           tmp%2
          )
          (=>
           (fuel_bool fuel%curve25519_dalek!specs.edwards_specs.edwards_scalar_mul_signed.)
       ...
       (=>
        ...
        (=>
         ...
         (and
          (=>
           %%location_label%%0
           (req%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_vt_step. tmp%3
            tmp%4 i!
          ))
          (=>
           (ens%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_vt_step. tmp%3
            tmp%4 i!
           )
           (=>
            (= tmp%5 (Add i! 1))
            (and
             ...
             (and
              ...
              (=>
               ...
               (=>
                (= r_next@ (curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.reconstruct_naf_from.?
                  (Poly%vstd!seq.Seq<i8.>. naf!) (I (Add i! 1))
                ))
                (=>
                 (= prev_result@ (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul_signed.? (
                    Poly%tuple%2. P!
                   ) (I r_next@)
                 ))
                 (=>
                   ...
                   (and
                    ...
                    (=>
                     ...
                     (=>
                      (= tmp%6 (Mul 2 r_next@))
                      (=>
                       (= tmp%7 (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. naf!) (I i!))))
                       (=>
                        (ens%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.axiom_edwards_scalar_mul_signed_additive.
                         P! tmp%6 tmp%7
                        )
                        (=>
                         (= tmp%8 (= (Add (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. naf!) (
                               I i!
                             ))
                            ) (Mul 2 r_next@)
     ...
     (and
      ...
      (=>
       ...
       (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.straus_vt_partial.?
          ...
          (Poly%tuple%2. P!) (I (curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.reconstruct_naf_from.?
            (Poly%vstd!seq.Seq<i8.>. naf!) (I i!)
 )))))))))))
 (get-info :version)
