...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:965:1: 965:49 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_field_mul_neg
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:965:1: 965:49 (#0)
        ...
        (=>
         ...
         (and
          (and
           (=>
            %%location_label%%1
            (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. c! neg_b_raw@ p@)
           )
           (=>
            (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. c! neg_b_raw@ p@)
            (=>
             %%location_label%%2
             (= (curve25519_dalek!specs.field_specs.field_mul.? (I c!) (I (curve25519_dalek!specs.field_specs.field_neg.?
                 (I b!)
               ))
              ) (EucMod (nClip (Mul c! neg_b_raw@)) p@)
          ))))
          (=>
           (= (curve25519_dalek!specs.field_specs.field_mul.? (I c!) (I (curve25519_dalek!specs.field_specs.field_neg.?
               (I b!)
           ...
           (and
            (=>
             ...
             (and
              (=>
               %%location_label%%3
               (req%vstd!arithmetic.div_mod.lemma_mod_twice. tmp%1 p@)
              )
              (=>
               (ens%vstd!arithmetic.div_mod.lemma_mod_twice. tmp%1 p@)
               (=>
                %%location_label%%4
                (= (curve25519_dalek!specs.field_specs.field_neg.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                    (I c!) (I b!)
                  ))
                 ) (EucMod (nClip (Sub p@ (EucMod (nClip (Mul c! b!)) p@))) p@)
            )))))
            (=>
             (= (curve25519_dalek!specs.field_specs.field_neg.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                 (I c!) (I b!)
