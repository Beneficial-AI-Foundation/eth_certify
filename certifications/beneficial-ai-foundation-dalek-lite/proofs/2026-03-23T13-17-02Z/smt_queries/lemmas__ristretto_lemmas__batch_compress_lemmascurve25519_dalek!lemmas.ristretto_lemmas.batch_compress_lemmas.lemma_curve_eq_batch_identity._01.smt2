...
;; curve25519-dalek/src/lemmas/ristretto_lemmas/batch_compress_lemmas.rs:805:1: 805:59 (#0)
...
;; Function-Def curve25519_dalek::lemmas::ristretto_lemmas::batch_compress_lemmas::lemma_curve_eq_batch_identity
;; curve25519-dalek/src/lemmas/ristretto_lemmas/batch_compress_lemmas.rs:805:1: 805:59 (#0)
...
(push)
 ...
 (declare-const a2b2@ Int)
 (declare-const dab2@ Int)
 (declare-const e@ Int)
 (declare-const g@ Int)
 (declare-const h@ Int)
 (declare-const d_plus_1@ Int)
 (declare-const two_sq@ Int)
 (declare-const sq_g@ Int)
 (declare-const sq_h@ Int)
 (declare-const curve_rhs@ Int)
 (declare-const sq_crhs@ Int)
 (declare-const V@ Int)
 (declare-const W@ Int)
 (declare-const VW@ Int)
 (assert
  fuel_defaults
 )
 (assert
 ...
 (assert
  (not (=>
    (= dd@ (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
       curve25519_dalek!backend.serial.u64.constants.EDWARDS_D.?
    )))
    (and
     (=>
      ...
      (=>
       ...
       (=>
        ...
        (=>
         ...
         (=>
          (= a2b2@ (curve25519_dalek!specs.field_specs.field_mul.? (I a2@) (I b2@)))
          (=>
           (= dab2@ (curve25519_dalek!specs.field_specs.field_mul.? (I dd@) (I a2b2@)))
           (=>
            (= e@ (curve25519_dalek!specs.field_specs.field_mul.? (I 2) (I ab@)))
            (=>
             (= g@ (curve25519_dalek!specs.field_specs.field_add.? (I a2@) (I b2@)))
             (=>
              (= h@ (curve25519_dalek!specs.field_specs.field_sub.? (I 1) (I dab2@)))
              (=>
               (= d_plus_1@ (curve25519_dalek!specs.field_specs.field_add.? (I dd@) (I 1)))
               (=>
                (= two_sq@ (curve25519_dalek!specs.field_specs.field_mul.? (I 2) (I 2)))
                (=>
                 (= sq_g@ (curve25519_dalek!specs.field_specs.field_square.? (I g@)))
                 (=>
                  (= sq_h@ (curve25519_dalek!specs.field_specs.field_square.? (I h@)))
                  (=>
                   (= curve_rhs@ (curve25519_dalek!specs.field_specs.field_add.? (I 1) (I dab2@)))
                   (=>
                    (= tmp%1 (= (curve25519_dalek!specs.field_specs.field_sub.? (I b2@) (I a2@)) curve_rhs@))
                    (and
                     (=>
                      %%location_label%%1
                      tmp%1
                     ...
                     (=>
                      tmp%1
                      (=>
                       (= sq_crhs@ (curve25519_dalek!specs.field_specs.field_square.? (I curve_rhs@)))
                       (=>
                        (= V@ (curve25519_dalek!specs.field_specs.field_mul.? (I two_sq@) (I a2b2@)))
                        (and
                         (=>
                          (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_add_comm.
                           a2@ b2@
                          ...
                          (=>
                           ...
                           (=>
                            ...
                            (=>
                             %%location_label%%2
                             (= (curve25519_dalek!specs.field_specs.field_sub.? (I sq_g@) (I (curve25519_dalek!specs.field_specs.field_square.?
                                 (I (curve25519_dalek!specs.field_specs.field_sub.? (I b2@) (I a2@)))
                               ))
                              ) V@
                         )))))
                         (=>
                          ...
                          (=>
                           (= tmp%2 (= (curve25519_dalek!specs.field_specs.field_sub.? (I sq_g@) (I sq_crhs@))
                             V@
                           ))
                           (and
                            (=>
                            ...
                            (=>
                             tmp%2
                             (=>
                              (= W@ (curve25519_dalek!specs.field_specs.field_mul.? (I two_sq@) (I dab2@)))
                              (and
                               (=>
                                (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_sum_sq_minus_diff_sq.
                                 1 dab2@
                                ...
                                (=>
                                 ...
                                 (and
                                  ...
                                  (=>
                                   ...
                                   (=>
                                    %%location_label%%5
                                    (= (curve25519_dalek!specs.field_specs.field_sub.? (I sq_crhs@) (I sq_h@)) W@)
                               )))))
                               (=>
                                (= (curve25519_dalek!specs.field_specs.field_sub.? (I sq_crhs@) (I sq_h@)) W@)
                                (=>
                                 (= VW@ (curve25519_dalek!specs.field_specs.field_add.? (I V@) (I W@)))
                                 (and
                                  (and
                                   (and
                                    (=>
                                    ...
                                    (=>
                                     ...
                                     (=>
                                      %%location_label%%7
                                      (= (curve25519_dalek!specs.field_specs.field_add.? (I V@) (I sq_crhs@)) sq_g@)
                                   )))
                                   (=>
                                    (= (curve25519_dalek!specs.field_specs.field_add.? (I V@) (I sq_crhs@)) sq_g@)
                                    (and
                                     (and
                                      ...
                                      (=>
                                       ...
                                       (=>
                                        %%location_label%%9
                                        (= (curve25519_dalek!specs.field_specs.field_add.? (I W@) (I sq_h@)) sq_crhs@)
                                     )))
                                     (=>
                                      (= (curve25519_dalek!specs.field_specs.field_add.? (I W@) (I sq_h@)) sq_crhs@)
                                      (and
                                       (=>
                                        ...
                                        (=>
                                         %%location_label%%10
                                         (= sq_g@ (curve25519_dalek!specs.field_specs.field_add.? (I VW@) (I sq_h@)))
                                       ))
                                       (=>
                                        (= sq_g@ (curve25519_dalek!specs.field_specs.field_add.? (I VW@) (I sq_h@)))
                                        (and
                                         ...
                                         (=>
                                          ...
                                          (=>
                                           %%location_label%%12
                                           (= (curve25519_dalek!specs.field_specs.field_sub.? (I sq_g@) (I sq_h@)) VW@)
                                  )))))))))
                                  (=>
                                   (= (curve25519_dalek!specs.field_specs.field_sub.? (I sq_g@) (I sq_h@)) VW@)
                                   (and
                                    (=>
                                     ...
                                     (=>
                                      ...
                                      (=>
                                       %%location_label%%13
                                       (= (curve25519_dalek!specs.field_specs.field_square.? (I e@)) V@)
                                    )))
                                    (=>
                                     (= (curve25519_dalek!specs.field_specs.field_square.? (I e@)) V@)
                                     (and
                                        ...
                                        (=>
                                         ...
                                         (and
                                          ...
                                          (=>
                                           ...
                                           (=>
                                            %%location_label%%15
                                            (= (curve25519_dalek!specs.field_specs.field_mul.? (I a2b2@) (I d_plus_1@)) (curve25519_dalek!specs.field_specs.field_add.?
                                              (I dab2@) (I a2b2@)
                                      ))))))))
                                      (=>
                                       (= (curve25519_dalek!specs.field_specs.field_mul.? (I a2b2@) (I d_plus_1@)) (curve25519_dalek!specs.field_specs.field_add.?
                                         ...
                                         (=>
                                          ...
                                          (=>
                                           ...
                                           (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_square.?
                                            ...
                                            ) (curve25519_dalek!specs.field_specs.field_add.? (I W@) (I V@))
                                        ))))
                                        (=>
                                         (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_square.?
                                             (I e@)
                                         ...
                                         (and
                                          (=>
                                           ...
                                           (=>
                                            %%location_label%%17
                                            (= (curve25519_dalek!specs.field_specs.field_sub.? (I sq_g@) (I sq_h@)) (curve25519_dalek!specs.field_specs.field_mul.?
                                              (I (curve25519_dalek!specs.field_specs.field_square.? (I e@))) (I d_plus_1@)
                                          ))))
                                          (=>
                                           (= (curve25519_dalek!specs.field_specs.field_sub.? (I sq_g@) (I sq_h@)) (curve25519_dalek!specs.field_specs.field_mul.?
                                             (I (curve25519_dalek!specs.field_specs.field_square.? (I e@))) (I d_plus_1@)
                                           ...
                                           (and
                                            (=>
                                             ...
                                             (=>
                                              %%location_label%%18
                                              (= (curve25519_dalek!specs.field_specs.field_sub.? (I sq_h@) (I sq_g@)) (curve25519_dalek!specs.field_specs.field_neg.?
