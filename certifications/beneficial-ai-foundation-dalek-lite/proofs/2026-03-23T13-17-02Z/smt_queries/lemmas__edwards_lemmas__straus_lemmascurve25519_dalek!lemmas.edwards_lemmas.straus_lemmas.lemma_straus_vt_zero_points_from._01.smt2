...
;; curve25519-dalek/src/lemmas/edwards_lemmas/straus_lemmas.rs:1188:1: 1188:96 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::straus_lemmas::lemma_straus_vt_zero_points_from
;; curve25519-dalek/src/lemmas/edwards_lemmas/straus_lemmas.rs:1188:1: 1188:96 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= decrease%init0 (Sub 256 i!))
    (or
     (and
      (=>
       (>= i! 256)
       (=>
        (ens%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_vt_base. pts!
         nafs!
        )
        %%switch_label%%0
      ))
      (=>
       ...
       (and
        (=>
         %%location_label%%0
         (req%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_vt_step. pts!
          nafs! i!
        ))
        (=>
         (ens%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_vt_step. pts!
          nafs! i!
         )
         (=>
          (= tmp%1 (Add i! 1))
          (and
           (=>
            ...
            (check_decrease_int (let
              ((pts!$0 pts!) (nafs!$1 nafs!) (i!$2 tmp%1))
              (Sub 256 i!$2)
