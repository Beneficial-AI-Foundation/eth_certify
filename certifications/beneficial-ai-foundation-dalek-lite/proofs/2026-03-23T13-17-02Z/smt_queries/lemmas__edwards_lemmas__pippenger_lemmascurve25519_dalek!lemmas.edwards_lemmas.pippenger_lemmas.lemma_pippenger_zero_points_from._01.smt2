...
;; curve25519-dalek/src/lemmas/edwards_lemmas/pippenger_lemmas.rs:302:1: 308:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::pippenger_lemmas::lemma_pippenger_zero_points_from
;; curve25519-dalek/src/lemmas/edwards_lemmas/pippenger_lemmas.rs:302:1: 308:2 (#0)
       ...
       (=>
        ...
        (and
          ...
          (and
           (=>
            ...
            (check_decrease_int (let
              ((pts!$0 pts!) (digs!$1 digs!) (j!$2 tmp%1) (w!$3 w!) (digits_count!$4 digits_count!))
         ...
         (=>
          (= (curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.pippenger_horner.? (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>.
             pts!
            ) (Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>. digs!) (I (Add j! 1)) (I w!) (I digits_count!)
           ) (curve25519_dalek!specs.edwards_specs.edwards_identity.? (I 0))
          )
          (and
           (=>
             ...
             (and
                ...
                (=>
                 ...
                 (=>
                  ...
                  (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_add.?
                     (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. id@))) (tuple%2./tuple%2/1 (%Poly%tuple%2.
                       (Poly%tuple%2. id@)
                      )
                     ) (I 0) (I 1)
                    )
              ...
              (=>
               (= (curve25519_dalek!specs.edwards_specs.edwards_add.? (tuple%2./tuple%2/0 (%Poly%tuple%2.
                 ...
                 ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. id@))) (I 0) (I 1)
                ) id@
               )
               %%switch_label%%0
      )))))))))
