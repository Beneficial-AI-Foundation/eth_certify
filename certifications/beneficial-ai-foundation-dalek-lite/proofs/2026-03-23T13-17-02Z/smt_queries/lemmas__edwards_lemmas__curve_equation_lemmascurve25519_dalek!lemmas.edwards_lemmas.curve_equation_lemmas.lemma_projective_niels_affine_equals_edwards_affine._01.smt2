...
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:2397:1: 2400:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::curve_equation_lemmas::lemma_projective_niels_affine_equals_edwards_affine
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:2397:1: 2400:2 (#0)
                         ...
                         (=>
                          ...
                          (and
                           (=>
                            (ens%curve25519_dalek!specs.field_specs_u64.p_gt_2. 0)
                            (=>
                             (= tmp%6 (curve25519_dalek!specs.field_specs.fe51_as_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                (curve25519_dalek!edwards.EdwardsPoint./EdwardsPoint/Y (%Poly%curve25519_dalek!edwards.EdwardsPoint.
                                  (Poly%curve25519_dalek!edwards.EdwardsPoint. point!)
                             )))))
                             (=>
                            ...
                            (and
                             (=>
                              ...
                              (and
                               (=>
                                %%location_label%%8
                                (req%vstd!arithmetic.div_mod.lemma_small_mod. x@ tmp%8)
                               )
                               (=>
                                (ens%vstd!arithmetic.div_mod.lemma_small_mod. x@ tmp%8)
                                (=>
                                 %%location_label%%9
                                 (= x_proj@ x@)
                             ))))
                              ...
                              (and
                               (=>
                                ...
                                (and
                                 (=>
                                  %%location_label%%10
                                  (req%vstd!arithmetic.div_mod.lemma_small_mod. y@ tmp%9)
                                 )
                                 (=>
                                  (ens%vstd!arithmetic.div_mod.lemma_small_mod. y@ tmp%9)
                                  (=>
                                   %%location_label%%11
                                   (= y_proj@ y@)
                               ))))
