...
;; curve25519-dalek/src/lemmas/field_lemmas/limbs_to_bytes_lemmas.rs:66:7: 66:74 (#0)
...
;; Function-Specs curve25519_dalek::lemmas::field_lemmas::limbs_to_bytes_lemmas::lemma_byte_sum_equals_limb_sum
(declare-fun req%curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.lemma_byte_sum_equals_limb_sum.
 (%%Function%% %%Function%%) Bool
)
...
(assert
 (forall ((limbs! %%Function%%) (bytes! %%Function%%)) (!
   (= (req%curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.lemma_byte_sum_equals_limb_sum.
     limbs! bytes!
    ) (and
     (=>
      ...
      (forall ((i$ Poly)) (!
        ...
        :qid user_curve25519_dalek__lemmas__field_lemmas__limbs_to_bytes_lemmas__lemma_byte_sum_equals_limb_sum_124
        :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__limbs_to_bytes_lemmas__lemma_byte_sum_equals_limb_sum_124
     )))
     (=>
   ...
   :pattern ((req%curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.lemma_byte_sum_equals_limb_sum.
     limbs! bytes!
   ))
   :qid internal_req__curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.lemma_byte_sum_equals_limb_sum._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.lemma_byte_sum_equals_limb_sum._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.lemma_byte_sum_equals_limb_sum.
 (%%Function%% %%Function%%) Bool
)
(assert
 (forall ((limbs! %%Function%%) (bytes! %%Function%%)) (!
   (= (ens%curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.lemma_byte_sum_equals_limb_sum.
     limbs! bytes!
    ) (= (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. bytes!)) (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.?
      (Poly%array%. limbs!)
   )))
   :pattern ((ens%curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.lemma_byte_sum_equals_limb_sum.
     limbs! bytes!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.lemma_byte_sum_equals_limb_sum._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.lemma_byte_sum_equals_limb_sum._definition
)))

;; Function-Def curve25519_dalek::lemmas::field_lemmas::limbs_to_bytes_lemmas::lemma_byte_sum_equals_limb_sum
;; curve25519-dalek/src/lemmas/field_lemmas/limbs_to_bytes_lemmas.rs:66:7: 66:74 (#0)
...
(push)
 ...
 (declare-const limb0_contribution@ Int)
 (declare-const limb1_contribution@ Int)
 (declare-const limb2_contribution@ Int)
 (declare-const limb3_contribution@ Int)
 (declare-const limb4_contribution@ Int)
 (assert
  fuel_defaults
 )
 (assert
 ...
 (assert
  (forall ((i$ Poly)) (!
    ...
    :qid user_curve25519_dalek__lemmas__field_lemmas__limbs_to_bytes_lemmas__lemma_byte_sum_equals_limb_sum_125
    :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__limbs_to_bytes_lemmas__lemma_byte_sum_equals_limb_sum_125
 )))
 (assert
  (curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.bytes_match_limbs_packing.?
   (Poly%array%. limbs!) (Poly%array%. bytes!)
 ...
 (assert
  (not (=>
    ...
    (=>
     (ens%vstd!arithmetic.power2.lemma_pow2_adds. 48 3)
     (=>
      (= limb0_contribution@ (curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.limb0_byte_contribution.?
        (Poly%array%. limbs!) (Poly%array%. bytes!)
      ))
      (=>
       (= limb1_contribution@ (curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.limb1_byte_contribution.?
         (Poly%array%. limbs!) (Poly%array%. bytes!)
       ))
       (=>
        (= limb2_contribution@ (curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.limb2_byte_contribution.?
          (Poly%array%. limbs!) (Poly%array%. bytes!)
        ))
        (=>
         (= limb3_contribution@ (curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.limb3_byte_contribution.?
           (Poly%array%. limbs!) (Poly%array%. bytes!)
         ))
         (=>
          (= limb4_contribution@ (curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.limb4_byte_contribution.?
            (Poly%array%. limbs!) (Poly%array%. bytes!)
          ))
          (and
           (=>
                   ...
                   (=>
                    ...
                    (and
                     ...
                     (=>
                      ...
                      (=>
                       (= tmp%1 (= (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. bytes!))
                         (nClip (Add (nClip (Add (nClip (Add (nClip (Add limb0_contribution@ limb1_contribution@))
                               limb2_contribution@
                              )
                             ) limb3_contribution@
                            )
