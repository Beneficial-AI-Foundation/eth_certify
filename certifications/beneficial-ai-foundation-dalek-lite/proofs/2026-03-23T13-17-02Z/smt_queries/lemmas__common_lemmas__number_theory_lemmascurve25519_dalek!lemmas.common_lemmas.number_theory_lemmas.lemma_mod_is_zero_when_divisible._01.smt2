...
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:410:7: 410:58 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::number_theory_lemmas::lemma_mod_is_zero_when_divisible
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:410:7: 410:58 (#0)
    ...
    (and
     (=>
      ...
      (and
       (=>
        %%location_label%%0
        (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. n! d!)
       )
       (=>
        (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. n! d!)
        (=>
         (= tmp%1 (= n! (Add (Mul (EucDiv n! d!) d!) (EucMod n! d!))))
         (and
          (=>
           %%location_label%%1
           tmp%1
                    ...
                    (and
                     ...
                     (=>
                      ...
                      (=>
                       (= tmp%6 (EucDiv n! d!))
                       (=>
                        (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. tmp%6 d!)
                        %%switch_label%%0
     )))))))))))))))))))
     (=>
      (not (> n! 0))
