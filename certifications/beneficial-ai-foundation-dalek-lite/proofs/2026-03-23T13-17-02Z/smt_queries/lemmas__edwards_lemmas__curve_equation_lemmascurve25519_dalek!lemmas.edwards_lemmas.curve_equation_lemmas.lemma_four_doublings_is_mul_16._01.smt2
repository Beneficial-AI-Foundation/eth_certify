...
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:1130:1: 1136:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::curve_equation_lemmas::lemma_four_doublings_is_mul_16
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:1130:1: 1136:2 (#0)
(get-info :all-statistics)
(push)
 (declare-const a0! tuple%2.)
 (declare-const a1! tuple%2.)
 (declare-const a2! tuple%2.)
 (declare-const a3! tuple%2.)
 (declare-const a4! tuple%2.)
 (assert
  fuel_defaults
 )
 (assert
  (has_type (Poly%tuple%2. a0!) (TYPE%tuple%2. $ NAT $ NAT))
 )
 (assert
  (has_type (Poly%tuple%2. a1!) (TYPE%tuple%2. $ NAT $ NAT))
 )
 (assert
  (has_type (Poly%tuple%2. a2!) (TYPE%tuple%2. $ NAT $ NAT))
 )
 (assert
  (has_type (Poly%tuple%2. a3!) (TYPE%tuple%2. $ NAT $ NAT))
 )
 (assert
  (has_type (Poly%tuple%2. a4!) (TYPE%tuple%2. $ NAT $ NAT))
 )
 (assert
  (= a1! (curve25519_dalek!specs.edwards_specs.edwards_double.? (tuple%2./tuple%2/0 (%Poly%tuple%2.
      (Poly%tuple%2. a0!)
 ...
 (assert
  (not (=>
    ...
    (and
     ...
     (=>
      (= (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2. a0!) (
         I 2
        )
       ) a1!
      )
         ...
         (=>
          ...
          (and
           ...
           (=>
            ...
            (=>
             %%location_label%%4
             (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. a4!) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.?
                (Poly%tuple%2. a0!) (I 16)
 )))))))))))))))
 (get-info :version)
