...
;; MODULE 'module lemmas::lizard_lemmas, function curve25519_dalek::lemmas::lizard_lemmas::lemma_jacobi_quartic_edge_values'
;; curve25519-dalek/src/lemmas/lizard_lemmas.rs:772:1: 772:83 (#0)
...
(assert
 (distinct fuel%vstd!arithmetic.div_mod.lemma_mod_bound. fuel%vstd!array.array_view.
  ...
  fuel%vstd!view.impl&%44.view. fuel%vstd!view.impl&%48.view. fuel%curve25519_dalek!backend.serial.u64.constants.SQRT_AD_MINUS_ONE.
  ...
  fuel%curve25519_dalek!lizard.u64_constants.MIDOUBLE_INVSQRT_A_MINUS_D. fuel%curve25519_dalek!specs.edwards_specs.is_on_edwards_curve.
  fuel%curve25519_dalek!specs.edwards_specs.is_on_edwards_curve_projective. fuel%curve25519_dalek!specs.edwards_specs.is_valid_extended_edwards_point.
  ...
  fuel%curve25519_dalek!specs.ristretto_specs.ristretto_coset_affine. fuel%curve25519_dalek!specs.lizard_specs.jacobi_to_edwards_affine.
  fuel%curve25519_dalek!specs.lizard_specs.midouble_invsqrt_a_minus_d. fuel%vstd!array.group_array_axioms.
        ...
        (let
         ...
         (=>
          ...
          (forall ((i$ Poly)) (!
            ...
            :qid user_curve25519_dalek__lemmas__lizard_lemmas__lemma_jacobi_quartic_edge_values_21
            :skolemid skolem_user_curve25519_dalek__lemmas__lizard_lemmas__lemma_jacobi_quartic_edge_values_21
   )))))))))
...
;; Function-Def curve25519_dalek::lemmas::lizard_lemmas::lemma_jacobi_quartic_edge_values
;; curve25519-dalek/src/lemmas/lizard_lemmas.rs:772:1: 772:83 (#0)
...
(push)
 ...
 (declare-const xn@ Int)
 (declare-const yn@ Int)
 (declare-const zn@ Int)
 (declare-const _tn@ Int)
 (declare-const z_inv@ Int)
 (declare-const coset@ %%Function%%)
 (declare-const jcs@ %%Function%%)
 (declare-const mc@ Int)
 (declare-const id@ tuple%2.)
 (declare-const i_pt@ tuple%2.)
 (declare-const neg_i_pt@ tuple%2.)
 (assert
  fuel_defaults
 )
 (assert
      ...
      (or
              ...
              (let
               ...
               (=>
                ...
                (forall ((i$ Poly)) (!
                   ...
                   (=>
                    ...
                    (let
                     ...
                     (or
                      (or
                       (or
                        (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. ji$) (vstd!seq.Seq.index.?
                  ...
                  :qid user_curve25519_dalek__lemmas__lizard_lemmas__lemma_jacobi_quartic_edge_values_22
                  :skolemid skolem_user_curve25519_dalek__lemmas__lizard_lemmas__lemma_jacobi_quartic_edge_values_22
        ))))))))))
        (=>
         (not (not (or
            (= x@ 0)
       ...
       (and
        ...
        (=>
         ...
         (=>
          (= tmp%%$1@ (curve25519_dalek!specs.edwards_specs.edwards_point_as_nat.? (Poly%curve25519_dalek!edwards.EdwardsPoint.
             point!
          )))
          (=>
           (= xn@ (%I (tuple%4./tuple%4/0 (%Poly%tuple%4. (Poly%tuple%4. tmp%%$1@)))))
           (=>
            (= yn@ (%I (tuple%4./tuple%4/1 (%Poly%tuple%4. (Poly%tuple%4. tmp%%$1@)))))
            (=>
             (= zn@ (%I (tuple%4./tuple%4/2 (%Poly%tuple%4. (Poly%tuple%4. tmp%%$1@)))))
             (=>
              (= _tn@ (%I (tuple%4./tuple%4/3 (%Poly%tuple%4. (Poly%tuple%4. tmp%%$1@)))))
              (=>
               (= z_inv@ (curve25519_dalek!specs.field_specs.field_inv.? (I zn@)))
               (and
                (=>
                 (= tmp%1 (curve25519_dalek!specs.edwards_specs.edwards_z.? (Poly%curve25519_dalek!edwards.EdwardsPoint.
                    point!
                 )))
                 (=>
                  (ens%curve25519_dalek!lemmas.field_lemmas.sqrt_ratio_lemmas.lemma_canonical_nat_lt_p.
                  ...
                  (=>
                   ...
                   (and
                    (=>
                     %%location_label%%1
                     (req%vstd!arithmetic.div_mod.lemma_small_mod. zn@ tmp%2)
                    )
                    (=>
                     (ens%vstd!arithmetic.div_mod.lemma_small_mod. zn@ tmp%2)
                     (=>
                      %%location_label%%2
                      (not (= (EucMod zn@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0))
                ))))))
                (=>
                 (not (= (EucMod zn@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0))
                 (and
                  (=>
                   (= tmp%3 (curve25519_dalek!specs.edwards_specs.edwards_x.? (Poly%curve25519_dalek!edwards.EdwardsPoint.
                      point!
                   )))
                   (=>
                    (ens%curve25519_dalek!lemmas.field_lemmas.sqrt_ratio_lemmas.lemma_canonical_nat_lt_p.
                    ...
                    (=>
                     %%location_label%%3
                     (< xn@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                  )))
                  (=>
                   (< xn@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                   (and
                    (=>
                     (= tmp%4 (curve25519_dalek!specs.edwards_specs.edwards_y.? (Poly%curve25519_dalek!edwards.EdwardsPoint.
                        point!
                     )))
                     (=>
                      (ens%curve25519_dalek!lemmas.field_lemmas.sqrt_ratio_lemmas.lemma_canonical_nat_lt_p.
                      ...
                      (=>
                       %%location_label%%4
                       (< yn@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                    )))
                    (=>
                     (< yn@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                     (or
                             ...
                             (=>
                              ...
                              (and
                               ...
                               (=>
                                ...
                                (and
                                 (=>
                                  (= tmp%8 (nClip (Mul yn@ z_inv@)))
                                  (=>
                                   (= tmp%9 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                                   (and
                                    (=>
                                     %%location_label%%11
                                     (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%8 tmp%9)
                                    )
                                    (=>
                                     (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%8 tmp%9)
                                     (=>
                                      %%location_label%%12
                                      (< y@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                                 )))))
                                            ...
                                            (=>
                                             ...
                                             (=>
                                              ...
                                              (=>
                                               ...
                                               (=>
                                                (= neg_i_pt@ (tuple%2./tuple%2 (I (curve25519_dalek!specs.field_specs.field_neg.? (I (
                                                ...
                                                (=>
                                                 ...
                                                 (=>
                                                  (= tmp%10 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.lizard_specs.jacobi_to_edwards_affine.?
                                                      (I 0) (I 1)
                                                     )
                                                    ) (Poly%tuple%2. id@)
                                                  ))
                                                  (and
                                                   ...
                                                   (=>
                                                    tmp%10
                                                    (=>
                                                     (ens%curve25519_dalek!lemmas.lizard_lemmas.lemma_jq_four_torsion_images. 0)
                                                     (=>
                                                      (= tmp%11 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.lizard_specs.jacobi_to_edwards_affine.?
                                                          (I 1) (I mc@)
                                                         )
                                                        ) (Poly%tuple%2. neg_i_pt@)
                                                      ))
                                                      (and
                                                       (=>
                                                        %%location_label%%19
                                                       ...
                                                       (=>
                                                        tmp%11
                                                        (=>
                                                         (= tmp%12 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.lizard_specs.jacobi_to_edwards_affine.?
                                                             (I (curve25519_dalek!specs.field_specs.field_neg.? (I 1))) (I mc@)
                                                            )
                                                           ) (Poly%tuple%2. i_pt@)
                                                         ))
                                                         (and
                                                           ...
                                                           (and
                                                              ...
                                                              (or
                                                               (and
                                                                (=>
                                                                 ...
                                                                 (=>
                                                                  (= tmp%13 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2.
                                                                      $ NAT $ NAT
                                                                     ) (vstd!view.View.view.? $ (ARRAY (DST $) (TYPE%tuple%2. $ NAT $ NAT) $ (CONST_INT 4))
                                                                      (Poly%array%. jcs@)
                                                                     ) i@
                                                                 ...
                                                                 (or
                                                                  (and
                                                                   (=>
                                                                    (= (%I i@) 2)
                                                                    (=>
                                                                     (= tmp%14 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2.
                                                                         $ NAT $ NAT
                                                                        ) (vstd!view.View.view.? $ (ARRAY (DST $) (TYPE%tuple%2. $ NAT $ NAT) $ (CONST_INT 4))
                                                                         (Poly%array%. jcs@)
                                                                        ) i@
                                                                       ) (Poly%tuple%2. (tuple%2./tuple%2 (I 1) (I mc@)))
                                                                     ))
                                                                     (and
                                                                      (=>
                                                                       %%location_label%%22
                                                                   ...
                                                                   (=>
                                                                    (not (= (%I i@) 2))
                                                                    (=>
                                                                     (= tmp%15 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2.
                                                                         $ NAT $ NAT
                                                                        ) (vstd!view.View.view.? $ (ARRAY (DST $) (TYPE%tuple%2. $ NAT $ NAT) $ (CONST_INT 4))
                                                                         (Poly%array%. jcs@)
                                                                        ) i@
                                                            ...
                                                            (=>
                                                             (forall ((i$ Poly)) (!
                                                               ...
                                                               :qid user_curve25519_dalek__lemmas__lizard_lemmas__lemma_jacobi_quartic_edge_values_29
                                                               :skolemid skolem_user_curve25519_dalek__lemmas__lizard_lemmas__lemma_jacobi_quartic_edge_values_29
                                                             ))
                                                             (=>
                                                              %%location_label%%25
                                                              (let
