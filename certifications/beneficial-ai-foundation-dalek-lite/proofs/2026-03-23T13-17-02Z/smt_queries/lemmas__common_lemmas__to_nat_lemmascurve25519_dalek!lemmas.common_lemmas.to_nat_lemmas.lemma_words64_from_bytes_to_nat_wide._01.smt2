...
;; curve25519-dalek/src/lemmas/common_lemmas/to_nat_lemmas.rs:891:1: 891:68 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::to_nat_lemmas::lemma_words64_from_bytes_to_nat_wide
;; curve25519-dalek/src/lemmas/common_lemmas/to_nat_lemmas.rs:891:1: 891:68 (#0)
  ...
  (not (=>
    ...
    (=>
     ...
     (=>
      ...
      (=>
       (= tmp%1 (= (curve25519_dalek!specs.core_specs.words64_from_bytes_to_nat.? (vstd!view.View.view.?
           $ (ARRAY $ (UINT 8) $ (CONST_INT 64)) (Poly%array%. bytes!)
          ) (I 1)
         ) (nClip (Add (curve25519_dalek!specs.core_specs.words64_from_bytes_to_nat.? (vstd!view.View.view.?
             $ (ARRAY $ (UINT 8) $ (CONST_INT 64)) (Poly%array%. bytes!)
            ) (I 0)
           ) (nClip (Mul (curve25519_dalek!specs.core_specs.word64_from_bytes.? (vstd!view.View.view.?
               $ (ARRAY $ (UINT 8) $ (CONST_INT 64)) (Poly%array%. bytes!)
              ) (I 0)
             ) (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 0 64))))
       ))))))
       (and
        (=>
         %%location_label%%0
