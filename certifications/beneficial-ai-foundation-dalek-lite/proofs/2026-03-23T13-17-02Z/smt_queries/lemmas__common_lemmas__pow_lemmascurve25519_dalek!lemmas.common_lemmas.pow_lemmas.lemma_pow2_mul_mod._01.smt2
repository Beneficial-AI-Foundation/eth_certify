...
;; curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:463:1: 463:56 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::pow_lemmas::lemma_pow2_mul_mod
;; curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:463:1: 463:56 (#0)
        ...
        (=>
         ...
         (=>
          ...
          (=>
           ...
           (and
            (and
             (> (nClip (Mul (vstd!arithmetic.power2.pow2.? (I k!)) (vstd!arithmetic.power2.pow2.?
                 (I d@)
               ))
              ) 0
             )
         ...
         (=>
          ...
          (=>
           ...
           (and
            (=>
             %%location_label%%2
             (req%vstd!arithmetic.div_mod.lemma_truncate_middle. x! tmp%1 tmp%2)
            )
            (=>
             (ens%vstd!arithmetic.div_mod.lemma_truncate_middle. x! tmp%1 tmp%2)
             (=>
              %%location_label%%3
              (= (EucMod (nClip (Mul (vstd!arithmetic.power2.pow2.? (I k!)) x!)) (nClip (Mul (vstd!arithmetic.power2.pow2.?
                   (I k!)
                  ) (vstd!arithmetic.power2.pow2.? (I d@))
                ))
               ) (nClip (Mul (vstd!arithmetic.power2.pow2.? (I k!)) (EucMod x! (vstd!arithmetic.power2.pow2.?
                   (I d@)
         ))))))))))
         (=>
          (= (EucMod (nClip (Mul (vstd!arithmetic.power2.pow2.? (I k!)) x!)) (nClip (Mul (vstd!arithmetic.power2.pow2.?
