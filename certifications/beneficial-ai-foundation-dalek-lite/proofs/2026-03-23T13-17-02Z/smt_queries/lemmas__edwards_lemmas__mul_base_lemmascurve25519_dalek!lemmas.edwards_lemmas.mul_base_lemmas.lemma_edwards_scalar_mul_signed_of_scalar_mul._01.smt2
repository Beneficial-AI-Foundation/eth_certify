...
;; curve25519-dalek/src/lemmas/edwards_lemmas/mul_base_lemmas.rs:285:1: 285:90 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::mul_base_lemmas::lemma_edwards_scalar_mul_signed_of_scalar_mul
;; curve25519-dalek/src/lemmas/edwards_lemmas/mul_base_lemmas.rs:285:1: 285:90 (#0)
     ...
     (and
        ...
        (=>
         ...
         (and
          ...
          (=>
           tmp%1
           (=>
            (= tmp%2 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul_signed.?
                (Poly%tuple%2. P!) (I (Mul a! k!))
               )
              ) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2.
                 P!
                ) (I (nClip (Mul a! k!)))
            ...
            (and
             ...
             (=>
              tmp%2
              (=>
               (= tmp%3 (= (nClip (Mul a! k!)) (nClip (Mul an@ k!))))
               (and
                (=>
                 %%location_label%%2
                 tmp%3
                ...
                (=>
                 ...
                 (and
                  (=>
                   (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. an@ k!)
                   (=>
                    %%location_label%%3
                    (= (nClip (Mul an@ k!)) (nClip (Mul k! an@)))
                  ))
                  (=>
                   (= (nClip (Mul an@ k!)) (nClip (Mul k! an@)))
                   (and
                    ...
                    (=>
                     ...
                     (=>
                      (= tmp%4 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.?
                          (Poly%tuple%2. P!) (I (nClip (Mul a! k!)))
                         )
                        ) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2.
                           P!
                          ) (I (nClip (Mul k! an@)))
      ...
      (=>
       ...
       (=>
        (= ap@ (nClip (Sub 0 a!)))
        (=>
         (= tmp%5 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul_signed.?
             (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2.
                P!
               ) (I k!)
              )
             ...
             ((tmp%%$ (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.?
                  (Poly%tuple%2. P!) (I k!)
                 )
                ) (I ap@)
             )))
                  ...
                  (=>
                   ...
                   (and
                    (=>
                     (= tmp%8 (Sub 0 a!))
                     (=>
                      (ens%vstd!arithmetic.mul.lemma_mul_strictly_positive. tmp%8 k!)
                      (=>
                       %%location_label%%10
                       (> (Mul (Sub 0 a!) k!) 0)
                    )))
                    (=>
                     ...
                     (and
                      (=>
                       (ens%vstd!arithmetic.mul.lemma_mul_unary_negation. a! k!)
                       (=>
                        %%location_label%%11
                        (> (Sub 0 (Mul a! k!)) 0)
                      ))
                       ...
                       (=>
                        ...
                        (and
                         ...
                         (=>
                          tmp%9
                          (=>
                           (= tmp%10 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul_signed.?
                               (Poly%tuple%2. P!) (I (Mul a! k!))
                              )
                             ) (Poly%tuple%2. (let
                               ((tmp%%$ (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2. P!)
                                  (I (nClip (Sub 0 (Mul a! k!))))
                               )))
                               (let
                                ((x$ (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$))))))
                                (let
                            ...
                            (=>
                             ...
                             (and
                              (=>
                               (ens%vstd!arithmetic.mul.lemma_mul_unary_negation. a! k!)
                               (=>
                                (= tmp%11 (= (Sub 0 (Mul a! k!)) (Mul (Sub 0 a!) k!)))
                                (and
                                 (=>
                                  %%location_label%%14
                                  tmp%11
                                  ...
                                  (=>
                                   ...
                                   (and
                                    ...
                                    (=>
                                     tmp%12
                                     (=>
                                      (= tmp%13 (= (Sub 0 (Mul a! k!)) (nClip (Mul ap@ k!))))
                                      (and
                                       (=>
                                        %%location_label%%16
                                        tmp%13
                                       ...
                                       (=>
                                        tmp%13
                                        (=>
                                         (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. ap@ k!)
                                         (=>
                                          %%location_label%%17
                                          (= (nClip (Sub 0 (Mul a! k!))) (nClip (Mul k! ap@)))
                              ))))))))))))
                              (=>
                               (= (nClip (Sub 0 (Mul a! k!))) (nClip (Mul k! ap@)))
                               (=>
                                (= tmp%14 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.?
                                    (Poly%tuple%2. P!) (I (nClip (Sub 0 (Mul a! k!))))
                                   )
                                  ) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2.
                                     P!
                                    ) (I (nClip (Mul k! ap@)))
