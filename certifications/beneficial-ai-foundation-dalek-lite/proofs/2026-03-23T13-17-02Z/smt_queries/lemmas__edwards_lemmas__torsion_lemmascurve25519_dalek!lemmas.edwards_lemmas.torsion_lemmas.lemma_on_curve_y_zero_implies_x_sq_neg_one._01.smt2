...
;; curve25519-dalek/src/lemmas/edwards_lemmas/torsion_lemmas.rs:82:1: 82:72 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::torsion_lemmas::lemma_on_curve_y_zero_implies_x_sq_neg_one
;; curve25519-dalek/src/lemmas/edwards_lemmas/torsion_lemmas.rs:82:1: 82:72 (#0)
         ...
         (and
          (and
           ...
           (=>
            ...
            (=>
             %%location_label%%2
             (= (curve25519_dalek!specs.field_specs.field_mul.? (I x2@) (I (curve25519_dalek!specs.field_specs.field_square.?
                 (I 0)
               ))
              ) 0
          ))))
           ...
           (and
            (and
             ...
             (=>
              ...
              (=>
               %%location_label%%4
               (= (curve25519_dalek!specs.field_specs.field_mul.? (I d@) (I 0)) 0)
            )))
            (=>
             (= (curve25519_dalek!specs.field_specs.field_mul.? (I d@) (I 0)) 0)
             (=>
                     ...
                     (=>
                      ...
                      (=>
                       ...
                       (and
                        (=>
                         %%location_label%%7
                         (req%vstd!arithmetic.div_mod.lemma_small_mod. x2@ tmp%5)
                        )
                        (=>
                         (ens%vstd!arithmetic.div_mod.lemma_small_mod. x2@ tmp%5)
                         (=>
                          %%location_label%%8
                          (= (curve25519_dalek!specs.field_specs.field_square.? (I x!)) (curve25519_dalek!specs.field_specs.field_neg.?
                            (I 1)
