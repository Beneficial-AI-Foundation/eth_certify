...
;; curve25519-dalek/src/lemmas/common_lemmas/div_mod_lemmas.rs:408:1: 408:62 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::div_mod_lemmas::lemma_mod_add_eq
;; curve25519-dalek/src/lemmas/common_lemmas/div_mod_lemmas.rs:408:1: 408:62 (#0)
...
(push)
 ...
 (assert
  (not (and
    (=>
     %%location_label%%0
     (req%vstd!arithmetic.div_mod.lemma_add_mod_noop. a! c! m!)
    )
    (=>
     (ens%vstd!arithmetic.div_mod.lemma_add_mod_noop. a! c! m!)
     (and
      (=>
       %%location_label%%1
       (req%vstd!arithmetic.div_mod.lemma_add_mod_noop. b! c! m!)
      )
      (=>
       (ens%vstd!arithmetic.div_mod.lemma_add_mod_noop. b! c! m!)
       (=>
        %%location_label%%2
        (= (EucMod (Add a! c!) m!) (EucMod (Add b! c!) m!))
 )))))))
