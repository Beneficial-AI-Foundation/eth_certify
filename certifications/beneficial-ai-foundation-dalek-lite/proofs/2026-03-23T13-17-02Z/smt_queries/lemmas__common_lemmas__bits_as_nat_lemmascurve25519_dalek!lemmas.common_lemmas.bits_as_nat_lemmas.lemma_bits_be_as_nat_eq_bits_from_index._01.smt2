...
;; MODULE 'module lemmas::common_lemmas::bits_as_nat_lemmas'
;; curve25519-dalek/src/lemmas/common_lemmas/bits_as_nat_lemmas.rs:118:1: 122:2 (#0)
...
(declare-const fuel%curve25519_dalek!specs.core_specs.bits_as_nat. FuelId)
(declare-const fuel%curve25519_dalek!specs.core_specs.bits_as_nat_rec. FuelId)
(declare-const fuel%curve25519_dalek!specs.core_specs.bits_be_as_nat. FuelId)
(declare-const fuel%curve25519_dalek!specs.core_specs.bits_from_index_to_nat. FuelId)
(declare-const fuel%curve25519_dalek!specs.core_specs.byte_bits_value. FuelId)
...
(assert
 (distinct fuel%vstd!arithmetic.div_mod.lemma_div_is_ordered. fuel%vstd!arithmetic.div_mod.lemma_fundamental_div_mod.
  fuel%vstd!arithmetic.div_mod.lemma_mod_breakdown. fuel%vstd!arithmetic.mul.lemma_mul_basics_3.
  fuel%vstd!arithmetic.mul.lemma_mul_basics_4. fuel%vstd!arithmetic.mul.lemma_mul_is_associative.
  fuel%vstd!arithmetic.mul.lemma_mul_is_commutative. fuel%vstd!arithmetic.power2.lemma_pow2_pos.
  ...
  fuel%vstd!bits.lemma_u8_shr_is_div. fuel%vstd!bits.low_bits_mask. fuel%vstd!bits.lemma_u8_low_bits_mask_is_mod.
  ...
  fuel%vstd!view.impl&%26.view. fuel%vstd!view.impl&%32.view. fuel%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u8_shr_zero_is_id.
  fuel%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u8_shr_by_sum. fuel%curve25519_dalek!specs.core_specs.u8_32_as_nat.
  fuel%curve25519_dalek!specs.core_specs.u8_32_as_nat_rec. fuel%curve25519_dalek!specs.core_specs.bytes_as_nat_prefix.
  fuel%curve25519_dalek!specs.core_specs.bits_as_nat. fuel%curve25519_dalek!specs.core_specs.bits_as_nat_rec.
  fuel%curve25519_dalek!specs.core_specs.bits_be_as_nat. fuel%curve25519_dalek!specs.core_specs.bits_from_index_to_nat.
  fuel%curve25519_dalek!specs.core_specs.byte_bits_value. fuel%vstd!array.group_array_axioms.
...
(declare-fun Poly%slice%<bool.>. (slice%<bool.>.) Poly)
(declare-fun %Poly%slice%<bool.>. (Poly) slice%<bool.>.)
...
(assert
 (forall ((x slice%<bool.>.)) (!
   (= x (%Poly%slice%<bool.>. (Poly%slice%<bool.>. x)))
   :pattern ((Poly%slice%<bool.>. x))
   :qid internal_crate__slice__<bool.>_box_axiom_definition
   :skolemid skolem_internal_crate__slice__<bool.>_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x (SLICE $ BOOL))
    (= x (Poly%slice%<bool.>. (%Poly%slice%<bool.>. x)))
   )
   :pattern ((has_type x (SLICE $ BOOL)))
   :qid internal_crate__slice__<bool.>_unbox_axiom_definition
   :skolemid skolem_internal_crate__slice__<bool.>_unbox_axiom_definition
)))
(assert
 (forall ((x slice%<bool.>.)) (!
   (has_type (Poly%slice%<bool.>. x) (SLICE $ BOOL))
   :pattern ((has_type (Poly%slice%<bool.>. x) (SLICE $ BOOL)))
   :qid internal_crate__slice__<bool.>_has_type_always_definition
   :skolemid skolem_internal_crate__slice__<bool.>_has_type_always_definition
)))
(assert
...
;; Function-Decl curve25519_dalek::specs::core_specs::bits_as_nat_rec
(declare-fun curve25519_dalek!specs.core_specs.bits_as_nat_rec.? (Poly Poly) Int)
(declare-fun curve25519_dalek!specs.core_specs.rec%bits_as_nat_rec.? (Poly Poly Fuel)
 Int
)

;; Function-Decl curve25519_dalek::specs::core_specs::bits_as_nat
(declare-fun curve25519_dalek!specs.core_specs.bits_as_nat.? (Poly) Int)

;; Function-Decl curve25519_dalek::specs::core_specs::bits_be_as_nat
(declare-fun curve25519_dalek!specs.core_specs.bits_be_as_nat.? (Poly Poly) Int)
(declare-fun curve25519_dalek!specs.core_specs.rec%bits_be_as_nat.? (Poly Poly Fuel)
 Int
)

;; Function-Decl curve25519_dalek::specs::core_specs::bits_from_index_to_nat
(declare-fun curve25519_dalek!specs.core_specs.bits_from_index_to_nat.? (Poly Poly
  Poly
 ) Int
)
(declare-fun curve25519_dalek!specs.core_specs.rec%bits_from_index_to_nat.? (Poly Poly
  Poly Fuel
 ) Int
)

;; Function-Decl curve25519_dalek::specs::core_specs::byte_bits_value
(declare-fun curve25519_dalek!specs.core_specs.byte_bits_value.? (Poly Poly Poly)
 Int
)
(declare-fun curve25519_dalek!specs.core_specs.rec%byte_bits_value.? (Poly Poly Poly
  Fuel
 ) Int
)
...
(assert
 (=>
  ...
  (forall ((x! Int) (y! Int) (z! Int)) (!
    ...
    :qid user_vstd__arithmetic__div_mod__lemma_div_is_ordered_18
    :skolemid skolem_user_vstd__arithmetic__div_mod__lemma_div_is_ordered_18
))))
...
(assert
 (=>
  ...
  (forall ((x! Int) (d! Int)) (!
    ...
    :qid user_vstd__arithmetic__div_mod__lemma_fundamental_div_mod_19
    :skolemid skolem_user_vstd__arithmetic__div_mod__lemma_fundamental_div_mod_19
))))
...
(assert
 (=>
  ...
  (forall ((x! Int) (y! Int) (z! Int)) (!
    ...
    :qid user_vstd__arithmetic__div_mod__lemma_mod_breakdown_20
    :skolemid skolem_user_vstd__arithmetic__div_mod__lemma_mod_breakdown_20
))))
...
(assert
 (=>
  ...
  (forall ((x! Int)) (!
    (= (Mul x! 1) x!)
    :pattern ((Mul x! 1))
    :qid user_vstd__arithmetic__mul__lemma_mul_basics_3_21
    :skolemid skolem_user_vstd__arithmetic__mul__lemma_mul_basics_3_21
))))
...
(assert
 (=>
  ...
  (forall ((x! Int)) (!
    (= (Mul 1 x!) x!)
    :pattern ((Mul 1 x!))
    :qid user_vstd__arithmetic__mul__lemma_mul_basics_4_22
    :skolemid skolem_user_vstd__arithmetic__mul__lemma_mul_basics_4_22
))))
...
(assert
 (=>
  ...
  (forall ((x! Poly) (shift! Poly)) (!
    ...
    :qid user_vstd__bits__lemma_u8_shr_is_div_27
    :skolemid skolem_user_vstd__bits__lemma_u8_shr_is_div_27
))))
...
(assert
 (=>
  ...
  (forall ((x! Poly) (n! Poly)) (!
    ...
    :qid user_vstd__bits__lemma_u8_low_bits_mask_is_mod_28
    :skolemid skolem_user_vstd__bits__lemma_u8_low_bits_mask_is_mod_28
))))
...
;; Function-Axioms curve25519_dalek::specs::core_specs::bits_as_nat_rec
(assert
 (fuel_bool_default fuel%curve25519_dalek!specs.core_specs.bits_as_nat_rec.)
)
(declare-const fuel_nat%curve25519_dalek!specs.core_specs.bits_as_nat_rec. Fuel)
(assert
 (forall ((bits! Poly) (index! Poly) (fuel% Fuel)) (!
   (= (curve25519_dalek!specs.core_specs.rec%bits_as_nat_rec.? bits! index! fuel%) (curve25519_dalek!specs.core_specs.rec%bits_as_nat_rec.?
     bits! index! zero
   ))
   :pattern ((curve25519_dalek!specs.core_specs.rec%bits_as_nat_rec.? bits! index! fuel%))
   :qid internal_curve25519_dalek!specs.core_specs.bits_as_nat_rec._fuel_to_zero_definition
   :skolemid skolem_internal_curve25519_dalek!specs.core_specs.bits_as_nat_rec._fuel_to_zero_definition
)))
(assert
 (forall ((bits! Poly) (index! Poly) (fuel% Fuel)) (!
   (=>
    (and
     (has_type bits! (ARRAY $ BOOL $ (CONST_INT 256)))
     (has_type index! INT)
    )
    (= (curve25519_dalek!specs.core_specs.rec%bits_as_nat_rec.? bits! index! (succ fuel%))
     (ite
      (>= (%I index!) 256)
      0
      (let
       ((bit_value$ (ite
          (%B (vstd!seq.Seq.index.? $ BOOL (vstd!view.View.view.? $ (ARRAY $ BOOL $ (CONST_INT 256))
             bits!
            ) index!
          ))
          1
       ...
       (nClip (Add (nClip (Mul bit_value$ (vstd!arithmetic.power2.pow2.? (I (nClip (%I index!))))))
         (curve25519_dalek!specs.core_specs.rec%bits_as_nat_rec.? bits! (I (Add (%I index!) 1))
          fuel%
   )))))))
   :pattern ((curve25519_dalek!specs.core_specs.rec%bits_as_nat_rec.? bits! index! (succ
      fuel%
   )))
   :qid internal_curve25519_dalek!specs.core_specs.bits_as_nat_rec._fuel_to_body_definition
   :skolemid skolem_internal_curve25519_dalek!specs.core_specs.bits_as_nat_rec._fuel_to_body_definition
)))
(assert
 (=>
  (fuel_bool fuel%curve25519_dalek!specs.core_specs.bits_as_nat_rec.)
  (forall ((bits! Poly) (index! Poly)) (!
    (=>
     (and
      (has_type bits! (ARRAY $ BOOL $ (CONST_INT 256)))
      (has_type index! INT)
     )
     (= (curve25519_dalek!specs.core_specs.bits_as_nat_rec.? bits! index!) (curve25519_dalek!specs.core_specs.rec%bits_as_nat_rec.?
       bits! index! (succ fuel_nat%curve25519_dalek!specs.core_specs.bits_as_nat_rec.)
    )))
    :pattern ((curve25519_dalek!specs.core_specs.bits_as_nat_rec.? bits! index!))
    :qid internal_curve25519_dalek!specs.core_specs.bits_as_nat_rec.?_definition
    :skolemid skolem_internal_curve25519_dalek!specs.core_specs.bits_as_nat_rec.?_definition
))))
(assert
 (forall ((bits! Poly) (index! Poly)) (!
   (=>
    ...
    (<= 0 (curve25519_dalek!specs.core_specs.bits_as_nat_rec.? bits! index!))
   )
   :pattern ((curve25519_dalek!specs.core_specs.bits_as_nat_rec.? bits! index!))
   :qid internal_curve25519_dalek!specs.core_specs.bits_as_nat_rec.?_pre_post_definition
   :skolemid skolem_internal_curve25519_dalek!specs.core_specs.bits_as_nat_rec.?_pre_post_definition
)))
(assert
 (forall ((bits! Poly) (index! Poly) (fuel% Fuel)) (!
   (=>
    ...
    (<= 0 (curve25519_dalek!specs.core_specs.rec%bits_as_nat_rec.? bits! index! fuel%))
   )
   :pattern ((curve25519_dalek!specs.core_specs.rec%bits_as_nat_rec.? bits! index! fuel%))
   :qid internal_curve25519_dalek!specs.core_specs.rec__bits_as_nat_rec.?_pre_post_rec_definition
   :skolemid skolem_internal_curve25519_dalek!specs.core_specs.rec__bits_as_nat_rec.?_pre_post_rec_definition
)))

;; Function-Axioms curve25519_dalek::specs::core_specs::bits_as_nat
(assert
 (fuel_bool_default fuel%curve25519_dalek!specs.core_specs.bits_as_nat.)
)
(assert
 (=>
  (fuel_bool fuel%curve25519_dalek!specs.core_specs.bits_as_nat.)
  (forall ((bits! Poly)) (!
    (= (curve25519_dalek!specs.core_specs.bits_as_nat.? bits!) (curve25519_dalek!specs.core_specs.bits_as_nat_rec.?
      bits! (I 0)
    ))
    :pattern ((curve25519_dalek!specs.core_specs.bits_as_nat.? bits!))
    :qid internal_curve25519_dalek!specs.core_specs.bits_as_nat.?_definition
    :skolemid skolem_internal_curve25519_dalek!specs.core_specs.bits_as_nat.?_definition
))))
(assert
 (forall ((bits! Poly)) (!
   (=>
    (has_type bits! (ARRAY $ BOOL $ (CONST_INT 256)))
    (<= 0 (curve25519_dalek!specs.core_specs.bits_as_nat.? bits!))
   )
   :pattern ((curve25519_dalek!specs.core_specs.bits_as_nat.? bits!))
   :qid internal_curve25519_dalek!specs.core_specs.bits_as_nat.?_pre_post_definition
   :skolemid skolem_internal_curve25519_dalek!specs.core_specs.bits_as_nat.?_pre_post_definition
)))

;; Function-Specs curve25519_dalek::specs::core_specs::bits_be_as_nat
(declare-fun req%curve25519_dalek!specs.core_specs.bits_be_as_nat. (Poly Poly) Bool)
(declare-const %%global_location_label%%15 Bool)
(assert
 (forall ((bits! Poly) (len! Poly)) (!
   (= (req%curve25519_dalek!specs.core_specs.bits_be_as_nat. bits! len!) (=>
     %%global_location_label%%15
     (let
      ((tmp%%$ (%I len!)))
      (and
       (<= 0 tmp%%$)
       (<= tmp%%$ (vstd!slice.spec_slice_len.? $ BOOL bits!))
   ))))
   :pattern ((req%curve25519_dalek!specs.core_specs.bits_be_as_nat. bits! len!))
   :qid internal_req__curve25519_dalek!specs.core_specs.bits_be_as_nat._definition
   :skolemid skolem_internal_req__curve25519_dalek!specs.core_specs.bits_be_as_nat._definition
)))

;; Function-Axioms curve25519_dalek::specs::core_specs::bits_be_as_nat
(assert
 (fuel_bool_default fuel%curve25519_dalek!specs.core_specs.bits_be_as_nat.)
)
(declare-const fuel_nat%curve25519_dalek!specs.core_specs.bits_be_as_nat. Fuel)
(assert
 (forall ((bits! Poly) (len! Poly) (fuel% Fuel)) (!
   (= (curve25519_dalek!specs.core_specs.rec%bits_be_as_nat.? bits! len! fuel%) (curve25519_dalek!specs.core_specs.rec%bits_be_as_nat.?
     bits! len! zero
   ))
   :pattern ((curve25519_dalek!specs.core_specs.rec%bits_be_as_nat.? bits! len! fuel%))
   :qid internal_curve25519_dalek!specs.core_specs.bits_be_as_nat._fuel_to_zero_definition
   :skolemid skolem_internal_curve25519_dalek!specs.core_specs.bits_be_as_nat._fuel_to_zero_definition
)))
(assert
 (forall ((bits! Poly) (len! Poly) (fuel% Fuel)) (!
   (=>
    (and
     (has_type bits! (SLICE $ BOOL))
     (has_type len! INT)
    )
    (= (curve25519_dalek!specs.core_specs.rec%bits_be_as_nat.? bits! len! (succ fuel%))
     (ite
      (<= (%I len!) 0)
      0
      (let
       ((bit_value$ (ite
          (%B (vstd!seq.Seq.index.? $ BOOL (vstd!view.View.view.? $slice (SLICE $ BOOL) bits!)
            (I (Sub (%I len!) 1))
          ))
          1
          0
       )))
       (nClip (Add bit_value$ (nClip (Mul 2 (curve25519_dalek!specs.core_specs.rec%bits_be_as_nat.?
            bits! (I (Sub (%I len!) 1)) fuel%
   )))))))))
   :pattern ((curve25519_dalek!specs.core_specs.rec%bits_be_as_nat.? bits! len! (succ fuel%)))
   :qid internal_curve25519_dalek!specs.core_specs.bits_be_as_nat._fuel_to_body_definition
   :skolemid skolem_internal_curve25519_dalek!specs.core_specs.bits_be_as_nat._fuel_to_body_definition
)))
(assert
 (=>
  (fuel_bool fuel%curve25519_dalek!specs.core_specs.bits_be_as_nat.)
  (forall ((bits! Poly) (len! Poly)) (!
    (=>
     (and
      (has_type bits! (SLICE $ BOOL))
     ...
     (= (curve25519_dalek!specs.core_specs.bits_be_as_nat.? bits! len!) (curve25519_dalek!specs.core_specs.rec%bits_be_as_nat.?
       bits! len! (succ fuel_nat%curve25519_dalek!specs.core_specs.bits_be_as_nat.)
    )))
    :pattern ((curve25519_dalek!specs.core_specs.bits_be_as_nat.? bits! len!))
    :qid internal_curve25519_dalek!specs.core_specs.bits_be_as_nat.?_definition
    :skolemid skolem_internal_curve25519_dalek!specs.core_specs.bits_be_as_nat.?_definition
))))
(assert
 (forall ((bits! Poly) (len! Poly)) (!
   (=>
    ...
    (<= 0 (curve25519_dalek!specs.core_specs.bits_be_as_nat.? bits! len!))
   )
   :pattern ((curve25519_dalek!specs.core_specs.bits_be_as_nat.? bits! len!))
   :qid internal_curve25519_dalek!specs.core_specs.bits_be_as_nat.?_pre_post_definition
   :skolemid skolem_internal_curve25519_dalek!specs.core_specs.bits_be_as_nat.?_pre_post_definition
)))
(assert
 (forall ((bits! Poly) (len! Poly) (fuel% Fuel)) (!
   (=>
    ...
    (<= 0 (curve25519_dalek!specs.core_specs.rec%bits_be_as_nat.? bits! len! fuel%))
   )
   :pattern ((curve25519_dalek!specs.core_specs.rec%bits_be_as_nat.? bits! len! fuel%))
   :qid internal_curve25519_dalek!specs.core_specs.rec__bits_be_as_nat.?_pre_post_rec_definition
   :skolemid skolem_internal_curve25519_dalek!specs.core_specs.rec__bits_be_as_nat.?_pre_post_rec_definition
)))

;; Function-Specs curve25519_dalek::specs::core_specs::bits_from_index_to_nat
(declare-fun req%curve25519_dalek!specs.core_specs.bits_from_index_to_nat. (Poly Poly
  Poly
 ) Bool
)
(declare-const %%global_location_label%%16 Bool)
(assert
 (forall ((bits! Poly) (start! Poly) (len! Poly)) (!
   (= (req%curve25519_dalek!specs.core_specs.bits_from_index_to_nat. bits! start! len!)
    (=>
     %%global_location_label%%16
     (<= (nClip (Add (%I start!) (%I len!))) 256)
   ))
   :pattern ((req%curve25519_dalek!specs.core_specs.bits_from_index_to_nat. bits! start!
     len!
   ))
   :qid internal_req__curve25519_dalek!specs.core_specs.bits_from_index_to_nat._definition
   :skolemid skolem_internal_req__curve25519_dalek!specs.core_specs.bits_from_index_to_nat._definition
)))

;; Function-Axioms curve25519_dalek::specs::core_specs::bits_from_index_to_nat
(assert
 (fuel_bool_default fuel%curve25519_dalek!specs.core_specs.bits_from_index_to_nat.)
)
(declare-const fuel_nat%curve25519_dalek!specs.core_specs.bits_from_index_to_nat.
 Fuel
)
(assert
 (forall ((bits! Poly) (start! Poly) (len! Poly) (fuel% Fuel)) (!
   (= (curve25519_dalek!specs.core_specs.rec%bits_from_index_to_nat.? bits! start! len!
     fuel%
    ) (curve25519_dalek!specs.core_specs.rec%bits_from_index_to_nat.? bits! start! len!
     zero
   ))
   :pattern ((curve25519_dalek!specs.core_specs.rec%bits_from_index_to_nat.? bits! start!
     len! fuel%
   ))
   :qid internal_curve25519_dalek!specs.core_specs.bits_from_index_to_nat._fuel_to_zero_definition
   :skolemid skolem_internal_curve25519_dalek!specs.core_specs.bits_from_index_to_nat._fuel_to_zero_definition
)))
(assert
 (forall ((bits! Poly) (start! Poly) (len! Poly) (fuel% Fuel)) (!
   (=>
    ...
    (= (curve25519_dalek!specs.core_specs.rec%bits_from_index_to_nat.? bits! start! len!
      ...
      (let
       ...
       (nClip (Add bit_value$ (nClip (Mul 2 (curve25519_dalek!specs.core_specs.rec%bits_from_index_to_nat.?
            bits! (I (nClip (Add (%I start!) 1))) (I (nClip (Sub (%I len!) 1))) fuel%
   )))))))))
   :pattern ((curve25519_dalek!specs.core_specs.rec%bits_from_index_to_nat.? bits! start!
     len! (succ fuel%)
   ))
   :qid internal_curve25519_dalek!specs.core_specs.bits_from_index_to_nat._fuel_to_body_definition
   :skolemid skolem_internal_curve25519_dalek!specs.core_specs.bits_from_index_to_nat._fuel_to_body_definition
)))
(assert
 (=>
  (fuel_bool fuel%curve25519_dalek!specs.core_specs.bits_from_index_to_nat.)
  (forall ((bits! Poly) (start! Poly) (len! Poly)) (!
    (=>
     (and
      (has_type bits! (ARRAY $ BOOL $ (CONST_INT 256)))
     ...
     (= (curve25519_dalek!specs.core_specs.bits_from_index_to_nat.? bits! start! len!)
      (curve25519_dalek!specs.core_specs.rec%bits_from_index_to_nat.? bits! start! len!
       (succ fuel_nat%curve25519_dalek!specs.core_specs.bits_from_index_to_nat.)
    )))
    :pattern ((curve25519_dalek!specs.core_specs.bits_from_index_to_nat.? bits! start!
      len!
    ))
    :qid internal_curve25519_dalek!specs.core_specs.bits_from_index_to_nat.?_definition
    :skolemid skolem_internal_curve25519_dalek!specs.core_specs.bits_from_index_to_nat.?_definition
))))
(assert
 (forall ((bits! Poly) (start! Poly) (len! Poly)) (!
   (=>
    ...
    (<= 0 (curve25519_dalek!specs.core_specs.bits_from_index_to_nat.? bits! start! len!))
   )
   :pattern ((curve25519_dalek!specs.core_specs.bits_from_index_to_nat.? bits! start!
     len!
   ))
   :qid internal_curve25519_dalek!specs.core_specs.bits_from_index_to_nat.?_pre_post_definition
   :skolemid skolem_internal_curve25519_dalek!specs.core_specs.bits_from_index_to_nat.?_pre_post_definition
)))
(assert
 (forall ((bits! Poly) (start! Poly) (len! Poly) (fuel% Fuel)) (!
   (=>
    ...
    (<= 0 (curve25519_dalek!specs.core_specs.rec%bits_from_index_to_nat.? bits! start!
      len! fuel%
   )))
   :pattern ((curve25519_dalek!specs.core_specs.rec%bits_from_index_to_nat.? bits! start!
     len! fuel%
   ))
   :qid internal_curve25519_dalek!specs.core_specs.rec__bits_from_index_to_nat.?_pre_post_rec_definition
   :skolemid skolem_internal_curve25519_dalek!specs.core_specs.rec__bits_from_index_to_nat.?_pre_post_rec_definition
)))

;; Function-Specs curve25519_dalek::specs::core_specs::byte_bits_value
(declare-fun req%curve25519_dalek!specs.core_specs.byte_bits_value. (Poly Poly Poly)
 Bool
)
(declare-const %%global_location_label%%17 Bool)
(assert
 (forall ((byte! Poly) (bit_start! Poly) (len! Poly)) (!
   (= (req%curve25519_dalek!specs.core_specs.byte_bits_value. byte! bit_start! len!)
    (=>
     %%global_location_label%%17
     (<= (nClip (Add (%I bit_start!) (%I len!))) 8)
   ))
   :pattern ((req%curve25519_dalek!specs.core_specs.byte_bits_value. byte! bit_start!
     len!
   ))
   :qid internal_req__curve25519_dalek!specs.core_specs.byte_bits_value._definition
   :skolemid skolem_internal_req__curve25519_dalek!specs.core_specs.byte_bits_value._definition
)))

;; Function-Axioms curve25519_dalek::specs::core_specs::byte_bits_value
(assert
 (fuel_bool_default fuel%curve25519_dalek!specs.core_specs.byte_bits_value.)
)
(declare-const fuel_nat%curve25519_dalek!specs.core_specs.byte_bits_value. Fuel)
(assert
 (forall ((byte! Poly) (bit_start! Poly) (len! Poly) (fuel% Fuel)) (!
   (= (curve25519_dalek!specs.core_specs.rec%byte_bits_value.? byte! bit_start! len! fuel%)
    (curve25519_dalek!specs.core_specs.rec%byte_bits_value.? byte! bit_start! len! zero)
   )
   :pattern ((curve25519_dalek!specs.core_specs.rec%byte_bits_value.? byte! bit_start!
     len! fuel%
   ))
   :qid internal_curve25519_dalek!specs.core_specs.byte_bits_value._fuel_to_zero_definition
   :skolemid skolem_internal_curve25519_dalek!specs.core_specs.byte_bits_value._fuel_to_zero_definition
)))
(assert
 (forall ((byte! Poly) (bit_start! Poly) (len! Poly) (fuel% Fuel)) (!
   (=>
    (and
     ...
     (has_type bit_start! NAT)
     (has_type len! NAT)
    )
    (= (curve25519_dalek!specs.core_specs.rec%byte_bits_value.? byte! bit_start! len! (
       succ fuel%
      )
     ) (ite
      (= (%I len!) 0)
      ...
      (let
       ((bit_val$ (ite
          (= (uClip 8 (bitand (I (uClip 8 (bitshr (I (%I byte!)) (I (uClip 8 (%I bit_start!))))))
             (I 1)
            )
           ) 1
          )
       ...
       (nClip (Add bit_val$ (nClip (Mul 2 (curve25519_dalek!specs.core_specs.rec%byte_bits_value.?
            byte! (I (nClip (Add (%I bit_start!) 1))) (I (nClip (Sub (%I len!) 1))) fuel%
   )))))))))
   :pattern ((curve25519_dalek!specs.core_specs.rec%byte_bits_value.? byte! bit_start!
     len! (succ fuel%)
   ))
   :qid internal_curve25519_dalek!specs.core_specs.byte_bits_value._fuel_to_body_definition
   :skolemid skolem_internal_curve25519_dalek!specs.core_specs.byte_bits_value._fuel_to_body_definition
)))
(assert
 (=>
  (fuel_bool fuel%curve25519_dalek!specs.core_specs.byte_bits_value.)
  (forall ((byte! Poly) (bit_start! Poly) (len! Poly)) (!
    (=>
     (and
      (has_type byte! (UINT 8))
     ...
     (= (curve25519_dalek!specs.core_specs.byte_bits_value.? byte! bit_start! len!) (curve25519_dalek!specs.core_specs.rec%byte_bits_value.?
       byte! bit_start! len! (succ fuel_nat%curve25519_dalek!specs.core_specs.byte_bits_value.)
    )))
    :pattern ((curve25519_dalek!specs.core_specs.byte_bits_value.? byte! bit_start! len!))
    :qid internal_curve25519_dalek!specs.core_specs.byte_bits_value.?_definition
    :skolemid skolem_internal_curve25519_dalek!specs.core_specs.byte_bits_value.?_definition
))))
(assert
 (forall ((byte! Poly) (bit_start! Poly) (len! Poly)) (!
   (=>
    ...
    (<= 0 (curve25519_dalek!specs.core_specs.byte_bits_value.? byte! bit_start! len!))
   )
   :pattern ((curve25519_dalek!specs.core_specs.byte_bits_value.? byte! bit_start! len!))
   :qid internal_curve25519_dalek!specs.core_specs.byte_bits_value.?_pre_post_definition
   :skolemid skolem_internal_curve25519_dalek!specs.core_specs.byte_bits_value.?_pre_post_definition
)))
(assert
 (forall ((byte! Poly) (bit_start! Poly) (len! Poly) (fuel% Fuel)) (!
   (=>
    ...
    (<= 0 (curve25519_dalek!specs.core_specs.rec%byte_bits_value.? byte! bit_start! len!
      fuel%
   )))
   :pattern ((curve25519_dalek!specs.core_specs.rec%byte_bits_value.? byte! bit_start!
     len! fuel%
   ))
   :qid internal_curve25519_dalek!specs.core_specs.rec__byte_bits_value.?_pre_post_rec_definition
   :skolemid skolem_internal_curve25519_dalek!specs.core_specs.rec__byte_bits_value.?_pre_post_rec_definition
)))
...
;; Function-Specs curve25519_dalek::lemmas::common_lemmas::bits_as_nat_lemmas::lemma_bits_as_nat_rec_eq_pow2_mul_bits_from_index
(declare-fun req%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_as_nat_rec_eq_pow2_mul_bits_from_index.
 (%%Function%% Int) Bool
)
(declare-const %%global_location_label%%19 Bool)
(assert
 (forall ((bits! %%Function%%) (start! Int)) (!
   (= (req%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_as_nat_rec_eq_pow2_mul_bits_from_index.
     bits! start!
    ) (=>
     %%global_location_label%%19
     (<= start! 256)
   ))
   :pattern ((req%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_as_nat_rec_eq_pow2_mul_bits_from_index.
     bits! start!
   ))
   :qid internal_req__curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_as_nat_rec_eq_pow2_mul_bits_from_index._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_as_nat_rec_eq_pow2_mul_bits_from_index._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_as_nat_rec_eq_pow2_mul_bits_from_index.
 (%%Function%% Int) Bool
)
(assert
 (forall ((bits! %%Function%%) (start! Int)) (!
   (= (ens%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_as_nat_rec_eq_pow2_mul_bits_from_index.
     bits! start!
    ) (= (curve25519_dalek!specs.core_specs.bits_as_nat_rec.? (Poly%array%. bits!) (I start!))
     (nClip (Mul (vstd!arithmetic.power2.pow2.? (I start!)) (curve25519_dalek!specs.core_specs.bits_from_index_to_nat.?
        (Poly%array%. bits!) (I start!) (I (nClip (Sub 256 start!)))
   )))))
   :pattern ((ens%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_as_nat_rec_eq_pow2_mul_bits_from_index.
     bits! start!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_as_nat_rec_eq_pow2_mul_bits_from_index._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_as_nat_rec_eq_pow2_mul_bits_from_index._definition
)))

;; Function-Specs curve25519_dalek::lemmas::common_lemmas::bits_as_nat_lemmas::lemma_bits_as_nat_eq_bits_from_index
(declare-fun ens%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_as_nat_eq_bits_from_index.
 (%%Function%%) Bool
)
(assert
 (forall ((bits! %%Function%%)) (!
   (= (ens%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_as_nat_eq_bits_from_index.
     bits!
    ) (= (curve25519_dalek!specs.core_specs.bits_as_nat.? (Poly%array%. bits!)) (curve25519_dalek!specs.core_specs.bits_from_index_to_nat.?
      (Poly%array%. bits!) (I 0) (I 256)
   )))
   :pattern ((ens%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_as_nat_eq_bits_from_index.
     bits!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_as_nat_eq_bits_from_index._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_as_nat_eq_bits_from_index._definition
)))

;; Function-Specs curve25519_dalek::lemmas::common_lemmas::bits_as_nat_lemmas::lemma_bits_from_index_split
(declare-fun req%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_from_index_split.
 (%%Function%% Int Int Int) Bool
)
(declare-const %%global_location_label%%20 Bool)
(assert
 (forall ((bits! %%Function%%) (start! Int) (m! Int) (n! Int)) (!
   (= (req%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_from_index_split.
     bits! start! m! n!
    ) (=>
     %%global_location_label%%20
     (<= (nClip (Add (nClip (Add start! m!)) n!)) 256)
   ))
   :pattern ((req%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_from_index_split.
     bits! start! m! n!
   ))
   :qid internal_req__curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_from_index_split._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_from_index_split._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_from_index_split.
 (%%Function%% Int Int Int) Bool
)
(assert
 (forall ((bits! %%Function%%) (start! Int) (m! Int) (n! Int)) (!
   (= (ens%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_from_index_split.
     bits! start! m! n!
    ) (= (curve25519_dalek!specs.core_specs.bits_from_index_to_nat.? (Poly%array%. bits!)
      (I start!) (I (nClip (Add m! n!)))
     ) (nClip (Add (curve25519_dalek!specs.core_specs.bits_from_index_to_nat.? (Poly%array%.
         bits!
        ) (I start!) (I m!)
       ) (nClip (Mul (vstd!arithmetic.power2.pow2.? (I m!)) (curve25519_dalek!specs.core_specs.bits_from_index_to_nat.?
          (Poly%array%. bits!) (I (nClip (Add start! m!))) (I n!)
   )))))))
   :pattern ((ens%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_from_index_split.
     bits! start! m! n!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_from_index_split._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_from_index_split._definition
)))

;; Function-Specs curve25519_dalek::lemmas::common_lemmas::bits_as_nat_lemmas::lemma_bits_from_index_eq_byte_bits
(declare-fun req%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_from_index_eq_byte_bits.
...
(assert
 (forall ((bits! %%Function%%) (byte! Int) (start! Int) (bit_offset! Int) (len! Int))
  (!
   (= (req%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_from_index_eq_byte_bits.
     bits! byte! start! bit_offset! len!
    ) (and
     (=>
      %%global_location_label%%21
      (<= (nClip (Add start! len!)) 256)
     )
     (=>
      %%global_location_label%%22
      (<= (nClip (Add bit_offset! len!)) 8)
     )
     (=>
      ...
      (forall ((j$ Int)) (!
        (=>
         ...
         (=>
          (< j$ len!)
          (= (%B (vstd!seq.Seq.index.? $ BOOL (vstd!view.View.view.? $ (ARRAY $ BOOL $ (CONST_INT
                256
               )
              ) (Poly%array%. bits!)
             ) (I (nClip (Add start! j$)))
            )
           ) (= (uClip 8 (bitand (I (uClip 8 (bitshr (I byte!) (I (uClip 8 (nClip (Add bit_offset! j$)))))))
              (I 1)
             )
            ) 1
        ))))
        :pattern ((vstd!seq.Seq.index.? $ BOOL (vstd!view.View.view.? $ (ARRAY $ BOOL $ (CONST_INT
             256
            )
           ) (Poly%array%. bits!)
          ) (I (nClip (Add start! j$)))
        ))
        :qid user_curve25519_dalek__lemmas__common_lemmas__bits_as_nat_lemmas__lemma_bits_from_index_eq_byte_bits_39
        :skolemid skolem_user_curve25519_dalek__lemmas__common_lemmas__bits_as_nat_lemmas__lemma_bits_from_index_eq_byte_bits_39
   )))))
   :pattern ((req%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_from_index_eq_byte_bits.
     bits! byte! start! bit_offset! len!
   ))
   :qid internal_req__curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_from_index_eq_byte_bits._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_from_index_eq_byte_bits._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_from_index_eq_byte_bits.
 (%%Function%% Int Int Int Int) Bool
)
(assert
 (forall ((bits! %%Function%%) (byte! Int) (start! Int) (bit_offset! Int) (len! Int))
  (!
   (= (ens%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_from_index_eq_byte_bits.
     bits! byte! start! bit_offset! len!
    ) (= (curve25519_dalek!specs.core_specs.bits_from_index_to_nat.? (Poly%array%. bits!)
      (I start!) (I len!)
     ) (curve25519_dalek!specs.core_specs.byte_bits_value.? (I byte!) (I bit_offset!) (
       I len!
   ))))
   :pattern ((ens%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_from_index_eq_byte_bits.
     bits! byte! start! bit_offset! len!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_from_index_eq_byte_bits._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_from_index_eq_byte_bits._definition
)))

;; Function-Specs curve25519_dalek::lemmas::common_lemmas::shift_lemmas::lemma_u8_shr_by_sum
(declare-fun req%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u8_shr_by_sum.
 (Int Int Int) Bool
)
(declare-const %%global_location_label%%24 Bool)
(assert
 (forall ((v! Int) (a! Int) (b! Int)) (!
   (= (req%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u8_shr_by_sum. v!
     a! b!
    ) (=>
     %%global_location_label%%24
     (< (nClip (Add a! b!)) 8)
   ))
   :pattern ((req%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u8_shr_by_sum.
     v! a! b!
   ))
   :qid internal_req__curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u8_shr_by_sum._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u8_shr_by_sum._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u8_shr_by_sum.
 (Int Int Int) Bool
)
(assert
 (forall ((v! Int) (a! Int) (b! Int)) (!
   (= (ens%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u8_shr_by_sum. v!
     a! b!
    ) (= (uClip 8 (bitshr (I v!) (I (nClip (Add a! b!))))) (uClip 8 (bitshr (I (uClip 8 (bitshr
          (I v!) (I a!)
        ))
       ) (I b!)
   ))))
   :pattern ((ens%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u8_shr_by_sum.
     v! a! b!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u8_shr_by_sum._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u8_shr_by_sum._definition
)))

;; Broadcast curve25519_dalek::lemmas::common_lemmas::shift_lemmas::lemma_u8_shr_by_sum
(assert
 (=>
  (fuel_bool fuel%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u8_shr_by_sum.)
  (forall ((v! Poly) (a! Int) (b! Int)) (!
    (=>
     (and
      (has_type v! (UINT 8))
      (<= 0 a!)
     ...
     (=>
      (< (nClip (Add a! b!)) 8)
      (= (uClip 8 (bitshr (I (%I v!)) (I (nClip (Add a! b!))))) (uClip 8 (bitshr (I (uClip 8
           (bitshr (I (%I v!)) (I a!))
          )
         ) (I b!)
    )))))
    :pattern ((uClip 8 (bitshr (I (%I v!)) (I (nClip (Add a! b!))))))
    :qid user_curve25519_dalek__lemmas__common_lemmas__shift_lemmas__lemma_u8_shr_by_sum_43
    :skolemid skolem_user_curve25519_dalek__lemmas__common_lemmas__shift_lemmas__lemma_u8_shr_by_sum_43
))))

;; Function-Specs curve25519_dalek::lemmas::common_lemmas::bits_as_nat_lemmas::lemma_byte_bits_value_is_mod
(declare-fun req%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_byte_bits_value_is_mod.
 (Int Int Int) Bool
)
(declare-const %%global_location_label%%25 Bool)
(assert
 (forall ((byte! Int) (bit_start! Int) (len! Int)) (!
   (= (req%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_byte_bits_value_is_mod.
     byte! bit_start! len!
    ) (=>
     %%global_location_label%%25
     (<= (nClip (Add bit_start! len!)) 8)
   ))
   :pattern ((req%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_byte_bits_value_is_mod.
     byte! bit_start! len!
   ))
   :qid internal_req__curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_byte_bits_value_is_mod._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_byte_bits_value_is_mod._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_byte_bits_value_is_mod.
 (Int Int Int) Bool
)
(assert
 (forall ((byte! Int) (bit_start! Int) (len! Int)) (!
   (= (ens%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_byte_bits_value_is_mod.
     byte! bit_start! len!
    ) (= (curve25519_dalek!specs.core_specs.byte_bits_value.? (I byte!) (I bit_start!)
      (I len!)
     ) (EucMod (uClip 8 (bitshr (I byte!) (I (uClip 8 bit_start!)))) (vstd!arithmetic.power2.pow2.?
       (I len!)
   ))))
   :pattern ((ens%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_byte_bits_value_is_mod.
     byte! bit_start! len!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_byte_bits_value_is_mod._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_byte_bits_value_is_mod._definition
)))

;; Function-Specs curve25519_dalek::lemmas::common_lemmas::shift_lemmas::lemma_u8_shr_zero_is_id
(declare-fun ens%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u8_shr_zero_is_id.
 (Int) Bool
)
(assert
 (forall ((v! Int)) (!
   (= (ens%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u8_shr_zero_is_id.
     v!
    ) (= (uClip 8 (bitshr (I v!) (I 0))) v!)
   )
   :pattern ((ens%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u8_shr_zero_is_id.
     v!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u8_shr_zero_is_id._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u8_shr_zero_is_id._definition
)))

;; Broadcast curve25519_dalek::lemmas::common_lemmas::shift_lemmas::lemma_u8_shr_zero_is_id
(assert
 (=>
  (fuel_bool fuel%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u8_shr_zero_is_id.)
  (forall ((v! Poly)) (!
    (=>
     (has_type v! (UINT 8))
     (= (uClip 8 (bitshr (I (%I v!)) (I 0))) (%I v!))
    )
    :pattern ((uClip 8 (bitshr (I (%I v!)) (I 0))))
    :qid user_curve25519_dalek__lemmas__common_lemmas__shift_lemmas__lemma_u8_shr_zero_is_id_53
    :skolemid skolem_user_curve25519_dalek__lemmas__common_lemmas__shift_lemmas__lemma_u8_shr_zero_is_id_53
))))

;; Function-Specs curve25519_dalek::lemmas::common_lemmas::bits_as_nat_lemmas::lemma_byte_bits_value_full
(declare-fun ens%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_byte_bits_value_full.
 (Int) Bool
)
(assert
 (forall ((byte! Int)) (!
   (= (ens%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_byte_bits_value_full.
     byte!
    ) (= (curve25519_dalek!specs.core_specs.byte_bits_value.? (I byte!) (I 0) (I 8)) byte!)
   )
   :pattern ((ens%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_byte_bits_value_full.
     byte!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_byte_bits_value_full._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_byte_bits_value_full._definition
)))

;; Function-Specs curve25519_dalek::lemmas::common_lemmas::bits_as_nat_lemmas::lemma_bits_chunks_eq_bytes_prefix
(declare-fun req%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_chunks_eq_bytes_prefix.
 (%%Function%% %%Function%% Int) Bool
)
(declare-const %%global_location_label%%26 Bool)
(declare-const %%global_location_label%%27 Bool)
(assert
 (forall ((bits! %%Function%%) (bytes! %%Function%%) (k! Int)) (!
   (= (req%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_chunks_eq_bytes_prefix.
     bits! bytes! k!
    ) (and
     (=>
     ...
     (=>
      ...
      (forall ((i$ Poly)) (!
        (=>
         ...
         (=>
          ...
          (= (%B (vstd!seq.Seq.index.? $ BOOL (vstd!view.View.view.? $ (ARRAY $ BOOL $ (CONST_INT
           ...
           ) (= (uClip 8 (bitand (I (uClip 8 (bitshr (I (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.?
                     $ (ARRAY $ (UINT 8) $ (CONST_INT 32)) (Poly%array%. bytes!)
                    ) (I (EucDiv (%I i$) 8))
                  ))
                 ) (I (uClip 8 (EucMod (%I i$) 8)))
               ))
              ) (I 1)
             )
            ) 1
        ...
        :qid user_curve25519_dalek__lemmas__common_lemmas__bits_as_nat_lemmas__lemma_bits_chunks_eq_bytes_prefix_58
        :skolemid skolem_user_curve25519_dalek__lemmas__common_lemmas__bits_as_nat_lemmas__lemma_bits_chunks_eq_bytes_prefix_58
   )))))
   :pattern ((req%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_chunks_eq_bytes_prefix.
     bits! bytes! k!
   ))
   :qid internal_req__curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_chunks_eq_bytes_prefix._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_chunks_eq_bytes_prefix._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_chunks_eq_bytes_prefix.
 (%%Function%% %%Function%% Int) Bool
)
(assert
 (forall ((bits! %%Function%%) (bytes! %%Function%%) (k! Int)) (!
   (= (ens%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_chunks_eq_bytes_prefix.
     bits! bytes! k!
    ) (= (curve25519_dalek!specs.core_specs.bits_from_index_to_nat.? (Poly%array%. bits!)
      (I 0) (I (nClip (Mul 8 k!)))
   ...
   :pattern ((ens%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_chunks_eq_bytes_prefix.
     bits! bytes! k!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_chunks_eq_bytes_prefix._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_chunks_eq_bytes_prefix._definition
)))

;; Function-Specs curve25519_dalek::lemmas::common_lemmas::bits_as_nat_lemmas::lemma_bits_from_bytes_eq_u8_32_as_nat
(declare-fun req%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_from_bytes_eq_u8_32_as_nat.
 (%%Function%% %%Function%%) Bool
)
(declare-const %%global_location_label%%28 Bool)
(assert
 (forall ((bits! %%Function%%) (bytes! %%Function%%)) (!
   (= (req%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_from_bytes_eq_u8_32_as_nat.
     bits! bytes!
    ) (=>
     ...
     (forall ((i$ Poly)) (!
       ...
       :qid user_curve25519_dalek__lemmas__common_lemmas__bits_as_nat_lemmas__lemma_bits_from_bytes_eq_u8_32_as_nat_67
       :skolemid skolem_user_curve25519_dalek__lemmas__common_lemmas__bits_as_nat_lemmas__lemma_bits_from_bytes_eq_u8_32_as_nat_67
   ))))
   :pattern ((req%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_from_bytes_eq_u8_32_as_nat.
     bits! bytes!
   ))
   :qid internal_req__curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_from_bytes_eq_u8_32_as_nat._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_from_bytes_eq_u8_32_as_nat._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_from_bytes_eq_u8_32_as_nat.
 (%%Function%% %%Function%%) Bool
)
(assert
 (forall ((bits! %%Function%%) (bytes! %%Function%%)) (!
   (= (ens%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_from_bytes_eq_u8_32_as_nat.
     bits! bytes!
    ) (= (curve25519_dalek!specs.core_specs.bits_as_nat.? (Poly%array%. bits!)) (curve25519_dalek!specs.core_specs.u8_32_as_nat.?
      (Poly%array%. bytes!)
   )))
   :pattern ((ens%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_from_bytes_eq_u8_32_as_nat.
     bits! bytes!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_from_bytes_eq_u8_32_as_nat._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_from_bytes_eq_u8_32_as_nat._definition
)))

;; Function-Specs curve25519_dalek::lemmas::common_lemmas::bits_as_nat_lemmas::lemma_bits_as_nat_lt_pow2_255_implies_msb_false
(declare-fun req%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_as_nat_lt_pow2_255_implies_msb_false.
 (%%Function%%) Bool
)
(declare-const %%global_location_label%%29 Bool)
(assert
 (forall ((bits! %%Function%%)) (!
   (= (req%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_as_nat_lt_pow2_255_implies_msb_false.
     bits!
    ) (=>
     %%global_location_label%%29
     (< (curve25519_dalek!specs.core_specs.bits_as_nat.? (Poly%array%. bits!)) (vstd!arithmetic.power2.pow2.?
       (I 255)
   ))))
   :pattern ((req%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_as_nat_lt_pow2_255_implies_msb_false.
     bits!
   ))
   :qid internal_req__curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_as_nat_lt_pow2_255_implies_msb_false._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_as_nat_lt_pow2_255_implies_msb_false._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_as_nat_lt_pow2_255_implies_msb_false.
 (%%Function%%) Bool
)
(assert
 (forall ((bits! %%Function%%)) (!
   (= (ens%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_as_nat_lt_pow2_255_implies_msb_false.
     bits!
    ) (not (%B (vstd!seq.Seq.index.? $ BOOL (vstd!view.View.view.? $ (ARRAY $ BOOL $ (CONST_INT
          256
         )
        ) (Poly%array%. bits!)
       ) (I 255)
   ))))
   :pattern ((ens%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_as_nat_lt_pow2_255_implies_msb_false.
     bits!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_as_nat_lt_pow2_255_implies_msb_false._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_as_nat_lt_pow2_255_implies_msb_false._definition
)))

;; Function-Specs curve25519_dalek::lemmas::common_lemmas::bits_as_nat_lemmas::lemma_bits_be_as_nat_eq_bits_from_index
(declare-fun req%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_be_as_nat_eq_bits_from_index.
 (%%Function%% slice%<bool.>. Int) Bool
)
(declare-const %%global_location_label%%30 Bool)
(declare-const %%global_location_label%%31 Bool)
(declare-const %%global_location_label%%32 Bool)
(assert
 (forall ((bits_le! %%Function%%) (bits_be! slice%<bool.>.) (len! Int)) (!
   (= (req%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_be_as_nat_eq_bits_from_index.
     bits_le! bits_be! len!
    ) (and
     (=>
     ...
     (=>
      ...
      (= (vstd!slice.spec_slice_len.? $ BOOL (Poly%slice%<bool.>. bits_be!)) 255)
     )
     (=>
      ...
      (forall ((i$ Poly)) (!
        (=>
         ...
         (=>
          ...
          (= (vstd!seq.Seq.index.? $ BOOL (vstd!view.View.view.? $slice (SLICE $ BOOL) (Poly%slice%<bool.>.
              bits_be!
             )
            ) i$
           ) (vstd!seq.Seq.index.? $ BOOL (vstd!view.View.view.? $ (ARRAY $ BOOL $ (CONST_INT 256))
             (Poly%array%. bits_le!)
            ) (I (Sub 254 (%I i$)))
        ))))
        :pattern ((vstd!seq.Seq.index.? $ BOOL (vstd!view.View.view.? $slice (SLICE $ BOOL)
           (Poly%slice%<bool.>. bits_be!)
          ) i$
        ))
        :qid user_curve25519_dalek__lemmas__common_lemmas__bits_as_nat_lemmas__lemma_bits_be_as_nat_eq_bits_from_index_76
        :skolemid skolem_user_curve25519_dalek__lemmas__common_lemmas__bits_as_nat_lemmas__lemma_bits_be_as_nat_eq_bits_from_index_76
   )))))
   :pattern ((req%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_be_as_nat_eq_bits_from_index.
     bits_le! bits_be! len!
   ))
   :qid internal_req__curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_be_as_nat_eq_bits_from_index._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_be_as_nat_eq_bits_from_index._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_be_as_nat_eq_bits_from_index.
 (%%Function%% slice%<bool.>. Int) Bool
)
(assert
 (forall ((bits_le! %%Function%%) (bits_be! slice%<bool.>.) (len! Int)) (!
   (= (ens%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_be_as_nat_eq_bits_from_index.
     bits_le! bits_be! len!
    ) (= (curve25519_dalek!specs.core_specs.bits_be_as_nat.? (Poly%slice%<bool.>. bits_be!)
      (I len!)
     ) (curve25519_dalek!specs.core_specs.bits_from_index_to_nat.? (Poly%array%. bits_le!)
      (I (nClip (Sub 255 len!))) (I len!)
   )))
   :pattern ((ens%curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_be_as_nat_eq_bits_from_index.
     bits_le! bits_be! len!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_be_as_nat_eq_bits_from_index._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.common_lemmas.bits_as_nat_lemmas.lemma_bits_be_as_nat_eq_bits_from_index._definition
)))

;; Function-Def curve25519_dalek::lemmas::common_lemmas::bits_as_nat_lemmas::lemma_bits_be_as_nat_eq_bits_from_index
;; curve25519-dalek/src/lemmas/common_lemmas/bits_as_nat_lemmas.rs:118:1: 122:2 (#0)
(get-info :all-statistics)
(push)
 (declare-const bits_le! %%Function%%)
 (declare-const bits_be! slice%<bool.>.)
 ...
 (assert
  (has_type (Poly%array%. bits_le!) (ARRAY $ BOOL $ (CONST_INT 256)))
 )
 (assert
  (<= 0 len!)
 )
 ...
 (assert
  (forall ((i$ Poly)) (!
    ...
    :qid user_curve25519_dalek__lemmas__common_lemmas__bits_as_nat_lemmas__lemma_bits_be_as_nat_eq_bits_from_index_79
    :skolemid skolem_user_curve25519_dalek__lemmas__common_lemmas__bits_as_nat_lemmas__lemma_bits_be_as_nat_eq_bits_from_index_79
 )))
    ...
    (or
     (and
      (=>
       (= len! 0)
       (=>
        (= tmp%1 (= (curve25519_dalek!specs.core_specs.bits_be_as_nat.? (Poly%slice%<bool.>.
            bits_be!
           ) (I 0)
          ) 0
        ))
        (and
         ...
         (=>
          tmp%1
          (=>
           (= tmp%2 (= (curve25519_dalek!specs.core_specs.bits_from_index_to_nat.? (Poly%array%.
               bits_le!
              ) (I 255) (I 0)
             ) 0
           ))
        ...
        (=>
         ...
         (and
          (=>
           ...
           (and
            ...
            (=>
             tmp%3
             (=>
              (= tmp%4 (= (vstd!seq.Seq.index.? $ BOOL (vstd!view.View.view.? $slice (SLICE $ BOOL)
                  (Poly%slice%<bool.>. bits_be!)
                 ) (I (Sub len! 1))
                ) (vstd!seq.Seq.index.? $ BOOL (vstd!view.View.view.? $ (ARRAY $ BOOL $ (CONST_INT 256))
                  (Poly%array%. bits_le!)
          ...
          (=>
           ...
           (=>
            (= tmp%6 (= (curve25519_dalek!specs.core_specs.bits_be_as_nat.? (Poly%slice%<bool.>.
                bits_be!
               ) (I len!)
              ) (nClip (Add (ite
                 (%B (vstd!seq.Seq.index.? $ BOOL (vstd!view.View.view.? $slice (SLICE $ BOOL) (Poly%slice%<bool.>.
                     bits_be!
                    )
                   ) (I (Sub len! 1))
                 ))
                 1
                 0
                ) (nClip (Mul 2 (curve25519_dalek!specs.core_specs.bits_be_as_nat.? (Poly%slice%<bool.>.
                    bits_be!
                   ) (I (Sub len! 1))
            )))))))
            (and
             ...
             (=>
              tmp%6
              (=>
               (= tmp%7 (= (curve25519_dalek!specs.core_specs.bits_from_index_to_nat.? (Poly%array%.
                   bits_le!
                  ) (I start@) (I len!)
                 ) (nClip (Add bit_value@ (nClip (Mul 2 (curve25519_dalek!specs.core_specs.bits_from_index_to_nat.?
                      (Poly%array%. bits_le!) (I (nClip (Add start@ 1))) (I (nClip (Sub len! 1)))
               )))))))
               (and
                (=>
                 %%location_label%%7
                ...
                (=>
                 tmp%7
                 (=>
                  (= tmp%8 (= (curve25519_dalek!specs.core_specs.bits_be_as_nat.? (Poly%slice%<bool.>.
                      bits_be!
                     ) (I len!)
                    ) (nClip (Add bit_value@ (nClip (Mul 2 (curve25519_dalek!specs.core_specs.bits_be_as_nat.?
                         (Poly%slice%<bool.>. bits_be!) (I (Sub len! 1))
                  )))))))
                  (and
                   (=>
                    %%location_label%%8
                   ...
                   (=>
                    ...
                    (and
                     (=>
                      (= tmp%9 (nClip (Sub len! 1)))
                      (and
                       (=>
                        %%location_label%%9
                        (check_decrease_int (let
                          ((bits_le!$0 bits_le!) (bits_be!$1 bits_be!) (len!$2 tmp%9))
                          len!$2
                        ...
                        (=>
                         ...
                         (=>
                          ...
                          (= (curve25519_dalek!specs.core_specs.bits_be_as_nat.? (Poly%slice%<bool.>. bits_be!)
                            ...
                            (I (nClip (Add start@ 1))) (I (nClip (Sub len! 1)))
                     )))))))
                     (=>
                      (= (curve25519_dalek!specs.core_specs.bits_be_as_nat.? (Poly%slice%<bool.>. bits_be!)
                        (I (Sub len! 1))
                      ...
                      (=>
                       (= tmp%10 (= (curve25519_dalek!specs.core_specs.bits_be_as_nat.? (Poly%slice%<bool.>.
                           bits_be!
                          ) (I len!)
                         ) (nClip (Add bit_value@ (nClip (Mul 2 (curve25519_dalek!specs.core_specs.bits_from_index_to_nat.?
                              (Poly%array%. bits_le!) (I (nClip (Add start@ 1))) (I (nClip (Sub len! 1)))
                       ...
                       (and
                        ...
                        (=>
                         tmp%10
                         (=>
                          (= tmp%11 (= (curve25519_dalek!specs.core_specs.bits_be_as_nat.? (Poly%slice%<bool.>.
                              bits_be!
                             ) (I len!)
                            ) (curve25519_dalek!specs.core_specs.bits_from_index_to_nat.? (Poly%array%. bits_le!)
                             (I start@) (I len!)
