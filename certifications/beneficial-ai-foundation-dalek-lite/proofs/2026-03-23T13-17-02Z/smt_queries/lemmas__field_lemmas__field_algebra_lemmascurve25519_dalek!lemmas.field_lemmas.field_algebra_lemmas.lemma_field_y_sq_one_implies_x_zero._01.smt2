...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:1603:1: 1603:73 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_field_y_sq_one_implies_x_zero
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:1603:1: 1603:73 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= x2@ (curve25519_dalek!specs.field_specs.field_square.? (I x!)))
    (=>
         ...
         (=>
          ...
          (=>
           ...
           (and
            (=>
             %%location_label%%2
             (req%vstd!arithmetic.div_mod.lemma_small_mod. x2@ tmp%3)
            )
            (=>
             (ens%vstd!arithmetic.div_mod.lemma_small_mod. x2@ tmp%3)
             (=>
              %%location_label%%3
              (= (curve25519_dalek!specs.field_specs.field_mul.? (I x2@) (I 1)) x2@)
         )))))
         (=>
          (= (curve25519_dalek!specs.field_specs.field_mul.? (I x2@) (I 1)) x2@)
          (=>
           ...
           (and
            (=>
             (= tmp%4 (Sub (curve25519_dalek!specs.field_specs_u64.p.? (I 0)) (EucMod x2@ (curve25519_dalek!specs.field_specs_u64.p.?
                 (I 0)
             ))))
             (=>
              ...
              (and
               ...
               (=>
                ...
                (=>
                 %%location_label%%5
                 (< neg_x2@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
            )))))
            (=>
             (< neg_x2@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
             (and
              (=>
               ...
               (=>
                %%location_label%%6
                (= (curve25519_dalek!specs.field_specs.field_sub.? (I 1) (I x2@)) (curve25519_dalek!specs.field_specs.field_add.?
                  (I 1) (I neg_x2@)
              ))))
              (=>
               (= (curve25519_dalek!specs.field_specs.field_sub.? (I 1) (I x2@)) (curve25519_dalek!specs.field_specs.field_add.?
               ...
               (and
                (=>
                 ...
                 (=>
                  %%location_label%%7
                  (= (curve25519_dalek!specs.field_specs.field_add.? (I neg_x2@) (I 1)) (curve25519_dalek!specs.field_specs.field_add.?
                    (I 1) (I neg_x2@)
                ))))
                (=>
                 (= (curve25519_dalek!specs.field_specs.field_add.? (I neg_x2@) (I 1)) (curve25519_dalek!specs.field_specs.field_add.?
                 ...
                 (and
                  ...
                  (=>
                   ...
                   (=>
                    (= dx2@ (curve25519_dalek!specs.field_specs.field_mul.? (I d!) (I x2@)))
                    (and
                     (=>
                      (= tmp%6 (nClip (Mul d! x2@)))
                      (=>
                       (= tmp%7 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                       (and
                        (=>
                         %%location_label%%10
                         (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%6 tmp%7)
                        )
                        (=>
                         (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%6 tmp%7)
                         (=>
                          %%location_label%%11
                          (< dx2@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                     )))))
                     (=>
                      (< dx2@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                      (and
                       (=>
                        ...
                        (=>
                         %%location_label%%12
                         (= (curve25519_dalek!specs.field_specs.field_add.? (I dx2@) (I 1)) (curve25519_dalek!specs.field_specs.field_add.?
                           (I 1) (I dx2@)
                       ))))
                       (=>
                        (= (curve25519_dalek!specs.field_specs.field_add.? (I dx2@) (I 1)) (curve25519_dalek!specs.field_specs.field_add.?
                        ...
                        (and
                         ...
                         (=>
                          ...
                          (=>
                           (= tmp%8 (= (curve25519_dalek!specs.field_specs.field_sub.? (I 1) (I x2@)) (curve25519_dalek!specs.field_specs.field_add.?
                              (I 1) (I dx2@)
                           )))
                           (and
                            (=>
                            ...
                            (=>
                             tmp%8
                             (=>
                              (= tmp%9 (= (curve25519_dalek!specs.field_specs.field_add.? (I neg_x2@) (I 1)) (curve25519_dalek!specs.field_specs.field_add.?
                                 (I dx2@) (I 1)
                              )))
                              (and
                               (=>
                                    ...
                                    (=>
                                     ...
                                     (=>
                                      ...
                                      (=>
                                       ...
                                       (=>
                                        %%location_label%%18
                                        (= (curve25519_dalek!specs.field_specs.field_add.? (I neg_x2@) (I x2@)) 0)
                                    ))))
                                    (=>
                                     (= (curve25519_dalek!specs.field_specs.field_add.? (I neg_x2@) (I x2@)) 0)
                                     (=>
                                      (= tmp%11 (= (curve25519_dalek!specs.field_specs.field_add.? (I dx2@) (I x2@)) 0))
                                      (and
                                       (=>
                                        %%location_label%%19
                                        tmp%11
                                         ...
                                         (=>
                                          ...
                                          (=>
                                           ...
                                           (and
                                            (=>
                                             %%location_label%%20
                                             (req%vstd!arithmetic.div_mod.lemma_small_mod. x2@ tmp%12)
                                            )
                                            (=>
                                             (ens%vstd!arithmetic.div_mod.lemma_small_mod. x2@ tmp%12)
                                             (=>
                                              %%location_label%%21
                                              (= (curve25519_dalek!specs.field_specs.field_mul.? (I 1) (I x2@)) x2@)
                                         )))))
                                         (=>
                                          (= (curve25519_dalek!specs.field_specs.field_mul.? (I 1) (I x2@)) x2@)
                                          (and
                                           (=>
                                            ...
                                            (=>
                                             ...
                                             (=>
                                              ...
                                              (=>
                                               %%location_label%%22
                                               (= (curve25519_dalek!specs.field_specs.field_mul.? (I x2@) (I (curve25519_dalek!specs.field_specs.field_add.?
                                                   (I d!) (I 1)
                                                 ))
                                                ) (curve25519_dalek!specs.field_specs.field_add.? (I dx2@) (I x2@))
                                           )))))
                                           (=>
                                            (= (curve25519_dalek!specs.field_specs.field_mul.? (I x2@) (I (curve25519_dalek!specs.field_specs.field_add.?
                                                (I d!) (I 1)
                                            ...
                                            (and
                                             (=>
                                              (= tmp%13 (curve25519_dalek!specs.field_specs.field_add.? (I d!) (I 1)))
                                              (=>
                                               (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_comm.
                                                tmp%13 x2@
                                               )
                                             ...
                                             (=>
                                              ...
                                              (and
                                               (or
                                                (and
                                                 (=>
                                                  (not (= (EucMod x2@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0))
                                                  (=>
                                                   (= tmp%14 (curve25519_dalek!specs.field_specs.field_add.? (I d!) (I 1)))
                                                   (=>
                                                    ...
                                                    (and
                                                     ...
                                                     (=>
                                                      ...
                                                      (=>
                                                       (= tmp%16 (curve25519_dalek!specs.field_specs.field_add.? (I d!) (I 1)))
                                                       (and
                                                        (=>
                                                         %%location_label%%25
                                                         (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_nonzero_product.
                                                 ...
                                                 (=>
                                                  (not (not (= (EucMod x2@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0)))
                                                  %%switch_label%%1
                                                ))
                                                (and
                                                 (not %%switch_label%%1)
                                                 (=>
                                                  %%location_label%%26
                                                  (= (EucMod x2@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0)
                                               )))
                                               (=>
                                                (= (EucMod x2@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0)
                                                (=>
                                                    ...
                                                    (and
                                                     (or
                                                      (and
                                                       ...
                                                       (=>
                                                        (not (not (= (EucMod x! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0)))
                                                        %%switch_label%%0
                                                      ))
                                                      (and
                                                       (not %%switch_label%%0)
                                                       (=>
                                                        %%location_label%%29
                                                        (= (EucMod x! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0)
                                                     )))
                                                     (=>
                                                      (= (EucMod x! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0)
                                                      (=>
                                                       ...
                                                       (and
                                                        (=>
                                                         %%location_label%%30
                                                         (req%vstd!arithmetic.div_mod.lemma_small_mod. x! tmp%18)
                                                        )
                                                        (=>
                                                         (ens%vstd!arithmetic.div_mod.lemma_small_mod. x! tmp%18)
                                                         (=>
                                                          %%location_label%%31
                                                          (= x! 0)
                                                    ))))))
