...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:3006:1: 3006:64 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_swap_sub_negates_mul
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:3006:1: 3006:64 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= diff@ (curve25519_dalek!specs.field_specs.field_sub.? (I a!) (I b!)))
    (=>
     (= neg_diff@ (curve25519_dalek!specs.field_specs.field_neg.? (I diff@)))
     (=>
      (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_sub_antisymmetric.
       a! b!
      )
      (=>
       (= tmp%1 (= (curve25519_dalek!specs.field_specs.field_sub.? (I b!) (I a!)) neg_diff@))
       (and
        (=>
         %%location_label%%0
         tmp%1
