...
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:58:1: 58:76 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::number_theory_lemmas::lemma_divides_linear_combo_sub
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:58:1: 58:76 (#0)
...
(push)
 ...
 (assert
  (not (and
    (=>
     %%location_label%%0
     (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. k! y! d!)
    )
    (=>
     (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. k! y! d!)
     (=>
      (= tmp%1 (= (EucMod (Mul k! y!) d!) (EucMod (Mul k! (EucMod y! d!)) d!)))
      (and
       (=>
        %%location_label%%1
        tmp%1
        ...
        (=>
         ...
         (and
          ...
          (=>
           tmp%2
           (=>
            (= tmp%3 (= (Mul k! (EucMod y! d!)) (Mul k! 0)))
            (and
             (=>
              %%location_label%%3
              tmp%3
               ...
               (and
                ...
                (=>
                 ...
                 (and
                  (=>
                   %%location_label%%5
                   (req%vstd!arithmetic.div_mod.lemma_mod_self_0. d!)
                  )
                  (=>
                   (ens%vstd!arithmetic.div_mod.lemma_mod_self_0. d!)
                   (=>
                    (= tmp%5 (= (EucMod 0 d!) 0))
                    (and
                     (=>
                     ...
                     (=>
                      tmp%5
                      (=>
                       (= tmp%6 (= (EucMod (nClip (Mul k! y!)) d!) 0))
                       (and
                        (=>
                         %%location_label%%7
                         tmp%6
                        ...
                        (=>
                         ...
                         (=>
                          ...
                          (and
                           (=>
                            %%location_label%%8
                            (req%vstd!arithmetic.div_mod.lemma_sub_mod_noop. x! tmp%7 d!)
                           )
                           (=>
                            (ens%vstd!arithmetic.div_mod.lemma_sub_mod_noop. x! tmp%7 d!)
                            (=>
                             %%location_label%%9
                             (= (EucMod (nClip (Sub x! (nClip (Mul k! y!)))) d!) 0)
 ))))))))))))))))))))))))))))
