...
;; MODULE 'module lemmas::lizard_lemmas, function curve25519_dalek::lemmas::lizard_lemmas::lemma_candidate_from_jq_spec'
;; curve25519-dalek/src/lemmas/lizard_lemmas.rs:1132:1: 1132:79 (#0)
...
(assert
 (distinct fuel%vstd!array.array_view. fuel%vstd!array.impl&%0.view. fuel%vstd!array.impl&%2.spec_index.
  ...
  fuel%curve25519_dalek!backend.serial.u64.constants.EDWARDS_D. fuel%curve25519_dalek!specs.edwards_specs.is_on_edwards_curve_projective.
  ...
  fuel%curve25519_dalek!specs.field_specs_u64.u64_5_as_nat. fuel%curve25519_dalek!specs.lizard_specs.spec_lizard_decode_candidates.
...
(declare-fun %%array%%1 (Poly Poly Poly Poly Poly Poly Poly Poly) %%Function%%)
(assert
 (forall ((%%hole%%0 Poly) (%%hole%%1 Poly) (%%hole%%2 Poly) (%%hole%%3 Poly) (%%hole%%4
    Poly
  ...
  (forall ((point! Poly)) (!
    (= (curve25519_dalek!specs.lizard_specs.spec_lizard_decode_candidates.? point!) (%Poly%array%.
      (let
       ...
       (array_new (DST $) (TYPE%tuple%2. $ BOOL $ NAT) 8 (%%array%%1 (Poly%tuple%2. (curve25519_dalek!specs.lizard_specs.spec_elligator_inv.?
...
;; Function-Def curve25519_dalek::lemmas::lizard_lemmas::lemma_candidate_from_jq_spec
;; curve25519-dalek/src/lemmas/lizard_lemmas.rs:1132:1: 1132:79 (#0)
        ...
        (and
         (and
          (and
           (and
            (and
             (ext_eq false (TYPE%tuple%2. $ BOOL $ NAT) (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2.
                $ BOOL $ NAT
