...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:1703:1: 1703:59 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_a_times_inv_ab_is_inv_b
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:1703:1: 1703:59 (#0)
...
(push)
 ...
 (declare-const inv_a@ Int)
 (declare-const inv_b@ Int)
 (declare-const inv_ab@ Int)
 (declare-const inv_a_times_inv_b@ Int)
 (declare-const a_times_inv_ab@ Int)
 (assert
  fuel_defaults
 )
 (assert
  ...
  (not (=>
    ...
    (=>
     ...
     (=>
      ...
      (=>
       (= inv_a@ (curve25519_dalek!specs.field_specs.field_inv.? (I a!)))
       (=>
        (= inv_b@ (curve25519_dalek!specs.field_specs.field_inv.? (I b!)))
        (=>
         (= inv_ab@ (curve25519_dalek!specs.field_specs.field_inv.? (I ab@)))
         (or
          (and
           (=>
            (= (EucMod b! p@) 0)
                ...
                (=>
                 ...
                 (and
                  ...
                  (=>
                   ...
                   (=>
                    %%location_label%%6
                    (= (curve25519_dalek!specs.field_specs.field_mul.? (I a!) (I inv_ab@)) 0)
             )))))))
             (=>
              (= (curve25519_dalek!specs.field_specs.field_mul.? (I a!) (I inv_ab@)) 0)
              (=>
           ...
           (and
            (=>
             ...
             (and
              (=>
               %%location_label%%9
               (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%2 p@)
              )
              (=>
               (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%2 p@)
               (=>
                (= tmp%3 (nClip (Mul a! b!)))
                (and
                 (=>
                  %%location_label%%10
                  (req%vstd!arithmetic.div_mod.lemma_mod_twice. tmp%3 p@)
                 )
                 (=>
                  (ens%vstd!arithmetic.div_mod.lemma_mod_twice. tmp%3 p@)
                  (or
                   (and
                    (=>
                     (= (EucMod (nClip (Mul a! b!)) p@) 0)
            ...
            (=>
             (not (= (EucMod ab@ p@) 0))
             (=>
              (= inv_a_times_inv_b@ (curve25519_dalek!specs.field_specs.field_mul.? (I inv_a@) (I
                 inv_b@
              )))
              (and
               (=>
                ...
                (=>
                 %%location_label%%14
                 (= inv_ab@ inv_a_times_inv_b@)
               ))
               (=>
                (= inv_ab@ inv_a_times_inv_b@)
                (=>
                 (= a_times_inv_ab@ (curve25519_dalek!specs.field_specs.field_mul.? (I a!) (I inv_ab@)))
                 (and
                  (=>
                   (= tmp%4 (nClip (Mul inv_a@ inv_b@)))
                   (and
                    (=>
                     %%location_label%%15
                     (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. a! tmp%4 p@)
                    )
                    (=>
                     (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. a! tmp%4 p@)
                     (=>
                      %%location_label%%16
                      (= (EucMod (nClip (Mul a! inv_a_times_inv_b@)) p@) (EucMod (nClip (Mul a! (nClip (Mul inv_a@
                            inv_b@
                         )))
                        ) p@
                  ))))))
                  (=>
                   ...
                   (and
                    (=>
                     (ens%vstd!arithmetic.mul.lemma_mul_is_associative. a! inv_a@ inv_b@)
                     (=>
                      %%location_label%%17
                      (= (nClip (Mul a! (nClip (Mul inv_a@ inv_b@)))) (nClip (Mul (nClip (Mul a! inv_a@))
                         inv_b@
                    )))))
                    (=>
                     (= (nClip (Mul a! (nClip (Mul inv_a@ inv_b@)))) (nClip (Mul (nClip (Mul a! inv_a@))
                      ...
                      (and
                       ...
                       (=>
                        ...
                        (and
                         (=>
                          %%location_label%%19
                          (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. a! inv_a@ p@)
                         )
                         (=>
                          (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. a! inv_a@ p@)
                          (=>
                           %%location_label%%20
                           (= (EucMod (nClip (Mul a! inv_a@)) p@) 1)
                      )))))
                      (=>
                       (= (EucMod (nClip (Mul a! inv_a@)) p@) 1)
                       (and
                        (=>
                         (= tmp%5 (nClip (Mul a! inv_a@)))
                         (and
                          (=>
                           %%location_label%%21
                           (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. tmp%5 inv_b@ p@)
                          )
                          (=>
                           (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. tmp%5 inv_b@ p@)
                           (=>
                            %%location_label%%22
                            (= (EucMod (nClip (Mul (EucMod (nClip (Mul a! inv_a@)) p@) inv_b@)) p@) (EucMod (nClip
                               (Mul (nClip (Mul a! inv_a@)) inv_b@)
                              ) p@
                        ))))))
                        (=>
                         (= (EucMod (nClip (Mul (EucMod (nClip (Mul a! inv_a@)) p@) inv_b@)) p@) (EucMod (nClip
                         ...
                         (and
                          (and
                           (=>
                            %%location_label%%23
                            (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. 1 inv_b@ p@)
                           )
                           (=>
                            (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. 1 inv_b@ p@)
                            (=>
                             %%location_label%%24
                             (= (EucMod (nClip (Mul 1 inv_b@)) p@) (EucMod (nClip (Mul (nClip (Mul a! inv_a@)) inv_b@))
                               p@
                          )))))
                          (=>
                           (= (EucMod (nClip (Mul 1 inv_b@)) p@) (EucMod (nClip (Mul (nClip (Mul a! inv_a@)) inv_b@))
                           ...
                           (and
                            (and
                             (=>
                              %%location_label%%25
                              (req%curve25519_dalek!specs.field_specs.field_inv_property. b!)
                             )
                             (=>
                              (ens%curve25519_dalek!specs.field_specs.field_inv_property. b!)
                              (and
                               (=>
                                %%location_label%%26
                                (req%vstd!arithmetic.div_mod.lemma_small_mod. inv_b@ p@)
                               )
                               (=>
                                (ens%vstd!arithmetic.div_mod.lemma_small_mod. inv_b@ p@)
                                (=>
                                 %%location_label%%27
                                 (= (EucMod inv_b@ p@) inv_b@)
                            )))))
                            (=>
                             (= (EucMod inv_b@ p@) inv_b@)
                             (and
                              (=>
                               (ens%vstd!arithmetic.mul.lemma_mul_basics. inv_b@)
                               (=>
                                %%location_label%%28
                                (= (EucMod (nClip (Mul 1 inv_b@)) p@) inv_b@)
                              ))
                              (=>
                               (= (EucMod (nClip (Mul 1 inv_b@)) p@) inv_b@)
                               (and
                                (and
                                 (=>
                                  %%location_label%%29
                                  (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. a! inv_ab@ p@)
                                 )
                                 (=>
                                  (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. a! inv_ab@ p@)
                                  (=>
                                   %%location_label%%30
                                   (= (EucMod (nClip (Mul a! inv_ab@)) p@) (EucMod (nClip (Mul a! inv_a_times_inv_b@))
                                     p@
                                )))))
                                (=>
                                 (= (EucMod (nClip (Mul a! inv_ab@)) p@) (EucMod (nClip (Mul a! inv_a_times_inv_b@))
                                 ...
                                 (and
                                  (=>
                                   (= tmp%6 (nClip (Mul inv_a@ inv_b@)))
                                   (and
                                    (=>
                                     %%location_label%%31
                                     (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. a! tmp%6 p@)
                                    )
                                    (=>
                                     (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. a! tmp%6 p@)
                                     (=>
                                      %%location_label%%32
                                      (= (EucMod (nClip (Mul a! inv_a_times_inv_b@)) p@) (EucMod (nClip (Mul a! (nClip (Mul inv_a@
                                            inv_b@
