...
;; curve25519-dalek/src/lemmas/edwards_lemmas/step1_lemmas.rs:130:1: 130:68 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::step1_lemmas::lemma_sqrt_ratio_success_means_valid_y
;; curve25519-dalek/src/lemmas/edwards_lemmas/step1_lemmas.rs:130:1: 130:68 (#0)
      ...
      (=>
       ...
       (=>
        ...
        (=>
         ...
         (and
          (=>
           (= tmp%1 (Sub (nClip (Add (EucMod y2@ p@) p@)) (EucMod 1 p@)))
           (and
            (=>
             %%location_label%%0
          ...
          (=>
           ...
           (and
            (=>
             (= tmp%2 (nClip (Add (EucMod (nClip (Mul d@ y2@)) p@) 1)))
             (and
              (=>
               %%location_label%%2
            ...
            (=>
             ...
             (and
              (=>
               %%location_label%%4
               (req%vstd!arithmetic.div_mod.lemma_small_mod. u@ p@)
              )
              (=>
               (ens%vstd!arithmetic.div_mod.lemma_small_mod. u@ p@)
               (and
                (=>
                 %%location_label%%5
                 (req%vstd!arithmetic.div_mod.lemma_small_mod. v@ p@)
                )
                (=>
                 (ens%vstd!arithmetic.div_mod.lemma_small_mod. v@ p@)
                 (=>
                  (= tmp%3 (not (= (EucMod v@ p@) 0)))
                  (and
                   (=>
                    %%location_label%%6
                    tmp%3
                   ...
                   (=>
                    ...
                    (=>
                     ...
                     (and
                      (=>
                       %%location_label%%7
                       (req%vstd!arithmetic.div_mod.lemma_mod_bound. r! p@)
                      )
                      (=>
                       (ens%vstd!arithmetic.div_mod.lemma_mod_bound. r! p@)
                       (=>
                        (= tmp%4 (< r_prime@ p@))
                        (and
                         (=>
                         ...
                         (=>
                          ...
                          (=>
                           ...
                           (=>
                            (= tmp%5 (= (curve25519_dalek!specs.field_specs.field_square.? (I r_prime@)) (curve25519_dalek!specs.field_specs.field_square.?
                               (I r!)
                            )))
                            (and
                             (=>
