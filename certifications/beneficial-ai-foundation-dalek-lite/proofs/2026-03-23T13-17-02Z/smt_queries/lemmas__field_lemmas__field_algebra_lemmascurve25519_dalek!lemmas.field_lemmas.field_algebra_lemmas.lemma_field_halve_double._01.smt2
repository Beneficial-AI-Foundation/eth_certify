...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:565:1: 565:46 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_field_halve_double
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:565:1: 565:46 (#0)
    ...
    (=>
     ...
     (and
      ...
      (=>
       (not (= (EucMod 2 p@) 0))
       (=>
        (= inv2@ (curve25519_dalek!specs.field_specs.field_inv.? (I 2)))
        (and
         (and
          (=>
           %%location_label%%2
           (req%curve25519_dalek!specs.field_specs.field_inv_property. 2)
          )
          (=>
           (ens%curve25519_dalek!specs.field_specs.field_inv_property. 2)
           (and
            (=>
             %%location_label%%3
             (req%vstd!arithmetic.div_mod.lemma_small_mod. 2 p@)
            ...
            (=>
             ...
             (=>
              %%location_label%%4
              (= (curve25519_dalek!specs.field_specs.field_mul.? (I 2) (I inv2@)) 1)
         )))))
         (=>
          (= (curve25519_dalek!specs.field_specs.field_mul.? (I 2) (I inv2@)) 1)
          (=>
           ...
           (=>
            (= tmp%1 (= (curve25519_dalek!specs.field_specs.field_mul.? (I 2) (I a!)) (curve25519_dalek!specs.field_specs.field_mul.?
               (I a!) (I 2)
            )))
            (and
             (=>
             ...
             (=>
              ...
              (=>
               ...
               (=>
                (= tmp%2 (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                     (I a!) (I 2)
                    )
                   ) (I inv2@)
                  ) (curve25519_dalek!specs.field_specs.field_mul.? (I a!) (I (curve25519_dalek!specs.field_specs.field_mul.?
                ...
                (and
                 ...
                 (=>
                  tmp%2
                  (=>
                   (= tmp%3 (= (curve25519_dalek!specs.field_specs.field_mul.? (I a!) (I (curve25519_dalek!specs.field_specs.field_mul.?
                        (I 2) (I inv2@)
                      ))
                     ) (curve25519_dalek!specs.field_specs.field_mul.? (I a!) (I 1))
                   ))
                   (and
                    (=>
                     %%location_label%%7
