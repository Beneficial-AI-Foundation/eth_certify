...
;; curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:594:1: 594:56 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::pow_lemmas::lemma_pow2_mul_div
;; curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:594:1: 594:56 (#0)
     ...
     (=>
      ...
      (and
       ...
       (=>
        ...
        (and
         (=>
          (ens%vstd!arithmetic.power2.lemma_pow2_adds. k! d@)
          (=>
           %%location_label%%2
           (= (vstd!arithmetic.power2.pow2.? (I s!)) (nClip (Mul (vstd!arithmetic.power2.pow2.?
               (I k!)
         ...
         (=>
          ...
          (and
           (=>
            (= tmp%1 (nClip (Mul x! (vstd!arithmetic.power2.pow2.? (I k!)))))
            (=>
             (= tmp%2 (vstd!arithmetic.power2.pow2.? (I k!)))
             (=>
              (= tmp%3 (vstd!arithmetic.power2.pow2.? (I d@)))
              (and
               (=>
                %%location_label%%3
                (req%vstd!arithmetic.div_mod.lemma_div_denominator. tmp%1 tmp%2 tmp%3)
               )
               (=>
                (ens%vstd!arithmetic.div_mod.lemma_div_denominator. tmp%1 tmp%2 tmp%3)
                (=>
                 %%location_label%%4
                 (= (EucDiv (nClip (Mul x! (vstd!arithmetic.power2.pow2.? (I k!)))) (vstd!arithmetic.power2.pow2.?
                    (I s!)
                   )
                  ) (EucDiv (EucDiv (nClip (Mul x! (vstd!arithmetic.power2.pow2.? (I k!)))) (vstd!arithmetic.power2.pow2.?
                     (I k!)
                    )
                   ) (vstd!arithmetic.power2.pow2.? (I d@))
           ))))))))
           (=>
            ...
            (and
             (=>
              (= tmp%4 (vstd!arithmetic.power2.pow2.? (I k!)))
              (and
               (=>
                %%location_label%%5
                (req%vstd!arithmetic.div_mod.lemma_div_by_multiple. x! tmp%4)
               )
               (=>
                (ens%vstd!arithmetic.div_mod.lemma_div_by_multiple. x! tmp%4)
                (=>
                 %%location_label%%6
                 (= (EucDiv (nClip (Mul x! (vstd!arithmetic.power2.pow2.? (I k!)))) (vstd!arithmetic.power2.pow2.?
                    (I k!)
