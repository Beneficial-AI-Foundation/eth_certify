...
;; curve25519-dalek/src/lemmas/field_lemmas/limbs_to_bytes_lemmas.rs:133:7: 133:69 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::limbs_to_bytes_lemmas::lemma_byte_from_limb_shift
;; curve25519-dalek/src/lemmas/field_lemmas/limbs_to_bytes_lemmas.rs:133:7: 133:69 (#0)
(get-info :all-statistics)
(push)
 (declare-const limb! Int)
 ...
 (assert
  (not (=>
    ...
    (and
     (=>
      %%location_label%%0
      (req%vstd!bits.lemma_u64_shr_is_div. limb! shift!)
     )
     (=>
      (ens%vstd!bits.lemma_u64_shr_is_div. limb! shift!)
      (=>
       (= tmp%1 (= (uClip 64 (bitshr (I limb!) (I shift!))) (EucDiv limb! (vstd!arithmetic.power2.pow2.?
           (I shift!)
       ))))
       (and
        (=>
        ...
        (=>
         ...
         (and
          (=>
           (= tmp%2 (uClip 64 (bitshr (I limb!) (I shift!))))
           (and
            (=>
             %%location_label%%2
             (req%curve25519_dalek!lemmas.common_lemmas.div_mod_lemmas.lemma_u64_cast_u8_is_mod.
            ...
            (=>
             ...
             (=>
              %%location_label%%3
              (= (uClip 8 (uClip 64 (bitshr (I limb!) (I shift!)))) (EucMod (uClip 64 (bitshr (I limb!)
                  (I shift!)
                 )
                ) 256
          ))))))
