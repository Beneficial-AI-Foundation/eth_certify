...
;; curve25519-dalek/src/lemmas/field_lemmas/compute_q_lemmas.rs:23:1: 23:42 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::compute_q_lemmas::lemma_bounded_shr_51
;; curve25519-dalek/src/lemmas/field_lemmas/compute_q_lemmas.rs:23:1: 23:42 (#0)
 ...
 (assert
  (not (=>
    ...
    (=>
     ...
     (=>
      (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. 3 tmp%1)
      (=>
       (= shifted@ (uClip 64 (bitshr (I x!) (I 51))))
       (and
        (=>
         %%location_label%%0
         (req%vstd!bits.lemma_u64_shr_is_div. x! 51)
        )
        (=>
         (ens%vstd!bits.lemma_u64_shr_is_div. x! 51)
         (=>
