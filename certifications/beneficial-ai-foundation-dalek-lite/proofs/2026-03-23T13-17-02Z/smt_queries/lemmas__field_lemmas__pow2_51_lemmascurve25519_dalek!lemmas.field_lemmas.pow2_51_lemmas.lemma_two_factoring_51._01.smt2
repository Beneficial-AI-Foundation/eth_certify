...
;; curve25519-dalek/src/lemmas/field_lemmas/pow2_51_lemmas.rs:18:1: 18:53 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::pow2_51_lemmas::lemma_two_factoring_51
;; curve25519-dalek/src/lemmas/field_lemmas/pow2_51_lemmas.rs:18:1: 18:53 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_two_factoring. k! 51 ai!)
    (=>
     %%location_label%%0
     (= (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Add k! 51)))) ai!) (Mul (vstd!arithmetic.power2.pow2.?
        (I k!)
