...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:740:1: 740:56 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_field_sub_add_cancel
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:740:1: 740:56 (#0)
 ...
 (assert
  (not (=>
    ...
    (=>
     ...
     (=>
      (= s@ (curve25519_dalek!specs.field_specs.field_add.? (I a!) (I b!)))
      (=>
       (= tmp%1 (= s@ (EucMod (nClip (Add a! b!)) p@)))
       (and
        (=>
         %%location_label%%0
         tmp%1
          ...
          (=>
           ...
           (and
            (and
             (=>
              %%location_label%%3
              (req%vstd!arithmetic.div_mod.lemma_small_mod. s@ p@)
             )
             (=>
              (ens%vstd!arithmetic.div_mod.lemma_small_mod. s@ p@)
              (and
               (=>
                %%location_label%%4
               ...
               (=>
                ...
                (=>
                 %%location_label%%5
                 (= (curve25519_dalek!specs.field_specs.field_sub.? (I s@) (I b!)) (EucMod (nClip (Sub
                     (nClip (Add s@ p@)) b!
                    )
                   ) p@
            )))))))
                 ...
                 (=>
                  ...
                  (and
                   ...
                   (=>
                    ...
                    (=>
                     %%location_label%%8
                     (= (EucMod s@ p@) (EucMod (nClip (Add a! b!)) p@))
               ))))))
               (=>
                (= (EucMod s@ p@) (EucMod (nClip (Add a! b!)) p@))
                (=>
                 ...
                 (and
                  (=>
                   %%location_label%%9
                   (req%curve25519_dalek!lemmas.common_lemmas.div_mod_lemmas.lemma_mod_add_eq. s@ tmp%4
                    p@ p@
                  ))
                  (=>
                   (ens%curve25519_dalek!lemmas.common_lemmas.div_mod_lemmas.lemma_mod_add_eq. s@ tmp%4
                    p@ p@
                   )
                   (=>
                    %%location_label%%10
                    (= (EucMod (nClip (Add s@ p@)) p@) (EucMod (nClip (Add (nClip (Add a! b!)) p@)) p@))
              ))))))
              (=>
               (= (EucMod (nClip (Add s@ p@)) p@) (EucMod (nClip (Add (nClip (Add a! b!)) p@)) p@))
               (and
                (=>
                 ...
                 (and
                  (=>
                   %%location_label%%11
                   (req%vstd!arithmetic.div_mod.lemma_sub_mod_noop. tmp%5 b! p@)
                  )
                  (=>
                   (ens%vstd!arithmetic.div_mod.lemma_sub_mod_noop. tmp%5 b! p@)
                   (=>
                    (= tmp%6 (nClip (Add (nClip (Add a! b!)) p@)))
                    (and
                     (=>
                      %%location_label%%12
                      (req%vstd!arithmetic.div_mod.lemma_sub_mod_noop. tmp%6 b! p@)
                     )
                     (=>
                      (ens%vstd!arithmetic.div_mod.lemma_sub_mod_noop. tmp%6 b! p@)
                      (=>
                       %%location_label%%13
                       (= (EucMod (Sub (nClip (Add s@ p@)) b!) p@) (EucMod (Sub (nClip (Add (nClip (Add a! b!))
                            p@
                           )
                          ) b!
                         ) p@
                ...
                (=>
                 ...
                 (=>
                  (= tmp%7 (= (EucMod (nClip (Sub (nClip (Add s@ p@)) b!)) p@) (EucMod (nClip (Sub (nClip
                        (Add (nClip (Add a! b!)) p@)
                       ) b!
                      )
                     ) p@
                  ...
                  (and
                   ...
                   (=>
                    tmp%7
                    (=>
                     (= tmp%8 (= (nClip (Sub (nClip (Add (nClip (Add a! b!)) p@)) b!)) (nClip (Add a! p@))))
                     (and
                      (=>
                       %%location_label%%15
                       tmp%8
                      ...
                      (=>
                       ...
                       (and
                        (=>
                         %%location_label%%16
                         (req%vstd!arithmetic.div_mod.lemma_mod_add_multiples_vanish. a! p@)
                        )
                        (=>
                         (ens%vstd!arithmetic.div_mod.lemma_mod_add_multiples_vanish. a! p@)
                         (and
                          (=>
                           %%location_label%%17
                           (req%vstd!arithmetic.div_mod.lemma_small_mod. a! p@)
                          )
                          (=>
                           (ens%vstd!arithmetic.div_mod.lemma_small_mod. a! p@)
                           (=>
                            %%location_label%%18
                            (= (curve25519_dalek!specs.field_specs.field_sub.? (I (curve25519_dalek!specs.field_specs.field_add.?
                                (I a!) (I b!)
