...
;; curve25519-dalek/src/lemmas/edwards_lemmas/step1_lemmas.rs:199:1: 202:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::step1_lemmas::lemma_step1_curve_semantics
;; curve25519-dalek/src/lemmas/edwards_lemmas/step1_lemmas.rs:199:1: 202:2 (#0)
        ...
        (and
         ...
         (=>
          ...
          (and
           (and
            (=>
             (= tmp%1 (Sub (nClip (Add (EucMod y2@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                 (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
                )
               ) (EucMod 1 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
             ))
             (=>
              ...
              (and
               ...
               (=>
                ...
                (=>
                 %%location_label%%3
                 (< u_math@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
            )))))
            (=>
             (< u_math@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
             (and
              (=>
               ...
               (and
                (=>
                 %%location_label%%4
                 (req%vstd!arithmetic.div_mod.lemma_small_mod. u_math@ tmp%3)
                )
                (=>
                 (ens%vstd!arithmetic.div_mod.lemma_small_mod. u_math@ tmp%3)
                 (=>
                  %%location_label%%5
                  (= (EucMod u_math@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) u_math@)
              ))))
              (=>
               (= (EucMod u_math@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) u_math@)
               (=>
                (= tmp%4 (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_square.?
                     (I x!)
                    )
                   ) (I v_math@)
                  ) u_math@
