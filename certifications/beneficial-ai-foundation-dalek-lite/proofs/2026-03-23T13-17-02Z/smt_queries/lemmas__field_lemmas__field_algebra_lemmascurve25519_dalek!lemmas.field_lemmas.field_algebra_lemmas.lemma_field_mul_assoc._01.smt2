...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:1437:1: 1437:59 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_field_mul_assoc
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:1437:1: 1437:59 (#0)
       ...
       (and
        (=>
         ...
         (and
          (=>
           %%location_label%%0
           (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. tmp%1 c! p@)
          )
          (=>
           (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. tmp%1 c! p@)
           (=>
            (= tmp%2 (nClip (Mul b! c!)))
            (and
             (=>
              %%location_label%%1
              (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. a! tmp%2 p@)
             )
             (=>
              (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. a! tmp%2 p@)
              (=>
               (ens%vstd!arithmetic.mul.lemma_mul_is_associative. a! b! c!)
               (=>
                %%location_label%%2
                (= (curve25519_dalek!specs.field_specs.field_mul.? (I ab@) (I c!)) (curve25519_dalek!specs.field_specs.field_mul.?
                  (I a!) (I bc@)
        ))))))))))
        (=>
         (= (curve25519_dalek!specs.field_specs.field_mul.? (I ab@) (I c!)) (curve25519_dalek!specs.field_specs.field_mul.?
