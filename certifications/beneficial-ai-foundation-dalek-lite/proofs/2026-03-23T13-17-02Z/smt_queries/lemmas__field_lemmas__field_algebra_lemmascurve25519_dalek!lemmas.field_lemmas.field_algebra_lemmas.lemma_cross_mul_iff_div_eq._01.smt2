...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:3098:1: 3098:72 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_cross_mul_iff_div_eq
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:3098:1: 3098:72 (#0)
...
(push)
 ...
 (assert
  (not (=>
    ...
    (=>
     (= inv_d@ (curve25519_dalek!specs.field_specs.field_inv.? (I d!)))
     (=>
      ...
      (=>
       ...
       (and
        (=>
         ...
         (=>
          %%location_label%%0
          (= bd@ (curve25519_dalek!specs.field_specs.field_mul.? (I d!) (I b!)))
        ))
        (=>
         (= bd@ (curve25519_dalek!specs.field_specs.field_mul.? (I d!) (I b!)))
         (or
          (and
              ...
              (=>
               ...
               (=>
                ...
                (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                  ...
                  ) (I (curve25519_dalek!specs.field_specs.field_inv.? (I bd@)))
                 ) (curve25519_dalek!specs.field_specs.field_mul.? (I a!) (I inv_b@))
             ))))
             (=>
              (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                  (I a!) (I d!)
                 ...
                 (=>
                  ...
                  (=>
                   ...
                   (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                    ...
                    ) (curve25519_dalek!specs.field_specs.field_mul.? (I c!) (I inv_d@))
               )))))
               (=>
                (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                    (I c!) (I b!)
                ...
                (=>
                 (= tmp%1 (= (curve25519_dalek!specs.field_specs.field_mul.? (I a!) (I inv_b@)) (curve25519_dalek!specs.field_specs.field_mul.?
                    (I c!) (I inv_d@)
                 )))
                 (and
                  (=>
           ...
           (=>
            (not (= (curve25519_dalek!specs.field_specs.field_mul.? (I a!) (I d!)) (curve25519_dalek!specs.field_specs.field_mul.?
               (I c!) (I b!)
            )))
            %%switch_label%%1
          ))
          (and
           ...
           (or
            (and
             (=>
              (= (curve25519_dalek!specs.field_specs.field_mul.? (I a!) (I inv_b@)) (curve25519_dalek!specs.field_specs.field_mul.?
                (I c!) (I inv_d@)
              ))
              (and
               (and
                ...
                (=>
                 ...
                 (=>
                  %%location_label%%7
                  (= (curve25519_dalek!specs.field_specs.field_mul.? (I inv_b@) (I b!)) 1)
               )))
               (=>
                (= (curve25519_dalek!specs.field_specs.field_mul.? (I inv_b@) (I b!)) 1)
                (and
                 (and
                  ...
                  (=>
                   ...
                   (=>
                    %%location_label%%9
                    (= (curve25519_dalek!specs.field_specs.field_mul.? (I inv_d@) (I d!)) 1)
                 )))
                 (=>
                  (= (curve25519_dalek!specs.field_specs.field_mul.? (I inv_d@) (I d!)) 1)
                  (and
                   (=>
                    ...
                    (=>
                     (= tmp%2 (curve25519_dalek!specs.field_specs.field_mul.? (I a!) (I d!)))
                     (=>
                      (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_one_right.
                       tmp%2
                      )
                      (=>
                       (= tmp%3 (curve25519_dalek!specs.field_specs.field_mul.? (I a!) (I d!)))
                       (=>
                            ...
                            (and
                             ...
                             (=>
                              ...
                              (=>
                               %%location_label%%12
                               (= (curve25519_dalek!specs.field_specs.field_mul.? (I a!) (I d!)) (curve25519_dalek!specs.field_specs.field_mul.?
                                 (I (curve25519_dalek!specs.field_specs.field_mul.? (I a!) (I inv_b@))) (I (curve25519_dalek!specs.field_specs.field_mul.?
                                   (I d!) (I b!)
                   ))))))))))))))))
                   (=>
                    (= (curve25519_dalek!specs.field_specs.field_mul.? (I a!) (I d!)) (curve25519_dalek!specs.field_specs.field_mul.?
                    ...
                    (and
                     (=>
                      ...
                      (=>
                       (= tmp%7 (curve25519_dalek!specs.field_specs.field_mul.? (I c!) (I b!)))
                       (=>
                        (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_one_right.
                         tmp%7
                        )
                        (=>
                         (= tmp%8 (curve25519_dalek!specs.field_specs.field_mul.? (I c!) (I b!)))
                         (=>
                          ...
                          (and
                           ...
                           (=>
                            ...
                            (=>
                             (= tmp%10 (nClip (Mul c! b!)))
                             (=>
                              (= tmp%11 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                              (and
                               (=>
                                %%location_label%%14
                                (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%10 tmp%11)
                               )
                               (=>
                                (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%10 tmp%11)
                                (=>
                                 %%location_label%%15
                                 (= (curve25519_dalek!specs.field_specs.field_mul.? (I c!) (I b!)) (curve25519_dalek!specs.field_specs.field_mul.?
                                   (I (curve25519_dalek!specs.field_specs.field_mul.? (I c!) (I inv_d@))) (I (curve25519_dalek!specs.field_specs.field_mul.?
                                     (I b!) (I d!)
                     ))))))))))))))))
                     (=>
                      (= (curve25519_dalek!specs.field_specs.field_mul.? (I c!) (I b!)) (curve25519_dalek!specs.field_specs.field_mul.?
                      ...
                      (=>
                       (= tmp%12 (= (curve25519_dalek!specs.field_specs.field_mul.? (I d!) (I b!)) (curve25519_dalek!specs.field_specs.field_mul.?
                          (I b!) (I d!)
                       )))
                       (and
                        (=>
                        ...
                        (=>
                         tmp%12
                         (=>
                          (= tmp%13 (= (curve25519_dalek!specs.field_specs.field_mul.? (I a!) (I d!)) (curve25519_dalek!specs.field_specs.field_mul.?
                             (I c!) (I b!)
                          )))
                          (and
                           (=>
             ...
             (=>
              (not (= (curve25519_dalek!specs.field_specs.field_mul.? (I a!) (I inv_b@)) (curve25519_dalek!specs.field_specs.field_mul.?
                 (I c!) (I inv_d@)
              )))
              %%switch_label%%0
            ))
