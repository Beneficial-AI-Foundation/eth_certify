...
;; curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:545:1: 548:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::as_bytes_lemmas::lemma_field_element_equal_implies_fe51_to_bytes_equal
;; curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:545:1: 548:2 (#0)
  ...
  (not (or
    (and
     (=>
      ...
      (=>
       (= bytes1@ (curve25519_dalek!core_assumes.seq_to_array_32.? (Poly%vstd!seq.Seq<u8.>.
          (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
            fe1!
       )))))
       (=>
        (= bytes2@ (curve25519_dalek!core_assumes.seq_to_array_32.? (Poly%vstd!seq.Seq<u8.>.
           (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
             fe2!
        )))))
        (and
         (=>
          ...
          (=>
           %%location_label%%0
           (= (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. bytes1@)) (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.?
         ...
         (=>
          ...
          (and
           (=>
            ...
            (=>
             %%location_label%%1
             (= (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. bytes2@)) (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.?
           ...
           (=>
            ...
            (=>
             (= tmp%1 (= (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. bytes1@))
               (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. bytes2@))
             ))
             (and
              (=>
               %%location_label%%2
                 ...
                 (=>
                  ...
                  (=>
                   ...
                   (forall ((i$ Poly)) (!
                     ...
                     :qid user_curve25519_dalek__lemmas__field_lemmas__as_bytes_lemmas__lemma_field_element_equal_implies_fe51_to_bytes_equal_59
                     :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__as_bytes_lemmas__lemma_field_element_equal_implies_fe51_to_bytes_equal_59
                )))))
                (=>
                 (forall ((i$ Poly)) (!
                   (=>
                   ...
                   :qid user_curve25519_dalek__lemmas__field_lemmas__as_bytes_lemmas__lemma_field_element_equal_implies_fe51_to_bytes_equal_60
                   :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__as_bytes_lemmas__lemma_field_element_equal_implies_fe51_to_bytes_equal_60
                 ))
                 (and
                  (and
                   (=>
                    ...
                    (=>
                     ...
                     (=>
                      (= tmp%2 (= (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!core_assumes.seq_from32.?
                           (Poly%array%. bytes1@)
                          )
                         ) i@
                        ) (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT
                      ...
                      (and
                       ...
                       (=>
                        tmp%2
                        (=>
                         (= tmp%3 (= (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!core_assumes.seq_from32.?
                              (Poly%array%. bytes2@)
                             )
                            ) i@
                           ) (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT
                         ...
                         (and
                          ...
                          (=>
                           tmp%3
                           (=>
                            (= tmp%4 (= (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT 8)
                                 $ (CONST_INT 32)
                                ) (Poly%array%. bytes1@)
                               ) i@
                              ) (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT
                   ...
                   (=>
                    (forall ((i$ Poly)) (!
                      ...
                      :qid user_curve25519_dalek__lemmas__field_lemmas__as_bytes_lemmas__lemma_field_element_equal_implies_fe51_to_bytes_equal_62
                      :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__as_bytes_lemmas__lemma_field_element_equal_implies_fe51_to_bytes_equal_62
                    ))
                    (=>
                     %%location_label%%9
                     (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!core_assumes.seq_from32.?
                        (Poly%array%. bytes1@)
                       )
                   ...
                   (and
                    (=>
                     ...
                     (and
                      ...
                      (=>
                       tmp%5
                       (=>
                        (= tmp%6 (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                           fe1!
                        )))
                        (and
                         (=>
                    ...
                    (=>
                     (= (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                      ...
                      ) (curve25519_dalek!core_assumes.seq_from32.? (Poly%array%. bytes1@))
                     )
                     (and
                      (=>
                       (= tmp%7 (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
                            (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe2!)
                          ))
                         ) 32
                       ))
                       (and
                        ...
                        (=>
                         tmp%7
                         (=>
                          (= tmp%8 (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                             fe2!
                          )))
                          (and
                           (=>
                      ...
                      (=>
                       (= (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                        ...
                        ) (curve25519_dalek!core_assumes.seq_from32.? (Poly%array%. bytes2@))
                       )
                       (=>
                        (= tmp%9 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
                            (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe1!)
                           )
                          ) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
                            (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe2!)
