...
;; curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:1122:1: 1122:49 (#0)
...
;; Function-Specs curve25519_dalek::lemmas::common_lemmas::pow_lemmas::lemma_pow2_geometric_double
(declare-fun ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_geometric_double.
 (Int) Bool
)
(assert
 (forall ((n! Int)) (!
   (= (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_geometric_double.
     n!
    ) (= (Add (Mul (Sub (vstd!arithmetic.power2.pow2.? (I n!)) 1) (vstd!arithmetic.power2.pow2.?
        (I n!)
       )
      ) (Sub (vstd!arithmetic.power2.pow2.? (I n!)) 1)
     ) (Sub (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 2 n!)))) 1)
   ))
   :pattern ((ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_geometric_double.
     n!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_geometric_double._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_geometric_double._definition
)))

;; Function-Def curve25519_dalek::lemmas::common_lemmas::pow_lemmas::lemma_pow2_geometric_double
;; curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:1122:1: 1122:49 (#0)
...
(push)
 ...
 (assert
  (not (=>
    ...
    (=>
     (ens%vstd!arithmetic.power2.lemma_pow2_adds. n! n!)
     (and
      (=>
       (= tmp%1 (= (nClip (Add n! n!)) (nClip (Mul 2 n!))))
       (and
        (=>
         %%location_label%%0
         tmp%1
        ...
        (=>
         ...
         (=>
          %%location_label%%1
          (= (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 2 n!)))) (nClip (Mul (vstd!arithmetic.power2.pow2.?
              (I n!)
             ) (vstd!arithmetic.power2.pow2.? (I n!))
      )))))))
      (=>
       ...
       (=>
        (= tmp%2 (vstd!arithmetic.power2.pow2.? (I n!)))
        (=>
         (= tmp%3 (vstd!arithmetic.power2.pow2.? (I n!)))
         (=>
          (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub. tmp%2 tmp%3 1)
          (=>
           %%location_label%%2
           (= (Add (Mul (Sub (vstd!arithmetic.power2.pow2.? (I n!)) 1) (vstd!arithmetic.power2.pow2.?
               (I n!)
