...
;; curve25519-dalek/src/lemmas/edwards_lemmas/niels_addition_correctness.rs:164:7: 164:86 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::niels_addition_correctness::lemma_segre_t_derivation
;; curve25519-dalek/src/lemmas/edwards_lemmas/niels_addition_correctness.rs:164:7: 164:86 (#0)
(get-info :all-statistics)
(push)
 (declare-const proj_x! Int)
 (declare-const proj_y! Int)
 (declare-const proj_z! Int)
 (declare-const proj_t! Int)
              ...
              (and
               ...
               (=>
                ...
                (=>
                 %%location_label%%4
                 (= (curve25519_dalek!specs.field_specs.field_mul.? (I proj_x!) (I proj_y!)) (curve25519_dalek!specs.field_specs.field_mul.?
                   (I xy@) (I (curve25519_dalek!specs.field_specs.field_mul.? (I proj_z!) (I proj_z!)))
       ))))))))))))
       (=>
        (= (curve25519_dalek!specs.field_specs.field_mul.? (I proj_x!) (I proj_y!)) (curve25519_dalek!specs.field_specs.field_mul.?
          (I xy@) (I (curve25519_dalek!specs.field_specs.field_mul.? (I proj_z!) (I proj_z!)))
        ...
        (and
         (=>
          ...
          (=>
           (= tmp%1 (curve25519_dalek!specs.field_specs.field_mul.? (I xy@) (I proj_z!)))
           (=>
            (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_comm.
             tmp%1 proj_z!
            )
            (=>
             (= tmp%2 (curve25519_dalek!specs.field_specs.field_mul.? (I xy@) (I proj_z!)))
             (and
              (=>
               %%location_label%%5
               (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_left_cancel.
