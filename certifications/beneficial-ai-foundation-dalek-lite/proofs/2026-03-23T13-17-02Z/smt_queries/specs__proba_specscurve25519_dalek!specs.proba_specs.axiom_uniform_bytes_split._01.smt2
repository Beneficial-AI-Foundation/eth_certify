...
;; curve25519-dalek/src/specs/proba_specs.rs:119:1: 119:94 (#0)
...
;; Function-Def curve25519_dalek::specs::proba_specs::axiom_uniform_bytes_split
;; curve25519-dalek/src/specs/proba_specs.rs:119:1: 119:94 (#0)
(get-info :all-statistics)
(push)
 (declare-const bytes! %%Function%%)
 (declare-const first! %%Function%%)
 (declare-const second! %%Function%%)
 (assert
  fuel_defaults
 )
 (assert
  (has_type (Poly%array%. bytes!) (ARRAY $ (UINT 8) $ (CONST_INT 64)))
 )
 (assert
  (has_type (Poly%array%. first!) (ARRAY $ (UINT 8) $ (CONST_INT 32)))
 )
 (assert
  (has_type (Poly%array%. second!) (ARRAY $ (UINT 8) $ (CONST_INT 32)))
 )
 (assert
  (= (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT 32)) (Poly%array%. first!))
   (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT
