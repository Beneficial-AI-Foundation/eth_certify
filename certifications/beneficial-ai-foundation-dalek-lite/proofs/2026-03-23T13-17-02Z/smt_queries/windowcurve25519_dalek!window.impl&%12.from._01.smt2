...
;; curve25519-dalek/src/window.rs:482:9: 548:10 (#0)
...
;; Function-Def curve25519_dalek::window::LookupTable::from
;; curve25519-dalek/src/window.rs:482:9: 548:10 (#0)
...
(push)
 ...
 (declare-const tmp%5 curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.)
 (declare-const tmp%6 curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.)
 ...
 (declare-const tmp%11 curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const tmp%12 curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const tmp%13 Poly)
 (declare-const tmp%14 Poly)
 (declare-const tmp%15 Poly)
 (declare-const tmp%16 curve25519_dalek!edwards.EdwardsPoint.)
 (declare-const tmp%17 Bool)
 (declare-const tmp%18 curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const tmp%19 curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const tmp%20 curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.)
 (declare-const tmp%21 Int)
 (declare-const tmp%22 curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.)
 ...
 (declare-const sum@ curve25519_dalek!backend.serial.curve_models.CompletedPoint.)
 (declare-const extended@ curve25519_dalek!edwards.EdwardsPoint.)
 ...
 (declare-const j$8@ Poly)
 (declare-const j$9@ Poly)
 (declare-const j$10@ Poly)
 (declare-const verus_tmp@0 tuple%2.)
 (declare-const P_affine@0 tuple%2.)
 (declare-const points@0 %%Function%%)
 (declare-const result@ curve25519_dalek!window.LookupTable.)
 (assert
  fuel_defaults
 )
 (assert
  (has_type P! TYPE%curve25519_dalek!edwards.EdwardsPoint.)
 )
 (assert
  (has_type tmp%1 TYPE%curve25519_dalek!edwards.EdwardsPoint.)
 )
 (assert
  (has_type (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. tmp%3) TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 )
 (assert
  (has_type (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. tmp%4) TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 )
 (assert
  (has_type (Poly%tuple%2. verus_tmp@0) (TYPE%tuple%2. $ NAT $ NAT))
 )
 (assert
  (has_type (Poly%tuple%2. verus_tmp_P_affine@) (TYPE%tuple%2. $ NAT $ NAT))
 )
 (assert
  (has_type (Poly%tuple%2. P_affine@0) (TYPE%tuple%2. $ NAT $ NAT))
 )
 (assert
  (has_type (Poly%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
    tmp%5
 ...
 (assert
  (has_type (Poly%array%. points@0) (ARRAY $ TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
    $ (CONST_INT 8)
 )))
 (assert
  (has_type (Poly%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
 ...
 (assert
  (has_type tmp%7 (TYPE%core!ops.range.Range. $ USIZE))
 )
 (assert
 ...
 (declare-const points@1 %%Function%%)
    ...
    (=>
     (%B (vstd!pervasive.ForLoopGhostIterator.ghost_invariant.? $ (TYPE%vstd!std_specs.range.RangeGhostIterator.
        ...
        (core!option.Option./Some (vstd!pervasive.ForLoopGhostIteratorNew.ghost_iter.? $ (TYPE%core!ops.range.Range.
           ...
           (Poly%core!ops.range.Range. (core!ops.range.Range./Range (I 0) (I 7)))
     ))))))
     (=>
      (let
       ((j$ (ite
       ...
       (forall ((k$ Poly)) (!
         ...
         :qid user_curve25519_dalek__window__LookupTable__from_98
         :skolemid skolem_user_curve25519_dalek__window__LookupTable__from_98
      )))
      (=>
       (let
        ((j$ (ite
        ...
        (forall ((k$ Poly)) (!
          ...
          :qid user_curve25519_dalek__window__LookupTable__from_99
          :skolemid skolem_user_curve25519_dalek__window__LookupTable__from_99
       )))
       (=>
        (let
         ((j$ (ite
         ...
         (forall ((k$ Poly)) (!
           ...
           :qid user_curve25519_dalek__window__LookupTable__from_100
           :skolemid skolem_user_curve25519_dalek__window__LookupTable__from_100
        )))
        (=>
         (let
          ((j$ (ite
          ...
          (curve25519_dalek!specs.edwards_specs.is_well_formed_edwards_point.? P!)
         )
         (=>
          (let
           ((j$ (ite
           ...
           (curve25519_dalek!specs.edwards_specs.edwards_point_limbs_bounded.? P!)
          )
          (=>
           (let
            ((j$ (ite
            ...
            (curve25519_dalek!specs.edwards_specs.is_valid_edwards_point.? P!)
           )
           (=>
            (let
             ((j$ (ite
             ...
             (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. P_affine@0) (Poly%tuple%2.
               (curve25519_dalek!specs.edwards_specs.edwards_point_as_affine.? P!)
            )))
            (=>
             ...
             (=>
              ...
              (=>
               (ens%core!iter.range.impl&%6.next. $ USIZE (Poly%core!ops.range.Range. VERUS_exec_iter@0)
                (Poly%core!ops.range.Range. VERUS_exec_iter@1) tmp%8
               )
               (=>
                (= tmp%%$1@ (%Poly%core!option.Option. tmp%8))
                (or
                 (and
                  (=>
                 ...
                 (and
                  ...
                  (=>
                   ...
                   (=>
                    (= tmp%9 P!)
                    (=>
                     (= tmp%10 (curve25519_dalek!edwards.impl&%15.well_formed.? tmp%9))
                     (=>
                      tmp%10
                      (=>
                       (ens%curve25519_dalek!specs.edwards_specs.lemma_unfold_edwards. (%Poly%curve25519_dalek!edwards.EdwardsPoint.
                         P!
                       ))
                       (=>
                        (= tmp%11 (curve25519_dalek!edwards.EdwardsPoint./EdwardsPoint/Y (%Poly%curve25519_dalek!edwards.EdwardsPoint.
                           P!
                        )))
                        (=>
                         (= tmp%12 (curve25519_dalek!edwards.EdwardsPoint./EdwardsPoint/X (%Poly%curve25519_dalek!edwards.EdwardsPoint.
                            P!
                         )))
                         (and
                          (=>
                          ...
                          (=>
                           ...
                           (=>
                            ...
                            (and
                             (=>
                              %%location_label%%11
                              (req%vstd!array.array_index_get. $ TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
                               $ (CONST_INT 8) points@0 j@
                             ))
                             (=>
                              (ens%vstd!array.array_index_get. $ TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
                               $ (CONST_INT 8) points@0 j@ tmp%13
                              )
                              (and
                               (=>
                                %%location_label%%12
                                (req%core!ops.arith.Add.add. (REF $) TYPE%curve25519_dalek!edwards.EdwardsPoint. (
                                  REF $
                                 ) TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint. tmp%14
                                 tmp%13
                               ))
                               (=>
                                (ens%curve25519_dalek!backend.serial.curve_models.impl&%29.add. tmp%14 tmp%13 tmp%15)
                                (=>
                                 (= sum@ (%Poly%curve25519_dalek!backend.serial.curve_models.CompletedPoint. tmp%15))
                                 (and
                                  (=>
                                   %%location_label%%13
                                   (req%curve25519_dalek!backend.serial.curve_models.impl&%26.as_extended. sum@)
                                  )
                                  (=>
                                   (ens%curve25519_dalek!backend.serial.curve_models.impl&%26.as_extended. sum@ extended@)
                                   (=>
                                    (= tmp%16 extended@)
                                    (=>
                                     (= tmp%17 (curve25519_dalek!edwards.impl&%15.well_formed.? (Poly%curve25519_dalek!edwards.EdwardsPoint.
                                        tmp%16
                                     )))
                                     (=>
                                      tmp%17
                                      (=>
                                       (ens%curve25519_dalek!specs.edwards_specs.lemma_unfold_edwards. extended@)
                                       (=>
                                        (= tmp%18 (curve25519_dalek!edwards.EdwardsPoint./EdwardsPoint/Y (%Poly%curve25519_dalek!edwards.EdwardsPoint.
                                           (Poly%curve25519_dalek!edwards.EdwardsPoint. extended@)
                                        )))
                                        (=>
                                         (= tmp%19 (curve25519_dalek!edwards.EdwardsPoint./EdwardsPoint/X (%Poly%curve25519_dalek!edwards.EdwardsPoint.
                                            (Poly%curve25519_dalek!edwards.EdwardsPoint. extended@)
                                         )))
                                         (and
                                          (=>
                                          ...
                                          (=>
                                           ...
                                           (and
                                            ...
                                            (=>
                                             (uInv SZ (Add j@ 1))
                                             (=>
                                              (= tmp%21 (uClip SZ (Add j@ 1)))
                                              (and
                                               (=>
                                                %%location_label%%16
                                                (req%curve25519_dalek!edwards.impl&%29.as_projective_niels. extended@)
                                               )
                                               (=>
                                                (ens%curve25519_dalek!edwards.impl&%29.as_projective_niels. extended@ tmp%20)
                                                (and
                                                 (=>
                                                  %%location_label%%17
                                                  (req%vstd!std_specs.core.index_set. $ (ARRAY $ TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
                                                    $ (CONST_INT 8)
                                                   ) $ USIZE $ TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
                                                   (Poly%array%. points@0) (I tmp%21) (Poly%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
                                                    tmp%20
                                                 )))
                                                 (=>
                                                  (has_type (Poly%array%. points@1) (ARRAY $ TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
                                                    $ (CONST_INT 8)
                                                  ))
                                                  (=>
                                                   (ens%vstd!std_specs.core.index_set. $ (ARRAY $ TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
                                                     $ (CONST_INT 8)
                                                    ) $ USIZE $ TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
                                                    (Poly%array%. points@0) (Poly%array%. points@1) (I tmp%21) (Poly%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
                                                     tmp%20
                                                   ))
                                                   (and
                                                    (=>
                                                     (= tmp%22 (%Poly%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
                                                       (vstd!seq.Seq.index.? $ TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
                                                        (vstd!view.View.view.? $ (ARRAY $ TYPE%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
                                                          $ (CONST_INT 8)
                                                         ) (Poly%array%. points@1)
                                                    ...
                                                    (=>
                                                     ...
                                                     (=>
                                                      (= prev@ (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2. P_affine@0)
                                                        (I (nClip (Add j@ 1)))
                                                      ))
                                                      (and
                                                       (=>
                                                        (= tmp%23 (nClip (Add j@ 1)))
                                                        (and
                                                         (=>
                                                          %%location_label%%20
                                                          (req%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_edwards_scalar_mul_succ.
                                                         ...
                                                         (=>
                                                          ...
                                                          (=>
                                                           ...
                                                           (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.?
                                                              (Poly%tuple%2. P_affine@0) (I (nClip (Add j@ 2)))
                                                             )
                                                            ) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_add.? (tuple%2./tuple%2/0
                                                               (%Poly%tuple%2. (Poly%tuple%2. prev@))
                                                              ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. prev@))) (tuple%2./tuple%2/0
                                                               (%Poly%tuple%2. (Poly%tuple%2. P_affine@0))
                                                              ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. P_affine@0)))
                                                       )))))))
                                                       (=>
                                                        (= (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2. P_affine@0)
                                                          (I (nClip (Add j@ 2)))
                                                         ) (curve25519_dalek!specs.edwards_specs.edwards_add.? (tuple%2./tuple%2/0 (%Poly%tuple%2.
                                                            (Poly%tuple%2. prev@)
                                                           )
                                                        ...
                                                        (and
                                                         (=>
                                                          (= tmp%24 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. P_affine@0)))))
                                                          (=>
                                                           (= tmp%25 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. P_affine@0)))))
                                                           (=>
                                                            (= tmp%26 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. prev@)))))
                                                            (=>
                                                             (= tmp%27 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. prev@)))))
                                                             (=>
                                                              (ens%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_edwards_add_commutative.
                                                              ...
                                                              (=>
                                                               ...
                                                               (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_add.?
                                                                  (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. P_affine@0))) (tuple%2./tuple%2/1
                                                                   (%Poly%tuple%2. (Poly%tuple%2. P_affine@0))
                                                                  ) (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. prev@))) (tuple%2./tuple%2/1
                                                                   (%Poly%tuple%2. (Poly%tuple%2. prev@))
                                                                 ))
                                                                ) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_add.? (tuple%2./tuple%2/0
                                                                   (%Poly%tuple%2. (Poly%tuple%2. prev@))
                                                         ...
                                                         (=>
                                                          (= (curve25519_dalek!specs.edwards_specs.edwards_add.? (tuple%2./tuple%2/0 (%Poly%tuple%2.
                                                              (Poly%tuple%2. P_affine@0)
                                                             )
                                                            ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. P_affine@0))) (tuple%2./tuple%2/0
                                                             (%Poly%tuple%2. (Poly%tuple%2. prev@))
