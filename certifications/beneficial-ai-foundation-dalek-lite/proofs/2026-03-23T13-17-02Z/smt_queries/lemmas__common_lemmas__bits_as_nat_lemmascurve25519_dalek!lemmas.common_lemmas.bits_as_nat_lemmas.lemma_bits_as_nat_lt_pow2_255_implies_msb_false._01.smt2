...
;; curve25519-dalek/src/lemmas/common_lemmas/bits_as_nat_lemmas.rs:90:1: 90:80 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::bits_as_nat_lemmas::lemma_bits_as_nat_lt_pow2_255_implies_msb_false
;; curve25519-dalek/src/lemmas/common_lemmas/bits_as_nat_lemmas.rs:90:1: 90:80 (#0)
(get-info :all-statistics)
(push)
 (declare-const bits! %%Function%%)
 ...
 (assert
  (has_type (Poly%array%. bits!) (ARRAY $ BOOL $ (CONST_INT 256)))
 )
 (assert
  (< (curve25519_dalek!specs.core_specs.bits_as_nat.? (Poly%array%. bits!)) (vstd!arithmetic.power2.pow2.?
    (I 255)
        ...
        (=>
         ...
         (= (curve25519_dalek!specs.core_specs.bits_from_index_to_nat.? (Poly%array%. bits!)
           (I 0) (I 256)
            ...
            ) (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 255)) (curve25519_dalek!specs.core_specs.bits_from_index_to_nat.?
               (Poly%array%. bits!) (I 255) (I 1)
      )))))))))
      (=>
       (= (curve25519_dalek!specs.core_specs.bits_from_index_to_nat.? (Poly%array%. bits!)
         (I 0) (I 256)
       ...
       (or
        (and
         (=>
          ...
          (=>
           (= tmp%1 (= (curve25519_dalek!specs.core_specs.bits_from_index_to_nat.? (Poly%array%.
               bits!
              ) (I 256) (I 0)
             ) 0
           ))
             ...
             (=>
              ...
              (and
               ...
               (=>
                tmp%2
                (=>
                 (= tmp%3 (>= (curve25519_dalek!specs.core_specs.bits_from_index_to_nat.? (Poly%array%.
                     bits!
                    ) (I 0) (I 256)
                 ...
                 (and
                  ...
                  (=>
                   tmp%3
                   (=>
                    (= tmp%4 (>= (curve25519_dalek!specs.core_specs.bits_as_nat.? (Poly%array%. bits!))
                      (vstd!arithmetic.power2.pow2.? (I 255))
                    ))
                    (and
                     (=>
