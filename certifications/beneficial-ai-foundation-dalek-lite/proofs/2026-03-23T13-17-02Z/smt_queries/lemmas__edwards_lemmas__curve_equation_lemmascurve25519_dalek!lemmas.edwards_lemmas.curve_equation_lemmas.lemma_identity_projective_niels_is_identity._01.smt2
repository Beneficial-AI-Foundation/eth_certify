...
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:2050:1: 2050:59 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::curve_equation_lemmas::lemma_identity_projective_niels_is_identity
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:2050:1: 2050:59 (#0)
...
(push)
 ...
 (declare-const id@ curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.)
 (declare-const y_plus_x@ Int)
 (declare-const y_minus_x@ Int)
 (declare-const z@ Int)
 (declare-const diff@ Int)
 (declare-const inv2@ Int)
 (declare-const x_proj@ Int)
 (declare-const sum@ Int)
 (declare-const y_proj@ Int)
 ...
 (assert
  (not (=>
    (= id@ (curve25519_dalek!specs.edwards_specs.identity_projective_niels.? (I 0)))
    (=>
     (= y_plus_x@ (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
        (curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint./ProjectiveNielsPoint/Y_plus_X
         (%Poly%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint. (Poly%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
     ...
     (=>
      ...
      (=>
       ...
       (and
        (=>
         (= tmp%1 (curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint./ProjectiveNielsPoint/Y_plus_X
           (%Poly%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint. (Poly%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
             id@
         ))))
         (and
        ...
        (=>
         ...
         (and
          (=>
           (= tmp%2 (curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint./ProjectiveNielsPoint/Y_minus_X
             (%Poly%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint. (Poly%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
               id@
           ))))
           (and
          ...
          (=>
           ...
           (and
            (=>
             (= tmp%3 (curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint./ProjectiveNielsPoint/Z
               (%Poly%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint. (Poly%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
                 id@
             ))))
             (and
            ...
            (=>
             (= z@ 1)
             (=>
              (= diff@ (curve25519_dalek!specs.field_specs.field_sub.? (I y_plus_x@) (I y_minus_x@)))
              (and
               (=>
               ...
               (=>
                ...
                (=>
                 ...
                 (=>
                  (= x_proj@ (curve25519_dalek!specs.field_specs.field_mul.? (I diff@) (I inv2@)))
                  (and
                   (=>
                    (ens%curve25519_dalek!specs.field_specs_u64.p_gt_2. 0)
                    (=>
                   ...
                   (=>
                    (= x_proj@ 0)
                    (=>
                     (= sum@ (curve25519_dalek!specs.field_specs.field_add.? (I y_plus_x@) (I y_minus_x@)))
                     (and
                      (=>
                       (ens%curve25519_dalek!specs.field_specs_u64.p_gt_2. 0)
                       (=>
                        ...
                        (and
                         (=>
                          %%location_label%%12
                          (req%vstd!arithmetic.div_mod.lemma_small_mod. 2 tmp%7)
                         )
                         (=>
                          (ens%vstd!arithmetic.div_mod.lemma_small_mod. 2 tmp%7)
                          (=>
                           %%location_label%%13
                           (= sum@ 2)
                      )))))
                      (=>
                       (= sum@ 2)
                       (=>
                        (= y_proj@ (curve25519_dalek!specs.field_specs.field_mul.? (I sum@) (I inv2@)))
                        (and
                         (=>
                          (ens%curve25519_dalek!specs.field_specs_u64.p_gt_2. 0)
                          (and
                           (=>
                            ...
                            (and
                             (=>
                              %%location_label%%14
                              (req%vstd!arithmetic.div_mod.lemma_small_mod. 2 tmp%8)
                             )
                             (=>
                              (ens%vstd!arithmetic.div_mod.lemma_small_mod. 2 tmp%8)
                              (=>
                               %%location_label%%15
                               (not (= (EucMod 2 (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0))
                           ))))
                           (=>
                            (not (= (EucMod 2 (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0))
                            (and
                             ...
                             (=>
                              ...
                              (=>
                               (= tmp%9 (curve25519_dalek!specs.field_specs.field_inv.? (I 2)))
                               (=>
                                (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_comm.
                                 2 tmp%9
                                )
                            ...
                            (=>
                             ...
                             (=>
                              ...
                              (and
                               (=>
                                %%location_label%%18
                                (req%vstd!arithmetic.div_mod.lemma_small_mod. 0 tmp%10)
                               )
                               (=>
                                (ens%vstd!arithmetic.div_mod.lemma_small_mod. 0 tmp%10)
                                (and
                                 (=>
                                  %%location_label%%19
                                  (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_zero_left.
                                 ...
                                 (=>
                                  ...
                                  (=>
                                   %%location_label%%20
                                   (= (curve25519_dalek!specs.field_specs.field_mul.? (I x_proj@) (I z_inv@)) 0)
                            )))))))
                            (=>
                             (= (curve25519_dalek!specs.field_specs.field_mul.? (I x_proj@) (I z_inv@)) 0)
                             (=>
                              ...
                              (and
                               (=>
                                ...
                                (and
                                 (=>
                                  %%location_label%%21
                                  (req%vstd!arithmetic.div_mod.lemma_small_mod. 1 tmp%11)
                                 )
                                 (=>
                                  (ens%vstd!arithmetic.div_mod.lemma_small_mod. 1 tmp%11)
                                  (=>
                                   %%location_label%%22
                               ...
                               (=>
                                ...
                                (and
                                 (=>
                                  %%location_label%%23
                                  (req%curve25519_dalek!specs.field_specs.field_inv_property. 1)
                                 )
                                 (=>
                                  (ens%curve25519_dalek!specs.field_specs.field_inv_property. 1)
                                  (and
                                   (=>
                                    ...
                                    (and
                                     (=>
                                      %%location_label%%24
                                      (req%vstd!arithmetic.div_mod.lemma_small_mod. 1 tmp%12)
                                     )
                                     (=>
                                      (ens%vstd!arithmetic.div_mod.lemma_small_mod. 1 tmp%12)
                                      (=>
                                       %%location_label%%25
