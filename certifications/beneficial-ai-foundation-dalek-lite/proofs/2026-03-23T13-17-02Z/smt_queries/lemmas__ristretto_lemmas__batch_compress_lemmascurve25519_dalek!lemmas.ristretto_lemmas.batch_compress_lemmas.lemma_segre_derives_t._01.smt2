...
;; curve25519-dalek/src/lemmas/ristretto_lemmas/batch_compress_lemmas.rs:86:1: 86:67 (#0)
...
;; Function-Def curve25519_dalek::lemmas::ristretto_lemmas::batch_compress_lemmas::lemma_segre_derives_t
;; curve25519-dalek/src/lemmas/ristretto_lemmas/batch_compress_lemmas.rs:86:1: 86:67 (#0)
         ...
         (=>
          ...
          (and
           (=>
            ...
            (=>
             %%location_label%%2
             (= (curve25519_dalek!specs.field_specs.field_mul.? (I ab@) (I z2@)) (curve25519_dalek!specs.field_specs.field_mul.?
               (I (curve25519_dalek!specs.field_specs.field_mul.? (I ab@) (I z!))) (I z!)
           ))))
           (=>
            (= (curve25519_dalek!specs.field_specs.field_mul.? (I ab@) (I z2@)) (curve25519_dalek!specs.field_specs.field_mul.?
              (I (curve25519_dalek!specs.field_specs.field_mul.? (I ab@) (I z!))) (I z!)
            ...
            (and
             (=>
              (= tmp%1 (curve25519_dalek!specs.field_specs.field_mul.? (I ab@) (I z!)))
              (=>
               (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_comm.
                tmp%1 z!
               )
             ...
             (=>
              ...
              (and
               (=>
                (= tmp%2 (curve25519_dalek!specs.field_specs.field_mul.? (I ab@) (I z!)))
                (and
                 (=>
                  %%location_label%%4
                  (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_left_cancel.
                 ...
                 (=>
                  ...
                  (=>
                   %%location_label%%5
                   (= (EucMod t! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) (EucMod (curve25519_dalek!specs.field_specs.field_mul.?
                      (I ab@) (I z!)
                     ) (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
               ))))))
               (=>
                ...
                (and
                 (and
                  ...
                  (=>
                   ...
                   (=>
                    (= tmp%3 (curve25519_dalek!specs.field_specs.field_mul.? (I ab@) (I z!)))
                    (and
                     (=>
                      %%location_label%%7
                      (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_element_reduced.
