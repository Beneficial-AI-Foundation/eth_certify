...
;; curve25519-dalek/src/lemmas/montgomery_pow_chain_lemmas.rs:80:5: 80:11 (#0)
...
;; Function-Def curve25519_dalek::lemmas::montgomery_pow_chain_lemmas::lemma_montgomery_mul_exponent_add
;; curve25519-dalek/src/lemmas/montgomery_pow_chain_lemmas.rs:80:5: 80:11 (#0)
...
(push)
 ...
 (declare-const ea_1@ Int)
 (declare-const eb_1@ Int)
 (declare-const eab_1@ Int)
 (declare-const R_ea1@ Int)
 (declare-const R_eb1@ Int)
 (assert
  fuel_defaults
 )
 (assert
    ...
    (=>
     ...
     (=>
      ...
      (=>
       (= eb_1@ (Sub eb! 1))
       (=>
        (= eab_1@ (Sub (nClip (Add ea! eb!)) 1))
        (=>
         %%location_label%%0
         (= eab_1@ (nClip (Add (nClip (Add 1 ea_1@)) eb_1@)))
 ))))))))
 (get-info :version)
