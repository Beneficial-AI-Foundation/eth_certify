...
;; MODULE 'module lemmas::edwards_lemmas::double_correctness'
;; curve25519-dalek/src/lemmas/edwards_lemmas/double_correctness.rs:45:1: 52:2 (#0)
...
(assert
 (distinct fuel%vstd!arithmetic.div_mod.lemma_mod_bound. fuel%vstd!array.array_view.
  ...
  fuel%curve25519_dalek!specs.edwards_specs.projective_point_edwards_as_nat. fuel%curve25519_dalek!specs.edwards_specs.projective_point_as_affine_edwards.
...
(declare-datatypes ((vstd!raw_ptr.PtrData. 0) (curve25519_dalek!backend.serial.u64.field.FieldElement51.
   ...
   0
  ) (curve25519_dalek!backend.serial.curve_models.CompletedPoint. 0) (tuple%0. 0) (
   tuple%2. 0
  ) (tuple%3. 0) (tuple%4. 0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::double_correctness::lemma_double_projective_completed_valid
;; curve25519-dalek/src/lemmas/edwards_lemmas/double_correctness.rs:45:1: 52:2 (#0)
(get-info :all-statistics)
(push)
 (declare-const self_point! curve25519_dalek!backend.serial.curve_models.ProjectivePoint.)
 (declare-const result! curve25519_dalek!backend.serial.curve_models.CompletedPoint.)
 (declare-const xx_val! Int)
 (declare-const yy_val! Int)
 (declare-const zz2_val! Int)
 (declare-const xpy_sq_val! Int)
 ...
 (assert
  (has_type (Poly%curve25519_dalek!backend.serial.curve_models.ProjectivePoint. self_point!)
   TYPE%curve25519_dalek!backend.serial.curve_models.ProjectivePoint.
 ))
 (assert
 ...
 (assert
  (not (=>
    (= pX@ (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
       (curve25519_dalek!backend.serial.curve_models.ProjectivePoint./ProjectivePoint/X (
         %Poly%curve25519_dalek!backend.serial.curve_models.ProjectivePoint. (Poly%curve25519_dalek!backend.serial.curve_models.ProjectivePoint.
          self_point!
    ))))))
    (=>
     (= pY@ (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
        (curve25519_dalek!backend.serial.curve_models.ProjectivePoint./ProjectivePoint/Y (
          %Poly%curve25519_dalek!backend.serial.curve_models.ProjectivePoint. (Poly%curve25519_dalek!backend.serial.curve_models.ProjectivePoint.
           self_point!
     ))))))
     (=>
      (= pZ@ (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
         (curve25519_dalek!backend.serial.curve_models.ProjectivePoint./ProjectivePoint/Z (
           %Poly%curve25519_dalek!backend.serial.curve_models.ProjectivePoint. (Poly%curve25519_dalek!backend.serial.curve_models.ProjectivePoint.
            self_point!
      ))))))
       ...
       (=>
        ...
        (and
         ...
         (=>
          ...
          (and
           (=>
            (= tmp%1 (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
            ...
            (and
             (=>
              %%location_label%%1
              (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%1 p_i@)
             )
             (=>
              (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%1 p_i@)
              (=>
               %%location_label%%2
               (< pX@ p@)
           ))))
           (=>
            ...
            (and
             (=>
              (= tmp%2 (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
                  (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                    (curve25519_dalek!backend.serial.curve_models.ProjectivePoint./ProjectivePoint/Y (
                      %Poly%curve25519_dalek!backend.serial.curve_models.ProjectivePoint. (Poly%curve25519_dalek!backend.serial.curve_models.ProjectivePoint.
                       self_point!
              ...
              (and
               (=>
                %%location_label%%3
                (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%2 p_i@)
               )
               (=>
                (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%2 p_i@)
                (=>
                 %%location_label%%4
                 (< pY@ p@)
             ))))
             (=>
              ...
              (and
               (=>
                (= tmp%3 (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
                    (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                      (curve25519_dalek!backend.serial.curve_models.ProjectivePoint./ProjectivePoint/Z (
                        %Poly%curve25519_dalek!backend.serial.curve_models.ProjectivePoint. (Poly%curve25519_dalek!backend.serial.curve_models.ProjectivePoint.
                         self_point!
                ...
                (and
                 (=>
                  %%location_label%%5
                  (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%3 p_i@)
                 )
                 (=>
                  (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%3 p_i@)
                  (=>
                   %%location_label%%6
                   (< pZ@ p@)
               ))))
                  ...
                  (=>
                   ...
                   (and
                    ...
                    (=>
                     (not (= (EucMod pZ@ p@) 0))
                     (=>
                      (= z_inv@ (curve25519_dalek!specs.field_specs.field_inv.? (I pZ@)))
                      (=>
                       (= x@ (curve25519_dalek!specs.field_specs.field_mul.? (I pX@) (I z_inv@)))
                       (=>
                        (= y@ (curve25519_dalek!specs.field_specs.field_mul.? (I pY@) (I z_inv@)))
                        (and
                         (and
                          (=>
                           %%location_label%%10
                         ...
                         (=>
                          (curve25519_dalek!specs.edwards_specs.is_on_edwards_curve.? (I x@) (I y@))
                          (=>
                           (= z2@ (curve25519_dalek!specs.field_specs.field_square.? (I pZ@)))
                           (=>
                             ...
                             (=>
                              ...
                              (=>
                               ...
                               (=>
                                ...
                                (and
                                 (=>
                                  (= tmp%5 (nClip (Mul pX@ z_inv@)))
                                  (and
                                   (=>
                                    %%location_label%%12
                                    (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%5 p_i@)
                                   )
                                   (=>
                                    (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%5 p_i@)
                                    (=>
                                     %%location_label%%13
                                     (< x@ p@)
                                 ))))
                                 (=>
                                  ...
                                  (and
                                   (=>
                                    (= tmp%6 (nClip (Mul pY@ z_inv@)))
                                    (and
                                     (=>
                                      %%location_label%%14
                                      (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%6 p_i@)
                                     )
                                     (=>
                                      (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%6 p_i@)
                                      (=>
                                       %%location_label%%15
                                       (< y@ p@)
                                   ))))
                                   (=>
                                    ...
                                    (and
                                     (=>
                                      (= tmp%7 (nClip (Mul pZ@ pZ@)))
                                      (and
                                       (=>
                                        %%location_label%%16
                                        (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%7 p_i@)
                                       )
                                       (=>
                                        (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%7 p_i@)
                                        (=>
                                         %%location_label%%17
                                         (< z2@ p@)
                                     ))))
                                      ...
                                      (and
                                       (=>
                                        ...
                                        (and
                                         (=>
                                          %%location_label%%18
                                          (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%8 p_i@)
                                         )
                                         (=>
                                          (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%8 p_i@)
                                          (=>
                                           %%location_label%%19
                                           (< x2@ p@)
                                       ))))
                                        ...
                                        (and
                                         (=>
                                          ...
                                          (and
                                           (=>
                                            %%location_label%%20
                                            (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%9 p_i@)
                                           )
                                           (=>
                                            (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%9 p_i@)
                                            (=>
                                             %%location_label%%21
                                             (< y2@ p@)
                                         ))))
                                         (=>
                                          ...
                                          (and
                                           (=>
                                            (= tmp%10 (nClip (Mul x@ y@)))
                                            (and
                                             (=>
                                              %%location_label%%22
                                              (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%10 p_i@)
                                             )
                                             (=>
                                              (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%10 p_i@)
                                              (=>
                                               %%location_label%%23
                                               (< xy@ p@)
                                           ))))
                                            ...
                                            (and
                                             (and
                                              ...
                                              (=>
                                               ...
                                               (=>
                                                %%location_label%%25
                                                (= xx_val! (curve25519_dalek!specs.field_specs.field_mul.? (I x2@) (I z2@)))
                                             )))
                                             (=>
                                              (= xx_val! (curve25519_dalek!specs.field_specs.field_mul.? (I x2@) (I z2@)))
                                              (and
                                               (and
                                                ...
                                                (=>
                                                 ...
                                                 (=>
                                                  %%location_label%%27
                                                  (= yy_val! (curve25519_dalek!specs.field_specs.field_mul.? (I y2@) (I z2@)))
                                               )))
                                               (=>
                                                (= yy_val! (curve25519_dalek!specs.field_specs.field_mul.? (I y2@) (I z2@)))
                                                (and
                                                 (and
                                                  ...
                                                  (=>
                                                   ...
                                                   (=>
                                                    %%location_label%%29
                                                    (= (curve25519_dalek!specs.field_specs.field_mul.? (I pX@) (I pY@)) (curve25519_dalek!specs.field_specs.field_mul.?
                                                      (I xy@) (I z2@)
                                                 )))))
                                                 (=>
                                                  (= (curve25519_dalek!specs.field_specs.field_mul.? (I pX@) (I pY@)) (curve25519_dalek!specs.field_specs.field_mul.?
                                                     ...
                                                     (=>
                                                      ...
                                                      (=>
                                                       ...
                                                       (= (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                                        ...
                                                        ) (curve25519_dalek!specs.field_specs.field_mul.? (I z2@) (I (curve25519_dalek!specs.field_specs.field_mul.?
                                                           (I 2) (I xy@)
                                                     ))))))
                                                     (=>
                                                      (= (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                                       ...
                                                       (=>
                                                        ...
                                                        (=>
                                                         ...
                                                         (= (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                                          ...
                                                          ) (curve25519_dalek!specs.field_specs.field_mul.? (I z2@) (I (curve25519_dalek!specs.field_specs.field_add.?
                                                             (I y2@) (I x2@)
                                                       ))))))
                                                       (=>
                                                        (= (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                                         ...
                                                         (=>
                                                          ...
                                                          (=>
                                                           ...
                                                           (= (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                                            ...
                                                            ) (curve25519_dalek!specs.field_specs.field_mul.? (I z2@) (I (curve25519_dalek!specs.field_specs.field_sub.?
                                                               (I y2@) (I x2@)
                                                         ))))))
                                                         (=>
                                                          (= (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                                          ...
                                                          (=>
                                                           (= tmp%11 (= (curve25519_dalek!specs.field_specs.field_sub.? (I y2@) (I x2@)) (curve25519_dalek!specs.field_specs.field_add.?
                                                              (I 1) (I t@)
                                                           )))
                                                           (and
                                                            (=>
                                                               ...
                                                               (=>
                                                                ...
                                                                (and
                                                                 (=>
                                                                  ...
                                                                  (=>
                                                                   %%location_label%%36
                                                                   (= (curve25519_dalek!specs.field_specs.field_mul.? (I 2) (I z2@)) (curve25519_dalek!specs.field_specs.field_mul.?
                                                                     (I z2@) (I 2)
                                                                 ))))
                                                                 (=>
                                                                  (= (curve25519_dalek!specs.field_specs.field_mul.? (I 2) (I z2@)) (curve25519_dalek!specs.field_specs.field_mul.?
                                                                  ...
                                                                  (and
                                                                   (=>
                                                                    (= tmp%13 (curve25519_dalek!specs.field_specs.field_sub.? (I y2@) (I x2@)))
                                                                    (=>
                                                                     (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_factor_result_component_sub.
                                                                      2 tmp%13 z2@
                                                                     )
                                                                     (=>
                                                                      ...
                                                                      (= (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                                                         (curve25519_dalek!backend.serial.curve_models.CompletedPoint./CompletedPoint/T (%Poly%curve25519_dalek!backend.serial.curve_models.CompletedPoint.
                                                                          ...
                                                                          (I 2) (I (curve25519_dalek!specs.field_specs.field_sub.? (I y2@) (I x2@)))
                                                                   )))))))
                                                                   (=>
                                                                    (= (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                                                       (curve25519_dalek!backend.serial.curve_models.CompletedPoint./CompletedPoint/T (%Poly%curve25519_dalek!backend.serial.curve_models.CompletedPoint.
                                                                     ...
                                                                     (and
                                                                      (and
                                                                       ...
                                                                       (=>
                                                                        ...
                                                                        (=>
                                                                         %%location_label%%39
                                                                         (= (curve25519_dalek!specs.field_specs.field_add.? (I 1) (I 1)) 2)
                                                                      )))
                                                                      (=>
                                                                       (= (curve25519_dalek!specs.field_specs.field_add.? (I 1) (I 1)) 2)
                                                                       (and
                                                                        (=>
                                                                         ...
                                                                         (=>
                                                                          %%location_label%%40
                                                                          (= (curve25519_dalek!specs.field_specs.field_add.? (I t@) (I 1)) (curve25519_dalek!specs.field_specs.field_add.?
                                                                            (I 1) (I t@)
                                                                        ))))
                                                                        (=>
                                                                         (= (curve25519_dalek!specs.field_specs.field_add.? (I t@) (I 1)) (curve25519_dalek!specs.field_specs.field_add.?
                                                                         ...
                                                                         (and
                                                                          ...
                                                                          (=>
                                                                           ...
                                                                           (and
                                                                            (=>
                                                                             (= tmp%14 (nClip (Mul d@ (curve25519_dalek!specs.field_specs.field_mul.? (I x2@) (I y2@)))))
                                                                             (and
                                                                              (=>
                                                                               %%location_label%%43
                                                                               (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%14 p_i@)
                                                                              )
                                                                              (=>
                                                                               (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%14 p_i@)
                                                                               (=>
                                                                                %%location_label%%44
                                                                                (< t@ p@)
                                                                            ))))
                                                                            (=>
                                                                             ...
                                                                             (and
                                                                              ...
                                                                              (=>
                                                                               ...
                                                                               (=>
                                                                                %%location_label%%46
                                                                                (= (curve25519_dalek!specs.field_specs.field_sub.? (I 2) (I (curve25519_dalek!specs.field_specs.field_add.?
                                                                                    (I 1) (I t@)
                                                                                  ))
                                                                                 ) (curve25519_dalek!specs.field_specs.field_sub.? (I 1) (I t@))
                                                                     ))))))))))))
                                                                     (=>
                                                                      (= (curve25519_dalek!specs.field_specs.field_sub.? (I 2) (I (curve25519_dalek!specs.field_specs.field_add.?
                                                                          (I 1) (I t@)
                                                                      ...
                                                                      (=>
                                                                       (= tmp%15 (= (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                                                           (curve25519_dalek!backend.serial.curve_models.CompletedPoint./CompletedPoint/T (%Poly%curve25519_dalek!backend.serial.curve_models.CompletedPoint.
                                                                             (Poly%curve25519_dalek!backend.serial.curve_models.CompletedPoint. result!)
                                                                          )))
                                                                         ) (curve25519_dalek!specs.field_specs.field_mul.? (I z2@) (I (curve25519_dalek!specs.field_specs.field_sub.?
                                                                            ...
                                                                            (=>
                                                                             ...
                                                                             (and
                                                                              ...
                                                                              (=>
                                                                               ...
                                                                               (and
                                                                                (=>
                                                                                 (= tmp%16 (curve25519_dalek!specs.field_specs.field_add.? (I 1) (I t@)))
                                                                                 (and
                                                                                  (=>
                                                                                   %%location_label%%53
                                                                                   (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_element_reduced.
                                                                                  ...
                                                                                  (=>
                                                                                   ...
                                                                                   (=>
                                                                                    %%location_label%%54
                                                                                    (not (= (EucMod (curve25519_dalek!specs.field_specs.field_add.? (I 1) (I t@)) p@) 0))
                                                                                ))))
                                                                                (=>
                                                                                 (not (= (EucMod (curve25519_dalek!specs.field_specs.field_add.? (I 1) (I t@)) p@) 0))
                                                                                 (and
                                                                                  (and
                                                                                   (=>
                                                                                    (= tmp%17 (Sub (nClip (Add (curve25519_dalek!specs.field_specs_u64.field_canonical.? (
                                                                                          I 1
                                                                                         )
                                                                                        ) p@
                                                                                       )
                                                                                      ) (curve25519_dalek!specs.field_specs_u64.field_canonical.? (I t@))
                                                                                    ))
                                                                                    (and
                                                                                     (=>
                                                                                      %%location_label%%55
                                                                                      (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%17 p_i@)
                                                                                     )
                                                                                     (=>
                                                                                      (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%17 p_i@)
                                                                                      (=>
                                                                                       %%location_label%%56
                                                                                       (< (curve25519_dalek!specs.field_specs.field_sub.? (I 1) (I t@)) p@)
                                                                                   ))))
                                                                                   (=>
                                                                                    (< (curve25519_dalek!specs.field_specs.field_sub.? (I 1) (I t@)) p@)
                                                                                    (=>
                                                                                     (= tmp%18 (curve25519_dalek!specs.field_specs.field_sub.? (I 1) (I t@)))
                                                                                     (and
                                                                                      (=>
                                                                                       %%location_label%%57
                                                                                       (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_element_reduced.
                                                                                      ...
                                                                                      (=>
                                                                                       ...
                                                                                       (=>
                                                                                        %%location_label%%58
                                                                                        (not (= (EucMod (curve25519_dalek!specs.field_specs.field_sub.? (I 1) (I t@)) p@) 0))
                                                                                  ))))))
                                                                                  (=>
                                                                                   (not (= (EucMod (curve25519_dalek!specs.field_specs.field_sub.? (I 1) (I t@)) p@) 0))
                                                                                   (and
                                                                                    (=>
                                                                                     (= tmp%19 (curve25519_dalek!specs.field_specs.field_add.? (I 1) (I t@)))
                                                                                     (and
                                                                                      (=>
                                                                                       %%location_label%%59
                                                                                       (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_nonzero_product.
                                                                                    ...
                                                                                    (=>
                                                                                     ...
                                                                                     (and
                                                                                      (=>
                                                                                       (= tmp%20 (curve25519_dalek!specs.field_specs.field_sub.? (I 1) (I t@)))
                                                                                       (and
                                                                                        (=>
                                                                                         %%location_label%%61
                                                                                         (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_nonzero_product.
                                                                                      ...
                                                                                      (=>
                                                                                       ...
                                                                                       (and
                                                                                        (=>
                                                                                         (= tmp%21 (curve25519_dalek!specs.field_specs.field_mul.? (I 2) (I xy@)))
                                                                                         (=>
                                                                                          (= tmp%22 (curve25519_dalek!specs.field_specs.field_add.? (I 1) (I t@)))
                                                                                          (and
                                                                                           (=>
                                                                                            %%location_label%%63
                                                                                            (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_cancel_common_factor.
                                                                                           ...
                                                                                           (=>
                                                                                            ...
                                                                                            (=>
                                                                                             ...
                                                                                             (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.?
                                                                                                 (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (curve25519_dalek!backend.serial.curve_models.CompletedPoint./CompletedPoint/X
                                                                                               ...
                                                                                               ) (I (curve25519_dalek!specs.field_specs.field_inv.? (I (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.?
                                                                                                   (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (curve25519_dalek!backend.serial.curve_models.CompletedPoint./CompletedPoint/Z
                                                                                                     (%Poly%curve25519_dalek!backend.serial.curve_models.CompletedPoint. (Poly%curve25519_dalek!backend.serial.curve_models.CompletedPoint.
                                                                                                       result!
                                                                                               ))))))))
                                                                                              ) (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                                                                                        ...
                                                                                        (=>
                                                                                         ...
                                                                                         (and
                                                                                          (=>
                                                                                           (= tmp%23 (curve25519_dalek!specs.field_specs.field_add.? (I y2@) (I x2@)))
                                                                                           (=>
                                                                                            (= tmp%24 (curve25519_dalek!specs.field_specs.field_sub.? (I 1) (I t@)))
                                                                                            (and
                                                                                             (=>
                                                                                              %%location_label%%65
                                                                                              (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_cancel_common_factor.
                                                                                             ...
                                                                                             (=>
                                                                                              ...
                                                                                              (=>
                                                                                               %%location_label%%66
                                                                                               (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.?
                                                                                                   (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (curve25519_dalek!backend.serial.curve_models.CompletedPoint./CompletedPoint/Y
                                                                                                     (%Poly%curve25519_dalek!backend.serial.curve_models.CompletedPoint. (Poly%curve25519_dalek!backend.serial.curve_models.CompletedPoint.
                                                                                                       result!
                                                                                                  )))))
                                                                                                 ) (I (curve25519_dalek!specs.field_specs.field_inv.? (I (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.?
                                                                                                     (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (curve25519_dalek!backend.serial.curve_models.CompletedPoint./CompletedPoint/T
                                                                                                       (%Poly%curve25519_dalek!backend.serial.curve_models.CompletedPoint. (Poly%curve25519_dalek!backend.serial.curve_models.CompletedPoint.
                                                                                                         result!
                                                                                                 ))))))))
                                                                                          ...
                                                                                          (=>
                                                                                           ...
                                                                                           (and
                                                                                            (=>
                                                                                             ...
                                                                                             (=>
                                                                                              %%location_label%%67
                                                                                              (= (curve25519_dalek!specs.field_specs.field_mul.? (I y@) (I x@)) xy@)
                                                                                            ))
                                                                                            (=>
                                                                                             (= (curve25519_dalek!specs.field_specs.field_mul.? (I y@) (I x@)) xy@)
                                                                                             (and
                                                                                              (=>
                                                                                               ...
                                                                                               (=>
                                                                                                %%location_label%%68
                                                                                                (= (curve25519_dalek!specs.field_specs.field_add.? (I xy@) (I xy@)) (curve25519_dalek!specs.field_specs.field_mul.?
                                                                                                  (I 2) (I xy@)
                                                                                              ))))
                                                                                              (=>
                                                                                               (= (curve25519_dalek!specs.field_specs.field_add.? (I xy@) (I xy@)) (curve25519_dalek!specs.field_specs.field_mul.?
                                                                                               ...
                                                                                               (and
                                                                                                 ...
                                                                                                 (=>
                                                                                                  ...
                                                                                                  (=>
                                                                                                   ...
                                                                                                   (curve25519_dalek!specs.edwards_specs.is_on_edwards_curve.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                                                                                                    ...
                                                                                                    ) (I (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.?
                                                                                                        (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (curve25519_dalek!backend.serial.curve_models.CompletedPoint./CompletedPoint/Y
                                                                                                          (%Poly%curve25519_dalek!backend.serial.curve_models.CompletedPoint. (Poly%curve25519_dalek!backend.serial.curve_models.CompletedPoint.
                                                                                                            result!
                                                                                                       )))))
                                                                                                ...
                                                                                                (=>
                                                                                                 ...
                                                                                                 (=>
                                                                                                  (= tmp%25 (curve25519_dalek!specs.edwards_specs.is_valid_completed_point.? (Poly%curve25519_dalek!backend.serial.curve_models.CompletedPoint.
                                                                                                     result!
                                                                                                  )))
                                                                                                  (and
                                                                                                   (=>
                                                                                                   ...
                                                                                                   (=>
                                                                                                    tmp%25
                                                                                                    (=>
                                                                                                     (= tmp%26 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.completed_point_as_affine_edwards.?
                                                                                                         (Poly%curve25519_dalek!backend.serial.curve_models.CompletedPoint. result!)
                                                                                                        )
                                                                                                       ) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_double.? (tuple%2./tuple%2/0
                                                                                                          (%Poly%tuple%2. (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.projective_point_as_affine_edwards.?
                                                                                                             (Poly%curve25519_dalek!backend.serial.curve_models.ProjectivePoint. self_point!)
                                                                                                          )))
                                                                                                         ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.projective_point_as_affine_edwards.?
                                                                                                             (Poly%curve25519_dalek!backend.serial.curve_models.ProjectivePoint. self_point!)
