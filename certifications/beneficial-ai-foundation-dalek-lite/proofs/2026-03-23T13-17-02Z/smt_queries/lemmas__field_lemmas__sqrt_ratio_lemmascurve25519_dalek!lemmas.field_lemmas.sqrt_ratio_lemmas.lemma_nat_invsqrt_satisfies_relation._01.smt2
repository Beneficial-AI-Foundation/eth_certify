...
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_ratio_lemmas.rs:1281:1: 1281:58 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::sqrt_ratio_lemmas::lemma_nat_invsqrt_satisfies_relation
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_ratio_lemmas.rs:1281:1: 1281:58 (#0)
...
(push)
 ...
 (declare-const k@ Int)
 (declare-const pow_a7_k@ Int)
 (declare-const r_raw@ Int)
 (declare-const check@ Int)
 (declare-const neg_one@ Int)
 (declare-const neg_i@ Int)
 (declare-const r_adj@ Int)
 (declare-const s@ Int)
 (declare-const w@ Int)
 (declare-const quarter@ Int)
 (declare-const fourth_root@ Int)
 (assert
  fuel_defaults
 )
 (assert
       ...
       (=>
        ...
        (=>
         ...
         (and
          (=>
           %%location_label%%0
           (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow_nonnegative. a7@ k@)
          )
          (=>
           (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow_nonnegative. a7@ k@)
           (=>
            (= pow_a7_k@ (EucMod (nClip (vstd!arithmetic.power.pow.? (I a7@) (I k@))) pn@))
            (=>
             (= r_raw@ (curve25519_dalek!specs.field_specs.field_mul.? (I a3@) (I pow_a7_k@)))
             (=>
              (= check@ (curve25519_dalek!specs.field_specs.field_mul.? (I a!) (I (curve25519_dalek!specs.field_specs.field_square.?
                  (I r_raw@)
              ))))
              (=>
               (= neg_one@ (curve25519_dalek!specs.field_specs.field_neg.? (I 1)))
               (=>
                ...
                (=>
                 ...
                 (=>
                  ...
                  (and
                   (=>
                    (= tmp%1 (Mul (curve25519_dalek!specs.field_specs.field_square.? (I a!)) a!))
                    (and
                     (=>
                      %%location_label%%1
                   ...
                   (=>
                    ...
                    (and
                     (=>
                      (= tmp%2 (Mul (curve25519_dalek!specs.field_specs.field_square.? (I a3@)) a!))
                      (and
                       (=>
                        %%location_label%%3
                           ...
                           (=>
                            ...
                            (and
                             ...
                             (=>
                              ...
                              (=>
                               (= tmp%5 (curve25519_dalek!specs.field_specs.field_square.? (I a!)))
                               (and
                                (=>
                                 %%location_label%%9
                                 (req%vstd!arithmetic.div_mod.lemma_small_mod. tmp%5 pn@)
                                )
                                (=>
                                 (ens%vstd!arithmetic.div_mod.lemma_small_mod. tmp%5 pn@)
                                 (=>
                                  %%location_label%%10
                                  (not (= (EucMod (curve25519_dalek!specs.field_specs.field_square.? (I a!)) pn@) 0))
                         )))))))))
                         (=>
                          (not (= (EucMod (curve25519_dalek!specs.field_specs.field_square.? (I a!)) pn@) 0))
                          (and
                           (=>
                            (= tmp%6 (curve25519_dalek!specs.field_specs.field_square.? (I a!)))
                            (and
                             (=>
                              %%location_label%%11
                              (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_nonzero_product.
                             ...
                             (=>
                              ...
                              (and
                               (=>
                                %%location_label%%12
                                (req%vstd!arithmetic.div_mod.lemma_small_mod. a3@ pn@)
                               )
                               (=>
                                (ens%vstd!arithmetic.div_mod.lemma_small_mod. a3@ pn@)
                                (=>
                                 %%location_label%%13
                                 (not (= (EucMod a3@ pn@) 0))
                           ))))))
                            ...
                            (and
                             (and
                              ...
                              (=>
                               ...
                               (=>
                                (= tmp%7 (nClip (Mul a3@ a3@)))
                                (and
                                 (=>
                                  %%location_label%%15
                                  (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%7 pn@)
                                 )
                                 (=>
                                  (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%7 pn@)
                                  (=>
                                   (= tmp%8 (curve25519_dalek!specs.field_specs.field_square.? (I a3@)))
                                   (and
                                    (=>
                                     %%location_label%%16
                                     (req%vstd!arithmetic.div_mod.lemma_small_mod. tmp%8 pn@)
                                    )
                                    (=>
                                     (ens%vstd!arithmetic.div_mod.lemma_small_mod. tmp%8 pn@)
                                     (=>
                                      %%location_label%%17
                                      (not (= (EucMod (curve25519_dalek!specs.field_specs.field_square.? (I a3@)) pn@) 0))
                             )))))))))
                             (=>
                              (not (= (EucMod (curve25519_dalek!specs.field_specs.field_square.? (I a3@)) pn@) 0))
                              (and
                               (=>
                                (= tmp%9 (curve25519_dalek!specs.field_specs.field_square.? (I a3@)))
                                (and
                                 (=>
                                  %%location_label%%18
                                  (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_nonzero_product.
                                 ...
                                 (=>
                                  ...
                                  (and
                                   (=>
                                    %%location_label%%19
                                    (req%vstd!arithmetic.div_mod.lemma_small_mod. a7@ pn@)
                                   )
                                   (=>
                                    (ens%vstd!arithmetic.div_mod.lemma_small_mod. a7@ pn@)
                                    (=>
                                     %%location_label%%20
                                     (not (= (EucMod a7@ pn@) 0))
                               ))))))
                               (=>
                                ...
                                (and
                                 ...
                                 (=>
                                  ...
                                  (=>
                                   (= w@ (curve25519_dalek!specs.field_specs.field_mul.? (I 1) (I a7@)))
                                   (=>
                                    (= quarter@ (nClip (EucDiv (Sub pn@ 1) 4)))
                                    (and
                                     (=>
                                      %%location_label%%22
                                      (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow_nonnegative. w@ quarter@)
                                     )
                                     (=>
                                      (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow_nonnegative. w@ quarter@)
                                      (=>
                                       (= fourth_root@ (EucMod (nClip (vstd!arithmetic.power.pow.? (I w@) (I quarter@))) pn@))
                                       (and
                                        (=>
                                         (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_one_left.
                                          a7@
                                          ...
                                          (=>
                                           ...
                                           (and
                                            ...
                                            (=>
                                             ...
                                             (=>
                                              %%location_label%%26
                                              (= (curve25519_dalek!specs.field_specs.field_mul.? (I 1) (I a3@)) a3@)
                                          ))))
                                          (=>
                                           (= (curve25519_dalek!specs.field_specs.field_mul.? (I 1) (I a3@)) a3@)
                                           (and
                                            (=>
                                             (= tmp%10 (vstd!arithmetic.power.pow.? (I w@) (I quarter@)))
                                             (and
                                              (=>
                                               %%location_label%%27
                                             ...
                                             (and
                                              (=>
                                               ...
                                               (and
                                                (=>
                                                 %%location_label%%29
                                                 (req%vstd!arithmetic.div_mod.lemma_small_mod. fourth_root@ pn@)
                                                )
                                                (=>
                                                 (ens%vstd!arithmetic.div_mod.lemma_small_mod. fourth_root@ pn@)
                                                 (=>
                                                  %%location_label%%30
                                                  (= check@ fourth_root@)
                                              ))))
                                                 ...
                                                 (and
                                                  (and
                                                   ...
                                                   (=>
                                                    ...
                                                    (=>
                                                     (= tmp%11 (nClip (Sub pn@ 1)))
                                                     (and
                                                      (=>
                                                       %%location_label%%33
                                                       (req%vstd!arithmetic.div_mod.lemma_small_mod. tmp%11 pn@)
                                                      )
                                                      (=>
                                                       (ens%vstd!arithmetic.div_mod.lemma_small_mod. tmp%11 pn@)
                                                       (=>
                                                        %%location_label%%34
                                                  ...
                                                  (=>
                                                   ...
                                                   (=>
                                                    ...
                                                    (and
                                                     (=>
                                                      (= tmp%12 (curve25519_dalek!specs.field_specs.fe51_as_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                                              ...
                                                              (and
                                                               (=>
                                                                ...
                                                                (=>
                                                                 ...
                                                                 (=>
                                                                  %%location_label%%41
                                                                  (= (curve25519_dalek!specs.field_specs.field_square.? (I r_adj@)) (curve25519_dalek!specs.field_specs.field_neg.?
                                                                    (I (curve25519_dalek!specs.field_specs.field_square.? (I r_raw@)))
                                                               )))))
                                                               (=>
                                                                (= (curve25519_dalek!specs.field_specs.field_square.? (I r_adj@)) (curve25519_dalek!specs.field_specs.field_neg.?
                                                                  (I (curve25519_dalek!specs.field_specs.field_square.? (I r_raw@)))
                                                                ...
                                                                (and
                                                                 (=>
                                                                  (= tmp%15 (curve25519_dalek!specs.field_specs.field_square.? (I r_raw@)))
                                                                  (=>
                                                                   (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_neg.
                                                                    a! tmp%15
                                                                   )
                                                                   (=>
                                                                    %%location_label%%42
                                                                    (= (curve25519_dalek!specs.field_specs.field_mul.? (I a!) (I (curve25519_dalek!specs.field_specs.field_square.?
                                                                        (I r_adj@)
                                                                      ))
                                                                     ) (curve25519_dalek!specs.field_specs.field_neg.? (I check@))
                                                                 ))))
                                                                 (=>
                                                                  (= (curve25519_dalek!specs.field_specs.field_mul.? (I a!) (I (curve25519_dalek!specs.field_specs.field_square.?
                                                                      (I r_adj@)
                                                                ...
                                                                (=>
                                                                 ...
                                                                 (=>
                                                                  ...
                                                                  (and
                                                                   (=>
                                                                    %%location_label%%48
                                                                    (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%17 pn@)
                                                                   )
                                                                   (=>
                                                                    (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%17 pn@)
                                                                    %%switch_label%%3
                                                                ))))
                                                                (=>
                                                                 (not (or
                                                                 ...
                                                                 (and
                                                                  (=>
                                                                   ...
                                                                   (and
                                                                    (=>
                                                                     %%location_label%%50
                                                                     (req%vstd!arithmetic.div_mod.lemma_small_mod. r_adj@ pn@)
                                                                    )
                                                                    (=>
                                                                     (ens%vstd!arithmetic.div_mod.lemma_small_mod. r_adj@ pn@)
                                                                     (=>
                                                                      (= tmp%18 (Sub pn@ r_adj@))
                                                                      (and
                                                                       (=>
                                                                        %%location_label%%51
                                                                        (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%18 pn@)
                                                                       )
                                                                       (=>
                                                                        (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%18 pn@)
                                                                        %%switch_label%%2
                                                                  ))))))
                                                                  (=>
                                                                   (not (curve25519_dalek!specs.field_specs.is_negative.? (I r_adj@)))
                                                                   %%switch_label%%2
                                                                 ))
                                                                 (and
                                                                  (not %%switch_label%%2)
                                                                 ...
                                                                 (and
                                                                  (and
                                                                   ...
                                                                   (=>
                                                                    (ens%vstd!arithmetic.div_mod.lemma_small_mod. r_adj@ pn@)
                                                                    (=>
                                                                     (= tmp%19 (curve25519_dalek!specs.field_specs.is_negative.? (I r_adj@)))
                                                                     (and
                                                                      (=>
                                                                       %%location_label%%54
                                                                       (req%curve25519_dalek!lemmas.field_lemmas.sqrt_ratio_lemmas.lemma_conditional_negate_makes_even.
                                                                   ...
                                                                   (and
                                                                    (or
                                                                     ...
                                                                     (and
                                                                      ...
                                                                      (=>
                                                                       %%location_label%%57
                                                                       (= (curve25519_dalek!specs.field_specs.field_square.? (I s@)) (curve25519_dalek!specs.field_specs.field_square.?
                                                                         (I r_adj@)
                                                                    )))))
                                                                    (=>
                                                                     (= (curve25519_dalek!specs.field_specs.field_square.? (I s@)) (curve25519_dalek!specs.field_specs.field_square.?
                                                                          ...
                                                                          (=>
                                                                           ...
                                                                           (and
                                                                            ...
                                                                            (=>
                                                                             ...
                                                                             (=>
                                                                              %%location_label%%62
                                                                              (= (curve25519_dalek!specs.field_specs.field_mul.? (I i@) (I 1)) i@)
                                                                          ))))
                                                                          (=>
                                                                           (= (curve25519_dalek!specs.field_specs.field_mul.? (I i@) (I 1)) i@)
                                                                           (or
                                                                            (and
                                                                             (=>
                                                                              ...
                                                                              (=>
                                                                               (= tmp%20 (= (curve25519_dalek!specs.field_specs_u64.field_canonical.? (I (nClip (Mul (
                                                                                      nClip (Mul s@ s@)
                                                                                     ) a!
                                                                                  )))
                                                                                 ) (curve25519_dalek!specs.field_specs_u64.field_canonical.? (I 1))
                                                                               ))
                                                                               (and
                                                                                (=>
                                                                                 %%location_label%%63
                                                                                ...
                                                                                (=>
                                                                                 tmp%20
                                                                                 (=>
                                                                                  (= tmp%21 (curve25519_dalek!specs.field_specs.is_sqrt_ratio.? (I 1) (I a!) (I s@)))
                                                                                  (and
                                                                                   (=>
                                                                                    %%location_label%%64
                                                                                    tmp%21
                                                                             ...
                                                                             (=>
                                                                              (not (= (curve25519_dalek!specs.field_specs.field_mul.? (I a!) (I (curve25519_dalek!specs.field_specs.field_square.?
                                                                                   (I r_adj@)
                                                                                 ))
                                                                                ) 1
                                                                              ))
                                                                              (=>
                                                                               (= tmp%22 (= (curve25519_dalek!specs.field_specs.field_mul.? (I a!) (I (curve25519_dalek!specs.field_specs.field_square.?
                                                                                    (I r_adj@)
                                                                                  ))
                                                                                 ) i@
                                                                               ))
                                                                               (and
                                                                                ...
                                                                                (=>
                                                                                 tmp%22
                                                                                 (=>
                                                                                  (= tmp%23 (= (curve25519_dalek!specs.field_specs_u64.field_canonical.? (I (nClip (Mul (
                                                                                         nClip (Mul s@ s@)
                                                                                        ) a!
                                                                                     )))
                                                                                    ) (curve25519_dalek!specs.field_specs.field_mul.? (I i@) (I 1))
                                                                                  ))
                                                                                  (and
                                                                                   (=>
                                                                                    %%location_label%%66
                                                                                   ...
                                                                                   (=>
                                                                                    tmp%23
                                                                                    (=>
                                                                                     (= tmp%24 (curve25519_dalek!specs.field_specs.is_sqrt_ratio_times_i.? (I 1) (I a!)
                                                                                       (I s@)
                                                                                     ))
                                                                                     (and
                                                                                      (=>
