...
;; curve25519-dalek/src/lemmas/common_lemmas/to_nat_lemmas.rs:181:7: 181:59 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::to_nat_lemmas::lemma_horner_to_prefix_step
;; curve25519-dalek/src/lemmas/common_lemmas/to_nat_lemmas.rs:181:7: 181:59 (#0)
(get-info :all-statistics)
(push)
 (declare-const seq! vstd!seq.Seq<u8.>.)
 (declare-const k! Int)
 ...
 (declare-const tail_prev@ Int)
 (declare-const tail_term@ Int)
 (declare-const tail@ vstd!seq.Seq<u8.>.)
 (declare-const goal@ Bool)
 ...
 (assert
  (not (=>
    (= decrease%init0 k!)
    (=>
     (= tail@ (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.subrange.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>.
         seq!
        ) (I 1) (I (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. seq!)))
     )))
     (=>
      (= goal@ (= (nClip (Add (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>.
               seq!
              ) (I 0)
             )
            ) (vstd!arithmetic.power2.pow2.? (I 0))
          ...
          (or
           (and
            (=>
             ...
             (and
              (=>
               (= tmp%1 (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. seq!) (I 0))))
               (=>
                ...
                (=>
                 ...
                 (=>
                  %%location_label%%0
                  (= (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. seq!) (I 0)))
                     (vstd!arithmetic.power2.pow2.? (I 0))
                    )
                   ) (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 0)) (%I (vstd!seq.Seq.index.? $ (UINT
                        8
                       ) (Poly%vstd!seq.Seq<u8.>. seq!) (I 0)
              )))))))))
              (=>
               (= (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. seq!) (I 0)))
                  (vstd!arithmetic.power2.pow2.? (I 0))
            ...
            (=>
             ...
             (=>
              (= k1@ (nClip (Sub k! 1)))
              (=>
               (= tail_prev@ (curve25519_dalek!specs.core_specs.bytes_as_nat_prefix.? (Poly%vstd!seq.Seq<u8.>.
                  tail@
                 ) (I k1@)
               ))
               (=>
                (= tail_term@ (nClip (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul k1@ 8)))) (%I
                    (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. tail@) (I k1@))
                ))))
                (and
                 (and
                  (=>
                   ...
                   (=>
                    ...
                    (=>
                     ...
                     (= (nClip (Add (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>.
                        ...
                        ) (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 8)) tail_prev@))
                       )
                      ) (curve25519_dalek!specs.core_specs.bytes_as_nat_prefix.? (Poly%vstd!seq.Seq<u8.>.
                        seq!
                       ) (I k!)
                 ...
                 (=>
                  ...
                  (and
                   (=>
                    (= tmp%3 (nClip (Mul k1@ 8)))
                    (=>
                     (ens%vstd!arithmetic.power2.lemma_pow2_adds. 8 tmp%3)
                     (and
                      (=>
                       (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub. 8 k! 1)
                       (=>
                        %%location_label%%4
                        (= (nClip (Add 8 (nClip (Mul k1@ 8)))) (nClip (Mul k! 8)))
                      ))
                      (=>
                       (= (nClip (Add 8 (nClip (Mul k1@ 8)))) (nClip (Mul k! 8)))
                       (=>
                        ...
                        (= (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 8)) (vstd!arithmetic.power2.pow2.? (
                         ...
                         ) (vstd!arithmetic.power2.pow2.? (I (nClip (Mul k! 8))))
                   ))))))
                   (=>
                    (= (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 8)) (vstd!arithmetic.power2.pow2.? (
                         I (nClip (Mul k1@ 8))
                    ...
                    (=>
                     (= tmp%4 (= (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. tail@) (I k1@))
                       (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. seq!) (I k!))
                     ))
                     (and
                      (=>
                       %%location_label%%6
                      ...
                      (=>
                       ...
                       (and
                        (=>
                         ...
                         (=>
                          (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add. tmp%5 tail_prev@ tail_term@)
                          (=>
                           %%location_label%%7
                           (= (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 8)) (curve25519_dalek!specs.core_specs.bytes_as_nat_prefix.?
                               (Poly%vstd!seq.Seq<u8.>. tail@) (I k!)
                             ))
                            ) (nClip (Add (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 8)) tail_prev@)) (nClip
                               (Mul (vstd!arithmetic.power2.pow2.? (I 8)) tail_term@)
                        )))))))
                        (=>
                         (= (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 8)) (curve25519_dalek!specs.core_specs.bytes_as_nat_prefix.?
                             (Poly%vstd!seq.Seq<u8.>. tail@) (I k!)
                         ...
                         (and
                          (=>
                           ...
                           (=>
                            (= tmp%7 (vstd!arithmetic.power2.pow2.? (I (nClip (Mul k1@ 8)))))
                            (=>
                             (= tmp%8 (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. tail@) (I k1@))))
                             (=>
                              (ens%vstd!arithmetic.mul.lemma_mul_is_associative. tmp%6 tmp%7 tmp%8)
                              (=>
                               %%location_label%%8
                               (= (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 8)) tail_term@)) (nClip (Mul (vstd!arithmetic.power2.pow2.?
                                   (I (nClip (Mul k! 8)))
                                  ) (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. seq!) (I k!)))
                          ))))))))
                          (=>
                           (= (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 8)) tail_term@)) (nClip (Mul (vstd!arithmetic.power2.pow2.?
                               (I (nClip (Mul k! 8)))
