...
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:2233:1: 2233:88 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::curve_equation_lemmas::lemma_negate_projective_niels_preserves_validity
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:2233:1: 2233:88 (#0)
...
(push)
 ...
 (declare-const tmp%12 %%Function%%)
 (declare-const tmp%13 %%Function%%)
 ...
 (declare-const neg@ curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.)
 ...
 (declare-const ep_x_fe@ curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const ep_t_fe@ curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const neg_x_limbs@ %%Function%%)
 (declare-const neg_t_limbs@ %%Function%%)
 (declare-const neg_x_fe@ curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const neg_t_fe@ curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const neg_xp@ Int)
 (declare-const neg_tp@ Int)
 (declare-const neg_ep@ curve25519_dalek!edwards.EdwardsPoint.)
 (declare-const pt_t2d_fe@ curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const pt_t2d_val@ Int)
 (declare-const d@ Int)
 (declare-const neg_t2d_fe@ curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const neg_t2d_val@ Int)
 (assert
  fuel_defaults
 )
 (assert
  ...
  (forall ((%%hole%%0 Type) (%%hole%%1 Poly) (%%hole%%2 Poly)) (!
    (=>
     (exists ((ep$1 Poly)) (!
       ...
       :qid user_curve25519_dalek__lemmas__edwards_lemmas__curve_equation_lemmas__lemma_negate_projective_niels_preserves_validity_157
       :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__curve_equation_lemmas__lemma_negate_projective_niels_preserves_validity_157
     ))
     (exists ((ep$1 Poly)) (!
       (and
        (and
 ...
 (assert
  (not (=>
    (= neg@ (curve25519_dalek!specs.edwards_specs.negate_projective_niels.? (Poly%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
       pt!
    )))
    (and
     (=>
     ...
     (=>
      ...
      (=>
       (= ep@ (%Poly%curve25519_dalek!edwards.EdwardsPoint. (as_type (%%choose%%0 TYPE%curve25519_dalek!edwards.EdwardsPoint.
           (Poly%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint. pt!) (Poly%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
            pt!
           )
          ) TYPE%curve25519_dalek!edwards.EdwardsPoint.
       )))
       (=>
        ...
        (=>
         (= xp@ (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
            (curve25519_dalek!edwards.EdwardsPoint./EdwardsPoint/X (%Poly%curve25519_dalek!edwards.EdwardsPoint.
              (Poly%curve25519_dalek!edwards.EdwardsPoint. ep@)
         )))))
         (=>
          (= yp@ (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
             (curve25519_dalek!edwards.EdwardsPoint./EdwardsPoint/Y (%Poly%curve25519_dalek!edwards.EdwardsPoint.
               (Poly%curve25519_dalek!edwards.EdwardsPoint. ep@)
          )))))
          (=>
           (= zp@ (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
              (curve25519_dalek!edwards.EdwardsPoint./EdwardsPoint/Z (%Poly%curve25519_dalek!edwards.EdwardsPoint.
                (Poly%curve25519_dalek!edwards.EdwardsPoint. ep@)
           )))))
           (=>
            (= tp@ (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
               (curve25519_dalek!edwards.EdwardsPoint./EdwardsPoint/T (%Poly%curve25519_dalek!edwards.EdwardsPoint.
                 (Poly%curve25519_dalek!edwards.EdwardsPoint. ep@)
            )))))
            (=>
             (= ep_x_fe@ (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51
               (%Poly%array%. (Poly%array%. (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
                  (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                    (curve25519_dalek!edwards.EdwardsPoint./EdwardsPoint/X (%Poly%curve25519_dalek!edwards.EdwardsPoint.
                      (Poly%curve25519_dalek!edwards.EdwardsPoint. ep@)
             )))))))))
             (=>
              (= ep_t_fe@ (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51
                (%Poly%array%. (Poly%array%. (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
                   (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                     (curve25519_dalek!edwards.EdwardsPoint./EdwardsPoint/T (%Poly%curve25519_dalek!edwards.EdwardsPoint.
                       (Poly%curve25519_dalek!edwards.EdwardsPoint. ep@)
               ...
               (=>
                ...
                (and
                 ...
                 (=>
                  ...
                  (=>
                   (= tmp%1 (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
                     (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                       (curve25519_dalek!edwards.EdwardsPoint./EdwardsPoint/X (%Poly%curve25519_dalek!edwards.EdwardsPoint.
                         (Poly%curve25519_dalek!edwards.EdwardsPoint. ep@)
                   ))))))
                   (and
                    (=>
                     %%location_label%%3
                     (req%curve25519_dalek!lemmas.field_lemmas.negate_lemmas.lemma_neg_no_underflow. tmp%1)
                    )
                    (=>
                     (ens%curve25519_dalek!lemmas.field_lemmas.negate_lemmas.lemma_neg_no_underflow. tmp%1)
                     (=>
                      ...
                      (and
                       (=>
                        %%location_label%%4
                        (req%curve25519_dalek!lemmas.field_lemmas.negate_lemmas.lemma_neg_no_underflow. tmp%2)
                       )
                       (=>
                        (ens%curve25519_dalek!lemmas.field_lemmas.negate_lemmas.lemma_neg_no_underflow. tmp%2)
                        (=>
                         (= tmp%3 (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
                           (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                             (curve25519_dalek!edwards.EdwardsPoint./EdwardsPoint/X (%Poly%curve25519_dalek!edwards.EdwardsPoint.
                               (Poly%curve25519_dalek!edwards.EdwardsPoint. ep@)
                         ))))))
                         (and
                          (=>
                           %%location_label%%5
                           (req%curve25519_dalek!lemmas.field_lemmas.negate_lemmas.proof_negate. tmp%3)
                          )
                          (=>
                           (ens%curve25519_dalek!lemmas.field_lemmas.negate_lemmas.proof_negate. tmp%3)
                           (=>
                            (= tmp%4 (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
                              (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                (curve25519_dalek!edwards.EdwardsPoint./EdwardsPoint/T (%Poly%curve25519_dalek!edwards.EdwardsPoint.
                                  (Poly%curve25519_dalek!edwards.EdwardsPoint. ep@)
                            ))))))
                            (and
                             (=>
                              %%location_label%%6
                              (req%curve25519_dalek!lemmas.field_lemmas.negate_lemmas.proof_negate. tmp%4)
                             )
                             (=>
                              (ens%curve25519_dalek!lemmas.field_lemmas.negate_lemmas.proof_negate. tmp%4)
                              (=>
                               (= neg_x_limbs@ (curve25519_dalek!specs.field_specs_u64.spec_negate.? (Poly%array%.
                               ...
                               (=>
                                (= neg_t_limbs@ (curve25519_dalek!specs.field_specs_u64.spec_negate.? (Poly%array%.
                                   (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                ...
                                (=>
                                 (= neg_x_fe@ (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51
                                   (%Poly%array%. (Poly%array%. neg_x_limbs@))
                                 ))
                                 (=>
                                  (= neg_t_fe@ (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51
                                    (%Poly%array%. (Poly%array%. neg_t_limbs@))
                                  ))
                                  (and
                                   (and
                                    (=>
                                    ...
                                    (=>
                                     (forall ((i$ Poly)) (!
                                       ...
                                       :qid user_curve25519_dalek__lemmas__edwards_lemmas__curve_equation_lemmas__lemma_negate_projective_niels_preserves_validity_158
                                       :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__curve_equation_lemmas__lemma_negate_projective_niels_preserves_validity_158
                                     ))
                                     (=>
                                      %%location_label%%9
                                      (curve25519_dalek!specs.field_specs.fe51_limbs_bounded.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                    ...
                                    (and
                                     (and
                                      ...
                                      (=>
                                       (forall ((i$ Poly)) (!
                                         ...
                                         :qid user_curve25519_dalek__lemmas__edwards_lemmas__curve_equation_lemmas__lemma_negate_projective_niels_preserves_validity_160
                                         :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__curve_equation_lemmas__lemma_negate_projective_niels_preserves_validity_160
                                       ))
                                       (=>
                                        %%location_label%%12
                                        (curve25519_dalek!specs.field_specs.fe51_limbs_bounded.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                     ...
                                     (=>
                                      ...
                                      (and
                                       (=>
                                        %%location_label%%13
                                        (req%curve25519_dalek!lemmas.field_lemmas.negate_lemmas.lemma_neg. ep_x_fe@)
                                       )
                                       (=>
                                        (ens%curve25519_dalek!lemmas.field_lemmas.negate_lemmas.lemma_neg. ep_x_fe@)
                                        (and
                                         (=>
                                          %%location_label%%14
                                          (req%curve25519_dalek!lemmas.field_lemmas.negate_lemmas.lemma_neg. ep_t_fe@)
                                         )
                                         (=>
                                          (ens%curve25519_dalek!lemmas.field_lemmas.negate_lemmas.lemma_neg. ep_t_fe@)
                                          (=>
                                           (= neg_xp@ (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                              neg_x_fe@
                                           )))
                                           (=>
                                            (= neg_tp@ (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                               neg_t_fe@
                                            )))
                                            (=>
                                             (= tmp%7 (= neg_xp@ (curve25519_dalek!specs.field_specs.field_neg.? (I xp@))))
                                             (and
                                              (=>
                                               %%location_label%%15
                                               tmp%7
                                              ...
                                              (=>
                                               tmp%7
                                               (=>
                                                (= tmp%8 (= neg_tp@ (curve25519_dalek!specs.field_specs.field_neg.? (I tp@))))
                                                (and
                                                 (=>
                                                  %%location_label%%16
                                                  tmp%8
                                                  ...
                                                  (and
                                                   (=>
                                                    ...
                                                    (=>
                                                     ...
                                                     (=>
                                                      %%location_label%%17
                                                      (= (curve25519_dalek!specs.field_specs.field_square.? (I neg_xp@)) (curve25519_dalek!specs.field_specs.field_square.?
                                                        (I xp@)
                                                   )))))
                                                   (=>
                                                    (= (curve25519_dalek!specs.field_specs.field_square.? (I neg_xp@)) (curve25519_dalek!specs.field_specs.field_square.?
                                                      ...
                                                      (=>
                                                       ...
                                                       (=>
                                                        ...
                                                        (=>
                                                         ...
                                                         (=>
                                                          %%location_label%%18
                                                          (curve25519_dalek!specs.edwards_specs.is_valid_extended_edwards_point.? (I neg_xp@)
                                                           (I yp@) (I zp@) (I neg_tp@)
                                                     ))))))
                                                     (=>
                                                      (curve25519_dalek!specs.edwards_specs.is_valid_extended_edwards_point.? (I neg_xp@)
                                                      ...
                                                      (=>
                                                       (= neg_ep@ (curve25519_dalek!edwards.EdwardsPoint./EdwardsPoint (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                                          (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. neg_x_fe@)
                                                         ) (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                                           (curve25519_dalek!edwards.EdwardsPoint./EdwardsPoint/Y (%Poly%curve25519_dalek!edwards.EdwardsPoint.
                                                             (Poly%curve25519_dalek!edwards.EdwardsPoint. ep@)
                                                          )))
                                                       ...
                                                       (=>
                                                        (ens%curve25519_dalek!specs.edwards_specs.lemma_unfold_edwards. neg_ep@)
                                                        (=>
                                                         (= tmp%9 (curve25519_dalek!specs.edwards_specs.is_valid_edwards_point.? (Poly%curve25519_dalek!edwards.EdwardsPoint.
                                                            neg_ep@
                                                         )))
                                                         (and
                                                          (=>
                                                          ...
                                                          (=>
                                                           tmp%9
                                                           (=>
                                                            (= tmp%10 (curve25519_dalek!specs.edwards_specs.edwards_point_limbs_bounded.? (Poly%curve25519_dalek!edwards.EdwardsPoint.
                                                               neg_ep@
                                                            )))
                                                            (and
                                                             (=>
                                                               ...
                                                               (=>
                                                                ...
                                                                (=>
                                                                 ...
                                                                 (= (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                                                  ...
                                                                  ) (curve25519_dalek!specs.field_specs.field_add.? (I yp@) (I neg_xp@))
                                                               )))
                                                               (=>
                                                                (= (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                                                   (curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint./ProjectiveNielsPoint/Y_plus_X
                                                                ...
                                                                (and
                                                                 (=>
                                                                  (= tmp%11 (curve25519_dalek!specs.field_specs.field_neg.? (I xp@)))
                                                                  (=>
                                                                   (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_sub_eq_add_neg.
                                                                    yp@ tmp%11
                                                                   )
                                                                     ...
                                                                     (=>
                                                                      ...
                                                                      (=>
                                                                       ...
                                                                       (= (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                                                        ...
                                                                        ) (curve25519_dalek!specs.field_specs.field_sub.? (I yp@) (I neg_xp@))
                                                                 )))))))
                                                                 (=>
                                                                  (= (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                                                     (curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint./ProjectiveNielsPoint/Y_minus_X
                                                                  ...
                                                                  (=>
                                                                   (= pt_t2d_fe@ (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51
                                                                     (%Poly%array%. (Poly%array%. (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
                                                                        (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                                                          (curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint./ProjectiveNielsPoint/T2d
                                                                           (%Poly%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint. (Poly%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
                                                                   ...
                                                                   (=>
                                                                    (= tmp%12 (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
                                                                      (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                                                        (curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint./ProjectiveNielsPoint/T2d
                                                                         (%Poly%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint. (Poly%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
                                                                           pt!
                                                                    ...
                                                                    (and
                                                                     (=>
                                                                      %%location_label%%23
                                                                      (req%curve25519_dalek!lemmas.field_lemmas.negate_lemmas.lemma_neg_no_underflow. tmp%12)
                                                                     )
                                                                     (=>
                                                                      (ens%curve25519_dalek!lemmas.field_lemmas.negate_lemmas.lemma_neg_no_underflow. tmp%12)
                                                                      (=>
                                                                       (= tmp%13 (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
                                                                         (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                                                           (curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint./ProjectiveNielsPoint/T2d
                                                                            (%Poly%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint. (Poly%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
                                                                              pt!
                                                                       ...
                                                                       (and
                                                                        (=>
                                                                         %%location_label%%24
                                                                         (req%curve25519_dalek!lemmas.field_lemmas.negate_lemmas.proof_negate. tmp%13)
                                                                        )
                                                                        (=>
                                                                         (ens%curve25519_dalek!lemmas.field_lemmas.negate_lemmas.proof_negate. tmp%13)
                                                                         (and
                                                                          (=>
                                                                           %%location_label%%25
                                                                           (req%curve25519_dalek!lemmas.field_lemmas.negate_lemmas.lemma_neg. pt_t2d_fe@)
                                                                          )
                                                                          (=>
                                                                           (ens%curve25519_dalek!lemmas.field_lemmas.negate_lemmas.lemma_neg. pt_t2d_fe@)
                                                                           (=>
                                                                            (= pt_t2d_val@ (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                                                               (curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint./ProjectiveNielsPoint/T2d
                                                                                (%Poly%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint. (Poly%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
                                                                                  pt!
                                                                            ))))))
                                                                            (=>
                                                                             ...
                                                                             (=>
                                                                              (= tmp%14 (= pt_t2d_val@ (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                                                                                   (I 2) (I d@)
                                                                                  )
                                                                                 ) (I tp@)
                                                                              )))
                                                                              (and
                                                                               ...
                                                                               (=>
                                                                                tmp%14
                                                                                (=>
                                                                                 (= neg_t2d_fe@ (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51
                                                                                   (%Poly%array%. (Poly%array%. (curve25519_dalek!specs.field_specs_u64.spec_negate.? (
                                                                                       Poly%array%. (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
                                                                                        (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                                                                          (curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint./ProjectiveNielsPoint/T2d
                                                                                           (%Poly%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint. (Poly%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.
                                                                                 ...
                                                                                 (=>
                                                                                  (= neg_t2d_val@ (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                                                                     neg_t2d_fe@
                                                                                  )))
                                                                                  (=>
                                                                                   (= tmp%15 (= neg_t2d_val@ (curve25519_dalek!specs.field_specs.field_neg.? (I pt_t2d_val@))))
                                                                                   (and
                                                                                    (=>
                                                                                     %%location_label%%27
                                                                                     tmp%15
                                                                                    ...
                                                                                    (=>
                                                                                     ...
                                                                                     (and
                                                                                      (=>
                                                                                       ...
                                                                                       (=>
                                                                                        ...
                                                                                        (=>
                                                                                         ...
                                                                                         (=>
                                                                                          (= tmp%18 (curve25519_dalek!specs.field_specs.field_neg.? (I tp@)))
                                                                                          (=>
                                                                                           (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_comm.
                                                                                            tmp%17 tmp%18
                                                                                           )
                                                                                           (=>
                                                                                            ...
                                                                                            (=>
                                                                                             ...
                                                                                             (=>
                                                                                              %%location_label%%28
                                                                                              (= neg_t2d_val@ (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                                                                                                  (I 2) (I d@)
                                                                                                 )
                                                                                                ) (I neg_tp@)
                                                                                      ))))))))))
                                                                                      (=>
                                                                                       ...
                                                                                       (=>
                                                                                        (= tmp%20 (curve25519_dalek!specs.edwards_specs.projective_niels_corresponds_to_edwards.?
                                                                                          (Poly%curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint. neg@) (Poly%curve25519_dalek!edwards.EdwardsPoint.
                                                                                           neg_ep@
                                                                                        )))
                                                                                        (and
                                                                                         (=>
