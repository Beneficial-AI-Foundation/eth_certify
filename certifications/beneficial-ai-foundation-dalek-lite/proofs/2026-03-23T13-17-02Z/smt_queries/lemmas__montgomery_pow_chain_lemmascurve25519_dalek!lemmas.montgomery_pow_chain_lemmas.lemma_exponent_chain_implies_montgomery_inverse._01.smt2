...
;; curve25519-dalek/src/lemmas/montgomery_pow_chain_lemmas.rs:375:1: 380:2 (#0)
...
;; Function-Specs curve25519_dalek::lemmas::montgomery_pow_chain_lemmas::lemma_square_multiply_exponent_compose
(declare-fun req%curve25519_dalek!lemmas.montgomery_pow_chain_lemmas.lemma_square_multiply_exponent_compose.
...
(assert
 (forall ((self_val! Int) (y_old! Int) (x_val! Int) (y_new! Int) (ey! Int) (ex! Int)
   (n! Int) (R! Int) (L! Int)
  ) (!
   (= (req%curve25519_dalek!lemmas.montgomery_pow_chain_lemmas.lemma_square_multiply_exponent_compose.
     self_val! y_old! x_val! y_new! ey! ex! n! R! L!
    ) (and
     (=>
     ...
     (=>
      ...
      (= (EucMod (nClip (Mul y_new! (nClip (vstd!arithmetic.power.pow.? (I R!) (I (vstd!arithmetic.power2.pow2.?
              (I n!)
         )))))
        ) L!
       ) (EucMod (Mul (vstd!arithmetic.power.pow.? (I y_old!) (I (vstd!arithmetic.power2.pow2.?
            (I n!)
          ))
         ) x_val!
        ) L!
     ...
     (=>
      ...
      (= (EucMod (nClip (Mul y_old! (nClip (vstd!arithmetic.power.pow.? (I R!) (I (nClip (Sub ey!
               1
         ))))))
        ) L!
       ) (EucMod (nClip (vstd!arithmetic.power.pow.? (I self_val!) (I ey!))) L!)
     ))
     (=>
      %%global_location_label%%27
      (= (EucMod (nClip (Mul x_val! (nClip (vstd!arithmetic.power.pow.? (I R!) (I (nClip (Sub ex!
               1
         ))))))
        ) L!
       ) (EucMod (nClip (vstd!arithmetic.power.pow.? (I self_val!) (I ex!))) L!)
   ))))
   :pattern ((req%curve25519_dalek!lemmas.montgomery_pow_chain_lemmas.lemma_square_multiply_exponent_compose.
     self_val! y_old! x_val! y_new! ey! ex! n! R! L!
   ))
   :qid internal_req__curve25519_dalek!lemmas.montgomery_pow_chain_lemmas.lemma_square_multiply_exponent_compose._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.montgomery_pow_chain_lemmas.lemma_square_multiply_exponent_compose._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.montgomery_pow_chain_lemmas.lemma_square_multiply_exponent_compose.
 (Int Int Int Int Int Int Int Int Int) Bool
)
(assert
 (forall ((self_val! Int) (y_old! Int) (x_val! Int) (y_new! Int) (ey! Int) (ex! Int)
   ...
   (= (ens%curve25519_dalek!lemmas.montgomery_pow_chain_lemmas.lemma_square_multiply_exponent_compose.
     self_val! y_old! x_val! y_new! ey! ex! n! R! L!
    ) (let
     ((new_exp$ (nClip (Add (nClip (Mul (vstd!arithmetic.power2.pow2.? (I n!)) ey!)) ex!))))
     (= (EucMod (nClip (Mul y_new! (nClip (vstd!arithmetic.power.pow.? (I R!) (I (nClip (Sub new_exp$
              1
        ))))))
       ) L!
      ) (EucMod (nClip (vstd!arithmetic.power.pow.? (I self_val!) (I new_exp$))) L!)
   )))
   :pattern ((ens%curve25519_dalek!lemmas.montgomery_pow_chain_lemmas.lemma_square_multiply_exponent_compose.
     self_val! y_old! x_val! y_new! ey! ex! n! R! L!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.montgomery_pow_chain_lemmas.lemma_square_multiply_exponent_compose._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.montgomery_pow_chain_lemmas.lemma_square_multiply_exponent_compose._definition
)))

;; Function-Specs curve25519_dalek::lemmas::montgomery_pow_chain_lemmas::lemma_exponent_chain_implies_montgomery_inverse
(declare-fun req%curve25519_dalek!lemmas.montgomery_pow_chain_lemmas.lemma_exponent_chain_implies_montgomery_inverse.
 (Int Int Int Int) Bool
)
...
(assert
 (forall ((self_val! Int) (y_val! Int) (R! Int) (L! Int)) (!
   (= (req%curve25519_dalek!lemmas.montgomery_pow_chain_lemmas.lemma_exponent_chain_implies_montgomery_inverse.
     self_val! y_val! R! L!
    ) (and
     (=>
     ...
     (=>
      ...
      (curve25519_dalek!specs.primality_specs.is_prime.? (I L!))
     )
     (=>
     ...
     (=>
      ...
      (= (EucMod (nClip (Mul y_val! (nClip (vstd!arithmetic.power.pow.? (I R!) (I (nClip (Sub L!
               3
         ))))))
        ) L!
       ) (EucMod (nClip (vstd!arithmetic.power.pow.? (I self_val!) (I (nClip (Sub L! 2)))))
        L!
   )))))
   :pattern ((req%curve25519_dalek!lemmas.montgomery_pow_chain_lemmas.lemma_exponent_chain_implies_montgomery_inverse.
     self_val! y_val! R! L!
   ))
   :qid internal_req__curve25519_dalek!lemmas.montgomery_pow_chain_lemmas.lemma_exponent_chain_implies_montgomery_inverse._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.montgomery_pow_chain_lemmas.lemma_exponent_chain_implies_montgomery_inverse._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.montgomery_pow_chain_lemmas.lemma_exponent_chain_implies_montgomery_inverse.
 (Int Int Int Int) Bool
)
(assert
 (forall ((self_val! Int) (y_val! Int) (R! Int) (L! Int)) (!
   (= (ens%curve25519_dalek!lemmas.montgomery_pow_chain_lemmas.lemma_exponent_chain_implies_montgomery_inverse.
     self_val! y_val! R! L!
    ) (= (EucMod (nClip (Mul y_val! self_val!)) L!) (EucMod (nClip (Mul R! R!)) L!))
   )
   :pattern ((ens%curve25519_dalek!lemmas.montgomery_pow_chain_lemmas.lemma_exponent_chain_implies_montgomery_inverse.
     self_val! y_val! R! L!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.montgomery_pow_chain_lemmas.lemma_exponent_chain_implies_montgomery_inverse._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.montgomery_pow_chain_lemmas.lemma_exponent_chain_implies_montgomery_inverse._definition
)))

;; Function-Def curve25519_dalek::lemmas::montgomery_pow_chain_lemmas::lemma_exponent_chain_implies_montgomery_inverse
;; curve25519-dalek/src/lemmas/montgomery_pow_chain_lemmas.rs:375:1: 380:2 (#0)
(get-info :all-statistics)
(push)
 (declare-const self_val! Int)
 (declare-const y_val! Int)
 (declare-const R! Int)
 (declare-const L! Int)
 ...
 (declare-const L_int@ Int)
 (declare-const R_int@ Int)
 (declare-const s_int@ Int)
 (declare-const Lm3@ Int)
 (declare-const Lm1@ Int)
 (declare-const R_L3@ Int)
 (declare-const R_2@ Int)
 (declare-const s_L2@ Int)
 (declare-const ys@ Int)
 (declare-const ys_RL3@ Int)
 (declare-const RL3_R2@ Int)
 (assert
  fuel_defaults
 )
 (assert
     ...
     (=>
      ...
      (and
       (and
        (=>
         %%location_label%%0
         (req%vstd!arithmetic.div_mod.lemma_small_mod. self_val! L!)
        )
        (=>
         (ens%vstd!arithmetic.div_mod.lemma_small_mod. self_val! L!)
         (=>
          %%location_label%%1
          (not (= (EucMod self_val! L!) 0))
       )))
       (=>
        (not (= (EucMod self_val! L!) 0))
        (and
         (and
          ...
          (=>
           ...
           (=>
            %%location_label%%3
            (= (EucMod (nClip (vstd!arithmetic.power.pow.? (I s_int@) (I (nClip (Sub L! 1)))))
              L!
             ) 1
         ))))
         (=>
          ...
          (and
           (and
            ...
            (=>
             ...
             (=>
              %%location_label%%5
              (= (EucMod (nClip (vstd!arithmetic.power.pow.? (I R_int@) (I (nClip (Sub L! 1)))))
                L!
               ) 1
           ))))
           (=>
            ...
            (and
             (=>
              (= tmp%1 (nClip (Sub L! 2)))
              (=>
               (ens%vstd!arithmetic.power.lemma_pow_adds. s_int@ tmp%1 1)
               (=>
                (ens%vstd!arithmetic.power.lemma_pow1. s_int@)
                (=>
                 (= tmp%2 (nClip (Sub L! 2)))
                 (and
                  (=>
                   %%location_label%%6
                   (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow_nonnegative. s_int@
                    tmp%2
                  ))
                  (=>
                   (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow_nonnegative. s_int@
                    tmp%2
                   )
                   (=>
                    (= tmp%3 (nClip (Sub L! 1)))
                    (and
                     ...
                     (=>
                      ...
                      (=>
                       ...
                       (and
                        (and
                         (= (Mul (vstd!arithmetic.power.pow.? (I s_int@) (I (nClip (Sub L! 2)))) s_int@) (vstd!arithmetic.power.pow.?
                           (I s_int@) (I (nClip (Sub L! 1)))
                         ))
                         (>= (vstd!arithmetic.power.pow.? (I s_int@) (I (nClip (Sub L! 2)))) 0)
                        )
                        (>= (vstd!arithmetic.power.pow.? (I s_int@) (I (nClip (Sub L! 1)))) 0)
             )))))))))))
             (=>
              (and
               (and
                ...
                (=>
                 ...
                 (and
                  ...
                  (=>
                   ...
                   (and
                    (=>
                     (ens%vstd!arithmetic.power.lemma_pow_adds. R_int@ Lm3@ 2)
                     (=>
                      (= tmp%5 (nClip (Sub L! 3)))
                      (and
                       (=>
                        %%location_label%%10
                        (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow_nonnegative. R_int@
                         tmp%5
                       ))
                       (=>
                        (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow_nonnegative. R_int@
                         tmp%5
                        )
                        (=>
                         (= tmp%6 (nClip (Sub L! 1)))
                            ...
                            (=>
                             ...
                             (=>
                              ...
                              (and
                               (and
                                (and
                                 (= (Mul (vstd!arithmetic.power.pow.? (I R_int@) (I Lm3@)) (vstd!arithmetic.power.pow.?
                                    (I R_int@) (I 2)
                                   )
                                  ) (vstd!arithmetic.power.pow.? (I R_int@) (I Lm1@))
                                 )
                                 (>= (vstd!arithmetic.power.pow.? (I R_int@) (I Lm3@)) 0)
                                )
                                (>= (vstd!arithmetic.power.pow.? (I R_int@) (I Lm1@)) 0)
                               )
                               (>= (vstd!arithmetic.power.pow.? (I R_int@) (I 2)) 0)
                    )))))))))))
                    (=>
                     (and
                      (and
                     ...
                     (=>
                      (= R_L3@ (vstd!arithmetic.power.pow.? (I R_int@) (I (nClip (Sub L! 3)))))
                      (=>
                       (= R_2@ (vstd!arithmetic.power.pow.? (I R_int@) (I 2)))
                       (=>
                        (= s_L2@ (vstd!arithmetic.power.pow.? (I s_int@) (I (nClip (Sub L! 2)))))
                        (and
                         (=>
                          (ens%vstd!arithmetic.power.lemma_pow1. R_int@)
                          (=>
                           (ens%vstd!arithmetic.power.lemma_pow_adds. R_int@ 1 1)
                           (=>
                            %%location_label%%14
                            (= R_2@ (Mul R_int@ R_int@))
                         )))
                         (=>
                          ...
                          (and
                           (=>
                            (= tmp%7 (Mul y_val! R_L3@))
                            (and
                             (=>
                              %%location_label%%15
                              (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop. tmp%7 s_int@ L_int@)
                             )
                             (=>
                              (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop. tmp%7 s_int@ L_int@)
                              (and
                               (=>
                                %%location_label%%16
                                (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop. s_L2@ s_int@ L_int@)
                               )
                               (=>
                                (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop. s_L2@ s_int@ L_int@)
                                (=>
                                 (= tmp%8 (= (Mul s_L2@ s_int@) (vstd!arithmetic.power.pow.? (I s_int@) (I (nClip (Sub L!
                                       1
                                 ))))))
                                 (and
                                  (=>
                                  ...
                                  (=>
                                   ...
                                   (=>
                                    %%location_label%%18
                                    (= (EucMod (Mul (Mul y_val! R_L3@) s_int@) L_int@) 1)
                           )))))))))
                           (=>
                            (= (EucMod (Mul (Mul y_val! R_L3@) s_int@) L_int@) 1)
                            (and
                             (=>
                              (ens%vstd!arithmetic.mul.lemma_mul_is_associative. y_val! R_L3@ s_int@)
                              (=>
                               (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. R_L3@ s_int@)
                               (=>
                                (ens%vstd!arithmetic.mul.lemma_mul_is_associative. y_val! s_int@ R_L3@)
                                (=>
                                 %%location_label%%19
                                 (= (EucMod (Mul (Mul y_val! s_int@) R_L3@) L_int@) 1)
                             ))))
                             (=>
                              (= (EucMod (Mul (Mul y_val! s_int@) R_L3@) L_int@) 1)
                              (and
                               (=>
                                (= tmp%9 (= (Mul R_L3@ R_2@) (vstd!arithmetic.power.pow.? (I R_int@) (I (nClip (Sub L!
                                      1
                                ))))))
                                (and
                                 (=>
                               ...
                               (=>
                                ...
                                (=>
                                 ...
                                 (=>
                                  ...
                                  (and
                                   (=>
                                    (ens%vstd!arithmetic.mul.lemma_mul_is_associative. ys@ R_L3@ R_2@)
                                    (=>
                                     %%location_label%%22
                                     (= (Mul ys@ (Mul R_L3@ R_2@)) (Mul ys_RL3@ R_2@))
                                   ))
                                   (=>
                                    (= (Mul ys@ (Mul R_L3@ R_2@)) (Mul ys_RL3@ R_2@))
                                    (=>
                                     (= tmp%10 (= (EucMod ys_RL3@ L_int@) 1))
                                     (and
                                      (=>
                                       %%location_label%%23
                                       tmp%10
                                      ...
                                      (=>
                                       ...
                                       (and
                                        (and
                                         (=>
                                          %%location_label%%24
                                          (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop. ys_RL3@ R_2@ L_int@)
                                         )
                                         (=>
                                          (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop. ys_RL3@ R_2@ L_int@)
                                          (and
                                           (=>
                                            (= tmp%11 (EucMod R_2@ L_int@))
                                            (=>
                                             (ens%vstd!arithmetic.mul.lemma_mul_basics. tmp%11)
                                             (=>
                                              %%location_label%%25
                                              (= (Mul 1 (EucMod R_2@ L_int@)) (EucMod R_2@ L_int@))
                                           )))
                                           (=>
                                            (= (Mul 1 (EucMod R_2@ L_int@)) (EucMod R_2@ L_int@))
                                            (and
                                             (=>
                                              %%location_label%%26
                                              (req%vstd!arithmetic.div_mod.lemma_mod_twice. R_2@ L_int@)
                                             )
                                             (=>
                                              (ens%vstd!arithmetic.div_mod.lemma_mod_twice. R_2@ L_int@)
                                              (=>
                                               %%location_label%%27
                                               (= (EucMod (Mul ys@ (Mul R_L3@ R_2@)) L_int@) (EucMod R_2@ L_int@))
                                        )))))))
                                        (=>
                                         (= (EucMod (Mul ys@ (Mul R_L3@ R_2@)) L_int@) (EucMod R_2@ L_int@))
                                         (=>
                                          ...
                                          (and
                                           (=>
                                            (= tmp%12 (= (Mul R_L3@ R_2@) (vstd!arithmetic.power.pow.? (I R_int@) (I Lm1@))))
                                            (and
                                             (=>
                                              %%location_label%%28
                                              tmp%12
                                           ...
                                           (=>
                                            ...
                                            (and
                                             (and
                                              (=>
                                               %%location_label%%30
                                               (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop. ys@ RL3_R2@ L_int@)
                                              )
                                              (=>
                                               (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop. ys@ RL3_R2@ L_int@)
                                               (and
                                                (=>
                                                 (= tmp%13 (EucMod ys@ L_int@))
                                                 (=>
                                                  (ens%vstd!arithmetic.mul.lemma_mul_basics. tmp%13)
                                                  (=>
                                                   %%location_label%%31
                                                   (= (Mul (EucMod ys@ L_int@) 1) (EucMod ys@ L_int@))
                                                )))
                                                (=>
                                                 (= (Mul (EucMod ys@ L_int@) 1) (EucMod ys@ L_int@))
                                                 (and
                                                  (=>
                                                   %%location_label%%32
                                                   (req%vstd!arithmetic.div_mod.lemma_mod_twice. ys@ L_int@)
                                                  )
                                                  (=>
                                                   (ens%vstd!arithmetic.div_mod.lemma_mod_twice. ys@ L_int@)
                                                   (=>
                                                    %%location_label%%33
                                                    (= (EucMod (Mul ys@ (Mul R_L3@ R_2@)) L_int@) (EucMod ys@ L_int@))
                                             )))))))
                                             (=>
                                              (= (EucMod (Mul ys@ (Mul R_L3@ R_2@)) L_int@) (EucMod ys@ L_int@))
                                              (=>
                                               (= tmp%14 (= (EucMod ys@ L_int@) (EucMod R_2@ L_int@)))
                                               (and
                                                (=>
                                                 %%location_label%%34
                                                 tmp%14
                                                ...
                                                (=>
                                                 tmp%14
                                                 (=>
                                                  (= tmp%15 (= (EucMod (nClip (Mul y_val! self_val!)) L!) (EucMod (nClip (Mul R! R!))
                                                     L!
                                                  )))
                                                  (and
                                                   (=>
