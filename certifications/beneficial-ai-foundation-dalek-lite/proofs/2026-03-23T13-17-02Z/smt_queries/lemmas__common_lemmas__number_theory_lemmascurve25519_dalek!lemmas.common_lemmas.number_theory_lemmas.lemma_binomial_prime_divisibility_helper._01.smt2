...
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:488:7: 488:66 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::number_theory_lemmas::lemma_binomial_prime_divisibility_helper
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:488:7: 488:66 (#0)
 ...
 (assert
  (not (and
    ...
    (=>
     ...
     (=>
      (= prod@ (nClip (Mul k! (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial.?
          (I p!) (I k!)
      ))))
      (=>
       (= tmp%1 (= prod@ (nClip (Mul p! (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial.?
            (I (nClip (Sub p! 1))) (I (nClip (Sub k! 1)))
       )))))
       (and
        (=>
         %%location_label%%1
        ...
        (=>
         ...
         (and
          (=>
           (= tmp%2 (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial.? (I (
               nClip (Sub p! 1)
              )
             ) (I (nClip (Sub k! 1)))
           ))
           (and
            (=>
             %%location_label%%2
             (req%vstd!arithmetic.div_mod.lemma_mod_multiples_basic. tmp%2 p!)
            )
            (=>
             (ens%vstd!arithmetic.div_mod.lemma_mod_multiples_basic. tmp%2 p!)
             (=>
              %%location_label%%3
              (= (EucMod prod@ p!) 0)
          ))))
          (=>
           ...
           (and
            (and
             (=>
              %%location_label%%4
              (req%vstd!arithmetic.div_mod.lemma_small_mod. k! p!)
             )
             (=>
              (ens%vstd!arithmetic.div_mod.lemma_small_mod. k! p!)
              (=>
               %%location_label%%5
               (not (= (EucMod k! p!) 0))
            )))
            (=>
             ...
             (or
              (and
               (=>
                (not (= (EucMod (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial.?
                    (I p!) (I k!)
                   ) p!
                  ) 0
                ))
                (=>
                 (= tmp%3 (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial.? (I p!)
                   (I k!)
                 ))
                 (and
                  (=>
               ...
               (=>
                (not (not (= (EucMod (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial.?
                     (I p!) (I k!)
                    ) p!
                   ) 0
                )))
