...
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:1197:1: 1197:67 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::number_theory_lemmas::lemma_mod_sub_eq_implies_zero
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:1197:1: 1197:67 (#0)
...
(push)
 ...
 (assert
  (not (and
    ...
    (=>
     (ens%vstd!arithmetic.div_mod.lemma_sub_mod_noop. x! y! m!)
     (and
      (=>
       %%location_label%%1
       (req%vstd!arithmetic.div_mod.lemma_small_mod. 0 (nClip m!))
      )
      (=>
       (ens%vstd!arithmetic.div_mod.lemma_small_mod. 0 (nClip m!))
       (=>
        %%location_label%%2
        (= (EucMod (Sub x! y!) m!) 0)
 )))))))
