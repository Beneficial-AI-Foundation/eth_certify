...
;; curve25519-dalek/src/lemmas/edwards_lemmas/mul_base_lemmas.rs:1084:1: 1090:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::mul_base_lemmas::lemma_basepoint_table_select
;; curve25519-dalek/src/lemmas/edwards_lemmas/mul_base_lemmas.rs:1084:1: 1090:2 (#0)
(get-info :all-statistics)
(push)
 (declare-const table! curve25519_dalek!edwards.EdwardsBasepointTable.)
 (declare-const a! vstd!seq.Seq<i8.>.)
 (declare-const i! Int)
 (declare-const selected! curve25519_dalek!backend.serial.curve_models.AffineNielsPoint.)
 (declare-const B! tuple%2.)
 (declare-const tmp%1 Bool)
 (declare-const tmp%2 %%Function%%)
 (declare-const tmp%3 Int)
 (declare-const table_idx@ Int)
 (declare-const table_base@ tuple%2.)
 (assert
  fuel_defaults
 )
 (assert
  (has_type (Poly%curve25519_dalek!edwards.EdwardsBasepointTable. table!) TYPE%curve25519_dalek!edwards.EdwardsBasepointTable.)
 )
 (assert
  (has_type (Poly%curve25519_dalek!backend.serial.curve_models.AffineNielsPoint. selected!)
   TYPE%curve25519_dalek!backend.serial.curve_models.AffineNielsPoint.
 ))
 (assert
 ...
 (assert
  (not (=>
    (= table_idx@ (EucDiv i! 2))
    (=>
     (= table_base@ (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2.
        B!
       ) (I (curve25519_dalek!specs.edwards_specs.pow256.? (I (nClip table_idx@))))
     ))
     (=>
      (= tmp%1 (let
        ((tmp%%$ table_idx@))
       ...
       (=>
        ...
        (and
         ...
         (=>
          ...
          (=>
           (= tmp%2 (curve25519_dalek!window.LookupTable./LookupTable/0 (%Poly%curve25519_dalek!window.LookupTable.
              (vstd!seq.Seq.index.? $ (TYPE%curve25519_dalek!window.LookupTable. $ TYPE%curve25519_dalek!backend.serial.curve_models.AffineNielsPoint.)
               (vstd!view.View.view.? $ (ARRAY $ (TYPE%curve25519_dalek!window.LookupTable. $ TYPE%curve25519_dalek!backend.serial.curve_models.AffineNielsPoint.)
                 $ (CONST_INT 32)
                ) (Poly%array%. (curve25519_dalek!edwards.EdwardsBasepointTable./EdwardsBasepointTable/0
           ...
           (=>
            (= tmp%3 (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. a!) (I i!))))
            (and
             (=>
              %%location_label%%2
              (req%curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.lemma_select_is_signed_scalar_mul.
               tmp%2 tmp%3 selected! table_base@
             ))
             (=>
              (ens%curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.lemma_select_is_signed_scalar_mul.
               tmp%2 tmp%3 selected! table_base@
