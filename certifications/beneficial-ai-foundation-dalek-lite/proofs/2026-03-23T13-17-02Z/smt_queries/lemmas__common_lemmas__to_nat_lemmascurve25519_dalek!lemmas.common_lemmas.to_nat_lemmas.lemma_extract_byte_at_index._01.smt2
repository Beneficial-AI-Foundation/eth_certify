...
;; curve25519-dalek/src/lemmas/common_lemmas/to_nat_lemmas.rs:469:1: 469:67 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::to_nat_lemmas::lemma_extract_byte_at_index
;; curve25519-dalek/src/lemmas/common_lemmas/to_nat_lemmas.rs:469:1: 469:67 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= goal@ (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT
           8
          ) $ (CONST_INT 32)
         ) (Poly%array%. bytes!)
        ) (I i!)
      ...
      (and
       (=>
        ...
        (=>
         (= tmp%2 (nClip (Mul i! 8)))
         (=>
          (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_div_mod. tmp%1 tmp%2
           8
          )
          (=>
           %%location_label%%0
           (= (EucMod (EucDiv (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. bytes!))
            ...
            ) (EucDiv (EucMod (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. bytes!))
       ...
       (=>
        ...
        (and
         (=>
          (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add. 8 1 i!)
          (=>
           %%location_label%%1
           (= (nClip (Add 8 (nClip (Mul i! 8)))) (nClip (Mul (nClip (Add i! 1)) 8)))
         ))
         (=>
          (= (nClip (Add 8 (nClip (Mul i! 8)))) (nClip (Mul (nClip (Add i! 1)) 8)))
          (and
            ...
            (and
             ...
             (=>
              ...
              (=>
               %%location_label%%3
               (= (EucMod (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. bytes!))
                 (vstd!arithmetic.power2.pow2.? (I (nClip (Mul (nClip (Add i! 1)) 8))))
                ) (curve25519_dalek!specs.core_specs.bytes_as_nat_prefix.? (vstd!view.View.view.? $
                  (ARRAY $ (UINT 8) $ (CONST_INT 32)) (Poly%array%. bytes!)
                 ) (I (nClip (Add i! 1)))
           ))))))
