...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:1569:1: 1569:77 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_field_curve_point_implies_valid_y
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:1569:1: 1569:77 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= u@ (curve25519_dalek!specs.field_specs.field_sub.? (I (curve25519_dalek!specs.field_specs.field_square.?
        (I y!)
       )
      ) (I 1)
    ))
    (=>
     ...
     (and
      ...
      (=>
       ...
       (=>
        (= tmp%1 (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_square.?
             (I x!)
            )
           ) (I v@)
          ) u@
               ...
               (and
                (=>
                 ...
                 (=>
                  ...
                  (=>
                   (= tmp%2 (nClip (Add (curve25519_dalek!specs.field_specs.field_mul.? (I d!) (I (curve25519_dalek!specs.field_specs.field_square.?
                         (I y!)
                       ))
                      ) 1
                   )))
                     ...
                     (=>
                      ...
                      (=>
                       ...
                       (and
                        (=>
                         %%location_label%%3
                         (req%vstd!arithmetic.div_mod.lemma_small_mod. v@ tmp%4)
                        )
                        (=>
                         (ens%vstd!arithmetic.div_mod.lemma_small_mod. v@ tmp%4)
                         (=>
                          (= tmp%5 (curve25519_dalek!specs.field_specs.field_square.? (I x!)))
                          (and
                           (=>
                            %%location_label%%4
                            (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_zero_right.
