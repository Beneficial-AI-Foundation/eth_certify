...
;; curve25519-dalek/src/lemmas/common_lemmas/to_nat_lemmas.rs:69:13: 69:19 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::to_nat_lemmas::lemma_bytes_as_nat_prefix_bounded
;; curve25519-dalek/src/lemmas/common_lemmas/to_nat_lemmas.rs:69:13: 69:19 (#0)
  ...
  (not (=>
    ...
    (=>
     ...
     (=>
      ...
      (=>
       %%location_label%%0
       (< (nClip (Add prev@ (nClip (Mul byte_val@ p1@)))) (nClip (Mul p1@ p2@)))
 ))))))
 (get-info :version)
