...
;; curve25519-dalek/src/lemmas/field_lemmas/to_bytes_reduction_lemmas.rs:205:7: 205:55 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::to_bytes_reduction_lemmas::lemma_mul_upper_bound
;; curve25519-dalek/src/lemmas/field_lemmas/to_bytes_reduction_lemmas.rs:205:7: 205:55 (#0)
    ...
    (and
     ...
     (=>
      ...
      (and
       (=>
        %%location_label%%0
        (req%vstd!arithmetic.mul.lemma_mul_inequality. x! b! a!)
       )
       (=>
        (ens%vstd!arithmetic.mul.lemma_mul_inequality. x! b! a!)
        %%switch_label%%0
    ))))
    (and
     (not %%switch_label%%0)
