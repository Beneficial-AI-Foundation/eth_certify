...
;; curve25519-dalek/src/backend/mod.rs:346:1: 351:54 (#0)
...
;; Function-Def curve25519_dalek::backend::straus_optional_multiscalar_mul_verus
;; curve25519-dalek/src/backend/mod.rs:346:1: 351:54 (#0)
...
(push)
 ...
 (assert
  (forall ((i$ Poly)) (!
    ...
    :qid user_curve25519_dalek__backend__straus_optional_multiscalar_mul_verus_46
    :skolemid skolem_user_curve25519_dalek__backend__straus_optional_multiscalar_mul_verus_46
 )))
