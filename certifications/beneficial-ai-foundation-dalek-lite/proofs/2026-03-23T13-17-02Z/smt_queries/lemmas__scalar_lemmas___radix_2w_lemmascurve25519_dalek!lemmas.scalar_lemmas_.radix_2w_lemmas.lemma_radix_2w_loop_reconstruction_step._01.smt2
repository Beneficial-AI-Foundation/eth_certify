...
;; curve25519-dalek/src/lemmas/scalar_lemmas_/radix_2w_lemmas.rs:1224:1: 1232:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::scalar_lemmas_::radix_2w_lemmas::lemma_radix_2w_loop_reconstruction_step
;; curve25519-dalek/src/lemmas/scalar_lemmas_/radix_2w_lemmas.rs:1224:1: 1232:2 (#0)
(get-info :all-statistics)
(push)
 (declare-const digits_new! vstd!seq.Seq<i8.>.)
 (declare-const i! Int)
 (declare-const w! Int)
 ...
 (declare-const digits_old@ vstd!seq.Seq<i8.>.)
 (declare-const pw@ Int)
 (declare-const pwi@ Int)
 (declare-const pwi1@ Int)
 (declare-const tail@ vstd!seq.Seq<i8.>.)
 (declare-const recon_old@ Int)
 (declare-const nc@ Int)
 (declare-const nc_pw@ Int)
 (declare-const recon_new@ Int)
 (assert
  fuel_defaults
 )
 (assert
 ...
 (assert
  (not (=>
    (= digit_val@ (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits_new!)
       (I i!)
    )))
    (=>
     (= coef_int@ (Add old_carry! extracted!))
     (=>
      (= digits_old@ (%Poly%vstd!seq.Seq<i8.>. (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
          digits_new!
         ) (I 0) (I i!)
      )))
      (=>
       ...
       (=>
        (= pwi@ (vstd!arithmetic.power2.pow2.? (I (nClip (Mul w! i!)))))
        (=>
         (= pwi1@ (vstd!arithmetic.power2.pow2.? (I (nClip (Mul w! (Add i! 1))))))
         (and
          (and
           (=>
            %%location_label%%0
           ...
           (=>
            ...
            (=>
             ...
             (= (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.? (Poly%vstd!seq.Seq<i8.>.
               ...
               ) (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul w! i!)))) (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.?
                 (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits_new!) (I i!) (
                   I (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits_new!))
                  )
                 ) (I w!)
          )))))))
          (=>
           ...
           (=>
            (= tail@ (%Poly%vstd!seq.Seq<i8.>. (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
                digits_new!
               ) (I i!) (I (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits_new!)))
            )))
            (and
             (=>
              (= tmp%1 (= (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.? (vstd!seq.Seq.subrange.?
              ...
              (and
               ...
               (=>
                tmp%1
                (=>
                 (ens%vstd!arithmetic.mul.lemma_mul_basics. pw@)
                 (=>
                  %%location_label%%3
                  (= (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.? (Poly%vstd!seq.Seq<i8.>.
                     tail@
             ...
             (=>
              ...
              (=>
               (= recon_old@ (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.? (Poly%vstd!seq.Seq<i8.>.
                  digits_old@
                 ) (I w!)
               ))
               (and
                (and
                 (=>
                  (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add. w! i! 1)
                  (=>
                   %%location_label%%4
                   (= (Add w! (Mul w! i!)) (Mul w! (Add i! 1)))
                 ))
                 (=>
                  (= (Add w! (Mul w! i!)) (Mul w! (Add i! 1)))
                  (=>
                   (= tmp%2 (nClip (Mul w! i!)))
                   (=>
                    (ens%vstd!arithmetic.power2.lemma_pow2_adds. w! tmp%2)
                    (=>
                     %%location_label%%5
                     (= (Mul pw@ pwi@) pwi1@)
                )))))
                (=>
                 ...
                 (=>
                  ...
                  (=>
                   (= nc_pw@ (Mul nc@ pw@))
                   (=>
                    (= tmp%3 (= digit_val@ (Sub coef_int@ nc_pw@)))
                    (and
                     (=>
                      %%location_label%%6
                      tmp%3
                     ...
                     (=>
                      ...
                      (and
                       (=>
                        (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub_other_way. pwi@ coef_int@ nc_pw@)
                        (=>
                         (ens%vstd!arithmetic.mul.lemma_mul_is_associative. nc@ pw@ pwi@)
                         (=>
                          %%location_label%%7
                          (= (Add (Mul digit_val@ pwi@) (Mul nc@ pwi1@)) (Mul coef_int@ pwi@))
                       )))
                       (=>
                        (= (Add (Mul digit_val@ pwi@) (Mul nc@ pwi1@)) (Mul coef_int@ pwi@))
                        (and
                         (and
                          (=>
                           (= tmp%4 (nClip (Mul w! i!)))
                           (=>
                            (ens%vstd!arithmetic.power2.lemma_pow2_pos. tmp%4)
                            (=>
                             %%location_label%%8
                             (> pwi@ 0)
                          )))
                           ...
                           (and
                            ...
                            (=>
                             ...
                             (and
                              (=>
                               %%location_label%%10
                               (req%vstd!arithmetic.div_mod.lemma_mod_breakdown. scalar_val! pwi@ pw@)
                              )
                              (=>
                               (ens%vstd!arithmetic.div_mod.lemma_mod_breakdown. scalar_val! pwi@ pw@)
                               (=>
                                %%location_label%%11
                                (= (EucMod scalar_val! (Mul pwi@ pw@)) (Add (Mul pwi@ (EucMod (EucDiv scalar_val! pwi@)
                                    pw@
                                   )
                                  ) (EucMod scalar_val! pwi@)
                         )))))))))
                         (=>
                          (= (EucMod scalar_val! (Mul pwi@ pw@)) (Add (Mul pwi@ (EucMod (EucDiv scalar_val! pwi@)
                              pw@
                          ...
                          (=>
                           (= tmp%5 (= (EucDiv scalar_val! pwi@) (EucDiv scalar_val! (vstd!arithmetic.power2.pow2.?
                               (I (nClip (Mul w! i!)))
                           ))))
                           (and
                            (=>
                            ...
                            (=>
                             ...
                             (and
                              (=>
                               (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. pwi@ extracted!)
                               (=>
                                %%location_label%%13
                                (= (Mul pwi@ extracted!) (Mul extracted! pwi@))
                              ))
                              (=>
                               (= (Mul pwi@ extracted!) (Mul extracted! pwi@))
                               (and
                                (=>
                                 (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. pwi@ old_carry!
                                  extracted!
                                 )
                                 (=>
                                  %%location_label%%14
                                  (= (Mul (Add old_carry! extracted!) pwi@) (Add (Mul old_carry! pwi@) (Mul extracted!
                                     pwi@
                                )))))
                                (=>
                                 (= (Mul (Add old_carry! extracted!) pwi@) (Add (Mul old_carry! pwi@) (Mul extracted!
                                 ...
                                 (=>
                                  (= tmp%6 (= (Add (Add recon_old@ (Mul old_carry! pwi@)) (Mul extracted! pwi@)) (Add
                                     (EucMod scalar_val! pwi@) (Mul extracted! pwi@)
                                  )))
                                  (and
                                   (=>
                                    %%location_label%%15
                                   ...
                                   (=>
                                    tmp%6
                                    (=>
                                     (= recon_new@ (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.? (Poly%vstd!seq.Seq<i8.>.
                                        digits_new!
                                       ) (I w!)
                                     ))
                                     (and
                                      (=>
                                       (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. digit_val@ pwi@)
                                       (=>
                                        %%location_label%%16
                                        (= (Mul digit_val@ pwi@) (Mul pwi@ digit_val@))
                                      ))
                                      (=>
                                       (= (Mul digit_val@ pwi@) (Mul pwi@ digit_val@))
                                       (=>
                                        (= tmp%7 (= (Add recon_new@ (Mul nc@ pwi1@)) (Add (EucMod scalar_val! pwi@) (Mul extracted!
                                            pwi@
                                        ))))
                                        (and
                                         (=>
                                         ...
                                         (=>
                                          tmp%7
                                          (=>
                                           (= tmp%8 (= (EucMod scalar_val! (Mul pwi@ pw@)) (Add (EucMod scalar_val! pwi@) (Mul extracted!
                                               pwi@
                                           ))))
                                           (and
                                            (=>
                                            ...
                                            (=>
                                             ...
                                             (and
                                              (=>
                                               (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. pwi@ pw@)
                                               (=>
                                                %%location_label%%19
                                                (= (Mul pwi@ pw@) pwi1@)
                                              ))
                                              (=>
                                               (= (Mul pwi@ pw@) pwi1@)
                                               (=>
                                                (= tmp%9 (= (EucMod scalar_val! pwi1@) (Add (EucMod scalar_val! pwi@) (Mul extracted!
                                                    pwi@
                                                ))))
                                                (and
                                                 (=>
