...
;; curve25519-dalek/src/lemmas/field_lemmas/invert_lemmas.rs:298:1: 304:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::invert_lemmas::lemma_invert_is_multiplicative_inverse
;; curve25519-dalek/src/lemmas/field_lemmas/invert_lemmas.rs:298:1: 304:2 (#0)
...
(push)
 ...
 (declare-const x@ Int)
 (declare-const pow_exp_t20@ Int)
 (declare-const pow_exp_t3@ Int)
 (assert
  fuel_defaults
 )
 (assert
 ...
 (assert
  (not (=>
    ...
    (=>
     (= pow_exp_t20@ (EucMod (nClip (vstd!arithmetic.power.pow.? (I x@) (I (nClip (Sub (vstd!arithmetic.power2.pow2.?
             (I 255)
            ) 32
        ))))
       ) (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
     ...
     (=>
      (= pow_exp_t3@ (EucMod (nClip (vstd!arithmetic.power.pow.? (I x@) (I 11))) (curve25519_dalek!specs.field_specs_u64.p.?
         (I 0)
      )))
      (and
       (and
         ...
         (=>
          ...
          (=>
           ...
           (= (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
            ...
            ) (EucMod (nClip (Mul pow_exp_t20@ pow_exp_t3@)) (curve25519_dalek!specs.field_specs_u64.p.?
              (I 0)
        ))))))
        (=>
         (= (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
           ...
           (=>
            ...
            (and
             ...
             (=>
              ...
              (=>
               %%location_label%%4
               (> (Sub (vstd!arithmetic.power2.pow2.? (I 255)) 32) 0)
          )))))
          (=>
           (> (Sub (vstd!arithmetic.power2.pow2.? (I 255)) 32) 0)
           (and
            (=>
             (= tmp%1 (nClip (Sub (vstd!arithmetic.power2.pow2.? (I 255)) 32)))
             (=>
               ...
               (=>
                ...
                (=>
                 ...
                 (= (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                  ...
                  ) (EucMod (nClip (vstd!arithmetic.power.pow.? (I x@) (I (nClip (Add (Sub (vstd!arithmetic.power2.pow2.?
                          (I 255)
                         ) 32
                        ) 11
                    ))))
            ...
            (=>
             ...
             (=>
              (= tmp%3 (= (nClip (Add (Sub (vstd!arithmetic.power2.pow2.? (I 255)) 32) 11)) (nClip
                 (Sub (vstd!arithmetic.power2.pow2.? (I 255)) 21)
              )))
              (and
               (=>
                %%location_label%%7
               ...
               (=>
                ...
                (=>
                 ...
                 (= (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                  ...
                  ) (EucMod (nClip (vstd!arithmetic.power.pow.? (I x@) (I (nClip (Sub (vstd!arithmetic.power2.pow2.?
                         (I 255)
                        ) 21
                    ))))
                   ) (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
              ...
              (and
               (and
                (and
                 ...
                 (=>
                  (> (curve25519_dalek!specs.field_specs_u64.p.? (I 0)) 0)
                  (=>
                   (= tmp%4 (curve25519_dalek!specs.field_specs.fe51_as_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                      self_fe!
                   )))
                   (=>
                 ...
                 (and
                  (=>
                   ...
                   (and
                    (=>
                     %%location_label%%16
                     (req%vstd!arithmetic.div_mod.lemma_small_mod. x@ tmp%6)
                    )
                    (=>
                     (ens%vstd!arithmetic.div_mod.lemma_small_mod. x@ tmp%6)
                     (=>
                      %%location_label%%17
               ...
               (=>
                ...
                (and
                 ...
                 (=>
                  (ens%curve25519_dalek!specs.field_specs.lemma_fermat_for_p. x@)
                  (=>
                   %%location_label%%20
                   (= (EucMod (nClip (vstd!arithmetic.power.pow.? (I x@) (I (nClip (Sub (curve25519_dalek!specs.field_specs_u64.p.?
                           (I 0)
