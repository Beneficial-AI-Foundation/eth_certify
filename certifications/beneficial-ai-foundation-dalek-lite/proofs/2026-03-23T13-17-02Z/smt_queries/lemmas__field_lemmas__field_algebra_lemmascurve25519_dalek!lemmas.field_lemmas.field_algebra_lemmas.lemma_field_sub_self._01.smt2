...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:2164:1: 2164:42 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_field_sub_self
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:2164:1: 2164:42 (#0)
  ...
  (not (=>
    ...
    (=>
     ...
     (=>
      (= x_mod@ (EucMod x! p@))
      (=>
       (= tmp%1 (= (curve25519_dalek!specs.field_specs.field_sub.? (I x!) (I x!)) (EucMod (
           nClip (Sub (nClip (Add x_mod@ p@)) x_mod@)
          ) p@
       )))
       (and
        (=>
        ...
        (=>
         ...
         (and
          (=>
           (= tmp%2 (= (nClip (Add x_mod@ p@)) (nClip (Add p@ x_mod@))))
           (and
            (=>
             %%location_label%%1
             tmp%2
            ...
            (=>
             tmp%2
             (=>
              (= tmp%3 (= (Sub (nClip (Add p@ x_mod@)) x_mod@) p@))
              (and
               (=>
                %%location_label%%2
                tmp%3
