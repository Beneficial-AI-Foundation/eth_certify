...
;; curve25519-dalek/src/lemmas/edwards_lemmas/step1_lemmas.rs:46:1: 46:63 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::step1_lemmas::lemma_sqrt_ratio_implies_on_curve
;; curve25519-dalek/src/lemmas/edwards_lemmas/step1_lemmas.rs:46:1: 46:63 (#0)
         ...
         (=>
          ...
          (=>
           ...
           (=>
            ...
            (=>
             (= x2_dy2@ (curve25519_dalek!specs.field_specs.field_mul.? (I x2@) (I dy2@)))
             (=>
              (ens%curve25519_dalek!specs.field_specs_u64.p_gt_2. 0)
              (and
               (=>
                (= tmp%1 (= (curve25519_dalek!specs.field_specs.field_mul.? (I x2@) (I v@)) u@))
                (and
                 (=>
                  %%location_label%%0
                  tmp%1
                  ...
                  (and
                   (=>
                    ...
                    (and
                     (=>
                      %%location_label%%1
                      (req%vstd!arithmetic.div_mod.lemma_small_mod. x2@ p@)
                     )
                     (=>
                      (ens%vstd!arithmetic.div_mod.lemma_small_mod. x2@ p@)
                      (=>
                       %%location_label%%2
                       (= (curve25519_dalek!specs.field_specs.field_add.? (I x2_dy2@) (I x2@)) u@)
                   ))))
                   (=>
                    (= (curve25519_dalek!specs.field_specs.field_add.? (I x2_dy2@) (I x2@)) u@)
                    (and
                     (=>
                      (= tmp%2 (nClip (Mul d@ y2@)))
                      (and
                       (=>
                        %%location_label%%3
                        (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. x2@ tmp%2 p@)
                       )
                       (=>
                        (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. x2@ tmp%2 p@)
                        (=>
                         (= tmp%3 (nClip (Mul x2@ y2@)))
                         (and
                          (=>
                           %%location_label%%4
                           (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. d@ tmp%3 p@)
                          )
                          (=>
                           (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. d@ tmp%3 p@)
                           (and
                            (=>
                             (ens%vstd!arithmetic.mul.lemma_mul_is_associative. x2@ d@ y2@)
                             (=>
                              (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. x2@ d@)
                              (=>
                               (ens%vstd!arithmetic.mul.lemma_mul_is_associative. d@ x2@ y2@)
                               (=>
                                %%location_label%%5
                                (= (Mul x2@ (Mul d@ y2@)) (Mul d@ (Mul x2@ y2@)))
                            ))))
                            (=>
                             (= (Mul x2@ (Mul d@ y2@)) (Mul d@ (Mul x2@ y2@)))
                             (=>
                     ...
                     (=>
                      ...
                      (and
                       (=>
                        (= tmp%4 (= (curve25519_dalek!specs.field_specs.field_add.? (I d_x2y2@) (I x2@)) u@))
                        (and
                         (=>
                          %%location_label%%7
                          tmp%4
                         ...
                         (=>
                          ...
                          (and
                           (=>
                            (= tmp%5 (nClip (Mul d@ x2y2@)))
                            (and
                             (=>
                              %%location_label%%8
                              (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%5 p@)
                             )
                             (=>
                              (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%5 p@)
                              (=>
                               (= tmp%6 (nClip (Mul x! x!)))
                               (and
                                (=>
                                 %%location_label%%9
                                 (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%6 p@)
                                )
                                (=>
                                 (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%6 p@)
                                 (=>
                                  (= tmp%7 (nClip (Mul y! y!)))
                                  (and
                                   (=>
                                    %%location_label%%10
                                    (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%7 p@)
                                   )
                                   (=>
                                    (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%7 p@)
                                    (=>
                                     %%location_label%%11
                                     (and
                                      (and
                           ...
                           (=>
                            ...
                            (and
                             ...
                             (=>
                              ...
                              (=>
                               %%location_label%%13
                               (= (curve25519_dalek!specs.field_specs.field_add.? (I d_x2y2@) (I 1)) (curve25519_dalek!specs.field_specs.field_sub.?
                                 (I y2@) (I x2@)
                       ))))))))))
                       (=>
                        (= (curve25519_dalek!specs.field_specs.field_add.? (I d_x2y2@) (I 1)) (curve25519_dalek!specs.field_specs.field_sub.?
                        ...
                        (and
                         (and
                          (=>
                           %%location_label%%14
                           (req%vstd!arithmetic.div_mod.lemma_add_mod_noop. 1 d_x2y2@ p@)
                          )
                          (=>
                           (ens%vstd!arithmetic.div_mod.lemma_add_mod_noop. 1 d_x2y2@ p@)
                           (and
                            (=>
                             %%location_label%%15
                             (req%vstd!arithmetic.div_mod.lemma_add_mod_noop. d_x2y2@ 1 p@)
                            )
                            (=>
                             (ens%vstd!arithmetic.div_mod.lemma_add_mod_noop. d_x2y2@ 1 p@)
                             (=>
                              %%location_label%%16
                              (= (curve25519_dalek!specs.field_specs.field_add.? (I 1) (I d_x2y2@)) (curve25519_dalek!specs.field_specs.field_sub.?
                                (I y2@) (I x2@)
                         )))))))
                         (=>
                          (= (curve25519_dalek!specs.field_specs.field_add.? (I 1) (I d_x2y2@)) (curve25519_dalek!specs.field_specs.field_sub.?
