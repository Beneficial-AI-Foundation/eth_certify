...
;; curve25519-dalek/src/lemmas/scalar_lemmas_/radix_2w_lemmas.rs:1043:1: 1049:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::scalar_lemmas_::radix_2w_lemmas::lemma_last_iter_carry_zero
;; curve25519-dalek/src/lemmas/scalar_lemmas_/radix_2w_lemmas.rs:1043:1: 1049:2 (#0)
    ...
    (and
     (=>
      ...
      (and
       (=>
        %%location_label%%0
        (req%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u64_shift_is_pow2. w!)
       )
       (=>
        (ens%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u64_shift_is_pow2. w!)
        (=>
         %%location_label%%1
         (= (vstd!arithmetic.power2.pow2.? (I w!)) (uClip 64 (bitshl (I 1) (I (uClip 64 w!)))))
     ))))
     (=>
      (= (vstd!arithmetic.power2.pow2.? (I w!)) (uClip 64 (bitshl (I 1) (I (uClip 64 w!)))))
      (=>
       (= wi@ (nClip (Mul w! i!)))
       (=>
        (= remaining_bits@ (nClip (Sub 256 (Mul w! i!))))
        (and
         (=>
          %%location_label%%2
          (req%curve25519_dalek!lemmas.scalar_lemmas_.radix_2w_lemmas.lemma_w_digits_count_concrete.
         ...
         (=>
          ...
          (or
           ...
           (and
            (not %%switch_label%%2)
            (=>
             (= quotient@ (EucDiv scalar_val! (vstd!arithmetic.power2.pow2.? (I wi@))))
             (and
              (and
               (=>
                (ens%vstd!arithmetic.power2.lemma_pow2_adds. remaining_bits@ wi@)
                (=>
                 %%location_label%%6
                 (= (vstd!arithmetic.power2.pow2.? (I 256)) (nClip (Mul (vstd!arithmetic.power2.pow2.?
                     (I remaining_bits@)
                    ) (vstd!arithmetic.power2.pow2.? (I wi@))
               )))))
               (=>
                (= (vstd!arithmetic.power2.pow2.? (I 256)) (nClip (Mul (vstd!arithmetic.power2.pow2.?
                    (I remaining_bits@)
                ...
                (and
                 (=>
                  (= tmp%4 (vstd!arithmetic.power2.pow2.? (I remaining_bits@)))
                  (=>
                   (= tmp%5 (vstd!arithmetic.power2.pow2.? (I wi@)))
                   (=>
                    ...
                    (=>
                     ...
                     (= (vstd!arithmetic.power2.pow2.? (I 256)) (nClip (Mul (vstd!arithmetic.power2.pow2.?
                         (I wi@)
                        ) (vstd!arithmetic.power2.pow2.? (I remaining_bits@))
                 )))))))
                 (=>
                  (= (vstd!arithmetic.power2.pow2.? (I 256)) (nClip (Mul (vstd!arithmetic.power2.pow2.?
                      (I wi@)
                  ...
                  (and
                   (=>
                    (ens%vstd!arithmetic.power2.lemma_pow2_pos. wi@)
                    (=>
                     %%location_label%%8
                     (>= (vstd!arithmetic.power2.pow2.? (I wi@)) 1)
                   ))
                   (=>
                    (>= (vstd!arithmetic.power2.pow2.? (I wi@)) 1)
                    (=>
                     (= tmp%6 (vstd!arithmetic.power2.pow2.? (I wi@)))
                     (=>
                      (= tmp%7 (vstd!arithmetic.power2.pow2.? (I remaining_bits@)))
                      (and
                       (=>
                        %%location_label%%9
                        (req%curve25519_dalek!lemmas.common_lemmas.div_mod_lemmas.lemma_div_strictly_bounded.
                         scalar_val! tmp%6 tmp%7
                       ))
                       (=>
                        (ens%curve25519_dalek!lemmas.common_lemmas.div_mod_lemmas.lemma_div_strictly_bounded.
                         scalar_val! tmp%6 tmp%7
                        ...
                        (=>
                         %%location_label%%10
                         (< quotient@ (vstd!arithmetic.power2.pow2.? (I remaining_bits@)))
              )))))))))))
              (=>
               (< quotient@ (vstd!arithmetic.power2.pow2.? (I remaining_bits@)))
               (=>
                (= extracted_nat@ extracted!)
                (and
                 (or
                  (and
                   (=>
                    ...
                    (and
                     (=>
                      %%location_label%%11
                      (req%vstd!arithmetic.power2.lemma_pow2_strictly_increases. remaining_bits@ w!)
                     )
                     (=>
                      (ens%vstd!arithmetic.power2.lemma_pow2_strictly_increases. remaining_bits@ w!)
                      %%switch_label%%1
                   )))
                   (=>
                    (not (< remaining_bits@ w!))
                    %%switch_label%%1
                  ))
                  (and
                   (not %%switch_label%%1)
                   (=>
                    (= tmp%8 (< quotient@ (vstd!arithmetic.power2.pow2.? (I w!))))
                    (and
                     (=>
                      %%location_label%%12
                      tmp%8
                     ...
                     (=>
                      tmp%8
                      (=>
                       (= tmp%9 (vstd!arithmetic.power2.pow2.? (I w!)))
                       (and
                        (=>
                         %%location_label%%13
                         (req%vstd!arithmetic.div_mod.lemma_small_mod. quotient@ tmp%9)
                        )
                        (=>
                         (ens%vstd!arithmetic.div_mod.lemma_small_mod. quotient@ tmp%9)
                         (=>
                          %%location_label%%14
                          (= extracted_nat@ quotient@)
                 )))))))))
                 (=>
                  (= extracted_nat@ quotient@)
                  (and
                   (or
                    (and
                     (=>
                      (< remaining_bits@ (nClip (Sub w! 2)))
                      (=>
                       (= tmp%10 (nClip (Sub w! 2)))
                       (and
                        (=>
                         %%location_label%%15
                         (req%vstd!arithmetic.power2.lemma_pow2_strictly_increases. remaining_bits@ tmp%10)
                        )
                        (=>
                         (ens%vstd!arithmetic.power2.lemma_pow2_strictly_increases. remaining_bits@ tmp%10)
                         %%switch_label%%0
                     ))))
                     (=>
                      (not (< remaining_bits@ (nClip (Sub w! 2))))
                      %%switch_label%%0
                    ))
                    (and
                     (not %%switch_label%%0)
                     (=>
                      %%location_label%%16
                      (<= (vstd!arithmetic.power2.pow2.? (I remaining_bits@)) (vstd!arithmetic.power2.pow2.?
                        (I (nClip (Sub w! 2)))
                   )))))
                   (=>
                    (<= (vstd!arithmetic.power2.pow2.? (I remaining_bits@)) (vstd!arithmetic.power2.pow2.?
                    ...
                    (and
                     (=>
                      (= tmp%11 (nClip (Sub w! 2)))
                      (=>
                       (ens%vstd!arithmetic.power2.lemma_pow2_adds. 1 tmp%11)
                       (=>
                        (ens%vstd!arithmetic.power2.lemma2_to64. 0)
                        (=>
                         %%location_label%%17
                         (= (vstd!arithmetic.power2.pow2.? (I (nClip (Sub w! 1)))) (nClip (Mul 2 (vstd!arithmetic.power2.pow2.?
                             (I (nClip (Sub w! 2)))
                     ))))))))
                     (=>
                      (= (vstd!arithmetic.power2.pow2.? (I (nClip (Sub w! 1)))) (nClip (Mul 2 (vstd!arithmetic.power2.pow2.?
                      ...
                      (and
                       (and
                        (=>
                         (= tmp%12 (nClip (Sub w! 1)))
                         (=>
                          (ens%vstd!arithmetic.power2.lemma_pow2_adds. tmp%12 1)
                          (=>
                           (ens%vstd!arithmetic.power2.lemma2_to64. 0)
                           (=>
                            %%location_label%%18
                            (= (vstd!arithmetic.power2.pow2.? (I w!)) (nClip (Mul (vstd!arithmetic.power2.pow2.?
                                (I (nClip (Sub w! 1)))
                               ) 2
                        )))))))
                        (=>
                         ...
                         (=>
                          (= tmp%13 (= (EucDiv (vstd!arithmetic.power2.pow2.? (I w!)) 2) (vstd!arithmetic.power2.pow2.?
                             (I (nClip (Sub w! 1)))
                          )))
                          (and
                           (=>
                           ...
                           (=>
                            ...
                            (=>
                             %%location_label%%20
                             (= (EucDiv (uClip 64 (bitshl (I 1) (I (uClip 64 w!)))) 2) (vstd!arithmetic.power2.pow2.?
                               (I (nClip (Sub w! 1)))
                       ))))))))
                       (=>
                        (= (EucDiv (uClip 64 (bitshl (I 1) (I (uClip 64 w!)))) 2) (vstd!arithmetic.power2.pow2.?
