...
;; curve25519-dalek/src/lemmas/ristretto_lemmas/batch_compress_lemmas.rs:2567:7: 2567:99 (#0)
...
;; Function-Def curve25519_dalek::lemmas::ristretto_lemmas::batch_compress_lemmas::lemma_batch_std_case_dispatch
;; curve25519-dalek/src/lemmas/ristretto_lemmas/batch_compress_lemmas.rs:2567:7: 2567:99 (#0)
...
(push)
 ...
 (declare-const d_plus_1@ Int)
 (declare-const tmp%8 Int)
 (declare-const e_eg@ Int)
 (declare-const h_fh@ Int)
 (declare-const inv_h_fh@ Int)
 ...
 (declare-const neg_one_minus_d@ Int)
 (declare-const B@ Int)
 (declare-const zinv@ Int)
 (declare-const tinv@ Int)
 (declare-const u1@ Int)
 (declare-const invsqrt_std@ Int)
 (assert
  fuel_defaults
 )
 (assert
          ...
          (=>
           ...
           (and
            ...
            (=>
             ...
             (and
              (=>
               (= tmp%1 (curve25519_dalek!specs.field_specs.field_inv.? (I f!)))
               (=>
                (= tmp%2 (curve25519_dalek!specs.field_specs.field_inv.? (I h!)))
                (=>
                 (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_four_factor_rearrange.
                  e! tmp%1 g! tmp%2
                 )
                 ...
                 (=>
                  ...
                  (and
                   ...
                   (=>
                    ...
                    (=>
                     (= tmp%3 (= (curve25519_dalek!specs.field_specs.field_mul.? (I u1@) (I (curve25519_dalek!specs.field_specs.field_square.?
                          (I t_aff@)
                        ))
                       ) (curve25519_dalek!specs.field_specs.field_mul.? (I neg_one_minus_d@) (I (curve25519_dalek!specs.field_specs.field_square.?
                          (I B@)
                       ...
                       (and
                        (=>
                         ...
                         (=>
                          ...
                          (=>
                           (= d_plus_1@ (curve25519_dalek!specs.field_specs.field_add.? (I 1) (I d@)))
                           (and
                            (and
                             (=>
                              %%location_label%%4
                             ...
                             (=>
                              ...
                              (=>
                               %%location_label%%5
                               (not (= (EucMod d_plus_1@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0))
                            )))
                            (=>
                             (not (= (EucMod d_plus_1@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0))
                             (and
                              ...
                              (=>
                               ...
                               (=>
                                ...
                                (=>
                                 (= tmp%4 (curve25519_dalek!specs.field_specs.field_neg.? (I 1)))
                                 (=>
                                  (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_distributes_over_add.
                                   tmp%4 1 d@
                                  )
                                  (=>
                                   ...
                                   (=>
                                    (= tmp%5 (curve25519_dalek!specs.field_specs.field_neg.? (I 1)))
                                    (=>
                                     (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_one_right.
                                      tmp%5
                                     )
                                     (=>
                                      (= tmp%6 (curve25519_dalek!specs.field_specs.field_neg.? (I 1)))
                                      (and
                                       (=>
                                        %%location_label%%7
                                        (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_element_reduced.
                                       ...
                                       (=>
                                        ...
                                        (=>
                                         (= tmp%7 (curve25519_dalek!specs.field_specs.field_neg.? (I 1)))
                                         (=>
                                          (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_sub_eq_add_neg.
                                           tmp%7 d@
                                          )
                        ...
                        (=>
                         ...
                         (and
                          (=>
                           (= e_eg@ (curve25519_dalek!specs.field_specs.field_mul.? (I e!) (I eg!)))
                           (=>
                            (= h_fh@ (curve25519_dalek!specs.field_specs.field_mul.? (I h!) (I fh!)))
                            (and
                             (and
                              (=>
                               %%location_label%%10
                              ...
                              (=>
                               ...
                               (and
                                ...
                                (=>
                                 ...
                                 (=>
                                  %%location_label%%12
                                  (not (= (EucMod e_eg@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0))
                             )))))
                             (=>
                              (not (= (EucMod e_eg@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0))
                              (and
                                ...
                                (=>
                                 ...
                                 (and
                                  ...
                                  (=>
                                   ...
                                   (=>
                                    %%location_label%%15
                                    (not (= (EucMod h_fh@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0))
                               )))))
                               (=>
                                (not (= (EucMod h_fh@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0))
                                (and
                                 (=>
                                  %%location_label%%16
                                  (req%curve25519_dalek!specs.field_specs.field_inv_property. h_fh@)
                                 )
                                 (=>
                                  (ens%curve25519_dalek!specs.field_specs.field_inv_property. h_fh@)
                                  (=>
                                   (= inv_h_fh@ (curve25519_dalek!specs.field_specs.field_inv.? (I h_fh@)))
                                   (and
                                    (or
                                     (and
                                      (=>
                                       ...
                                       (and
                                        (=>
                                         (= tmp%8 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                                         (and
                                          (=>
                                           %%location_label%%17
                                           (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. h_fh@ 0 tmp%8)
                                          )
                                          (=>
                                           (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. h_fh@ 0 tmp%8)
                                           (=>
                                            %%location_label%%18
                                            (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs_u64.field_canonical.?
                                                (I h_fh@)
                                     ...
                                     (and
                                      (and
                                       ...
                                       (=>
                                        ...
                                        (=>
                                         %%location_label%%21
                                         (not (= (EucMod inv_h_fh@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0))
                                      )))
                                      (=>
                                       (not (= (EucMod inv_h_fh@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0))
                                       (and
                          ...
                          (=>
                           ...
                           (and
                            (=>
                             %%location_label%%25
                             (req%curve25519_dalek!specs.field_specs.axiom_invsqrt_factors_over_square. neg_one_minus_d@
                              B@
                            ))
                            (=>
                             (ens%curve25519_dalek!specs.field_specs.axiom_invsqrt_factors_over_square. neg_one_minus_d@
                              B@
                             )
                             (=>
                              (ens%curve25519_dalek!lemmas.ristretto_lemmas.axioms.axiom_invsqrt_a_minus_d. 0)
                              (=>
                               (= invsqrt_std@ (curve25519_dalek!specs.field_specs.nat_invsqrt.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                                   (I u1@) (I (curve25519_dalek!specs.field_specs.field_square.? (I t_aff@)))
                               ))))
                               (=>
                                (= tmp%9 (= invsqrt_std@ (curve25519_dalek!specs.field_specs.field_abs.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                                     (I c_iad@) (I (curve25519_dalek!specs.field_specs.field_inv.? (I B@)))
                                )))))
                                (and
                                 (=>
