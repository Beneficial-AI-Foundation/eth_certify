...
;; curve25519-dalek/src/lemmas/field_lemmas/pow2_51_lemmas.rs:85:5: 85:11 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::pow2_51_lemmas::lemma_cast_then_mod_51
;; curve25519-dalek/src/lemmas/field_lemmas/pow2_51_lemmas.rs:85:5: 85:11 (#0)
...
(declare-const tmp$$$$bitvectmp3 (_ BitVec 128))
(assert
 true
)
...
(assert
 (not (=>
   %%location_label%%0
   (= ((_ zero_extend 64) (let
      ((tmp$$$$bitvectmp0 (_ bv2251799813685248 52)))
      (ite
       (= tmp$$$$bitvectmp0 (_ bv0 52))
       tmp$$$$bitvectmp1
       (bvurem ((_ extract 63 0) x!) ((_ zero_extend 12) tmp$$$$bitvectmp0))
     ))
    ) (let
     ((tmp$$$$bitvectmp2 (_ bv2251799813685248 52)))
     (ite
      (= tmp$$$$bitvectmp2 (_ bv0 52))
      tmp$$$$bitvectmp3
      (bvurem x! ((_ zero_extend 76) tmp$$$$bitvectmp2))
))))))
(get-info :version)
