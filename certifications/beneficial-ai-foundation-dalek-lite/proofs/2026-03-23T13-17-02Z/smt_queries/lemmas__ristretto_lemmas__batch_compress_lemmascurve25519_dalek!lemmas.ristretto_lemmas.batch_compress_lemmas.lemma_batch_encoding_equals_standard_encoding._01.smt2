...
;; curve25519-dalek/src/lemmas/ristretto_lemmas/batch_compress_lemmas.rs:2693:1: 2701:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::ristretto_lemmas::batch_compress_lemmas::lemma_batch_encoding_equals_standard_encoding
;; curve25519-dalek/src/lemmas/ristretto_lemmas/batch_compress_lemmas.rs:2693:1: 2701:2 (#0)
 ...
 (assert
  (not (and
    ...
    (=>
     (> (curve25519_dalek!specs.field_specs_u64.p.? (I 0)) 2)
     (=>
      (= egfh@ (curve25519_dalek!specs.field_specs.field_mul.? (I eg!) (I fh!)))
      (and
       (and
        (=>
         %%location_label%%1
       ...
       (=>
        ...
        (and
         (or
          (and
           (=>
            (= (EucMod eg! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0)
            (=>
             (= tmp%1 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
             (and
              (=>
               %%location_label%%3
               (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. eg! fh! tmp%1)
              )
              (=>
               (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. eg! fh! tmp%1)
               %%switch_label%%5
           ))))
           (=>
            (not (= (EucMod eg! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0))
         ...
         (=>
          ...
          (and
           (or
            (and
             (=>
              (= (EucMod fh! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0)
              (=>
               (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_comm.
                eg! fh!
               )
               (=>
                ...
                (and
                 (=>
                  %%location_label%%5
                  (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. fh! eg! tmp%2)
                 )
                 (=>
                  (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. fh! eg! tmp%2)
                  %%switch_label%%4
             )))))
             (=>
              (not (= (EucMod fh! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0))
           ...
           (=>
            ...
            (and
             (or
              (and
               (=>
                (= (EucMod e! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0)
                (=>
                 (= tmp%3 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                 (and
                  (=>
                   %%location_label%%7
                   (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. e! g! tmp%3)
                  )
                  (=>
                   (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. e! g! tmp%3)
                   %%switch_label%%3
               ))))
               (=>
                (not (= (EucMod e! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0))
              ...
              (and
               ...
               (or
                (and
                 (=>
                  (= (EucMod g! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0)
                  (=>
                   (= tmp%4 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                   (and
                    (=>
                     %%location_label%%8
                     (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. g! e! tmp%4)
                    )
                    (=>
                     (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. g! e! tmp%4)
                     (=>
                      (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_comm.
                       e! g!
                      )
             ...
             (=>
              ...
              (and
               (or
                (and
                 (=>
                  (= (EucMod f! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0)
                  (=>
                   (= tmp%5 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                   (and
                    (=>
                     %%location_label%%10
                     (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. f! h! tmp%5)
                    )
                    (=>
                     (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. f! h! tmp%5)
                     %%switch_label%%1
                 ))))
                 (=>
                  (not (= (EucMod f! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0))
                ...
                (and
                 ...
                 (or
                  (and
                   (=>
                    (= (EucMod h! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0)
                    (=>
                     (= tmp%6 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                     (and
                      (=>
                       %%location_label%%11
                       (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. h! f! tmp%6)
                      )
                      (=>
                       (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. h! f! tmp%6)
                       (=>
                        (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_comm.
                         f! h!
                        )
