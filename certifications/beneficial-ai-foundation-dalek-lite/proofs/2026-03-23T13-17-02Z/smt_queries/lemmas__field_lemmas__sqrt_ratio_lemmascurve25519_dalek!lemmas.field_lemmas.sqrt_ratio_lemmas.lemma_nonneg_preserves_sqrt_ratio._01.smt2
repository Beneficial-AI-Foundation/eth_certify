...
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_ratio_lemmas.rs:1834:1: 1834:71 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::sqrt_ratio_lemmas::lemma_nonneg_preserves_sqrt_ratio
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_ratio_lemmas.rs:1834:1: 1834:71 (#0)
 ...
 (assert
  (not (=>
    ...
    (=>
     ...
     (=>
      (= nr@ (curve25519_dalek!specs.field_specs.field_abs.? (I r!)))
      (or
       (and
        (=>
         (curve25519_dalek!specs.field_specs.is_negative.? (I r!))
         (=>
          (= tmp%1 (= nr@ (curve25519_dalek!specs.field_specs.field_neg.? (I r!))))
          (and
           (=>
            %%location_label%%0
            tmp%1
           ...
           (=>
            ...
            (and
             (=>
              ...
              (=>
               %%location_label%%1
               (= (curve25519_dalek!specs.field_specs.field_square.? (I nr@)) (curve25519_dalek!specs.field_specs.field_square.?
                 (I (EucMod r! pn@))
             ))))
             (=>
              (= (curve25519_dalek!specs.field_specs.field_square.? (I nr@)) (curve25519_dalek!specs.field_specs.field_square.?
              ...
              (and
               (and
                ...
                (=>
                 ...
                 (=>
                  %%location_label%%3
                  (= (curve25519_dalek!specs.field_specs.field_square.? (I (EucMod r! pn@))) (curve25519_dalek!specs.field_specs.field_square.?
                    (I r!)
               )))))
               (=>
                (= (curve25519_dalek!specs.field_specs.field_square.? (I (EucMod r! pn@))) (curve25519_dalek!specs.field_specs.field_square.?
