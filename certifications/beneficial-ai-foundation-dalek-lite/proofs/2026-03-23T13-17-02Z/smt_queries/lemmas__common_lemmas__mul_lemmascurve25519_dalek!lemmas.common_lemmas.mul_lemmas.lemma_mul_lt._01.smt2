...
;; curve25519-dalek/src/lemmas/common_lemmas/mul_lemmas.rs:8:1: 8:62 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::mul_lemmas::lemma_mul_lt
;; curve25519-dalek/src/lemmas/common_lemmas/mul_lemmas.rs:8:1: 8:62 (#0)
  ...
  (not (or
    (and
     (=>
      ...
      (and
       (=>
        (ens%vstd!arithmetic.mul.lemma_mul_nonzero. b1! b2!)
        (=>
         %%location_label%%0
         (> (nClip (Mul b1! b2!)) 0)
       ))
     ...
     (=>
      ...
      (and
       (=>
        %%location_label%%1
        (req%vstd!arithmetic.mul.lemma_mul_strict_inequality. a1! b1! a2!)
       )
       (=>
        (ens%vstd!arithmetic.mul.lemma_mul_strict_inequality. a1! b1! a2!)
        (and
         (=>
          %%location_label%%2
          (req%vstd!arithmetic.mul.lemma_mul_strict_inequality. a2! b2! b1!)
         )
         (=>
          (ens%vstd!arithmetic.mul.lemma_mul_strict_inequality. a2! b2! b1!)
          %%switch_label%%0
    ))))))
    (and
     (not %%switch_label%%0)
