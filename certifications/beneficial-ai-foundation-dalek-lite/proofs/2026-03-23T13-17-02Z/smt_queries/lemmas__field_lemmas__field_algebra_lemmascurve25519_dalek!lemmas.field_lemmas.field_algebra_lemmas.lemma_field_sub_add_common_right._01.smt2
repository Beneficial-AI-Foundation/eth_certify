...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:248:1: 248:70 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_field_sub_add_common_right
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:248:1: 248:70 (#0)
  ...
  (not (=>
    ...
    (=>
     ...
     (=>
      ...
      (=>
       (= x1@ (curve25519_dalek!specs.field_specs.field_add.? (I x!) (I y!)))
       (=>
        (= z1@ (curve25519_dalek!specs.field_specs.field_add.? (I z!) (I y!)))
        (=>
         (= tmp%1 (= x1@ (EucMod (nClip (Add x! y!)) p@)))
         (and
          (=>
           %%location_label%%0
           tmp%1
          ...
          (=>
           tmp%1
           (=>
            (= tmp%2 (= z1@ (EucMod (nClip (Add z! y!)) p@)))
            (and
             (=>
              %%location_label%%1
              tmp%2
                ...
                (and
                 (=>
                  ...
                  (and
                   (=>
                    %%location_label%%4
                    (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%4 p_i@)
                   )
                   (=>
                    (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%4 p_i@)
                    (=>
                     %%location_label%%5
                     (< z1@ p@)
                 ))))
                 (=>
                  ...
                  (and
                   (and
                    (=>
                     %%location_label%%6
                     (req%vstd!arithmetic.div_mod.lemma_small_mod. x1@ p@)
                    )
                    (=>
                     (ens%vstd!arithmetic.div_mod.lemma_small_mod. x1@ p@)
                     (and
                      (=>
                       %%location_label%%7
                       (req%vstd!arithmetic.div_mod.lemma_small_mod. z1@ p@)
                      )
                      (=>
                       (ens%vstd!arithmetic.div_mod.lemma_small_mod. z1@ p@)
                       (=>
                        %%location_label%%8
                        (= (curve25519_dalek!specs.field_specs.field_sub.? (I x1@) (I z1@)) (EucMod (nClip (
                            Sub (nClip (Add x1@ p@)) z1@
                           )
                          ) p@
                   )))))))
                   (=>
                       ...
                       (=>
                        ...
                        (and
                         ...
                         (=>
                          ...
                          (=>
                           %%location_label%%11
                           (= (EucMod x1@ p_i@) (EucMod (nClip (Add x! y!)) p_i@))
                     ))))))
                     (=>
                      (= (EucMod x1@ p_i@) (EucMod (nClip (Add x! y!)) p_i@))
                      (and
                         ...
                         (=>
                          ...
                          (and
                           ...
                           (=>
                            ...
                            (=>
                             %%location_label%%14
                             (= (EucMod z1@ p_i@) (EucMod (nClip (Add z! y!)) p_i@))
                       ))))))
                       (=>
                        (= (EucMod z1@ p_i@) (EucMod (nClip (Add z! y!)) p_i@))
                        (and
                         (and
                          (=>
                           %%location_label%%15
                           (req%vstd!arithmetic.div_mod.lemma_mod_add_multiples_vanish. x1@ p_i@)
                          )
                          (=>
                           (ens%vstd!arithmetic.div_mod.lemma_mod_add_multiples_vanish. x1@ p_i@)
                           (=>
                            (= tmp%7 (nClip (Add x! y!)))
                            (and
                             (=>
                              %%location_label%%16
                              (req%vstd!arithmetic.div_mod.lemma_mod_add_multiples_vanish. tmp%7 p_i@)
                             )
                             (=>
                              (ens%vstd!arithmetic.div_mod.lemma_mod_add_multiples_vanish. tmp%7 p_i@)
                              (=>
                               %%location_label%%17
                               (= (EucMod (nClip (Add x1@ p@)) p_i@) (EucMod (nClip (Add (nClip (Add x! y!)) p@))
                                 p_i@
                         ))))))))
                         (=>
                          (= (EucMod (nClip (Add x1@ p@)) p_i@) (EucMod (nClip (Add (nClip (Add x! y!)) p@))
                          ...
                          (and
                           (=>
                            (= tmp%8 (nClip (Add x1@ p@)))
                            (and
                             (=>
                              %%location_label%%18
                              (req%vstd!arithmetic.div_mod.lemma_sub_mod_noop. tmp%8 z1@ p_i@)
                             )
                             (=>
                              (ens%vstd!arithmetic.div_mod.lemma_sub_mod_noop. tmp%8 z1@ p_i@)
                              (=>
                               (= tmp%9 (nClip (Add (nClip (Add x! y!)) p@)))
                               (=>
                                (= tmp%10 (nClip (Add z! y!)))
                                (and
                                 (=>
                                  %%location_label%%19
                                  (req%vstd!arithmetic.div_mod.lemma_sub_mod_noop. tmp%9 tmp%10 p_i@)
                                 )
                                 (=>
                                  (ens%vstd!arithmetic.div_mod.lemma_sub_mod_noop. tmp%9 tmp%10 p_i@)
                                  (=>
                                   %%location_label%%20
                                   (= (EucMod (Sub (nClip (Add x1@ p@)) z1@) p_i@) (EucMod (Sub (nClip (Add (nClip (Add x!
                                          y!
                                         )
                                        ) p@
                                       )
                           ...
                           (=>
                            ...
                            (=>
                             (= tmp%11 (= (Sub (nClip (Add (nClip (Add x! y!)) p@)) (nClip (Add z! y!))) (Sub (nClip
                                 (Add x! p@)
                                ) z!
                             )))
                             (and
                              ...
                              (=>
                               tmp%11
                               (=>
                                (= tmp%12 (= (EucMod (Sub (nClip (Add x1@ p@)) z1@) p_i@) (EucMod (Sub (nClip (Add x! p@))
                                    z!
                                   ) p_i@
                                )))
                                (and
                                 ...
                                 (=>
                                  tmp%12
                                  (=>
                                   (= tmp%13 (= (EucMod (nClip (Sub (nClip (Add x1@ p@)) z1@)) p@) (EucMod (nClip (Sub (nClip
                                         (Add x! p@)
                                        ) z!
                                       )
                                      ) p@
                                    ...
                                    (=>
                                     ...
                                     (and
                                      (and
                                       (=>
                                        %%location_label%%24
                                        (req%vstd!arithmetic.div_mod.lemma_small_mod. x! p@)
                                       )
                                       (=>
                                        (ens%vstd!arithmetic.div_mod.lemma_small_mod. x! p@)
                                        (and
                                         (=>
                                          %%location_label%%25
                                         ...
                                         (=>
                                          ...
                                          (=>
                                           %%location_label%%26
                                           (= (curve25519_dalek!specs.field_specs.field_sub.? (I x!) (I z!)) (EucMod (nClip (Sub
                                               (nClip (Add x! p@)) z!
                                              )
                                             ) p@
                                      )))))))
