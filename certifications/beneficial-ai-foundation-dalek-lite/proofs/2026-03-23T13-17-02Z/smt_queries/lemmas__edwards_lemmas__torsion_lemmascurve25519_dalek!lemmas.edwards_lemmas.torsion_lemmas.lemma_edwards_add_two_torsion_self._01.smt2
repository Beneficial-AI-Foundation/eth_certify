...
;; curve25519-dalek/src/lemmas/edwards_lemmas/torsion_lemmas.rs:198:1: 198:50 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::torsion_lemmas::lemma_edwards_add_two_torsion_self
;; curve25519-dalek/src/lemmas/edwards_lemmas/torsion_lemmas.rs:198:1: 198:50 (#0)
                   ...
                   (=>
                    ...
                    (and
                     ...
                     (=>
                      ...
                      (=>
                       %%location_label%%9
                       (= (curve25519_dalek!specs.field_specs.field_mul.? (I neg1@) (I neg1@)) 1)
                  )))))
                  (=>
                   (= (curve25519_dalek!specs.field_specs.field_mul.? (I neg1@) (I neg1@)) 1)
                   (=>
                    (= x1x2@ (curve25519_dalek!specs.field_specs.field_mul.? (I 0) (I 0)))
                    (=>
                     (= y1y2@ (curve25519_dalek!specs.field_specs.field_mul.? (I neg1@) (I neg1@)))
                     (=>
                      (= x1y2@ (curve25519_dalek!specs.field_specs.field_mul.? (I 0) (I neg1@)))
                      (=>
                       (= y1x2@ (curve25519_dalek!specs.field_specs.field_mul.? (I neg1@) (I 0)))
                       (=>
                        (= tmp%4 (and
                          (and
                           (and
                           ...
                           (=>
                            ...
                            (and
                             ...
                             (=>
                              ...
                              (=>
                               (= tmp%5 (= (curve25519_dalek!specs.field_specs.field_add.? (I x1y2@) (I y1x2@)) 0))
                               (and
                                (=>
                                 %%location_label%%14
                                 tmp%5
                                ...
                                (=>
                                 tmp%5
                                 (=>
                                  (= tmp%6 (= (curve25519_dalek!specs.field_specs.field_add.? (I y1y2@) (I x1x2@)) 1))
                                  (and
                                   (=>
                                    %%location_label%%15
                                    tmp%6
                                       ...
                                       (=>
                                        ...
                                        (=>
                                         ...
                                         (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_add.?
                                            (I 0) (I (curve25519_dalek!specs.field_specs.field_neg.? (I 1))) (I 0) (I (curve25519_dalek!specs.field_specs.field_neg.?
                                              (I 1)
                                           )))
