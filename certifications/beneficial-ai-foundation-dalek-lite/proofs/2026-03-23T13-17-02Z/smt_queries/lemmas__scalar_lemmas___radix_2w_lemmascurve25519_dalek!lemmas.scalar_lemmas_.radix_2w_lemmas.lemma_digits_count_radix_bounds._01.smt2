...
;; curve25519-dalek/src/lemmas/scalar_lemmas_/radix_2w_lemmas.rs:1028:5: 1028:11 (#0)
...
;; Function-Def curve25519_dalek::lemmas::scalar_lemmas_::radix_2w_lemmas::lemma_digits_count_radix_bounds
;; curve25519-dalek/src/lemmas/scalar_lemmas_/radix_2w_lemmas.rs:1028:5: 1028:11 (#0)
...
(assert
 (not (=>
   %%location_label%%0
   (bvule radix@ ((_ zero_extend 55) (_ bv256 9)))
)))
(get-info :version)
