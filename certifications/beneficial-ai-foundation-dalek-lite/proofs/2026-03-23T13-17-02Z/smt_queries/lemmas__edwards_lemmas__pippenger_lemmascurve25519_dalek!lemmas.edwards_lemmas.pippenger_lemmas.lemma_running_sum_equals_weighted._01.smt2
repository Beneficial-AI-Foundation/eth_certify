...
;; curve25519-dalek/src/lemmas/edwards_lemmas/pippenger_lemmas.rs:952:1: 952:88 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::pippenger_lemmas::lemma_running_sum_equals_weighted
;; curve25519-dalek/src/lemmas/edwards_lemmas/pippenger_lemmas.rs:952:1: 952:88 (#0)
(get-info :all-statistics)
(push)
 (declare-const buckets_affine! vstd!seq.Seq<tuple%2<nat./nat.>.>.)
 (declare-const B! Int)
 (assert
  fuel_defaults
 )
 ...
 (assert
  (forall ((j$ Poly)) (!
    ...
    :qid user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_running_sum_equals_weighted_62
    :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_running_sum_equals_weighted_62
 )))
