...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:823:1: 823:59 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_field_sub_antisymmetric
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:823:1: 823:59 (#0)
...
(push)
 ...
 (declare-const diff$1@ Int)
 (declare-const p@ Int)
 (declare-const a_mod@ Int)
 (declare-const b_mod@ Int)
 (declare-const sub_ab@ Int)
 (declare-const sub_ba@ Int)
 (assert
  fuel_defaults
 )
 (assert
    ...
    (=>
     ...
     (=>
      ...
      (=>
       (= b_mod@ (EucMod b! p@))
       (=>
        (= sub_ab@ (curve25519_dalek!specs.field_specs.field_sub.? (I a!) (I b!)))
        (=>
         (= sub_ba@ (curve25519_dalek!specs.field_specs.field_sub.? (I b!) (I a!)))
         (and
          (=>
           (= tmp%1 (Sub (nClip (Add a_mod@ p@)) b_mod@))
           (and
            (=>
             %%location_label%%0
          ...
          (=>
           ...
           (and
            (=>
             (= tmp%2 (Sub (nClip (Add b_mod@ p@)) a_mod@))
             (and
              (=>
               %%location_label%%2
                 ...
                 (and
                  (and
                   (and
                    (=>
                     %%location_label%%4
                     (req%vstd!arithmetic.div_mod.lemma_mod_bound. b! p@)
                    )
                    (=>
                     (ens%vstd!arithmetic.div_mod.lemma_mod_bound. b! p@)
                     (=>
                      %%location_label%%5
                      (< b_mod@ p@)
                   )))
                     ...
                     (and
                      (and
                       ...
                       (=>
                        ...
                        (=>
                         %%location_label%%12
                         (= (curve25519_dalek!specs.field_specs_u64.field_canonical.? (I 0)) 0)
                      )))
                      (=>
                       (= (curve25519_dalek!specs.field_specs_u64.field_canonical.? (I 0)) 0)
                       (and
                        ...
                        (=>
                         ...
                         (=>
                          %%location_label%%14
                          (= (curve25519_dalek!specs.field_specs.field_neg.? (I sub_ab@)) 0)
                     )))))
                     (=>
                      (= (curve25519_dalek!specs.field_specs.field_neg.? (I sub_ab@)) 0)
                      %%switch_label%%0
                ...
                (or
                 (and
                  (=>
                   (> a_mod@ b_mod@)
                   (=>
                    (= diff@ (nClip (Sub a_mod@ b_mod@)))
                    (and
                     (=>
                      (= tmp%3 (= (Sub (nClip (Add a_mod@ p@)) b_mod@) (nClip (Add p@ diff@))))
                      (and
                       (=>
                        %%location_label%%15
                        tmp%3
                       ...
                       (=>
                        ...
                        (and
                         (=>
                          %%location_label%%16
                          (req%vstd!arithmetic.div_mod.lemma_mod_add_multiples_vanish. diff@ p@)
                         )
                         (=>
                          (ens%vstd!arithmetic.div_mod.lemma_mod_add_multiples_vanish. diff@ p@)
                          (and
                           (=>
                            %%location_label%%17
                     ...
                     (=>
                      ...
                      (and
                       (=>
                        (= tmp%4 (= (Sub (nClip (Add b_mod@ p@)) a_mod@) (Sub p@ diff@)))
                        (and
                         (=>
                          %%location_label%%19
                          tmp%4
                        ...
                        (and
                         (and
                          ...
                          (=>
                           (ens%vstd!arithmetic.div_mod.lemma_small_mod. diff@ p@)
                           (=>
                            (= tmp%6 (nClip (Sub p@ diff@)))
                            (and
                             (=>
                              %%location_label%%23
                              (req%vstd!arithmetic.div_mod.lemma_small_mod. tmp%6 p@)
                             )
                             (=>
                              (ens%vstd!arithmetic.div_mod.lemma_small_mod. tmp%6 p@)
                              (=>
                               %%location_label%%24
                               (= (curve25519_dalek!specs.field_specs.field_neg.? (I sub_ab@)) (Sub p@ diff@))
                         ))))))
                         (=>
                          (= (curve25519_dalek!specs.field_specs.field_neg.? (I sub_ab@)) (Sub p@ diff@))
                          %%switch_label%%1
                  ...
                  (=>
                   (not (> a_mod@ b_mod@))
                   (=>
                    (= diff$1@ (nClip (Sub b_mod@ a_mod@)))
                    (and
                     (=>
                      (= tmp%7 (= (Sub (nClip (Add a_mod@ p@)) b_mod@) (Sub p@ diff$1@)))
                      (and
                       (=>
                        %%location_label%%25
                        tmp%7
                       ...
                       (=>
                        tmp%7
                        (=>
                         (= tmp%8 (nClip (Sub p@ diff$1@)))
                         (and
                          (=>
                           %%location_label%%26
                           (req%vstd!arithmetic.div_mod.lemma_small_mod. tmp%8 p@)
                          )
                          (=>
                           (ens%vstd!arithmetic.div_mod.lemma_small_mod. tmp%8 p@)
                           (=>
                            %%location_label%%27
                            (= sub_ab@ (Sub p@ diff$1@))
                     )))))))
                     (=>
                      ...
                      (and
                       (=>
                        (= tmp%9 (= (Sub (nClip (Add b_mod@ p@)) a_mod@) (nClip (Add p@ diff$1@))))
                        (and
                         (=>
                          %%location_label%%28
                          tmp%9
                         ...
                         (=>
                          ...
                          (and
                           (=>
                            %%location_label%%29
                            (req%vstd!arithmetic.div_mod.lemma_mod_add_multiples_vanish. diff$1@ p@)
                           )
                           (=>
                            (ens%vstd!arithmetic.div_mod.lemma_mod_add_multiples_vanish. diff$1@ p@)
                            (and
                             (=>
                              %%location_label%%30
                              (req%vstd!arithmetic.div_mod.lemma_small_mod. diff$1@ p@)
                             )
                             (=>
                              (ens%vstd!arithmetic.div_mod.lemma_small_mod. diff$1@ p@)
                              (=>
                               %%location_label%%31
                               (= sub_ba@ diff$1@)
                       ))))))))
                       (=>
                        ...
                        (and
                         (=>
                          (= tmp%10 (= (Sub p@ (Sub p@ diff$1@)) diff$1@))
                          (and
                           (=>
                            %%location_label%%32
                            tmp%10
                           ...
                           (=>
                            tmp%10
                            (=>
                             (= tmp%11 (nClip (Sub p@ diff$1@)))
                             (and
                              (=>
                               %%location_label%%33
                               (req%vstd!arithmetic.div_mod.lemma_small_mod. tmp%11 p@)
                              )
                              (=>
                               (ens%vstd!arithmetic.div_mod.lemma_small_mod. tmp%11 p@)
                               (and
                                (=>
                                 %%location_label%%34
                                 (req%vstd!arithmetic.div_mod.lemma_small_mod. diff$1@ p@)
                                ...
                                (=>
                                 ...
                                 (=>
                                  %%location_label%%35
                                  (= (curve25519_dalek!specs.field_specs.field_neg.? (I sub_ab@)) diff$1@)
                         )))))))))
                         (=>
                          (= (curve25519_dalek!specs.field_specs.field_neg.? (I sub_ab@)) diff$1@)
                          %%switch_label%%1
