...
;; curve25519-dalek/src/lemmas/field_lemmas/invert_lemmas.rs:150:1: 156:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::invert_lemmas::lemma_invert_power_chain
;; curve25519-dalek/src/lemmas/field_lemmas/invert_lemmas.rs:150:1: 156:2 (#0)
  ...
  (not (and
    (and
     ...
     (=>
      (> (vstd!arithmetic.power2.pow2.? (I 5)) 0)
      (=>
       (= tmp%1 (vstd!arithmetic.power2.pow2.? (I 5)))
       (and
        (=>
         %%location_label%%1
         (req%curve25519_dalek!lemmas.field_lemmas.invert_lemmas.lemma_pow2k_to_field_element.
    ...
    (=>
     ...
     (=>
      ...
      (and
       (and
        (=>
         (ens%vstd!arithmetic.power2.lemma_pow2_pos. 250)
         (and
          (=>
           ...
           (and
            (=>
             %%location_label%%3
             (req%vstd!arithmetic.power2.lemma_pow2_strictly_increases. 0 250)
            )
            (=>
             (ens%vstd!arithmetic.power2.lemma_pow2_strictly_increases. 0 250)
             (=>
              %%location_label%%4
              (> (vstd!arithmetic.power2.pow2.? (I 250)) 1)
          ))))
          (=>
           (> (vstd!arithmetic.power2.pow2.? (I 250)) 1)
           (=>
            %%location_label%%5
            (> (Sub (vstd!arithmetic.power2.pow2.? (I 250)) 1) 0)
        ))))
        (=>
         (> (Sub (vstd!arithmetic.power2.pow2.? (I 250)) 1) 0)
         (and
          ...
          (=>
           ...
           (and
            ...
            (=>
             (> (curve25519_dalek!specs.field_specs_u64.p.? (I 0)) 0)
             (=>
              (= tmp%2 (nClip (Sub (vstd!arithmetic.power2.pow2.? (I 250)) 1)))
              (=>
               (= tmp%3 (vstd!arithmetic.power2.pow2.? (I 5)))
               (=>
                (= tmp%4 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                (and
                 (=>
                  %%location_label%%8
                  (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow_mod_composition. x@
                   tmp%2 tmp%3 tmp%4
                 ))
                 (=>
                  (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow_mod_composition. x@
                   tmp%2 tmp%3 tmp%4
                  )
                  (=>
                   %%location_label%%9
                   (= (EucMod (nClip (vstd!arithmetic.power.pow.? (I (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.?
                    ...
                    ) (EucMod (nClip (vstd!arithmetic.power.pow.? (I x@) (I (nClip (Mul (Sub (vstd!arithmetic.power2.pow2.?
                            (I 250)
                           ) 1
