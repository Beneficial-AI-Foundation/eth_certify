...
;; curve25519-dalek/src/lemmas/edwards_lemmas/straus_lemmas.rs:850:1: 850:97 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::straus_lemmas::lemma_straus_ct_partial_peel_last
;; curve25519-dalek/src/lemmas/edwards_lemmas/straus_lemmas.rs:850:1: 850:97 (#0)
(get-info :all-statistics)
(push)
 (declare-const pts! vstd!seq.Seq<tuple%2<nat./nat.>.>.)
 (declare-const digs! vstd!seq.Seq<vstd!seq.Seq<i8.>.>.)
 (declare-const j! Int)
 (declare-const tmp%1 tuple%2.)
 (declare-const tmp%2 Int)
 (declare-const tmp%3 Int)
 (declare-const tmp%4 tuple%2.)
 (declare-const tmp%5 vstd!seq.Seq<i8.>.)
 (declare-const prev_full@ tuple%2.)
 (declare-const prev_prefix@ tuple%2.)
 (declare-const prev_single@ tuple%2.)
 (declare-const scaled_prefix@ tuple%2.)
 (declare-const scaled_single@ tuple%2.)
 (declare-const col_full@ tuple%2.)
 (declare-const col_prefix@ tuple%2.)
 (declare-const col_single@ tuple%2.)
 (declare-const n@ Int)
 (declare-const pts_prefix@ vstd!seq.Seq<tuple%2<nat./nat.>.>.)
 (declare-const digs_prefix@ vstd!seq.Seq<vstd!seq.Seq<i8.>.>.)
 (declare-const pts_single@ vstd!seq.Seq<tuple%2<nat./nat.>.>.)
 (declare-const digs_single@ vstd!seq.Seq<vstd!seq.Seq<i8.>.>.)
 ...
 (assert
  (forall ((k$ Poly)) (!
    ...
    :qid user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_straus_ct_partial_peel_last_89
    :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_straus_ct_partial_peel_last_89
 )))
 (assert
  (forall ((k$ Poly)) (!
    (=>
    ...
    :qid user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_straus_ct_partial_peel_last_90
    :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_straus_ct_partial_peel_last_90
 )))
    ...
    (=>
     ...
     (=>
      (= pts_prefix@ (%Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. (vstd!seq_lib.impl&%0.drop_last.?
         (DST $) (TYPE%tuple%2. $ NAT $ NAT) (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. pts!)
      )))
      (=>
       (= digs_prefix@ (%Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>. (vstd!seq_lib.impl&%0.drop_last.?
          $ (TYPE%vstd!seq.Seq. $ (SINT 8)) (Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>. digs!)
       )))
       (=>
        (= pts_single@ (%Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. (vstd!seq.Seq.push.? (DST $)
           (TYPE%tuple%2. $ NAT $ NAT) (vstd!seq.Seq.empty.? (DST $) (TYPE%tuple%2. $ NAT $ NAT))
           (vstd!seq.Seq.last.? (DST $) (TYPE%tuple%2. $ NAT $ NAT) (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>.
             pts!
        )))))
        (=>
         (= digs_single@ (%Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>. (vstd!seq.Seq.push.? $ (TYPE%vstd!seq.Seq.
             $ (SINT 8)
            ) (vstd!seq.Seq.empty.? $ (TYPE%vstd!seq.Seq. $ (SINT 8))) (vstd!seq.Seq.last.? $
             (TYPE%vstd!seq.Seq. $ (SINT 8)) (Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>. digs!)
         ))))
         (or
          (and
           (=>
            (>= j! 64)
            (=>
             (ens%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_ct_base. pts!
              digs!
             )
             (=>
              (ens%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_ct_base. pts_prefix@
               digs_prefix@
              )
              (=>
               (ens%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_ct_base. pts_single@
                digs_single@
               )
               (=>
                (ens%curve25519_dalek!specs.field_specs_u64.p_gt_2. 0)
                (=>
                 (= tmp%1 (curve25519_dalek!specs.edwards_specs.edwards_identity.? (I 0)))
                 (and
                  (=>
                   %%location_label%%0
                   (req%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_edwards_add_identity_right_canonical.
           ...
           (=>
            ...
            (and
             (=>
              %%location_label%%1
              (req%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_ct_step. pts!
               digs! j!
             ))
             (=>
              (ens%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_ct_step. pts!
               digs! j!
              )
              (and
               (=>
                %%location_label%%2
                (req%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_ct_step. pts_prefix@
                 digs_prefix@ j!
               ))
               (=>
                (ens%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_ct_step. pts_prefix@
                 digs_prefix@ j!
                )
                (and
                 (=>
                  %%location_label%%3
                  (req%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_ct_step. pts_single@
                   digs_single@ j!
                 ))
                 (=>
                  (ens%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_ct_step. pts_single@
                   digs_single@ j!
                  )
                  (=>
                   (= tmp%2 (Add j! 1))
                   (and
                    (=>
                     ...
                     (check_decrease_int (let
                       ((pts!$0 pts!) (digs!$1 digs!) (j!$2 tmp%2))
                       (Sub 64 j!$2)
                    ...
                    (and
                     ...
                     (=>
                      ...
                      (=>
                       (= prev_full@ (curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.straus_ct_partial.?
                         (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. pts!) (Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>.
                          digs!
                         ) (I (Add j! 1))
                       ))
                       (=>
                        (= prev_prefix@ (curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.straus_ct_partial.?
                          (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. pts_prefix@) (Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>.
                           digs_prefix@
                          ) (I (Add j! 1))
                        ))
                        (=>
                         (= prev_single@ (curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.straus_ct_partial.?
                           (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. pts_single@) (Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>.
                            digs_single@
                           ) (I (Add j! 1))
                         ))
                         (=>
                          (ens%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.axiom_edwards_scalar_mul_distributive.
                           prev_prefix@ prev_single@ 16
                          )
                          (=>
                           (= scaled_prefix@ (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2.
                              prev_prefix@
                             ) (I 16)
                           ))
                           (=>
                            (= scaled_single@ (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2.
                               prev_single@
                              ) (I 16)
                            ))
                            (=>
                             (= col_full@ (curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.straus_column_sum.?
                               (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. pts!) (Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>.
                                digs!
                               ) (I j!) (I n@)
                             ))
                             (=>
                              (= col_prefix@ (curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.straus_column_sum.?
                                (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. pts_prefix@) (Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>.
                                 digs_prefix@
                                ) (I j!) (I (Sub n@ 1))
                              ))
                              (=>
                               (= col_single@ (curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.straus_column_sum.?
                                 (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. pts_single@) (Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>.
                                  digs_single@
                                 ) (I j!) (I 1)
                               ))
                               (=>
                                ...
                                (and
                                 (=>
                                  %%location_label%%6
                                  (req%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_column_sum_prefix_eq.
                                   pts! digs! pts_prefix@ digs_prefix@ j! tmp%3
                                 ))
                                 (=>
                                  (ens%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_column_sum_prefix_eq.
                                   pts! digs! pts_prefix@ digs_prefix@ j! tmp%3
                                  ...
                                  (=>
                                   (= tmp%4 (%Poly%tuple%2. (vstd!seq.Seq.last.? (DST $) (TYPE%tuple%2. $ NAT $ NAT) (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>.
                                       pts!
                                   ))))
                                   (=>
                                    (= tmp%5 (%Poly%vstd!seq.Seq<i8.>. (vstd!seq.Seq.last.? $ (TYPE%vstd!seq.Seq. $ (SINT
                                         8
                                        )
                                       ) (Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>. digs!)
                                    )))
                                    (and
                                     (=>
                                      %%location_label%%7
                                     ...
                                     (=>
                                      ...
                                      (=>
                                       (ens%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_edwards_add_four_way_swap.
                                        scaled_prefix@ scaled_single@ col_prefix@ col_single@
                                       )
                                       %%switch_label%%0
          )))))))))))))))))))))))))))))
          (and
