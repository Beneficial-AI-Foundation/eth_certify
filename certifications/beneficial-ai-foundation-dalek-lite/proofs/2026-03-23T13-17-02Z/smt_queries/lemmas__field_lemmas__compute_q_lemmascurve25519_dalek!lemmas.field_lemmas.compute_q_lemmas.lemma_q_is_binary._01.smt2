...
;; curve25519-dalek/src/lemmas/field_lemmas/compute_q_lemmas.rs:472:1: 472:56 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::compute_q_lemmas::lemma_q_is_binary
;; curve25519-dalek/src/lemmas/field_lemmas/compute_q_lemmas.rs:472:1: 472:56 (#0)
...
(push)
 ...
 (assert
  (forall ((i$ Poly)) (!
    ...
    :qid user_curve25519_dalek__lemmas__field_lemmas__compute_q_lemmas__lemma_q_is_binary_57
    :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__compute_q_lemmas__lemma_q_is_binary_57
 )))
 (assert
  (< (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. limbs!)) (
    nClip (Mul 2 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
       ...
       (=>
        ...
        (and
         (=>
          ...
          (=>
           %%location_label%%1
           (< (curve25519_dalek!specs.field_specs_u64.p.? (I 0)) (vstd!arithmetic.power2.pow2.?
             (I 255)
         ))))
         (=>
          (< (curve25519_dalek!specs.field_specs_u64.p.? (I 0)) (vstd!arithmetic.power2.pow2.?
