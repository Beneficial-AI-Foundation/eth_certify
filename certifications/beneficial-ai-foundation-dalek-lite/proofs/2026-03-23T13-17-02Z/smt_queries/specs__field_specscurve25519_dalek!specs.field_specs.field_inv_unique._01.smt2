...
;; curve25519-dalek/src/specs/field_specs.rs:254:1: 254:46 (#0)
...
;; Function-Def curve25519_dalek::specs::field_specs::field_inv_unique
;; curve25519-dalek/src/specs/field_specs.rs:254:1: 254:46 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= a_red@ (EucMod a! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))))
    (=>
     (= z@ (curve25519_dalek!specs.field_specs.field_inv.? (I a!)))
     (and
      (=>
       %%location_label%%0
       (req%curve25519_dalek!specs.field_specs.field_inv_property. a!)
      ...
      (=>
       (ens%curve25519_dalek!specs.field_specs.field_inv_property. a!)
       (and
        (=>
         ...
         (and
          (=>
           %%location_label%%1
           (req%vstd!arithmetic.div_mod.lemma_mod_bound. a! tmp%1)
          )
          (=>
           (ens%vstd!arithmetic.div_mod.lemma_mod_bound. a! tmp%1)
           (=>
            %%location_label%%2
            (< a_red@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
        ))))
        (=>
         (< a_red@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
         (and
          (=>
           ...
           (and
            (=>
             %%location_label%%3
             (req%vstd!arithmetic.div_mod.lemma_small_mod. a_red@ tmp%2)
            )
            (=>
             (ens%vstd!arithmetic.div_mod.lemma_small_mod. a_red@ tmp%2)
             (=>
              %%location_label%%4
              (= (EucMod a_red@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) a_red@)
          ))))
          (=>
           (= (EucMod a_red@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) a_red@)
           (=>
            ...
            (and
             (=>
              %%location_label%%5
              (req%curve25519_dalek!specs.field_specs.lemma_inverse_unique_core. a_red@ w! z@ tmp%3)
             )
             (=>
              (ens%curve25519_dalek!specs.field_specs.lemma_inverse_unique_core. a_red@ w! z@ tmp%3)
              (=>
               %%location_label%%6
               (= w! (curve25519_dalek!specs.field_specs.field_inv.? (I a!)))
 ))))))))))))))
 (get-info :version)
