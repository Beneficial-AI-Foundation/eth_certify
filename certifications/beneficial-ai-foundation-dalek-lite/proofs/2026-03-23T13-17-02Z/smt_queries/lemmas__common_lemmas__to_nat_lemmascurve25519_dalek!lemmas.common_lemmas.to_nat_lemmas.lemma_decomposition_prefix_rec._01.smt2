...
;; curve25519-dalek/src/lemmas/common_lemmas/to_nat_lemmas.rs:248:1: 248:70 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::to_nat_lemmas::lemma_decomposition_prefix_rec
;; curve25519-dalek/src/lemmas/common_lemmas/to_nat_lemmas.rs:248:1: 248:70 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= decrease%init0 n!)
    (=>
     (= goal@ (= (curve25519_dalek!specs.core_specs.u8_32_as_nat_rec.? (Poly%array%. bytes!)
        (I 0)
       ) (nClip (Add (curve25519_dalek!specs.core_specs.bytes_as_nat_prefix.? (vstd!view.View.view.?
           $ (ARRAY $ (UINT 8) $ (CONST_INT 32)) (Poly%array%. bytes!)
          ) (I n!)
      ...
      (or
       (and
        (=>
         (= n! 0)
         (=>
          (= tmp%1 (= (curve25519_dalek!specs.core_specs.bytes_as_nat_prefix.? (vstd!view.View.view.?
              $ (ARRAY $ (UINT 8) $ (CONST_INT 32)) (Poly%array%. bytes!)
             ) (I 0)
            ) 0
          ))
              ...
              (=>
               ...
               (= (curve25519_dalek!specs.core_specs.u8_32_as_nat_rec.? (Poly%array%. bytes!) (I 0))
                (nClip (Add (curve25519_dalek!specs.core_specs.bytes_as_nat_prefix.? (vstd!view.View.view.?
                  ...
                  ) (curve25519_dalek!specs.core_specs.u8_32_as_nat_rec.? (Poly%array%. bytes!) (I (nClip
                     (Sub n! 1)
          )))))))))))
          (=>
           (= (curve25519_dalek!specs.core_specs.u8_32_as_nat_rec.? (Poly%array%. bytes!) (I 0))
           ...
           (=>
            (= tmp%3 (= (curve25519_dalek!specs.core_specs.u8_32_as_nat_rec.? (Poly%array%. bytes!)
               (I (nClip (Sub n! 1)))
              ) (nClip (Add (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $
                     (ARRAY $ (UINT 8) $ (CONST_INT 32)) (Poly%array%. bytes!)
                    ) (I (Sub n! 1))
                   )
                  ) (vstd!arithmetic.power2.pow2.? (I (nClip (Mul (Sub n! 1) 8))))
                 )
                ) (curve25519_dalek!specs.core_specs.u8_32_as_nat_rec.? (Poly%array%. bytes!) (I n!))
            ))))
            (and
             ...
             (=>
              tmp%3
              (=>
               (= tmp%4 (= (curve25519_dalek!specs.core_specs.bytes_as_nat_prefix.? (vstd!view.View.view.?
                   $ (ARRAY $ (UINT 8) $ (CONST_INT 32)) (Poly%array%. bytes!)
                  ) (I n!)
                 ) (nClip (Add (curve25519_dalek!specs.core_specs.bytes_as_nat_prefix.? (vstd!view.View.view.?
                     $ (ARRAY $ (UINT 8) $ (CONST_INT 32)) (Poly%array%. bytes!)
                    ) (I (nClip (Sub n! 1)))
                   ) (nClip (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul (Sub n! 1) 8)))) (%I (vstd!seq.Seq.index.?
                ...
                (=>
                 ...
                 (and
                  (=>
                   ...
                   (=>
                    (= tmp%6 (vstd!arithmetic.power2.pow2.? (I (nClip (Mul (Sub n! 1) 8)))))
                    (=>
                     (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. tmp%5 tmp%6)
                     (=>
                      %%location_label%%6
                      (= (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT
                              8
