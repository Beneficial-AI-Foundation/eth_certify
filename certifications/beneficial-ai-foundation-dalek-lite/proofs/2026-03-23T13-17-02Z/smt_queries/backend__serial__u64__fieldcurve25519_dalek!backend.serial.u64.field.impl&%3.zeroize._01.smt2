...
;; curve25519-dalek/src/backend/serial/u64/field.rs:131:5: 131:26 (#0)
...
;; Function-Def curve25519_dalek::backend::serial::u64::field::FieldElement51::zeroize
;; curve25519-dalek/src/backend/serial/u64/field.rs:131:5: 131:26 (#0)
...
(push)
 ...
 (assert
  (not (=>
    ...
    (=>
     (ens%curve25519_dalek!core_assumes.zeroize_limbs5. (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
       (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
         self!@0
       ))
      ) (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
     ...
     (=>
      ...
      (forall ((i$ Poly)) (!
        ...
        :qid user_curve25519_dalek__backend__serial__u64__field__FieldElement51__zeroize_107
        :skolemid skolem_user_curve25519_dalek__backend__serial__u64__field__FieldElement51__zeroize_107
 )))))))
 (get-info :version)
