...
;; curve25519-dalek/src/specs/proba_specs.rs:157:1: 162:2 (#0)
...
;; Function-Def curve25519_dalek::specs::proba_specs::axiom_from_bytes_independent
;; curve25519-dalek/src/specs/proba_specs.rs:157:1: 162:2 (#0)
(get-info :all-statistics)
(push)
 (declare-const bytes1! %%Function%%)
 (declare-const bytes2! %%Function%%)
 ...
 (assert
  (has_type (Poly%array%. bytes1!) (ARRAY $ (UINT 8) $ (CONST_INT 32)))
 )
 (assert
  (has_type (Poly%array%. bytes2!) (ARRAY $ (UINT 8) $ (CONST_INT 32)))
 )
 (assert
