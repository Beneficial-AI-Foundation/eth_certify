...
;; curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:572:1: 572:50 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::pow_lemmas::pow2_MUL_div
;; curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:572:1: 572:50 (#0)
  ...
  (not (and
    ...
    (=>
     ...
     (=>
      ...
      (and
       (=>
        (ens%vstd!arithmetic.power2.lemma_pow2_adds. d@ s!)
        (=>
         %%location_label%%1
         (= (vstd!arithmetic.power2.pow2.? (I k!)) (nClip (Mul (vstd!arithmetic.power2.pow2.?
             (I d@)
            ) (vstd!arithmetic.power2.pow2.? (I s!))
       )))))
       (=>
        ...
        (and
         (=>
          ...
          (=>
           ...
           (=>
            (ens%vstd!arithmetic.mul.lemma_mul_is_associative. x! tmp%1 tmp%2)
            (=>
             %%location_label%%2
             (= (nClip (Mul x! (vstd!arithmetic.power2.pow2.? (I k!)))) (nClip (Mul (nClip (Mul x!
         ...
         (=>
          ...
          (and
           (=>
            (= tmp%3 (nClip (Mul x! (vstd!arithmetic.power2.pow2.? (I d@)))))
            (=>
             (= tmp%4 (vstd!arithmetic.power2.pow2.? (I s!)))
             (and
              (=>
               %%location_label%%3
              ...
              (=>
               ...
               (=>
                %%location_label%%4
                (= (EucDiv (nClip (Mul (nClip (Mul x! (vstd!arithmetic.power2.pow2.? (I d@)))) (vstd!arithmetic.power2.pow2.?
                     (I s!)
                   ))
                  ) (vstd!arithmetic.power2.pow2.? (I s!))
                 ) (nClip (Mul x! (vstd!arithmetic.power2.pow2.? (I d@))))
           ))))))
           (=>
            (= (EucDiv (nClip (Mul (nClip (Mul x! (vstd!arithmetic.power2.pow2.? (I d@)))) (vstd!arithmetic.power2.pow2.?
                 (I s!)
