...
;; curve25519-dalek/src/lemmas/scalar_lemmas_/naf_lemmas.rs:527:5: 527:11 (#0)
...
;; Function-Def curve25519_dalek::lemmas::scalar_lemmas_::naf_lemmas::lemma_naf_window_no_overflow
;; curve25519-dalek/src/lemmas/scalar_lemmas_/naf_lemmas.rs:527:5: 527:11 (#0)
...
(declare-const window_mask! (_ BitVec 64))
(declare-const w! (_ BitVec 32))
(declare-const bit_buf! (_ BitVec 64))
(assert
 (= ((_ zero_extend 1) window_mask!) (bvsub ((_ zero_extend 1) (bvshl ((_ zero_extend 63)
      (_ bv1 1)
     ) ((_ zero_extend 32) w!)
    )
   ) ((_ zero_extend 64) (_ bv1 1))
)))
(assert
 (and
  (bvule ((_ zero_extend 30) (_ bv2 2)) w!)
...
(assert
 (not (=>
   %%location_label%%0
   (bvule (bvand bit_buf! window_mask!) window_mask!)
)))
(get-info :version)
