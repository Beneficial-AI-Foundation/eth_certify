...
;; MODULE 'module backend::serial::scalar_mul::vartime_double_base'
;; curve25519-dalek/src/backend/serial/scalar_mul/vartime_double_base.rs:100:5: 100:9 (#0)
...
(declare-const fuel%curve25519_dalek!lemmas.edwards_lemmas.vartime_double_base_lemmas.vartime_double_base_shared_input_valid.
 FuelId
)
...
(declare-const fuel%curve25519_dalek!specs.window_specs.is_valid_naf_lookup_table8_affine_coords.
 FuelId
)
...
(assert
 (distinct fuel%vstd!std_specs.num.u8_specs.impl&%2.obeys_cmp_spec. fuel%vstd!std_specs.num.u8_specs.impl&%2.cmp_spec.
  ...
  fuel%vstd!seq.Seq.last. fuel%vstd!seq.axiom_seq_index_decreases. fuel%vstd!seq.axiom_seq_subrange_decreases.
  ...
  fuel%vstd!view.impl&%28.view. fuel%vstd!view.impl&%32.view. fuel%vstd!view.impl&%42.view.
  ...
  fuel%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.straus_column_sum. fuel%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.reconstruct_naf_from.
  fuel%curve25519_dalek!lemmas.edwards_lemmas.vartime_double_base_lemmas.vartime_double_base_shared_input_valid.
  ...
  fuel%curve25519_dalek!specs.scalar_specs.is_valid_naf. fuel%curve25519_dalek!specs.scalar52_specs.group_order.
  fuel%curve25519_dalek!specs.scalar52_specs.group_canonical. fuel%curve25519_dalek!specs.window_specs.naf_lookup_table5_projective_limbs_bounded.
  ...
  fuel%curve25519_dalek!specs.window_specs.is_valid_naf_lookup_table8_affine_coords.
...
(declare-datatypes ((core!cmp.Ordering. 0) (vstd!raw_ptr.PtrData. 0) (curve25519_dalek!backend.serial.u64.field.FieldElement51.
   0
   ...
   0
  ) (curve25519_dalek!edwards.EdwardsPoint. 0) (curve25519_dalek!window.NafLookupTable5.
   0
  ) (curve25519_dalek!window.NafLookupTable8. 0) (tuple%0. 0) (tuple%1. 0) (tuple%2.
   0
  ) (tuple%3. 0) (tuple%4. 0)
...
;; Function-Decl curve25519_dalek::backend::serial::u64::constants::AFFINE_ODD_MULTIPLES_OF_BASEPOINT
(declare-fun curve25519_dalek!backend.serial.u64.constants.AFFINE_ODD_MULTIPLES_OF_BASEPOINT.?
...
;; Function-Decl curve25519_dalek::lemmas::edwards_lemmas::vartime_double_base_lemmas::vartime_double_base_shared_input_valid
(declare-fun curve25519_dalek!lemmas.edwards_lemmas.vartime_double_base_lemmas.vartime_double_base_shared_input_valid.?
 (Poly Poly Poly Poly Poly Poly Poly Poly Poly) Bool
)
...
;; Function-Decl curve25519_dalek::specs::window_specs::is_valid_naf_lookup_table8_affine_coords
(declare-fun curve25519_dalek!specs.window_specs.is_valid_naf_lookup_table8_affine_coords.?
 (Poly Poly) Bool
)
...
(assert
 (forall ((closure%$ Poly) (Self%&. Dcr) (Self%& Type) (T&. Dcr) (T& Type)) (!
   ...
   :qid user_core__convert__From__from_26
   :skolemid skolem_user_core__convert__From__from_26
)))
(assert
 (forall ((closure%$ Poly) (ret$ Poly) (Self%&. Dcr) (Self%& Type) (T&. Dcr) (T& Type))
  (!
   ...
   :qid user_core__convert__From__from_27
   :skolemid skolem_user_core__convert__From__from_27
)))
...
;; Function-Specs curve25519_dalek::backend::serial::u64::constants::ED25519_BASEPOINT_POINT
(declare-fun ens%curve25519_dalek!backend.serial.u64.constants.ED25519_BASEPOINT_POINT.
 (curve25519_dalek!edwards.EdwardsPoint.) Bool
)
(assert
 (forall ((%return! curve25519_dalek!edwards.EdwardsPoint.)) (!
   (= (ens%curve25519_dalek!backend.serial.u64.constants.ED25519_BASEPOINT_POINT. %return!)
    (and
     (has_type (Poly%curve25519_dalek!edwards.EdwardsPoint. %return!) TYPE%curve25519_dalek!edwards.EdwardsPoint.)
   ...
   :pattern ((ens%curve25519_dalek!backend.serial.u64.constants.ED25519_BASEPOINT_POINT.
     %return!
   ))
   :qid internal_ens__curve25519_dalek!backend.serial.u64.constants.ED25519_BASEPOINT_POINT._definition
   :skolemid skolem_internal_ens__curve25519_dalek!backend.serial.u64.constants.ED25519_BASEPOINT_POINT._definition
)))

;; Function-Axioms curve25519_dalek::backend::serial::u64::constants::AFFINE_ODD_MULTIPLES_OF_BASEPOINT
(assert
 (has_type (Poly%curve25519_dalek!window.NafLookupTable8. curve25519_dalek!backend.serial.u64.constants.AFFINE_ODD_MULTIPLES_OF_BASEPOINT.?)
  (TYPE%curve25519_dalek!window.NafLookupTable8. $ TYPE%curve25519_dalek!backend.serial.curve_models.AffineNielsPoint.)
))
  ...
  (forall ((niels! Poly)) (!
    (= (curve25519_dalek!specs.edwards_specs.is_valid_projective_niels_point.? niels!)
     (exists ((point$ Poly)) (!
       ...
       :qid user_curve25519_dalek__specs__edwards_specs__is_valid_projective_niels_point_30
       :skolemid skolem_user_curve25519_dalek__specs__edwards_specs__is_valid_projective_niels_point_30
    )))
  ...
  (forall ((naf! Poly) (w! Poly)) (!
    (= (curve25519_dalek!specs.scalar_specs.is_valid_naf.? naf! w!) (forall ((i$ Poly))
      (!
       ...
       :qid user_curve25519_dalek__specs__scalar_specs__is_valid_naf_32
       :skolemid skolem_user_curve25519_dalek__specs__scalar_specs__is_valid_naf_32
    )))
  ...
  (forall ((table! Poly) (A! Poly)) (!
    (= (curve25519_dalek!specs.window_specs.is_valid_naf_lookup_table5_projective.? table!
      A!
       ...
       :qid user_curve25519_dalek__specs__window_specs__is_valid_naf_lookup_table5_projective_33
       :skolemid skolem_user_curve25519_dalek__specs__window_specs__is_valid_naf_lookup_table5_projective_33
    )))
  ...
  (forall ((table! Poly)) (!
    (= (curve25519_dalek!specs.window_specs.naf_lookup_table5_projective_limbs_bounded.?
      table!
       ...
       :qid user_curve25519_dalek__specs__window_specs__naf_lookup_table5_projective_limbs_bounded_34
       :skolemid skolem_user_curve25519_dalek__specs__window_specs__naf_lookup_table5_projective_limbs_bounded_34
    )))
...
;; Function-Axioms curve25519_dalek::lemmas::edwards_lemmas::vartime_double_base_lemmas::vartime_double_base_shared_input_valid
(assert
 (fuel_bool_default fuel%curve25519_dalek!lemmas.edwards_lemmas.vartime_double_base_lemmas.vartime_double_base_shared_input_valid.)
)
(assert
 (=>
  (fuel_bool fuel%curve25519_dalek!lemmas.edwards_lemmas.vartime_double_base_lemmas.vartime_double_base_shared_input_valid.)
  (forall ((A_affine! Poly) (B_affine! Poly) (pts_affine! Poly) (a_naf! Poly) (b_naf!
     Poly
    ) (nafs! Poly) (table_A! Poly) (A! Poly) (bp! Poly)
   ) (!
    (= (curve25519_dalek!lemmas.edwards_lemmas.vartime_double_base_lemmas.vartime_double_base_shared_input_valid.?
      A_affine! B_affine! pts_affine! a_naf! b_naf! nafs! table_A! A! bp!
     ) (and
      (and
       (and
        (and
                  ...
                  (and
                   (and
                    (and
                     (and
                      (and
                       (< (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. A_affine!))) (curve25519_dalek!specs.field_specs_u64.p.?
                         (I 0)
                       ))
                       (< (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. A_affine!))) (curve25519_dalek!specs.field_specs_u64.p.?
                         (I 0)
                      )))
                      (< (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. B_affine!))) (curve25519_dalek!specs.field_specs_u64.p.?
                        (I 0)
                     )))
                     (< (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. B_affine!))) (curve25519_dalek!specs.field_specs_u64.p.?
                       (I 0)
                    )))
                    (= (%Poly%tuple%2. A_affine!) (curve25519_dalek!specs.edwards_specs.edwards_point_as_affine.?
                      A!
                   )))
                   (= (%Poly%tuple%2. B_affine!) (curve25519_dalek!specs.edwards_specs.edwards_point_as_affine.?
                     bp!
                  )))
                  (= (vstd!seq.Seq.len.? $ (SINT 8) a_naf!) 256)
                 )
                 (= (vstd!seq.Seq.len.? $ (SINT 8) b_naf!) 256)
                )
                (= (vstd!seq.Seq.len.? (DST $) (TYPE%tuple%2. $ NAT $ NAT) pts_affine!) 2)
               )
               (= (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2. $ NAT $ NAT) pts_affine! (I 0)) A_affine!)
              )
              (= (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2. $ NAT $ NAT) pts_affine! (I 1)) B_affine!)
             )
             (= (vstd!seq.Seq.len.? $ (TYPE%vstd!seq.Seq. $ (SINT 8)) nafs!) 2)
            )
            (= (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq. $ (SINT 8)) nafs! (I 0)) a_naf!)
           )
           (= (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq. $ (SINT 8)) nafs! (I 1)) b_naf!)
          )
          (curve25519_dalek!specs.scalar_specs.is_valid_naf.? a_naf! (I 5))
         )
         (curve25519_dalek!specs.scalar_specs.is_valid_naf.? b_naf! (I 8))
        )
        (curve25519_dalek!specs.window_specs.naf_lookup_table5_projective_limbs_bounded.?
         table_A!
       ))
       (curve25519_dalek!specs.window_specs.is_valid_naf_lookup_table5_projective.? table_A!
        A!
      ))
      (forall ((j$ Poly)) (!
        (=>
        ...
        :qid user_curve25519_dalek__lemmas__edwards_lemmas__vartime_double_base_lemmas__vartime_double_base_shared_input_valid_35
        :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__vartime_double_base_lemmas__vartime_double_base_shared_input_valid_35
    ))))
    :pattern ((curve25519_dalek!lemmas.edwards_lemmas.vartime_double_base_lemmas.vartime_double_base_shared_input_valid.?
      A_affine! B_affine! pts_affine! a_naf! b_naf! nafs! table_A! A! bp!
    ))
    :qid internal_curve25519_dalek!lemmas.edwards_lemmas.vartime_double_base_lemmas.vartime_double_base_shared_input_valid.?_definition
    :skolemid skolem_internal_curve25519_dalek!lemmas.edwards_lemmas.vartime_double_base_lemmas.vartime_double_base_shared_input_valid.?_definition
))))
  ...
  (forall ((niels! Poly)) (!
    (= (curve25519_dalek!specs.edwards_specs.is_valid_affine_niels_point.? niels!) (exists
      ((point$ Poly)) (!
       ...
       :qid user_curve25519_dalek__specs__edwards_specs__is_valid_affine_niels_point_36
       :skolemid skolem_user_curve25519_dalek__specs__edwards_specs__is_valid_affine_niels_point_36
    )))
  ...
  (forall ((table! Poly)) (!
    (= (curve25519_dalek!specs.window_specs.naf_lookup_table5_affine_limbs_bounded.? table!)
     (forall ((j$ Poly)) (!
       ...
       :qid user_curve25519_dalek__specs__window_specs__naf_lookup_table5_affine_limbs_bounded_37
       :skolemid skolem_user_curve25519_dalek__specs__window_specs__naf_lookup_table5_affine_limbs_bounded_37
    )))
  ...
  (forall ((table! Poly) (A! Poly)) (!
    (= (curve25519_dalek!specs.window_specs.is_valid_naf_lookup_table5_affine.? table!
      A!
       ...
       :qid user_curve25519_dalek__specs__window_specs__is_valid_naf_lookup_table5_affine_38
       :skolemid skolem_user_curve25519_dalek__specs__window_specs__is_valid_naf_lookup_table5_affine_38
    )))
  ...
  (forall ((table! Poly)) (!
    (= (curve25519_dalek!specs.window_specs.naf_lookup_table8_projective_limbs_bounded.?
      table!
       ...
       :qid user_curve25519_dalek__specs__window_specs__naf_lookup_table8_projective_limbs_bounded_39
       :skolemid skolem_user_curve25519_dalek__specs__window_specs__naf_lookup_table8_projective_limbs_bounded_39
    )))
  ...
  (forall ((table! Poly)) (!
    (= (curve25519_dalek!specs.window_specs.naf_lookup_table8_affine_limbs_bounded.? table!)
     (forall ((j$ Poly)) (!
       ...
       :qid user_curve25519_dalek__specs__window_specs__naf_lookup_table8_affine_limbs_bounded_40
       :skolemid skolem_user_curve25519_dalek__specs__window_specs__naf_lookup_table8_affine_limbs_bounded_40
    )))
  ...
  (forall ((table! Poly) (A! Poly)) (!
    (= (curve25519_dalek!specs.window_specs.is_valid_naf_lookup_table8_projective.? table!
      A!
       ...
       :qid user_curve25519_dalek__specs__window_specs__is_valid_naf_lookup_table8_projective_41
       :skolemid skolem_user_curve25519_dalek__specs__window_specs__is_valid_naf_lookup_table8_projective_41
    )))
  ...
  (forall ((table! Poly) (A! Poly)) (!
    (= (curve25519_dalek!specs.window_specs.is_valid_naf_lookup_table8_affine.? table!
      A!
       ...
       :qid user_curve25519_dalek__specs__window_specs__is_valid_naf_lookup_table8_affine_42
       :skolemid skolem_user_curve25519_dalek__specs__window_specs__is_valid_naf_lookup_table8_affine_42
    )))
...
;; Function-Axioms curve25519_dalek::specs::window_specs::is_valid_naf_lookup_table8_affine_coords
(assert
 (fuel_bool_default fuel%curve25519_dalek!specs.window_specs.is_valid_naf_lookup_table8_affine_coords.)
)
(assert
 (=>
  (fuel_bool fuel%curve25519_dalek!specs.window_specs.is_valid_naf_lookup_table8_affine_coords.)
  (forall ((table! Poly) (basepoint! Poly)) (!
    (= (curve25519_dalek!specs.window_specs.is_valid_naf_lookup_table8_affine_coords.?
      table! basepoint!
     ) (forall ((j$ Poly)) (!
       (=>
        (has_type j$ INT)
       ...
       :qid user_curve25519_dalek__specs__window_specs__is_valid_naf_lookup_table8_affine_coords_43
       :skolemid skolem_user_curve25519_dalek__specs__window_specs__is_valid_naf_lookup_table8_affine_coords_43
    )))
    :pattern ((curve25519_dalek!specs.window_specs.is_valid_naf_lookup_table8_affine_coords.?
      table! basepoint!
    ))
    :qid internal_curve25519_dalek!specs.window_specs.is_valid_naf_lookup_table8_affine_coords.?_definition
    :skolemid skolem_internal_curve25519_dalek!specs.window_specs.is_valid_naf_lookup_table8_affine_coords.?_definition
))))
...
(assert
 (forall ((closure%$ Poly) (result$ Poly)) (!
   ...
   :qid user_curve25519_dalek__scalar__Scalar__from_44
   :skolemid skolem_user_curve25519_dalek__scalar__Scalar__from_44
)))
 ...
 (forall ((A! Poly) (result! Poly)) (!
   (= (ens%curve25519_dalek!window.impl&%17.from. A! result!) (and
     ...
     (forall ((j$ Poly)) (!
       ...
       :qid user_curve25519_dalek__window__NafLookupTable5__from_49
       :skolemid skolem_user_curve25519_dalek__window__NafLookupTable5__from_49
   ))))
...
(assert
 (forall ((closure%$ Poly) (result$ Poly)) (!
     ...
     (let
      ...
      (and
       ...
       (forall ((j$ Poly)) (!
         ...
         :qid user_curve25519_dalek__window__NafLookupTable5__from_50
         :skolemid skolem_user_curve25519_dalek__window__NafLookupTable5__from_50
   ))))))
   ...
   :qid user_curve25519_dalek__window__NafLookupTable5__from_51
   :skolemid skolem_user_curve25519_dalek__window__NafLookupTable5__from_51
)))
...
(assert
 (forall ((closure%$ Poly) (result$ Poly)) (!
   ...
   :qid user_curve25519_dalek__window__NafLookupTable5__from_52
   :skolemid skolem_user_curve25519_dalek__window__NafLookupTable5__from_52
)))
...
(assert
 (forall ((closure%$ Poly) (result$ Poly)) (!
   ...
   :qid user_curve25519_dalek__window__NafLookupTable8__from_53
   :skolemid skolem_user_curve25519_dalek__window__NafLookupTable8__from_53
)))
...
(assert
 (forall ((closure%$ Poly) (result$ Poly)) (!
   ...
   :qid user_curve25519_dalek__window__NafLookupTable8__from_54
   :skolemid skolem_user_curve25519_dalek__window__NafLookupTable8__from_54
)))
...
;; Function-Specs curve25519_dalek::specs::window_specs::axiom_affine_odd_multiples_of_basepoint_valid
(declare-fun ens%curve25519_dalek!specs.window_specs.axiom_affine_odd_multiples_of_basepoint_valid.
 (Int) Bool
)
(assert
 (forall ((no%param Int)) (!
   (= (ens%curve25519_dalek!specs.window_specs.axiom_affine_odd_multiples_of_basepoint_valid.
     no%param
    ) (and
     (curve25519_dalek!specs.window_specs.naf_lookup_table8_affine_limbs_bounded.? (Poly%array%.
       (curve25519_dalek!window.NafLookupTable8./NafLookupTable8/0 (%Poly%curve25519_dalek!window.NafLookupTable8.
         (Poly%curve25519_dalek!window.NafLookupTable8. curve25519_dalek!backend.serial.u64.constants.AFFINE_ODD_MULTIPLES_OF_BASEPOINT.?)
     ))))
     (forall ((j$ Poly)) (!
       (=>
        (has_type j$ INT)
       ...
       :qid user_curve25519_dalek__specs__window_specs__axiom_affine_odd_multiples_of_basepoint_valid_55
       :skolemid skolem_user_curve25519_dalek__specs__window_specs__axiom_affine_odd_multiples_of_basepoint_valid_55
     ))
     (curve25519_dalek!specs.window_specs.is_valid_naf_lookup_table8_affine_coords.? (Poly%array%.
       (curve25519_dalek!window.NafLookupTable8./NafLookupTable8/0 (%Poly%curve25519_dalek!window.NafLookupTable8.
         (Poly%curve25519_dalek!window.NafLookupTable8. curve25519_dalek!backend.serial.u64.constants.AFFINE_ODD_MULTIPLES_OF_BASEPOINT.?)
       ))
      ) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.spec_ed25519_basepoint.? (I 0)))
   )))
   :pattern ((ens%curve25519_dalek!specs.window_specs.axiom_affine_odd_multiples_of_basepoint_valid.
     no%param
   ))
   :qid internal_ens__curve25519_dalek!specs.window_specs.axiom_affine_odd_multiples_of_basepoint_valid._definition
   :skolemid skolem_internal_ens__curve25519_dalek!specs.window_specs.axiom_affine_odd_multiples_of_basepoint_valid._definition
)))
   ...
   (= (req%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_column_sum_canonical.
     ...
     (=>
      ...
      (forall ((k$ Poly)) (!
        ...
        :qid user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_column_sum_canonical_56
        :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_column_sum_canonical_56
     )))
     (=>
      ...
      (forall ((k$ Poly)) (!
        ...
        :qid user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_column_sum_canonical_57
        :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_column_sum_canonical_57
   )))))
   ...
   (= (req%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_vt_zero_suffix.
     ...
     (=>
      ...
      (forall ((k$ Poly)) (!
        ...
        :qid user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_straus_vt_zero_suffix_58
        :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_straus_vt_zero_suffix_58
     )))
     (=>
   ...
   (= (req%curve25519_dalek!window.impl&%15.select. self! x!) (and
     ...
     (=>
      ...
      (forall ((j$ Poly)) (!
        ...
        :qid user_curve25519_dalek__window__NafLookupTable5__select_61
        :skolemid skolem_user_curve25519_dalek__window__NafLookupTable5__select_61
   )))))
   ...
   (= (req%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_naf_select_is_signed_scalar_mul_projective.
     ...
     (=>
      ...
      (forall ((j$ Poly)) (!
        ...
        :qid user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_naf_select_is_signed_scalar_mul_projective_62
        :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_naf_select_is_signed_scalar_mul_projective_62
     )))
     (=>
...
;; Function-Specs curve25519_dalek::lemmas::edwards_lemmas::vartime_double_base_lemmas::lemma_vartime_double_base_col_a
(declare-fun req%curve25519_dalek!lemmas.edwards_lemmas.vartime_double_base_lemmas.lemma_vartime_double_base_col_a.
 (vstd!seq.Seq<tuple%2<nat./nat.>.>. vstd!seq.Seq<vstd!seq.Seq<i8.>.>. tuple%2. vstd!seq.Seq<i8.>.
  Int
 ) Bool
)
...
(assert
 (forall ((pts_affine! vstd!seq.Seq<tuple%2<nat./nat.>.>.) (nafs! vstd!seq.Seq<vstd!seq.Seq<i8.>.>.)
   (A_affine! tuple%2.) (a_naf! vstd!seq.Seq<i8.>.) (i! Int)
  ) (!
   (= (req%curve25519_dalek!lemmas.edwards_lemmas.vartime_double_base_lemmas.lemma_vartime_double_base_col_a.
     pts_affine! nafs! A_affine! a_naf! i!
    ) (and
     (=>
     ...
     (=>
      ...
      (= (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. a_naf!)) 256)
     )
     (=>
     ...
     (=>
      ...
      (= (%Poly%vstd!seq.Seq<i8.>. (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq. $ (SINT 8))
     ...
     (=>
      ...
      (< (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. A_affine!)))) (curve25519_dalek!specs.field_specs_u64.p.?
        (I 0)
     )))
     (=>
      %%global_location_label%%76
      (< (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. A_affine!)))) (curve25519_dalek!specs.field_specs_u64.p.?
        (I 0)
   )))))
   :pattern ((req%curve25519_dalek!lemmas.edwards_lemmas.vartime_double_base_lemmas.lemma_vartime_double_base_col_a.
     pts_affine! nafs! A_affine! a_naf! i!
   ))
   :qid internal_req__curve25519_dalek!lemmas.edwards_lemmas.vartime_double_base_lemmas.lemma_vartime_double_base_col_a._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.edwards_lemmas.vartime_double_base_lemmas.lemma_vartime_double_base_col_a._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.edwards_lemmas.vartime_double_base_lemmas.lemma_vartime_double_base_col_a.
 (vstd!seq.Seq<tuple%2<nat./nat.>.>. vstd!seq.Seq<vstd!seq.Seq<i8.>.>. tuple%2. vstd!seq.Seq<i8.>.
  Int
 ) Bool
)
(assert
 (forall ((pts_affine! vstd!seq.Seq<tuple%2<nat./nat.>.>.) (nafs! vstd!seq.Seq<vstd!seq.Seq<i8.>.>.)
   ...
   (= (ens%curve25519_dalek!lemmas.edwards_lemmas.vartime_double_base_lemmas.lemma_vartime_double_base_col_a.
     pts_affine! nafs! A_affine! a_naf! i!
    ) (= (curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.straus_column_sum.? (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>.
       pts_affine!
      ) (Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>. nafs!) (I i!) (I 1)
     ) (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul_signed.? (Poly%tuple%2.
       A_affine!
      ) (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. a_naf!) (I i!))
   )))
   :pattern ((ens%curve25519_dalek!lemmas.edwards_lemmas.vartime_double_base_lemmas.lemma_vartime_double_base_col_a.
     pts_affine! nafs! A_affine! a_naf! i!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.edwards_lemmas.vartime_double_base_lemmas.lemma_vartime_double_base_col_a._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.edwards_lemmas.vartime_double_base_lemmas.lemma_vartime_double_base_col_a._definition
)))
...
;; Function-Specs curve25519_dalek::lemmas::edwards_lemmas::straus_lemmas::lemma_naf_digit_positive_select_preconditions_width8
(declare-fun req%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_naf_digit_positive_select_preconditions_width8.
 (Int) Bool
)
...
(assert
 (forall ((digit! Int)) (!
   (= (req%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_naf_digit_positive_select_preconditions_width8.
     digit!
    ) (and
     (=>
   ...
   :pattern ((req%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_naf_digit_positive_select_preconditions_width8.
     digit!
   ))
   :qid internal_req__curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_naf_digit_positive_select_preconditions_width8._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_naf_digit_positive_select_preconditions_width8._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_naf_digit_positive_select_preconditions_width8.
 (Int) Bool
)
(assert
 (forall ((digit! Int)) (!
   (= (ens%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_naf_digit_positive_select_preconditions_width8.
     digit!
    ) (and
     (= (uClip SZ (bitand (I (uClip SZ digit!)) (I 1))) 1)
     (< (uClip SZ digit!) 128)
   ))
   :pattern ((ens%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_naf_digit_positive_select_preconditions_width8.
     digit!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_naf_digit_positive_select_preconditions_width8._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_naf_digit_positive_select_preconditions_width8._definition
)))

;; Function-Specs curve25519_dalek::window::NafLookupTable8::select
(declare-fun req%curve25519_dalek!window.impl&%21.select. (curve25519_dalek!window.NafLookupTable8.
  Int
 ) Bool
)
...
(assert
 (forall ((self! curve25519_dalek!window.NafLookupTable8.) (x! Int)) (!
   (= (req%curve25519_dalek!window.impl&%21.select. self! x!) (and
     (=>
     ...
     (=>
      ...
      (curve25519_dalek!specs.window_specs.naf_lookup_table8_affine_limbs_bounded.? (Poly%array%.
        (curve25519_dalek!window.NafLookupTable8./NafLookupTable8/0 (%Poly%curve25519_dalek!window.NafLookupTable8.
          (Poly%curve25519_dalek!window.NafLookupTable8. self!)
     )))))
     (=>
      ...
      (forall ((j$ Poly)) (!
        ...
        :qid user_curve25519_dalek__window__NafLookupTable8__select_63
        :skolemid skolem_user_curve25519_dalek__window__NafLookupTable8__select_63
   )))))
   :pattern ((req%curve25519_dalek!window.impl&%21.select. self! x!))
   :qid internal_req__curve25519_dalek!window.impl&__21.select._definition
   :skolemid skolem_internal_req__curve25519_dalek!window.impl&__21.select._definition
)))
(declare-fun ens%curve25519_dalek!window.impl&%21.select. (curve25519_dalek!window.NafLookupTable8.
  Int curve25519_dalek!backend.serial.curve_models.AffineNielsPoint.
 ) Bool
)
(assert
 (forall ((self! curve25519_dalek!window.NafLookupTable8.) (x! Int) (result! curve25519_dalek!backend.serial.curve_models.AffineNielsPoint.))
  (!
   (= (ens%curve25519_dalek!window.impl&%21.select. self! x! result!) (and
   ...
   :pattern ((ens%curve25519_dalek!window.impl&%21.select. self! x! result!))
   :qid internal_ens__curve25519_dalek!window.impl&__21.select._definition
   :skolemid skolem_internal_ens__curve25519_dalek!window.impl&__21.select._definition
)))

;; Function-Specs curve25519_dalek::lemmas::edwards_lemmas::straus_lemmas::lemma_naf_select_is_signed_scalar_mul_affine8
(declare-fun req%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_naf_select_is_signed_scalar_mul_affine8.
...
(assert
 (forall ((table! %%Function%%) (digit! Int) (result! curve25519_dalek!backend.serial.curve_models.AffineNielsPoint.)
   (basepoint! tuple%2.)
  ) (!
   (= (req%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_naf_select_is_signed_scalar_mul_affine8.
     table! digit! result! basepoint!
    ) (and
     (=>
     ...
     (=>
      ...
      (forall ((j$ Poly)) (!
        ...
        :qid user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_naf_select_is_signed_scalar_mul_affine8_64
        :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_naf_select_is_signed_scalar_mul_affine8_64
     )))
     (=>
   ...
   :pattern ((req%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_naf_select_is_signed_scalar_mul_affine8.
     table! digit! result! basepoint!
   ))
   :qid internal_req__curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_naf_select_is_signed_scalar_mul_affine8._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_naf_select_is_signed_scalar_mul_affine8._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_naf_select_is_signed_scalar_mul_affine8.
 (%%Function%% Int curve25519_dalek!backend.serial.curve_models.AffineNielsPoint. tuple%2.)
 Bool
)
(assert
 (forall ((table! %%Function%%) (digit! Int) (result! curve25519_dalek!backend.serial.curve_models.AffineNielsPoint.)
   ...
   (= (ens%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_naf_select_is_signed_scalar_mul_affine8.
     table! digit! result! basepoint!
   ...
   :pattern ((ens%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_naf_select_is_signed_scalar_mul_affine8.
     table! digit! result! basepoint!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_naf_select_is_signed_scalar_mul_affine8._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_naf_select_is_signed_scalar_mul_affine8._definition
)))

;; Function-Specs curve25519_dalek::lemmas::edwards_lemmas::vartime_double_base_lemmas::lemma_vartime_double_base_col_ab
(declare-fun req%curve25519_dalek!lemmas.edwards_lemmas.vartime_double_base_lemmas.lemma_vartime_double_base_col_ab.
 (vstd!seq.Seq<tuple%2<nat./nat.>.>. vstd!seq.Seq<vstd!seq.Seq<i8.>.>. tuple%2. vstd!seq.Seq<i8.>.
  Int
 ) Bool
)
...
(assert
 (forall ((pts_affine! vstd!seq.Seq<tuple%2<nat./nat.>.>.) (nafs! vstd!seq.Seq<vstd!seq.Seq<i8.>.>.)
   (B_affine! tuple%2.) (b_naf! vstd!seq.Seq<i8.>.) (i! Int)
  ) (!
   (= (req%curve25519_dalek!lemmas.edwards_lemmas.vartime_double_base_lemmas.lemma_vartime_double_base_col_ab.
     pts_affine! nafs! B_affine! b_naf! i!
    ) (and
     (=>
     ...
     (=>
      ...
      (= (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. b_naf!)) 256)
     )
     (=>
     ...
     (=>
      ...
      (= (%Poly%vstd!seq.Seq<i8.>. (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq. $ (SINT 8))
         (Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>. nafs!) (I 1)
        )
       ) b_naf!
   ))))
   :pattern ((req%curve25519_dalek!lemmas.edwards_lemmas.vartime_double_base_lemmas.lemma_vartime_double_base_col_ab.
     pts_affine! nafs! B_affine! b_naf! i!
   ))
   :qid internal_req__curve25519_dalek!lemmas.edwards_lemmas.vartime_double_base_lemmas.lemma_vartime_double_base_col_ab._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.edwards_lemmas.vartime_double_base_lemmas.lemma_vartime_double_base_col_ab._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.edwards_lemmas.vartime_double_base_lemmas.lemma_vartime_double_base_col_ab.
 (vstd!seq.Seq<tuple%2<nat./nat.>.>. vstd!seq.Seq<vstd!seq.Seq<i8.>.>. tuple%2. vstd!seq.Seq<i8.>.
  Int
 ) Bool
)
(assert
 (forall ((pts_affine! vstd!seq.Seq<tuple%2<nat./nat.>.>.) (nafs! vstd!seq.Seq<vstd!seq.Seq<i8.>.>.)
   ...
   (= (ens%curve25519_dalek!lemmas.edwards_lemmas.vartime_double_base_lemmas.lemma_vartime_double_base_col_ab.
     pts_affine! nafs! B_affine! b_naf! i!
    ) (= (curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.straus_column_sum.? (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>.
       pts_affine!
      ) (Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>. nafs!) (I i!) (I 2)
     ) (curve25519_dalek!specs.edwards_specs.edwards_add.? (tuple%2./tuple%2/0 (%Poly%tuple%2.
        (Poly%tuple%2. (curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.straus_column_sum.?
          (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. pts_affine!) (Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>.
           nafs!
          ) (I i!) (I 1)
       )))
      ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. (curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.straus_column_sum.?
          (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. pts_affine!) (Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>.
           nafs!
          ) (I i!) (I 1)
       )))
      ) (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul_signed.?
          (Poly%tuple%2. B_affine!) (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
            b_naf!
           ) (I i!)
       ))))
      ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul_signed.?
          (Poly%tuple%2. B_affine!) (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
            b_naf!
           ) (I i!)
   ))))))))
   :pattern ((ens%curve25519_dalek!lemmas.edwards_lemmas.vartime_double_base_lemmas.lemma_vartime_double_base_col_ab.
     pts_affine! nafs! B_affine! b_naf! i!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.edwards_lemmas.vartime_double_base_lemmas.lemma_vartime_double_base_col_ab._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.edwards_lemmas.vartime_double_base_lemmas.lemma_vartime_double_base_col_ab._definition
)))

;; Function-Specs curve25519_dalek::lemmas::edwards_lemmas::straus_lemmas::lemma_naf_digit_negative_select_preconditions_width8
(declare-fun req%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_naf_digit_negative_select_preconditions_width8.
 (Int) Bool
)
...
(assert
 (forall ((digit! Int)) (!
   (= (req%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_naf_digit_negative_select_preconditions_width8.
     digit!
    ) (and
     (=>
   ...
   :pattern ((req%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_naf_digit_negative_select_preconditions_width8.
     digit!
   ))
   :qid internal_req__curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_naf_digit_negative_select_preconditions_width8._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_naf_digit_negative_select_preconditions_width8._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_naf_digit_negative_select_preconditions_width8.
 (Int) Bool
)
(assert
 (forall ((digit! Int)) (!
   (= (ens%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_naf_digit_negative_select_preconditions_width8.
     digit!
    ) (and
     (= (uClip SZ (bitand (I (uClip SZ (Sub 0 digit!))) (I 1))) 1)
     (< (uClip SZ (Sub 0 digit!)) 128)
   ))
   :pattern ((ens%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_naf_digit_negative_select_preconditions_width8.
     digit!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_naf_digit_negative_select_preconditions_width8._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_naf_digit_negative_select_preconditions_width8._definition
)))
...
;; Function-Specs curve25519_dalek::lemmas::edwards_lemmas::straus_lemmas::lemma_straus_vt_partial_peel_last
(declare-fun req%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_vt_partial_peel_last.
 (vstd!seq.Seq<tuple%2<nat./nat.>.>. vstd!seq.Seq<vstd!seq.Seq<i8.>.>. Int) Bool
)
...
(assert
 (forall ((pts! vstd!seq.Seq<tuple%2<nat./nat.>.>.) (nafs! vstd!seq.Seq<vstd!seq.Seq<i8.>.>.)
   (i! Int)
  ) (!
   (= (req%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_vt_partial_peel_last.
     pts! nafs! i!
    ) (and
     (=>
     ...
     (=>
      ...
      (forall ((k$ Poly)) (!
        ...
        :qid user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_straus_vt_partial_peel_last_65
        :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_straus_vt_partial_peel_last_65
     )))
     (=>
      ...
      (forall ((k$ Poly)) (!
        ...
        :qid user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_straus_vt_partial_peel_last_66
        :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_straus_vt_partial_peel_last_66
   )))))
   :pattern ((req%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_vt_partial_peel_last.
     pts! nafs! i!
   ))
   :qid internal_req__curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_vt_partial_peel_last._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_vt_partial_peel_last._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_vt_partial_peel_last.
 (vstd!seq.Seq<tuple%2<nat./nat.>.>. vstd!seq.Seq<vstd!seq.Seq<i8.>.>. Int) Bool
)
(assert
 (forall ((pts! vstd!seq.Seq<tuple%2<nat./nat.>.>.) (nafs! vstd!seq.Seq<vstd!seq.Seq<i8.>.>.)
   ...
   (= (ens%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_vt_partial_peel_last.
     pts! nafs! i!
    ) (= (curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.straus_vt_partial.? (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>.
       pts!
      ) (Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>. nafs!) (I i!)
     ) (let
      ((prefix_result$ (curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.straus_vt_partial.?
      ...
      (let
       ((single_result$ (curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.straus_vt_partial.?
   ...
   :pattern ((ens%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_vt_partial_peel_last.
     pts! nafs! i!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_vt_partial_peel_last._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_vt_partial_peel_last._definition
)))

;; Function-Specs curve25519_dalek::lemmas::edwards_lemmas::straus_lemmas::lemma_straus_vt_single
(declare-fun req%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_vt_single.
...
(assert
 (forall ((P! tuple%2.) (naf! vstd!seq.Seq<i8.>.) (i! Int)) (!
   (= (req%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_vt_single.
     P! naf! i!
    ) (and
     (=>
   ...
   :pattern ((req%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_vt_single.
     P! naf! i!
   ))
   :qid internal_req__curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_vt_single._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_vt_single._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_vt_single.
 (tuple%2. vstd!seq.Seq<i8.>. Int) Bool
)
(assert
 (forall ((P! tuple%2.) (naf! vstd!seq.Seq<i8.>.) (i! Int)) (!
   (= (ens%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_vt_single.
     P! naf! i!
    ) (= (curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.straus_vt_partial.? (vstd!seq.Seq.push.?
       ...
       P!
      ) (I (curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.reconstruct_naf_from.? (
         Poly%vstd!seq.Seq<i8.>. naf!
        ) (I i!)
   )))))
   :pattern ((ens%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_vt_single.
     P! naf! i!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_vt_single._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_vt_single._definition
)))

;; Function-Specs curve25519_dalek::lemmas::edwards_lemmas::straus_lemmas::lemma_reconstruct_naf_from_equals_reconstruct
(declare-fun req%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_reconstruct_naf_from_equals_reconstruct.
 (vstd!seq.Seq<i8.>.) Bool
)
(declare-const %%global_location_label%%115 Bool)
(assert
 (forall ((naf! vstd!seq.Seq<i8.>.)) (!
   (= (req%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_reconstruct_naf_from_equals_reconstruct.
     naf!
    ) (=>
     %%global_location_label%%115
     (= (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. naf!)) 256)
   ))
   :pattern ((req%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_reconstruct_naf_from_equals_reconstruct.
     naf!
   ))
   :qid internal_req__curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_reconstruct_naf_from_equals_reconstruct._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_reconstruct_naf_from_equals_reconstruct._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_reconstruct_naf_from_equals_reconstruct.
 (vstd!seq.Seq<i8.>.) Bool
)
(assert
 (forall ((naf! vstd!seq.Seq<i8.>.)) (!
   (= (ens%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_reconstruct_naf_from_equals_reconstruct.
     naf!
    ) (= (curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.reconstruct_naf_from.? (
       Poly%vstd!seq.Seq<i8.>. naf!
      ) (I 0)
     ) (curve25519_dalek!specs.scalar_specs.reconstruct.? (Poly%vstd!seq.Seq<i8.>. naf!))
   ))
   :pattern ((ens%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_reconstruct_naf_from_equals_reconstruct.
     naf!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_reconstruct_naf_from_equals_reconstruct._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_reconstruct_naf_from_equals_reconstruct._definition
)))

;; Function-Specs curve25519_dalek::backend::serial::scalar_mul::vartime_double_base::mul
(declare-fun req%curve25519_dalek!backend.serial.scalar_mul.vartime_double_base.mul.
 (curve25519_dalek!scalar.Scalar. curve25519_dalek!edwards.EdwardsPoint. curve25519_dalek!scalar.Scalar.)
 Bool
)
...
(assert
 (forall ((a! curve25519_dalek!scalar.Scalar.) (A! curve25519_dalek!edwards.EdwardsPoint.)
   (b! curve25519_dalek!scalar.Scalar.)
  ) (!
   (= (req%curve25519_dalek!backend.serial.scalar_mul.vartime_double_base.mul. a! A! b!)
    (and
     (=>
   ...
   :pattern ((req%curve25519_dalek!backend.serial.scalar_mul.vartime_double_base.mul.
     a! A! b!
   ))
   :qid internal_req__curve25519_dalek!backend.serial.scalar_mul.vartime_double_base.mul._definition
   :skolemid skolem_internal_req__curve25519_dalek!backend.serial.scalar_mul.vartime_double_base.mul._definition
)))
(declare-fun ens%curve25519_dalek!backend.serial.scalar_mul.vartime_double_base.mul.
 (curve25519_dalek!scalar.Scalar. curve25519_dalek!edwards.EdwardsPoint. curve25519_dalek!scalar.Scalar.
  curve25519_dalek!edwards.EdwardsPoint.
 ) Bool
)
(assert
 (forall ((a! curve25519_dalek!scalar.Scalar.) (A! curve25519_dalek!edwards.EdwardsPoint.)
   (b! curve25519_dalek!scalar.Scalar.) (out! curve25519_dalek!edwards.EdwardsPoint.)
  ) (!
   (= (ens%curve25519_dalek!backend.serial.scalar_mul.vartime_double_base.mul. a! A! b!
     out!
    ) (and
     (has_type (Poly%curve25519_dalek!edwards.EdwardsPoint. out!) TYPE%curve25519_dalek!edwards.EdwardsPoint.)
     (curve25519_dalek!specs.edwards_specs.is_well_formed_edwards_point.? (Poly%curve25519_dalek!edwards.EdwardsPoint.
       out!
     ))
     (= (curve25519_dalek!specs.edwards_specs.edwards_point_as_affine.? (Poly%curve25519_dalek!edwards.EdwardsPoint.
       ...
       ((aA$ (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_point_as_affine.?
            (Poly%curve25519_dalek!edwards.EdwardsPoint. A!)
           )
       ...
       (let
        ((bB$ (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.spec_ed25519_basepoint.?
             (I 0)
            )
           ) (I (curve25519_dalek!specs.scalar_specs.scalar_as_nat.? (Poly%curve25519_dalek!scalar.Scalar.
              b!
   ...
   :pattern ((ens%curve25519_dalek!backend.serial.scalar_mul.vartime_double_base.mul.
     a! A! b! out!
   ))
   :qid internal_ens__curve25519_dalek!backend.serial.scalar_mul.vartime_double_base.mul._definition
   :skolemid skolem_internal_ens__curve25519_dalek!backend.serial.scalar_mul.vartime_double_base.mul._definition
)))

;; Function-Def curve25519_dalek::backend::serial::scalar_mul::vartime_double_base::mul
;; curve25519-dalek/src/backend/serial/scalar_mul/vartime_double_base.rs:100:5: 100:9 (#0)
(get-info :all-statistics)
(push)
 (declare-const out! curve25519_dalek!edwards.EdwardsPoint.)
 (declare-const a! curve25519_dalek!scalar.Scalar.)
 (declare-const A! curve25519_dalek!edwards.EdwardsPoint.)
 (declare-const b! curve25519_dalek!scalar.Scalar.)
 (declare-const verus_tmp_A_affine@ tuple%2.)
 (declare-const verus_tmp_B_affine@ tuple%2.)
 (declare-const verus_tmp_pts_affine@ vstd!seq.Seq<tuple%2<nat./nat.>.>.)
 (declare-const verus_tmp_nafs@ vstd!seq.Seq<vstd!seq.Seq<i8.>.>.)
 ...
 (declare-const verus_tmp_old_i@ Int)
 (declare-const verus_tmp_prev_partial@ tuple%2.)
 (declare-const verus_tmp_doubled_affine@ tuple%2.)
 (declare-const verus_tmp_col_a@ tuple%2.)
 ...
 (declare-const tmp%36 curve25519_dalek!window.NafLookupTable5.)
 (declare-const tmp%37 Poly)
 (declare-const tmp%38 Bool)
 (declare-const tmp%39 %%Function%%)
 (declare-const tmp%40 tuple%2.)
 (declare-const tmp%41 Bool)
 (declare-const tmp%42 Bool)
 (declare-const tmp%43 vstd!seq.Seq<i8.>.)
 (declare-const tmp%44 Bool)
 (declare-const tmp%45 Bool)
 (declare-const digit$1@ Int)
 (declare-const term_a@ tuple%2.)
 (declare-const selected_A@ curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.)
 (declare-const t_ext@ curve25519_dalek!edwards.EdwardsPoint.)
 (declare-const digit$2@ Int)
 (declare-const tmp%46 Poly)
 (declare-const tmp%47 Int)
 (declare-const tmp%48 curve25519_dalek!window.NafLookupTable5.)
 (declare-const tmp%49 Int)
 (declare-const tmp%50 Poly)
 (declare-const tmp%51 Bool)
 (declare-const tmp%52 %%Function%%)
 (declare-const tmp%53 tuple%2.)
 (declare-const tmp%54 Bool)
 (declare-const tmp%55 Bool)
 (declare-const tmp%56 Bool)
 (declare-const tmp%57 vstd!seq.Seq<i8.>.)
 (declare-const tmp%58 Bool)
 (declare-const tmp%59 Bool)
 (declare-const digit$3@ Int)
 (declare-const abs_digit@ Int)
 (declare-const term_a$1@ tuple%2.)
 (declare-const selected_A$1@ curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.)
 (declare-const t_ext$1@ curve25519_dalek!edwards.EdwardsPoint.)
 (declare-const tmp%%$6@ core!cmp.Ordering.)
 (declare-const tmp%60 Bool)
 (declare-const verus_tmp_col_ab@ tuple%2.)
 (declare-const tmp%61 Poly)
 (declare-const tmp%62 Poly)
 (declare-const digit$4@ Int)
 (declare-const tmp%63 Poly)
 (declare-const tmp%64 curve25519_dalek!window.NafLookupTable8.)
 (declare-const tmp%65 curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const tmp%66 curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const tmp%67 Bool)
 (declare-const tmp%68 Bool)
 (declare-const tmp%69 Poly)
 (declare-const tmp%70 %%Function%%)
 (declare-const tmp%71 vstd!seq.Seq<i8.>.)
 ...
 (declare-const digit$5@ Int)
 (declare-const term_b@ tuple%2.)
 (declare-const selected_B@ curve25519_dalek!backend.serial.curve_models.AffineNielsPoint.)
 (declare-const t_ext$2@ curve25519_dalek!edwards.EdwardsPoint.)
 (declare-const digit$6@ Int)
 (declare-const tmp%79 Poly)
 (declare-const tmp%80 Int)
 (declare-const tmp%81 curve25519_dalek!window.NafLookupTable8.)
 (declare-const tmp%82 Int)
 (declare-const tmp%83 curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const tmp%84 curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const tmp%85 Bool)
 (declare-const tmp%86 Bool)
 (declare-const tmp%87 Poly)
 (declare-const tmp%88 %%Function%%)
 (declare-const tmp%89 Bool)
 (declare-const tmp%90 vstd!seq.Seq<i8.>.)
 ...
 (declare-const digit$7@ Int)
 (declare-const abs_digit$1@ Int)
 (declare-const term_b$1@ tuple%2.)
 (declare-const selected_B$1@ curve25519_dalek!backend.serial.curve_models.AffineNielsPoint.)
 (declare-const t_ext$3@ curve25519_dalek!edwards.EdwardsPoint.)
 (declare-const tmp%98 Bool)
 (declare-const tmp%%$7@ core!cmp.Ordering.)
 ...
 (declare-const old_i$1@0 Int)
 (declare-const verus_tmp$5@0 tuple%2.)
 (declare-const prev_partial@0 tuple%2.)
 (declare-const t@0 curve25519_dalek!backend.serial.curve_models.CompletedPoint.)
 (declare-const verus_tmp$6@0 tuple%2.)
 (declare-const doubled_affine@0 tuple%2.)
 (declare-const verus_tmp$7@0 tuple%2.)
 (declare-const col_a@0 tuple%2.)
 (declare-const verus_tmp$8@0 tuple%2.)
 (declare-const col_ab@0 tuple%2.)
 (declare-const decrease%init1%0 Int)
 (declare-const tmp%103 curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const tmp%104 curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const tmp%105 curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 ...
 (declare-const tmp%112 vstd!seq.Seq<i8.>.)
 (declare-const tmp%113 vstd!seq.Seq<i8.>.)
 (declare-const tmp%114 vstd!seq.Seq<i8.>.)
 (declare-const tmp%115 vstd!seq.Seq<i8.>.)
 ...
 (declare-const a_naf@ %%Function%%)
 (declare-const b_naf@ %%Function%%)
 (declare-const verus_tmp@0 tuple%2.)
 (declare-const A_affine@0 tuple%2.)
 (declare-const bp_for_proof@ curve25519_dalek!edwards.EdwardsPoint.)
 (declare-const verus_tmp$1@0 tuple%2.)
 (declare-const B_affine@0 tuple%2.)
 (declare-const verus_tmp$2@0 vstd!seq.Seq<tuple%2<nat./nat.>.>.)
 (declare-const pts_affine@0 vstd!seq.Seq<tuple%2<nat./nat.>.>.)
 (declare-const verus_tmp$3@0 vstd!seq.Seq<vstd!seq.Seq<i8.>.>.)
 (declare-const nafs@0 vstd!seq.Seq<vstd!seq.Seq<i8.>.>.)
 (declare-const i@0 Int)
 (declare-const table_A@ curve25519_dalek!window.NafLookupTable5.)
 (declare-const table_B@ curve25519_dalek!window.NafLookupTable8.)
 (declare-const r@0 curve25519_dalek!backend.serial.curve_models.ProjectivePoint.)
 (declare-const result@ curve25519_dalek!edwards.EdwardsPoint.)
 (assert
  fuel_defaults
 )
 (assert
  (has_type (Poly%curve25519_dalek!scalar.Scalar. a!) TYPE%curve25519_dalek!scalar.Scalar.)
 )
 (assert
  (has_type (Poly%curve25519_dalek!edwards.EdwardsPoint. A!) TYPE%curve25519_dalek!edwards.EdwardsPoint.)
 )
 (assert
  (has_type (Poly%curve25519_dalek!scalar.Scalar. b!) TYPE%curve25519_dalek!scalar.Scalar.)
 )
 (assert
  (has_type (Poly%array%. a_naf@) (ARRAY $ (SINT 8) $ (CONST_INT 256)))
 )
 (assert
  (has_type (Poly%array%. b_naf@) (ARRAY $ (SINT 8) $ (CONST_INT 256)))
 )
 (assert
  (has_type (Poly%tuple%2. verus_tmp@0) (TYPE%tuple%2. $ NAT $ NAT))
 )
 (assert
  (has_type (Poly%tuple%2. verus_tmp_A_affine@) (TYPE%tuple%2. $ NAT $ NAT))
 )
 (assert
  (has_type (Poly%tuple%2. A_affine@0) (TYPE%tuple%2. $ NAT $ NAT))
 )
 (assert
  (has_type (Poly%curve25519_dalek!edwards.EdwardsPoint. bp_for_proof@) TYPE%curve25519_dalek!edwards.EdwardsPoint.)
 )
 (assert
  (has_type (Poly%tuple%2. verus_tmp$1@0) (TYPE%tuple%2. $ NAT $ NAT))
 )
 (assert
  (has_type (Poly%tuple%2. verus_tmp_B_affine@) (TYPE%tuple%2. $ NAT $ NAT))
 )
 (assert
  (has_type (Poly%tuple%2. B_affine@0) (TYPE%tuple%2. $ NAT $ NAT))
 )
 (assert
  (uInv SZ i@0)
 )
 ...
 (assert
  (not (=>
    (<= i@0 255)
    (=>
     (= (vstd!seq.Seq.len.? $ (SINT 8) (vstd!view.View.view.? $ (ARRAY $ (SINT 8) $ (CONST_INT
          256
         )
        ) (Poly%array%. a_naf@)
       )
     ...
     (=>
      ...
      (=>
       (forall ((j$ Poly)) (!
         ...
         :qid user_curve25519_dalek__backend__serial__scalar_mul__vartime_double_base__mul_67
         :skolemid skolem_user_curve25519_dalek__backend__serial__scalar_mul__vartime_double_base__mul_67
       ))
       (=>
        (= decrease%init0%0 (Add i@0 1))
        (and
         (=>
          %%location_label%%0
          (req%vstd!array.array_index_get. $ (SINT 8) $ (CONST_INT 256) a_naf@ i@0)
         )
         (=>
          (ens%vstd!array.array_index_get. $ (SINT 8) $ (CONST_INT 256) a_naf@ i@0 tmp%1)
          (or
           (and
            (=>
             (not (= (%I tmp%1) 0))
            ...
            (=>
             ...
             (and
              (=>
               %%location_label%%1
               (req%vstd!array.array_index_get. $ (SINT 8) $ (CONST_INT 256) b_naf@ i@0)
              )
              (=>
               (ens%vstd!array.array_index_get. $ (SINT 8) $ (CONST_INT 256) b_naf@ i@0 tmp%2)
               (=>
                (= tmp%3 (not (= (%I tmp%2) 0)))
                %%switch_label%%4
           )))))
           (and
            ...
            (or
             ...
             (and
              (not %%switch_label%%3)
              (=>
               (= tmp%4 (= (%I (vstd!seq.Seq.index.? $ (SINT 8) (vstd!view.View.view.? $ (ARRAY $ (SINT
                      8
                     ) $ (CONST_INT 256)
                    ) (Poly%array%. a_naf@)
                   ) (I i@0)
               ...
               (and
                ...
                (=>
                 tmp%4
                 (=>
                  (= tmp%5 (= (%I (vstd!seq.Seq.index.? $ (SINT 8) (vstd!view.View.view.? $ (ARRAY $ (SINT
                         8
                        ) $ (CONST_INT 256)
                       ) (Poly%array%. b_naf@)
                      ) (I i@0)
                      ...
                      (=>
                       ...
                       (and
                        ...
                        (=>
                         (uInv SZ (Sub i@0 1))
                         (=>
                          (= i@1 (uClip SZ (Sub i@0 1)))
                          (=>
                           (= tmp%6 (= (Add i@1 1) old_i@))
                           (and
                            (=>
                             %%location_label%%13
                             tmp%6
                             ...
                             (and
                                   ...
                                   (or
                                    (and
                                     (=>
                                      (= (%I j@) old_i@)
                                      (=>
                                       (= tmp%7 (= (%I (vstd!seq.Seq.index.? $ (SINT 8) (vstd!view.View.view.? $ (ARRAY $ (SINT
                                              8
                                             ) $ (CONST_INT 256)
                                            ) (Poly%array%. a_naf@)
                                           ) j@
                                       ...
                                       (and
                                        ...
                                        (=>
                                         tmp%7
                                         (=>
                                          (= tmp%8 (= (%I (vstd!seq.Seq.index.? $ (SINT 8) (vstd!view.View.view.? $ (ARRAY $ (SINT
                                                 8
                                                ) $ (CONST_INT 256)
                                               ) (Poly%array%. b_naf@)
                                              ) j@
                              ...
                              (=>
                               (forall ((j$ Poly)) (!
                                 ...
                                 :qid user_curve25519_dalek__backend__serial__scalar_mul__vartime_double_base__mul_68
                                 :skolemid skolem_user_curve25519_dalek__backend__serial__scalar_mul__vartime_double_base__mul_68
                               ))
                               (and
                                (=>
                                 %%location_label%%19
                                ...
                                (and
                                 ...
                                 (and
                                  ...
                                  (and
                                   ...
                                   (=>
                                    %%location_label%%23
                                    (check_decrease_int (Add i@1 1) decrease%init0%0 false)
 )))))))))))))))))))))))))))))))))))
 (get-info :version)
