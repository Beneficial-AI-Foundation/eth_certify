...
;; curve25519-dalek/src/lemmas/edwards_lemmas/straus_lemmas.rs:601:1: 606:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::straus_lemmas::lemma_column_sum_canonical
;; curve25519-dalek/src/lemmas/edwards_lemmas/straus_lemmas.rs:601:1: 606:2 (#0)
...
(push)
 ...
 (assert
  (forall ((k$ Poly)) (!
    ...
    :qid user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_column_sum_canonical_51
    :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_column_sum_canonical_51
 )))
 (assert
  (forall ((k$ Poly)) (!
    (=>
    ...
    :qid user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_column_sum_canonical_52
    :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_column_sum_canonical_52
 )))
        ...
        (and
         (=>
          ...
          (check_decrease_int (let
            ((points_affine!$0 points_affine!) (digits!$1 digits!) (j!$2 j!) (n!$3 tmp%1))
            n!$3
          ...
          (=>
           ...
           (=>
            ...
            (=>
             ...
             (=>
              (= tmp%3 (%I (vstd!seq.Seq.index.? $ (SINT 8) (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq.
                   $ (SINT 8)
                  ) (Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>. digits!) (I (Sub n! 1))
                 ) (I j!)
              )))
              (and
               (=>
               ...
               (=>
                ...
                (=>
                 ...
                 (=>
                  (= tmp%4 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. prev@)))))
                  (=>
                   (= tmp%5 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. prev@)))))
                   (=>
                    (= tmp%6 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. term@)))))
                    (=>
                     (= tmp%7 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. term@)))))
                     (=>
                      (ens%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_edwards_add_canonical.
