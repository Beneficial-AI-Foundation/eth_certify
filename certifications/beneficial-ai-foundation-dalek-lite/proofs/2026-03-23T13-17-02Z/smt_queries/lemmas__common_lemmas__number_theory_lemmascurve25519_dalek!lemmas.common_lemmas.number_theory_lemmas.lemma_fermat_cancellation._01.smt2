...
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:1117:7: 1117:59 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::number_theory_lemmas::lemma_fermat_cancellation
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:1117:7: 1117:59 (#0)
     ...
     (and
      (and
       ...
       (=>
        ...
        (=>
         %%location_label%%3
         (>= (vstd!arithmetic.power.pow.? (I a!) (I n!)) 1)
      )))
      (=>
       (>= (vstd!arithmetic.power.pow.? (I a!) (I n!)) 1)
       (=>
        (= pow_n@ (vstd!arithmetic.power.pow.? (I a!) (I n!)))
        (and
         (=>
          (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub. a! pow_n@ 1)
          (=>
           %%location_label%%4
           (= (Sub (Mul a! pow_n@) a!) (Mul a! (Sub pow_n@ 1)))
         ))
         (=>
          (= (Sub (Mul a! pow_n@) a!) (Mul a! (Sub pow_n@ 1)))
          (and
           (=>
            ...
            (and
             ...
             (=>
              ...
              (=>
               %%location_label%%6
               (= (EucMod (Sub (Mul a! pow_n@) a!) p!) 0)
           ))))
           (=>
            (= (EucMod (Sub (Mul a! pow_n@) a!) p!) 0)
            (=>
             (= tmp%2 (= (EucMod (Mul a! (Sub pow_n@ 1)) p!) 0))
             (and
              (=>
               %%location_label%%7
               tmp%2
              ...
              (=>
               ...
               (or
                (and
                 (=>
                  (not (= (EucMod (Sub pow_n@ 1) p!) 0))
                  (=>
                   (= diff@ (nClip (Sub pow_n@ 1)))
                   (and
                    (=>
                     %%location_label%%8
                     (req%curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.lemma_euclid_prime.
                 ...
                 (=>
                  (not (not (= (EucMod (Sub pow_n@ 1) p!) 0)))
                  %%switch_label%%0
                ))
                (and
                 (not %%switch_label%%0)
                 (and
                  (=>
                   ...
                   (and
                    (=>
                     %%location_label%%9
                     (req%vstd!arithmetic.div_mod.lemma_mod_adds. tmp%3 1 p!)
                    )
                    (=>
                     (ens%vstd!arithmetic.div_mod.lemma_mod_adds. tmp%3 1 p!)
                     (and
                      (=>
                       %%location_label%%10
