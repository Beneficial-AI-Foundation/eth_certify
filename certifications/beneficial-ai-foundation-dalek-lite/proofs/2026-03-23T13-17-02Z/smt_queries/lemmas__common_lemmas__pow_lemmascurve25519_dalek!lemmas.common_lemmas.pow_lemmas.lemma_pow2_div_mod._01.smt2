...
;; curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:486:1: 486:56 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::pow_lemmas::lemma_pow2_div_mod
;; curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:486:1: 486:56 (#0)
...
(push)
 ...
 (declare-const d@ Int)
 (declare-const ps@ Int)
 (declare-const pk@ Int)
 (declare-const pd@ Int)
 (declare-const x_div_pd@ Int)
 (declare-const x_mod_pd@ Int)
 (assert
  fuel_defaults
 )
 (assert
 ...
 (assert
  (not (=>
    (= d@ (nClip (Add s! k!)))
    (=>
     (= ps@ (vstd!arithmetic.power2.pow2.? (I s!)))
     (=>
      (= pk@ (vstd!arithmetic.power2.pow2.? (I k!)))
      (=>
       ...
       (and
        ...
        (=>
         ...
         (and
          (=>
           (ens%vstd!arithmetic.power2.lemma_pow2_adds. s! k!)
           (=>
            (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. ps@ pk@)
            (=>
             %%location_label%%1
             (let
              ((tmp%%$ (nClip (Mul ps@ pk@))))
          ...
          (=>
           ...
           (and
            (and
             (=>
              %%location_label%%2
              (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. x! pd@)
             )
             (=>
              (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. x! pd@)
              (=>
               %%location_label%%3
               (= x! (nClip (Add (nClip (Mul pd@ (EucDiv x! pd@))) (EucMod x! pd@))))
            )))
            (=>
             (= x! (nClip (Add (nClip (Mul pd@ (EucDiv x! pd@))) (EucMod x! pd@))))
             (=>
              (= x_div_pd@ (EucDiv x! pd@))
              (=>
               (= x_mod_pd@ (EucMod x! pd@))
               (and
                (and
                 (=>
                  %%location_label%%4
                  (req%vstd!arithmetic.div_mod.lemma_mod_bound. x! pd@)
                 )
                 (=>
                  (ens%vstd!arithmetic.div_mod.lemma_mod_bound. x! pd@)
                  (=>
                   %%location_label%%5
                   (< x_mod_pd@ pd@)
                )))
                (=>
                 ...
                 (and
                  (and
                   (=>
                    (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. pd@ x_div_pd@)
                    (and
                     (=>
                      %%location_label%%6
                      (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_binary_sum_div_decomposition.
                       x_mod_pd@ x_div_pd@ d@ k!
                     ))
                     (=>
                      (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_binary_sum_div_decomposition.
                       x_mod_pd@ x_div_pd@ d@ k!
                      ...
                      (=>
                       %%location_label%%7
                       (= (EucDiv (nClip (Add (nClip (Mul pd@ x_div_pd@)) x_mod_pd@)) pk@) (nClip (Add (EucDiv
                           (nClip (Mul pd@ x_div_pd@)) pk@
                          ) (EucDiv x_mod_pd@ pk@)
                   )))))))
                   (=>
                    (= (EucDiv (nClip (Add (nClip (Mul pd@ x_div_pd@)) x_mod_pd@)) pk@) (nClip (Add (EucDiv
                    ...
                    (and
                     (and
                      (=>
                       (ens%vstd!arithmetic.mul.lemma_mul_is_associative. pk@ ps@ x_div_pd@)
                       (=>
                        %%location_label%%8
                        (= (nClip (Mul pd@ x_div_pd@)) (nClip (Mul pk@ (nClip (Mul ps@ x_div_pd@)))))
                      ))
                      (=>
                       (= (nClip (Mul pd@ x_div_pd@)) (nClip (Mul pk@ (nClip (Mul ps@ x_div_pd@)))))
                       (and
                        (=>
                         (= tmp%1 (nClip (Mul ps@ x_div_pd@)))
                         (and
                          (=>
                           %%location_label%%9
                           (req%vstd!arithmetic.div_mod.lemma_div_multiples_vanish. tmp%1 pk@)
                          )
                          (=>
                           (ens%vstd!arithmetic.div_mod.lemma_div_multiples_vanish. tmp%1 pk@)
                           (=>
                            %%location_label%%10
                            (= (EucDiv (nClip (Mul pk@ (nClip (Mul ps@ x_div_pd@)))) pk@) (nClip (Mul ps@ x_div_pd@)))
                        ))))
                        (=>
                         (= (EucDiv (nClip (Mul pk@ (nClip (Mul ps@ x_div_pd@)))) pk@) (nClip (Mul ps@ x_div_pd@)))
                         (=>
                          %%location_label%%11
                          (= (EucDiv (nClip (Mul pd@ x_div_pd@)) pk@) (nClip (Mul ps@ x_div_pd@)))
                     )))))
                     (=>
                      (= (EucDiv (nClip (Mul pd@ x_div_pd@)) pk@) (nClip (Mul ps@ x_div_pd@)))
                      (=>
                       %%location_label%%12
                       (= (EucDiv x! pk@) (nClip (Add (nClip (Mul ps@ x_div_pd@)) (EucDiv x_mod_pd@ pk@))))
                  )))))
                  (=>
                   (= (EucDiv x! pk@) (nClip (Add (nClip (Mul ps@ x_div_pd@)) (EucDiv x_mod_pd@ pk@))))
                   (and
                      ...
                      (and
                       (and
                        (and
                         (=>
                          %%location_label%%14
                          (req%vstd!arithmetic.div_mod.lemma_div_by_multiple. ps@ pk@)
                         )
                         (=>
                          (ens%vstd!arithmetic.div_mod.lemma_div_by_multiple. ps@ pk@)
                          (=>
                           %%location_label%%15
                           (= ps@ (EucDiv pd@ pk@))
                        )))
                        (=>
                         ...
                         (and
                          (=>
                           %%location_label%%16
                           (req%vstd!arithmetic.div_mod.lemma_div_by_multiple_is_strongly_ordered. x_mod_pd@
                            pd@ ps@ pk@
                          ))
                          (=>
                           (ens%vstd!arithmetic.div_mod.lemma_div_by_multiple_is_strongly_ordered. x_mod_pd@
                            pd@ ps@ pk@
                           )
                           (=>
                            %%location_label%%17
                            (< (EucDiv x_mod_pd@ pk@) ps@)
                       )))))
                       (=>
                        (< (EucDiv x_mod_pd@ pk@) ps@)
                        (and
                         (=>
                          (= tmp%2 (EucDiv x_mod_pd@ pk@))
                          (and
                           (=>
                            %%location_label%%18
                            (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_binary_sum_mod_decomposition.
                           ...
                           (=>
                            ...
                            (=>
                             %%location_label%%19
                             (= (EucMod (nClip (Add (nClip (Mul ps@ x_div_pd@)) (EucDiv x_mod_pd@ pk@))) ps@) (
                               nClip (Add (EucMod (nClip (Mul ps@ x_div_pd@)) ps@) (EucMod (EucDiv x_mod_pd@ pk@)
                                 ps@
                         ))))))))
                         (=>
                          (= (EucMod (nClip (Add (nClip (Mul ps@ x_div_pd@)) (EucDiv x_mod_pd@ pk@))) ps@) (
                          ...
                          (and
                           (=>
                            (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. ps@ x_div_pd@)
                            (and
                             (=>
                              %%location_label%%20
                              (req%vstd!arithmetic.div_mod.lemma_mod_multiples_basic. x_div_pd@ ps@)
                             )
                             (=>
                              (ens%vstd!arithmetic.div_mod.lemma_mod_multiples_basic. x_div_pd@ ps@)
                              (=>
                               %%location_label%%21
                               (= (EucMod (nClip (Mul ps@ x_div_pd@)) ps@) 0)
                           ))))
                           (=>
                            (= (EucMod (nClip (Mul ps@ x_div_pd@)) ps@) 0)
                            (and
                             (=>
                              (= tmp%3 (EucDiv x_mod_pd@ pk@))
                              (and
                               (=>
                                %%location_label%%22
                                (req%vstd!arithmetic.div_mod.lemma_small_mod. tmp%3 ps@)
                               )
                               (=>
                                (ens%vstd!arithmetic.div_mod.lemma_small_mod. tmp%3 ps@)
                                (=>
                                 %%location_label%%23
                                 (= (EucMod (EucDiv x_mod_pd@ pk@) ps@) (EucDiv x_mod_pd@ pk@))
                             ))))
                             (=>
                              (= (EucMod (EucDiv x_mod_pd@ pk@) ps@) (EucDiv x_mod_pd@ pk@))
                              (=>
                               %%location_label%%24
                               (= (EucMod (EucDiv x! pk@) ps@) (EucDiv x_mod_pd@ pk@))
                    )))))))))))
                    (=>
                     (= (EucMod (EucDiv x! pk@) ps@) (EucDiv x_mod_pd@ pk@))
                     (=>
