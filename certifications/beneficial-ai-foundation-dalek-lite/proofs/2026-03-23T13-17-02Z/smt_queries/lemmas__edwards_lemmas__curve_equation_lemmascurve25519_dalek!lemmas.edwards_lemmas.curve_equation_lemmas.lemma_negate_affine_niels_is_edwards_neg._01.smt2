...
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:2015:1: 2015:76 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::curve_equation_lemmas::lemma_negate_affine_niels_is_edwards_neg
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:2015:1: 2015:76 (#0)
(get-info :all-statistics)
(push)
 (declare-const pt! curve25519_dalek!backend.serial.curve_models.AffineNielsPoint.)
 ...
 (assert
  (has_type (Poly%curve25519_dalek!backend.serial.curve_models.AffineNielsPoint. pt!)
   TYPE%curve25519_dalek!backend.serial.curve_models.AffineNielsPoint.
 ))
 ;; assertion failed
     ...
     (=>
      ...
      (=>
       ...
       (=>
        ...
        (=>
         (= x_neg@ (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_sub.?
             (I y_minus_x@) (I y_plus_x@)
            )
           ) (I inv2@)
         ))
         (=>
          (= y_neg@ (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_add.?
              (I y_minus_x@) (I y_plus_x@)
             )
            ) (I inv2@)
          ))
