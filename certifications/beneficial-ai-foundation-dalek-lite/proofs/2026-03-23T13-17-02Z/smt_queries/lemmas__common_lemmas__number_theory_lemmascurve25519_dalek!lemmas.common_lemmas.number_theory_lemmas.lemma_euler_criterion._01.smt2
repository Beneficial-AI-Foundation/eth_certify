...
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:2443:1: 2443:51 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::number_theory_lemmas::lemma_euler_criterion
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:2443:1: 2443:51 (#0)
           ...
           (and
            (=>
             ...
             (and
              (=>
               %%location_label%%3
               (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. tmp%2 2)
              )
              (=>
               (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. tmp%2 2)
               (=>
                %%location_label%%4
                (= (nClip (Mul half@ 2)) (nClip (Sub p! 1)))
            ))))
            (=>
             (= (nClip (Mul half@ 2)) (nClip (Sub p! 1)))
             (=>
              (= y@ (vstd!arithmetic.power.pow.? (I x!) (I half@)))
              (and
               (and
                (=>
                 %%location_label%%5
                 (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow_nonnegative. x! half@)
                )
                (=>
                 (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow_nonnegative. x! half@)
                 (=>
                  %%location_label%%6
                  (>= y@ 0)
               )))
               (=>
                ...
                (and
                 (=>
                  (ens%vstd!arithmetic.power.lemma_pow_multiplies. x! half@ 2)
                  (=>
                   %%location_label%%7
                   (= (vstd!arithmetic.power.pow.? (I y@) (I 2)) (vstd!arithmetic.power.pow.? (I x!) (
                      I (nClip (Sub p! 1))
                 )))))
                 (=>
                  (= (vstd!arithmetic.power.pow.? (I y@) (I 2)) (vstd!arithmetic.power.pow.? (I x!) (
