...
;; curve25519-dalek/src/backend/serial/u64/field.rs:693:5: 693:88 (#0)
...
;; Function-Def curve25519_dalek::backend::serial::u64::field::FieldElement51::conditional_swap
;; curve25519-dalek/src/backend/serial/u64/field.rs:693:5: 693:88 (#0)
(get-info :all-statistics)
(push)
 (declare-const a!@0 curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const b!@0 curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 ...
 (declare-const a0@0 Int)
 (declare-const b0@0 Int)
 (declare-const a1@0 Int)
 (declare-const b1@0 Int)
 (declare-const a2@0 Int)
 (declare-const b2@0 Int)
 (declare-const a3@0 Int)
 (declare-const b3@0 Int)
 (declare-const a4@0 Int)
 (declare-const b4@0 Int)
 (assert
  fuel_defaults
 )
 (assert
  (has_type (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. a!@0) TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 )
 (assert
  (has_type (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. b!@0) TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 )
 (declare-const a0@1 Int)
 (declare-const b0@1 Int)
 (declare-const a!@1 curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const b!@1 curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const a1@1 Int)
 (declare-const b1@1 Int)
 (declare-const a!@2 curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const b!@2 curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const a2@1 Int)
 (declare-const b2@1 Int)
 (declare-const a!@3 curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const b!@3 curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const a3@1 Int)
 (declare-const b3@1 Int)
 (declare-const a!@4 curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const b!@4 curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const a4@1 Int)
 (declare-const b4@1 Int)
 (declare-const a!@5 curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const b!@5 curve25519_dalek!backend.serial.u64.field.FieldElement51.)
          ...
          (=>
           ...
           (=>
            ...
            (=>
             (uInv 64 b0@1)
             (=>
              (ens%curve25519_dalek!backend.serial.u64.subtle_assumes.conditional_swap_u64. a0@0
               a0@1 b0@0 b0@1 choice!
              )
              (and
               (=>
                %%location_label%%2
                (req%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                 $ (UINT 64) (Poly%array%. (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
                   (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                     a!@0
                  )))
                 ) (I 0) (I a0@1)
               ...
               (=>
                (has_type (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. a!@1) TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.)
                (=>
                 ...
                 (and
                  ...
                  (=>
                   (has_type (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. b!@1) TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.)
                   (=>
                    (ens%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                     $ (UINT 64) (Poly%array%. (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
                       (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                    ...
                    (=>
                     (= tmp%6 (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
                       (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                         a!@1
                     ))))
                     (and
                      (=>
                       %%location_label%%4
                       (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) tmp%6 1)
                      )
                      (=>
                       (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) tmp%6 1 tmp%5)
                       (=>
                        (= a1@0 (%I tmp%5))
                        (=>
                         (= tmp%8 (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
                           (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                             b!@1
                         ))))
                         (and
                          (=>
                           %%location_label%%5
                           (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) tmp%8 1)
                          )
                          (=>
                           (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) tmp%8 1 tmp%7)
                           (=>
                            (= b1@0 (%I tmp%7))
                            (=>
                             (uInv 64 a1@1)
                             (=>
                              (uInv 64 b1@1)
                              (=>
                               (ens%curve25519_dalek!backend.serial.u64.subtle_assumes.conditional_swap_u64. a1@0
                                a1@1 b1@0 b1@1 choice!
                               )
                               (and
                                (=>
                                 %%location_label%%6
                                ...
                                (=>
                                 (has_type (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. a!@2) TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.)
                                 (=>
                                  (ens%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                   $ (UINT 64) (Poly%array%. (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
                                     (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                  ...
                                  (and
                                   ...
                                   (=>
                                    (has_type (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. b!@2) TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.)
                                    (=>
                                     (ens%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                      $ (UINT 64) (Poly%array%. (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
                                        (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                     ...
                                     (=>
                                      (= tmp%10 (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
                                        (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                          a!@2
                                      ))))
                                      (and
                                       (=>
                                        %%location_label%%8
                                        (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) tmp%10 2)
                                       )
                                       (=>
                                        (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) tmp%10 2 tmp%9)
                                        (=>
                                         (= a2@0 (%I tmp%9))
                                         (=>
                                          ...
                                          (and
                                           (=>
                                            %%location_label%%9
                                            (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) tmp%12 2)
                                           )
                                           (=>
                                            (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) tmp%12 2 tmp%11)
                                            (=>
                                             (= b2@0 (%I tmp%11))
                                             (=>
                                              (uInv 64 a2@1)
                                              (=>
                                               (uInv 64 b2@1)
                                               (=>
                                                (ens%curve25519_dalek!backend.serial.u64.subtle_assumes.conditional_swap_u64. a2@0
                                                 a2@1 b2@0 b2@1 choice!
                                                )
                                                (and
                                                 (=>
                                                  %%location_label%%10
                                                 ...
                                                 (=>
                                                  (has_type (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. a!@3) TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.)
                                                  (=>
                                                   (ens%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                                    $ (UINT 64) (Poly%array%. (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
                                                      (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                                   ...
                                                   (and
                                                    ...
                                                    (=>
                                                     (has_type (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. b!@3) TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.)
                                                     (=>
                                                      (ens%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                                       $ (UINT 64) (Poly%array%. (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
                                                         (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                                      ...
                                                      (=>
                                                       (= tmp%14 (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
                                                         (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                                           a!@3
                                                       ))))
                                                       (and
                                                        (=>
                                                         %%location_label%%12
                                                         (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) tmp%14 3)
                                                        )
                                                        (=>
                                                         (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) tmp%14 3 tmp%13)
                                                         (=>
                                                          (= a3@0 (%I tmp%13))
                                                          (=>
                                                           ...
                                                           (and
                                                            (=>
                                                             %%location_label%%13
                                                             (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) tmp%16 3)
                                                            )
                                                            (=>
                                                             (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) tmp%16 3 tmp%15)
                                                             (=>
                                                              (= b3@0 (%I tmp%15))
                                                              (=>
                                                               (uInv 64 a3@1)
                                                               (=>
                                                                (uInv 64 b3@1)
                                                                (=>
                                                                 (ens%curve25519_dalek!backend.serial.u64.subtle_assumes.conditional_swap_u64. a3@0
                                                                  a3@1 b3@0 b3@1 choice!
                                                                 )
                                                                 (and
                                                                  (=>
                                                                   %%location_label%%14
                                                                  ...
                                                                  (=>
                                                                   (has_type (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. a!@4) TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.)
                                                                   (=>
                                                                    (ens%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                                                     $ (UINT 64) (Poly%array%. (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
                                                                       (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                                                    ...
                                                                    (and
                                                                     ...
                                                                     (=>
                                                                      (has_type (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. b!@4) TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.)
                                                                      (=>
                                                                       (ens%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                                                        $ (UINT 64) (Poly%array%. (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
                                                                          (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                                                       ...
                                                                       (=>
                                                                        ...
                                                                        (and
                                                                         (=>
                                                                          %%location_label%%16
                                                                          (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) tmp%18 4)
                                                                         )
                                                                         (=>
                                                                          (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) tmp%18 4 tmp%17)
                                                                          (=>
                                                                           (= a4@0 (%I tmp%17))
                                                                           (=>
                                                                            ...
                                                                            (and
                                                                             (=>
                                                                              %%location_label%%17
                                                                              (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) tmp%20 4)
                                                                             )
                                                                             (=>
                                                                              (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) tmp%20 4 tmp%19)
                                                                              (=>
                                                                               (= b4@0 (%I tmp%19))
                                                                               (=>
                                                                                (uInv 64 a4@1)
                                                                                (=>
                                                                                 (uInv 64 b4@1)
                                                                                 (=>
                                                                                  (ens%curve25519_dalek!backend.serial.u64.subtle_assumes.conditional_swap_u64. a4@0
                                                                                   a4@1 b4@0 b4@1 choice!
                                                                                  )
                                                                                  (and
                                                                                   (=>
                                                                                    %%location_label%%18
                                                                                   ...
                                                                                   (=>
                                                                                    (has_type (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. a!@5) TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.)
                                                                                    (=>
                                                                                     (ens%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                                                                      $ (UINT 64) (Poly%array%. (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
                                                                                        (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                                                                     ...
                                                                                     (and
                                                                                      ...
                                                                                      (=>
                                                                                       (has_type (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. b!@5) TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.)
                                                                                       (=>
                                                                                        (ens%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                                                                         $ (UINT 64) (Poly%array%. (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
                                                                                           (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
