...
;; MODULE 'module lemmas::field_lemmas::pow_p58_lemma'
;; curve25519-dalek/src/lemmas/field_lemmas/pow_p58_lemma.rs:42:1: 47:2 (#0)
...
(assert
 (distinct fuel%vstd!arithmetic.mul.lemma_mul_is_distributive_sub. fuel%vstd!arithmetic.power.lemma_pow1.
  ...
  fuel%curve25519_dalek!specs.field_specs_u64.p. fuel%curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.
...
(assert
 (=>
  ...
  (forall ((x! Int) (y! Int) (z! Int)) (!
    ...
    :qid user_vstd__arithmetic__mul__lemma_mul_is_distributive_sub_18
    :skolemid skolem_user_vstd__arithmetic__mul__lemma_mul_is_distributive_sub_18
))))
...
(assert
 (=>
  ...
  (forall ((b! Poly)) (!
    ...
    :qid user_vstd__arithmetic__power__lemma_pow1_19
    :skolemid skolem_user_vstd__arithmetic__power__lemma_pow1_19
))))
...
(assert
 (=>
  ...
  (forall ((e! Poly)) (!
    ...
    :pattern ((vstd!arithmetic.power2.pow2.? e!))
    :qid user_vstd__arithmetic__power2__lemma_pow2_pos_20
    :skolemid skolem_user_vstd__arithmetic__power2__lemma_pow2_pos_20
))))
...
(assert
 (=>
  ...
  (forall ((e1! Int) (e2! Int)) (!
    ...
    :qid user_vstd__arithmetic__power2__lemma_pow2_adds_21
    :skolemid skolem_user_vstd__arithmetic__power2__lemma_pow2_adds_21
))))
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::pow_p58_lemma::lemma_pow_p58_prove
;; curve25519-dalek/src/lemmas/field_lemmas/pow_p58_lemma.rs:42:1: 47:2 (#0)
(get-info :all-statistics)
(push)
 (declare-const self_limbs! %%Function%%)
 (declare-const t19_limbs! %%Function%%)
 (declare-const t20_limbs! %%Function%%)
 (declare-const t21_limbs! %%Function%%)
 ...
 (declare-const exp_250_m1@ Int)
 (declare-const exp_252_m4@ Int)
 (declare-const exp_252_m3@ Int)
 (assert
  fuel_defaults
 )
 (assert
 ...
 (assert
  (has_type (Poly%array%. t20_limbs!) (ARRAY $ (UINT 64) $ (CONST_INT 5)))
 )
 (assert
  (has_type (Poly%array%. t21_limbs!) (ARRAY $ (UINT 64) $ (CONST_INT 5)))
 )
 (assert
  (= (EucMod (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. t19_limbs!))
    (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
  ...
  (not (=>
    ...
    (and
     ...
     (=>
      (> (curve25519_dalek!specs.field_specs_u64.p.? (I 0)) 0)
      (=>
       (= exp_250_m1@ (nClip (Sub (vstd!arithmetic.power2.pow2.? (I 250)) 1)))
       (=>
        (= exp_252_m4@ (nClip (Sub (vstd!arithmetic.power2.pow2.? (I 252)) 4)))
        (=>
         (= exp_252_m3@ (nClip (Sub (vstd!arithmetic.power2.pow2.? (I 252)) 3)))
         (and
          (=>
          ...
          (=>
           ...
           (and
            (and
             (=>
              (ens%vstd!arithmetic.power2.lemma_pow2_adds. 2 250)
              (=>
               %%location_label%%2
               (= (vstd!arithmetic.power2.pow2.? (I 252)) (nClip (Mul (vstd!arithmetic.power2.pow2.?
                   (I 2)
                  ) (vstd!arithmetic.power2.pow2.? (I 250))
             )))))
             (=>
              (= (vstd!arithmetic.power2.pow2.? (I 252)) (nClip (Mul (vstd!arithmetic.power2.pow2.?
                  (I 2)
              ...
              (=>
               (= tmp%1 (= (nClip (Mul 4 (vstd!arithmetic.power2.pow2.? (I 250)))) (vstd!arithmetic.power2.pow2.?
                  (I 252)
               )))
               (and
                (=>
                   ...
                   (and
                    (=>
                     ...
                     (and
                      (=>
                       %%location_label%%5
                       (req%vstd!arithmetic.power2.lemma_pow2_strictly_increases. 2 252)
                      )
                      (=>
                       (ens%vstd!arithmetic.power2.lemma_pow2_strictly_increases. 2 252)
                       (=>
                        %%location_label%%6
                        (>= (vstd!arithmetic.power2.pow2.? (I 252)) 4)
                    ))))
                    (=>
                     (>= (vstd!arithmetic.power2.pow2.? (I 252)) 4)
                     (=>
                      (= a_int@ (Sub (vstd!arithmetic.power2.pow2.? (I 250)) 1))
                      (=>
                       (= b_int@ (Sub (vstd!arithmetic.power2.pow2.? (I 252)) 4))
                       (and
                        (=>
                         (= tmp%2 (vstd!arithmetic.power2.pow2.? (I 250)))
                         (=>
                          (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub. 4 tmp%2 1)
                          (=>
                           %%location_label%%7
                           (= (Mul 4 a_int@) b_int@)
                        )))
                            ...
                            (=>
                             ...
                             (and
                              ...
                              (=>
                               tmp%4
                               (=>
                                (= tmp%5 (= (nClip (Mul 4 a_int@)) (nClip (Mul 4 (nClip a_int@)))))
                                (and
                                 (=>
                                  %%location_label%%10
                                  tmp%5
                                     ...
                                     (=>
                                      ...
                                      (and
                                       ...
                                       (=>
                                        ...
                                        (=>
                                         %%location_label%%13
                                         (= (nClip (Mul exp_250_m1@ 4)) exp_252_m4@)
            )))))))))))))))))))))))))))))
            (=>
             (= (nClip (Mul exp_250_m1@ 4)) exp_252_m4@)
             (and
              (=>
               ...
               (=>
                %%location_label%%14
                (> (vstd!arithmetic.power2.pow2.? (I 2)) 0)
              ))
              (=>
               (> (vstd!arithmetic.power2.pow2.? (I 2)) 0)
               (=>
                (= tmp%8 (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. t19_limbs!)))
                (=>
                 (= tmp%9 (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. t20_limbs!)))
                 (=>
                  (= tmp%10 (vstd!arithmetic.power2.pow2.? (I 2)))
                  (and
                   (=>
                    %%location_label%%15
                    (req%curve25519_dalek!lemmas.field_lemmas.pow_chain_lemmas.lemma_prove_pow2k_step.
                     base@ tmp%8 tmp%9 exp_250_m1@ tmp%10
                   ))
                   (=>
                    (ens%curve25519_dalek!lemmas.field_lemmas.pow_chain_lemmas.lemma_prove_pow2k_step.
                     base@ tmp%8 tmp%9 exp_250_m1@ tmp%10
                    ...
                    (=>
                     (= tmp%11 (= (EucMod (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%.
                       ...
                       ) (EucMod (nClip (vstd!arithmetic.power.pow.? (I base@) (I exp_252_m4@))) (curve25519_dalek!specs.field_specs_u64.p.?
                         (I 0)
                     ))))
                     (and
                      (=>
                      ...
                      (=>
                       ...
                       (and
                        ...
                        (=>
                         (= (vstd!arithmetic.power.pow.? (I base@) (I 1)) base@)
                         (=>
                          (= tmp%12 (= (nClip (vstd!arithmetic.power.pow.? (I base@) (I 1))) (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.?
                             (Poly%array%. self_limbs!)
                          )))
                          (and
                           (=>
                            ...
                            (and
                             (and
                              ...
                              (=>
                               (>= (vstd!arithmetic.power2.pow2.? (I 252)) 4)
                               (=>
                                (= n@ (vstd!arithmetic.power2.pow2.? (I 252)))
                                (=>
                                 (= tmp%13 (= (Add 1 (Sub n@ 4)) (Sub n@ 3)))
                                 (and
                                  (=>
                                   %%location_label%%21
                                   tmp%13
                                  ...
                                  (=>
                                   tmp%13
                                   (=>
                                    (= tmp%14 (= exp_252_m4@ (nClip (Sub n@ 4))))
                                    (and
                                     (=>
                                      %%location_label%%22
                                      tmp%14
                                     ...
                                     (=>
                                      tmp%14
                                      (=>
                                       (= tmp%15 (= exp_252_m3@ (nClip (Sub n@ 3))))
                                       (and
                                        (=>
                                         %%location_label%%23
                                         tmp%15
                                        ...
                                        (=>
                                         ...
                                         (=>
                                          %%location_label%%24
                                          (= (nClip (Add 1 exp_252_m4@)) exp_252_m3@)
                             )))))))))))))
                             (=>
                              (= (nClip (Add 1 exp_252_m4@)) exp_252_m3@)
                              (=>
                               (= tmp%16 (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. self_limbs!)))
                               (=>
                                (= tmp%17 (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. t20_limbs!)))
                                (=>
                                 (= tmp%18 (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. t21_limbs!)))
                                 (and
                                  (=>
                                   %%location_label%%25
                                   (req%curve25519_dalek!lemmas.field_lemmas.pow_chain_lemmas.lemma_prove_geometric_mul_step.
                                    base@ tmp%16 tmp%17 tmp%18 1 exp_252_m4@
                                  ))
                                  (=>
                                   (ens%curve25519_dalek!lemmas.field_lemmas.pow_chain_lemmas.lemma_prove_geometric_mul_step.
                                    base@ tmp%16 tmp%17 tmp%18 1 exp_252_m4@
                                   ...
                                   (=>
                                    (= tmp%19 (= (EucMod (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%.
                                         t21_limbs!
                                        )
                                       ) (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
                                      ) (EucMod (nClip (vstd!arithmetic.power.pow.? (I base@) (I exp_252_m3@))) (curve25519_dalek!specs.field_specs_u64.p.?
                                        (I 0)
                                    ))))
                                    (and
                                     (=>
