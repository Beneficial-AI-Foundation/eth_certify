...
;; curve25519-dalek/src/backend/serial/u64/field.rs:255:9: 266:10 (#0)
...
;; Function-Def curve25519_dalek::backend::serial::u64::field::impl&%6::add
;; curve25519-dalek/src/backend/serial/u64/field.rs:255:9: 266:10 (#0)
(get-info :all-statistics)
(push)
 (declare-const output! Poly)
 (declare-const self! Poly)
 (declare-const _rhs! Poly)
 ...
 (declare-const output@0 curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 ...
 (assert
  (has_type _rhs! TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 )
 (assert
  (has_type (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. output@0)
   TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.
 ))
 (assert
 ...
 (declare-const output@1 curve25519_dalek!backend.serial.u64.field.FieldElement51.)
     ...
     (=>
      (let
       ...
       (forall ((j$ Poly)) (!
         ...
         :qid user_curve25519_dalek__backend__serial__u64__field__impl&%6__add_80
         :skolemid skolem_user_curve25519_dalek__backend__serial__u64__field__impl&%6__add_80
      )))
      (=>
       (let
        ((i$ (ite
        ...
        (forall ((j$ Poly)) (!
          ...
          :qid user_curve25519_dalek__backend__serial__u64__field__impl&%6__add_81
          :skolemid skolem_user_curve25519_dalek__backend__serial__u64__field__impl&%6__add_81
       )))
       (=>
        (let
         ((i$ (ite
         ...
         (forall ((j$ Poly)) (!
           ...
           :qid user_curve25519_dalek__backend__serial__u64__field__impl&%6__add_82
           :skolemid skolem_user_curve25519_dalek__backend__serial__u64__field__impl&%6__add_82
        )))
        (=>
                           ...
                           (=>
                            ...
                            (=>
                             ...
                             (and
                              ...
                              (=>
                               (has_type (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. output@1)
                                TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                               )
                               (=>
