...
;; curve25519-dalek/src/lemmas/ristretto_lemmas/batch_compress_lemmas.rs:1160:7: 1167:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::ristretto_lemmas::batch_compress_lemmas::lemma_z_inv_std_is_one
;; curve25519-dalek/src/lemmas/ristretto_lemmas/batch_compress_lemmas.rs:1160:7: 1167:2 (#0)
...
(push)
 ...
 (declare-const i1_i2@ Int)
 (declare-const sq_inv@ Int)
 (declare-const sq_c@ Int)
 (declare-const sq_inv_B@ Int)
 (assert
  fuel_defaults
 )
 (assert
 ...
 (assert
  (not (=>
    (= R@ (curve25519_dalek!specs.field_specs.field_mul.? (I c_iad!) (I (curve25519_dalek!specs.field_specs.field_inv.?
        (I B!)
    ))))
    (=>
      ...
      (=>
       ...
       (and
        ...
        (=>
         (> (curve25519_dalek!specs.field_specs_u64.p.? (I 0)) 2)
         (=>
          (= i1_i2@ (curve25519_dalek!specs.field_specs.field_mul.? (I i1_std@) (I i2_std@)))
          (=>
           (= sq_inv@ (curve25519_dalek!specs.field_specs.field_square.? (I invsqrt_std!)))
           (and
            (=>
             (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_four_factor_rearrange.
              invsqrt_std! u1! invsqrt_std! t_aff!
             )
             (=>
              %%location_label%%1
              (= i1_i2@ (curve25519_dalek!specs.field_specs.field_mul.? (I sq_inv@) (I (curve25519_dalek!specs.field_specs.field_mul.?
                  (I u1!) (I t_aff!)
            ))))))
            (=>
             (= i1_i2@ (curve25519_dalek!specs.field_specs.field_mul.? (I sq_inv@) (I (curve25519_dalek!specs.field_specs.field_mul.?
             ...
             (and
              (and
               (=>
                ...
                (=>
                 %%location_label%%2
                 (= z_inv_std@ (curve25519_dalek!specs.field_specs.field_mul.? (I i1_i2@) (I t_aff!)))
               ))
               (=>
                (= z_inv_std@ (curve25519_dalek!specs.field_specs.field_mul.? (I i1_i2@) (I t_aff!)))
                (and
                 (=>
                  (= tmp%1 (curve25519_dalek!specs.field_specs.field_mul.? (I u1!) (I t_aff!)))
                  (=>
                   (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_assoc.
                    sq_inv@ tmp%1 t_aff!
                   )
                   (=>
                    ...
                    (=>
                     %%location_label%%3
                     (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                         (I sq_inv@) (I (curve25519_dalek!specs.field_specs.field_mul.? (I u1!) (I t_aff!)))
                        )
                       ) (I t_aff!)
                      ) (curve25519_dalek!specs.field_specs.field_mul.? (I sq_inv@) (I (curve25519_dalek!specs.field_specs.field_mul.?
                 ...
                 (=>
                  ...
                  (=>
                   %%location_label%%4
                   (= z_inv_std@ (curve25519_dalek!specs.field_specs.field_mul.? (I sq_inv@) (I (curve25519_dalek!specs.field_specs.field_mul.?
                       (I u1!) (I (curve25519_dalek!specs.field_specs.field_square.? (I t_aff!)))
              )))))))))
              (=>
               (= z_inv_std@ (curve25519_dalek!specs.field_specs.field_mul.? (I sq_inv@) (I (curve25519_dalek!specs.field_specs.field_mul.?
               ...
               (=>
                (= tmp%2 (= z_inv_std@ (curve25519_dalek!specs.field_specs.field_mul.? (I sq_inv@) (
                    I (curve25519_dalek!specs.field_specs.field_mul.? (I c_coeff!) (I (curve25519_dalek!specs.field_specs.field_square.?
                       (I B!)
                )))))))
                (and
                 (=>
                 ...
                 (=>
                  ...
                  (and
                   (or
                    (and
                     (=>
                      (curve25519_dalek!specs.field_specs.is_negative.? (I R@))
                      (=>
                       (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_neg_square_eq.
                        R@
                       )
                        ...
                        (=>
                         ...
                         (=>
                          ...
                          (and
                           (=>
                            %%location_label%%7
                            (req%vstd!arithmetic.div_mod.lemma_small_mod. R@ tmp%3)
                           )
                           (=>
                            (ens%vstd!arithmetic.div_mod.lemma_small_mod. R@ tmp%3)
                            %%switch_label%%0
                     )))))))
                     (=>
                    ...
                    (and
                     ...
                     (=>
                      %%location_label%%8
                      (= sq_inv@ (curve25519_dalek!specs.field_specs.field_square.? (I R@)))
                   )))
                   (=>
                    (= sq_inv@ (curve25519_dalek!specs.field_specs.field_square.? (I R@)))
                    (=>
                     (= sq_c@ (curve25519_dalek!specs.field_specs.field_square.? (I c_iad!)))
                     (=>
                      (= sq_inv_B@ (curve25519_dalek!specs.field_specs.field_square.? (I (curve25519_dalek!specs.field_specs.field_inv.?
                          (I B!)
                      ))))
                      (and
                       (=>
                        (= tmp%4 (curve25519_dalek!specs.field_specs.field_inv.? (I B!)))
                        (=>
                         (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_product_of_squares_eq_square_of_product.
                          c_iad! tmp%4
                         )
                         (=>
                          %%location_label%%9
                          (= sq_inv@ (curve25519_dalek!specs.field_specs.field_mul.? (I sq_c@) (I sq_inv_B@)))
                       )))
                       (=>
                        (= sq_inv@ (curve25519_dalek!specs.field_specs.field_mul.? (I sq_c@) (I sq_inv_B@)))
                        (and
                         (=>
                          (= tmp%5 (curve25519_dalek!specs.field_specs.field_square.? (I B!)))
                          (=>
                           (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_four_factor_rearrange.
                            sq_c@ sq_inv_B@ c_coeff! tmp%5
                           )
                           (=>
                            %%location_label%%10
                            (= z_inv_std@ (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                                (I sq_c@) (I c_coeff!)
                               )
                              ) (I (curve25519_dalek!specs.field_specs.field_mul.? (I sq_inv_B@) (I (curve25519_dalek!specs.field_specs.field_square.?
                                  (I B!)
                         )))))))))
                         (=>
                          (= z_inv_std@ (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                           ...
                           (=>
                            ...
                            (and
                             (=>
                              (ens%curve25519_dalek!specs.field_specs_u64.p_gt_2. 0)
                              (=>
                               (= tmp%7 (curve25519_dalek!specs.field_specs.field_inv.? (I B!)))
                               (=>
                                (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_product_of_squares_eq_square_of_product.
                                 tmp%7 B!
                                )
                                (and
                                 ...
                                 (=>
                                  ...
                                  (=>
                                   %%location_label%%14
                                   (= (curve25519_dalek!specs.field_specs.field_mul.? (I sq_inv_B@) (I (curve25519_dalek!specs.field_specs.field_square.?
                                       (I B!)
                                     ))
                                    ) 1
                             )))))))
                             (=>
                              ...
                              (and
                               (=>
                                (= tmp%8 (curve25519_dalek!specs.field_specs.field_mul.? (I sq_c@) (I c_coeff!)))
                                (=>
                                 (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_one_right.
                                  tmp%8
                                 )
                                 (=>
                                  (= tmp%9 (curve25519_dalek!specs.field_specs.field_mul.? (I sq_c@) (I c_coeff!)))
                                  (and
                                   (=>
                                    %%location_label%%15
                                    (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_element_reduced.
