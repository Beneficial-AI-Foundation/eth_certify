...
;; MODULE 'module lemmas::scalar_lemmas_extra'
;; curve25519-dalek/src/lemmas/scalar_lemmas_extra.rs:567:1: 574:2 (#0)
...
(assert
 (distinct fuel%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. fuel%vstd!arithmetic.div_mod.lemma_add_mod_noop.
  ...
  fuel%vstd!array.axiom_array_has_resolved. fuel%vstd!bits.lemma_u64_shl_is_mul. fuel%vstd!raw_ptr.impl&%3.view.
  ...
  fuel%vstd!view.impl&%26.view. fuel%vstd!view.impl&%32.view. fuel%curve25519_dalek!specs.core_specs.bytes_as_nat_suffix.
  fuel%curve25519_dalek!specs.core_specs.word64_from_bytes. fuel%curve25519_dalek!specs.core_specs.word64_from_bytes_partial.
  fuel%curve25519_dalek!specs.scalar52_specs.five_limbs_to_nat_aux. fuel%curve25519_dalek!specs.scalar52_specs.group_order.
  fuel%curve25519_dalek!specs.scalar52_specs.montgomery_radix. fuel%vstd!arithmetic.mul.group_mul_is_distributive.
...
(assert
 (=>
  ...
  (forall ((x! Int) (y! Int) (z! Int)) (!
    ...
    :qid user_vstd__arithmetic__mul__lemma_mul_is_distributive_sub_24
    :skolemid skolem_user_vstd__arithmetic__mul__lemma_mul_is_distributive_sub_24
))))
...
;; Function-Specs vstd::bits::lemma_u64_mul_pow2_le_max_iff_max_shr
(declare-fun req%vstd!bits.lemma_u64_mul_pow2_le_max_iff_max_shr. (Int Int Int) Bool)
(declare-const %%global_location_label%%10 Bool)
(assert
 (forall ((x! Int) (shift! Int) (max! Int)) (!
   (= (req%vstd!bits.lemma_u64_mul_pow2_le_max_iff_max_shr. x! shift! max!) (=>
   ...
   :pattern ((req%vstd!bits.lemma_u64_mul_pow2_le_max_iff_max_shr. x! shift! max!))
   :qid internal_req__vstd!bits.lemma_u64_mul_pow2_le_max_iff_max_shr._definition
   :skolemid skolem_internal_req__vstd!bits.lemma_u64_mul_pow2_le_max_iff_max_shr._definition
)))
(declare-fun ens%vstd!bits.lemma_u64_mul_pow2_le_max_iff_max_shr. (Int Int Int) Bool)
(assert
 (forall ((x! Int) (shift! Int) (max! Int)) (!
   (= (ens%vstd!bits.lemma_u64_mul_pow2_le_max_iff_max_shr. x! shift! max!) (= (<= (Mul
       x! (vstd!arithmetic.power2.pow2.? (I shift!))
      ) max!
     ) (<= x! (uClip 64 (bitshr (I max!) (I shift!))))
   ))
   :pattern ((ens%vstd!bits.lemma_u64_mul_pow2_le_max_iff_max_shr. x! shift! max!))
   :qid internal_ens__vstd!bits.lemma_u64_mul_pow2_le_max_iff_max_shr._definition
   :skolemid skolem_internal_ens__vstd!bits.lemma_u64_mul_pow2_le_max_iff_max_shr._definition
)))
 ...
 (forall ((lo! curve25519_dalek!backend.serial.u64.scalar.Scalar52.) (words! %%Function%%)
   ...
   (= (ens%curve25519_dalek!lemmas.scalar_lemmas_extra.lemma_lo_limbs_bounded. lo! words!
     mask!
      ...
      :qid user_curve25519_dalek__lemmas__scalar_lemmas_extra__lemma_lo_limbs_bounded_29
      :skolemid skolem_user_curve25519_dalek__lemmas__scalar_lemmas_extra__lemma_lo_limbs_bounded_29
   )))
 ...
 (forall ((hi! curve25519_dalek!backend.serial.u64.scalar.Scalar52.) (words! %%Function%%)
   ...
   (= (ens%curve25519_dalek!lemmas.scalar_lemmas_extra.lemma_hi_limbs_bounded. hi! words!
     mask!
      ...
      :qid user_curve25519_dalek__lemmas__scalar_lemmas_extra__lemma_hi_limbs_bounded_31
      :skolemid skolem_user_curve25519_dalek__lemmas__scalar_lemmas_extra__lemma_hi_limbs_bounded_31
   )))
...
;; Function-Specs curve25519_dalek::lemmas::scalar_lemmas_extra::lemma_limb_from_adjacent_words
(declare-fun req%curve25519_dalek!lemmas.scalar_lemmas_extra.lemma_limb_from_adjacent_words.
...
(assert
 (forall ((prev_word! Int) (next_word! Int) (prev_shift! Int) (high_bits! Int) (low_mask_shift!
    Int
   ) (limb! Int) (high_part! Int) (low_part! Int)
  ) (!
   (= (req%curve25519_dalek!lemmas.scalar_lemmas_extra.lemma_limb_from_adjacent_words.
     prev_word! next_word! prev_shift! high_bits! low_mask_shift! limb! high_part! low_part!
    ) (and
     (=>
     ...
     (=>
      ...
      (= (Add prev_shift! high_bits!) 64)
     )
     (=>
      %%global_location_label%%36
      (= (Add low_mask_shift! (Sub 52 high_bits!)) 64)
     )
     (=>
      %%global_location_label%%37
      (= limb! (uClip 64 (bitand (I (uClip 64 (bitor (I (uClip 64 (bitshr (I prev_word!) (I prev_shift!))))
            (I (uClip 64 (bitshl (I next_word!) (I high_bits!))))
          ))
         ) (I (uClip 64 (bitshr (I 18446744073709551615) (I 12))))
     ))))
     (=>
      %%global_location_label%%38
      (= high_part! (uClip 64 (bitshr (I prev_word!) (I prev_shift!))))
     )
     (=>
      %%global_location_label%%39
      (= low_part! (uClip 64 (bitand (I next_word!) (I (uClip 64 (bitshr (I 18446744073709551615)
            (I low_mask_shift!)
   )))))))))
   :pattern ((req%curve25519_dalek!lemmas.scalar_lemmas_extra.lemma_limb_from_adjacent_words.
     prev_word! next_word! prev_shift! high_bits! low_mask_shift! limb! high_part! low_part!
   ))
   :qid internal_req__curve25519_dalek!lemmas.scalar_lemmas_extra.lemma_limb_from_adjacent_words._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.scalar_lemmas_extra.lemma_limb_from_adjacent_words._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.scalar_lemmas_extra.lemma_limb_from_adjacent_words.
 (Int Int Int Int Int Int Int Int) Bool
)
(assert
 (forall ((prev_word! Int) (next_word! Int) (prev_shift! Int) (high_bits! Int) (low_mask_shift!
   ...
   (= (ens%curve25519_dalek!lemmas.scalar_lemmas_extra.lemma_limb_from_adjacent_words.
     prev_word! next_word! prev_shift! high_bits! low_mask_shift! limb! high_part! low_part!
    ) (= limb! (nClip (Add high_part! (nClip (Mul (vstd!arithmetic.power2.pow2.? (I high_bits!))
         low_part!
   ))))))
   :pattern ((ens%curve25519_dalek!lemmas.scalar_lemmas_extra.lemma_limb_from_adjacent_words.
     prev_word! next_word! prev_shift! high_bits! low_mask_shift! limb! high_part! low_part!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.scalar_lemmas_extra.lemma_limb_from_adjacent_words._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.scalar_lemmas_extra.lemma_limb_from_adjacent_words._definition
)))

;; Function-Specs curve25519_dalek::lemmas::scalar_lemmas_extra::lemma_word_contribution_decomposition
(declare-fun req%curve25519_dalek!lemmas.scalar_lemmas_extra.lemma_word_contribution_decomposition.
...
(assert
 (forall ((word! Int) (scale! Int) (split_pos! Int) (mask_shift! Int) (low_part! Int)
   (high_part! Int)
  ) (!
   (= (req%curve25519_dalek!lemmas.scalar_lemmas_extra.lemma_word_contribution_decomposition.
     word! scale! split_pos! mask_shift! low_part! high_part!
    ) (and
     (=>
     ...
     (=>
      ...
      (= (Add mask_shift! split_pos!) 64)
     )
     (=>
      %%global_location_label%%42
      (= low_part! (uClip 64 (bitand (I word!) (I (uClip 64 (bitshr (I 18446744073709551615)
            (I mask_shift!)
     )))))))
     (=>
      %%global_location_label%%43
      (= high_part! (uClip 64 (bitshr (I word!) (I split_pos!))))
   )))
   :pattern ((req%curve25519_dalek!lemmas.scalar_lemmas_extra.lemma_word_contribution_decomposition.
     word! scale! split_pos! mask_shift! low_part! high_part!
   ))
   :qid internal_req__curve25519_dalek!lemmas.scalar_lemmas_extra.lemma_word_contribution_decomposition._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.scalar_lemmas_extra.lemma_word_contribution_decomposition._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.scalar_lemmas_extra.lemma_word_contribution_decomposition.
 (Int Int Int Int Int Int) Bool
)
(assert
 (forall ((word! Int) (scale! Int) (split_pos! Int) (mask_shift! Int) (low_part! Int)
   ...
   (= (ens%curve25519_dalek!lemmas.scalar_lemmas_extra.lemma_word_contribution_decomposition.
     word! scale! split_pos! mask_shift! low_part! high_part!
    ) (= (nClip (Mul (vstd!arithmetic.power2.pow2.? (I scale!)) word!)) (nClip (Add (nClip
        (Mul (vstd!arithmetic.power2.pow2.? (I scale!)) low_part!)
       ) (nClip (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Add scale! split_pos!)))) high_part!))
   ))))
   :pattern ((ens%curve25519_dalek!lemmas.scalar_lemmas_extra.lemma_word_contribution_decomposition.
     word! scale! split_pos! mask_shift! low_part! high_part!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.scalar_lemmas_extra.lemma_word_contribution_decomposition._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.scalar_lemmas_extra.lemma_word_contribution_decomposition._definition
)))
...
;; Function-Def curve25519_dalek::lemmas::scalar_lemmas_extra::lemma_montgomery_reduced_sum_congruent
;; curve25519-dalek/src/lemmas/scalar_lemmas_extra.rs:567:1: 574:2 (#0)
(get-info :all-statistics)
(push)
 (declare-const result_nat! Int)
 (declare-const hi_nat! Int)
 (declare-const lo_nat! Int)
 (declare-const hi_raw_nat! Int)
 (declare-const lo_raw_nat! Int)
 (declare-const wide_input! Int)
 ...
 (assert
  (not (=>
    (= r_nat@ (curve25519_dalek!specs.scalar52_specs.montgomery_radix.? (I 0)))
    (=>
     (= group_int@ (curve25519_dalek!specs.scalar52_specs.group_order.? (I 0)))
     (=>
      (ens%vstd!arithmetic.power2.lemma_pow2_pos. 260)
      (and
       (=>
        %%location_label%%0
        (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. wide_input! r_nat@)
       )
       (=>
        (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. wide_input! r_nat@)
        (and
         (=>
          (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. hi_raw_nat! r_nat@)
          (=>
           (= tmp%1 (nClip (Mul hi_raw_nat! r_nat@)))
           (=>
            (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. r_nat@ tmp%1 lo_raw_nat!)
            (=>
             %%location_label%%1
             (= (nClip (Add (nClip (Mul (nClip (Mul hi_raw_nat! r_nat@)) r_nat@)) (nClip (Mul lo_raw_nat!
                  r_nat@
               )))
              ) (nClip (Mul wide_input! r_nat@))
         )))))
         (=>
          (= (nClip (Add (nClip (Mul (nClip (Mul hi_raw_nat! r_nat@)) r_nat@)) (nClip (Mul lo_raw_nat!
               r_nat@
          ...
          (=>
           (= tmp%2 (EucMod (nClip (Add hi_nat! lo_nat!)) (curve25519_dalek!specs.scalar52_specs.group_order.?
              (I 0)
           )))
           (=>
            (= tmp%3 (curve25519_dalek!specs.scalar52_specs.group_order.? (I 0)))
            (and
             (=>
              %%location_label%%2
             ...
             (=>
              ...
              (=>
               (= tmp%4 (EucMod (nClip (Add hi_nat! lo_nat!)) (curve25519_dalek!specs.scalar52_specs.group_order.?
                  (I 0)
               )))
               (=>
                (= tmp%5 (nClip (Add hi_nat! lo_nat!)))
                (and
                 (=>
                  %%location_label%%3
                  (req%curve25519_dalek!lemmas.scalar_lemmas.lemma_mul_factors_congruent_implies_products_congruent.
                   r_nat@ tmp%4 tmp%5 group_int@
                 ))
                 (=>
                  (ens%curve25519_dalek!lemmas.scalar_lemmas.lemma_mul_factors_congruent_implies_products_congruent.
                   r_nat@ tmp%4 tmp%5 group_int@
                  ...
                  (=>
                   (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add. r_nat@ hi_nat! lo_nat!)
                   (=>
                    (= tmp%6 (nClip (Mul r_nat@ hi_nat!)))
                    (=>
                     (= tmp%7 (nClip (Mul r_nat@ lo_nat!)))
                     (and
                      (=>
                       %%location_label%%4
                       (req%vstd!arithmetic.div_mod.lemma_add_mod_noop. tmp%6 tmp%7 group_int@)
                      )
                      (=>
                       (ens%vstd!arithmetic.div_mod.lemma_add_mod_noop. tmp%6 tmp%7 group_int@)
                       (=>
                        (= tmp%8 (nClip (Mul (nClip (Mul hi_raw_nat! r_nat@)) r_nat@)))
                        (=>
                         (= tmp%9 (nClip (Mul lo_raw_nat! r_nat@)))
                         (and
                          (=>
                           %%location_label%%5
                           (req%vstd!arithmetic.div_mod.lemma_add_mod_noop. tmp%8 tmp%9 group_int@)
                          )
                          (=>
                           (ens%vstd!arithmetic.div_mod.lemma_add_mod_noop. tmp%8 tmp%9 group_int@)
                           (=>
                            %%location_label%%6
                            (= (EucMod (nClip (Mul result_nat! (curve25519_dalek!specs.scalar52_specs.montgomery_radix.?
                                 (I 0)
