...
;; curve25519-dalek/src/lemmas/montgomery_curve_lemmas.rs:482:1: 482:37 (#0)
...
;; Function-Def curve25519_dalek::lemmas::montgomery_curve_lemmas::lemma_field_sqrt_zero
;; curve25519-dalek/src/lemmas/montgomery_curve_lemmas.rs:482:1: 482:37 (#0)
          ...
          (=>
           ...
           (=>
            ...
            (and
             ...
             (= (curve25519_dalek!specs.field_specs.field_mul.? (I y@) (I y@)) (curve25519_dalek!specs.field_specs_u64.field_canonical.?
               (I 0)
       ))))))))
       (=>
        (and
        ...
        (=>
         ...
         (exists ((y$ Poly)) (!
           (and
            (has_type y$ NAT)
            (and
             (< (%I y$) (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
             (= (curve25519_dalek!specs.field_specs.field_mul.? y$ y$) (curve25519_dalek!specs.field_specs_u64.field_canonical.?
               (I 0)
           ))))
           :pattern ((curve25519_dalek!specs.field_specs.field_mul.? y$ y$))
           :qid user_curve25519_dalek__lemmas__montgomery_curve_lemmas__lemma_field_sqrt_zero_45
           :skolemid skolem_user_curve25519_dalek__lemmas__montgomery_curve_lemmas__lemma_field_sqrt_zero_45
    )))))))
    (=>
     (exists ((y$ Poly)) (!
       (and
       ...
       :pattern ((curve25519_dalek!specs.field_specs.field_mul.? y$ y$))
       :qid user_curve25519_dalek__lemmas__montgomery_curve_lemmas__lemma_field_sqrt_zero_46
       :skolemid skolem_user_curve25519_dalek__lemmas__montgomery_curve_lemmas__lemma_field_sqrt_zero_46
     ))
     (=>
      (fuel_bool fuel%curve25519_dalek!specs.field_specs.field_sqrt.)
      (=>
       (= y$1@ (curve25519_dalek!specs.field_specs.field_sqrt.? (I 0)))
       (=>
        (= tmp%2 (and
          (< y$1@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
          (= (curve25519_dalek!specs.field_specs_u64.field_canonical.? (I (nClip (Mul y$1@ y$1@))))
           0
        )))
        (and
         (=>
              ...
              (=>
               ...
               (=>
                ...
                (and
                 (=>
                  %%location_label%%7
                  (req%vstd!arithmetic.div_mod.lemma_small_mod. y$1@ tmp%4)
                 )
                 (=>
                  (ens%vstd!arithmetic.div_mod.lemma_small_mod. y$1@ tmp%4)
                  (=>
                   %%location_label%%8
                   (= y$1@ 0)
           ))))))))
