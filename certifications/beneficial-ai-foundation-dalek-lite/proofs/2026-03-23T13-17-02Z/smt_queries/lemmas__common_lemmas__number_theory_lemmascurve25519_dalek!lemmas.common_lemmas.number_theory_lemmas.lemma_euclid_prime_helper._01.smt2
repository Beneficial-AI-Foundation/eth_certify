...
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:1548:7: 1548:59 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::number_theory_lemmas::lemma_euclid_prime_helper
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:1548:7: 1548:59 (#0)
          ...
          (=>
           ...
           (and
            (and
             (=>
              %%location_label%%5
              (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. p! a!)
             )
             (=>
              (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. p! a!)
              (=>
               %%location_label%%6
               (= p! (nClip (Add (nClip (Mul q@ a!)) r@)))
            )))
            (=>
             (= p! (nClip (Add (nClip (Mul q@ a!)) r@)))
             (and
                ...
                (and
                 ...
                 (=>
                  ...
                  (=>
                   (= tmp%4 (nClip (Mul q@ a!)))
                   (=>
                    (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub_other_way. b! p! tmp%4)
                    (=>
                     (= tmp%5 (= (Mul (Sub p! (nClip (Mul q@ a!))) b!) (Sub (nClip (Mul p! b!)) (nClip (Mul
                          (nClip (Mul q@ a!)) b!
                     )))))
                     (and
                      (=>
                      ...
                      (=>
                       tmp%5
                       (=>
                        (ens%vstd!arithmetic.mul.lemma_mul_is_associative. q@ a! b!)
                        (=>
                         %%location_label%%9
                         (= (nClip (Mul r@ b!)) (Sub (nClip (Mul p! b!)) (nClip (Mul (nClip (Mul q@ a!)) b!))))
               ))))))))))
               (=>
                (= (nClip (Mul r@ b!)) (Sub (nClip (Mul p! b!)) (nClip (Mul (nClip (Mul q@ a!)) b!))))
                (and
                 (and
                  (=>
                   %%location_label%%10
                   (req%vstd!arithmetic.div_mod.lemma_mod_multiples_basic. b! p!)
                  )
                  (=>
                   (ens%vstd!arithmetic.div_mod.lemma_mod_multiples_basic. b! p!)
                   (=>
                    %%location_label%%11
                    (= (EucMod (nClip (Mul p! b!)) p!) 0)
                 )))
                 (=>
                  (= (EucMod (nClip (Mul p! b!)) p!) 0)
                  (and
                   (=>
                    ...
                    (and
                     (=>
                      %%location_label%%12
                      (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. q@ tmp%6 p!)
                     )
                     (=>
                      (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. q@ tmp%6 p!)
                      (=>
                       (= tmp%7 (= (EucMod (nClip (Mul a! b!)) p!) 0))
                       (and
                        (=>
                         %%location_label%%13
                         tmp%7
                        ...
                        (=>
                         tmp%7
                         (=>
                          (ens%vstd!arithmetic.mul.lemma_mul_basics. q@)
                          (and
                           (=>
                            %%location_label%%14
                           ...
                           (=>
                            ...
                            (=>
                             %%location_label%%15
                             (= (EucMod (nClip (Mul q@ (nClip (Mul a! b!)))) p!) 0)
                   ))))))))))
                   (=>
                    (= (EucMod (nClip (Mul q@ (nClip (Mul a! b!)))) p!) 0)
                    (=>
                     (ens%vstd!arithmetic.mul.lemma_mul_is_associative. q@ a! b!)
                     (=>
                      (= tmp%8 (= (nClip (Mul (nClip (Mul q@ a!)) b!)) (nClip (Mul q@ (nClip (Mul a! b!))))))
                      (and
                       (=>
                        %%location_label%%16
                        tmp%8
                          ...
                          (and
                           (=>
                            ...
                            (and
                             (=>
                              %%location_label%%19
                              (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. q@ tmp%9 p!)
                             )
                             (=>
                              (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. q@ tmp%9 p!)
                              (=>
                               (ens%vstd!arithmetic.mul.lemma_mul_basics. q@)
                               (and
                                (=>
                           ...
                           (=>
                            (= (EucMod (nClip (Mul q@ (nClip (Mul a! b!)))) p!) 0)
                            (=>
                             (= tmp%10 (nClip (Mul p! b!)))
                             (=>
                              (= tmp%11 (nClip (Mul q@ (nClip (Mul a! b!)))))
                              (and
                               (=>
                                %%location_label%%22
                                (req%curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.lemma_mod_difference_zero.
                 ...
                 (=>
                  ...
                  (and
                   (and
                    (=>
                     %%location_label%%25
                     (req%vstd!arithmetic.div_mod.lemma_mod_bound. p! a!)
                    )
                    (=>
                     (ens%vstd!arithmetic.div_mod.lemma_mod_bound. p! a!)
                     (=>
                      %%location_label%%26
                      (< r@ p!)
                   )))
