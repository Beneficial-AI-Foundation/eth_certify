...
;; curve25519-dalek/src/lemmas/common_lemmas/bits_as_nat_lemmas.rs:445:1: 445:87 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::bits_as_nat_lemmas::lemma_bits_from_bytes_eq_u8_32_as_nat
;; curve25519-dalek/src/lemmas/common_lemmas/bits_as_nat_lemmas.rs:445:1: 445:87 (#0)
...
(push)
 ...
 (assert
  (forall ((i$ Poly)) (!
    ...
    :qid user_curve25519_dalek__lemmas__common_lemmas__bits_as_nat_lemmas__lemma_bits_from_bytes_eq_u8_32_as_nat_73
    :skolemid skolem_user_curve25519_dalek__lemmas__common_lemmas__bits_as_nat_lemmas__lemma_bits_from_bytes_eq_u8_32_as_nat_73
 )))
 ;; assertion failed
          ...
          (and
           (and
            ...
            (=>
             ...
             (=>
              %%location_label%%5
              (= (curve25519_dalek!specs.core_specs.u8_32_as_nat_rec.? (Poly%array%. bytes!) (I 0))
               (nClip (Add (curve25519_dalek!specs.core_specs.bytes_as_nat_prefix.? (vstd!view.View.view.?
                   $ (ARRAY $ (UINT 8) $ (CONST_INT 32)) (Poly%array%. bytes!)
                  ) (I 32)
                 ) (curve25519_dalek!specs.core_specs.u8_32_as_nat_rec.? (Poly%array%. bytes!) (I 32))
           ))))))
           (=>
            (= (curve25519_dalek!specs.core_specs.u8_32_as_nat_rec.? (Poly%array%. bytes!) (I 0))
             (nClip (Add (curve25519_dalek!specs.core_specs.bytes_as_nat_prefix.? (vstd!view.View.view.?
            ...
            (=>
             (= tmp%1 (= (curve25519_dalek!specs.core_specs.u8_32_as_nat_rec.? (Poly%array%. bytes!)
                (I 32)
               ) 0
             ))
             (and
