...
;; curve25519-dalek/src/lemmas/common_lemmas/div_mod_lemmas.rs:249:1: 249:53 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::div_mod_lemmas::lemma_int_nat_mod_equiv
;; curve25519-dalek/src/lemmas/common_lemmas/div_mod_lemmas.rs:249:1: 249:53 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= v_nat@ (nClip v!))
    (=>
     (= r_nat@ (EucMod v_nat@ m!))
     (=>
      (= q_nat@ (EucDiv v_nat@ m!))
      (and
       (and
        (=>
         %%location_label%%0
         (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. v! m!)
        )
        (=>
         (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. v! m!)
         (=>
          %%location_label%%1
          (= v_nat@ (nClip (Add (nClip (Mul q_nat@ m!)) r_nat@)))
       )))
       (=>
        (= v_nat@ (nClip (Add (nClip (Mul q_nat@ m!)) r_nat@)))
        (and
         (=>
          %%location_label%%2
          (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod_converse_mod. v! m! q_nat@
           r_nat@
         ))
         (=>
          (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod_converse_mod. v! m! q_nat@
           r_nat@
          )
          (=>
           %%location_label%%3
