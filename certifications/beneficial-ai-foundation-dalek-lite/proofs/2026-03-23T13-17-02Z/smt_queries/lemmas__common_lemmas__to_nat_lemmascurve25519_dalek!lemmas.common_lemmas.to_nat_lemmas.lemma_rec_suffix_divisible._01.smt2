...
;; curve25519-dalek/src/lemmas/common_lemmas/to_nat_lemmas.rs:295:1: 295:66 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::to_nat_lemmas::lemma_rec_suffix_divisible
;; curve25519-dalek/src/lemmas/common_lemmas/to_nat_lemmas.rs:295:1: 295:66 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= decrease%init0 (Sub 32 n!))
    (=>
     (= d@ (vstd!arithmetic.power2.pow2.? (I (nClip (Mul n! 8)))))
     (=>
      (= goal@ (= (EucMod (curve25519_dalek!specs.core_specs.u8_32_as_nat_rec.? (Poly%array%.
           bytes!
          ) (I n!)
         ) d@
        ) 0
        ...
        (or
         (and
               ...
               (=>
                ...
                (and
                 (and
                  (=>
                   %%location_label%%1
                   (req%vstd!arithmetic.div_mod.lemma_small_mod. 0 d@)
                  )
                  (=>
                   (ens%vstd!arithmetic.div_mod.lemma_small_mod. 0 d@)
                   (=>
                    %%location_label%%2
                    (= (EucMod 0 d@) 0)
                 )))
          ...
          (=>
           (not (>= n! 32))
           (=>
            (= term1@ (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY
                   $ (UINT 8) $ (CONST_INT 32)
                  ) (Poly%array%. bytes!)
                 ) (I n!)
                )
            ...
            (=>
             (= term2@ (curve25519_dalek!specs.core_specs.u8_32_as_nat_rec.? (Poly%array%. bytes!)
               (I (nClip (Add n! 1)))
             ))
             (=>
              (= tmp%3 (nClip (Mul n! 8)))
               ...
               (and
                (=>
                 ...
                 (and
                  (=>
                   %%location_label%%3
                   (req%vstd!arithmetic.div_mod.lemma_mod_multiples_basic. tmp%4 d@)
                  )
                  (=>
                   (ens%vstd!arithmetic.div_mod.lemma_mod_multiples_basic. tmp%4 d@)
                   (=>
                    %%location_label%%4
                    (= (EucMod term1@ d@) 0)
                ))))
                   ...
                   (and
                    ...
                    (and
                     ...
                     (=>
                      ...
                      (=>
                       %%location_label%%7
                       (= (EucMod term2@ (vstd!arithmetic.power2.pow2.? (I (nClip (Mul (nClip (Add n! 1)) 8)))))
                        0
                  ))))))
                  (=>
                   (= (EucMod term2@ (vstd!arithmetic.power2.pow2.? (I (nClip (Mul (nClip (Add n! 1)) 8)))))
                   ...
                   (and
                    (and
                     (=>
                      (= tmp%6 (nClip (Mul n! 8)))
                      (=>
                       (ens%vstd!arithmetic.power2.lemma_pow2_adds. tmp%6 8)
                       (=>
                        %%location_label%%8
                        (= (vstd!arithmetic.power2.pow2.? (I (nClip (Mul (nClip (Add n! 1)) 8)))) (nClip (Mul
                           d@ (vstd!arithmetic.power2.pow2.? (I 8))
                     ))))))
                     (=>
                      (= (vstd!arithmetic.power2.pow2.? (I (nClip (Mul (nClip (Add n! 1)) 8)))) (nClip (Mul
                         d@ (vstd!arithmetic.power2.pow2.? (I 8))
                      ...
                      (=>
                       (= tmp%7 (vstd!arithmetic.power2.pow2.? (I 8)))
                       (and
                        (=>
                         %%location_label%%9
                         (req%vstd!arithmetic.div_mod.lemma_mod_breakdown. term2@ d@ tmp%7)
                        )
                        (=>
                         (ens%vstd!arithmetic.div_mod.lemma_mod_breakdown. term2@ d@ tmp%7)
                         (=>
                          %%location_label%%10
                          (= (EucMod term2@ d@) 0)
                    ))))))
                     ...
                     (and
                      (and
                       ...
                       (=>
                        ...
                        (=>
                         %%location_label%%12
                         (= (EucMod (nClip (Add term1@ term2@)) d@) 0)
                      )))
                      (=>
                       (= (EucMod (nClip (Add term1@ term2@)) d@) 0)
                       (=>
                        (= tmp%8 (= (curve25519_dalek!specs.core_specs.u8_32_as_nat_rec.? (Poly%array%. bytes!)
                           (I n!)
                          ) (nClip (Add term1@ term2@))
                        ))
                        (and
                         (=>
                          %%location_label%%13
