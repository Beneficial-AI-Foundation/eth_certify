...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:2543:1: 2543:50 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_sub_neg_eq_add
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:2543:1: 2543:50 (#0)
        ...
        (=>
         ...
         (=>
          ...
          (and
           (=>
            %%location_label%%0
            (req%vstd!arithmetic.div_mod.lemma_add_mod_noop. c! tmp%1 p@)
           )
           (=>
            (ens%vstd!arithmetic.div_mod.lemma_add_mod_noop. c! tmp%1 p@)
            (and
             (=>
              %%location_label%%1
              (req%vstd!arithmetic.div_mod.lemma_add_mod_noop. c! d! p@)
             )
             (=>
              (ens%vstd!arithmetic.div_mod.lemma_add_mod_noop. c! d! p@)
              (and
               (=>
                %%location_label%%2
                (req%vstd!arithmetic.div_mod.lemma_mod_twice. d! p@)
               )
               (=>
                (ens%vstd!arithmetic.div_mod.lemma_mod_twice. d! p@)
                (=>
                 %%location_label%%3
                 (= (curve25519_dalek!specs.field_specs.field_sub.? (I c!) (I neg_d@)) (curve25519_dalek!specs.field_specs.field_add.?
                   (I c!) (I d!)
      )))))))))))))
      (=>
       (= (curve25519_dalek!specs.field_specs.field_sub.? (I c!) (I neg_d@)) (curve25519_dalek!specs.field_specs.field_add.?
