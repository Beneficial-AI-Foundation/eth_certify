...
;; curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:1360:1: 1371:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::pow_lemmas::lemma_pow2_distributivity_over_word
;; curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:1360:1: 1371:2 (#0)
(get-info :all-statistics)
(push)
 (declare-const word! Int)
 ...
 (assert
  (not (=>
    (= x1@ (nClip (Mul byte0! (vstd!arithmetic.power2.pow2.? (I 0)))))
    (=>
     (= x2@ (nClip (Mul byte1! (vstd!arithmetic.power2.pow2.? (I 8)))))
     (=>
      (= x3@ (nClip (Mul byte2! (vstd!arithmetic.power2.pow2.? (I 16)))))
      (=>
       (= x4@ (nClip (Mul byte3! (vstd!arithmetic.power2.pow2.? (I 24)))))
       (=>
        (= x5@ (nClip (Mul byte4! (vstd!arithmetic.power2.pow2.? (I 32)))))
        (=>
         (= x6@ (nClip (Mul byte5! (vstd!arithmetic.power2.pow2.? (I 40)))))
         (=>
          (= x7@ (nClip (Mul byte6! (vstd!arithmetic.power2.pow2.? (I 48)))))
          (=>
           (= x8@ (nClip (Mul byte7! (vstd!arithmetic.power2.pow2.? (I 56)))))
           (=>
            (= tmp%1 (vstd!arithmetic.power2.pow2.? (I exp!)))
            (=>
             (ens%curve25519_dalek!lemmas.common_lemmas.mul_lemmas.lemma_mul_distributive_8_terms.
              tmp%1 x1@ x2@ x3@ x4@ x5@ x6@ x7@ x8@
             )
             (=>
              (= tmp%2 (= (nClip (Mul word! (vstd!arithmetic.power2.pow2.? (I exp!)))) (nClip (Add
                  (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip (Mul (nClip (Mul byte0!
                                  (vstd!arithmetic.power2.pow2.? (I 0))
                                 )
                                ) (vstd!arithmetic.power2.pow2.? (I exp!))
                               )
                              ) (nClip (Mul (nClip (Mul byte1! (vstd!arithmetic.power2.pow2.? (I 8)))) (vstd!arithmetic.power2.pow2.?
                                 (I exp!)
                             ))))
                            ) (nClip (Mul (nClip (Mul byte2! (vstd!arithmetic.power2.pow2.? (I 16)))) (vstd!arithmetic.power2.pow2.?
                               (I exp!)
                           ))))
                          ) (nClip (Mul (nClip (Mul byte3! (vstd!arithmetic.power2.pow2.? (I 24)))) (vstd!arithmetic.power2.pow2.?
                             (I exp!)
                         ))))
                        ) (nClip (Mul (nClip (Mul byte4! (vstd!arithmetic.power2.pow2.? (I 32)))) (vstd!arithmetic.power2.pow2.?
                           (I exp!)
                       ))))
                      ) (nClip (Mul (nClip (Mul byte5! (vstd!arithmetic.power2.pow2.? (I 40)))) (vstd!arithmetic.power2.pow2.?
                         (I exp!)
                     ))))
                    ) (nClip (Mul (nClip (Mul byte6! (vstd!arithmetic.power2.pow2.? (I 48)))) (vstd!arithmetic.power2.pow2.?
                       (I exp!)
                   ))))
                  ) (nClip (Mul (nClip (Mul byte7! (vstd!arithmetic.power2.pow2.? (I 56)))) (vstd!arithmetic.power2.pow2.?
                     (I exp!)
              )))))))
              (and
               (=>
               ...
               (=>
                tmp%2
                (=>
                 (ens%vstd!arithmetic.power2.lemma_pow2_adds. 0 exp!)
                 (=>
                  (= tmp%3 (vstd!arithmetic.power2.pow2.? (I 0)))
                  (=>
                   (= tmp%4 (vstd!arithmetic.power2.pow2.? (I exp!)))
                   (=>
                    (ens%vstd!arithmetic.mul.lemma_mul_is_associative. byte0! tmp%3 tmp%4)
                    (=>
                     (= tmp%5 (= (nClip (Mul (nClip (Mul byte0! (vstd!arithmetic.power2.pow2.? (I 0)))) (vstd!arithmetic.power2.pow2.?
                          (I exp!)
                        ))
                       ) (nClip (Mul byte0! (vstd!arithmetic.power2.pow2.? (I exp!))))
                     ))
                     (and
                      (=>
                       %%location_label%%1
                      ...
                      (=>
                       tmp%5
                       (=>
                        (ens%vstd!arithmetic.power2.lemma_pow2_adds. 8 exp!)
                        (=>
                         (= tmp%6 (vstd!arithmetic.power2.pow2.? (I 8)))
                         (=>
                          (= tmp%7 (vstd!arithmetic.power2.pow2.? (I exp!)))
                          (=>
                           (ens%vstd!arithmetic.mul.lemma_mul_is_associative. byte1! tmp%6 tmp%7)
                           (=>
                            (= tmp%8 (= (nClip (Mul (nClip (Mul byte1! (vstd!arithmetic.power2.pow2.? (I 8)))) (vstd!arithmetic.power2.pow2.?
                                 (I exp!)
                               ))
                              ) (nClip (Mul byte1! (vstd!arithmetic.power2.pow2.? (I (nClip (Add exp! 8))))))
                            ))
                            (and
                             ...
                             (=>
                              tmp%8
                              (=>
                               (ens%vstd!arithmetic.power2.lemma_pow2_adds. 16 exp!)
                               (=>
                                (= tmp%9 (vstd!arithmetic.power2.pow2.? (I 16)))
                                (=>
                                 (= tmp%10 (vstd!arithmetic.power2.pow2.? (I exp!)))
                                 (=>
                                  (ens%vstd!arithmetic.mul.lemma_mul_is_associative. byte2! tmp%9 tmp%10)
                                  (=>
                                   (= tmp%11 (= (nClip (Mul (nClip (Mul byte2! (vstd!arithmetic.power2.pow2.? (I 16))))
                                       (vstd!arithmetic.power2.pow2.? (I exp!))
                                      )
                                     ) (nClip (Mul byte2! (vstd!arithmetic.power2.pow2.? (I (nClip (Add exp! 16))))))
                                   ))
                                   (and
                                    ...
                                    (=>
                                     tmp%11
                                     (=>
                                      (ens%vstd!arithmetic.power2.lemma_pow2_adds. 24 exp!)
                                      (=>
                                       (= tmp%12 (vstd!arithmetic.power2.pow2.? (I 24)))
                                       (=>
                                        (= tmp%13 (vstd!arithmetic.power2.pow2.? (I exp!)))
                                        (=>
                                         (ens%vstd!arithmetic.mul.lemma_mul_is_associative. byte3! tmp%12 tmp%13)
                                         (=>
                                          (= tmp%14 (= (nClip (Mul (nClip (Mul byte3! (vstd!arithmetic.power2.pow2.? (I 24))))
                                              (vstd!arithmetic.power2.pow2.? (I exp!))
                                             )
                                            ) (nClip (Mul byte3! (vstd!arithmetic.power2.pow2.? (I (nClip (Add exp! 24))))))
                                          ))
                                          (and
                                           ...
                                           (=>
                                            tmp%14
                                            (=>
                                             (ens%vstd!arithmetic.power2.lemma_pow2_adds. 32 exp!)
                                             (=>
                                              (= tmp%15 (vstd!arithmetic.power2.pow2.? (I 32)))
                                              (=>
                                               (= tmp%16 (vstd!arithmetic.power2.pow2.? (I exp!)))
                                               (=>
                                                (ens%vstd!arithmetic.mul.lemma_mul_is_associative. byte4! tmp%15 tmp%16)
                                                (=>
                                                 (= tmp%17 (= (nClip (Mul (nClip (Mul byte4! (vstd!arithmetic.power2.pow2.? (I 32))))
                                                     (vstd!arithmetic.power2.pow2.? (I exp!))
                                                    )
                                                   ) (nClip (Mul byte4! (vstd!arithmetic.power2.pow2.? (I (nClip (Add exp! 32))))))
                                                 ))
                                                 (and
                                                  ...
                                                  (=>
                                                   tmp%17
                                                   (=>
                                                    (ens%vstd!arithmetic.power2.lemma_pow2_adds. 40 exp!)
                                                    (=>
                                                     (= tmp%18 (vstd!arithmetic.power2.pow2.? (I 40)))
                                                     (=>
                                                      (= tmp%19 (vstd!arithmetic.power2.pow2.? (I exp!)))
                                                      (=>
                                                       (ens%vstd!arithmetic.mul.lemma_mul_is_associative. byte5! tmp%18 tmp%19)
                                                       (=>
                                                        (= tmp%20 (= (nClip (Mul (nClip (Mul byte5! (vstd!arithmetic.power2.pow2.? (I 40))))
                                                            (vstd!arithmetic.power2.pow2.? (I exp!))
                                                           )
                                                          ) (nClip (Mul byte5! (vstd!arithmetic.power2.pow2.? (I (nClip (Add exp! 40))))))
                                                        ))
                                                        (and
                                                         ...
                                                         (=>
                                                          tmp%20
                                                          (=>
                                                           (ens%vstd!arithmetic.power2.lemma_pow2_adds. 48 exp!)
                                                           (=>
                                                            (= tmp%21 (vstd!arithmetic.power2.pow2.? (I 48)))
                                                            (=>
                                                             (= tmp%22 (vstd!arithmetic.power2.pow2.? (I exp!)))
                                                             (=>
                                                              (ens%vstd!arithmetic.mul.lemma_mul_is_associative. byte6! tmp%21 tmp%22)
                                                              (=>
                                                               (= tmp%23 (= (nClip (Mul (nClip (Mul byte6! (vstd!arithmetic.power2.pow2.? (I 48))))
                                                                   (vstd!arithmetic.power2.pow2.? (I exp!))
                                                                  )
                                                                 ) (nClip (Mul byte6! (vstd!arithmetic.power2.pow2.? (I (nClip (Add exp! 48))))))
                                                               ))
                                                               (and
                                                                ...
                                                                (=>
                                                                 tmp%23
                                                                 (=>
                                                                  (ens%vstd!arithmetic.power2.lemma_pow2_adds. 56 exp!)
                                                                  (=>
                                                                   (= tmp%24 (vstd!arithmetic.power2.pow2.? (I 56)))
                                                                   (=>
                                                                    (= tmp%25 (vstd!arithmetic.power2.pow2.? (I exp!)))
                                                                    (=>
                                                                     (ens%vstd!arithmetic.mul.lemma_mul_is_associative. byte7! tmp%24 tmp%25)
                                                                     (=>
                                                                      (= tmp%26 (= (nClip (Mul (nClip (Mul byte7! (vstd!arithmetic.power2.pow2.? (I 56))))
                                                                          (vstd!arithmetic.power2.pow2.? (I exp!))
                                                                         )
                                                                        ) (nClip (Mul byte7! (vstd!arithmetic.power2.pow2.? (I (nClip (Add exp! 56))))))
                                                                      ))
                                                                      (and
                                                                       ...
                                                                       (=>
                                                                        ...
                                                                        (=>
                                                                         %%location_label%%9
                                                                         (= (nClip (Mul word! (vstd!arithmetic.power2.pow2.? (I exp!)))) (nClip (Add (nClip (Add
