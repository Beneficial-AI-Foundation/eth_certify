...
;; curve25519-dalek/src/lemmas/edwards_lemmas/constants_lemmas.rs:177:1: 177:45 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::constants_lemmas::lemma_edwards_d2_is_2d
;; curve25519-dalek/src/lemmas/edwards_lemmas/constants_lemmas.rs:177:1: 177:45 (#0)
...
(push)
 ...
 (assert
  (not (and
    (=>
     (let
      ((lp$ (curve25519_dalek!lemmas.edwards_lemmas.constants_lemmas.local_p.? (I 0))))
      (let
       ((d2_val$ (EucMod (curve25519_dalek!lemmas.edwards_lemmas.constants_lemmas.local_u5_nat.?
           (Poly%array%. (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
       ...
       (let
        ((d_val$ (EucMod (curve25519_dalek!lemmas.edwards_lemmas.constants_lemmas.local_u5_nat.?
            (Poly%array%. (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
              (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
        ...
        (= d2_val$ (EucMod (nClip (Mul 2 d_val$)) lp$))
     )))
     (=>
      (ens%curve25519_dalek!lemmas.edwards_lemmas.constants_lemmas.lemma_bridge_local_pow2_d2.
       0
