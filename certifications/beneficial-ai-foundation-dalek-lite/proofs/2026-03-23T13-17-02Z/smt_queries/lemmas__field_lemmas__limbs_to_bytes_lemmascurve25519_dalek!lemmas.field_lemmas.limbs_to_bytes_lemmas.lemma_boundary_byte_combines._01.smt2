...
;; curve25519-dalek/src/lemmas/field_lemmas/limbs_to_bytes_lemmas.rs:1941:7: 1947:2 (#0)
...
;; Function-Specs curve25519_dalek::lemmas::field_lemmas::limbs_to_bytes_lemmas::lemma_limb4_contribution_correctness
(declare-fun req%curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.lemma_limb4_contribution_correctness.
 (%%Function%% %%Function%%) Bool
)
...
(assert
 (forall ((limbs! %%Function%%) (bytes! %%Function%%)) (!
   (= (req%curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.lemma_limb4_contribution_correctness.
     limbs! bytes!
    ) (and
     (=>
   ...
   :pattern ((req%curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.lemma_limb4_contribution_correctness.
     limbs! bytes!
   ))
   :qid internal_req__curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.lemma_limb4_contribution_correctness._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.lemma_limb4_contribution_correctness._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.lemma_limb4_contribution_correctness.
 (%%Function%% %%Function%%) Bool
)
(assert
 (forall ((limbs! %%Function%%) (bytes! %%Function%%)) (!
   (= (ens%curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.lemma_limb4_contribution_correctness.
     limbs! bytes!
    ) (= (curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.limb4_byte_contribution.?
      (Poly%array%. limbs!) (Poly%array%. bytes!)
     ) (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (
   ...
   :pattern ((ens%curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.lemma_limb4_contribution_correctness.
     limbs! bytes!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.lemma_limb4_contribution_correctness._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.lemma_limb4_contribution_correctness._definition
)))

;; Function-Specs curve25519_dalek::lemmas::field_lemmas::limbs_to_bytes_lemmas::lemma_boundary_byte_combines
(declare-fun req%curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.lemma_boundary_byte_combines.
...
(assert
 (forall ((low_limb! Int) (high_limb! Int) (byte! Int) (low_shift! Int) (low_bits! Int))
  (!
   (= (req%curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.lemma_boundary_byte_combines.
     low_limb! high_limb! byte! low_shift! low_bits!
    ) (and
     (=>
      %%global_location_label%%70
      (< low_limb! (vstd!arithmetic.power2.pow2.? (I 51)))
     )
     (=>
      %%global_location_label%%71
      (< high_limb! (vstd!arithmetic.power2.pow2.? (I 51)))
     )
     (=>
     ...
     (=>
      ...
      (= (nClip (Add low_shift! low_bits!)) 51)
     )
     (=>
   ...
   :pattern ((req%curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.lemma_boundary_byte_combines.
     low_limb! high_limb! byte! low_shift! low_bits!
   ))
   :qid internal_req__curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.lemma_boundary_byte_combines._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.lemma_boundary_byte_combines._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.lemma_boundary_byte_combines.
 (Int Int Int Int Int) Bool
)
(assert
 (forall ((low_limb! Int) (high_limb! Int) (byte! Int) (low_shift! Int) (low_bits! Int))
  (!
   (= (ens%curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.lemma_boundary_byte_combines.
     low_limb! high_limb! byte! low_shift! low_bits!
   ...
   :pattern ((ens%curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.lemma_boundary_byte_combines.
     low_limb! high_limb! byte! low_shift! low_bits!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.lemma_boundary_byte_combines._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.lemma_boundary_byte_combines._definition
)))

;; Function-Def curve25519_dalek::lemmas::field_lemmas::limbs_to_bytes_lemmas::lemma_boundary_byte_combines
;; curve25519-dalek/src/lemmas/field_lemmas/limbs_to_bytes_lemmas.rs:1941:7: 1947:2 (#0)
(get-info :all-statistics)
(push)
 (declare-const low_limb! Int)
 (declare-const high_limb! Int)
 (declare-const byte! Int)
 (declare-const low_shift! Int)
  ...
  (not (=>
    ...
    (and
     (and
      (=>
       %%location_label%%0
       (req%vstd!bits.lemma_u64_shr_is_div. low_limb! (uClip 64 low_shift!))
      )
      (=>
       (ens%vstd!bits.lemma_u64_shr_is_div. low_limb! (uClip 64 low_shift!))
       (=>
        %%location_label%%1
        (= (uClip 64 (bitshr (I low_limb!) (I low_shift!))) (EucDiv low_limb! (vstd!arithmetic.power2.pow2.?
           (I low_shift!)
     ))))))
     (=>
      (= (uClip 64 (bitshr (I low_limb!) (I low_shift!))) (EucDiv low_limb! (vstd!arithmetic.power2.pow2.?
      ...
      (and
       (=>
        (ens%vstd!arithmetic.power2.lemma_pow2_adds. low_shift! low_bits!)
        (=>
         (= tmp%1 (vstd!arithmetic.power2.pow2.? (I low_bits!)))
         (=>
          (= tmp%2 (vstd!arithmetic.power2.pow2.? (I low_shift!)))
          (=>
           (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. tmp%1 tmp%2)
           (=>
            %%location_label%%2
            (let
             ((tmp%%$ (nClip (Mul (vstd!arithmetic.power2.pow2.? (I low_shift!)) (vstd!arithmetic.power2.pow2.?
                  (I low_bits!)
             )))))
             (and
              (= (vstd!arithmetic.power2.pow2.? (I 51)) tmp%%$)
              (= tmp%%$ (nClip (Mul (vstd!arithmetic.power2.pow2.? (I low_bits!)) (vstd!arithmetic.power2.pow2.?
                  (I low_shift!)
       )))))))))))
       (=>
        (let
        ...
        (and
         (and
          (=>
           (= tmp%3 (vstd!arithmetic.power2.pow2.? (I low_bits!)))
           (=>
            (= tmp%4 (vstd!arithmetic.power2.pow2.? (I low_shift!)))
            (and
             (=>
              %%location_label%%3
              (req%vstd!arithmetic.div_mod.lemma_div_by_multiple. tmp%3 tmp%4)
             )
             (=>
              (ens%vstd!arithmetic.div_mod.lemma_div_by_multiple. tmp%3 tmp%4)
              (=>
               %%location_label%%4
               (= (EucDiv (vstd!arithmetic.power2.pow2.? (I 51)) (vstd!arithmetic.power2.pow2.? (I low_shift!)))
                (vstd!arithmetic.power2.pow2.? (I low_bits!))
          ))))))
          (=>
           (= (EucDiv (vstd!arithmetic.power2.pow2.? (I 51)) (vstd!arithmetic.power2.pow2.? (I low_shift!)))
           ...
           (and
            (=>
             (ens%vstd!arithmetic.power2.lemma_pow2_pos. low_shift!)
             (=>
              %%location_label%%5
              (> (vstd!arithmetic.power2.pow2.? (I low_shift!)) 0)
            ))
            (=>
             (> (vstd!arithmetic.power2.pow2.? (I low_shift!)) 0)
             (=>
              ...
              (=>
               (= tmp%6 (vstd!arithmetic.power2.pow2.? (I low_bits!)))
               (=>
                (= tmp%7 (vstd!arithmetic.power2.pow2.? (I low_shift!)))
                (and
                 (=>
                  %%location_label%%6
                  (req%vstd!arithmetic.div_mod.lemma_div_by_multiple_is_strongly_ordered. low_limb!
                   tmp%5 tmp%6 tmp%7
                 ))
                 (=>
                  (ens%vstd!arithmetic.div_mod.lemma_div_by_multiple_is_strongly_ordered. low_limb!
                   tmp%5 tmp%6 tmp%7
                  )
                  (=>
                   %%location_label%%7
                   (< (EucDiv low_limb! (vstd!arithmetic.power2.pow2.? (I low_shift!))) (vstd!arithmetic.power2.pow2.?
                     (I low_bits!)
         ))))))))))))
         (=>
          (< (EucDiv low_limb! (vstd!arithmetic.power2.pow2.? (I low_shift!))) (vstd!arithmetic.power2.pow2.?
          ...
          (=>
           (= a@ (uClip 64 (bitshr (I low_limb!) (I low_shift!))))
           (=>
            (= b@ high_limb!)
            (and
             (and
              (and
               (and
                (=>
                 %%location_label%%8
                 (req%vstd!arithmetic.power2.lemma_pow2_strictly_increases. low_bits! 8)
                )
                (=>
                 (ens%vstd!arithmetic.power2.lemma_pow2_strictly_increases. low_bits! 8)
                 (=>
                  (= tmp%8 (vstd!arithmetic.power2.pow2.? (I 51)))
                  (=>
                   (= tmp%9 (vstd!arithmetic.power2.pow2.? (I low_bits!)))
                   (=>
                    (= tmp%10 (vstd!arithmetic.power2.pow2.? (I 8)))
                    (and
                     (=>
                      %%location_label%%9
                      (req%curve25519_dalek!lemmas.common_lemmas.mul_lemmas.lemma_mul_lt. b@ tmp%8 tmp%9
                       tmp%10
                     ))
                     (=>
                      (ens%curve25519_dalek!lemmas.common_lemmas.mul_lemmas.lemma_mul_lt. b@ tmp%8 tmp%9
                       tmp%10
                      )
                      (=>
                       (ens%vstd!arithmetic.power2.lemma_pow2_adds. 51 8)
                       (=>
                        %%location_label%%10
                        (< (Mul b@ (vstd!arithmetic.power2.pow2.? (I low_bits!))) (vstd!arithmetic.power2.pow2.?
                          (I (nClip (Add 51 8)))
               )))))))))))
               (=>
                (< (Mul b@ (vstd!arithmetic.power2.pow2.? (I low_bits!))) (vstd!arithmetic.power2.pow2.?
                ...
                (and
                 (and
                  (=>
                   %%location_label%%11
                   (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_u64_pow2_le_max. 59)
                  )
                  (=>
                   (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_u64_pow2_le_max. 59)
                   (=>
                    %%location_label%%12
                    (<= (vstd!arithmetic.power2.pow2.? (I 59)) 18446744073709551615)
                 )))
                 (=>
                  (<= (vstd!arithmetic.power2.pow2.? (I 59)) 18446744073709551615)
                  (=>
                   %%location_label%%13
                   (< (Mul b@ (vstd!arithmetic.power2.pow2.? (I low_bits!))) 18446744073709551615)
              )))))
              (=>
               (< (Mul b@ (vstd!arithmetic.power2.pow2.? (I low_bits!))) 18446744073709551615)
               (and
                (=>
                 %%location_label%%14
                 (req%vstd!bits.lemma_u64_shl_is_mul. high_limb! (uClip 64 low_bits!))
                )
                (=>
                 (ens%vstd!bits.lemma_u64_shl_is_mul. high_limb! (uClip 64 low_bits!))
                 (=>
                  %%location_label%%15
                  (= (uClip 64 (bitshl (I b@) (I low_bits!))) (Mul high_limb! (vstd!arithmetic.power2.pow2.?
                     (I low_bits!)
             ))))))))
             (=>
              (= (uClip 64 (bitshl (I b@) (I low_bits!))) (Mul high_limb! (vstd!arithmetic.power2.pow2.?
              ...
              (and
               (and
                (and
                 (and
                  (=>
                   %%location_label%%16
                   (req%vstd!bits.lemma_u64_shr_is_div. 18446744073709551615 (uClip 64 low_bits!))
                  )
                  (=>
                   (ens%vstd!bits.lemma_u64_shr_is_div. 18446744073709551615 (uClip 64 low_bits!))
                   (=>
                    %%location_label%%17
                    (= (uClip 64 (bitshr (I 18446744073709551615) (I low_bits!))) (EucDiv 18446744073709551615
                      (vstd!arithmetic.power2.pow2.? (I low_bits!))
                 )))))
                 (=>
                  (= (uClip 64 (bitshr (I 18446744073709551615) (I low_bits!))) (EucDiv 18446744073709551615
                  ...
                  (and
                   (=>
                    (ens%vstd!arithmetic.power2.lemma_pow2_pos. low_bits!)
                    (and
                     (=>
                      %%location_label%%18
                      (req%vstd!arithmetic.power2.lemma_pow2_strictly_increases. low_bits! 8)
                     ...
                     (=>
                      (ens%vstd!arithmetic.power2.lemma_pow2_strictly_increases. low_bits! 8)
                      (=>
                       (= tmp%11 (vstd!arithmetic.power2.pow2.? (I low_bits!)))
                       (=>
                        (= tmp%12 (vstd!arithmetic.power2.pow2.? (I 8)))
                        (and
                         (=>
                          %%location_label%%19
                          (req%vstd!arithmetic.div_mod.lemma_div_is_ordered_by_denominator. 18446744073709551615
                           tmp%11 tmp%12
                         ))
                         (=>
                          (ens%vstd!arithmetic.div_mod.lemma_div_is_ordered_by_denominator. 18446744073709551615
                           tmp%11 tmp%12
                          )
                          (=>
                           %%location_label%%20
                           (>= (EucDiv 18446744073709551615 (vstd!arithmetic.power2.pow2.? (I low_bits!))) (EucDiv
                             18446744073709551615 (vstd!arithmetic.power2.pow2.? (I 8))
                   ))))))))))
                   (=>
                    (>= (EucDiv 18446744073709551615 (vstd!arithmetic.power2.pow2.? (I low_bits!))) (EucDiv
                      18446744073709551615 (vstd!arithmetic.power2.pow2.? (I 8))
                    ...
                    (and
                     (=>
                      ...
                      (=>
                       %%location_label%%21
                       (>= (EucDiv 18446744073709551615 256) (vstd!arithmetic.power2.pow2.? (I 51)))
                     ))
                     (=>
                      (>= (EucDiv 18446744073709551615 256) (vstd!arithmetic.power2.pow2.? (I 51)))
                      (=>
                       %%location_label%%22
                       (<= b@ (uClip 64 (bitshr (I 18446744073709551615) (I low_bits!))))
                )))))))
                (=>
                 (<= b@ (uClip 64 (bitshr (I 18446744073709551615) (I low_bits!))))
                 (and
                  (and
                   (=>
                    %%location_label%%23
                    (req%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u64_shift_is_pow2. low_bits!)
                   )
                   (=>
                    (ens%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u64_shift_is_pow2. low_bits!)
                    (=>
                     %%location_label%%24
                     (= (vstd!arithmetic.power2.pow2.? (I low_bits!)) (uClip 64 (bitshl (I 1) (I low_bits!))))
                  )))
                  (=>
                   (= (vstd!arithmetic.power2.pow2.? (I low_bits!)) (uClip 64 (bitshl (I 1) (I low_bits!))))
                   (and
                    (and
                     (=>
                      %%location_label%%25
                      (req%curve25519_dalek!lemmas.common_lemmas.bit_lemmas.lemma_u64_bit_or_is_plus. a@
                       b@ (uClip 64 low_bits!)
                     ))
                     (=>
                      (ens%curve25519_dalek!lemmas.common_lemmas.bit_lemmas.lemma_u64_bit_or_is_plus. a@
                       b@ (uClip 64 low_bits!)
                      )
                      (=>
                       %%location_label%%26
                       (= (uClip 64 (bitor (I a@) (I (uClip 64 (bitshl (I b@) (I low_bits!)))))) (Add a@ (
                          uClip 64 (bitshl (I b@) (I low_bits!))
                    ))))))
                    (=>
                     (= (uClip 64 (bitor (I a@) (I (uClip 64 (bitshl (I b@) (I low_bits!)))))) (Add a@ (
                        uClip 64 (bitshl (I b@) (I low_bits!))
               ...
               (=>
                ...
                (and
                 (=>
                  (= tmp%13 (uClip 64 (bitor (I a@) (I (uClip 64 (bitshl (I b@) (I low_bits!)))))))
                  (and
                   (=>
                    %%location_label%%28
                    (req%curve25519_dalek!lemmas.common_lemmas.div_mod_lemmas.lemma_u64_cast_u8_is_mod.
                   ...
                   (=>
                    ...
                    (=>
                     %%location_label%%29
                     (= (uClip 8 (uClip 64 (bitor (I a@) (I (uClip 64 (bitshl (I b@) (I low_bits!)))))))
                      (EucMod (nClip (Add a@ (Mul b@ (vstd!arithmetic.power2.pow2.? (I low_bits!))))) (vstd!arithmetic.power2.pow2.?
                        (I 8)
                 )))))))
                 (=>
                  (= (uClip 8 (uClip 64 (bitor (I a@) (I (uClip 64 (bitshl (I b@) (I low_bits!)))))))
                  ...
                  (and
                   (and
                    ...
                    (=>
                     ...
                     (=>
                      %%location_label%%31
                      (= (EucMod (nClip (Add a@ (Mul b@ (vstd!arithmetic.power2.pow2.? (I low_bits!)))))
                        (vstd!arithmetic.power2.pow2.? (I 8))
                       ) (nClip (Add (EucMod a@ (vstd!arithmetic.power2.pow2.? (I 8))) (EucMod (nClip (Mul b@
                            (vstd!arithmetic.power2.pow2.? (I low_bits!))
                           )
                          ) (vstd!arithmetic.power2.pow2.? (I 8))
                   )))))))
                   (=>
                    ...
                    (and
                     (=>
                      (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_div_mod. low_limb!
                       low_shift! 8
                      )
                      (=>
                       %%location_label%%32
                       (= (EucMod (EucDiv low_limb! (vstd!arithmetic.power2.pow2.? (I low_shift!))) (vstd!arithmetic.power2.pow2.?
                          (I 8)
                         )
                        ) (EucDiv (EucMod low_limb! (vstd!arithmetic.power2.pow2.? (I (nClip (Add low_shift! 8)))))
                         (vstd!arithmetic.power2.pow2.? (I low_shift!))
                     ))))
                     (=>
                      (= (EucMod (EucDiv low_limb! (vstd!arithmetic.power2.pow2.? (I low_shift!))) (vstd!arithmetic.power2.pow2.?
                         (I 8)
                      ...
                      (and
                       (=>
                        (= tmp%14 (nClip (Add low_shift! low_bits!)))
                        (=>
                         (= tmp%15 (nClip (Add low_shift! 8)))
                         (and
                          (=>
                           %%location_label%%33
                           (req%vstd!arithmetic.power2.lemma_pow2_strictly_increases. tmp%14 tmp%15)
                          )
                          (=>
                           (ens%vstd!arithmetic.power2.lemma_pow2_strictly_increases. tmp%14 tmp%15)
                           (=>
                            (= tmp%16 (vstd!arithmetic.power2.pow2.? (I (nClip (Add low_shift! 8)))))
                            (and
                             (=>
                              %%location_label%%34
                              (req%vstd!arithmetic.div_mod.lemma_small_mod. low_limb! tmp%16)
                             )
                             (=>
                              (ens%vstd!arithmetic.div_mod.lemma_small_mod. low_limb! tmp%16)
                              (=>
                               %%location_label%%35
                               (= (EucMod low_limb! (vstd!arithmetic.power2.pow2.? (I (nClip (Add low_shift! 8)))))
                                low_limb!
                       )))))))))
                       (=>
                        (= (EucMod low_limb! (vstd!arithmetic.power2.pow2.? (I (nClip (Add low_shift! 8)))))
                        ...
                        (and
                         (=>
                          (= tmp%17 (EucDiv low_limb! (vstd!arithmetic.power2.pow2.? (I low_shift!))))
                          (=>
                           (= tmp%18 (vstd!arithmetic.power2.pow2.? (I low_bits!)))
                           (and
                            (=>
                             %%location_label%%36
                             (req%vstd!arithmetic.div_mod.lemma_small_mod. tmp%17 tmp%18)
                            )
                            (=>
                             (ens%vstd!arithmetic.div_mod.lemma_small_mod. tmp%17 tmp%18)
                             (=>
                              %%location_label%%37
                              (= (EucDiv low_limb! (vstd!arithmetic.power2.pow2.? (I low_shift!))) (EucMod (EucDiv
                                 low_limb! (vstd!arithmetic.power2.pow2.? (I low_shift!))
                                ) (vstd!arithmetic.power2.pow2.? (I low_bits!))
                         )))))))
                         (=>
                          (= (EucDiv low_limb! (vstd!arithmetic.power2.pow2.? (I low_shift!))) (EucMod (EucDiv
                          ...
                          (and
                           (and
                            (=>
                             %%location_label%%38
                             (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_mul_mod. b@ low_bits!
                              8
                            ))
                            (=>
                             (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_mul_mod. b@ low_bits!
                              8
                             )
                             (=>
                              %%location_label%%39
                              (= (EucMod (nClip (Mul b@ (vstd!arithmetic.power2.pow2.? (I low_bits!)))) (vstd!arithmetic.power2.pow2.?
                                 (I 8)
                                )
                               ) (nClip (Mul (EucMod b@ (vstd!arithmetic.power2.pow2.? (I (nClip (Sub 8 low_bits!)))))
                                 (vstd!arithmetic.power2.pow2.? (I low_bits!))
                           ))))))
                           (=>
                            (= (EucMod (nClip (Mul b@ (vstd!arithmetic.power2.pow2.? (I low_bits!)))) (vstd!arithmetic.power2.pow2.?
