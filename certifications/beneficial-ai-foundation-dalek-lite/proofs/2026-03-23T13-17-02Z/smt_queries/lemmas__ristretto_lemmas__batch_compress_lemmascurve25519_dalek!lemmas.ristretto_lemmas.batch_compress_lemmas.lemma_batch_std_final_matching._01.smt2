...
;; curve25519-dalek/src/lemmas/ristretto_lemmas/batch_compress_lemmas.rs:1072:7: 1072:100 (#0)
...
;; Function-Def curve25519_dalek::lemmas::ristretto_lemmas::batch_compress_lemmas::lemma_batch_std_final_matching
;; curve25519-dalek/src/lemmas/ristretto_lemmas/batch_compress_lemmas.rs:1072:7: 1072:100 (#0)
...
(push)
 ...
 (declare-const d@ Int)
 (declare-const c_iad@ Int)
 (declare-const inv_f@ Int)
 (declare-const inv_h@ Int)
 (declare-const inv_fh@ Int)
 (declare-const x_aff@ Int)
 (declare-const y_aff@ Int)
 (declare-const t_aff@ Int)
             ...
             (and
              (=>
               ...
               (=>
                ...
                (=>
                 %%location_label%%1
                 (= t_aff@ (curve25519_dalek!specs.field_specs.field_mul.? (I eg!) (I inv_fh@)))
              )))
              (=>
               (= t_aff@ (curve25519_dalek!specs.field_specs.field_mul.? (I eg!) (I inv_fh@)))
               (=>
                ...
                (and
                 (and
                  ...
                  (=>
                   ...
                   (=>
                    %%location_label%%3
                    (not (= (EucMod egfh@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0))
                 )))
                 (=>
                  (not (= (EucMod egfh@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0))
                  (and
                   (and
                    (=>
                     ...
                     (=>
                      %%location_label%%4
                      (= (curve25519_dalek!specs.field_specs.field_mul.? (I egfh@) (I inv!)) 1)
                    ))
                    (=>
                     (= (curve25519_dalek!specs.field_specs.field_mul.? (I egfh@) (I inv!)) 1)
                     (and
                      (and
                       (=>
                        %%location_label%%5
                        (req%curve25519_dalek!specs.field_specs.field_inv_property. egfh@)
                       )
                       (=>
                        (ens%curve25519_dalek!specs.field_specs.field_inv_property. egfh@)
                        (=>
                         (= tmp%1 (curve25519_dalek!specs.field_specs.field_inv.? (I egfh@)))
                         (=>
                          (= tmp%2 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                          (and
                           (=>
                            %%location_label%%6
                            (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. egfh@ tmp%1 tmp%2)
                           )
                           (=>
                            (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. egfh@ tmp%1 tmp%2)
                            (=>
                             %%location_label%%7
                             (= (curve25519_dalek!specs.field_specs.field_mul.? (I egfh@) (I (curve25519_dalek!specs.field_specs.field_inv.?
                                 (I egfh@)
                               ))
                              ) 1
                      ))))))))
                      (=>
                       ...
                       (=>
                        (= tmp%3 (curve25519_dalek!specs.field_specs.field_inv.? (I egfh@)))
                        (and
                         (=>
                          %%location_label%%8
                          (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_left_cancel.
                         ...
                         (=>
                          ...
                          (=>
                           %%location_label%%9
                           (= (EucMod inv! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) (EucMod (curve25519_dalek!specs.field_specs.field_inv.?
                              (I egfh@)
                             ) (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
                   ))))))))))
                   (=>
                    ...
                    (and
                     (=>
                      ...
                      (and
                       (=>
                        %%location_label%%10
                        (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. eg! inv! tmp%4)
                       )
                       (=>
                        (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. eg! inv! tmp%4)
                        (=>
                         (= tmp%5 (curve25519_dalek!specs.field_specs.field_inv.? (I egfh@)))
                         (=>
                          (= tmp%6 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                          (and
                           (=>
                            %%location_label%%11
                            (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. eg! tmp%5 tmp%6)
                           )
                           (=>
                            (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. eg! tmp%5 tmp%6)
                            (and
                             (=>
                              %%location_label%%12
                              (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_a_times_inv_ab_is_inv_b.
                      ...
                      (and
                       (=>
                        ...
                        (and
                         (=>
                          %%location_label%%14
                          (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. fh! inv! tmp%7)
                         )
                         (=>
                          (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. fh! inv! tmp%7)
                          (=>
                           (= tmp%8 (curve25519_dalek!specs.field_specs.field_inv.? (I egfh@)))
                           (=>
                            (= tmp%9 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                            (and
                             (=>
                              %%location_label%%15
                              (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. fh! tmp%8 tmp%9)
                             )
                             (=>
                              (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. fh! tmp%8 tmp%9)
                              (=>
                               (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_comm.
                                eg! fh!
                               )
