...
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:969:7: 969:66 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::number_theory_lemmas::lemma_partial_binomial_sum_mod_p
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:969:7: 969:66 (#0)
...
(push)
 ...
 (declare-const binom_int@ Int)
 (declare-const pow_int@ Int)
 (declare-const term_int@ Int)
 (declare-const term_j@ Int)
 ...
 (declare-const pow_a_p@ Int)
 (declare-const term_p@ Int)
    ...
    (or
     (and
      (=>
       (= j! 0)
       (=>
        (= tmp%1 (= (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial.? (
            I p!
           ) (I 0)
          ) 1
        ))
        (and
         ...
         (=>
          ...
          (=>
           (fuel_bool fuel%vstd!arithmetic.power.pow.)
           (=>
            (= tmp%2 (= (vstd!arithmetic.power.pow.? (I a!) (I 0)) 1))
            (and
             (=>
              %%location_label%%1
              tmp%2
             ...
             (=>
              tmp%2
              (=>
               (= tmp%3 (= (nClip (vstd!arithmetic.power.pow.? (I a!) (I 0))) 1))
               (and
                (=>
                 %%location_label%%2
                 tmp%3
                ...
                (=>
                 tmp%3
                 (=>
                  (= tmp%4 (= (nClip (Mul (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial.?
                       (I p!) (I 0)
                      ) (nClip (vstd!arithmetic.power.pow.? (I a!) (I 0)))
                     )
                    ) 1
                  ))
                  (and
                   ...
                   (=>
                    tmp%4
                    (=>
                     (= tmp%5 (= (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial_sum.?
                        (I a!) (I p!) (I 0)
                       ) 1
                     ))
                     (and
           ...
           (and
            ...
            (and
             ...
             (=>
              ...
              (=>
               (= tmp%7 (= (EucMod (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial_sum.?
                   (I a!) (I p!) (I (nClip (Sub j! 1)))
                  ) p!
                 ) 1
               ))
               (and
                ...
                (=>
                 ...
                 (and
                  ...
                  (=>
                   ...
                   (=>
                    (= tmp%8 (= (EucMod (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial.?
                        (I p!) (I j!)
                       ) p!
                      ) 0
                    ))
                    (and
                     ...
                     (=>
                      ...
                      (and
                       (=>
                        %%location_label%%11
                        (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow_nonnegative. a! j!)
                       )
                       (=>
                        (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow_nonnegative. a! j!)
                        (=>
                         (= tmp%9 (>= (vstd!arithmetic.power.pow.? (I a!) (I j!)) 0))
                         (and
                          (=>
                           %%location_label%%12
                           tmp%9
                          ...
                          (=>
                           tmp%9
                           (=>
                            (= binom_int@ (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial.?
                              (I p!) (I j!)
                            ))
                            (=>
                             (= pow_int@ (vstd!arithmetic.power.pow.? (I a!) (I j!)))
                             (=>
                              (= term_int@ (Mul binom_int@ pow_int@))
                              (and
                               (=>
                                (= tmp%10 (= (EucMod binom_int@ p!) 0))
                                (and
                                 (=>
                                  %%location_label%%13
                                  tmp%10
                                 ...
                                 (=>
                                  ...
                                  (and
                                   (=>
                                    %%location_label%%14
                                    (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. binom_int@ pow_int@ p!)
                                   )
                                   (=>
                                    (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. binom_int@ pow_int@ p!)
                                    (=>
                                     (ens%vstd!arithmetic.mul.lemma_mul_basics. pow_int@)
                                     (=>
                                      (= tmp%11 (= (Mul (EucMod binom_int@ p!) pow_int@) 0))
                                      (and
                                       (=>
                                        %%location_label%%15
                                        tmp%11
                               ...
                               (=>
                                ...
                                (and
                                 (and
                                  (=>
                                   %%location_label%%19
                                   (req%vstd!arithmetic.mul.lemma_mul_nonnegative. binom_int@ pow_int@)
                                  )
                                  (=>
                                   (ens%vstd!arithmetic.mul.lemma_mul_nonnegative. binom_int@ pow_int@)
                                   (=>
                                    %%location_label%%20
                                    (>= term_int@ 0)
                                 )))
                                 (=>
                                  (>= term_int@ 0)
                                  (=>
                                   (= term_j@ (nClip (Mul (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial.?
                                       (I p!) (I j!)
                                      ) (nClip (vstd!arithmetic.power.pow.? (I a!) (I j!)))
                                   )))
                                   (=>
                                    (= tmp%12 (= term_j@ (nClip term_int@)))
                                    (and
                                     (=>
                                      %%location_label%%21
                                      tmp%12
                                     ...
                                     (=>
                                      ...
                                      (and
                                       ...
                                       (=>
                                        (= (EucMod term_j@ p!) 0)
                                        (=>
                                         (= tmp%13 (= (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial_sum.?
                                            (I a!) (I p!) (I j!)
                                           ) (nClip (Add (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial_sum.?
                                              (I a!) (I p!) (I (nClip (Sub j! 1)))
                                             ) term_j@
                                         ))))
                                         (and
                                          ...
                                          (=>
                                           ...
                                           (and
                                            (=>
                                             (= tmp%14 (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial_sum.?
                                               (I a!) (I p!) (I (nClip (Sub j! 1)))
                                             ))
                                             (and
                                              (=>
                                               %%location_label%%24
                                               (req%vstd!arithmetic.div_mod.lemma_mod_adds. tmp%14 term_j@ p!)
                                              )
                                              (=>
                                               (ens%vstd!arithmetic.div_mod.lemma_mod_adds. tmp%14 term_j@ p!)
                                               (and
                                                (=>
                                                 %%location_label%%25
                                                 (req%vstd!arithmetic.div_mod.lemma_small_mod. 1 p!)
          ...
          (or
           (and
            (=>
             (= p! 1)
             (=>
              (= tmp%15 (= (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial_sum.?
                 (I a!) (I 1) (I 1)
                ) (nClip (Add (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial_sum.?
                   (I a!) (I 1) (I 0)
                  ) (nClip (Mul (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial.?
                     (I 1) (I 1)
                    ) (nClip (vstd!arithmetic.power.pow.? (I a!) (I 1)))
              ))))))
              (and
               (=>
                %%location_label%%27
               ...
               (=>
                tmp%15
                (=>
                 (= tmp%16 (= (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial_sum.?
                    (I a!) (I 1) (I 0)
                   ) 1
                 ))
                 (and
                  ...
                  (=>
                   tmp%16
                   (=>
                    (= tmp%17 (= (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial.?
                       (I 1) (I 1)
                      ) 1
                    ))
                    (and
                      ...
                      (and
                       (=>
                        ...
                        (=>
                         ...
                         (=>
                          %%location_label%%30
                          (= (vstd!arithmetic.power.pow.? (I a!) (I 1)) a!)
                       )))
                       (=>
                        (= (vstd!arithmetic.power.pow.? (I a!) (I 1)) a!)
                        %%switch_label%%2
           ...
           (and
            (not %%switch_label%%2)
            (=>
             (= tmp%18 (nClip (Sub p! 1)))
             (and
              (=>
               %%location_label%%31
               (check_decrease_int (let
                 ((a!$0 a!) (p!$1 p!) (j!$2 tmp%18))
                 j!$2
                ) decrease%init0 false
              ))
              (and
               ...
               (=>
                ...
                (=>
                 (= tmp%19 (= (EucMod (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial_sum.?
                     (I a!) (I p!) (I (nClip (Sub p! 1)))
                    ) p!
                   ) 1
                 ))
                 (and
                  ...
                  (=>
                   tmp%19
                   (=>
                    (= tmp%20 (= (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial.?
                       (I p!) (I p!)
                      ) 1
                    ))
                    (and
                     ...
                     (=>
                      tmp%20
                      (=>
                       (= pow_a_p@ (nClip (vstd!arithmetic.power.pow.? (I a!) (I p!))))
                       (and
                        (=>
                         %%location_label%%35
                         (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow_nonnegative. a! p!)
                        )
                        (=>
                         (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow_nonnegative. a! p!)
                         (=>
                          (= tmp%21 (>= (vstd!arithmetic.power.pow.? (I a!) (I p!)) 0))
                          (and
                           (=>
                            %%location_label%%36
                            tmp%21
                           ...
                           (=>
                            tmp%21
                            (=>
                             (= term_p@ (nClip (Mul (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial.?
                                 (I p!) (I p!)
                                ) pow_a_p@
                             )))
                             (and
                              (=>
                               (= tmp%22 (= (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial.?
                                  (I p!) (I p!)
                                 ) 1
                               ))
                               (and
                                ...
                                (=>
                                 ...
                                 (and
                                  (=>
                                   (ens%vstd!arithmetic.mul.lemma_mul_basics. pow_a_p@)
                                   (=>
                                    %%location_label%%38
                                    (= (nClip (Mul 1 pow_a_p@)) pow_a_p@)
                                  ))
                                  (=>
                                   (= (nClip (Mul 1 pow_a_p@)) pow_a_p@)
                                   (=>
                              ...
                              (=>
                               (= term_p@ pow_a_p@)
                               (=>
                                (= tmp%23 (= (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial_sum.?
                                   (I a!) (I p!) (I p!)
                                  ) (nClip (Add (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial_sum.?
                                     (I a!) (I p!) (I (nClip (Sub p! 1)))
                                    ) term_p@
                                ...
                                (and
                                 ...
                                 (=>
                                  tmp%23
                                  (=>
                                   (= tmp%24 (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial_sum.?
                                     (I a!) (I p!) (I (nClip (Sub p! 1)))
                                   ))
                                   (and
                                    (=>
                                     %%location_label%%41
                                     (req%vstd!arithmetic.div_mod.lemma_mod_adds. tmp%24 term_p@ p!)
                                    )
                                    (=>
                                     (ens%vstd!arithmetic.div_mod.lemma_mod_adds. tmp%24 term_p@ p!)
                                     (=>
                                      (= tmp%25 (= (EucMod term_p@ p!) (EucMod pow_a_p@ p!)))
                                      (and
                                       (=>
                                        %%location_label%%42
                                        tmp%25
                                       ...
                                       (=>
                                        ...
                                        (and
                                         (=>
                                          %%location_label%%43
                                          (req%vstd!arithmetic.div_mod.lemma_mod_adds. 1 pow_a_p@ p!)
                                         )
                                         (=>
                                          (ens%vstd!arithmetic.div_mod.lemma_mod_adds. 1 pow_a_p@ p!)
                                          (and
                                           (=>
                                            %%location_label%%44
                                            (req%vstd!arithmetic.div_mod.lemma_small_mod. 1 p!)
                                           ...
                                           (=>
                                            (ens%vstd!arithmetic.div_mod.lemma_small_mod. 1 p!)
                                            (=>
                                             (= tmp%26 (= (EucMod (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial_sum.?
                                                 (I a!) (I p!) (I p!)
                                                ) p!
                                               ) (EucMod (nClip (Add 1 pow_a_p@)) p!)
                                             ))
                                             (and
                                              (=>
                                               %%location_label%%45
