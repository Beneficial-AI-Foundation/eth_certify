...
;; curve25519-dalek/src/lemmas/field_lemmas/pow_chain_lemmas.rs:26:1: 32:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::pow_chain_lemmas::lemma_prove_pow2k_step
;; curve25519-dalek/src/lemmas/field_lemmas/pow_chain_lemmas.rs:26:1: 32:2 (#0)
(get-info :all-statistics)
(push)
 (declare-const base! Int)
 (declare-const val_in! Int)
 (declare-const val_out! Int)
 (declare-const exp_in! Int)
 (declare-const exp_power! Int)
  ...
  (not (and
    (and
     ...
     (=>
      ...
      (=>
       %%location_label%%1
       (>= (vstd!arithmetic.power.pow.? (I base!) (I exp_in!)) 0)
    )))
    (=>
     (>= (vstd!arithmetic.power.pow.? (I base!) (I exp_in!)) 0)
     (=>
      (= tmp%1 (= (EucMod val_in! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) (EucMod
         (vstd!arithmetic.power.pow.? (I base!) (I exp_in!)) (curve25519_dalek!specs.field_specs_u64.p.?
          (I 0)
      ))))
      (and
       (=>
       ...
       (=>
        ...
        (and
         (=>
          (= tmp%2 (vstd!arithmetic.power.pow.? (I base!) (I exp_in!)))
          (=>
           (= tmp%3 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
           (and
            (=>
             %%location_label%%3
             (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow_mod_congruent. val_in!
              tmp%2 exp_power! tmp%3
            ))
            (=>
             (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow_mod_congruent. val_in!
              tmp%2 exp_power! tmp%3
             )
             (=>
              %%location_label%%4
              (= (nClip (EucMod (vstd!arithmetic.power.pow.? (I val_in!) (I exp_power!)) (curve25519_dalek!specs.field_specs_u64.p.?
                  (I 0)
                ))
         ...
         (=>
          ...
          (and
           (=>
            (ens%vstd!arithmetic.power.lemma_pow_multiplies. base! exp_in! exp_power!)
            (=>
             %%location_label%%5
             (= (vstd!arithmetic.power.pow.? (I (vstd!arithmetic.power.pow.? (I base!) (I exp_in!)))
               (I exp_power!)
              ) (vstd!arithmetic.power.pow.? (I base!) (I (nClip (Mul exp_in! exp_power!))))
           )))
           (=>
            (= (vstd!arithmetic.power.pow.? (I (vstd!arithmetic.power.pow.? (I base!) (I exp_in!)))
              (I exp_power!)
            ...
            (and
             (=>
              (= tmp%4 (nClip (Mul exp_in! exp_power!)))
              (and
               (=>
                %%location_label%%6
                (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow_nonnegative. base!
               ...
               (=>
                ...
                (=>
                 %%location_label%%7
                 (>= (vstd!arithmetic.power.pow.? (I base!) (I (nClip (Mul exp_in! exp_power!)))) 0)
             ))))
             (=>
              (>= (vstd!arithmetic.power.pow.? (I base!) (I (nClip (Mul exp_in! exp_power!)))) 0)
              (and
               (and
                (=>
                 %%location_label%%8
                 (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow_nonnegative. val_in!
                  exp_power!
                ))
                (=>
                 (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow_nonnegative. val_in!
                  exp_power!
                 )
                 (=>
                  %%location_label%%9
                  (>= (vstd!arithmetic.power.pow.? (I val_in!) (I exp_power!)) 0)
               )))
               (=>
                (>= (vstd!arithmetic.power.pow.? (I val_in!) (I exp_power!)) 0)
                (=>
                 (= tmp%5 (= (EucMod val_out! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) (nClip
                    (EucMod (vstd!arithmetic.power.pow.? (I val_in!) (I exp_power!)) (curve25519_dalek!specs.field_specs_u64.p.?
                      (I 0)
                 )))))
                 (and
                  (=>
                  ...
                  (=>
                   tmp%5
                   (=>
                    (= tmp%6 (= (nClip (EucMod (vstd!arithmetic.power.pow.? (I base!) (I (nClip (Mul exp_in!
                            exp_power!
                         )))
                        ) (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
                       )
                      ) (EucMod (nClip (vstd!arithmetic.power.pow.? (I base!) (I (nClip (Mul exp_in! exp_power!)))))
                       (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
                    )))
                    (and
                     (=>
                     ...
                     (=>
                      tmp%6
                      (=>
                       (= tmp%7 (= (EucMod val_out! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) (EucMod
                          (nClip (vstd!arithmetic.power.pow.? (I base!) (I (nClip (Mul exp_in! exp_power!)))))
                          (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
                       )))
                       (and
