...
;; MODULE 'module specs::iterator_specs'
;; curve25519-dalek/src/specs/iterator_specs.rs:253:1: 253:86 (#0)
...
(declare-const fuel%curve25519_dalek!specs.iterator_specs.sum_of_ristretto_points.
 FuelId
)
...
(assert
 (distinct fuel%vstd!std_specs.option.impl&%0.arrow_0. fuel%vstd!std_specs.option.is_some.
  ...
  fuel%vstd!view.impl&%26.view. fuel%vstd!view.impl&%44.view. fuel%vstd!view.impl&%48.view.
  ...
  fuel%curve25519_dalek!specs.edwards_specs.edwards_add. fuel%curve25519_dalek!specs.edwards_specs.sum_of_points.
  ...
  fuel%curve25519_dalek!specs.field_specs_u64.u64_5_as_nat. fuel%curve25519_dalek!specs.iterator_specs.all_points_some.
  fuel%curve25519_dalek!specs.iterator_specs.unwrap_points. fuel%curve25519_dalek!specs.iterator_specs.sum_of_ristretto_points.
  fuel%curve25519_dalek!specs.scalar_specs.is_canonical_scalar. fuel%curve25519_dalek!specs.scalar52_specs.group_order.
...
(declare-sort alloc!vec.Vec<curve25519_dalek!ristretto.RistrettoPoint./allocator_global%.>.
 0
)
(declare-sort alloc!vec.Vec<curve25519_dalek!scalar.Scalar./allocator_global%.>. 0)
(declare-sort alloc!vec.into_iter.IntoIter<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>./allocator_global%.>.
 0
)
(declare-sort alloc!vec.into_iter.IntoIter<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>.
 0
)
...
(declare-sort vstd!seq.Seq<curve25519_dalek!ristretto.RistrettoPoint.>. 0)
...
(declare-datatypes ((core!option.Option. 0) (vstd!raw_ptr.PtrData. 0) (curve25519_dalek!backend.serial.u64.field.FieldElement51.
   0
  ) (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult. 0) (curve25519_dalek!scalar.Scalar.
   0
  ) (curve25519_dalek!edwards.EdwardsPoint. 0) (curve25519_dalek!ristretto.RistrettoPoint.
   0
...
(declare-fun Poly%alloc!vec.Vec<curve25519_dalek!ristretto.RistrettoPoint./allocator_global%.>.
 (alloc!vec.Vec<curve25519_dalek!ristretto.RistrettoPoint./allocator_global%.>.) Poly
)
(declare-fun %Poly%alloc!vec.Vec<curve25519_dalek!ristretto.RistrettoPoint./allocator_global%.>.
 (Poly) alloc!vec.Vec<curve25519_dalek!ristretto.RistrettoPoint./allocator_global%.>.
)
...
(declare-fun Poly%alloc!vec.into_iter.IntoIter<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>./allocator_global%.>.
 (alloc!vec.into_iter.IntoIter<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>./allocator_global%.>.)
 Poly
)
(declare-fun %Poly%alloc!vec.into_iter.IntoIter<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>./allocator_global%.>.
 (Poly) alloc!vec.into_iter.IntoIter<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>./allocator_global%.>.
)
(declare-fun Poly%alloc!vec.into_iter.IntoIter<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>.
 (alloc!vec.into_iter.IntoIter<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>.)
 Poly
)
(declare-fun %Poly%alloc!vec.into_iter.IntoIter<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>.
 (Poly) alloc!vec.into_iter.IntoIter<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>.
)
...
(declare-fun Poly%vstd!seq.Seq<curve25519_dalek!ristretto.RistrettoPoint.>. (vstd!seq.Seq<curve25519_dalek!ristretto.RistrettoPoint.>.)
 Poly
)
(declare-fun %Poly%vstd!seq.Seq<curve25519_dalek!ristretto.RistrettoPoint.>. (Poly)
 vstd!seq.Seq<curve25519_dalek!ristretto.RistrettoPoint.>.
)
...
(assert
 (forall ((x alloc!vec.Vec<curve25519_dalek!ristretto.RistrettoPoint./allocator_global%.>.))
  (!
   (= x (%Poly%alloc!vec.Vec<curve25519_dalek!ristretto.RistrettoPoint./allocator_global%.>.
     (Poly%alloc!vec.Vec<curve25519_dalek!ristretto.RistrettoPoint./allocator_global%.>.
      x
   )))
   :pattern ((Poly%alloc!vec.Vec<curve25519_dalek!ristretto.RistrettoPoint./allocator_global%.>.
     x
   ))
   :qid internal_alloc__vec__Vec<curve25519_dalek!ristretto.RistrettoPoint./allocator_global__.>_box_axiom_definition
   :skolemid skolem_internal_alloc__vec__Vec<curve25519_dalek!ristretto.RistrettoPoint./allocator_global__.>_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x (TYPE%alloc!vec.Vec. $ TYPE%curve25519_dalek!ristretto.RistrettoPoint.
      $ ALLOCATOR_GLOBAL
    ))
    (= x (Poly%alloc!vec.Vec<curve25519_dalek!ristretto.RistrettoPoint./allocator_global%.>.
      (%Poly%alloc!vec.Vec<curve25519_dalek!ristretto.RistrettoPoint./allocator_global%.>.
   ...
   :pattern ((has_type x (TYPE%alloc!vec.Vec. $ TYPE%curve25519_dalek!ristretto.RistrettoPoint.
      $ ALLOCATOR_GLOBAL
   )))
   :qid internal_alloc__vec__Vec<curve25519_dalek!ristretto.RistrettoPoint./allocator_global__.>_unbox_axiom_definition
   :skolemid skolem_internal_alloc__vec__Vec<curve25519_dalek!ristretto.RistrettoPoint./allocator_global__.>_unbox_axiom_definition
)))
(assert
 (forall ((x alloc!vec.Vec<curve25519_dalek!ristretto.RistrettoPoint./allocator_global%.>.))
  (!
   (has_type (Poly%alloc!vec.Vec<curve25519_dalek!ristretto.RistrettoPoint./allocator_global%.>.
     x
    ) (TYPE%alloc!vec.Vec. $ TYPE%curve25519_dalek!ristretto.RistrettoPoint. $ ALLOCATOR_GLOBAL)
   )
   :pattern ((has_type (Poly%alloc!vec.Vec<curve25519_dalek!ristretto.RistrettoPoint./allocator_global%.>.
      x
     ) (TYPE%alloc!vec.Vec. $ TYPE%curve25519_dalek!ristretto.RistrettoPoint. $ ALLOCATOR_GLOBAL)
   ))
   :qid internal_alloc__vec__Vec<curve25519_dalek!ristretto.RistrettoPoint./allocator_global__.>_has_type_always_definition
   :skolemid skolem_internal_alloc__vec__Vec<curve25519_dalek!ristretto.RistrettoPoint./allocator_global__.>_has_type_always_definition
)))
(assert
...
(assert
 (forall ((x alloc!vec.into_iter.IntoIter<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>./allocator_global%.>.))
  (!
   (= x (%Poly%alloc!vec.into_iter.IntoIter<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>./allocator_global%.>.
     (Poly%alloc!vec.into_iter.IntoIter<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>./allocator_global%.>.
      x
   )))
   :pattern ((Poly%alloc!vec.into_iter.IntoIter<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>./allocator_global%.>.
     x
   ))
   :qid internal_alloc__vec__into_iter__IntoIter<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>./allocator_global__.>_box_axiom_definition
   :skolemid skolem_internal_alloc__vec__into_iter__IntoIter<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>./allocator_global__.>_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x (TYPE%alloc!vec.into_iter.IntoIter. $ (TYPE%core!option.Option. $ TYPE%curve25519_dalek!edwards.EdwardsPoint.)
      $ ALLOCATOR_GLOBAL
    ))
    (= x (Poly%alloc!vec.into_iter.IntoIter<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>./allocator_global%.>.
      (%Poly%alloc!vec.into_iter.IntoIter<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>./allocator_global%.>.
   ...
   :pattern ((has_type x (TYPE%alloc!vec.into_iter.IntoIter. $ (TYPE%core!option.Option.
       $ TYPE%curve25519_dalek!edwards.EdwardsPoint.
      ) $ ALLOCATOR_GLOBAL
   )))
   :qid internal_alloc__vec__into_iter__IntoIter<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>./allocator_global__.>_unbox_axiom_definition
   :skolemid skolem_internal_alloc__vec__into_iter__IntoIter<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>./allocator_global__.>_unbox_axiom_definition
)))
(assert
 (forall ((x alloc!vec.into_iter.IntoIter<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>./allocator_global%.>.))
  (!
   (has_type (Poly%alloc!vec.into_iter.IntoIter<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>./allocator_global%.>.
     x
    ) (TYPE%alloc!vec.into_iter.IntoIter. $ (TYPE%core!option.Option. $ TYPE%curve25519_dalek!edwards.EdwardsPoint.)
     $ ALLOCATOR_GLOBAL
   ))
   :pattern ((has_type (Poly%alloc!vec.into_iter.IntoIter<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>./allocator_global%.>.
      x
     ) (TYPE%alloc!vec.into_iter.IntoIter. $ (TYPE%core!option.Option. $ TYPE%curve25519_dalek!edwards.EdwardsPoint.)
      $ ALLOCATOR_GLOBAL
   )))
   :qid internal_alloc__vec__into_iter__IntoIter<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>./allocator_global__.>_has_type_always_definition
   :skolemid skolem_internal_alloc__vec__into_iter__IntoIter<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>./allocator_global__.>_has_type_always_definition
)))
(assert
 (forall ((x alloc!vec.into_iter.IntoIter<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>.))
  (!
   (= x (%Poly%alloc!vec.into_iter.IntoIter<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>.
     (Poly%alloc!vec.into_iter.IntoIter<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>.
      x
   )))
   :pattern ((Poly%alloc!vec.into_iter.IntoIter<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>.
     x
   ))
   :qid internal_alloc__vec__into_iter__IntoIter<curve25519_dalek!edwards.EdwardsPoint./allocator_global__.>_box_axiom_definition
   :skolemid skolem_internal_alloc__vec__into_iter__IntoIter<curve25519_dalek!edwards.EdwardsPoint./allocator_global__.>_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x (TYPE%alloc!vec.into_iter.IntoIter. $ TYPE%curve25519_dalek!edwards.EdwardsPoint.
      $ ALLOCATOR_GLOBAL
    ))
    (= x (Poly%alloc!vec.into_iter.IntoIter<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>.
      (%Poly%alloc!vec.into_iter.IntoIter<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>.
   ...
   :pattern ((has_type x (TYPE%alloc!vec.into_iter.IntoIter. $ TYPE%curve25519_dalek!edwards.EdwardsPoint.
      $ ALLOCATOR_GLOBAL
   )))
   :qid internal_alloc__vec__into_iter__IntoIter<curve25519_dalek!edwards.EdwardsPoint./allocator_global__.>_unbox_axiom_definition
   :skolemid skolem_internal_alloc__vec__into_iter__IntoIter<curve25519_dalek!edwards.EdwardsPoint./allocator_global__.>_unbox_axiom_definition
)))
(assert
 (forall ((x alloc!vec.into_iter.IntoIter<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>.))
  (!
   (has_type (Poly%alloc!vec.into_iter.IntoIter<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>.
     x
    ) (TYPE%alloc!vec.into_iter.IntoIter. $ TYPE%curve25519_dalek!edwards.EdwardsPoint.
     $ ALLOCATOR_GLOBAL
   ))
   :pattern ((has_type (Poly%alloc!vec.into_iter.IntoIter<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>.
      x
     ) (TYPE%alloc!vec.into_iter.IntoIter. $ TYPE%curve25519_dalek!edwards.EdwardsPoint.
      $ ALLOCATOR_GLOBAL
   )))
   :qid internal_alloc__vec__into_iter__IntoIter<curve25519_dalek!edwards.EdwardsPoint./allocator_global__.>_has_type_always_definition
   :skolemid skolem_internal_alloc__vec__into_iter__IntoIter<curve25519_dalek!edwards.EdwardsPoint./allocator_global__.>_has_type_always_definition
)))
(assert
...
(assert
 (forall ((x vstd!seq.Seq<curve25519_dalek!ristretto.RistrettoPoint.>.)) (!
   (= x (%Poly%vstd!seq.Seq<curve25519_dalek!ristretto.RistrettoPoint.>. (Poly%vstd!seq.Seq<curve25519_dalek!ristretto.RistrettoPoint.>.
      x
   )))
   :pattern ((Poly%vstd!seq.Seq<curve25519_dalek!ristretto.RistrettoPoint.>. x))
   :qid internal_vstd__seq__Seq<curve25519_dalek!ristretto.RistrettoPoint.>_box_axiom_definition
   :skolemid skolem_internal_vstd__seq__Seq<curve25519_dalek!ristretto.RistrettoPoint.>_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x (TYPE%vstd!seq.Seq. $ TYPE%curve25519_dalek!ristretto.RistrettoPoint.))
    (= x (Poly%vstd!seq.Seq<curve25519_dalek!ristretto.RistrettoPoint.>. (%Poly%vstd!seq.Seq<curve25519_dalek!ristretto.RistrettoPoint.>.
       x
   ))))
   :pattern ((has_type x (TYPE%vstd!seq.Seq. $ TYPE%curve25519_dalek!ristretto.RistrettoPoint.)))
   :qid internal_vstd__seq__Seq<curve25519_dalek!ristretto.RistrettoPoint.>_unbox_axiom_definition
   :skolemid skolem_internal_vstd__seq__Seq<curve25519_dalek!ristretto.RistrettoPoint.>_unbox_axiom_definition
)))
(assert
 (forall ((x vstd!seq.Seq<curve25519_dalek!ristretto.RistrettoPoint.>.)) (!
   (has_type (Poly%vstd!seq.Seq<curve25519_dalek!ristretto.RistrettoPoint.>. x) (TYPE%vstd!seq.Seq.
     $ TYPE%curve25519_dalek!ristretto.RistrettoPoint.
   ))
   :pattern ((has_type (Poly%vstd!seq.Seq<curve25519_dalek!ristretto.RistrettoPoint.>.
      x
     ) (TYPE%vstd!seq.Seq. $ TYPE%curve25519_dalek!ristretto.RistrettoPoint.)
   ))
   :qid internal_vstd__seq__Seq<curve25519_dalek!ristretto.RistrettoPoint.>_has_type_always_definition
   :skolemid skolem_internal_vstd__seq__Seq<curve25519_dalek!ristretto.RistrettoPoint.>_has_type_always_definition
)))
(assert
...
(assert
 (forall ((T&. Dcr) (T& Type) (A&. Dcr) (A& Type)) (!
   (= (proj%%vstd!view.View./V $ (TYPE%alloc!vec.into_iter.IntoIter. T&. T& A&. A&))
    (DST $)
   )
   :pattern ((proj%%vstd!view.View./V $ (TYPE%alloc!vec.into_iter.IntoIter. T&. T& A&.
      A&
   )))
   :qid internal_proj____vstd!view.View./V_assoc_type_impl_true_definition
   :skolemid skolem_internal_proj____vstd!view.View./V_assoc_type_impl_true_definition
...
(assert
 (forall ((T&. Dcr) (T& Type) (A&. Dcr) (A& Type)) (!
   (= (proj%vstd!view.View./V $ (TYPE%alloc!vec.into_iter.IntoIter. T&. T& A&. A&)) (
     TYPE%tuple%2. $ INT $ (TYPE%vstd!seq.Seq. T&. T&)
   ))
   :pattern ((proj%vstd!view.View./V $ (TYPE%alloc!vec.into_iter.IntoIter. T&. T& A&. A&)))
   :qid internal_proj__vstd!view.View./V_assoc_type_impl_false_definition
   :skolemid skolem_internal_proj__vstd!view.View./V_assoc_type_impl_false_definition
)))
(assert
 (forall ((T&. Dcr) (T& Type) (A&. Dcr) (A& Type)) (!
   (= (proj%%core!iter.traits.iterator.Iterator./Item $ (TYPE%alloc!vec.into_iter.IntoIter.
      T&. T& A&. A&
     )
    ) T&.
   )
   :pattern ((proj%%core!iter.traits.iterator.Iterator./Item $ (TYPE%alloc!vec.into_iter.IntoIter.
      T&. T& A&. A&
   )))
...
;; Function-Decl curve25519_dalek::specs::iterator_specs::spec_edwards_from_ristretto_iter
(declare-fun curve25519_dalek!specs.iterator_specs.spec_edwards_from_ristretto_iter.?
 (Dcr Type Dcr Type Poly) vstd!seq.Seq<curve25519_dalek!edwards.EdwardsPoint.>.
)

;; Function-Decl curve25519_dalek::specs::iterator_specs::spec_optional_edwards_from_ristretto_iter
(declare-fun curve25519_dalek!specs.iterator_specs.spec_optional_edwards_from_ristretto_iter.?
 (Dcr Type Poly) vstd!seq.Seq<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>.>.
)
...
;; Function-Decl curve25519_dalek::specs::iterator_specs::sum_of_ristretto_points
(declare-fun curve25519_dalek!specs.iterator_specs.sum_of_ristretto_points.? (Poly)
 tuple%2.
)
(declare-fun curve25519_dalek!specs.iterator_specs.rec%sum_of_ristretto_points.? (
  Poly Fuel
 ) tuple%2.
)
...
(assert
 (=>
  ...
  (forall ((T&. Dcr) (T& Type) (A&. Dcr) (A& Type) (v! Poly)) (!
    ...
    :pattern ((vstd!std_specs.vec.spec_vec_len.? T&. T& A&. A& v!))
    :qid user_vstd__std_specs__vec__axiom_spec_len_22
    :skolemid skolem_user_vstd__std_specs__vec__axiom_spec_len_22
))))
...
(assert
 (=>
  ...
  (forall ((T&. Dcr) (T& Type) (vec! Poly) (i! Poly)) (!
    ...
    :qid user_vstd__std_specs__vec__axiom_vec_has_resolved_23
    :skolemid skolem_user_vstd__std_specs__vec__axiom_vec_has_resolved_23
))))
...
(assert
 (forall ((T&. Dcr) (T& Type) (A&. Dcr) (A& Type)) (!
   (=>
    ...
    (tr_bound%vstd!view.View. $ (TYPE%alloc!vec.into_iter.IntoIter. T&. T& A&. A&))
   )
   :pattern ((tr_bound%vstd!view.View. $ (TYPE%alloc!vec.into_iter.IntoIter. T&. T& A&.
      A&
   )))
   :qid internal_vstd__std_specs__vec__impl&__4_trait_impl_definition
   :skolemid skolem_internal_vstd__std_specs__vec__impl&__4_trait_impl_definition
)))
  ...
  (!
   (= (ens%curve25519_dalek!specs.iterator_specs.collect_scalars_from_iter. S&. S& I&.
     ...
     (forall ((i$ Poly)) (!
       ...
       :qid user_curve25519_dalek__specs__iterator_specs__collect_scalars_from_iter_25
       :skolemid skolem_user_curve25519_dalek__specs__iterator_specs__collect_scalars_from_iter_25
   ))))
  ...
  (forall ((fe1! Poly) (fe2! Poly) (bound! Poly)) (!
    (= (curve25519_dalek!specs.field_specs.sum_of_limbs_bounded.? fe1! fe2! bound!) (forall
      ((i$ Poly)) (!
       ...
       :qid user_curve25519_dalek__specs__field_specs__sum_of_limbs_bounded_26
       :skolemid skolem_user_curve25519_dalek__specs__field_specs__sum_of_limbs_bounded_26
    )))
...
;; Function-Specs curve25519_dalek::specs::iterator_specs::vec_to_edwards_iter
(declare-fun req%curve25519_dalek!specs.iterator_specs.vec_to_edwards_iter. (alloc!vec.Vec<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>.)
 Bool
)
(declare-const %%global_location_label%%8 Bool)
(assert
 (forall ((vec! alloc!vec.Vec<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>.))
  (!
   (= (req%curve25519_dalek!specs.iterator_specs.vec_to_edwards_iter. vec!) (=>
     ...
     (forall ((i$ Poly)) (!
         ...
         (let
          ...
          (and
           ...
           (< tmp%%$ (vstd!seq.Seq.len.? $ TYPE%curve25519_dalek!edwards.EdwardsPoint. (vstd!view.View.view.?
              $ (TYPE%alloc!vec.Vec. $ TYPE%curve25519_dalek!edwards.EdwardsPoint. $ ALLOCATOR_GLOBAL)
              (Poly%alloc!vec.Vec<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>. vec!)
         )))))
       ...
       :qid user_curve25519_dalek__specs__iterator_specs__vec_to_edwards_iter_27
       :skolemid skolem_user_curve25519_dalek__specs__iterator_specs__vec_to_edwards_iter_27
   ))))
   :pattern ((req%curve25519_dalek!specs.iterator_specs.vec_to_edwards_iter. vec!))
   :qid internal_req__curve25519_dalek!specs.iterator_specs.vec_to_edwards_iter._definition
   :skolemid skolem_internal_req__curve25519_dalek!specs.iterator_specs.vec_to_edwards_iter._definition
)))
(declare-fun ens%curve25519_dalek!specs.iterator_specs.vec_to_edwards_iter. (alloc!vec.Vec<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>.
  alloc!vec.into_iter.IntoIter<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>.
 ) Bool
)
(assert
 (forall ((vec! alloc!vec.Vec<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>.)
   (result! alloc!vec.into_iter.IntoIter<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>.)
  ) (!
   (= (ens%curve25519_dalek!specs.iterator_specs.vec_to_edwards_iter. vec! result!) (
     = (curve25519_dalek!specs.iterator_specs.spec_points_from_iter.? $ TYPE%curve25519_dalek!edwards.EdwardsPoint.
      $ (TYPE%alloc!vec.into_iter.IntoIter. $ TYPE%curve25519_dalek!edwards.EdwardsPoint.
       $ ALLOCATOR_GLOBAL
      ) (Poly%alloc!vec.into_iter.IntoIter<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>.
       result!
   ...
   :pattern ((ens%curve25519_dalek!specs.iterator_specs.vec_to_edwards_iter. vec! result!))
   :qid internal_ens__curve25519_dalek!specs.iterator_specs.vec_to_edwards_iter._definition
   :skolemid skolem_internal_ens__curve25519_dalek!specs.iterator_specs.vec_to_edwards_iter._definition
)))

;; Function-Specs curve25519_dalek::specs::iterator_specs::vec_to_optional_edwards_iter
(declare-fun req%curve25519_dalek!specs.iterator_specs.vec_to_optional_edwards_iter.
 (alloc!vec.Vec<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>./allocator_global%.>.)
 Bool
)
(declare-const %%global_location_label%%9 Bool)
(assert
 (forall ((vec! alloc!vec.Vec<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>./allocator_global%.>.))
  (!
   (= (req%curve25519_dalek!specs.iterator_specs.vec_to_optional_edwards_iter. vec!)
    (=>
     ...
     (forall ((i$ Poly)) (!
        ...
        (=>
         ...
         (curve25519_dalek!specs.edwards_specs.is_well_formed_edwards_point.? (core!option.Option./Some/0
           $ TYPE%curve25519_dalek!edwards.EdwardsPoint. (%Poly%core!option.Option. (vstd!seq.Seq.index.?
             $ (TYPE%core!option.Option. $ TYPE%curve25519_dalek!edwards.EdwardsPoint.) (vstd!view.View.view.?
              $ (TYPE%alloc!vec.Vec. $ (TYPE%core!option.Option. $ TYPE%curve25519_dalek!edwards.EdwardsPoint.)
               $ ALLOCATOR_GLOBAL
              ) (Poly%alloc!vec.Vec<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>./allocator_global%.>.
               vec!
       ...
       :qid user_curve25519_dalek__specs__iterator_specs__vec_to_optional_edwards_iter_28
       :skolemid skolem_user_curve25519_dalek__specs__iterator_specs__vec_to_optional_edwards_iter_28
   ))))
   :pattern ((req%curve25519_dalek!specs.iterator_specs.vec_to_optional_edwards_iter.
     vec!
   ))
   :qid internal_req__curve25519_dalek!specs.iterator_specs.vec_to_optional_edwards_iter._definition
   :skolemid skolem_internal_req__curve25519_dalek!specs.iterator_specs.vec_to_optional_edwards_iter._definition
)))
(declare-fun ens%curve25519_dalek!specs.iterator_specs.vec_to_optional_edwards_iter.
 (alloc!vec.Vec<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>./allocator_global%.>.
  alloc!vec.into_iter.IntoIter<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>./allocator_global%.>.
 ) Bool
)
(assert
 (forall ((vec! alloc!vec.Vec<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>./allocator_global%.>.)
   (result! alloc!vec.into_iter.IntoIter<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>./allocator_global%.>.)
  ) (!
   (= (ens%curve25519_dalek!specs.iterator_specs.vec_to_optional_edwards_iter. vec! result!)
    (= (curve25519_dalek!specs.iterator_specs.spec_optional_points_from_iter.? $ (TYPE%alloc!vec.into_iter.IntoIter.
       $ (TYPE%core!option.Option. $ TYPE%curve25519_dalek!edwards.EdwardsPoint.) $ ALLOCATOR_GLOBAL
      ) (Poly%alloc!vec.into_iter.IntoIter<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>./allocator_global%.>.
       result!
      )
     ) (%Poly%vstd!seq.Seq<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>.>.
   ...
   :pattern ((ens%curve25519_dalek!specs.iterator_specs.vec_to_optional_edwards_iter.
     vec! result!
   ))
   :qid internal_ens__curve25519_dalek!specs.iterator_specs.vec_to_optional_edwards_iter._definition
   :skolemid skolem_internal_ens__curve25519_dalek!specs.iterator_specs.vec_to_optional_edwards_iter._definition
)))

;; Function-Specs curve25519_dalek::specs::iterator_specs::collect_edwards_from_ristretto_iter
(declare-fun ens%curve25519_dalek!specs.iterator_specs.collect_edwards_from_ristretto_iter.
 (Dcr Type Dcr Type Poly alloc!vec.Vec<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>.)
 Bool
)
(assert
 (forall ((P&. Dcr) (P& Type) (J&. Dcr) (J& Type) (iter! Poly) (result! alloc!vec.Vec<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>.))
  (!
   (= (ens%curve25519_dalek!specs.iterator_specs.collect_edwards_from_ristretto_iter.
     P&. P& J&. J& iter! result!
    ) (= (%Poly%vstd!seq.Seq<curve25519_dalek!edwards.EdwardsPoint.>. (vstd!view.View.view.?
       $ (TYPE%alloc!vec.Vec. $ TYPE%curve25519_dalek!edwards.EdwardsPoint. $ ALLOCATOR_GLOBAL)
       (Poly%alloc!vec.Vec<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>. result!)
      )
     ) (curve25519_dalek!specs.iterator_specs.spec_edwards_from_ristretto_iter.? P&. P&
      J&. J& iter!
   )))
   :pattern ((ens%curve25519_dalek!specs.iterator_specs.collect_edwards_from_ristretto_iter.
     P&. P& J&. J& iter! result!
   ))
   :qid internal_ens__curve25519_dalek!specs.iterator_specs.collect_edwards_from_ristretto_iter._definition
   :skolemid skolem_internal_ens__curve25519_dalek!specs.iterator_specs.collect_edwards_from_ristretto_iter._definition
)))

;; Function-Specs curve25519_dalek::specs::iterator_specs::clone_ristretto_iter_with_spec
(declare-fun ens%curve25519_dalek!specs.iterator_specs.clone_ristretto_iter_with_spec.
 (Dcr Type Dcr Type Poly tuple%2.) Bool
)
(assert
 (forall ((P&. Dcr) (P& Type) (J&. Dcr) (J& Type) (iter! Poly) (result! tuple%2.))
  (!
   (= (ens%curve25519_dalek!specs.iterator_specs.clone_ristretto_iter_with_spec. P&. P&
     J&. J& iter! result!
    ) (and
     (has_type (Poly%tuple%2. result!) (TYPE%tuple%2. J&. J& J&. J&))
     (= (curve25519_dalek!specs.iterator_specs.spec_edwards_from_ristretto_iter.? P&. P&
       J&. J& (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. result!)))
      ) (curve25519_dalek!specs.iterator_specs.spec_edwards_from_ristretto_iter.? P&. P&
       J&. J& iter!
     ))
     (= (curve25519_dalek!specs.iterator_specs.spec_edwards_from_ristretto_iter.? P&. P&
       J&. J& (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. result!)))
      ) (curve25519_dalek!specs.iterator_specs.spec_edwards_from_ristretto_iter.? P&. P&
       J&. J& iter!
   ))))
   :pattern ((ens%curve25519_dalek!specs.iterator_specs.clone_ristretto_iter_with_spec.
     P&. P& J&. J& iter! result!
   ))
   :qid internal_ens__curve25519_dalek!specs.iterator_specs.clone_ristretto_iter_with_spec._definition
   :skolemid skolem_internal_ens__curve25519_dalek!specs.iterator_specs.clone_ristretto_iter_with_spec._definition
)))

;; Function-Specs curve25519_dalek::specs::iterator_specs::collect_ristretto_points
(declare-fun ens%curve25519_dalek!specs.iterator_specs.collect_ristretto_points. (
  Dcr Type Dcr Type Poly alloc!vec.Vec<curve25519_dalek!ristretto.RistrettoPoint./allocator_global%.>.
 ) Bool
)
(assert
 (forall ((P&. Dcr) (P& Type) (J&. Dcr) (J& Type) (iter! Poly) (result! alloc!vec.Vec<curve25519_dalek!ristretto.RistrettoPoint./allocator_global%.>.))
  (!
   (= (ens%curve25519_dalek!specs.iterator_specs.collect_ristretto_points. P&. P& J&.
     J& iter! result!
    ) (and
     (= (vstd!seq.Seq.len.? $ TYPE%curve25519_dalek!ristretto.RistrettoPoint. (vstd!view.View.view.?
        $ (TYPE%alloc!vec.Vec. $ TYPE%curve25519_dalek!ristretto.RistrettoPoint. $ ALLOCATOR_GLOBAL)
        (Poly%alloc!vec.Vec<curve25519_dalek!ristretto.RistrettoPoint./allocator_global%.>.
         result!
       ))
      ) (vstd!seq.Seq.len.? $ TYPE%curve25519_dalek!edwards.EdwardsPoint. (Poly%vstd!seq.Seq<curve25519_dalek!edwards.EdwardsPoint.>.
        (curve25519_dalek!specs.iterator_specs.spec_edwards_from_ristretto_iter.? P&. P& J&.
         J& iter!
     ))))
     (forall ((i$ Poly)) (!
       (=>
        ...
        (=>
         (let
          ...
          (and
           (<= 0 tmp%%$)
           (< tmp%%$ (vstd!seq.Seq.len.? $ TYPE%curve25519_dalek!ristretto.RistrettoPoint. (vstd!view.View.view.?
              $ (TYPE%alloc!vec.Vec. $ TYPE%curve25519_dalek!ristretto.RistrettoPoint. $ ALLOCATOR_GLOBAL)
              (Poly%alloc!vec.Vec<curve25519_dalek!ristretto.RistrettoPoint./allocator_global%.>.
               result!
         ))))))
         (= (curve25519_dalek!ristretto.RistrettoPoint./RistrettoPoint/0 (%Poly%curve25519_dalek!ristretto.RistrettoPoint.
            (vstd!seq.Seq.index.? $ TYPE%curve25519_dalek!ristretto.RistrettoPoint. (vstd!view.View.view.?
              $ (TYPE%alloc!vec.Vec. $ TYPE%curve25519_dalek!ristretto.RistrettoPoint. $ ALLOCATOR_GLOBAL)
              (Poly%alloc!vec.Vec<curve25519_dalek!ristretto.RistrettoPoint./allocator_global%.>.
               result!
              )
          ...
          ) (%Poly%curve25519_dalek!edwards.EdwardsPoint. (vstd!seq.Seq.index.? $ TYPE%curve25519_dalek!edwards.EdwardsPoint.
            (Poly%vstd!seq.Seq<curve25519_dalek!edwards.EdwardsPoint.>. (curve25519_dalek!specs.iterator_specs.spec_edwards_from_ristretto_iter.?
              P&. P& J&. J& iter!
             )
            ) i$
       )))))
       :pattern ((vstd!seq.Seq.index.? $ TYPE%curve25519_dalek!ristretto.RistrettoPoint. (
          vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ TYPE%curve25519_dalek!ristretto.RistrettoPoint.
           $ ALLOCATOR_GLOBAL
          ) (Poly%alloc!vec.Vec<curve25519_dalek!ristretto.RistrettoPoint./allocator_global%.>.
           result!
          )
       ...
       :qid user_curve25519_dalek__specs__iterator_specs__collect_ristretto_points_29
       :skolemid skolem_user_curve25519_dalek__specs__iterator_specs__collect_ristretto_points_29
   ))))
   :pattern ((ens%curve25519_dalek!specs.iterator_specs.collect_ristretto_points. P&.
     P& J&. J& iter! result!
   ))
   :qid internal_ens__curve25519_dalek!specs.iterator_specs.collect_ristretto_points._definition
   :skolemid skolem_internal_ens__curve25519_dalek!specs.iterator_specs.collect_ristretto_points._definition
)))

;; Function-Specs curve25519_dalek::specs::iterator_specs::collect_optional_edwards_from_ristretto_iter
(declare-fun ens%curve25519_dalek!specs.iterator_specs.collect_optional_edwards_from_ristretto_iter.
 (Dcr Type Poly alloc!vec.Vec<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>./allocator_global%.>.)
 Bool
)
(assert
 (forall ((J&. Dcr) (J& Type) (iter! Poly) (result! alloc!vec.Vec<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>./allocator_global%.>.))
  (!
   (= (ens%curve25519_dalek!specs.iterator_specs.collect_optional_edwards_from_ristretto_iter.
     J&. J& iter! result!
    ) (= (%Poly%vstd!seq.Seq<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>.>.
      (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec. $ (TYPE%core!option.Option. $ TYPE%curve25519_dalek!edwards.EdwardsPoint.)
        $ ALLOCATOR_GLOBAL
     ...
     ) (curve25519_dalek!specs.iterator_specs.spec_optional_edwards_from_ristretto_iter.?
      J&. J& iter!
   )))
   :pattern ((ens%curve25519_dalek!specs.iterator_specs.collect_optional_edwards_from_ristretto_iter.
     J&. J& iter! result!
   ))
   :qid internal_ens__curve25519_dalek!specs.iterator_specs.collect_optional_edwards_from_ristretto_iter._definition
   :skolemid skolem_internal_ens__curve25519_dalek!specs.iterator_specs.collect_optional_edwards_from_ristretto_iter._definition
)))

;; Function-Specs curve25519_dalek::specs::iterator_specs::clone_optional_ristretto_iter_with_spec
(declare-fun ens%curve25519_dalek!specs.iterator_specs.clone_optional_ristretto_iter_with_spec.
 (Dcr Type Poly tuple%2.) Bool
)
(assert
 (forall ((J&. Dcr) (J& Type) (iter! Poly) (result! tuple%2.)) (!
   (= (ens%curve25519_dalek!specs.iterator_specs.clone_optional_ristretto_iter_with_spec.
     J&. J& iter! result!
    ) (and
     (has_type (Poly%tuple%2. result!) (TYPE%tuple%2. J&. J& J&. J&))
     (= (curve25519_dalek!specs.iterator_specs.spec_optional_edwards_from_ristretto_iter.?
   ...
   :pattern ((ens%curve25519_dalek!specs.iterator_specs.clone_optional_ristretto_iter_with_spec.
     J&. J& iter! result!
   ))
   :qid internal_ens__curve25519_dalek!specs.iterator_specs.clone_optional_ristretto_iter_with_spec._definition
   :skolemid skolem_internal_ens__curve25519_dalek!specs.iterator_specs.clone_optional_ristretto_iter_with_spec._definition
)))
  ...
  (forall ((points! Poly)) (!
    (= (curve25519_dalek!specs.iterator_specs.all_points_some.? points!) (forall ((i$ Poly))
      (!
       ...
       :qid user_curve25519_dalek__specs__iterator_specs__all_points_some_30
       :skolemid skolem_user_curve25519_dalek__specs__iterator_specs__all_points_some_30
    )))
...
(assert
 (forall ((%%hole%%0 Dcr) (%%hole%%1 Type) (_i$ Poly) (opt$ Poly)) (!
   (= (%%apply%%1 (%%lambda%%2 %%hole%%0 %%hole%%1) _i$ opt$) (core!option.Option./Some/0
     %%hole%%0 %%hole%%1 (%Poly%core!option.Option. opt$)
   ))
   :pattern ((%%apply%%1 (%%lambda%%2 %%hole%%0 %%hole%%1) _i$ opt$))
)))
(assert
 (=>
  ...
  (forall ((points! Poly)) (!
    (= (curve25519_dalek!specs.iterator_specs.unwrap_points.? points!) (%Poly%vstd!seq.Seq<curve25519_dalek!edwards.EdwardsPoint.>.
      (vstd!seq_lib.impl&%0.map.? $ (TYPE%core!option.Option. $ TYPE%curve25519_dalek!edwards.EdwardsPoint.)
       $ TYPE%curve25519_dalek!edwards.EdwardsPoint. points! (Poly%fun%2. (mk_fun (%%lambda%%2
          $ TYPE%curve25519_dalek!edwards.EdwardsPoint.
    ))))))
...
;; Function-Axioms curve25519_dalek::specs::iterator_specs::sum_of_ristretto_points
(assert
 (fuel_bool_default fuel%curve25519_dalek!specs.iterator_specs.sum_of_ristretto_points.)
)
(declare-const fuel_nat%curve25519_dalek!specs.iterator_specs.sum_of_ristretto_points.
 Fuel
)
(assert
 (forall ((points! Poly) (fuel% Fuel)) (!
   (= (curve25519_dalek!specs.iterator_specs.rec%sum_of_ristretto_points.? points! fuel%)
    (curve25519_dalek!specs.iterator_specs.rec%sum_of_ristretto_points.? points! zero)
   )
   :pattern ((curve25519_dalek!specs.iterator_specs.rec%sum_of_ristretto_points.? points!
     fuel%
   ))
   :qid internal_curve25519_dalek!specs.iterator_specs.sum_of_ristretto_points._fuel_to_zero_definition
   :skolemid skolem_internal_curve25519_dalek!specs.iterator_specs.sum_of_ristretto_points._fuel_to_zero_definition
)))
(assert
 (forall ((points! Poly) (fuel% Fuel)) (!
   (=>
    (has_type points! (TYPE%vstd!seq.Seq. $ TYPE%curve25519_dalek!ristretto.RistrettoPoint.))
    (= (curve25519_dalek!specs.iterator_specs.rec%sum_of_ristretto_points.? points! (succ
       fuel%
      )
     ) (ite
      (= (vstd!seq.Seq.len.? $ TYPE%curve25519_dalek!ristretto.RistrettoPoint. points!)
       0
      )
      (tuple%2./tuple%2 (I 0) (I 1))
      (let
       ((last$ (Sub (vstd!seq.Seq.len.? $ TYPE%curve25519_dalek!ristretto.RistrettoPoint. points!)
          1
       )))
       (let
        ((prev$ (curve25519_dalek!specs.iterator_specs.rec%sum_of_ristretto_points.? (vstd!seq.Seq.subrange.?
            $ TYPE%curve25519_dalek!ristretto.RistrettoPoint. points! (I 0) (I last$)
           ) fuel%
        )))
        (let
         ((point_affine$ (curve25519_dalek!specs.edwards_specs.edwards_point_as_affine.? (Poly%curve25519_dalek!edwards.EdwardsPoint.
             (curve25519_dalek!ristretto.RistrettoPoint./RistrettoPoint/0 (%Poly%curve25519_dalek!ristretto.RistrettoPoint.
               (vstd!seq.Seq.index.? $ TYPE%curve25519_dalek!ristretto.RistrettoPoint. points! (I
                 last$
         ))))))))
         (curve25519_dalek!specs.edwards_specs.edwards_add.? (tuple%2./tuple%2/0 (%Poly%tuple%2.
            (Poly%tuple%2. prev$)
   ...
   :qid internal_curve25519_dalek!specs.iterator_specs.sum_of_ristretto_points._fuel_to_body_definition
   :skolemid skolem_internal_curve25519_dalek!specs.iterator_specs.sum_of_ristretto_points._fuel_to_body_definition
)))
(assert
 (=>
  (fuel_bool fuel%curve25519_dalek!specs.iterator_specs.sum_of_ristretto_points.)
  (forall ((points! Poly)) (!
    (=>
     (has_type points! (TYPE%vstd!seq.Seq. $ TYPE%curve25519_dalek!ristretto.RistrettoPoint.))
     (= (curve25519_dalek!specs.iterator_specs.sum_of_ristretto_points.? points!) (curve25519_dalek!specs.iterator_specs.rec%sum_of_ristretto_points.?
       points! (succ fuel_nat%curve25519_dalek!specs.iterator_specs.sum_of_ristretto_points.)
    )))
    :pattern ((curve25519_dalek!specs.iterator_specs.sum_of_ristretto_points.? points!))
    :qid internal_curve25519_dalek!specs.iterator_specs.sum_of_ristretto_points.?_definition
    :skolemid skolem_internal_curve25519_dalek!specs.iterator_specs.sum_of_ristretto_points.?_definition
))))
(assert
 (forall ((points! Poly)) (!
   (=>
    (has_type points! (TYPE%vstd!seq.Seq. $ TYPE%curve25519_dalek!ristretto.RistrettoPoint.))
    (has_type (Poly%tuple%2. (curve25519_dalek!specs.iterator_specs.sum_of_ristretto_points.?
       points!
      )
     ) (TYPE%tuple%2. $ NAT $ NAT)
   ))
   :pattern ((curve25519_dalek!specs.iterator_specs.sum_of_ristretto_points.? points!))
   :qid internal_curve25519_dalek!specs.iterator_specs.sum_of_ristretto_points.?_pre_post_definition
   :skolemid skolem_internal_curve25519_dalek!specs.iterator_specs.sum_of_ristretto_points.?_pre_post_definition
)))
(assert
 (forall ((points! Poly) (fuel% Fuel)) (!
   (=>
    (has_type points! (TYPE%vstd!seq.Seq. $ TYPE%curve25519_dalek!ristretto.RistrettoPoint.))
    (has_type (Poly%tuple%2. (curve25519_dalek!specs.iterator_specs.rec%sum_of_ristretto_points.?
       points! fuel%
      )
     ) (TYPE%tuple%2. $ NAT $ NAT)
   ))
   ...
   :qid internal_curve25519_dalek!specs.iterator_specs.rec__sum_of_ristretto_points.?_pre_post_rec_definition
   :skolemid skolem_internal_curve25519_dalek!specs.iterator_specs.rec__sum_of_ristretto_points.?_pre_post_rec_definition
)))
...
(assert
 (forall ((T&. Dcr) (T& Type) (A&. Dcr) (A& Type)) (!
   ...
   :qid internal_alloc__vec__into_iter__impl&__14_trait_impl_definition
   :skolemid skolem_internal_alloc__vec__into_iter__impl&__14_trait_impl_definition
)))
...
(assert
 (forall ((T&. Dcr) (T& Type) (A&. Dcr) (A& Type)) (!
   (=>
    ...
    (tr_bound%core!iter.traits.iterator.Iterator. $ (TYPE%alloc!vec.into_iter.IntoIter.
      T&. T& A&. A&
   )))
   :pattern ((tr_bound%core!iter.traits.iterator.Iterator. $ (TYPE%alloc!vec.into_iter.IntoIter.
      T&. T& A&. A&
   )))
   :qid internal_alloc__vec__into_iter__impl&__5_trait_impl_definition
   :skolemid skolem_internal_alloc__vec__into_iter__impl&__5_trait_impl_definition
)))
...
;; Function-Specs curve25519_dalek::specs::iterator_specs::lemma_sum_ristretto_edwards_equiv
(declare-fun ens%curve25519_dalek!specs.iterator_specs.lemma_sum_ristretto_edwards_equiv.
 (vstd!seq.Seq<curve25519_dalek!ristretto.RistrettoPoint.>.) Bool
)
(declare-fun %%lambda%%3 (Dcr Type Poly) %%Function%%)
(assert
 (forall ((%%hole%%0 Dcr) (%%hole%%1 Type) (%%hole%%2 Poly) (i$ Poly)) (!
   (= (%%apply%%0 (%%lambda%%3 %%hole%%0 %%hole%%1 %%hole%%2) i$) (Poly%curve25519_dalek!edwards.EdwardsPoint.
     (curve25519_dalek!ristretto.RistrettoPoint./RistrettoPoint/0 (%Poly%curve25519_dalek!ristretto.RistrettoPoint.
...
(assert
 (forall ((ristretto_points! vstd!seq.Seq<curve25519_dalek!ristretto.RistrettoPoint.>.))
  (!
   (= (ens%curve25519_dalek!specs.iterator_specs.lemma_sum_ristretto_edwards_equiv. ristretto_points!)
    (= (curve25519_dalek!specs.iterator_specs.sum_of_ristretto_points.? (Poly%vstd!seq.Seq<curve25519_dalek!ristretto.RistrettoPoint.>.
       ristretto_points!
      )
     ) (curve25519_dalek!specs.edwards_specs.sum_of_points.? (vstd!seq.Seq.new.? $ TYPE%curve25519_dalek!edwards.EdwardsPoint.
       $ (TYPE%fun%1. $ INT $ TYPE%curve25519_dalek!edwards.EdwardsPoint.) (I (vstd!seq.Seq.len.?
         $ TYPE%curve25519_dalek!ristretto.RistrettoPoint. (Poly%vstd!seq.Seq<curve25519_dalek!ristretto.RistrettoPoint.>.
          ristretto_points!
        ))
       ) (Poly%fun%1. (mk_fun (%%lambda%%3 $ TYPE%curve25519_dalek!ristretto.RistrettoPoint.
          (Poly%vstd!seq.Seq<curve25519_dalek!ristretto.RistrettoPoint.>. ristretto_points!)
   )))))))
   :pattern ((ens%curve25519_dalek!specs.iterator_specs.lemma_sum_ristretto_edwards_equiv.
     ristretto_points!
   ))
   :qid internal_ens__curve25519_dalek!specs.iterator_specs.lemma_sum_ristretto_edwards_equiv._definition
   :skolemid skolem_internal_ens__curve25519_dalek!specs.iterator_specs.lemma_sum_ristretto_edwards_equiv._definition
)))

;; Function-Def curve25519_dalek::specs::iterator_specs::lemma_sum_ristretto_edwards_equiv
;; curve25519-dalek/src/specs/iterator_specs.rs:253:1: 253:86 (#0)
(get-info :all-statistics)
(push)
 (declare-const ristretto_points! vstd!seq.Seq<curve25519_dalek!ristretto.RistrettoPoint.>.)
 (declare-const tmp%1 vstd!seq.Seq<curve25519_dalek!ristretto.RistrettoPoint.>.)
 (declare-const tmp%2 Bool)
 (declare-const tmp%3 Bool)
 (declare-const last@ Int)
 (declare-const edwards_points@ vstd!seq.Seq<curve25519_dalek!edwards.EdwardsPoint.>.)
 ...
 (assert
  (not (=>
    (= decrease%init0 (vstd!seq.Seq.len.? $ TYPE%curve25519_dalek!ristretto.RistrettoPoint.
      (Poly%vstd!seq.Seq<curve25519_dalek!ristretto.RistrettoPoint.>. ristretto_points!)
    ))
    (=>
     (= edwards_points@ (%Poly%vstd!seq.Seq<curve25519_dalek!edwards.EdwardsPoint.>. (vstd!seq.Seq.new.?
        $ TYPE%curve25519_dalek!edwards.EdwardsPoint. $ (TYPE%fun%1. $ INT $ TYPE%curve25519_dalek!edwards.EdwardsPoint.)
        (I (vstd!seq.Seq.len.? $ TYPE%curve25519_dalek!ristretto.RistrettoPoint. (Poly%vstd!seq.Seq<curve25519_dalek!ristretto.RistrettoPoint.>.
           ristretto_points!
         ))
        ) (Poly%fun%1. (mk_fun (%%lambda%%3 $ TYPE%curve25519_dalek!ristretto.RistrettoPoint.
           (Poly%vstd!seq.Seq<curve25519_dalek!ristretto.RistrettoPoint.>. ristretto_points!)
     ...
     (or
      (and
       (=>
        (= (vstd!seq.Seq.len.? $ TYPE%curve25519_dalek!ristretto.RistrettoPoint. (Poly%vstd!seq.Seq<curve25519_dalek!ristretto.RistrettoPoint.>.
           ristretto_points!
          )
         ) 0
        )
       ...
       (=>
        (not (= (vstd!seq.Seq.len.? $ TYPE%curve25519_dalek!ristretto.RistrettoPoint. (Poly%vstd!seq.Seq<curve25519_dalek!ristretto.RistrettoPoint.>.
            ristretto_points!
           )
          ) 0
        ))
        (=>
         (= last@ (Sub (vstd!seq.Seq.len.? $ TYPE%curve25519_dalek!ristretto.RistrettoPoint.
            (Poly%vstd!seq.Seq<curve25519_dalek!ristretto.RistrettoPoint.>. ristretto_points!)
           ) 1
         ))
         (=>
          (= tmp%1 (%Poly%vstd!seq.Seq<curve25519_dalek!ristretto.RistrettoPoint.>. (vstd!seq.Seq.subrange.?
             $ TYPE%curve25519_dalek!ristretto.RistrettoPoint. (Poly%vstd!seq.Seq<curve25519_dalek!ristretto.RistrettoPoint.>.
              ristretto_points!
             ) (I 0) (I last@)
          )))
          (and
           ...
           (=>
            (ens%curve25519_dalek!specs.iterator_specs.lemma_sum_ristretto_edwards_equiv. tmp%1)
            (=>
             (= tmp%2 (ext_eq false (TYPE%vstd!seq.Seq. $ TYPE%curve25519_dalek!edwards.EdwardsPoint.)
               (vstd!seq.Seq.new.? $ TYPE%curve25519_dalek!edwards.EdwardsPoint. $ (TYPE%fun%1. $
                 INT $ TYPE%curve25519_dalek!edwards.EdwardsPoint.
                ) (I (vstd!seq.Seq.len.? $ TYPE%curve25519_dalek!ristretto.RistrettoPoint. (vstd!seq.Seq.subrange.?
                   $ TYPE%curve25519_dalek!ristretto.RistrettoPoint. (Poly%vstd!seq.Seq<curve25519_dalek!ristretto.RistrettoPoint.>.
                    ristretto_points!
                   ) (I 0) (I last@)
                 ))
                ) (Poly%fun%1. (mk_fun (%%lambda%%3 $ TYPE%curve25519_dalek!ristretto.RistrettoPoint.
                   (vstd!seq.Seq.subrange.? $ TYPE%curve25519_dalek!ristretto.RistrettoPoint. (Poly%vstd!seq.Seq<curve25519_dalek!ristretto.RistrettoPoint.>.
                     ristretto_points!
                    ) (I 0) (I last@)
                ))))
               ) (vstd!seq.Seq.subrange.? $ TYPE%curve25519_dalek!edwards.EdwardsPoint. (Poly%vstd!seq.Seq<curve25519_dalek!edwards.EdwardsPoint.>.
                 edwards_points@
                ) (I 0) (I last@)
             )))
             (and
              ...
              (=>
               tmp%2
               (=>
                (= tmp%3 (= (curve25519_dalek!ristretto.RistrettoPoint./RistrettoPoint/0 (%Poly%curve25519_dalek!ristretto.RistrettoPoint.
                    (vstd!seq.Seq.index.? $ TYPE%curve25519_dalek!ristretto.RistrettoPoint. (Poly%vstd!seq.Seq<curve25519_dalek!ristretto.RistrettoPoint.>.
                      ristretto_points!
                     ) (I last@)
                   ))
                  ) (%Poly%curve25519_dalek!edwards.EdwardsPoint. (vstd!seq.Seq.index.? $ TYPE%curve25519_dalek!edwards.EdwardsPoint.
                    (Poly%vstd!seq.Seq<curve25519_dalek!edwards.EdwardsPoint.>. edwards_points@) (I last@)
                ))))
                (and
                 (=>
                  %%location_label%%2
      ...
      (and
       ...
       (=>
        %%location_label%%3
        (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.iterator_specs.sum_of_ristretto_points.?
           (Poly%vstd!seq.Seq<curve25519_dalek!ristretto.RistrettoPoint.>. ristretto_points!)
          )
         ) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.sum_of_points.? (vstd!seq.Seq.new.?
            $ TYPE%curve25519_dalek!edwards.EdwardsPoint. $ (TYPE%fun%1. $ INT $ TYPE%curve25519_dalek!edwards.EdwardsPoint.)
            (I (vstd!seq.Seq.len.? $ TYPE%curve25519_dalek!ristretto.RistrettoPoint. (Poly%vstd!seq.Seq<curve25519_dalek!ristretto.RistrettoPoint.>.
               ristretto_points!
             ))
