...
;; curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:146:1: 146:50 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::pow_lemmas::lemma_pow_nat_is_nat
;; curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:146:1: 146:50 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (ens%vstd!arithmetic.power2.lemma_pow2_pos. i!)
    (or
     (and
      (=>
       (= v! 0)
      ...
      (=>
       ...
       (=>
        ...
        (and
         (=>
          %%location_label%%1
          (req%vstd!arithmetic.power.lemma_pow_positive. v! tmp%2)
         )
         (=>
          (ens%vstd!arithmetic.power.lemma_pow_positive. v! tmp%2)
          %%switch_label%%0
     )))))
     (and
      (not %%switch_label%%0)
