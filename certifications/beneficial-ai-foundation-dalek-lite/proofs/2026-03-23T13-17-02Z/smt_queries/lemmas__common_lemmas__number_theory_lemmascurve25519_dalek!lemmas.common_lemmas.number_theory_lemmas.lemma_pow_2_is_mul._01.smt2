...
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:2330:1: 2330:40 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::number_theory_lemmas::lemma_pow_2_is_mul
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:2330:1: 2330:40 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (fuel_bool fuel%vstd!arithmetic.power.pow.)
    (=>
     (= tmp%1 (= (vstd!arithmetic.power.pow.? (I x!) (I 2)) (Mul x! (vstd!arithmetic.power.pow.?
         (I x!) (I 1)
     ))))
     (and
      (=>
      ...
      (=>
       tmp%1
       (=>
        (= tmp%2 (= (vstd!arithmetic.power.pow.? (I x!) (I 1)) (Mul x! (vstd!arithmetic.power.pow.?
            (I x!) (I 0)
        ))))
        (and
         (=>
         ...
         (=>
          tmp%2
          (=>
           (= tmp%3 (= (vstd!arithmetic.power.pow.? (I x!) (I 0)) 1))
           (and
            (=>
             %%location_label%%2
             tmp%3
