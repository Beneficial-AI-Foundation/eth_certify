...
;; curve25519-dalek/src/lemmas/field_lemmas/constants_lemmas.rs:195:5: 195:11 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::constants_lemmas::lemma_minus_one_field_element_value
;; curve25519-dalek/src/lemmas/field_lemmas/constants_lemmas.rs:195:5: 195:11 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= (vstd!arithmetic.power2.pow2.? (I 102)) (nClip (Mul p51@ p51@)))
    (=>
     %%location_label%%0
     (= (Mul p51@ (Sub p51@ 1)) (Sub (vstd!arithmetic.power2.pow2.? (I 102)) p51@))
 ))))
 (get-info :version)
