...
;; curve25519-dalek/src/lemmas/edwards_lemmas/pippenger_lemmas.rs:983:7: 983:89 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::pippenger_lemmas::lemma_weighted_bucket_sum_agree
;; curve25519-dalek/src/lemmas/edwards_lemmas/pippenger_lemmas.rs:983:7: 983:89 (#0)
(get-info :all-statistics)
(push)
 (declare-const a! vstd!seq.Seq<tuple%2<nat./nat.>.>.)
 (declare-const b! vstd!seq.Seq<tuple%2<nat./nat.>.>.)
 (declare-const B! Int)
 ...
 (assert
  (forall ((j$ Poly)) (!
    ...
    :qid user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_weighted_bucket_sum_agree_70
    :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_weighted_bucket_sum_agree_70
 )))
