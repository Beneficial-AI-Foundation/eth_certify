...
;; MODULE 'module lemmas::lizard_lemmas, function curve25519_dalek::lemmas::lizard_lemmas::lemma_spec_lizard_fe_bytes_injective'
;; curve25519-dalek/src/lemmas/lizard_lemmas.rs:310:1: 310:76 (#0)
...
;; Function-Def curve25519_dalek::lemmas::lizard_lemmas::lemma_spec_lizard_fe_bytes_injective
;; curve25519-dalek/src/lemmas/lizard_lemmas.rs:310:1: 310:76 (#0)
(get-info :all-statistics)
(push)
 (declare-const m1! vstd!seq.Seq<u8.>.)
 (declare-const m2! vstd!seq.Seq<u8.>.)
 (assert
  fuel_defaults
 )
 (assert
 ...
 (assert
  (not (=>
    (ens%curve25519_dalek!core_assumes.axiom_sha256_output_length. m1!)
    (=>
     (ens%curve25519_dalek!core_assumes.axiom_sha256_output_length. m2!)
     (=>
      %%location_label%%0
      (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. m1!) (Poly%vstd!seq.Seq<u8.>.
        m2!
