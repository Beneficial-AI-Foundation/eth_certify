...
;; curve25519-dalek/src/lemmas/montgomery_curve_lemmas.rs:252:1: 260:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::montgomery_curve_lemmas::axiom_xadd_projective_correct
;; curve25519-dalek/src/lemmas/montgomery_curve_lemmas.rs:252:1: 260:2 (#0)
...
(push)
 ...
 (declare-const U_P! Int)
 (declare-const W_P! Int)
 (declare-const U_Q! Int)
 (declare-const W_Q! Int)
 (declare-const affine_PmQ! Int)
 (assert
  fuel_defaults
 )
 (assert
