...
;; curve25519-dalek/src/lemmas/edwards_lemmas/pippenger_lemmas.rs:735:7: 735:81 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::pippenger_lemmas::lemma_intermediate_sum_extend
;; curve25519-dalek/src/lemmas/edwards_lemmas/pippenger_lemmas.rs:735:7: 735:81 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= decrease%init0 (Sub (Sub B! 1) b!))
    (or
     (and
      (=>
       (= b! (Sub B! 2))
       (=>
        (= tmp%1 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.pippenger_intermediate_sum.?
            (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. buckets!) (I (Sub B! 1)) (I B!)
           )
          ) (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2. $ NAT $ NAT) (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>.
            buckets!
           ) (I (Sub B! 1))
         ...
         (=>
          ...
          (=>
           (= tmp%2 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.pippenger_intermediate_sum.?
               (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. buckets!) (I (Sub B! 2)) (I (Sub B! 1))
              )
             ) (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2. $ NAT $ NAT) (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>.
               buckets!
              ) (I (Sub B! 2))
           ...
           (and
            ...
            (=>
             ...
             (and
              (=>
               (= tmp%3 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2.
                     $ NAT $ NAT
                    ) (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. buckets!) (I (Sub B! 1))
               )))))
               (=>
                (= tmp%4 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2.
                      $ NAT $ NAT
                     ) (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. buckets!) (I (Sub B! 1))
                )))))
                (=>
                 (= tmp%5 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2.
                       $ NAT $ NAT
                      ) (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. buckets!) (I (Sub B! 2))
                 )))))
                 (=>
                  (= tmp%6 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2.
                        $ NAT $ NAT
                       ) (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. buckets!) (I (Sub B! 2))
                  )))))
                  (=>
                   ...
                   (=>
                    ...
                    (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_add.?
                       ...
                       ) (tuple%2./tuple%2/0 (%Poly%tuple%2. (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2. $
                           NAT $ NAT
                          ) (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. buckets!) (I (Sub B! 2))
                        ))
                       ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2. $
      ...
      (=>
       (not (= b! (Sub B! 2)))
       (=>
        (= A@ (curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.pippenger_intermediate_sum.?
        ...
        (=>
         ...
         (=>
          (= D@ (%Poly%tuple%2. (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2. $ NAT $ NAT) (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>.
              buckets!
             ) (I b!)
          )))
          (and
            ...
            (and
             (=>
              ...
              (check_decrease_int (let
                ((buckets!$0 buckets!) (b!$1 tmp%7) (B!$2 B!))
                (Sub (Sub B!$2 1) b!$1)
           ...
           (=>
            ...
            (and
             (=>
              (= tmp%8 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. A@)))))
              (=>
               (= tmp%9 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. A@)))))
               (=>
                (= tmp%10 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. C@)))))
                (=>
                 (= tmp%11 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. C@)))))
                 (=>
                  (= tmp%12 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. D@)))))
                  (=>
                   (= tmp%13 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. D@)))))
                   (=>
                    (ens%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.axiom_edwards_add_associative.
                     tmp%8 tmp%9 tmp%10 tmp%11 tmp%12 tmp%13
                    )
                    (=>
                     (= tmp%14 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. C@)))))
                     (=>
                      (= tmp%15 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. C@)))))
                      (=>
                       (= tmp%16 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. D@)))))
                       (=>
                        (= tmp%17 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. D@)))))
                        (=>
                         (ens%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_edwards_add_commutative.
                          tmp%14 tmp%15 tmp%16 tmp%17
                         )
                         (=>
                          (= tmp%18 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. A@)))))
                          (=>
                           (= tmp%19 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. A@)))))
                           (=>
                            (= tmp%20 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. D@)))))
                            (=>
                             (= tmp%21 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. D@)))))
                             (=>
                              (= tmp%22 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. C@)))))
                              (=>
                               (= tmp%23 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. C@)))))
                               (=>
                                (ens%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.axiom_edwards_add_associative.
                                ...
                                (=>
                                 ...
                                 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_add.?
                                    (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_add.?
                                        ...
                                        ) (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. C@))) (tuple%2./tuple%2/1 (%Poly%tuple%2.
                                          (Poly%tuple%2. C@)
                                     )))))
                                    ...
                                    ) (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. D@))) (tuple%2./tuple%2/1 (%Poly%tuple%2.
                                      (Poly%tuple%2. D@)
                                   )))
                                  ) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_add.? (tuple%2./tuple%2/0
                                     (%Poly%tuple%2. (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_add.? (
                                         tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. A@))
                                        ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. A@))) (tuple%2./tuple%2/0 (%Poly%tuple%2.
                                          (Poly%tuple%2. D@)
                                         )
