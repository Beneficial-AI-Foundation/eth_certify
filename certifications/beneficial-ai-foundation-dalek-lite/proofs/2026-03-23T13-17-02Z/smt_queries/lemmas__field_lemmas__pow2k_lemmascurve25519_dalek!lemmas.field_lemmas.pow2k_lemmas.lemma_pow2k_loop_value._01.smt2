...
;; curve25519-dalek/src/lemmas/field_lemmas/pow2k_lemmas.rs:314:1: 314:74 (#0)
...
;; Function-Specs curve25519_dalek::lemmas::field_lemmas::pow2k_lemmas::lemma_c_i_0_bounded
(declare-fun req%curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.lemma_c_i_0_bounded.
 (%%Function%% Int) Bool
)
...
(assert
 (forall ((a! %%Function%%) (bound! Int)) (!
   (= (req%curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.lemma_c_i_0_bounded. a! bound!)
    (and
     (=>
     ...
     (=>
      ...
      (forall ((i$ Poly)) (!
        ...
        :qid user_curve25519_dalek__lemmas__field_lemmas__pow2k_lemmas__lemma_c_i_0_bounded_36
        :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__pow2k_lemmas__lemma_c_i_0_bounded_36
   )))))
   :pattern ((req%curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.lemma_c_i_0_bounded.
     a! bound!
   ))
   :qid internal_req__curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.lemma_c_i_0_bounded._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.lemma_c_i_0_bounded._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.lemma_c_i_0_bounded.
 (%%Function%% Int) Bool
)
(assert
 (forall ((a! %%Function%%) (bound! Int)) (!
   (= (ens%curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.lemma_c_i_0_bounded. a! bound!)
    (curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.ci_0_val_boundaries.? (Poly%array%.
      a!
     ) (I bound!)
   ))
   :pattern ((ens%curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.lemma_c_i_0_bounded.
     a! bound!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.lemma_c_i_0_bounded._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.lemma_c_i_0_bounded._definition
)))
...
;; Function-Specs curve25519_dalek::lemmas::field_lemmas::pow2k_lemmas::lemma_c_i_shift_bounded
(declare-fun req%curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.lemma_c_i_shift_bounded.
 (%%Function%% Int) Bool
)
...
(assert
 (forall ((a! %%Function%%) (bound! Int)) (!
   (= (req%curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.lemma_c_i_shift_bounded.
     a! bound!
    ) (and
     (=>
   ...
   :pattern ((req%curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.lemma_c_i_shift_bounded.
     a! bound!
   ))
   :qid internal_req__curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.lemma_c_i_shift_bounded._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.lemma_c_i_shift_bounded._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.lemma_c_i_shift_bounded.
 (%%Function%% Int) Bool
)
(assert
 (forall ((a! %%Function%%) (bound! Int)) (!
   (= (ens%curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.lemma_c_i_shift_bounded.
     a! bound!
    ) (curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.ci_val_boundaries.? (Poly%array%.
      a!
   )))
   :pattern ((ens%curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.lemma_c_i_shift_bounded.
     a! bound!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.lemma_c_i_shift_bounded._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.lemma_c_i_shift_bounded._definition
)))
 ...
 (forall ((a! %%Function%%)) (!
   (= (req%curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.lemma_pow2k_loop_boundary.
     ...
     (forall ((i$ Poly)) (!
       ...
       :qid user_curve25519_dalek__lemmas__field_lemmas__pow2k_lemmas__lemma_pow2k_loop_boundary_38
       :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__pow2k_lemmas__lemma_pow2k_loop_boundary_38
   ))))
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::pow2k_lemmas::lemma_pow2k_loop_value
;; curve25519-dalek/src/lemmas/field_lemmas/pow2k_lemmas.rs:314:1: 314:74 (#0)
...
(push)
 ...
 (declare-const a_hat@ %%Function%%)
 (declare-const a0_1@ Int)
 (declare-const a0_2@ Int)
 (declare-const a1_0@ Int)
 (declare-const a1_1@ Int)
 (declare-const a2@ Int)
 (declare-const a3@ Int)
 (declare-const a4@ Int)
 (declare-const a_pow_2i_int@ Int)
 (declare-const a_pow_2i@ Int)
 (assert
  fuel_defaults
 )
 (assert
     ...
     (=>
      ...
      (and
       ...
       (=>
        (= curve25519_dalek!specs.field_specs_u64.mask51.? (vstd!bits.low_bits_mask.? (I 51)))
        (=>
         (= a_hat@ (curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.pow2k_loop_return.? (Poly%array%.
            a!
         )))
         (=>
          (= a0_1@ (curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.a0_1_val.? (Poly%array%.
             a!
          )))
          (=>
           (= a0_2@ (curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.a0_2_val.? (Poly%array%.
              a!
           )))
           (=>
            (= a1_0@ (curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.a1_0_val.? (Poly%array%.
               a!
            )))
            (=>
             (= a1_1@ (curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.a1_1_val.? (Poly%array%.
                a!
             )))
             (=>
              (= a2@ (curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.a2_0_val.? (Poly%array%. a!)))
              (=>
               (= a3@ (curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.a3_0_val.? (Poly%array%. a!)))
               (=>
                (= a4@ (curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.a4_0_val.? (Poly%array%. a!)))
                (and
                 (and
                  (and
                   (and
                    (and
                     (=>
                      %%location_label%%2
                      (req%vstd!bits.lemma_u64_low_bits_mask_is_mod. a0_1@ 51)
                     )
                     (=>
                      (ens%vstd!bits.lemma_u64_low_bits_mask_is_mod. a0_1@ 51)
                      (=>
                       %%location_label%%3
                       (= a0_2@ (EucMod a0_1@ (uClip 64 (vstd!arithmetic.power2.pow2.? (I 51)))))
                    )))
                    (=>
                     (= a0_2@ (EucMod a0_1@ (uClip 64 (vstd!arithmetic.power2.pow2.? (I 51)))))
                     (and
                      (and
                       (=>
                        %%location_label%%4
                        (req%vstd!bits.lemma_u64_shr_is_div. a0_1@ 51)
                       )
                       (=>
                        (ens%vstd!bits.lemma_u64_shr_is_div. a0_1@ 51)
                        (=>
                         %%location_label%%5
                         (= (uClip 64 (bitshr (I a0_1@) (I 51))) (EucDiv a0_1@ (uClip 64 (vstd!arithmetic.power2.pow2.?
                             (I 51)
                      )))))))
                      (=>
                       (= (uClip 64 (bitshr (I a0_1@) (I 51))) (EucDiv a0_1@ (uClip 64 (vstd!arithmetic.power2.pow2.?
                       ...
                       (=>
                        (= tmp%1 (uClip 64 (bitshr (I a0_1@) (I 51))))
                        (and
                         (=>
                          %%location_label%%6
                          (req%curve25519_dalek!lemmas.field_lemmas.pow2_51_lemmas.lemma_u64_div_and_mod_51.
                         ...
                         (=>
                          ...
                          (=>
                           %%location_label%%7
                           (= (Add a0_2@ (Mul (vstd!arithmetic.power2.pow2.? (I 51)) a1_1@)) (Add a0_1@ (Mul (vstd!arithmetic.power2.pow2.?
                               (I 51)
                              ) a1_0@
                   )))))))))))
                   (=>
                    ...
                    (=>
                     %%location_label%%8
                     (= (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. a_hat@)) (
                       Add (Add (Add (Add a0_1@ (Mul (vstd!arithmetic.power2.pow2.? (I 51)) a1_0@)) (Mul (vstd!arithmetic.power2.pow2.?
                           (I 102)
                          ) a2@
                         )
                        ) (Mul (vstd!arithmetic.power2.pow2.? (I 153)) a3@)
                       ) (Mul (vstd!arithmetic.power2.pow2.? (I 204)) a4@)
                  )))))
                  (=>
                   (= (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. a_hat@)) (
                     Add (Add (Add (Add a0_1@ (Mul (vstd!arithmetic.power2.pow2.? (I 51)) a1_0@)) (Mul (vstd!arithmetic.power2.pow2.?
                   ...
                   (=>
                    (= c0_0@ (curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.c0_0_val.? (Poly%array%.
                       a!
                    )))
                    (=>
                     (= c1_0@ (curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.c1_0_val.? (Poly%array%.
                        a!
                     )))
                     (=>
                      (= c2_0@ (curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.c2_0_val.? (Poly%array%.
                         a!
                      )))
                      (=>
                       (= c3_0@ (curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.c3_0_val.? (Poly%array%.
                          a!
                       )))
                       (=>
                        (= c4_0@ (curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.c4_0_val.? (Poly%array%.
                           a!
                        )))
                        (=>
                         (= c1@ (curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.c1_val.? (Poly%array%. a!)))
                         (=>
                          (= c2@ (curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.c2_val.? (Poly%array%. a!)))
                          (=>
                           (= c3@ (curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.c3_val.? (Poly%array%. a!)))
                           (=>
                            (= c4@ (curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.c4_val.? (Poly%array%. a!)))
                            (=>
                             (= carry@ (curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.carry_val.? (Poly%array%.
                                a!
                             )))
                             (and
                              (=>
                                  ...
                                  (and
                                   (and
                                    ...
                                    (=>
                                     ...
                                     (=>
                                      %%location_label%%11
                                      (= a0_1@ (Add (EucMod (uClip 64 c0_0@) (uClip 64 (vstd!arithmetic.power2.pow2.? (I 51))))
                                        (Mul 19 carry@)
                                   )))))
                                   (=>
                                    (= a0_1@ (Add (EucMod (uClip 64 c0_0@) (uClip 64 (vstd!arithmetic.power2.pow2.? (I 51))))
                                    ...
                                    (and
                                     (and
                                      ...
                                      (=>
                                       ...
                                       (=>
                                        %%location_label%%13
                                        (= a1_0@ (EucMod (uClip 64 c1@) (uClip 64 (vstd!arithmetic.power2.pow2.? (I 51)))))
                                     )))
                                     (=>
                                      (= a1_0@ (EucMod (uClip 64 c1@) (uClip 64 (vstd!arithmetic.power2.pow2.? (I 51)))))
                                      (and
                                       (and
                                        ...
                                        (=>
                                         ...
                                         (=>
                                          %%location_label%%15
                                          (= a2@ (EucMod (uClip 64 c2@) (uClip 64 (vstd!arithmetic.power2.pow2.? (I 51)))))
                                       )))
                                       (=>
                                        (= a2@ (EucMod (uClip 64 c2@) (uClip 64 (vstd!arithmetic.power2.pow2.? (I 51)))))
                                        (and
                                         (and
                                          ...
                                          (=>
                                           ...
                                           (=>
                                            %%location_label%%17
                                            (= a3@ (EucMod (uClip 64 c3@) (uClip 64 (vstd!arithmetic.power2.pow2.? (I 51)))))
                                         )))
                                         (=>
                                          (= a3@ (EucMod (uClip 64 c3@) (uClip 64 (vstd!arithmetic.power2.pow2.? (I 51)))))
                                          (and
                                           (and
                                            ...
                                            (=>
                                             ...
                                             (=>
                                              %%location_label%%19
                                              (= a4@ (EucMod (uClip 64 c4@) (uClip 64 (vstd!arithmetic.power2.pow2.? (I 51)))))
                                           )))
                                           (=>
                                            (= a4@ (EucMod (uClip 64 c4@) (uClip 64 (vstd!arithmetic.power2.pow2.? (I 51)))))
                                            (=>
                                        ...
                                        (and
                                         (=>
                                          ...
                                          (and
                                           ...
                                           (=>
                                            ...
                                            (=>
                                             %%location_label%%42
                                             (= (EucMod (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. a_hat@))
                                               (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
                                         ...
                                         (=>
                                          ...
                                          (=>
                                           ...
                                           (=>
                                            (= a3_19@ (Mul 19 (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY
                                                  $ (UINT 64) $ (CONST_INT 5)
                                                 ) (Poly%array%. a!)
                                                ) (I 3)
                                            ))))
                                            (=>
                                             (= a4_19@ (Mul 19 (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY
                                                   $ (UINT 64) $ (CONST_INT 5)
                                                  ) (Poly%array%. a!)
                                                 ) (I 4)
                                             ))))
                                                   ...
                                                   (=>
                                                    ...
                                                    (=>
                                                     ...
                                                     (=>
                                                      ...
                                                      (=>
                                                       (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. tmp%19 tmp%20)
                                                       (=>
                                                        ...
                                                        (=>
                                                         ...
                                                         (=>
                                                          (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. tmp%21 tmp%22)
                                                          (=>
                                                           %%location_label%%43
                                               ...
                                               (and
                                                (=>
                                                 ...
                                                 (=>
                                                  ...
                                                  (=>
                                                   (ens%vstd!arithmetic.mul.lemma_mul_is_associative. tmp%23 tmp%24 19)
                                                   (=>
                                                    ...
                                                    (=>
                                                     ...
                                                     (=>
                                                      (ens%vstd!arithmetic.mul.lemma_mul_is_associative. tmp%25 tmp%26 19)
                                                      (=>
                                                       ...
                                                       (=>
                                                        ...
                                                        (=>
                                                         (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. tmp%27 tmp%28)
                                                         (=>
                                                          ...
                                                          (=>
                                                           ...
                                                           (=>
                                                            (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. tmp%29 tmp%30)
                                                            (=>
                                                             %%location_label%%44
                                                   ...
                                                   (=>
                                                    ...
                                                    (=>
                                                     ...
                                                     (=>
                                                      ...
                                                      (=>
                                                       (= tmp%34 (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT
                                                             64
                                                            ) $ (CONST_INT 5)
                                                           ) (Poly%array%. a!)
                                                          ) (I 0)
                                                   ...
                                                   (and
                                                    (=>
                                                     ...
                                                     (=>
                                                      ...
                                                      (=>
                                                       (ens%vstd!arithmetic.mul.lemma_mul_is_associative. tmp%37 tmp%38 19)
                                                       (=>
                                                        ...
                                                        (=>
                                                         (= tmp%40 (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT
                                                               64
                                                              ) $ (CONST_INT 5)
                                                             ) (Poly%array%. a!)
                                                            ) (I 1)
                                                         ...
                                                         (=>
                                                          (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. tmp%39 tmp%40)
                                                          (=>
                                                           ...
                                                           (=>
                                                            ...
                                                            (=>
                                                             (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. tmp%41 tmp%42)
                                                             (=>
                                                              %%location_label%%46
                                                    ...
                                                    (=>
                                                     ...
                                                     (and
                                                      (=>
                                                       ...
                                                       (=>
                                                        (= tmp%44 (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT
                                                              64
                                                             ) $ (CONST_INT 5)
                                                            ) (Poly%array%. a!)
                                                           ) (I 1)
                                                        ...
                                                        (=>
                                                         (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. tmp%43 tmp%44)
                                                         (=>
                                                          (= tmp%45 (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT
                                                                64
                                                               ) $ (CONST_INT 5)
                                                              ) (Poly%array%. a!)
                                                             ) (I 4)
                                                          ...
                                                          (=>
                                                           ...
                                                           (=>
                                                            (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. tmp%45 tmp%46)
                                                            (=>
                                                             %%location_label%%47
                                                             (= c4_0@ (Add (Add (Add (Add (Mul (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                                                                      $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. a!)
                                                                     ) (I 0)
                                                                    )
                                                                   ) (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $
                                                       ...
                                                       (=>
                                                        ...
                                                        (= (EucMod (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. a_hat@))
                                                          (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
                                                            ...
                                                            ) (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. a!))
                                                           )
                                                          ) (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
                 )))))))))))))))))))))))))))))))))))))))))
                 (=>
                  ...
                  (=>
                   (= a_pow_2i_int@ (vstd!arithmetic.power.pow.? (I (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.?
                       (Poly%array%. limbs!)
                      )
                     ) (I (vstd!arithmetic.power2.pow2.? (I i!)))
                   ))
                   (and
                    (=>
                     (= tmp%47 (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. limbs!)))
                     (=>
                      (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow_nat_is_nat. tmp%47
                       i!
                      )
                      (=>
                       %%location_label%%49
                    ...
                    (=>
                     (>= a_pow_2i_int@ 0)
                     (=>
                      (= a_pow_2i@ (nClip a_pow_2i_int@))
                      (and
                       (=>
                        (= tmp%48 (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. a!)))
                        (=>
                         (= tmp%49 (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. a!)))
                         (=>
                          (= tmp%50 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                          (and
                           (=>
                            %%location_label%%50
                            (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop. tmp%48 tmp%49 tmp%50)
                           )
                           (=>
                            (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop. tmp%48 tmp%49 tmp%50)
                            (=>
                             %%location_label%%51
                             (= (EucMod (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. a_hat@))
                               (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
                       ...
                       (=>
                        ...
                        (and
                         (=>
                          (= tmp%51 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                          (and
                           (=>
                            %%location_label%%52
                            (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop. a_pow_2i@ a_pow_2i@ tmp%51)
                           )
                           (=>
                            (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop. a_pow_2i@ a_pow_2i@ tmp%51)
                            (=>
                             %%location_label%%53
                             (= (EucMod (nClip (Mul (EucMod a_pow_2i@ (curve25519_dalek!specs.field_specs_u64.p.? (I
                                    0
                                  ))
                                 ) (EucMod a_pow_2i@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                                )
                               ) (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
                              ) (EucMod (nClip (Mul a_pow_2i@ a_pow_2i@)) (curve25519_dalek!specs.field_specs_u64.p.?
                                (I 0)
                         )))))))
                         (=>
                          (= (EucMod (nClip (Mul (EucMod a_pow_2i@ (curve25519_dalek!specs.field_specs_u64.p.? (I
                          ...
                          (and
                           (=>
                            (= tmp%52 (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. limbs!)))
                            (=>
                             (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_square. tmp%52 i!)
                             (=>
                              %%location_label%%54
                              (= (Mul (vstd!arithmetic.power.pow.? (I (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.?
                                   (Poly%array%. limbs!)
                                  )
                                 ) (I (vstd!arithmetic.power2.pow2.? (I i!)))
