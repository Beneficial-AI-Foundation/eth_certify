...
;; MODULE 'module lemmas::field_lemmas::negate_lemmas'
;; curve25519-dalek/src/lemmas/field_lemmas/negate_lemmas.rs:40:1: 40:43 (#0)
...
(assert
 (distinct fuel%vstd!arithmetic.div_mod.lemma_div_is_ordered. fuel%vstd!arithmetic.div_mod.lemma_fundamental_div_mod.
  ...
  fuel%vstd!arithmetic.div_mod.lemma_mod_is_zero. fuel%vstd!arithmetic.div_mod.lemma_mod_multiples_basic.
  fuel%vstd!arithmetic.div_mod.lemma_add_mod_noop. fuel%vstd!arithmetic.div_mod.lemma_mod_bound.
  fuel%vstd!arithmetic.mul.lemma_mul_is_commutative. fuel%vstd!arithmetic.mul.lemma_mul_is_distributive_sub.
  ...
  fuel%vstd!view.impl&%32.view. fuel%curve25519_dalek!lemmas.field_lemmas.negate_lemmas.all_neg_limbs_positive.
...
;; Function-Specs vstd::arithmetic::div_mod::lemma_div_by_self
...
(assert
 (=>
  ...
  (forall ((x! Int) (y! Int) (z! Int)) (!
    ...
    :qid user_vstd__arithmetic__div_mod__lemma_div_is_ordered_22
    :skolemid skolem_user_vstd__arithmetic__div_mod__lemma_div_is_ordered_22
))))
...
(assert
 (=>
  ...
  (forall ((x! Int) (d! Int)) (!
    ...
    :qid user_vstd__arithmetic__div_mod__lemma_fundamental_div_mod_23
    :skolemid skolem_user_vstd__arithmetic__div_mod__lemma_fundamental_div_mod_23
))))
...
(assert
 (=>
  ...
  (forall ((b! Int) (d! Int)) (!
    ...
    :qid user_vstd__arithmetic__div_mod__lemma_div_by_multiple_24
    :skolemid skolem_user_vstd__arithmetic__div_mod__lemma_div_by_multiple_24
))))
...
(assert
 (=>
  ...
  (forall ((x! Int) (y! Int) (m! Int) (z! Int)) (!
    ...
    :qid user_vstd__arithmetic__div_mod__lemma_div_by_multiple_is_strongly_ordered_25
    :skolemid skolem_user_vstd__arithmetic__div_mod__lemma_div_by_multiple_is_strongly_ordered_25
))))
...
(assert
 (=>
  ...
  (forall ((m! Int)) (!
    ...
    :pattern ((EucMod m! m!))
    :qid user_vstd__arithmetic__div_mod__lemma_mod_self_0_26
    :skolemid skolem_user_vstd__arithmetic__div_mod__lemma_mod_self_0_26
))))
...
;; Function-Specs vstd::arithmetic::div_mod::lemma_mod_is_zero
(declare-fun req%vstd!arithmetic.div_mod.lemma_mod_is_zero. (Int Int) Bool)
(declare-const %%global_location_label%%17 Bool)
(declare-const %%global_location_label%%18 Bool)
(assert
 (forall ((x! Int) (m! Int)) (!
   (= (req%vstd!arithmetic.div_mod.lemma_mod_is_zero. x! m!) (and
     (=>
   ...
   :pattern ((req%vstd!arithmetic.div_mod.lemma_mod_is_zero. x! m!))
   :qid internal_req__vstd!arithmetic.div_mod.lemma_mod_is_zero._definition
   :skolemid skolem_internal_req__vstd!arithmetic.div_mod.lemma_mod_is_zero._definition
)))
(declare-fun ens%vstd!arithmetic.div_mod.lemma_mod_is_zero. (Int Int) Bool)
(assert
 (forall ((x! Int) (m! Int)) (!
   (= (ens%vstd!arithmetic.div_mod.lemma_mod_is_zero. x! m!) (>= x! m!))
   :pattern ((ens%vstd!arithmetic.div_mod.lemma_mod_is_zero. x! m!))
   :qid internal_ens__vstd!arithmetic.div_mod.lemma_mod_is_zero._definition
   :skolemid skolem_internal_ens__vstd!arithmetic.div_mod.lemma_mod_is_zero._definition
)))

;; Broadcast vstd::arithmetic::div_mod::lemma_mod_is_zero
(assert
 (=>
  ...
  (forall ((x! Int) (m! Int)) (!
    ...
    :pattern ((EucMod x! m!))
    :qid user_vstd__arithmetic__div_mod__lemma_mod_is_zero_28
    :skolemid skolem_user_vstd__arithmetic__div_mod__lemma_mod_is_zero_28
))))
...
(assert
 (=>
  ...
  (forall ((x! Int) (m! Int)) (!
    ...
    :qid user_vstd__arithmetic__div_mod__lemma_mod_multiples_basic_29
    :skolemid skolem_user_vstd__arithmetic__div_mod__lemma_mod_multiples_basic_29
))))
...
(assert
 (=>
  ...
  (forall ((x! Int) (y! Int) (m! Int)) (!
    ...
    :qid user_vstd__arithmetic__div_mod__lemma_add_mod_noop_30
    :skolemid skolem_user_vstd__arithmetic__div_mod__lemma_add_mod_noop_30
))))
...
(assert
 (=>
  ...
  (forall ((x! Int) (y! Int) (z! Int)) (!
    ...
    :qid user_vstd__arithmetic__mul__lemma_mul_is_distributive_sub_33
    :skolemid skolem_user_vstd__arithmetic__mul__lemma_mul_is_distributive_sub_33
))))
 ...
 (forall ((a! %%Function%%) (b! %%Function%%)) (!
   (= (req%curve25519_dalek!lemmas.field_lemmas.u64_5_as_nat_lemmas.lemma_u64_5_as_nat_sub.
     ...
     (forall ((i$ Poly)) (!
       ...
       :qid user_curve25519_dalek__lemmas__field_lemmas__u64_5_as_nat_lemmas__lemma_u64_5_as_nat_sub_37
       :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__u64_5_as_nat_lemmas__lemma_u64_5_as_nat_sub_37
   ))))
 ...
 (forall ((limbs! %%Function%%)) (!
   (= (req%curve25519_dalek!lemmas.field_lemmas.negate_lemmas.lemma_neg_no_underflow.
     ...
     (forall ((i$ Poly)) (!
       ...
       :qid user_curve25519_dalek__lemmas__field_lemmas__negate_lemmas__lemma_neg_no_underflow_38
       :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__negate_lemmas__lemma_neg_no_underflow_38
   ))))
   ...
   (= (req%curve25519_dalek!lemmas.field_lemmas.negate_lemmas.proof_negate. limbs!) (
     ...
     (=>
      ...
      (forall ((i$ Poly)) (!
        ...
        :qid user_curve25519_dalek__lemmas__field_lemmas__negate_lemmas__proof_negate_41
        :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__negate_lemmas__proof_negate_41
     )))
     (=>
 ...
 (forall ((limbs! %%Function%%)) (!
   (= (ens%curve25519_dalek!lemmas.field_lemmas.negate_lemmas.proof_negate. limbs!) (
     ...
     (forall ((i$ Poly)) (!
       ...
       :qid user_curve25519_dalek__lemmas__field_lemmas__negate_lemmas__proof_negate_42
       :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__negate_lemmas__proof_negate_42
     ))
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::negate_lemmas::proof_negate
;; curve25519-dalek/src/lemmas/field_lemmas/negate_lemmas.rs:40:1: 40:43 (#0)
...
(push)
 ...
 (assert
  (forall ((i$ Poly)) (!
    ...
    :qid user_curve25519_dalek__lemmas__field_lemmas__negate_lemmas__proof_negate_51
    :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__negate_lemmas__proof_negate_51
 )))
 (assert
  (curve25519_dalek!lemmas.field_lemmas.negate_lemmas.all_neg_limbs_positive.? (Poly%array%.
    limbs!
 ...
 (assert
  (not (=>
    (= tmp%1 (curve25519_dalek!specs.field_specs_u64.pre_reduce_limbs.? (Poly%array%. limbs!)))
    (=>
     (ens%curve25519_dalek!lemmas.field_lemmas.reduce_lemmas.proof_reduce. tmp%1)
     (=>
      (= c0@ (Sub (vstd!arithmetic.power2.pow2.? (I 51)) 19))
      (=>
       (= c@ (Sub (vstd!arithmetic.power2.pow2.? (I 51)) 1))
       (=>
        (ens%vstd!arithmetic.power2.lemma2_to64_rest. 0)
        (and
         (=>
          %%location_label%%0
          (req%curve25519_dalek!lemmas.field_lemmas.negate_lemmas.lemma_neg_no_underflow. limbs!)
         )
         (=>
          (ens%curve25519_dalek!lemmas.field_lemmas.negate_lemmas.lemma_neg_no_underflow. limbs!)
          (=>
           (= v@ (%Poly%array%. (array_new $ (UINT 64) 5 (%%array%%0 (I (uClip 64 (Mul 16 c0@)))
               (I (uClip 64 (Mul 16 c@))) (I (uClip 64 (Mul 16 c@))) (I (uClip 64 (Mul 16 c@)))
               (I (uClip 64 (Mul 16 c@)))
           ))))
           (and
            (=>
             (= tmp%2 (= (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. v@))
               (Add (Add (Add (Add (Mul 16 c0@) (Mul (vstd!arithmetic.power2.pow2.? (I 51)) (Mul 16 c@)))
                  (Mul (vstd!arithmetic.power2.pow2.? (I 102)) (Mul 16 c@))
                 ) (Mul (vstd!arithmetic.power2.pow2.? (I 153)) (Mul 16 c@))
                ) (Mul (vstd!arithmetic.power2.pow2.? (I 204)) (Mul 16 c@))
             )))
             (and
              (=>
               %%location_label%%1
                 ...
                 (=>
                  ...
                  (=>
                   ...
                   (=>
                    ...
                    (=>
                     %%location_label%%2
                     (= (curve25519_dalek!specs.field_specs_u64.p.? (I 0)) (Add (Add (Add (Add c0@ (Mul (vstd!arithmetic.power2.pow2.?
                            (I 51)
                           ) c@
                          )
                         ) (Mul (vstd!arithmetic.power2.pow2.? (I 102)) c@)
                        ) (Mul (vstd!arithmetic.power2.pow2.? (I 153)) c@)
                       ) (Mul (vstd!arithmetic.power2.pow2.? (I 204)) c@)
                )))))))
                (=>
                 (= (curve25519_dalek!specs.field_specs_u64.p.? (I 0)) (Add (Add (Add (Add c0@ (Mul (vstd!arithmetic.power2.pow2.?
                        (I 51)
                 ...
                 (=>
                  %%location_label%%3
                  (= (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. v@)) (nClip
                    (Mul 16 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
            ))))))))
            (=>
             (= (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. v@)) (nClip
               (Mul 16 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                   ...
                   (and
                    ...
                    (=>
                     ...
                     (=>
                      %%location_label%%5
                      (= (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (array_new $ (UINT 64) 5 (
                          %%array%%0 (I (uClip 64 (Sub (Mul 16 c0@) l0@))) (I (uClip 64 (Sub (Mul 16 c@) l1@)))
                          (I (uClip 64 (Sub (Mul 16 c@) l2@))) (I (uClip 64 (Sub (Mul 16 c@) l3@))) (I (uClip
                            64 (Sub (Mul 16 c@) l4@)
                        ))))
                       ) (Sub (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. v@)) (
                         curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. limbs!)
                   ))))))
                   (=>
                    (= (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (array_new $ (UINT 64) 5 (
                    ...
                    (=>
                     (= k@ (uClip 64 (bitshr (I (uClip 64 (Sub (Mul 16 c@) l4@))) (I 51))))
                     (and
                      (=>
                       (= tmp%3 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                       (=>
                        (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub. tmp%3 16 k@)
                        (=>
                         %%location_label%%6
                         (= (Add (Sub (Sub (nClip (Mul 16 (curve25519_dalek!specs.field_specs_u64.p.? (I 0))))
                             (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. limbs!))
                            ) (Mul (curve25519_dalek!specs.field_specs_u64.p.? (I 0)) k@)
                           ) (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. limbs!))
                          ) (Mul (curve25519_dalek!specs.field_specs_u64.p.? (I 0)) (Sub 16 k@))
                      ))))
                      (=>
                       (= (Add (Sub (Sub (nClip (Mul 16 (curve25519_dalek!specs.field_specs_u64.p.? (I 0))))
                           (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. limbs!))
                       ...
                       (and
                        (and
                         (and
                          (=>
                           (= tmp%4 (uClip 64 (Sub (Mul 16 c@) l4@)))
                           (=>
                            (= tmp%5 (uClip 64 (nClip (Mul 16 (vstd!arithmetic.power2.pow2.? (I 51))))))
                            (and
                             (=>
                              %%location_label%%7
                              (req%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u64_shr_le. tmp%4 tmp%5
                               51
                             ))
                             (=>
                              (ens%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u64_shr_le. tmp%4 tmp%5
                               51
                              )
                              (=>
                               %%location_label%%8
                               (<= k@ (uClip 64 (bitshr (I (uClip 64 (nClip (Mul 16 (vstd!arithmetic.power2.pow2.? (I 51))))))
                                  (I 51)
                          ))))))))
                          (=>
                           (<= k@ (uClip 64 (bitshr (I (uClip 64 (nClip (Mul 16 (vstd!arithmetic.power2.pow2.? (I 51))))))
                           ...
                           (and
                            ...
                            (=>
                             (= (uClip 64 (bitshr (I (uClip 64 (nClip (Mul 16 2251799813685248)))) (I 51))) 16)
                             (=>
                              %%location_label%%10
                              (<= k@ 16)
                         )))))
                          ...
                          (=>
                           ...
                           (=>
                            ...
                            (and
                             (=>
                              %%location_label%%11
                              (req%vstd!arithmetic.div_mod.lemma_mod_multiples_basic. tmp%6 tmp%7)
                             )
                             (=>
                              (ens%vstd!arithmetic.div_mod.lemma_mod_multiples_basic. tmp%6 tmp%7)
                              (=>
                               (= tmp%8 (Sub 16 k@))
                               (=>
                                ...
                                (=>
                                 ...
                                 (=>
                                  %%location_label%%12
                                  (= (EucMod (nClip (Mul (curve25519_dalek!specs.field_specs_u64.p.? (I 0)) (Sub 16 k@)))
                                    (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
                                   ) 0
                        )))))))))))
                        (=>
                         ...
                         (and
                          (=>
                           ...
                           (forall ((i$ Poly)) (!
                             ...
                             :qid user_curve25519_dalek__lemmas__field_lemmas__negate_lemmas__proof_negate_43
                             :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__negate_lemmas__proof_negate_43
                          )))
                          (and
                           (=>
                            %%location_label%%14
