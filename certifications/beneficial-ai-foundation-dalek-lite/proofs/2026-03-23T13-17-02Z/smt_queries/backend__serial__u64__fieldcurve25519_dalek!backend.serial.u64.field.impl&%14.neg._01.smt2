...
;; curve25519-dalek/src/backend/serial/u64/field.rs:657:5: 657:44 (#0)
...
;; Function-Def curve25519_dalek::backend::serial::u64::field::impl&%14::neg
;; curve25519-dalek/src/backend/serial/u64/field.rs:657:5: 657:44 (#0)
...
(push)
 ...
 (assert
  (%B (vstd!std_specs.ops.NegSpec.neg_req.? (REF $) TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.
    self!
 )))
 ...
 (assert
  (not (=>
    (= output@0 (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. self!))
    (and
     (=>
      %%location_label%%0
      (req%curve25519_dalek!backend.serial.u64.field.impl&%16.negate. output@0)
     )
     (=>
      ...
      (=>
       (ens%curve25519_dalek!backend.serial.u64.field.impl&%16.negate. output@0 output@1)
       (and
        (=>
         %%location_label%%1
         (req%curve25519_dalek!lemmas.field_lemmas.negate_lemmas.lemma_neg. (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
           self!
        )))
        (=>
         (ens%curve25519_dalek!lemmas.field_lemmas.negate_lemmas.lemma_neg. (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
           self!
         ))
         (=>
          (= output! (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. output@1))
          (and
           (=>
            %%location_label%%2
            (=>
             (%B (vstd!std_specs.ops.NegSpec.obeys_neg_spec.? (REF $) TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.))
             (= output! (vstd!std_specs.ops.NegSpec.neg_spec.? (REF $) TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.
               self!
           ))))
           (and
            (=>
