...
;; curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:31:1: 31:61 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::as_bytes_lemmas::lemma_as_bytes_boundaries1
;; curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:31:1: 31:61 (#0)
(get-info :all-statistics)
(push)
 (declare-const raw_limbs! %%Function%%)
 ...
 (assert
  (has_type (Poly%array%. raw_limbs!) (ARRAY $ (UINT 64) $ (CONST_INT 5)))
 )
 ;; assertion failed
 ...
 (assert
  (not (=>
    (ens%curve25519_dalek!lemmas.field_lemmas.reduce_lemmas.proof_reduce. raw_limbs!)
    (=>
     (= limbs@ (curve25519_dalek!specs.field_specs_u64.spec_reduce.? (Poly%array%. raw_limbs!)))
     (and
      (=>
       %%location_label%%0
       true
        ...
        (=>
         ...
         (and
          ...
          (=>
           ...
           (=>
            (= q_arr@ (curve25519_dalek!specs.field_specs_u64.compute_q_arr.? (Poly%array%. limbs@)))
            (=>
             (= q0@ (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64)
                  $ (CONST_INT 5)
                 ) (Poly%array%. q_arr@)
                ) (I 0)
             )))
             (=>
              (= q1@ (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64)
                   $ (CONST_INT 5)
                  ) (Poly%array%. q_arr@)
                 ) (I 1)
              )))
              (=>
               (= q2@ (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64)
                    $ (CONST_INT 5)
                   ) (Poly%array%. q_arr@)
                  ) (I 2)
               )))
               (=>
                (= q3@ (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64)
                     $ (CONST_INT 5)
                    ) (Poly%array%. q_arr@)
                   ) (I 3)
                )))
                (=>
                 (= q4@ (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64)
                      $ (CONST_INT 5)
                     ) (Poly%array%. q_arr@)
                    ) (I 4)
                 )))
                 (and
                  (=>
                   (= tmp%1 (uClip 64 (Add (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $
                         (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. limbs@)
                        ) (I 0)
                       )
                      ) 19
                   ...
                   (=>
                    (= tmp%2 (uClip 64 (Add (uClip 64 (bitshl (I 1) (I 52))) 19)))
                    (and
                     (=>
                      %%location_label%%3
                      (req%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u64_shr_le. tmp%1 tmp%2
                       51
                     ))
                     (=>
                      (ens%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u64_shr_le. tmp%1 tmp%2
                       51
                      )
                      (=>
                       %%location_label%%4
                  ...
                  (=>
                   ...
                   (and
                    (=>
                     (= tmp%3 (uClip 64 (Add (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $
                           (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. limbs@)
                          ) (I 1)
                         )
                        ) q0@
                     ...
                     (=>
                      (= tmp%4 (uClip 64 (Add (uClip 64 (bitshl (I 1) (I 52))) 2)))
                      (and
                       (=>
                        %%location_label%%5
                        (req%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u64_shr_le. tmp%3 tmp%4
                         51
                       ))
                       (=>
                        (ens%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u64_shr_le. tmp%3 tmp%4
                         51
                        )
                        (=>
                         %%location_label%%6
                    ...
                    (=>
                     ...
                     (and
                      (=>
                       ...
                       (=>
                        (= tmp%6 (uClip 64 (Add (uClip 64 (bitshl (I 1) (I 52))) 2)))
                        (and
                         (=>
                          %%location_label%%7
                          (req%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u64_shr_le. tmp%5 tmp%6
                           51
                         ))
                         (=>
                          (ens%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u64_shr_le. tmp%5 tmp%6
                           51
                          )
                          (=>
                           %%location_label%%8
                      ...
                      (=>
                       ...
                       (and
                        (=>
                         (= tmp%7 (uClip 64 (Add (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $
                               (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. limbs@)
                              ) (I 3)
                             )
                            ) q2@
                         ...
                         (=>
                          (= tmp%8 (uClip 64 (Add (uClip 64 (bitshl (I 1) (I 52))) 2)))
                          (and
                           (=>
                            %%location_label%%9
                            (req%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u64_shr_le. tmp%7 tmp%8
                             51
                           ))
                           (=>
                            (ens%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u64_shr_le. tmp%7 tmp%8
                             51
                            )
                            (=>
                             %%location_label%%10
                        ...
                        (=>
                         ...
                         (and
                          (=>
                           (= tmp%9 (uClip 64 (Add (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $
                                 (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. limbs@)
                                ) (I 4)
                               )
                              ) q3@
                           ...
                           (=>
                            (= tmp%10 (uClip 64 (Add (uClip 64 (bitshl (I 1) (I 52))) 2)))
                            (and
                             (=>
                              %%location_label%%11
                              (req%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u64_shr_le. tmp%9 tmp%10
                               51
                             ))
                             (=>
                              (ens%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u64_shr_le. tmp%9 tmp%10
                               51
                              )
                              (=>
                               %%location_label%%12
                                ...
                                (and
                                 (=>
                                  ...
                                  (forall ((i$ Poly)) (!
                                    ...
                                    :qid user_curve25519_dalek__lemmas__field_lemmas__as_bytes_lemmas__lemma_as_bytes_boundaries1_33
                                    :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__as_bytes_lemmas__lemma_as_bytes_boundaries1_33
                                 )))
                                 (and
                                  (=>
                                   %%location_label%%19
