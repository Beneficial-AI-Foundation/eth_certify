...
;; curve25519-dalek/src/lemmas/field_lemmas/load8_lemmas.rs:176:1: 176:73 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::load8_lemmas::lemma_load8_at_plus_version_is_spec
;; curve25519-dalek/src/lemmas/field_lemmas/load8_lemmas.rs:176:1: 176:73 (#0)
...
(push)
 ...
 (declare-const byte_val@ Int)
 (declare-const shift_bits@ Int)
 ...
 (assert
  (not (=>
    (= tmp%1 (= (curve25519_dalek!lemmas.field_lemmas.load8_lemmas.load8_at_plus_version_rec.?
           ...
           (=>
            ...
            (=>
             ...
             (= (uClip 64 (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $slice (SLICE
              ...
              ) (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 0 8)))) (%I (vstd!seq.Seq.index.?
                 $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $ (UINT 8)) (Poly%slice%<u8.>. input!))
                 (I (Add i! 0))
           ))))))
           (=>
                           ...
                           (and
                                   ...
                                   (=>
                                    ...
                                    (=>
                                     ...
                                     (<= (curve25519_dalek!lemmas.field_lemmas.load8_lemmas.load8_at_plus_version_rec.?
                                      ...
                                      ) (Sub (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 8 (%I j@))))) 1)
                                 )))))
                                 (=>
                                  (<= (curve25519_dalek!lemmas.field_lemmas.load8_lemmas.load8_at_plus_version_rec.?
                                    (Poly%slice%<u8.>. input!) (I i!) (I (nClip (Sub (%I j@) 1)))
                                  ...
                                  (and
                                   (=>
                                    (= byte_val@ (uClip 64 (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $slice
                                         (SLICE $ (UINT 8)) (Poly%slice%<u8.>. input!)
                                        ) (I (Add i! (%I j@)))
                                    ))))
                                    (=>
                                     (= shift_bits@ (uClip 64 (nClip (Mul (%I j@) 8))))
                                     (=>
                                      (ens%vstd!arithmetic.power2.lemma2_to64. 0)
                                      (and
                                       (=>
                                       ...
                                       (=>
                                        (<= (nClip (Mul 255 72057594037927936)) 18446744073709551615)
                                        (or
                                         (and
                                          (=>
                                           (< shift_bits@ 56)
                                           (and
                                            (=>
                                             %%location_label%%14
                                             (req%vstd!arithmetic.power2.lemma_pow2_strictly_increases. shift_bits@ 56)
                                            )
                                            (=>
                                             (ens%vstd!arithmetic.power2.lemma_pow2_strictly_increases. shift_bits@ 56)
                                             %%switch_label%%0
                                          )))
                                          (=>
                                           (not (< shift_bits@ 56))
                                         ...
                                         (and
                                          (not %%switch_label%%0)
                                          (=>
                                           (= tmp%3 (vstd!arithmetic.power2.pow2.? (I shift_bits@)))
                                           (=>
                                            (= tmp%4 (vstd!arithmetic.power2.pow2.? (I 56)))
                                            (and
                                             (=>
                                              %%location_label%%15
                                              (req%curve25519_dalek!lemmas.common_lemmas.mul_lemmas.lemma_mul_le. byte_val@ 255
                                               tmp%3 tmp%4
                                             ))
                                             (=>
                                              (ens%curve25519_dalek!lemmas.common_lemmas.mul_lemmas.lemma_mul_le. byte_val@ 255
                                               tmp%3 tmp%4
                                              )
                                              (and
                                               (=>
                                                %%location_label%%16
                                                (req%vstd!bits.lemma_u64_shl_is_mul. byte_val@ shift_bits@)
                                               )
                                               (=>
                                                (ens%vstd!bits.lemma_u64_shl_is_mul. byte_val@ shift_bits@)
                                                (=>
                                                 (= tmp%5 (vstd!arithmetic.power2.pow2.? (I (nClip (Mul (%I j@) 8)))))
                                                 (and
                                                  (=>
                                                   %%location_label%%17
                                                   (req%vstd!arithmetic.mul.lemma_mul_inequality. byte_val@ 255 tmp%5)
                                                  )
                                                  (=>
                                                   (ens%vstd!arithmetic.mul.lemma_mul_inequality. byte_val@ 255 tmp%5)
                                                   (=>
                                                    %%location_label%%18
                                                    (<= (uClip 64 (bitshl (I (uClip 64 (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.?
                                                            $slice (SLICE $ (UINT 8)) (Poly%slice%<u8.>. input!)
                                                     ...
                                                     ) (Mul 255 (vstd!arithmetic.power2.pow2.? (I (nClip (Mul (%I j@) 8)))))
                                   ))))))))))))))))))
                                   (=>
                                    (<= (uClip 64 (bitshl (I (uClip 64 (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.?
                                            $slice (SLICE $ (UINT 8)) (Poly%slice%<u8.>. input!)
                                    ...
                                    (and
                                     (=>
                                      (= tmp%6 (vstd!arithmetic.power2.pow2.? (I (nClip (Mul (%I j@) 8)))))
                                      (=>
                                       (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add. 1 255 tmp%6)
                                       (=>
                                        %%location_label%%19
                                        (<= (Add (curve25519_dalek!lemmas.field_lemmas.load8_lemmas.load8_at_plus_version_rec.?
                                         ...
                                         ) (Sub (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 8 (nClip (Add (%I j@) 1))))))
                                          1
                                     )))))
                                     (=>
                                      (<= (Add (curve25519_dalek!lemmas.field_lemmas.load8_lemmas.load8_at_plus_version_rec.?
                            ...
                            (=>
                             (forall ((j$ Poly)) (!
                               ...
                               :qid user_curve25519_dalek__lemmas__field_lemmas__load8_lemmas__lemma_load8_at_plus_version_is_spec_58
                               :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__load8_lemmas__lemma_load8_at_plus_version_is_spec_58
                             ))
                             (=>
                              %%location_label%%22
                              (= (curve25519_dalek!lemmas.field_lemmas.load8_lemmas.load8_at_plus_version_rec.? (
                               ...
                               ) (Add (Add (Add (Add (Add (Add (Add (uClip 64 (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.?
                                          $slice (SLICE $ (UINT 8)) (Poly%slice%<u8.>. input!)
                                         ) (I i!)
                                       ))
                                      ) (uClip 64 (bitshl (I (uClip 64 (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.?
