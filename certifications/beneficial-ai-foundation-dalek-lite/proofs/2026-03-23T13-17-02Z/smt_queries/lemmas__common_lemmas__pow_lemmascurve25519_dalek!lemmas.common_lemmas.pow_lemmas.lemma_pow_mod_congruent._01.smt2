...
;; curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:1151:1: 1151:69 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::pow_lemmas::lemma_pow_mod_congruent
;; curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:1151:1: 1151:69 (#0)
...
(push)
 ...
 (assert
  (not (and
    (=>
     %%location_label%%0
     (req%vstd!arithmetic.power.lemma_pow_mod_noop. a! n! m!)
    )
    (=>
     (ens%vstd!arithmetic.power.lemma_pow_mod_noop. a! n! m!)
     (and
      (=>
       %%location_label%%1
       (req%vstd!arithmetic.power.lemma_pow_mod_noop. b! n! m!)
      )
      (=>
       (ens%vstd!arithmetic.power.lemma_pow_mod_noop. b! n! m!)
       (=>
        %%location_label%%2
        (= (EucMod (vstd!arithmetic.power.pow.? (I a!) (I n!)) m!) (EucMod (vstd!arithmetic.power.pow.?
           (I b!) (I n!)
