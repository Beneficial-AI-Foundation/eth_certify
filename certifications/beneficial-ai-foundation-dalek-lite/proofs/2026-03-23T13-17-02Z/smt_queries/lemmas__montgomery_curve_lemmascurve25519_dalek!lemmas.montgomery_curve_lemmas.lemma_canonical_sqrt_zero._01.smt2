...
;; curve25519-dalek/src/lemmas/montgomery_curve_lemmas.rs:515:1: 515:41 (#0)
...
;; Function-Def curve25519_dalek::lemmas::montgomery_curve_lemmas::lemma_canonical_sqrt_zero
;; curve25519-dalek/src/lemmas/montgomery_curve_lemmas.rs:515:1: 515:41 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (ens%curve25519_dalek!lemmas.montgomery_curve_lemmas.lemma_field_sqrt_zero. 0)
    (=>
     (= s1@ (curve25519_dalek!specs.field_specs.field_sqrt.? (I 0)))
     (=>
      (= tmp%1 (= s1@ 0))
      (and
       (=>
       ...
       (=>
        ...
        (and
         (=>
          ...
          (=>
           (= tmp%2 (= (curve25519_dalek!specs.field_specs.field_neg.? (I 0)) (EucMod (nClip (Sub
                (curve25519_dalek!specs.field_specs_u64.p.? (I 0)) (EucMod 0 (curve25519_dalek!specs.field_specs_u64.p.?
                  (I 0)
               )))
              ) (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
           )))
         ...
         (=>
          (= (curve25519_dalek!specs.field_specs.field_neg.? (I 0)) 0)
          (=>
           (= tmp%4 (= (curve25519_dalek!specs.montgomery_specs.canonical_sqrt.? (I 0)) s1@))
           (and
            (=>
             %%location_label%%4
             tmp%4
