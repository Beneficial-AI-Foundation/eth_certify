...
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:693:9: 693:15 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::number_theory_lemmas::lemma_binomial_factorial_relation
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:693:9: 693:15 (#0)
...
(push)
 ...
 (declare-const nmk@ Int)
 (declare-const nmkm1@ Int)
 (declare-const ba@ Int)
 (declare-const bb@ Int)
 (declare-const fk@ Int)
 (declare-const fkm1@ Int)
 (declare-const fnmk@ Int)
 (declare-const fnmkm1@ Int)
 (declare-const fnm1@ Int)
 (declare-const ki@ Int)
 (declare-const nmki@ Int)
 (declare-const ni@ Int)
 ...
 (assert
  (not (=>
    (= (Mul (Mul ba@ fkm1@) fnmk@) fnm1@)
    (=>
     (= fk@ (Mul ki@ fkm1@))
     (=>
      %%location_label%%0
      (= (Mul (Mul ba@ fk@) fnmk@) (Mul ki@ fnm1@))
 )))))
 (get-info :version)
