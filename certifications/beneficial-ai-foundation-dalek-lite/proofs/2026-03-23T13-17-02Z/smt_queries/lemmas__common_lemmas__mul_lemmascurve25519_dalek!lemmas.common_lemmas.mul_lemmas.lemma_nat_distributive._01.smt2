...
;; curve25519-dalek/src/lemmas/common_lemmas/mul_lemmas.rs:54:1: 54:60 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::mul_lemmas::lemma_nat_distributive
;; curve25519-dalek/src/lemmas/common_lemmas/mul_lemmas.rs:54:1: 54:60 (#0)
...
(push)
 ...
 (assert
  (not (=>
    ...
    (=>
     %%location_label%%0
     (= (nClip (Mul (nClip (Add y! z!)) x!)) (nClip (Add (nClip (Mul y! x!)) (nClip (Mul z!
          x!
 )))))))))
 (get-info :version)
