...
;; curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:158:1: 158:66 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::pow_lemmas::lemma_pow2_mul_bound_general
;; curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:158:1: 158:66 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= tmp%1 (<= a! (Sub (vstd!arithmetic.power2.pow2.? (I s!)) 1)))
    (and
     (=>
      %%location_label%%0
      tmp%1
     ...
     (=>
      tmp%1
      (=>
       (= tmp%2 (nClip (Sub (vstd!arithmetic.power2.pow2.? (I s!)) 1)))
       (=>
        ...
        (=>
         ...
         (and
          (=>
           %%location_label%%1
           (req%curve25519_dalek!lemmas.common_lemmas.mul_lemmas.lemma_mul_le. a! tmp%2 tmp%3
            tmp%4
          ))
          (=>
           (ens%curve25519_dalek!lemmas.common_lemmas.mul_lemmas.lemma_mul_le. a! tmp%2 tmp%3
            tmp%4
           )
           (and
            (=>
             (= tmp%5 (vstd!arithmetic.power2.pow2.? (I k!)))
             (=>
              (= tmp%6 (vstd!arithmetic.power2.pow2.? (I s!)))
              (=>
               (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub. tmp%5 tmp%6 1)
               (=>
                (ens%vstd!arithmetic.power2.lemma_pow2_adds. k! s!)
                (=>
                 %%location_label%%2
                 (= (Mul (Sub (vstd!arithmetic.power2.pow2.? (I s!)) 1) (vstd!arithmetic.power2.pow2.?
                    (I k!)
                   )
                  ) (Sub (vstd!arithmetic.power2.pow2.? (I (nClip (Add k! s!)))) (vstd!arithmetic.power2.pow2.?
                    (I k!)
            ...
            (=>
             ...
             (=>
              (= tmp%7 (vstd!arithmetic.power2.pow2.? (I k!)))
              (=>
               (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. a! tmp%7)
               (and
                (=>
