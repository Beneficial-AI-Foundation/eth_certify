...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:513:1: 513:64 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_field_add_add_recover_double
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:513:1: 513:64 (#0)
     ...
     (=>
      ...
      (=>
       ...
       (=>
        (= bm@ (EucMod b! p@))
        (=>
         (= lhs@ (curve25519_dalek!specs.field_specs.field_add.? (I (curve25519_dalek!specs.field_specs.field_add.?
             (I a!) (I b!)
            )
           ) (I (curve25519_dalek!specs.field_specs.field_sub.? (I a!) (I b!)))
         ))
         (=>
          (= rhs@ (curve25519_dalek!specs.field_specs.field_mul.? (I 2) (I a!)))
          (=>
           (= rhs_simpl@ (curve25519_dalek!specs.field_specs.field_mul.? (I 2) (I am@)))
           (and
            (and
             (=>
              %%location_label%%0
              (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. 2 a! p_int@)
             )
             (=>
              (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. 2 a! p_int@)
              (=>
               %%location_label%%1
               (= rhs@ rhs_simpl@)
            )))
            (=>
             (= rhs@ rhs_simpl@)
             (=>
              (= tmp%1 (= rhs_simpl@ (EucMod (nClip (Mul 2 am@)) p@)))
              (and
               (=>
                %%location_label%%2
                tmp%1
                          ...
                          (=>
                           ...
                           (and
                            ...
                            (=>
                             tmp%4
                             (=>
                              (= tmp%5 (= lhs@ (EucMod (nClip (Add add_ab@ sub_ab@)) p@)))
                              (and
                               (=>
                                %%location_label%%8
                                tmp%5
                                ...
                                (=>
                                 ...
                                 (=>
                                  ...
                                  (and
                                   (=>
                                    %%location_label%%9
                                    (req%vstd!arithmetic.div_mod.lemma_add_mod_noop. A_int@ D_int@ p_int@)
                                   )
                                   (=>
                                    (ens%vstd!arithmetic.div_mod.lemma_add_mod_noop. A_int@ D_int@ p_int@)
                                    (=>
                                     (= tmp%6 (= (Add A_int@ D_int@) (Add (Mul 2 am@) p_int@)))
                                     (and
                                      (=>
                                       %%location_label%%10
                                       tmp%6
                                      ...
                                      (=>
                                       ...
                                       (=>
                                        ...
                                        (and
                                         (=>
                                          %%location_label%%11
                                          (req%vstd!arithmetic.div_mod.lemma_mod_add_multiples_vanish. tmp%7 p_int@)
                                         )
                                         (=>
                                          (ens%vstd!arithmetic.div_mod.lemma_mod_add_multiples_vanish. tmp%7 p_int@)
                                          (=>
                                           (= tmp%8 (= (EucMod (Add (Mul 2 am@) p_int@) p_int@) (EucMod (Mul 2 am@) p_int@)))
                                           (and
                                            (=>
                                             %%location_label%%12
                                             tmp%8
