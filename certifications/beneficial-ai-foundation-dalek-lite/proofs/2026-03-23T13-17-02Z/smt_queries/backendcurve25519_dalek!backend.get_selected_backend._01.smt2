...
;; curve25519-dalek/src/backend/mod.rs:71:1: 71:50 (#0)
...
;; Function-Def curve25519_dalek::backend::get_selected_backend
;; curve25519-dalek/src/backend/mod.rs:71:1: 71:50 (#0)
(get-info :all-statistics)
(push)
 (declare-const result! curve25519_dalek!backend.BackendKind.)
 ...
 (assert
  (not (=>
    (= result! curve25519_dalek!backend.BackendKind./Serial)
    (=>
     %%location_label%%0
     (is-curve25519_dalek!backend.BackendKind./Serial result!)
 ))))
 (get-info :version)
