...
;; curve25519-dalek/src/lemmas/scalar_byte_lemmas/scalar_to_bytes_lemmas.rs:275:1: 275:76 (#0)
...
;; Function-Def curve25519_dalek::lemmas::scalar_byte_lemmas::scalar_to_bytes_lemmas::lemma_sum_equals_byte_nat_52
;; curve25519-dalek/src/lemmas/scalar_byte_lemmas/scalar_to_bytes_lemmas.rs:275:1: 275:76 (#0)
...
(push)
 ...
 (assert
  (forall ((i$ Poly)) (!
    ...
    :qid user_curve25519_dalek__lemmas__scalar_byte_lemmas__scalar_to_bytes_lemmas__lemma_sum_equals_byte_nat_52_57
    :skolemid skolem_user_curve25519_dalek__lemmas__scalar_byte_lemmas__scalar_to_bytes_lemmas__lemma_sum_equals_byte_nat_52_57
 )))
 (assert
  (curve25519_dalek!lemmas.scalar_byte_lemmas.scalar_to_bytes_lemmas.bytes_match_limbs_packing_52.?
   (Poly%array%. limbs!) (Poly%array%. bytes!)
        ...
        (=>
         ...
         (=>
          ...
          (forall ((i$ Poly)) (!
            ...
            :qid user_curve25519_dalek__lemmas__scalar_byte_lemmas__scalar_to_bytes_lemmas__lemma_sum_equals_byte_nat_52_50
            :skolemid skolem_user_curve25519_dalek__lemmas__scalar_byte_lemmas__scalar_to_bytes_lemmas__lemma_sum_equals_byte_nat_52_50
       )))))
       (=>
        (forall ((i$ Poly)) (!
          (=>
          ...
          :qid user_curve25519_dalek__lemmas__scalar_byte_lemmas__scalar_to_bytes_lemmas__lemma_sum_equals_byte_nat_52_51
          :skolemid skolem_user_curve25519_dalek__lemmas__scalar_byte_lemmas__scalar_to_bytes_lemmas__lemma_sum_equals_byte_nat_52_51
        ))
        (=>
                  ...
                  (=>
                   ...
                   (and
                    ...
                    (=>
                     ...
                     (and
                      (=>
                       (= tmp%11 (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 19 8)))))
                       (=>
                       ...
                       (=>
                        ...
                        (and
                         ...
                         (=>
                          tmp%14
                          (=>
                           (= after_split@ (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip
                                         (Add (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip (
                                                          Add (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip (
                                                                          Add (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip (
                                                                                          Add (nClip (Add (nClip (Add (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.?
                           ...
                           (=>
                            (= tmp%15 (= (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (
                                    ARRAY $ (UINT 8) $ (CONST_INT 32)
                                   ) (Poly%array%. bytes!)
                                  ) (I 0)
                                 )
                            ...
                            (and
                             ...
                             (=>
                              tmp%15
                              (=>
                               (= tmp%16 (= after_split@ (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%.
                                   bytes!
                               ))))
                               (and
                                (=>
                                ...
                                (=>
                                 tmp%16
                                 (=>
                                  (= tmp%17 (= after_split@ (nClip (Add (nClip (Add (nClip (Add (nClip (Add (curve25519_dalek!lemmas.scalar_byte_lemmas.scalar_to_bytes_lemmas.limb0_byte_contribution_52.?
                                             (Poly%array%. limbs!) (Poly%array%. bytes!)
                                            ) (curve25519_dalek!lemmas.scalar_byte_lemmas.scalar_to_bytes_lemmas.limb1_byte_contribution_52.?
                                             (Poly%array%. limbs!) (Poly%array%. bytes!)
                                           ))
