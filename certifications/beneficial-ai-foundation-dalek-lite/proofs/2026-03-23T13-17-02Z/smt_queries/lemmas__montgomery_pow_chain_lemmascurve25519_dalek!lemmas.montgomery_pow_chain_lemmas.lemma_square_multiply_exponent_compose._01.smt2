...
;; curve25519-dalek/src/lemmas/montgomery_pow_chain_lemmas.rs:242:5: 242:11 (#0)
...
;; Function-Def curve25519_dalek::lemmas::montgomery_pow_chain_lemmas::lemma_square_multiply_exponent_compose
;; curve25519-dalek/src/lemmas/montgomery_pow_chain_lemmas.rs:242:5: 242:11 (#0)
(set-option :smt.arith.solver 6)
(get-info :all-statistics)
(push)
 (declare-const self_val! Int)
 (declare-const y_old! Int)
 (declare-const x_val! Int)
 (declare-const y_new! Int)
 ...
 (declare-const p2n@ Int)
 (declare-const new_exp@ Int)
 (declare-const new_exp_1@ Int)
 (declare-const ey_1@ Int)
 (declare-const ex_1@ Int)
 (declare-const R_p2n@ Int)
 (declare-const R_p2n_ey1@ Int)
 (declare-const R_ex1@ Int)
 (declare-const R_ey1@ Int)
 (declare-const lhs@ Int)
 (declare-const mid1@ Int)
 (declare-const y_old_p2n_x@ Int)
 (declare-const mid2@ Int)
 (declare-const part1@ Int)
 (declare-const part2@ Int)
 (declare-const y_R_ey1@ Int)
 (declare-const s_ey@ Int)
 (assert
  fuel_defaults
 )
 (assert
  ...
  (not (=>
    ...
    (=>
     ...
     (=>
      (>= ex! 1)
      (=>
       (= new_exp@ (nClip (Add (nClip (Mul p2n@ ey!)) ex!)))
       (=>
        (= new_exp_1@ (Sub new_exp@ 1))
        (=>
         (= ey_1@ (Sub ey! 1))
         (=>
          (= ex_1@ (Sub ex! 1))
          (=>
           %%location_label%%0
           (= new_exp_1@ (nClip (Add (nClip (Add p2n@ (nClip (Mul p2n@ ey_1@)))) ex_1@)))
 ))))))))))
 (get-info :version)
