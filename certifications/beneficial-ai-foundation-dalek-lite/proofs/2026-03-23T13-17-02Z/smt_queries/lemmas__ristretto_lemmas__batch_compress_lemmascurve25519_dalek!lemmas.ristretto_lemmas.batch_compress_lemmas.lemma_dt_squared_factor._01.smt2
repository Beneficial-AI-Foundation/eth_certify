...
;; curve25519-dalek/src/lemmas/ristretto_lemmas/batch_compress_lemmas.rs:128:1: 128:77 (#0)
...
;; Function-Def curve25519_dalek::lemmas::ristretto_lemmas::batch_compress_lemmas::lemma_dt_squared_factor
;; curve25519-dalek/src/lemmas/ristretto_lemmas/batch_compress_lemmas.rs:128:1: 128:77 (#0)
     ...
     (=>
      ...
      (and
       (=>
        ...
        (=>
         %%location_label%%0
         (= (curve25519_dalek!specs.field_specs.field_square.? (I t!)) (curve25519_dalek!specs.field_specs.field_mul.?
           (I (curve25519_dalek!specs.field_specs.field_square.? (I ab@))) (I z2@)
       ))))
       (=>
        (= (curve25519_dalek!specs.field_specs.field_square.? (I t!)) (curve25519_dalek!specs.field_specs.field_mul.?
          (I (curve25519_dalek!specs.field_specs.field_square.? (I ab@))) (I z2@)
        ...
        (and
         (=>
          ...
          (=>
           %%location_label%%1
           (= (curve25519_dalek!specs.field_specs.field_square.? (I ab@)) (curve25519_dalek!specs.field_specs.field_mul.?
             (I (curve25519_dalek!specs.field_specs.field_square.? (I a!))) (I (curve25519_dalek!specs.field_specs.field_square.?
               (I b!)
         ))))))
         (=>
