...
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_m1_lemmas.rs:484:7: 484:75 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::sqrt_m1_lemmas::lemma_q_times_i_eq_y
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_m1_lemmas.rs:484:7: 484:75 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= tmp%1 (nClip (Mul y! inv_i!)))
    (and
     (=>
      %%location_label%%0
      (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. tmp%1 i! pn!)
     )
     (=>
      (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. tmp%1 i! pn!)
      (=>
       (ens%vstd!arithmetic.mul.lemma_mul_is_associative. y! inv_i! i!)
       (and
        (=>
         (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. inv_i! i!)
         (and
          (=>
           %%location_label%%1
          ...
          (=>
           ...
           (=>
            %%location_label%%2
            (= (EucMod (nClip (Mul inv_i! i!)) pn!) 1)
        ))))
        (=>
         (= (EucMod (nClip (Mul inv_i! i!)) pn!) 1)
         (=>
          (= tmp%2 (nClip (Mul inv_i! i!)))
          (and
           (=>
            %%location_label%%3
            (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. y! tmp%2 pn!)
           )
           (=>
            (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. y! tmp%2 pn!)
            (=>
             (ens%vstd!arithmetic.mul.lemma_mul_basics. y!)
             (=>
              %%location_label%%4
              (= (EucMod (nClip (Mul q! i!)) pn!) (EucMod y! pn!))
 )))))))))))))
