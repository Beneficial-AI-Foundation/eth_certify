...
;; curve25519-dalek/src/lemmas/field_lemmas/batch_invert_lemmas.rs:78:13: 78:19 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::batch_invert_lemmas::lemma_nat_zero_implies_all_zero_bytes
;; curve25519-dalek/src/lemmas/field_lemmas/batch_invert_lemmas.rs:78:13: 78:19 (#0)
...
(push)
 ...
 (assert
  (not (=>
    ...
    (=>
     (>= (vstd!arithmetic.power2.pow2.? (I (nClip (Mul ku@ 8)))) 1)
     (=>
      %%location_label%%0
      (>= (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (
              UINT 8
             ) $ (CONST_INT 32)
            ) (Poly%array%. bytes!)
           ) k@
          )
         ) (vstd!arithmetic.power2.pow2.? (I (nClip (Mul ku@ 8))))
        )
       ) 1
 ))))))
 (get-info :version)
