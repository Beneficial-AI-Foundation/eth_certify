...
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:1803:1: 1803:73 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::number_theory_lemmas::lemma_product_of_multiples_mod_eq_factorial
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:1803:1: 1803:73 (#0)
...
(push)
 ...
 (declare-const n@ Int)
 (declare-const a_red@ Int)
 (declare-const product@ Int)
 (declare-const pow_a_red_n@ Int)
 (declare-const pow_a_n@ Int)
 (declare-const pow_a_n$1@ Int)
 (declare-const fact_n@ Int)
 (assert
  fuel_defaults
 )
 (assert
      ...
      (=>
       ...
       (=>
        (= tmp%1 (= (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.product_of_multiples.?
           (I a!) (I 1)
          ) (nClip (Mul (nClip (Mul 1 a!)) (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.product_of_multiples.?
             (I a!) (I 0)
        )))))
        (and
         (=>
         ...
         (=>
          tmp%1
          (=>
           (= tmp%2 (= (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.product_of_multiples.?
              (I a!) (I 0)
             ) 1
           ))
           (and
            ...
            (=>
             ...
             (and
              (=>
               (ens%vstd!arithmetic.mul.lemma_mul_basics. a!)
               (=>
                %%location_label%%2
                (= (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.product_of_multiples.?
                  (I a!) (I 1)
              ...
              (=>
               ...
               (and
                (=>
                 (= tmp%3 (= (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.factorial.?
                    (I 1)
                   ) (nClip (Mul 1 (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.factorial.?
                      (I 0)
                 )))))
                 (and
                  (=>
                  ...
                  (=>
                   tmp%3
                   (=>
                    (= tmp%4 (= (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.factorial.?
                       (I 0)
                      ) 1
                    ))
                    (and
                     ...
                     (=>
                      tmp%4
                      (=>
                       (ens%vstd!arithmetic.mul.lemma_mul_basics. 1)
                       (=>
                        %%location_label%%5
                        (= (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.factorial.? (I 1))
                         1
                )))))))))
                (=>
                 (= (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.factorial.? (I 1))
                 ...
                 (and
                  (=>
                   %%location_label%%6
                   (req%vstd!arithmetic.div_mod.lemma_mod_bound. a! 2)
                  )
                  (=>
                   (ens%vstd!arithmetic.div_mod.lemma_mod_bound. a! 2)
                   (and
                    (=>
                     %%location_label%%7
                     (req%vstd!arithmetic.div_mod.lemma_small_mod. 1 2)
                    )
                    (=>
                     (ens%vstd!arithmetic.div_mod.lemma_small_mod. 1 2)
                     (=>
                      %%location_label%%8
                      (= (EucMod (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.product_of_multiples.?
                         (I a!) (I (nClip (Sub p! 1)))
       ...
       (=>
        ...
        (and
         (and
          (=>
           %%location_label%%9
           (req%vstd!arithmetic.div_mod.lemma_mod_bound. a! p!)
          )
          (=>
           (ens%vstd!arithmetic.div_mod.lemma_mod_bound. a! p!)
           (=>
            %%location_label%%10
            (< a_red@ p!)
         )))
                 ...
                 (=>
                  ...
                  (and
                   ...
                   (=>
                    ...
                    (=>
                     %%location_label%%14
                     (= (vstd!arithmetic.power.pow.? (I a_red@) (I p!)) (Mul a_red@ (vstd!arithmetic.power.pow.?
                        (I a_red@) (I n@)
                ))))))))
                (=>
                 (= (vstd!arithmetic.power.pow.? (I a_red@) (I p!)) (Mul a_red@ (vstd!arithmetic.power.pow.?
                 ...
                 (and
                  (and
                   (=>
                    %%location_label%%15
                    (req%vstd!arithmetic.div_mod.lemma_small_mod. a_red@ p!)
                   )
                   (=>
                    (ens%vstd!arithmetic.div_mod.lemma_small_mod. a_red@ p!)
                    (=>
                     %%location_label%%16
                     (= (EucMod a_red@ p!) a_red@)
                  )))
                  (=>
                   (= (EucMod a_red@ p!) a_red@)
                   (=>
                    ...
                    (and
                     ...
                     (=>
                      ...
                      (and
                       (=>
                        %%location_label%%18
                        (req%vstd!arithmetic.power.lemma_pow_positive. a_red@ n@)
                       )
                       (=>
                        (ens%vstd!arithmetic.power.lemma_pow_positive. a_red@ n@)
                        (=>
                         (= tmp%8 (>= (vstd!arithmetic.power.pow.? (I a_red@) (I n@)) 1))
                         (and
                          (=>
                           %%location_label%%19
                           tmp%8
                          ...
                          (=>
                           tmp%8
                           (=>
                            (= tmp%9 (vstd!arithmetic.power.pow.? (I a_red@) (I n@)))
                            (=>
                             (ens%vstd!arithmetic.mul.lemma_mul_strictly_positive. a_red@ tmp%9)
                             (=>
                              (= product@ (Mul a_red@ (vstd!arithmetic.power.pow.? (I a_red@) (I n@))))
                              (=>
                               (= tmp%10 (> product@ 0))
                               (and
                                (=>
                                ...
                                (=>
                                 tmp%10
                                 (=>
                                  (= tmp%11 (= (EucMod (nClip product@) p!) a_red@))
                                  (and
                                   (=>
                                    %%location_label%%21
                                    tmp%11
                                    ...
                                    (=>
                                     ...
                                     (and
                                      ...
                                      (=>
                                       tmp%12
                                       (=>
                                        (= tmp%13 (= (EucMod (Mul a_red@ (vstd!arithmetic.power.pow.? (I a_red@) (I n@))) p!)
                                          a_red@
                                        ))
                                        (and
                                         (=>
                                          ...
                                          (and
                                           (and
                                            ...
                                            (=>
                                             ...
                                             (=>
                                              %%location_label%%25
                                              (>= (vstd!arithmetic.power.pow.? (I a_red@) (I n@)) 0)
                                           )))
                                           (=>
                                            (>= (vstd!arithmetic.power.pow.? (I a_red@) (I n@)) 0)
                                            (and
                                             ...
                                             (=>
                                              ...
                                              (and
                                               (=>
                                                %%location_label%%27
                                                (req%vstd!arithmetic.power.lemma_pow_mod_noop. a! n@ p!)
                                               )
                                               (=>
                                                (ens%vstd!arithmetic.power.lemma_pow_mod_noop. a! n@ p!)
                                                (and
                                                 (=>
                                                  %%location_label%%28
                                                  (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow_nonnegative. a! n@)
                                                 )
                                                 (=>
                                                  (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow_nonnegative. a! n@)
                                                  (=>
                                                   (= pow_a_red_n@ (vstd!arithmetic.power.pow.? (I a_red@) (I n@)))
                                                   (=>
                                                    (= pow_a_n@ (vstd!arithmetic.power.pow.? (I a!) (I n@)))
                                                    (=>
                                                     (= tmp%14 (= (EucMod pow_a_red_n@ p!) 1))
                                                     (and
                                                      (=>
                                                       %%location_label%%29
                                                       tmp%14
                                                       ...
                                                       (=>
                                                        ...
                                                        (and
                                                         ...
                                                         (=>
                                                          tmp%15
                                                          (=>
                                                           (= tmp%16 (= (EucMod (nClip (vstd!arithmetic.power.pow.? (I a!) (I n@))) p!) 1))
                                                           (and
                                                            (=>
                                                             %%location_label%%31
                                                             tmp%16
                                                            ...
                                                            (=>
                                                             tmp%16
                                                             (=>
                                                              (= pow_a_n$1@ (nClip (vstd!arithmetic.power.pow.? (I a!) (I n@))))
                                                              (=>
                                                               (= fact_n@ (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.factorial.?
                                                                 (I n@)
                                                               ))
                                                               (and
                                                                (=>
                                                                 (= tmp%17 (= (EucMod pow_a_n$1@ p!) 1))
                                                                 (and
                                                                  (=>
                                                                   %%location_label%%32
                                                                   tmp%17
                                                                  ...
                                                                  (=>
                                                                   ...
                                                                   (and
                                                                    (=>
                                                                     %%location_label%%33
                                                                     (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_general. pow_a_n$1@ fact_n@ p!)
                                                                    )
                                                                    (=>
                                                                     (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_general. pow_a_n$1@ fact_n@ p!)
                                                                     (=>
                                                                      (= tmp%18 (EucMod fact_n@ p!))
                                                                      (=>
                                                                       (ens%vstd!arithmetic.mul.lemma_mul_basics. tmp%18)
                                                                       (and
                                                                        (=>
                                                                         %%location_label%%34
                                                                         (req%vstd!arithmetic.div_mod.lemma_mod_bound. fact_n@ p!)
                                                                        )
                                                                        (=>
                                                                         (ens%vstd!arithmetic.div_mod.lemma_mod_bound. fact_n@ p!)
                                                                         (=>
                                                                          %%location_label%%35
                                                                          (= (EucMod (nClip (Mul pow_a_n$1@ fact_n@)) p!) (EucMod fact_n@ p!))
                                                                ))))))))))
                                                                (=>
                                                                 (= (EucMod (nClip (Mul pow_a_n$1@ fact_n@)) p!) (EucMod fact_n@ p!))
                                                                 (=>
