...
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_ratio_lemmas.rs:619:1: 623:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::sqrt_ratio_lemmas::lemma_negate_makes_nonnegative
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_ratio_lemmas.rs:619:1: 623:2 (#0)
(get-info :all-statistics)
(push)
 (declare-const r_before! curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const r_after! curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const is_neg! subtle!Choice.)
 ...
 (assert
  (has_type (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. r_before!)
   TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.
 ))
 (assert
  (has_type (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. r_after!)
   TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.
 ))
 (assert
  (curve25519_dalek!specs.field_specs.fe51_limbs_bounded.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
 ...
 (assert
  (not (=>
    ...
    (=>
     (= r_nat@ (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
        r_before!
     )))
     (=>
