...
;; curve25519-dalek/src/lemmas/montgomery_curve_lemmas.rs:303:1: 306:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::montgomery_curve_lemmas::lemma_projective_represents_implies_u_coordinate
;; curve25519-dalek/src/lemmas/montgomery_curve_lemmas.rs:303:1: 306:2 (#0)
(get-info :all-statistics)
(push)
 (declare-const P_proj! curve25519_dalek!montgomery.ProjectivePoint.)
 (declare-const P_aff! curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.)
 ...
 (assert
  (has_type (Poly%curve25519_dalek!montgomery.ProjectivePoint. P_proj!) TYPE%curve25519_dalek!montgomery.ProjectivePoint.)
 )
 (assert
  (has_type (Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine. P_aff!)
   TYPE%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.
 ))
 (assert
  (curve25519_dalek!specs.montgomery_specs.projective_represents_montgomery_or_infinity.?
 ...
 (assert
  (not (or
    (and
     (=>
      (is-curve25519_dalek!specs.montgomery_specs.MontgomeryAffine./Infinity P_aff!)
      (=>
       (= tmp%1 (= (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
           (curve25519_dalek!montgomery.ProjectivePoint./ProjectivePoint/W (%Poly%curve25519_dalek!montgomery.ProjectivePoint.
             (Poly%curve25519_dalek!montgomery.ProjectivePoint. P_proj!)
          )))
         ) 0
       ))
       (and
        ...
        (=>
         tmp%1
         (=>
          (= tmp%2 (= (curve25519_dalek!specs.montgomery_specs.projective_u_coordinate.? (Poly%curve25519_dalek!montgomery.ProjectivePoint.
              P_proj!
             )
            ) 0
          ))
          (and
           ...
           (=>
            tmp%2
            (=>
             (= tmp%3 (= (curve25519_dalek!specs.montgomery_specs.u_coordinate.? (Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.
                 P_aff!
                )
               ) 0
             ))
     ...
     (=>
      (not (is-curve25519_dalek!specs.montgomery_specs.MontgomeryAffine./Infinity P_aff!))
      (=>
       (= u@ (curve25519_dalek!specs.montgomery_specs.MontgomeryAffine./Finite/u (%Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.
          (Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine. P_aff!)
       )))
       (=>
        (= U@ (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
           (curve25519_dalek!montgomery.ProjectivePoint./ProjectivePoint/U (%Poly%curve25519_dalek!montgomery.ProjectivePoint.
         ...
         (=>
          ...
          (and
           ...
           (=>
            tmp%5
            (=>
             (= tmp%6 (= U@ (curve25519_dalek!specs.field_specs.field_mul.? (I u@) (I W@))))
             (and
              (=>
               %%location_label%%6
               tmp%6
              ...
              (=>
               ...
               (and
                (=>
                 (= W_raw@ (curve25519_dalek!specs.field_specs.fe51_as_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                    (curve25519_dalek!montgomery.ProjectivePoint./ProjectivePoint/W (%Poly%curve25519_dalek!montgomery.ProjectivePoint.
                      (Poly%curve25519_dalek!montgomery.ProjectivePoint. P_proj!)
                 )))))
                 (=>
                  (= tmp%7 (= W@ (EucMod W_raw@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))))
                  (and
                   (=>
                    %%location_label%%7
                    tmp%7
                     ...
                     (=>
                      ...
                      (=>
                       ...
                       (and
                        (=>
                         %%location_label%%8
                         (req%vstd!arithmetic.div_mod.lemma_mod_division_less_than_divisor. W_raw@ tmp%8)
                        )
                        (=>
                         (ens%vstd!arithmetic.div_mod.lemma_mod_division_less_than_divisor. W_raw@ tmp%8)
                         (=>
                          %%location_label%%9
                          (< (EucMod W_raw@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) (curve25519_dalek!specs.field_specs_u64.p.?
                            (I 0)
                     )))))))
                     (=>
                      (< (EucMod W_raw@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) (curve25519_dalek!specs.field_specs_u64.p.?
                      ...
                      (and
                       (=>
                        ...
                        (and
                         (=>
                          %%location_label%%10
                          (req%vstd!arithmetic.div_mod.lemma_small_mod. W@ tmp%9)
                         )
                         (=>
                          (ens%vstd!arithmetic.div_mod.lemma_small_mod. W@ tmp%9)
                          (=>
                           %%location_label%%11
                           (= (EucMod W@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) W@)
                       ))))
                       (=>
                        (= (EucMod W@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) W@)
                        (=>
                ...
                (=>
                 (not (= (EucMod W@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0))
                 (=>
                  (= tmp%10 (= (curve25519_dalek!specs.montgomery_specs.projective_u_coordinate.? (Poly%curve25519_dalek!montgomery.ProjectivePoint.
                      P_proj!
                     )
                    ) (curve25519_dalek!specs.field_specs.field_mul.? (I U@) (I (curve25519_dalek!specs.field_specs.field_inv.?
                       (I W@)
                  ...
                  (and
                   ...
                   (=>
                    tmp%10
                    (=>
                     (= tmp%11 (= (curve25519_dalek!specs.montgomery_specs.projective_u_coordinate.? (Poly%curve25519_dalek!montgomery.ProjectivePoint.
                         P_proj!
                        )
                       ) (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                          (I u@) (I W@)
                         )
                        ) (I (curve25519_dalek!specs.field_specs.field_inv.? (I W@)))
                     )))
                     (and
                      (=>
                       %%location_label%%14
                      ...
                      (=>
                       ...
                       (and
                        (=>
                         (= tmp%12 (curve25519_dalek!specs.field_specs.field_inv.? (I W@)))
                         (=>
                          (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_assoc.
                           u@ W@ tmp%12
                          )
                          (=>
                           ...
                           (= (curve25519_dalek!specs.montgomery_specs.projective_u_coordinate.? (Poly%curve25519_dalek!montgomery.ProjectivePoint.
                            ...
                            ) (curve25519_dalek!specs.field_specs.field_mul.? (I u@) (I (curve25519_dalek!specs.field_specs.field_mul.?
                               (I W@) (I (curve25519_dalek!specs.field_specs.field_inv.? (I W@)))
                        )))))))
                        (=>
                         (= (curve25519_dalek!specs.montgomery_specs.projective_u_coordinate.? (Poly%curve25519_dalek!montgomery.ProjectivePoint.
                            P_proj!
                         ...
                         (and
                          (and
                           ...
                           (=>
                            ...
                            (=>
                             (= tmp%13 (curve25519_dalek!specs.field_specs.field_inv.? (I W@)))
                             (=>
                              (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_comm.
                               tmp%13 W@
                              )
                              (=>
                               %%location_label%%17
                               (= (curve25519_dalek!specs.field_specs.field_mul.? (I W@) (I (curve25519_dalek!specs.field_specs.field_inv.?
                                   (I W@)
                                 ))
                                ) 1
                          ))))))
                          (=>
                           ...
                           (and
                            (=>
                             ...
                             (=>
                              %%location_label%%18
                              (= (curve25519_dalek!specs.field_specs.field_mul.? (I u@) (I 1)) (EucMod u@ (curve25519_dalek!specs.field_specs_u64.p.?
                                 (I 0)
                            )))))
                            (=>
                             (= (curve25519_dalek!specs.field_specs.field_mul.? (I u@) (I 1)) (EucMod u@ (curve25519_dalek!specs.field_specs_u64.p.?
                             ...
                             (=>
                              (= tmp%14 (= (curve25519_dalek!specs.montgomery_specs.projective_u_coordinate.? (Poly%curve25519_dalek!montgomery.ProjectivePoint.
                                  P_proj!
                                 )
                                ) (EucMod u@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                              ))
