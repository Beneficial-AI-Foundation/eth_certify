...
;; curve25519-dalek/src/lemmas/field_lemmas/compute_q_lemmas.rs:290:1: 290:45 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::compute_q_lemmas::lemma_carry_propagation_setup
;; curve25519-dalek/src/lemmas/field_lemmas/compute_q_lemmas.rs:290:1: 290:45 (#0)
      ...
      (and
       ...
       (=>
        ...
        (=>
         ...
         (and
          (=>
           (ens%vstd!arithmetic.power2.lemma_pow2_adds. 1 51)
           (=>
            %%location_label%%2
            (= (vstd!arithmetic.power2.pow2.? (I 52)) (nClip (Mul 2 (vstd!arithmetic.power2.pow2.?
                (I 51)
