...
;; curve25519-dalek/src/backend/serial/scalar_mul/pippenger.rs:247:9: 247:24 (#3442)
...
;; Function-Def curve25519_dalek::backend::serial::scalar_mul::pippenger::Pippenger::init_buckets
;; curve25519-dalek/src/backend/serial/scalar_mul/pippenger.rs:247:9: 247:24 (#3442)
(get-info :all-statistics)
(push)
 (declare-const buckets! alloc!vec.Vec<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>.)
 ...
 (assert
  (has_type tmp%1 (TYPE%alloc!vec.Vec. $ TYPE%curve25519_dalek!edwards.EdwardsPoint.
    $ ALLOCATOR_GLOBAL
 )))
 (assert
  (uInv SZ i@0)
 ...
 (assert
  (not (=>
    ...
    (=>
     (= (vstd!seq.Seq.len.? $ TYPE%curve25519_dalek!edwards.EdwardsPoint. (vstd!view.View.view.?
        $ (TYPE%alloc!vec.Vec. $ TYPE%curve25519_dalek!edwards.EdwardsPoint. $ ALLOCATOR_GLOBAL)
        (Poly%alloc!vec.Vec<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>. buckets@0)
       )
      ) i@0
     )
     (=>
      (forall ((k$ Poly)) (!
        ...
        :qid user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__init_buckets_54
        :skolemid skolem_user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__init_buckets_54
      ))
      (=>
       (forall ((k$ Poly)) (!
         (=>
         ...
         :qid user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__init_buckets_55
         :skolemid skolem_user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__init_buckets_55
       ))
       (=>
        (= decrease%init0%0 (Sub count! i@0))
        (=>
         (< i@0 count!)
         (=>
          ...
          (=>
           ...
           (and
            ...
            (=>
             ...
             (=>
              (ens%alloc!vec.impl&%1.push. $ TYPE%curve25519_dalek!edwards.EdwardsPoint. $ ALLOCATOR_GLOBAL
               (Poly%alloc!vec.Vec<curve25519_dalek!edwards.EdwardsPoint./allocator_global%.>. buckets@0)
                  ...
                  (and
                   ...
                   (and
                    ...
                    (and
                     ...
                     (=>
                      %%location_label%%6
                      (check_decrease_int (Sub count! i@1) decrease%init0%0 false)
 )))))))))))))))))))))
 (get-info :version)
