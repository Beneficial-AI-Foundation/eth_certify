...
;; curve25519-dalek/src/lemmas/scalar_lemmas_/radix16_lemmas.rs:160:7: 160:83 (#0)
...
;; Function-Def curve25519_dalek::lemmas::scalar_lemmas_::radix16_lemmas::lemma_nibbles_equal_bytes_prefix
;; curve25519-dalek/src/lemmas/scalar_lemmas_/radix16_lemmas.rs:160:7: 160:83 (#0)
(get-info :all-statistics)
(push)
 (declare-const output! vstd!seq.Seq<i8.>.)
 ...
 (declare-const tail_skip1@ vstd!seq.Seq<i8.>.)
 (declare-const tail_skip2@ vstd!seq.Seq<i8.>.)
 ...
 (assert
  (forall ((i$ Int)) (!
    ...
    :qid user_curve25519_dalek__lemmas__scalar_lemmas___radix16_lemmas__lemma_nibbles_equal_bytes_prefix_32
    :skolemid skolem_user_curve25519_dalek__lemmas__scalar_lemmas___radix16_lemmas__lemma_nibbles_equal_bytes_prefix_32
 )))
 (assert
  (forall ((i$ Poly)) (!
    (=>
    ...
    :pattern ((vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. output!) i$))
    :qid user_curve25519_dalek__lemmas__scalar_lemmas___radix16_lemmas__lemma_nibbles_equal_bytes_prefix_33
    :skolemid skolem_user_curve25519_dalek__lemmas__scalar_lemmas___radix16_lemmas__lemma_nibbles_equal_bytes_prefix_33
 )))
         ...
         (=>
          ...
          (=>
           (= tmp%2 (= (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.? (vstd!seq.Seq.subrange.?
               $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. output!) (I 0) (I 0)
              ) (I 4)
             ) 0
           ))
           (and
        ...
        (and
         (=>
          ...
          (check_decrease_int (let
            ((output!$0 output!) (bytes!$1 bytes!) (k!$2 km1@))
            k!$2
         ...
         (and
          ...
          (=>
           ...
           (=>
            ...
            (=>
             (= tmp%3 (= (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. prefix@)) (nClip
                (Mul 2 k!)
             )))
             (and
              (=>
                 ...
                 (=>
                  ...
                  (=>
                   (= tmp%5 (ext_eq false (TYPE%vstd!seq.Seq. $ (SINT 8)) (vstd!seq.Seq.subrange.? $ (SINT
                       8
                      ) (Poly%vstd!seq.Seq<i8.>. prefix@) (I 0) (I (nClip (Mul 2 km1@)))
                     ) (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. output!) (I 0) (I (nClip
                        (Mul 2 km1@)
                   )))))
                   (and
                    (=>
                    ...
                    (=>
                     ...
                     (=>
                      (= tail@ (%Poly%vstd!seq.Seq<i8.>. (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
                          prefix@
                         ) (I (nClip (Mul 2 km1@))) (I (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
                            prefix@
                      ))))))
                      (=>
                       (= tmp%6 (= (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. tail@)) 2))
                       (and
                        (=>
                         %%location_label%%7
                         tmp%6
                        ...
                        (=>
                         tmp%6
                         (=>
                          (= tmp%7 (= (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. tail@) (I 0))
                            (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. output!) (I (nClip (Mul 2 km1@))))
                          ))
                          (and
                           (=>
                            %%location_label%%8
                           ...
                           (=>
                            tmp%7
                            (=>
                             (= tmp%8 (= (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. tail@) (I 1))
                               (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. output!) (I (nClip (Add (nClip
                                    (Mul 2 km1@)
                                   ) 1
                             ))))))
                             (and
                              ...
                              (=>
                               tmp%8
                               (=>
                                (= tail_skip1@ (%Poly%vstd!seq.Seq<i8.>. (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
                                    tail@
                                   ) (I 1) (I (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. tail@)))
                                )))
                                (=>
                                 (= tail_skip2@ (%Poly%vstd!seq.Seq<i8.>. (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
                                     tail_skip1@
                                    ) (I 1) (I (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. tail_skip1@)))
                                 )))
                                 (=>
                                  (= tmp%9 (= (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. tail_skip1@)) 1))
                                  (and
                                   (=>
                                    %%location_label%%10
                                    tmp%9
                                   ...
                                   (=>
                                    tmp%9
                                    (=>
                                     (= tmp%10 (= (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. tail_skip1@)
                                        (I 0)
                                       ) (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. tail@) (I 1))
                                     ))
                                     (and
                                      (=>
                                       %%location_label%%11
                                      ...
                                      (=>
                                       tmp%10
                                       (=>
                                        (= tmp%11 (= (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. tail_skip2@))
                                          0
                                        ))
                                        (and
                                         (=>
                                         ...
                                         (=>
                                          tmp%11
                                          (=>
                                           (= tmp%12 (= (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.? (Poly%vstd!seq.Seq<i8.>.
                                               tail_skip2@
                                              ) (I 4)
                                             ) 0
                                           ))
                                           (and
                                            ...
                                            (=>
                                             tmp%12
                                             (=>
                                              (= tmp%13 (= (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.? (Poly%vstd!seq.Seq<i8.>.
                                                  tail_skip1@
                                                 ) (I 4)
                                                ) (Add (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. tail@) (I 1)))
                                                 (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 4)) 0))
                                              )))
                                              (and
                                               (=>
                                                %%location_label%%14
                                               ...
                                               (=>
                                                ...
                                                (and
                                                 (=>
                                                  (= tmp%14 (vstd!arithmetic.power2.pow2.? (I 4)))
                                                  (=>
                                                   (ens%vstd!arithmetic.mul.lemma_mul_basics. tmp%14)
                                                   (=>
                                                    %%location_label%%15
                                                    (= (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.? (Poly%vstd!seq.Seq<i8.>.
                                                       tail_skip1@
                                                      ) (I 4)
                                                     ) (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. tail@) (I 1)))
                                                 ))))
                                                 (=>
                                                  (= (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.? (Poly%vstd!seq.Seq<i8.>.
                                                     tail_skip1@
                                                  ...
                                                  (=>
                                                   (= tmp%15 (= (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.? (Poly%vstd!seq.Seq<i8.>.
                                                       tail@
                                                      ) (I 4)
                                                     ) (Add (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. tail@) (I 0)))
                                                      (Mul (vstd!arithmetic.power2.pow2.? (I 4)) (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
                                                          tail@
                                                         ) (I 1)
                                                   ))))))
                                                   (and
                                                    ...
                                                    (=>
                                                     ...
                                                     (and
                                                      ...
                                                      (=>
                                                       (= (vstd!arithmetic.power2.pow2.? (I 4)) 16)
                                                       (=>
                                                        (= tmp%16 (= (Add (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. output!)
                                                             (I (nClip (Mul 2 km1@)))
                                                            )
                                                           ) (Mul 16 (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. output!) (I (
                                                                nClip (Add (nClip (Mul 2 km1@)) 1)
                                                           )))))
                                                          ) (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes!) (I km1@)))
                                                        ))
                                                        (and
                                                         (=>
                                                          %%location_label%%18
                                                         ...
                                                         (=>
                                                          tmp%16
                                                          (=>
                                                           (= tmp%17 (= (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.? (Poly%vstd!seq.Seq<i8.>.
                                                               tail@
                                                              ) (I 4)
                                                             ) (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes!) (I km1@)))
                                                           ))
                                                           (and
                                                            ...
                                                            (=>
                                                             ...
                                                             (and
                                                              (=>
                                                               (ens%vstd!arithmetic.mul.lemma_mul_is_associative. 4 2 km1@)
                                                               (=>
                                                                %%location_label%%20
                                                                (= (nClip (Mul 4 (nClip (Mul 2 km1@)))) (nClip (Mul 8 km1@)))
                                                              ))
                                                              (=>
                                                               (= (nClip (Mul 4 (nClip (Mul 2 km1@)))) (nClip (Mul 8 km1@)))
                                                               %%switch_label%%0
