...
;; curve25519-dalek/src/lemmas/scalar_lemmas_/naf_lemmas.rs:489:1: 489:65 (#0)
...
;; Function-Def curve25519_dalek::lemmas::scalar_lemmas_::naf_lemmas::lemma_naf_high_bits_zero
;; curve25519-dalek/src/lemmas/scalar_lemmas_/naf_lemmas.rs:489:1: 489:65 (#0)
  ...
  (not (and
    (or
     (and
      (=>
       ...
       (and
        (=>
         %%location_label%%0
         (req%vstd!arithmetic.power2.lemma_pow2_strictly_increases. 255 pos!)
        )
        (=>
         (ens%vstd!arithmetic.power2.lemma_pow2_strictly_increases. 255 pos!)
         %%switch_label%%0
      )))
      (=>
       (not (> pos! 255))
     ...
     (and
      ...
      (=>
       %%location_label%%1
       (< scalar_val! (vstd!arithmetic.power2.pow2.? (I pos!)))
    )))
    (=>
     (< scalar_val! (vstd!arithmetic.power2.pow2.? (I pos!)))
     (and
      (=>
       ...
       (=>
        (= tmp%1 (vstd!arithmetic.power2.pow2.? (I pos!)))
        (and
         (=>
          %%location_label%%2
          (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod_converse. scalar_val! tmp%1
           0 scalar_val!
         ))
         (=>
          (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod_converse. scalar_val! tmp%1
           0 scalar_val!
          )
          (=>
           %%location_label%%3
