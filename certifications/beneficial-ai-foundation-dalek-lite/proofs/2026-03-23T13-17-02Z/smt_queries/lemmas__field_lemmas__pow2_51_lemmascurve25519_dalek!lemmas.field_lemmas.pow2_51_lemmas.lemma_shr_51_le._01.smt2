...
;; curve25519-dalek/src/lemmas/field_lemmas/pow2_51_lemmas.rs:52:1: 52:47 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::pow2_51_lemmas::lemma_shr_51_le
;; curve25519-dalek/src/lemmas/field_lemmas/pow2_51_lemmas.rs:52:1: 52:47 (#0)
  ...
  (not (=>
    ...
    (=>
     ...
     (and
      (=>
       %%location_label%%0
       (req%vstd!bits.lemma_u128_shr_is_div. a! 51)
      )
      (=>
       (ens%vstd!bits.lemma_u128_shr_is_div. a! 51)
       (and
        (=>
         %%location_label%%1
         (req%vstd!bits.lemma_u128_shr_is_div. b! 51)
        )
        (=>
         (ens%vstd!bits.lemma_u128_shr_is_div. b! 51)
         (and
          (=>
           %%location_label%%2
           (req%vstd!arithmetic.div_mod.lemma_div_is_ordered. a! b! 51)
          )
          (=>
           (ens%vstd!arithmetic.div_mod.lemma_div_is_ordered. a! b! 51)
           (=>
            %%location_label%%3
            (<= (uClip 128 (bitshr (I a!) (I 51))) (uClip 128 (bitshr (I b!) (I 51))))
 )))))))))))
