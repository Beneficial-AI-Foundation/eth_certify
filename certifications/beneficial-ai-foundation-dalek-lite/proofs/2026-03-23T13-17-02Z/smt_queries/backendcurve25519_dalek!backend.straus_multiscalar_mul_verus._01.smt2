...
;; curve25519-dalek/src/backend/mod.rs:313:1: 318:35 (#0)
...
(assert
 (distinct fuel%vstd!std_specs.option.impl&%0.arrow_0. fuel%vstd!std_specs.option.is_some.
  ...
  fuel%vstd!view.impl&%26.view. fuel%vstd!view.impl&%42.view. fuel%vstd!view.impl&%44.view.
  ...
  fuel%curve25519_dalek!specs.edwards_specs.edwards_point_as_affine. fuel%curve25519_dalek!specs.edwards_specs.edwards_add.
  fuel%curve25519_dalek!specs.edwards_specs.edwards_double. fuel%curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.
  ...
  fuel%curve25519_dalek!specs.iterator_specs.all_points_some. fuel%curve25519_dalek!specs.iterator_specs.unwrap_points.
  fuel%curve25519_dalek!specs.scalar_specs.scalar_as_nat. fuel%vstd!array.group_array_axioms.
...
(declare-datatypes ((core!option.Option. 0) (vstd!raw_ptr.PtrData. 0) (curve25519_dalek!backend.serial.u64.field.FieldElement51.
   ...
   0
  ) (curve25519_dalek!edwards.EdwardsPoint. 0) (curve25519_dalek!backend.BackendKind.
   0
  ...
  ) ((curve25519_dalek!backend.BackendKind./Serial)) ((tuple%0./tuple%0)) ((tuple%1./tuple%1
    (tuple%1./tuple%1/?0 Poly)
   )
  ) ((tuple%2./tuple%2 (tuple%2./tuple%2/?0 Poly) (tuple%2./tuple%2/?1 Poly))) ((tuple%4./tuple%4
...
(declare-const TYPE%curve25519_dalek!backend.BackendKind. Type)
...
(declare-fun Poly%curve25519_dalek!backend.BackendKind. (curve25519_dalek!backend.BackendKind.)
 Poly
)
(declare-fun %Poly%curve25519_dalek!backend.BackendKind. (Poly) curve25519_dalek!backend.BackendKind.)
...
(assert
 (forall ((x curve25519_dalek!backend.BackendKind.)) (!
   (= x (%Poly%curve25519_dalek!backend.BackendKind. (Poly%curve25519_dalek!backend.BackendKind.
      x
   )))
   :pattern ((Poly%curve25519_dalek!backend.BackendKind. x))
   :qid internal_curve25519_dalek__backend__BackendKind_box_axiom_definition
   :skolemid skolem_internal_curve25519_dalek__backend__BackendKind_box_axiom_definition
)))
(assert
 (forall ((x Poly)) (!
   (=>
    (has_type x TYPE%curve25519_dalek!backend.BackendKind.)
    (= x (Poly%curve25519_dalek!backend.BackendKind. (%Poly%curve25519_dalek!backend.BackendKind.
       x
   ))))
   :pattern ((has_type x TYPE%curve25519_dalek!backend.BackendKind.))
   :qid internal_curve25519_dalek__backend__BackendKind_unbox_axiom_definition
   :skolemid skolem_internal_curve25519_dalek__backend__BackendKind_unbox_axiom_definition
)))
(assert
 (forall ((x curve25519_dalek!backend.BackendKind.)) (!
   (has_type (Poly%curve25519_dalek!backend.BackendKind. x) TYPE%curve25519_dalek!backend.BackendKind.)
   :pattern ((has_type (Poly%curve25519_dalek!backend.BackendKind. x) TYPE%curve25519_dalek!backend.BackendKind.))
   :qid internal_curve25519_dalek__backend__BackendKind_has_type_always_definition
   :skolemid skolem_internal_curve25519_dalek__backend__BackendKind_has_type_always_definition
)))
(assert
 (forall ((x tuple%0.)) (!
...
(assert
 (forall ((closure%$ Poly) (Self%&. Dcr) (Self%& Type)) (!
   ...
   :qid user_core__clone__Clone__clone_22
   :skolemid skolem_user_core__clone__Clone__clone_22
)))
...
(assert
 (forall ((closure%$ Poly) (res$ Poly)) (!
   ...
   :qid user_core__clone__impls__impl&%6__clone_23
   :skolemid skolem_user_core__clone__impls__impl&%6__clone_23
)))
...
(assert
 (forall ((closure%$ Poly) (res$ Poly)) (!
   ...
   :qid user_core__clone__impls__impl&%9__clone_24
   :skolemid skolem_user_core__clone__impls__impl&%9__clone_24
)))
...
(assert
 (forall ((closure%$ Poly) (res$ Poly)) (!
   ...
   :qid user_core__clone__impls__impl&%5__clone_25
   :skolemid skolem_user_core__clone__impls__impl&%5__clone_25
)))
...
(assert
 (forall ((closure%$ Poly) (res$ Poly) (T&. Dcr) (T& Type)) (!
   ...
   :qid user_core__option__impl&%5__clone_33
   :skolemid skolem_user_core__option__impl&%5__clone_33
)))
...
(assert
 (forall ((closure%$ Poly) (res$ Poly) (T&. Dcr) (T& Type) (A&. Dcr) (A& Type)) (!
   ...
   :qid user_alloc__boxed__impl&%13__clone_34
   :skolemid skolem_user_alloc__boxed__impl&%13__clone_34
)))
  ...
  (forall ((points! Poly)) (!
    (= (curve25519_dalek!specs.iterator_specs.all_points_some.? points!) (forall ((i$ Poly))
      (!
       ...
       :qid user_curve25519_dalek__specs__iterator_specs__all_points_some_37
       :skolemid skolem_user_curve25519_dalek__specs__iterator_specs__all_points_some_37
    )))
...
(assert
 (forall ((closure%$ Poly) (%return$ Poly)) (!
   ...
   :qid user_curve25519_dalek__scalar__Scalar__clone_38
   :skolemid skolem_user_curve25519_dalek__scalar__Scalar__clone_38
)))
...
(assert
 (forall ((closure%$ Poly) (%return$ Poly)) (!
   ...
   :qid user_curve25519_dalek__edwards__EdwardsPoint__clone_39
   :skolemid skolem_user_curve25519_dalek__edwards__EdwardsPoint__clone_39
)))
...
;; Function-Specs curve25519_dalek::backend::get_selected_backend
(declare-fun ens%curve25519_dalek!backend.get_selected_backend. (Int curve25519_dalek!backend.BackendKind.)
 Bool
)
(assert
 (forall ((no%param Int) (result! curve25519_dalek!backend.BackendKind.)) (!
   (= (ens%curve25519_dalek!backend.get_selected_backend. no%param result!) (is-curve25519_dalek!backend.BackendKind./Serial
     result!
   ))
   :pattern ((ens%curve25519_dalek!backend.get_selected_backend. no%param result!))
   :qid internal_ens__curve25519_dalek!backend.get_selected_backend._definition
   :skolemid skolem_internal_ens__curve25519_dalek!backend.get_selected_backend._definition
)))
...
;; Function-Specs curve25519_dalek::backend::variable_base_mul
(declare-fun req%curve25519_dalek!backend.variable_base_mul. (curve25519_dalek!edwards.EdwardsPoint.
  curve25519_dalek!scalar.Scalar.
 ) Bool
)
...
(assert
 (forall ((point! curve25519_dalek!edwards.EdwardsPoint.) (scalar! curve25519_dalek!scalar.Scalar.))
  (!
   (= (req%curve25519_dalek!backend.variable_base_mul. point! scalar!) (and
     (=>
   ...
   :pattern ((req%curve25519_dalek!backend.variable_base_mul. point! scalar!))
   :qid internal_req__curve25519_dalek!backend.variable_base_mul._definition
   :skolemid skolem_internal_req__curve25519_dalek!backend.variable_base_mul._definition
)))
(declare-fun ens%curve25519_dalek!backend.variable_base_mul. (curve25519_dalek!edwards.EdwardsPoint.
  curve25519_dalek!scalar.Scalar. curve25519_dalek!edwards.EdwardsPoint.
 ) Bool
)
(assert
 (forall ((point! curve25519_dalek!edwards.EdwardsPoint.) (scalar! curve25519_dalek!scalar.Scalar.)
   ...
   (= (ens%curve25519_dalek!backend.variable_base_mul. point! scalar! result!) (and
     (has_type (Poly%curve25519_dalek!edwards.EdwardsPoint. result!) TYPE%curve25519_dalek!edwards.EdwardsPoint.)
     (curve25519_dalek!specs.edwards_specs.is_well_formed_edwards_point.? (Poly%curve25519_dalek!edwards.EdwardsPoint.
       result!
     ))
   ...
   :pattern ((ens%curve25519_dalek!backend.variable_base_mul. point! scalar! result!))
   :qid internal_ens__curve25519_dalek!backend.variable_base_mul._definition
   :skolemid skolem_internal_ens__curve25519_dalek!backend.variable_base_mul._definition
)))
...
(assert
 (forall ((closure%$ Poly) (%return$ Poly)) (!
   ...
   :qid user_curve25519_dalek__backend__serial__u64__field__FieldElement51__clone_40
   :skolemid skolem_user_curve25519_dalek__backend__serial__u64__field__FieldElement51__clone_40
)))
...
;; Function-Specs curve25519_dalek::backend::BackendKind::clone
(declare-fun ens%curve25519_dalek!backend.impl&%2.clone. (Poly Poly) Bool)
(assert
 (forall ((self! Poly) (%return! Poly)) (!
   (= (ens%curve25519_dalek!backend.impl&%2.clone. self! %return!) (and
     (ens%core!clone.Clone.clone. $ TYPE%curve25519_dalek!backend.BackendKind. self! %return!)
     (= %return! self!)
   ))
   :pattern ((ens%curve25519_dalek!backend.impl&%2.clone. self! %return!))
   :qid internal_ens__curve25519_dalek!backend.impl&__2.clone._definition
   :skolemid skolem_internal_ens__curve25519_dalek!backend.impl&__2.clone._definition
)))
(assert
 (forall ((closure%$ Poly) (%return$ Poly)) (!
   (=>
    (and
     (has_type closure%$ (TYPE%tuple%1. (REF $) TYPE%curve25519_dalek!backend.BackendKind.))
     (has_type %return$ TYPE%curve25519_dalek!backend.BackendKind.)
    )
    (=>
     (closure_ens (FNDEF%core!clone.Clone.clone. $ TYPE%curve25519_dalek!backend.BackendKind.)
      (DST (REF $)) (TYPE%tuple%1. (REF $) TYPE%curve25519_dalek!backend.BackendKind.)
      (F fndef_singleton) closure%$ %return$
     )
     (let
      ((self$ (%Poly%curve25519_dalek!backend.BackendKind. (tuple%1./tuple%1/0 (%Poly%tuple%1.
           closure%$
      )))))
      (= (%Poly%curve25519_dalek!backend.BackendKind. %return$) self$)
   )))
   :pattern ((closure_ens (FNDEF%core!clone.Clone.clone. $ TYPE%curve25519_dalek!backend.BackendKind.)
     (DST (REF $)) (TYPE%tuple%1. (REF $) TYPE%curve25519_dalek!backend.BackendKind.)
     (F fndef_singleton) closure%$ %return$
   ))
   :qid user_curve25519_dalek__backend__BackendKind__clone_41
   :skolemid skolem_user_curve25519_dalek__backend__BackendKind__clone_41
)))

;; Trait-Impl-Axiom
(assert
 (tr_bound%core!clone.Clone. $ TYPE%curve25519_dalek!backend.BackendKind.)
)
   ...
   (= (req%curve25519_dalek!backend.serial.scalar_mul.straus.impl&%2.optional_multiscalar_mul_verus.
     ...
     (=>
      ...
      (forall ((i$ Poly)) (!
        ...
        :qid user_curve25519_dalek__backend__serial__scalar_mul__straus__Straus__optional_multiscalar_mul_verus_42
        :skolemid skolem_user_curve25519_dalek__backend__serial__scalar_mul__straus__Straus__optional_multiscalar_mul_verus_42
   )))))
   ...
   (= (req%curve25519_dalek!backend.serial.scalar_mul.straus.impl&%2.multiscalar_mul_verus.
     ...
     (=>
      ...
      (forall ((i$ Poly)) (!
        ...
        :qid user_curve25519_dalek__backend__serial__scalar_mul__straus__Straus__multiscalar_mul_verus_43
        :skolemid skolem_user_curve25519_dalek__backend__serial__scalar_mul__straus__Straus__multiscalar_mul_verus_43
   )))))
   ...
   (= (req%curve25519_dalek!backend.serial.scalar_mul.pippenger.impl&%1.optional_multiscalar_mul_verus.
     ...
     (=>
      ...
      (forall ((i$ Poly)) (!
        ...
        :qid user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__optional_multiscalar_mul_verus_44
        :skolemid skolem_user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__optional_multiscalar_mul_verus_44
   )))))
...
;; Function-Specs curve25519_dalek::backend::vartime_double_base_mul
(declare-fun req%curve25519_dalek!backend.vartime_double_base_mul. (curve25519_dalek!scalar.Scalar.
  curve25519_dalek!edwards.EdwardsPoint. curve25519_dalek!scalar.Scalar.
 ) Bool
)
...
(assert
 (forall ((a! curve25519_dalek!scalar.Scalar.) (A! curve25519_dalek!edwards.EdwardsPoint.)
   ...
   (= (req%curve25519_dalek!backend.vartime_double_base_mul. a! A! b!) (and
     (=>
   ...
   :pattern ((req%curve25519_dalek!backend.vartime_double_base_mul. a! A! b!))
   :qid internal_req__curve25519_dalek!backend.vartime_double_base_mul._definition
   :skolemid skolem_internal_req__curve25519_dalek!backend.vartime_double_base_mul._definition
)))
(declare-fun ens%curve25519_dalek!backend.vartime_double_base_mul. (curve25519_dalek!scalar.Scalar.
  curve25519_dalek!edwards.EdwardsPoint. curve25519_dalek!scalar.Scalar. curve25519_dalek!edwards.EdwardsPoint.
 ) Bool
)
(assert
 (forall ((a! curve25519_dalek!scalar.Scalar.) (A! curve25519_dalek!edwards.EdwardsPoint.)
   (b! curve25519_dalek!scalar.Scalar.) (result! curve25519_dalek!edwards.EdwardsPoint.)
  ) (!
   (= (ens%curve25519_dalek!backend.vartime_double_base_mul. a! A! b! result!) (and
     (has_type (Poly%curve25519_dalek!edwards.EdwardsPoint. result!) TYPE%curve25519_dalek!edwards.EdwardsPoint.)
     (curve25519_dalek!specs.edwards_specs.is_well_formed_edwards_point.? (Poly%curve25519_dalek!edwards.EdwardsPoint.
       result!
     ))
   ...
   :pattern ((ens%curve25519_dalek!backend.vartime_double_base_mul. a! A! b! result!))
   :qid internal_ens__curve25519_dalek!backend.vartime_double_base_mul._definition
   :skolemid skolem_internal_ens__curve25519_dalek!backend.vartime_double_base_mul._definition
)))

;; Function-Specs curve25519_dalek::backend::straus_optional_multiscalar_mul_verus
(declare-fun req%curve25519_dalek!backend.straus_optional_multiscalar_mul_verus. (
...
(assert
 (forall ((S&. Dcr) (S& Type) (I&. Dcr) (I& Type) (J&. Dcr) (J& Type) (scalars! Poly)
   ...
   (= (req%curve25519_dalek!backend.straus_optional_multiscalar_mul_verus. S&. S& I&.
     I& J&. J& scalars! points!
    ) (and
     (=>
     ...
     (=>
      ...
      (forall ((i$ Poly)) (!
        ...
        :qid user_curve25519_dalek__backend__straus_optional_multiscalar_mul_verus_45
        :skolemid skolem_user_curve25519_dalek__backend__straus_optional_multiscalar_mul_verus_45
   )))))
   :pattern ((req%curve25519_dalek!backend.straus_optional_multiscalar_mul_verus. S&.
     S& I&. I& J&. J& scalars! points!
   ))
   :qid internal_req__curve25519_dalek!backend.straus_optional_multiscalar_mul_verus._definition
   :skolemid skolem_internal_req__curve25519_dalek!backend.straus_optional_multiscalar_mul_verus._definition
)))
(declare-fun ens%curve25519_dalek!backend.straus_optional_multiscalar_mul_verus. (
  Dcr Type Dcr Type Dcr Type Poly Poly core!option.Option.
 ) Bool
)
(assert
 (forall ((S&. Dcr) (S& Type) (I&. Dcr) (I& Type) (J&. Dcr) (J& Type) (scalars! Poly)
   ...
   (= (ens%curve25519_dalek!backend.straus_optional_multiscalar_mul_verus. S&. S& I&.
     I& J&. J& scalars! points! result!
    ) (and
     (has_type (Poly%core!option.Option. result!) (TYPE%core!option.Option. $ TYPE%curve25519_dalek!edwards.EdwardsPoint.))
     (= (is-core!option.Option./Some result!) (curve25519_dalek!specs.iterator_specs.all_points_some.?
       (Poly%vstd!seq.Seq<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>.>. (
   ...
   :pattern ((ens%curve25519_dalek!backend.straus_optional_multiscalar_mul_verus. S&.
     S& I&. I& J&. J& scalars! points! result!
   ))
   :qid internal_ens__curve25519_dalek!backend.straus_optional_multiscalar_mul_verus._definition
   :skolemid skolem_internal_ens__curve25519_dalek!backend.straus_optional_multiscalar_mul_verus._definition
)))

;; Function-Specs curve25519_dalek::backend::pippenger_optional_multiscalar_mul_verus
(declare-fun req%curve25519_dalek!backend.pippenger_optional_multiscalar_mul_verus.
 (Dcr Type Dcr Type Dcr Type Poly Poly) Bool
)
...
(assert
 (forall ((S&. Dcr) (S& Type) (I&. Dcr) (I& Type) (J&. Dcr) (J& Type) (scalars! Poly)
   ...
   (= (req%curve25519_dalek!backend.pippenger_optional_multiscalar_mul_verus. S&. S& I&.
     I& J&. J& scalars! points!
    ) (and
     (=>
     ...
     (=>
      ...
      (forall ((i$ Poly)) (!
        ...
        :qid user_curve25519_dalek__backend__pippenger_optional_multiscalar_mul_verus_47
        :skolemid skolem_user_curve25519_dalek__backend__pippenger_optional_multiscalar_mul_verus_47
   )))))
   :pattern ((req%curve25519_dalek!backend.pippenger_optional_multiscalar_mul_verus. S&.
     S& I&. I& J&. J& scalars! points!
   ))
   :qid internal_req__curve25519_dalek!backend.pippenger_optional_multiscalar_mul_verus._definition
   :skolemid skolem_internal_req__curve25519_dalek!backend.pippenger_optional_multiscalar_mul_verus._definition
)))
(declare-fun ens%curve25519_dalek!backend.pippenger_optional_multiscalar_mul_verus.
 (Dcr Type Dcr Type Dcr Type Poly Poly core!option.Option.) Bool
)
(assert
 (forall ((S&. Dcr) (S& Type) (I&. Dcr) (I& Type) (J&. Dcr) (J& Type) (scalars! Poly)
   ...
   (= (ens%curve25519_dalek!backend.pippenger_optional_multiscalar_mul_verus. S&. S& I&.
     I& J&. J& scalars! points! result!
    ) (and
     (has_type (Poly%core!option.Option. result!) (TYPE%core!option.Option. $ TYPE%curve25519_dalek!edwards.EdwardsPoint.))
     (= (is-core!option.Option./Some result!) (curve25519_dalek!specs.iterator_specs.all_points_some.?
   ...
   :pattern ((ens%curve25519_dalek!backend.pippenger_optional_multiscalar_mul_verus. S&.
     S& I&. I& J&. J& scalars! points! result!
   ))
   :qid internal_ens__curve25519_dalek!backend.pippenger_optional_multiscalar_mul_verus._definition
   :skolemid skolem_internal_ens__curve25519_dalek!backend.pippenger_optional_multiscalar_mul_verus._definition
)))

;; Function-Specs curve25519_dalek::backend::straus_multiscalar_mul_verus
(declare-fun req%curve25519_dalek!backend.straus_multiscalar_mul_verus. (Dcr Type Dcr
...
(assert
 (forall ((S&. Dcr) (S& Type) (P&. Dcr) (P& Type) (I&. Dcr) (I& Type) (J&. Dcr) (J& Type)
   ...
   (= (req%curve25519_dalek!backend.straus_multiscalar_mul_verus. S&. S& P&. P& I&. I&
     J&. J& scalars! points!
    ) (and
     (=>
     ...
     (=>
      ...
      (forall ((i$ Poly)) (!
        ...
        :qid user_curve25519_dalek__backend__straus_multiscalar_mul_verus_49
        :skolemid skolem_user_curve25519_dalek__backend__straus_multiscalar_mul_verus_49
   )))))
   :pattern ((req%curve25519_dalek!backend.straus_multiscalar_mul_verus. S&. S& P&. P&
     I&. I& J&. J& scalars! points!
   ))
   :qid internal_req__curve25519_dalek!backend.straus_multiscalar_mul_verus._definition
   :skolemid skolem_internal_req__curve25519_dalek!backend.straus_multiscalar_mul_verus._definition
)))
(declare-fun ens%curve25519_dalek!backend.straus_multiscalar_mul_verus. (Dcr Type Dcr
  Type Dcr Type Dcr Type Poly Poly curve25519_dalek!edwards.EdwardsPoint.
 ) Bool
)
(assert
 (forall ((S&. Dcr) (S& Type) (P&. Dcr) (P& Type) (I&. Dcr) (I& Type) (J&. Dcr) (J& Type)
   ...
   (= (ens%curve25519_dalek!backend.straus_multiscalar_mul_verus. S&. S& P&. P& I&. I&
     J&. J& scalars! points! result!
    ) (and
     (has_type (Poly%curve25519_dalek!edwards.EdwardsPoint. result!) TYPE%curve25519_dalek!edwards.EdwardsPoint.)
     (curve25519_dalek!specs.edwards_specs.is_well_formed_edwards_point.? (Poly%curve25519_dalek!edwards.EdwardsPoint.
       result!
   ...
   :pattern ((ens%curve25519_dalek!backend.straus_multiscalar_mul_verus. S&. S& P&. P&
     I&. I& J&. J& scalars! points! result!
   ))
   :qid internal_ens__curve25519_dalek!backend.straus_multiscalar_mul_verus._definition
   :skolemid skolem_internal_ens__curve25519_dalek!backend.straus_multiscalar_mul_verus._definition
)))

;; Function-Def curve25519_dalek::backend::straus_multiscalar_mul_verus
;; curve25519-dalek/src/backend/mod.rs:313:1: 318:35 (#0)
...
(push)
 ...
 (declare-const tmp%1 curve25519_dalek!edwards.EdwardsPoint.)
 (declare-const tmp%%@ curve25519_dalek!backend.BackendKind.)
 (assert
  fuel_defaults
 )
 (assert
 ...
 (assert
  (forall ((i$ Poly)) (!
    ...
    :qid user_curve25519_dalek__backend__straus_multiscalar_mul_verus_50
    :skolemid skolem_user_curve25519_dalek__backend__straus_multiscalar_mul_verus_50
 )))
 ...
 (assert
  (not (=>
    (ens%curve25519_dalek!backend.get_selected_backend. 0 tmp%%@)
    (and
     (=>
      %%location_label%%0
      (req%curve25519_dalek!backend.serial.scalar_mul.straus.impl&%2.multiscalar_mul_verus.
     ...
     (=>
      (ens%curve25519_dalek!backend.serial.scalar_mul.straus.impl&%2.multiscalar_mul_verus.
       S&. S& P&. P& I&. I& J&. J& scalars! points! tmp%1
      )
      (=>
       (= result! tmp%1)
       (and
