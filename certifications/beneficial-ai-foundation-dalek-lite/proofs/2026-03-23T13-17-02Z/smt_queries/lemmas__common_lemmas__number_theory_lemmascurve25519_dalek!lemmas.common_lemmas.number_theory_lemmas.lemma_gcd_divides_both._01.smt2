...
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:79:1: 79:52 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::number_theory_lemmas::lemma_gcd_divides_both
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:79:1: 79:52 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= decrease%init0 b!)
    (=>
     (= g@ (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.spec_gcd.? (I a!)
       (I b!)
     ))
     (or
      (and
         ...
         (and
          (=>
           ...
           (and
            (=>
             %%location_label%%0
             (req%vstd!arithmetic.div_mod.lemma_mod_self_0. a!)
            )
            (=>
             (ens%vstd!arithmetic.div_mod.lemma_mod_self_0. a!)
             %%switch_label%%1
          )))
          (=>
           (not (> a! 0))
                  ...
                  (=>
                   ...
                   (and
                    (=>
                     (= tmp%2 (EucDiv a! b!))
                     (=>
                      (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. tmp%2 b!)
                      (=>
                       %%location_label%%4
                       (= (nClip (Add r@ (nClip (Mul (EucDiv a! b!) b!)))) a!)
                    )))
                    (=>
                     (= (nClip (Add r@ (nClip (Mul (EucDiv a! b!) b!)))) a!)
                     %%switch_label%%2
