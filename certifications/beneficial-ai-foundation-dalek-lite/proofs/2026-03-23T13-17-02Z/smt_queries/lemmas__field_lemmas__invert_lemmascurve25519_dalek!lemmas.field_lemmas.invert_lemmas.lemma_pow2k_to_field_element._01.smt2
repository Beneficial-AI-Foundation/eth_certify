...
;; curve25519-dalek/src/lemmas/field_lemmas/invert_lemmas.rs:32:1: 32:96 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::invert_lemmas::lemma_pow2k_to_field_element
;; curve25519-dalek/src/lemmas/field_lemmas/invert_lemmas.rs:32:1: 32:96 (#0)
 ...
 (assert
  (not (and
    ...
    (=>
     (> (curve25519_dalek!specs.field_specs_u64.p.? (I 0)) 0)
     (=>
      (= tmp%1 (= (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
          result!
         )
        ) (EucMod (nClip (vstd!arithmetic.power.pow.? (I (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.?
             (Poly%array%. (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
         ...
         (=>
          ...
          (=>
           ...
           (and
            (=>
             %%location_label%%2
             (req%vstd!arithmetic.power.lemma_pow_mod_noop. tmp%2 k! tmp%3)
            )
            (=>
             (ens%vstd!arithmetic.power.lemma_pow_mod_noop. tmp%2 k! tmp%3)
             (=>
              %%location_label%%3
              (= (EucMod (vstd!arithmetic.power.pow.? (I (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.?
                   (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
                  )
                 ) (I k!)
                ) (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
               ) (EucMod (vstd!arithmetic.power.pow.? (I (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.?
                   (Poly%array%. (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
                     (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                       fe!
                  )))))
          ...
          (and
           (=>
            ...
            (and
             (=>
              %%location_label%%4
              (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow_nonnegative. tmp%4
               k!
             ))
             (=>
              (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow_nonnegative. tmp%4
               k!
              )
              (=>
               %%location_label%%5
            ...
            (and
             (=>
              ...
              (and
               (=>
                %%location_label%%6
                (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow_nonnegative. tmp%5
                 k!
               ))
               (=>
                (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow_nonnegative. tmp%5
                 k!
                )
                (=>
                 %%location_label%%7
                 (>= (vstd!arithmetic.power.pow.? (I (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.?
                     (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
                    )
                   ) (I k!)
                  ) 0
