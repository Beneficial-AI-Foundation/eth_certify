...
;; curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:1032:1: 1032:76 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::pow_lemmas::lemma_modular_bit_partitioning
;; curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:1032:1: 1032:76 (#0)
    ...
    (and
     ...
     (=>
      ...
      (=>
       ...
       (= (EucMod (nClip (Add a! (nClip (Mul b! (vstd!arithmetic.power2.pow2.? (I k!))))))
         (vstd!arithmetic.power2.pow2.? (I n!))
        ) (nClip (Add (EucMod a! (vstd!arithmetic.power2.pow2.? (I n!))) (EucMod (nClip (Mul b!
             (vstd!arithmetic.power2.pow2.? (I k!))
            )
           ) (vstd!arithmetic.power2.pow2.? (I n!))
    )))))))
    (=>
     ...
     (and
      (and
       (=>
        %%location_label%%2
        (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_mul_mod. b! k! n!)
       )
       (=>
        (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_mul_mod. b! k! n!)
        (=>
         %%location_label%%3
         (= (EucMod (nClip (Mul b! (vstd!arithmetic.power2.pow2.? (I k!)))) (vstd!arithmetic.power2.pow2.?
            (I n!)
           )
          ) (nClip (Mul (EucMod b! (vstd!arithmetic.power2.pow2.? (I (nClip (Sub n! k!))))) (
             vstd!arithmetic.power2.pow2.? (I k!)
      )))))))
      (=>
       (= (EucMod (nClip (Mul b! (vstd!arithmetic.power2.pow2.? (I k!)))) (vstd!arithmetic.power2.pow2.?
        ...
        (and
         (or
          (and
           (=>
            ...
            (and
             (=>
              %%location_label%%4
              (req%vstd!arithmetic.power2.lemma_pow2_strictly_increases. k! n!)
             )
             (=>
              (ens%vstd!arithmetic.power2.lemma_pow2_strictly_increases. k! n!)
              %%switch_label%%0
           )))
           (=>
            (not (< k! n!))
          ...
          (and
           ...
           (=>
            %%location_label%%5
            (<= (vstd!arithmetic.power2.pow2.? (I k!)) (vstd!arithmetic.power2.pow2.? (I n!)))
         )))
         (=>
          (<= (vstd!arithmetic.power2.pow2.? (I k!)) (vstd!arithmetic.power2.pow2.? (I n!)))
          (=>
               ...
               (=>
                ...
                (=>
                 ...
                 (let
                  ((tmp%%$ a!))
                  (and
                   (= (EucMod a! (vstd!arithmetic.power2.pow2.? (I k!))) tmp%%$)
                   (= tmp%%$ (EucMod a! (vstd!arithmetic.power2.pow2.? (I n!))))
        )))))))))))
        (=>
         (let
          ((tmp%%$ a!))
