...
;; curve25519-dalek/src/lemmas/field_lemmas/limbs_to_bytes_lemmas.rs:2069:7: 2069:69 (#0)
...
;; Function-Specs curve25519_dalek::lemmas::field_lemmas::limbs_to_bytes_lemmas::lemma_sum_equals_byte_nat
(declare-fun req%curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.lemma_sum_equals_byte_nat.
 (%%Function%% %%Function%%) Bool
)
...
(assert
 (forall ((limbs! %%Function%%) (bytes! %%Function%%)) (!
   (= (req%curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.lemma_sum_equals_byte_nat.
     limbs! bytes!
    ) (and
     (=>
      ...
      (forall ((i$ Poly)) (!
        ...
        :qid user_curve25519_dalek__lemmas__field_lemmas__limbs_to_bytes_lemmas__lemma_sum_equals_byte_nat_114
        :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__limbs_to_bytes_lemmas__lemma_sum_equals_byte_nat_114
     )))
     (=>
   ...
   :pattern ((req%curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.lemma_sum_equals_byte_nat.
     limbs! bytes!
   ))
   :qid internal_req__curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.lemma_sum_equals_byte_nat._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.lemma_sum_equals_byte_nat._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.lemma_sum_equals_byte_nat.
 (%%Function%% %%Function%%) Bool
)
(assert
 (forall ((limbs! %%Function%%) (bytes! %%Function%%)) (!
   (= (ens%curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.lemma_sum_equals_byte_nat.
     limbs! bytes!
    ) (= (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. bytes!)) (nClip
      (Add (nClip (Add (nClip (Add (nClip (Add (curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.limb0_byte_contribution.?
              (Poly%array%. limbs!) (Poly%array%. bytes!)
             ) (curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.limb1_byte_contribution.?
              (Poly%array%. limbs!) (Poly%array%. bytes!)
            ))
   ...
   :pattern ((ens%curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.lemma_sum_equals_byte_nat.
     limbs! bytes!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.lemma_sum_equals_byte_nat._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.lemma_sum_equals_byte_nat._definition
)))

;; Function-Def curve25519_dalek::lemmas::field_lemmas::limbs_to_bytes_lemmas::lemma_sum_equals_byte_nat
;; curve25519-dalek/src/lemmas/field_lemmas/limbs_to_bytes_lemmas.rs:2069:7: 2069:69 (#0)
...
(push)
 ...
 (declare-const byte6_low@ Int)
 (declare-const byte6_high@ Int)
 (declare-const byte12_low@ Int)
 (declare-const byte12_high@ Int)
 (declare-const byte19_low@ Int)
 (declare-const byte19_high@ Int)
 (declare-const byte25_low@ Int)
 (declare-const byte25_high@ Int)
 (declare-const after_split_25_pow2_first@ Int)
 (assert
  fuel_defaults
 )
 (assert
 ...
 (assert
  (forall ((i$ Poly)) (!
    ...
    :qid user_curve25519_dalek__lemmas__field_lemmas__limbs_to_bytes_lemmas__lemma_sum_equals_byte_nat_123
    :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__limbs_to_bytes_lemmas__lemma_sum_equals_byte_nat_123
 )))
 (assert
  (curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.bytes_match_limbs_packing.?
   (Poly%array%. limbs!) (Poly%array%. bytes!)
 ...
 (assert
  (not (=>
    ...
    (=>
     (= byte6_low@ (nClip (Mul (EucMod (EucDiv (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
     ...
     (=>
      (= byte6_high@ (nClip (Mul (nClip (Mul (EucMod (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
               $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. limbs!)
              ) (I 1)
             )
            ) (vstd!arithmetic.power2.pow2.? (I 5))
      ...
      (=>
       (= byte12_low@ (nClip (Mul (EucMod (EucDiv (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
               $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. limbs!)
              ) (I 1)
             )
            ) (vstd!arithmetic.power2.pow2.? (I 45))
       ...
       (=>
        (= byte12_high@ (nClip (Mul (nClip (Mul (EucMod (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                 $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. limbs!)
                ) (I 2)
               )
              ) (vstd!arithmetic.power2.pow2.? (I 2))
        ...
        (=>
         (= byte19_low@ (nClip (Mul (EucMod (EucDiv (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                 $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. limbs!)
                ) (I 2)
               )
              ) (vstd!arithmetic.power2.pow2.? (I 50))
         ...
         (=>
          (= byte19_high@ (nClip (Mul (nClip (Mul (EucMod (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                   $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. limbs!)
                  ) (I 3)
                 )
                ) (vstd!arithmetic.power2.pow2.? (I 7))
          ...
          (=>
           (= byte25_low@ (nClip (Mul (EucMod (EucDiv (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                   $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. limbs!)
                  ) (I 3)
                 )
                ) (vstd!arithmetic.power2.pow2.? (I 47))
           ...
           (=>
            (= byte25_high@ (nClip (Mul (nClip (Mul (EucMod (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                     $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. limbs!)
                    ) (I 4)
                   )
                  ) (vstd!arithmetic.power2.pow2.? (I 4))
            ...
            (and
                 ...
                 (=>
                  ...
                  (=>
                   ...
                   (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (
                    ...
                    ) (nClip (Add (EucMod (EucDiv (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                           $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. limbs!)
                          ) (I 0)
                         )
                        ) (vstd!arithmetic.power2.pow2.? (I 48))
             ...
             (=>
              ...
              (and
               (=>
                (= tmp%4 (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 6 8)))))
                (=>
                 (= tmp%5 (EucMod (EucDiv (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $
                       (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. limbs!)
                      ) (I 0)
                     )
                    ) (vstd!arithmetic.power2.pow2.? (I 48))
                 ...
                 (=>
                  (= tmp%6 (nClip (Mul (EucMod (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                         $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. limbs!)
                        ) (I 1)
                       )
                      ) (vstd!arithmetic.power2.pow2.? (I 5))
                  ...
                  (=>
                   (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. tmp%4 tmp%5 tmp%6)
                   (=>
                    %%location_label%%2
                    (= (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT
                            8
                     ...
                     ) (nClip (Add (nClip (Mul (EucMod (EucDiv (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                              $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. limbs!)
                             ) (I 0)
                            )
                           ) (vstd!arithmetic.power2.pow2.? (I 48))
               ...
               (=>
                ...
                (=>
                 (= tmp%7 (= (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY
                         $ (UINT 8) $ (CONST_INT 32)
                        ) (Poly%array%. bytes!)
                       ) (I 6)
                      )
                   ...
                   ) (nClip (Add byte6_low@ byte6_high@))
                 ))
                 (and
                  (=>
                   %%location_label%%3
                  ...
                  (=>
                   ...
                   (and
                    ...
                    (=>
                     ...
                     (and
                      (=>
                       (= tmp%11 (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 12 8)))))
                       (=>
                        (= tmp%12 (EucMod (EucDiv (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                              $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. limbs!)
                             ) (I 1)
                            )
                           ) (vstd!arithmetic.power2.pow2.? (I 45))
                        ...
                        (=>
                         (= tmp%13 (nClip (Mul (EucMod (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                                $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. limbs!)
                               ) (I 2)
                              )
                             ) (vstd!arithmetic.power2.pow2.? (I 2))
                         ...
                         (=>
                          (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. tmp%11 tmp%12 tmp%13)
                          (=>
                           %%location_label%%6
                           (= (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT
                                   8
                      ...
                      (=>
                       ...
                       (=>
                        (= tmp%14 (= (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (
                          ...
                          ) (nClip (Add byte12_low@ byte12_high@))
                        ))
                        (and
                         (=>
                          %%location_label%%7
                         ...
                         (=>
                          ...
                          (and
                           ...
                           (=>
                            ...
                            (and
                             (=>
                              (= tmp%18 (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 19 8)))))
                              (=>
                               (= tmp%19 (EucMod (EucDiv (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                                     $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. limbs!)
                                    ) (I 2)
                                   )
                                  ) (vstd!arithmetic.power2.pow2.? (I 50))
                               ...
                               (=>
                                (= tmp%20 (nClip (Mul (EucMod (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                                       $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. limbs!)
                                      ) (I 3)
                                     )
                                    ) (vstd!arithmetic.power2.pow2.? (I 7))
                                ...
                                (=>
                                 (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. tmp%18 tmp%19 tmp%20)
                                 (=>
                                  %%location_label%%10
                                  (= (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT
                                          8
                             ...
                             (=>
                              ...
                              (=>
                               (= tmp%21 (= (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (
                                       ARRAY $ (UINT 8) $ (CONST_INT 32)
                                      ) (Poly%array%. bytes!)
                                     ) (I 19)
                                    )
                                 ...
                                 ) (nClip (Add byte19_low@ byte19_high@))
                               ))
                               (and
                                (=>
                                 %%location_label%%11
                                ...
                                (=>
                                 ...
                                 (and
                                  ...
                                  (=>
                                   ...
                                   (and
                                    (=>
                                     (= tmp%25 (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 25 8)))))
                                     (=>
                                      (= tmp%26 (EucMod (EucDiv (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                                            $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. limbs!)
                                           ) (I 3)
                                          )
                                         ) (vstd!arithmetic.power2.pow2.? (I 47))
                                      ...
                                      (=>
                                       (= tmp%27 (nClip (Mul (EucMod (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                                              $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. limbs!)
                                             ) (I 4)
                                            )
                                           ) (vstd!arithmetic.power2.pow2.? (I 4))
                                       ...
                                       (=>
                                        (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add_other_way. tmp%25 tmp%26 tmp%27)
                                        (=>
                                         %%location_label%%14
                                         (= (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT
                                                 8
                                    ...
                                    (=>
                                     ...
                                     (=>
                                      (= tmp%28 (= (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (
                                              ARRAY $ (UINT 8) $ (CONST_INT 32)
                                             ) (Poly%array%. bytes!)
                                            ) (I 25)
                                           )
                                        ...
                                        ) (nClip (Add byte25_low@ byte25_high@))
                                      ))
                                      (and
                                       (=>
                                        %%location_label%%15
                                       ...
                                       (=>
                                        tmp%28
                                        (=>
                                         (= after_split_25_pow2_first@ (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip
                                                     (Add (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip (
                                                                      Add (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip (
                                                                                      Add (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip (
                                                                                                      Add (nClip (Add (nClip (Add (nClip (Add (nClip (Add (nClip (Add (%I (vstd!seq.Seq.index.? $ (
                                                                                                                   UINT 8
                                         ...
                                         (=>
                                          (= tmp%29 (= after_split_25_pow2_first@ (curve25519_dalek!specs.core_specs.u8_32_as_nat.?
                                             (Poly%array%. bytes!)
                                          )))
                                          (and
                                           (=>
                                           ...
                                           (=>
                                            tmp%29
                                            (=>
                                             (= tmp%30 (= (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (
                                                     ARRAY $ (UINT 8) $ (CONST_INT 32)
                                                    ) (Poly%array%. bytes!)
                                                   ) (I 0)
                                                  )
                                             ...
                                             (and
                                              ...
                                              (=>
                                               tmp%30
                                               (=>
                                                (= tmp%31 (= after_split_25_pow2_first@ (nClip (Add (nClip (Add (nClip (Add (nClip (Add (curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.limb0_byte_contribution.?
                                                           (Poly%array%. limbs!) (Poly%array%. bytes!)
                                                          ) (curve25519_dalek!lemmas.field_lemmas.limbs_to_bytes_lemmas.limb1_byte_contribution.?
                                                           (Poly%array%. limbs!) (Poly%array%. bytes!)
                                                         ))
