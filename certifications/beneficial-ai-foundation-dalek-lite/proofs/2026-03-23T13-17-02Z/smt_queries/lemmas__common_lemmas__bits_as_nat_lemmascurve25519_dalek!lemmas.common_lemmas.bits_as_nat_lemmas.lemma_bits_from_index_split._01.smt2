...
;; curve25519-dalek/src/lemmas/common_lemmas/bits_as_nat_lemmas.rs:372:9: 372:15 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::bits_as_nat_lemmas::lemma_bits_from_index_split
;; curve25519-dalek/src/lemmas/common_lemmas/bits_as_nat_lemmas.rs:372:9: 372:15 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= (vstd!arithmetic.power2.pow2.? (I m!)) (nClip (Mul 2 (vstd!arithmetic.power2.pow2.?
        (I (nClip (Sub m! 1)))
    ))))
    (=>
     %%location_label%%0
     (= (nClip (Mul 2 (nClip (Add A@ (nClip (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Sub m!
                1
             )))
            ) B@
       )))))
      ) (nClip (Add (nClip (Mul 2 A@)) (nClip (Mul (vstd!arithmetic.power2.pow2.? (I m!)) B@))))
 )))))
 (get-info :version)
