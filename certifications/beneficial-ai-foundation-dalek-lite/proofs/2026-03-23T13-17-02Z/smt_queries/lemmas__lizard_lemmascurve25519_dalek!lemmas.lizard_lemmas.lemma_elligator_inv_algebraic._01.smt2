...
;; curve25519-dalek/src/lemmas/lizard_lemmas.rs:890:1: 890:59 (#0)
...
;; Function-Def curve25519_dalek::lemmas::lizard_lemmas::lemma_elligator_inv_algebraic
;; curve25519-dalek/src/lemmas/lizard_lemmas.rs:890:1: 890:59 (#0)
(get-info :all-statistics)
(push)
 (declare-const s! Int)
 (declare-const t! Int)
 (declare-const pms2@ Int)
 (declare-const x@ Int)
 (declare-const r0@ Int)
 (declare-const a@ Int)
 (declare-const s2@ Int)
 (declare-const s4@ Int)
 (declare-const inv_sq_y@ Int)
 (declare-const y@ Int)
 (declare-const sq@ Bool)
 (assert
  fuel_defaults
 )
 (assert
         ...
         (=>
          ...
          (=>
           ...
           (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.lizard_specs.jacobi_to_edwards_affine.?
            ...
            ) (Poly%tuple%2. (tuple%2./tuple%2 (I 0) (I 1)))
        ))))
        (=>
         (= (curve25519_dalek!specs.lizard_specs.jacobi_to_edwards_affine.? (I s!) (I t!))
          (tuple%2./tuple%2 (I 0) (I 1))
         ...
         (or
          (and
           (=>
            (= (curve25519_dalek!specs.field_specs_u64.field_canonical.? (I t!)) 1)
            (and
             (=>
              (ens%curve25519_dalek!lemmas.lizard_lemmas.axiom_elligator_forward_sqrt_id. 0)
              (=>
               %%location_label%%2
               (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.ristretto_specs.spec_elligator_ristretto_flavor.?
                  (I (curve25519_dalek!specs.lizard_specs.sqrt_id.? (I 0)))
                 )
                ) (Poly%tuple%2. (tuple%2./tuple%2 (I 0) (I 1)))
             )))
             (=>
           ...
           (=>
            (not (= (curve25519_dalek!specs.field_specs_u64.field_canonical.? (I t!)) 1))
            (and
             (=>
              (ens%curve25519_dalek!lemmas.lizard_lemmas.axiom_elligator_forward_zero. 0)
              (=>
               %%location_label%%3
               (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.ristretto_specs.spec_elligator_ristretto_flavor.?
                  (I 0)
     ...
     (and
      ...
      (=>
       ...
       (=>
        ...
        (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.ristretto_specs.spec_elligator_ristretto_flavor.?
           (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. (curve25519_dalek!specs.lizard_specs.spec_elligator_inv.?
               (I s!) (I t!)
          )))))
         ) (Poly%tuple%2. (curve25519_dalek!specs.lizard_specs.jacobi_to_edwards_affine.? (I
            s!
