...
;; curve25519-dalek/src/lemmas/common_lemmas/to_nat_lemmas.rs:628:1: 628:87 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::to_nat_lemmas::lemma_prefix_equal_when_bytes_match
;; curve25519-dalek/src/lemmas/common_lemmas/to_nat_lemmas.rs:628:1: 628:87 (#0)
(get-info :all-statistics)
(push)
 (declare-const seq1! vstd!seq.Seq<u8.>.)
 (declare-const seq2! vstd!seq.Seq<u8.>.)
 (declare-const n! Int)
 ...
 (assert
  (forall ((i$ Poly)) (!
    ...
    :pattern ((vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. seq1!) i$))
    :pattern ((vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. seq2!) i$))
    :qid user_curve25519_dalek__lemmas__common_lemmas__to_nat_lemmas__lemma_prefix_equal_when_bytes_match_55
    :skolemid skolem_user_curve25519_dalek__lemmas__common_lemmas__to_nat_lemmas__lemma_prefix_equal_when_bytes_match_55
 )))
 ...
 (assert
  (not (=>
    (= decrease%init0 n!)
    (=>
     (= goal@ (= (curve25519_dalek!specs.core_specs.bytes_as_nat_prefix.? (Poly%vstd!seq.Seq<u8.>.
         seq1!
        ) (I n!)
       ) (curve25519_dalek!specs.core_specs.bytes_as_nat_prefix.? (Poly%vstd!seq.Seq<u8.>.
         seq2!
           ...
           (and
            (=>
             ...
             (check_decrease_int (let
               ((seq1!$0 seq1!) (seq2!$1 seq2!) (n!$2 tmp%1))
               n!$2
