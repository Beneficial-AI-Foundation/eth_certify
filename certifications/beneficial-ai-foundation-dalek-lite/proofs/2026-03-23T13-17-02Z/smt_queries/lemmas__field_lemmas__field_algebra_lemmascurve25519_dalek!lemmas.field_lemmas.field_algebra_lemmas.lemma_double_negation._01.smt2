...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:2000:1: 2000:43 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_double_negation
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:2000:1: 2000:43 (#0)
...
(push)
 ...
 (assert
  (not (=>
    ...
    (=>
     (= tmp%1 (curve25519_dalek!specs.field_specs.field_neg.? (I a!)))
     (=>
      (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_neg_one_times_is_neg.
       tmp%1
      )
      (=>
       ...
       (=>
        ...
        (and
         (=>
          %%location_label%%0
          (req%vstd!arithmetic.div_mod.lemma_small_mod. a! tmp%2)
         )
         (=>
          (ens%vstd!arithmetic.div_mod.lemma_small_mod. a! tmp%2)
          (=>
           %%location_label%%1
           (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_neg.?
               (I 1)
