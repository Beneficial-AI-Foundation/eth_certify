...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:1057:1: 1057:50 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_inv_of_product
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:1057:1: 1057:50 (#0)
...
(push)
 ...
 (declare-const inv_a_inv_b@ Int)
 (declare-const step1@ Int)
 (declare-const step2@ Int)
 (declare-const step3@ Int)
 (declare-const step4@ Int)
 (declare-const step5@ Int)
 (declare-const step6@ Int)
 (assert
  fuel_defaults
 )
 (assert
     ...
     (=>
      ...
      (=>
       ...
       (=>
        ...
        (=>
         (= inv_a_inv_b@ (curve25519_dalek!specs.field_specs.field_mul.? (I inv_a@) (I inv_b@)))
         (or
          (and
           (=>
            (or
            ...
            (and
             (and
              ...
              (=>
               ...
               (=>
                %%location_label%%3
                (= (curve25519_dalek!specs.field_specs.field_inv.? (I ab@)) 0)
             )))
             (=>
              (= (curve25519_dalek!specs.field_specs.field_inv.? (I ab@)) 0)
              (and
                ...
                (=>
                 ...
                 (and
                  (and
                   ...
                   (= (EucMod (nClip (Mul (EucMod a! p@) inv_a@)) p@) 1)
                  )
            ...
            (=>
             ...
             (and
                 ...
                 (=>
                  ...
                  (and
                   ...
                   (=>
                    ...
                    (=>
                     (= tmp%4 (= (EucMod (nClip (Mul a! b!)) p@) 0))
                     (and
                      (=>
                       %%location_label%%16
                       tmp%4
              ...
              (=>
               (not (= (EucMod ab@ p@) 0))
               (=>
                (= step1@ (nClip (Mul (nClip (Mul a! b!)) (nClip (Mul inv_a@ inv_b@)))))
                (=>
                 (= step2@ (nClip (Mul (nClip (Mul (nClip (Mul a! b!)) inv_a@)) inv_b@)))
                 (=>
                  (= step3@ (nClip (Mul (nClip (Mul a! (nClip (Mul b! inv_a@)))) inv_b@)))
                  (=>
                   (= step4@ (nClip (Mul (nClip (Mul a! (nClip (Mul inv_a@ b!)))) inv_b@)))
                   (=>
                    (= step5@ (nClip (Mul (nClip (Mul (nClip (Mul a! inv_a@)) b!)) inv_b@)))
                    (=>
                     (= step6@ (nClip (Mul (nClip (Mul a! inv_a@)) (nClip (Mul b! inv_b@)))))
                     (and
                      (=>
                       (= tmp%5 (nClip (Mul a! b!)))
                       (=>
                        (ens%vstd!arithmetic.mul.lemma_mul_is_associative. tmp%5 inv_a@ inv_b@)
                        (=>
                         %%location_label%%19
                         (= step1@ step2@)
                      )))
                      (=>
                       ...
                       (and
                        (=>
                         (ens%vstd!arithmetic.mul.lemma_mul_is_associative. a! b! inv_a@)
                         (=>
                          %%location_label%%20
                          (= step2@ step3@)
                        ))
                        (=>
                         ...
                         (and
                          (=>
                           (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. b! inv_a@)
                           (=>
                            %%location_label%%21
                            (= step3@ step4@)
                          ))
                          (=>
                           ...
                           (and
                            (=>
                             (ens%vstd!arithmetic.mul.lemma_mul_is_associative. a! inv_a@ b!)
                             (=>
                              %%location_label%%22
                              (= step4@ step5@)
                            ))
                            (=>
                             ...
                             (and
                              (=>
                               (= tmp%6 (nClip (Mul a! inv_a@)))
                               (=>
                                (ens%vstd!arithmetic.mul.lemma_mul_is_associative. tmp%6 b! inv_b@)
                                (=>
                                 %%location_label%%23
                                 (= step5@ step6@)
                              )))
                               ...
                               (=>
                                ...
                                (and
                                 ...
                                 (=>
                                  tmp%7
                                  (=>
                                   (= tmp%8 (= (nClip (Mul (nClip (Mul a! b!)) (nClip (Mul inv_a@ inv_b@)))) (nClip (Mul
                                       (nClip (Mul a! inv_a@)) (nClip (Mul b! inv_b@))
                                   ))))
                                   (and
                                    (=>
                                     %%location_label%%25
                                       ...
                                       (and
                                        (and
                                         ...
                                         (=>
                                          ...
                                          (=>
                                           %%location_label%%29
                                           (= (EucMod (nClip (Mul b! inv_b@)) p@) 1)
                                        )))
                                        (=>
                                         (= (EucMod (nClip (Mul b! inv_b@)) p@) 1)
                                         (and
                                          (=>
                                           (= tmp%9 (nClip (Mul a! inv_a@)))
                                           (=>
                                            (= tmp%10 (nClip (Mul b! inv_b@)))
                                            (and
                                             (=>
                                              %%location_label%%30
                                              (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop. tmp%9 tmp%10 p@)
                                             )
                                             (=>
                                              (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop. tmp%9 tmp%10 p@)
                                              (and
                                               (=>
                                                %%location_label%%31
                                               ...
                                               (=>
                                                ...
                                                (=>
                                                 %%location_label%%32
                                                 (= (EucMod (nClip (Mul (nClip (Mul a! inv_a@)) (nClip (Mul b! inv_b@)))) p@) 1)
                                          )))))))
                                          (=>
                                           (= (EucMod (nClip (Mul (nClip (Mul a! inv_a@)) (nClip (Mul b! inv_b@)))) p@) 1)
                                           (=>
                                            (= tmp%11 (= (EucMod (nClip (Mul (nClip (Mul a! b!)) (nClip (Mul inv_a@ inv_b@)))) p@)
                                              1
                                            ))
                                            (and
                                             (=>
                                             ...
                                             (=>
                                              ...
                                              (and
                                               (=>
                                                (= tmp%12 (nClip (Mul a! b!)))
                                                (and
                                                 (=>
                                                  %%location_label%%34
                                                  (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%12 p@)
                                                 )
                                                 (=>
                                                  (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%12 p@)
                                                  (and
                                                   (=>
                                                    %%location_label%%35
                                                    (req%vstd!arithmetic.div_mod.lemma_small_mod. ab@ p@)
                                                   )
                                                   (=>
                                                    (ens%vstd!arithmetic.div_mod.lemma_small_mod. ab@ p@)
                                                    (=>
                                                     (= tmp%13 (nClip (Mul inv_a@ inv_b@)))
                                                     (and
                                                      (=>
                                                       %%location_label%%36
                                                       (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%13 p@)
                                                      )
                                                      (=>
                                                       (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%13 p@)
                                                       (=>
                                                        (= tmp%14 (nClip (Mul a! b!)))
                                                        (=>
                                                         (= tmp%15 (nClip (Mul inv_a@ inv_b@)))
                                                         (and
                                                          (=>
                                                           %%location_label%%37
                                                           (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop. tmp%14 tmp%15 p@)
                                                          )
                                                          (=>
                                                           (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop. tmp%14 tmp%15 p@)
                                                           (=>
                                                            %%location_label%%38
                                                            (= (EucMod (nClip (Mul (EucMod ab@ p@) inv_a_inv_b@)) p@) 1)
                                               )))))))))))))
                                               (=>
                                                (= (EucMod (nClip (Mul (EucMod ab@ p@) inv_a_inv_b@)) p@) 1)
                                                (and
                                                 (=>
                                                  (= tmp%16 (nClip (Mul inv_a@ inv_b@)))
                                                  (and
                                                   (=>
                                                    %%location_label%%39
                                                    (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%16 p@)
                                                   )
                                                   (=>
                                                    (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%16 p@)
                                                    (=>
                                                     %%location_label%%40
                                                     (< inv_a_inv_b@ p@)
                                                 ))))
                                                 (=>
                                                  ...
                                                  (and
                                                   (and
                                                    (=>
                                                     %%location_label%%41
                                                     (req%curve25519_dalek!specs.field_specs.field_inv_unique. ab@ inv_a_inv_b@)
                                                    )
                                                    (=>
                                                     (ens%curve25519_dalek!specs.field_specs.field_inv_unique. ab@ inv_a_inv_b@)
                                                     (=>
                                                      %%location_label%%42
                                                      (= (curve25519_dalek!specs.field_specs.field_inv.? (I ab@)) inv_a_inv_b@)
                                                   )))
                                                   (=>
                                                    (= (curve25519_dalek!specs.field_specs.field_inv.? (I ab@)) inv_a_inv_b@)
                                                    (=>
