...
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:734:1: 734:49 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::number_theory_lemmas::lemma_fermat_strong
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:734:1: 734:49 (#0)
...
(push)
 ...
 (declare-const am1@ Int)
 (declare-const pow_am1_p@ Int)
 (declare-const am1_pow_mod@ Int)
 (declare-const pow_am1_p_int@ Int)
 (declare-const p_int@ Int)
 (declare-const am1_int@ Int)
       ...
       (and
        (or
         (and
          ...
          (=>
           ...
           (=>
            (fuel_bool fuel%vstd!arithmetic.power.pow.)
            (=>
             (= tmp%1 (vstd!arithmetic.power.pow.? (I 0) (I (nClip (Sub p! 1)))))
             (=>
         ...
         (and
          ...
          (=>
           %%location_label%%0
           (= (vstd!arithmetic.power.pow.? (I 0) (I p!)) 0)
        )))
        (=>
         (= (vstd!arithmetic.power.pow.? (I 0) (I p!)) 0)
         (and
        ...
        (and
         ...
         (and
          ...
          (=>
           ...
           (=>
            (= tmp%2 (= (EucMod (nClip (vstd!arithmetic.power.pow.? (I am1@) (I p!))) p!) (EucMod
               am1@ p!
            )))
            (and
             (=>
                ...
                (=>
                 ...
                 (and
                  ...
                  (=>
                   tmp%3
                   (=>
                    (= tmp%4 (= (EucMod (nClip (vstd!arithmetic.power.pow.? (I a!) (I p!))) p!) (EucMod
                       (nClip (Add 1 (nClip (vstd!arithmetic.power.pow.? (I am1@) (I p!))))) p!
                    )))
                    (and
                     (=>
                      %%location_label%%7
                     ...
                     (=>
                      tmp%4
                      (=>
                       (= pow_am1_p@ (nClip (vstd!arithmetic.power.pow.? (I am1@) (I p!))))
                       (=>
                        (= am1_pow_mod@ (EucMod pow_am1_p@ p!))
                        (=>
                         (= tmp%5 (= am1_pow_mod@ (EucMod am1@ p!)))
                         (and
                          (=>
                           %%location_label%%8
                           tmp%5
                            ...
                            (=>
                             ...
                             (=>
                              ...
                              (and
                               (=>
                                %%location_label%%9
                                (req%vstd!arithmetic.div_mod.lemma_mod_adds. 1 pow_am1_p_int@ p_int@)
                               )
                               (=>
                                (ens%vstd!arithmetic.div_mod.lemma_mod_adds. 1 pow_am1_p_int@ p_int@)
                                (and
                                 (=>
                                  %%location_label%%10
                                  ...
                                  (=>
                                   ...
                                   (and
                                    ...
                                    (=>
                                     tmp%6
                                     (=>
                                      (= tmp%7 (= (EucMod pow_am1_p_int@ p_int@) am1_pow_mod@))
                                      (and
                                       (=>
                                        %%location_label%%12
                                        tmp%7
                                       ...
                                       (=>
                                        tmp%7
                                        (=>
                                         (= tmp%8 (= am1_pow_mod@ (EucMod am1@ p!)))
                                         (and
                                          (=>
                                           %%location_label%%13
                                           tmp%8
                                          ...
                                          (=>
                                           ...
                                           (and
                                            (=>
                                             %%location_label%%14
                                             (req%vstd!arithmetic.div_mod.lemma_mod_adds. 1 am1_int@ p_int@)
                                            )
                                            (=>
                                             (ens%vstd!arithmetic.div_mod.lemma_mod_adds. 1 am1_int@ p_int@)
                                             (=>
                                              (= tmp%9 (= (EucMod (Add 1 pow_am1_p_int@) p_int@) (EucMod (Add 1 am1_int@) p_int@)))
                                              (and
                                               (=>
                                                %%location_label%%15
                                                tmp%9
                                               ...
                                               (=>
                                                tmp%9
                                                (=>
                                                 (= tmp%10 (= (EucMod (nClip (Add 1 pow_am1_p@)) p!) (EucMod (nClip (Add 1 am1@)) p!)))
                                                 (and
                                                  (=>
                                                   %%location_label%%16
                                                   tmp%10
