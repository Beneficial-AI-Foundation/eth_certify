...
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:515:1: 515:55 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::number_theory_lemmas::lemma_binomial_absorption
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:515:1: 515:55 (#0)
             ...
             (=>
              ...
              (and
               ...
               (=>
                tmp%3
                (=>
                 (= tmp%4 (= (nClip (Mul 1 1)) (nClip (Mul 1 1))))
                 (and
                  (=>
                   %%location_label%%3
                   tmp%4
       ...
       (or
        (and
         (=>
          (= k! n!)
          (=>
           (= tmp%5 (= (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial.? (
               I n!
              ) (I n!)
             ) 1
           ))
           (and
            ...
            (=>
             tmp%5
             (=>
              (= tmp%6 (= (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial.? (
                  I (nClip (Sub n! 1))
                 ) (I (nClip (Sub n! 1)))
                ) 1
              ))
            ...
            (=>
             ...
             (and
              ...
              (=>
               ...
               (=>
                (= tmp%7 (= (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial.? (
                    I n!
                   ) (I 1)
                  ) n!
                ))
                (and
                 ...
                 (=>
                  tmp%7
                  (=>
                   (= tmp%8 (= (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial.? (
                       I (nClip (Sub n! 1))
                      ) (I 0)
                     ) 1
                   ))
                   (and
                    ...
                    (=>
                     tmp%8
                     (=>
                      (ens%vstd!arithmetic.mul.lemma_mul_basics. n!)
                      %%switch_label%%2
            ))))))))))
            (=>
             (not (= k! 1))
             (=>
              (= tmp%9 (= (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial.? (
                  I n!
                 ) (I k!)
                ) (nClip (Add (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial.?
                   (I (nClip (Sub n! 1))) (I (nClip (Sub k! 1)))
                  ) (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial.? (I (nClip (
                      Sub n! 1
                    ))
                   ) (I k!)
              )))))
              (and
               ...
               (=>
                tmp%9
                (=>
                 (= tmp%10 (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial.? (I
                    (nClip (Sub n! 1))
                   ) (I (nClip (Sub k! 1)))
                 ))
                 (=>
                  (= tmp%11 (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial.? (I
                     (nClip (Sub n! 1))
                    ) (I k!)
                  ))
                  (=>
                   (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add. k! tmp%10 tmp%11)
                   (or
                    (and
                     (=>
                      (< k! (Sub n! 1))
                      (=>
                       (= tmp%12 (nClip (Sub n! 1)))
                       (and
                        (=>
                         %%location_label%%10
