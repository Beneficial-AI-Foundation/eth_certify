...
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_ratio_lemmas.rs:947:1: 957:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::sqrt_ratio_lemmas::lemma_sqrt_ratio_correctness
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_ratio_lemmas.rs:947:1: 957:2 (#0)
...
(push)
 ...
 (declare-const was_nonzero_sq! Bool)
                  ...
                  (=>
                   ...
                   (and
                    (and
                     (=>
                      %%location_label%%10
                      (req%vstd!arithmetic.div_mod.lemma_small_mod. u_nat! pn@)
                     )
                     (=>
                      (ens%vstd!arithmetic.div_mod.lemma_small_mod. u_nat! pn@)
                      (and
                       (=>
                        %%location_label%%11
                        (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_neg_nonzero.
                     ...
                     (=>
                      ...
                      (and
                       ...
                       (=>
                        tmp%7
                        (=>
                         (= tmp%8 (= r_nat! (curve25519_dalek!specs.field_specs.field_mul.? (I i@) (I r_orig_nat!))))
                         (and
                          (=>
                           %%location_label%%22
                           tmp%8
                           ...
                           (or
                            (and
                             (=>
                              ...
                              (and
                               (=>
                                (ens%curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.lemma_p_is_odd. 0)
                                (and
                                 (=>
                                  %%location_label%%23
                                  (req%vstd!arithmetic.div_mod.lemma_small_mod. u_nat! pn@)
                                  ...
                                  (or
                                   (and
                                    (=>
                                     (> u_nat! 0)
                                     (=>
                                      (= tmp%9 (nClip (Sub pn@ u_nat!)))
                                      (and
                                       (=>
                                        %%location_label%%24
                                        (req%vstd!arithmetic.div_mod.lemma_small_mod. tmp%9 pn@)
                                       )
                                       (=>
                                        (ens%vstd!arithmetic.div_mod.lemma_small_mod. tmp%9 pn@)
                                        (=>
                                         (= tmp%10 (= (nClip (Add u_nat! u_nat!)) pn@))
                                         (and
                                          (=>
                                           %%location_label%%25
                                           tmp%10
                                          ...
                                          (=>
                                           ...
                                           (and
                                            (and
                                             (=>
                                              %%location_label%%26
                                              (req%vstd!arithmetic.div_mod.lemma_mod_multiples_basic. 1 2)
                                             )
                                             (=>
                                              (ens%vstd!arithmetic.div_mod.lemma_mod_multiples_basic. 1 2)
                                              (=>
                                               %%location_label%%27
                                               (= (EucMod pn@ 2) 0)
                                            )))
                              ...
                              (and
                               (=>
                                ...
                                (=>
                                 ...
                                 (=>
                                  %%location_label%%33
                                  (= (curve25519_dalek!specs.field_specs.field_square.? (I r_nat!)) (curve25519_dalek!specs.field_specs.field_neg.?
                                    (I (curve25519_dalek!specs.field_specs.field_square.? (I r_orig_nat!)))
                               )))))
                               (=>
                                (= (curve25519_dalek!specs.field_specs.field_square.? (I r_nat!)) (curve25519_dalek!specs.field_specs.field_neg.?
                                  (I (curve25519_dalek!specs.field_specs.field_square.? (I r_orig_nat!)))
                                ...
                                (and
                                 (=>
                                  (= tmp%12 (curve25519_dalek!specs.field_specs.field_square.? (I r_orig_nat!)))
                                  (=>
                                   (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_neg.
                                    v_nat! tmp%12
                                   )
                                   (=>
                                    ...
                                    (= (curve25519_dalek!specs.field_specs.field_mul.? (I v_nat!) (I (curve25519_dalek!specs.field_specs.field_square.?
                                     ...
                                     ) (curve25519_dalek!specs.field_specs.field_neg.? (I check_nat!))
                                 ))))
                                 (=>
                                  (= (curve25519_dalek!specs.field_specs.field_mul.? (I v_nat!) (I (curve25519_dalek!specs.field_specs.field_square.?
                                      (I r_nat!)
                     ...
                     (or
                      (and
                       (=>
                        ...
                        (=>
                         (= tmp%13 (= r_nat! (curve25519_dalek!specs.field_specs.field_mul.? (I i@) (I r_orig_nat!))))
                         (and
                          (=>
                           %%location_label%%38
                           tmp%13
                ...
                (=>
                 ...
                 (and
                  ...
                  (=>
                   (not flipped_sign!)
                   (=>
                    (= ui@ (curve25519_dalek!specs.field_specs.field_mul.? (I u_nat!) (I i@)))
                    (=>
                     (= neg_ui@ (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_neg.?
                         (I u_nat!)
                        )
                       ) (I i@)
                     ))
                     (or
                      (and
                       ...
                       (=>
                        (not (not flipped_sign_i!))
                        (=>
                         (= tmp%17 (= r_nat! (curve25519_dalek!specs.field_specs.field_mul.? (I i@) (I r_orig_nat!))))
                         (and
                          (=>
                           %%location_label%%50
                           tmp%17
                          ...
                          (=>
                           ...
                           (and
                            ...
                            (=>
                             ...
                             (and
                              (=>
                               (= tmp%18 (curve25519_dalek!specs.field_specs.field_square.? (I r_orig_nat!)))
                               (=>
                                (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_neg.
                                 v_nat! tmp%18
                                )
                              ...
                              (=>
                               ...
                               (and
                                (=>
                                 ...
                                 (=>
                                  (= tmp%19 (= check_nat! (curve25519_dalek!specs.field_specs.field_neg.? (I ui@))))
                                  (and
                                   (=>
                                    %%location_label%%53
                                    tmp%19
                                   ...
                                   (=>
                                    ...
                                    (=>
                                     ...
                                     (and
                                      (=>
                                       %%location_label%%54
                                       (req%vstd!arithmetic.div_mod.lemma_mod_bound. ui@ pn@)
                                      )
                                      (=>
                                       (ens%vstd!arithmetic.div_mod.lemma_mod_bound. ui@ pn@)
                                       (and
                                        (=>
                                         %%location_label%%55
                                         (req%vstd!arithmetic.div_mod.lemma_small_mod. ui@ pn@)
                                        )
                                        (=>
                                         (ens%vstd!arithmetic.div_mod.lemma_small_mod. ui@ pn@)
                                         (=>
                                          %%location_label%%56
                                          (= (curve25519_dalek!specs.field_specs.field_neg.? (I check_nat!)) ui@)
                                ))))))))))
                                (=>
                                 (= (curve25519_dalek!specs.field_specs.field_neg.? (I check_nat!)) ui@)
                                 (and
