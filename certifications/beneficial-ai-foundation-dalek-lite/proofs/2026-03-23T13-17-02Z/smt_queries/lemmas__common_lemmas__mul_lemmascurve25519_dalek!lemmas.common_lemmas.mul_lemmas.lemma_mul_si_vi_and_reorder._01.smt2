...
;; curve25519-dalek/src/lemmas/common_lemmas/mul_lemmas.rs:266:1: 278:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::mul_lemmas::lemma_mul_si_vi_and_reorder
;; curve25519-dalek/src/lemmas/common_lemmas/mul_lemmas.rs:266:1: 278:2 (#0)
     ...
     (=>
      ...
      (=>
       ...
       (=>
        ...
        (=>
         (ens%curve25519_dalek!lemmas.common_lemmas.mul_lemmas.lemma_mul_distributive_5_terms.
          tmp%1 v0! tmp%2 tmp%3 tmp%4 tmp%5
         )
         (=>
          (= tmp%6 (= (Mul (Mul si! vi!) (Add (Add (Add (Add v0! (Mul s1! v1!)) (Mul s2! v2!)) (
                Mul s3! v3!
               )
              ) (Mul s4! v4!)
             )
            ) (Add (Add (Add (Add (Mul (Mul si! vi!) v0!) (Mul (Mul si! vi!) (Mul s1! v1!))) (Mul
                (Mul si! vi!) (Mul s2! v2!)
               )
              ) (Mul (Mul si! vi!) (Mul s3! v3!))
             ) (Mul (Mul si! vi!) (Mul s4! v4!))
          )))
          (and
           (=>
            %%location_label%%0
           ...
           (=>
            tmp%6
            (=>
             (ens%vstd!arithmetic.mul.lemma_mul_is_associative. si! vi! v0!)
             (=>
              (ens%curve25519_dalek!lemmas.common_lemmas.mul_lemmas.lemma_mul_quad_prod. si! vi!
               s1! v1!
              )
              (=>
               (ens%curve25519_dalek!lemmas.common_lemmas.mul_lemmas.lemma_mul_quad_prod. si! vi!
               ...
               (=>
                ...
                (=>
                 ...
                 (=>
                  %%location_label%%1
                  (= (Mul (Mul si! vi!) (Add (Add (Add (Add v0! (Mul s1! v1!)) (Mul s2! v2!)) (Mul s3! v3!))
                     (Mul s4! v4!)
                    )
                   ) (Add (Add (Add (Add (Mul si! (Mul vi! v0!)) (Mul (Mul si! s1!) (Mul vi! v1!))) (Mul
                       (Mul si! s2!) (Mul vi! v2!)
