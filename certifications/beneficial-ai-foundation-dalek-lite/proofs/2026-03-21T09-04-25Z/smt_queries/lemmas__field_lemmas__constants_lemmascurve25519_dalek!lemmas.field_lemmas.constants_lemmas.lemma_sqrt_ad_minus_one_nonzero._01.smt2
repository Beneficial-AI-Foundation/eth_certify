...
;; MODULE 'module lemmas::field_lemmas::constants_lemmas'
;; curve25519-dalek/src/lemmas/field_lemmas/constants_lemmas.rs:505:1: 505:47 (#0)
...
(declare-const fuel%curve25519_dalek!backend.serial.u64.constants.ONE_MINUS_EDWARDS_D_SQUARED.
 FuelId
)
(declare-const fuel%curve25519_dalek!backend.serial.u64.constants.EDWARDS_D_MINUS_ONE_SQUARED.
 FuelId
)
...
(declare-const fuel%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_pow2.
 FuelId
)
(declare-const fuel%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_u5_nat.
 FuelId
)
(declare-const fuel%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_p.
 FuelId
)
...
(assert
 (distinct fuel%vstd!arithmetic.div_mod.lemma_mod_bound. fuel%vstd!arithmetic.power2.lemma_pow2_adds.
  ...
  fuel%curve25519_dalek!backend.serial.u64.field.impl&%16.MINUS_ONE. fuel%curve25519_dalek!backend.serial.u64.constants.ONE_MINUS_EDWARDS_D_SQUARED.
  fuel%curve25519_dalek!backend.serial.u64.constants.EDWARDS_D_MINUS_ONE_SQUARED. fuel%curve25519_dalek!backend.serial.u64.constants.SQRT_AD_MINUS_ONE.
  fuel%curve25519_dalek!backend.serial.u64.constants.INVSQRT_A_MINUS_D. fuel%curve25519_dalek!backend.serial.u64.constants.MONTGOMERY_A.
  fuel%curve25519_dalek!backend.serial.u64.constants.MONTGOMERY_A_NEG. fuel%curve25519_dalek!backend.serial.u64.constants.SQRT_M1.
  fuel%curve25519_dalek!backend.serial.u64.constants.EDWARDS_D. fuel%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_pow2.
  fuel%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_u5_nat. fuel%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_p.
  ...
  fuel%curve25519_dalek!specs.field_specs.field_square. fuel%curve25519_dalek!specs.field_specs_u64.p.
...
;; Function-Decl curve25519_dalek::backend::serial::u64::constants::ONE_MINUS_EDWARDS_D_SQUARED
(declare-fun curve25519_dalek!backend.serial.u64.constants.ONE_MINUS_EDWARDS_D_SQUARED.?
 () curve25519_dalek!backend.serial.u64.field.FieldElement51.
)

;; Function-Decl curve25519_dalek::backend::serial::u64::constants::EDWARDS_D_MINUS_ONE_SQUARED
(declare-fun curve25519_dalek!backend.serial.u64.constants.EDWARDS_D_MINUS_ONE_SQUARED.?
 () curve25519_dalek!backend.serial.u64.field.FieldElement51.
)
...
;; Function-Decl curve25519_dalek::lemmas::field_lemmas::constants_lemmas::local_pow2
(declare-fun curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_pow2.? (Poly)
 Int
)
(declare-fun curve25519_dalek!lemmas.field_lemmas.constants_lemmas.rec%local_pow2.?
 (Poly Fuel) Int
)

;; Function-Decl curve25519_dalek::lemmas::field_lemmas::constants_lemmas::local_u5_nat
(declare-fun curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_u5_nat.?
 (Poly) Int
)

;; Function-Decl curve25519_dalek::lemmas::field_lemmas::constants_lemmas::local_p
(declare-fun curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_p.? (Poly)
 Int
)
...
(assert
 (=>
  ...
  (forall ((x! Int) (m! Int)) (!
    ...
    :pattern ((EucMod x! m!))
    :qid user_vstd__arithmetic__div_mod__lemma_mod_bound_22
    :skolemid skolem_user_vstd__arithmetic__div_mod__lemma_mod_bound_22
))))
...
(assert
 (=>
  ...
  (forall ((e1! Int) (e2! Int)) (!
    ...
    :qid user_vstd__arithmetic__power2__lemma_pow2_adds_23
    :skolemid skolem_user_vstd__arithmetic__power2__lemma_pow2_adds_23
))))
...
;; Function-Axioms curve25519_dalek::backend::serial::u64::constants::ONE_MINUS_EDWARDS_D_SQUARED
(assert
 (fuel_bool_default fuel%curve25519_dalek!backend.serial.u64.constants.ONE_MINUS_EDWARDS_D_SQUARED.)
)
(assert
 (=>
  (fuel_bool fuel%curve25519_dalek!backend.serial.u64.constants.ONE_MINUS_EDWARDS_D_SQUARED.)
  (= curve25519_dalek!backend.serial.u64.constants.ONE_MINUS_EDWARDS_D_SQUARED.? (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51
    (%Poly%array%. (array_new $ (UINT 64) 5 (%%array%%0 (I 1136626929484150) (I 1998550399581263)
       (I 496427632559748) (I 118527312129759) (I 45110755273534)
)))))))
(assert
 (has_type (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. curve25519_dalek!backend.serial.u64.constants.ONE_MINUS_EDWARDS_D_SQUARED.?)
  TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.
))

;; Function-Axioms curve25519_dalek::backend::serial::u64::constants::EDWARDS_D_MINUS_ONE_SQUARED
(assert
 (fuel_bool_default fuel%curve25519_dalek!backend.serial.u64.constants.EDWARDS_D_MINUS_ONE_SQUARED.)
)
(assert
 (=>
  (fuel_bool fuel%curve25519_dalek!backend.serial.u64.constants.EDWARDS_D_MINUS_ONE_SQUARED.)
  (= curve25519_dalek!backend.serial.u64.constants.EDWARDS_D_MINUS_ONE_SQUARED.? (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51
    (%Poly%array%. (array_new $ (UINT 64) 5 (%%array%%0 (I 1507062230895904) (I 1572317787530805)
       (I 683053064812840) (I 317374165784489) (I 1572899562415810)
)))))))
(assert
 (has_type (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. curve25519_dalek!backend.serial.u64.constants.EDWARDS_D_MINUS_ONE_SQUARED.?)
  TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.
))
...
;; Function-Axioms curve25519_dalek::lemmas::field_lemmas::constants_lemmas::local_pow2
(assert
 (fuel_bool_default fuel%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_pow2.)
)
(declare-const fuel_nat%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_pow2.
 Fuel
)
(assert
 (forall ((n! Poly) (fuel% Fuel)) (!
   (= (curve25519_dalek!lemmas.field_lemmas.constants_lemmas.rec%local_pow2.? n! fuel%)
    (curve25519_dalek!lemmas.field_lemmas.constants_lemmas.rec%local_pow2.? n! zero)
   )
   :pattern ((curve25519_dalek!lemmas.field_lemmas.constants_lemmas.rec%local_pow2.? n!
     fuel%
   ))
   :qid internal_curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_pow2._fuel_to_zero_definition
   :skolemid skolem_internal_curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_pow2._fuel_to_zero_definition
)))
(assert
 (forall ((n! Poly) (fuel% Fuel)) (!
   (=>
    (has_type n! NAT)
    (= (curve25519_dalek!lemmas.field_lemmas.constants_lemmas.rec%local_pow2.? n! (succ
       fuel%
      )
     ) (ite
      (= (%I n!) 0)
      1
      (nClip (Mul 2 (curve25519_dalek!lemmas.field_lemmas.constants_lemmas.rec%local_pow2.?
         (I (nClip (Sub (%I n!) 1))) fuel%
   ))))))
   :pattern ((curve25519_dalek!lemmas.field_lemmas.constants_lemmas.rec%local_pow2.? n!
     (succ fuel%)
   ))
   :qid internal_curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_pow2._fuel_to_body_definition
   :skolemid skolem_internal_curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_pow2._fuel_to_body_definition
)))
(assert
 (=>
  (fuel_bool fuel%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_pow2.)
  (forall ((n! Poly)) (!
    (=>
     (has_type n! NAT)
     (= (curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_pow2.? n!) (curve25519_dalek!lemmas.field_lemmas.constants_lemmas.rec%local_pow2.?
       n! (succ fuel_nat%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_pow2.)
    )))
    :pattern ((curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_pow2.? n!))
    :qid internal_curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_pow2.?_definition
    :skolemid skolem_internal_curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_pow2.?_definition
))))
(assert
 (forall ((n! Poly)) (!
   (=>
    (has_type n! NAT)
    (<= 0 (curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_pow2.? n!))
   )
   :pattern ((curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_pow2.? n!))
   :qid internal_curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_pow2.?_pre_post_definition
   :skolemid skolem_internal_curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_pow2.?_pre_post_definition
)))
(assert
 (forall ((n! Poly) (fuel% Fuel)) (!
   (=>
    (has_type n! NAT)
    (<= 0 (curve25519_dalek!lemmas.field_lemmas.constants_lemmas.rec%local_pow2.? n! fuel%))
   )
   :pattern ((curve25519_dalek!lemmas.field_lemmas.constants_lemmas.rec%local_pow2.? n!
     fuel%
   ))
   :qid internal_curve25519_dalek!lemmas.field_lemmas.constants_lemmas.rec__local_pow2.?_pre_post_rec_definition
   :skolemid skolem_internal_curve25519_dalek!lemmas.field_lemmas.constants_lemmas.rec__local_pow2.?_pre_post_rec_definition
)))

;; Function-Axioms curve25519_dalek::lemmas::field_lemmas::constants_lemmas::local_u5_nat
(assert
 (fuel_bool_default fuel%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_u5_nat.)
)
(assert
 (=>
  (fuel_bool fuel%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_u5_nat.)
  (forall ((limbs! Poly)) (!
    (= (curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_u5_nat.? limbs!) (
      nClip (Add (nClip (Add (nClip (Add (nClip (Add (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) limbs!
               ) (I 0)
              )
             ) (nClip (Mul (curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_pow2.? (I
                 51
                )
               ) (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $
                   (CONST_INT 5)
    ...
    :pattern ((curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_u5_nat.? limbs!))
    :qid internal_curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_u5_nat.?_definition
    :skolemid skolem_internal_curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_u5_nat.?_definition
))))
(assert
 (forall ((limbs! Poly)) (!
   (=>
    (has_type limbs! (ARRAY $ (UINT 64) $ (CONST_INT 5)))
    (<= 0 (curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_u5_nat.? limbs!))
   )
   :pattern ((curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_u5_nat.? limbs!))
   :qid internal_curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_u5_nat.?_pre_post_definition
   :skolemid skolem_internal_curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_u5_nat.?_pre_post_definition
)))

;; Function-Axioms curve25519_dalek::lemmas::field_lemmas::constants_lemmas::local_p
(assert
 (fuel_bool_default fuel%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_p.)
)
(assert
 (=>
  (fuel_bool fuel%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_p.)
  (forall ((no%param Poly)) (!
    (= (curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_p.? no%param) (nClip
      (Sub (curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_pow2.? (I 255))
       19
    )))
    :pattern ((curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_p.? no%param))
    :qid internal_curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_p.?_definition
    :skolemid skolem_internal_curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_p.?_definition
))))
(assert
 (forall ((no%param Poly)) (!
   (=>
    (has_type no%param INT)
    (<= 0 (curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_p.? no%param))
   )
   :pattern ((curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_p.? no%param))
   :qid internal_curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_p.?_pre_post_definition
   :skolemid skolem_internal_curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_p.?_pre_post_definition
)))
...
;; Function-Specs curve25519_dalek::lemmas::field_lemmas::constants_lemmas::lemma_zero_limbs_bounded_51
(declare-fun ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_zero_limbs_bounded_51.
 (Int) Bool
)
(assert
 (forall ((no%param Int)) (!
   (= (ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_zero_limbs_bounded_51.
     no%param
    ) (curve25519_dalek!specs.field_specs.fe51_limbs_bounded.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
      curve25519_dalek!backend.serial.u64.field.impl&%16.ZERO.?
     ) (I 51)
   ))
   :pattern ((ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_zero_limbs_bounded_51.
     no%param
   ))
   :qid internal_ens__curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_zero_limbs_bounded_51._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_zero_limbs_bounded_51._definition
)))
...
;; Function-Specs curve25519_dalek::lemmas::field_lemmas::constants_lemmas::lemma_minus_one_limbs_bounded_51
(declare-fun ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_minus_one_limbs_bounded_51.
 (Int) Bool
)
(assert
 (forall ((no%param Int)) (!
   (= (ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_minus_one_limbs_bounded_51.
     no%param
    ) (curve25519_dalek!specs.field_specs.fe51_limbs_bounded.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
      curve25519_dalek!backend.serial.u64.field.impl&%16.MINUS_ONE.?
     ) (I 51)
   ))
   :pattern ((ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_minus_one_limbs_bounded_51.
     no%param
   ))
   :qid internal_ens__curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_minus_one_limbs_bounded_51._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_minus_one_limbs_bounded_51._definition
)))

;; Function-Specs curve25519_dalek::lemmas::field_lemmas::constants_lemmas::lemma_minus_one_field_element_value
(declare-fun ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_minus_one_field_element_value.
 (Int) Bool
)
(assert
 (forall ((no%param Int)) (!
   (= (ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_minus_one_field_element_value.
     no%param
    ) (and
     (= (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
        curve25519_dalek!backend.serial.u64.field.impl&%16.MINUS_ONE.?
   ...
   :pattern ((ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_minus_one_field_element_value.
     no%param
   ))
   :qid internal_ens__curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_minus_one_field_element_value._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_minus_one_field_element_value._definition
)))

;; Function-Specs curve25519_dalek::lemmas::field_lemmas::constants_lemmas::lemma_bridge_local_pow2
(declare-fun ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_bridge_local_pow2.
 (Int) Bool
)
(assert
 (forall ((no%param Int)) (!
   (= (ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_bridge_local_pow2.
     no%param
    ) (and
     (= (curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_pow2.? (I 51)) (vstd!arithmetic.power2.pow2.?
       (I 51)
     ))
     (= (curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_pow2.? (I 102)) (vstd!arithmetic.power2.pow2.?
       (I 102)
     ))
     (= (curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_pow2.? (I 153)) (vstd!arithmetic.power2.pow2.?
       (I 153)
     ))
     (= (curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_pow2.? (I 204)) (vstd!arithmetic.power2.pow2.?
       (I 204)
     ))
     (= (curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_pow2.? (I 255)) (vstd!arithmetic.power2.pow2.?
       (I 255)
   ))))
   :pattern ((ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_bridge_local_pow2.
     no%param
   ))
   :qid internal_ens__curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_bridge_local_pow2._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_bridge_local_pow2._definition
)))

;; Function-Specs curve25519_dalek::lemmas::field_lemmas::constants_lemmas::lemma_one_minus_d_squared_value
(declare-fun ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_one_minus_d_squared_value.
 (Int) Bool
)
(assert
 (forall ((no%param Int)) (!
   (= (ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_one_minus_d_squared_value.
     no%param
    ) (= (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
       curve25519_dalek!backend.serial.u64.constants.ONE_MINUS_EDWARDS_D_SQUARED.?
        ...
        (I 1) (I (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
           curve25519_dalek!backend.serial.u64.constants.EDWARDS_D.?
       ))))
      ) (I (curve25519_dalek!specs.field_specs.field_add.? (I 1) (I (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.?
          (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. curve25519_dalek!backend.serial.u64.constants.EDWARDS_D.?)
   )))))))
   :pattern ((ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_one_minus_d_squared_value.
     no%param
   ))
   :qid internal_ens__curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_one_minus_d_squared_value._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_one_minus_d_squared_value._definition
)))

;; Function-Specs curve25519_dalek::lemmas::field_lemmas::constants_lemmas::lemma_d_minus_one_squared_value
(declare-fun ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_d_minus_one_squared_value.
 (Int) Bool
)
(assert
 (forall ((no%param Int)) (!
   (= (ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_d_minus_one_squared_value.
     no%param
    ) (= (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
       curve25519_dalek!backend.serial.u64.constants.EDWARDS_D_MINUS_ONE_SQUARED.?
      )
     ) (curve25519_dalek!specs.field_specs.field_square.? (I (curve25519_dalek!specs.field_specs.field_sub.?
        (I (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
           curve25519_dalek!backend.serial.u64.constants.EDWARDS_D.?
         ))
        ) (I 1)
   )))))
   :pattern ((ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_d_minus_one_squared_value.
     no%param
   ))
   :qid internal_ens__curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_d_minus_one_squared_value._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_d_minus_one_squared_value._definition
)))
...
;; Function-Specs curve25519_dalek::lemmas::field_lemmas::constants_lemmas::lemma_montgomery_a_limbs_bounded_51
(declare-fun ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_montgomery_a_limbs_bounded_51.
 (Int) Bool
)
(assert
 (forall ((no%param Int)) (!
   (= (ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_montgomery_a_limbs_bounded_51.
     no%param
    ) (curve25519_dalek!specs.field_specs.fe51_limbs_bounded.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
      curve25519_dalek!backend.serial.u64.constants.MONTGOMERY_A.?
     ) (I 51)
   ))
   :pattern ((ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_montgomery_a_limbs_bounded_51.
     no%param
   ))
   :qid internal_ens__curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_montgomery_a_limbs_bounded_51._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_montgomery_a_limbs_bounded_51._definition
)))

;; Function-Specs curve25519_dalek::lemmas::field_lemmas::constants_lemmas::lemma_montgomery_a_neg_limbs_bounded_51
(declare-fun ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_montgomery_a_neg_limbs_bounded_51.
 (Int) Bool
)
(assert
 (forall ((no%param Int)) (!
   (= (ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_montgomery_a_neg_limbs_bounded_51.
     no%param
    ) (curve25519_dalek!specs.field_specs.fe51_limbs_bounded.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
      curve25519_dalek!backend.serial.u64.constants.MONTGOMERY_A_NEG.?
     ) (I 51)
   ))
   :pattern ((ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_montgomery_a_neg_limbs_bounded_51.
     no%param
   ))
   :qid internal_ens__curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_montgomery_a_neg_limbs_bounded_51._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_montgomery_a_neg_limbs_bounded_51._definition
)))

;; Function-Specs curve25519_dalek::lemmas::field_lemmas::constants_lemmas::lemma_invsqrt_a_minus_d_limbs_bounded
(declare-fun ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_invsqrt_a_minus_d_limbs_bounded.
 (Int) Bool
)
(assert
 (forall ((no%param Int)) (!
   (= (ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_invsqrt_a_minus_d_limbs_bounded.
     no%param
    ) (and
     (curve25519_dalek!specs.field_specs.fe51_limbs_bounded.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
   ...
   :pattern ((ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_invsqrt_a_minus_d_limbs_bounded.
     no%param
   ))
   :qid internal_ens__curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_invsqrt_a_minus_d_limbs_bounded._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_invsqrt_a_minus_d_limbs_bounded._definition
)))

;; Function-Specs curve25519_dalek::lemmas::field_lemmas::constants_lemmas::lemma_sqrt_ad_minus_one_limbs_bounded
(declare-fun ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_sqrt_ad_minus_one_limbs_bounded.
 (Int) Bool
)
(assert
 (forall ((no%param Int)) (!
   (= (ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_sqrt_ad_minus_one_limbs_bounded.
     no%param
    ) (and
     (curve25519_dalek!specs.field_specs.fe51_limbs_bounded.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
   ...
   :pattern ((ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_sqrt_ad_minus_one_limbs_bounded.
     no%param
   ))
   :qid internal_ens__curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_sqrt_ad_minus_one_limbs_bounded._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_sqrt_ad_minus_one_limbs_bounded._definition
)))

;; Function-Specs curve25519_dalek::lemmas::field_lemmas::constants_lemmas::lemma_one_minus_d_squared_limbs_bounded
(declare-fun ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_one_minus_d_squared_limbs_bounded.
 (Int) Bool
)
(assert
 (forall ((no%param Int)) (!
   (= (ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_one_minus_d_squared_limbs_bounded.
     no%param
    ) (and
     (curve25519_dalek!specs.field_specs.fe51_limbs_bounded.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
       curve25519_dalek!backend.serial.u64.constants.ONE_MINUS_EDWARDS_D_SQUARED.?
   ...
   :pattern ((ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_one_minus_d_squared_limbs_bounded.
     no%param
   ))
   :qid internal_ens__curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_one_minus_d_squared_limbs_bounded._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_one_minus_d_squared_limbs_bounded._definition
)))

;; Function-Specs curve25519_dalek::lemmas::field_lemmas::constants_lemmas::lemma_d_minus_one_squared_limbs_bounded
(declare-fun ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_d_minus_one_squared_limbs_bounded.
 (Int) Bool
)
(assert
 (forall ((no%param Int)) (!
   (= (ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_d_minus_one_squared_limbs_bounded.
     no%param
    ) (and
     (curve25519_dalek!specs.field_specs.fe51_limbs_bounded.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
       curve25519_dalek!backend.serial.u64.constants.EDWARDS_D_MINUS_ONE_SQUARED.?
   ...
   :pattern ((ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_d_minus_one_squared_limbs_bounded.
     no%param
   ))
   :qid internal_ens__curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_d_minus_one_squared_limbs_bounded._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_d_minus_one_squared_limbs_bounded._definition
)))

;; Function-Specs curve25519_dalek::lemmas::field_lemmas::constants_lemmas::lemma_sqrt_ad_minus_one_nonzero
(declare-fun ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_sqrt_ad_minus_one_nonzero.
 (Int) Bool
)
(assert
 (forall ((no%param Int)) (!
   (= (ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_sqrt_ad_minus_one_nonzero.
     no%param
    ) (and
     ...
     (not (= (EucMod (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
          curve25519_dalek!backend.serial.u64.constants.SQRT_AD_MINUS_ONE.?
         )
        ) (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
       ) 0
   ))))
   :pattern ((ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_sqrt_ad_minus_one_nonzero.
     no%param
   ))
   :qid internal_ens__curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_sqrt_ad_minus_one_nonzero._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_sqrt_ad_minus_one_nonzero._definition
)))

;; Function-Def curve25519_dalek::lemmas::field_lemmas::constants_lemmas::lemma_sqrt_ad_minus_one_nonzero
;; curve25519-dalek/src/lemmas/field_lemmas/constants_lemmas.rs:505:1: 505:47 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (not (= (EucMod (curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_u5_nat.?
        (Poly%array%. (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
       ...
       ) (curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_p.? (I 0))
      ) 0
    ))
    (=>
     (= (curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_pow2.? (I 51)) 2251799813685248)
     (and
      (=>
      ...
      (=>
       (= (vstd!arithmetic.power2.pow2.? (I 51)) 2251799813685248)
       (=>
        (= (curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_pow2.? (I 102)) (nClip
          (Mul (curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_pow2.? (I 51)) (
            curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_pow2.? (I 51)
        ))))
        (and
         (=>
          ...
          (=>
           %%location_label%%1
           (= (vstd!arithmetic.power2.pow2.? (I 102)) (nClip (Mul (vstd!arithmetic.power2.pow2.?
               (I 51)
         ...
         (=>
          ...
          (=>
           (= (curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_pow2.? (I 153)) (nClip
             (Mul (curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_pow2.? (I 51)) (
               curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_pow2.? (I 102)
           ))))
           (and
            (=>
             ...
             (=>
              %%location_label%%2
              (= (vstd!arithmetic.power2.pow2.? (I 153)) (nClip (Mul (vstd!arithmetic.power2.pow2.?
                  (I 51)
            ...
            (=>
             ...
             (=>
              (= (curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_pow2.? (I 204)) (nClip
                (Mul (curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_pow2.? (I 51)) (
                  curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_pow2.? (I 153)
              ))))
              (and
               (=>
                ...
                (=>
                 %%location_label%%3
                 (= (vstd!arithmetic.power2.pow2.? (I 204)) (nClip (Mul (vstd!arithmetic.power2.pow2.?
                     (I 51)
               ...
               (=>
                ...
                (=>
                 (= (curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_pow2.? (I 255)) (nClip
                   (Mul (curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_pow2.? (I 51)) (
                     curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_pow2.? (I 204)
                 ))))
                 (and
                  (=>
                   ...
                   (=>
                    %%location_label%%4
                    (= (vstd!arithmetic.power2.pow2.? (I 255)) (nClip (Mul (vstd!arithmetic.power2.pow2.?
                        (I 51)
                  ...
                  (=>
                   ...
                   (=>
                    (= tmp%1 (not (= (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                         curve25519_dalek!backend.serial.u64.constants.SQRT_AD_MINUS_ONE.?
                        )
                       ) 0
                    )))
                    (and
                     ...
                     (=>
                      ...
                      (and
                       (=>
                        (= tmp%2 (curve25519_dalek!specs.field_specs.fe51_as_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                           curve25519_dalek!backend.serial.u64.constants.SQRT_AD_MINUS_ONE.?
                        )))
                        (=>
                         ...
                         (and
                          (=>
                           %%location_label%%6
                           (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%2 tmp%3)
                          )
                          (=>
                           (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%2 tmp%3)
                           (=>
