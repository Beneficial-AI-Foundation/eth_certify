...
;; curve25519-dalek/src/lemmas/field_lemmas/reduce_lemmas.rs:66:1: 66:43 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::reduce_lemmas::proof_reduce
;; curve25519-dalek/src/lemmas/field_lemmas/reduce_lemmas.rs:66:1: 66:43 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= rr@ (curve25519_dalek!specs.field_specs_u64.spec_reduce.? (Poly%array%. limbs!)))
    (and
     (or
      (and
       (=>
        (forall ((i$ Poly)) (!
          ...
          :qid user_curve25519_dalek__lemmas__field_lemmas__reduce_lemmas__proof_reduce_36
          :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__reduce_lemmas__proof_reduce_36
        ))
        (and
         (=>
          (has_type i@ INT)
             ...
             (=>
              ...
              (=>
               ...
               (and
                (=>
                 %%location_label%%1
                 (req%vstd!bits.lemma_u64_low_bits_mask_is_mod. tmp%1 51)
                )
                (=>
                 (ens%vstd!bits.lemma_u64_low_bits_mask_is_mod. tmp%1 51)
                 (=>
         ...
         (=>
          (forall ((i$ Poly)) (!
            ...
            :qid user_curve25519_dalek__lemmas__field_lemmas__reduce_lemmas__proof_reduce_37
            :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__reduce_lemmas__proof_reduce_37
          ))
          (and
           (=>
            (has_type i$1@ INT)
               ...
               (=>
                ...
                (=>
                 ...
                 (and
                  (=>
                   %%location_label%%5
                   (req%vstd!bits.lemma_u64_shr_is_div. tmp%4 51)
                  )
                  (=>
                   (ens%vstd!bits.lemma_u64_shr_is_div. tmp%4 51)
                   (=>
                    ...
                    (=>
                     ...
                     (and
                      (=>
                       %%location_label%%6
                       (req%vstd!arithmetic.div_mod.lemma_basic_div. tmp%5 tmp%6)
                      )
                      (=>
                       (ens%vstd!arithmetic.div_mod.lemma_basic_div. tmp%5 tmp%6)
                       (=>
                        %%location_label%%7
                        (= (uClip 64 (bitshr (I (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (
                                ARRAY $ (UINT 64) $ (CONST_INT 5)
           ...
           (=>
            (forall ((i$ Poly)) (!
              ...
              :qid user_curve25519_dalek__lemmas__field_lemmas__reduce_lemmas__proof_reduce_38
              :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__reduce_lemmas__proof_reduce_38
            ))
            %%switch_label%%0
       )))))
       (=>
       ...
       (=>
        ...
        (=>
         (forall ((i$ Poly)) (!
           ...
           :qid user_curve25519_dalek__lemmas__field_lemmas__reduce_lemmas__proof_reduce_39
           :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__reduce_lemmas__proof_reduce_39
         ))
         (ext_eq false (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. rr@) (Poly%array%.
           limbs!
     ))))))
     (=>
      (=>
       (forall ((i$ Poly)) (!
         ...
         :qid user_curve25519_dalek__lemmas__field_lemmas__reduce_lemmas__proof_reduce_40
         :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__reduce_lemmas__proof_reduce_40
       ))
       (ext_eq false (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. rr@) (Poly%array%.
         limbs!
      )))
      (=>
       (= a0@ (uClip 64 (bitshr (I (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
              $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. limbs!)
             ) (I 0)
           ))
          ) (I 51)
       ...
       (=>
        (= a1@ (uClip 64 (bitshr (I (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
               $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. limbs!)
              ) (I 1)
            ))
           ) (I 51)
        ...
        (=>
         (= a2@ (uClip 64 (bitshr (I (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. limbs!)
               ) (I 2)
             ))
            ) (I 51)
         ...
         (=>
          (= a3@ (uClip 64 (bitshr (I (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                 $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. limbs!)
                ) (I 3)
              ))
             ) (I 51)
          ...
          (=>
           (= a4@ (uClip 64 (bitshr (I (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                  $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. limbs!)
                 ) (I 4)
               ))
              ) (I 51)
           ...
           (=>
            (= b0@ (uClip 64 (bitand (I (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                   $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. limbs!)
                  ) (I 0)
                ))
               ) (I curve25519_dalek!specs.field_specs_u64.mask51.?)
            ...
            (=>
             (= b1@ (uClip 64 (bitand (I (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                    $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. limbs!)
                   ) (I 1)
                 ))
                ) (I curve25519_dalek!specs.field_specs_u64.mask51.?)
             ...
             (=>
              (= b2@ (uClip 64 (bitand (I (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                     $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. limbs!)
                    ) (I 2)
                  ))
                 ) (I curve25519_dalek!specs.field_specs_u64.mask51.?)
              ...
              (=>
               (= b3@ (uClip 64 (bitand (I (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                      $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. limbs!)
                     ) (I 3)
                   ))
                  ) (I curve25519_dalek!specs.field_specs_u64.mask51.?)
               ...
               (=>
                (= b4@ (uClip 64 (bitand (I (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                       $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. limbs!)
                      ) (I 4)
                    ))
                   ) (I curve25519_dalek!specs.field_specs_u64.mask51.?)
                ...
                (=>
                 (ens%curve25519_dalek!lemmas.field_lemmas.reduce_lemmas.lemma_reduce_boundaries. limbs!)
                 (and
                  (=>
                   (= tmp%7 (vstd!arithmetic.power2.pow2.? (I 51)))
                   (=>
                    (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add. tmp%7 a0@ b1@)
                    (=>
                     (= tmp%8 (vstd!arithmetic.power2.pow2.? (I 102)))
                     (=>
                      (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add. tmp%8 a1@ b2@)
                      (=>
                       (= tmp%9 (vstd!arithmetic.power2.pow2.? (I 153)))
                       (=>
                        (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add. tmp%9 a2@ b3@)
                        (=>
                         (= tmp%10 (vstd!arithmetic.power2.pow2.? (I 204)))
                         (=>
                          (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add. tmp%10 a3@ b4@)
                          (=>
                           %%location_label%%9
                           (= (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. rr@)) (Add
                             (Add (Add (Add (Add (Add (Add (Add (Add (Mul 19 a4@) b0@) (Mul (vstd!arithmetic.power2.pow2.?
                                      (I 51)
                                     ) a0@
                                    )
                                   ) (Mul (vstd!arithmetic.power2.pow2.? (I 51)) b1@)
                                  ) (Mul (vstd!arithmetic.power2.pow2.? (I 102)) a1@)
                                 ) (Mul (vstd!arithmetic.power2.pow2.? (I 102)) b2@)
                                ) (Mul (vstd!arithmetic.power2.pow2.? (I 153)) a2@)
                               ) (Mul (vstd!arithmetic.power2.pow2.? (I 153)) b3@)
                              ) (Mul (vstd!arithmetic.power2.pow2.? (I 204)) a3@)
                             ) (Mul (vstd!arithmetic.power2.pow2.? (I 204)) b4@)
                  )))))))))))
                  (=>
                   (= (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. rr@)) (Add
                     (Add (Add (Add (Add (Add (Add (Add (Add (Mul 19 a4@) b0@) (Mul (vstd!arithmetic.power2.pow2.?
                   ...
                   (and
                    (=>
                     (ens%curve25519_dalek!lemmas.field_lemmas.pow2_51_lemmas.lemma_two_factoring_51. 51
                      a1@
                     )
                     (=>
                      (ens%curve25519_dalek!lemmas.field_lemmas.pow2_51_lemmas.lemma_two_factoring_51. 102
                       a2@
                      )
                      (=>
                       (ens%curve25519_dalek!lemmas.field_lemmas.pow2_51_lemmas.lemma_two_factoring_51. 153
                        a3@
                       )
                       (=>
                        %%location_label%%10
                        (= (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. rr@)) (Add
                          (Add (Add (Add (Add (Add (Add (Add (Add (Mul 19 a4@) b0@) (Mul (vstd!arithmetic.power2.pow2.?
                               ...
                               ) (Mul (vstd!arithmetic.power2.pow2.? (I 51)) (Mul (vstd!arithmetic.power2.pow2.? (I
                                   51
                                  )
                                 ) a1@
                               ))
                              ) (Mul (vstd!arithmetic.power2.pow2.? (I 102)) b2@)
                             ) (Mul (vstd!arithmetic.power2.pow2.? (I 102)) (Mul (vstd!arithmetic.power2.pow2.? (
                                 I 51
                                )
                               ) a2@
                             ))
                            ) (Mul (vstd!arithmetic.power2.pow2.? (I 153)) b3@)
                           ) (Mul (vstd!arithmetic.power2.pow2.? (I 153)) (Mul (vstd!arithmetic.power2.pow2.? (
                               I 51
                              )
                             ) a3@
                           ))
                    ...
                    (=>
                     ...
                     (and
                      (=>
                       (= tmp%11 (vstd!arithmetic.power2.pow2.? (I 51)))
                       (=>
                        (= tmp%12 (Mul (vstd!arithmetic.power2.pow2.? (I 51)) a1@))
                        (=>
                         (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add. tmp%11 b1@ tmp%12)
                         (=>
                          (= tmp%13 (vstd!arithmetic.power2.pow2.? (I 102)))
                          (=>
                           (= tmp%14 (Mul (vstd!arithmetic.power2.pow2.? (I 51)) a2@))
                           (=>
                            (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add. tmp%13 b2@ tmp%14)
                            (=>
                             (= tmp%15 (vstd!arithmetic.power2.pow2.? (I 153)))
                             (=>
                              (= tmp%16 (Mul (vstd!arithmetic.power2.pow2.? (I 51)) a3@))
                              (=>
                               (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add. tmp%15 b3@ tmp%16)
                               (=>
                                %%location_label%%11
                                (= (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. rr@)) (Add
                                  (Add (Add (Add (Add (Add b0@ (Mul (vstd!arithmetic.power2.pow2.? (I 51)) a0@)) (Mul (vstd!arithmetic.power2.pow2.?
                                        (I 51)
                                       ) (Add b1@ (Mul (vstd!arithmetic.power2.pow2.? (I 51)) a1@))
                                      )
                                     ) (Mul (vstd!arithmetic.power2.pow2.? (I 102)) (Add b2@ (Mul (vstd!arithmetic.power2.pow2.?
                                         (I 51)
                                        ) a2@
                                     )))
                                    ) (Mul (vstd!arithmetic.power2.pow2.? (I 153)) (Add b3@ (Mul (vstd!arithmetic.power2.pow2.?
                                        (I 51)
                                       ) a3@
                                    )))
                                   ) (Mul (vstd!arithmetic.power2.pow2.? (I 204)) b4@)
                                  ...
                                  (and
                                   ...
                                   (=>
                                    ...
                                    (=>
                                     %%location_label%%16
                                     (= (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. rr@)) (Add
                                       (Add (Add (Add (Add (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY
                                               $ (UINT 64) $ (CONST_INT 5)
                                              ) (Poly%array%. limbs!)
                                             ) (I 0)
                                            )
                                           ) (Mul (vstd!arithmetic.power2.pow2.? (I 51)) (%I (vstd!seq.Seq.index.? $ (UINT 64)
                                              (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. limbs!))
                                              (I 1)
                                           )))
                                          ) (Mul (vstd!arithmetic.power2.pow2.? (I 102)) (%I (vstd!seq.Seq.index.? $ (UINT 64)
                                             (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. limbs!))
                                             (I 2)
                                          )))
                                         ) (Mul (vstd!arithmetic.power2.pow2.? (I 153)) (%I (vstd!seq.Seq.index.? $ (UINT 64)
                                            (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. limbs!))
                                            (I 3)
                                         )))
                                        ) (Mul (vstd!arithmetic.power2.pow2.? (I 204)) b4@)
                            ...
                            (=>
                             ...
                             (and
                              (=>
                               ...
                               (=>
                                (= tmp%23 (Mul (vstd!arithmetic.power2.pow2.? (I 51)) a4@))
                                (=>
                                 (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add. tmp%22 tmp%23 b4@)
                                 (=>
                                  %%location_label%%18
                                  (= (Mul (vstd!arithmetic.power2.pow2.? (I 204)) (%I (vstd!seq.Seq.index.? $ (UINT 64)
                                      (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. limbs!))
                                      (I 4)
                                    ))
                                   ) (Add (Mul (vstd!arithmetic.power2.pow2.? (I 204)) b4@) (Mul (vstd!arithmetic.power2.pow2.?
                                      (I 204)
                                     ) (Mul (vstd!arithmetic.power2.pow2.? (I 51)) a4@)
                              )))))))
                              (=>
                               (= (Mul (vstd!arithmetic.power2.pow2.? (I 204)) (%I (vstd!seq.Seq.index.? $ (UINT 64)
                                   (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. limbs!))
                               ...
                               (=>
                                %%location_label%%19
                                (= (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. rr@)) (Add
                                  (Sub (Add (Add (Add (Add (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (
                                           ARRAY $ (UINT 64) $ (CONST_INT 5)
                                          ) (Poly%array%. limbs!)
                                         ) (I 0)
                                        )
                                   ...
                                   ) (Mul (vstd!arithmetic.power2.pow2.? (I 204)) (Mul (vstd!arithmetic.power2.pow2.? (
                                       I 51
                                      )
                                     ) a4@
                                   ))
                          ...
                          (=>
                           ...
                           (and
                            (=>
                             ...
                             (=>
                              (= tmp%25 (vstd!arithmetic.power2.pow2.? (I 51)))
                              (=>
                               (ens%vstd!arithmetic.mul.lemma_mul_is_associative. tmp%24 tmp%25 a4@)
                               (=>
                                (ens%vstd!arithmetic.power2.lemma_pow2_adds. 204 51)
                                (=>
                                 (= tmp%26 (vstd!arithmetic.power2.pow2.? (I 255)))
                                 (=>
                                  (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub_other_way. a4@ tmp%26 19)
                                  (=>
                                   (ens%curve25519_dalek!specs.field_specs_u64.pow255_gt_19. 0)
                                   (=>
                                    %%location_label%%20
                                    (= (Sub (Mul (vstd!arithmetic.power2.pow2.? (I 204)) (Mul (vstd!arithmetic.power2.pow2.?
                                         (I 51)
                                        ) a4@
                                       )
                                      ) (Mul 19 a4@)
                                     ) (Mul (curve25519_dalek!specs.field_specs_u64.p.? (I 0)) a4@)
                            )))))))))
                            (=>
                             (= (Sub (Mul (vstd!arithmetic.power2.pow2.? (I 204)) (Mul (vstd!arithmetic.power2.pow2.?
                                  (I 51)
                             ...
                             (=>
                              (ens%curve25519_dalek!specs.field_specs_u64.pow255_gt_19. 0)
                              (=>
                               (= tmp%27 (uClip 64 (bitshr (I (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                                      $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. limbs!)
                                     ) (I 4)
                                   ))
                                  ) (I 51)
                               ...
                               (=>
                                (= tmp%28 (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. (curve25519_dalek!specs.field_specs_u64.spec_reduce.?
                                    (Poly%array%. limbs!)
                                ))))
                                (=>
                                 ...
                                 (and
                                  (=>
                                   %%location_label%%21
                                   (req%vstd!arithmetic.div_mod.lemma_mod_multiples_vanish. tmp%27 tmp%28 tmp%29)
                                  )
                                  (=>
                                   (ens%vstd!arithmetic.div_mod.lemma_mod_multiples_vanish. tmp%27 tmp%28 tmp%29)
                                   (and
                                    (=>
                                     %%location_label%%22
                                     (forall ((i$ Poly)) (!
                                       ...
                                       :qid user_curve25519_dalek__lemmas__field_lemmas__reduce_lemmas__proof_reduce_34
                                       :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__reduce_lemmas__proof_reduce_34
                                    )))
                                    (and
                                     (=>
                                      %%location_label%%23
                                      (=>
                                       (forall ((i$ Poly)) (!
                                         ...
                                         :qid user_curve25519_dalek__lemmas__field_lemmas__reduce_lemmas__proof_reduce_35
                                         :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__reduce_lemmas__proof_reduce_35
                                       ))
                                       (ext_eq false (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. (curve25519_dalek!specs.field_specs_u64.spec_reduce.?
                                          (Poly%array%. limbs!)
                                         )
