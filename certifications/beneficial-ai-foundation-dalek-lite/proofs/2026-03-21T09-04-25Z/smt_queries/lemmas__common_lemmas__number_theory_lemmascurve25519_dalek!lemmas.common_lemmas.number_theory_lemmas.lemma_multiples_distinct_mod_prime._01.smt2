...
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:1666:1: 1666:80 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::number_theory_lemmas::lemma_multiples_distinct_mod_prime
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:1666:1: 1666:80 (#0)
...
(push)
 ...
 (assert
  (not (or
    (and
     (=>
      (= (EucMod (nClip (Mul a! i!)) p!) (EucMod (nClip (Mul a! j!)) p!))
      (=>
       (= diff@ (nClip (Sub j! i!)))
       (=>
        (= tmp%1 (let
        ...
        (and
         ...
         (=>
          ...
          (and
           (=>
            (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub. a! j! i!)
            (=>
             %%location_label%%1
             (= (Sub (nClip (Mul a! j!)) (nClip (Mul a! i!))) (nClip (Mul a! diff@)))
           ))
           (=>
            (= (Sub (nClip (Mul a! j!)) (nClip (Mul a! i!))) (nClip (Mul a! diff@)))
            (and
             ...
             (=>
              ...
              (and
               (and
                (=>
                 %%location_label%%4
                 (req%vstd!arithmetic.div_mod.lemma_small_mod. diff@ p!)
                )
                (=>
                 (ens%vstd!arithmetic.div_mod.lemma_small_mod. diff@ p!)
                 (=>
                  %%location_label%%5
                  (= (EucMod diff@ p!) diff@)
               )))
