...
;; curve25519-dalek/src/lemmas/edwards_lemmas/straus_lemmas.rs:576:5: 576:11 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::straus_lemmas::lemma_naf_digit_negative_select_preconditions_width8
;; curve25519-dalek/src/lemmas/edwards_lemmas/straus_lemmas.rs:576:5: 576:11 (#0)
...
(assert
 (bvslt digit! ((_ zero_extend 7) (_ bv0 1)))
)
(assert
 (bvsgt digit! (_ bv128 8))
)
(assert
 (not (= (let
    ...
    (ite
     ...
     tmp$$$$bitvectmp1
     (ite
      (bvslt (bvsrem digit! ((_ zero_extend 6) tmp$$$$bitvectmp0)) (_ bv0 8))
      (bvadd (bvsrem digit! ((_ zero_extend 6) tmp$$$$bitvectmp0)) (ite
        (bvslt ((_ zero_extend 6) tmp$$$$bitvectmp0) (_ bv0 8))
        (bvneg ((_ zero_extend 6) tmp$$$$bitvectmp0))
        ((_ zero_extend 6) tmp$$$$bitvectmp0)
      ))
      (bvsrem digit! ((_ zero_extend 6) tmp$$$$bitvectmp0))
    ))
...
(assert
 (not (=>
   %%location_label%%0
   (= (bvand ((_ sign_extend 23) (bvsub ((_ zero_extend 8) (_ bv0 1)) ((_ sign_extend 1)
        digit!
      ))
