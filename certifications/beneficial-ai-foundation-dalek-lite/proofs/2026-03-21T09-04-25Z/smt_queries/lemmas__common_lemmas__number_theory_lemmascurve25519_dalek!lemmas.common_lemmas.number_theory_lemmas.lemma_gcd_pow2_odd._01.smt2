...
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:393:1: 393:48 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::number_theory_lemmas::lemma_gcd_pow2_odd
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:393:1: 393:48 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= g@ (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.spec_gcd.? (I (vstd!arithmetic.power2.pow2.?
        (I k!)
       )
      ) (I n!)
    ))
    (and
     (=>
      ...
      (=>
       %%location_label%%0
       (> (vstd!arithmetic.power2.pow2.? (I k!)) 0)
     ))
     (=>
      (> (vstd!arithmetic.power2.pow2.? (I k!)) 0)
      (=>
       (= tmp%1 (vstd!arithmetic.power2.pow2.? (I k!)))
       (and
        (=>
         %%location_label%%1
         (req%curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.lemma_gcd_positive.
        ...
        (=>
         ...
         (=>
          (= tmp%2 (vstd!arithmetic.power2.pow2.? (I k!)))
          (=>
           (ens%curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.lemma_gcd_divides_both.
            tmp%2 n!
           )
