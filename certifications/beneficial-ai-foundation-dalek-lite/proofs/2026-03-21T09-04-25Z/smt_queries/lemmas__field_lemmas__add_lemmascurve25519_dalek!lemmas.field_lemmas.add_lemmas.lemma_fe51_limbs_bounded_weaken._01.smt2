...
;; curve25519-dalek/src/lemmas/field_lemmas/add_lemmas.rs:133:9: 133:15 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::add_lemmas::lemma_fe51_limbs_bounded_weaken
;; curve25519-dalek/src/lemmas/field_lemmas/add_lemmas.rs:133:9: 133:15 (#0)
...
(assert
 (bvule b! ((_ zero_extend 58) (_ bv63 6)))
)
...
(assert
 (not (=>
   %%location_label%%0
   (bvult (bvshl ((_ zero_extend 63) (_ bv1 1)) a!) (bvshl ((_ zero_extend 63) (_ bv1 1))
     b!
)))))
(get-info :version)
