...
;; curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:126:1: 126:57 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::pow_lemmas::lemma_two_factoring
;; curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:126:1: 126:57 (#0)
...
(push)
 ...
 (assert
  (not (=>
    ...
    (=>
     (= tmp%1 (vstd!arithmetic.power2.pow2.? (I a!)))
     (=>
      (= tmp%2 (vstd!arithmetic.power2.pow2.? (I b!)))
      (=>
       (ens%vstd!arithmetic.mul.lemma_mul_is_associative. tmp%1 tmp%2 v!)
       (=>
        %%location_label%%0
        (= (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Add a! b!)))) v!) (Mul (vstd!arithmetic.power2.pow2.?
           (I a!)
