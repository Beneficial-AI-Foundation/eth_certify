...
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_m1_lemmas.rs:419:1: 419:59 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::sqrt_m1_lemmas::lemma_neg_u_times_inv_iu_is_i
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_m1_lemmas.rs:419:1: 419:59 (#0)
...
(push)
 ...
 (declare-const p@ Int)
 (declare-const neg_u@ Int)
 (declare-const iu@ Int)
 (declare-const ui@ Int)
 (declare-const inv_iu@ Int)
 (declare-const inv_ui@ Int)
    ...
    (=>
     ...
     (=>
      ...
      (=>
       (= iu@ (curve25519_dalek!specs.field_specs.field_mul.? (I i!) (I u!)))
       (=>
        (= ui@ (curve25519_dalek!specs.field_specs.field_mul.? (I u!) (I i!)))
        (=>
         (= inv_iu@ (curve25519_dalek!specs.field_specs.field_inv.? (I iu@)))
         (=>
          (= inv_ui@ (curve25519_dalek!specs.field_specs.field_inv.? (I ui@)))
          (=>
               ...
               (and
                (and
                 ...
                 (=>
                  ...
                  (=>
                   %%location_label%%2
                   (= (curve25519_dalek!specs.field_specs.field_mul.? (I neg_u@) (I inv_ui@)) (curve25519_dalek!specs.field_specs.field_mul.?
                     (I neg_one@) (I inv_i@)
                )))))
                (=>
                 (= (curve25519_dalek!specs.field_specs.field_mul.? (I neg_u@) (I inv_ui@)) (curve25519_dalek!specs.field_specs.field_mul.?
                    ...
                    (=>
                     ...
                     (and
                      ...
                      (=>
                       ...
                       (and
                        (=>
                         (= tmp%2 (curve25519_dalek!specs.field_specs.field_neg.? (I i!)))
                         (=>
                          (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_neg_one_times_is_neg.
                           tmp%2
                          )
                          (=>
                           ...
                           (and
                            ...
                            (=>
                             ...
                             (=>
                              %%location_label%%8
                              (= (curve25519_dalek!specs.field_specs.field_mul.? (I neg_one@) (I neg_i@)) i!)
                        ))))))
                        (=>
                         (= (curve25519_dalek!specs.field_specs.field_mul.? (I neg_one@) (I neg_i@)) i!)
                         (and
