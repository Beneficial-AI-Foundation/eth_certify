...
;; curve25519-dalek/src/backend/serial/scalar_mul/pippenger.rs:763:17: 763:23 (#0)
...
;; Function-Specs curve25519_dalek::scalar::Scalar::to_radix_2w_size_hint
(declare-fun req%curve25519_dalek!scalar.impl&%52.to_radix_2w_size_hint. (Int) Bool)
(declare-const %%global_location_label%%59 Bool)
(assert
 (forall ((w! Int)) (!
   (= (req%curve25519_dalek!scalar.impl&%52.to_radix_2w_size_hint. w!) (=>
   ...
   :pattern ((req%curve25519_dalek!scalar.impl&%52.to_radix_2w_size_hint. w!))
   :qid internal_req__curve25519_dalek!scalar.impl&__52.to_radix_2w_size_hint._definition
   :skolemid skolem_internal_req__curve25519_dalek!scalar.impl&__52.to_radix_2w_size_hint._definition
)))
(declare-fun ens%curve25519_dalek!scalar.impl&%52.to_radix_2w_size_hint. (Int Int)
 Bool
)
(assert
 (forall ((w! Int) (%return! Int)) (!
   (= (ens%curve25519_dalek!scalar.impl&%52.to_radix_2w_size_hint. w! %return!) (and
     (uInv SZ %return!)
     (= %return! (uClip SZ (ite
        (< w! 8)
        (EucDiv (Sub (Add 256 w!) 1) w!)
   ...
   :pattern ((ens%curve25519_dalek!scalar.impl&%52.to_radix_2w_size_hint. w! %return!))
   :qid internal_ens__curve25519_dalek!scalar.impl&__52.to_radix_2w_size_hint._definition
   :skolemid skolem_internal_ens__curve25519_dalek!scalar.impl&__52.to_radix_2w_size_hint._definition
)))
...
;; Function-Specs curve25519_dalek::lemmas::edwards_lemmas::pippenger_lemmas::lemma_pippenger_horner_correct
(declare-fun req%curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.lemma_pippenger_horner_correct.
 (vstd!seq.Seq<curve25519_dalek!scalar.Scalar.>. vstd!seq.Seq<curve25519_dalek!edwards.EdwardsPoint.>.
  vstd!seq.Seq<tuple%2<nat./nat.>.>. vstd!seq.Seq<vstd!seq.Seq<i8.>.>. Int Int
 ) Bool
)
...
(assert
 (forall ((scalars! vstd!seq.Seq<curve25519_dalek!scalar.Scalar.>.) (points_ep! vstd!seq.Seq<curve25519_dalek!edwards.EdwardsPoint.>.)
   ...
   (w! Int) (digits_count! Int)
  ) (!
   (= (req%curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.lemma_pippenger_horner_correct.
     scalars! points_ep! points_affine! digits! w! digits_count!
    ) (and
     (=>
     ...
     (=>
      ...
      (forall ((k$ Poly)) (!
        ...
        :qid user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_pippenger_horner_correct_101
        :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_pippenger_horner_correct_101
     )))
     (=>
      ...
      (forall ((k$ Poly)) (!
        (=>
         ...
         (=>
          ...
          (and
           ...
           (= (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w_from.? (vstd!seq.Seq.index.?
        ...
        :qid user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_pippenger_horner_correct_102
        :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_pippenger_horner_correct_102
   )))))
   :pattern ((req%curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.lemma_pippenger_horner_correct.
     scalars! points_ep! points_affine! digits! w! digits_count!
   ))
   :qid internal_req__curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.lemma_pippenger_horner_correct._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.lemma_pippenger_horner_correct._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.lemma_pippenger_horner_correct.
 (vstd!seq.Seq<curve25519_dalek!scalar.Scalar.>. vstd!seq.Seq<curve25519_dalek!edwards.EdwardsPoint.>.
  vstd!seq.Seq<tuple%2<nat./nat.>.>. vstd!seq.Seq<vstd!seq.Seq<i8.>.>. Int Int
 ) Bool
)
(assert
 (forall ((scalars! vstd!seq.Seq<curve25519_dalek!scalar.Scalar.>.) (points_ep! vstd!seq.Seq<curve25519_dalek!edwards.EdwardsPoint.>.)
   ...
   (= (ens%curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.lemma_pippenger_horner_correct.
     scalars! points_ep! points_affine! digits! w! digits_count!
    ) (= (curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.pippenger_horner.? (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>.
       points_affine!
      ) (Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>. digits!) (I 0) (I w!) (I digits_count!)
   ...
   :pattern ((ens%curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.lemma_pippenger_horner_correct.
     scalars! points_ep! points_affine! digits! w! digits_count!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.lemma_pippenger_horner_correct._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.lemma_pippenger_horner_correct._definition
)))

;; Function-Specs curve25519_dalek::backend::serial::scalar_mul::pippenger::Pippenger::optional_multiscalar_mul_verus
(declare-fun req%curve25519_dalek!backend.serial.scalar_mul.pippenger.impl&%1.optional_multiscalar_mul_verus.
...
(assert
 (forall ((S&. Dcr) (S& Type) (I&. Dcr) (I& Type) (J&. Dcr) (J& Type) (scalars! Poly)
   ...
   (= (req%curve25519_dalek!backend.serial.scalar_mul.pippenger.impl&%1.optional_multiscalar_mul_verus.
     ...
     (=>
      ...
      (forall ((i$ Poly)) (!
        ...
        :qid user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__optional_multiscalar_mul_verus_103
        :skolemid skolem_user_curve25519_dalek__backend__serial__scalar_mul__pippenger__Pippenger__optional_multiscalar_mul_verus_103
   )))))
   :pattern ((req%curve25519_dalek!backend.serial.scalar_mul.pippenger.impl&%1.optional_multiscalar_mul_verus.
     S&. S& I&. I& J&. J& scalars! points!
   ))
   :qid internal_req__curve25519_dalek!backend.serial.scalar_mul.pippenger.impl&__1.optional_multiscalar_mul_verus._definition
   :skolemid skolem_internal_req__curve25519_dalek!backend.serial.scalar_mul.pippenger.impl&__1.optional_multiscalar_mul_verus._definition
)))
(declare-fun ens%curve25519_dalek!backend.serial.scalar_mul.pippenger.impl&%1.optional_multiscalar_mul_verus.
...
(assert
 (forall ((S&. Dcr) (S& Type) (I&. Dcr) (I& Type) (J&. Dcr) (J& Type) (scalars! Poly)
   ...
   (= (ens%curve25519_dalek!backend.serial.scalar_mul.pippenger.impl&%1.optional_multiscalar_mul_verus.
   ...
   :pattern ((ens%curve25519_dalek!backend.serial.scalar_mul.pippenger.impl&%1.optional_multiscalar_mul_verus.
     S&. S& I&. I& J&. J& scalars! points! result!
   ))
   :qid internal_ens__curve25519_dalek!backend.serial.scalar_mul.pippenger.impl&__1.optional_multiscalar_mul_verus._definition
   :skolemid skolem_internal_ens__curve25519_dalek!backend.serial.scalar_mul.pippenger.impl&__1.optional_multiscalar_mul_verus._definition
)))

;; Function-Def curve25519_dalek::backend::serial::scalar_mul::pippenger::Pippenger::optional_multiscalar_mul_verus
;; curve25519-dalek/src/backend/serial/scalar_mul/pippenger.rs:763:17: 763:23 (#0)
