...
;; curve25519-dalek/src/lemmas/field_lemmas/u64_5_as_nat_lemmas.rs:471:1: 471:57 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::u64_5_as_nat_lemmas::lemma_fe51_unit_is_one
;; curve25519-dalek/src/lemmas/field_lemmas/u64_5_as_nat_lemmas.rs:471:1: 471:57 (#0)
  ...
  (not (and
    (=>
     ...
     (=>
      ...
      (=>
       (ens%vstd!arithmetic.mul.lemma_mul_by_zero_is_zero. tmp%1)
       (=>
        (= tmp%2 (vstd!arithmetic.power2.pow2.? (I 102)))
        (=>
         (ens%vstd!arithmetic.mul.lemma_mul_by_zero_is_zero. tmp%2)
         (=>
          (= tmp%3 (vstd!arithmetic.power2.pow2.? (I 153)))
          (=>
           (ens%vstd!arithmetic.mul.lemma_mul_by_zero_is_zero. tmp%3)
           (=>
            (= tmp%4 (vstd!arithmetic.power2.pow2.? (I 204)))
            (=>
             (ens%vstd!arithmetic.mul.lemma_mul_by_zero_is_zero. tmp%4)
             (=>
              %%location_label%%0
