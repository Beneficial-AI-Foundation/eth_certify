...
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_ratio_lemmas.rs:475:1: 475:66 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::sqrt_ratio_lemmas::lemma_sqrt_ratio_check_value
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_ratio_lemmas.rs:475:1: 475:66 (#0)
...
(push)
 ...
 (declare-const k@ Int)
 (declare-const pow_w_k@ Int)
 (declare-const b@ Int)
 (declare-const r@ Int)
 (declare-const check@ Int)
 (declare-const quarter@ Int)
 (declare-const sq_uv3@ Int)
 (declare-const sq_b@ Int)
 (declare-const two_k@ Int)
 (assert
  fuel_defaults
 )
 (assert
        ...
        (=>
         ...
         (=>
          ...
          (and
           (=>
            %%location_label%%0
            (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow_nonnegative. w@ k@)
           )
           (=>
            (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow_nonnegative. w@ k@)
            (=>
             (= pow_w_k@ (vstd!arithmetic.power.pow.? (I w@) (I k@)))
             (=>
              (= b@ (EucMod (nClip pow_w_k@) pn@))
              (=>
               (= r@ (curve25519_dalek!specs.field_specs.field_mul.? (I uv3@) (I b@)))
               (=>
                (= check@ (curve25519_dalek!specs.field_specs.field_mul.? (I v_val!) (I (curve25519_dalek!specs.field_specs.field_square.?
                    (I r@)
                ))))
                (=>
                 ...
                 (=>
                  ...
                  (=>
                   (= sq_uv3@ (curve25519_dalek!specs.field_specs.field_square.? (I uv3@)))
                   (=>
                    (= sq_b@ (curve25519_dalek!specs.field_specs.field_square.? (I b@)))
                    (=>
                     (= tmp%1 (= (curve25519_dalek!specs.field_specs.field_square.? (I r@)) (curve25519_dalek!specs.field_specs.field_mul.?
                        (I sq_uv3@) (I sq_b@)
                     )))
                     (and
                      (=>
                      ...
                      (=>
                       ...
                       (and
                        (=>
                         ...
                         (=>
                          %%location_label%%2
                          (= check@ (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                              (I v_val!) (I sq_uv3@)
                             )
                            ) (I sq_b@)
                        ))))
                        (=>
                         ...
                         (=>
                          ...
                          (=>
                           (= tmp%2 (= (curve25519_dalek!specs.field_specs.field_mul.? (I v_val!) (I sq_uv3@))
                             (curve25519_dalek!specs.field_specs.field_mul.? (I u_val!) (I w@))
                           ))
                           (and
                            (=>
                            ...
                            (=>
                             tmp%2
                             (=>
                              (= tmp%3 (= check@ (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                                   (I u_val!) (I w@)
                                  )
                                 ) (I sq_b@)
                              )))
                               ...
                               (=>
                                ...
                                (and
                                 ...
                                 (=>
                                  ...
                                  (=>
                                   (= tmp%4 (= sq_b@ (EucMod (nClip (vstd!arithmetic.power.pow.? (I w@) (I (nClip (Mul 2 k@)))))
                                      pn@
                                   )))
                                   (and
                                    (=>
                                    ...
                                    (=>
                                     ...
                                     (and
                                      (=>
                                       ...
                                       (=>
                                        %%location_label%%7
                                        (= check@ (curve25519_dalek!specs.field_specs.field_mul.? (I u_val!) (I (curve25519_dalek!specs.field_specs.field_mul.?
                                            (I w@) (I sq_b@)
                                      ))))))
                                      (=>
                                       (= check@ (curve25519_dalek!specs.field_specs.field_mul.? (I u_val!) (I (curve25519_dalek!specs.field_specs.field_mul.?
                                       ...
                                       (=>
                                        ...
                                        (and
                                         (=>
                                          %%location_label%%8
                                          (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow_nonnegative. w@ two_k@)
                                         )
                                         (=>
                                          (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow_nonnegative. w@ two_k@)
                                          (and
                                           (=>
                                            (= tmp%5 (nClip (vstd!arithmetic.power.pow.? (I w@) (I two_k@))))
                                            (and
                                             (=>
                                              %%location_label%%9
                                              (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. w@ tmp%5 pn@)
                                             )
                                             (=>
                                              (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. w@ tmp%5 pn@)
                                              (and
                                               (=>
                                                (ens%vstd!arithmetic.power.lemma_pow1. w@)
                                                (=>
                                                 %%location_label%%10
                                                 (= (Mul w@ (vstd!arithmetic.power.pow.? (I w@) (I two_k@))) (Mul (vstd!arithmetic.power.pow.?
                                                    (I w@) (I 1)
                                                   ) (vstd!arithmetic.power.pow.? (I w@) (I two_k@))
                                               ))))
                                               (=>
                                                (= (Mul w@ (vstd!arithmetic.power.pow.? (I w@) (I two_k@))) (Mul (vstd!arithmetic.power.pow.?
                                                   (I w@) (I 1)
                                                ...
                                                (=>
                                                 (ens%vstd!arithmetic.power.lemma_pow_adds. w@ 1 two_k@)
                                                 (=>
                                                  (= tmp%6 (nClip (Add two_k@ 1)))
                                                  (and
                                                   (=>
                                                    %%location_label%%11
                                                    (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow_nonnegative. w@ tmp%6)
                                                   )
                                                   (=>
                                                    (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow_nonnegative. w@ tmp%6)
                                                    (=>
                                                     %%location_label%%12
                                                     (= (curve25519_dalek!specs.field_specs.field_mul.? (I w@) (I sq_b@)) (EucMod (nClip
                                                        (vstd!arithmetic.power.pow.? (I w@) (I (nClip (Add two_k@ 1))))
                                                       ) pn@
                                           ))))))))))))
                                           (=>
                                            (= (curve25519_dalek!specs.field_specs.field_mul.? (I w@) (I sq_b@)) (EucMod (nClip
