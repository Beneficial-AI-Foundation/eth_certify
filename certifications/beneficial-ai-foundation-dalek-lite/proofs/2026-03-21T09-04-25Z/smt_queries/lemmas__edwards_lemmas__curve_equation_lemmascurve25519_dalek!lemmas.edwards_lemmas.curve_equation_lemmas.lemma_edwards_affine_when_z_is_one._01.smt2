...
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:3109:1: 3109:92 (#0)
...
;; Function-Specs curve25519_dalek::lemmas::edwards_lemmas::curve_equation_lemmas::lemma_edwards_to_montgomery_correspondence
(declare-fun req%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_edwards_to_montgomery_correspondence.
 (Int Int) Bool
)
(declare-const %%global_location_label%%108 Bool)
(assert
 (forall ((y! Int) (z! Int)) (!
   (= (req%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_edwards_to_montgomery_correspondence.
     y! z!
    ) (=>
     %%global_location_label%%108
     (not (= (EucMod z! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0))
   ))
   :pattern ((req%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_edwards_to_montgomery_correspondence.
     y! z!
   ))
   :qid internal_req__curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_edwards_to_montgomery_correspondence._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_edwards_to_montgomery_correspondence._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_edwards_to_montgomery_correspondence.
 (Int Int) Bool
)
(assert
 (forall ((y! Int) (z! Int)) (!
   (= (ens%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_edwards_to_montgomery_correspondence.
     y! z!
    ) (let
     ((y_affine$ (curve25519_dalek!specs.field_specs.field_mul.? (I y!) (I (curve25519_dalek!specs.field_specs.field_inv.?
          (I z!)
     )))))
     (let
      ((one_plus_y$ (curve25519_dalek!specs.field_specs.field_add.? (I 1) (I y_affine$))))
      (let
       ((one_minus_y$ (curve25519_dalek!specs.field_specs.field_sub.? (I 1) (I y_affine$))))
       (let
        ((projective_result$ (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_add.?
             (I z!) (I y!)
            )
        ...
        (let
         ((affine_result$ (curve25519_dalek!specs.field_specs.field_mul.? (I one_plus_y$) (I (
              curve25519_dalek!specs.field_specs.field_inv.? (I one_minus_y$)
         )))))
         (= projective_result$ affine_result$)
   ))))))
   :pattern ((ens%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_edwards_to_montgomery_correspondence.
     y! z!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_edwards_to_montgomery_correspondence._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_edwards_to_montgomery_correspondence._definition
)))

;; Function-Specs curve25519_dalek::lemmas::edwards_lemmas::curve_equation_lemmas::lemma_edwards_affine_when_z_is_one
(declare-fun req%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_edwards_affine_when_z_is_one.
...
(assert
 (forall ((point! curve25519_dalek!edwards.EdwardsPoint.)) (!
   (= (req%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_edwards_affine_when_z_is_one.
     point!
    ) (and
     (=>
   ...
   :pattern ((req%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_edwards_affine_when_z_is_one.
     point!
   ))
   :qid internal_req__curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_edwards_affine_when_z_is_one._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_edwards_affine_when_z_is_one._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_edwards_affine_when_z_is_one.
 (curve25519_dalek!edwards.EdwardsPoint.) Bool
)
(assert
 (forall ((point! curve25519_dalek!edwards.EdwardsPoint.)) (!
   (= (ens%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_edwards_affine_when_z_is_one.
     point!
    ) (and
     (= (curve25519_dalek!specs.edwards_specs.edwards_point_as_affine.? (Poly%curve25519_dalek!edwards.EdwardsPoint.
        point!
       )
      ) (tuple%2./tuple%2 (I (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (
          Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (curve25519_dalek!specs.edwards_specs.edwards_x.?
           (Poly%curve25519_dalek!edwards.EdwardsPoint. point!)
        )))
   ...
   :pattern ((ens%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_edwards_affine_when_z_is_one.
     point!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_edwards_affine_when_z_is_one._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_edwards_affine_when_z_is_one._definition
)))

;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::curve_equation_lemmas::lemma_edwards_affine_when_z_is_one
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:3109:1: 3109:92 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (ens%curve25519_dalek!specs.edwards_specs.lemma_unfold_edwards. point!)
    (=>
     (= x@ (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
        (curve25519_dalek!edwards.EdwardsPoint./EdwardsPoint/X (%Poly%curve25519_dalek!edwards.EdwardsPoint.
          (Poly%curve25519_dalek!edwards.EdwardsPoint. point!)
         ...
         (=>
          ...
          (and
           (=>
            ...
            (=>
             %%location_label%%4
             (= (curve25519_dalek!specs.field_specs.field_mul.? (I x@) (I 1)) (EucMod x@ (curve25519_dalek!specs.field_specs_u64.p.?
                (I 0)
           )))))
           (=>
            (= (curve25519_dalek!specs.field_specs.field_mul.? (I x@) (I 1)) (EucMod x@ (curve25519_dalek!specs.field_specs_u64.p.?
            ...
            (and
             (=>
              ...
              (=>
               %%location_label%%5
               (= (curve25519_dalek!specs.field_specs.field_mul.? (I y@) (I 1)) (EucMod y@ (curve25519_dalek!specs.field_specs_u64.p.?
                  (I 0)
             )))))
             (=>
              (= (curve25519_dalek!specs.field_specs.field_mul.? (I y@) (I 1)) (EucMod y@ (curve25519_dalek!specs.field_specs_u64.p.?
              ...
              (and
               (=>
                ...
                (and
                 (=>
                  %%location_label%%6
                  (req%vstd!arithmetic.div_mod.lemma_small_mod. x@ tmp%5)
                 )
                 (=>
                  (ens%vstd!arithmetic.div_mod.lemma_small_mod. x@ tmp%5)
                  (=>
                   (= tmp%6 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                   (and
                    (=>
                     %%location_label%%7
                     (req%vstd!arithmetic.div_mod.lemma_small_mod. y@ tmp%6)
                    )
                    (=>
                     (ens%vstd!arithmetic.div_mod.lemma_small_mod. y@ tmp%6)
                     (=>
                      %%location_label%%8
                      (and
                       (= (EucMod x@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) x@)
                       (= (EucMod y@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) y@)
               ))))))))
               (=>
                (and
                 (= (EucMod x@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) x@)
                ...
                (=>
                 ...
                 (=>
                  ...
                  (=>
                   ...
                   (=>
                    (= sub@ (curve25519_dalek!specs.field_specs.field_sub.? (I y2@) (I x2@)))
                    (and
                     (=>
                      (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_one_right.
                       sub@
                      ...
                      (=>
                       ...
                       (and
                        (=>
                         %%location_label%%9
                         (req%vstd!arithmetic.div_mod.lemma_mod_bound. sub@ tmp%7)
                        )
                        (=>
                         (ens%vstd!arithmetic.div_mod.lemma_mod_bound. sub@ tmp%7)
                         (=>
                          (= tmp%8 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                          (and
                           (=>
                            %%location_label%%10
                            (req%vstd!arithmetic.div_mod.lemma_small_mod. sub@ tmp%8)
                           )
                           (=>
                            (ens%vstd!arithmetic.div_mod.lemma_small_mod. sub@ tmp%8)
                            (=>
                             %%location_label%%11
                             (and
                              (= (curve25519_dalek!specs.field_specs.field_mul.? (I sub@) (I 1)) (EucMod sub@ (curve25519_dalek!specs.field_specs_u64.p.?
                                 (I 0)
                              )))
                              (= (EucMod sub@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) sub@)
                     )))))))))
                     (=>
                      (and
                       (= (curve25519_dalek!specs.field_specs.field_mul.? (I sub@) (I 1)) (EucMod sub@ (curve25519_dalek!specs.field_specs_u64.p.?
                        ...
                        (and
                         (=>
                          ...
                          (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_point_as_affine.?
                           ...
                           ) (Poly%tuple%2. (tuple%2./tuple%2 (I (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.?
                               (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (curve25519_dalek!specs.edwards_specs.edwards_x.?
                                 (Poly%curve25519_dalek!edwards.EdwardsPoint. point!)
                              )))
                             ) (I (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
