...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:779:1: 779:56 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_field_add_sub_cancel
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:779:1: 779:56 (#0)
 ...
 (assert
  (not (=>
    ...
    (=>
     ...
     (=>
      (= d@ (curve25519_dalek!specs.field_specs.field_sub.? (I a!) (I b!)))
      (and
       (=>
        (= tmp%1 (Sub (nClip (Add a! p@)) b!))
        (and
         (=>
          %%location_label%%0
       ...
       (=>
        (< d@ p@)
        (=>
         (= tmp%2 (= (curve25519_dalek!specs.field_specs.field_add.? (I d@) (I b!)) (EucMod (
             nClip (Add d@ b!)
            ) p@
         )))
         (and
             ...
             (=>
              ...
              (and
               ...
               (=>
                ...
                (=>
                 %%location_label%%5
                 (= (curve25519_dalek!specs.field_specs.field_sub.? (I a!) (I b!)) (EucMod (nClip (Sub
                     (nClip (Add a! p@)) b!
                    )
                   ) p@
            )))))))
             ...
             (and
              (and
               (and
                (=>
                 %%location_label%%6
                 (req%vstd!arithmetic.div_mod.lemma_small_mod. d@ p@)
                )
                (=>
                 (ens%vstd!arithmetic.div_mod.lemma_small_mod. d@ p@)
                 (=>
                  (= tmp%3 (Sub (nClip (Add a! p@)) b!))
                  (and
                   (=>
                    %%location_label%%7
                    (req%curve25519_dalek!lemmas.common_lemmas.div_mod_lemmas.lemma_int_nat_mod_equiv.
                   ...
                   (=>
                    ...
                    (=>
                     %%location_label%%8
                     (= (EucMod d@ p@) (EucMod (Sub (nClip (Add a! p@)) b!) p@))
               ))))))
               (=>
                (= (EucMod d@ p@) (EucMod (Sub (nClip (Add a! p@)) b!) p@))
                (=>
                 (= tmp%4 (Sub (nClip (Add a! p@)) b!))
                 (and
                  (=>
                   %%location_label%%9
                   (req%curve25519_dalek!lemmas.common_lemmas.div_mod_lemmas.lemma_mod_add_eq. d@ tmp%4
                    b! p@
                  ))
                  (=>
                   (ens%curve25519_dalek!lemmas.common_lemmas.div_mod_lemmas.lemma_mod_add_eq. d@ tmp%4
                    b! p@
                   )
                   (=>
                    %%location_label%%10
                    (= (EucMod (nClip (Add d@ b!)) p@) (EucMod (nClip (Add (Sub (nClip (Add a! p@)) b!) b!))
                      p@
              ))))))))
              (=>
               (= (EucMod (nClip (Add d@ b!)) p@) (EucMod (nClip (Add (Sub (nClip (Add a! p@)) b!) b!))
               ...
               (=>
                (= tmp%5 (= (nClip (Add (Sub (nClip (Add a! p@)) b!) b!)) (nClip (Add a! p@))))
                (and
                 (=>
                  %%location_label%%11
                  tmp%5
