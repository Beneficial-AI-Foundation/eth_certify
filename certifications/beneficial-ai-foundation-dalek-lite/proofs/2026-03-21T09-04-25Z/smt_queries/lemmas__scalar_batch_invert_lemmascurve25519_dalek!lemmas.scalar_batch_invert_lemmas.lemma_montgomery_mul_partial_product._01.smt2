...
;; curve25519-dalek/src/lemmas/scalar_batch_invert_lemmas.rs:142:5: 142:11 (#0)
...
;; Function-Def curve25519_dalek::lemmas::scalar_batch_invert_lemmas::lemma_montgomery_mul_partial_product
;; curve25519-dalek/src/lemmas/scalar_batch_invert_lemmas.rs:142:5: 142:11 (#0)
...
(push)
 ...
 (assert
  (not (=>
    %%location_label%%0
    (= (nClip (Mul (nClip (Mul R@ pp_i@)) (nClip (Mul s_i@ R@)))) (nClip (Mul (nClip (Mul
         (nClip (Mul R@ pp_i@)) s_i@
        )
       ) R@
 ))))))
 (get-info :version)
