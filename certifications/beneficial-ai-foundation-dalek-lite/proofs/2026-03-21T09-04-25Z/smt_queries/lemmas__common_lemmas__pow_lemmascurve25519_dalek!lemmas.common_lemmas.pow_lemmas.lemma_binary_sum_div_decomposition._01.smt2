...
;; curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:213:1: 213:80 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::pow_lemmas::lemma_binary_sum_div_decomposition
;; curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:213:1: 213:80 (#0)
         ...
         (=>
          ...
          (and
           (and
            (=>
             %%location_label%%1
             (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. x@ pk@)
            )
            (=>
             (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. x@ pk@)
             (=>
              %%location_label%%2
              (= x@ (nClip (Add (nClip (Mul pk@ (EucDiv x@ pk@))) (EucMod x@ pk@))))
           )))
           (=>
            (= x@ (nClip (Add (nClip (Mul pk@ (EucDiv x@ pk@))) (EucMod x@ pk@))))
            (and
             (and
              (=>
               %%location_label%%3
               (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. y@ pk@)
              )
              (=>
               (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. y@ pk@)
               (=>
                %%location_label%%4
                (= y@ (nClip (Add (nClip (Mul pk@ (EucDiv y@ pk@))) (EucMod y@ pk@))))
             )))
             (=>
              (= y@ (nClip (Add (nClip (Mul pk@ (EucDiv y@ pk@))) (EucMod y@ pk@))))
              (and
               (and
                ...
                (=>
                 ...
                 (=>
                  %%location_label%%6
                  (= (EucMod z@ pk@) (nClip (Add (EucMod x@ pk@) (EucMod y@ pk@))))
               )))
               (=>
                (= (EucMod z@ pk@) (nClip (Add (EucMod x@ pk@) (EucMod y@ pk@))))
                (and
                 (=>
                  ...
                  (=>
                   (= tmp%2 (EucDiv y@ pk@))
                   (=>
                    (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add. pk@ tmp%1 tmp%2)
                    (=>
                     %%location_label%%7
                     (let
                      ((tmp%%$ (nClip (Add x@ y@))))
                      (and
                       (= z@ tmp%%$)
                       (= tmp%%$ (nClip (Add (nClip (Mul pk@ (nClip (Add (EucDiv x@ pk@) (EucDiv y@ pk@)))))
                          (EucMod z@ pk@)
                 )))))))))
                 (=>
                  (let
                  ...
                  (and
                   (and
                    (=>
                     %%location_label%%8
                     (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. z@ pk@)
                    )
                    (=>
                     (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. z@ pk@)
                     (=>
                      %%location_label%%9
                      (= z@ (nClip (Add (nClip (Mul pk@ (EucDiv z@ pk@))) (EucMod z@ pk@))))
                   )))
                   (=>
                    (= z@ (nClip (Add (nClip (Mul pk@ (EucDiv z@ pk@))) (EucMod z@ pk@))))
                    (and
                     (=>
                      (= tmp%3 (EucDiv z@ pk@))
                      (=>
                       (= tmp%4 (nClip (Add (EucDiv x@ pk@) (EucDiv y@ pk@))))
                       (and
                        (=>
                         %%location_label%%10
                         (req%vstd!arithmetic.mul.lemma_mul_equality_converse. pk@ tmp%3 tmp%4)
                        )
                        (=>
                         (ens%vstd!arithmetic.mul.lemma_mul_equality_converse. pk@ tmp%3 tmp%4)
                         (=>
                          %%location_label%%11
                          (= (EucDiv z@ pk@) (nClip (Add (EucDiv x@ pk@) (EucDiv y@ pk@))))
                     )))))
                     (=>
                      (= (EucDiv z@ pk@) (nClip (Add (EucDiv x@ pk@) (EucDiv y@ pk@))))
                      (=>
