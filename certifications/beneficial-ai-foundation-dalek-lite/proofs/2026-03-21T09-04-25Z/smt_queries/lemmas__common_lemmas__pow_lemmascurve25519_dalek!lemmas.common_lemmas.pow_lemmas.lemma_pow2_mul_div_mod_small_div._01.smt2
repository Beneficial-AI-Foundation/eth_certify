...
;; curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:620:1: 620:87 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::pow_lemmas::lemma_pow2_mul_div_mod_small_div
;; curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:620:1: 620:87 (#0)
      ...
      (=>
       ...
       (and
        (and
         (=>
          %%location_label%%2
          (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_mul_mod. x! d@ t!)
         )
         (=>
          (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_mul_mod. x! d@ t!)
          (=>
           %%location_label%%3
           (= (EucMod (nClip (Mul x! (vstd!arithmetic.power2.pow2.? (I d@)))) (vstd!arithmetic.power2.pow2.?
              (I t!)
             )
            ) (nClip (Mul (EucMod x! (vstd!arithmetic.power2.pow2.? (I dd@))) (vstd!arithmetic.power2.pow2.?
               (I d@)
        )))))))
        (=>
         (= (EucMod (nClip (Mul x! (vstd!arithmetic.power2.pow2.? (I d@)))) (vstd!arithmetic.power2.pow2.?
           ...
           (or
            (and
             (=>
              ...
              (and
               (=>
                %%location_label%%4
                (req%vstd!arithmetic.power2.lemma_pow2_strictly_increases. px! dd@)
               )
               (=>
                (ens%vstd!arithmetic.power2.lemma_pow2_strictly_increases. px! dd@)
                %%switch_label%%0
             )))
             (=>
              (not (< px! dd@))
            ...
            (and
             ...
             (=>
              %%location_label%%5
              (let
               ((tmp%%$ (vstd!arithmetic.power2.pow2.? (I px!))))
               (and
                (< x! tmp%%$)
                (<= tmp%%$ (vstd!arithmetic.power2.pow2.? (I dd@)))
           )))))
           (=>
            (let
             ((tmp%%$ (vstd!arithmetic.power2.pow2.? (I px!))))
            ...
            (and
             (=>
              (= tmp%1 (vstd!arithmetic.power2.pow2.? (I dd@)))
              (and
               (=>
                %%location_label%%6
                (req%vstd!arithmetic.div_mod.lemma_small_mod. x! tmp%1)
               )
               (=>
                (ens%vstd!arithmetic.div_mod.lemma_small_mod. x! tmp%1)
                (=>
                 %%location_label%%7
                 (= (EucMod x! (vstd!arithmetic.power2.pow2.? (I dd@))) x!)
             ))))
             (=>
              (= (EucMod x! (vstd!arithmetic.power2.pow2.? (I dd@))) x!)
              (=>
