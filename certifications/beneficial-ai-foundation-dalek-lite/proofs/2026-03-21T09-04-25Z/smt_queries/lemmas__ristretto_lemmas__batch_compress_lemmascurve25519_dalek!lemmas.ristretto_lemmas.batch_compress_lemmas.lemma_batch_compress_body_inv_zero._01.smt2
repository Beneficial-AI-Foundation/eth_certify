...
;; curve25519-dalek/src/lemmas/ristretto_lemmas/batch_compress_lemmas.rs:483:1: 483:98 (#0)
...
;; Function-Def curve25519_dalek::lemmas::ristretto_lemmas::batch_compress_lemmas::lemma_batch_compress_body_inv_zero
;; curve25519-dalek/src/lemmas/ristretto_lemmas/batch_compress_lemmas.rs:483:1: 483:98 (#0)
      ...
      (and
       (and
        ...
        (=>
         ...
         (=>
          %%location_label%%2
          (= (curve25519_dalek!specs.field_specs.field_mul.? (I eg!) (I 0)) 0)
       )))
       (=>
        (= (curve25519_dalek!specs.field_specs.field_mul.? (I eg!) (I 0)) 0)
        (and
         (and
          ...
          (=>
           ...
           (=>
            %%location_label%%4
            (= (curve25519_dalek!specs.field_specs.field_mul.? (I fh!) (I 0)) 0)
         )))
         (=>
          (= (curve25519_dalek!specs.field_specs.field_mul.? (I fh!) (I 0)) 0)
          (=>
           (= tmp%1 (not (curve25519_dalek!specs.field_specs.is_negative.? (I 0))))
           (and
            (=>
             %%location_label%%5
             tmp%1
            ...
            (=>
             ...
             (and
              (=>
               (= tmp%2 (curve25519_dalek!specs.field_specs.field_mul.? (I h!) (I e!)))
               (and
                (=>
                 %%location_label%%6
                 (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_zero_right.
               ...
               (and
                (and
                 ...
                 (=>
                  ...
                  (=>
                   %%location_label%%9
                   (= (curve25519_dalek!specs.field_specs.field_mul.? (I g!) (I 0)) 0)
                )))
                (=>
                 (= (curve25519_dalek!specs.field_specs.field_mul.? (I g!) (I 0)) 0)
                 (and
                  (and
                   ...
                   (=>
                    ...
                    (=>
                     %%location_label%%11
                     (= (curve25519_dalek!specs.field_specs.field_mul.? (I invsqrt_a_minus_d@) (I 0)) 0)
                  )))
                  (=>
                   (= (curve25519_dalek!specs.field_specs.field_mul.? (I invsqrt_a_minus_d@) (I 0)) 0)
                   (and
