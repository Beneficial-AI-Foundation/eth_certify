...
;; curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:994:5: 994:11 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::as_bytes_lemmas::lemma_xor_sign_bit_preserves_y
;; curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:994:5: 994:11 (#0)
...
(declare-const byte31_before@ (_ BitVec 8))
(assert
 (= (bvlshr byte31_before@ ((_ zero_extend 5) (_ bv7 3))) ((_ zero_extend 7) (_ bv0 1)))
)
