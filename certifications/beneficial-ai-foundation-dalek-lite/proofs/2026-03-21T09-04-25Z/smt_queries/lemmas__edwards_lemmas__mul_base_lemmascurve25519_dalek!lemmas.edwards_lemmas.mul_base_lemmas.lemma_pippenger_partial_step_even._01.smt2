...
;; curve25519-dalek/src/lemmas/edwards_lemmas/mul_base_lemmas.rs:206:1: 206:87 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::mul_base_lemmas::lemma_pippenger_partial_step_even
;; curve25519-dalek/src/lemmas/edwards_lemmas/mul_base_lemmas.rs:206:1: 206:87 (#0)
...
(push)
 ...
 (declare-const even_i@ tuple%2.)
 (declare-const even_ip1@ tuple%2.)
 (declare-const base@ tuple%2.)
 (declare-const term@ tuple%2.)
 (declare-const pi@ tuple%2.)
 (assert
  fuel_defaults
 )
 (assert
  ...
  (not (=>
    ...
    (=>
     (= odd_sum@ (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.odd_sum_up_to.?
       (Poly%vstd!seq.Seq<i8.>. digits!) (I 64) (Poly%tuple%2. B!)
     ))
     (=>
      ...
      (=>
       (= even_i@ (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.even_sum_up_to.?
         (Poly%vstd!seq.Seq<i8.>. digits!) (I i!) (Poly%tuple%2. B!)
       ))
       (and
        (=>
         %%location_label%%0
        ...
        (=>
         ...
         (=>
          (= even_ip1@ (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.even_sum_up_to.?
            (Poly%vstd!seq.Seq<i8.>. digits!) (I (Add i! 1)) (Poly%tuple%2. B!)
          ))
          (=>
           (= base@ (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.? (Poly%tuple%2. B!)
             (I (curve25519_dalek!specs.edwards_specs.pow256.? (I (nClip (EucDiv i! 2)))))
           ...
           (=>
            ...
            (=>
             (= pi@ (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.pippenger_partial.?
               (Poly%vstd!seq.Seq<i8.>. digits!) (I i!) (Poly%tuple%2. B!)
             ))
             (=>
              (= tmp%1 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. pi@) (Poly%tuple%2.
                 (curve25519_dalek!specs.edwards_specs.edwards_add.? (tuple%2./tuple%2/0 (%Poly%tuple%2.
                    (Poly%tuple%2. scaled@)
                   )
                  ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. scaled@))) (tuple%2./tuple%2/0
                   (%Poly%tuple%2. (Poly%tuple%2. even_i@))
                  ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. even_i@)))
              ))))
              (and
               (=>
                %%location_label%%1
               ...
               (=>
                tmp%1
                (=>
                 (= tmp%2 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. even_ip1@) (Poly%tuple%2.
                    (let
                     ((prev$ (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.even_sum_up_to.? (Poly%vstd!seq.Seq<i8.>.
                         digits!
                        ) (I i!) (Poly%tuple%2. B!)
                 ...
                 (and
                  ...
                  (=>
                   tmp%2
                   (=>
                    (= tmp%3 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. even_ip1@) (Poly%tuple%2.
                       (curve25519_dalek!specs.edwards_specs.edwards_add.? (tuple%2./tuple%2/0 (%Poly%tuple%2.
                          (Poly%tuple%2. even_i@)
                         )
                        ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. even_i@))) (tuple%2./tuple%2/0
                         (%Poly%tuple%2. (Poly%tuple%2. term@))
                        ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. term@)))
                    ))))
                    (and
                     ...
                     (=>
                      tmp%3
                      (=>
                       (= tmp%4 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. scaled@)))))
                       (=>
                        (= tmp%5 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. scaled@)))))
                        (=>
                         (= tmp%6 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. even_i@)))))
                         (=>
                          (= tmp%7 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. even_i@)))))
                          (=>
                           (= tmp%8 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. term@)))))
                           (=>
                            (= tmp%9 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. term@)))))
                            (=>
                             (ens%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.axiom_edwards_add_associative.
                              tmp%4 tmp%5 tmp%6 tmp%7 tmp%8 tmp%9
                             )
                             (=>
                              (= tmp%10 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_add.?
                                  (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. pi@))) (tuple%2./tuple%2/1 (%Poly%tuple%2.
                                    (Poly%tuple%2. pi@)
                                   )
                                   ...
                                   (%Poly%tuple%2. (Poly%tuple%2. even_ip1@))
                                  ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. even_ip1@)))
                              ))))
                              (and
                               (=>
                                %%location_label%%4
                               ...
                               (=>
                                tmp%10
                                (=>
                                 (= tmp%11 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_add.?
                                     (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. scaled@))) (tuple%2./tuple%2/1
                                      (%Poly%tuple%2. (Poly%tuple%2. scaled@))
                                     ) (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. even_ip1@))) (tuple%2./tuple%2/1
                                      (%Poly%tuple%2. (Poly%tuple%2. even_ip1@))
                                    ))
                                   ) (Poly%tuple%2. (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.pippenger_partial.?
                                     (Poly%vstd!seq.Seq<i8.>. digits!) (I (Add i! 1)) (Poly%tuple%2. B!)
                                 ))))
                                 (and
                                  (=>
