...
;; curve25519-dalek/src/lemmas/scalar_byte_lemmas/bytes_to_scalar_lemmas.rs:53:1: 53:91 (#0)
...
;; Function-Def curve25519_dalek::lemmas::scalar_byte_lemmas::bytes_to_scalar_lemmas::lemma_byte_to_word_step
;; curve25519-dalek/src/lemmas/scalar_byte_lemmas/bytes_to_scalar_lemmas.rs:53:1: 53:91 (#0)
...
(push)
 ...
 (declare-const old_word@ Int)
 (declare-const new_byte@ Int)
 (declare-const j8@ Int)
 (declare-const j8next@ Int)
 (assert
  fuel_defaults
 )
 (assert
 ...
 (assert
  (forall ((i2$ Poly)) (!
    ...
    :qid user_curve25519_dalek__lemmas__scalar_byte_lemmas__bytes_to_scalar_lemmas__lemma_byte_to_word_step_66
    :skolemid skolem_user_curve25519_dalek__lemmas__scalar_byte_lemmas__bytes_to_scalar_lemmas__lemma_byte_to_word_step_66
 )))
 (assert
  (= (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $
       (CONST_INT 4)
 ...
 (assert
  (forall ((i2$ Poly)) (!
    ...
    :qid user_curve25519_dalek__lemmas__scalar_byte_lemmas__bytes_to_scalar_lemmas__lemma_byte_to_word_step_67
    :skolemid skolem_user_curve25519_dalek__lemmas__scalar_byte_lemmas__bytes_to_scalar_lemmas__lemma_byte_to_word_step_67
 )))
 ;; assertion failed
      ...
      (=>
       ...
       (and
        ...
        (=>
         tmp%2
         (=>
          (= idx@ (Add (Mul (uClip 64 i!) 8) (uClip 64 j!)))
          (=>
           (= tmp%3 (< idx@ 32))
           (and
            (=>
            ...
            (=>
             tmp%3
             (=>
              (= old_word@ (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (
                    UINT 64
                   ) $ (CONST_INT 4)
                  ) (Poly%array%. words!)
                 ) (I i!)
              ...
              (=>
               (= new_byte@ (uClip 64 (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (
                ...
                (and
                 ...
                 (=>
                  ...
                  (and
                   (=>
                    %%location_label%%4
                    (req%vstd!arithmetic.mul.lemma_mul_strict_inequality. j! 8 8)
                   )
                   (=>
                    (ens%vstd!arithmetic.mul.lemma_mul_strict_inequality. j! 8 8)
                    (=>
                     (= tmp%5 (< (Mul j! 8) 64))
                     (and
                      (=>
                      ...
                      (=>
                       ...
                       (=>
                        ...
                        (and
                         (=>
                          %%location_label%%6
                          (req%vstd!arithmetic.power2.lemma_pow2_strictly_increases. tmp%6 64)
                         )
                         (=>
                          (ens%vstd!arithmetic.power2.lemma_pow2_strictly_increases. tmp%6 64)
                          (=>
                           (= tmp%7 (= (nClip (Mul 1 (vstd!arithmetic.power2.pow2.? (I (nClip (Mul j! 8))))))
                             (vstd!arithmetic.power2.pow2.? (I (nClip (Mul j! 8))))
                           ))
                           (and
                            (=>
                            ...
                            (=>
                             tmp%7
                             (=>
                              (= tmp%8 (< (nClip (Mul 1 (vstd!arithmetic.power2.pow2.? (I (nClip (Mul j! 8))))))
                               ...
                               (=>
                                ...
                                (=>
                                 ...
                                 (and
                                  (=>
                                   %%location_label%%9
                                   (req%vstd!bits.lemma_u64_pow2_no_overflow. tmp%9)
                                  )
                                  (=>
                                   (ens%vstd!bits.lemma_u64_pow2_no_overflow. tmp%9)
                                   (=>
                                    (= j8@ (uClip 64 (Mul j! 8)))
                                    (and
                                     (=>
                                      (= tmp%10 (< old_word@ (vstd!arithmetic.power2.pow2.? (I j8@))))
                                      (and
                                       (=>
                                        %%location_label%%10
                                        tmp%10
                                        ...
                                        (=>
                                         ...
                                         (and
                                          ...
                                          (=>
                                           tmp%11
                                           (=>
                                            (= tmp%12 (<= (nClip (Mul 1 (vstd!arithmetic.power2.pow2.? (I j8@)))) 18446744073709551615))
                                            (and
                                             (=>
                                              %%location_label%%12
                                              tmp%12
                                             ...
                                             (=>
                                              ...
                                              (and
                                               (=>
                                                %%location_label%%13
                                                (req%vstd!bits.lemma_u64_shl_is_mul. 1 j8@)
                                               )
                                               (=>
                                                (ens%vstd!bits.lemma_u64_shl_is_mul. 1 j8@)
                                                (=>
                                                 (= tmp%13 (= (uClip 64 (bitshl (I 1) (I j8@))) (nClip (Mul 1 (vstd!arithmetic.power2.pow2.?
                                                      (I j8@)
                                                 )))))
                                                 (and
                                                  (=>
                                                  ...
                                                  (=>
                                                   ...
                                                   (=>
                                                    %%location_label%%15
                                                    (< old_word@ (uClip 64 (bitshl (I 1) (I j8@))))
                                     )))))))))))))))
                                     (=>
                                      (< old_word@ (uClip 64 (bitshl (I 1) (I j8@))))
                                      (and
                                         ...
                                         (=>
                                          ...
                                          (and
                                           (and
                                            (=>
                                             %%location_label%%17
                                             (req%vstd!bits.lemma_u64_shr_is_div. 18446744073709551615 j8@)
                                            )
                                            (=>
                                             (ens%vstd!bits.lemma_u64_shr_is_div. 18446744073709551615 j8@)
                                             (=>
                                              %%location_label%%18
                                              (= (uClip 64 (bitshr (I 18446744073709551615) (I (Mul j! 8)))) (EucDiv 18446744073709551615
                                                (uClip 64 (vstd!arithmetic.power2.pow2.? (I j8@)))
                                           )))))
                                           (=>
                                            (= (uClip 64 (bitshr (I 18446744073709551615) (I (Mul j! 8)))) (EucDiv 18446744073709551615
                                              (uClip 64 (vstd!arithmetic.power2.pow2.? (I j8@)))
                                               ...
                                               (=>
                                                ...
                                                (and
                                                 (and
                                                  (=>
                                                   %%location_label%%20
                                                   (req%vstd!arithmetic.power.lemma_pow_increases. 2 j8@ 56)
                                                  )
                                                  (=>
                                                   (ens%vstd!arithmetic.power.lemma_pow_increases. 2 j8@ 56)
                                                   (=>
                                                    (ens%vstd!arithmetic.power2.lemma_pow2. j8@)
                                                    (=>
                                                     (ens%vstd!arithmetic.power2.lemma_pow2. 56)
                                                     (=>
                                                      %%location_label%%21
                                                      (<= (vstd!arithmetic.power2.pow2.? (I j8@)) (vstd!arithmetic.power2.pow2.? (I 56)))
                                                 )))))
                                                 (=>
                                                  (<= (vstd!arithmetic.power2.pow2.? (I j8@)) (vstd!arithmetic.power2.pow2.? (I 56)))
                                                  (=>
                                                   (= tmp%16 (vstd!arithmetic.power2.pow2.? (I j8@)))
                                                   (=>
                                                    (= tmp%17 (vstd!arithmetic.power2.pow2.? (I 56)))
                                                    (and
                                                     (=>
                                                      %%location_label%%22
                                                     ...
                                                     (=>
                                                      ...
                                                      (=>
                                                       (= tmp%18 (<= (EucDiv 18446744073709551615 (vstd!arithmetic.power2.pow2.? (I 56)))
                                                         (EucDiv 18446744073709551615 (vstd!arithmetic.power2.pow2.? (I j8@)))
                                                       ))
                                                       (and
                                                        (=>
                                                         %%location_label%%23
                                                        ...
                                                        (=>
                                                         ...
                                                         (and
                                                          (=>
                                                           %%location_label%%24
                                                           (req%vstd!bits.lemma_u64_pow2_no_overflow. 56)
                                                          )
                                                          (=>
                                                           (ens%vstd!bits.lemma_u64_pow2_no_overflow. 56)
                                                           (=>
                                                            %%location_label%%25
                                                            (<= (EucDiv 18446744073709551615 (uClip 64 (vstd!arithmetic.power2.pow2.? (I 56))))
                                                             (EucDiv 18446744073709551615 (uClip 64 (vstd!arithmetic.power2.pow2.? (I j8@))))
                                             ))))))))))))))))
                                             (=>
                                              (<= (EucDiv 18446744073709551615 (uClip 64 (vstd!arithmetic.power2.pow2.? (I 56))))
                                               (EucDiv 18446744073709551615 (uClip 64 (vstd!arithmetic.power2.pow2.? (I j8@))))
                                                 ...
                                                 (=>
                                                  ...
                                                  (=>
                                                   ...
                                                   (and
                                                    ...
                                                    (=>
                                                     (<= 255 (EucDiv 18446744073709551615 (uClip 64 (vstd!arithmetic.power.pow.? (I 2) (I 56)))))
                                                     (=>
                                                      %%location_label%%28
                                                      (<= 255 (EucDiv 18446744073709551615 (uClip 64 (vstd!arithmetic.power2.pow2.? (I 56)))))
                                               )))))))
                                               (=>
                                                (<= 255 (EucDiv 18446744073709551615 (uClip 64 (vstd!arithmetic.power2.pow2.? (I 56)))))
                                                (=>
                                                 %%location_label%%29
                                                 (<= new_byte@ (uClip 64 (bitshr (I 18446744073709551615) (I j8@))))
                                       ))))))))))
                                       (=>
                                        (<= new_byte@ (uClip 64 (bitshr (I 18446744073709551615) (I j8@))))
                                        (and
                                         (and
                                          (=>
                                           %%location_label%%30
                                           (req%curve25519_dalek!lemmas.common_lemmas.bit_lemmas.lemma_u64_bit_or_is_plus. old_word@
                                            new_byte@ (uClip 64 j8@)
                                          ))
                                          (=>
                                           (ens%curve25519_dalek!lemmas.common_lemmas.bit_lemmas.lemma_u64_bit_or_is_plus. old_word@
                                            new_byte@ (uClip 64 j8@)
                                           )
                                           (=>
                                            %%location_label%%31
                                            (= (uClip 64 (bitor (I old_word@) (I (uClip 64 (bitshl (I new_byte@) (I j8@))))))
                                             (Add old_word@ (uClip 64 (bitshl (I new_byte@) (I j8@))))
                                         ))))
                                         (=>
                                          (= (uClip 64 (bitor (I old_word@) (I (uClip 64 (bitshl (I new_byte@) (I j8@))))))
                                           (Add old_word@ (uClip 64 (bitshl (I new_byte@) (I j8@))))
                                          ...
                                          (=>
                                           (= j8next@ (Mul (Add (uClip 64 j!) 1) (uClip 64 8)))
                                           (and
                                            (=>
                                             (= tmp%19 (<= new_byte@ 255))
                                             (and
                                              ...
                                              (=>
                                               ...
                                               (and
                                                ...
                                                (=>
                                                 ...
                                                 (and
                                                  (=>
                                                   (= tmp%20 (vstd!arithmetic.power2.pow2.? (I j8@)))
                                                   (=>
                                                    (= tmp%21 (vstd!arithmetic.power2.pow2.? (I 56)))
                                                    (and
                                                     (=>
                                                      %%location_label%%35
                                                      (req%curve25519_dalek!lemmas.common_lemmas.mul_lemmas.lemma_mul_le. new_byte@ new_byte@
                                                       tmp%20 tmp%21
                                                     ))
                                                     (=>
                                                      (ens%curve25519_dalek!lemmas.common_lemmas.mul_lemmas.lemma_mul_le. new_byte@ new_byte@
                                                       tmp%20 tmp%21
                                                      )
                                                      (=>
                                                       %%location_label%%36
                                                       (<= (Mul new_byte@ (vstd!arithmetic.power2.pow2.? (I j8@))) (Mul new_byte@ (vstd!arithmetic.power2.pow2.?
                                                          (I 56)
                                                  ))))))))
                                                  (=>
                                                   (<= (Mul new_byte@ (vstd!arithmetic.power2.pow2.? (I j8@))) (Mul new_byte@ (vstd!arithmetic.power2.pow2.?
                                                   ...
                                                   (and
                                                    (=>
                                                     (= tmp%22 (vstd!arithmetic.power2.pow2.? (I 56)))
                                                     (and
                                                      (=>
                                                       %%location_label%%37
                                                       (req%vstd!arithmetic.mul.lemma_mul_inequality. new_byte@ 255 tmp%22)
                                                      )
                                                      (=>
                                                       (ens%vstd!arithmetic.mul.lemma_mul_inequality. new_byte@ 255 tmp%22)
                                                       (and
                                                        (=>
                                                         %%location_label%%38
                                                         true
                                                        ...
                                                        (=>
                                                         (<= (Mul 255 (vstd!arithmetic.power.pow.? (I 2) (I 56))) 18446744073709551615)
                                                         (and
                                                          (=>
                                                           (ens%vstd!arithmetic.power2.lemma_pow2. 56)
                                                           (=>
                                                            %%location_label%%39
                                                            (<= (nClip (Mul 255 (vstd!arithmetic.power2.pow2.? (I 56)))) 18446744073709551615)
                                                          ))
                                                          (=>
                                                           (<= (nClip (Mul 255 (vstd!arithmetic.power2.pow2.? (I 56)))) 18446744073709551615)
                                                           (=>
                                                            %%location_label%%40
                                                            (<= (Mul new_byte@ (vstd!arithmetic.power2.pow2.? (I j8@))) 18446744073709551615)
                                                    ))))))))
                                                    (=>
                                                     (<= (Mul new_byte@ (vstd!arithmetic.power2.pow2.? (I j8@))) 18446744073709551615)
                                                     (and
                                                      (=>
                                                       %%location_label%%41
                                                       (req%vstd!bits.lemma_u64_shl_is_mul. new_byte@ j8@)
                                                      )
                                                      (=>
                                                       (ens%vstd!bits.lemma_u64_shl_is_mul. new_byte@ j8@)
                                                       (=>
                                                        %%location_label%%42
                                                        (= (Add old_word@ (uClip 64 (bitshl (I new_byte@) (I j8@)))) (Add old_word@ (Mul new_byte@
                                                           (vstd!arithmetic.power2.pow2.? (I j8@))
                                            )))))))))))))))
                                            (=>
                                             (= (Add old_word@ (uClip 64 (bitshl (I new_byte@) (I j8@)))) (Add old_word@ (Mul new_byte@
                                                (vstd!arithmetic.power2.pow2.? (I j8@))
                                             ...
                                             (and
                                              (and
                                               (=>
                                                (= tmp%23 (vstd!arithmetic.power2.pow2.? (I j8@)))
                                                (and
                                                 (=>
                                                  %%location_label%%43
                                                  (req%vstd!arithmetic.mul.lemma_mul_inequality. new_byte@ 255 tmp%23)
                                                 )
                                                 (=>
                                                  (ens%vstd!arithmetic.mul.lemma_mul_inequality. new_byte@ 255 tmp%23)
                                                  (=>
                                                   %%location_label%%44
                                                   (<= (Mul new_byte@ (vstd!arithmetic.power2.pow2.? (I j8@))) (nClip (Mul 255 (vstd!arithmetic.power2.pow2.?
                                                       (I j8@)
                                               ))))))))
                                               (=>
                                                (<= (Mul new_byte@ (vstd!arithmetic.power2.pow2.? (I j8@))) (nClip (Mul 255 (vstd!arithmetic.power2.pow2.?
                                                ...
                                                (=>
                                                 (= tmp%24 (<= (Add old_word@ (Mul new_byte@ (vstd!arithmetic.power2.pow2.? (I j8@))))
                                                   (nClip (Mul 256 (vstd!arithmetic.power2.pow2.? (I j8@))))
                                                 ))
                                                 (and
                                                  (=>
                                                   %%location_label%%45
                                                  ...
                                                  (=>
                                                   ...
                                                   (and
                                                    (=>
                                                     (ens%vstd!arithmetic.power2.lemma_pow2. 8)
                                                     (and
                                                      (=>
                                                       %%location_label%%46
                                                       true
                                                      ...
                                                      (=>
                                                       (= 256 (vstd!arithmetic.power.pow.? (I 2) (I 8)))
                                                       (=>
                                                        (= tmp%25 (= 256 (vstd!arithmetic.power2.pow2.? (I 8))))
                                                        (and
                                                         (=>
                                                          %%location_label%%47
                                                          tmp%25
                                                         ...
                                                         (=>
                                                          ...
                                                          (=>
                                                           %%location_label%%48
                                                           (= (nClip (Mul 256 (vstd!arithmetic.power2.pow2.? (I j8@)))) (nClip (Mul (vstd!arithmetic.power2.pow2.?
                                                               (I 8)
                                                              ) (vstd!arithmetic.power2.pow2.? (I j8@))
                                                    ))))))))))
                                                    (=>
                                                     ...
                                                     (and
                                                      (=>
                                                       (ens%vstd!arithmetic.power2.lemma_pow2_adds. 8 j8@)
                                                       (=>
                                                        %%location_label%%49
                                                        (= (nClip (Mul 256 (vstd!arithmetic.power2.pow2.? (I j8@)))) (vstd!arithmetic.power2.pow2.?
                                                          (I (nClip (Add 8 j8@)))
                                                      ))))
                                                      (=>
                                                       (= (nClip (Mul 256 (vstd!arithmetic.power2.pow2.? (I j8@)))) (vstd!arithmetic.power2.pow2.?
                                                       ...
                                                       (=>
                                                        %%location_label%%50
                                                        (< (Add old_word@ (uClip 64 (bitshl (I new_byte@) (I j8@)))) (vstd!arithmetic.power2.pow2.?
                                                          (I (nClip j8next@))
                                              ))))))))))))
                                              (=>
                                               (< (Add old_word@ (uClip 64 (bitshl (I new_byte@) (I j8@)))) (vstd!arithmetic.power2.pow2.?
                                               ...
                                               (=>
                                                (= tmp%26 (= old_word@ (curve25519_dalek!specs.core_specs.bytes_as_nat_prefix.? (vstd!seq.Seq.new.?
                                                    $ (UINT 8) $ (TYPE%fun%1. $ INT $ (UINT 8)) (I 8) (Poly%fun%1. (mk_fun (%%lambda%%3
                                                       (Mul i! 8) $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT 32))
                                                        (Poly%array%. bytes!)
                                                    ))))
                                                   ) (I j!)
                                                )))
                                                 ...
                                                 (=>
                                                  ...
                                                  (and
                                                   (=>
                                                    ...
                                                    (=>
                                                     %%location_label%%52
                                                     (= (Add (curve25519_dalek!specs.core_specs.bytes_as_nat_prefix.? (vstd!seq.Seq.new.?
                                                         $ (UINT 8) $ (TYPE%fun%1. $ INT $ (UINT 8)) (I 8) (Poly%fun%1. (mk_fun (%%lambda%%3
                                                            (Mul i! 8) $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT 32))
                                                             (Poly%array%. bytes!)
                                                         ))))
                                                   ...
                                                   (=>
                                                    ...
                                                    (and
                                                     (=>
                                                      ...
                                                      (=>
                                                       (= tmp%28 (vstd!arithmetic.power2.pow2.? (I (nClip (Mul j! 8)))))
                                                       (=>
                                                     ...
                                                     (=>
                                                      ...
                                                      (=>
                                                       (= tmp%29 (= (Add old_word@ (Mul new_byte@ (vstd!arithmetic.power2.pow2.? (I j8@))))
                                                         (curve25519_dalek!specs.core_specs.bytes_as_nat_prefix.? (vstd!seq.Seq.new.? $ (UINT
                                                            8
                                                           ) $ (TYPE%fun%1. $ INT $ (UINT 8)) (I 8) (Poly%fun%1. (mk_fun (%%lambda%%3 (Mul i! 8)
                                                              $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT 32)) (Poly%array%.
                                                       ...
                                                       (and
                                                        ...
                                                        (=>
                                                         ...
                                                         (and
                                                          (=>
                                                           %%location_label%%55
                                                           (= (Add old_word@ (Mul new_byte@ (vstd!arithmetic.power2.pow2.? (I j8@)))) (Add old_word@
                                                             (uClip 64 (bitshl (I new_byte@) (I j8@)))
                                                          )))
                                                          (=>
                                                           (= (Add old_word@ (Mul new_byte@ (vstd!arithmetic.power2.pow2.? (I j8@)))) (Add old_word@
                                                             (uClip 64 (bitshl (I new_byte@) (I j8@)))
                                                           ...
                                                           (=>
                                                            (= tmp%30 (< (uClip 64 (bitor (I (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                                                            ...
                                                            (and
                                                             ...
                                                             (=>
                                                              tmp%30
                                                              (=>
                                                               (= tmp%31 (= (uClip 64 (bitor (I (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                                                                       $ (ARRAY $ (UINT 64) $ (CONST_INT 4)) (Poly%array%. words!)
                                                                      ) (I i!)
                                                                    ))
                                                                   ) (I (uClip 64 (bitshl (I (uClip 64 (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.?
