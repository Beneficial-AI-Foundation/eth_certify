...
;; curve25519-dalek/src/lemmas/field_lemmas/compute_q_lemmas.rs:321:1: 321:101 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::compute_q_lemmas::lemma_single_stage_division
;; curve25519-dalek/src/lemmas/field_lemmas/compute_q_lemmas.rs:321:1: 321:101 (#0)
(get-info :all-statistics)
(push)
 (declare-const limb! Int)
 (declare-const carry_in! Int)
 (declare-const stage_input! Int)
 ...
 (assert
  (not (=>
    ...
    (and
     (=>
      %%location_label%%0
      (req%vstd!bits.lemma_u64_shr_is_div. stage_input! 51)
     )
     (=>
      (ens%vstd!bits.lemma_u64_shr_is_div. stage_input! 51)
      (and
       (=>
        %%location_label%%1
        (req%curve25519_dalek!lemmas.field_lemmas.compute_q_lemmas.lemma_bounded_shr_51. stage_input!)
       )
       (=>
        (ens%curve25519_dalek!lemmas.field_lemmas.compute_q_lemmas.lemma_bounded_shr_51. stage_input!)
        (and
         (=>
          %%location_label%%2
          (< carry_out! 3)
