...
;; curve25519-dalek/src/lemmas/field_lemmas/compute_q_lemmas.rs:367:1: 367:74 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::compute_q_lemmas::lemma_carry_propagation_is_division
;; curve25519-dalek/src/lemmas/field_lemmas/compute_q_lemmas.rs:367:1: 367:74 (#0)
...
(push)
 ...
 (assert
  (forall ((i$ Poly)) (!
    ...
    :qid user_curve25519_dalek__lemmas__field_lemmas__compute_q_lemmas__lemma_carry_propagation_is_division_54
    :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__compute_q_lemmas__lemma_carry_propagation_is_division_54
 )))
 (assert
  (= q! (curve25519_dalek!specs.field_specs_u64.compute_q_spec.? (Poly%array%. limbs!)))
 )
         ...
         (and
          ...
          (=>
           ...
           (=>
            ...
            (=>
             (= tmp%2 (uClip 64 (Add (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $
                ...
                (and
                 ...
                 (=>
                  ...
                  (=>
                   ...
                   (=>
                    (= tmp%5 (uClip 64 (Add (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $
                          (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. limbs!)
                         ) (I 1)
                        )
                       ) q0@
                       ...
                       (and
                        ...
                        (=>
                         ...
                         (=>
                          ...
                          (=>
                           (= tmp%8 (uClip 64 (Add (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $
                                 (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. limbs!)
                                ) (I 2)
                               )
                              ) q1@
                              ...
                              (and
                               ...
                               (=>
                                ...
                                (=>
                                 ...
                                 (=>
                                  (= tmp%11 (uClip 64 (Add (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $
                                        (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. limbs!)
                                       ) (I 3)
                                      )
                                     ) q2@
                                     ...
                                     (and
                                      ...
                                      (=>
                                       ...
                                       (=>
                                        ...
                                        (=>
                                         (= tmp%14 (uClip 64 (Add (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $
                                               (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. limbs!)
                                              ) (I 4)
                                             )
                                            ) q3@
