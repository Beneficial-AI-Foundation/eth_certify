...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:2026:1: 2026:64 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_cancel_common_factor
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:2026:1: 2026:64 (#0)
...
(push)
 ...
 (declare-const inv_c@ Int)
 (declare-const inv_bc@ Int)
 (declare-const inv_b_inv_c@ Int)
 (assert
  fuel_defaults
 )
 (assert
     ...
     (=>
      ...
      (=>
       ...
       (=>
        ...
        (=>
         (= inv_c@ (curve25519_dalek!specs.field_specs.field_inv.? (I c!)))
         (=>
          (= inv_bc@ (curve25519_dalek!specs.field_specs.field_inv.? (I bc@)))
          (and
           (=>
            (= tmp%1 (nClip (Mul b! c!)))
            (and
             ...
             (=>
              ...
              (=>
               ...
               (and
                (=>
                 %%location_label%%1
                 (req%vstd!arithmetic.div_mod.lemma_mod_twice. tmp%2 p@)
                )
                (=>
                 (ens%vstd!arithmetic.div_mod.lemma_mod_twice. tmp%2 p@)
                 (or
                  (and
                   (=>
                    (= (EucMod (nClip (Mul b! c!)) p@) 0)
                    (=>
           ...
           (=>
            ...
            (and
             (=>
              ...
              (=>
               %%location_label%%5
               (= inv_bc@ (curve25519_dalek!specs.field_specs.field_mul.? (I inv_b@) (I inv_c@)))
             ))
             (=>
              (= inv_bc@ (curve25519_dalek!specs.field_specs.field_mul.? (I inv_b@) (I inv_c@)))
              (and
               (and
                (=>
                 %%location_label%%6
                 (req%curve25519_dalek!specs.field_specs.field_inv_property. c!)
                )
                (=>
                 (ens%curve25519_dalek!specs.field_specs.field_inv_property. c!)
                 (and
                  (=>
                   %%location_label%%7
                   (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. c! inv_c@ p@)
                  )
                  (=>
                   (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. c! inv_c@ p@)
                   (and
                    (=>
                     %%location_label%%8
                    ...
                    (=>
                     ...
                     (=>
                      %%location_label%%9
                      (= (curve25519_dalek!specs.field_specs.field_mul.? (I c!) (I inv_c@)) 1)
               )))))))
               (=>
                (= (curve25519_dalek!specs.field_specs.field_mul.? (I c!) (I inv_c@)) 1)
                (=>
                 (= inv_b_inv_c@ (curve25519_dalek!specs.field_specs.field_mul.? (I inv_b@) (I inv_c@)))
                 (=>
                  (= tmp%3 (= (curve25519_dalek!specs.field_specs.field_mul.? (I ac@) (I inv_bc@)) (curve25519_dalek!specs.field_specs.field_mul.?
                     (I ac@) (I inv_b_inv_c@)
                  )))
                  (and
                   (=>
                   ...
                   (=>
                    ...
                    (and
                     (=>
                      (= tmp%4 (nClip (Mul a! c!)))
                      (=>
                       (= tmp%5 (nClip (Mul inv_b@ inv_c@)))
                       (and
                        (=>
                         %%location_label%%11
                         (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop. tmp%4 tmp%5 p@)
                        )
                        (=>
                         (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop. tmp%4 tmp%5 p@)
                         (and
                          (=>
                           (= tmp%6 (nClip (Mul inv_b@ inv_c@)))
                           (=>
                            (ens%vstd!arithmetic.mul.lemma_mul_is_associative. a! c! tmp%6)
                            (=>
                             %%location_label%%12
                             (= (nClip (Mul (nClip (Mul a! c!)) (nClip (Mul inv_b@ inv_c@)))) (nClip (Mul a! (nClip
                                 (Mul c! (nClip (Mul inv_b@ inv_c@)))
                          )))))))
                          (=>
                           (= (nClip (Mul (nClip (Mul a! c!)) (nClip (Mul inv_b@ inv_c@)))) (nClip (Mul a! (nClip
                               (Mul c! (nClip (Mul inv_b@ inv_c@)))
                           ...
                           (and
                            (=>
                             (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. inv_b@ inv_c@)
                             (=>
                              %%location_label%%13
                              (= (nClip (Mul c! (nClip (Mul inv_b@ inv_c@)))) (nClip (Mul c! (nClip (Mul inv_c@ inv_b@)))))
                            ))
                            (=>
                             (= (nClip (Mul c! (nClip (Mul inv_b@ inv_c@)))) (nClip (Mul c! (nClip (Mul inv_c@ inv_b@)))))
                             (and
                              (=>
                               (ens%vstd!arithmetic.mul.lemma_mul_is_associative. c! inv_c@ inv_b@)
                               (=>
                                %%location_label%%14
                                (= (nClip (Mul c! (nClip (Mul inv_c@ inv_b@)))) (nClip (Mul (nClip (Mul c! inv_c@))
                                   inv_b@
                              )))))
                              (=>
                               (= (nClip (Mul c! (nClip (Mul inv_c@ inv_b@)))) (nClip (Mul (nClip (Mul c! inv_c@))
                                 ...
                                 (=>
                                  ...
                                  (and
                                   ...
                                   (=>
                                    ...
                                    (=>
                                     %%location_label%%17
                                     (= (EucMod (nClip (Mul c! inv_c@)) p@) 1)
                                )))))
                                (=>
                                 (= (EucMod (nClip (Mul c! inv_c@)) p@) 1)
                                 (and
                                  (=>
                                   (= tmp%7 (nClip (Mul c! inv_c@)))
                                   (and
                                    (=>
                                     %%location_label%%18
                                     (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. tmp%7 inv_b@ p@)
                                    )
                                    (=>
                                     (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. tmp%7 inv_b@ p@)
                                     (=>
                                       ...
                                       (=>
                                        ...
                                        (and
                                         ...
                                         (=>
                                          ...
                                          (=>
                                           %%location_label%%21
                                           (= (EucMod (nClip (Mul (nClip (Mul c! inv_c@)) inv_b@)) p@) inv_b@)
                                  )))))))))
                                  (=>
                                   (= (EucMod (nClip (Mul (nClip (Mul c! inv_c@)) inv_b@)) p@) inv_b@)
                                   (and
                                    (=>
                                     (= tmp%8 (= (nClip (Mul c! (nClip (Mul inv_b@ inv_c@)))) (nClip (Mul (nClip (Mul c! inv_c@))
                                         inv_b@
                                     ))))
                                     (and
                                      (=>
                                      ...
                                      (=>
                                       ...
                                       (=>
                                        %%location_label%%23
                                        (= (EucMod (nClip (Mul a! (nClip (Mul c! (nClip (Mul inv_b@ inv_c@)))))) p@) (EucMod
                                          (nClip (Mul a! (nClip (Mul (nClip (Mul c! inv_c@)) inv_b@)))) p@
                                    ))))))
                                    (=>
                                     (= (EucMod (nClip (Mul a! (nClip (Mul c! (nClip (Mul inv_b@ inv_c@)))))) p@) (EucMod
                                       (nClip (Mul a! (nClip (Mul (nClip (Mul c! inv_c@)) inv_b@)))) p@
                                     ...
                                     (and
                                      (=>
                                       (= tmp%9 (nClip (Mul (nClip (Mul c! inv_c@)) inv_b@)))
                                       (and
                                        (=>
                                         %%location_label%%24
                                         (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. a! tmp%9 p@)
                                        )
                                        (=>
                                         (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. a! tmp%9 p@)
                                         (=>
                                          %%location_label%%25
                                          (= (EucMod (nClip (Mul a! (nClip (Mul (nClip (Mul c! inv_c@)) inv_b@)))) p@) (EucMod
                                            (nClip (Mul a! inv_b@)) p@
                                      ))))))
                                      (=>
                                       (= (EucMod (nClip (Mul a! (nClip (Mul (nClip (Mul c! inv_c@)) inv_b@)))) p@) (EucMod
                                       ...
                                       (=>
                                        %%location_label%%26
                                        (= (curve25519_dalek!specs.field_specs.field_mul.? (I ac@) (I inv_b_inv_c@)) (curve25519_dalek!specs.field_specs.field_mul.?
                                          (I a!) (I inv_b@)
                     )))))))))))))))))))))
                     (=>
                      (= (curve25519_dalek!specs.field_specs.field_mul.? (I ac@) (I inv_b_inv_c@)) (curve25519_dalek!specs.field_specs.field_mul.?
