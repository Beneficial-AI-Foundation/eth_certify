...
;; curve25519-dalek/src/lemmas/common_lemmas/bits_as_nat_lemmas.rs:291:1: 297:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::bits_as_nat_lemmas::lemma_bits_from_index_eq_byte_bits
;; curve25519-dalek/src/lemmas/common_lemmas/bits_as_nat_lemmas.rs:291:1: 297:2 (#0)
...
(push)
 ...
 (assert
  (forall ((j$ Int)) (!
    ...
    :qid user_curve25519_dalek__lemmas__common_lemmas__bits_as_nat_lemmas__lemma_bits_from_index_eq_byte_bits_42
    :skolemid skolem_user_curve25519_dalek__lemmas__common_lemmas__bits_as_nat_lemmas__lemma_bits_from_index_eq_byte_bits_42
 )))
       ...
       (and
        (=>
         ...
         (=>
          (< j@ (nClip (Sub len! 1)))
          (=>
           (= tmp%1 (= (%B (vstd!seq.Seq.index.? $ BOOL (vstd!view.View.view.? $ (ARRAY $ BOOL $ (
                  CONST_INT 256
                 )
                ) (Poly%array%. bits!)
               ) (I (nClip (Add start! (nClip (Add j@ 1)))))
              )
             ) (= (uClip 8 (bitand (I (uClip 8 (bitshr (I byte!) (I (uClip 8 (nClip (Add bit_offset! (nClip
                        (Add j@ 1)
                 )))))))
                ) (I 1)
               )
            ...
            (=>
             ...
             (=>
              ...
              (= (%B (vstd!seq.Seq.index.? $ BOOL (vstd!view.View.view.? $ (ARRAY $ BOOL $ (CONST_INT
                 ...
                 ) (I (nClip (Add (nClip (Add start! 1)) j@)))
                )
               ) (= (uClip 8 (bitand (I (uClip 8 (bitshr (I byte!) (I (uClip 8 (nClip (Add (nClip (Add bit_offset!
                           1
                          )
                         ) j@
                   ))))))
        ...
        (=>
         (forall ((j$ Int)) (!
           ...
           :qid user_curve25519_dalek__lemmas__common_lemmas__bits_as_nat_lemmas__lemma_bits_from_index_eq_byte_bits_40
           :skolemid skolem_user_curve25519_dalek__lemmas__common_lemmas__bits_as_nat_lemmas__lemma_bits_from_index_eq_byte_bits_40
         ))
         (and
          (=>
           (= tmp%2 (nClip (Add start! 1)))
           (=>
            (= tmp%3 (nClip (Add bit_offset! 1)))
            (=>
             (= tmp%4 (nClip (Sub len! 1)))
             (and
              (=>
               %%location_label%%2
               (check_decrease_int (let
                 ((bits!$0 bits!) (byte!$1 byte!) (start!$2 tmp%2) (bit_offset!$3 tmp%3) (len!$4 tmp%4))
                 len!$4
               ...
               (=>
                ...
                (=>
                 ...
                 (= (curve25519_dalek!specs.core_specs.bits_from_index_to_nat.? (Poly%array%. bits!)
                  ...
                  ) (curve25519_dalek!specs.core_specs.byte_bits_value.? (I byte!) (I (nClip (Add bit_offset!
                      1
                    ))
                   ) (I (nClip (Sub len! 1)))
          )))))))))
          (=>
           ...
           (=>
            (= tmp%5 (= (%B (vstd!seq.Seq.index.? $ BOOL (vstd!view.View.view.? $ (ARRAY $ BOOL $ (
                   CONST_INT 256
                  )
                 ) (Poly%array%. bits!)
                ) (I (nClip (Add start! 0)))
               )
              ) (= (uClip 8 (bitand (I (uClip 8 (bitshr (I byte!) (I (uClip 8 (nClip (Add bit_offset! 0)))))))
                 (I 1)
                )
               ) 1
            )))
