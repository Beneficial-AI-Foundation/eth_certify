...
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:1223:1: 1223:74 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::curve_equation_lemmas::lemma_neg_distributes_over_add
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:1223:1: 1223:74 (#0)
(get-info :all-statistics)
(push)
 (declare-const P! tuple%2.)
 (declare-const Q! tuple%2.)
 ...
 (declare-const neg_px@ Int)
 (declare-const neg_qx@ Int)
 (declare-const d@ Int)
 ...
 (assert
  (has_type (Poly%tuple%2. Q!) (TYPE%tuple%2. $ NAT $ NAT))
 )
 ...
 (assert
  (not (=>
    (= tmp%%@ (tuple%2./tuple%2 (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. P!)))
      (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. P!)))
    ))
    (=>
     (= px@ (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@)))))
     (=>
      (= py@ (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@)))))
      (=>
       (= tmp%%$1@ (tuple%2./tuple%2 (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. Q!)))
         (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. Q!)))
       ))
       (=>
        (= qx@ (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$1@)))))
        (=>
         (= qy@ (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%$1@)))))
         (=>
          (= neg_px@ (curve25519_dalek!specs.field_specs.field_neg.? (I px@)))
          (=>
           (= neg_qx@ (curve25519_dalek!specs.field_specs.field_neg.? (I qx@)))
           (=>
            (= d@ (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
               curve25519_dalek!backend.serial.u64.constants.EDWARDS_D.?
            )))
            (=>
             (= x1x2@ (curve25519_dalek!specs.field_specs.field_mul.? (I px@) (I qx@)))
             (=>
              (= y1y2@ (curve25519_dalek!specs.field_specs.field_mul.? (I py@) (I qy@)))
              (=>
               (= x1y2@ (curve25519_dalek!specs.field_specs.field_mul.? (I px@) (I qy@)))
               (=>
                (= y1x2@ (curve25519_dalek!specs.field_specs.field_mul.? (I py@) (I qx@)))
                (=>
                 (= t@ (curve25519_dalek!specs.field_specs.field_mul.? (I d@) (I (curve25519_dalek!specs.field_specs.field_mul.?
                     (I x1x2@) (I y1y2@)
                 ))))
                     ...
                     (and
                      (=>
                       ...
                       (=>
                        ...
                        (=>
                         (= tmp%1 (curve25519_dalek!specs.field_specs.field_mul.? (I px@) (I qx@)))
                         (=>
                          (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_neg_neg.
                           tmp%1
                          )
                            ...
                            (=>
                             ...
                             (and
                              ...
                              (=>
                               ...
                               (=>
                                (= tmp%4 (curve25519_dalek!specs.field_specs.field_mul.? (I px@) (I qx@)))
                                (and
                                 (=>
                                  %%location_label%%1
                                  (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_element_reduced.
                                 ...
                                 (=>
                                  ...
                                  (=>
                                   %%location_label%%2
                                   (= (curve25519_dalek!specs.field_specs.field_mul.? (I neg_px@) (I neg_qx@)) x1x2@)
                      )))))))))))))
                      (=>
                       (= (curve25519_dalek!specs.field_specs.field_mul.? (I neg_px@) (I neg_qx@)) x1x2@)
                       (and
                        (=>
                         ...
                         (=>
                          %%location_label%%3
                          (= (curve25519_dalek!specs.field_specs.field_mul.? (I neg_px@) (I qy@)) (curve25519_dalek!specs.field_specs.field_neg.?
                            (I x1y2@)
                        ))))
                        (=>
                         (= (curve25519_dalek!specs.field_specs.field_mul.? (I neg_px@) (I qy@)) (curve25519_dalek!specs.field_specs.field_neg.?
                         ...
                         (and
                          (=>
                           ...
                           (=>
                            %%location_label%%4
                            (= (curve25519_dalek!specs.field_specs.field_mul.? (I py@) (I neg_qx@)) (curve25519_dalek!specs.field_specs.field_neg.?
                              (I y1x2@)
                          ))))
                          (=>
                           (= (curve25519_dalek!specs.field_specs.field_mul.? (I py@) (I neg_qx@)) (curve25519_dalek!specs.field_specs.field_neg.?
                           ...
                           (and
                            (=>
                             (= tmp%5 (curve25519_dalek!specs.field_specs.field_neg.? (I x1y2@)))
                             (=>
                              (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_sub_eq_add_neg.
                               tmp%5 y1x2@
                              )
                              (=>
                               (= tmp%6 (curve25519_dalek!specs.field_specs.field_neg.? (I x1y2@)))
                               (=>
                                (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_sub_antisymmetric.
                                 y1x2@ tmp%6
                                )
                                 ...
                                 (=>
                                  ...
                                  (=>
                                   ...
                                   (= (curve25519_dalek!specs.field_specs.field_add.? (I (curve25519_dalek!specs.field_specs.field_neg.?
                                     ...
                                     ) (I (curve25519_dalek!specs.field_specs.field_neg.? (I y1x2@)))
                            ...
                            (=>
                             ...
                             (=>
                              (= x_num@ (curve25519_dalek!specs.field_specs.field_add.? (I x1y2@) (I y1x2@)))
                              (and
                               (=>
                                (= tmp%7 (curve25519_dalek!specs.field_specs.field_inv.? (I denom_x@)))
                                (=>
                                 (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_neg_mul_left.
                                  x_num@ tmp%7
                                 )
                                 (=>
                                  ...
                                  (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_neg.?
                                   ...
                                   ) (curve25519_dalek!specs.field_specs.field_neg.? (I x3@))
                               ))))
                               (=>
                                (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_neg.?
                                    (I x_num@)
                                 ...
                                 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_add.?
                                    (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_neg.?
                                     ...
                                     (curve25519_dalek!specs.edwards_specs.edwards_add.? (tuple%2./tuple%2/0 (%Poly%tuple%2.
                                      ...
                                      ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. P!))) (tuple%2./tuple%2/0 (%Poly%tuple%2.
                                        (Poly%tuple%2. Q!)
                                       )
                                      ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. Q!)))
 )))))))))))))))))))))))))))))))))))))
