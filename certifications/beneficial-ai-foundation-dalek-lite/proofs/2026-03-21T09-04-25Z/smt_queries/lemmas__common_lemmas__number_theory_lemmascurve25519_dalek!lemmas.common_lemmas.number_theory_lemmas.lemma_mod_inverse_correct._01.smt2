...
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:1424:1: 1424:55 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::number_theory_lemmas::lemma_mod_inverse_correct
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:1424:1: 1424:55 (#0)
...
(push)
 ...
 (declare-const r@ curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult.)
 (declare-const inv@ Int)
 (declare-const normalized_x@ Int)
 (assert
  fuel_defaults
 )
 (assert
    ...
    (=>
     ...
     (=>
      ...
      (=>
       ...
       (and
        (=>
         (= tmp%1 (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult./ExtGcdResult/y
           (%Poly%curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult. (Poly%curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult.
             r@
         ))))
         (=>
          (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. m! tmp%1)
          (=>
           (= tmp%2 (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult./ExtGcdResult/y
             (%Poly%curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult. (Poly%curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult.
               r@
           ))))
           (and
            (=>
             %%location_label%%0
             (req%vstd!arithmetic.div_mod.lemma_mod_multiples_basic. tmp%2 m!)
            )
            (=>
             (ens%vstd!arithmetic.div_mod.lemma_mod_multiples_basic. tmp%2 m!)
             (=>
              %%location_label%%1
              (= (EucMod (Mul m! (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult./ExtGcdResult/y
                  (%Poly%curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult. (Poly%curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult.
                    r@
                 )))
                ) m!
        ...
        (=>
         ...
         (and
          (=>
           (= tmp%3 (Mul a_red@ (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult./ExtGcdResult/x
              (%Poly%curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult. (Poly%curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult.
                r@
           )))))
           (=>
            (= tmp%4 (Mul m! (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult./ExtGcdResult/y
               (%Poly%curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult. (Poly%curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult.
                 r@
            )))))
            (and
             (=>
              %%location_label%%2
              (req%vstd!arithmetic.div_mod.lemma_add_mod_noop. tmp%3 tmp%4 m!)
             )
             (=>
              (ens%vstd!arithmetic.div_mod.lemma_add_mod_noop. tmp%3 tmp%4 m!)
              (=>
               (= tmp%5 (Mul a_red@ (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult./ExtGcdResult/x
                  (%Poly%curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult. (Poly%curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult.
                    r@
               )))))
               (and
                (=>
                 %%location_label%%3
                 (req%vstd!arithmetic.div_mod.lemma_mod_twice. tmp%5 m!)
                )
                (=>
                 (ens%vstd!arithmetic.div_mod.lemma_mod_twice. tmp%5 m!)
                 (and
                  (=>
                   %%location_label%%4
                   (req%vstd!arithmetic.div_mod.lemma_small_mod. 1 m!)
                  )
                  (=>
                   (ens%vstd!arithmetic.div_mod.lemma_small_mod. 1 m!)
                   (=>
                    %%location_label%%5
                    (= (EucMod (Mul a_red@ (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult./ExtGcdResult/x
                        (%Poly%curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult. (Poly%curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult.
                          r@
                       )))
                      ) m!
          ...
          (=>
           ...
           (=>
            ...
            (=>
             (= normalized_x@ (nClip (EucMod (Add (EucMod (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult./ExtGcdResult/x
                   (%Poly%curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult. (Poly%curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult.
                     r@
                   ))
                  ) m!
             ...
             (and
              (=>
               (= tmp%6 (Add (EucMod (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult./ExtGcdResult/x
                   (%Poly%curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult. (Poly%curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult.
                     r@
                   ))
                  ) m!
               ...
               (and
                (=>
                 %%location_label%%6
                 (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%6 m!)
                )
                (=>
                 (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%6 m!)
                 (=>
                  %%location_label%%7
                  (< inv@ m!)
              ))))
              (=>
               ...
               (and
                (=>
                 (= tmp%7 (EucMod (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult./ExtGcdResult/x
                    (%Poly%curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult. (Poly%curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult.
                      r@
                    ))
                   ) m!
                 ...
                 (and
                  (=>
                   %%location_label%%8
                   (req%vstd!arithmetic.div_mod.lemma_add_mod_noop. tmp%7 m! m!)
                  )
                  (=>
                   (ens%vstd!arithmetic.div_mod.lemma_add_mod_noop. tmp%7 m! m!)
                   (and
                    (=>
                     %%location_label%%9
                     (req%vstd!arithmetic.div_mod.lemma_mod_self_0. m!)
                    ...
                    (=>
                     ...
                     (=>
                      (= tmp%8 (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult./ExtGcdResult/x
                        (%Poly%curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult. (Poly%curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult.
                          r@
                      ))))
                      (and
                       (=>
                        %%location_label%%10
                        (req%vstd!arithmetic.div_mod.lemma_mod_twice. tmp%8 m!)
                       )
                       (=>
                        (ens%vstd!arithmetic.div_mod.lemma_mod_twice. tmp%8 m!)
                        (=>
                         %%location_label%%11
                         (= (EucMod normalized_x@ m!) (EucMod (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult./ExtGcdResult/x
                            (%Poly%curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult. (Poly%curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult.
                              r@
                            ))
                           ) m!
                ...
                (=>
                 ...
                 (and
                  (and
                   (=>
                    %%location_label%%12
                    (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. a_red@ normalized_x@ m!)
                   )
                   (=>
                    (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. a_red@ normalized_x@ m!)
                    (=>
                     (= tmp%9 (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult./ExtGcdResult/x
                       (%Poly%curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult. (Poly%curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.ExtGcdResult.
                         r@
                     ))))
                     (and
                      (=>
                       %%location_label%%13
                       (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. a_red@ tmp%9 m!)
                      )
                      (=>
                       (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. a_red@ tmp%9 m!)
                       (=>
                        %%location_label%%14
                        (= (EucMod (Mul a_red@ normalized_x@) m!) 1)
                  ))))))
                  (=>
                   (= (EucMod (Mul a_red@ normalized_x@) m!) 1)
                   (and
                    (and
                     (=>
                      %%location_label%%15
                      (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. a! inv@ m!)
                     )
                     (=>
                      (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. a! inv@ m!)
                      (=>
                       %%location_label%%16
                       (= (EucMod (nClip (Mul a! inv@)) m!) 1)
                    )))
                    (=>
                     (= (EucMod (nClip (Mul a! inv@)) m!) 1)
                     (and
