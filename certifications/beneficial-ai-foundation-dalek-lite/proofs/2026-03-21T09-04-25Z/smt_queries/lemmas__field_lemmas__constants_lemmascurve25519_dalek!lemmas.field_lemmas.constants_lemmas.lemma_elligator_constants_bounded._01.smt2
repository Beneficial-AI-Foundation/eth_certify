...
;; curve25519-dalek/src/lemmas/field_lemmas/constants_lemmas.rs:544:1: 544:49 (#0)
...
;; Function-Specs curve25519_dalek::lemmas::edwards_lemmas::constants_lemmas::lemma_edwards_d_limbs_bounded_54
(declare-fun ens%curve25519_dalek!lemmas.edwards_lemmas.constants_lemmas.lemma_edwards_d_limbs_bounded_54.
 (Int) Bool
)
(assert
 (forall ((no%param Int)) (!
   (= (ens%curve25519_dalek!lemmas.edwards_lemmas.constants_lemmas.lemma_edwards_d_limbs_bounded_54.
     no%param
    ) (curve25519_dalek!specs.field_specs.fe51_limbs_bounded.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
      curve25519_dalek!backend.serial.u64.constants.EDWARDS_D.?
     ) (I 54)
   ))
   :pattern ((ens%curve25519_dalek!lemmas.edwards_lemmas.constants_lemmas.lemma_edwards_d_limbs_bounded_54.
     no%param
   ))
   :qid internal_ens__curve25519_dalek!lemmas.edwards_lemmas.constants_lemmas.lemma_edwards_d_limbs_bounded_54._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.edwards_lemmas.constants_lemmas.lemma_edwards_d_limbs_bounded_54._definition
)))

;; Function-Specs curve25519_dalek::lemmas::field_lemmas::constants_lemmas::lemma_elligator_constants_bounded
(declare-fun ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_elligator_constants_bounded.
 (Int) Bool
)
(assert
 (forall ((no%param Int)) (!
   (= (ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_elligator_constants_bounded.
     no%param
    ) (and
     (curve25519_dalek!specs.field_specs.fe51_limbs_bounded.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
       curve25519_dalek!backend.serial.u64.constants.SQRT_M1.?
   ...
   :pattern ((ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_elligator_constants_bounded.
     no%param
   ))
   :qid internal_ens__curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_elligator_constants_bounded._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_elligator_constants_bounded._definition
)))

;; Function-Def curve25519_dalek::lemmas::field_lemmas::constants_lemmas::lemma_elligator_constants_bounded
;; curve25519-dalek/src/lemmas/field_lemmas/constants_lemmas.rs:544:1: 544:49 (#0)
