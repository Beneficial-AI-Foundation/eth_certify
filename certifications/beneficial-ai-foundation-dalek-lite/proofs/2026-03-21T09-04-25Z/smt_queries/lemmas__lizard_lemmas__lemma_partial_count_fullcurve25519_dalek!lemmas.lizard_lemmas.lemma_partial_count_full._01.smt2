...
;; MODULE 'module lemmas::lizard_lemmas, function curve25519_dalek::lemmas::lizard_lemmas::lemma_partial_count_full'
;; curve25519-dalek/src/lemmas/lizard_lemmas.rs:1387:1: 1387:75 (#0)
...
(assert
 (distinct fuel%vstd!array.array_view. fuel%vstd!array.impl&%0.view. fuel%vstd!array.impl&%2.spec_index.
  ...
  fuel%curve25519_dalek!specs.field_specs.field_square. fuel%curve25519_dalek!specs.field_specs.u8_32_from_nat.
  ...
  fuel%curve25519_dalek!specs.lizard_specs.spec_lizard_fe_bytes. fuel%curve25519_dalek!specs.lizard_specs.spec_lizard_decode_candidates.
  fuel%curve25519_dalek!specs.lizard_specs.spec_candidate_sha_consistent. fuel%curve25519_dalek!specs.lizard_specs.spec_sha_consistent_count.
  fuel%curve25519_dalek!specs.lizard_specs.partial_sha_consistent_count. fuel%curve25519_dalek!core_assumes.seq_to_array_32.
...
(declare-datatypes ((vstd!raw_ptr.PtrData. 0) (curve25519_dalek!backend.serial.u64.field.FieldElement51.
   0
  ) (curve25519_dalek!edwards.EdwardsPoint. 0) (tuple%0. 0) (tuple%2. 0)
 ...
 (=>
  ...
  (forall ((limbs! Poly) (bit_limit! Poly)) (!
    (= (curve25519_dalek!specs.field_specs.u64_5_bounded.? limbs! bit_limit!) (forall (
       ...
       :qid user_curve25519_dalek__specs__field_specs__u64_5_bounded_21
       :skolemid skolem_user_curve25519_dalek__specs__field_specs__u64_5_bounded_21
    )))
  ...
  (forall ((fe1! Poly) (fe2! Poly) (bound! Poly)) (!
    (= (curve25519_dalek!specs.field_specs.sum_of_limbs_bounded.? fe1! fe2! bound!) (forall
      ((i$ Poly)) (!
       ...
       :qid user_curve25519_dalek__specs__field_specs__sum_of_limbs_bounded_22
       :skolemid skolem_user_curve25519_dalek__specs__field_specs__sum_of_limbs_bounded_22
    )))
  ...
  (forall ((point! Poly)) (!
    (= (curve25519_dalek!specs.lizard_specs.spec_lizard_decode_candidates.? point!) (%Poly%array%.
      (let
       ...
       (array_new (DST $) (TYPE%tuple%2. $ BOOL $ NAT) 8 (%%array%%2 (Poly%tuple%2. (curve25519_dalek!specs.lizard_specs.spec_elligator_inv.?
...
;; Function-Def curve25519_dalek::lemmas::lizard_lemmas::lemma_partial_count_full
;; curve25519-dalek/src/lemmas/lizard_lemmas.rs:1387:1: 1387:75 (#0)
 ...
 (assert
  (not (=>
    ...
    (=>
     (fuel_bool fuel%curve25519_dalek!specs.lizard_specs.partial_sha_consistent_count.)
     (=>
      (exists ((fuel% Fuel)) (= fuel_nat%curve25519_dalek!specs.lizard_specs.partial_sha_consistent_count.
        (succ (succ (succ (succ (succ (succ (succ (succ fuel%))))))))
      ))
      (=>
       (= tmp%1 (= (curve25519_dalek!specs.lizard_specs.partial_sha_consistent_count.? (Poly%array%.
           c@
          ) (I 0)
         ) 0
       ))
       (and
        ...
        (=>
         tmp%1
         (=>
          (= tmp%2 (= (curve25519_dalek!specs.lizard_specs.partial_sha_consistent_count.? (Poly%array%.
              c@
             ) (I 1)
            ) (nClip (Add 0 (ite
               (and
          ...
          (and
           ...
           (=>
            tmp%2
            (=>
             (= tmp%3 (= (curve25519_dalek!specs.lizard_specs.partial_sha_consistent_count.? (Poly%array%.
                 c@
                ) (I 2)
               ) (nClip (Add (curve25519_dalek!specs.lizard_specs.partial_sha_consistent_count.? (Poly%array%.
                   c@
                  ) (I 1)
                 ) (ite
                  (and
             ...
             (and
              ...
              (=>
               tmp%3
               (=>
                (= tmp%4 (= (curve25519_dalek!specs.lizard_specs.partial_sha_consistent_count.? (Poly%array%.
                    c@
                   ) (I 3)
                  ) (nClip (Add (curve25519_dalek!specs.lizard_specs.partial_sha_consistent_count.? (Poly%array%.
                      c@
                ...
                (and
                 ...
                 (=>
                  tmp%4
                  (=>
                   (= tmp%5 (= (curve25519_dalek!specs.lizard_specs.partial_sha_consistent_count.? (Poly%array%.
                       c@
                      ) (I 4)
                     ) (nClip (Add (curve25519_dalek!specs.lizard_specs.partial_sha_consistent_count.? (Poly%array%.
                         c@
                   ...
                   (and
                    ...
                    (=>
                     tmp%5
                     (=>
                      (= tmp%6 (= (curve25519_dalek!specs.lizard_specs.partial_sha_consistent_count.? (Poly%array%.
                          c@
                         ) (I 5)
                        ) (nClip (Add (curve25519_dalek!specs.lizard_specs.partial_sha_consistent_count.? (Poly%array%.
                            c@
                      ...
                      (and
                       ...
                       (=>
                        tmp%6
                        (=>
                         (= tmp%7 (= (curve25519_dalek!specs.lizard_specs.partial_sha_consistent_count.? (Poly%array%.
                             c@
                            ) (I 6)
                           ) (nClip (Add (curve25519_dalek!specs.lizard_specs.partial_sha_consistent_count.? (Poly%array%.
                               c@
                         ...
                         (and
                          ...
                          (=>
                           tmp%7
                           (=>
                            (= tmp%8 (= (curve25519_dalek!specs.lizard_specs.partial_sha_consistent_count.? (Poly%array%.
                                c@
                               ) (I 7)
                              ) (nClip (Add (curve25519_dalek!specs.lizard_specs.partial_sha_consistent_count.? (Poly%array%.
                                  c@
                            ...
                            (and
                             ...
                             (=>
                              tmp%8
                              (=>
                               (= tmp%9 (= (curve25519_dalek!specs.lizard_specs.partial_sha_consistent_count.? (Poly%array%.
                                   c@
                                  ) (I 8)
                                 ) (nClip (Add (curve25519_dalek!specs.lizard_specs.partial_sha_consistent_count.? (Poly%array%.
                                     c@
