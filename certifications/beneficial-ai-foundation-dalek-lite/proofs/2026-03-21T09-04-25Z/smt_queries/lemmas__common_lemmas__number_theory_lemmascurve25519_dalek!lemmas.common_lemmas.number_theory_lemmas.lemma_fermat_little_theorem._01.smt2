...
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:1915:1: 1915:61 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::number_theory_lemmas::lemma_fermat_little_theorem
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:1915:1: 1915:61 (#0)
    ...
    (=>
     ...
     (and
      (and
       (=>
        %%location_label%%0
        (req%vstd!arithmetic.div_mod.lemma_mod_bound. x! prime!)
       )
       (=>
        (ens%vstd!arithmetic.div_mod.lemma_mod_bound. x! prime!)
        (=>
         %%location_label%%1
         (< a@ prime!)
      )))
      (=>
       ...
       (and
        (and
         (=>
          %%location_label%%2
          (req%vstd!arithmetic.div_mod.lemma_small_mod. a@ prime!)
         )
         (=>
          (ens%vstd!arithmetic.div_mod.lemma_small_mod. a@ prime!)
          (=>
           %%location_label%%3
           (= (EucMod a@ prime!) a@)
        )))
         ...
         (and
          ...
          (=>
           ...
           (=>
            ...
            (=>
             (= tmp%1 (= (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.product_of_multiples.?
                (I a@) (I n@)
               ) (nClip (Mul (nClip (vstd!arithmetic.power.pow.? (I a@) (I n@))) (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.factorial.?
                  (I n@)
             )))))
              ...
              (=>
               ...
               (and
                ...
                (=>
                 ...
                 (=>
                  (= tmp%2 (= (EucMod (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.product_of_multiples.?
                      (I a@) (I n@)
                     ) prime!
                    ) (EucMod (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.factorial.? (
                       I n@
                   ...
                   (=>
                    ...
                    (and
                     ...
                     (=>
                      ...
                      (=>
                       (= tmp%3 (not (= (EucMod (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.factorial.?
                            (I n@)
                           ) prime!
                          ) 0
                       )))
                       (and
                        ...
                        (=>
                         ...
                         (and
                          (=>
                           %%location_label%%10
                           (= (EucMod (nClip (Mul (nClip (vstd!arithmetic.power.pow.? (I a@) (I n@))) (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.factorial.?
                                (I n@)
                              ))
                             ) prime!
                            ) (EucMod (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.factorial.? (
                          ...
                          (=>
                           ...
                           (=>
                            (= tmp%4 (nClip (vstd!arithmetic.power.pow.? (I a@) (I n@))))
                            (=>
                             (= tmp%5 (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.factorial.? (I
                                n@
                             )))
                             (and
                              (=>
                              ...
                              (=>
                               ...
                               (=>
                                (= tmp%6 (= (EucMod (nClip (vstd!arithmetic.power.pow.? (I a@) (I n@))) prime!) 1))
                                (and
                                 (=>
                                  %%location_label%%12
                                  tmp%6
                                 ...
                                 (=>
                                  ...
                                  (and
                                   (=>
                                    %%location_label%%13
                                    (req%vstd!arithmetic.power.lemma_pow_mod_noop. x! n@ prime!)
                                   )
                                   (=>
                                    (ens%vstd!arithmetic.power.lemma_pow_mod_noop. x! n@ prime!)
                                    (and
                                     (or
                                      (and
                                       (=>
                                        ...
                                        (and
                                         (=>
                                          %%location_label%%14
                                          (req%vstd!arithmetic.power.lemma_pow_positive. a@ n@)
                                         )
                                         (=>
                                          (ens%vstd!arithmetic.power.lemma_pow_positive. a@ n@)
                                          %%switch_label%%1
                                       )))
                                       (=>
                                        (not (> a@ 0))
                                          ...
                                          (=>
                                           ...
                                           (and
                                            (and
                                             (=>
                                              %%location_label%%16
                                              (req%vstd!arithmetic.div_mod.lemma_small_mod. 0 prime!)
                                             )
                                             (=>
                                              (ens%vstd!arithmetic.div_mod.lemma_small_mod. 0 prime!)
                                              (=>
                                               %%location_label%%17
                                               (= (EucMod a@ prime!) 0)
                                            )))
                                      ...
                                      (and
                                       ...
                                       (=>
                                        %%location_label%%18
                                        (>= (vstd!arithmetic.power.pow.? (I a@) (I n@)) 0)
                                     )))
                                     (=>
                                      (>= (vstd!arithmetic.power.pow.? (I a@) (I n@)) 0)
                                      (and
                                       (=>
                                        (= tmp%8 (= a@ (EucMod x! prime!)))
                                        (and
                                         (=>
                                          %%location_label%%19
                                          tmp%8
                                         ...
                                         (=>
                                          ...
                                          (and
                                           ...
                                           (=>
                                            ...
                                            (=>
                                             %%location_label%%22
                                             (= (EucMod (vstd!arithmetic.power.pow.? (I a@) (I n@)) prime!) (EucMod (vstd!arithmetic.power.pow.?
                                                (I x!) (I n@)
                                               ) prime!
                                       ))))))))
                                       (=>
                                         ...
                                         (and
                                          (or
                                           (and
                                            (=>
                                             ...
                                             (and
                                              (=>
                                               %%location_label%%23
                                               (req%vstd!arithmetic.power.lemma_pow_positive. x! n@)
                                              )
                                              (=>
                                               (ens%vstd!arithmetic.power.lemma_pow_positive. x! n@)
                                               %%switch_label%%0
                                            )))
                                            (=>
                                             (not (> x! 0))
                                           ...
                                           (and
                                            ...
                                            (=>
                                             %%location_label%%27
                                             (>= (vstd!arithmetic.power.pow.? (I x!) (I n@)) 0)
                                          )))
                                          (=>
                                           (>= (vstd!arithmetic.power.pow.? (I x!) (I n@)) 0)
                                           (=>
                                            %%location_label%%28
                                            (= (EucMod (nClip (vstd!arithmetic.power.pow.? (I x!) (I n@))) prime!) 1)
                                         )))
                                         (=>
                                          (= (EucMod (nClip (vstd!arithmetic.power.pow.? (I x!) (I n@))) prime!) 1)
                                          (=>
