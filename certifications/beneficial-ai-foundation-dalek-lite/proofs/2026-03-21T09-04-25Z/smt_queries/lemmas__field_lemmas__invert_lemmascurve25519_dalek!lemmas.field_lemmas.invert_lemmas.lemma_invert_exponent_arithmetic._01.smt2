...
;; curve25519-dalek/src/lemmas/field_lemmas/invert_lemmas.rs:123:1: 123:48 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::invert_lemmas::lemma_invert_exponent_arithmetic
;; curve25519-dalek/src/lemmas/field_lemmas/invert_lemmas.rs:123:1: 123:48 (#0)
...
(push)
 ...
 (assert
  (not (and
    (and
     (=>
      (ens%vstd!arithmetic.power2.lemma_pow2_adds. 250 5)
      (=>
       %%location_label%%0
       (= (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 250)) (vstd!arithmetic.power2.pow2.?
           (I 5)
         ))
