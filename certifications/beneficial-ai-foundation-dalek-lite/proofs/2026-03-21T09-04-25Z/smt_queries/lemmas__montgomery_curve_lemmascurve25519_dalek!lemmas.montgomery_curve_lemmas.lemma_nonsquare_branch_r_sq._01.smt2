...
;; curve25519-dalek/src/lemmas/montgomery_curve_lemmas.rs:1008:7: 1008:78 (#0)
...
;; Function-Def curve25519_dalek::lemmas::montgomery_curve_lemmas::lemma_nonsquare_branch_r_sq
;; curve25519-dalek/src/lemmas/montgomery_curve_lemmas.rs:1008:7: 1008:78 (#0)
...
(push)
 ...
 (declare-const dpa@ Int)
 (declare-const neg_a@ Int)
 (declare-const inv_dd@ Int)
 (declare-const two_rsq@ Int)
 (declare-const a_two_rsq@ Int)
 ...
 (assert
  (not (=>
    ...
    (=>
     ...
     (=>
      (= dpa@ (curve25519_dalek!specs.field_specs.field_add.? (I d!) (I A!)))
      (and
       (and
        (=>
         %%location_label%%0
         (req%vstd!arithmetic.div_mod.lemma_small_mod. 0 pp@)
        )
        (=>
         (ens%vstd!arithmetic.div_mod.lemma_small_mod. 0 pp@)
         (and
          (=>
           %%location_label%%1
          ...
          (=>
           ...
           (=>
            (= tmp%1 (nClip (Sub pp@ 1)))
            (and
             (=>
              %%location_label%%2
              (req%vstd!arithmetic.div_mod.lemma_small_mod. tmp%1 pp@)
             )
             (=>
              (ens%vstd!arithmetic.div_mod.lemma_small_mod. tmp%1 pp@)
              (=>
               %%location_label%%3
               (= (curve25519_dalek!specs.field_specs.field_sub.? (I 0) (I 1)) (nClip (Sub pp@ 1)))
       ))))))))
       (=>
        (= (curve25519_dalek!specs.field_specs.field_sub.? (I 0) (I 1)) (nClip (Sub pp@ 1)))
        (and
         (=>
          ...
          (and
           (=>
            %%location_label%%4
            (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%2 pp@)
           )
           (=>
            (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%2 pp@)
            (=>
             %%location_label%%5
             (< dpa@ pp@)
         ))))
            ...
            (=>
             ...
             (and
              (and
               (=>
                %%location_label%%6
                (req%vstd!arithmetic.div_mod.lemma_mod_self_0. pp@)
               )
               (=>
                (ens%vstd!arithmetic.div_mod.lemma_mod_self_0. pp@)
                (=>
                 %%location_label%%7
                 (= (curve25519_dalek!specs.field_specs.field_neg.? (I 0)) 0)
              )))
              (=>
               (= (curve25519_dalek!specs.field_specs.field_neg.? (I 0)) 0)
               (=>
           ...
           (and
            ...
            (and
             (and
              (=>
               %%location_label%%9
               (req%vstd!arithmetic.div_mod.lemma_small_mod. dpa@ pp@)
              )
              (=>
               (ens%vstd!arithmetic.div_mod.lemma_small_mod. dpa@ pp@)
               (=>
                (= tmp%3 (nClip (Sub pp@ dpa@)))
                (and
                 (=>
                  %%location_label%%10
                  (req%vstd!arithmetic.div_mod.lemma_small_mod. tmp%3 pp@)
                 )
                 (=>
                  (ens%vstd!arithmetic.div_mod.lemma_small_mod. tmp%3 pp@)
                  (=>
                   %%location_label%%11
                   (= (curve25519_dalek!specs.field_specs.field_neg.? (I dpa@)) (nClip (Sub pp@ dpa@)))
             ))))))
             (=>
              (= (curve25519_dalek!specs.field_specs.field_neg.? (I dpa@)) (nClip (Sub pp@ dpa@)))
              (=>
                 ...
                 (and
                  (or
                   (and
                    (=>
                     (= (EucMod d_denom! pp@) 0)
                     (=>
                      (= tmp%5 (= (curve25519_dalek!specs.field_specs.field_inv.? (I d_denom!)) 0))
                      (and
                       (=>
                        %%location_label%%13
                        tmp%5
                       ...
                       (=>
                        tmp%5
                        (=>
                         (= tmp%6 (curve25519_dalek!specs.field_specs.field_neg.? (I A!)))
                         (=>
                          (= tmp%7 (curve25519_dalek!specs.field_specs.field_inv.? (I d_denom!)))
                          (and
                           (=>
                            %%location_label%%14
                            (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_zero_right.
                             ...
                             (and
                              ...
                              (=>
                               ...
                               (and
                                (=>
                                 %%location_label%%16
                                 (req%curve25519_dalek!lemmas.montgomery_curve_lemmas.lemma_p_gt_small. A!)
                                )
                                (=>
                                 (ens%curve25519_dalek!lemmas.montgomery_curve_lemmas.lemma_p_gt_small. A!)
                                 (and
                                  (and
                                   (=>
                                    %%location_label%%17
                                    (req%vstd!arithmetic.div_mod.lemma_small_mod. A! pp@)
                                   )
                                   (=>
                                    (ens%vstd!arithmetic.div_mod.lemma_small_mod. A! pp@)
                                    (=>
                                     %%location_label%%18
                                     (= (curve25519_dalek!specs.field_specs.field_add.? (I 0) (I A!)) A!)
                                  )))
                                  (=>
                                   (= (curve25519_dalek!specs.field_specs.field_add.? (I 0) (I A!)) A!)
                                   (=>
                  ...
                  (=>
                   ...
                   (=>
                    ...
                    (=>
                     (= inv_dd@ (curve25519_dalek!specs.field_specs.field_inv.? (I d_denom!)))
                     (=>
                      (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_assoc.
                       neg_a@ inv_dd@ d_denom!
                      )
                      (=>
                       (= tmp%9 (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                            (I neg_a@) (I inv_dd@)
                           )
                          ) (I d_denom!)
                         ) (curve25519_dalek!specs.field_specs.field_mul.? (I neg_a@) (I (curve25519_dalek!specs.field_specs.field_mul.?
                            (I inv_dd@) (I d_denom!)
                       )))))
                       (and
                        (=>
                        ...
                        (=>
                         tmp%9
                         (=>
                          (= tmp%10 (= d! (curve25519_dalek!specs.field_specs.field_mul.? (I neg_a@) (I inv_dd@))))
                          (and
                           (=>
                            %%location_label%%22
                            tmp%10
                           ...
                           (=>
                            ...
                            (and
                             ...
                             (=>
                              ...
                              (=>
                               (= tmp%11 (= (curve25519_dalek!specs.field_specs.field_mul.? (I inv_dd@) (I d_denom!))
                                 1
                               ))
                               (and
                                (=>
                                ...
                                (=>
                                 ...
                                 (=>
                                  ...
                                  (and
                                   (=>
                                    (= tmp%12 (Sub pp@ (EucMod A! pp@)))
                                    (and
                                     (=>
                                      %%location_label%%25
                                      (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%12 pp@)
                                     )
                                     (=>
                                      (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%12 pp@)
                                      (=>
                                       %%location_label%%26
                                       (< neg_a@ pp@)
                                   ))))
                                   (=>
                                    ...
                                    (and
                                     (=>
                                      %%location_label%%27
                                      (req%vstd!arithmetic.div_mod.lemma_small_mod. neg_a@ pp@)
                                     )
                                     (=>
                                      (ens%vstd!arithmetic.div_mod.lemma_small_mod. neg_a@ pp@)
                                      (=>
                                       (= tmp%13 (= (curve25519_dalek!specs.field_specs.field_mul.? (I neg_a@) (I 1)) neg_a@))
                                       (and
                                        (=>
                                         %%location_label%%28
                                         tmp%13
                                        ...
                                        (=>
                                         tmp%13
                                         (=>
                                          (= tmp%14 (= (curve25519_dalek!specs.field_specs.field_mul.? (I d!) (I d_denom!)) neg_a@))
                                          (and
                                           (=>
                                            %%location_label%%29
                                            tmp%14
                                             ...
                                             (=>
                                              ...
                                              (=>
                                               ...
                                               (=>
                                                ...
                                                (=>
                                                 (= tmp%15 (= (curve25519_dalek!specs.field_specs.field_mul.? (I dpa@) (I d_denom!))
                                                   (curve25519_dalek!specs.field_specs.field_add.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                                                      (I d!) (I d_denom!)
                                                     )
                                                    ) (I (curve25519_dalek!specs.field_specs.field_mul.? (I A!) (I d_denom!)))
                                                 )))
                                                 (and
                                                  (=>
                                                   %%location_label%%30
                                                  ...
                                                  (=>
                                                   ...
                                                   (=>
                                                    ...
                                                    (and
                                                     (=>
                                                      (= tmp%16 (nClip (Add 1 (EucMod (nClip (Mul 2 r_sq!)) pp@))))
                                                      (and
                                                       (=>
                                                        %%location_label%%31
                                                        (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%16 pp@)
                                                       )
                                                       (=>
                                                        (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%16 pp@)
                                                        (=>
                                                         %%location_label%%32
                                                         (< d_denom! pp@)
                                                     ))))
                                                     (=>
                                                      ...
                                                      (and
                                                       (=>
                                                        %%location_label%%33
                                                        (req%vstd!arithmetic.div_mod.lemma_small_mod. d_denom! pp@)
                                                       )
                                                       (=>
                                                        (ens%vstd!arithmetic.div_mod.lemma_small_mod. d_denom! pp@)
                                                        (=>
                                                         (= tmp%17 (= (curve25519_dalek!specs.field_specs.field_mul.? (I dpa@) (I d_denom!))
                                                           d_denom!
                                                         ))
                                                         (and
                                                          (=>
                                                          ...
                                                          (=>
                                                           tmp%17
                                                           (=>
                                                            (= tmp%18 (= d_denom! (curve25519_dalek!specs.field_specs.field_add.? (I (curve25519_dalek!specs.field_specs.field_neg.?
                                                                 (I A!)
                                                                )
                                                               ) (I (curve25519_dalek!specs.field_specs.field_mul.? (I A!) (I d_denom!)))
                                                            )))
                                                            (and
                                                             ...
                                                             (=>
                                                              tmp%18
                                                              (=>
                                                               (= two_rsq@ (curve25519_dalek!specs.field_specs.field_mul.? (I 2) (I r_sq!)))
                                                               (=>
                                                                (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_distributes_over_add.
                                                                 A! 1 two_rsq@
                                                                )
                                                                  ...
                                                                  (=>
                                                                   ...
                                                                   (and
                                                                    ...
                                                                    (=>
                                                                     (ens%vstd!arithmetic.div_mod.lemma_small_mod. A! pp@)
                                                                     (=>
                                                                      (= a_two_rsq@ (curve25519_dalek!specs.field_specs.field_mul.? (I A!) (I two_rsq@)))
                                                                      (=>
                                                                       (= tmp%19 (curve25519_dalek!specs.field_specs.field_neg.? (I A!)))
                                                                       (=>
                                                                        (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_add_assoc.
                                                                         tmp%19 A! a_two_rsq@
                                                                        )
                                                                        (and
                                                                         (and
                                                                          ...
                                                                          (=>
                                                                           (ens%vstd!arithmetic.div_mod.lemma_small_mod. A! pp@)
                                                                           (=>
                                                                            (= tmp%20 (nClip (Sub pp@ A!)))
                                                                            (and
                                                                             (=>
                                                                              %%location_label%%39
                                                                              (req%vstd!arithmetic.div_mod.lemma_small_mod. tmp%20 pp@)
                                                                             )
                                                                             (=>
                                                                              (ens%vstd!arithmetic.div_mod.lemma_small_mod. tmp%20 pp@)
                                                                              (=>
                                                                               %%location_label%%40
                                                                               (= (curve25519_dalek!specs.field_specs.field_neg.? (I A!)) (nClip (Sub pp@ A!)))
                                                                         ))))))
                                                                         (=>
                                                                          (= (curve25519_dalek!specs.field_specs.field_neg.? (I A!)) (nClip (Sub pp@ A!)))
                                                                          (and
                                                                           (and
                                                                            ...
                                                                            (=>
                                                                             ...
                                                                             (=>
                                                                              %%location_label%%42
                                                                              (= (curve25519_dalek!specs.field_specs.field_add.? (I (curve25519_dalek!specs.field_specs.field_neg.?
                                                                                  (I A!)
                                                                                 )
                                                                                ) (I A!)
                                                                               ) 0
                                                                           ...
                                                                           (=>
                                                                            ...
                                                                            (and
                                                                             (=>
                                                                              (= tmp%21 (nClip (Mul A! two_rsq@)))
                                                                              (and
                                                                               (=>
                                                                                %%location_label%%43
                                                                                (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%21 pp@)
                                                                               )
                                                                               (=>
                                                                                (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%21 pp@)
                                                                                (=>
                                                                                 %%location_label%%44
                                                                                 (< a_two_rsq@ pp@)
                                                                             ))))
                                                                             (=>
                                                                              ...
                                                                              (and
                                                                               (and
                                                                                (=>
                                                                                 %%location_label%%45
                                                                                 (req%vstd!arithmetic.div_mod.lemma_small_mod. a_two_rsq@ pp@)
                                                                                )
                                                                                (=>
                                                                                 (ens%vstd!arithmetic.div_mod.lemma_small_mod. a_two_rsq@ pp@)
                                                                                 (=>
                                                                                  %%location_label%%46
                                                                                  (= (curve25519_dalek!specs.field_specs.field_add.? (I 0) (I a_two_rsq@)) a_two_rsq@)
                                                                               )))
                                                                               (=>
                                                                                (= (curve25519_dalek!specs.field_specs.field_add.? (I 0) (I a_two_rsq@)) a_two_rsq@)
                                                                                (=>
                                                                                 (= tmp%22 (= d_denom! a_two_rsq@))
                                                                                 (and
                                                                                  (=>
                                                                                   %%location_label%%47
                                                                                   tmp%22
                                                                                  ...
                                                                                  (=>
                                                                                   ...
                                                                                   (=>
                                                                                    ...
                                                                                    (=>
                                                                                     (= tmp%23 (= a_two_rsq@ (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                                                                                          (I A!) (I 2)
                                                                                         )
                                                                                        ) (I r_sq!)
                                                                                     )))
                                                                                      ...
                                                                                      (=>
                                                                                       ...
                                                                                       (and
                                                                                        (and
                                                                                         ...
                                                                                         (=>
                                                                                          (= (nClip (Mul 486662 2)) 973324)
                                                                                          (and
                                                                                           (=>
                                                                                            %%location_label%%50
                                                                                            (req%curve25519_dalek!lemmas.montgomery_curve_lemmas.lemma_p_gt_small. 973324)
                                                                                           )
                                                                                           (=>
                                                                                            (ens%curve25519_dalek!lemmas.montgomery_curve_lemmas.lemma_p_gt_small. 973324)
                                                                                            (and
                                                                                             (=>
                                                                                              %%location_label%%51
                                                                                              (req%vstd!arithmetic.div_mod.lemma_small_mod. 973324 pp@)
                                                                                             )
                                                                                             (=>
                                                                                              (ens%vstd!arithmetic.div_mod.lemma_small_mod. 973324 pp@)
                                                                                              (=>
                                                                                               %%location_label%%52
                                                                                               (= (curve25519_dalek!specs.field_specs.field_mul.? (I A!) (I 2)) 973324)
                                                                                        )))))))
                                                                                        (=>
                                                                                         (= (curve25519_dalek!specs.field_specs.field_mul.? (I A!) (I 2)) 973324)
                                                                                         (and
                                                                                          (=>
                                                                                           (= tmp%24 (nClip (Mul 2 r_sq!)))
                                                                                           (and
                                                                                            (=>
                                                                                             %%location_label%%53
                                                                                             (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%24 pp@)
                                                                                            )
                                                                                            (=>
                                                                                             (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%24 pp@)
                                                                                             (=>
                                                                                              %%location_label%%54
                                                                                              (< two_rsq@ pp@)
                                                                                          ))))
                                                                                             ...
                                                                                             (=>
                                                                                              ...
                                                                                              (and
                                                                                               ...
                                                                                               (=>
                                                                                                ...
                                                                                                (=>
                                                                                                 (= tmp%26 (= (curve25519_dalek!specs.field_specs.field_sub.? (I d_denom!) (I two_rsq@))
                                                                                                   1
                                                                                                 ))
                                                                                                 (and
                                                                                                  (=>
                                                                                                  ...
                                                                                                  (=>
                                                                                                   tmp%26
                                                                                                   (=>
                                                                                                    (= tmp%27 (= (curve25519_dalek!specs.field_specs.field_sub.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                                                                                                         (I 973324) (I r_sq!)
                                                                                                        )
                                                                                                       ) (I two_rsq@)
                                                                                                      ) 1
                                                                                                        ...
                                                                                                        (and
                                                                                                         ...
                                                                                                         (=>
                                                                                                          ...
                                                                                                          (and
                                                                                                           (=>
                                                                                                            %%location_label%%60
                                                                                                            (req%vstd!arithmetic.div_mod.lemma_small_mod. 2 pp@)
                                                                                                           )
                                                                                                           (=>
                                                                                                            (ens%vstd!arithmetic.div_mod.lemma_small_mod. 2 pp@)
                                                                                                            (and
                                                                                                             (=>
                                                                                                              %%location_label%%61
                                                                                                              (req%vstd!arithmetic.div_mod.lemma_mod_add_multiples_vanish. 973322 pp@)
                                                                                                             )
                                                                                                             (=>
                                                                                                              (ens%vstd!arithmetic.div_mod.lemma_mod_add_multiples_vanish. 973322 pp@)
                                                                                                              (and
                                                                                                               (=>
                                                                                                                %%location_label%%62
                                                                                                                (req%vstd!arithmetic.div_mod.lemma_small_mod. 973322 pp@)
                                                                                                               )
                                                                                                               (=>
                                                                                                                (ens%vstd!arithmetic.div_mod.lemma_small_mod. 973322 pp@)
                                                                                                                (=>
                                                                                                                 %%location_label%%63
                                                                                                                 (= (curve25519_dalek!specs.field_specs.field_sub.? (I 973324) (I 2)) 973322)
                                                                                                        )))))))))
                                                                                                        (=>
                                                                                                         (= (curve25519_dalek!specs.field_specs.field_sub.? (I 973324) (I 2)) 973322)
                                                                                                         (=>
                                                                                                          (= tmp%28 (= (curve25519_dalek!specs.field_specs.field_mul.? (I 973322) (I r_sq!))
                                                                                                            1
                                                                                                          ))
                                                                                                          (and
                                                                                                           (=>
                                                                                                           ...
                                                                                                           (=>
                                                                                                            ...
                                                                                                            (and
                                                                                                             ...
                                                                                                             (=>
                                                                                                              (= 973322 (nClip (Mul 2 486661)))
                                                                                                              (=>
                                                                                                               (= two_a1@ (EucMod (nClip (Mul 2 486661)) pp@))
                                                                                                               (and
                                                                                                                (and
                                                                                                                 (=>
                                                                                                                  %%location_label%%66
                                                                                                                ...
                                                                                                                (=>
                                                                                                                 (= two_a1@ 973322)
                                                                                                                 (=>
                                                                                                                  (= tmp%29 (= (curve25519_dalek!specs.field_specs.field_mul.? (I two_a1@) (I r_sq!))
                                                                                                                    1
                                                                                                                  ))
                                                                                                                  (and
                                                                                                                   (=>
                                                                                                                      ...
                                                                                                                      (=>
                                                                                                                       ...
                                                                                                                       (and
                                                                                                                        ...
                                                                                                                        (=>
                                                                                                                         ...
                                                                                                                         (=>
                                                                                                                          (= tmp%30 (curve25519_dalek!specs.field_specs.field_inv.? (I two_a1@)))
                                                                                                                          (=>
                                                                                                                           (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_one_left.
                                                                                                                            tmp%30
                                                                                                                           )
                                                                                                                           (and
                                                                                                                            (=>
                                                                                                                             %%location_label%%72
                                                                                                                             (req%curve25519_dalek!specs.field_specs.field_inv_property. two_a1@)
                                                                                                                            )
                                                                                                                            (=>
                                                                                                                             (ens%curve25519_dalek!specs.field_specs.field_inv_property. two_a1@)
                                                                                                                             (=>
                                                                                                                              (= tmp%31 (curve25519_dalek!specs.field_specs.field_inv.? (I two_a1@)))
                                                                                                                              (and
                                                                                                                               (=>
                                                                                                                                %%location_label%%73
                                                                                                                                (req%vstd!arithmetic.div_mod.lemma_small_mod. tmp%31 pp@)
                                                                                                                               )
                                                                                                                               (=>
                                                                                                                                (ens%vstd!arithmetic.div_mod.lemma_small_mod. tmp%31 pp@)
                                                                                                                                (and
                                                                                                                                 (=>
                                                                                                                                  %%location_label%%74
                                                                                                                                  (req%vstd!arithmetic.div_mod.lemma_small_mod. r_sq! pp@)
                                                                                                                                 )
                                                                                                                                 (=>
                                                                                                                                  (ens%vstd!arithmetic.div_mod.lemma_small_mod. r_sq! pp@)
                                                                                                                                  (=>
                                                                                                                                   %%location_label%%75
                                                                                                                                   (= r_sq! (curve25519_dalek!specs.field_specs.field_inv.? (I (EucMod (nClip (Mul 2 486661))
                                                                                                                                       (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
