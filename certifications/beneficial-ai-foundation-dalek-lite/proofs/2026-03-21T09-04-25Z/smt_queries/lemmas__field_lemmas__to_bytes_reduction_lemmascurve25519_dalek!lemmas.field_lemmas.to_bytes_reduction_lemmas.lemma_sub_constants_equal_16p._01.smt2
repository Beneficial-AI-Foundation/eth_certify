...
;; curve25519-dalek/src/lemmas/field_lemmas/to_bytes_reduction_lemmas.rs:699:1: 699:45 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::to_bytes_reduction_lemmas::lemma_sub_constants_equal_16p
;; curve25519-dalek/src/lemmas/field_lemmas/to_bytes_reduction_lemmas.rs:699:1: 699:45 (#0)
...
(push)
 ...
 (assert
  (not (=>
    ...
    (=>
     (= tmp%1 (= (vstd!arithmetic.power2.pow2.? (I 51)) 2251799813685248))
     (and
      (=>
       %%location_label%%0
       tmp%1
      ...
      (=>
       ...
       (and
        (and
         (=>
          (= tmp%2 (= (vstd!arithmetic.power2.pow2.? (I 51)) 2251799813685248))
          (and
           (=>
            %%location_label%%1
            tmp%2
           ...
           (=>
            ...
            (=>
             %%location_label%%2
             (= (Mul 16 (Sub (vstd!arithmetic.power2.pow2.? (I 51)) 19)) (Mul 16 (Sub 2251799813685248
                19
         )))))))
         (=>
          (= (Mul 16 (Sub (vstd!arithmetic.power2.pow2.? (I 51)) 19)) (Mul 16 (Sub 2251799813685248
          ...
          (and
           ...
           (=>
            (= (Mul 16 (Sub 2251799813685248 19)) 36028797018963664)
            (=>
             %%location_label%%4
             (= 36028797018963664 (Mul 16 (Sub (vstd!arithmetic.power2.pow2.? (I 51)) 19)))
        )))))
        (=>
         (= 36028797018963664 (Mul 16 (Sub (vstd!arithmetic.power2.pow2.? (I 51)) 19)))
         (and
          (and
           (=>
            (= tmp%3 (= (vstd!arithmetic.power2.pow2.? (I 51)) 2251799813685248))
            (and
             (=>
              %%location_label%%5
              tmp%3
             ...
             (=>
              ...
              (=>
               %%location_label%%6
               (= (Mul 16 (Sub (vstd!arithmetic.power2.pow2.? (I 51)) 1)) (Mul 16 (Sub 2251799813685248
                  1
           )))))))
           (=>
            (= (Mul 16 (Sub (vstd!arithmetic.power2.pow2.? (I 51)) 1)) (Mul 16 (Sub 2251799813685248
            ...
            (and
             ...
             (=>
              (= (Mul 16 (Sub 2251799813685248 1)) 36028797018963952)
              (=>
               %%location_label%%8
               (= 36028797018963952 (Mul 16 (Sub (vstd!arithmetic.power2.pow2.? (I 51)) 1)))
          )))))
          (=>
           (= 36028797018963952 (Mul 16 (Sub (vstd!arithmetic.power2.pow2.? (I 51)) 1)))
           (and
            (and
             (=>
              ...
              (= (nClip (Add (nClip (Add (nClip (Add (nClip (Add 36028797018963664 (nClip (Mul (vstd!arithmetic.power2.pow2.?
               ...
               ) (nClip (Add (Add (Add (Add (Mul 16 (Sub (vstd!arithmetic.power2.pow2.? (I 51)) 19))
                    (Mul (vstd!arithmetic.power2.pow2.? (I 51)) (Mul 16 (Sub (vstd!arithmetic.power2.pow2.?
                        (I 51)
                       ) 1
                    )))
                   ) (Mul (vstd!arithmetic.power2.pow2.? (I 102)) (Mul 16 (Sub (vstd!arithmetic.power2.pow2.?
                       (I 51)
                      ) 1
                   )))
                  ) (Mul (vstd!arithmetic.power2.pow2.? (I 153)) (Mul 16 (Sub (vstd!arithmetic.power2.pow2.?
                      (I 51)
                     ) 1
                  )))
                 ) (Mul (vstd!arithmetic.power2.pow2.? (I 204)) (Mul 16 (Sub (vstd!arithmetic.power2.pow2.?
                     (I 51)
                    ) 1
             )))))))
             (=>
              ...
              (and
               (=>
                (= tmp%4 (Sub (vstd!arithmetic.power2.pow2.? (I 51)) 19))
                (=>
                 (= tmp%5 (Add (Add (Add (Mul (vstd!arithmetic.power2.pow2.? (I 51)) (Sub (vstd!arithmetic.power2.pow2.?
                        (I 51)
                       ) 1
                      )
                     ) (Mul (vstd!arithmetic.power2.pow2.? (I 102)) (Sub (vstd!arithmetic.power2.pow2.? (
                 ...
                 (=>
                  (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add. 16 tmp%4 tmp%5)
                  (=>
                   %%location_label%%10
                   (= (nClip (Add (Add (Add (Add (Mul 16 (Sub (vstd!arithmetic.power2.pow2.? (I 51)) 19))
                         (Mul (vstd!arithmetic.power2.pow2.? (I 51)) (Mul 16 (Sub (vstd!arithmetic.power2.pow2.?
                    ...
                    ) (nClip (Mul 16 (Add (Add (Add (Add (Sub (vstd!arithmetic.power2.pow2.? (I 51)) 19) (Mul
                           (vstd!arithmetic.power2.pow2.? (I 51)) (Sub (vstd!arithmetic.power2.pow2.? (I 51))
                            1
                          ))
                         ) (Mul (vstd!arithmetic.power2.pow2.? (I 102)) (Sub (vstd!arithmetic.power2.pow2.? (
                             I 51
