...
;; curve25519-dalek/src/lemmas/field_lemmas/from_bytes_lemmas.rs:597:9: 597:15 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::from_bytes_lemmas::lemma_from_u8_32_as_nat_01234
;; curve25519-dalek/src/lemmas/field_lemmas/from_bytes_lemmas.rs:597:9: 597:15 (#0)
(set-option :smt.arith.solver 6)
(get-info :all-statistics)
(push)
 (declare-const bytes! %%Function%%)
 (declare-const tmp%1 slice%<u8.>.)
 (declare-const n@ Int)
 ...
 (assert
  (not (=>
    (= n@ (vstd!arithmetic.power2.pow2.? (I 204)))
    (=>
     (= x1@ y1@)
     (=>
      %%location_label%%0
      (= (Mul n@ x1@) (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 204)) y1@)))
 )))))
 (get-info :version)
