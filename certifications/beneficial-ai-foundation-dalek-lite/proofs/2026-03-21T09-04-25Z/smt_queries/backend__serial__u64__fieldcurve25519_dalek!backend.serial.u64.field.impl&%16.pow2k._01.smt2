...
;; curve25519-dalek/src/backend/serial/u64/field.rs:1180:9: 1180:13 (#0)
...
;; Function-Def curve25519_dalek::backend::serial::u64::field::FieldElement51::pow2k
;; curve25519-dalek/src/backend/serial/u64/field.rs:1180:9: 1180:13 (#0)
(get-info :all-statistics)
(push)
 (declare-const r! curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const self! curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const k! Int)
 (declare-const verus_tmp_k0@ Int)
 ...
 (declare-const tmp%88 Poly)
 (declare-const tmp%89 Int)
 (declare-const tmp%90 Int)
 (declare-const a3_19@ Int)
 (declare-const a4_19@ Int)
 (declare-const c0@ Int)
 (declare-const c1@0 Int)
 (declare-const c2@0 Int)
 (declare-const c3@0 Int)
 (declare-const c4@0 Int)
 (declare-const carry@ Int)
 (declare-const decrease%init0%0 Int)
 (declare-const a@0 %%Function%%)
 (declare-const verus_tmp@0 Int)
 (declare-const k0@0 Int)
 ...
 (assert
  (has_type (Poly%array%. a@0) (ARRAY $ (UINT 64) $ (CONST_INT 5)))
 )
 (assert
  (uInv 32 verus_tmp@0)
 )
 (assert
  (uInv 32 verus_tmp_k0@)
 )
 (assert
  (uInv 32 k0@0)
 )
 ...
 (declare-const c1@1 Int)
 (declare-const a@1 %%Function%%)
 (declare-const c2@1 Int)
 (declare-const a@2 %%Function%%)
 (declare-const c3@1 Int)
 (declare-const a@3 %%Function%%)
 (declare-const c4@1 Int)
 (declare-const a@4 %%Function%%)
 (declare-const a@5 %%Function%%)
 (declare-const a@6 %%Function%%)
 (declare-const a@7 %%Function%%)
 (declare-const a@8 %%Function%%)
 ...
 (assert
  (not (=>
    (curve25519_dalek!specs.field_specs.u64_5_bounded.? (Poly%array%. a@0) (I 54))
    (=>
     (= (curve25519_dalek!specs.field_specs_u64.u64_5_as_field_canonical.? (Poly%array%.
        a@0
       )
          ...
          ) (I (vstd!arithmetic.power2.pow2.? (I (nClip (Sub k0@0 k@0)))))
     )))))
     (=>
      (let
       ((tmp%%$ k@0))
      ...
      (=>
       (= decrease%init0%0 k@0)
       (=>
        (= i@ (nClip (Sub k0@0 k@0)))
        (and
         (=>
          %%location_label%%0
          (req%curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.lemma_pow2k_loop_boundary.
         ...
         (=>
          ...
          (=>
           (= tmp%2 (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
             (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
               self!
           ))))
           (and
            (=>
             %%location_label%%1
             (req%curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.lemma_pow2k_loop_value. a@0
              tmp%2 i@
            ))
            (=>
             (ens%curve25519_dalek!lemmas.field_lemmas.pow2k_lemmas.lemma_pow2k_loop_value. a@0
              tmp%2 i@
             )
             (=>
              (= tmp%4 19)
              (and
               (=>
                %%location_label%%2
                (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) a@0 3)
               )
               (=>
                (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) a@0 3 tmp%3)
                (and
                 (=>
                  %%location_label%%3
                  (uInv 64 (Mul tmp%4 (%I tmp%3)))
                 )
                 (=>
                  (uInv 64 (Mul tmp%4 (%I tmp%3)))
                  (=>
                   (= a3_19@ (uClip 64 (Mul tmp%4 (%I tmp%3))))
                   (=>
                    (= tmp%6 19)
                    (and
                     (=>
                      %%location_label%%4
                      (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) a@0 4)
                     )
                     (=>
                      (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) a@0 4 tmp%5)
                      (and
                       (=>
                        %%location_label%%5
                        (uInv 64 (Mul tmp%6 (%I tmp%5)))
                       )
                       (=>
                        (uInv 64 (Mul tmp%6 (%I tmp%5)))
                        (=>
                         (= a4_19@ (uClip 64 (Mul tmp%6 (%I tmp%5))))
                         (and
                          (=>
                           %%location_label%%6
                           (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) a@0 0)
                          )
                          (=>
                           (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) a@0 0 tmp%7)
                           (=>
                            (= tmp%9 (%I tmp%7))
                            (and
                             (=>
                             ...
                             (=>
                              (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) a@0 0 tmp%8)
                              (=>
                               (ens%curve25519_dalek!backend.serial.u64.field.m. tmp%9 (%I tmp%8) tmp%10)
                               (=>
                                (= tmp%17 tmp%10)
                                (=>
                                 (= tmp%16 2)
                                 (and
                                  (=>
                                   %%location_label%%8
                                   (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) a@0 1)
                                  )
                                  (=>
                                   (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) a@0 1 tmp%11)
                                   (=>
                                    (ens%curve25519_dalek!backend.serial.u64.field.m. (%I tmp%11) a4_19@ tmp%12)
                                    (=>
                                     (= tmp%15 tmp%12)
                                     (and
                                      (=>
                                       %%location_label%%9
                                       (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) a@0 2)
                                      )
                                      (=>
                                       (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) a@0 2 tmp%13)
                                       (=>
                                        (ens%curve25519_dalek!backend.serial.u64.field.m. (%I tmp%13) a3_19@ tmp%14)
                                        (and
                                         (=>
                                          %%location_label%%10
                                          (uInv 128 (Add tmp%15 tmp%14))
                                         )
                                         (=>
                                          (uInv 128 (Add tmp%15 tmp%14))
                                          (and
                                           (=>
                                            %%location_label%%11
                                            (uInv 128 (Mul tmp%16 (uClip 128 (Add tmp%15 tmp%14))))
                                           )
                                           (=>
                                            (uInv 128 (Mul tmp%16 (uClip 128 (Add tmp%15 tmp%14))))
                                            (and
                                             (=>
                                              %%location_label%%12
                                              (uInv 128 (Add tmp%17 (uClip 128 (Mul tmp%16 (uClip 128 (Add tmp%15 tmp%14))))))
                                             )
                                             (=>
                                              (uInv 128 (Add tmp%17 (uClip 128 (Mul tmp%16 (uClip 128 (Add tmp%15 tmp%14))))))
                                              (=>
                                               (= c0@ (uClip 128 (Add tmp%17 (uClip 128 (Mul tmp%16 (uClip 128 (Add tmp%15 tmp%14)))))))
                                               (and
                                                (=>
                                                 %%location_label%%13
                                                 (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) a@0 3)
                                                ...
                                                (=>
                                                 (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) a@0 3 tmp%18)
                                                 (=>
                                                  (ens%curve25519_dalek!backend.serial.u64.field.m. (%I tmp%18) a3_19@ tmp%19)
                                                  (=>
                                                   (= tmp%28 tmp%19)
                                                   (=>
                                                    (= tmp%27 2)
                                                    (and
                                                     ...
                                                     (=>
                                                      (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) a@0 0 tmp%20)
                                                      (=>
                                                       (= tmp%22 (%I tmp%20))
                                                       (and
                                                        (=>
                                                        ...
                                                        (=>
                                                         (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) a@0 1 tmp%21)
                                                         (=>
                                                          (ens%curve25519_dalek!backend.serial.u64.field.m. tmp%22 (%I tmp%21) tmp%23)
                                                          (=>
                                                           (= tmp%26 tmp%23)
                                                           (and
                                                            (=>
                                                            ...
                                                            (=>
                                                             (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) a@0 2 tmp%24)
                                                             (=>
                                                              (ens%curve25519_dalek!backend.serial.u64.field.m. (%I tmp%24) a4_19@ tmp%25)
                                                              (and
                                                               (=>
                                                                %%location_label%%17
                                                                (uInv 128 (Add tmp%26 tmp%25))
                                                               )
                                                               (=>
                                                                (uInv 128 (Add tmp%26 tmp%25))
                                                                (and
                                                                 (=>
                                                                  %%location_label%%18
                                                                  (uInv 128 (Mul tmp%27 (uClip 128 (Add tmp%26 tmp%25))))
                                                                 )
                                                                 (=>
                                                                  (uInv 128 (Mul tmp%27 (uClip 128 (Add tmp%26 tmp%25))))
                                                                  (and
                                                                   (=>
                                                                    %%location_label%%19
                                                                    (uInv 128 (Add tmp%28 (uClip 128 (Mul tmp%27 (uClip 128 (Add tmp%26 tmp%25))))))
                                                                   )
                                                                   (=>
                                                                    (uInv 128 (Add tmp%28 (uClip 128 (Mul tmp%27 (uClip 128 (Add tmp%26 tmp%25))))))
                                                                    (=>
                                                                     (= c1@0 (uClip 128 (Add tmp%28 (uClip 128 (Mul tmp%27 (uClip 128 (Add tmp%26 tmp%25)))))))
                                                                     (and
                                                                      (=>
                                                                       %%location_label%%20
                                                                       (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) a@0 1)
                                                                      ...
                                                                      (=>
                                                                       (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) a@0 1 tmp%29)
                                                                       (=>
                                                                        (= tmp%31 (%I tmp%29))
                                                                        (and
                                                                         (=>
                                                                         ...
                                                                         (=>
                                                                          (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) a@0 1 tmp%30)
                                                                          (=>
                                                                           (ens%curve25519_dalek!backend.serial.u64.field.m. tmp%31 (%I tmp%30) tmp%32)
                                                                           (=>
                                                                            (= tmp%41 tmp%32)
                                                                            (=>
                                                                             (= tmp%40 2)
                                                                             (and
                                                                              ...
                                                                              (=>
                                                                               (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) a@0 0 tmp%33)
                                                                               (=>
                                                                                (= tmp%35 (%I tmp%33))
                                                                                (and
                                                                                 (=>
                                                                                 ...
                                                                                 (=>
                                                                                  (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) a@0 2 tmp%34)
                                                                                  (=>
                                                                                   (ens%curve25519_dalek!backend.serial.u64.field.m. tmp%35 (%I tmp%34) tmp%36)
                                                                                   (=>
                                                                                    (= tmp%39 tmp%36)
                                                                                    (and
                                                                                     (=>
                                                                                     ...
                                                                                     (=>
                                                                                      (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) a@0 4 tmp%37)
                                                                                      (=>
                                                                                       (ens%curve25519_dalek!backend.serial.u64.field.m. (%I tmp%37) a3_19@ tmp%38)
                                                                                       (and
                                                                                        (=>
                                                                                         %%location_label%%25
                                                                                         (uInv 128 (Add tmp%39 tmp%38))
                                                                                        )
                                                                                        (=>
                                                                                         (uInv 128 (Add tmp%39 tmp%38))
                                                                                         (and
                                                                                          (=>
                                                                                           %%location_label%%26
                                                                                           (uInv 128 (Mul tmp%40 (uClip 128 (Add tmp%39 tmp%38))))
                                                                                          )
                                                                                          (=>
                                                                                           (uInv 128 (Mul tmp%40 (uClip 128 (Add tmp%39 tmp%38))))
                                                                                           (and
                                                                                            (=>
                                                                                             %%location_label%%27
                                                                                             (uInv 128 (Add tmp%41 (uClip 128 (Mul tmp%40 (uClip 128 (Add tmp%39 tmp%38))))))
                                                                                            )
                                                                                            (=>
                                                                                             (uInv 128 (Add tmp%41 (uClip 128 (Mul tmp%40 (uClip 128 (Add tmp%39 tmp%38))))))
                                                                                             (=>
                                                                                              (= c2@0 (uClip 128 (Add tmp%41 (uClip 128 (Mul tmp%40 (uClip 128 (Add tmp%39 tmp%38)))))))
                                                                                              (and
                                                                                               (=>
                                                                                                %%location_label%%28
                                                                                                (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) a@0 4)
                                                                                               ...
                                                                                               (=>
                                                                                                (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) a@0 4 tmp%42)
                                                                                                (=>
                                                                                                 (ens%curve25519_dalek!backend.serial.u64.field.m. (%I tmp%42) a4_19@ tmp%43)
                                                                                                 (=>
                                                                                                  (= tmp%54 tmp%43)
                                                                                                  (=>
                                                                                                   (= tmp%53 2)
                                                                                                   (and
                                                                                                    ...
                                                                                                    (=>
                                                                                                     (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) a@0 0 tmp%44)
                                                                                                     (=>
                                                                                                      (= tmp%46 (%I tmp%44))
                                                                                                      (and
                                                                                                       (=>
                                                                                                       ...
                                                                                                       (=>
                                                                                                        (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) a@0 3 tmp%45)
                                                                                                        (=>
                                                                                                         (ens%curve25519_dalek!backend.serial.u64.field.m. tmp%46 (%I tmp%45) tmp%47)
                                                                                                         (=>
                                                                                                          (= tmp%52 tmp%47)
                                                                                                          (and
                                                                                                           (=>
                                                                                                           ...
                                                                                                           (=>
                                                                                                            (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) a@0 1 tmp%48)
                                                                                                            (=>
                                                                                                             (= tmp%50 (%I tmp%48))
                                                                                                             (and
                                                                                                              (=>
                                                                                                              ...
                                                                                                              (=>
                                                                                                               (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) a@0 2 tmp%49)
                                                                                                               (=>
                                                                                                                (ens%curve25519_dalek!backend.serial.u64.field.m. tmp%50 (%I tmp%49) tmp%51)
                                                                                                                (and
                                                                                                                 (=>
                                                                                                                  %%location_label%%33
                                                                                                                  (uInv 128 (Add tmp%52 tmp%51))
                                                                                                                 )
                                                                                                                 (=>
                                                                                                                  (uInv 128 (Add tmp%52 tmp%51))
                                                                                                                  (and
                                                                                                                   (=>
                                                                                                                    %%location_label%%34
                                                                                                                    (uInv 128 (Mul tmp%53 (uClip 128 (Add tmp%52 tmp%51))))
                                                                                                                   )
                                                                                                                   (=>
                                                                                                                    (uInv 128 (Mul tmp%53 (uClip 128 (Add tmp%52 tmp%51))))
                                                                                                                    (and
                                                                                                                     (=>
                                                                                                                      %%location_label%%35
                                                                                                                      (uInv 128 (Add tmp%54 (uClip 128 (Mul tmp%53 (uClip 128 (Add tmp%52 tmp%51))))))
                                                                                                                     )
                                                                                                                     (=>
                                                                                                                      (uInv 128 (Add tmp%54 (uClip 128 (Mul tmp%53 (uClip 128 (Add tmp%52 tmp%51))))))
                                                                                                                      (=>
                                                                                                                       (= c3@0 (uClip 128 (Add tmp%54 (uClip 128 (Mul tmp%53 (uClip 128 (Add tmp%52 tmp%51)))))))
                                                                                                                       (and
                                                                                                                        (=>
                                                                                                                         %%location_label%%36
                                                                                                                         (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) a@0 2)
                                                                                                                        ...
                                                                                                                        (=>
                                                                                                                         (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) a@0 2 tmp%55)
                                                                                                                         (=>
                                                                                                                          (= tmp%57 (%I tmp%55))
                                                                                                                          (and
                                                                                                                           (=>
                                                                                                                           ...
                                                                                                                           (=>
                                                                                                                            (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) a@0 2 tmp%56)
                                                                                                                            (=>
                                                                                                                             (ens%curve25519_dalek!backend.serial.u64.field.m. tmp%57 (%I tmp%56) tmp%58)
                                                                                                                             (=>
                                                                                                                              (= tmp%69 tmp%58)
                                                                                                                              (=>
                                                                                                                               (= tmp%68 2)
                                                                                                                               (and
                                                                                                                                ...
                                                                                                                                (=>
                                                                                                                                 (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) a@0 0 tmp%59)
                                                                                                                                 (=>
                                                                                                                                  (= tmp%61 (%I tmp%59))
                                                                                                                                  (and
                                                                                                                                   (=>
                                                                                                                                   ...
                                                                                                                                   (=>
                                                                                                                                    (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) a@0 4 tmp%60)
                                                                                                                                    (=>
                                                                                                                                     (ens%curve25519_dalek!backend.serial.u64.field.m. tmp%61 (%I tmp%60) tmp%62)
                                                                                                                                     (=>
                                                                                                                                      (= tmp%67 tmp%62)
                                                                                                                                      (and
                                                                                                                                       (=>
                                                                                                                                       ...
                                                                                                                                       (=>
                                                                                                                                        (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) a@0 1 tmp%63)
                                                                                                                                        (=>
                                                                                                                                         (= tmp%65 (%I tmp%63))
                                                                                                                                         (and
                                                                                                                                          (=>
                                                                                                                                          ...
                                                                                                                                          (=>
                                                                                                                                           (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) a@0 3 tmp%64)
                                                                                                                                           (=>
                                                                                                                                            (ens%curve25519_dalek!backend.serial.u64.field.m. tmp%65 (%I tmp%64) tmp%66)
                                                                                                                                            (and
                                                                                                                                             (=>
                                                                                                                                              %%location_label%%42
                                                                                                                                              (uInv 128 (Add tmp%67 tmp%66))
                                                                                                                                             )
                                                                                                                                             (=>
                                                                                                                                              (uInv 128 (Add tmp%67 tmp%66))
                                                                                                                                              (and
                                                                                                                                               (=>
                                                                                                                                                %%location_label%%43
                                                                                                                                                (uInv 128 (Mul tmp%68 (uClip 128 (Add tmp%67 tmp%66))))
                                                                                                                                               )
                                                                                                                                               (=>
                                                                                                                                                (uInv 128 (Mul tmp%68 (uClip 128 (Add tmp%67 tmp%66))))
                                                                                                                                                (and
                                                                                                                                                 (=>
                                                                                                                                                  %%location_label%%44
                                                                                                                                                  (uInv 128 (Add tmp%69 (uClip 128 (Mul tmp%68 (uClip 128 (Add tmp%67 tmp%66))))))
                                                                                                                                                 )
                                                                                                                                                 (=>
                                                                                                                                                  (uInv 128 (Add tmp%69 (uClip 128 (Mul tmp%68 (uClip 128 (Add tmp%67 tmp%66))))))
                                                                                                                                                  (=>
                                                                                                                                                   (= c4@0 (uClip 128 (Add tmp%69 (uClip 128 (Mul tmp%68 (uClip 128 (Add tmp%67 tmp%66)))))))
                                                                                                                                                   (=>
                                                                                                                                                    (= tmp%70 c1@0)
                                                                                                                                                    (and
                                                                                                                                                     (=>
                                                                                                                                                     ...
                                                                                                                                                     (=>
                                                                                                                                                      ...
                                                                                                                                                      (and
                                                                                                                                                       (=>
                                                                                                                                                        %%location_label%%46
                                                                                                                                                        (uInv 128 (Add tmp%70 (uClip 128 (uClip 64 (uClip 128 (bitshr (I c0@) (I 51)))))))
                                                                                                                                                       )
                                                                                                                                                       (=>
                                                                                                                                                        (uInv 128 (Add tmp%70 (uClip 128 (uClip 64 (uClip 128 (bitshr (I c0@) (I 51)))))))
                                                                                                                                                        (=>
                                                                                                                                                         (= c1@1 (uClip 128 (Add tmp%70 (uClip 128 (uClip 64 (uClip 128 (bitshr (I c0@) (I 51))))))))
                                                                                                                                                         (=>
                                                                                                                                                          (= tmp%71 (uClip 64 (bitand (I (uClip 64 c0@)) (I curve25519_dalek!backend.serial.u64.field.LOW_51_BIT_MASK.?))))
                                                                                                                                                          (and
                                                                                                                                                           (=>
                                                                                                                                                            %%location_label%%47
                                                                                                                                                            (req%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                                                                                                                                             $ (UINT 64) (Poly%array%. a@0) (I 0) (I tmp%71)
                                                                                                                                                           ))
                                                                                                                                                           (=>
                                                                                                                                                            (has_type (Poly%array%. a@1) (ARRAY $ (UINT 64) $ (CONST_INT 5)))
                                                                                                                                                            (=>
                                                                                                                                                             (ens%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                                                                                                                                              $ (UINT 64) (Poly%array%. a@0) (Poly%array%. a@1) (I 0) (I tmp%71)
                                                                                                                                                             )
                                                                                                                                                             (=>
                                                                                                                                                              (= tmp%72 c2@0)
                                                                                                                                                              (and
                                                                                                                                                               ...
                                                                                                                                                               (=>
                                                                                                                                                                ...
                                                                                                                                                                (and
                                                                                                                                                                 (=>
                                                                                                                                                                  %%location_label%%49
                                                                                                                                                                  (uInv 128 (Add tmp%72 (uClip 128 (uClip 64 (uClip 128 (bitshr (I c1@1) (I 51)))))))
                                                                                                                                                                 )
                                                                                                                                                                 (=>
                                                                                                                                                                  (uInv 128 (Add tmp%72 (uClip 128 (uClip 64 (uClip 128 (bitshr (I c1@1) (I 51)))))))
                                                                                                                                                                  (=>
                                                                                                                                                                   (= c2@1 (uClip 128 (Add tmp%72 (uClip 128 (uClip 64 (uClip 128 (bitshr (I c1@1) (I 51))))))))
                                                                                                                                                                   (=>
                                                                                                                                                                    (= tmp%73 (uClip 64 (bitand (I (uClip 64 c1@1)) (I curve25519_dalek!backend.serial.u64.field.LOW_51_BIT_MASK.?))))
                                                                                                                                                                    (and
                                                                                                                                                                     (=>
                                                                                                                                                                      %%location_label%%50
                                                                                                                                                                      (req%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                                                                                                                                                       $ (UINT 64) (Poly%array%. a@1) (I 1) (I tmp%73)
                                                                                                                                                                     ))
                                                                                                                                                                     (=>
                                                                                                                                                                      (has_type (Poly%array%. a@2) (ARRAY $ (UINT 64) $ (CONST_INT 5)))
                                                                                                                                                                      (=>
                                                                                                                                                                       (ens%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                                                                                                                                                        $ (UINT 64) (Poly%array%. a@1) (Poly%array%. a@2) (I 1) (I tmp%73)
                                                                                                                                                                       )
                                                                                                                                                                       (=>
                                                                                                                                                                        (= tmp%74 c3@0)
                                                                                                                                                                        (and
                                                                                                                                                                         ...
                                                                                                                                                                         (=>
                                                                                                                                                                          ...
                                                                                                                                                                          (and
                                                                                                                                                                           (=>
                                                                                                                                                                            %%location_label%%52
                                                                                                                                                                            (uInv 128 (Add tmp%74 (uClip 128 (uClip 64 (uClip 128 (bitshr (I c2@1) (I 51)))))))
                                                                                                                                                                           )
                                                                                                                                                                           (=>
                                                                                                                                                                            (uInv 128 (Add tmp%74 (uClip 128 (uClip 64 (uClip 128 (bitshr (I c2@1) (I 51)))))))
                                                                                                                                                                            (=>
                                                                                                                                                                             (= c3@1 (uClip 128 (Add tmp%74 (uClip 128 (uClip 64 (uClip 128 (bitshr (I c2@1) (I 51))))))))
                                                                                                                                                                             (=>
                                                                                                                                                                              (= tmp%75 (uClip 64 (bitand (I (uClip 64 c2@1)) (I curve25519_dalek!backend.serial.u64.field.LOW_51_BIT_MASK.?))))
                                                                                                                                                                              (and
                                                                                                                                                                               (=>
                                                                                                                                                                                %%location_label%%53
                                                                                                                                                                                (req%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                                                                                                                                                                 $ (UINT 64) (Poly%array%. a@2) (I 2) (I tmp%75)
                                                                                                                                                                               ))
                                                                                                                                                                               (=>
                                                                                                                                                                                (has_type (Poly%array%. a@3) (ARRAY $ (UINT 64) $ (CONST_INT 5)))
                                                                                                                                                                                (=>
                                                                                                                                                                                 (ens%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                                                                                                                                                                  $ (UINT 64) (Poly%array%. a@2) (Poly%array%. a@3) (I 2) (I tmp%75)
                                                                                                                                                                                 )
                                                                                                                                                                                 (=>
                                                                                                                                                                                  (= tmp%76 c4@0)
                                                                                                                                                                                  (and
                                                                                                                                                                                   ...
                                                                                                                                                                                   (=>
                                                                                                                                                                                    ...
                                                                                                                                                                                    (and
                                                                                                                                                                                     (=>
                                                                                                                                                                                      %%location_label%%55
                                                                                                                                                                                      (uInv 128 (Add tmp%76 (uClip 128 (uClip 64 (uClip 128 (bitshr (I c3@1) (I 51)))))))
                                                                                                                                                                                     )
                                                                                                                                                                                     (=>
                                                                                                                                                                                      (uInv 128 (Add tmp%76 (uClip 128 (uClip 64 (uClip 128 (bitshr (I c3@1) (I 51)))))))
                                                                                                                                                                                      (=>
                                                                                                                                                                                       (= c4@1 (uClip 128 (Add tmp%76 (uClip 128 (uClip 64 (uClip 128 (bitshr (I c3@1) (I 51))))))))
                                                                                                                                                                                       (=>
                                                                                                                                                                                        (= tmp%77 (uClip 64 (bitand (I (uClip 64 c3@1)) (I curve25519_dalek!backend.serial.u64.field.LOW_51_BIT_MASK.?))))
                                                                                                                                                                                        (and
                                                                                                                                                                                         (=>
                                                                                                                                                                                          %%location_label%%56
                                                                                                                                                                                          (req%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                                                                                                                                                                           $ (UINT 64) (Poly%array%. a@3) (I 3) (I tmp%77)
                                                                                                                                                                                         ))
                                                                                                                                                                                         (=>
                                                                                                                                                                                          (has_type (Poly%array%. a@4) (ARRAY $ (UINT 64) $ (CONST_INT 5)))
                                                                                                                                                                                          (=>
                                                                                                                                                                                           (ens%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                                                                                                                                                                            $ (UINT 64) (Poly%array%. a@3) (Poly%array%. a@4) (I 3) (I tmp%77)
                                                                                                                                                                                           )
                                                                                                                                                                                           (and
                                                                                                                                                                                            (=>
                                                                                                                                                                                             %%location_label%%57
                                                                                                                                                                                            ...
                                                                                                                                                                                            (=>
                                                                                                                                                                                             ...
                                                                                                                                                                                             (=>
                                                                                                                                                                                              (= carry@ (uClip 64 (uClip 128 (bitshr (I c4@1) (I 51)))))
                                                                                                                                                                                              (=>
                                                                                                                                                                                               (= tmp%78 (uClip 64 (bitand (I (uClip 64 c4@1)) (I curve25519_dalek!backend.serial.u64.field.LOW_51_BIT_MASK.?))))
                                                                                                                                                                                               (and
                                                                                                                                                                                                (=>
                                                                                                                                                                                                 %%location_label%%58
                                                                                                                                                                                                 (req%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                                                                                                                                                                                  $ (UINT 64) (Poly%array%. a@4) (I 4) (I tmp%78)
                                                                                                                                                                                                ))
                                                                                                                                                                                                (=>
                                                                                                                                                                                                 (has_type (Poly%array%. a@5) (ARRAY $ (UINT 64) $ (CONST_INT 5)))
                                                                                                                                                                                                 (=>
                                                                                                                                                                                                  (ens%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                                                                                                                                                                                   $ (UINT 64) (Poly%array%. a@4) (Poly%array%. a@5) (I 4) (I tmp%78)
                                                                                                                                                                                                  )
                                                                                                                                                                                                  (=>
                                                                                                                                                                                                   (= tmp%81 0)
                                                                                                                                                                                                   (and
                                                                                                                                                                                                    (=>
                                                                                                                                                                                                     %%location_label%%59
                                                                                                                                                                                                     (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) a@5 0)
                                                                                                                                                                                                    )
                                                                                                                                                                                                    (=>
                                                                                                                                                                                                     (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) a@5 0 tmp%79)
                                                                                                                                                                                                     (=>
                                                                                                                                                                                                      (= tmp%80 tmp%79)
                                                                                                                                                                                                      (and
                                                                                                                                                                                                       (=>
                                                                                                                                                                                                        %%location_label%%60
                                                                                                                                                                                                        (uInv 64 (Mul carry@ 19))
                                                                                                                                                                                                       )
                                                                                                                                                                                                       (=>
                                                                                                                                                                                                        (uInv 64 (Mul carry@ 19))
                                                                                                                                                                                                        (and
                                                                                                                                                                                                         (=>
                                                                                                                                                                                                          %%location_label%%61
                                                                                                                                                                                                          (uInv 64 (Add (%I tmp%80) (uClip 64 (Mul carry@ 19))))
                                                                                                                                                                                                         )
                                                                                                                                                                                                         (=>
                                                                                                                                                                                                          (uInv 64 (Add (%I tmp%80) (uClip 64 (Mul carry@ 19))))
                                                                                                                                                                                                          (=>
                                                                                                                                                                                                           (= tmp%82 (uClip 64 (Add (%I tmp%80) (uClip 64 (Mul carry@ 19)))))
                                                                                                                                                                                                           (and
                                                                                                                                                                                                            (=>
                                                                                                                                                                                                             %%location_label%%62
                                                                                                                                                                                                             (req%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                                                                                                                                                                                              $ (UINT 64) (Poly%array%. a@5) (I tmp%81) (I tmp%82)
                                                                                                                                                                                                            ))
                                                                                                                                                                                                            (=>
                                                                                                                                                                                                             (has_type (Poly%array%. a@6) (ARRAY $ (UINT 64) $ (CONST_INT 5)))
                                                                                                                                                                                                             (=>
                                                                                                                                                                                                              (ens%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                                                                                                                                                                                               $ (UINT 64) (Poly%array%. a@5) (Poly%array%. a@6) (I tmp%81) (I tmp%82)
                                                                                                                                                                                                              )
                                                                                                                                                                                                              (=>
                                                                                                                                                                                                               (= tmp%86 1)
                                                                                                                                                                                                               (and
                                                                                                                                                                                                                (=>
                                                                                                                                                                                                                 %%location_label%%63
                                                                                                                                                                                                                 (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) a@6 1)
                                                                                                                                                                                                                )
                                                                                                                                                                                                                (=>
                                                                                                                                                                                                                 (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) a@6 1 tmp%83)
                                                                                                                                                                                                                 (=>
                                                                                                                                                                                                                  (= tmp%85 tmp%83)
                                                                                                                                                                                                                  (and
                                                                                                                                                                                                                   (=>
                                                                                                                                                                                                                    %%location_label%%64
                                                                                                                                                                                                                    (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) a@6 0)
                                                                                                                                                                                                                   )
                                                                                                                                                                                                                   (=>
                                                                                                                                                                                                                    (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) a@6 0 tmp%84)
                                                                                                                                                                                                                    (and
                                                                                                                                                                                                                     (=>
                                                                                                                                                                                                                      %%location_label%%65
                                                                                                                                                                                                                      (and
                                                                                                                                                                                                                     ...
                                                                                                                                                                                                                     (=>
                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                      (and
                                                                                                                                                                                                                       (=>
                                                                                                                                                                                                                        %%location_label%%66
                                                                                                                                                                                                                        (uInv 64 (Add (%I tmp%85) (uClip 64 (bitshr (I (%I tmp%84)) (I 51)))))
                                                                                                                                                                                                                       )
                                                                                                                                                                                                                       (=>
                                                                                                                                                                                                                        (uInv 64 (Add (%I tmp%85) (uClip 64 (bitshr (I (%I tmp%84)) (I 51)))))
                                                                                                                                                                                                                        (=>
                                                                                                                                                                                                                         (= tmp%87 (uClip 64 (Add (%I tmp%85) (uClip 64 (bitshr (I (%I tmp%84)) (I 51))))))
                                                                                                                                                                                                                         (and
                                                                                                                                                                                                                          (=>
                                                                                                                                                                                                                           %%location_label%%67
                                                                                                                                                                                                                           (req%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                                                                                                                                                                                                            $ (UINT 64) (Poly%array%. a@6) (I tmp%86) (I tmp%87)
                                                                                                                                                                                                                          ))
                                                                                                                                                                                                                          (=>
                                                                                                                                                                                                                           (has_type (Poly%array%. a@7) (ARRAY $ (UINT 64) $ (CONST_INT 5)))
                                                                                                                                                                                                                           (=>
                                                                                                                                                                                                                            (ens%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                                                                                                                                                                                                             $ (UINT 64) (Poly%array%. a@6) (Poly%array%. a@7) (I tmp%86) (I tmp%87)
                                                                                                                                                                                                                            )
                                                                                                                                                                                                                            (=>
                                                                                                                                                                                                                             (= tmp%89 0)
                                                                                                                                                                                                                             (and
                                                                                                                                                                                                                              (=>
                                                                                                                                                                                                                               %%location_label%%68
                                                                                                                                                                                                                               (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) a@7 0)
                                                                                                                                                                                                                              )
                                                                                                                                                                                                                              (=>
                                                                                                                                                                                                                               (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) a@7 0 tmp%88)
                                                                                                                                                                                                                               (=>
                                                                                                                                                                                                                                (= tmp%90 (uClip 64 (bitand (I (%I tmp%88)) (I curve25519_dalek!backend.serial.u64.field.LOW_51_BIT_MASK.?))))
                                                                                                                                                                                                                                (and
                                                                                                                                                                                                                                 (=>
                                                                                                                                                                                                                                  %%location_label%%69
                                                                                                                                                                                                                                  (req%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                                                                                                                                                                                                                   $ (UINT 64) (Poly%array%. a@7) (I tmp%89) (I tmp%90)
                                                                                                                                                                                                                                 ))
                                                                                                                                                                                                                                 (=>
                                                                                                                                                                                                                                  (has_type (Poly%array%. a@8) (ARRAY $ (UINT 64) $ (CONST_INT 5)))
                                                                                                                                                                                                                                  (=>
                                                                                                                                                                                                                                   (ens%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                                                                                                                                                                                                                    $ (UINT 64) (Poly%array%. a@7) (Poly%array%. a@8) (I tmp%89) (I tmp%90)
                                                                                                                                                                                                                                   )
                                                                                                                                                                                                                                   (and
                                                                                                                                                                                                                                    (=>
                                                                                                                                                                                                                                     %%location_label%%70
                                                                                                                                                                                                                                      ...
                                                                                                                                                                                                                                      (or
                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                        (=>
                                                                                                                                                                                                                                         ...
                                                                                                                                                                                                                                         (and
                                                                                                                                                                                                                                          ...
                                                                                                                                                                                                                                          (and
                                                                                                                                                                                                                                           (=>
                                                                                                                                                                                                                                            %%location_label%%72
                                                                                                                                                                                                                                            (curve25519_dalek!specs.field_specs.u64_5_bounded.? (Poly%array%. a@8) (I 52))
                                                                                                                                                                                                                                           )
                                                                                                                                                                                                                                           (and
                                                                                                                                                                                                                                            (=>
                                                                                                                                                                                                                                             %%location_label%%73
                                                                                                                                                                                                                                             (= (curve25519_dalek!specs.field_specs_u64.u64_5_as_field_canonical.? (Poly%array%.
                                                                                                                                                                                                                                                a@8
                                                                                                                                                                                                                                                  ...
                                                                                                                                                                                                                                                  ) (I (vstd!arithmetic.power2.pow2.? (I k0@0)))
                                                                                                                                                                                                                                            ))))))
                                                                                                                                                                                                                                            (=>
                                                                                                                                                                                                                                             %%location_label%%74
                                                                                                                                                                                                                                             (< (uClip 64 (bitshl (I 1) (I 52))) (uClip 64 (bitshl (I 1) (I 54))))
                                                                                                                                                                                                                                       ...
                                                                                                                                                                                                                                       (and
                                                                                                                                                                                                                                        ...
                                                                                                                                                                                                                                        (and
                                                                                                                                                                                                                                         (=>
                                                                                                                                                                                                                                          %%location_label%%75
                                                                                                                                                                                                                                          (curve25519_dalek!specs.field_specs.u64_5_bounded.? (Poly%array%. a@8) (I 54))
                                                                                                                                                                                                                                         )
                                                                                                                                                                                                                                         (and
                                                                                                                                                                                                                                          (=>
                                                                                                                                                                                                                                           %%location_label%%76
                                                                                                                                                                                                                                           (= (curve25519_dalek!specs.field_specs_u64.u64_5_as_field_canonical.? (Poly%array%.
                                                                                                                                                                                                                                              a@8
                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                ) (I (vstd!arithmetic.power2.pow2.? (I (nClip (Sub k0@0 k@1)))))
                                                                                                                                                                                                                                          ))))))
                                                                                                                                                                                                                                          (and
                                                                                                                                                                                                                                           (=>
                                                                                                                                                                                                                                            %%location_label%%77
                                                                                                                                                                                                                                           ...
                                                                                                                                                                                                                                           (=>
                                                                                                                                                                                                                                            %%location_label%%78
                                                                                                                                                                                                                                            (check_decrease_int k@1 decrease%init0%0 false)
 )))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))))
 (get-info :version)
