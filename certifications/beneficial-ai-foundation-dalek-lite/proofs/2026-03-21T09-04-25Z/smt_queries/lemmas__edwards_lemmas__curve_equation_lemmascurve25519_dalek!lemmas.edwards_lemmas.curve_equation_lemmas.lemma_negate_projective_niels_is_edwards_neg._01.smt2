...
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:2127:1: 2129:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::curve_equation_lemmas::lemma_negate_projective_niels_is_edwards_neg
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:2127:1: 2129:2 (#0)
...
(push)
 ...
 (declare-const x@ Int)
 (declare-const y@ Int)
 (declare-const x_proj_neg@ Int)
 (declare-const y_proj_neg@ Int)
 (declare-const x_neg@ Int)
 (declare-const y_neg@ Int)
 (assert
  fuel_defaults
 )
 (assert
         ...
         (=>
          ...
          (=>
           ...
           (=>
            (= y@ (curve25519_dalek!specs.field_specs.field_mul.? (I y_proj@) (I z_inv@)))
            (=>
             (= x_proj_neg@ (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_sub.?
                 (I y_minus_x@) (I y_plus_x@)
                )
               ) (I inv2@)
             ))
             (=>
              (= y_proj_neg@ (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_add.?
                  (I y_minus_x@) (I y_plus_x@)
                 )
                ) (I inv2@)
              ))
              (=>
               (= x_neg@ (curve25519_dalek!specs.field_specs.field_mul.? (I x_proj_neg@) (I z_inv@)))
               (=>
                (= y_neg@ (curve25519_dalek!specs.field_specs.field_mul.? (I y_proj_neg@) (I z_inv@)))
                (and
                 (=>
                  (= tmp%1 (= (nClip (Add y_minus_x@ y_plus_x@)) (nClip (Add y_plus_x@ y_minus_x@))))
                  (and
                   (=>
                    %%location_label%%0
                    tmp%1
                   ...
                   (and
                    ...
                    (=>
                     ...
                     (and
                      (=>
                       (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_swap_sub_negates_mul.
                        y_plus_x@ y_minus_x@ inv2@
                       )
                       (=>
                        %%location_label%%3
                        (= x_proj_neg@ (curve25519_dalek!specs.field_specs.field_neg.? (I x_proj@)))
                      ))
                      (=>
                       (= x_proj_neg@ (curve25519_dalek!specs.field_specs.field_neg.? (I x_proj@)))
                       (and
                        (=>
                         ...
                         (=>
                          (= tmp%3 (curve25519_dalek!specs.field_specs.field_neg.? (I x_proj@)))
                          (=>
                           (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_comm.
                            tmp%3 z_inv@
                           )
                           (=>
                            ...
                            (=>
                             %%location_label%%4
                             (= x_neg@ (curve25519_dalek!specs.field_specs.field_neg.? (I x@)))
                        )))))
                        (=>
                         (= x_neg@ (curve25519_dalek!specs.field_specs.field_neg.? (I x@)))
                         (=>
