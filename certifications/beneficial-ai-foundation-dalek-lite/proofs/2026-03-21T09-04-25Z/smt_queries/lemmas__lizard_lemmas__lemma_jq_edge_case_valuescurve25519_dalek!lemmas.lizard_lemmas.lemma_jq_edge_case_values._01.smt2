...
;; MODULE 'module lemmas::lizard_lemmas, function curve25519_dalek::lemmas::lizard_lemmas::lemma_jq_edge_case_values'
;; curve25519-dalek/src/lemmas/lizard_lemmas.rs:592:1: 592:76 (#0)
...
(assert
 (distinct fuel%vstd!arithmetic.div_mod.lemma_mod_self_0. fuel%vstd!array.array_view.
  ...
  fuel%curve25519_dalek!backend.serial.u64.constants.EDWARDS_D. fuel%curve25519_dalek!lizard.u64_constants.MDOUBLE_INVSQRT_A_MINUS_D.
  fuel%curve25519_dalek!lizard.u64_constants.MIDOUBLE_INVSQRT_A_MINUS_D. fuel%curve25519_dalek!lizard.u64_constants.MINVSQRT_ONE_PLUS_D.
  ...
  fuel%curve25519_dalek!specs.field_specs.field_square. fuel%curve25519_dalek!specs.field_specs.is_negative.
...
;; Function-Def curve25519_dalek::lemmas::lizard_lemmas::lemma_jq_edge_case_values
;; curve25519-dalek/src/lemmas/lizard_lemmas.rs:592:1: 592:76 (#0)
...
(push)
 ...
 (declare-const s_over_x@ Int)
 (declare-const sp_over_xp@ Int)
 ...
 (declare-const den1@ Int)
 (declare-const s_over_x$1@ Int)
 (declare-const sp_over_xp$1@ Int)
                 ...
                 (or
                  (and
                   (=>
                    (= xn@ 0)
                    (=>
                     (= s_over_x@ (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                         (I (curve25519_dalek!specs.field_specs.nat_invsqrt.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                             (I (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_square.?
                               ...
                               ) (I (curve25519_dalek!specs.field_specs.field_square.? (I xn@)))
                              )
                             ) (I (curve25519_dalek!specs.field_specs.field_sub.? (I (curve25519_dalek!specs.field_specs.field_square.?
                                 (I zn@)
                                )
                               ) (I y2@)
                          )))))
                       ...
                       ) (I (curve25519_dalek!specs.field_specs.field_sub.? (I zn@) (I yn@)))
                     ))
                     (and
                      (and
                       (=>
                       ...
                       (=>
                        ...
                        (=>
                         %%location_label%%3
                         (= (curve25519_dalek!specs.field_specs.field_mul.? (I s_over_x@) (I 0)) 0)
                      )))
                      (=>
                       (= (curve25519_dalek!specs.field_specs.field_mul.? (I s_over_x@) (I 0)) 0)
                       (=>
                        (= sp_over_xp@ (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                            (I (curve25519_dalek!specs.field_specs.nat_invsqrt.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                                (I (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_square.?
                                    (I y2@)
                                   )
                          ...
                          ) (I (curve25519_dalek!specs.field_specs.field_add.? (I zn@) (I yn@)))
                        ))
                        (and
                         (=>
                          (= tmp%2 (curve25519_dalek!specs.field_specs.field_neg.? (I sp_over_xp@)))
                          (and
                           (=>
                            %%location_label%%4
                            (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_zero_right.
                       ...
                       (and
                        (=>
                         ...
                         (and
                          (=>
                           %%location_label%%8
                           (req%vstd!arithmetic.div_mod.lemma_small_mod. 0 tmp%4)
                          )
                          (=>
                           (ens%vstd!arithmetic.div_mod.lemma_small_mod. 0 tmp%4)
                           (=>
                            %%location_label%%9
                            (= y4@ 0)
                        ))))
                        (=>
                         ...
                         (=>
                          (= gamma@ (curve25519_dalek!specs.field_specs.nat_invsqrt.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                              (I (curve25519_dalek!specs.field_specs.field_mul.? (I y4@) (I (curve25519_dalek!specs.field_specs.field_square.?
                                  (I xn@)
                               )))
                              ) (I (curve25519_dalek!specs.field_specs.field_sub.? (I (curve25519_dalek!specs.field_specs.field_square.?
                                  (I zn@)
                          ...
                          (and
                           (=>
                            (= tmp%5 (curve25519_dalek!specs.field_specs.field_square.? (I xn@)))
                            (and
                             (=>
                              %%location_label%%10
                              (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_zero_left.
                             ...
                             (=>
                              ...
                              (=>
                               %%location_label%%11
                               (= (curve25519_dalek!specs.field_specs.field_mul.? (I y4@) (I (curve25519_dalek!specs.field_specs.field_square.?
                                   (I xn@)
                                 ))
                                ) 0
                           )))))
                            ...
                            (=>
                             ...
                             (and
                              ...
                              (=>
                               (= den1@ 0)
                               (=>
                                (= s_over_x$1@ (curve25519_dalek!specs.field_specs.field_mul.? (I den1@) (I (curve25519_dalek!specs.field_specs.field_sub.?
                                    (I zn@) (I yn@)
                                ))))
                                (and
                                 (=>
                                  (= tmp%6 (curve25519_dalek!specs.field_specs.field_sub.? (I zn@) (I yn@)))
                                  (and
                                   (=>
                                    %%location_label%%14
                                    (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_zero_left.
                                  ...
                                  (and
                                   (and
                                    ...
                                    (=>
                                     ...
                                     (=>
                                      %%location_label%%17
                                      (= (curve25519_dalek!specs.field_specs.field_mul.? (I s_over_x$1@) (I xn@)) 0)
                                   )))
                                   (=>
                                    (= (curve25519_dalek!specs.field_specs.field_mul.? (I s_over_x$1@) (I xn@)) 0)
                                    (=>
                                     (= sp_over_xp$1@ (curve25519_dalek!specs.field_specs.field_mul.? (I den1@) (I (curve25519_dalek!specs.field_specs.field_add.?
                                         (I zn@) (I yn@)
                                     ))))
                                     (and
                                      (=>
                                       (= tmp%7 (curve25519_dalek!specs.field_specs.field_add.? (I zn@) (I yn@)))
                                       (and
                                        (=>
                                         %%location_label%%18
                                         (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_zero_left.
                                        ...
                                        (and
                                         (=>
                                          ...
                                          (and
                                           (=>
                                            %%location_label%%20
                                            (req%vstd!arithmetic.div_mod.lemma_mod_self_0. tmp%8)
                                           )
                                           (=>
                                            (ens%vstd!arithmetic.div_mod.lemma_mod_self_0. tmp%8)
                                            (=>
                                             %%location_label%%21
                                         ...
                                         (=>
                                          (= (curve25519_dalek!specs.field_specs.field_neg.? (I 0)) 0)
                                          (=>
                                           (= tmp%9 (curve25519_dalek!specs.field_specs.field_neg.? (I sp_over_xp$1@)))
                                           (and
                                            (=>
                                             %%location_label%%22
                                             (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_zero_left.
