...
;; curve25519-dalek/src/lemmas/scalar_batch_invert_lemmas.rs:81:1: 81:99 (#0)
...
;; Function-Def curve25519_dalek::lemmas::scalar_batch_invert_lemmas::lemma_partial_product_prefix_eq
;; curve25519-dalek/src/lemmas/scalar_batch_invert_lemmas.rs:81:1: 81:99 (#0)
(get-info :all-statistics)
(push)
 (declare-const scalars1! vstd!seq.Seq<curve25519_dalek!scalar.Scalar.>.)
 (declare-const scalars2! vstd!seq.Seq<curve25519_dalek!scalar.Scalar.>.)
 (declare-const n! Int)
 ...
 (assert
  (forall ((j$ Poly)) (!
    ...
    :qid user_curve25519_dalek__lemmas__scalar_batch_invert_lemmas__lemma_partial_product_prefix_eq_25
    :skolemid skolem_user_curve25519_dalek__lemmas__scalar_batch_invert_lemmas__lemma_partial_product_prefix_eq_25
 )))
        ...
        (and
         (=>
          ...
          (check_decrease_int (let
            ((scalars1!$0 scalars1!) (scalars2!$1 scalars2!) (n!$2 tmp%1))
            n!$2
