...
;; curve25519-dalek/src/backend/serial/u64/field.rs:187:9: 198:10 (#0)
...
;; Function-Def curve25519_dalek::backend::serial::u64::field::FieldElement51::add_assign
;; curve25519-dalek/src/backend/serial/u64/field.rs:187:9: 198:10 (#0)
(get-info :all-statistics)
(push)
 (declare-const self!@0 curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const _rhs! curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const verus_tmp_original_limbs@ %%Function%%)
 ...
 (declare-const original_limbs@0 %%Function%%)
 (assert
  fuel_defaults
 )
 (assert
 ...
 (assert
  (has_type (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. _rhs!) TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 )
 (assert
  (has_type (Poly%array%. verus_tmp@0) (ARRAY $ (UINT 64) $ (CONST_INT 5)))
 )
 (assert
  (has_type (Poly%array%. verus_tmp_original_limbs@) (ARRAY $ (UINT 64) $ (CONST_INT 5)))
 )
 (assert
  (has_type (Poly%array%. original_limbs@0) (ARRAY $ (UINT 64) $ (CONST_INT 5)))
 )
 (assert
      ...
      (=>
       (let
        ...
        (forall ((j$ Poly)) (!
          ...
          :qid user_curve25519_dalek__backend__serial__u64__field__FieldElement51__add_assign_108
          :skolemid skolem_user_curve25519_dalek__backend__serial__u64__field__FieldElement51__add_assign_108
       )))
       (=>
        (let
         ((i$ (ite
         ...
         (forall ((j$ Poly)) (!
           ...
           :qid user_curve25519_dalek__backend__serial__u64__field__FieldElement51__add_assign_109
           :skolemid skolem_user_curve25519_dalek__backend__serial__u64__field__FieldElement51__add_assign_109
        )))
        (=>
         (let
          ((i$ (ite
          ...
          (forall ((j$ Poly)) (!
            ...
            :qid user_curve25519_dalek__backend__serial__u64__field__FieldElement51__add_assign_110
            :skolemid skolem_user_curve25519_dalek__backend__serial__u64__field__FieldElement51__add_assign_110
         )))
         (=>
             ...
             (or
              ...
              (and
               ...
               (=>
                (= i@ VERUS_loop_next@1)
                (=>
                 (= tmp%3 (<= (Add (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY
                        $ (UINT 64) $ (CONST_INT 5)
                       ) (Poly%array%. original_limbs@0)
                      ) (I i@)
                     )
                 ...
                 (and
                  ...
                  (=>
                   ...
                   (=>
                    (= tmp%9 i@)
                    (=>
                     (= tmp%5 (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
                       (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                         self!@1
                     ))))
                     (and
                      (=>
                       %%location_label%%7
                       (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) tmp%5 i@)
                      )
                      (=>
                       (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) tmp%5 i@ tmp%4)
                       (=>
                        (= tmp%8 tmp%4)
                        (=>
                         ...
                         (and
                          (=>
                           %%location_label%%8
                           (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) tmp%7 i@)
                          )
                          (=>
                           (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) tmp%7 i@ tmp%6)
                           (and
                            (=>
                             %%location_label%%9
                             (uInv 64 (Add (%I tmp%8) (%I tmp%6)))
                            )
                            (=>
                             (uInv 64 (Add (%I tmp%8) (%I tmp%6)))
                             (=>
                              (= tmp%10 (uClip 64 (Add (%I tmp%8) (%I tmp%6))))
                              (and
                               (=>
                                %%location_label%%10
