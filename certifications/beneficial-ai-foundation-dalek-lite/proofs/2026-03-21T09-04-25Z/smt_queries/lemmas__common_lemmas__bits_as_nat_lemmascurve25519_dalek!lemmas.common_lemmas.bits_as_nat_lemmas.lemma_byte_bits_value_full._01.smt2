...
;; curve25519-dalek/src/lemmas/common_lemmas/bits_as_nat_lemmas.rs:270:1: 270:50 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::bits_as_nat_lemmas::lemma_byte_bits_value_full
;; curve25519-dalek/src/lemmas/common_lemmas/bits_as_nat_lemmas.rs:270:1: 270:50 (#0)
  ...
  (not (and
    (and
     ...
     (=>
      ...
      (=>
       %%location_label%%1
       (= (curve25519_dalek!specs.core_specs.byte_bits_value.? (I byte!) (I 0) (I 8)) (EucMod
         (uClip 8 (bitshr (I byte!) (I 0))) (vstd!arithmetic.power2.pow2.? (I 8))
    )))))
    (=>
     (= (curve25519_dalek!specs.core_specs.byte_bits_value.? (I byte!) (I 0) (I 8)) (EucMod
       (uClip 8 (bitshr (I byte!) (I 0))) (vstd!arithmetic.power2.pow2.? (I 8))
     ...
     (and
      (=>
       (ens%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u8_shr_zero_is_id. byte!)
       (=>
        %%location_label%%2
        (= (uClip 8 (bitshr (I byte!) (I 0))) byte!)
      ))
      (=>
       (= (uClip 8 (bitshr (I byte!) (I 0))) byte!)
       (and
        ...
        (=>
         ...
         (and
          (and
           (=>
            %%location_label%%4
            (req%vstd!arithmetic.div_mod.lemma_small_mod. byte! 256)
           )
           (=>
            (ens%vstd!arithmetic.div_mod.lemma_small_mod. byte! 256)
            (=>
             %%location_label%%5
             (= (EucMod byte! 256) byte!)
          )))
          (=>
           (= (EucMod byte! 256) byte!)
           (=>
