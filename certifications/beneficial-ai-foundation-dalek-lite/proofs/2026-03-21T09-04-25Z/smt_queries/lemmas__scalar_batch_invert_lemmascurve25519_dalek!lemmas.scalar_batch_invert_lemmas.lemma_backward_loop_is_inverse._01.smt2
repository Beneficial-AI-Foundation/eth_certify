...
;; curve25519-dalek/src/lemmas/scalar_batch_invert_lemmas.rs:239:5: 239:11 (#0)
...
;; Function-Specs curve25519_dalek::lemmas::scalar_batch_invert_lemmas::lemma_mul_congruence
(declare-fun req%curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_mul_congruence.
...
(assert
 (forall ((a! Int) (b! Int) (c! Int) (d! Int) (L! Int)) (!
   (= (req%curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_mul_congruence. a!
     b! c! d! L!
    ) (and
     (=>
     ...
     (=>
      ...
      (= (EucMod a! L!) (EucMod c! L!))
     )
     (=>
      %%global_location_label%%16
      (= (EucMod b! L!) (EucMod d! L!))
   )))
   :pattern ((req%curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_mul_congruence.
     a! b! c! d! L!
   ))
   :qid internal_req__curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_mul_congruence._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_mul_congruence._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_mul_congruence.
 (Int Int Int Int Int) Bool
)
(assert
 (forall ((a! Int) (b! Int) (c! Int) (d! Int) (L! Int)) (!
   (= (ens%curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_mul_congruence. a!
     b! c! d! L!
    ) (= (EucMod (nClip (Mul a! b!)) L!) (EucMod (nClip (Mul c! d!)) L!))
   )
   :pattern ((ens%curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_mul_congruence.
     a! b! c! d! L!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_mul_congruence._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_mul_congruence._definition
)))

;; Function-Specs curve25519_dalek::lemmas::scalar_batch_invert_lemmas::lemma_montgomery_mul_partial_product
(declare-fun req%curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_montgomery_mul_partial_product.
 (Int Int Int vstd!seq.Seq<curve25519_dalek!scalar.Scalar.>. Int) Bool
)
...
(assert
 (forall ((acc_before! Int) (tmp! Int) (acc_after! Int) (scalars! vstd!seq.Seq<curve25519_dalek!scalar.Scalar.>.)
   (i! Int)
  ) (!
   (= (req%curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_montgomery_mul_partial_product.
     acc_before! tmp! acc_after! scalars! i!
    ) (and
     (=>
     ...
     (=>
      ...
      (= (EucMod acc_before! (curve25519_dalek!specs.scalar52_specs.group_order.? (I 0)))
       (EucMod (nClip (Mul (curve25519_dalek!specs.scalar52_specs.montgomery_radix.? (I 0))
          (curve25519_dalek!lemmas.scalar_batch_invert_lemmas.partial_product.? (Poly%vstd!seq.Seq<curve25519_dalek!scalar.Scalar.>.
            scalars!
           ) (I i!)
     ...
     (=>
      ...
      (= (EucMod tmp! (curve25519_dalek!specs.scalar52_specs.group_order.? (I 0))) (EucMod
        (nClip (Mul (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. (curve25519_dalek!scalar.Scalar./Scalar/bytes
             (%Poly%curve25519_dalek!scalar.Scalar. (vstd!seq.Seq.index.? $ TYPE%curve25519_dalek!scalar.Scalar.
               (Poly%vstd!seq.Seq<curve25519_dalek!scalar.Scalar.>. scalars!) (I i!)
           ))))
     ...
     (=>
      ...
      (= (EucMod (nClip (Mul acc_after! (curve25519_dalek!specs.scalar52_specs.montgomery_radix.?
           (I 0)
         ))
        ) (curve25519_dalek!specs.scalar52_specs.group_order.? (I 0))
       ) (EucMod (nClip (Mul acc_before! tmp!)) (curve25519_dalek!specs.scalar52_specs.group_order.?
         (I 0)
   ))))))
   :pattern ((req%curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_montgomery_mul_partial_product.
     acc_before! tmp! acc_after! scalars! i!
   ))
   :qid internal_req__curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_montgomery_mul_partial_product._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_montgomery_mul_partial_product._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_montgomery_mul_partial_product.
 (Int Int Int vstd!seq.Seq<curve25519_dalek!scalar.Scalar.>. Int) Bool
)
(assert
 (forall ((acc_before! Int) (tmp! Int) (acc_after! Int) (scalars! vstd!seq.Seq<curve25519_dalek!scalar.Scalar.>.)
   ...
   (= (ens%curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_montgomery_mul_partial_product.
     acc_before! tmp! acc_after! scalars! i!
    ) (= (EucMod acc_after! (curve25519_dalek!specs.scalar52_specs.group_order.? (I 0)))
     (EucMod (nClip (Mul (curve25519_dalek!specs.scalar52_specs.montgomery_radix.? (I 0))
        (curve25519_dalek!lemmas.scalar_batch_invert_lemmas.partial_product.? (Poly%vstd!seq.Seq<curve25519_dalek!scalar.Scalar.>.
          scalars!
         ) (I (Add i! 1))
   ...
   :pattern ((ens%curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_montgomery_mul_partial_product.
     acc_before! tmp! acc_after! scalars! i!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_montgomery_mul_partial_product._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_montgomery_mul_partial_product._definition
)))

;; Function-Specs curve25519_dalek::lemmas::scalar_batch_invert_lemmas::lemma_backward_loop_acc_invariant
(declare-fun req%curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_backward_loop_acc_invariant.
 (Int Int Int vstd!seq.Seq<curve25519_dalek!scalar.Scalar.>. Int) Bool
)
...
(assert
 (forall ((acc_before! Int) (input_val! Int) (acc_after! Int) (scalars! vstd!seq.Seq<curve25519_dalek!scalar.Scalar.>.)
   (i! Int)
  ) (!
   (= (req%curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_backward_loop_acc_invariant.
     acc_before! input_val! acc_after! scalars! i!
    ) (and
     (=>
     ...
     (=>
      ...
      (= (EucMod (nClip (Mul acc_before! (curve25519_dalek!lemmas.scalar_batch_invert_lemmas.partial_product.?
           (Poly%vstd!seq.Seq<curve25519_dalek!scalar.Scalar.>. scalars!) (I (Add i! 1))
         ))
        ) (curve25519_dalek!specs.scalar52_specs.group_order.? (I 0))
       ) 1
     ))
     (=>
      ...
      (= (EucMod input_val! (curve25519_dalek!specs.scalar52_specs.group_order.? (I 0)))
       (EucMod (nClip (Mul (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. (curve25519_dalek!scalar.Scalar./Scalar/bytes
             (%Poly%curve25519_dalek!scalar.Scalar. (vstd!seq.Seq.index.? $ TYPE%curve25519_dalek!scalar.Scalar.
               (Poly%vstd!seq.Seq<curve25519_dalek!scalar.Scalar.>. scalars!) (I i!)
           ))))
          ) (curve25519_dalek!specs.scalar52_specs.montgomery_radix.? (I 0))
     ...
     (=>
      ...
      (= (EucMod (nClip (Mul acc_after! (curve25519_dalek!specs.scalar52_specs.montgomery_radix.?
       ...
       ) (EucMod (nClip (Mul acc_before! input_val!)) (curve25519_dalek!specs.scalar52_specs.group_order.?
         (I 0)
   ))))))
   :pattern ((req%curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_backward_loop_acc_invariant.
     acc_before! input_val! acc_after! scalars! i!
   ))
   :qid internal_req__curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_backward_loop_acc_invariant._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_backward_loop_acc_invariant._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_backward_loop_acc_invariant.
 (Int Int Int vstd!seq.Seq<curve25519_dalek!scalar.Scalar.>. Int) Bool
)
(assert
 (forall ((acc_before! Int) (input_val! Int) (acc_after! Int) (scalars! vstd!seq.Seq<curve25519_dalek!scalar.Scalar.>.)
   ...
   (= (ens%curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_backward_loop_acc_invariant.
     acc_before! input_val! acc_after! scalars! i!
    ) (= (EucMod (nClip (Mul acc_after! (curve25519_dalek!lemmas.scalar_batch_invert_lemmas.partial_product.?
         (Poly%vstd!seq.Seq<curve25519_dalek!scalar.Scalar.>. scalars!) (I i!)
       ))
      ) (curve25519_dalek!specs.scalar52_specs.group_order.? (I 0))
     ) 1
   ))
   :pattern ((ens%curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_backward_loop_acc_invariant.
     acc_before! input_val! acc_after! scalars! i!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_backward_loop_acc_invariant._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_backward_loop_acc_invariant._definition
)))

;; Function-Specs curve25519_dalek::lemmas::scalar_batch_invert_lemmas::lemma_invert_chain
(declare-fun req%curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_invert_chain.
...
(assert
 (forall ((acc_before! Int) (acc_after! Int) (final_acc! Int) (product! Int)) (!
   (= (req%curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_invert_chain. acc_before!
     acc_after! final_acc! product!
    ) (and
     (=>
     ...
     (=>
      ...
      (= (EucMod (nClip (Mul acc_after! acc_before!)) (curve25519_dalek!specs.scalar52_specs.group_order.?
         (I 0)
        )
       ) (EucMod (nClip (Mul (curve25519_dalek!specs.scalar52_specs.montgomery_radix.? (I 0))
          (curve25519_dalek!specs.scalar52_specs.montgomery_radix.? (I 0))
     ...
     (=>
      ...
      (= (EucMod (nClip (Mul final_acc! (curve25519_dalek!specs.scalar52_specs.montgomery_radix.?
           (I 0)
         ))
        ) (curve25519_dalek!specs.scalar52_specs.group_order.? (I 0))
       ) (EucMod acc_after! (curve25519_dalek!specs.scalar52_specs.group_order.? (I 0)))
     ...
     (=>
      ...
      (< final_acc! (curve25519_dalek!specs.scalar52_specs.group_order.? (I 0)))
   )))
   :pattern ((req%curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_invert_chain.
     acc_before! acc_after! final_acc! product!
   ))
   :qid internal_req__curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_invert_chain._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_invert_chain._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_invert_chain.
 (Int Int Int Int) Bool
)
(assert
 (forall ((acc_before! Int) (acc_after! Int) (final_acc! Int) (product! Int)) (!
   (= (ens%curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_invert_chain. acc_before!
     acc_after! final_acc! product!
    ) (= (EucMod (nClip (Mul final_acc! product!)) (curve25519_dalek!specs.scalar52_specs.group_order.?
       (I 0)
      )
     ) (EucMod 1 (curve25519_dalek!specs.scalar52_specs.group_order.? (I 0)))
   ))
   :pattern ((ens%curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_invert_chain.
     acc_before! acc_after! final_acc! product!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_invert_chain._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_invert_chain._definition
)))

;; Function-Specs curve25519_dalek::lemmas::scalar_batch_invert_lemmas::lemma_backward_loop_is_inverse
(declare-fun req%curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_backward_loop_is_inverse.
 (Int Int Int Int vstd!seq.Seq<curve25519_dalek!scalar.Scalar.>. Int) Bool
)
...
(assert
 (forall ((acc_before! Int) (scratch_val! Int) (result_m! Int) (result! Int) (scalars!
    vstd!seq.Seq<curve25519_dalek!scalar.Scalar.>.
   ) (i! Int)
  ) (!
   (= (req%curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_backward_loop_is_inverse.
     acc_before! scratch_val! result_m! result! scalars! i!
    ) (and
     (=>
     ...
     (=>
      ...
      (= (EucMod scratch_val! (curve25519_dalek!specs.scalar52_specs.group_order.? (I 0)))
       (EucMod (nClip (Mul (curve25519_dalek!specs.scalar52_specs.montgomery_radix.? (I 0))
          (curve25519_dalek!lemmas.scalar_batch_invert_lemmas.partial_product.? (Poly%vstd!seq.Seq<curve25519_dalek!scalar.Scalar.>.
            scalars!
           ) (I i!)
     ...
     (=>
      ...
      (= (EucMod (nClip (Mul result_m! (curve25519_dalek!specs.scalar52_specs.montgomery_radix.?
           (I 0)
         ))
        ) (curve25519_dalek!specs.scalar52_specs.group_order.? (I 0))
       ) (EucMod (nClip (Mul acc_before! scratch_val!)) (curve25519_dalek!specs.scalar52_specs.group_order.?
         (I 0)
     ))))
     (=>
      %%global_location_label%%33
      (< result_m! (vstd!arithmetic.power2.pow2.? (I 256)))
     )
     (=>
      %%global_location_label%%34
      (= result! result_m!)
   )))
   :pattern ((req%curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_backward_loop_is_inverse.
     acc_before! scratch_val! result_m! result! scalars! i!
   ))
   :qid internal_req__curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_backward_loop_is_inverse._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_backward_loop_is_inverse._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_backward_loop_is_inverse.
 (Int Int Int Int vstd!seq.Seq<curve25519_dalek!scalar.Scalar.>. Int) Bool
)
(assert
 (forall ((acc_before! Int) (scratch_val! Int) (result_m! Int) (result! Int) (scalars!
   ...
   (= (ens%curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_backward_loop_is_inverse.
     acc_before! scratch_val! result_m! result! scalars! i!
    ) (= (EucMod (nClip (Mul result! (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%.
   ...
   :pattern ((ens%curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_backward_loop_is_inverse.
     acc_before! scratch_val! result_m! result! scalars! i!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_backward_loop_is_inverse._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.scalar_batch_invert_lemmas.lemma_backward_loop_is_inverse._definition
)))

;; Function-Def curve25519_dalek::lemmas::scalar_batch_invert_lemmas::lemma_backward_loop_is_inverse
;; curve25519-dalek/src/lemmas/scalar_batch_invert_lemmas.rs:239:5: 239:11 (#0)
(set-option :smt.arith.solver 6)
(get-info :all-statistics)
(push)
 (declare-const acc_before! Int)
 (declare-const scratch_val! Int)
 (declare-const result_m! Int)
 ...
 (assert
  (not (=>
    %%location_label%%0
    (= (nClip (Mul acc_before! (nClip (Mul R@ pp_i@)))) (nClip (Mul (nClip (Mul acc_before!
         pp_i@
        )
       ) R@
 ))))))
