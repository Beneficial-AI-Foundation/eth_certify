...
;; curve25519-dalek/src/lemmas/common_lemmas/to_nat_lemmas.rs:513:1: 513:79 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::to_nat_lemmas::lemma_canonical_bytes_equal
;; curve25519-dalek/src/lemmas/common_lemmas/to_nat_lemmas.rs:513:1: 513:79 (#0)
  ...
  (not (and
         ...
         (=>
          ...
          (=>
           (= tmp%1 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT
             ...
             ) (EucMod (EucDiv (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. bytes1!))
               (vstd!arithmetic.power2.pow2.? (I (nClip (Mul (nClip (%I i@)) 8))))
              ) (vstd!arithmetic.power2.pow2.? (I 8))
           )))
           (and
            (=>
            ...
            (=>
             ...
             (=>
              (= tmp%2 (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT
                ...
                ) (EucMod (EucDiv (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. bytes2!))
                  (vstd!arithmetic.power2.pow2.? (I (nClip (Mul (nClip (%I i@)) 8))))
                 ) (vstd!arithmetic.power2.pow2.? (I 8))
              )))
              (and
               ...
               (=>
                tmp%2
                (=>
                 (= tmp%3 (= (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT 8)
                      $ (CONST_INT 32)
                     ) (Poly%array%. bytes1!)
                    ) i@
                   ) (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT
    ...
    (=>
     (forall ((i$ Poly)) (!
       ...
       :qid user_curve25519_dalek__lemmas__common_lemmas__to_nat_lemmas__lemma_canonical_bytes_equal_92
       :skolemid skolem_user_curve25519_dalek__lemmas__common_lemmas__to_nat_lemmas__lemma_canonical_bytes_equal_92
     ))
     (=>
      %%location_label%%6
      (forall ((i$ Poly)) (!
        ...
        :qid user_curve25519_dalek__lemmas__common_lemmas__to_nat_lemmas__lemma_canonical_bytes_equal_91
        :skolemid skolem_user_curve25519_dalek__lemmas__common_lemmas__to_nat_lemmas__lemma_canonical_bytes_equal_91
 )))))))
 (get-info :version)
