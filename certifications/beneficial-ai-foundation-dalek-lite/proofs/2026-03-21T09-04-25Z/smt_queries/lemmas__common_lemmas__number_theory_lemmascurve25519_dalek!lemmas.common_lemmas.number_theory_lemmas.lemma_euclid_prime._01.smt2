...
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:1502:1: 1502:56 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::number_theory_lemmas::lemma_euclid_prime
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:1502:1: 1502:56 (#0)
             ...
             (=>
              ...
              (and
               (and
                (=>
                 %%location_label%%3
                 (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. a! b! p!)
                )
                (=>
                 (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. a! b! p!)
                 (=>
                  %%location_label%%4
                  (= (EucMod (nClip (Mul a_mod@ b!)) p!) 0)
               )))
               (=>
                (= (EucMod (nClip (Mul a_mod@ b!)) p!) 0)
                (and
