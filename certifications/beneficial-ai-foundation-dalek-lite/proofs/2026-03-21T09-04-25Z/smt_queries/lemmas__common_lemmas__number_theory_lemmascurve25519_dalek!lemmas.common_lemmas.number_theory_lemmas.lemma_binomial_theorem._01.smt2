...
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:959:9: 959:15 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::number_theory_lemmas::lemma_binomial_theorem
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:959:9: 959:15 (#0)
...
(push)
 ...
 (assert
  (not (=>
    %%location_label%%0
    (= (Mul (Add ai@ 1) bs@) (Add (Mul ai@ bs@) bs@))
 )))
 (get-info :version)
