...
;; curve25519-dalek/src/backend/serial/u64/field.rs:674:5: 675:23 (#0)
...
;; Function-Def curve25519_dalek::backend::serial::u64::field::FieldElement51::conditional_select
;; curve25519-dalek/src/backend/serial/u64/field.rs:674:5: 675:23 (#0)
       ...
       (=>
        ...
        (and
         ...
         (=>
          ...
          (=>
           (ens%curve25519_dalek!backend.serial.u64.subtle_assumes.conditional_select_u64. tmp%5
            (%I tmp%3) choice! tmp%6
           )
           (=>
            (= tmp%31 tmp%6)
            (=>
               ...
               (=>
                ...
                (=>
                 ...
                 (and
                  (=>
                   %%location_label%%3
                   (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) tmp%10 1)
                  )
                  (=>
                   (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) tmp%10 1 tmp%9)
                   (=>
                    (ens%curve25519_dalek!backend.serial.u64.subtle_assumes.conditional_select_u64. tmp%11
                     (%I tmp%9) choice! tmp%12
                    )
                    (=>
                     (= tmp%32 tmp%12)
                     (=>
                      ...
                      (and
                       (=>
                        %%location_label%%4
                        (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) tmp%14 2)
                       )
                       (=>
                        (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) tmp%14 2 tmp%13)
                        (=>
                         (= tmp%17 (%I tmp%13))
                         (=>
                          ...
                          (and
                           (=>
                            %%location_label%%5
                            (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) tmp%16 2)
                           )
                           (=>
                            (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) tmp%16 2 tmp%15)
                            (=>
                             (ens%curve25519_dalek!backend.serial.u64.subtle_assumes.conditional_select_u64. tmp%17
                              (%I tmp%15) choice! tmp%18
                             )
                             (=>
                              (= tmp%33 tmp%18)
                              (=>
                               ...
                               (and
                                (=>
                                 %%location_label%%6
                                 (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) tmp%20 3)
                                )
                                (=>
                                 (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) tmp%20 3 tmp%19)
                                 (=>
                                  (= tmp%23 (%I tmp%19))
                                  (=>
                                   ...
                                   (and
                                    (=>
                                     %%location_label%%7
                                     (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) tmp%22 3)
                                    )
                                    (=>
                                     (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) tmp%22 3 tmp%21)
                                     (=>
                                      (ens%curve25519_dalek!backend.serial.u64.subtle_assumes.conditional_select_u64. tmp%23
                                       (%I tmp%21) choice! tmp%24
                                      )
                                      (=>
                                       (= tmp%34 tmp%24)
                                       (=>
                                        (= tmp%26 (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
                                          (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                            a!
                                        ))))
                                        (and
                                         (=>
                                          %%location_label%%8
                                          (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) tmp%26 4)
                                         )
                                         (=>
                                          (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) tmp%26 4 tmp%25)
                                          (=>
                                           (= tmp%29 (%I tmp%25))
                                           (=>
                                            (= tmp%28 (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
                                              (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                                b!
                                            ))))
                                            (and
                                             (=>
                                              %%location_label%%9
                                              (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) tmp%28 4)
                                             )
                                             (=>
                                              (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) tmp%28 4 tmp%27)
                                              (=>
                                               (ens%curve25519_dalek!backend.serial.u64.subtle_assumes.conditional_select_u64. tmp%29
                                                (%I tmp%27) choice! tmp%30
                                               )
                                               (=>
                                                (= result! (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51
                                                  (%Poly%array%. (array_new $ (UINT 64) 5 (%%array%%0 (I tmp%31) (I tmp%32) (I tmp%33)
                                                     (I tmp%34) (I tmp%30)
                                                )))))
                                                (and
                                                 (=>
