...
;; curve25519-dalek/src/lemmas/montgomery_curve_lemmas.rs:151:1: 151:71 (#0)
...
;; Function-Def curve25519_dalek::lemmas::montgomery_curve_lemmas::lemma_xdbl_degenerate_gives_w_zero
;; curve25519-dalek/src/lemmas/montgomery_curve_lemmas.rs:151:1: 151:71 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= t0@ (curve25519_dalek!specs.field_specs.field_add.? (I U!) (I W!)))
    (=>
     (= t1@ (curve25519_dalek!specs.field_specs.field_sub.? (I U!) (I W!)))
     (=>
      (= t4@ (curve25519_dalek!specs.field_specs.field_square.? (I t0@)))
      (=>
       (= t5@ (curve25519_dalek!specs.field_specs.field_square.? (I t1@)))
         ...
         (or
          (and
           (=>
            (= U! 0)
            (=>
             (= tmp%1 (= t0@ (EucMod W! (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))))
             (and
              (=>
               %%location_label%%0
               tmp%1
                   ...
                   (=>
                    ...
                    (and
                     ...
                     (=>
                      ...
                      (=>
                       %%location_label%%3
                       (= t1@ (curve25519_dalek!specs.field_specs.field_neg.? (I W!)))
                )))))))
                (=>
                 (= t1@ (curve25519_dalek!specs.field_specs.field_neg.? (I W!)))
                 (and
                  (=>
                   ...
                   (=>
                    %%location_label%%4
                    (= t5@ (curve25519_dalek!specs.field_specs.field_square.? (I (EucMod W! (curve25519_dalek!specs.field_specs_u64.p.?
                         (I 0)
                  )))))))
                  (=>
                   (= t5@ (curve25519_dalek!specs.field_specs.field_square.? (I (EucMod W! (curve25519_dalek!specs.field_specs_u64.p.?
                   ...
                   (and
                    (=>
                     ...
                     (=>
                      %%location_label%%5
                      (= t4@ (curve25519_dalek!specs.field_specs.field_square.? (I (EucMod W! (curve25519_dalek!specs.field_specs_u64.p.?
                           (I 0)
                    )))))))
                    (=>
                     (= t4@ (curve25519_dalek!specs.field_specs.field_square.? (I (EucMod W! (curve25519_dalek!specs.field_specs_u64.p.?
            ...
            (=>
             ...
             (and
              ...
              (=>
               tmp%5
               (=>
                (= tmp%6 (= t0@ (EucMod U! (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))))
                (and
                 (=>
                  %%location_label%%8
                  tmp%6
                   ...
                   (=>
                    ...
                    (and
                     ...
                     (=>
                      ...
                      (=>
                       (= tmp%8 (EucMod U! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))))
                       (=>
                        (= tmp%9 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                        (and
                         (=>
                          %%location_label%%10
                          (req%vstd!arithmetic.div_mod.lemma_mod_add_multiples_vanish. tmp%8 tmp%9)
                         )
                         (=>
                          (ens%vstd!arithmetic.div_mod.lemma_mod_add_multiples_vanish. tmp%8 tmp%9)
                          (=>
                           (= tmp%10 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                           (and
                            (=>
                             %%location_label%%11
                             (req%vstd!arithmetic.div_mod.lemma_mod_twice. U! tmp%10)
                            )
                            (=>
                             (ens%vstd!arithmetic.div_mod.lemma_mod_twice. U! tmp%10)
                             (=>
                              %%location_label%%12
                              (= t1@ (EucMod U! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))))
                   )))))))))))
                   (=>
                    (= t1@ (EucMod U! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))))
                    (=>
          ...
          (and
           ...
           (and
            ...
            (=>
             ...
             (and
              (=>
               (= t15@ (curve25519_dalek!specs.field_specs.field_add.? (I (curve25519_dalek!specs.field_specs.field_mul.?
               ...
               (and
                ...
                (=>
                 ...
                 (=>
                  %%location_label%%17
                  (= (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. (curve25519_dalek!lemmas.montgomery_curve_lemmas.spec_xdbl_projective.?
                        (I U!) (I W!)
                    ))))
                   ) 0
              )))))
