...
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:2885:1: 2894:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::curve_equation_lemmas::lemma_completed_point_ratios
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:2885:1: 2894:2 (#0)
                ...
                (=>
                 ...
                 (=>
                  ...
                  (and
                   ...
                   (curve25519_dalek!specs.edwards_specs.is_on_edwards_curve.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                      (I num_x@) (I (curve25519_dalek!specs.field_specs.field_inv.? (I denom_x@)))
                     )
                    ) (I (curve25519_dalek!specs.field_specs.field_mul.? (I num_y@) (I (curve25519_dalek!specs.field_specs.field_inv.?
                        (I denom_y@)
               )))))))))
               (=>
                (and
                  ...
                  (and
                   (=>
                    ...
                    (and
                     (=>
                      %%location_label%%3
                      (req%vstd!arithmetic.div_mod.lemma_small_mod. two@ tmp%1)
                     )
                     (=>
                      (ens%vstd!arithmetic.div_mod.lemma_small_mod. two@ tmp%1)
                      (=>
                       %%location_label%%4
                       (not (= (EucMod two@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0))
                   ))))
                   (=>
                    (not (= (EucMod two@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0))
                    (and
                     (=>
                      ...
                      (and
                       (=>
                        %%location_label%%5
                        (req%vstd!arithmetic.div_mod.lemma_small_mod. denom_x@ tmp%2)
                       )
                       (=>
                        (ens%vstd!arithmetic.div_mod.lemma_small_mod. denom_x@ tmp%2)
                        (=>
                         %%location_label%%6
                         (not (= (EucMod denom_x@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0))
                     ))))
                     (=>
                      (not (= (EucMod denom_x@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0))
                      (and
                       (=>
                        ...
                        (and
                         (=>
                          %%location_label%%7
                          (req%vstd!arithmetic.div_mod.lemma_small_mod. denom_y@ tmp%3)
                         )
                         (=>
                          (ens%vstd!arithmetic.div_mod.lemma_small_mod. denom_y@ tmp%3)
                          (=>
                           %%location_label%%8
                           (not (= (EucMod denom_y@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0))
                       ))))
                       (=>
                        (not (= (EucMod denom_y@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0))
                        (and
                         (=>
                          ...
                          (=>
                           %%location_label%%9
                           (= (curve25519_dalek!specs.field_specs.field_mul.? (I two@) (I denom_x@)) (curve25519_dalek!specs.field_specs.field_mul.?
                             (I denom_x@) (I two@)
                         ))))
                         (=>
                          (= (curve25519_dalek!specs.field_specs.field_mul.? (I two@) (I denom_x@)) (curve25519_dalek!specs.field_specs.field_mul.?
                          ...
                          (and
                           (and
                            ...
                            (=>
                             ...
                             (=>
                              %%location_label%%11
                              (not (= (curve25519_dalek!specs.field_specs.field_mul.? (I denom_x@) (I two@)) 0))
                           )))
                           (=>
                            (not (= (curve25519_dalek!specs.field_specs.field_mul.? (I denom_x@) (I two@)) 0))
                            (and
                             (=>
                              ...
                              (=>
                               %%location_label%%12
                               (= (curve25519_dalek!specs.field_specs.field_mul.? (I two@) (I denom_y@)) (curve25519_dalek!specs.field_specs.field_mul.?
                                 (I denom_y@) (I two@)
                             ))))
                             (=>
                              (= (curve25519_dalek!specs.field_specs.field_mul.? (I two@) (I denom_y@)) (curve25519_dalek!specs.field_specs.field_mul.?
                              ...
                              (and
                               (and
                                ...
                                (=>
                                 ...
                                 (=>
                                  %%location_label%%14
                                  (not (= (curve25519_dalek!specs.field_specs.field_mul.? (I denom_y@) (I two@)) 0))
                               )))
                               (=>
                                (not (= (curve25519_dalek!specs.field_specs.field_mul.? (I denom_y@) (I two@)) 0))
                                (and
                                 (=>
                                  ...
                                  (=>
                                   %%location_label%%15
                                   (= (curve25519_dalek!specs.field_specs.field_mul.? (I two@) (I num_x@)) (curve25519_dalek!specs.field_specs.field_mul.?
                                     (I num_x@) (I two@)
                                 ))))
                                 (=>
                                  (= (curve25519_dalek!specs.field_specs.field_mul.? (I two@) (I num_x@)) (curve25519_dalek!specs.field_specs.field_mul.?
                                    ...
                                    (=>
                                     ...
                                     (=>
                                      ...
                                      (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                                       ...
                                       ) (curve25519_dalek!specs.field_specs.field_mul.? (I num_x@) (I (curve25519_dalek!specs.field_specs.field_inv.?
                                          (I denom_x@)
                                   )))))))
                                   (=>
                                    (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                                    ...
                                    (and
                                     (=>
                                      ...
                                      (=>
                                       %%location_label%%18
                                       (= (curve25519_dalek!specs.field_specs.field_mul.? (I two@) (I num_y@)) (curve25519_dalek!specs.field_specs.field_mul.?
                                         (I num_y@) (I two@)
                                     ))))
                                     (=>
                                      (= (curve25519_dalek!specs.field_specs.field_mul.? (I two@) (I num_y@)) (curve25519_dalek!specs.field_specs.field_mul.?
                                        ...
                                        (=>
                                         ...
                                         (=>
                                          ...
                                          (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                                           ...
                                           ) (curve25519_dalek!specs.field_specs.field_mul.? (I num_y@) (I (curve25519_dalek!specs.field_specs.field_inv.?
                                              (I denom_y@)
                                       )))))))
                                       (=>
                                        (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_mul.?
