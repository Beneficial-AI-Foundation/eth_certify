...
;; curve25519-dalek/src/lemmas/scalar_lemmas_/montgomery_reduce_part1_chain_lemmas.rs:498:1: 515:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::scalar_lemmas_::montgomery_reduce_part1_chain_lemmas::lemma_part1_telescoping_expansion
;; curve25519-dalek/src/lemmas/scalar_lemmas_/montgomery_reduce_part1_chain_lemmas.rs:498:1: 515:2 (#0)
    ...
    (=>
     ...
     (=>
      ...
      (=>
       ...
       (=>
        (= tmp%1 (= (nClip (Add s0! (nClip (Mul n0! l0!)))) (nClip (Mul c0! (vstd!arithmetic.power2.pow2.?
             (I 52)
        )))))
        (and
         (=>
         ...
         (=>
          ...
          (and
           (=>
            (= tmp%2 (vstd!arithmetic.power2.pow2.? (I 52)))
            (=>
             (= tmp%3 (nClip (Mul c1! (vstd!arithmetic.power2.pow2.? (I 52)))))
             (=>
              (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub_other_way. tmp%2 tmp%3 c0!)
              (=>
               (= tmp%4 (vstd!arithmetic.power2.pow2.? (I 52)))
               (=>
                (= tmp%5 (vstd!arithmetic.power2.pow2.? (I 52)))
                (=>
                 (ens%vstd!arithmetic.mul.lemma_mul_is_associative. c1! tmp%4 tmp%5)
                 (=>
                  %%location_label%%1
                  (= (Mul (Sub (nClip (Mul c1! (vstd!arithmetic.power2.pow2.? (I 52)))) c0!) (vstd!arithmetic.power2.pow2.?
                     (I 52)
                    )
                   ) (Sub (nClip (Mul c1! (vstd!arithmetic.power2.pow2.? (I 104)))) (nClip (Mul c0! (vstd!arithmetic.power2.pow2.?
                       (I 52)
           ))))))))))))
           (=>
            (= (Mul (Sub (nClip (Mul c1! (vstd!arithmetic.power2.pow2.? (I 52)))) c0!) (vstd!arithmetic.power2.pow2.?
            ...
            (and
             (=>
              (= tmp%6 (vstd!arithmetic.power2.pow2.? (I 104)))
              (=>
               (= tmp%7 (nClip (Mul c2! (vstd!arithmetic.power2.pow2.? (I 52)))))
               (=>
                (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub_other_way. tmp%6 tmp%7 c1!)
                (=>
                 (= tmp%8 (vstd!arithmetic.power2.pow2.? (I 52)))
                 (=>
                  (= tmp%9 (vstd!arithmetic.power2.pow2.? (I 104)))
                  (=>
                   (ens%vstd!arithmetic.mul.lemma_mul_is_associative. c2! tmp%8 tmp%9)
                   (=>
                    %%location_label%%2
                    (= (Mul (Sub (nClip (Mul c2! (vstd!arithmetic.power2.pow2.? (I 52)))) c1!) (vstd!arithmetic.power2.pow2.?
                       (I 104)
                      )
                     ) (Sub (nClip (Mul c2! (vstd!arithmetic.power2.pow2.? (I 156)))) (nClip (Mul c1! (vstd!arithmetic.power2.pow2.?
                         (I 104)
             ))))))))))))
             (=>
              (= (Mul (Sub (nClip (Mul c2! (vstd!arithmetic.power2.pow2.? (I 52)))) c1!) (vstd!arithmetic.power2.pow2.?
              ...
              (and
               (=>
                (= tmp%10 (vstd!arithmetic.power2.pow2.? (I 156)))
                (=>
                 (= tmp%11 (nClip (Mul c3! (vstd!arithmetic.power2.pow2.? (I 52)))))
                 (=>
                  (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub_other_way. tmp%10 tmp%11 c2!)
                  (=>
                   (= tmp%12 (vstd!arithmetic.power2.pow2.? (I 52)))
                   (=>
                    (= tmp%13 (vstd!arithmetic.power2.pow2.? (I 156)))
                    (=>
                     (ens%vstd!arithmetic.mul.lemma_mul_is_associative. c3! tmp%12 tmp%13)
                     (=>
                      %%location_label%%3
                      (= (Mul (Sub (nClip (Mul c3! (vstd!arithmetic.power2.pow2.? (I 52)))) c2!) (vstd!arithmetic.power2.pow2.?
                         (I 156)
                        )
                       ) (Sub (nClip (Mul c3! (vstd!arithmetic.power2.pow2.? (I 208)))) (nClip (Mul c2! (vstd!arithmetic.power2.pow2.?
                           (I 156)
               ))))))))))))
               (=>
                (= (Mul (Sub (nClip (Mul c3! (vstd!arithmetic.power2.pow2.? (I 52)))) c2!) (vstd!arithmetic.power2.pow2.?
                ...
                (and
                 (=>
                  ...
                  (=>
                   (= tmp%15 (nClip (Mul c4! (vstd!arithmetic.power2.pow2.? (I 52)))))
                   (=>
                    (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub_other_way. tmp%14 tmp%15 c3!)
                    (=>
                     (= tmp%16 (vstd!arithmetic.power2.pow2.? (I 52)))
                     (=>
                      (= tmp%17 (vstd!arithmetic.power2.pow2.? (I 208)))
                      (=>
                       (ens%vstd!arithmetic.mul.lemma_mul_is_associative. c4! tmp%16 tmp%17)
                       (=>
                        %%location_label%%4
                        (= (Mul (Sub (nClip (Mul c4! (vstd!arithmetic.power2.pow2.? (I 52)))) c3!) (vstd!arithmetic.power2.pow2.?
                           (I 208)
                          )
                         ) (Sub (nClip (Mul c4! (vstd!arithmetic.power2.pow2.? (I 260)))) (nClip (Mul c3! (vstd!arithmetic.power2.pow2.?
                             (I 208)
                 ))))))))))))
                 (=>
                  (= (Mul (Sub (nClip (Mul c4! (vstd!arithmetic.power2.pow2.? (I 52)))) c3!) (vstd!arithmetic.power2.pow2.?
                  ...
                  (=>
                   (= tmp%18 (= (Add (Sub s1! c0!) (nClip (Mul n1! l0!))) (Sub (nClip (Mul c1! (vstd!arithmetic.power2.pow2.?
                         (I 52)
                       ))
                      ) c0!
                   )))
                   (and
                    ...
                    (=>
                     tmp%18
                     (=>
                      (= tmp%19 (= (Add (Sub s2! c1!) (nClip (Mul n2! l0!))) (Sub (nClip (Mul c2! (vstd!arithmetic.power2.pow2.?
                            (I 52)
                          ))
                         ) c1!
                      )))
                      (and
                       ...
                       (=>
                        tmp%19
                        (=>
                         (= tmp%20 (= (Add (Sub s3! c2!) (nClip (Mul n3! l0!))) (Sub (nClip (Mul c3! (vstd!arithmetic.power2.pow2.?
                               (I 52)
                             ))
                            ) c2!
                         )))
                         (and
                          ...
                          (=>
                           tmp%20
                           (=>
                            (= tmp%21 (= (Add (Sub s4! c3!) (nClip (Mul n4! l0!))) (Sub (nClip (Mul c4! (vstd!arithmetic.power2.pow2.?
                                  (I 52)
                                ))
                               ) c3!
                            )))
