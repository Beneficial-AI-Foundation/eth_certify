...
;; curve25519-dalek/src/lemmas/field_lemmas/load8_lemmas.rs:32:1: 32:72 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::load8_lemmas::lemma_load8_at_rec_version_is_exec
;; curve25519-dalek/src/lemmas/field_lemmas/load8_lemmas.rs:32:1: 32:72 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= tmp%1 (= (curve25519_dalek!lemmas.field_lemmas.load8_lemmas.load8_at_or_version_rec.?
       (Poly%slice%<u8.>. input!) (I i!) (I 0)
      ) (uClip 64 (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $slice (SLICE
           $ (UINT 8)
          ) (Poly%slice%<u8.>. input!)
         ) (I i!)
      ...
      (and
         ...
         (=>
          ...
          (=>
           ...
           (= (curve25519_dalek!lemmas.field_lemmas.load8_lemmas.load8_at_or_version_rec.? (Poly%slice%<u8.>.
            ...
            ) (uClip 64 (bitor (I (curve25519_dalek!lemmas.field_lemmas.load8_lemmas.load8_at_or_version_rec.?
                (Poly%slice%<u8.>. input!) (I i!) (I (nClip (Sub (%I j@) 1)))
               )
              ) (I (uClip 64 (bitshl (I (uClip 64 (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.?
                      $slice (SLICE $ (UINT 8)) (Poly%slice%<u8.>. input!)
                     ) (I (Add i! (%I j@)))
       ...
       (=>
        (forall ((j$ Poly)) (!
          ...
          :pattern ((curve25519_dalek!lemmas.field_lemmas.load8_lemmas.load8_at_or_version_rec.?
            (Poly%slice%<u8.>. input!) (I i!) j$
          ))
          :qid user_curve25519_dalek__lemmas__field_lemmas__load8_lemmas__lemma_load8_at_rec_version_is_exec_139
          :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__load8_lemmas__lemma_load8_at_rec_version_is_exec_139
        ))
        (=>
         %%location_label%%2
         (= (curve25519_dalek!lemmas.field_lemmas.load8_lemmas.load8_at_or_version_rec.? (Poly%slice%<u8.>.
