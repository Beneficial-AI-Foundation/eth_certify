...
;; curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:684:1: 684:87 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::pow_lemmas::lemma_pow2_mul_div_mod_small_mul
;; curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:684:1: 684:87 (#0)
  ...
  (not (=>
    ...
    (and
     (and
      (=>
       %%location_label%%0
       (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_mul_div. x! k! s!)
      )
      (=>
       (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_mul_div. x! k! s!)
       (=>
        %%location_label%%1
        (= (EucDiv (nClip (Mul x! (vstd!arithmetic.power2.pow2.? (I k!)))) (vstd!arithmetic.power2.pow2.?
           (I s!)
          )
         ) (EucDiv x! (vstd!arithmetic.power2.pow2.? (I d@)))
     ))))
     (=>
      (= (EucDiv (nClip (Mul x! (vstd!arithmetic.power2.pow2.? (I k!)))) (vstd!arithmetic.power2.pow2.?
         (I s!)
       ...
       (=>
        ...
        (and
         (and
          (and
           (=>
            (ens%vstd!arithmetic.power2.lemma_pow2_adds. d@ t!)
            (=>
             %%location_label%%3
             (= (nClip (Mul (vstd!arithmetic.power2.pow2.? (I d@)) (vstd!arithmetic.power2.pow2.?
                 (I t!)
               ))
              ) (vstd!arithmetic.power2.pow2.? (I (nClip (Add d@ t!))))
           )))
           (=>
            (= (nClip (Mul (vstd!arithmetic.power2.pow2.? (I d@)) (vstd!arithmetic.power2.pow2.?
                (I t!)
               ...
               (=>
                ...
                (=>
                 ...
                 (and
                  (=>
                   %%location_label%%4
                   (req%vstd!arithmetic.power2.lemma_pow2_strictly_increases. px! tmp%1)
                  )
                  (=>
                   (ens%vstd!arithmetic.power2.lemma_pow2_strictly_increases. px! tmp%1)
                   %%switch_label%%0
               ))))
               (=>
                (not (< px! (nClip (Add t! d@))))
                %%switch_label%%0
              ))
              (and
               (not %%switch_label%%0)
               (=>
                %%location_label%%5
                (<= (vstd!arithmetic.power2.pow2.? (I px!)) (vstd!arithmetic.power2.pow2.? (I (nClip
                    (Add t! d@)
             )))))))
             (=>
              (<= (vstd!arithmetic.power2.pow2.? (I px!)) (vstd!arithmetic.power2.pow2.? (I (nClip
              ...
              (=>
               %%location_label%%6
               (< x! (nClip (Mul (vstd!arithmetic.power2.pow2.? (I d@)) (vstd!arithmetic.power2.pow2.?
                   (I t!)
          )))))))))
          (=>
           (< x! (nClip (Mul (vstd!arithmetic.power2.pow2.? (I d@)) (vstd!arithmetic.power2.pow2.?
           ...
           (and
            (=>
             ...
             (=>
              (= tmp%3 (vstd!arithmetic.power2.pow2.? (I t!)))
              (and
               (=>
                %%location_label%%7
                (req%vstd!arithmetic.div_mod.lemma_multiply_divide_lt. x! tmp%2 tmp%3)
               )
               (=>
                (ens%vstd!arithmetic.div_mod.lemma_multiply_divide_lt. x! tmp%2 tmp%3)
                (=>
                 %%location_label%%8
                 (< (EucDiv x! (vstd!arithmetic.power2.pow2.? (I d@))) (vstd!arithmetic.power2.pow2.?
                   (I t!)
            )))))))
            (=>
             (< (EucDiv x! (vstd!arithmetic.power2.pow2.? (I d@))) (vstd!arithmetic.power2.pow2.?
         ...
         (=>
          ...
          (and
           (=>
            (= tmp%4 (EucDiv x! (vstd!arithmetic.power2.pow2.? (I d@))))
            (=>
             (= tmp%5 (vstd!arithmetic.power2.pow2.? (I t!)))
             (and
              (=>
               %%location_label%%10
              ...
              (=>
               ...
               (=>
                %%location_label%%11
                (= (EucMod (EucDiv x! (vstd!arithmetic.power2.pow2.? (I d@))) (vstd!arithmetic.power2.pow2.?
                   (I t!)
                  )
                 ) (EucDiv x! (vstd!arithmetic.power2.pow2.? (I d@)))
           ))))))
