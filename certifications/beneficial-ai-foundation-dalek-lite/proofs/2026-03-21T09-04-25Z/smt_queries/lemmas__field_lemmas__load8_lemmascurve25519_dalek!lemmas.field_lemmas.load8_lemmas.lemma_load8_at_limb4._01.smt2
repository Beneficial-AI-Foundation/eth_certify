...
;; curve25519-dalek/src/lemmas/field_lemmas/load8_lemmas.rs:1003:1: 1003:48 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::load8_lemmas::lemma_load8_at_limb4
;; curve25519-dalek/src/lemmas/field_lemmas/load8_lemmas.rs:1003:1: 1003:48 (#0)
...
(push)
 ...
 (declare-const i@ Int)
 (declare-const k@ Int)
 (declare-const j_div@ Int)
 (declare-const j_id@ Int)
 (declare-const j_shift@ Int)
 (assert
  fuel_defaults
 )
 (assert
       ...
       (=>
        ...
        (and
         ...
         (=>
          ...
          (=>
           (= tmp%1 (= (uClip 64 (bitand (I (uClip 64 (bitshr (I (uClip 64 (curve25519_dalek!specs.core_specs.spec_load8_at.?
                     (Poly%slice%<u8.>. input!) (I i@)
                   ))
                  ) (I k@)
                ))
            ...
            (=>
             ...
             (and
              (and
               (and
                (=>
                 (= tmp%2 (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $ (
                       UINT 8
                      )
                     ) (Poly%slice%<u8.>. input!)
                    ) (I 24)
                 ...
                 (=>
                  (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_u8_lt_pow2_8. tmp%2)
                  (=>
                   %%location_label%%2
                   (< (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $ (UINT 8))
                       (Poly%slice%<u8.>. input!)
                ...
                (=>
                 ...
                 (and
                  (and
                   (=>
                    %%location_label%%3
                    (req%vstd!arithmetic.power2.lemma_pow2_strictly_increases. 8 12)
                   )
                   (=>
                    (ens%vstd!arithmetic.power2.lemma_pow2_strictly_increases. 8 12)
                    (=>
                     %%location_label%%4
                     (< (vstd!arithmetic.power2.pow2.? (I 8)) (vstd!arithmetic.power2.pow2.? (I 12)))
                  )))
                  (=>
                   (< (vstd!arithmetic.power2.pow2.? (I 8)) (vstd!arithmetic.power2.pow2.? (I 12)))
                   (=>
                    %%location_label%%5
                    (let
                     ((tmp%%$ (vstd!arithmetic.power2.pow2.? (I 8))))
                     (and
                      (< (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $ (UINT 8))
                          (Poly%slice%<u8.>. input!)
                         ) (I 24)
                      ...
                      (< tmp%%$ (vstd!arithmetic.power2.pow2.? (I 12)))
               )))))))
               (=>
                (let
                 ((tmp%%$ (vstd!arithmetic.power2.pow2.? (I 8))))
                ...
                (=>
                 ...
                 (=>
                  (= tmp%4 (vstd!arithmetic.power2.pow2.? (I 12)))
                  (and
                   (=>
                    %%location_label%%6
                    (req%vstd!arithmetic.div_mod.lemma_basic_div. tmp%3 tmp%4)
                   )
                   (=>
                    (ens%vstd!arithmetic.div_mod.lemma_basic_div. tmp%3 tmp%4)
                    (=>
                     %%location_label%%7
                     (= (EucDiv (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $
                           (UINT 8)
                       ...
                       ) (vstd!arithmetic.power2.pow2.? (I 12))
                      ) 0
              ))))))))
              (=>
               (= (EucDiv (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $slice (SLICE $
