...
;; MODULE 'module specs::field_specs'
;; curve25519-dalek/src/specs/field_specs.rs:639:1: 639:63 (#0)
...
(declare-const fuel%curve25519_dalek!specs.field_specs.is_inverse_field_of_nat. FuelId)
(declare-const fuel%curve25519_dalek!specs.field_specs.product_of_field_elems. FuelId)
(declare-const fuel%curve25519_dalek!specs.field_specs.partial_product_nonzeros. FuelId)
(declare-const fuel%curve25519_dalek!specs.field_specs.is_square_of. FuelId)
...
(declare-const fuel%curve25519_dalek!specs.field_specs.has_inv_mod_p. FuelId)
(declare-const fuel%curve25519_dalek!specs.field_specs.is_inv_witness. FuelId)
...
(assert
 (distinct fuel%vstd!arithmetic.div_mod.lemma_mod_bound. fuel%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left.
  fuel%vstd!arithmetic.div_mod.lemma_mul_mod_noop_general. fuel%vstd!arithmetic.mul.lemma_mul_is_associative.
  ...
  fuel%curve25519_dalek!specs.field_specs.fe51_as_canonical_nat_sign_bit. fuel%curve25519_dalek!specs.field_specs.field_add.
  ...
  fuel%curve25519_dalek!specs.field_specs.field_sqrt. fuel%curve25519_dalek!specs.field_specs.spec_fe51_from_bytes.
  fuel%curve25519_dalek!specs.field_specs.spec_fe51_as_bytes. fuel%curve25519_dalek!specs.field_specs.is_inverse_field.
  fuel%curve25519_dalek!specs.field_specs.is_inverse_field_of_nat. fuel%curve25519_dalek!specs.field_specs.product_of_field_elems.
  fuel%curve25519_dalek!specs.field_specs.partial_product_nonzeros. fuel%curve25519_dalek!specs.field_specs.is_square_of.
  ...
  fuel%curve25519_dalek!specs.field_specs.sqrt_ratio_i_post. fuel%curve25519_dalek!specs.field_specs.has_inv_mod_p.
  fuel%curve25519_dalek!specs.field_specs.is_inv_witness. fuel%curve25519_dalek!specs.field_specs.sqrt_m1.
...
;; Function-Decl curve25519_dalek::specs::field_specs::is_inverse_field_of_nat
(declare-fun curve25519_dalek!specs.field_specs.is_inverse_field_of_nat.? (Poly Poly)
 Bool
)

;; Function-Decl curve25519_dalek::specs::field_specs::product_of_field_elems
(declare-fun curve25519_dalek!specs.field_specs.product_of_field_elems.? (Poly) Int)
(declare-fun curve25519_dalek!specs.field_specs.rec%product_of_field_elems.? (Poly
  Fuel
 ) Int
)
...
;; Function-Decl curve25519_dalek::specs::field_specs::is_square_of
(declare-fun curve25519_dalek!specs.field_specs.is_square_of.? (Poly Poly) Bool)
...
;; Function-Decl curve25519_dalek::specs::field_specs::has_inv_mod_p
(declare-fun curve25519_dalek!specs.field_specs.has_inv_mod_p.? (Poly) Bool)

;; Function-Decl curve25519_dalek::specs::field_specs::is_inv_witness
(declare-fun curve25519_dalek!specs.field_specs.is_inv_witness.? (Poly Poly) Bool)
  ...
  (forall ((fe1! Poly) (fe2! Poly) (bound! Poly)) (!
    (= (curve25519_dalek!specs.field_specs.sum_of_limbs_bounded.? fe1! fe2! bound!) (forall
      ((i$ Poly)) (!
       ...
       :qid user_curve25519_dalek__specs__field_specs__sum_of_limbs_bounded_28
       :skolemid skolem_user_curve25519_dalek__specs__field_specs__sum_of_limbs_bounded_28
    )))
 ...
 (=>
  ...
  (forall ((a! Poly)) (!
    (= (curve25519_dalek!specs.field_specs.is_square.? a!) (exists ((y$ Poly)) (!
       ...
       :qid user_curve25519_dalek__specs__field_specs__is_square_29
       :skolemid skolem_user_curve25519_dalek__specs__field_specs__is_square_29
    )))
 ...
 (forall ((%%hole%%0 Type) (%%hole%%1 Int) (%%hole%%2 Int)) (!
   (=>
    (exists ((y$ Poly)) (!
      ...
      :pattern ((curve25519_dalek!specs.field_specs.field_mul.? y$ y$))
      :qid user_curve25519_dalek__specs__field_specs__field_sqrt_30
      :skolemid skolem_user_curve25519_dalek__specs__field_specs__field_sqrt_30
    ))
    (exists ((y$ Poly)) (!
      (and
       (and
...
;; Function-Axioms curve25519_dalek::specs::field_specs::is_inverse_field_of_nat
(assert
 (fuel_bool_default fuel%curve25519_dalek!specs.field_specs.is_inverse_field_of_nat.)
)
(assert
 (=>
  (fuel_bool fuel%curve25519_dalek!specs.field_specs.is_inverse_field_of_nat.)
  (forall ((fe! Poly) (n! Poly)) (!
    (= (curve25519_dalek!specs.field_specs.is_inverse_field_of_nat.? fe! n!) (= (curve25519_dalek!specs.field_specs.field_mul.?
       (I (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? fe!)) n!
      ) 1
    ))
    :pattern ((curve25519_dalek!specs.field_specs.is_inverse_field_of_nat.? fe! n!))
    :qid internal_curve25519_dalek!specs.field_specs.is_inverse_field_of_nat.?_definition
    :skolemid skolem_internal_curve25519_dalek!specs.field_specs.is_inverse_field_of_nat.?_definition
))))

;; Function-Axioms curve25519_dalek::specs::field_specs::product_of_field_elems
(assert
 (fuel_bool_default fuel%curve25519_dalek!specs.field_specs.product_of_field_elems.)
)
(declare-const fuel_nat%curve25519_dalek!specs.field_specs.product_of_field_elems.
 Fuel
)
(assert
 (forall ((fields! Poly) (fuel% Fuel)) (!
   (= (curve25519_dalek!specs.field_specs.rec%product_of_field_elems.? fields! fuel%)
    (curve25519_dalek!specs.field_specs.rec%product_of_field_elems.? fields! zero)
   )
   :pattern ((curve25519_dalek!specs.field_specs.rec%product_of_field_elems.? fields!
     fuel%
   ))
   :qid internal_curve25519_dalek!specs.field_specs.product_of_field_elems._fuel_to_zero_definition
   :skolemid skolem_internal_curve25519_dalek!specs.field_specs.product_of_field_elems._fuel_to_zero_definition
)))
(assert
 (forall ((fields! Poly) (fuel% Fuel)) (!
   (=>
    (has_type fields! (TYPE%vstd!seq.Seq. $ TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.))
    (= (curve25519_dalek!specs.field_specs.rec%product_of_field_elems.? fields! (succ fuel%))
     (ite
      (= (vstd!seq.Seq.len.? $ TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.
        fields!
       ) 0
      )
      1
      (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.rec%product_of_field_elems.?
         (vstd!seq.Seq.subrange.? $ TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.
          fields! (I 1) (I (vstd!seq.Seq.len.? $ TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.
            fields!
          ))
         ) fuel%
        )
       ) (I (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (vstd!seq.Seq.index.?
          $ TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51. fields! (I 0)
   )))))))
   :pattern ((curve25519_dalek!specs.field_specs.rec%product_of_field_elems.? fields!
     (succ fuel%)
   ))
   :qid internal_curve25519_dalek!specs.field_specs.product_of_field_elems._fuel_to_body_definition
   :skolemid skolem_internal_curve25519_dalek!specs.field_specs.product_of_field_elems._fuel_to_body_definition
)))
(assert
 (=>
  (fuel_bool fuel%curve25519_dalek!specs.field_specs.product_of_field_elems.)
  (forall ((fields! Poly)) (!
    (=>
     (has_type fields! (TYPE%vstd!seq.Seq. $ TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.))
     (= (curve25519_dalek!specs.field_specs.product_of_field_elems.? fields!) (curve25519_dalek!specs.field_specs.rec%product_of_field_elems.?
       fields! (succ fuel_nat%curve25519_dalek!specs.field_specs.product_of_field_elems.)
    )))
    :pattern ((curve25519_dalek!specs.field_specs.product_of_field_elems.? fields!))
    :qid internal_curve25519_dalek!specs.field_specs.product_of_field_elems.?_definition
    :skolemid skolem_internal_curve25519_dalek!specs.field_specs.product_of_field_elems.?_definition
))))
(assert
 (forall ((fields! Poly)) (!
   (=>
    (has_type fields! (TYPE%vstd!seq.Seq. $ TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.))
    (<= 0 (curve25519_dalek!specs.field_specs.product_of_field_elems.? fields!))
   )
   :pattern ((curve25519_dalek!specs.field_specs.product_of_field_elems.? fields!))
   :qid internal_curve25519_dalek!specs.field_specs.product_of_field_elems.?_pre_post_definition
   :skolemid skolem_internal_curve25519_dalek!specs.field_specs.product_of_field_elems.?_pre_post_definition
)))
(assert
 (forall ((fields! Poly) (fuel% Fuel)) (!
   (=>
    (has_type fields! (TYPE%vstd!seq.Seq. $ TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.))
    (<= 0 (curve25519_dalek!specs.field_specs.rec%product_of_field_elems.? fields! fuel%))
   )
   :pattern ((curve25519_dalek!specs.field_specs.rec%product_of_field_elems.? fields!
     fuel%
   ))
   :qid internal_curve25519_dalek!specs.field_specs.rec__product_of_field_elems.?_pre_post_rec_definition
   :skolemid skolem_internal_curve25519_dalek!specs.field_specs.rec__product_of_field_elems.?_pre_post_rec_definition
)))
...
;; Function-Axioms curve25519_dalek::specs::field_specs::is_square_of
(assert
 (fuel_bool_default fuel%curve25519_dalek!specs.field_specs.is_square_of.)
)
(assert
 (=>
  (fuel_bool fuel%curve25519_dalek!specs.field_specs.is_square_of.)
  (forall ((a! Poly) (b! Poly)) (!
    (= (curve25519_dalek!specs.field_specs.is_square_of.? a! b!) (= (curve25519_dalek!specs.field_specs.field_mul.?
       (I (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? b!)) (I (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.?
         b!
       ))
      ) (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? a!)
    ))
    :pattern ((curve25519_dalek!specs.field_specs.is_square_of.? a! b!))
    :qid internal_curve25519_dalek!specs.field_specs.is_square_of.?_definition
    :skolemid skolem_internal_curve25519_dalek!specs.field_specs.is_square_of.?_definition
))))
 ...
 (forall ((%%hole%%0 Type) (%%hole%%1 Int)) (!
   (=>
    (exists ((b$ Poly)) (!
      ...
      :qid user_curve25519_dalek__specs__field_specs__u8_32_from_nat_31
      :skolemid skolem_user_curve25519_dalek__specs__field_specs__u8_32_from_nat_31
    ))
    (exists ((b$ Poly)) (!
      (and
       (and
 ...
 (=>
  ...
  (forall ((n! Poly)) (!
    (= (curve25519_dalek!specs.field_specs.u8_32_from_nat.? n!) (%Poly%array%. (as_type
       (%%choose%%1 (ARRAY $ (UINT 8) $ (CONST_INT 32)) (EucMod (%I n!) (vstd!arithmetic.power2.pow2.?
          (I 256)
        ))
...
;; Function-Axioms curve25519_dalek::specs::field_specs::has_inv_mod_p
(assert
 (fuel_bool_default fuel%curve25519_dalek!specs.field_specs.has_inv_mod_p.)
)
(assert
 (=>
  (fuel_bool fuel%curve25519_dalek!specs.field_specs.has_inv_mod_p.)
  (forall ((v! Poly)) (!
    (= (curve25519_dalek!specs.field_specs.has_inv_mod_p.? v!) (and
      (not (= (curve25519_dalek!specs.field_specs_u64.field_canonical.? v!) 0))
      (exists ((w$ Poly)) (!
        (and
         (has_type w$ NAT)
         (= (curve25519_dalek!specs.field_specs.field_mul.? v! w$) 1)
        )
        :pattern ((curve25519_dalek!specs.field_specs.field_mul.? v! w$))
        :qid user_curve25519_dalek__specs__field_specs__has_inv_mod_p_32
        :skolemid skolem_user_curve25519_dalek__specs__field_specs__has_inv_mod_p_32
    ))))
    :pattern ((curve25519_dalek!specs.field_specs.has_inv_mod_p.? v!))
    :qid internal_curve25519_dalek!specs.field_specs.has_inv_mod_p.?_definition
    :skolemid skolem_internal_curve25519_dalek!specs.field_specs.has_inv_mod_p.?_definition
))))

;; Function-Axioms curve25519_dalek::specs::field_specs::is_inv_witness
(assert
 (fuel_bool_default fuel%curve25519_dalek!specs.field_specs.is_inv_witness.)
)
(assert
 (=>
  (fuel_bool fuel%curve25519_dalek!specs.field_specs.is_inv_witness.)
  (forall ((v! Poly) (w! Poly)) (!
    (= (curve25519_dalek!specs.field_specs.is_inv_witness.? v! w!) (= (curve25519_dalek!specs.field_specs.field_mul.?
       (I (curve25519_dalek!specs.field_specs_u64.field_canonical.? v!)) (I (curve25519_dalek!specs.field_specs_u64.field_canonical.?
         w!
       ))
      ) 1
    ))
    :pattern ((curve25519_dalek!specs.field_specs.is_inv_witness.? v! w!))
    :qid internal_curve25519_dalek!specs.field_specs.is_inv_witness.?_definition
    :skolemid skolem_internal_curve25519_dalek!specs.field_specs.is_inv_witness.?_definition
))))
...
;; Function-Specs curve25519_dalek::specs::field_specs::lemma_fermat_for_p
(declare-fun req%curve25519_dalek!specs.field_specs.lemma_fermat_for_p. (Int) Bool)
(declare-const %%global_location_label%%21 Bool)
(assert
 (forall ((x! Int)) (!
   (= (req%curve25519_dalek!specs.field_specs.lemma_fermat_for_p. x!) (=>
     %%global_location_label%%21
     (not (= (curve25519_dalek!specs.field_specs_u64.field_canonical.? (I x!)) 0))
   ))
   :pattern ((req%curve25519_dalek!specs.field_specs.lemma_fermat_for_p. x!))
   :qid internal_req__curve25519_dalek!specs.field_specs.lemma_fermat_for_p._definition
   :skolemid skolem_internal_req__curve25519_dalek!specs.field_specs.lemma_fermat_for_p._definition
)))
(declare-fun ens%curve25519_dalek!specs.field_specs.lemma_fermat_for_p. (Int) Bool)
(assert
 (forall ((x! Int)) (!
   (= (ens%curve25519_dalek!specs.field_specs.lemma_fermat_for_p. x!) (= (curve25519_dalek!specs.field_specs_u64.field_canonical.?
      (I (nClip (vstd!arithmetic.power.pow.? (I x!) (I (nClip (Sub (curve25519_dalek!specs.field_specs_u64.p.?
             (I 0)
            ) 1
      ))))))
     ) 1
   ))
   :pattern ((ens%curve25519_dalek!specs.field_specs.lemma_fermat_for_p. x!))
   :qid internal_ens__curve25519_dalek!specs.field_specs.lemma_fermat_for_p._definition
   :skolemid skolem_internal_ens__curve25519_dalek!specs.field_specs.lemma_fermat_for_p._definition
)))

;; Function-Specs curve25519_dalek::specs::field_specs::lemma_inverse_unique_core
(declare-fun req%curve25519_dalek!specs.field_specs.lemma_inverse_unique_core. (Int
  Int Int Int
 ) Bool
)
...
(assert
 (forall ((a! Int) (w! Int) (z! Int) (p! Int)) (!
   (= (req%curve25519_dalek!specs.field_specs.lemma_inverse_unique_core. a! w! z! p!)
    (and
     (=>
     ...
     (=>
      ...
      (= (EucMod (nClip (Mul a! w!)) p!) 1)
     )
     (=>
      %%global_location_label%%27
      (= (EucMod (nClip (Mul a! z!)) p!) 1)
   )))
   :pattern ((req%curve25519_dalek!specs.field_specs.lemma_inverse_unique_core. a! w!
     z! p!
   ))
   :qid internal_req__curve25519_dalek!specs.field_specs.lemma_inverse_unique_core._definition
   :skolemid skolem_internal_req__curve25519_dalek!specs.field_specs.lemma_inverse_unique_core._definition
)))
(declare-fun ens%curve25519_dalek!specs.field_specs.lemma_inverse_unique_core. (Int
  Int Int Int
 ) Bool
)
(assert
 (forall ((a! Int) (w! Int) (z! Int) (p! Int)) (!
   (= (ens%curve25519_dalek!specs.field_specs.lemma_inverse_unique_core. a! w! z! p!)
    (= w! z!)
   )
   :pattern ((ens%curve25519_dalek!specs.field_specs.lemma_inverse_unique_core. a! w!
     z! p!
   ))
   :qid internal_ens__curve25519_dalek!specs.field_specs.lemma_inverse_unique_core._definition
   :skolemid skolem_internal_ens__curve25519_dalek!specs.field_specs.lemma_inverse_unique_core._definition
)))
...
;; Function-Def curve25519_dalek::specs::field_specs::axiom_invsqrt_factors_over_square
;; curve25519-dalek/src/specs/field_specs.rs:639:1: 639:63 (#0)
