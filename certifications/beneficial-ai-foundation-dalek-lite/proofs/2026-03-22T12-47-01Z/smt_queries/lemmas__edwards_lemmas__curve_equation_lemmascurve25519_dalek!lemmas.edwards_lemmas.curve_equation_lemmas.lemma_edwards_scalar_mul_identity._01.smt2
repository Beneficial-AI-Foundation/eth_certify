...
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:3240:1: 3240:55 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::curve_equation_lemmas::lemma_edwards_scalar_mul_identity
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:3240:1: 3240:55 (#0)
         ...
         (and
          (=>
           ...
           (=>
            (fuel_bool fuel%curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.)
            (=>
             (exists ((fuel% Fuel)) (= fuel_nat%curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.
               (succ fuel%)
             ))
             (=>
