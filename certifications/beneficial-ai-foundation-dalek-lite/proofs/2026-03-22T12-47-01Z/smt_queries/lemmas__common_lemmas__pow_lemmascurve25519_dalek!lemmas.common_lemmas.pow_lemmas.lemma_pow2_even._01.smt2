...
;; curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:1059:1: 1059:37 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::pow_lemmas::lemma_pow2_even
;; curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:1059:1: 1059:37 (#0)
  ...
  (not (=>
    ...
    (or
     (and
      ...
      (=>
       ...
       (=>
        (= m@ (nClip (Sub n! 1)))
        (=>
         (ens%vstd!arithmetic.power2.lemma_pow2_adds. 1 m@)
         (=>
          (= tmp%1 (= (vstd!arithmetic.power2.pow2.? (I n!)) (nClip (Mul (vstd!arithmetic.power2.pow2.?
               (I 1)
              ) (vstd!arithmetic.power2.pow2.? (I m@))
          ))))
          (and
           (=>
            %%location_label%%3
           ...
           (=>
            ...
            (and
             ...
             (=>
              (= (vstd!arithmetic.power2.pow2.? (I 1)) 2)
              (=>
               (= tmp%2 (vstd!arithmetic.power2.pow2.? (I m@)))
               (and
                (=>
                 %%location_label%%5
                 (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. 2 tmp%2 2)
                )
                (=>
                 (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. 2 tmp%2 2)
                 (and
                  (=>
                   %%location_label%%6
                  ...
                  (and
                   (=>
                    %%location_label%%7
                    (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_even. m@)
                   )
                   (=>
                    (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_even. m@)
                    (=>
                     (= tmp%3 (= (EucMod (Mul 2 (EucMod (vstd!arithmetic.power2.pow2.? (I m@)) 2)) 2) 0))
                     (and
                      (=>
                       %%location_label%%8
                       tmp%3
                      ...
                      (=>
                       tmp%3
                       (=>
                        (= tmp%4 (= (EucMod (vstd!arithmetic.power2.pow2.? (I n!)) 2) 0))
                        (and
                         (=>
                          %%location_label%%9
                          tmp%4
     ...
     (and
      ...
      (=>
       %%location_label%%10
       (= (EucMod (vstd!arithmetic.power2.pow2.? (I n!)) 2) 0)
 ))))))
 (get-info :version)
