...
;; MODULE 'module field'
;; curve25519-dalek/src/field.rs:153:5: 154:15 (#0)
...
;; Function-Def curve25519_dalek::field::FieldElement::ct_eq
;; curve25519-dalek/src/field.rs:153:5: 154:15 (#0)
...
(push)
 ...
 (declare-const self_bytes@ %%Function%%)
 (declare-const other_bytes@ %%Function%%)
 ...
 (assert
  (not (=>
    (ens%curve25519_dalek!backend.serial.u64.field.impl&%16.as_bytes. (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
      self!
     ) self_bytes@
    )
    (=>
     ...
     (=>
      (ens%curve25519_dalek!backend.serial.u64.subtle_assumes.ct_eq_bytes32. self_bytes@
       other_bytes@ result@
      )
      (and
       (=>
        %%location_label%%0
        (req%curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes.
         (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. self!) self_bytes@
       ))
       (=>
        (ens%curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes.
         (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. self!) self_bytes@
        ...
        (and
         (=>
          %%location_label%%1
          (req%curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes.
           (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. other!) other_bytes@
         ))
         (=>
          (ens%curve25519_dalek!lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes.
           (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. other!) other_bytes@
               ...
               (=>
                ...
                (=>
                 ...
                 (= (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT
                    ...
                    ) (Poly%array%. self_bytes@)
                   ) i@
                  ) (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT
                      32
                     )
                    ) (Poly%array%. other_bytes@)
                   ) i@
              )))))
              (=>
               (forall ((i$ Poly)) (!
                 ...
                 :qid user_curve25519_dalek__field__FieldElement__ct_eq_47
                 :skolemid skolem_user_curve25519_dalek__field__FieldElement__ct_eq_47
               ))
               (=>
                (= tmp%1 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!core_assumes.seq_from32.?
                    (Poly%array%. self_bytes@)
                   )
                ...
                (and
                 ...
                 (=>
                  tmp%1
                  (=>
                   (= tmp%2 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
                       self!
                      )
            ...
            (or
             (and
              (=>
               ...
               (=>
                (= tmp%3 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!core_assumes.seq_from32.?
                    (Poly%array%. self_bytes@)
                   )
                  ) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!core_assumes.seq_from32.? (Poly%array%.
                     other_bytes@
                 ...
                 (=>
                  ...
                  (and
                   ...
                   (=>
                    ...
                    (=>
                     (= tmp%4 (ext_eq false (ARRAY $ (UINT 8) $ (CONST_INT 32)) (Poly%array%. self_bytes@)
                       (Poly%array%. other_bytes@)
                     ))
                     (and
                      (=>
              ...
              (=>
               (not (= (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.? self!) (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
                  other!
               )))
               %%switch_label%%0
             ))
             (and
              (not %%switch_label%%0)
              (=>
               (= result! (Poly%subtle!Choice. result@))
               (=>
                %%location_label%%8
                (= (curve25519_dalek!backend.serial.u64.subtle_assumes.choice_is_true.? result!) (
                  = (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.? self!) (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
