...
;; curve25519-dalek/src/lemmas/scalar_byte_lemmas/scalar_to_bytes_lemmas.rs:266:5: 266:11 (#0)
...
;; Function-Def curve25519_dalek::lemmas::scalar_byte_lemmas::scalar_to_bytes_lemmas::lemma_byte_from_limb_shift_52
;; curve25519-dalek/src/lemmas/scalar_byte_lemmas/scalar_to_bytes_lemmas.rs:266:5: 266:11 (#0)
...
(declare-const shifted@ (_ BitVec 64))
(assert
 true
)
...
(assert
 (not (=>
   %%location_label%%0
   (= ((_ extract 7 0) shifted@) ((_ extract 7 0) (bvand shifted@ ((_ zero_extend 56) (_
        bv255 8
))))))))
(get-info :version)
