...
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:355:7: 355:56 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::number_theory_lemmas::lemma_only_odd_divisor_of_pow2
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:355:7: 355:56 (#0)
     ...
     (and
      ...
      (=>
       ...
       (=>
        ...
        (and
         (=>
          (ens%vstd!arithmetic.power2.lemma_pow2_adds. 1 km1@)
          (and
           (=>
            (ens%vstd!arithmetic.power2.lemma2_to64. 0)
            (=>
           ...
           (=>
            ...
            (=>
             %%location_label%%3
             (= (vstd!arithmetic.power2.pow2.? (I k!)) (nClip (Mul 2 (vstd!arithmetic.power2.pow2.?
                 (I km1@)
         ))))))))
         (=>
          (= (vstd!arithmetic.power2.pow2.? (I k!)) (nClip (Mul 2 (vstd!arithmetic.power2.pow2.?
          ...
          (and
           ...
           (=>
            ...
            (=>
             (= tmp%1 (= (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.spec_gcd.? (
                 I (EucMod d! 2)
                ) (I 2)
               ) (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.spec_gcd.? (I d!) (I
                 2
                 ...
                 (=>
                  ...
                  (and
                   (=>
                    (fuel_bool fuel%curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.spec_gcd.)
                    (=>
                     (exists ((fuel% Fuel)) (= fuel_nat%curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.spec_gcd.
                       (succ (succ (succ fuel%)))
                     ))
                     (=>
                      %%location_label%%7
                      (= (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.spec_gcd.? (I 1) (I 2))
                       1
                   ))))
                   (=>
                    (= (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.spec_gcd.? (I 1) (I 2))
                    ...
                    (=>
                     (= tmp%3 (= (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.spec_gcd.? (
                         I d!
                        ) (I 2)
                       ) 1
                     ))
                     (and
                      ...
                      (=>
                       tmp%3
                       (=>
                        (= tmp%4 (= (EucMod (nClip (Mul 2 (vstd!arithmetic.power2.pow2.? (I km1@)))) d!) 0))
                        (and
                         (=>
                          %%location_label%%9
                          tmp%4
                         ...
                         (=>
                          tmp%4
                          (=>
                           (= tmp%5 (vstd!arithmetic.power2.pow2.? (I km1@)))
                           (and
                            (=>
                             %%location_label%%10
                             (req%curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.lemma_coprime_div_cancel.
