...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:89:1: 89:35 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_field_inv_one
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:89:1: 89:35 (#0)
...
(push)
 ...
 (assert
  (not (=>
    ...
    (=>
     (= inv@ (curve25519_dalek!specs.field_specs.field_inv.? (I 1)))
     (and
      (=>
           ...
           (=>
            ...
            (and
             (and
              ...
              (= (EucMod (nClip (Mul (EucMod 1 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                  inv@
                 )
                ) (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
               ) 1
             ))
             (< inv@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
      )))))))
      (=>
       (and
        (and
       ...
       (and
        (=>
         ...
         (and
          (=>
           %%location_label%%3
           (req%vstd!arithmetic.div_mod.lemma_small_mod. inv@ tmp%2)
          )
          (=>
           (ens%vstd!arithmetic.div_mod.lemma_small_mod. inv@ tmp%2)
           (=>
            %%location_label%%4
            (= inv@ 1)
        ))))
