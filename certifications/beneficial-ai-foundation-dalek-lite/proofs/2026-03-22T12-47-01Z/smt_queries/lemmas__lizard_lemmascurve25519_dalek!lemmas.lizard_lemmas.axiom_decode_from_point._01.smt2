...
;; curve25519-dalek/src/lemmas/lizard_lemmas.rs:1295:1: 1298:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::lizard_lemmas::axiom_decode_from_point
;; curve25519-dalek/src/lemmas/lizard_lemmas.rs:1295:1: 1298:2 (#0)
(get-info :all-statistics)
(push)
 (declare-const point! curve25519_dalek!edwards.EdwardsPoint.)
 (declare-const passed_data! core!option.Option.)
 (assert
  fuel_defaults
 )
 (assert
 ...
 (assert
  (has_type (Poly%core!option.Option. passed_data!) (TYPE%core!option.Option. $ (TYPE%vstd!seq.Seq.
     $ (UINT 8)
 ))))
 (assert
  (curve25519_dalek!specs.edwards_specs.is_well_formed_edwards_point.? (Poly%curve25519_dalek!edwards.EdwardsPoint.
