...
;; MODULE 'module lemmas::field_lemmas::from_bytes_lemmas'
;; curve25519-dalek/src/lemmas/field_lemmas/from_bytes_lemmas.rs:685:1: 685:55 (#0)
...
(assert
 (distinct fuel%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. fuel%vstd!arithmetic.mul.lemma_mul_basics_3.
  ...
  fuel%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.pow2_sum_u8. fuel%curve25519_dalek!specs.core_specs.u8_32_as_nat.
...
(assert
 (=>
  ...
  (forall ((x! Int)) (!
    (= (Mul x! 1) x!)
    :pattern ((Mul x! 1))
    :qid user_vstd__arithmetic__mul__lemma_mul_basics_3_20
    :skolemid skolem_user_vstd__arithmetic__mul__lemma_mul_basics_3_20
))))
...
;; Function-Specs curve25519_dalek::lemmas::common_lemmas::mul_lemmas::lemma_nat_distributive
(declare-fun ens%curve25519_dalek!lemmas.common_lemmas.mul_lemmas.lemma_nat_distributive.
 (Int Int Int) Bool
)
(assert
 (forall ((x! Int) (y! Int) (z! Int)) (!
   (= (ens%curve25519_dalek!lemmas.common_lemmas.mul_lemmas.lemma_nat_distributive. x!
     y! z!
    ) (= (nClip (Mul (nClip (Add y! z!)) x!)) (nClip (Add (nClip (Mul y! x!)) (nClip (Mul
         z! x!
   ))))))
   :pattern ((ens%curve25519_dalek!lemmas.common_lemmas.mul_lemmas.lemma_nat_distributive.
     x! y! z!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.common_lemmas.mul_lemmas.lemma_nat_distributive._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.common_lemmas.mul_lemmas.lemma_nat_distributive._definition
)))

;; Function-Specs curve25519_dalek::lemmas::field_lemmas::from_bytes_lemmas::lemma_assemble_mod_div
(declare-fun ens%curve25519_dalek!lemmas.field_lemmas.from_bytes_lemmas.lemma_assemble_mod_div.
 (Int Int Int) Bool
)
(assert
 (forall ((a! Int) (d! Int) (b! Int)) (!
   (= (ens%curve25519_dalek!lemmas.field_lemmas.from_bytes_lemmas.lemma_assemble_mod_div.
     a! d! b!
    ) (= (nClip (Add (nClip (Mul (EucMod a! (vstd!arithmetic.power2.pow2.? (I d!))) (vstd!arithmetic.power2.pow2.?
          (I b!)
        ))
       ) (nClip (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Add b! d!)))) (EucDiv a! (vstd!arithmetic.power2.pow2.?
           (I d!)
      )))))
     ) (nClip (Mul a! (vstd!arithmetic.power2.pow2.? (I b!))))
   ))
   :pattern ((ens%curve25519_dalek!lemmas.field_lemmas.from_bytes_lemmas.lemma_assemble_mod_div.
     a! d! b!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.field_lemmas.from_bytes_lemmas.lemma_assemble_mod_div._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.field_lemmas.from_bytes_lemmas.lemma_assemble_mod_div._definition
)))

;; Function-Specs curve25519_dalek::lemmas::field_lemmas::from_bytes_lemmas::lemma_assemble_pow_a_pow
(declare-fun req%curve25519_dalek!lemmas.field_lemmas.from_bytes_lemmas.lemma_assemble_pow_a_pow.
 (Int Int Int Int) Bool
)
(declare-const %%global_location_label%%12 Bool)
(assert
 (forall ((a! Int) (j! Int) (k! Int) (l! Int)) (!
   (= (req%curve25519_dalek!lemmas.field_lemmas.from_bytes_lemmas.lemma_assemble_pow_a_pow.
     a! j! k! l!
    ) (=>
     %%global_location_label%%12
     (> (nClip (Mul k! 8)) l!)
   ))
   :pattern ((req%curve25519_dalek!lemmas.field_lemmas.from_bytes_lemmas.lemma_assemble_pow_a_pow.
     a! j! k! l!
   ))
   :qid internal_req__curve25519_dalek!lemmas.field_lemmas.from_bytes_lemmas.lemma_assemble_pow_a_pow._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.field_lemmas.from_bytes_lemmas.lemma_assemble_pow_a_pow._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.field_lemmas.from_bytes_lemmas.lemma_assemble_pow_a_pow.
 (Int Int Int Int) Bool
)
(assert
 (forall ((a! Int) (j! Int) (k! Int) (l! Int)) (!
   (= (ens%curve25519_dalek!lemmas.field_lemmas.from_bytes_lemmas.lemma_assemble_pow_a_pow.
     a! j! k! l!
    ) (= (nClip (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Add (nClip (Mul j! 8)) l!))))
       (nClip (Mul a! (vstd!arithmetic.power2.pow2.? (I (nClip (Sub (nClip (Mul k! 8)) l!))))))
      )
     ) (nClip (Mul a! (vstd!arithmetic.power2.pow2.? (I (nClip (Mul (nClip (Add j! k!)) 8))))))
   ))
   :pattern ((ens%curve25519_dalek!lemmas.field_lemmas.from_bytes_lemmas.lemma_assemble_pow_a_pow.
     a! j! k! l!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.field_lemmas.from_bytes_lemmas.lemma_assemble_pow_a_pow._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.field_lemmas.from_bytes_lemmas.lemma_assemble_pow_a_pow._definition
)))

;; Function-Specs curve25519_dalek::lemmas::field_lemmas::from_bytes_lemmas::lemma_from_u8_32_as_nat_01
(declare-fun ens%curve25519_dalek!lemmas.field_lemmas.from_bytes_lemmas.lemma_from_u8_32_as_nat_01.
 (%%Function%%) Bool
)
(assert
 (forall ((bytes! %%Function%%)) (!
   (= (ens%curve25519_dalek!lemmas.field_lemmas.from_bytes_lemmas.lemma_from_u8_32_as_nat_01.
     bytes!
    ) (= (Add (uClip 64 (bitand (I (uClip 64 (curve25519_dalek!specs.core_specs.spec_load8_at.?
           (vstd!array.spec_array_as_slice.? $ (UINT 8) $ (CONST_INT 32) (Poly%array%. bytes!))
           (I 0)
         ))
        ) (I curve25519_dalek!specs.field_specs_u64.mask51.?)
       )
      ) (Mul (vstd!arithmetic.power2.pow2.? (I 51)) (uClip 64 (bitand (I (uClip 64 (bitshr (I
             (uClip 64 (curve25519_dalek!specs.core_specs.spec_load8_at.? (vstd!array.spec_array_as_slice.?
     ...
     ) (Add (Add (Add (Add (Add (Add (Add (Add (Add (Add (Add (Add (Mul (%I (vstd!seq.Seq.index.? $ (
                     UINT 8
   ...
   :pattern ((ens%curve25519_dalek!lemmas.field_lemmas.from_bytes_lemmas.lemma_from_u8_32_as_nat_01.
     bytes!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.field_lemmas.from_bytes_lemmas.lemma_from_u8_32_as_nat_01._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.field_lemmas.from_bytes_lemmas.lemma_from_u8_32_as_nat_01._definition
)))
...
;; Function-Specs curve25519_dalek::lemmas::field_lemmas::from_bytes_lemmas::lemma_from_u8_32_as_nat_012
(declare-fun ens%curve25519_dalek!lemmas.field_lemmas.from_bytes_lemmas.lemma_from_u8_32_as_nat_012.
 (%%Function%%) Bool
)
(assert
 (forall ((bytes! %%Function%%)) (!
   (= (ens%curve25519_dalek!lemmas.field_lemmas.from_bytes_lemmas.lemma_from_u8_32_as_nat_012.
     bytes!
    ) (= (Add (Add (uClip 64 (bitand (I (uClip 64 (curve25519_dalek!specs.core_specs.spec_load8_at.?
            (vstd!array.spec_array_as_slice.? $ (UINT 8) $ (CONST_INT 32) (Poly%array%. bytes!))
            (I 0)
          ))
         ) (I curve25519_dalek!specs.field_specs_u64.mask51.?)
      ...
      ) (Mul (vstd!arithmetic.power2.pow2.? (I 102)) (uClip 64 (bitand (I (uClip 64 (bitshr (
             I (uClip 64 (curve25519_dalek!specs.core_specs.spec_load8_at.? (vstd!array.spec_array_as_slice.?
                $ (UINT 8) $ (CONST_INT 32) (Poly%array%. bytes!)
               ) (I 12)
             ))
            ) (I 6)
     ...
     ) (Add (Add (Add (Add (Add (Add (Add (Add (Add (Add (Add (Add (Add (Add (Add (Add (Add (Add (Add (Mul
   ...
   :pattern ((ens%curve25519_dalek!lemmas.field_lemmas.from_bytes_lemmas.lemma_from_u8_32_as_nat_012.
     bytes!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.field_lemmas.from_bytes_lemmas.lemma_from_u8_32_as_nat_012._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.field_lemmas.from_bytes_lemmas.lemma_from_u8_32_as_nat_012._definition
)))
...
;; Function-Specs curve25519_dalek::lemmas::field_lemmas::from_bytes_lemmas::lemma_from_u8_32_as_nat_0123
(declare-fun ens%curve25519_dalek!lemmas.field_lemmas.from_bytes_lemmas.lemma_from_u8_32_as_nat_0123.
 (%%Function%%) Bool
)
(assert
 (forall ((bytes! %%Function%%)) (!
   (= (ens%curve25519_dalek!lemmas.field_lemmas.from_bytes_lemmas.lemma_from_u8_32_as_nat_0123.
     bytes!
    ) (= (Add (Add (Add (uClip 64 (bitand (I (uClip 64 (curve25519_dalek!specs.core_specs.spec_load8_at.?
             (vstd!array.spec_array_as_slice.? $ (UINT 8) $ (CONST_INT 32) (Poly%array%. bytes!))
             (I 0)
           ))
          ) (I curve25519_dalek!specs.field_specs_u64.mask51.?)
      ...
      ) (Mul (vstd!arithmetic.power2.pow2.? (I 153)) (uClip 64 (bitand (I (uClip 64 (bitshr (
             I (uClip 64 (curve25519_dalek!specs.core_specs.spec_load8_at.? (vstd!array.spec_array_as_slice.?
                $ (UINT 8) $ (CONST_INT 32) (Poly%array%. bytes!)
               ) (I 19)
             ))
                         ...
                         (Add (Add (Add (Add (Add (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.?
   ...
   :pattern ((ens%curve25519_dalek!lemmas.field_lemmas.from_bytes_lemmas.lemma_from_u8_32_as_nat_0123.
     bytes!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.field_lemmas.from_bytes_lemmas.lemma_from_u8_32_as_nat_0123._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.field_lemmas.from_bytes_lemmas.lemma_from_u8_32_as_nat_0123._definition
)))
...
;; Function-Specs curve25519_dalek::lemmas::field_lemmas::from_bytes_lemmas::lemma_from_u8_32_as_nat_01234
(declare-fun ens%curve25519_dalek!lemmas.field_lemmas.from_bytes_lemmas.lemma_from_u8_32_as_nat_01234.
 (%%Function%%) Bool
)
(assert
 (forall ((bytes! %%Function%%)) (!
   (= (ens%curve25519_dalek!lemmas.field_lemmas.from_bytes_lemmas.lemma_from_u8_32_as_nat_01234.
     bytes!
    ) (= (Add (Add (Add (Add (uClip 64 (bitand (I (uClip 64 (curve25519_dalek!specs.core_specs.spec_load8_at.?
              (vstd!array.spec_array_as_slice.? $ (UINT 8) $ (CONST_INT 32) (Poly%array%. bytes!))
              (I 0)
            ))
           ) (I curve25519_dalek!specs.field_specs_u64.mask51.?)
      ...
      ) (Mul (vstd!arithmetic.power2.pow2.? (I 204)) (uClip 64 (bitand (I (uClip 64 (bitshr (
             I (uClip 64 (curve25519_dalek!specs.core_specs.spec_load8_at.? (vstd!array.spec_array_as_slice.?
                $ (UINT 8) $ (CONST_INT 32) (Poly%array%. bytes!)
               ) (I 24)
             ))
   ...
   :pattern ((ens%curve25519_dalek!lemmas.field_lemmas.from_bytes_lemmas.lemma_from_u8_32_as_nat_01234.
     bytes!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.field_lemmas.from_bytes_lemmas.lemma_from_u8_32_as_nat_01234._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.field_lemmas.from_bytes_lemmas.lemma_from_u8_32_as_nat_01234._definition
)))
   ...
   (= (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u8_bounds.
     ...
     (=>
      ...
      (forall ((i$ Int)) (!
        ...
        :qid user_curve25519_dalek__lemmas__common_lemmas__pow_lemmas__lemma_pow2_sum_u8_bounds_60
        :skolemid skolem_user_curve25519_dalek__lemmas__common_lemmas__pow_lemmas__lemma_pow2_sum_u8_bounds_60
   )))))
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::from_bytes_lemmas::lemma_as_nat_32_mod_255
;; curve25519-dalek/src/lemmas/field_lemmas/from_bytes_lemmas.rs:685:1: 685:55 (#0)
 ...
 (assert
  (not (and
     ...
     (=>
      ...
      (and
       (=>
        ...
        (=>
         (ens%vstd!arithmetic.mul.lemma_mul_basics_3. tmp%1)
         (=>
          %%location_label%%1
       ...
       (=>
        ...
        (=>
         (fuel_bool fuel%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.pow2_sum_u8.)
         (=>
          (exists ((fuel% Fuel)) (= fuel_nat%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.pow2_sum_u8.
            (succ (succ (succ (succ (succ (succ (succ (succ (succ (succ (succ (succ (succ (succ (succ (succ (
                             succ (succ (succ (succ (succ (succ (succ (succ (succ (succ (succ (succ (succ (succ fuel%)))))))))))))
          )))))))))))))))))))
          (=>
           %%location_label%%2
           (let
            ((tmp%%$ (Add (Add (Add (Add (Add (Add (Add (Add (Add (Add (Add (Add (Add (Add (Add (Add (Add (Add (Add
                                 (Add (Add (Add (Add (Add (Add (Add (Add (Add (Add (Add (Add (Mul (%I (vstd!seq.Seq.index.? $ (UINT
                                                 8
                                                ) (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT 32)) (Poly%array%. bytes!))
                                                (I 0)
                                               )
            ...
            (and
             (= (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. bytes!)) tmp%%$)
             (= tmp%%$ (Add (curve25519_dalek!lemmas.common_lemmas.pow_lemmas.pow2_sum_u8.? (vstd!array.spec_array_as_slice.?
                 $ (UINT 8) $ (CONST_INT 32) (Poly%array%. bytes!)
                ) (I 0) (I 8) (I 30)
               ) (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT 8)
                    $ (CONST_INT 32)
    ...
    (=>
     ...
     (=>
      (= tmp%2 (= (EucMod (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. bytes!))
         (vstd!arithmetic.power2.pow2.? (I 255))
        ) (EucMod (nClip (Add (curve25519_dalek!lemmas.common_lemmas.pow_lemmas.pow2_sum_u8.?
            (vstd!array.spec_array_as_slice.? $ (UINT 8) $ (CONST_INT 32) (Poly%array%. bytes!))
            (I 0) (I 8) (I 30)
           ) (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT 8)
                $ (CONST_INT 32)
        ...
        (and
         (and
          (and
           (=>
            ...
            (=>
             ...
             (=>
              ...
              (=>
               (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_u8_lt_pow2_8. tmp%3)
               (=>
                %%location_label%%4
                (< (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (
                      CONST_INT 32
           ...
           (=>
            (forall ((i$ Poly)) (!
              ...
              :qid user_curve25519_dalek__lemmas__field_lemmas__from_bytes_lemmas__lemma_as_nat_32_mod_255_64
              :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__from_bytes_lemmas__lemma_as_nat_32_mod_255_64
            ))
            (=>
             (= tmp%4 (%Poly%slice%<u8.>. (vstd!array.spec_array_as_slice.? $ (UINT 8) $ (CONST_INT
                 32
                ) (Poly%array%. bytes!)
             )))
             (and
              (=>
               %%location_label%%5
               (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u8_bounds. tmp%4
                0 8 30
              ))
              (=>
               (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u8_bounds. tmp%4
                0 8 30
               )
               (=>
                %%location_label%%6
                (< (curve25519_dalek!lemmas.common_lemmas.pow_lemmas.pow2_sum_u8.? (vstd!array.spec_array_as_slice.?
                   $ (UINT 8) $ (CONST_INT 32) (Poly%array%. bytes!)
                  ) (I 0) (I 8) (I 30)
                 ) (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 31 8))))
          )))))))
          (=>
           ...
           (and
            (=>
             (= tmp%5 (curve25519_dalek!lemmas.common_lemmas.pow_lemmas.pow2_sum_u8.? (vstd!array.spec_array_as_slice.?
                $ (UINT 8) $ (CONST_INT 32) (Poly%array%. bytes!)
               ) (I 0) (I 8) (I 30)
             ))
             (=>
              (= tmp%6 (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT 8)
                   $ (CONST_INT 32)
                  ) (Poly%array%. bytes!)
                 ) (I 31)
              )))
              (=>
               (= tmp%7 (nClip (Mul 31 8)))
               (and
                (=>
                 %%location_label%%7
                 (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_binary_sum_mod_decomposition.
                  tmp%5 tmp%6 tmp%7 255
                ))
                (=>
                 (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_binary_sum_mod_decomposition.
                  tmp%5 tmp%6 tmp%7 255
                 ...
                 (=>
                  ...
                  (= (EucMod (nClip (Add (curve25519_dalek!lemmas.common_lemmas.pow_lemmas.pow2_sum_u8.?
                   ...
                   ) (nClip (Add (EucMod (curve25519_dalek!lemmas.common_lemmas.pow_lemmas.pow2_sum_u8.?
                       (vstd!array.spec_array_as_slice.? $ (UINT 8) $ (CONST_INT 32) (Poly%array%. bytes!))
                       (I 0) (I 8) (I 30)
                      ) (vstd!arithmetic.power2.pow2.? (I 255))
                     ) (EucMod (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY
                            $ (UINT 8) $ (CONST_INT 32)
                           ) (Poly%array%. bytes!)
                          ) (I 31)
                         )
            ...
            (=>
             ...
             (and
              (and
               (=>
                (= tmp%8 (nClip (Mul 31 8)))
                (and
                 (=>
                  %%location_label%%9
                  (req%vstd!arithmetic.power2.lemma_pow2_strictly_increases. tmp%8 255)
                 )
                 (=>
                  (ens%vstd!arithmetic.power2.lemma_pow2_strictly_increases. tmp%8 255)
                  (=>
                   %%location_label%%10
                   (< (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 31 8)))) (vstd!arithmetic.power2.pow2.?
                     (I 255)
               ))))))
               (=>
                (< (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 31 8)))) (vstd!arithmetic.power2.pow2.?
                ...
                (=>
                 (= tmp%9 (curve25519_dalek!lemmas.common_lemmas.pow_lemmas.pow2_sum_u8.? (vstd!array.spec_array_as_slice.?
                    $ (UINT 8) $ (CONST_INT 32) (Poly%array%. bytes!)
                   ) (I 0) (I 8) (I 30)
                 ))
                 (=>
                  (= tmp%10 (vstd!arithmetic.power2.pow2.? (I 255)))
                  (and
                   (=>
                    %%location_label%%11
                   ...
                   (=>
                    ...
                    (=>
                     %%location_label%%12
                     (= (EucMod (curve25519_dalek!lemmas.common_lemmas.pow_lemmas.pow2_sum_u8.? (vstd!array.spec_array_as_slice.?
                         $ (UINT 8) $ (CONST_INT 32) (Poly%array%. bytes!)
                        ) (I 0) (I 8) (I 30)
                       ) (vstd!arithmetic.power2.pow2.? (I 255))
                      ) (curve25519_dalek!lemmas.common_lemmas.pow_lemmas.pow2_sum_u8.? (vstd!array.spec_array_as_slice.?
              ...
              (=>
               ...
               (=>
                ...
                (= (EucMod (nClip (Add (curve25519_dalek!lemmas.common_lemmas.pow_lemmas.pow2_sum_u8.?
                 ...
                 ) (nClip (Add (curve25519_dalek!lemmas.common_lemmas.pow_lemmas.pow2_sum_u8.? (vstd!array.spec_array_as_slice.?
                     $ (UINT 8) $ (CONST_INT 32) (Poly%array%. bytes!)
                    ) (I 0) (I 8) (I 30)
                   ) (EucMod (nClip (Mul (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY
                          $ (UINT 8) $ (CONST_INT 32)
         ...
         (=>
          ...
          (and
           (=>
            ...
            (=>
             (= tmp%12 (nClip (Mul 31 8)))
             (and
              (=>
               %%location_label%%14
               (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_mul_mod. tmp%11 tmp%12
                255
              ))
              (=>
               (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_mul_mod. tmp%11 tmp%12
                255
               )
               (=>
                %%location_label%%15
