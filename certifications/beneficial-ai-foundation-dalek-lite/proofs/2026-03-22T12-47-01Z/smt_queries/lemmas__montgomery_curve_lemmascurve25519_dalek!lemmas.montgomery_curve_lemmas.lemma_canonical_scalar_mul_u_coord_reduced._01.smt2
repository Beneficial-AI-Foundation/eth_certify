...
;; curve25519-dalek/src/lemmas/montgomery_curve_lemmas.rs:658:1: 658:73 (#0)
...
;; Function-Def curve25519_dalek::lemmas::montgomery_curve_lemmas::lemma_canonical_scalar_mul_u_coord_reduced
;; curve25519-dalek/src/lemmas/montgomery_curve_lemmas.rs:658:1: 658:73 (#0)
       ...
       (or
        (and
         (=>
          (= n! 0)
          (=>
           (= tmp%1 (= R@ curve25519_dalek!specs.montgomery_specs.MontgomeryAffine./Infinity))
           (and
            (=>
             %%location_label%%0
             tmp%1
            ...
            (and
             ...
             (and
              ...
              (=>
               ...
               (=>
                (= tmp%4 (< (curve25519_dalek!specs.montgomery_specs.u_coordinate.? (Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.
                    R_prev@
                   )
                  ) (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
                ))
