...
;; MODULE 'module specs::primality_specs'
;; curve25519-dalek/src/specs/primality_specs.rs:40:1: 40:42 (#0)
...
(assert
 (distinct fuel%curve25519_dalek!specs.field_specs_u64.p. fuel%curve25519_dalek!specs.primality_specs.is_prime.
  ...
  (forall ((n! Poly)) (!
    (= (curve25519_dalek!specs.primality_specs.is_prime.? n!) (and
      ...
      (forall ((d$ Int)) (!
        ...
        :qid user_curve25519_dalek__specs__primality_specs__is_prime_0
        :skolemid skolem_user_curve25519_dalek__specs__primality_specs__is_prime_0
    ))))
...
;; Function-Specs curve25519_dalek::specs::primality_specs::axiom_group_order_is_prime
(declare-fun ens%curve25519_dalek!specs.primality_specs.axiom_group_order_is_prime.
 (Int) Bool
)
(assert
 (forall ((no%param Int)) (!
   (= (ens%curve25519_dalek!specs.primality_specs.axiom_group_order_is_prime. no%param)
    (curve25519_dalek!specs.primality_specs.is_prime.? (I (curve25519_dalek!specs.scalar52_specs.group_order.?
       (I 0)
   ))))
   :pattern ((ens%curve25519_dalek!specs.primality_specs.axiom_group_order_is_prime. no%param))
   :qid internal_ens__curve25519_dalek!specs.primality_specs.axiom_group_order_is_prime._definition
   :skolemid skolem_internal_ens__curve25519_dalek!specs.primality_specs.axiom_group_order_is_prime._definition
)))

;; Function-Def curve25519_dalek::specs::primality_specs::axiom_group_order_is_prime
;; curve25519-dalek/src/specs/primality_specs.rs:40:1: 40:42 (#0)
