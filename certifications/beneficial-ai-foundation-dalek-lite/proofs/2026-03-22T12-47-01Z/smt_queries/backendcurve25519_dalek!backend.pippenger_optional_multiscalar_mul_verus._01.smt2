...
;; curve25519-dalek/src/backend/mod.rs:382:1: 387:54 (#0)
...
;; Function-Def curve25519_dalek::backend::pippenger_optional_multiscalar_mul_verus
;; curve25519-dalek/src/backend/mod.rs:382:1: 387:54 (#0)
...
(push)
 ...
 (assert
  (and
   (= $ (proj%%core!iter.traits.iterator.Iterator./Item J&. J&))
   (= (TYPE%core!option.Option. $ TYPE%curve25519_dalek!edwards.EdwardsPoint.) (proj%core!iter.traits.iterator.Iterator./Item
     J&. J&
 ))))
 (assert
 ...
 (assert
  (forall ((i$ Poly)) (!
    ...
    :qid user_curve25519_dalek__backend__pippenger_optional_multiscalar_mul_verus_48
    :skolemid skolem_user_curve25519_dalek__backend__pippenger_optional_multiscalar_mul_verus_48
 )))
 ...
 (assert
  (not (=>
    ...
    (and
     ...
     (=>
      (ens%curve25519_dalek!backend.serial.scalar_mul.pippenger.impl&%1.optional_multiscalar_mul_verus.
       S&. S& I&. I& J&. J& scalars! points! tmp%1
      )
      (=>
       (= result! tmp%1)
       (and
          ...
          (=>
           ...
           (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_point_as_affine.?
              (core!option.Option./Some/0 $ TYPE%curve25519_dalek!edwards.EdwardsPoint. (%Poly%core!option.Option.
                (Poly%core!option.Option. result!)
             )))
