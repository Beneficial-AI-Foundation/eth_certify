...
;; curve25519-dalek/src/lemmas/montgomery_curve_lemmas.rs:931:7: 931:55 (#0)
...
;; Function-Def curve25519_dalek::lemmas::montgomery_curve_lemmas::lemma_eps_when_d_is_minus_one
;; curve25519-dalek/src/lemmas/montgomery_curve_lemmas.rs:931:7: 931:55 (#0)
...
(push)
 ...
 (declare-const val_486661@ Int)
 (declare-const inner@ Int)
 (declare-const val_486660@ Int)
  ...
  (not (=>
    ...
    (=>
     ...
     (and
      (=>
       %%location_label%%0
       (req%curve25519_dalek!lemmas.montgomery_curve_lemmas.lemma_p_gt_small. 486662)
      )
      (=>
       (ens%curve25519_dalek!lemmas.montgomery_curve_lemmas.lemma_p_gt_small. 486662)
       (and
        (and
         (=>
          %%location_label%%1
         ...
         (=>
          ...
          (and
           ...
           (=>
            ...
            (=>
             %%location_label%%3
             (= d! (curve25519_dalek!specs.field_specs.field_neg.? (I 1)))
        )))))
        (=>
         (= d! (curve25519_dalek!specs.field_specs.field_neg.? (I 1)))
         (=>
           ...
           (=>
            ...
            (and
             ...
             (=>
              (ens%vstd!arithmetic.div_mod.lemma_small_mod. 1 pp@)
              (=>
               (= tmp%1 (= (curve25519_dalek!specs.field_specs.field_square.? (I d!)) (curve25519_dalek!specs.field_specs.field_square.?
                  (I (EucMod 1 pp@))
               )))
               (and
                (=>
                ...
                (=>
                 tmp%1
                 (=>
                  (= tmp%2 (= (curve25519_dalek!specs.field_specs.field_square.? (I 1)) (EucMod (nClip
                      (Mul 1 1)
                     ) pp@
                  )))
                  (and
            ...
            (=>
             ...
             (and
              (=>
               ...
               (=>
                (= tmp%3 (= (curve25519_dalek!specs.field_specs.field_mul.? (I A!) (I (curve25519_dalek!specs.field_specs.field_neg.?
                     (I 1)
                   ))
                  ) (curve25519_dalek!specs.field_specs.field_neg.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                     (I A!) (I 1)
                  ...
                  (=>
                   ...
                   (and
                    ...
                    (=>
                     ...
                     (=>
                      %%location_label%%11
                      (= A_d@ (curve25519_dalek!specs.field_specs.field_neg.? (I A!)))
              ))))))))
              (=>
               (= A_d@ (curve25519_dalek!specs.field_specs.field_neg.? (I A!)))
               (=>
                (= sum1@ (curve25519_dalek!specs.field_specs.field_add.? (I d_sq@) (I A_d@)))
                (and
                 (=>
                  (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_sub_eq_add_neg.
                   1 A!
                  ...
                  (=>
                   %%location_label%%12
                   (= sum1@ (curve25519_dalek!specs.field_specs.field_sub.? (I 1) (I A!)))
                 ))
                 (=>
                  (= sum1@ (curve25519_dalek!specs.field_specs.field_sub.? (I 1) (I A!)))
                  (=>
                   (= val_486661@ (nClip (Sub pp@ 486661)))
                   (and
                    (and
                     (=>
                      %%location_label%%13
                        ...
                        (and
                         ...
                         (=>
                          ...
                          (and
                           (=>
                            %%location_label%%16
                            (req%vstd!arithmetic.div_mod.lemma_small_mod. val_486661@ pp@)
                           )
                           (=>
                            (ens%vstd!arithmetic.div_mod.lemma_small_mod. val_486661@ pp@)
                            (=>
                             %%location_label%%17
                             (= sum1@ val_486661@)
                    )))))))))
                    (=>
                     (= sum1@ val_486661@)
                     (=>
                      (= inner@ (curve25519_dalek!specs.field_specs.field_add.? (I sum1@) (I 1)))
                      (=>
                       (= val_486660@ (nClip (Sub pp@ 486660)))
                       (and
                        (and
                         (=>
                          %%location_label%%18
                         ...
                         (=>
                          ...
                          (and
                           (=>
                            %%location_label%%19
                            (req%vstd!arithmetic.div_mod.lemma_small_mod. val_486660@ pp@)
                           )
                           (=>
                            (ens%vstd!arithmetic.div_mod.lemma_small_mod. val_486660@ pp@)
                            (=>
                             %%location_label%%20
                             (= inner@ val_486660@)
                        )))))
                              ...
                              (and
                               ...
                               (=>
                                ...
                                (and
                                 (=>
                                  %%location_label%%23
                                  (req%vstd!arithmetic.div_mod.lemma_small_mod. 486660 pp@)
                                 )
                                 (=>
                                  (ens%vstd!arithmetic.div_mod.lemma_small_mod. 486660 pp@)
                                  (=>
                                   %%location_label%%24
                                   (= eps@ 486660)
                           ))))))))
