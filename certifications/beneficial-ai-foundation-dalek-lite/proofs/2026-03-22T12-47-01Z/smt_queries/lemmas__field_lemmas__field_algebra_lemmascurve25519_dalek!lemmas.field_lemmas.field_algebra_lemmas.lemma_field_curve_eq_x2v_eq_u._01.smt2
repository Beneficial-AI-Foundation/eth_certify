...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:1496:1: 1496:67 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_field_curve_eq_x2v_eq_u
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:1496:1: 1496:67 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= pp@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
    (=>
     (= pn@ pp@)
     (=>
      ...
      (=>
       ...
       (=>
        ...
        (=>
         ...
         (=>
          (= dy2@ (curve25519_dalek!specs.field_specs.field_mul.? (I d!) (I y2@)))
          (=>
           (= dx2y2@ (curve25519_dalek!specs.field_specs.field_mul.? (I d!) (I x2y2@)))
           (=>
            (= v@ (curve25519_dalek!specs.field_specs.field_add.? (I dy2@) (I 1)))
            (=>
             (= u@ (curve25519_dalek!specs.field_specs.field_sub.? (I y2@) (I 1)))
             (=>
              (= tmp%1 (= (curve25519_dalek!specs.field_specs.field_sub.? (I y2@) (I x2@)) (curve25519_dalek!specs.field_specs.field_add.?
                 (I 1) (I dx2y2@)
              )))
              (and
               (=>
                ...
                (and
                 (=>
                  ...
                  (and
                   (=>
                    %%location_label%%1
                    (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%2 pn@)
                   )
                   (=>
                    (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%2 pn@)
                    (=>
                     %%location_label%%2
                     (< x2@ pp@)
                 ))))
                  ...
                  (and
                   (=>
                    ...
                    (and
                     (=>
                      %%location_label%%3
                      (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%3 pn@)
                     )
                     (=>
                      (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%3 pn@)
                      (=>
                       %%location_label%%4
                       (< y2@ pp@)
                   ))))
                   (=>
                    ...
                    (and
                     (=>
                      (= tmp%4 (nClip (Mul d! x2y2@)))
                      (and
                       (=>
                        %%location_label%%5
                        (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%4 pn@)
                       )
                       (=>
                        (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%4 pn@)
                        (=>
                         %%location_label%%6
                         (< dx2y2@ pp@)
                     ))))
                       ...
                       (=>
                        ...
                        (=>
                         ...
                         (=>
                          ...
                          (=>
                           %%location_label%%7
                           (= (curve25519_dalek!specs.field_specs.field_mul.? (I d!) (I x2y2@)) (curve25519_dalek!specs.field_specs.field_mul.?
                             (I x2@) (I dy2@)
                       ))))))
                       (=>
                        (= (curve25519_dalek!specs.field_specs.field_mul.? (I d!) (I x2y2@)) (curve25519_dalek!specs.field_specs.field_mul.?
                        ...
                        (and
                         (=>
                          ...
                          (=>
                           %%location_label%%8
                           (= (curve25519_dalek!specs.field_specs.field_mul.? (I x2@) (I v@)) (curve25519_dalek!specs.field_specs.field_add.?
                             (I (curve25519_dalek!specs.field_specs.field_mul.? (I x2@) (I dy2@))) (I (curve25519_dalek!specs.field_specs.field_mul.?
                               (I x2@) (I 1)
                         ))))))
                         (=>
                          (= (curve25519_dalek!specs.field_specs.field_mul.? (I x2@) (I v@)) (curve25519_dalek!specs.field_specs.field_add.?
                          ...
                          (and
                           (=>
                            ...
                            (and
                             (=>
                              %%location_label%%9
                              (req%vstd!arithmetic.div_mod.lemma_small_mod. x2@ pp@)
                             )
                             (=>
                              (ens%vstd!arithmetic.div_mod.lemma_small_mod. x2@ pp@)
                              (=>
                               %%location_label%%10
                             ...
                             (=>
                              ...
                              (and
                               (and
                                (=>
                                 %%location_label%%13
                                 (req%vstd!arithmetic.div_mod.lemma_small_mod. y2@ pp@)
                                )
                                (=>
                                 (ens%vstd!arithmetic.div_mod.lemma_small_mod. y2@ pp@)
                                 (and
                                  (=>
                                   %%location_label%%14
                                   (req%vstd!arithmetic.div_mod.lemma_small_mod. 1 pp@)
                                  )
                                  (=>
                                   (ens%vstd!arithmetic.div_mod.lemma_small_mod. 1 pp@)
                                   (=>
                                    (= tmp%5 (Sub y2@ 1))
                                    (and
                                     (=>
                                      %%location_label%%15
                                      (req%vstd!arithmetic.div_mod.lemma_mod_add_multiples_vanish. tmp%5 pn@)
                                     )
                                     (=>
                                      (ens%vstd!arithmetic.div_mod.lemma_mod_add_multiples_vanish. tmp%5 pn@)
                                      (=>
                                       (= tmp%6 (Add 1 dx2y2@))
                                       (and
                                        (=>
                                         %%location_label%%16
                                         (req%vstd!arithmetic.div_mod.lemma_add_mod_noop. tmp%6 x2@ pn@)
                                        )
                                        (=>
                                         (ens%vstd!arithmetic.div_mod.lemma_add_mod_noop. tmp%6 x2@ pn@)
                                         (=>
                                          (= tmp%7 (EucMod (Add 1 dx2y2@) pn@))
                                          (and
                                           (=>
                                            %%location_label%%17
                                            (req%vstd!arithmetic.div_mod.lemma_add_mod_noop. tmp%7 x2@ pn@)
                                           )
                                           (=>
                                            (ens%vstd!arithmetic.div_mod.lemma_add_mod_noop. tmp%7 x2@ pn@)
                                            (=>
                                             (= tmp%8 (Add (Add 1 dx2y2@) x2@))
                                             (and
                                              (=>
                                               %%location_label%%18
                                               (req%vstd!arithmetic.div_mod.lemma_sub_mod_noop. tmp%8 1 pn@)
                                              )
                                              (=>
                                               (ens%vstd!arithmetic.div_mod.lemma_sub_mod_noop. tmp%8 1 pn@)
                                               (=>
                                                (= tmp%9 (= (Sub (Add (Add 1 dx2y2@) x2@) 1) (Add dx2y2@ x2@)))
                                                (and
                                                 (=>
                                                  %%location_label%%19
                                                  tmp%9
                                                 ...
                                                 (=>
                                                  tmp%9
                                                  (=>
                                                   (= tmp%10 (Sub (Add y2@ pn@) 1))
                                                   (and
                                                    (=>
                                                     %%location_label%%20
                                                     (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%10 pn@)
                                                    )
                                                    (=>
                                                     (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%10 pn@)
                                                     (=>
                                                      (= tmp%11 (nClip (Add dx2y2@ x2@)))
                                                      (and
                                                       (=>
                                                        %%location_label%%21
                                                        (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%11 pn@)
                                                       )
                                                       (=>
                                                        (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%11 pn@)
                                                        (and
                                                         (=>
                                                          %%location_label%%22
                                                          (req%vstd!arithmetic.div_mod.lemma_small_mod. u@ pp@)
                                                         )
                                                         (=>
                                                          (ens%vstd!arithmetic.div_mod.lemma_small_mod. u@ pp@)
                                                          (=>
                                                           (= tmp%12 (curve25519_dalek!specs.field_specs.field_add.? (I dx2y2@) (I x2@)))
                                                           (and
                                                            (=>
                                                             %%location_label%%23
                                                             (req%vstd!arithmetic.div_mod.lemma_small_mod. tmp%12 pp@)
                                                            )
                                                            (=>
                                                             (ens%vstd!arithmetic.div_mod.lemma_small_mod. tmp%12 pp@)
                                                             (=>
                                                              %%location_label%%24
                                                              (= (curve25519_dalek!specs.field_specs.field_sub.? (I y2@) (I 1)) (curve25519_dalek!specs.field_specs.field_add.?
                                                                (I dx2y2@) (I x2@)
                               )))))))))))))))))))))))))))))))))
                               (=>
                                (= (curve25519_dalek!specs.field_specs.field_sub.? (I y2@) (I 1)) (curve25519_dalek!specs.field_specs.field_add.?
