...
;; MODULE 'module lemmas::lizard_lemmas, function curve25519_dalek::lemmas::lizard_lemmas::lemma_h_equals_spec_lizard_fe_bytes'
;; curve25519-dalek/src/lemmas/lizard_lemmas.rs:167:1: 167:76 (#0)
...
(assert
 (distinct fuel%vstd!array.array_view. fuel%vstd!array.impl&%0.view. fuel%vstd!array.impl&%2.spec_index.
  ...
  fuel%vstd!view.impl&%16.view. fuel%vstd!view.impl&%26.view. fuel%curve25519_dalek!specs.lizard_specs.spec_lizard_fe_bytes.
   ...
   (= (req%curve25519_dalek!lemmas.lizard_lemmas.lemma_h_equals_spec_lizard_fe_bytes.
     ...
     (=>
      ...
      (forall ((i$ Poly)) (!
        ...
        :qid user_curve25519_dalek__lemmas__lizard_lemmas__lemma_h_equals_spec_lizard_fe_bytes_21
        :skolemid skolem_user_curve25519_dalek__lemmas__lizard_lemmas__lemma_h_equals_spec_lizard_fe_bytes_21
     )))
     (=>
      ...
      (forall ((i$ Poly)) (!
        ...
        :qid user_curve25519_dalek__lemmas__lizard_lemmas__lemma_h_equals_spec_lizard_fe_bytes_22
        :skolemid skolem_user_curve25519_dalek__lemmas__lizard_lemmas__lemma_h_equals_spec_lizard_fe_bytes_22
     )))
     (=>
      ...
      (forall ((i$ Poly)) (!
        ...
        :qid user_curve25519_dalek__lemmas__lizard_lemmas__lemma_h_equals_spec_lizard_fe_bytes_23
        :skolemid skolem_user_curve25519_dalek__lemmas__lizard_lemmas__lemma_h_equals_spec_lizard_fe_bytes_23
     )))
     (=>
...
;; Function-Def curve25519_dalek::lemmas::lizard_lemmas::lemma_h_equals_spec_lizard_fe_bytes
;; curve25519-dalek/src/lemmas/lizard_lemmas.rs:167:1: 167:76 (#0)
...
(push)
 ...
 (assert
  (forall ((i$ Poly)) (!
    ...
    :qid user_curve25519_dalek__lemmas__lizard_lemmas__lemma_h_equals_spec_lizard_fe_bytes_24
    :skolemid skolem_user_curve25519_dalek__lemmas__lizard_lemmas__lemma_h_equals_spec_lizard_fe_bytes_24
 )))
 (assert
  (forall ((i$ Poly)) (!
    (=>
    ...
    :pattern ((vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. msg!) i$))
    :qid user_curve25519_dalek__lemmas__lizard_lemmas__lemma_h_equals_spec_lizard_fe_bytes_25
    :skolemid skolem_user_curve25519_dalek__lemmas__lizard_lemmas__lemma_h_equals_spec_lizard_fe_bytes_25
 )))
 (assert
  (forall ((i$ Poly)) (!
    (=>
    ...
    :qid user_curve25519_dalek__lemmas__lizard_lemmas__lemma_h_equals_spec_lizard_fe_bytes_26
    :skolemid skolem_user_curve25519_dalek__lemmas__lizard_lemmas__lemma_h_equals_spec_lizard_fe_bytes_26
 )))
 (assert
  (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (
        CONST_INT 32
 ...
 (assert
  (not (=>
    (ens%curve25519_dalek!core_assumes.axiom_sha256_output_length. msg!)
    (=>
     %%location_label%%0
     (ext_eq false (ARRAY $ (UINT 8) $ (CONST_INT 32)) (Poly%array%. h!) (Poly%array%. (
