...
;; curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:79:1: 79:61 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::as_bytes_lemmas::lemma_as_bytes_boundaries2
;; curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:79:1: 79:61 (#0)
    ...
    (=>
     ...
     (=>
      ...
      (=>
       ...
       (=>
        (ens%curve25519_dalek!lemmas.field_lemmas.reduce_lemmas.lemma_reduce_bound_2p. raw_limbs!)
        (and
         (=>
          %%location_label%%0
          true
            ...
            (=>
             ...
             (and
              ...
              (=>
               tmp%1
               (=>
                (= l@ (curve25519_dalek!specs.field_specs_u64.compute_unmasked_limbs.? (Poly%array%.
                   limbs@
                  ) (I q@)
                ))
                (=>
                     ...
                     (and
                      (=>
                       ...
                       (and
                        (=>
                         %%location_label%%4
                         (req%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u64_shr_le. l0@ tmp%2
                          51
                        ))
                        (=>
                         (ens%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u64_shr_le. l0@ tmp%2
                          51
                         )
                         (=>
                          %%location_label%%5
                          (<= (uClip 64 (bitshr (I l0@) (I 51))) 2)
                      ))))
                      (=>
                       (<= (uClip 64 (bitshr (I l0@) (I 51))) 2)
                       (and
                        (=>
                         (= tmp%3 (uClip 64 (Add (uClip 64 (bitshl (I 1) (I 52))) 2)))
                         (and
                          (=>
                           %%location_label%%6
                           (req%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u64_shr_le. l1@ tmp%3
                            51
                          ))
                          (=>
                           (ens%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u64_shr_le. l1@ tmp%3
                            51
                           )
                           (=>
                            %%location_label%%7
                            (<= (uClip 64 (bitshr (I l1@) (I 51))) 2)
                        ))))
                        (=>
                         (<= (uClip 64 (bitshr (I l1@) (I 51))) 2)
                         (and
                          (=>
                           ...
                           (and
                            (=>
                             %%location_label%%8
                             (req%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u64_shr_le. l2@ tmp%4
                              51
                            ))
                            (=>
                             (ens%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u64_shr_le. l2@ tmp%4
                              51
                             )
                             (=>
                              %%location_label%%9
                              (<= (uClip 64 (bitshr (I l2@) (I 51))) 2)
                          ))))
                          (=>
                           (<= (uClip 64 (bitshr (I l2@) (I 51))) 2)
                           (and
                            (=>
                             (= tmp%5 (uClip 64 (Add (uClip 64 (bitshl (I 1) (I 52))) 2)))
                             (and
                              (=>
                               %%location_label%%10
                               (req%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u64_shr_le. l3@ tmp%5
                                51
                              ))
                              (=>
                               (ens%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u64_shr_le. l3@ tmp%5
                                51
                               )
                               (=>
                                %%location_label%%11
                                (<= (uClip 64 (bitshr (I l3@) (I 51))) 2)
                            ))))
                            (=>
                             (<= (uClip 64 (bitshr (I l3@) (I 51))) 2)
                             (and
                              (=>
                               ...
                               (and
                                (=>
                                 %%location_label%%12
                                 (req%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u64_shr_le. l4@ tmp%6
                                  51
                                ))
                                (=>
                                 (ens%curve25519_dalek!lemmas.common_lemmas.shift_lemmas.lemma_u64_shr_le. l4@ tmp%6
                                  51
                                 )
                                 (=>
                                  %%location_label%%13
                                  (<= (uClip 64 (bitshr (I l4@) (I 51))) 2)
                              ))))
                              (=>
                               (<= (uClip 64 (bitshr (I l4@) (I 51))) 2)
                               (and
