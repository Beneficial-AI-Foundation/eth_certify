...
;; curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:1171:1: 1171:54 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::pow_lemmas::lemma_pow_nonnegative
;; curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:1171:1: 1171:54 (#0)
      ...
      (or
       (and
        (=>
         (= n! 0)
         (=>
          (ens%vstd!arithmetic.power.lemma_pow0. 0)
          %%switch_label%%1
        ))
        (=>
         (not (= n! 0))
         (and
          (=>
           %%location_label%%1
           (req%vstd!arithmetic.power.lemma0_pow. n!)
          )
          (=>
           (ens%vstd!arithmetic.power.lemma0_pow. n!)
           %%switch_label%%1
       ))))
       (and
        (not %%switch_label%%1)
