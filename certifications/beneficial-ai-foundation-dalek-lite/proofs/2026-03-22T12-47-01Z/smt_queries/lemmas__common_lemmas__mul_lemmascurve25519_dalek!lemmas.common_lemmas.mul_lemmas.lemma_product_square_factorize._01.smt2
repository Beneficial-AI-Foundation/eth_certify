...
;; curve25519-dalek/src/lemmas/common_lemmas/mul_lemmas.rs:248:1: 248:60 (#0)
...
;; Function-Specs curve25519_dalek::lemmas::common_lemmas::mul_lemmas::lemma_mul_quad_prod
(declare-fun ens%curve25519_dalek!lemmas.common_lemmas.mul_lemmas.lemma_mul_quad_prod.
 (Int Int Int Int) Bool
)
(assert
 (forall ((a1! Int) (b1! Int) (a2! Int) (b2! Int)) (!
   (= (ens%curve25519_dalek!lemmas.common_lemmas.mul_lemmas.lemma_mul_quad_prod. a1! b1!
     a2! b2!
    ) (= (Mul (Mul a1! b1!) (Mul a2! b2!)) (Mul (Mul a1! a2!) (Mul b1! b2!)))
   )
   :pattern ((ens%curve25519_dalek!lemmas.common_lemmas.mul_lemmas.lemma_mul_quad_prod.
     a1! b1! a2! b2!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.common_lemmas.mul_lemmas.lemma_mul_quad_prod._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.common_lemmas.mul_lemmas.lemma_mul_quad_prod._definition
)))
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::mul_lemmas::lemma_product_square_factorize
;; curve25519-dalek/src/lemmas/common_lemmas/mul_lemmas.rs:248:1: 248:60 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= tmp%1 (Mul a! b!))
    (=>
     (ens%vstd!arithmetic.mul.lemma_mul_is_associative. a! b! tmp%1)
     (=>
      (ens%vstd!arithmetic.mul.lemma_mul_is_associative. b! a! b!)
      (=>
       (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. b! a!)
       (=>
        (= tmp%2 (Mul a! b!))
        (=>
         (ens%vstd!arithmetic.mul.lemma_mul_is_associative. a! tmp%2 b!)
         (=>
          (ens%vstd!arithmetic.mul.lemma_mul_is_associative. a! a! b!)
          (=>
           (= tmp%3 (Mul a! a!))
           (=>
            (ens%vstd!arithmetic.mul.lemma_mul_is_associative. tmp%3 b! b!)
            (=>
             %%location_label%%0
             (= (Mul (Mul a! b!) (Mul a! b!)) (Mul (Mul a! a!) (Mul b! b!)))
 ))))))))))))
