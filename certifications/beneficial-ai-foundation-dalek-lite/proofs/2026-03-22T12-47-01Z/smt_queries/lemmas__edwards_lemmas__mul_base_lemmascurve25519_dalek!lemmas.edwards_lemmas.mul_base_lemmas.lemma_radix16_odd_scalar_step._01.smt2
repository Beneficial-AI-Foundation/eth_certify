...
;; curve25519-dalek/src/lemmas/edwards_lemmas/mul_base_lemmas.rs:634:1: 634:68 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::mul_base_lemmas::lemma_radix16_odd_scalar_step
;; curve25519-dalek/src/lemmas/edwards_lemmas/mul_base_lemmas.rs:634:1: 634:68 (#0)
...
(push)
 ...
 (declare-const tmp%9 vstd!seq.Seq<i8.>.)
 ...
 (declare-const nm2@ Int)
 (declare-const suf@ vstd!seq.Seq<i8.>.)
 (declare-const suf_idx@ Int)
     ...
     (and
      (=>
       ...
       (=>
        (fuel_bool fuel%curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_odd_scalar.)
        (=>
         (= tmp%1 (= (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_odd_scalar.?
           ...
           (and
            (=>
             ...
             (=>
              ...
              (=>
               %%location_label%%1
               (= (curve25519_dalek!specs.edwards_specs.pow256.? (I 0)) 1)
            )))
            (=>
             (= (curve25519_dalek!specs.edwards_specs.pow256.? (I 0)) 1)
             (=>
              (= tmp%2 (= (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_odd_scalar.?
                 (Poly%vstd!seq.Seq<i8.>. digits!) (I 1)
              ...
              (and
               ...
               (=>
                tmp%2
                (=>
                 (= tmp%3 (= (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_odd_scalar.?
                    (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I 2) (I (vstd!seq.Seq.len.?
                       $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!)
                     ))
                    ) (I 0)
                 ...
                 (and
                  ...
                  (=>
                   tmp%3
                   (=>
                    (= tmp%4 (curve25519_dalek!specs.edwards_specs.pow256.? (I 1)))
                    (=>
                     (ens%vstd!arithmetic.mul.lemma_mul_basics_2. tmp%4)
                     (=>
                      (= tmp%5 (= (Mul (curve25519_dalek!specs.edwards_specs.pow256.? (I 1)) (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_odd_scalar.?
                          (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I 2) (I (vstd!seq.Seq.len.?
                             $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!)
                           ))
                          ) (I 0)
                      ...
                      (and
                       ...
                       (=>
                        tmp%5
                        (=>
                         (= tmp%6 (= (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_odd_scalar.?
                            (Poly%vstd!seq.Seq<i8.>. digits!) (I 1)
                           ) (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I 1)))
                         ))
                         (and
                          (=>
                           %%location_label%%5
                          ...
                          (=>
                           tmp%6
                           (=>
                            (= tmp%7 (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I 1))))
                            (=>
                             (ens%vstd!arithmetic.mul.lemma_mul_basics_3. tmp%7)
                             (=>
                              (= tmp%8 (= (Add (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_odd_scalar.?
                                  (Poly%vstd!seq.Seq<i8.>. digits!) (I 0)
                                 ) (Mul (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I 1)))
                                  (curve25519_dalek!specs.edwards_specs.pow256.? (I 0))
                                 )
                                ) (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I 1)))
                              ))
                              (and
      ...
      (=>
       ...
       (=>
        ...
        (=>
         (= nm2@ (nClip (Sub nm1@ 1)))
         (=>
          (= tmp%9 (%Poly%vstd!seq.Seq<i8.>. (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
              digits!
          ...
          (and
           ...
           (and
            ...
            (=>
             ...
             (=>
              (= suf@ (%Poly%vstd!seq.Seq<i8.>. (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
                  digits!
                 ) (I 2) (I (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!)))
              )))
              (=>
               (= tmp%10 (>= (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. suf@)) (nClip
                  (Mul 2 nm1@)
               )))
               (and
                (=>
                ...
                (=>
                 tmp%10
                 (=>
                  (= suf_idx@ (nClip (Add (nClip (Mul 2 nm2@)) 1)))
                  (=>
                   (= tmp%11 (< (Add suf_idx@ 2) (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
                       digits!
                   ))))
                   (and
                    (=>
                    ...
                    (=>
                     tmp%11
                     (=>
                      (= tmp%12 (= (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. suf@) (I suf_idx@))
                        (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I (Add suf_idx@
                           2
                      )))))
                      (and
                       (=>
                       ...
                       (=>
                        tmp%12
                        (=>
                         (= tmp%13 (= (Add suf_idx@ 2) (nClip (Add (nClip (Mul 2 nm1@)) 1))))
                         (and
                          (=>
                           %%location_label%%12
                           tmp%13
                          ...
                          (=>
                           tmp%13
                           (=>
                            (= tmp%14 (= (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. suf@) (I suf_idx@))
                              (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I (nClip (Add (nClip
                                   (Mul 2 nm1@)
                                  ) 1
                            ))))))
                            (and
                             ...
                             (=>
                              ...
                              (and
                               (=>
                                (fuel_bool fuel%curve25519_dalek!specs.edwards_specs.pow256.)
                                (=>
                                 (= tmp%15 (= (nClip (Mul 8 nm1@)) (nClip (Add (nClip (Mul 8 nm2@)) 8))))
                                 (and
                                  (=>
                                   %%location_label%%14
                                   tmp%15
                                  ...
                                  (=>
                                   tmp%15
                                   (=>
                                    (= tmp%16 (nClip (Mul 8 nm2@)))
                                    (=>
                                     (ens%vstd!arithmetic.power2.lemma_pow2_adds. tmp%16 8)
                                     (=>
                                      (= tmp%17 (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 8 nm2@)))))
                                      (=>
                                       (= tmp%18 (vstd!arithmetic.power2.pow2.? (I 8)))
                                       (=>
                                        (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. tmp%17 tmp%18)
                                        (=>
                                         %%location_label%%15
                                         (= (Mul (curve25519_dalek!specs.edwards_specs.pow256.? (I 1)) (curve25519_dalek!specs.edwards_specs.pow256.?
                                            (I nm2@)
                                           )
                                ...
                                (=>
                                 ...
                                 (and
                                  (and
                                   (=>
                                    %%location_label%%16
                                    (= (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_odd_scalar.? (Poly%vstd!seq.Seq<i8.>.
                                       digits!
                                      ) (I n!)
                                     ) (Add (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I 1)))
                                      (Mul (curve25519_dalek!specs.edwards_specs.pow256.? (I 1)) (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_odd_scalar.?
                                        (Poly%vstd!seq.Seq<i8.>. suf@) (I nm1@)
                                   )))))
                                   (=>
                                    (= (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_odd_scalar.? (Poly%vstd!seq.Seq<i8.>.
                                       digits!
                                    ...
                                    (and
                                     (=>
                                      (= tmp%19 (= (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_odd_scalar.?
                                         (Poly%vstd!seq.Seq<i8.>. suf@) (I nm1@)
                                        ) (Add (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_odd_scalar.?
                                          (Poly%vstd!seq.Seq<i8.>. suf@) (I nm2@)
                                         ) (Mul (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. suf@) (I suf_idx@)))
                                          (curve25519_dalek!specs.edwards_specs.pow256.? (I nm2@))
                                      ))))
                                      (and
                                       (=>
                                        %%location_label%%17
                                       ...
                                       (=>
                                        tmp%19
                                        (=>
                                         (= tmp%20 (curve25519_dalek!specs.edwards_specs.pow256.? (I 1)))
                                         (=>
                                          (= tmp%21 (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_odd_scalar.?
                                            (Poly%vstd!seq.Seq<i8.>. suf@) (I nm2@)
                                          ))
                                          (=>
                                           (= tmp%22 (Mul (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. suf@) (I
                                                suf_idx@
                                              ))
                                             ) (curve25519_dalek!specs.edwards_specs.pow256.? (I nm2@))
                                           ))
                                           (=>
                                            (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add. tmp%20 tmp%21 tmp%22)
                                            (=>
                                             %%location_label%%18
                                             (= (Add (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I 1)))
                                               (Mul (curve25519_dalek!specs.edwards_specs.pow256.? (I 1)) (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_odd_scalar.?
                                               ...
                                               ) (Mul (curve25519_dalek!specs.edwards_specs.pow256.? (I 1)) (Mul (%I (vstd!seq.Seq.index.?
                                                   $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. suf@) (I suf_idx@)
                                                  )
                                                 ) (curve25519_dalek!specs.edwards_specs.pow256.? (I nm2@))
                                     ))))))))))))
                                     (=>
                                      ...
                                      (and
                                       (=>
                                        (= d@ (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. suf@) (I suf_idx@))))
                                        (=>
                                         (= p@ (curve25519_dalek!specs.edwards_specs.pow256.? (I nm2@)))
                                         (=>
                                          (= b@ (curve25519_dalek!specs.edwards_specs.pow256.? (I 1)))
                                          (and
                                           (=>
                                            (ens%vstd!arithmetic.mul.lemma_mul_is_associative. b@ d@ p@)
                                            (=>
                                             %%location_label%%19
                                             (= (Mul b@ (Mul d@ p@)) (Mul (Mul b@ d@) p@))
                                           ))
                                           (=>
                                            (= (Mul b@ (Mul d@ p@)) (Mul (Mul b@ d@) p@))
                                            (and
                                             (=>
                                              (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. b@ d@)
                                              (=>
                                               %%location_label%%20
                                               (= (Mul b@ d@) (Mul d@ b@))
                                             ))
                                             (=>
                                              ...
                                              (and
                                               (=>
                                                (ens%vstd!arithmetic.mul.lemma_mul_is_associative. d@ b@ p@)
                                                (=>
                                                 %%location_label%%21
                                                 (= (Mul (Mul d@ b@) p@) (Mul d@ (Mul b@ p@)))
                                               ))
                                               (=>
                                                (= (Mul (Mul d@ b@) p@) (Mul d@ (Mul b@ p@)))
                                                (=>
                                                 (= tmp%23 (= (Mul b@ (Mul d@ p@)) (Mul d@ (Mul b@ p@))))
                                                 (and
                                                  (=>
                                                   %%location_label%%22
                                                   tmp%23
                                                  ...
                                                  (=>
                                                   tmp%23
                                                   (=>
                                                    (= tmp%24 (= (Mul (curve25519_dalek!specs.edwards_specs.pow256.? (I 1)) (curve25519_dalek!specs.edwards_specs.pow256.?
                                                        (I nm2@)
                                                       )
                                                      ) (curve25519_dalek!specs.edwards_specs.pow256.? (I nm1@))
                                                    ))
                                                    (and
                                                     ...
                                                     (=>
                                                      tmp%24
                                                      (=>
                                                       (= tmp%25 (= (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. suf@) (I suf_idx@))
                                                         (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I (nClip (Add (nClip
                                                              (Mul 2 nm1@)
                                                             ) 1
                                                       ))))))
                                       ...
                                       (=>
                                        ...
                                        (and
                                         (=>
                                          (= tmp%26 (= (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_odd_scalar.?
