...
;; curve25519-dalek/src/lemmas/montgomery_curve_lemmas.rs:580:1: 580:67 (#0)
...
;; Function-Def curve25519_dalek::lemmas::montgomery_curve_lemmas::lemma_montgomery_add_zero_point_doubles_to_infinity
;; curve25519-dalek/src/lemmas/montgomery_curve_lemmas.rs:580:1: 580:67 (#0)
  ...
  (not (=>
    ...
    (and
     (=>
      ...
      (=>
       %%location_label%%0
       (= P@ (curve25519_dalek!specs.montgomery_specs.MontgomeryAffine./Finite (%I (I 0))
         (%I (I 0))
     ))))
     (=>
      (= P@ (curve25519_dalek!specs.montgomery_specs.MontgomeryAffine./Finite (%I (I 0))
      ...
      (=>
       (= tmp%1 (= (curve25519_dalek!specs.montgomery_specs.montgomery_add.? (Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.
           P@
          ) (Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine. P@)
         ) curve25519_dalek!specs.montgomery_specs.MontgomeryAffine./Infinity
       ))
