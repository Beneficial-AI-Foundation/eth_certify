...
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:3172:1: 3172:78 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::curve_equation_lemmas::lemma_projective_implies_affine_on_curve
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:3172:1: 3172:78 (#0)
    ...
    (=>
     ...
     (=>
      ...
      (=>
       ...
       (=>
        (= ghost_t@ (curve25519_dalek!specs.field_specs.field_mul.? (I xy@) (I z_inv@)))
        (and
         (=>
          (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_comm.
           xy@ z_inv@
          ...
          (=>
           %%location_label%%0
           (= ghost_t@ (curve25519_dalek!specs.field_specs.field_mul.? (I z_inv@) (I xy@)))
         ))
         (=>
          (= ghost_t@ (curve25519_dalek!specs.field_specs.field_mul.? (I z_inv@) (I xy@)))
          (and
             ...
             (and
              ...
              (=>
               ...
               (and
                (=>
                 %%location_label%%3
                 (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. z! z_inv@ p@)
                )
                (=>
                 (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. z! z_inv@ p@)
                 (=>
                  %%location_label%%4
                  (= (curve25519_dalek!specs.field_specs.field_mul.? (I z!) (I z_inv@)) 1)
             )))))
             (=>
              (= (curve25519_dalek!specs.field_specs.field_mul.? (I z!) (I z_inv@)) 1)
              (and
                 ...
                 (and
                  ...
                  (=>
                   ...
                   (and
                    (=>
                     %%location_label%%6
                     (req%vstd!arithmetic.div_mod.lemma_small_mod. xy@ p@)
                    )
                    (=>
                     (ens%vstd!arithmetic.div_mod.lemma_small_mod. xy@ p@)
                     (=>
                      %%location_label%%7
                      (= (curve25519_dalek!specs.field_specs.field_mul.? (I 1) (I xy@)) xy@)
               )))))))
               (=>
                (= (curve25519_dalek!specs.field_specs.field_mul.? (I 1) (I xy@)) xy@)
                (=>
                 (= tmp%2 (= (curve25519_dalek!specs.field_specs.field_mul.? (I z!) (I ghost_t@)) xy@))
                 (and
                  (=>
                   %%location_label%%8
                   tmp%2
                  ...
                  (=>
                   tmp%2
                   (=>
                    (= tmp%3 (curve25519_dalek!specs.edwards_specs.is_valid_extended_edwards_point.? (I
                       x!
                      ) (I y!) (I z!) (I ghost_t@)
                    ))
                    (and
