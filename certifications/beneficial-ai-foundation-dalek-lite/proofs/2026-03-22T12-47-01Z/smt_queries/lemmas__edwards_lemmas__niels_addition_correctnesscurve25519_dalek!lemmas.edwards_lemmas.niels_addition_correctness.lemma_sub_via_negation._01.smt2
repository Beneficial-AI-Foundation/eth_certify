...
;; curve25519-dalek/src/lemmas/edwards_lemmas/niels_addition_correctness.rs:211:7: 222:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::niels_addition_correctness::lemma_sub_via_negation
;; curve25519-dalek/src/lemmas/edwards_lemmas/niels_addition_correctness.rs:211:7: 222:2 (#0)
          ...
          (=>
           ...
           (and
            (=>
             ...
             (=>
              (= tmp%1 (curve25519_dalek!specs.field_specs.field_neg.? (I x1x2!)))
              (=>
               (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_comm.
                tmp%1 y1y2!
               )
               (=>
                ...
                (=>
                 ...
                 (=>
                  (= tmp%2 (curve25519_dalek!specs.field_specs.field_mul.? (I x1x2!) (I y1y2!)))
                  (=>
                   (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_neg.
                    d! tmp%2
                   )
                 ...
                 (=>
                  ...
                  (=>
                   ...
                   (and
                    (=>
                     %%location_label%%5
                     (req%vstd!arithmetic.div_mod.lemma_add_mod_noop. 1 tmp%3 p@)
                    )
                    (=>
                     (ens%vstd!arithmetic.div_mod.lemma_add_mod_noop. 1 tmp%3 p@)
                     (and
                      (=>
                       %%location_label%%6
                       (req%vstd!arithmetic.div_mod.lemma_add_mod_noop. 1 t! p@)
                      )
                      (=>
                       (ens%vstd!arithmetic.div_mod.lemma_add_mod_noop. 1 t! p@)
                       (and
                        (=>
                         %%location_label%%7
                         (req%vstd!arithmetic.div_mod.lemma_mod_twice. t! p@)
                        )
                        (=>
                         (ens%vstd!arithmetic.div_mod.lemma_mod_twice. t! p@)
                         (=>
                          %%location_label%%8
                          (= (curve25519_dalek!specs.field_specs.field_sub.? (I 1) (I t_prime@)) (curve25519_dalek!specs.field_specs.field_add.?
                            (I 1) (I t!)
