...
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_ratio_lemmas.rs:857:1: 862:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::sqrt_ratio_lemmas::lemma_sqrt_ratio_zero_propagation
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_ratio_lemmas.rs:857:1: 862:2 (#0)
...
(push)
 ...
 (declare-const w_zero@ Int)
 (declare-const pow_result$1@ Int)
            ...
            (and
             ...
             (=>
              ...
              (=>
               ...
               (=>
                (= w@ (curve25519_dalek!specs.field_specs.field_mul.? (I 0) (I v7@)))
                (and
                 (=>
                  %%location_label%%2
                  (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_zero_left.
                 ...
                 (=>
                  ...
                  (=>
                   (= k@ (nClip (EucDiv (Sub pn@ 5) 8)))
                   (=>
                    (= pow_result@ (EucMod (nClip (vstd!arithmetic.power.pow.? (I w@) (I k@))) pn@))
                    (and
                     (=>
                      %%location_label%%3
                      (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_zero_left.
            ...
            (=>
             ...
             (and
              ...
              (=>
               tmp%1
               (=>
                (= tmp%2 (= (curve25519_dalek!specs.field_specs.field_square.? (I 0)) 0))
                (and
                 (=>
                  %%location_label%%11
                  tmp%2
                     ...
                     (=>
                      ...
                      (and
                       ...
                       (=>
                        ...
                        (=>
                         (= k$1@ (nClip (EucDiv (Sub pn@ 5) 8)))
                         (=>
                          (= w_zero@ (curve25519_dalek!specs.field_specs.field_mul.? (I u_nat!) (I 0)))
                          (=>
                           (= pow_result$1@ (EucMod (nClip (vstd!arithmetic.power.pow.? (I w_zero@) (I k$1@)))
                             pn@
                           ))
                           (and
                            (=>
                             ...
                             (=>
                              ...
                              (and
                               ...
                               (=>
                                tmp%3
                                (=>
                                 (= tmp%4 (curve25519_dalek!specs.field_specs.field_square.? (I r_orig_nat!)))
                                 (and
                                  (=>
                                   %%location_label%%17
                                   (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_zero_left.
