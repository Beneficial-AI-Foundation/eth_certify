...
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:1282:1: 1282:67 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::curve_equation_lemmas::lemma_neg_of_signed_scalar_mul
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:1282:1: 1282:67 (#0)
    ...
    (or
     (and
      (=>
       (> n! 0)
       (=>
        (= tmp%1 (= (nClip (Sub 0 (Sub 0 n!))) (nClip n!)))
        (and
         (=>
          %%location_label%%0
          tmp%1
              ...
              (=>
               ...
               (=>
                ...
                (and
                 (=>
                  %%location_label%%2
                  (req%vstd!arithmetic.div_mod.lemma_mod_self_0. tmp%3)
                 )
                 (=>
                  (ens%vstd!arithmetic.div_mod.lemma_mod_self_0. tmp%3)
                  %%switch_label%%1
         )))))))))
         (=>
          (not (= n! 0))
          (=>
           ...
           (=>
            (= x@ (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@)))))
            (=>
             (= _y@ (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. tmp%%@)))))
             (=>
              (= tmp%4 (nClip (Sub 0 n!)))
              (and
               (=>
     ...
     (and
      ...
      (=>
       %%location_label%%5
       (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_neg.?
