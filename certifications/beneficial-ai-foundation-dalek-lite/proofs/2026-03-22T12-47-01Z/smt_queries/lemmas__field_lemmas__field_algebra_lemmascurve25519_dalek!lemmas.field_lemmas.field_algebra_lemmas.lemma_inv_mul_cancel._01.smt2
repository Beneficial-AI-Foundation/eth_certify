...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:685:1: 685:42 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_inv_mul_cancel
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:685:1: 685:42 (#0)
     ...
     (=>
      ...
      (and
       ...
       (=>
        ...
        (=>
         (= tmp%1 (= (EucMod (nClip (Mul (EucMod a! p@) inv_a@)) p@) 1))
         (and
          (=>
           %%location_label%%1
           tmp%1
          ...
          (=>
           tmp%1
           (=>
            (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. inv_a@ a!)
            (and
             (=>
              %%location_label%%2
             ...
             (=>
              ...
              (and
               (=>
                %%location_label%%3
                (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. inv_a@ a! p@)
               )
               (=>
                (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. inv_a@ a! p@)
                (=>
                 %%location_label%%4
                 (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_inv.?
                     (I a!)
