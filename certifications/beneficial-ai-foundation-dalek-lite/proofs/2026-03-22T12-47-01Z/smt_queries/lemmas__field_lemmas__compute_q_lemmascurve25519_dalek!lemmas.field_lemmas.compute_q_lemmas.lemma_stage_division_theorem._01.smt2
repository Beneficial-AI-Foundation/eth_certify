...
;; curve25519-dalek/src/lemmas/field_lemmas/compute_q_lemmas.rs:346:1: 346:95 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::compute_q_lemmas::lemma_stage_division_theorem
;; curve25519-dalek/src/lemmas/field_lemmas/compute_q_lemmas.rs:346:1: 346:95 (#0)
(get-info :all-statistics)
(push)
 (declare-const r! Int)
 (declare-const limb! Int)
 (declare-const carry_in! Int)
 (declare-const carry_out! Int)
 ...
 (assert
  (not (and
    ...
    (=>
     (> (vstd!arithmetic.power2.pow2.? (I 51)) 0)
     (=>
      (= tmp%1 (Add limb! carry_in!))
      (=>
       (= tmp%2 (vstd!arithmetic.power2.pow2.? (I 51)))
       (and
        (=>
         %%location_label%%1
         (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. tmp%1 tmp%2)
        )
        (=>
         (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. tmp%1 tmp%2)
         (=>
          (= r@ (EucMod (Add limb! carry_in!) (vstd!arithmetic.power2.pow2.? (I 51))))
          (=>
           (= tmp%3 (Add limb! carry_in!))
           (=>
