...
;; curve25519-dalek/src/lemmas/common_lemmas/div_mod_lemmas.rs:77:1: 77:59 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::div_mod_lemmas::lemma_mod_diff_factor
;; curve25519-dalek/src/lemmas/common_lemmas/div_mod_lemmas.rs:77:1: 77:59 (#0)
 ...
 (assert
  (not (=>
    ...
    (and
     (=>
      %%location_label%%0
      (req%vstd!arithmetic.div_mod.lemma_sub_mod_noop. b! tmp%1 m!)
     )
     (=>
      (ens%vstd!arithmetic.div_mod.lemma_sub_mod_noop. b! tmp%1 m!)
      (and
       (=>
        %%location_label%%1
       ...
       (=>
        ...
        (and
         (=>
          %%location_label%%2
          (req%vstd!arithmetic.div_mod.lemma_mod_twice. b! m!)
         )
         (=>
          (ens%vstd!arithmetic.div_mod.lemma_mod_twice. b! m!)
          (=>
           %%location_label%%3
           (= (EucMod (Sub b! (Mul a! m!)) m!) (EucMod b! m!))
 ))))))))))
