...
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:1709:1: 1709:77 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::curve_equation_lemmas::lemma_edwards_add_canonical
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:1709:1: 1709:77 (#0)
...
(push)
 ...
 (assert
  (not (=>
    ...
    (=>
     (= tmp%1 (Mul (curve25519_dalek!specs.field_specs.field_add.? (I (curve25519_dalek!specs.field_specs.field_mul.?
          (I x1!) (I y2!)
         )
        ) (I (curve25519_dalek!specs.field_specs.field_mul.? (I y1!) (I x2!)))
     ...
     (=>
      ...
      (and
       ...
       (=>
        ...
        (=>
         (= tmp%3 (Mul (curve25519_dalek!specs.field_specs.field_add.? (I (curve25519_dalek!specs.field_specs.field_mul.?
              (I y1!) (I y2!)
             )
            ) (I (curve25519_dalek!specs.field_specs.field_mul.? (I x1!) (I x2!)))
