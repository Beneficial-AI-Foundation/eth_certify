...
;; curve25519-dalek/src/lemmas/field_lemmas/invert_lemmas.rs:452:13: 452:19 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::invert_lemmas::lemma_invert_equals_field_inv
;; curve25519-dalek/src/lemmas/field_lemmas/invert_lemmas.rs:452:13: 452:19 (#0)
...
(push)
 ...
 (assert
  (not (=>
    %%location_label%%0
    (= (nClip (Mul x@ t21_val@)) (nClip (Mul t21_val@ x@)))
 )))
 (get-info :version)
