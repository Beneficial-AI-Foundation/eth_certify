...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:2188:1: 2188:60 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_foil_add
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:2188:1: 2188:60 (#0)
...
(push)
 ...
 (assert
  (not (=>
    ...
    (=>
     (= cd@ (curve25519_dalek!specs.field_specs.field_add.? (I c!) (I d!)))
     (and
      (=>
       (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_distributes_over_add.
        ab@ c! d!
       ...
       (=>
        %%location_label%%0
        (= (curve25519_dalek!specs.field_specs.field_mul.? (I ab@) (I cd@)) (curve25519_dalek!specs.field_specs.field_add.?
          (I (curve25519_dalek!specs.field_specs.field_mul.? (I ab@) (I c!))) (I (curve25519_dalek!specs.field_specs.field_mul.?
            (I ab@) (I d!)
      ))))))
      (=>
       (= (curve25519_dalek!specs.field_specs.field_mul.? (I ab@) (I cd@)) (curve25519_dalek!specs.field_specs.field_add.?
         ...
         (=>
          ...
          (=>
           ...
           (=>
            ...
            (=>
             %%location_label%%1
             (= (curve25519_dalek!specs.field_specs.field_mul.? (I ab@) (I c!)) (curve25519_dalek!specs.field_specs.field_add.?
               (I (curve25519_dalek!specs.field_specs.field_mul.? (I a!) (I c!))) (I (curve25519_dalek!specs.field_specs.field_mul.?
                 (I b!) (I c!)
        )))))))))
        (=>
           ...
           (=>
            ...
            (=>
             ...
             (=>
              ...
              (=>
               %%location_label%%2
               (= (curve25519_dalek!specs.field_specs.field_mul.? (I ab@) (I d!)) (curve25519_dalek!specs.field_specs.field_add.?
               ...
               (and
                (=>
                 ...
                 (=>
                  ...
                  (=>
                   (= tmp%1 (nClip (Add ac@ bc@)))
                   (=>
                    (= tmp%2 (nClip (Add ad@ bd@)))
                    (and
                     (=>
                      %%location_label%%3
                     ...
                     (=>
                      ...
                      (and
                       (=>
                        %%location_label%%4
                        (req%vstd!arithmetic.div_mod.lemma_add_mod_noop. ac@ bc@ p@)
                       )
                       (=>
                        (ens%vstd!arithmetic.div_mod.lemma_add_mod_noop. ac@ bc@ p@)
                        (and
                         (=>
                          %%location_label%%5
                          (req%vstd!arithmetic.div_mod.lemma_add_mod_noop. ad@ bd@ p@)
                         )
                         (=>
                          (ens%vstd!arithmetic.div_mod.lemma_add_mod_noop. ad@ bd@ p@)
                          (=>
                           (= tmp%3 (nClip (Add ac@ ad@)))
                           (=>
                            (= tmp%4 (nClip (Add bc@ bd@)))
                            (and
                             (=>
                              %%location_label%%6
                               ...
                               (=>
                                ...
                                (and
                                 ...
                                 (=>
                                  ...
                                  (=>
                                   (= tmp%5 (= (nClip (Add (nClip (Add (nClip (Add ac@ bc@)) ad@)) bd@)) (nClip (Add (nClip
                                        (Add (nClip (Add ac@ ad@)) bc@)
                                       ) bd@
                                   ))))
                                   (and
                                    (=>
                                    ...
                                    (=>
                                     ...
                                     (=>
                                      ...
                                      (= (curve25519_dalek!specs.field_specs.field_add.? (I (curve25519_dalek!specs.field_specs.field_add.?
                                        ...
                                        ) (I (curve25519_dalek!specs.field_specs.field_add.? (I ad@) (I bd@)))
                                       ) (curve25519_dalek!specs.field_specs.field_add.? (I (curve25519_dalek!specs.field_specs.field_add.?
                                          (I ac@) (I ad@)
                                         )
