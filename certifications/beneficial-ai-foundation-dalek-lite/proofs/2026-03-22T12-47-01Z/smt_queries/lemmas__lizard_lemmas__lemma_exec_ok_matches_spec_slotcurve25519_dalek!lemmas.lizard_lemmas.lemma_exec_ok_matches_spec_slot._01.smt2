...
;; MODULE 'module lemmas::lizard_lemmas, function curve25519_dalek::lemmas::lizard_lemmas::lemma_exec_ok_matches_spec_slot'
;; curve25519-dalek/src/lemmas/lizard_lemmas.rs:1325:1: 1333:2 (#0)
...
(assert
 (distinct fuel%vstd!arithmetic.div_mod.lemma_mod_bound. fuel%vstd!arithmetic.power2.lemma_pow2_strictly_increases.
  ...
  fuel%vstd!view.impl&%44.view. fuel%curve25519_dalek!specs.core_specs.u8_32_as_nat.
  fuel%curve25519_dalek!specs.field_specs.fe51_as_nat. fuel%curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.
  fuel%curve25519_dalek!specs.field_specs.u8_32_from_nat. fuel%curve25519_dalek!specs.field_specs_u64.p.
  ...
  fuel%curve25519_dalek!specs.field_specs_u64.u64_5_as_nat. fuel%curve25519_dalek!specs.lizard_specs.spec_lizard_fe_bytes.
  fuel%curve25519_dalek!specs.lizard_specs.spec_candidate_sha_consistent. fuel%curve25519_dalek!core_assumes.seq_to_array_32.
    ...
    (=>
     ...
     (=>
      ...
      (= (ext_eq false (ARRAY T&. T& N&. N&) a1! a2!) (forall ((i$ Poly)) (!
         ...
         :qid user_vstd__array__axiom_array_ext_equal_16
         :skolemid skolem_user_vstd__array__axiom_array_ext_equal_16
    )))))
...
(assert
 (=>
  ...
  (forall ((T&. Dcr) (T& Type) (N&. Dcr) (N& Type) (array! Poly) (i! Poly)) (!
    ...
    :qid user_vstd__array__axiom_array_has_resolved_18
    :skolemid skolem_user_vstd__array__axiom_array_has_resolved_18
))))
...
(assert
 (=>
  ...
  (forall ((x! Int) (m! Int)) (!
    ...
    :pattern ((EucMod x! m!))
    :qid user_vstd__arithmetic__div_mod__lemma_mod_bound_21
    :skolemid skolem_user_vstd__arithmetic__div_mod__lemma_mod_bound_21
))))
...
(assert
 (=>
  ...
  (forall ((e1! Poly) (e2! Poly)) (!
    ...
    :qid user_vstd__arithmetic__power2__lemma_pow2_strictly_increases_22
    :skolemid skolem_user_vstd__arithmetic__power2__lemma_pow2_strictly_increases_22
))))
 ...
 (forall ((%%hole%%0 Type) (%%hole%%1 Int)) (!
   (=>
    (exists ((b$ Poly)) (!
      ...
      :qid user_curve25519_dalek__specs__field_specs__u8_32_from_nat_23
      :skolemid skolem_user_curve25519_dalek__specs__field_specs__u8_32_from_nat_23
    ))
    (exists ((b$ Poly)) (!
      (and
       (and
 ...
 (=>
  ...
  (forall ((s! Poly)) (!
    (= (curve25519_dalek!core_assumes.seq_to_array_32.? s!) (%Poly%array%. (array_new $
       (UINT 8) 32 (%%array%%0 (vstd!seq.Seq.index.? $ (UINT 8) s! (I 0)) (vstd!seq.Seq.index.?
         $ (UINT 8) s! (I 1)
 ...
 (forall ((bytes1! %%Function%%) (bytes2! %%Function%%)) (!
   (= (ens%curve25519_dalek!lemmas.common_lemmas.to_nat_lemmas.lemma_canonical_bytes_equal.
     bytes1! bytes2!
      ...
      :qid user_curve25519_dalek__lemmas__common_lemmas__to_nat_lemmas__lemma_canonical_bytes_equal_24
      :skolemid skolem_user_curve25519_dalek__lemmas__common_lemmas__to_nat_lemmas__lemma_canonical_bytes_equal_24
   )))
   ...
   (= (req%curve25519_dalek!lemmas.lizard_lemmas.lemma_exec_ok_matches_spec_slot. mask_bit_set!
     ...
     (=>
      ...
      (forall ((i$ Poly)) (!
        ...
        :qid user_curve25519_dalek__lemmas__lizard_lemmas__lemma_exec_ok_matches_spec_slot_25
        :skolemid skolem_user_curve25519_dalek__lemmas__lizard_lemmas__lemma_exec_ok_matches_spec_slot_25
     )))
     (=>
...
;; Function-Def curve25519_dalek::lemmas::lizard_lemmas::lemma_exec_ok_matches_spec_slot
;; curve25519-dalek/src/lemmas/lizard_lemmas.rs:1325:1: 1333:2 (#0)
(get-info :all-statistics)
(push)
 (declare-const mask_bit_set! Bool)
 (declare-const sha_match! Bool)
 (declare-const buf2! %%Function%%)
 (declare-const msg! vstd!seq.Seq<u8.>.)
 (declare-const h! %%Function%%)
 (declare-const fe_j! curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const cj! tuple%2.)
 ...
 (declare-const chosen@ %%Function%%)
 (declare-const spec_msg@ vstd!seq.Seq<u8.>.)
 (assert
  fuel_defaults
 )
 (assert
  (has_type (Poly%array%. buf2!) (ARRAY $ (UINT 8) $ (CONST_INT 32)))
 )
 (assert
  (has_type (Poly%array%. h!) (ARRAY $ (UINT 8) $ (CONST_INT 32)))
 )
 (assert
  (has_type (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe_j!) TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 )
 (assert
  (has_type (Poly%tuple%2. cj!) (TYPE%tuple%2. $ BOOL $ NAT))
 )
 (assert
  (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. msg!)) 16)
 )
 (assert
  (forall ((i$ Poly)) (!
    ...
    :pattern ((vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. msg!) i$))
    :qid user_curve25519_dalek__lemmas__lizard_lemmas__lemma_exec_ok_matches_spec_slot_30
    :skolemid skolem_user_curve25519_dalek__lemmas__lizard_lemmas__lemma_exec_ok_matches_spec_slot_30
 )))
 (assert
  (= h! (curve25519_dalek!specs.lizard_specs.spec_lizard_fe_bytes.? (Poly%vstd!seq.Seq<u8.>.
     msg!
  ...
  (not (or
    (and
     (=>
      (%B (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. cj!))))
      (=>
       (= tmp%1 (= (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. buf2!))
         (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. cj!))))
       ))
       (and
        (=>
            ...
            (=>
             ...
             (and
              ...
              (=>
               ...
               (=>
                %%location_label%%2
                (< (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. cj!)))) (curve25519_dalek!specs.field_specs_u64.p.?
                  (I 0)
          ))))))))
          (=>
           (< (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. cj!)))) (curve25519_dalek!specs.field_specs_u64.p.?
           ...
           (and
            (=>
             ...
             (and
              (=>
               %%location_label%%3
               (req%vstd!arithmetic.power2.lemma_pow2_strictly_increases. 255 256)
              )
              (=>
               (ens%vstd!arithmetic.power2.lemma_pow2_strictly_increases. 255 256)
               (=>
                %%location_label%%4
                (< (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. cj!)))) (vstd!arithmetic.power2.pow2.?
                  (I 256)
            ))))))
            (=>
             (< (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. cj!)))) (vstd!arithmetic.power2.pow2.?
             ...
             (=>
              (= tmp%4 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. cj!)))))
              (=>
               ...
               (and
                ...
                (=>
                 ...
                 (=>
                  (= chosen@ (curve25519_dalek!specs.field_specs.u8_32_from_nat.? (tuple%2./tuple%2/1
                     (%Poly%tuple%2. (Poly%tuple%2. cj!))
                  )))
                  (and
                   (=>
                   ...
                   (=>
                    ...
                    (=>
                     (= tmp%6 (ext_eq false (ARRAY $ (UINT 8) $ (CONST_INT 32)) (Poly%array%. buf2!) (Poly%array%.
                        chosen@
                     )))
                     (and
                      (=>
                      ...
                      (=>
                       tmp%6
                       (=>
                        (= spec_msg@ (%Poly%vstd!seq.Seq<u8.>. (vstd!seq.Seq.new.? $ (UINT 8) $ (TYPE%fun%1.
                            $ INT $ (UINT 8)
                           ) (I 16) (Poly%fun%1. (mk_fun (%%lambda%%2 8 $ (UINT 8) (vstd!view.View.view.? $ (ARRAY
                                $ (UINT 8) $ (CONST_INT 32)
                               ) (Poly%array%. chosen@)
                        ...
                        (and
                         (=>
                          (= tmp%7 (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. msg!)) 16))
                          (and
                           (=>
                            %%location_label%%8
                            tmp%7
                           ...
                           (=>
                            tmp%7
                            (=>
                             (= tmp%8 (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. spec_msg@)) 16))
                             (and
                              (=>
                               %%location_label%%9
                               tmp%8
                               ...
                               (and
                                (=>
                                 ...
                                 (=>
                                  ...
                                  (=>
                                   (= tmp%9 (= (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. msg!) i@) (vstd!seq.Seq.index.?
                                      $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT 32)) (Poly%array%.
                                        buf2!
                                       )
                                      ) (I (Add 8 (%I i@)))
                                   ...
                                   (and
                                    ...
                                    (=>
                                     tmp%9
                                     (=>
                                      (= tmp%10 (= (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT 8)
                                           $ (CONST_INT 32)
                                          ) (Poly%array%. buf2!)
                                         ) (I (Add 8 (%I i@)))
                                        ) (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT
                                      ...
                                      (and
                                       ...
                                       (=>
                                        ...
                                        (=>
                                         %%location_label%%12
                                         (= (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. msg!) i@) (vstd!seq.Seq.index.?
                                           $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. spec_msg@) i@
                                )))))))))))
                                (=>
                                 (forall ((i$ Poly)) (!
                                   (=>
                                   ...
                                   :pattern ((vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. msg!) i$))
                                   :pattern ((vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. spec_msg@) i$))
                                   :qid user_curve25519_dalek__lemmas__lizard_lemmas__lemma_exec_ok_matches_spec_slot_28
                                   :skolemid skolem_user_curve25519_dalek__lemmas__lizard_lemmas__lemma_exec_ok_matches_spec_slot_28
                                 ))
                                 (=>
                                  %%location_label%%13
                                  (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. msg!) (Poly%vstd!seq.Seq<u8.>.
                                    spec_msg@
                         )))))))))))
                         (=>
                          (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. msg!) (Poly%vstd!seq.Seq<u8.>.
                          ...
                          (=>
                           (= tmp%11 (= (curve25519_dalek!specs.lizard_specs.spec_candidate_sha_consistent.? (tuple%2./tuple%2/1
                               (%Poly%tuple%2. (Poly%tuple%2. cj!))
                              )
                             ) (= chosen@ (curve25519_dalek!specs.lizard_specs.spec_lizard_fe_bytes.? (Poly%vstd!seq.Seq<u8.>.
                                spec_msg@
                           )))))
                           (and
                            (=>
                            ...
                            (=>
                             tmp%11
                             (=>
                              (= tmp%12 (= (curve25519_dalek!specs.lizard_specs.spec_candidate_sha_consistent.? (tuple%2./tuple%2/1
                                  (%Poly%tuple%2. (Poly%tuple%2. cj!))
                                 )
     ...
     (=>
      (not (%B (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. cj!)))))
      %%switch_label%%0
    ))
    (and
     (not %%switch_label%%0)
