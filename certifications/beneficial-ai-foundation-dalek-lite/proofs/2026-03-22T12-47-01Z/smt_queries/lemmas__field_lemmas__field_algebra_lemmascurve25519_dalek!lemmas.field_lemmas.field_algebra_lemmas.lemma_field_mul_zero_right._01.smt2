...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:65:1: 65:56 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_field_mul_zero_right
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:65:1: 65:56 (#0)
    ...
    (=>
     ...
     (and
      (and
       (=>
        %%location_label%%0
        (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. a! b! p@)
       )
       (=>
        (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. a! b! p@)
        (and
         (=>
