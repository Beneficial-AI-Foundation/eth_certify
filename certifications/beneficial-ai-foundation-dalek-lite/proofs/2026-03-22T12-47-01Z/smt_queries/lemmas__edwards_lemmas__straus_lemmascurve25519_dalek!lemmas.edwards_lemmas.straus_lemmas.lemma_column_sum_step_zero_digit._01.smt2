...
;; curve25519-dalek/src/lemmas/edwards_lemmas/straus_lemmas.rs:639:1: 644:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::straus_lemmas::lemma_column_sum_step_zero_digit
;; curve25519-dalek/src/lemmas/edwards_lemmas/straus_lemmas.rs:639:1: 644:2 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= col_k@ (curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.straus_column_sum.?
      (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. points_affine!) (Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>.
       digits!
      ) (I j!) (I k!)
    ))
    (=>
     ...
     (=>
      (fuel_bool fuel%curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.)
      (=>
       (= tmp%1 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. term@) (Poly%tuple%2.
          (curve25519_dalek!specs.edwards_specs.edwards_identity.? (I 0))
       )))
       (and
        (=>
        ...
        (=>
         tmp%1
         (=>
          (= tmp%2 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. term@) (Poly%tuple%2.
             (tuple%2./tuple%2 (I 0) (I 1))
          )))
          (and
           (=>
