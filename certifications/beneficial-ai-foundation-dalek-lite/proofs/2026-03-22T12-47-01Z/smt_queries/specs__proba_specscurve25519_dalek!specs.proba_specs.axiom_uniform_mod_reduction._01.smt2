...
;; MODULE 'module specs::proba_specs'
;; curve25519-dalek/src/specs/proba_specs.rs:292:1: 292:76 (#0)
...
(assert
 (distinct fuel%vstd!array.array_view. fuel%vstd!array.impl&%0.view. fuel%vstd!array.impl&%2.spec_index.
  ...
  fuel%vstd!view.impl&%48.view. fuel%curve25519_dalek!backend.serial.u64.constants.SQRT_AD_MINUS_ONE.
  ...
  fuel%curve25519_dalek!specs.edwards_specs.edwards_add. fuel%curve25519_dalek!specs.field_specs.fe51_as_nat.
  ...
  fuel%curve25519_dalek!specs.field_specs.field_inv. fuel%curve25519_dalek!specs.field_specs.is_sqrt_ratio.
  ...
  fuel%curve25519_dalek!specs.ristretto_specs.elligator_intermediates. fuel%curve25519_dalek!specs.scalar_specs.scalar_as_nat.
  fuel%curve25519_dalek!specs.scalar52_specs.group_order. fuel%vstd!array.group_array_axioms.
...
;; Function-Decl curve25519_dalek::specs::proba_specs::is_uniform
(declare-fun curve25519_dalek!specs.proba_specs.is_uniform.? (Poly) Bool)
...
;; Function-Decl curve25519_dalek::specs::proba_specs::is_uniform_scalar
(declare-fun curve25519_dalek!specs.proba_specs.is_uniform_scalar.? (Poly) Bool)

;; Function-Decl curve25519_dalek::specs::proba_specs::is_uniform_ristretto_point
(declare-fun curve25519_dalek!specs.proba_specs.is_uniform_ristretto_point.? (Poly)
 Bool
)

;; Function-Decl curve25519_dalek::specs::proba_specs::is_independent_uniform_bytes32
(declare-fun curve25519_dalek!specs.proba_specs.is_independent_uniform_bytes32.? (
  Poly Poly
 ) Bool
)

;; Function-Decl curve25519_dalek::specs::proba_specs::is_independent_uniform_field_elements
(declare-fun curve25519_dalek!specs.proba_specs.is_independent_uniform_field_elements.?
 (Poly Poly) Bool
)

;; Function-Decl curve25519_dalek::specs::proba_specs::is_independent_uniform_ristretto_points
(declare-fun curve25519_dalek!specs.proba_specs.is_independent_uniform_ristretto_points.?
 (Poly Poly) Bool
)

;; Function-Decl curve25519_dalek::specs::proba_specs::is_uniform_over_elligator_image
(declare-fun curve25519_dalek!specs.proba_specs.is_uniform_over_elligator_image.?
 (Poly) Bool
)
...
;; Function-Specs curve25519_dalek::specs::proba_specs::axiom_uniform_bytes_split
(declare-fun req%curve25519_dalek!specs.proba_specs.axiom_uniform_bytes_split. (%%Function%%
  %%Function%% %%Function%%
 ) Bool
)
...
(assert
 (forall ((bytes! %%Function%%) (first! %%Function%%) (second! %%Function%%)) (!
   (= (req%curve25519_dalek!specs.proba_specs.axiom_uniform_bytes_split. bytes! first!
     second!
    ) (and
     (=>
      %%global_location_label%%8
      (= (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT 32)) (Poly%array%. first!))
     ...
     (=>
      ...
      (= (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT 32)) (Poly%array%. second!))
       (vstd!seq.Seq.subrange.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT
           64
          )
         ) (Poly%array%. bytes!)
     ...
     (=>
      ...
      (curve25519_dalek!specs.proba_specs.is_uniform_bytes.? (vstd!array.spec_array_as_slice.?
        $ (UINT 8) $ (CONST_INT 64) (Poly%array%. bytes!)
   )))))
   :pattern ((req%curve25519_dalek!specs.proba_specs.axiom_uniform_bytes_split. bytes!
     first! second!
   ))
   :qid internal_req__curve25519_dalek!specs.proba_specs.axiom_uniform_bytes_split._definition
   :skolemid skolem_internal_req__curve25519_dalek!specs.proba_specs.axiom_uniform_bytes_split._definition
)))
(declare-fun ens%curve25519_dalek!specs.proba_specs.axiom_uniform_bytes_split. (%%Function%%
  %%Function%% %%Function%%
 ) Bool
)
(assert
 (forall ((bytes! %%Function%%) (first! %%Function%%) (second! %%Function%%)) (!
   (= (ens%curve25519_dalek!specs.proba_specs.axiom_uniform_bytes_split. bytes! first!
     second!
    ) (and
     (curve25519_dalek!specs.proba_specs.is_uniform_bytes.? (vstd!array.spec_array_as_slice.?
       $ (UINT 8) $ (CONST_INT 32) (Poly%array%. first!)
     ))
     (curve25519_dalek!specs.proba_specs.is_uniform_bytes.? (vstd!array.spec_array_as_slice.?
       $ (UINT 8) $ (CONST_INT 32) (Poly%array%. second!)
     ))
     (curve25519_dalek!specs.proba_specs.is_independent_uniform_bytes32.? (Poly%array%.
       first!
      ) (Poly%array%. second!)
   )))
   :pattern ((ens%curve25519_dalek!specs.proba_specs.axiom_uniform_bytes_split. bytes!
     first! second!
   ))
   :qid internal_ens__curve25519_dalek!specs.proba_specs.axiom_uniform_bytes_split._definition
   :skolemid skolem_internal_ens__curve25519_dalek!specs.proba_specs.axiom_uniform_bytes_split._definition
)))

;; Function-Specs curve25519_dalek::specs::proba_specs::axiom_from_bytes_independent
(declare-fun req%curve25519_dalek!specs.proba_specs.axiom_from_bytes_independent.
 (%%Function%% %%Function%% curve25519_dalek!backend.serial.u64.field.FieldElement51.
  curve25519_dalek!backend.serial.u64.field.FieldElement51.
 ) Bool
)
...
(assert
 (forall ((bytes1! %%Function%%) (bytes2! %%Function%%) (fe1! curve25519_dalek!backend.serial.u64.field.FieldElement51.)
   (fe2! curve25519_dalek!backend.serial.u64.field.FieldElement51.)
  ) (!
   (= (req%curve25519_dalek!specs.proba_specs.axiom_from_bytes_independent. bytes1! bytes2!
     fe1! fe2!
    ) (and
     (=>
      ...
      (= (curve25519_dalek!specs.field_specs.fe51_as_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
       ...
       ) (EucMod (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. bytes1!))
        (vstd!arithmetic.power2.pow2.? (I 255))
     )))
     (=>
      ...
      (= (curve25519_dalek!specs.field_specs.fe51_as_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
       ...
       ) (EucMod (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. bytes2!))
        (vstd!arithmetic.power2.pow2.? (I 255))
     )))
     (=>
   ...
   :pattern ((req%curve25519_dalek!specs.proba_specs.axiom_from_bytes_independent. bytes1!
     bytes2! fe1! fe2!
   ))
   :qid internal_req__curve25519_dalek!specs.proba_specs.axiom_from_bytes_independent._definition
   :skolemid skolem_internal_req__curve25519_dalek!specs.proba_specs.axiom_from_bytes_independent._definition
)))
(declare-fun ens%curve25519_dalek!specs.proba_specs.axiom_from_bytes_independent.
 (%%Function%% %%Function%% curve25519_dalek!backend.serial.u64.field.FieldElement51.
  curve25519_dalek!backend.serial.u64.field.FieldElement51.
 ) Bool
)
(assert
 (forall ((bytes1! %%Function%%) (bytes2! %%Function%%) (fe1! curve25519_dalek!backend.serial.u64.field.FieldElement51.)
   ...
   (= (ens%curve25519_dalek!specs.proba_specs.axiom_from_bytes_independent. bytes1! bytes2!
     fe1! fe2!
    ) (curve25519_dalek!specs.proba_specs.is_independent_uniform_field_elements.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
      fe1!
     ) (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe2!)
   ))
   :pattern ((ens%curve25519_dalek!specs.proba_specs.axiom_from_bytes_independent. bytes1!
     bytes2! fe1! fe2!
   ))
   :qid internal_ens__curve25519_dalek!specs.proba_specs.axiom_from_bytes_independent._definition
   :skolemid skolem_internal_ens__curve25519_dalek!specs.proba_specs.axiom_from_bytes_independent._definition
)))

;; Function-Specs curve25519_dalek::specs::proba_specs::axiom_uniform_elligator
(declare-fun req%curve25519_dalek!specs.proba_specs.axiom_uniform_elligator. (curve25519_dalek!backend.serial.u64.field.FieldElement51.
...
(assert
 (forall ((fe! curve25519_dalek!backend.serial.u64.field.FieldElement51.) (point! curve25519_dalek!ristretto.RistrettoPoint.))
  (!
   (= (req%curve25519_dalek!specs.proba_specs.axiom_uniform_elligator. fe! point!) (and
     (=>
      ...
      (= (curve25519_dalek!specs.edwards_specs.edwards_point_as_affine.? (Poly%curve25519_dalek!edwards.EdwardsPoint.
       ...
       ) (curve25519_dalek!specs.ristretto_specs.spec_elligator_ristretto_flavor.? (I (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.?
          (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
     )))))
     (=>
   ...
   :pattern ((req%curve25519_dalek!specs.proba_specs.axiom_uniform_elligator. fe! point!))
   :qid internal_req__curve25519_dalek!specs.proba_specs.axiom_uniform_elligator._definition
   :skolemid skolem_internal_req__curve25519_dalek!specs.proba_specs.axiom_uniform_elligator._definition
)))
(declare-fun ens%curve25519_dalek!specs.proba_specs.axiom_uniform_elligator. (curve25519_dalek!backend.serial.u64.field.FieldElement51.
  curve25519_dalek!ristretto.RistrettoPoint.
 ) Bool
)
(assert
 (forall ((fe! curve25519_dalek!backend.serial.u64.field.FieldElement51.) (point! curve25519_dalek!ristretto.RistrettoPoint.))
  (!
   (= (ens%curve25519_dalek!specs.proba_specs.axiom_uniform_elligator. fe! point!) (curve25519_dalek!specs.proba_specs.is_uniform_over_elligator_image.?
     (Poly%curve25519_dalek!ristretto.RistrettoPoint. point!)
   ))
   :pattern ((ens%curve25519_dalek!specs.proba_specs.axiom_uniform_elligator. fe! point!))
   :qid internal_ens__curve25519_dalek!specs.proba_specs.axiom_uniform_elligator._definition
   :skolemid skolem_internal_ens__curve25519_dalek!specs.proba_specs.axiom_uniform_elligator._definition
)))

;; Function-Specs curve25519_dalek::specs::proba_specs::axiom_uniform_elligator_independent
(declare-fun req%curve25519_dalek!specs.proba_specs.axiom_uniform_elligator_independent.
 (curve25519_dalek!backend.serial.u64.field.FieldElement51. curve25519_dalek!backend.serial.u64.field.FieldElement51.
  curve25519_dalek!ristretto.RistrettoPoint. curve25519_dalek!ristretto.RistrettoPoint.
 ) Bool
)
...
(assert
 (forall ((fe1! curve25519_dalek!backend.serial.u64.field.FieldElement51.) (fe2! curve25519_dalek!backend.serial.u64.field.FieldElement51.)
   (p1! curve25519_dalek!ristretto.RistrettoPoint.) (p2! curve25519_dalek!ristretto.RistrettoPoint.)
  ) (!
   (= (req%curve25519_dalek!specs.proba_specs.axiom_uniform_elligator_independent. fe1!
     fe2! p1! p2!
    ) (and
     (=>
      ...
      (= (curve25519_dalek!specs.edwards_specs.edwards_point_as_affine.? (Poly%curve25519_dalek!edwards.EdwardsPoint.
         (curve25519_dalek!ristretto.RistrettoPoint./RistrettoPoint/0 (%Poly%curve25519_dalek!ristretto.RistrettoPoint.
           (Poly%curve25519_dalek!ristretto.RistrettoPoint. p1!)
        )))
       ) (curve25519_dalek!specs.ristretto_specs.spec_elligator_ristretto_flavor.? (I (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.?
     ...
     (=>
      ...
      (= (curve25519_dalek!specs.edwards_specs.edwards_point_as_affine.? (Poly%curve25519_dalek!edwards.EdwardsPoint.
         (curve25519_dalek!ristretto.RistrettoPoint./RistrettoPoint/0 (%Poly%curve25519_dalek!ristretto.RistrettoPoint.
           (Poly%curve25519_dalek!ristretto.RistrettoPoint. p2!)
        )))
       ) (curve25519_dalek!specs.ristretto_specs.spec_elligator_ristretto_flavor.? (I (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.?
          (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe2!)
     )))))
   ...
   :pattern ((req%curve25519_dalek!specs.proba_specs.axiom_uniform_elligator_independent.
     fe1! fe2! p1! p2!
   ))
   :qid internal_req__curve25519_dalek!specs.proba_specs.axiom_uniform_elligator_independent._definition
   :skolemid skolem_internal_req__curve25519_dalek!specs.proba_specs.axiom_uniform_elligator_independent._definition
)))
(declare-fun ens%curve25519_dalek!specs.proba_specs.axiom_uniform_elligator_independent.
 (curve25519_dalek!backend.serial.u64.field.FieldElement51. curve25519_dalek!backend.serial.u64.field.FieldElement51.
  curve25519_dalek!ristretto.RistrettoPoint. curve25519_dalek!ristretto.RistrettoPoint.
 ) Bool
)
(assert
 (forall ((fe1! curve25519_dalek!backend.serial.u64.field.FieldElement51.) (fe2! curve25519_dalek!backend.serial.u64.field.FieldElement51.)
   ...
   (= (ens%curve25519_dalek!specs.proba_specs.axiom_uniform_elligator_independent. fe1!
     fe2! p1! p2!
    ) (curve25519_dalek!specs.proba_specs.is_independent_uniform_ristretto_points.? (Poly%curve25519_dalek!ristretto.RistrettoPoint.
      p1!
     ) (Poly%curve25519_dalek!ristretto.RistrettoPoint. p2!)
   ))
   :pattern ((ens%curve25519_dalek!specs.proba_specs.axiom_uniform_elligator_independent.
     fe1! fe2! p1! p2!
   ))
   :qid internal_ens__curve25519_dalek!specs.proba_specs.axiom_uniform_elligator_independent._definition
   :skolemid skolem_internal_ens__curve25519_dalek!specs.proba_specs.axiom_uniform_elligator_independent._definition
)))

;; Function-Specs curve25519_dalek::specs::proba_specs::axiom_uniform_elligator_sum
(declare-fun req%curve25519_dalek!specs.proba_specs.axiom_uniform_elligator_sum. (
  curve25519_dalek!ristretto.RistrettoPoint. curve25519_dalek!ristretto.RistrettoPoint.
  curve25519_dalek!ristretto.RistrettoPoint.
 ) Bool
)
...
(assert
 (forall ((p1! curve25519_dalek!ristretto.RistrettoPoint.) (p2! curve25519_dalek!ristretto.RistrettoPoint.)
   (sum! curve25519_dalek!ristretto.RistrettoPoint.)
  ) (!
   (= (req%curve25519_dalek!specs.proba_specs.axiom_uniform_elligator_sum. p1! p2! sum!)
    (and
     (=>
      %%global_location_label%%19
      (= (curve25519_dalek!specs.edwards_specs.edwards_point_as_affine.? (Poly%curve25519_dalek!edwards.EdwardsPoint.
         (curve25519_dalek!ristretto.RistrettoPoint./RistrettoPoint/0 (%Poly%curve25519_dalek!ristretto.RistrettoPoint.
           (Poly%curve25519_dalek!ristretto.RistrettoPoint. sum!)
        )))
          ...
          (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_point_as_affine.? (Poly%curve25519_dalek!edwards.EdwardsPoint.
            ...
            (Poly%curve25519_dalek!edwards.EdwardsPoint. (curve25519_dalek!ristretto.RistrettoPoint./RistrettoPoint/0
              (%Poly%curve25519_dalek!ristretto.RistrettoPoint. (Poly%curve25519_dalek!ristretto.RistrettoPoint.
                p1!
         )))))))
     ...
     (=>
      ...
      (curve25519_dalek!specs.proba_specs.is_uniform_over_elligator_image.? (Poly%curve25519_dalek!ristretto.RistrettoPoint.
        p1!
     )))
     (=>
   ...
   :pattern ((req%curve25519_dalek!specs.proba_specs.axiom_uniform_elligator_sum. p1!
     p2! sum!
   ))
   :qid internal_req__curve25519_dalek!specs.proba_specs.axiom_uniform_elligator_sum._definition
   :skolemid skolem_internal_req__curve25519_dalek!specs.proba_specs.axiom_uniform_elligator_sum._definition
)))
(declare-fun ens%curve25519_dalek!specs.proba_specs.axiom_uniform_elligator_sum. (
  curve25519_dalek!ristretto.RistrettoPoint. curve25519_dalek!ristretto.RistrettoPoint.
  curve25519_dalek!ristretto.RistrettoPoint.
 ) Bool
)
(assert
 (forall ((p1! curve25519_dalek!ristretto.RistrettoPoint.) (p2! curve25519_dalek!ristretto.RistrettoPoint.)
   ...
   (= (ens%curve25519_dalek!specs.proba_specs.axiom_uniform_elligator_sum. p1! p2! sum!)
    (curve25519_dalek!specs.proba_specs.is_uniform_ristretto_point.? (Poly%curve25519_dalek!ristretto.RistrettoPoint.
      sum!
   )))
   :pattern ((ens%curve25519_dalek!specs.proba_specs.axiom_uniform_elligator_sum. p1!
     p2! sum!
   ))
   :qid internal_ens__curve25519_dalek!specs.proba_specs.axiom_uniform_elligator_sum._definition
   :skolemid skolem_internal_ens__curve25519_dalek!specs.proba_specs.axiom_uniform_elligator_sum._definition
)))

;; Function-Specs curve25519_dalek::specs::proba_specs::axiom_uniform_point_add
(declare-fun req%curve25519_dalek!specs.proba_specs.axiom_uniform_point_add. (curve25519_dalek!ristretto.RistrettoPoint.
  curve25519_dalek!ristretto.RistrettoPoint. curve25519_dalek!ristretto.RistrettoPoint.
 ) Bool
)
...
(assert
 (forall ((p1! curve25519_dalek!ristretto.RistrettoPoint.) (p2! curve25519_dalek!ristretto.RistrettoPoint.)
   ...
   (= (req%curve25519_dalek!specs.proba_specs.axiom_uniform_point_add. p1! p2! sum!)
    (and
     (=>
   ...
   :pattern ((req%curve25519_dalek!specs.proba_specs.axiom_uniform_point_add. p1! p2!
     sum!
   ))
   :qid internal_req__curve25519_dalek!specs.proba_specs.axiom_uniform_point_add._definition
   :skolemid skolem_internal_req__curve25519_dalek!specs.proba_specs.axiom_uniform_point_add._definition
)))
(declare-fun ens%curve25519_dalek!specs.proba_specs.axiom_uniform_point_add. (curve25519_dalek!ristretto.RistrettoPoint.
  curve25519_dalek!ristretto.RistrettoPoint. curve25519_dalek!ristretto.RistrettoPoint.
 ) Bool
)
(assert
 (forall ((p1! curve25519_dalek!ristretto.RistrettoPoint.) (p2! curve25519_dalek!ristretto.RistrettoPoint.)
   ...
   (= (ens%curve25519_dalek!specs.proba_specs.axiom_uniform_point_add. p1! p2! sum!)
    (curve25519_dalek!specs.proba_specs.is_uniform_ristretto_point.? (Poly%curve25519_dalek!ristretto.RistrettoPoint.
      sum!
   )))
   :pattern ((ens%curve25519_dalek!specs.proba_specs.axiom_uniform_point_add. p1! p2!
     sum!
   ))
   :qid internal_ens__curve25519_dalek!specs.proba_specs.axiom_uniform_point_add._definition
   :skolemid skolem_internal_ens__curve25519_dalek!specs.proba_specs.axiom_uniform_point_add._definition
)))

;; Function-Specs curve25519_dalek::specs::proba_specs::axiom_uniform_mod_reduction
(declare-fun req%curve25519_dalek!specs.proba_specs.axiom_uniform_mod_reduction. (
  %%Function%% curve25519_dalek!scalar.Scalar.
 ) Bool
)
(declare-const %%global_location_label%%27 Bool)
(assert
 (forall ((input! %%Function%%) (result! curve25519_dalek!scalar.Scalar.)) (!
   (= (req%curve25519_dalek!specs.proba_specs.axiom_uniform_mod_reduction. input! result!)
    (=>
     %%global_location_label%%27
     (= (curve25519_dalek!specs.scalar_specs.scalar_as_nat.? (Poly%curve25519_dalek!scalar.Scalar.
        result!
       )
      ) (EucMod (curve25519_dalek!specs.core_specs.bytes_seq_as_nat.? (vstd!view.View.view.?
         $ (ARRAY $ (UINT 8) $ (CONST_INT 64)) (Poly%array%. input!)
        )
       ) (curve25519_dalek!specs.scalar52_specs.group_order.? (I 0))
   ))))
   :pattern ((req%curve25519_dalek!specs.proba_specs.axiom_uniform_mod_reduction. input!
     result!
   ))
   :qid internal_req__curve25519_dalek!specs.proba_specs.axiom_uniform_mod_reduction._definition
   :skolemid skolem_internal_req__curve25519_dalek!specs.proba_specs.axiom_uniform_mod_reduction._definition
)))
(declare-fun ens%curve25519_dalek!specs.proba_specs.axiom_uniform_mod_reduction. (
  %%Function%% curve25519_dalek!scalar.Scalar.
 ) Bool
)
(assert
 (forall ((input! %%Function%%) (result! curve25519_dalek!scalar.Scalar.)) (!
   (= (ens%curve25519_dalek!specs.proba_specs.axiom_uniform_mod_reduction. input! result!)
    (=>
     (curve25519_dalek!specs.proba_specs.is_uniform_bytes.? (vstd!array.spec_array_as_slice.?
       $ (UINT 8) $ (CONST_INT 64) (Poly%array%. input!)
     ))
     (curve25519_dalek!specs.proba_specs.is_uniform_scalar.? (Poly%curve25519_dalek!scalar.Scalar.
       result!
   ))))
   :pattern ((ens%curve25519_dalek!specs.proba_specs.axiom_uniform_mod_reduction. input!
     result!
   ))
   :qid internal_ens__curve25519_dalek!specs.proba_specs.axiom_uniform_mod_reduction._definition
   :skolemid skolem_internal_ens__curve25519_dalek!specs.proba_specs.axiom_uniform_mod_reduction._definition
)))

;; Function-Def curve25519_dalek::specs::proba_specs::axiom_uniform_mod_reduction
;; curve25519-dalek/src/specs/proba_specs.rs:292:1: 292:76 (#0)
(get-info :all-statistics)
(push)
 (declare-const input! %%Function%%)
 (declare-const result! curve25519_dalek!scalar.Scalar.)
 (assert
  fuel_defaults
 )
 (assert
  (has_type (Poly%array%. input!) (ARRAY $ (UINT 8) $ (CONST_INT 64)))
 )
 (assert
  (has_type (Poly%curve25519_dalek!scalar.Scalar. result!) TYPE%curve25519_dalek!scalar.Scalar.)
 )
 (assert
  (= (curve25519_dalek!specs.scalar_specs.scalar_as_nat.? (Poly%curve25519_dalek!scalar.Scalar.
     result!
