...
;; curve25519-dalek/src/lemmas/edwards_lemmas/mul_base_lemmas.rs:734:1: 734:73 (#0)
...
;; Function-Specs curve25519_dalek::lemmas::edwards_lemmas::mul_base_lemmas::lemma_reconstruct_radix16_even_odd
(declare-fun req%curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.lemma_reconstruct_radix16_even_odd.
 (vstd!seq.Seq<i8.>. Int) Bool
)
(declare-const %%global_location_label%%45 Bool)
(assert
 (forall ((digits! vstd!seq.Seq<i8.>.) (n! Int)) (!
   (= (req%curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.lemma_reconstruct_radix16_even_odd.
     digits! n!
    ) (=>
   ...
   :pattern ((req%curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.lemma_reconstruct_radix16_even_odd.
     digits! n!
   ))
   :qid internal_req__curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.lemma_reconstruct_radix16_even_odd._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.lemma_reconstruct_radix16_even_odd._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.lemma_reconstruct_radix16_even_odd.
 (vstd!seq.Seq<i8.>. Int) Bool
)
(assert
 (forall ((digits! vstd!seq.Seq<i8.>.) (n! Int)) (!
   (= (ens%curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.lemma_reconstruct_radix16_even_odd.
     digits! n!
    ) (= (curve25519_dalek!specs.scalar_specs.reconstruct_radix_16.? (vstd!seq.Seq.subrange.?
       $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I 0) (I (nClip (Mul 2 n!)))
      )
     ) (Add (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_even_scalar.?
       (Poly%vstd!seq.Seq<i8.>. digits!) (I n!)
      ) (Mul 16 (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_odd_scalar.?
        (Poly%vstd!seq.Seq<i8.>. digits!) (I n!)
   )))))
   :pattern ((ens%curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.lemma_reconstruct_radix16_even_odd.
     digits! n!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.lemma_reconstruct_radix16_even_odd._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.lemma_reconstruct_radix16_even_odd._definition
)))

;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::mul_base_lemmas::lemma_reconstruct_radix16_even_odd
;; curve25519-dalek/src/lemmas/edwards_lemmas/mul_base_lemmas.rs:734:1: 734:73 (#0)
...
(push)
 ...
 (declare-const tmp%2 vstd!seq.Seq<i8.>.)
 ...
 (declare-const pref@ vstd!seq.Seq<i8.>.)
 (declare-const r1@ Int)
 (declare-const rest@ vstd!seq.Seq<i8.>.)
     ...
     (and
      ...
      (=>
       ...
       (=>
        (= nm1@ (nClip (Sub n! 1)))
        (=>
         (= tmp%2 (%Poly%vstd!seq.Seq<i8.>. (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
             digits!
            ) (I 2) (I (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!)))
         )))
         (and
          (=>
           %%location_label%%1
           (check_decrease_int (let
             ((digits!$0 tmp%2) (n!$1 nm1@))
             n!$1
          ...
          (and
           ...
           (=>
            ...
            (=>
             (= pref@ (%Poly%vstd!seq.Seq<i8.>. (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
                 digits!
                ) (I 0) (I (nClip (Mul 2 n!)))
             )))
             (=>
              (= tmp%3 (= (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. pref@)) (nClip (
                  Mul 2 n!
              ))))
              (and
               (=>
               ...
               (=>
                tmp%3
                (=>
                 (= tmp%4 (>= (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. pref@)) 2))
                 (and
                  (=>
                   %%location_label%%4
                   tmp%4
                  ...
                  (=>
                   ...
                   (=>
                    ...
                    (=>
                     (fuel_bool fuel%curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.)
                     (=>
                      (= r1@ (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.? (vstd!seq.Seq.subrange.?
                         $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. pref@) (I 1) (I (vstd!seq.Seq.len.? $ (SINT 8)
                           (Poly%vstd!seq.Seq<i8.>. pref@)
                         ))
                        ) (I 4)
                      ))
                      (=>
                       (= tmp%5 (= (curve25519_dalek!specs.scalar_specs.reconstruct_radix_16.? (Poly%vstd!seq.Seq<i8.>.
                           pref@
                          )
                         ) (Add (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. pref@) (I 0)))
                          (Mul (vstd!arithmetic.power2.pow2.? (I 4)) r1@)
                       )))
                       (and
                        (=>
                         %%location_label%%5
                        ...
                        (=>
                         tmp%5
                         (=>
                          (= tmp%6 (> (vstd!seq.Seq.len.? $ (SINT 8) (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
                               pref@
                              ) (I 1) (I (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. pref@)))
                             )
                            ) 0
                          ))
                          (and
                           ...
                           (=>
                            ...
                            (and
                             (=>
                              ...
                              (=>
                               %%location_label%%7
                               (= r1@ (Add (%I (vstd!seq.Seq.index.? $ (SINT 8) (vstd!seq.Seq.subrange.? $ (SINT 8) (
                                     Poly%vstd!seq.Seq<i8.>. pref@
                                    ) (I 1) (I (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. pref@)))
                                   ) (I 0)
                                  )
                                 ) (Mul (vstd!arithmetic.power2.pow2.? (I 4)) (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.?
                                   (vstd!seq.Seq.subrange.? $ (SINT 8) (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
                                      pref@
                                     ) (I 1) (I (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. pref@)))
                             ...
                             (=>
                              ...
                              (=>
                               (= tmp%7 (ext_eq false (TYPE%vstd!seq.Seq. $ (SINT 8)) (vstd!seq.Seq.subrange.? $ (SINT
                                   8
                                  ) (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. pref@) (I 1) (I (vstd!seq.Seq.len.?
                                     $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. pref@)
                                   ))
                                  ) (I 1) (I (vstd!seq.Seq.len.? $ (SINT 8) (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
                                      pref@
                                     ) (I 1) (I (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. pref@)))
                                  )))
                                 ) (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. pref@) (I 2) (I (vstd!seq.Seq.len.?
                                    $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. pref@)
                               )))))
                               (and
                                (=>
                                ...
                                (=>
                                 tmp%7
                                 (=>
                                  (= tmp%8 (= (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.? (vstd!seq.Seq.subrange.?
                                      $ (SINT 8) (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. pref@) (I 1)
                                       (I (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. pref@)))
                                      ) (I 1) (I (vstd!seq.Seq.len.? $ (SINT 8) (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
                                          pref@
                                         ) (I 1) (I (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. pref@)))
                                      )))
                                      ...
                                      $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. pref@) (I 2) (I (vstd!seq.Seq.len.? $ (SINT 8)
                                        (Poly%vstd!seq.Seq<i8.>. pref@)
                                      ))
                                     ) (I 4)
                                  )))
                                   ...
                                   (=>
                                    ...
                                    (=>
                                     (= tmp%9 (= (vstd!seq.Seq.index.? $ (SINT 8) (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
                                       ...
                                       ) (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. pref@) (I 1))
                                     ))
                                     (and
                                      (=>
                                       %%location_label%%10
                                        ...
                                        (=>
                                         ...
                                         (and
                                          ...
                                          (=>
                                           (= (vstd!arithmetic.power2.pow2.? (I 8)) 256)
                                           (=>
                                            (ens%vstd!arithmetic.power2.lemma_pow2_adds. 4 4)
                                            (=>
                                             (= rest@ (%Poly%vstd!seq.Seq<i8.>. (vstd!seq.Seq.subrange.? $ (SINT 8) (vstd!seq.Seq.subrange.?
                                                 $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I 2) (I (vstd!seq.Seq.len.? $ (SINT 8)
                                                   (Poly%vstd!seq.Seq<i8.>. digits!)
                                                 ))
                                                ) (I 0) (I (nClip (Mul 2 nm1@)))
                                             )))
                                             (=>
                                              (= tmp%10 (ext_eq false (TYPE%vstd!seq.Seq. $ (SINT 8)) (vstd!seq.Seq.subrange.? $ (
                                                  SINT 8
                                                 ) (Poly%vstd!seq.Seq<i8.>. pref@) (I 2) (I (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
                                                    pref@
                                                 )))
                                                ) (Poly%vstd!seq.Seq<i8.>. rest@)
                                              ))
                                              (and
                                               (=>
                                                %%location_label%%13
                                               ...
                                               (=>
                                                tmp%10
                                                (=>
                                                 (= tmp%11 (= (curve25519_dalek!specs.scalar_specs.reconstruct_radix_16.? (Poly%vstd!seq.Seq<i8.>.
                                                     rest@
                                                    )
                                                   ) (Add (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_even_scalar.?
                                                     (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I 2) (I (vstd!seq.Seq.len.?
                                                 ...
                                                 (and
                                                  ...
                                                  (=>
                                                   tmp%11
                                                   (=>
                                                    (= tmp%12 (= (curve25519_dalek!specs.scalar_specs.reconstruct_radix_16.? (vstd!seq.Seq.subrange.?
                                                        $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. pref@) (I 2) (I (vstd!seq.Seq.len.? $ (SINT 8)
                                                          (Poly%vstd!seq.Seq<i8.>. pref@)
                                                       )))
                                                        ...
                                                        (and
                                                         (and
                                                          ...
                                                          (=>
                                                           ...
                                                           (and
                                                            (=>
                                                             (= tmp%13 (= r1@ (Add (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. pref@)
                                                                  (I 1)
                                                                 )
                                                                ) (Mul (vstd!arithmetic.power2.pow2.? (I 4)) (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.?
                                                                  (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. pref@) (I 2) (I (vstd!seq.Seq.len.?
                                                              ...
                                                              (=>
                                                               ...
                                                               (=>
                                                                ...
                                                                (= (Add (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. pref@) (I 0)))
                                                                  ...
                                                                  (Mul (vstd!arithmetic.power2.pow2.? (I 4)) (Add (%I (vstd!seq.Seq.index.? $ (SINT 8)
                                                                      (Poly%vstd!seq.Seq<i8.>. pref@) (I 1)
                                                                     )
                                                                    ) (Mul (vstd!arithmetic.power2.pow2.? (I 4)) (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.?
                                                                      (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. pref@) (I 2) (I (vstd!seq.Seq.len.?
                                                                         $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. pref@)
                                                            ...
                                                            (=>
                                                             ...
                                                             (and
                                                              (=>
                                                               ...
                                                               (=>
                                                                (= tmp%15 (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. pref@) (I 1))))
                                                                (=>
                                                                 (= tmp%16 (Mul (vstd!arithmetic.power2.pow2.? (I 4)) (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.?
                                                                    (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. pref@) (I 2) (I (vstd!seq.Seq.len.?
                                                                       $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. pref@)
                                                                     ))
                                                                    ) (I 4)
                                                                 ...
                                                                 (=>
                                                                  ...
                                                                  (=>
                                                                   ...
                                                                   (= (Add (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. pref@) (I 0)))
                                                                    ...
                                                                    ) (Add (Add (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. pref@) (I 0)))
                                                                      (Mul (vstd!arithmetic.power2.pow2.? (I 4)) (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
                                                                          pref@
                                                                         ) (I 1)
                                                                      )))
                                                                     ) (Mul (vstd!arithmetic.power2.pow2.? (I 4)) (Mul (vstd!arithmetic.power2.pow2.? (I 4))
                                                                       (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.? (vstd!seq.Seq.subrange.?
                                                                         $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. pref@) (I 2) (I (vstd!seq.Seq.len.? $ (SINT 8)
                                                                           (Poly%vstd!seq.Seq<i8.>. pref@)
                                                                         ))
                                                              ...
                                                              (=>
                                                               ...
                                                               (and
                                                                (=>
                                                                 (= tmp%17 (vstd!arithmetic.power2.pow2.? (I 4)))
                                                                 (=>
                                                                  (= tmp%18 (vstd!arithmetic.power2.pow2.? (I 4)))
                                                                  (=>
                                                                   (= tmp%19 (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.? (vstd!seq.Seq.subrange.?
                                                                      $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. pref@) (I 2) (I (vstd!seq.Seq.len.? $ (SINT 8)
                                                                        (Poly%vstd!seq.Seq<i8.>. pref@)
                                                                      ))
                                                                     ) (I 4)
                                                                   ...
                                                                   (=>
                                                                    (ens%vstd!arithmetic.mul.lemma_mul_is_associative. tmp%17 tmp%18 tmp%19)
                                                                    (=>
                                                                     (= tmp%20 (= (Mul (vstd!arithmetic.power2.pow2.? (I 4)) (vstd!arithmetic.power2.pow2.?
                                                                         (I 4)
                                                                        )
                                                                      ...
                                                                      (=>
                                                                       ...
                                                                       (=>
                                                                        ...
                                                                        (= (Add (Add (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. pref@) (I 0)))
                                                                           ...
                                                                           (Mul 16 (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. pref@) (I 1))))
                                                                          ) (Mul (vstd!arithmetic.power2.pow2.? (I 8)) (curve25519_dalek!specs.scalar_specs.reconstruct_radix_16.?
                                                                            (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. pref@) (I 2) (I (vstd!seq.Seq.len.?
                                                                               $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. pref@)
                                                                )))))))))))))))
                                                                (=>
                                                                 ...
                                                                 (and
                                                                  (and
                                                                   (=>
                                                                    ...
                                                                    (=>
                                                                     %%location_label%%22
                                                                     (= (vstd!arithmetic.power2.pow2.? (I 8)) (curve25519_dalek!specs.edwards_specs.pow256.?
                                                                       (I 1)
                                                                   ))))
                                                                   (=>
                                                                    (= (vstd!arithmetic.power2.pow2.? (I 8)) (curve25519_dalek!specs.edwards_specs.pow256.?
                                                                    ...
                                                                    (=>
                                                                     (= tmp%21 (= (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. pref@) (I 0))
                                                                     ...
                                                                     (and
                                                                      ...
                                                                      (=>
                                                                       tmp%21
                                                                       (=>
                                                                        (= tmp%22 (= (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. pref@) (I 1))
                                                                          (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I 1))
                                                                        ))
                                                                        (and
                                                                         (=>
                                                                          %%location_label%%24
                                                                         ...
                                                                         (=>
                                                                          tmp%22
                                                                          (=>
                                                                           (= tmp%23 (= (curve25519_dalek!specs.scalar_specs.reconstruct_radix_16.? (vstd!seq.Seq.subrange.?
                                                                               $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. pref@) (I 2) (I (vstd!seq.Seq.len.? $ (SINT 8)
                                                                                 (Poly%vstd!seq.Seq<i8.>. pref@)
                                                                              )))
                                                                             ) (Add (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_even_scalar.?
                                                                            ...
                                                                            (=>
                                                                             ...
                                                                             (=>
                                                                              ...
                                                                              (= (Add (Add (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. pref@) (I 0)))
                                                                               ...
                                                                               ) (Add (Add (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I
                                                                                    0
                                                                                  ))
                                                                                 ) (Mul 16 (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I 1))))
                                                                                ) (Mul (curve25519_dalek!specs.edwards_specs.pow256.? (I 1)) (Add (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_even_scalar.?
                                                                                   (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I 2) (I (vstd!seq.Seq.len.?
                                                                                      $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!)
                                                                                    ))
                                                                                   ) (I nm1@)
                                                                  ...
                                                                  (=>
                                                                   ...
                                                                   (and
                                                                    (=>
                                                                     (= tmp%24 (curve25519_dalek!specs.edwards_specs.pow256.? (I 1)))
                                                                     (=>
                                                                      (= tmp%25 (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_even_scalar.?
                                                                        (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I 2) (I (vstd!seq.Seq.len.?
                                                                           $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!)
                                                                         ))
                                                                        ) (I nm1@)
                                                                      ...
                                                                      (=>
                                                                       (= tmp%26 (Mul 16 (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_odd_scalar.?
                                                                          (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I 2) (I (vstd!seq.Seq.len.?
                                                                             $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!)
                                                                           ))
                                                                          ) (I nm1@)
                                                                       ...
                                                                       (=>
                                                                        (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add. tmp%24 tmp%25 tmp%26)
                                                                        (=>
                                                                         %%location_label%%27
                                                                         (= (Add (Add (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I
                                                                               0
                                                                          ...
                                                                          ) (Add (Add (Add (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!)
                                                                               (I 0)
                                                                              )
                                                                             ) (Mul 16 (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I 1))))
                                                                            ) (Mul (curve25519_dalek!specs.edwards_specs.pow256.? (I 1)) (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_even_scalar.?
                                                                              (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I 2) (I (vstd!seq.Seq.len.?
                                                                                 $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!)
                                                                               ))
                                                                              ) (I nm1@)
                                                                            ))
                                                                           ) (Mul (curve25519_dalek!specs.edwards_specs.pow256.? (I 1)) (Mul 16 (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_odd_scalar.?
                                                                              (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I 2) (I (vstd!seq.Seq.len.?
                                                                                 $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!)
                                                                               ))
                                                                              ) (I nm1@)
                                                                    ...
                                                                    (=>
                                                                     ...
                                                                     (and
                                                                      (=>
                                                                       (= tmp%27 (= (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_even_scalar.?
                                                                          (Poly%vstd!seq.Seq<i8.>. digits!) (I n!)
                                                                         ) (Add (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I 0)))
                                                                          (Mul (curve25519_dalek!specs.edwards_specs.pow256.? (I 1)) (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_even_scalar.?
                                                                            (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I 2) (I (vstd!seq.Seq.len.?
                                                                               $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!)
                                                                             ))
                                                                       ...
                                                                       (and
                                                                        ...
                                                                        (=>
                                                                         tmp%27
                                                                         (=>
                                                                          (= tmp%28 (= (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_odd_scalar.?
                                                                             (Poly%vstd!seq.Seq<i8.>. digits!) (I n!)
                                                                            ) (Add (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I 1)))
                                                                             (Mul (curve25519_dalek!specs.edwards_specs.pow256.? (I 1)) (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_odd_scalar.?
                                                                               (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I 2) (I (vstd!seq.Seq.len.?
                                                                                  $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!)
                                                                                ))
                                                                               ) (I nm1@)
                                                                          ...
                                                                          (and
                                                                           ...
                                                                           (=>
                                                                            tmp%28
                                                                            (=>
                                                                             (= tmp%29 (curve25519_dalek!specs.edwards_specs.pow256.? (I 1)))
                                                                             (=>
                                                                              (= tmp%30 (curve25519_dalek!lemmas.edwards_lemmas.mul_base_lemmas.radix16_odd_scalar.?
                                                                                (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I 2) (I (vstd!seq.Seq.len.?
                                                                                   $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!)
                                                                                 ))
                                                                                ) (I nm1@)
                                                                              ...
                                                                              (=>
                                                                               (ens%vstd!arithmetic.mul.lemma_mul_is_associative. tmp%29 16 tmp%30)
                                                                               (=>
                                                                                %%location_label%%30
                                                                                (= (Add (Add (Add (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!)
                                                                                      (I 0)
