...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:2572:1: 2572:63 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_pm_minus_mp
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:2572:1: 2572:63 (#0)
        ...
        (=>
         ...
         (=>
          ...
          (= (curve25519_dalek!specs.field_specs.field_sub.? (I (curve25519_dalek!specs.field_specs.field_mul.?
              ...
              (I (curve25519_dalek!specs.field_specs.field_mul.? (I a!) (I neg_d@))) (I bc@)
        ))))))
        (=>
         (= (curve25519_dalek!specs.field_specs.field_sub.? (I (curve25519_dalek!specs.field_specs.field_mul.?
             (I (curve25519_dalek!specs.field_specs.field_add.? (I a!) (I b!))) (I (curve25519_dalek!specs.field_specs.field_add.?
         ...
         (and
          (=>
           ...
           (=>
            %%location_label%%1
            (= (curve25519_dalek!specs.field_specs.field_mul.? (I a!) (I neg_d@)) (curve25519_dalek!specs.field_specs.field_neg.?
              (I ad@)
          ))))
          (=>
           (= (curve25519_dalek!specs.field_specs.field_mul.? (I a!) (I neg_d@)) (curve25519_dalek!specs.field_specs.field_neg.?
           ...
           (and
            (=>
             ...
             (=>
              (= tmp%1 (= (nClip (Add (curve25519_dalek!specs.field_specs.field_neg.? (I ad@)) bc@))
                (nClip (Add bc@ (curve25519_dalek!specs.field_specs.field_neg.? (I ad@))))
              ))
              (and
               (=>
                %%location_label%%2
               ...
               (=>
                ...
                (=>
                 ...
                 (= (curve25519_dalek!specs.field_specs.field_add.? (I (curve25519_dalek!specs.field_specs.field_neg.?
                  ...
                  ) (curve25519_dalek!specs.field_specs.field_sub.? (I bc@) (I ad@))
            ))))))
            (=>
             (= (curve25519_dalek!specs.field_specs.field_add.? (I (curve25519_dalek!specs.field_specs.field_neg.?
                 (I ad@)
