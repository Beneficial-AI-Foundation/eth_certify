...
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_m1_lemmas.rs:676:1: 676:48 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::sqrt_m1_lemmas::lemma_fourth_root_of_unity
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_m1_lemmas.rs:676:1: 676:48 (#0)
...
(push)
 ...
 (declare-const y_pow@ Int)
 (declare-const y@ Int)
 (declare-const x_half_mod@ Int)
 (assert
  fuel_defaults
 )
 (assert
       ...
       (=>
        ...
        (and
         (=>
          ...
          (=>
           %%location_label%%0
           (= (nClip (Mul quarter@ 2)) half@)
         ))
         (=>
          (= (nClip (Mul quarter@ 2)) half@)
          (=>
           (= y_pow@ (vstd!arithmetic.power.pow.? (I x!) (I quarter@)))
           (and
            (and
             (=>
              %%location_label%%1
              (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow_nonnegative. x! quarter@)
             )
             (=>
              (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow_nonnegative. x! quarter@)
              (=>
               %%location_label%%2
               (>= y_pow@ 0)
            )))
            (=>
             (>= y_pow@ 0)
             (=>
              (= y@ (EucMod (nClip y_pow@) pn@))
              (and
               (=>
                (ens%vstd!arithmetic.power.lemma_pow_multiplies. x! quarter@ 2)
                (=>
                 %%location_label%%3
                 (= (vstd!arithmetic.power.pow.? (I y_pow@) (I 2)) (vstd!arithmetic.power.pow.? (I x!)
                   (I half@)
               ))))
               (=>
                (= (vstd!arithmetic.power.pow.? (I y_pow@) (I 2)) (vstd!arithmetic.power.pow.? (I x!)
                ...
                (and
                 (and
                  (=>
                   %%location_label%%4
                   (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop. y_pow@ y_pow@ pn@)
                  )
                  (=>
                   (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop. y_pow@ y_pow@ pn@)
                   (=>
                    (ens%curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.lemma_pow_2_is_mul.
                     y_pow@
                    )
                    (=>
                     %%location_label%%5
                     (= (EucMod (nClip (Mul y@ y@)) pn@) (EucMod (nClip (vstd!arithmetic.power.pow.? (I x!)
                         (I half@)
                        )
                       ) pn@
                 ))))))
                 (=>
                  ...
                  (and
                   ...
                   (=>
                    ...
                    (=>
                     (= x_half_mod@ (EucMod (nClip (vstd!arithmetic.power.pow.? (I x!) (I half@))) pn@))
                     (=>
                      (= tmp%1 (or
                        (= x_half_mod@ 1)
                        (= x_half_mod@ (nClip (Sub pn@ 1)))
                      ))
                      (and
                       (=>
                        %%location_label%%7
                        ...
                        (or
                         (and
                          (=>
                           (= x_half_mod@ 1)
                           (=>
                            (= tmp%2 (= (EucMod (nClip (Mul y@ y@)) pn@) 1))
                            (and
                             (=>
                              %%location_label%%8
                              tmp%2
                                 ...
                                 (and
                                  ...
                                  (=>
                                   ...
                                   (and
                                    (=>
                                     %%location_label%%11
                                     (req%vstd!arithmetic.div_mod.lemma_small_mod. y@ pn@)
                                    )
                                    (=>
                                     (ens%vstd!arithmetic.div_mod.lemma_small_mod. y@ pn@)
                                     %%switch_label%%0
                          )))))))))))
                          (=>
                           (not (= x_half_mod@ 1))
                           (=>
                            (= tmp%4 (= (EucMod (nClip (Mul y@ y@)) pn@) (nClip (Sub pn@ 1))))
                            (and
                             (=>
                              %%location_label%%12
                              tmp%4
                             ...
                             (=>
                              ...
                              (=>
                               (= i@ (curve25519_dalek!specs.field_specs.sqrt_m1.? (I 0)))
                               (=>
                                (ens%curve25519_dalek!lemmas.field_lemmas.sqrt_m1_lemmas.lemma_sqrt_m1_nonzero. 0)
                                (and
                                 (=>
                                  %%location_label%%13
                                  (req%curve25519_dalek!lemmas.field_lemmas.sqrt_m1_lemmas.lemma_square_root_of_neg_one.
