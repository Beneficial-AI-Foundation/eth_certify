...
;; curve25519-dalek/src/backend/serial/u64/field.rs:864:5: 864:57 (#0)
...
;; Function-Def curve25519_dalek::backend::serial::u64::field::FieldElement51::reduce
;; curve25519-dalek/src/backend/serial/u64/field.rs:864:5: 864:57 (#0)
...
(push)
 ...
 (declare-const limbs@2 %%Function%%)
 (declare-const limbs@3 %%Function%%)
 (declare-const limbs@4 %%Function%%)
 (declare-const limbs@5 %%Function%%)
 (declare-const limbs@6 %%Function%%)
 (declare-const limbs@7 %%Function%%)
 (declare-const limbs@8 %%Function%%)
 (declare-const limbs@9 %%Function%%)
 (declare-const limbs@10 %%Function%%)
 ...
 (assert
  (not (=>
    (= limbs@0 limbs!)
    (=>
     (ens%curve25519_dalek!lemmas.field_lemmas.reduce_lemmas.lemma_reduce_boundaries. limbs@0)
     (=>
      (ens%curve25519_dalek!lemmas.field_lemmas.reduce_lemmas.proof_reduce. limbs@0)
      (=>
       (ens%curve25519_dalek!lemmas.field_lemmas.reduce_lemmas.lemma_reduce_bound_2p. limbs@0)
       (and
        (=>
         %%location_label%%0
         (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) limbs@0 0)
        )
        (=>
         (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) limbs@0 0 tmp%1)
         (and
          (=>
           %%location_label%%1
           (and
          ...
          (=>
           ...
           (=>
            (= c0@ (uClip 64 (bitshr (I (%I tmp%1)) (I 51))))
            (and
             (=>
              %%location_label%%2
              (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) limbs@0 1)
             )
             (=>
              (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) limbs@0 1 tmp%2)
              (and
               (=>
                %%location_label%%3
                (and
               ...
               (=>
                ...
                (=>
                 (= c1@ (uClip 64 (bitshr (I (%I tmp%2)) (I 51))))
                 (and
                  (=>
                   %%location_label%%4
                   (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) limbs@0 2)
                  )
                  (=>
                   (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) limbs@0 2 tmp%3)
                   (and
                    (=>
                     %%location_label%%5
                     (and
                    ...
                    (=>
                     ...
                     (=>
                      (= c2@ (uClip 64 (bitshr (I (%I tmp%3)) (I 51))))
                      (and
                       (=>
                        %%location_label%%6
                        (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) limbs@0 3)
                       )
                       (=>
                        (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) limbs@0 3 tmp%4)
                        (and
                         (=>
                          %%location_label%%7
                          (and
                         ...
                         (=>
                          ...
                          (=>
                           (= c3@ (uClip 64 (bitshr (I (%I tmp%4)) (I 51))))
                           (and
                            (=>
                             %%location_label%%8
                             (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) limbs@0 4)
                            )
                            (=>
                             (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) limbs@0 4 tmp%5)
                             (and
                              (=>
                               %%location_label%%9
                               (and
                              ...
                              (=>
                               ...
                               (=>
                                (= c4@ (uClip 64 (bitshr (I (%I tmp%5)) (I 51))))
                                (=>
                                 (= tmp%7 0)
                                 (and
                                  (=>
                                  ...
                                  (=>
                                   (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) limbs@0 0 tmp%6)
                                   (=>
                                    (= tmp%8 (uClip 64 (bitand (I (%I tmp%6)) (I curve25519_dalek!backend.serial.u64.field.LOW_51_BIT_MASK.?))))
                                    (and
                                     (=>
                                      %%location_label%%11
                                      (req%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                       $ (UINT 64) (Poly%array%. limbs@0) (I tmp%7) (I tmp%8)
                                     ))
                                     (=>
                                      (has_type (Poly%array%. limbs@1) (ARRAY $ (UINT 64) $ (CONST_INT 5)))
                                      (=>
                                       (ens%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                        $ (UINT 64) (Poly%array%. limbs@0) (Poly%array%. limbs@1) (I tmp%7) (I tmp%8)
                                       )
                                       (=>
                                        (= tmp%10 1)
                                        (and
                                         (=>
                                          %%location_label%%12
                                          (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) limbs@1 1)
                                         )
                                         (=>
                                          (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) limbs@1 1 tmp%9)
                                          (=>
                                           (= tmp%11 (uClip 64 (bitand (I (%I tmp%9)) (I curve25519_dalek!backend.serial.u64.field.LOW_51_BIT_MASK.?))))
                                           (and
                                            (=>
                                             %%location_label%%13
                                             (req%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                              $ (UINT 64) (Poly%array%. limbs@1) (I tmp%10) (I tmp%11)
                                            ))
                                            (=>
                                             (has_type (Poly%array%. limbs@2) (ARRAY $ (UINT 64) $ (CONST_INT 5)))
                                             (=>
                                              (ens%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                               $ (UINT 64) (Poly%array%. limbs@1) (Poly%array%. limbs@2) (I tmp%10) (I tmp%11)
                                              )
                                              (=>
                                               (= tmp%13 2)
                                               (and
                                                (=>
                                                 %%location_label%%14
                                                 (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) limbs@2 2)
                                                )
                                                (=>
                                                 (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) limbs@2 2 tmp%12)
                                                 (=>
                                                  (= tmp%14 (uClip 64 (bitand (I (%I tmp%12)) (I curve25519_dalek!backend.serial.u64.field.LOW_51_BIT_MASK.?))))
                                                  (and
                                                   (=>
                                                    %%location_label%%15
                                                    (req%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                                     $ (UINT 64) (Poly%array%. limbs@2) (I tmp%13) (I tmp%14)
                                                   ))
                                                   (=>
                                                    (has_type (Poly%array%. limbs@3) (ARRAY $ (UINT 64) $ (CONST_INT 5)))
                                                    (=>
                                                     (ens%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                                      $ (UINT 64) (Poly%array%. limbs@2) (Poly%array%. limbs@3) (I tmp%13) (I tmp%14)
                                                     )
                                                     (=>
                                                      (= tmp%16 3)
                                                      (and
                                                       (=>
                                                        %%location_label%%16
                                                        (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) limbs@3 3)
                                                       )
                                                       (=>
                                                        (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) limbs@3 3 tmp%15)
                                                        (=>
                                                         (= tmp%17 (uClip 64 (bitand (I (%I tmp%15)) (I curve25519_dalek!backend.serial.u64.field.LOW_51_BIT_MASK.?))))
                                                         (and
                                                          (=>
                                                           %%location_label%%17
                                                           (req%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                                            $ (UINT 64) (Poly%array%. limbs@3) (I tmp%16) (I tmp%17)
                                                          ))
                                                          (=>
                                                           (has_type (Poly%array%. limbs@4) (ARRAY $ (UINT 64) $ (CONST_INT 5)))
                                                           (=>
                                                            (ens%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                                             $ (UINT 64) (Poly%array%. limbs@3) (Poly%array%. limbs@4) (I tmp%16) (I tmp%17)
                                                            )
                                                            (=>
                                                             (= tmp%19 4)
                                                             (and
                                                              (=>
                                                               %%location_label%%18
                                                               (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) limbs@4 4)
                                                              )
                                                              (=>
                                                               (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) limbs@4 4 tmp%18)
                                                               (=>
                                                                (= tmp%20 (uClip 64 (bitand (I (%I tmp%18)) (I curve25519_dalek!backend.serial.u64.field.LOW_51_BIT_MASK.?))))
                                                                (and
                                                                 (=>
                                                                  %%location_label%%19
                                                                  (req%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                                                   $ (UINT 64) (Poly%array%. limbs@4) (I tmp%19) (I tmp%20)
                                                                 ))
                                                                 (=>
                                                                  (has_type (Poly%array%. limbs@5) (ARRAY $ (UINT 64) $ (CONST_INT 5)))
                                                                  (=>
                                                                   (ens%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                                                    $ (UINT 64) (Poly%array%. limbs@4) (Poly%array%. limbs@5) (I tmp%19) (I tmp%20)
                                                                   )
                                                                   (=>
                                                                    (= tmp%23 0)
                                                                    (and
                                                                     (=>
                                                                      %%location_label%%20
                                                                      (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) limbs@5 0)
                                                                     )
                                                                     (=>
                                                                      (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) limbs@5 0 tmp%21)
                                                                      (=>
                                                                       (= tmp%22 tmp%21)
                                                                       (and
                                                                        (=>
                                                                        ...
                                                                        (=>
                                                                         ...
                                                                         (and
                                                                          (=>
                                                                           %%location_label%%22
                                                                           (uInv 64 (Add (%I tmp%22) (uClip 64 (Mul c4@ 19))))
                                                                          )
                                                                          (=>
                                                                           (uInv 64 (Add (%I tmp%22) (uClip 64 (Mul c4@ 19))))
                                                                           (=>
                                                                            (= tmp%24 (uClip 64 (Add (%I tmp%22) (uClip 64 (Mul c4@ 19)))))
                                                                            (and
                                                                             (=>
                                                                              %%location_label%%23
                                                                              (req%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                                                               $ (UINT 64) (Poly%array%. limbs@5) (I tmp%23) (I tmp%24)
                                                                             ))
                                                                             (=>
                                                                              (has_type (Poly%array%. limbs@6) (ARRAY $ (UINT 64) $ (CONST_INT 5)))
                                                                              (=>
                                                                               (ens%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                                                                $ (UINT 64) (Poly%array%. limbs@5) (Poly%array%. limbs@6) (I tmp%23) (I tmp%24)
                                                                               )
                                                                               (=>
                                                                                (= tmp%26 1)
                                                                                (and
                                                                                 (=>
                                                                                  %%location_label%%24
                                                                                  (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) limbs@6 1)
                                                                                 )
                                                                                 (=>
                                                                                  (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) limbs@6 1 tmp%25)
                                                                                  (and
                                                                                   (=>
                                                                                    %%location_label%%25
                                                                                    (uInv 64 (Add (%I tmp%25) c0@))
                                                                                   )
                                                                                   (=>
                                                                                    (uInv 64 (Add (%I tmp%25) c0@))
                                                                                    (=>
                                                                                     (= tmp%27 (uClip 64 (Add (%I tmp%25) c0@)))
                                                                                     (and
                                                                                      (=>
                                                                                       %%location_label%%26
                                                                                       (req%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                                                                        $ (UINT 64) (Poly%array%. limbs@6) (I tmp%26) (I tmp%27)
                                                                                      ))
                                                                                      (=>
                                                                                       (has_type (Poly%array%. limbs@7) (ARRAY $ (UINT 64) $ (CONST_INT 5)))
                                                                                       (=>
                                                                                        (ens%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                                                                         $ (UINT 64) (Poly%array%. limbs@6) (Poly%array%. limbs@7) (I tmp%26) (I tmp%27)
                                                                                        )
                                                                                        (=>
                                                                                         (= tmp%29 2)
                                                                                         (and
                                                                                          (=>
                                                                                           %%location_label%%27
                                                                                           (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) limbs@7 2)
                                                                                          )
                                                                                          (=>
                                                                                           (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) limbs@7 2 tmp%28)
                                                                                           (and
                                                                                            (=>
                                                                                             %%location_label%%28
                                                                                             (uInv 64 (Add (%I tmp%28) c1@))
                                                                                            )
                                                                                            (=>
                                                                                             (uInv 64 (Add (%I tmp%28) c1@))
                                                                                             (=>
                                                                                              (= tmp%30 (uClip 64 (Add (%I tmp%28) c1@)))
                                                                                              (and
                                                                                               (=>
                                                                                                %%location_label%%29
                                                                                                (req%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                                                                                 $ (UINT 64) (Poly%array%. limbs@7) (I tmp%29) (I tmp%30)
                                                                                               ))
                                                                                               (=>
                                                                                                (has_type (Poly%array%. limbs@8) (ARRAY $ (UINT 64) $ (CONST_INT 5)))
                                                                                                (=>
                                                                                                 (ens%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                                                                                  $ (UINT 64) (Poly%array%. limbs@7) (Poly%array%. limbs@8) (I tmp%29) (I tmp%30)
                                                                                                 )
                                                                                                 (=>
                                                                                                  (= tmp%32 3)
                                                                                                  (and
                                                                                                   (=>
                                                                                                    %%location_label%%30
                                                                                                    (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) limbs@8 3)
                                                                                                   )
                                                                                                   (=>
                                                                                                    (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) limbs@8 3 tmp%31)
                                                                                                    (and
                                                                                                     (=>
                                                                                                      %%location_label%%31
                                                                                                      (uInv 64 (Add (%I tmp%31) c2@))
                                                                                                     )
                                                                                                     (=>
                                                                                                      (uInv 64 (Add (%I tmp%31) c2@))
                                                                                                      (=>
                                                                                                       (= tmp%33 (uClip 64 (Add (%I tmp%31) c2@)))
                                                                                                       (and
                                                                                                        (=>
                                                                                                         %%location_label%%32
                                                                                                         (req%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                                                                                          $ (UINT 64) (Poly%array%. limbs@8) (I tmp%32) (I tmp%33)
                                                                                                        ))
                                                                                                        (=>
                                                                                                         (has_type (Poly%array%. limbs@9) (ARRAY $ (UINT 64) $ (CONST_INT 5)))
                                                                                                         (=>
                                                                                                          (ens%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                                                                                           $ (UINT 64) (Poly%array%. limbs@8) (Poly%array%. limbs@9) (I tmp%32) (I tmp%33)
                                                                                                          )
                                                                                                          (=>
                                                                                                           (= tmp%35 4)
                                                                                                           (and
                                                                                                            (=>
                                                                                                             %%location_label%%33
                                                                                                             (req%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) limbs@9 4)
                                                                                                            )
                                                                                                            (=>
                                                                                                             (ens%vstd!array.array_index_get. $ (UINT 64) $ (CONST_INT 5) limbs@9 4 tmp%34)
                                                                                                             (and
                                                                                                              (=>
                                                                                                               %%location_label%%34
                                                                                                               (uInv 64 (Add (%I tmp%34) c3@))
                                                                                                              )
                                                                                                              (=>
                                                                                                               (uInv 64 (Add (%I tmp%34) c3@))
                                                                                                               (=>
                                                                                                                (= tmp%36 (uClip 64 (Add (%I tmp%34) c3@)))
                                                                                                                (and
                                                                                                                 (=>
                                                                                                                  %%location_label%%35
                                                                                                                  (req%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                                                                                                   $ (UINT 64) (Poly%array%. limbs@9) (I tmp%35) (I tmp%36)
                                                                                                                 ))
                                                                                                                 (=>
                                                                                                                  (has_type (Poly%array%. limbs@10) (ARRAY $ (UINT 64) $ (CONST_INT 5)))
                                                                                                                  (=>
                                                                                                                   (ens%vstd!std_specs.core.index_set. $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) $ USIZE
                                                                                                                    $ (UINT 64) (Poly%array%. limbs@9) (Poly%array%. limbs@10) (I tmp%35) (I tmp%36)
                                                                                                                   )
                                                                                                                   (=>
                                                                                                                    (= r! (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51 (%Poly%array%.
                                                                                                                       (Poly%array%. limbs@10)
                                                                                                                    )))
                                                                                                                    (and
                                                                                                                     (=>
                                                                                                                       ...
                                                                                                                       (=>
                                                                                                                        ...
                                                                                                                        (=>
                                                                                                                         (forall ((i$ Poly)) (!
                                                                                                                           ...
                                                                                                                           :qid user_curve25519_dalek__backend__serial__u64__field__FieldElement51__reduce_77
                                                                                                                           :skolemid skolem_user_curve25519_dalek__backend__serial__u64__field__FieldElement51__reduce_77
                                                                                                                         ))
                                                                                                                         (ext_eq false (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
                                                                                                                            (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                                                                                                                              r!
