...
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:57:1: 57:39 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::curve_equation_lemmas::lemma_identity_on_curve
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:57:1: 57:39 (#0)
      ...
      (=>
       ...
       (and
        ...
        (=>
         (= x2@ 0)
         (=>
          (= y2@ (curve25519_dalek!specs.field_specs.field_square.? (I 1)))
          (and
           (and
            (=>
             %%location_label%%2
                ...
                (and
                 ...
                 (=>
                  ...
                  (and
                   (=>
                    %%location_label%%6
                    (req%vstd!arithmetic.div_mod.lemma_mod_multiples_vanish. 1 1 modulus@)
                   )
                   (=>
                    (ens%vstd!arithmetic.div_mod.lemma_mod_multiples_vanish. 1 1 modulus@)
                    (=>
                     %%location_label%%7
                     (= lhs@ 1)
              )))))))
