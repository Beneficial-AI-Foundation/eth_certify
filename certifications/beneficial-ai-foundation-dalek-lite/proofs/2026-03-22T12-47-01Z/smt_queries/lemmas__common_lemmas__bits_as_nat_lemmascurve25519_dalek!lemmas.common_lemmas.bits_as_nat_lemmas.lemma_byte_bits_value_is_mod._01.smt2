...
;; curve25519-dalek/src/lemmas/common_lemmas/bits_as_nat_lemmas.rs:240:13: 240:19 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::bits_as_nat_lemmas::lemma_byte_bits_value_is_mod
;; curve25519-dalek/src/lemmas/common_lemmas/bits_as_nat_lemmas.rs:240:13: 240:19 (#0)
...
(assert
 (not (=>
   %%location_label%%0
   (= (bvlshr byte! ((_ zero_extend 4) (_ bv8 4))) ((_ zero_extend 7) (_ bv0 1)))
)))
(get-info :version)
