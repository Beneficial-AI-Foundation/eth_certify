...
;; curve25519-dalek/src/lemmas/common_lemmas/div_mod_lemmas.rs:354:1: 354:64 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::div_mod_lemmas::lemma_mul_by_minus_one_is_negation
;; curve25519-dalek/src/lemmas/common_lemmas/div_mod_lemmas.rs:354:1: 354:64 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= a_mod@ (EucMod a! m!))
    (=>
     (= m_minus_1@ (nClip (Sub m! 1)))
     (=>
      (= neg_a@ (nClip (Sub m! a_mod@)))
      (and
       (=>
        (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub. a! m! 1)
        (=>
         %%location_label%%0
         (= (nClip (Mul a! m_minus_1@)) (Sub (nClip (Mul a! m!)) a!))
       ))
       (=>
        (= (nClip (Mul a! m_minus_1@)) (Sub (nClip (Mul a! m!)) a!))
        (and
         (and
          (=>
           %%location_label%%1
           (req%vstd!arithmetic.div_mod.lemma_mod_multiples_basic. a! m!)
          )
          (=>
           (ens%vstd!arithmetic.div_mod.lemma_mod_multiples_basic. a! m!)
           (=>
            %%location_label%%2
            (= (EucMod (nClip (Mul a! m!)) m!) 0)
         )))
         (=>
          (= (EucMod (nClip (Mul a! m!)) m!) 0)
          (and
           (=>
            ...
            (and
             (=>
              %%location_label%%3
              (req%vstd!arithmetic.div_mod.lemma_sub_mod_noop. tmp%1 a! m!)
             )
             (=>
              (ens%vstd!arithmetic.div_mod.lemma_sub_mod_noop. tmp%1 a! m!)
              (=>
               %%location_label%%4
               (= (EucMod (Sub (nClip (Mul a! m!)) a!) m!) (EucMod (Sub 0 a_mod@) m!))
           ))))
           (=>
            (= (EucMod (Sub (nClip (Mul a! m!)) a!) m!) (EucMod (Sub 0 a_mod@) m!))
            (and
             (=>
              ...
              (and
               (=>
                %%location_label%%5
                (req%vstd!arithmetic.div_mod.lemma_mod_add_multiples_vanish. tmp%2 m!)
               )
               (=>
                (ens%vstd!arithmetic.div_mod.lemma_mod_add_multiples_vanish. tmp%2 m!)
                (=>
                 %%location_label%%6
                 (= (EucMod (Sub 0 a_mod@) m!) (EucMod (Sub m! a_mod@) m!))
             ))))
             (=>
              (= (EucMod (Sub 0 a_mod@) m!) (EucMod (Sub m! a_mod@) m!))
              (=>
               (= tmp%3 (= (EucMod (Sub m! a_mod@) m!) (EucMod neg_a@ m!)))
               (and
                (=>
                 %%location_label%%7
                 tmp%3
                ...
                (=>
                 ...
                 (and
                  (and
                   (=>
                    %%location_label%%8
                    (req%vstd!arithmetic.mul.lemma_mul_inequality. 1 m! a!)
                   )
                   (=>
                    (ens%vstd!arithmetic.mul.lemma_mul_inequality. 1 m! a!)
                    (=>
                     (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. 1 a!)
                     (=>
                      (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. m! a!)
                      (=>
                       %%location_label%%9
                       (>= (Mul a! m!) a!)
                  )))))
                  (=>
                   (>= (Mul a! m!) a!)
                   (=>
                    (= tmp%4 (= (nClip (Mul a! m_minus_1@)) (Sub (Mul a! m!) a!)))
                    (and
                     (=>
                      %%location_label%%10
                      tmp%4
                      ...
                      (=>
                       ...
                       (and
                        ...
                        (=>
                         tmp%5
                         (=>
                          (= tmp%6 (= (EucMod (nClip (Mul a! m_minus_1@)) m!) (EucMod neg_a@ m!)))
                          (and
                           (=>
                            %%location_label%%12
                            tmp%6
                           ...
                           (=>
                            ...
                            (=>
                             %%location_label%%13
                             (= (EucMod (nClip (Mul a! (nClip (Sub m! 1)))) m!) (EucMod (nClip (Sub m! (EucMod a! m!)))
                               m!
 ))))))))))))))))))))))))))))))
 (get-info :version)
