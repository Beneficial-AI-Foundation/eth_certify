...
;; curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:1138:1: 1138:50 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::pow_lemmas::lemma_pow2_geometric
;; curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:1138:1: 1138:50 (#0)
...
(push)
 ...
 (assert
  (not (=>
    ...
    (=>
     (ens%vstd!arithmetic.power2.lemma_pow2_adds. a! b!)
     (=>
      (= tmp%1 (vstd!arithmetic.power2.pow2.? (I b!)))
      (=>
       (= tmp%2 (vstd!arithmetic.power2.pow2.? (I a!)))
       (=>
        (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub. tmp%1 tmp%2 1)
        (=>
         %%location_label%%0
         (= (Add (Mul (Sub (vstd!arithmetic.power2.pow2.? (I a!)) 1) (vstd!arithmetic.power2.pow2.?
             (I b!)
