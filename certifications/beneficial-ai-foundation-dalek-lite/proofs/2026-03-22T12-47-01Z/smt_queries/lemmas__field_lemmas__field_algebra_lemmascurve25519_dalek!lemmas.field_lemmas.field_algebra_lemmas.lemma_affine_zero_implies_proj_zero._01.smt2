...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:709:1: 709:65 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_affine_zero_implies_proj_zero
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:709:1: 709:65 (#0)
       ...
       (and
        (and
         ...
         (=>
          ...
          (=>
           %%location_label%%2
           (= (curve25519_dalek!specs.field_specs.field_mul.? (I inv_z@) (I z!)) 1)
        )))
        (=>
         (= (curve25519_dalek!specs.field_specs.field_mul.? (I inv_z@) (I z!)) 1)
         (and
          (=>
           ...
           (=>
            ...
            (and
             (=>
              %%location_label%%3
              (req%vstd!arithmetic.div_mod.lemma_small_mod. a! tmp%1)
             )
             (=>
              (ens%vstd!arithmetic.div_mod.lemma_small_mod. a! tmp%1)
              (=>
               %%location_label%%4
           ...
           (and
            (=>
             ...
             (and
              (=>
               %%location_label%%5
               (req%vstd!arithmetic.div_mod.lemma_small_mod. 0 tmp%2)
              )
              (=>
               (ens%vstd!arithmetic.div_mod.lemma_small_mod. 0 tmp%2)
               (and
                (=>
                 %%location_label%%6
                 (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_zero_left.
                ...
                (=>
                 ...
                 (=>
                  %%location_label%%7
                  (= (curve25519_dalek!specs.field_specs.field_mul.? (I 0) (I z!)) 0)
            ))))))
            (=>
             (= (curve25519_dalek!specs.field_specs.field_mul.? (I 0) (I z!)) 0)
             (=>
