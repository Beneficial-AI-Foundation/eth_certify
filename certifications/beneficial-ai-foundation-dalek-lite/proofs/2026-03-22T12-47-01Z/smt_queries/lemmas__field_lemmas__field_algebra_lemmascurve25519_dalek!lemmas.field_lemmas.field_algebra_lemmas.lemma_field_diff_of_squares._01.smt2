...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:310:1: 310:57 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_field_diff_of_squares
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:310:1: 310:57 (#0)
 ...
 (assert
  (not (=>
    ...
    (=>
     ...
     (=>
      (= sa@ (curve25519_dalek!specs.field_specs.field_square.? (I a!)))
      (=>
       (= sb@ (curve25519_dalek!specs.field_specs.field_square.? (I b!)))
       (=>
        (= ab@ (curve25519_dalek!specs.field_specs.field_mul.? (I a!) (I b!)))
        (=>
         (= tmp%1 (curve25519_dalek!specs.field_specs.field_add.? (I a!) (I b!)))
         (=>
          (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_distributes_over_sub_right.
           a! b! tmp%1
          )
          (=>
           (= tmp%2 (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_sub.?
                (I a!) (I b!)
               )
              ) (I (curve25519_dalek!specs.field_specs.field_add.? (I a!) (I b!)))
             ) (curve25519_dalek!specs.field_specs.field_sub.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                (I a!) (I (curve25519_dalek!specs.field_specs.field_add.? (I a!) (I b!)))
               )
              ) (I (curve25519_dalek!specs.field_specs.field_mul.? (I b!) (I (curve25519_dalek!specs.field_specs.field_add.?
                  (I a!) (I b!)
           )))))))
           (and
            (=>
            ...
            (=>
             ...
             (=>
              ...
              (=>
               ...
               (=>
                (= tmp%3 (= (curve25519_dalek!specs.field_specs.field_mul.? (I a!) (I (curve25519_dalek!specs.field_specs.field_add.?
                     (I a!) (I b!)
                   ))
                  ) (curve25519_dalek!specs.field_specs.field_add.? (I sa@) (I ab@))
                ))
                (and
                 (=>
                  %%location_label%%1
                 ...
                 (=>
                  tmp%3
                  (=>
                   (= tmp%4 (= (curve25519_dalek!specs.field_specs.field_mul.? (I b!) (I (curve25519_dalek!specs.field_specs.field_add.?
                        (I a!) (I b!)
                      ))
                     ) (curve25519_dalek!specs.field_specs.field_add.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                        (I b!) (I a!)
                   ...
                   (and
                    ...
                    (=>
                     ...
                     (=>
                      ...
                      (=>
                       (= tmp%5 (= (curve25519_dalek!specs.field_specs.field_mul.? (I b!) (I a!)) ab@))
                       (and
                        (=>
                         %%location_label%%3
                         tmp%5
                        ...
                        (=>
                         tmp%5
                         (=>
                          (= tmp%6 (= (curve25519_dalek!specs.field_specs.field_add.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                               (I b!) (I a!)
                              )
                             ) (I sb@)
                            ) (curve25519_dalek!specs.field_specs.field_add.? (I ab@) (I sb@))
                          ))
                          (and
                           (=>
                            %%location_label%%4
                           ...
                           (=>
                            ...
                            (=>
                             ...
                             (=>
                              (= tmp%7 (= (curve25519_dalek!specs.field_specs.field_add.? (I ab@) (I sb@)) (curve25519_dalek!specs.field_specs.field_add.?
                                 (I sb@) (I ab@)
                              )))
                              (and
                               (=>
                               ...
                               (=>
                                tmp%7
                                (=>
                                 (= tmp%8 (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_sub.?
                                      (I a!) (I b!)
                                     )
                                    ) (I (curve25519_dalek!specs.field_specs.field_add.? (I a!) (I b!)))
                                   ) (curve25519_dalek!specs.field_specs.field_sub.? (I (curve25519_dalek!specs.field_specs.field_add.?
                                    ...
                                    ) (I (curve25519_dalek!specs.field_specs.field_add.? (I sb@) (I ab@)))
                                 )))
                                 (and
                                  (=>
                                   %%location_label%%6
                                   ...
                                   (and
                                    (=>
                                     ...
                                     (and
                                      (=>
                                       %%location_label%%7
                                       (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%9 p@)
                                      )
                                      (=>
                                       (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%9 p@)
                                       (=>
                                        %%location_label%%8
                                        (< sa@ p@)
                                    ))))
                                    (=>
                                     ...
                                     (and
                                      (=>
                                       (= tmp%10 (nClip (Mul b! b!)))
                                       (and
                                        (=>
                                         %%location_label%%9
                                         (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%10 p@)
                                        )
                                        (=>
                                         (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%10 p@)
                                         (=>
                                          %%location_label%%10
                                          (< sb@ p@)
                                      ))))
                                      (=>
                                       ...
                                       (and
                                        (=>
                                         (= tmp%11 (nClip (Mul a! b!)))
                                         (and
                                          (=>
                                           %%location_label%%11
                                           (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%11 p@)
                                          )
                                          (=>
                                           (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%11 p@)
                                           (=>
                                            %%location_label%%12
                                            (< ab@ p@)
                                        ))))
