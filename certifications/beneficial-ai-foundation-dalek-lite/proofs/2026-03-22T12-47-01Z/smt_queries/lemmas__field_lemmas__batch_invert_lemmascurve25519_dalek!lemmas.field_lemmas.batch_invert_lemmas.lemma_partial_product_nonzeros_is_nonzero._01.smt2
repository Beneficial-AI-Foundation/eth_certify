...
;; curve25519-dalek/src/lemmas/field_lemmas/batch_invert_lemmas.rs:92:1: 92:92 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::batch_invert_lemmas::lemma_partial_product_nonzeros_is_nonzero
;; curve25519-dalek/src/lemmas/field_lemmas/batch_invert_lemmas.rs:92:1: 92:92 (#0)
     ...
     (or
      (and
       (=>
        ...
        (and
         (=>
          (= tmp%1 (= (curve25519_dalek!specs.field_specs.partial_product_nonzeros.? (Poly%vstd!seq.Seq<curve25519_dalek!backend.serial.u64.field.FieldElement51.>.
              fields!
             ) (I 0)
            ) 1
          ))
         ...
         (and
          ...
          (and
           ...
           (=>
            ...
            (=>
             (= rest@ (curve25519_dalek!specs.field_specs.partial_product_nonzeros.? (Poly%vstd!seq.Seq<curve25519_dalek!backend.serial.u64.field.FieldElement51.>.
                fields!
               ) (I (Sub k! 1))
             ))
             (=>
                 ...
                 (and
                  (=>
                   (= tmp%4 (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
                       (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (vstd!seq.Seq.index.?
                         $ TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%vstd!seq.Seq<curve25519_dalek!backend.serial.u64.field.FieldElement51.>.
                          fields!
                         ) (I (Sub k! 1))
                   ))))))
                     ...
                     (=>
                      ...
                      (=>
                       ...
                       (and
                        (=>
                         %%location_label%%6
                         (req%vstd!arithmetic.div_mod.lemma_small_mod. a_k@ tmp%6)
                        )
                        (=>
                         (ens%vstd!arithmetic.div_mod.lemma_small_mod. a_k@ tmp%6)
                         (=>
                          %%location_label%%7
                          (not (= (EucMod a_k@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0))
                  ))))))))
                  (=>
                   (not (= (EucMod a_k@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0))
                   (=>
                    (= fm@ (curve25519_dalek!specs.field_specs.field_mul.? (I rest@) (I a_k@)))
                    (and
                     (and
                      (and
                       (=>
                          ...
                          (=>
                           ...
                           (=>
                            ...
                            (and
                             (=>
                              %%location_label%%11
                              (req%vstd!arithmetic.div_mod.lemma_small_mod. fm@ tmp%9)
                             )
                             (=>
                              (ens%vstd!arithmetic.div_mod.lemma_small_mod. fm@ tmp%9)
                              (=>
                               %%location_label%%12
                               (not (= (EucMod fm@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0))
                     ))))))))))
                     (=>
                      (not (= (EucMod fm@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0))
                      %%switch_label%%1
