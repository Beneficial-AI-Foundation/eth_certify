...
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_m1_lemmas.rs:252:1: 252:40 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::sqrt_m1_lemmas::lemma_i_inverse_is_neg_i
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_m1_lemmas.rs:252:1: 252:40 (#0)
     ...
     (=>
      ...
      (and
       ...
       (=>
        (< i@ p@)
        (=>
         (= neg_i@ (curve25519_dalek!specs.field_specs.field_neg.? (I i@)))
         (and
          (=>
                ...
                (=>
                 ...
                 (=>
                  ...
                  (and
                   (=>
                    %%location_label%%5
                    (req%vstd!arithmetic.div_mod.lemma_small_mod. tmp%3 p@)
                   )
                   (=>
                    (ens%vstd!arithmetic.div_mod.lemma_small_mod. tmp%3 p@)
                    (=>
                     %%location_label%%6
                     (= neg_i@ (nClip (Sub p@ i@)))
            )))))))))
                  ...
                  (=>
                   ...
                   (and
                    (and
                     (=>
                      %%location_label%%9
                      (req%vstd!arithmetic.div_mod.lemma_mod_multiples_basic. i@ p@)
                     )
                     (=>
                      (ens%vstd!arithmetic.div_mod.lemma_mod_multiples_basic. i@ p@)
                      (=>
                       %%location_label%%10
                       (= (EucMod (nClip (Mul i@ p@)) p@) 0)
                    )))
                    (=>
                     (= (EucMod (nClip (Mul i@ p@)) p@) 0)
                     (=>
                      (= i2_mod@ (nClip (Sub p@ 1)))
                      (and
                       (=>
                        (ens%curve25519_dalek!lemmas.field_lemmas.sqrt_m1_lemmas.axiom_sqrt_m1_squared. 0)
                        (=>
                         %%location_label%%11
                         (= (EucMod (nClip (Mul i@ i@)) p@) i2_mod@)
                       ))
                       (=>
                        (= (EucMod (nClip (Mul i@ i@)) p@) i2_mod@)
                        (=>
                         (= product@ (Mul i@ (Sub p@ i@)))
                         (and
                          (=>
                           (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub. i@ p@ i@)
                           (=>
                            %%location_label%%12
                            (= product@ (Sub (nClip (Mul i@ p@)) (nClip (Mul i@ i@))))
                          ))
                          (=>
                           (= product@ (Sub (nClip (Mul i@ p@)) (nClip (Mul i@ i@))))
                           (=>
                            ...
                            (=>
                             ...
                             (and
                              (=>
                               %%location_label%%13
                               (req%vstd!arithmetic.div_mod.lemma_sub_mod_noop. tmp%5 tmp%6 p@)
                              )
                              (=>
                               (ens%vstd!arithmetic.div_mod.lemma_sub_mod_noop. tmp%5 tmp%6 p@)
                               (and
                                (=>
                                 (= tmp%7 (= (Sub 0 i2_mod@) (Sub 1 p@)))
                                 (and
                                  (=>
                                   %%location_label%%14
                                   tmp%7
                                  ...
                                  (=>
                                   ...
                                   (and
                                    (=>
                                     %%location_label%%15
                                     (req%vstd!arithmetic.div_mod.lemma_mod_sub_multiples_vanish. 1 p@)
                                    )
                                    (=>
                                     (ens%vstd!arithmetic.div_mod.lemma_mod_sub_multiples_vanish. 1 p@)
                                     (and
                                      (=>
                                       %%location_label%%16
                                      ...
                                      (=>
                                       ...
                                       (=>
                                        %%location_label%%17
                                        (= (EucMod (Sub 0 i2_mod@) p@) 1)
                                ))))))))
                                (=>
                                 (= (EucMod (Sub 0 i2_mod@) p@) 1)
                                 (=>
                                  (= tmp%8 (= (EucMod (Mul i@ (Sub p@ i@)) p@) 1))
                                  (and
                                   (=>
                                    %%location_label%%18
                                    tmp%8
                                    ...
                                    (and
                                     (=>
                                      ...
                                      (and
                                       (=>
                                        %%location_label%%19
                                        (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. i@ tmp%9 p@)
                                       )
                                       (=>
                                        (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. i@ tmp%9 p@)
                                        (=>
                                         %%location_label%%20
                                         (= (EucMod (Mul (EucMod i@ p@) (Sub p@ i@)) p@) 1)
                                     ))))
                                     (=>
                                      (= (EucMod (Mul (EucMod i@ p@) (Sub p@ i@)) p@) 1)
                                      (=>
                                       %%location_label%%21
                                       (= (EucMod (nClip (Mul (EucMod i@ p@) neg_i@)) p@) 1)
              )))))))))))))))))))))))))
              (=>
               (= (EucMod (nClip (Mul (EucMod i@ p@) neg_i@)) p@) 1)
               (and
                (and
                 ...
                 (=>
                  ...
                  (and
                   (=>
                    %%location_label%%23
                    (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. i@ neg_i@ p@)
                   )
                   (=>
                    (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. i@ neg_i@ p@)
                    (=>
                     %%location_label%%24
                     (= (curve25519_dalek!specs.field_specs.field_mul.? (I i@) (I neg_i@)) 1)
                )))))
                (=>
                 (= (curve25519_dalek!specs.field_specs.field_mul.? (I i@) (I neg_i@)) 1)
                 (and
                     ...
                     (and
                      ...
                      (=>
                       ...
                       (and
                        (=>
                         %%location_label%%28
                         (req%curve25519_dalek!specs.field_specs.field_inv_unique. i@ neg_i@)
                        )
                        (=>
                         (ens%curve25519_dalek!specs.field_specs.field_inv_unique. i@ neg_i@)
                         (=>
                          %%location_label%%29
                          (= (curve25519_dalek!specs.field_specs.field_inv.? (I i@)) neg_i@)
                  ))))))))
                  (=>
                   (= (curve25519_dalek!specs.field_specs.field_inv.? (I i@)) neg_i@)
                   (and
