...
;; curve25519-dalek/src/lemmas/ristretto_lemmas/batch_compress_lemmas.rs:1249:7: 1264:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::ristretto_lemmas::batch_compress_lemmas::lemma_no_rotation_algebraic_setup
;; curve25519-dalek/src/lemmas/ristretto_lemmas/batch_compress_lemmas.rs:1249:7: 1264:2 (#0)
          ...
          (=>
           ...
           (=>
            ...
            (=>
             ...
             (=>
              (= tmp%3 (curve25519_dalek!specs.field_specs.field_inv.? (I h!)))
              (=>
               (= tmp%4 (curve25519_dalek!specs.field_specs.field_inv.? (I f!)))
               (=>
                (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_exchange.
                 h! e! tmp%3 tmp%4
                )
                (and
                 ...
                 (=>
                  ...
                  (=>
                   (= tmp%5 (curve25519_dalek!specs.field_specs.field_inv.? (I h!)))
                   (=>
                    (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_comm.
                     tmp%5 h!
                    )
                    (=>
                     (= tmp%6 (curve25519_dalek!specs.field_specs.field_mul.? (I e!) (I (curve25519_dalek!specs.field_specs.field_inv.?
                         (I f!)
                     ))))
                     (=>
                      (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_one_left.
                      ...
                      (=>
                       (= tmp%7 (curve25519_dalek!specs.field_specs.field_mul.? (I e!) (I (curve25519_dalek!specs.field_specs.field_inv.?
                           (I f!)
                       ))))
                       (and
                        (=>
         ...
         (=>
          ...
          (and
           ...
           (=>
            ...
            (and
             (=>
              (= tmp%8 (curve25519_dalek!specs.field_specs.field_inv.? (I fh!)))
              (=>
               (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_assoc.
                eg! tmp%8 inv_h@
               )
               (=>
                ...
                (=>
                 ...
                 (=>
                  (= tmp%9 (curve25519_dalek!specs.field_specs.field_inv.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                      (I h!) (I fh!)
                  ))))
                  (=>
                   (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_assoc.
                   ...
                   (=>
                    %%location_label%%5
                    (= B! (curve25519_dalek!specs.field_specs.field_mul.? (I e!) (I K@)))
             )))))))
             (=>
              (= B! (curve25519_dalek!specs.field_specs.field_mul.? (I e!) (I K@)))
              (and
               (or
                (and
                 (=>
                  (= (EucMod K@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) 0)
                  (=>
                   (= tmp%10 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                   (and
                    (=>
                     %%location_label%%6
                     (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. e! K@ tmp%10)
                    )
                    (=>
                     (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. e! K@ tmp%10)
                     (and
                      (=>
                       %%location_label%%7
                       (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_element_reduced.
                 ...
                 (and
                  ...
                  (=>
                   ...
                   (=>
                    ...
                    (=>
                     (= tmp%11 (curve25519_dalek!specs.field_specs.field_inv.? (I B!)))
                     (=>
                      (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_comm.
                       tmp%11 K@
                      )
                      (=>
                       (= tmp%12 (curve25519_dalek!specs.field_specs.field_inv.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                           (I K@) (I e!)
                       ))))
                       (=>
                        (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_comm.
                        ...
                        (=>
                         ...
                         (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_inv.?
                          ...
                          ) (curve25519_dalek!specs.field_specs.field_inv.? (I e!))
                 )))))))))
                 (=>
                  (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_inv.?
                      (I B!)
                  ...
                  (and
                   (=>
                    (= tmp%13 (curve25519_dalek!specs.field_specs.field_inv.? (I B!)))
                    (=>
                     (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_assoc.
                      c_iad! tmp%13 K@
                     )
                     (=>
                      %%location_label%%11
                      (= (curve25519_dalek!specs.field_specs.field_mul.? (I ciad_inv_B@) (I K@)) ciad_inv_e@)
                   )))
                   (=>
                    (= (curve25519_dalek!specs.field_specs.field_mul.? (I ciad_inv_B@) (I K@)) ciad_inv_e@)
                    (and
