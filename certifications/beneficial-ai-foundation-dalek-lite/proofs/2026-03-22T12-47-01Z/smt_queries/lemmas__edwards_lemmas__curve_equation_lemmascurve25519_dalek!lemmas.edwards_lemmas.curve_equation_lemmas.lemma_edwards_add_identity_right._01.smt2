...
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:706:1: 706:62 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::curve_equation_lemmas::lemma_edwards_add_identity_right
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:706:1: 706:62 (#0)
        ...
        (=>
         ...
         (and
          ...
          (=>
           ...
           (=>
            (= tmp%3 (EucMod x! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))))
            (=>
             ...
             (and
              ...
              (=>
               ...
               (=>
                (= tmp%5 (EucMod y! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))))
                (=>
                  ...
                  (=>
                   ...
                   (=>
                    ...
                    (and
                     (=>
                      %%location_label%%4
                      (req%vstd!arithmetic.div_mod.lemma_mod_multiples_vanish. 1 1 tmp%7)
                     )
                     (=>
                      (ens%vstd!arithmetic.div_mod.lemma_mod_multiples_vanish. 1 1 tmp%7)
                      (and
                       (=>
                        %%location_label%%5
                        (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_zero_right.
                         ...
                         (=>
                          ...
                          (=>
                           ...
                           (=>
                            ...
                            (=>
                             (= tmp%8 (EucMod x! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))))
                             (=>
                              (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_one_right.
                               tmp%8
                              )
                              (=>
                               (= tmp%9 (EucMod y! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))))
                               (=>
                                (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_one_right.
                                 tmp%9
                                )
                                (=>
                                 ...
                                 (=>
                                  (= y1y2@ (curve25519_dalek!specs.field_specs.field_mul.? (I y!) (I 1)))
                                  (=>
                                   (= x1y2@ (curve25519_dalek!specs.field_specs.field_mul.? (I x!) (I 1)))
                                   (=>
                                    (= y1x2@ (curve25519_dalek!specs.field_specs.field_mul.? (I y!) (I 0)))
                                    (=>
                                     (= tmp%10 (and
                                       (and
                                        (and
                                        ...
                                        (= y1y2@ (EucMod y! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))))
                                       )
                                       (= x1y2@ (EucMod x! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))))
                                     ))
                                     (and
                                      (=>
                                       %%location_label%%7
                                      ...
                                      (=>
                                       tmp%10
                                       (=>
                                        (= t@ (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.?
                                            (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. curve25519_dalek!backend.serial.u64.constants.EDWARDS_D.?)
                                           )
                                          ) (I (curve25519_dalek!specs.field_specs.field_mul.? (I x1x2@) (I y1y2@)))
                                        ))
                                        (and
                                         (and
                                          (=>
                                                 ...
                                                 (=>
                                                  ...
                                                  (=>
                                                   ...
                                                   (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_add.?
                                                    ...
                                                    ) (Poly%tuple%2. (tuple%2./tuple%2 (I (EucMod x! (curve25519_dalek!specs.field_specs_u64.p.?
                                                         (I 0)
                                                       ))
                                                      ) (I (EucMod y! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))))
 )))))))))))))))))))))))))))))))))))))))))))))))))))))
