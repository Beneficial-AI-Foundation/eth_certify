...
;; MODULE 'module lemmas::scalar_lemmas_::radix16_lemmas'
;; curve25519-dalek/src/lemmas/scalar_lemmas_/radix16_lemmas.rs:30:1: 36:2 (#0)
...
(assert
 (distinct fuel%vstd!arithmetic.mul.lemma_mul_is_associative. fuel%vstd!arithmetic.mul.lemma_mul_is_commutative.
  fuel%vstd!arithmetic.mul.lemma_mul_is_distributive_add. fuel%vstd!array.array_view.
  ...
  fuel%vstd!view.impl&%16.view. fuel%vstd!view.impl&%26.view. fuel%vstd!view.impl&%28.view.
  fuel%curve25519_dalek!specs.core_specs.u8_32_as_nat. fuel%curve25519_dalek!specs.core_specs.u8_32_as_nat_rec.
  fuel%curve25519_dalek!specs.core_specs.bytes_as_nat_prefix. fuel%curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.
  ...
  fuel%curve25519_dalek!specs.scalar_specs.radix_16_all_bounded. fuel%vstd!array.group_array_axioms.
    ...
    (= (curve25519_dalek!specs.scalar_specs.is_valid_radix_2w.? digits! w! digits_count!)
     (and
      ...
      (forall ((i$ Poly)) (!
        ...
        :qid user_curve25519_dalek__specs__scalar_specs__is_valid_radix_2w_25
        :skolemid skolem_user_curve25519_dalek__specs__scalar_specs__is_valid_radix_2w_25
    ))))
 ...
 (=>
  ...
  (forall ((digits! Poly)) (!
    (= (curve25519_dalek!specs.scalar_specs.radix_16_all_bounded.? digits!) (forall ((i$
       ...
       :qid user_curve25519_dalek__specs__scalar_specs__radix_16_all_bounded_26
       :skolemid skolem_user_curve25519_dalek__specs__scalar_specs__radix_16_all_bounded_26
    )))
...
;; Function-Specs curve25519_dalek::lemmas::scalar_lemmas_::radix16_lemmas::lemma_nibbles_equal_bytes_prefix
(declare-fun req%curve25519_dalek!lemmas.scalar_lemmas_.radix16_lemmas.lemma_nibbles_equal_bytes_prefix.
 (vstd!seq.Seq<i8.>. vstd!seq.Seq<u8.>. Int) Bool
)
...
(assert
 (forall ((output! vstd!seq.Seq<i8.>.) (bytes! vstd!seq.Seq<u8.>.) (k! Int)) (!
   (= (req%curve25519_dalek!lemmas.scalar_lemmas_.radix16_lemmas.lemma_nibbles_equal_bytes_prefix.
     output! bytes! k!
    ) (and
     (=>
      %%global_location_label%%9
      (= (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. output!)) 64)
     )
     (=>
      %%global_location_label%%10
      (= (vstd!seq.Seq.len.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes!)) 32)
     )
     (=>
     ...
     (=>
      ...
      (forall ((i$ Int)) (!
        (=>
         ...
         (= (Add (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. output!) (I (Mul
               2 i$
            )))
           ) (Mul 16 (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. output!) (I (
                Add (Mul 2 i$) 1
           )))))
          ) (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. bytes!) (I i$)))
        ))
        :pattern ((vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. output!) (I (Mul
            2 i$
          ))
         ) (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. output!) (I (Add (Mul 2 i$)
            1
        ))))
        :qid user_curve25519_dalek__lemmas__scalar_lemmas___radix16_lemmas__lemma_nibbles_equal_bytes_prefix_27
        :skolemid skolem_user_curve25519_dalek__lemmas__scalar_lemmas___radix16_lemmas__lemma_nibbles_equal_bytes_prefix_27
     )))
     (=>
      ...
      (forall ((i$ Poly)) (!
        (=>
         ...
         (=>
          ...
          (>= (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. output!) i$)) 0)
        ))
        :pattern ((vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. output!) i$))
        :qid user_curve25519_dalek__lemmas__scalar_lemmas___radix16_lemmas__lemma_nibbles_equal_bytes_prefix_28
        :skolemid skolem_user_curve25519_dalek__lemmas__scalar_lemmas___radix16_lemmas__lemma_nibbles_equal_bytes_prefix_28
   )))))
   :pattern ((req%curve25519_dalek!lemmas.scalar_lemmas_.radix16_lemmas.lemma_nibbles_equal_bytes_prefix.
     output! bytes! k!
   ))
   :qid internal_req__curve25519_dalek!lemmas.scalar_lemmas_.radix16_lemmas.lemma_nibbles_equal_bytes_prefix._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.scalar_lemmas_.radix16_lemmas.lemma_nibbles_equal_bytes_prefix._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.scalar_lemmas_.radix16_lemmas.lemma_nibbles_equal_bytes_prefix.
 (vstd!seq.Seq<i8.>. vstd!seq.Seq<u8.>. Int) Bool
)
(assert
 (forall ((output! vstd!seq.Seq<i8.>.) (bytes! vstd!seq.Seq<u8.>.) (k! Int)) (!
   (= (ens%curve25519_dalek!lemmas.scalar_lemmas_.radix16_lemmas.lemma_nibbles_equal_bytes_prefix.
     output! bytes! k!
    ) (= (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.? (vstd!seq.Seq.subrange.?
       $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. output!) (I 0) (I (nClip (Mul 2 k!)))
      ) (I 4)
     ) (curve25519_dalek!specs.core_specs.bytes_as_nat_prefix.? (Poly%vstd!seq.Seq<u8.>.
       bytes!
      ) (I k!)
   )))
   :pattern ((ens%curve25519_dalek!lemmas.scalar_lemmas_.radix16_lemmas.lemma_nibbles_equal_bytes_prefix.
     output! bytes! k!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.scalar_lemmas_.radix16_lemmas.lemma_nibbles_equal_bytes_prefix._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.scalar_lemmas_.radix16_lemmas.lemma_nibbles_equal_bytes_prefix._definition
)))

;; Function-Specs curve25519_dalek::lemmas::scalar_lemmas_::radix16_lemmas::lemma_bytes32_to_radix16_nibbles
(declare-fun req%curve25519_dalek!lemmas.scalar_lemmas_.radix16_lemmas.lemma_bytes32_to_radix16_nibbles.
 (%%Function%% %%Function%%) Bool
)
(declare-const %%global_location_label%%14 Bool)
(declare-const %%global_location_label%%15 Bool)
(assert
 (forall ((output! %%Function%%) (bytes! %%Function%%)) (!
   (= (req%curve25519_dalek!lemmas.scalar_lemmas_.radix16_lemmas.lemma_bytes32_to_radix16_nibbles.
     output! bytes!
    ) (and
     (=>
      ...
      (forall ((i$ Int)) (!
        (=>
         ...
         (= (Add (%I (vstd!seq.Seq.index.? $ (SINT 8) (vstd!view.View.view.? $ (ARRAY $ (SINT 8)
           ...
           ) (Mul 16 (%I (vstd!seq.Seq.index.? $ (SINT 8) (vstd!view.View.view.? $ (ARRAY $ (SINT
                 8
                ) $ (CONST_INT 64)
               ) (Poly%array%. output!)
              ) (I (Add (Mul 2 i$) 1))
        ...
        :qid user_curve25519_dalek__lemmas__scalar_lemmas___radix16_lemmas__lemma_bytes32_to_radix16_nibbles_34
        :skolemid skolem_user_curve25519_dalek__lemmas__scalar_lemmas___radix16_lemmas__lemma_bytes32_to_radix16_nibbles_34
     )))
     (=>
      ...
      (forall ((i$ Poly)) (!
        ...
        :qid user_curve25519_dalek__lemmas__scalar_lemmas___radix16_lemmas__lemma_bytes32_to_radix16_nibbles_35
        :skolemid skolem_user_curve25519_dalek__lemmas__scalar_lemmas___radix16_lemmas__lemma_bytes32_to_radix16_nibbles_35
   )))))
   :pattern ((req%curve25519_dalek!lemmas.scalar_lemmas_.radix16_lemmas.lemma_bytes32_to_radix16_nibbles.
     output! bytes!
   ))
   :qid internal_req__curve25519_dalek!lemmas.scalar_lemmas_.radix16_lemmas.lemma_bytes32_to_radix16_nibbles._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.scalar_lemmas_.radix16_lemmas.lemma_bytes32_to_radix16_nibbles._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.scalar_lemmas_.radix16_lemmas.lemma_bytes32_to_radix16_nibbles.
 (%%Function%% %%Function%%) Bool
)
(assert
 (forall ((output! %%Function%%) (bytes! %%Function%%)) (!
   (= (ens%curve25519_dalek!lemmas.scalar_lemmas_.radix16_lemmas.lemma_bytes32_to_radix16_nibbles.
     output! bytes!
    ) (= (curve25519_dalek!specs.scalar_specs.reconstruct_radix_16.? (vstd!view.View.view.?
       $ (ARRAY $ (SINT 8) $ (CONST_INT 64)) (Poly%array%. output!)
      )
     ) (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. bytes!))
   ))
   :pattern ((ens%curve25519_dalek!lemmas.scalar_lemmas_.radix16_lemmas.lemma_bytes32_to_radix16_nibbles.
     output! bytes!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.scalar_lemmas_.radix16_lemmas.lemma_bytes32_to_radix16_nibbles._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.scalar_lemmas_.radix16_lemmas.lemma_bytes32_to_radix16_nibbles._definition
)))

;; Function-Specs curve25519_dalek::lemmas::scalar_lemmas_::radix16_lemmas::lemma_carry_preserves_reconstruction
(declare-fun req%curve25519_dalek!lemmas.scalar_lemmas_.radix16_lemmas.lemma_carry_preserves_reconstruction.
 (vstd!seq.Seq<i8.>. vstd!seq.Seq<i8.>. Int Int Int) Bool
)
...
(assert
 (forall ((old_digits! vstd!seq.Seq<i8.>.) (new_digits! vstd!seq.Seq<i8.>.) (i! Int)
   (carry! Int) (w! Int)
  ) (!
   (= (req%curve25519_dalek!lemmas.scalar_lemmas_.radix16_lemmas.lemma_carry_preserves_reconstruction.
     old_digits! new_digits! i! carry! w!
    ) (and
     (=>
     ...
     (=>
      ...
      (= (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. old_digits!)) (vstd!seq.Seq.len.?
        $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. new_digits!)
     )))
     (=>
      %%global_location_label%%18
      (< (nClip (Add i! 1)) (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. old_digits!)))
     )
     (=>
      %%global_location_label%%19
      (= (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. new_digits!) (I i!)))
       (Sub (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. old_digits!) (I i!)))
        (Mul carry! (vstd!arithmetic.power2.pow2.? (I w!)))
     )))
     (=>
      %%global_location_label%%20
      (= (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. new_digits!) (I (nClip
           (Add i! 1)
        )))
       ) (Add (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. old_digits!) (I
           (nClip (Add i! 1))
         ))
        ) carry!
     )))
          ...
          (and
           (and
            (let
             ...
             (and
              (<= 0 tmp%%$)
              (< tmp%%$ (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. old_digits!)))
            ))
            (not (= (%I j$) i!))
           )
           (not (= (%I j$) (nClip (Add i! 1))))
          )
          (= (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. old_digits!) j$) (vstd!seq.Seq.index.?
            $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. new_digits!) j$
        ))))
        :pattern ((vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. old_digits!) j$))
        :pattern ((vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. new_digits!) j$))
        :qid user_curve25519_dalek__lemmas__scalar_lemmas___radix16_lemmas__lemma_carry_preserves_reconstruction_40
        :skolemid skolem_user_curve25519_dalek__lemmas__scalar_lemmas___radix16_lemmas__lemma_carry_preserves_reconstruction_40
   )))))
   :pattern ((req%curve25519_dalek!lemmas.scalar_lemmas_.radix16_lemmas.lemma_carry_preserves_reconstruction.
     old_digits! new_digits! i! carry! w!
   ))
   :qid internal_req__curve25519_dalek!lemmas.scalar_lemmas_.radix16_lemmas.lemma_carry_preserves_reconstruction._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.scalar_lemmas_.radix16_lemmas.lemma_carry_preserves_reconstruction._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.scalar_lemmas_.radix16_lemmas.lemma_carry_preserves_reconstruction.
 (vstd!seq.Seq<i8.>. vstd!seq.Seq<i8.>. Int Int Int) Bool
)
(assert
 (forall ((old_digits! vstd!seq.Seq<i8.>.) (new_digits! vstd!seq.Seq<i8.>.) (i! Int)
   ...
   (= (ens%curve25519_dalek!lemmas.scalar_lemmas_.radix16_lemmas.lemma_carry_preserves_reconstruction.
     old_digits! new_digits! i! carry! w!
    ) (= (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.? (Poly%vstd!seq.Seq<i8.>.
       new_digits!
      ) (I w!)
   ...
   :pattern ((ens%curve25519_dalek!lemmas.scalar_lemmas_.radix16_lemmas.lemma_carry_preserves_reconstruction.
     old_digits! new_digits! i! carry! w!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.scalar_lemmas_.radix16_lemmas.lemma_carry_preserves_reconstruction._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.scalar_lemmas_.radix16_lemmas.lemma_carry_preserves_reconstruction._definition
)))

;; Function-Def curve25519_dalek::lemmas::scalar_lemmas_::radix16_lemmas::lemma_carry_preserves_reconstruction
;; curve25519-dalek/src/lemmas/scalar_lemmas_/radix16_lemmas.rs:30:1: 36:2 (#0)
(get-info :all-statistics)
(push)
 (declare-const old_digits! vstd!seq.Seq<i8.>.)
 (declare-const new_digits! vstd!seq.Seq<i8.>.)
 (declare-const i! Int)
 ...
 (declare-const old_suffix@ vstd!seq.Seq<i8.>.)
 (declare-const new_suffix@ vstd!seq.Seq<i8.>.)
 (declare-const old_rest@ vstd!seq.Seq<i8.>.)
 (declare-const new_rest@ vstd!seq.Seq<i8.>.)
 (declare-const old_di@ Int)
 (declare-const old_di1@ Int)
 (declare-const new_di@ Int)
 (declare-const new_di1@ Int)
 (declare-const pw@ Int)
 (declare-const tail_recon@ Int)
 (assert
  fuel_defaults
 )
 (assert
 ...
 (assert
  (forall ((j$ Poly)) (!
    ...
    :pattern ((vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. old_digits!) j$))
    :pattern ((vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. new_digits!) j$))
    :qid user_curve25519_dalek__lemmas__scalar_lemmas___radix16_lemmas__lemma_carry_preserves_reconstruction_48
    :skolemid skolem_user_curve25519_dalek__lemmas__scalar_lemmas___radix16_lemmas__lemma_carry_preserves_reconstruction_48
 )))
      ...
      (=>
       ...
       (=>
        (= tmp%1 (ext_eq false (TYPE%vstd!seq.Seq. $ (SINT 8)) (vstd!seq.Seq.subrange.? $ (SINT
            8
           ) (Poly%vstd!seq.Seq<i8.>. old_digits!) (I 0) (I i!)
          ) (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. new_digits!) (I 0)
           (I i!)
        )))
        (and
         (=>
         ...
         (=>
          tmp%1
          (=>
           (= old_suffix@ (%Poly%vstd!seq.Seq<i8.>. (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
               old_digits!
              ) (I i!) (I (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. old_digits!)))
           )))
           (=>
            (= new_suffix@ (%Poly%vstd!seq.Seq<i8.>. (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
                new_digits!
               ) (I i!) (I (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. new_digits!)))
            )))
            (=>
             (= tmp%2 (>= (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. old_suffix@))
               2
             ))
             (and
              (=>
                ...
                (=>
                 ...
                 (and
                  ...
                  (=>
                   ...
                   (and
                    (=>
                     (= tmp%3 (= (vstd!seq.Seq.index.? $ (SINT 8) (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
                          old_suffix@
                         ) (I 0) (I 1)
                        ) (I 0)
                       ) (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. old_digits!) (I i!))
                     ))
                     (and
                      (=>
                       %%location_label%%6
                      ...
                      (=>
                       tmp%3
                       (=>
                        (= tmp%4 (= (vstd!seq.Seq.len.? $ (SINT 8) (vstd!seq.Seq.subrange.? $ (SINT 8) (vstd!seq.Seq.subrange.?
                             $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. old_suffix@) (I 0) (I 1)
                         ...
                         (=>
                          ...
                          (=>
                           ...
                           (= (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.? (vstd!seq.Seq.subrange.?
                            ...
                            ) (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. old_digits!) (I i!)))
                    ))))))))
                    (=>
                     (= (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.? (vstd!seq.Seq.subrange.?
                        $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. old_suffix@) (I 0) (I 1)
                     ...
                     (and
                      (=>
                       (= tmp%5 (= (vstd!seq.Seq.index.? $ (SINT 8) (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
                         ...
                         ) (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. new_digits!) (I i!))
                       ))
                       (and
                        (=>
                         %%location_label%%9
                        ...
                        (=>
                         tmp%5
                         (=>
                          (= tmp%6 (= (vstd!seq.Seq.len.? $ (SINT 8) (vstd!seq.Seq.subrange.? $ (SINT 8) (vstd!seq.Seq.subrange.?
                               $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. new_suffix@) (I 0) (I 1)
                              ) (I 1) (I (vstd!seq.Seq.len.? $ (SINT 8) (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
                                  new_suffix@
                                 ) (I 0) (I 1)
                             ))))
                      ...
                      (=>
                       ...
                       (=>
                        (= old_rest@ (%Poly%vstd!seq.Seq<i8.>. (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
                            old_suffix@
                           ) (I 1) (I (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. old_suffix@)))
                        )))
                        (=>
                         (= new_rest@ (%Poly%vstd!seq.Seq<i8.>. (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
                             new_suffix@
                            ) (I 1) (I (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. new_suffix@)))
                         )))
                         (and
                          (=>
                           %%location_label%%12
                          ...
                          (=>
                           ...
                           (and
                            ...
                            (=>
                             ...
                             (and
                              (=>
                               (= tmp%7 (= (vstd!seq.Seq.index.? $ (SINT 8) (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
                                    old_rest@
                                   ) (I 0) (I 1)
                                  ) (I 0)
                                 ) (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. old_digits!) (I (nClip (
                                     Add i! 1
                               ))))))
                               (and
                                (=>
                                ...
                                (=>
                                 tmp%7
                                 (=>
                                  (= tmp%8 (= (vstd!seq.Seq.len.? $ (SINT 8) (vstd!seq.Seq.subrange.? $ (SINT 8) (vstd!seq.Seq.subrange.?
                                       $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. old_rest@) (I 0) (I 1)
                                      ) (I 1) (I (vstd!seq.Seq.len.? $ (SINT 8) (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
                                          old_rest@
                                         ) (I 0) (I 1)
                                     ))))
                                   ...
                                   (=>
                                    ...
                                    (=>
                                     ...
                                     (= (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.? (vstd!seq.Seq.subrange.?
                                      ...
                                      ) (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. old_digits!) (I (nClip
                                          (Add i! 1)
                              ))))))))))))
                              (=>
                               (= (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.? (vstd!seq.Seq.subrange.?
                               ...
                               (and
                                (=>
                                 (= tmp%9 (= (vstd!seq.Seq.index.? $ (SINT 8) (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
                                      new_rest@
                                     ) (I 0) (I 1)
                                    ) (I 0)
                                   ) (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. new_digits!) (I (nClip (
                                       Add i! 1
                                 ))))))
                                 (and
                                  (=>
                                  ...
                                  (=>
                                   tmp%9
                                   (=>
                                    (= tmp%10 (= (vstd!seq.Seq.len.? $ (SINT 8) (vstd!seq.Seq.subrange.? $ (SINT 8) (vstd!seq.Seq.subrange.?
                                         $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. new_rest@) (I 0) (I 1)
                                        ) (I 1) (I (vstd!seq.Seq.len.? $ (SINT 8) (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
                                            new_rest@
                                           ) (I 0) (I 1)
                                       ))))
                                ...
                                (=>
                                 ...
                                 (=>
                                  (= tmp%11 (ext_eq false (TYPE%vstd!seq.Seq. $ (SINT 8)) (vstd!seq.Seq.subrange.? $ (
                                      SINT 8
                                     ) (Poly%vstd!seq.Seq<i8.>. old_rest@) (I 1) (I (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
                                        old_rest@
                                     )))
                                    ) (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. new_rest@) (I 1) (I
                                      (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. new_rest@))
                                  ))))
                                  (and
                                   (=>
                                    %%location_label%%20
                                   ...
                                   (=>
                                    tmp%11
                                    (=>
                                     (= old_di@ (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. old_digits!)
                                        (I i!)
                                     )))
                                     (=>
                                      (= old_di1@ (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. old_digits!)
                                         (I (nClip (Add i! 1)))
                                      )))
                                      (=>
                                       (= new_di@ (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. new_digits!)
                                          (I i!)
                                       )))
                                       (=>
                                        (= new_di1@ (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. new_digits!)
                                           (I (nClip (Add i! 1)))
                                        )))
                                        (=>
                                         (= pw@ (vstd!arithmetic.power2.pow2.? (I w!)))
                                         (=>
                                          (= tail_recon@ (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.? (vstd!seq.Seq.subrange.?
                                             $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. old_rest@) (I 1) (I (vstd!seq.Seq.len.? $ (SINT
                                                8
                                               ) (Poly%vstd!seq.Seq<i8.>. old_rest@)
                                             ))
                                            ) (I w!)
                                          ))
                                          (and
                                           (=>
                                            (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add. pw@ old_di1@ carry!)
                                            (=>
                                             (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. carry! pw@)
                                             (=>
                                              %%location_label%%21
                                              (= (Add new_di@ (Mul pw@ new_di1@)) (Add old_di@ (Mul pw@ old_di1@)))
                                           )))
                                           (=>
                                            (= (Add new_di@ (Mul pw@ new_di1@)) (Add old_di@ (Mul pw@ old_di1@)))
                                            (and
                                             (=>
                                              (= tmp%12 (Mul pw@ tail_recon@))
                                              (=>
                                               (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add. pw@ new_di1@ tmp%12)
                                               (=>
                                                (= tmp%13 (Mul pw@ tail_recon@))
                                                (=>
                                                 (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add. pw@ old_di1@ tmp%13)
                                                 (=>
                                                  %%location_label%%22
                                                  (= (Add new_di@ (Mul pw@ (Add new_di1@ (Mul pw@ tail_recon@)))) (Add old_di@ (Mul pw@
                                                     (Add old_di1@ (Mul pw@ tail_recon@))
                                             ))))))))
                                             (=>
                                              (= (Add new_di@ (Mul pw@ (Add new_di1@ (Mul pw@ tail_recon@)))) (Add old_di@ (Mul pw@
                                                 (Add old_di1@ (Mul pw@ tail_recon@))
                                              ...
                                              (and
                                               (=>
                                                (ens%vstd!arithmetic.mul.lemma_mul_basics. w!)
                                                (=>
                                                 %%location_label%%23
                                                 (= (nClip (Mul w! 1)) w!)
                                               ))
