...
;; curve25519-dalek/src/lemmas/edwards_lemmas/decompress_lemmas.rs:255:17: 255:23 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::decompress_lemmas::lemma_decompress_valid_branch
;; curve25519-dalek/src/lemmas/edwards_lemmas/decompress_lemmas.rs:255:17: 255:23 (#0)
...
(declare-const sign_bit$1@ (_ BitVec 8))
(declare-const repr_byte_31@ (_ BitVec 8))
(assert
 (= sign_bit$1@ (bvlshr repr_byte_31@ ((_ zero_extend 5) (_ bv7 3))))
)
...
(assert
 (not (=>
   %%location_label%%0
   (or
    (= sign_bit$1@ ((_ zero_extend 7) (_ bv0 1)))
    (= sign_bit$1@ ((_ zero_extend 7) (_ bv1 1)))
))))
(get-info :version)
