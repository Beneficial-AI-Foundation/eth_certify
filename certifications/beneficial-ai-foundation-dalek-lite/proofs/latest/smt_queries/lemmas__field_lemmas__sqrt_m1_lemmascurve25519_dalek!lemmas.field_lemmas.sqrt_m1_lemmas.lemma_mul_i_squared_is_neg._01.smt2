...
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_m1_lemmas.rs:749:1: 749:48 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::sqrt_m1_lemmas::lemma_mul_i_squared_is_neg
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_m1_lemmas.rs:749:1: 749:48 (#0)
          ...
          (=>
           ...
           (and
            ...
            (=>
             ...
             (=>
              (= tmp%1 (nClip (Sub pn@ 1)))
              (and
               (=>
                %%location_label%%3
                (req%vstd!arithmetic.div_mod.lemma_small_mod. tmp%1 pn@)
               )
               (=>
                (ens%vstd!arithmetic.div_mod.lemma_small_mod. tmp%1 pn@)
                (=>
                 %%location_label%%4
                 (= (curve25519_dalek!specs.field_specs.field_mul.? (I i@) (I i@)) (curve25519_dalek!specs.field_specs.field_neg.?
                   (I 1)
          )))))))))
          (=>
           (= (curve25519_dalek!specs.field_specs.field_mul.? (I i@) (I i@)) (curve25519_dalek!specs.field_specs.field_neg.?
           ...
           (and
            (=>
             (= tmp%2 (curve25519_dalek!specs.field_specs.field_neg.? (I 1)))
             (=>
              (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_comm.
               a! tmp%2
              )
              (=>
               ...
               (=>
                %%location_label%%5
                (= (curve25519_dalek!specs.field_specs.field_mul.? (I a!) (I (curve25519_dalek!specs.field_specs.field_neg.?
                    (I 1)
                  ))
                 ) (curve25519_dalek!specs.field_specs.field_neg.? (I a!))
            )))))
