...
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:2222:1: 2222:42 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::number_theory_lemmas::lemma_p_divisibility_facts
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:2222:1: 2222:42 (#0)
  ...
  (not (=>
    ...
    (=>
     ...
     (=>
      ...
      (=>
       (= tmp%1 (= pn@ (Sub (vstd!arithmetic.power2.pow2.? (I 255)) 19)))
       (and
        (=>
         %%location_label%%0
         tmp%1
        ...
        (=>
         tmp%1
         (=>
          (ens%vstd!arithmetic.power2.lemma_pow2_adds. 3 252)
          (=>
           (= tmp%2 (= (vstd!arithmetic.power2.pow2.? (I 255)) (nClip (Mul (vstd!arithmetic.power2.pow2.?
                (I 3)
           ...
           (and
            ...
            (=>
             ...
             (=>
              ...
              (=>
               (= tmp%3 (= (vstd!arithmetic.power2.pow2.? (I 3)) 8))
               (and
                (=>
                 %%location_label%%2
                 tmp%3
                ...
                (=>
                 ...
                 (and
                  (=>
                   (= tmp%4 (vstd!arithmetic.power2.pow2.? (I 252)))
                   (and
                    (=>
                     %%location_label%%3
                     (req%vstd!arithmetic.div_mod.lemma_mod_multiples_basic. tmp%4 8)
                    )
                    (=>
                     (ens%vstd!arithmetic.div_mod.lemma_mod_multiples_basic. tmp%4 8)
                     (=>
                      (= tmp%5 (= 24 (nClip (Mul 3 8))))
                      (and
                       (=>
                        %%location_label%%4
                        tmp%5
                       ...
                       (=>
                        ...
                        (and
                         (=>
                          %%location_label%%5
                          (req%vstd!arithmetic.div_mod.lemma_mod_multiples_basic. 3 8)
                         )
                         (=>
                          (ens%vstd!arithmetic.div_mod.lemma_mod_multiples_basic. 3 8)
                          (and
                           (=>
                            %%location_label%%6
                            (req%vstd!arithmetic.div_mod.lemma_small_mod. 0 8)
                           )
                           (=>
                            (ens%vstd!arithmetic.div_mod.lemma_small_mod. 0 8)
                            (=>
                             (= tmp%6 (vstd!arithmetic.power2.pow2.? (I 255)))
                             (and
                              (=>
                               %%location_label%%7
                               (req%vstd!arithmetic.div_mod.lemma_sub_mod_noop. tmp%6 24 8)
                              )
                              (=>
                               (ens%vstd!arithmetic.div_mod.lemma_sub_mod_noop. tmp%6 24 8)
                               (=>
                                %%location_label%%8
                                (= (EucMod (Sub pn@ 5) 8) 0)
                  ))))))))))))))
                   ...
                   (=>
                    ...
                    (=>
                     ...
                     (and
                      (=>
                       %%location_label%%9
                       (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. tmp%7 8)
                      )
                      (=>
                       (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. tmp%7 8)
                       (=>
                        (= tmp%8 (= (Sub pn@ 5) (nClip (Mul 8 k@))))
                        (and
                         (=>
                          %%location_label%%10
                          tmp%8
                         ...
                         (=>
                          ...
                          (and
                           (and
                            (=>
                             (= tmp%9 (vstd!arithmetic.power2.pow2.? (I 252)))
                             (=>
                              (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub. 8 tmp%9 3)
                              (=>
                               %%location_label%%11
                               (= (Sub pn@ 5) (Mul 8 (Sub (vstd!arithmetic.power2.pow2.? (I 252)) 3)))
                            )))
                            (=>
                             (= (Sub pn@ 5) (Mul 8 (Sub (vstd!arithmetic.power2.pow2.? (I 252)) 3)))
                             (and
                              (=>
                               %%location_label%%12
                               (req%vstd!arithmetic.power2.lemma_pow2_strictly_increases. 3 252)
                              )
                              (=>
                               (ens%vstd!arithmetic.power2.lemma_pow2_strictly_increases. 3 252)
                               (=>
                                (= tmp%10 (> (vstd!arithmetic.power2.pow2.? (I 252)) 8))
                                (and
                                 (=>
                                  %%location_label%%13
                                  tmp%10
                                 ...
                                 (=>
                                  tmp%10
                                  (=>
                                   (= tmp%11 (Sub (vstd!arithmetic.power2.pow2.? (I 252)) 3))
                                   (and
                                    (=>
                                     %%location_label%%14
                                     (req%vstd!arithmetic.div_mod.lemma_div_multiples_vanish. tmp%11 8)
                                    )
                                    (=>
                                     (ens%vstd!arithmetic.div_mod.lemma_div_multiples_vanish. tmp%11 8)
                                     (=>
                                      %%location_label%%15
                                      (= k@ (nClip (Sub (vstd!arithmetic.power2.pow2.? (I 252)) 3)))
                           )))))))))))
                           (=>
                            (= k@ (nClip (Sub (vstd!arithmetic.power2.pow2.? (I 252)) 3)))
                            (=>
                             (= tmp%12 (= (Sub pn@ 1) (nClip (Add (nClip (Mul 8 k@)) 4))))
                             (and
                              (=>
                               %%location_label%%16
                               tmp%12
                              ...
                              (=>
                               ...
                               (and
                                (and
                                 (=>
                                  (= tmp%13 (nClip (Mul 2 k@)))
                                  (=>
                                   (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add. 4 tmp%13 1)
                                   (=>
                                    (ens%vstd!arithmetic.mul.lemma_mul_is_associative. 4 2 k@)
                                    (=>
                                     %%location_label%%17
                                     (= (nClip (Add (nClip (Mul 8 k@)) 4)) (nClip (Mul 4 (nClip (Add (nClip (Mul 2 k@)) 1)))))
                                 ))))
                                 (=>
                                  (= (nClip (Add (nClip (Mul 8 k@)) 4)) (nClip (Mul 4 (nClip (Add (nClip (Mul 2 k@)) 1)))))
                                  (=>
                                 ...
                                 (=>
                                  ...
                                  (=>
                                   ...
                                   (and
                                    (=>
                                     %%location_label%%19
                                     (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. tmp%14 4)
                                    )
                                    (=>
                                     (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. tmp%14 4)
                                     (=>
                                      (= tmp%15 (= (Sub pn@ 1) (nClip (Mul 4 quarter@))))
                                      (and
                                       (=>
                                        %%location_label%%20
                                        tmp%15
                                       ...
                                       (=>
                                        ...
                                        (and
                                         (=>
                                          (= tmp%16 (nClip (Add (nClip (Mul 2 k@)) 1)))
                                          (and
                                           (=>
                                            %%location_label%%21
                                            (req%vstd!arithmetic.mul.lemma_mul_equality_converse. 4 quarter@ tmp%16)
                                           )
                                           (=>
                                            (ens%vstd!arithmetic.mul.lemma_mul_equality_converse. 4 quarter@ tmp%16)
                                            (=>
                                             %%location_label%%22
                                             (= quarter@ (nClip (Add (nClip (Mul 2 k@)) 1)))
                                         ))))
                                         (=>
                                          ...
                                          (and
                                           (and
                                            (=>
                                             (ens%vstd!arithmetic.mul.lemma_mul_is_associative. 2 2 quarter@)
                                             (=>
                                              %%location_label%%23
                                              (= (nClip (Mul 4 quarter@)) (nClip (Mul 2 (nClip (Mul 2 quarter@)))))
                                            ))
                                            (=>
                                             (= (nClip (Mul 4 quarter@)) (nClip (Mul 2 (nClip (Mul 2 quarter@)))))
                                             (=>
                                            ...
                                            (=>
                                             ...
                                             (=>
                                              ...
                                              (and
                                               (=>
                                                %%location_label%%25
                                                (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. tmp%17 2)
                                               )
                                               (=>
                                                (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. tmp%17 2)
                                                (=>
                                                 (= tmp%18 (= (nClip (Mul 2 half@)) (Sub pn@ 1)))
                                                 (and
                                                  (=>
                                                   %%location_label%%26
                                                   tmp%18
                                                  ...
                                                  (=>
                                                   ...
                                                   (and
                                                    (=>
                                                     (= tmp%19 (= (nClip (Mul 2 half@)) (nClip (Mul 4 quarter@))))
                                                     (and
                                                      (=>
                                                       %%location_label%%27
                                                       tmp%19
