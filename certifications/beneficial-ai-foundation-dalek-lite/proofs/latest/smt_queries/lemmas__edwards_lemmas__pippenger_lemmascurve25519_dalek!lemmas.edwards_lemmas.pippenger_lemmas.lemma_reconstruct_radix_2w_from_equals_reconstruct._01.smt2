...
;; curve25519-dalek/src/lemmas/edwards_lemmas/pippenger_lemmas.rs:517:1: 521:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::pippenger_lemmas::lemma_reconstruct_radix_2w_from_equals_reconstruct
;; curve25519-dalek/src/lemmas/edwards_lemmas/pippenger_lemmas.rs:517:1: 521:2 (#0)
    ...
    (=>
     ...
     (=>
      (= tmp%1 (ext_eq false (TYPE%vstd!seq.Seq. $ (SINT 8)) (vstd!seq.Seq.subrange.? $ (SINT
          8
         ) (Poly%vstd!seq.Seq<i8.>. d!) (I 0) (I digits_count!)
        ) (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. d!) (I 0) (I digits_count!))
      ))
      (and
       (=>
        %%location_label%%2
