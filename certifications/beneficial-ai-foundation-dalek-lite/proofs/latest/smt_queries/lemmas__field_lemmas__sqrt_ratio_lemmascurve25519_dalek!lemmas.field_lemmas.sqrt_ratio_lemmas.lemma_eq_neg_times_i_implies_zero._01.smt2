...
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_ratio_lemmas.rs:650:1: 650:55 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::sqrt_ratio_lemmas::lemma_eq_neg_times_i_implies_zero
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_ratio_lemmas.rs:650:1: 650:55 (#0)
                ...
                (=>
                 ...
                 (and
                  ...
                  (=>
                   tmp%2
                   (=>
                    (= tmp%3 (= (curve25519_dalek!specs.field_specs.field_neg.? (I 1)) (nClip (Sub pn@ 1))))
                    (and
                     (=>
                      %%location_label%%3
                      tmp%3
                     ...
                     (=>
                      tmp%3
                      (=>
                       (= tmp%4 (= i_sq@ (curve25519_dalek!specs.field_specs.field_neg.? (I 1))))
                       (and
                        (=>
                         %%location_label%%4
                         tmp%4
                        ...
                        (=>
                         tmp%4
                         (=>
                          (= tmp%5 (curve25519_dalek!specs.field_specs.field_neg.? (I u!)))
                          (=>
                           (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_assoc.
                            tmp%5 i@ i@
                           )
                           (=>
                            (= tmp%6 (curve25519_dalek!specs.field_specs.field_neg.? (I u!)))
                            (=>
                             (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_neg_one_times_is_neg.
                              tmp%6
                             )
                             (=>
                              (= tmp%7 (curve25519_dalek!specs.field_specs.field_neg.? (I u!)))
                              (=>
                               (= tmp%8 (curve25519_dalek!specs.field_specs.field_neg.? (I 1)))
                               (=>
                                (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_comm.
                                 tmp%7 tmp%8
                                )
                                (=>
                                 ...
                                 (and
                                  ...
                                  (=>
                                   ...
                                   (=>
                                    (= tmp%9 (= (curve25519_dalek!specs.field_specs.field_mul.? (I u!) (I i@)) u!))
                                    (and
                                     (=>
                                      %%location_label%%6
                                      tmp%9
                                                      ...
                                                      (=>
                                                       ...
                                                       (and
                                                        ...
                                                        (=>
                                                         ...
                                                         (and
                                                          (=>
                                                           (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub. u! i@ 1)
                                                           (=>
                                                            (ens%vstd!arithmetic.mul.lemma_mul_basics. u!)
                                                            (=>
                                                             %%location_label%%17
                                                             (= (nClip (Mul u! i_minus_1@)) (Sub (nClip (Mul u! i@)) u!))
                                                          )))
                                                          (=>
                                                           (= (nClip (Mul u! i_minus_1@)) (Sub (nClip (Mul u! i@)) u!))
                                                           (=>
                                                            (= tmp%14 (= (curve25519_dalek!specs.field_specs.field_mul.? (I u!) (I i_minus_1@))
                                                              0
                                                            ))
                                                            (and
                                                             (=>
                                                              ...
                                                              (and
                                                               ...
                                                               (=>
                                                                ...
                                                                (and
                                                                 (=>
                                                                  %%location_label%%20
                                                                  (req%vstd!arithmetic.div_mod.lemma_small_mod. i_minus_1@ pn@)
                                                                 )
                                                                 (=>
                                                                  (ens%vstd!arithmetic.div_mod.lemma_small_mod. i_minus_1@ pn@)
                                                                  (and
                                                                   (=>
                                                                    %%location_label%%21
                                                                    (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_nonzero_product.
