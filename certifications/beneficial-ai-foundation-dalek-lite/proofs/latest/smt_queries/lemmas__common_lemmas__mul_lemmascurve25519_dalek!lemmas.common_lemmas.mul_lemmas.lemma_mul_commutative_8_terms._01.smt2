...
;; curve25519-dalek/src/lemmas/common_lemmas/mul_lemmas.rs:212:1: 229:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::mul_lemmas::lemma_mul_commutative_8_terms
;; curve25519-dalek/src/lemmas/common_lemmas/mul_lemmas.rs:212:1: 229:2 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. a0! b0!)
    (=>
     (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. a1! b1!)
     (=>
      (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. a2! b2!)
      (=>
       (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. a3! b3!)
       (=>
        (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. a4! b4!)
        (=>
         (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. a5! b5!)
         (=>
          (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. a6! b6!)
          (=>
           (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. a7! b7!)
           (=>
            %%location_label%%0
            (= (Add (Add (Add (Add (Add (Add (Add (Mul a0! b0!) (Mul a1! b1!)) (Mul a2! b2!)) (Mul a3!
                   b3!
                  )
                 ) (Mul a4! b4!)
                ) (Mul a5! b5!)
