...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:412:1: 412:64 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_field_add_sub_recover_double
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:412:1: 412:64 (#0)
...
(push)
 ...
 (declare-const rhs_simpl@ Int)
 (declare-const b_int@ Int)
 (declare-const A_int@ Int)
 (declare-const D_int@ Int)
 (declare-const add_ab@ Int)
 (declare-const sub_ab@ Int)
 (declare-const v_int@ Int)
 (assert
  fuel_defaults
 )
 (assert
     ...
     (=>
      ...
      (=>
       ...
       (=>
        (= bm@ (EucMod b! p@))
        (=>
         (= lhs@ (curve25519_dalek!specs.field_specs.field_sub.? (I (curve25519_dalek!specs.field_specs.field_add.?
             (I a!) (I b!)
            )
           ) (I (curve25519_dalek!specs.field_specs.field_sub.? (I a!) (I b!)))
         ))
         (=>
          (= rhs@ (curve25519_dalek!specs.field_specs.field_mul.? (I 2) (I b!)))
          (=>
           (= rhs_simpl@ (curve25519_dalek!specs.field_specs.field_mul.? (I 2) (I bm@)))
           (and
            (and
             (=>
              %%location_label%%0
              (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. 2 b! p_int@)
             )
             (=>
              (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. 2 b! p_int@)
              (=>
               %%location_label%%1
               (= rhs@ rhs_simpl@)
            )))
            (=>
             (= rhs@ rhs_simpl@)
             (=>
              (= tmp%1 (= rhs_simpl@ (EucMod (nClip (Mul 2 bm@)) p@)))
              (and
               (=>
                %%location_label%%2
                tmp%1
               ...
               (=>
                ...
                (=>
                 (= b_int@ bm@)
                 (=>
                  (= A_int@ (nClip (Add am@ bm@)))
                  (=>
                   (= D_int@ (Sub (nClip (Add am@ p@)) bm@))
                   (and
                    (and
                     (=>
                      %%location_label%%3
                      (req%vstd!arithmetic.div_mod.lemma_add_mod_noop. a! b! p_int@)
                     )
                     (=>
                      (ens%vstd!arithmetic.div_mod.lemma_add_mod_noop. a! b! p_int@)
                      (=>
                       %%location_label%%4
                       (= (curve25519_dalek!specs.field_specs.field_add.? (I a!) (I b!)) (EucMod (nClip (Add
                           am@ bm@
                          )
                         ) p@
                    )))))
                    (=>
                     ...
                     (=>
                      (= tmp%2 (= (curve25519_dalek!specs.field_specs.field_sub.? (I a!) (I b!)) (EucMod (
                          nClip (Sub (nClip (Add am@ p@)) bm@)
                         ) p@
                      )))
                      (and
                       (=>
                       ...
                       (=>
                        tmp%2
                        (=>
                         (= add_ab@ (curve25519_dalek!specs.field_specs.field_add.? (I a!) (I b!)))
                         (=>
                          (= sub_ab@ (curve25519_dalek!specs.field_specs.field_sub.? (I a!) (I b!)))
                          (=>
                           (= tmp%3 (= add_ab@ (EucMod (nClip (Add am@ bm@)) p@)))
                           (and
                            (=>
                             %%location_label%%6
                             tmp%3
                            ...
                            (=>
                             tmp%3
                             (=>
                              (= tmp%4 (= sub_ab@ (EucMod (nClip (Sub (nClip (Add am@ p@)) bm@)) p@)))
                              (and
                               (=>
                                %%location_label%%7
                                tmp%4
                               ...
                               (=>
                                ...
                                (and
                                 (and
                                  (=>
                                   (= tmp%5 (nClip (Add am@ bm@)))
                                   (and
                                    (=>
                                     %%location_label%%8
                                     (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%5 p_int@)
                                    )
                                    (=>
                                     (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%5 p_int@)
                                     (=>
                                      %%location_label%%9
                                      (< add_ab@ p@)
                                  ))))
                                  (=>
                                   ...
                                   (and
                                    (=>
                                     (= tmp%6 (Sub (nClip (Add am@ p@)) bm@))
                                     (and
                                      (=>
                                       %%location_label%%10
                                       (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%6 p_int@)
                                      )
                                      (=>
                                       (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%6 p_int@)
                                       (=>
                                        %%location_label%%11
                                        (< sub_ab@ p@)
                                    ))))
                                    (=>
                                     ...
                                     (and
                                      (=>
                                       %%location_label%%12
                                       (req%vstd!arithmetic.div_mod.lemma_small_mod. add_ab@ p@)
                                      )
                                      (=>
                                       (ens%vstd!arithmetic.div_mod.lemma_small_mod. add_ab@ p@)
                                       (and
                                        (=>
                                         %%location_label%%13
                                         (req%vstd!arithmetic.div_mod.lemma_small_mod. sub_ab@ p@)
                                        )
                                        (=>
                                         (ens%vstd!arithmetic.div_mod.lemma_small_mod. sub_ab@ p@)
                                         (=>
                                          %%location_label%%14
                                          (= lhs@ (EucMod (nClip (Sub (nClip (Add add_ab@ p@)) sub_ab@)) p@))
                                 )))))))))
                                 (=>
                                  (= lhs@ (EucMod (nClip (Sub (nClip (Add add_ab@ p@)) sub_ab@)) p@))
                                  (=>
                                   (= v_int@ (Sub (Add add_ab@ p_int@) sub_ab@))
                                   (and
                                    (=>
                                     (= tmp%7 (< sub_ab@ p@))
                                     (and
                                     ...
                                     (and
                                      (and
                                       ...
                                       (=>
                                        ...
                                        (=>
                                         %%location_label%%18
                                         (= (nClip (EucMod v_int@ p_int@)) (EucMod (nClip (Sub (nClip (Add add_ab@ p@)) sub_ab@))
                                           p@
                                      )))))
                                      (=>
                                       (= (nClip (EucMod v_int@ p_int@)) (EucMod (nClip (Sub (nClip (Add add_ab@ p@)) sub_ab@))
                                         ...
                                         (and
                                          (and
                                           ...
                                           (=>
                                            ...
                                            (=>
                                             %%location_label%%22
                                             (= sub_ab@ (EucMod D_int@ p_int@))
                                          )))
                                          (=>
                                           (= sub_ab@ (EucMod D_int@ p_int@))
                                           (and
                                            (=>
                                             (= tmp%8 (Sub (EucMod A_int@ p_int@) (EucMod D_int@ p_int@)))
                                             (and
                                              (=>
                                               %%location_label%%23
                                               (req%vstd!arithmetic.div_mod.lemma_mod_add_multiples_vanish. tmp%8 p_int@)
                                              )
                                              (=>
                                               (ens%vstd!arithmetic.div_mod.lemma_mod_add_multiples_vanish. tmp%8 p_int@)
                                               (=>
                                                %%location_label%%24
                                                (= (EucMod (Sub (Add (EucMod A_int@ p_int@) p_int@) (EucMod D_int@ p_int@)) p_int@)
                                                 (EucMod (Sub (EucMod A_int@ p_int@) (EucMod D_int@ p_int@)) p_int@)
                                            )))))
                                            (=>
                                             (= (EucMod (Sub (Add (EucMod A_int@ p_int@) p_int@) (EucMod D_int@ p_int@)) p_int@)
                                              (EucMod (Sub (EucMod A_int@ p_int@) (EucMod D_int@ p_int@)) p_int@)
                                             ...
                                             (and
                                              (=>
                                               %%location_label%%25
                                               (req%vstd!arithmetic.div_mod.lemma_sub_mod_noop. A_int@ D_int@ p_int@)
                                              )
                                              (=>
                                               (ens%vstd!arithmetic.div_mod.lemma_sub_mod_noop. A_int@ D_int@ p_int@)
                                               (=>
                                                (= tmp%9 (= (Sub A_int@ D_int@) (Sub (Mul 2 b_int@) p_int@)))
                                                (and
                                                 (=>
                                                  %%location_label%%26
                                                  tmp%9
                                                 ...
                                                 (=>
                                                  tmp%9
                                                  (=>
                                                   (= tmp%10 (Sub (Mul 2 b_int@) p_int@))
                                                   (and
                                                    (=>
                                                     %%location_label%%27
                                                     (req%vstd!arithmetic.div_mod.lemma_mod_add_multiples_vanish. tmp%10 p_int@)
                                                    )
                                                    (=>
                                                     (ens%vstd!arithmetic.div_mod.lemma_mod_add_multiples_vanish. tmp%10 p_int@)
                                                     (=>
                                                      (= tmp%11 (= (EucMod (Sub (Mul 2 b_int@) p_int@) p_int@) (EucMod (Mul 2 b_int@) p_int@)))
                                                      (and
                                                       (=>
                                                        %%location_label%%28
                                                        tmp%11
