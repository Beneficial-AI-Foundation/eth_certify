...
;; curve25519-dalek/src/lemmas/edwards_lemmas/torsion_lemmas.rs:166:1: 166:70 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::torsion_lemmas::lemma_edwards_add_zero_coord_denom
;; curve25519-dalek/src/lemmas/edwards_lemmas/torsion_lemmas.rs:166:1: 166:70 (#0)
...
(push)
 ...
 (declare-const d@ Int)
 (declare-const t@ Int)
 (declare-const denom_x@ Int)
 (declare-const denom_y@ Int)
 (assert
  fuel_defaults
 )
 (assert
                ...
                (and
                 ...
                 (=>
                  ...
                  (=>
                   ...
                   (=>
                    (= tmp%4 (and
                      (= (curve25519_dalek!specs.field_specs.field_inv.? (I denom_x@)) 1)
                      (= (curve25519_dalek!specs.field_specs.field_inv.? (I denom_y@)) 1)
                    ))
                    (and
                     (=>
                      %%location_label%%6
