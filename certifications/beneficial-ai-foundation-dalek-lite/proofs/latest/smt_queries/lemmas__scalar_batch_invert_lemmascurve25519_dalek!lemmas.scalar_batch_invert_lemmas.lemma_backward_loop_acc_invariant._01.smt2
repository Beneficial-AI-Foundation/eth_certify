...
;; curve25519-dalek/src/lemmas/scalar_batch_invert_lemmas.rs:178:5: 178:11 (#0)
...
;; Function-Def curve25519_dalek::lemmas::scalar_batch_invert_lemmas::lemma_backward_loop_acc_invariant
;; curve25519-dalek/src/lemmas/scalar_batch_invert_lemmas.rs:178:5: 178:11 (#0)
(set-option :smt.arith.solver 6)
(get-info :all-statistics)
(push)
 (declare-const acc_before! Int)
 (declare-const input_val! Int)
 ...
 (assert
  (not (=>
    %%location_label%%0
    (= (nClip (Mul (nClip (Mul acc_before! s_i@)) R@)) (nClip (Mul acc_before! (nClip (Mul
         s_i@ R@
 ))))))))
 (get-info :version)
