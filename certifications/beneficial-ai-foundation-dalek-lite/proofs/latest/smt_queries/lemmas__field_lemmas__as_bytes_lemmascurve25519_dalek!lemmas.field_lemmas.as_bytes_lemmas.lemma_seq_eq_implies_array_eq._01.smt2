...
;; curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:342:1: 342:81 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::as_bytes_lemmas::lemma_seq_eq_implies_array_eq
;; curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:342:1: 342:81 (#0)
  ...
  (not (and
    (=>
     ...
     (=>
      ...
      (=>
       (= tmp%1 (= (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!core_assumes.seq_from32.?
            (Poly%array%. bytes1!)
           )
          ) i@
         ) (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT
    ...
    (=>
     (forall ((i$ Poly)) (!
       ...
       :qid user_curve25519_dalek__lemmas__field_lemmas__as_bytes_lemmas__lemma_seq_eq_implies_array_eq_54
       :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__as_bytes_lemmas__lemma_seq_eq_implies_array_eq_54
     ))
     (=>
      (= tmp%4 (ext_eq false (ARRAY $ (UINT 8) $ (CONST_INT 32)) (Poly%array%. bytes1!) (
         Poly%array%. bytes2!
      )))
      (and
       (=>
       ...
       (=>
        ...
        (=>
         %%location_label%%5
         (ext_eq false (ARRAY $ (UINT 8) $ (CONST_INT 32)) (Poly%array%. bytes1!) (Poly%array%.
           bytes2!
 ))))))))))
 (get-info :version)
