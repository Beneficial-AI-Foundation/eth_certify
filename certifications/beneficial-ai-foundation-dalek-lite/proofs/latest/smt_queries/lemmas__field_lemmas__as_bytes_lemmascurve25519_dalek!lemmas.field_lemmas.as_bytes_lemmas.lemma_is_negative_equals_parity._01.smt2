...
;; curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:956:5: 956:11 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::as_bytes_lemmas::lemma_is_negative_equals_parity
;; curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:956:5: 956:11 (#0)
...
(declare-const byte0@ (_ BitVec 8))
...
(assert
 (not (=>
   %%location_label%%0
   (= (= (bvand byte0@ ((_ zero_extend 7) (_ bv1 1))) ((_ zero_extend 7) (_ bv1 1)))
    (= (let
      ((tmp$$$$bitvectmp0 (_ bv2 2)))
      (ite
       (= tmp$$$$bitvectmp0 (_ bv0 2))
       tmp$$$$bitvectmp1
       (bvurem byte0@ ((_ zero_extend 6) tmp$$$$bitvectmp0))
      )
