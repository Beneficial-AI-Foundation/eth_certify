...
;; curve25519-dalek/src/lemmas/scalar_lemmas_/radix_2w_lemmas.rs:135:1: 135:79 (#0)
...
;; Function-Def curve25519_dalek::lemmas::scalar_lemmas_::radix_2w_lemmas::lemma_u64x4_lower_words_bounded
;; curve25519-dalek/src/lemmas/scalar_lemmas_/radix_2w_lemmas.rs:135:1: 135:79 (#0)
(get-info :all-statistics)
(push)
 (declare-const words! %%Function%%)
 (declare-const base_idx! Int)
 ...
 (declare-const p64$1@ Int)
 (declare-const p128$1@ Int)
 ...
 (assert
  (not (=>
    ...
    (=>
     (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_u64_lt_pow2_64. tmp%1)
     (or
      (and
       (=>
        (>= base_idx! 2)
        (=>
         ...
         (=>
          (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_u64_lt_pow2_64. tmp%2)
          (=>
            ...
            (=>
             ...
             (and
              (=>
               ...
               (=>
                ...
                (and
                 (=>
                  %%location_label%%0
                  (req%vstd!arithmetic.mul.lemma_mul_inequality. tmp%3 tmp%4 p64@)
                 )
                 (=>
                  (ens%vstd!arithmetic.mul.lemma_mul_inequality. tmp%3 tmp%4 p64@)
                  (=>
                   %%location_label%%1
              ...
              (=>
               ...
               (and
                (=>
                 (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub_other_way. p64@ p64@ 1)
                 (=>
                  (ens%vstd!arithmetic.mul.lemma_mul_basics. p64@)
                  (=>
                   %%location_label%%2
                   (= (Mul (Sub p64@ 1) p64@) (Sub p128@ p64@))
                )))
                (=>
                 (= (Mul (Sub p64@ 1) p64@) (Sub p128@ p64@))
                 %%switch_label%%1
        ...
        (and
         (=>
          ...
          (=>
           ...
           (=>
            (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_u64_lt_pow2_64. tmp%5)
            (=>
             (ens%vstd!arithmetic.power2.lemma_pow2_adds. 128 64)
             (=>
              (= p64$1@ (vstd!arithmetic.power2.pow2.? (I 64)))
              (=>
               (= p128$1@ (vstd!arithmetic.power2.pow2.? (I 128)))
               (=>
                (= p192@ (vstd!arithmetic.power2.pow2.? (I 192)))
                (and
                 (=>
                  ...
                  (=>
                   ...
                   (and
                    (=>
                     %%location_label%%3
                     (req%vstd!arithmetic.mul.lemma_mul_inequality. tmp%6 tmp%7 p128$1@)
                    )
                    (=>
                     (ens%vstd!arithmetic.mul.lemma_mul_inequality. tmp%6 tmp%7 p128$1@)
                     (=>
                      %%location_label%%4
                      (<= (Mul (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64)
                            $ (CONST_INT 4)
                 ...
                 (=>
                  ...
                  (and
                   (=>
                    (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub_other_way. p128$1@ p64$1@ 1)
                    (=>
                     (ens%vstd!arithmetic.mul.lemma_mul_basics. p128$1@)
                     (=>
                      (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. p64$1@ p128$1@)
                      (=>
                       %%location_label%%5
                       (= (Mul (Sub p64$1@ 1) p128$1@) (Sub p192@ p128$1@))
                   ))))
                   (=>
                    (= (Mul (Sub p64$1@ 1) p128$1@) (Sub p192@ p128$1@))
                    %%switch_label%%0
