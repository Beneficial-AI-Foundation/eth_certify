...
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:171:1: 171:54 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::number_theory_lemmas::lemma_gcd_with_prime
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:171:1: 171:54 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= a_red@ (EucMod a! prime!))
    (=>
     (= g@ (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.spec_gcd.? (I a_red@)
       (I prime!)
     ))
     (and
      (and
       (=>
        %%location_label%%0
        (req%vstd!arithmetic.div_mod.lemma_mod_bound. a! prime!)
       )
       (=>
        (ens%vstd!arithmetic.div_mod.lemma_mod_bound. a! prime!)
        (=>
         %%location_label%%1
         (< a_red@ prime!)
      )))
             ...
             (=>
              ...
              (and
               (and
                (=>
                 %%location_label%%7
                 (req%vstd!arithmetic.div_mod.lemma_small_mod. a_red@ prime!)
                )
                (=>
                 (ens%vstd!arithmetic.div_mod.lemma_small_mod. a_red@ prime!)
                 (=>
                  %%location_label%%8
                  (= (EucMod a_red@ prime!) a_red@)
               )))
               (=>
                (= (EucMod a_red@ prime!) a_red@)
                (=>
