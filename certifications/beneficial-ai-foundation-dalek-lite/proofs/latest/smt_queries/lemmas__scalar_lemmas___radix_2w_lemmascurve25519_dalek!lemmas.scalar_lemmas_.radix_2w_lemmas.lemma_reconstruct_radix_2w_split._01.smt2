...
;; curve25519-dalek/src/lemmas/scalar_lemmas_/radix_2w_lemmas.rs:188:1: 188:79 (#0)
...
;; Function-Def curve25519_dalek::lemmas::scalar_lemmas_::radix_2w_lemmas::lemma_reconstruct_radix_2w_split
;; curve25519-dalek/src/lemmas/scalar_lemmas_/radix_2w_lemmas.rs:188:1: 188:79 (#0)
    ...
    (or
     (and
       ...
       (=>
        ...
        (and
         ...
         (=>
          tmp%1
          (=>
           (= tmp%2 (= (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.? (vstd!seq.Seq.subrange.?
               $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I 0) (I 0)
              ) (I w!)
             ) 0
           ))
           (and
            ...
            (=>
             ...
             (=>
              (= tmp%3 (ext_eq false (TYPE%vstd!seq.Seq. $ (SINT 8)) (vstd!seq.Seq.subrange.? $ (SINT
                  8
                 ) (Poly%vstd!seq.Seq<i8.>. digits!) (I 0) (I (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
                    digits!
                 )))
               ...
               (=>
                ...
                (and
                 ...
                 (=>
                  (= (vstd!arithmetic.power2.pow2.? (I 0)) 1)
                  (=>
                   (= tmp%4 (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.? (Poly%vstd!seq.Seq<i8.>.
                      digits!
                     ) (I w!)
                   ))
                   (=>
      ...
      (=>
       (not (= k! 0))
       (=>
        (= tmp%5 (> (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!)) 0))
        (and
         (=>
          %%location_label%%4
          tmp%5
          ...
          (=>
           ...
           (=>
            (= tail@ (%Poly%vstd!seq.Seq<i8.>. (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
                digits!
               ) (I 1) (I (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!)))
            )))
            (=>
                 ...
                 (=>
                  ...
                  (=>
                   (= tmp%7 (ext_eq false (TYPE%vstd!seq.Seq. $ (SINT 8)) (vstd!seq.Seq.subrange.? $ (SINT
                       8
                      ) (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I 0) (I k!))
                    ...
                    (=>
                     ...
                     (=>
                      (= tmp%8 (ext_eq false (TYPE%vstd!seq.Seq. $ (SINT 8)) (vstd!seq.Seq.subrange.? $ (SINT
                          8
                         ) (Poly%vstd!seq.Seq<i8.>. digits!) (I k!) (I (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
                            digits!
                         )))
                           ...
                           (=>
                            ...
                            (=>
                             (= tmp%10 (= (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. prefix@) (I 0))
                               (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. digits!) (I 0))
                             ))
                             (and
                              (=>
                               %%location_label%%11
                              ...
                              (=>
                               tmp%10
                               (=>
                                (= r_prefix_tail@ (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.? (vstd!seq.Seq.subrange.?
                                   $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. tail@) (I 0) (I km1@)
                                  ) (I w!)
                                ))
                                (=>
                                 (= r_suffix@ (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w.? (vstd!seq.Seq.subrange.?
                                 ...
                                 (=>
                                  ...
                                  (and
                                   (=>
                                    (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add. w! km1@ 1)
                                    (=>
                                     %%location_label%%12
                                     (= (nClip (Add (nClip (Mul w! km1@)) w!)) (nClip (Mul w! k!)))
                                   ))
                                   (=>
                                    (= (nClip (Add (nClip (Mul w! km1@)) w!)) (nClip (Mul w! k!)))
                                    (and
                                     (=>
                                      (= tmp%11 (nClip (Mul w! km1@)))
                                      (=>
                                       (ens%vstd!arithmetic.power2.lemma_pow2_adds. w! tmp%11)
                                       (=>
                                        %%location_label%%13
                                        (= (nClip (Mul (vstd!arithmetic.power2.pow2.? (I w!)) (vstd!arithmetic.power2.pow2.?
                                            (I (nClip (Mul w! km1@)))
                                          ))
                                         ) (vstd!arithmetic.power2.pow2.? (I (nClip (Mul w! k!))))
                                     ))))
                                     (=>
                                      (= (nClip (Mul (vstd!arithmetic.power2.pow2.? (I w!)) (vstd!arithmetic.power2.pow2.?
                                          (I (nClip (Mul w! km1@)))
                                      ...
                                      (and
                                       (=>
                                        (= tmp%12 (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul w! km1@)))) r_suffix@))
                                        (=>
                                         (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add. pw@ r_prefix_tail@ tmp%12)
                                         (=>
                                          %%location_label%%14
                                          (= (Mul pw@ (Add r_prefix_tail@ (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul w! km1@))))
                                              r_suffix@
                                            ))
                                           ) (Add (Mul pw@ r_prefix_tail@) (Mul pw@ (Mul (vstd!arithmetic.power2.pow2.? (I (nClip
                                                 (Mul w! km1@)
                                               ))
                                              ) r_suffix@
                                       )))))))
                                       (=>
                                        ...
                                        (and
                                         (=>
                                          (= tmp%13 (vstd!arithmetic.power2.pow2.? (I (nClip (Mul w! km1@)))))
                                          (=>
                                           (ens%vstd!arithmetic.mul.lemma_mul_is_associative. pw@ tmp%13 r_suffix@)
                                           (=>
                                            %%location_label%%15
                                            (= (Mul pw@ (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul w! km1@)))) r_suffix@))
                                             (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul w! k!)))) r_suffix@)
                                         ))))
                                         (=>
                                          (= (Mul pw@ (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul w! km1@)))) r_suffix@))
                                           (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul w! k!)))) r_suffix@)
