...
;; curve25519-dalek/src/lemmas/edwards_lemmas/straus_lemmas.rs:1042:1: 1042:76 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::straus_lemmas::lemma_reconstruct_radix_16_from_equals_reconstruct
;; curve25519-dalek/src/lemmas/edwards_lemmas/straus_lemmas.rs:1042:1: 1042:76 (#0)
 ...
 (assert
  (not (and
    ...
    (=>
     ...
     (=>
      (= tmp%1 (ext_eq false (TYPE%vstd!seq.Seq. $ (SINT 8)) (vstd!seq.Seq.subrange.? $ (SINT
          8
         ) (Poly%vstd!seq.Seq<i8.>. d!) (I 0) (I 64)
        ) (Poly%vstd!seq.Seq<i8.>. d!)
      ))
      (and
       (=>
