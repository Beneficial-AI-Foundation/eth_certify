...
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:2345:1: 2345:56 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::number_theory_lemmas::lemma_square_root_of_unity
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:2345:1: 2345:56 (#0)
     ...
     (=>
      ...
      (and
       (and
        (=>
         %%location_label%%0
         (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop. y! y! p!)
        )
        (=>
         (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop. y! y! p!)
         (and
          (=>
           %%location_label%%1
           (req%vstd!arithmetic.div_mod.lemma_small_mod. 0 p!)
          )
          (=>
           (ens%vstd!arithmetic.div_mod.lemma_small_mod. 0 p!)
           (=>
            %%location_label%%2
            (= (EucMod (nClip (Mul y! y!)) p!) 0)
       )))))
       (=>
        (= (EucMod (nClip (Mul y! y!)) p!) 0)
        (=>
     ...
     (=>
      ...
      (and
       (and
        (=>
         %%location_label%%4
         (req%vstd!arithmetic.div_mod.lemma_mod_bound. y! p!)
        )
        (=>
         (ens%vstd!arithmetic.div_mod.lemma_mod_bound. y! p!)
         (=>
          %%location_label%%5
          (and
           (>= yr@ 1)
         ...
         (=>
          ...
          (and
           (and
            (=>
             %%location_label%%8
             (req%vstd!arithmetic.mul.lemma_mul_increases. yr@ yr@)
            )
            (=>
             (ens%vstd!arithmetic.mul.lemma_mul_increases. yr@ yr@)
             (=>
              %%location_label%%9
              (>= (nClip (Mul yr@ yr@)) 1)
           )))
            ...
            (and
             (and
              (and
               (=>
                %%location_label%%10
                (req%vstd!arithmetic.div_mod.lemma_small_mod. 1 p!)
               )
               (=>
                (ens%vstd!arithmetic.div_mod.lemma_small_mod. 1 p!)
                (=>
                 %%location_label%%11
                 (= (EucMod 1 p!) 1)
              )))
               ...
               (=>
                ...
                (and
                 ...
                 (=>
                  ...
                  (=>
                   %%location_label%%13
                   (= (EucMod (nClip (Sub (nClip (Mul yr@ yr@)) 1)) p!) 0)
             ))))))
             (=>
              (= (EucMod (nClip (Sub (nClip (Mul yr@ yr@)) 1)) p!) 0)
              (and
               (and
                (=>
                 (= tmp%2 (Sub yr@ 1))
                 (=>
                  (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add. tmp%2 yr@ 1)
                  (=>
                   %%location_label%%14
                   (= (Mul (Sub yr@ 1) (nClip (Add yr@ 1))) (Add (Mul (Sub yr@ 1) yr@) (Mul (Sub yr@ 1)
                      1
                ))))))
                (=>
                 (= (Mul (Sub yr@ 1) (nClip (Add yr@ 1))) (Add (Mul (Sub yr@ 1) yr@) (Mul (Sub yr@ 1)
                 ...
                 (and
                  (=>
                   (= tmp%3 (Sub yr@ 1))
                   (=>
                    (ens%vstd!arithmetic.mul.lemma_mul_basics. tmp%3)
                    (=>
                     %%location_label%%15
                     (= (Mul (Sub yr@ 1) 1) (Sub yr@ 1))
                  )))
                  (=>
                   (= (Mul (Sub yr@ 1) 1) (Sub yr@ 1))
                   (and
                    (=>
                     (= tmp%4 (Sub yr@ 1))
                     (=>
                      (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. tmp%4 yr@)
                      (=>
                       %%location_label%%16
                       (= (Mul (Sub yr@ 1) yr@) (Mul yr@ (Sub yr@ 1)))
                    )))
                    (=>
                     (= (Mul (Sub yr@ 1) yr@) (Mul yr@ (Sub yr@ 1)))
                     (and
                      (=>
                       (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub. yr@ yr@ 1)
                       (=>
                        %%location_label%%17
                        (= (Mul yr@ (Sub yr@ 1)) (Sub (Mul yr@ yr@) (Mul yr@ 1)))
                      ))
                      (=>
                       (= (Mul yr@ (Sub yr@ 1)) (Sub (Mul yr@ yr@) (Mul yr@ 1)))
                       (and
                        (=>
                         (ens%vstd!arithmetic.mul.lemma_mul_basics. yr@)
                         (=>
                          %%location_label%%18
                          (= (Mul yr@ 1) yr@)
                        ))
                        (=>
                         ...
                         (=>
                          %%location_label%%19
                          (= (Sub (nClip (Mul yr@ yr@)) 1) (Mul (Sub yr@ 1) (nClip (Add yr@ 1))))
               )))))))))))
               (=>
                (= (Sub (nClip (Mul yr@ yr@)) 1) (Mul (Sub yr@ 1) (nClip (Add yr@ 1))))
                (=>
                 (= tmp%5 (= (EucMod (nClip (Mul (nClip (Sub yr@ 1)) (nClip (Add yr@ 1)))) p!) 0))
                 (and
                  (=>
                   %%location_label%%20
                   tmp%5
                  ...
                  (=>
                   tmp%5
                   (=>
                    (= tmp%6 (nClip (Sub yr@ 1)))
                    (=>
                     (= tmp%7 (nClip (Add yr@ 1)))
                     (and
                      (=>
                       %%location_label%%21
                       (req%curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.lemma_euclid_prime.
                      ...
                      (=>
                       ...
                       (or
                        (and
                             ...
                             (or
                              (and
                               (=>
                                (> (Sub yr@ 1) 0)
                                (=>
                                 (= tmp%9 (nClip (Sub yr@ 1)))
                                 (and
                                  (=>
                                   %%location_label%%23
                                   (req%vstd!arithmetic.div_mod.lemma_small_mod. tmp%9 p!)
                                  )
                                  (=>
                                   (ens%vstd!arithmetic.div_mod.lemma_small_mod. tmp%9 p!)
                                   (=>
                                    %%location_label%%24
                                    false
                               )))))
                         ...
                         (=>
                          (not (= (EucMod (nClip (Sub yr@ 1)) p!) 0))
                          (=>
                           (= tmp%12 (= (EucMod (nClip (Add yr@ 1)) p!) 0))
                           (and
                            (=>
                             %%location_label%%27
                             tmp%12
                                ...
                                (or
                                 (and
                                  (=>
                                   (< (nClip (Add yr@ 1)) p!)
                                   (=>
                                    (= tmp%14 (nClip (Add yr@ 1)))
                                    (and
                                     (=>
                                      %%location_label%%29
                                      (req%vstd!arithmetic.div_mod.lemma_small_mod. tmp%14 p!)
                                     )
                                     (=>
                                      (ens%vstd!arithmetic.div_mod.lemma_small_mod. tmp%14 p!)
                                      (=>
                                       %%location_label%%30
                                       false
                                  )))))
                                  (=>
                                   (not (< (nClip (Add yr@ 1)) p!))
                                   %%switch_label%%2
                                 ))
                                 (and
                                  (not %%switch_label%%2)
                                  (=>
                                   (= tmp%15 (= (nClip (Add yr@ 1)) p!))
                                   (and
                                    (=>
                                     %%location_label%%31
                                     tmp%15
                                     ...
                                     (=>
                                      ...
                                      (and
                                       ...
                                       (=>
                                        tmp%16
                                        (=>
                                         (= tmp%17 (= (EucMod y! p!) (nClip (Sub p! 1))))
                                         (and
                                          (=>
                                           %%location_label%%33
                                           tmp%17
