...
;; curve25519-dalek/src/backend/serial/scalar_mul/straus.rs:357:9: 357:38 (#3434)
...
;; Function-Def curve25519_dalek::backend::serial::scalar_mul::straus::Straus::optional_multiscalar_mul_verus
;; curve25519-dalek/src/backend/serial/scalar_mul/straus.rs:357:9: 357:38 (#3434)
...
(push)
 ...
 (declare-const verus_tmp_spec_points@ vstd!seq.Seq<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>.>.)
 ...
 (declare-const verus_tmp_unwrapped_points@ vstd!seq.Seq<curve25519_dalek!edwards.EdwardsPoint.>.)
 (declare-const verus_tmp_pts_affine@ vstd!seq.Seq<tuple%2<nat./nat.>.>.)
 (declare-const verus_tmp_nafs_seqs@ vstd!seq.Seq<vstd!seq.Seq<i8.>.>.)
 (declare-const tmp%20 Poly)
 (declare-const m@ Poly)
 (declare-const m$1@ Poly)
 (declare-const tmp%21 curve25519_dalek!edwards.EdwardsPoint.)
 ...
 (declare-const tmp%35 curve25519_dalek!window.NafLookupTable5.)
 (declare-const tmp%36 curve25519_dalek!edwards.EdwardsPoint.)
 ...
 (declare-const base_j@ tuple%2.)
 (declare-const digit_val@ Int)
 (declare-const term_j@ tuple%2.)
 (declare-const col_j@ tuple%2.)
 (declare-const digit_i8@ Int)
 (declare-const R_j@ curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.)
 (declare-const tmp%46 Bool)
 (declare-const digit$1@ Int)
 (declare-const tmp%47 Poly)
 (declare-const tmp%48 Int)
 (declare-const tmp%49 curve25519_dalek!window.NafLookupTable5.)
 (declare-const tmp%50 Int)
 (declare-const tmp%51 curve25519_dalek!edwards.EdwardsPoint.)
 ...
 (declare-const base_j$1@ tuple%2.)
 (declare-const digit_val$1@ Int)
 (declare-const term_j$1@ tuple%2.)
 (declare-const col_j$1@ tuple%2.)
 (declare-const neg_digit@ Int)
 (declare-const R_j$1@ curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.)
 (declare-const tmp%%$15@ core!cmp.Ordering.)
 (declare-const naf@ %%Function%%)
 (declare-const lookup_table@ curve25519_dalek!window.NafLookupTable5.)
 ...
 (declare-const tmp%63 curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const tmp%64 curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 ...
 (declare-const verus_tmp$1@0 vstd!seq.Seq<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>.>.)
 (declare-const spec_points@0 vstd!seq.Seq<core!option.Option<curve25519_dalek!edwards.EdwardsPoint.>.>.)
 ...
 (declare-const nafs@0 Poly)
 (declare-const idx@0 Int)
 (declare-const lookup_tables@0 alloc!vec.Vec<curve25519_dalek!window.NafLookupTable5<curve25519_dalek!backend.serial.curve_models.ProjectiveNielsPoint.>./allocator_global%.>.)
 (declare-const verus_tmp$2@0 Int)
 (declare-const n@0 Int)
 (declare-const verus_tmp$3@0 vstd!seq.Seq<curve25519_dalek!edwards.EdwardsPoint.>.)
 (declare-const unwrapped_points@0 vstd!seq.Seq<curve25519_dalek!edwards.EdwardsPoint.>.)
 (declare-const verus_tmp$4@0 vstd!seq.Seq<tuple%2<nat./nat.>.>.)
 (declare-const pts_affine@0 vstd!seq.Seq<tuple%2<nat./nat.>.>.)
 (declare-const verus_tmp$5@0 vstd!seq.Seq<vstd!seq.Seq<i8.>.>.)
 (declare-const nafs_seqs@0 vstd!seq.Seq<vstd!seq.Seq<i8.>.>.)
 ...
 (assert
  (has_type nafs@0 (TYPE%alloc!vec.Vec. $ (ARRAY $ (SINT 8) $ (CONST_INT 256)) $ ALLOCATOR_GLOBAL))
 )
 (assert
  (uInv SZ idx@0)
 )
 ...
 (assert
  (not (=>
    ...
    (=>
     (= (vstd!seq.Seq.len.? $ (ARRAY $ (SINT 8) $ (CONST_INT 256)) (vstd!view.View.view.?
        $ (TYPE%alloc!vec.Vec. $ (ARRAY $ (SINT 8) $ (CONST_INT 256)) $ ALLOCATOR_GLOBAL)
        nafs@0
       )
      ) idx@0
     )
     (=>
      (ext_eq false (TYPE%vstd!seq.Seq. $ TYPE%curve25519_dalek!scalar.Scalar.) (vstd!view.View.view.?
        $ (TYPE%alloc!vec.Vec. $ TYPE%curve25519_dalek!scalar.Scalar. $ ALLOCATOR_GLOBAL)
        (Poly%alloc!vec.Vec<curve25519_dalek!scalar.Scalar./allocator_global%.>. scalars_vec@)
       ) (Poly%vstd!seq.Seq<curve25519_dalek!scalar.Scalar.>. spec_scalars@0)
      )
      (=>
       (forall ((k$ Poly)) (!
         (=>
         ...
         :qid user_curve25519_dalek__backend__serial__scalar_mul__straus__Straus__optional_multiscalar_mul_verus_85
         :skolemid skolem_user_curve25519_dalek__backend__serial__scalar_mul__straus__Straus__optional_multiscalar_mul_verus_85
       ))
       (=>
        (forall ((k$ Poly)) (!
          (=>
           ...
           (=>
            ...
            (and
             (curve25519_dalek!specs.scalar_specs.is_valid_naf.? (vstd!view.View.view.? $ (ARRAY
                $ (SINT 8) $ (CONST_INT 256)
               ) (vstd!seq.Seq.index.? $ (ARRAY $ (SINT 8) $ (CONST_INT 256)) (vstd!view.View.view.?
                 $ (TYPE%alloc!vec.Vec. $ (ARRAY $ (SINT 8) $ (CONST_INT 256)) $ ALLOCATOR_GLOBAL)
                 nafs@0
                ) k$
               )
          ...
          :pattern ((vstd!view.View.view.? $ (ARRAY $ (SINT 8) $ (CONST_INT 256)) (vstd!seq.Seq.index.?
             $ (ARRAY $ (SINT 8) $ (CONST_INT 256)) (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
               $ (ARRAY $ (SINT 8) $ (CONST_INT 256)) $ ALLOCATOR_GLOBAL
              ) nafs@0
             ) k$
          )))
          :qid user_curve25519_dalek__backend__serial__scalar_mul__straus__Straus__optional_multiscalar_mul_verus_86
          :skolemid skolem_user_curve25519_dalek__backend__serial__scalar_mul__straus__Straus__optional_multiscalar_mul_verus_86
        ))
        (=>
         (= decrease%init0%0 (Sub (vstd!std_specs.vec.spec_vec_len.? $ TYPE%curve25519_dalek!scalar.Scalar.
            $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<curve25519_dalek!scalar.Scalar./allocator_global%.>.
             scalars_vec@
            )
           ) idx@0
         ))
         (=>
          (= tmp%2 idx@0)
          (=>
           (ens%alloc!vec.impl&%1.len. $ TYPE%curve25519_dalek!scalar.Scalar. $ ALLOCATOR_GLOBAL
            (Poly%alloc!vec.Vec<curve25519_dalek!scalar.Scalar./allocator_global%.>. scalars_vec@)
            tmp%1
           )
           (=>
            (< tmp%2 tmp%1)
            (=>
             (= tmp%3 (curve25519_dalek!specs.scalar_specs.is_canonical_scalar.? (vstd!seq.Seq.index.?
                $ TYPE%curve25519_dalek!scalar.Scalar. (vstd!view.View.view.? $ (TYPE%alloc!vec.Vec.
                  $ TYPE%curve25519_dalek!scalar.Scalar. $ ALLOCATOR_GLOBAL
                 ) (Poly%alloc!vec.Vec<curve25519_dalek!scalar.Scalar./allocator_global%.>. scalars_vec@)
                ) (I idx@0)
               ...
               (=>
                (= tmp%4 (<= (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT
                       8
                        ...
                        (vstd!seq.Seq.index.? $ TYPE%curve25519_dalek!scalar.Scalar. (vstd!view.View.view.?
                          $ (TYPE%alloc!vec.Vec. $ TYPE%curve25519_dalek!scalar.Scalar. $ ALLOCATOR_GLOBAL)
                          (Poly%alloc!vec.Vec<curve25519_dalek!scalar.Scalar./allocator_global%.>. scalars_vec@)
                         ) (I idx@0)
                     ))))
                ...
                (and
                 ...
                 (=>
                  tmp%4
                  (=>
                   (= tmp%5 (curve25519_dalek!scalar.Scalar./Scalar/bytes (%Poly%curve25519_dalek!scalar.Scalar.
                      (vstd!seq.Seq.index.? $ TYPE%curve25519_dalek!scalar.Scalar. (vstd!view.View.view.?
                        $ (TYPE%alloc!vec.Vec. $ TYPE%curve25519_dalek!scalar.Scalar. $ ALLOCATOR_GLOBAL)
                        (Poly%alloc!vec.Vec<curve25519_dalek!scalar.Scalar./allocator_global%.>. scalars_vec@)
                       ) (I idx@0)
                     ...
                     (and
                      ...
                      (=>
                       ...
                       (and
                        (=>
                         %%location_label%%4
                         (req%curve25519_dalek!scalar.impl&%52.non_adjacent_form. (%Poly%curve25519_dalek!scalar.Scalar.
                           tmp%6
                          ) 5
                        ))
                        (=>
                         (ens%curve25519_dalek!scalar.impl&%52.non_adjacent_form. (%Poly%curve25519_dalek!scalar.Scalar.
                           tmp%6
                          ) 5 tmp%7
                         )
                         (=>
                          (has_type nafs@1 (TYPE%alloc!vec.Vec. $ (ARRAY $ (SINT 8) $ (CONST_INT 256)) $ ALLOCATOR_GLOBAL))
                          (=>
                           (ens%alloc!vec.impl&%1.push. $ (ARRAY $ (SINT 8) $ (CONST_INT 256)) $ ALLOCATOR_GLOBAL
                            nafs@0 nafs@1 (Poly%array%. tmp%7)
                           )
                           (and
                            (=>
                             %%location_label%%5
                                ...
                                (and
                                 ...
                                 (and
                                  ...
                                  (and
                                   ...
                                   (=>
                                    %%location_label%%11
                                    (check_decrease_int (Sub (vstd!std_specs.vec.spec_vec_len.? $ TYPE%curve25519_dalek!scalar.Scalar.
                                       $ ALLOCATOR_GLOBAL (Poly%alloc!vec.Vec<curve25519_dalek!scalar.Scalar./allocator_global%.>.
                                        scalars_vec@
                                       )
                                      ) idx@1
