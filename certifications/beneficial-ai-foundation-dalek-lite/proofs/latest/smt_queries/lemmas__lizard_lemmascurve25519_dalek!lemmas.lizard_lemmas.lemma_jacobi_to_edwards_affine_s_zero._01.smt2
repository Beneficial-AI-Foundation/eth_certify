...
;; curve25519-dalek/src/lemmas/lizard_lemmas.rs:465:1: 465:59 (#0)
...
;; Function-Def curve25519_dalek::lemmas::lizard_lemmas::lemma_jacobi_to_edwards_affine_s_zero
;; curve25519-dalek/src/lemmas/lizard_lemmas.rs:465:1: 465:59 (#0)
     ...
     (=>
      ...
      (and
       ...
       (=>
        ...
        (=>
         %%location_label%%1
         (= (curve25519_dalek!specs.field_specs.field_square.? (I 0)) 0)
     ))))
     (=>
      (= (curve25519_dalek!specs.field_specs.field_square.? (I 0)) 0)
      (and
         ...
         (=>
          ...
          (=>
           ...
           (and
            (=>
             %%location_label%%3
             (req%vstd!arithmetic.div_mod.lemma_mod_add_multiples_vanish. 1 tmp%3)
            )
            (=>
             (ens%vstd!arithmetic.div_mod.lemma_mod_add_multiples_vanish. 1 tmp%3)
             (=>
              %%location_label%%4
             ...
             (=>
              ...
              (=>
               ...
               (and
                (=>
                 %%location_label%%8
                 (req%vstd!arithmetic.div_mod.lemma_small_mod. 1 tmp%5)
                )
                (=>
                 (ens%vstd!arithmetic.div_mod.lemma_small_mod. 1 tmp%5)
                 (=>
                  %%location_label%%9
              ...
              (and
               (and
                ...
                (=>
                 ...
                 (=>
                  %%location_label%%11
                  (= (curve25519_dalek!specs.field_specs.field_mul.? (I 2) (I 0)) 0)
               )))
               (=>
                (= (curve25519_dalek!specs.field_specs.field_mul.? (I 2) (I 0)) 0)
                (=>
                   ...
                   (=>
                    ...
                    (=>
                     ...
                     (and
                      (=>
                       %%location_label%%13
                       (req%vstd!arithmetic.div_mod.lemma_small_mod. 0 tmp%6)
                      )
                      (=>
                       (ens%vstd!arithmetic.div_mod.lemma_small_mod. 0 tmp%6)
                       (=>
                        %%location_label%%14
                        (= (curve25519_dalek!specs.field_specs.field_mul.? (I 0) (I denom@)) 0)
                  ))))))
                  (=>
                   (= (curve25519_dalek!specs.field_specs.field_mul.? (I 0) (I denom@)) 0)
                   (=>
