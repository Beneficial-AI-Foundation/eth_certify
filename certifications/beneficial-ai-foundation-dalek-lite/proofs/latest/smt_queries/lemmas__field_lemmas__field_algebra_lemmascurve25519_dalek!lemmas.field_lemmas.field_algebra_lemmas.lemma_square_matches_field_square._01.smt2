...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:381:1: 381:72 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_square_matches_field_square
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:381:1: 381:72 (#0)
(get-info :all-statistics)
(push)
 (declare-const y_raw! Int)
 (declare-const y2_raw! Int)
    ...
    (=>
     ...
     (and
      (=>
       (fuel_bool fuel%vstd!arithmetic.power.pow.)
       (=>
        (= tmp%1 (= (vstd!arithmetic.power.pow.? (I y_raw!) (I 1)) (Mul y_raw! (vstd!arithmetic.power.pow.?
            (I y_raw!) (I 0)
        ))))
        (and
         (=>
         ...
         (=>
          ...
          (=>
           %%location_label%%1
           (= (vstd!arithmetic.power.pow.? (I y_raw!) (I 2)) (Mul y_raw! y_raw!))
      )))))
      (=>
       (= (vstd!arithmetic.power.pow.? (I y_raw!) (I 2)) (Mul y_raw! y_raw!))
       (and
        (and
         (=>
          %%location_label%%2
          (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_general. y_raw! y_raw! p@)
         )
         (=>
          (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_general. y_raw! y_raw! p@)
          (=>
           %%location_label%%3
           (= (EucMod (nClip (Mul y_raw! y_raw!)) p@) (EucMod (nClip (Mul (EucMod y_raw! p@) (EucMod
                y_raw! p@
              ))
             ) p@
        )))))
        (=>
         ...
         (=>
          (= tmp%2 (= (curve25519_dalek!specs.field_specs.field_mul.? (I (EucMod y_raw! p@)) (
              I (EucMod y_raw! p@)
             )
            ) (curve25519_dalek!specs.field_specs.field_square.? (I (EucMod y_raw! p@)))
          ))
          (and
           (=>
            %%location_label%%4
