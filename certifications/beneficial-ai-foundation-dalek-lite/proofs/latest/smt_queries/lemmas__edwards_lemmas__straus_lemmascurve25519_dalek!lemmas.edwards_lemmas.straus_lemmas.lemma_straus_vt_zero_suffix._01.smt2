...
;; curve25519-dalek/src/lemmas/edwards_lemmas/straus_lemmas.rs:701:1: 701:101 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::straus_lemmas::lemma_straus_vt_zero_suffix
;; curve25519-dalek/src/lemmas/edwards_lemmas/straus_lemmas.rs:701:1: 701:101 (#0)
...
(push)
 ...
 (assert
  (forall ((k$ Poly)) (!
    ...
    :qid user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_straus_vt_zero_suffix_62
    :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_straus_vt_zero_suffix_62
 )))
 (assert
  (forall ((k$ Poly)) (!
    (=>
    ...
    :qid user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_straus_vt_zero_suffix_63
    :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_straus_vt_zero_suffix_63
 )))
 (assert
  (forall ((k$ Poly) (j$ Poly)) (!
    (=>
    ...
    :qid user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_straus_vt_zero_suffix_64
    :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_straus_vt_zero_suffix_64
 )))
 ...
 (assert
  (not (=>
    (= decrease%init0 (Sub 255 i!))
    (or
     (and
      (=>
       (= i! 255)
       (=>
        (ens%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_vt_base. points_affine!
         nafs!
        )
        %%switch_label%%0
      ))
      (=>
       ...
       (=>
        ...
        (and
         (=>
          %%location_label%%0
          (req%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_vt_step. points_affine!
           nafs! tmp%1
         ))
         (=>
          (ens%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_straus_vt_step. points_affine!
           nafs! tmp%1
          )
          (=>
           (= tmp%2 (Add i! 1))
           (and
            (=>
             ...
             (check_decrease_int (let
               ((points_affine!$0 points_affine!) (nafs!$1 nafs!) (i!$2 tmp%2))
               (Sub 255 i!$2)
            ...
            (and
             ...
             (=>
              ...
              (=>
               (= tmp%3 (Add i! 1))
               (=>
                (= tmp%4 (vstd!seq.Seq.len.? (DST $) (TYPE%tuple%2. $ NAT $ NAT) (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>.
                   points_affine!
                )))
                (and
                 (=>
                  %%location_label%%3
                  (req%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_column_sum_all_zero.
                   points_affine! nafs! tmp%3 tmp%4
                 ))
                 (=>
                  (ens%curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.lemma_column_sum_all_zero.
                   points_affine! nafs! tmp%3 tmp%4
                  ...
                  (=>
                   ...
                   (=>
                    ...
                    (=>
                     (= tmp%5 (curve25519_dalek!specs.edwards_specs.edwards_identity.? (I 0)))
                     (and
                      (=>
                       %%location_label%%4
                       (req%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_edwards_add_identity_right_canonical.
