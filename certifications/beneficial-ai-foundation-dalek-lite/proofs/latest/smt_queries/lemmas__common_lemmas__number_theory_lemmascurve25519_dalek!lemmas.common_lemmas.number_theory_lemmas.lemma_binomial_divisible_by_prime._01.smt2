...
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:464:1: 464:63 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::number_theory_lemmas::lemma_binomial_divisible_by_prime
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:464:1: 464:63 (#0)
 ...
 (assert
  (not (or
       ...
       (and
        ...
        (=>
         ...
         (and
          (=>
           %%location_label%%1
           (= (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial.? (I 2) (I 1))
            (nClip (Add (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial.? (
                I 1
               ) (I 0)
              ) (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial.? (I 1) (I 1))
          ))))
          (=>
           (= (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial.? (I 2) (I 1))
            (nClip (Add (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial.? (
           ...
           (=>
            (= tmp%2 (= (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial.? (
                I 1
               ) (I 0)
              ) 1
            ))
            (and
             ...
             (=>
              tmp%2
              (=>
               (= tmp%3 (= (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial.? (
                   I 1
                  ) (I 1)
                 ) 1
               ))
               (and
                ...
                (=>
                 tmp%3
                 (=>
                  (= tmp%4 (= (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial.? (
                      I 2
                     ) (I 1)
                    ) 2
                  ))
                   ...
                   (=>
                    ...
                    (and
                     (and
                      (=>
                       %%location_label%%5
                       (req%vstd!arithmetic.div_mod.lemma_mod_self_0. 2)
                      )
                      (=>
                       (ens%vstd!arithmetic.div_mod.lemma_mod_self_0. 2)
                       (=>
                        %%location_label%%6
                        (= (EucMod 2 2) 0)
                     )))
    ...
    (and
     ...
     (=>
      %%location_label%%8
      (= (EucMod (curve25519_dalek!lemmas.common_lemmas.number_theory_lemmas.binomial.? (I
          p!
         ) (I k!)
        ) p!
       ) 0
