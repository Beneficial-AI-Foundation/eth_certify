...
;; curve25519-dalek/src/lemmas/field_lemmas/limbs_to_bytes_lemmas.rs:960:5: 960:11 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::limbs_to_bytes_lemmas::lemma_limb1_contribution_correctness
;; curve25519-dalek/src/lemmas/field_lemmas/limbs_to_bytes_lemmas.rs:960:5: 960:11 (#0)
...
(push)
 ...
 (declare-const low_term@ Int)
 (declare-const middle_term@ Int)
 (declare-const high_term@ Int)
 (declare-const shifted_value@ Int)
 (declare-const low_part@ Int)
 (declare-const mid_part@ Int)
 ...
 (assert
  (not (=>
    (= (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $
     ...
     ) (nClip (Add (nClip (Add low_part@ (nClip (Mul mid_part@ (vstd!arithmetic.power2.pow2.?
            (I 5)
        ))))
       ) (nClip (Mul high_part@ (vstd!arithmetic.power2.pow2.? (I 45))))
    )))
    (=>
     (= contribution@ (nClip (Add (nClip (Add (nClip (Mul low_part@ (vstd!arithmetic.power2.pow2.?
             (I 51)
           ))
          ) (nClip (Mul mid_part@ (vstd!arithmetic.power2.pow2.? (I 56))))
         )
        ) (nClip (Mul high_part@ (vstd!arithmetic.power2.pow2.? (I 96))))
     )))
     (=>
      (= (vstd!arithmetic.power2.pow2.? (I 56)) (nClip (Mul (vstd!arithmetic.power2.pow2.?
          (I 51)
         ) (vstd!arithmetic.power2.pow2.? (I 5))
      )))
      (=>
       (= (vstd!arithmetic.power2.pow2.? (I 96)) (nClip (Mul (vstd!arithmetic.power2.pow2.?
           (I 51)
          ) (vstd!arithmetic.power2.pow2.? (I 45))
       )))
       (=>
