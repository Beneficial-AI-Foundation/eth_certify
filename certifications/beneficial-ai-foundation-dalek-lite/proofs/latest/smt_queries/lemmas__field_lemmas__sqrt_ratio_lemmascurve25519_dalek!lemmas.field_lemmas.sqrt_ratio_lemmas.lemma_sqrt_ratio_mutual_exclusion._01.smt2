...
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_ratio_lemmas.rs:1573:1: 1573:71 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::sqrt_ratio_lemmas::lemma_sqrt_ratio_mutual_exclusion
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_ratio_lemmas.rs:1573:1: 1573:71 (#0)
          ...
          (=>
           ...
           (or
            (and
              ...
              (and
               (=>
                ...
                (and
                 (=>
                  %%location_label%%2
                  (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. tmp%1 v! the_p@)
                 )
                 (=>
                  (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. tmp%1 v! the_p@)
                  (=>
                   %%location_label%%3
                   (= (EucMod (nClip (Mul (nClip (Mul r! r!)) (EucMod v! the_p@))) the_p@) (EucMod (nClip
                      (Mul (nClip (Mul r! r!)) v!)
                     ) the_p@
               ))))))
               (=>
             ...
             (=>
              (not (= (EucMod v! the_p@) 0))
              (=>
               (= r_mod@ (EucMod r! the_p@))
               (and
                (and
                 (=>
                  %%location_label%%8
                  (req%vstd!arithmetic.div_mod.lemma_mod_bound. r! the_p@)
                 )
                 (=>
                  (ens%vstd!arithmetic.div_mod.lemma_mod_bound. r! the_p@)
                  (=>
                   %%location_label%%9
                   (< r_mod@ the_p@)
                )))
                (=>
                 ...
                 (and
                  (and
                   (=>
                    %%location_label%%10
                    (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_general. r! r! the_p@)
                   )
                   (=>
                    (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_general. r! r! the_p@)
                    (=>
                     %%location_label%%11
                     (= (curve25519_dalek!specs.field_specs.field_square.? (I r_mod@)) (curve25519_dalek!specs.field_specs.field_square.?
                       (I r!)
                  )))))
                  (=>
                   (= (curve25519_dalek!specs.field_specs.field_square.? (I r_mod@)) (curve25519_dalek!specs.field_specs.field_square.?
