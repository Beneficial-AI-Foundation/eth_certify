...
;; curve25519-dalek/src/lemmas/field_lemmas/load8_lemmas.rs:320:1: 320:82 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::load8_lemmas::lemma_load8_plus_ver_div_mod
;; curve25519-dalek/src/lemmas/field_lemmas/load8_lemmas.rs:320:1: 320:82 (#0)
...
(push)
 ...
 (declare-const xk_1@ Int)
 (declare-const v@ Int)
 (declare-const v_n@ Int)
 (assert
  fuel_defaults
 )
 (assert
  ...
  (not (and
    (and
     ...
     (=>
      ...
      (=>
       %%location_label%%1
       (<= (vstd!arithmetic.power2.pow2.? (I s!)) 18446744073709551615)
    )))
    (=>
     (<= (vstd!arithmetic.power2.pow2.? (I s!)) 18446744073709551615)
     (and
      (=>
       ...
       (=>
        %%location_label%%2
        (> (vstd!arithmetic.power2.pow2.? (I s!)) 0)
      ))
      (=>
       (> (vstd!arithmetic.power2.pow2.? (I s!)) 0)
       (and
        (=>
         ...
         (and
          (=>
           %%location_label%%3
           (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_u64_pow2_le_max. tmp%1)
          )
          (=>
           (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_u64_pow2_le_max. tmp%1)
           (=>
            %%location_label%%4
            (<= (vstd!arithmetic.power2.pow2.? (I (nClip (Mul k! 8)))) 18446744073709551615)
        ))))
        (=>
         (<= (vstd!arithmetic.power2.pow2.? (I (nClip (Mul k! 8)))) 18446744073709551615)
         (=>
          (= p64@ (uClip 64 (vstd!arithmetic.power2.pow2.? (I s!))))
          (=>
           (= xk@ (curve25519_dalek!lemmas.field_lemmas.load8_lemmas.load8_at_plus_version_rec.?
             (Poly%slice%<u8.>. input!) (I i!) (I k!)
           ))
           (=>
            (= xk_1@ (curve25519_dalek!lemmas.field_lemmas.load8_lemmas.load8_at_plus_version_rec.?
              (Poly%slice%<u8.>. input!) (I i!) (I (nClip (Sub k! 1)))
            ))
            (=>
             ...
             (=>
              ...
              (and
               (=>
                ...
                (=>
                 %%location_label%%5
                 (= xk@ (uClip 64 (Add xk_1@ (uClip 64 (bitshl (I (uClip 64 v@)) (I (nClip (Mul k! 8))))))))
               ))
               (=>
                (= xk@ (uClip 64 (Add xk_1@ (uClip 64 (bitshl (I (uClip 64 v@)) (I (nClip (Mul k! 8))))))))
                (and
                 (=>
                  ...
                  (and
                   ...
                   (=>
                    ...
                    (=>
                     %%location_label%%7
                     (<= (Mul v@ (vstd!arithmetic.power2.pow2.? (I (nClip (Mul k! 8))))) 18446744073709551615)
                 ))))
                 (=>
                  (<= (Mul v@ (vstd!arithmetic.power2.pow2.? (I (nClip (Mul k! 8))))) 18446744073709551615)
                  (and
                   (=>
                    (= tmp%3 (uClip 64 (nClip (Mul k! 8))))
                    (and
                     (=>
                      %%location_label%%8
                      (req%vstd!bits.lemma_u64_shl_is_mul. (uClip 64 v@) tmp%3)
                     )
                     (=>
                      (ens%vstd!bits.lemma_u64_shl_is_mul. (uClip 64 v@) tmp%3)
                      (=>
                       %%location_label%%9
                       (= (uClip 64 (bitshl (I (uClip 64 v@)) (I (nClip (Mul k! 8))))) (Mul (vstd!arithmetic.power2.pow2.?
                          (I (nClip (Mul k! 8)))
                         ) v@
                   ))))))
                   (=>
                     ...
                     (=>
                      ...
                      (and
                       ...
                       (=>
                        ...
                        (=>
                         %%location_label%%11
                         (< xk_1@ (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 8 k!)))))
                     ))))
                     (=>
                      (< xk_1@ (vstd!arithmetic.power2.pow2.? (I (nClip (Mul 8 k!)))))
                      (and
                       (and
                        (and
                         ...
                         (=>
                          ...
                          (=>
                           %%location_label%%13
                           (<= (Add xk_1@ (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul k! 8)))) v@)) 18446744073709551615)
                        )))
                        (=>
                         (<= (Add xk_1@ (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul k! 8)))) v@)) 18446744073709551615)
                         (=>
                             ...
                             (and
                              ...
                              (=>
                               ...
                               (=>
                                %%location_label%%16
                                (and
                                 (= (EucDiv (uClip 64 (Add xk_1@ (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul k! 8))))
                                      v@
                                    ))
                                   ) p64@
                                  ) (Add (EucDiv xk_1@ p64@) (EucDiv (uClip 64 (Mul (vstd!arithmetic.power2.pow2.? (I (nClip
                                         (Mul k! 8)
                                       ))
                                      ) v@
                                     )
                                 ...
                                 (= (EucMod (uClip 64 (Add xk_1@ (Mul (vstd!arithmetic.power2.pow2.? (I (nClip (Mul k! 8))))
                                      v@
                                    ))
                                   ) p64@
                                  ) (Add (EucMod xk_1@ p64@) (EucMod (uClip 64 (Mul (vstd!arithmetic.power2.pow2.? (I (nClip
                                         (Mul k! 8)
                                       ))
                                      ) v@
                                     )
