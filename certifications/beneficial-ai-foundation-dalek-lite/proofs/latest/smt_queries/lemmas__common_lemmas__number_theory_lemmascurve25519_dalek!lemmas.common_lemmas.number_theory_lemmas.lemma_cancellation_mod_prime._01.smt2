...
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:2064:7: 2064:66 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::number_theory_lemmas::lemma_cancellation_mod_prime
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:2064:7: 2064:66 (#0)
  ...
  (not (or
    (and
     (=>
      ...
      (and
       (=>
        (ens%vstd!arithmetic.mul.lemma_mul_basics. b!)
        (and
         (=>
          %%location_label%%0
         ...
         (=>
          ...
          (=>
           %%location_label%%1
           (= (EucMod (nClip (Mul a! b!)) prime!) 0)
       ))))
       (=>
        (= (EucMod (nClip (Mul a! b!)) prime!) 0)
        (=>
         (= tmp%1 (= (EucMod b! prime!) 0))
         (and
          (=>
           %%location_label%%2
           tmp%1
     ...
     (=>
      ...
      (and
       ...
       (=>
        ...
        (and
         (=>
          (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_sub_other_way. b! a! 1)
          (=>
           %%location_label%%4
           (= (Mul (Sub a! 1) b!) (Sub (nClip (Mul a! b!)) b!))
         ))
         (=>
          (= (Mul (Sub a! 1) b!) (Sub (nClip (Mul a! b!)) b!))
          (or
           (and
            (=>
             ...
             (and
              (=>
               %%location_label%%5
               (req%vstd!arithmetic.div_mod.lemma_small_mod. 1 prime!)
              )
              (=>
               (ens%vstd!arithmetic.div_mod.lemma_small_mod. 1 prime!)
               %%switch_label%%0
            )))
            (=>
             (not (= a! 1))
              ...
              (=>
               ...
               (and
                (and
                 (=>
                  %%location_label%%8
                  (req%vstd!arithmetic.mul.lemma_mul_increases. a! b!)
                 )
                 (=>
                  (ens%vstd!arithmetic.mul.lemma_mul_increases. a! b!)
                  (=>
                   %%location_label%%9
                   (>= (nClip (Mul a! b!)) b!)
                )))
                 ...
                 (=>
                  ...
                  (and
                   ...
                   (=>
                    ...
                    (=>
                     (= tmp%4 (= (EucMod (nClip (Sub (nClip (Mul a! b!)) b!)) prime!) 0))
                     (and
                      (=>
                       %%location_label%%11
                       tmp%4
                      ...
                      (=>
                       tmp%4
                       (=>
                        (= tmp%5 (= (EucMod (nClip (Mul (nClip (Sub a! 1)) b!)) prime!) 0))
                        (and
                         (=>
                          %%location_label%%12
                          tmp%5
                          ...
                          (=>
                           ...
                           (and
                            ...
                            (=>
                             ...
                             (=>
                              (= tmp%7 (= (EucMod (nClip (Sub a! 1)) prime!) 0))
                              (and
                               (=>
                                %%location_label%%14
                                tmp%7
                                ...
                                (and
                                 (=>
                                  ...
                                  (and
                                   (=>
                                    %%location_label%%15
                                    (req%vstd!arithmetic.div_mod.lemma_mod_adds. tmp%8 1 prime!)
                                   )
                                   (=>
                                    (ens%vstd!arithmetic.div_mod.lemma_mod_adds. tmp%8 1 prime!)
                                    (and
                                     (=>
                                      %%location_label%%16
                                      (req%vstd!arithmetic.div_mod.lemma_small_mod. 1 prime!)
