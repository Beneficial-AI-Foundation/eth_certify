...
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_ratio_lemmas.rs:278:1: 278:71 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::sqrt_ratio_lemmas::lemma_no_square_root_when_times_i
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_ratio_lemmas.rs:278:1: 278:71 (#0)
...
(push)
 ...
 (declare-const r_squared_v$1@ Int)
 (declare-const iu$1@ Int)
 (declare-const inv_iu$1@ Int)
 (declare-const q2$1@ Int)
 (declare-const the_p@ Int)
 (declare-const i@ Int)
 (declare-const x@ Int)
 (declare-const x_inv@ Int)
 (declare-const q@ Int)
 (assert
  fuel_defaults
 )
 ...
 (assert
  (exists ((x$ Poly)) (!
    ...
    :qid user_curve25519_dalek__lemmas__field_lemmas__sqrt_ratio_lemmas__lemma_no_square_root_when_times_i_75
    :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__sqrt_ratio_lemmas__lemma_no_square_root_when_times_i_75
 )))
 (declare-fun %%choose%%0 (Type Int Poly Int Poly) Poly)
 (assert
  (forall ((%%hole%%0 Type) (%%hole%%1 Int) (%%hole%%2 Poly) (%%hole%%3 Int) (%%hole%%4
     Poly
    )
   ) (!
    (=>
     (exists ((x$1 Poly)) (!
       ...
       :qid user_curve25519_dalek__lemmas__field_lemmas__sqrt_ratio_lemmas__lemma_no_square_root_when_times_i_53
       :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__sqrt_ratio_lemmas__lemma_no_square_root_when_times_i_53
     ))
     (exists ((x$1 Poly)) (!
       (and
        (and
        ...
        (= (%%choose%%0 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4) x$1)
       )
       :pattern ((curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_square.?
           x$1
          )
    ...
    :pattern ((%%choose%%0 %%hole%%0 %%hole%%1 %%hole%%2 %%hole%%3 %%hole%%4))
 )))
 ...
 (assert
  (not (=>
    (= the_p@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
    (=>
     (= i@ (curve25519_dalek!specs.field_specs.sqrt_m1.? (I 0)))
     (=>
      (= x@ (%I (as_type (%%choose%%0 NAT (curve25519_dalek!specs.field_specs_u64.p.? (I 0))
          (I v!) (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.sqrt_m1.?
             (I 0)
            )
           ) (I u!)
          ) (I v!)
         ...
         (=>
          ...
          (and
           (and
            (=>
             %%location_label%%0
             (req%vstd!arithmetic.div_mod.lemma_small_mod. 0 the_p@)
            )
            (=>
             (ens%vstd!arithmetic.div_mod.lemma_small_mod. 0 the_p@)
             (=>
              %%location_label%%1
               ...
               (=>
                ...
                (and
                 ...
                 (=>
                  ...
                  (=>
                   %%location_label%%4
                   (= (curve25519_dalek!specs.field_specs.field_mul.? (I 0) (I v!)) 0)
             ))))))
             (=>
              (= (curve25519_dalek!specs.field_specs.field_mul.? (I 0) (I v!)) 0)
              (and
                ...
                (and
                 (or
                  (and
                      ...
                      (=>
                       ...
                       (and
                        (and
                         (=>
                          %%location_label%%7
                          (req%vstd!arithmetic.div_mod.lemma_small_mod. i@ the_p@)
                         )
                         (=>
                          (ens%vstd!arithmetic.div_mod.lemma_small_mod. i@ the_p@)
                          (=>
                           %%location_label%%8
                           (not (= (EucMod i@ the_p@) 0))
                        )))
                        (=>
                         (not (= (EucMod i@ the_p@) 0))
                         (=>
                   ...
                   (=>
                    (not (= (EucMod (nClip (Mul i@ u!)) the_p@) 0))
                    %%switch_label%%3
                  ))
                  (and
                   (not %%switch_label%%3)
       ...
       (=>
        ...
        (and
         (and
          (=>
           %%location_label%%13
           (req%vstd!arithmetic.div_mod.lemma_small_mod. x@ the_p@)
          )
          (=>
           (ens%vstd!arithmetic.div_mod.lemma_small_mod. x@ the_p@)
           (=>
            %%location_label%%14
            (not (= (EucMod x@ the_p@) 0))
         )))
         (=>
          (not (= (EucMod x@ the_p@) 0))
          (and
           ...
           (=>
            ...
            (=>
             (= x_inv@ (curve25519_dalek!specs.field_specs.field_inv.? (I x@)))
             (=>
              (= q@ (curve25519_dalek!specs.field_specs.field_mul.? (I r!) (I x_inv@)))
              (and
               (=>
                (= tmp%2 (nClip (Mul r! x_inv@)))
                (and
                 (=>
                  %%location_label%%16
                  (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%2 the_p@)
                 )
                 (=>
                  (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%2 the_p@)
                  (=>
                   %%location_label%%17
                   (< q@ the_p@)
               ))))
                    ...
                    (=>
                     ...
                     (=>
                      ...
                      (=>
                       ...
                       (=>
                        (= neg_i@ (nClip (Sub the_p@ i@)))
                        (and
                         (and
                          (=>
                           %%location_label%%18
                           (req%vstd!arithmetic.div_mod.lemma_mod_bound. u! the_p@)
                          )
                          (=>
                           (ens%vstd!arithmetic.div_mod.lemma_mod_bound. u! the_p@)
                           (=>
                            %%location_label%%19
                            (< r_squared_v@ the_p@)
                         )))
                          ...
                          (and
                           (and
                            ...
                            (=>
                             ...
                             (=>
                              %%location_label%%21
                              (= q2@ (curve25519_dalek!specs.field_specs.field_mul.? (I r_squared_v@) (I inv_iu@)))
                           )))
                           (=>
                            (= q2@ (curve25519_dalek!specs.field_specs.field_mul.? (I r_squared_v@) (I inv_iu@)))
                            (and
                             ...
                             (=>
                              ...
                              (and
                               (and
                                (=>
                                 %%location_label%%24
                                 (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. u! inv_iu@ the_p@)
                                )
                                (=>
                                 (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. u! inv_iu@ the_p@)
                                 (=>
                                  %%location_label%%25
                                  (= (curve25519_dalek!specs.field_specs.field_mul.? (I r_squared_v@) (I inv_iu@)) (
                                    curve25519_dalek!specs.field_specs.field_mul.? (I u!) (I inv_iu@)
                               )))))
                               (=>
                                (= (curve25519_dalek!specs.field_specs.field_mul.? (I r_squared_v@) (I inv_iu@)) (
                                  curve25519_dalek!specs.field_specs.field_mul.? (I u!) (I inv_iu@)
                                ...
                                (=>
                                 (= tmp%3 (= q2@ (curve25519_dalek!specs.field_specs.field_neg.? (I i@))))
                                 (and
                                  (=>
                                   %%location_label%%26
                                   tmp%3
                                   ...
                                   (and
                                    (and
                                     ...
                                     (=>
                                      (ens%vstd!arithmetic.div_mod.lemma_small_mod. i@ the_p@)
                                      (=>
                                       (= tmp%4 (nClip (Sub the_p@ i@)))
                                       (and
                                        (=>
                                         %%location_label%%28
                                         (req%vstd!arithmetic.div_mod.lemma_small_mod. tmp%4 the_p@)
                                        )
                                        (=>
                                         (ens%vstd!arithmetic.div_mod.lemma_small_mod. tmp%4 the_p@)
                                         (=>
                                          %%location_label%%29
                                          (= (curve25519_dalek!specs.field_specs.field_neg.? (I i@)) neg_i@)
                                    ))))))
                                    (=>
                                     (= (curve25519_dalek!specs.field_specs.field_neg.? (I i@)) neg_i@)
                                     (and
                                      (=>
                                       ...
                                       (=>
                                        %%location_label%%30
                                        (not (curve25519_dalek!specs.field_specs.is_square.? (I neg_i@)))
                                      ))
                                      (=>
                                       (not (curve25519_dalek!specs.field_specs.is_square.? (I neg_i@)))
                                       (and
                                        (and
                                         (=>
                                          %%location_label%%31
                                          (req%vstd!arithmetic.div_mod.lemma_small_mod. q2@ the_p@)
                                         )
                                         (=>
                                          (ens%vstd!arithmetic.div_mod.lemma_small_mod. q2@ the_p@)
                                          (and
                                           (=>
                                            %%location_label%%32
                                            (req%vstd!arithmetic.div_mod.lemma_small_mod. neg_i@ the_p@)
                                           )
                                           (=>
                                            (ens%vstd!arithmetic.div_mod.lemma_small_mod. neg_i@ the_p@)
                                            (=>
                                             %%location_label%%33
                                             (= (curve25519_dalek!specs.field_specs.field_mul.? (I q@) (I q@)) (curve25519_dalek!specs.field_specs_u64.field_canonical.?
                                               (I neg_i@)
                                        )))))))
                                        (=>
                                         (= (curve25519_dalek!specs.field_specs.field_mul.? (I q@) (I q@)) (curve25519_dalek!specs.field_specs_u64.field_canonical.?
                                         ...
                                         (=>
                                          (= tmp%5 (curve25519_dalek!specs.field_specs.is_square.? (I neg_i@)))
                                          (and
                                           (=>
                                            %%location_label%%34
                                            tmp%5
                  ...
                  (or
                   (and
                    (=>
                     ...
                     (=>
                      (= r_squared_v$1@ (curve25519_dalek!specs.field_specs.field_neg.? (I u!)))
                      (=>
                       (= iu$1@ (curve25519_dalek!specs.field_specs.field_mul.? (I i@) (I u!)))
                       (=>
                        (= inv_iu$1@ (curve25519_dalek!specs.field_specs.field_inv.? (I iu$1@)))
                        (=>
                         (= q2$1@ (curve25519_dalek!specs.field_specs.field_square.? (I q@)))
                         (and
                          (=>
                           (= tmp%6 (Sub the_p@ (EucMod u! the_p@)))
                           (and
                            (=>
                             %%location_label%%36
                             (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%6 the_p@)
                            )
                            (=>
                             (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%6 the_p@)
                             (=>
                              %%location_label%%37
                              (< r_squared_v$1@ the_p@)
                          ))))
                           ...
                           (and
                            (and
                             ...
                             (=>
                              ...
                              (=>
                               %%location_label%%39
                               (= q2$1@ (curve25519_dalek!specs.field_specs.field_mul.? (I r_squared_v$1@) (I inv_iu$1@)))
                            )))
                            (=>
                             (= q2$1@ (curve25519_dalek!specs.field_specs.field_mul.? (I r_squared_v$1@) (I inv_iu$1@)))
                             (and
                                 ...
                                 (=>
                                  ...
                                  (and
                                   (=>
                                    ...
                                    (=>
                                     %%location_label%%43
                                     (not (curve25519_dalek!specs.field_specs.is_square.? (I i@)))
                                   ))
                                   (=>
                                    (not (curve25519_dalek!specs.field_specs.is_square.? (I i@)))
                                    (and
                                     (and
                                      (=>
                                       %%location_label%%44
                                       (req%vstd!arithmetic.div_mod.lemma_small_mod. q2$1@ the_p@)
                                      )
                                      (=>
                                       (ens%vstd!arithmetic.div_mod.lemma_small_mod. q2$1@ the_p@)
                                       (and
                                        (=>
                                         %%location_label%%45
                                         (req%vstd!arithmetic.div_mod.lemma_small_mod. i@ the_p@)
                                     ...
                                     (=>
                                      ...
                                      (=>
                                       (= tmp%8 (curve25519_dalek!specs.field_specs.is_square.? (I i@)))
                                       (and
                                        (=>
                                         %%location_label%%47
                                         tmp%8
