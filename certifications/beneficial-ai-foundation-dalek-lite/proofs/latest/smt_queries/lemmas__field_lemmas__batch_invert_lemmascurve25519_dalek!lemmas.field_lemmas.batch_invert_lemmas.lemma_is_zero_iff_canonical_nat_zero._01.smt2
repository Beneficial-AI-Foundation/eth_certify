...
;; curve25519-dalek/src/lemmas/field_lemmas/batch_invert_lemmas.rs:31:1: 31:70 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::batch_invert_lemmas::lemma_is_zero_iff_canonical_nat_zero
;; curve25519-dalek/src/lemmas/field_lemmas/batch_invert_lemmas.rs:31:1: 31:70 (#0)
(get-info :all-statistics)
(push)
 (declare-const fe! curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 ...
 (assert
  (has_type (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!) TYPE%curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 )
 ...
 (assert
  (not (=>
    (= bytes@ (curve25519_dalek!core_assumes.seq_to_array_32.? (Poly%vstd!seq.Seq<u8.>.
       (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
         fe!
    )))))
    (and
     (=>
      ...
      (=>
       %%location_label%%0
       (= (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. bytes@)) (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.?
         (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
     ))))
     (=>
      (= (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. bytes@)) (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.?
      ...
      (or
       (and
        (=>
         (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
            (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
           )
           ...
           (and
            (=>
             ...
             (=>
              ...
              (=>
               (= tmp%1 (= (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT 8)
                    $ (CONST_INT 32)
                   ) (Poly%array%. bytes@)
                  ) i@
            ...
            (=>
             (forall ((i$ Poly)) (!
               ...
               :qid user_curve25519_dalek__lemmas__field_lemmas__batch_invert_lemmas__lemma_is_zero_iff_canonical_nat_zero_25
               :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__batch_invert_lemmas__lemma_is_zero_iff_canonical_nat_zero_25
             ))
             (=>
              %%location_label%%3
              (forall ((i$ Poly)) (!
                ...
                :qid user_curve25519_dalek__lemmas__field_lemmas__batch_invert_lemmas__lemma_is_zero_iff_canonical_nat_zero_26
                :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__batch_invert_lemmas__lemma_is_zero_iff_canonical_nat_zero_26
           )))))
           (=>
            (forall ((i$ Poly)) (!
              (=>
              ...
              :qid user_curve25519_dalek__lemmas__field_lemmas__batch_invert_lemmas__lemma_is_zero_iff_canonical_nat_zero_27
              :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__batch_invert_lemmas__lemma_is_zero_iff_canonical_nat_zero_27
            ))
            (=>
             (ens%curve25519_dalek!lemmas.common_lemmas.to_nat_lemmas.lemma_u8_32_as_nat_equals_rec.
              bytes@
        ...
        (=>
         (not (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
             (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
            )
           ) (vstd!seq.Seq.new.? $ (UINT 8) $ (TYPE%fun%1. $ INT $ (UINT 8)) (I 32) (Poly%fun%1.
             (mk_fun (%%lambda%%1 (I 0)))
              ...
              (and
               (=>
                ...
                (=>
                 ...
                 (=>
                  (= tmp%2 (= (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
                       (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
                      )
                     ) i$1@
                  ...
                  (and
                   ...
                   (=>
                    ...
                    (=>
                     %%location_label%%8
                     (= (%I (vstd!seq.Seq.index.? $ (UINT 8) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
                          (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. fe!)
                         )
                        ) i$1@
                       )
               ...
               (=>
                (forall ((i$ Poly)) (!
                  ...
                  :qid user_curve25519_dalek__lemmas__field_lemmas__batch_invert_lemmas__lemma_is_zero_iff_canonical_nat_zero_30
                  :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__batch_invert_lemmas__lemma_is_zero_iff_canonical_nat_zero_30
                ))
                (=>
                 %%location_label%%9
                 (ext_eq false (TYPE%vstd!seq.Seq. $ (UINT 8)) (Poly%vstd!seq.Seq<u8.>. (curve25519_dalek!specs.field_specs.spec_fe51_as_bytes.?
