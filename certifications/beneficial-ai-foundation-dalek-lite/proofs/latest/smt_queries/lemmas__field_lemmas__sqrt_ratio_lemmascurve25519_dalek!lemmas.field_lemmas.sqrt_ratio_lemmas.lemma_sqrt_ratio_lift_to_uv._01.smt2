...
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_ratio_lemmas.rs:1733:1: 1733:65 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::sqrt_ratio_lemmas::lemma_sqrt_ratio_lift_to_uv
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_ratio_lemmas.rs:1733:1: 1733:65 (#0)
            ...
            (=>
             ...
             (=>
              ...
              (=>
               ...
               (=>
                (= tmp%1 (curve25519_dalek!specs.field_specs.field_square.? (I u!)))
                (=>
                 (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_assoc.
                  s! s! tmp%1
                 )
                 (=>
                  %%location_label%%2
                  (= (curve25519_dalek!specs.field_specs.field_mul.? (I su@) (I su@)) (curve25519_dalek!specs.field_specs.field_mul.?
                    (I (curve25519_dalek!specs.field_specs.field_square.? (I s!))) (I (curve25519_dalek!specs.field_specs.field_square.?
                      (I u!)
            ))))))))))
            (=>
             (= (curve25519_dalek!specs.field_specs.field_mul.? (I su@) (I su@)) (curve25519_dalek!specs.field_specs.field_mul.?
             ...
             (and
              (=>
               (= tmp%2 (curve25519_dalek!specs.field_specs.field_square.? (I s!)))
               (=>
                (= tmp%3 (curve25519_dalek!specs.field_specs.field_square.? (I u!)))
                (=>
                 (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_assoc.
                  tmp%2 tmp%3 v!
                 )
                 (=>
                  ...
                  (=>
                   ...
                   (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                     ...
                     ) (I (curve25519_dalek!specs.field_specs.field_mul.? (I u!) (I uv@)))
              )))))))
              (=>
               (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                   (I (curve25519_dalek!specs.field_specs.field_square.? (I s!))) (I (curve25519_dalek!specs.field_specs.field_square.?
               ...
               (and
                (=>
                 ...
                 (=>
                  (= tmp%4 (curve25519_dalek!specs.field_specs.field_square.? (I s!)))
                  (=>
                   (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_assoc.
                    tmp%4 uv@ u!
                   )
                   (=>
                    ...
                    (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_square.?
                        ...
                        (I (curve25519_dalek!specs.field_specs.field_square.? (I s!))) (I uv@)
                       )
                      ) (I u!)
                ))))))
                (=>
                 ...
                 (or
                  (and
                   (=>
                    (curve25519_dalek!specs.field_specs.is_sqrt_ratio.? (I 1) (I uv@) (I s!))
                    (and
                     (and
                      (=>
                       %%location_label%%5
                       ...
                       (=>
                        ...
                        (and
                         (=>
                          ...
                          (=>
                           %%location_label%%9
                           (= (curve25519_dalek!specs.field_specs.field_mul.? (I 1) (I u!)) (EucMod u! pn@))
                         ))
                         (=>
                          (= (curve25519_dalek!specs.field_specs.field_mul.? (I 1) (I u!)) (EucMod u! pn@))
                          (=>
                           (= tmp%5 (= (curve25519_dalek!specs.field_specs_u64.field_canonical.? (I (nClip (Mul (nClip
                                  (Mul su@ su@)
                                 ) v!
                              )))
                             ) (curve25519_dalek!specs.field_specs_u64.field_canonical.? (I u!))
                   ...
                   (=>
                    (not (curve25519_dalek!specs.field_specs.is_sqrt_ratio.? (I 1) (I uv@) (I s!)))
                    %%switch_label%%1
                  ))
                  (and
                   (not %%switch_label%%1)
                   (or
                    (and
                     (=>
                      (curve25519_dalek!specs.field_specs.is_sqrt_ratio_times_i.? (I 1) (I uv@) (I s!))
                      (=>
                       (= i@ (curve25519_dalek!specs.field_specs.sqrt_m1.? (I 0)))
                       (=>
                        (= tmp%6 (= (curve25519_dalek!specs.field_specs_u64.field_canonical.? (I (nClip (Mul (nClip
                               (Mul s! s!)
                              ) uv@
                           )))
                         ...
                         (=>
                          ...
                          (and
                           (=>
                            ...
                            (=>
                             %%location_label%%12
                             (= (curve25519_dalek!specs.field_specs.field_mul.? (I i@) (I 1)) (EucMod i@ pn@))
                           ))
                           (=>
                            (= (curve25519_dalek!specs.field_specs.field_mul.? (I i@) (I 1)) (EucMod i@ pn@))
                            (and
                             ...
                             (=>
                              ...
                              (and
                               (and
                                (=>
                                 %%location_label%%14
                                 (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. i@ u! pn@)
                                )
                                (=>
                                 (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. i@ u! pn@)
                                 (=>
                                  %%location_label%%15
                                  (= (curve25519_dalek!specs.field_specs.field_mul.? (I (EucMod i@ pn@)) (I u!)) (curve25519_dalek!specs.field_specs.field_mul.?
                                    (I i@) (I u!)
                               )))))
                               (=>
                                (= (curve25519_dalek!specs.field_specs.field_mul.? (I (EucMod i@ pn@)) (I u!)) (curve25519_dalek!specs.field_specs.field_mul.?
                                ...
                                (=>
                                 (= tmp%7 (= (curve25519_dalek!specs.field_specs_u64.field_canonical.? (I (nClip (Mul (nClip
                                        (Mul su@ su@)
                                       ) v!
                                    )))
                                   ) (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.sqrt_m1.?
                     ...
                     (=>
                      (not (curve25519_dalek!specs.field_specs.is_sqrt_ratio_times_i.? (I 1) (I uv@) (I s!)))
                      %%switch_label%%0
                    ))
                    (and
                     (not %%switch_label%%0)
