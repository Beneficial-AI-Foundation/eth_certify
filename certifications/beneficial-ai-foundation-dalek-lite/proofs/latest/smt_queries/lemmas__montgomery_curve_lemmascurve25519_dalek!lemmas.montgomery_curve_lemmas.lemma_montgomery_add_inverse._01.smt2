...
;; curve25519-dalek/src/lemmas/montgomery_curve_lemmas.rs:72:1: 72:63 (#0)
...
;; Function-Def curve25519_dalek::lemmas::montgomery_curve_lemmas::lemma_montgomery_add_inverse
;; curve25519-dalek/src/lemmas/montgomery_curve_lemmas.rs:72:1: 72:63 (#0)
...
(push)
 ...
 (assert
  (not (or
    (and
     (=>
      (is-curve25519_dalek!specs.montgomery_specs.MontgomeryAffine./Infinity P!)
      %%switch_label%%0
     )
     (=>
      (not (is-curve25519_dalek!specs.montgomery_specs.MontgomeryAffine./Infinity P!))
      (=>
       (= u@ (curve25519_dalek!specs.montgomery_specs.MontgomeryAffine./Finite/u (%Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine.
          (Poly%curve25519_dalek!specs.montgomery_specs.MontgomeryAffine. P!)
       )))
        ...
        (and
         (=>
          ...
          (=>
           ...
           (=>
            %%location_label%%0
            (= (curve25519_dalek!specs.field_specs.field_add.? (I v@) (I (curve25519_dalek!specs.field_specs.field_neg.?
                (I v@)
              ))
             ) 0
         ))))
