...
;; curve25519-dalek/src/lemmas/edwards_lemmas/step1_lemmas.rs:260:1: 260:57 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::step1_lemmas::lemma_u_zero_implies_identity_point
;; curve25519-dalek/src/lemmas/edwards_lemmas/step1_lemmas.rs:260:1: 260:57 (#0)
        ...
        (=>
         ...
         (and
          (and
           (=>
            %%location_label%%2
            (req%vstd!arithmetic.div_mod.lemma_small_mod. y2@ p@)
           )
           (=>
            (ens%vstd!arithmetic.div_mod.lemma_small_mod. y2@ p@)
            (=>
             %%location_label%%3
             (= (EucMod y2@ p@) y2@)
          )))
                          ...
                          (and
                           (=>
                            ...
                            (and
                             (=>
                              %%location_label%%9
                              (req%vstd!arithmetic.div_mod.lemma_small_mod. tmp%5 p@)
                             )
                             (=>
                              (ens%vstd!arithmetic.div_mod.lemma_small_mod. tmp%5 p@)
                              (=>
                               %%location_label%%10
                               (= (EucMod sum@ p@) (Sub p@ 1))
                           ))))
                           (=>
                            (= (EucMod sum@ p@) (Sub p@ 1))
                            %%switch_label%%0
                          ...
                          (=>
                           ...
                           (and
                            ...
                            (=>
                             ...
                             (and
                              (=>
                               (= tmp%7 (nClip (Sub y2@ 1)))
                               (and
                                (=>
                                 %%location_label%%12
                                 (req%vstd!arithmetic.div_mod.lemma_small_mod. tmp%7 p@)
                                )
                                (=>
                                 (ens%vstd!arithmetic.div_mod.lemma_small_mod. tmp%7 p@)
                                 (=>
                                  (= tmp%8 (Sub 0 1))
                                  (and
                                   (=>
                                    %%location_label%%13
                                    (req%vstd!arithmetic.div_mod.lemma_mod_multiples_vanish. tmp%8 sum@ p@)
                                   )
                                   (=>
                                    (ens%vstd!arithmetic.div_mod.lemma_mod_multiples_vanish. tmp%8 sum@ p@)
                                    (=>
                                     %%location_label%%14
                                     (= (EucMod sum@ p@) (Sub y2@ 1))
                              )))))))
                              (=>
                               (= (EucMod sum@ p@) (Sub y2@ 1))
                               %%switch_label%%1
           ...
           (and
            ...
            (=>
             ...
             (=>
              ...
              (=>
               (= x2@ (curve25519_dalek!specs.field_specs.field_square.? (I 0)))
               (=>
                (= x2y2@ (curve25519_dalek!specs.field_specs.field_mul.? (I x2@) (I y2@)))
                (=>
                 (= d_x2y2@ (curve25519_dalek!specs.field_specs.field_mul.? (I d@) (I x2y2@)))
                 (and
                  (and
                   (=>
                    (ens%vstd!arithmetic.mul.lemma_mul_basics. 0)
                    (=>
                     %%location_label%%18
                     (= (Mul 0 0) 0)
                   ))
                  ...
                  (=>
                   ...
                   (and
                    (and
                     (=>
                      (ens%vstd!arithmetic.mul.lemma_mul_basics. y2@)
                      (=>
                       %%location_label%%21
                       (= (Mul 0 y2@) 0)
                     ))
                          ...
                          (=>
                           ...
                           (and
                            ...
                            (=>
                             ...
                             (=>
                              %%location_label%%29
                              (= (curve25519_dalek!specs.field_specs.field_add.? (I 1) (I d_x2y2@)) 1)
                        ))))))
                        (=>
                         (= (curve25519_dalek!specs.field_specs.field_add.? (I 1) (I d_x2y2@)) 1)
                         (and
                                   ...
                                   (=>
                                    ...
                                    (and
                                     (and
                                      (=>
                                       %%location_label%%36
                                       (req%vstd!arithmetic.div_mod.lemma_mod_adds. p@ 1 p@)
                                      )
                                      (=>
                                       (ens%vstd!arithmetic.div_mod.lemma_mod_adds. p@ 1 p@)
                                       (and
                                        (=>
                                         %%location_label%%37
                                        ...
                                        (=>
                                         ...
                                         (and
                                          ...
                                          (=>
                                           ...
                                           (=>
                                            %%location_label%%39
                                            (= (EucMod (nClip (Add p@ 1)) p@) 1)
                                     )))))))
                                     (=>
                                      (= (EucMod (nClip (Add p@ 1)) p@) 1)
                                      (=>
                                       %%location_label%%40
                                       (= (curve25519_dalek!specs.field_specs.field_sub.? (I y2@) (I x2@)) 1)
                          )))))))))))))
                          (=>
                           (= (curve25519_dalek!specs.field_specs.field_sub.? (I y2@) (I x2@)) 1)
                           (=>
