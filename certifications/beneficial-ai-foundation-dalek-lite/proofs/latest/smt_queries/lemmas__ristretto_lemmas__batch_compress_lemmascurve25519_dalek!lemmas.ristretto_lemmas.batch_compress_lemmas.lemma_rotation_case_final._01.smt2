...
;; curve25519-dalek/src/lemmas/ristretto_lemmas/batch_compress_lemmas.rs:2277:7: 2293:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::ristretto_lemmas::batch_compress_lemmas::lemma_rotation_case_final
;; curve25519-dalek/src/lemmas/ristretto_lemmas/batch_compress_lemmas.rs:2277:7: 2293:2 (#0)
...
(push)
 ...
 (declare-const i@ Int)
 (declare-const h_rot@ Int)
 (declare-const nc2_batch@ Bool)
 (declare-const g_rot@ Int)
 (declare-const g_final@ Int)
 (declare-const s_batch@ Int)
 (declare-const s_final_batch@ Int)
 (declare-const enchanted@ Int)
 (declare-const nc2_std@ Bool)
 (declare-const y_rot@ Int)
 (declare-const y_final@ Int)
 (declare-const s_std@ Int)
 (declare-const s_final_std@ Int)
 (assert
  fuel_defaults
 )
 (assert
        ...
        (=>
         ...
         (and
          ...
          (=>
           ...
           (=>
            (= tmp%1 (curve25519_dalek!specs.field_specs.field_mul.? (I y_aff!) (I i@)))
            (and
             (=>
              %%location_label%%3
              (req%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_mul_one_identity.
             ...
             (=>
              ...
              (=>
               ...
               (and
                (and
                 (= (curve25519_dalek!specs.field_specs.field_mul.? (I t_aff!) (I 1)) t_aff!)
                 (= (curve25519_dalek!specs.field_specs.field_mul.? (I x_aff!) (I 1)) x_aff!)
                )
                (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                    (I y_aff!) (I i@)
                   )
                  ) (I 1)
                 ) (curve25519_dalek!specs.field_specs.field_mul.? (I y_aff!) (I i@))
       ))))))))))
       (=>
        (and
         (and
        ...
        (and
         (=>
          ...
          (=>
           %%location_label%%5
           (= (curve25519_dalek!specs.field_specs.field_mul.? (I i@) (I y_aff!)) (curve25519_dalek!specs.field_specs.field_mul.?
             (I y_aff!) (I i@)
         ))))
         (=>
          (= (curve25519_dalek!specs.field_specs.field_mul.? (I i@) (I y_aff!)) (curve25519_dalek!specs.field_specs.field_mul.?
           ...
           (=>
            ...
            (=>
             ...
             (= (curve25519_dalek!specs.field_specs.field_neg.? (I (curve25519_dalek!specs.field_specs.field_neg.?
              ...
              ) (EucMod e! (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
           )))
           (=>
            (= (curve25519_dalek!specs.field_specs.field_neg.? (I (curve25519_dalek!specs.field_specs.field_neg.?
                (I e!)
            ...
            (=>
             (= h_rot@ (curve25519_dalek!specs.field_specs.field_mul.? (I f!) (I i@)))
             (=>
              (= nc2_batch@ (curve25519_dalek!specs.field_specs.is_negative.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                  (I (curve25519_dalek!specs.field_specs.field_mul.? (I h_rot@) (I g!))) (I zinv!)
              ))))
              (=>
               (= g_rot@ (curve25519_dalek!specs.field_specs.field_neg.? (I e!)))
               (=>
                (= g_final@ (ite
                  nc2_batch@
                  (curve25519_dalek!specs.field_specs.field_neg.? (I g_rot@))
                ...
                (=>
                 (= s_batch@ (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_sub.?
                     (I h_rot@) (I g_final@)
                    )
                   ) (I (curve25519_dalek!specs.field_specs.field_mul.? (I i@) (I (curve25519_dalek!specs.field_specs.field_mul.?
                       (I g_final@) (I tinv!)
                 ...
                 (=>
                  (= s_final_batch@ (curve25519_dalek!specs.field_specs.field_abs.? (I s_batch@)))
                  (=>
                   (= tmp%2 (ext_eq false (ARRAY $ (UINT 8) $ (CONST_INT 32)) (Poly%array%. (curve25519_dalek!specs.ristretto_specs.batch_compress_body.?
                       (I e!) (I f!) (I g!) (I h!) (I eg!) (I fh!) (I inv!)
                      )
                     ) (Poly%array%. (curve25519_dalek!specs.field_specs.u8_32_from_nat.? (I s_final_batch@)))
                   ))
                   (and
                    (=>
                     %%location_label%%7
                    ...
                    (=>
                     ...
                     (=>
                      ...
                      (=>
                       (= nc2_std@ (curve25519_dalek!specs.field_specs.is_negative.? (I (curve25519_dalek!specs.field_specs.field_mul.?
                           (I y_aff!) (I i@)
                       ))))
                       (=>
                        (= y_rot@ (curve25519_dalek!specs.field_specs.field_mul.? (I x_aff!) (I i@)))
                        (=>
                         (= y_final@ (ite
                           nc2_std@
                           (curve25519_dalek!specs.field_specs.field_neg.? (I y_rot@))
                         ...
                         (=>
                          (= s_std@ (curve25519_dalek!specs.field_specs.field_mul.? (I enchanted@) (I (curve25519_dalek!specs.field_specs.field_sub.?
                              (I 1) (I y_final@)
                          ))))
                          (=>
                           (= s_final_std@ (curve25519_dalek!specs.field_specs.field_abs.? (I s_std@)))
                           (=>
                            (= tmp%3 (ext_eq false (ARRAY $ (UINT 8) $ (CONST_INT 32)) (Poly%array%. (curve25519_dalek!specs.ristretto_specs.ristretto_compress_affine.?
                                (I x_aff!) (I y_aff!)
                               )
                              ) (Poly%array%. (curve25519_dalek!specs.field_specs.u8_32_from_nat.? (I s_final_std@)))
                            ))
                            (and
                             (=>
                              %%location_label%%8
                                 ...
                                 (or
                                  (and
                                     ...
                                     (=>
                                      ...
                                      (=>
                                       ...
                                       (and
                                        (=>
                                         %%location_label%%10
                                         (req%vstd!arithmetic.div_mod.lemma_mod_bound. e! tmp%5)
                                        )
                                        (=>
                                         (ens%vstd!arithmetic.div_mod.lemma_mod_bound. e! tmp%5)
                                         (=>
                                          (= tmp%6 (EucMod e! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))))
                                          (=>
                                           (= tmp%7 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                                           (and
                                            (=>
                                             %%location_label%%11
                                             (req%vstd!arithmetic.div_mod.lemma_small_mod. tmp%6 tmp%7)
                                            )
                                            (=>
                                             (ens%vstd!arithmetic.div_mod.lemma_small_mod. tmp%6 tmp%7)
                                             (=>
                                              %%location_label%%12
                                              (= (curve25519_dalek!specs.field_specs.field_sub.? (I h_rot@) (I (curve25519_dalek!specs.field_specs.field_neg.?
                                                  (I (curve25519_dalek!specs.field_specs.field_neg.? (I e!)))
                                                ))
                                               ) (curve25519_dalek!specs.field_specs.field_sub.? (I h_rot@) (I e!))
                                     ))))))))))
                                     (=>
                                      (= (curve25519_dalek!specs.field_specs.field_sub.? (I h_rot@) (I (curve25519_dalek!specs.field_specs.field_neg.?
                                          (I (curve25519_dalek!specs.field_specs.field_neg.? (I e!)))
                                       ...
                                       (=>
                                        ...
                                        (=>
                                         ...
                                         (and
                                          (=>
                                           %%location_label%%13
                                           (req%vstd!arithmetic.div_mod.lemma_mod_bound. e! tmp%8)
                                          )
                                          (=>
                                           (ens%vstd!arithmetic.div_mod.lemma_mod_bound. e! tmp%8)
                                           (=>
                                            (= tmp%9 (EucMod e! (curve25519_dalek!specs.field_specs_u64.p.? (I 0))))
                                            (=>
                                             (= tmp%10 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                                             (and
                                              (=>
                                               %%location_label%%14
                                              ...
                                              (=>
                                               ...
                                               (=>
                                                ...
                                                (and
                                                 (=>
                                                  %%location_label%%15
                                                  (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. e! tinv! tmp%11)
                                                 )
                                                 (=>
                                                  (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. e! tinv! tmp%11)
                                                  (=>
                                                   %%location_label%%16
                                                   (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_neg.?
                                                       (I (curve25519_dalek!specs.field_specs.field_neg.? (I e!)))
                                                    ...
                                                    ) (curve25519_dalek!specs.field_specs.field_mul.? (I e!) (I tinv!))
                                       )))))))))))))
                                       (=>
                                        (= (curve25519_dalek!specs.field_specs.field_mul.? (I (curve25519_dalek!specs.field_specs.field_neg.?
                                            (I (curve25519_dalek!specs.field_specs.field_neg.? (I e!)))
                                        ...
                                        (=>
                                         (= tmp%12 (= (curve25519_dalek!specs.field_specs.field_abs.? (I s_batch@)) (curve25519_dalek!specs.field_specs.field_abs.?
                                            (I s_std@)
                                         )))
                                         (and
                                          (=>
                                   ...
                                   (=>
                                    (not nc2_batch@)
                                    (=>
                                     (= tmp%13 (= (curve25519_dalek!specs.field_specs.field_abs.? (I s_batch@)) (curve25519_dalek!specs.field_specs.field_abs.?
                                        (I s_std@)
                                     )))
                                     (and
                                      (=>
                                  ...
                                  (and
                                   (not %%switch_label%%0)
                                   (=>
                                    (= tmp%14 (= s_final_batch@ s_final_std@))
                                    (and
                                     (=>
                                      %%location_label%%19
                                      tmp%14
