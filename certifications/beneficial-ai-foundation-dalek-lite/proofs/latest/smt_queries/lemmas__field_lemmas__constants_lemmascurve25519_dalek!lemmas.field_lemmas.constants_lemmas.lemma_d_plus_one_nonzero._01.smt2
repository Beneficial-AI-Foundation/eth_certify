...
;; curve25519-dalek/src/lemmas/field_lemmas/constants_lemmas.rs:353:1: 353:40 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::constants_lemmas::lemma_d_plus_one_nonzero
;; curve25519-dalek/src/lemmas/field_lemmas/constants_lemmas.rs:353:1: 353:40 (#0)
  ...
  (not (=>
    (let
     ...
     (let
      ...
      (let
       ((d_plus_one$ (EucMod (nClip (Add d_val$ 1)) lp$)))
       (not (= d_plus_one$ 0))
    )))
    (and
     (=>
