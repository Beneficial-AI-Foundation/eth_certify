...
;; curve25519-dalek/src/lemmas/common_lemmas/to_nat_lemmas.rs:998:1: 1004:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::to_nat_lemmas::lemma_u64x4_from_le_bytes
;; curve25519-dalek/src/lemmas/common_lemmas/to_nat_lemmas.rs:998:1: 1004:2 (#0)
(get-info :all-statistics)
(push)
 (declare-const bytes! %%Function%%)
 (declare-const chunk0! %%Function%%)
 (declare-const chunk1! %%Function%%)
 (declare-const chunk2! %%Function%%)
 (declare-const chunk3! %%Function%%)
 ...
 (assert
  (has_type (Poly%array%. chunk0!) (ARRAY $ (UINT 8) $ (CONST_INT 8)))
 )
 (assert
  (has_type (Poly%array%. chunk1!) (ARRAY $ (UINT 8) $ (CONST_INT 8)))
 )
 (assert
  (has_type (Poly%array%. chunk2!) (ARRAY $ (UINT 8) $ (CONST_INT 8)))
 )
 (assert
  (has_type (Poly%array%. chunk3!) (ARRAY $ (UINT 8) $ (CONST_INT 8)))
 )
 (assert
  (forall ((j$ Poly)) (!
    (=>
    ...
    :qid user_curve25519_dalek__lemmas__common_lemmas__to_nat_lemmas__lemma_u64x4_from_le_bytes_121
    :skolemid skolem_user_curve25519_dalek__lemmas__common_lemmas__to_nat_lemmas__lemma_u64x4_from_le_bytes_121
 )))
 (assert
  (forall ((j$ Poly)) (!
    (=>
    ...
    :qid user_curve25519_dalek__lemmas__common_lemmas__to_nat_lemmas__lemma_u64x4_from_le_bytes_122
    :skolemid skolem_user_curve25519_dalek__lemmas__common_lemmas__to_nat_lemmas__lemma_u64x4_from_le_bytes_122
 )))
 (assert
  (forall ((j$ Poly)) (!
    (=>
    ...
    :qid user_curve25519_dalek__lemmas__common_lemmas__to_nat_lemmas__lemma_u64x4_from_le_bytes_123
    :skolemid skolem_user_curve25519_dalek__lemmas__common_lemmas__to_nat_lemmas__lemma_u64x4_from_le_bytes_123
 )))
 (assert
  (forall ((j$ Poly)) (!
    (=>
    ...
    :qid user_curve25519_dalek__lemmas__common_lemmas__to_nat_lemmas__lemma_u64x4_from_le_bytes_124
    :skolemid skolem_user_curve25519_dalek__lemmas__common_lemmas__to_nat_lemmas__lemma_u64x4_from_le_bytes_124
 )))
 ...
 (assert
  (not (and
    (=>
     (= tmp%1 (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT
          8
         )
        ) (Poly%array%. chunk0!)
     )))
     (=>
      (= tmp%2 (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT
           32
          )
         ) (Poly%array%. bytes!)
      )))
      (and
       ...
       (=>
        ...
        (=>
         %%location_label%%1
         (= (curve25519_dalek!specs.core_specs.bytes_as_nat_prefix.? (vstd!view.View.view.? $
            (ARRAY $ (UINT 8) $ (CONST_INT 8)) (Poly%array%. chunk0!)
           ) (I 8)
          ) (curve25519_dalek!specs.core_specs.bytes_as_nat_prefix.? (vstd!view.View.view.? $
            (ARRAY $ (UINT 8) $ (CONST_INT 32)) (Poly%array%. bytes!)
           ) (I 8)
    ...
    (=>
     ...
     (and
      (=>
       (= tmp%3 (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT
            32
           )
          ) (Poly%array%. bytes!)
       )))
       (=>
        (= tmp%4 (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT
             8
            )
           ) (Poly%array%. chunk0!)
        )))
      ...
      (=>
       ...
       (=>
        (= tmp%5 (= (curve25519_dalek!specs.core_specs.bytes_as_nat_prefix.? (vstd!view.View.view.?
            $ (ARRAY $ (UINT 8) $ (CONST_INT 32)) (Poly%array%. bytes!)
           ) (I 0)
          ) 0
        ))
            ...
            (and
             ...
             (=>
              (forall ((j$ Poly)) (!
                ...
                :qid user_curve25519_dalek__lemmas__common_lemmas__to_nat_lemmas__lemma_u64x4_from_le_bytes_114
                :skolemid skolem_user_curve25519_dalek__lemmas__common_lemmas__to_nat_lemmas__lemma_u64x4_from_le_bytes_114
              ))
              (and
               (=>
                (= tmp%8 (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT
                     32
                    )
                   ) (Poly%array%. bytes!)
                )))
                (=>
                 (= tmp%9 (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT
                      8
                     )
                    ) (Poly%array%. chunk1!)
                 )))
                ...
                (and
                 ...
                 (=>
                  (forall ((j$ Poly)) (!
                    ...
                    :qid user_curve25519_dalek__lemmas__common_lemmas__to_nat_lemmas__lemma_u64x4_from_le_bytes_116
                    :skolemid skolem_user_curve25519_dalek__lemmas__common_lemmas__to_nat_lemmas__lemma_u64x4_from_le_bytes_116
                  ))
                  (and
                   (=>
                    (= tmp%12 (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT
                         32
                        )
                       ) (Poly%array%. bytes!)
                    )))
                    (=>
                     (= tmp%13 (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT
                          8
                         )
                        ) (Poly%array%. chunk2!)
                     )))
                    ...
                    (and
                     ...
                     (=>
                      (forall ((j$ Poly)) (!
                        ...
                        :qid user_curve25519_dalek__lemmas__common_lemmas__to_nat_lemmas__lemma_u64x4_from_le_bytes_118
                        :skolemid skolem_user_curve25519_dalek__lemmas__common_lemmas__to_nat_lemmas__lemma_u64x4_from_le_bytes_118
                      ))
                      (and
                       (=>
                        (= tmp%16 (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT
                             32
                            )
                           ) (Poly%array%. bytes!)
                        )))
                        (=>
                         (= tmp%17 (%Poly%vstd!seq.Seq<u8.>. (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT
                              8
                             )
                            ) (Poly%array%. chunk3!)
                         )))
