...
;; curve25519-dalek/src/lemmas/field_lemmas/constants_lemmas.rs:116:1: 116:45 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::constants_lemmas::lemma_one_field_element_value
;; curve25519-dalek/src/lemmas/field_lemmas/constants_lemmas.rs:116:1: 116:45 (#0)
                ...
                (=>
                 ...
                 (and
                  ...
                  (=>
                   tmp%5
                   (=>
                    (= tmp%6 (= (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
                         (%Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51. (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                           curve25519_dalek!backend.serial.u64.field.impl&%16.ONE.?
                       ))))
                      ) 1
                      ...
                      (=>
                       ...
                       (=>
                        ...
                        (and
                         (=>
                          %%location_label%%6
                          (req%vstd!arithmetic.div_mod.lemma_small_mod. 1 tmp%7)
                         )
                         (=>
                          (ens%vstd!arithmetic.div_mod.lemma_small_mod. 1 tmp%7)
                          (=>
                           %%location_label%%7
                           (= (curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.? (Poly%curve25519_dalek!backend.serial.u64.field.FieldElement51.
                              curve25519_dalek!backend.serial.u64.field.impl&%16.ONE.?
