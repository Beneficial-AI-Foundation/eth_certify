...
;; curve25519-dalek/src/lemmas/field_lemmas/add_lemmas.rs:201:9: 201:15 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::add_lemmas::lemma_sum_of_limbs_bounded_from_fe51_bounded
;; curve25519-dalek/src/lemmas/field_lemmas/add_lemmas.rs:201:9: 201:15 (#0)
...
(assert
 (bvule n! ((_ zero_extend 58) (_ bv62 6)))
)
...
(assert
 (not (=>
   %%location_label%%0
   (bvult (bvadd ((_ zero_extend 1) (bvshl ((_ zero_extend 63) (_ bv1 1)) n!)) ((_ zero_extend
       1
      ) (bvshl ((_ zero_extend 63) (_ bv1 1)) n!)
     )
    ) ((_ zero_extend 1) (_ bv18446744073709551615 64))
))))
(get-info :version)
