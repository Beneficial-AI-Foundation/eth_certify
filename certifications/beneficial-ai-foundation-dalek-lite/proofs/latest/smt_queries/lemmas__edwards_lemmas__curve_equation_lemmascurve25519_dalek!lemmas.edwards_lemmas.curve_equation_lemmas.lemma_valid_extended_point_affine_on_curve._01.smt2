...
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:2629:1: 2629:88 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::curve_equation_lemmas::lemma_valid_extended_point_affine_on_curve
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:2629:1: 2629:88 (#0)
...
(push)
 ...
 (declare-const x_div_z@ Int)
 (declare-const y_div_z@ Int)
 (declare-const x_div_z_sq@ Int)
 (declare-const y_div_z_sq@ Int)
 (declare-const x2@ Int)
 (declare-const y2@ Int)
 (declare-const z2@ Int)
 (declare-const z4@ Int)
 (declare-const inv_z2@ Int)
 (declare-const inv_z4@ Int)
 (declare-const y2_minus_x2@ Int)
 (declare-const x2_y2@ Int)
 (declare-const proj_lhs@ Int)
 (declare-const proj_rhs@ Int)
 (declare-const affine_lhs@ Int)
 (declare-const x2_y2_inv_z4@ Int)
 (declare-const affine_rhs@ Int)
 (assert
  fuel_defaults
 )
 (assert
     ...
     (=>
      ...
      (=>
       ...
       (=>
        ...
        (=>
         (= x_div_z@ (curve25519_dalek!specs.field_specs.field_mul.? (I x!) (I inv_z@)))
         (=>
          (= y_div_z@ (curve25519_dalek!specs.field_specs.field_mul.? (I y!) (I inv_z@)))
          (=>
           (= x_div_z_sq@ (curve25519_dalek!specs.field_specs.field_square.? (I x_div_z@)))
           (=>
            (= y_div_z_sq@ (curve25519_dalek!specs.field_specs.field_square.? (I y_div_z@)))
            (=>
             ...
             (=>
              ...
              (=>
               ...
               (=>
                (= z4@ (curve25519_dalek!specs.field_specs.field_square.? (I z2@)))
                (=>
                 (= inv_z2@ (curve25519_dalek!specs.field_specs.field_inv.? (I z2@)))
                 (=>
                  (= inv_z4@ (curve25519_dalek!specs.field_specs.field_inv.? (I z4@)))
                  (=>
                   (= y2_minus_x2@ (curve25519_dalek!specs.field_specs.field_sub.? (I y2@) (I x2@)))
                   (=>
                    (= x2_y2@ (curve25519_dalek!specs.field_specs.field_mul.? (I x2@) (I y2@)))
                    (=>
                     (= proj_lhs@ (curve25519_dalek!specs.field_specs.field_mul.? (I y2_minus_x2@) (I z2@)))
                     (=>
                      (= proj_rhs@ (curve25519_dalek!specs.field_specs.field_add.? (I z4@) (I (curve25519_dalek!specs.field_specs.field_mul.?
                          (I d@) (I x2_y2@)
                      ))))
                      (=>
                       (= tmp%1 (= proj_lhs@ proj_rhs@))
                       (and
                        (=>
                         %%location_label%%1
                         tmp%1
                           ...
                           (and
                            (and
                             ...
                             (=>
                              ...
                              (and
                               (=>
                                (= tmp%3 (nClip (Mul z2@ z2@)))
                                (and
                                 (=>
                                  %%location_label%%8
                                  (req%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%3 p@)
                                 )
                                 (=>
                                  (ens%vstd!arithmetic.div_mod.lemma_mod_bound. tmp%3 p@)
                                  (=>
                                   %%location_label%%9
                                   (< z4@ p@)
                               ))))
                            ...
                            (=>
                             ...
                             (and
                              (=>
                               ...
                               (=>
                                %%location_label%%12
                                (= x_div_z_sq@ (curve25519_dalek!specs.field_specs.field_mul.? (I x2@) (I inv_z2@)))
                              ))
                              (=>
                               (= x_div_z_sq@ (curve25519_dalek!specs.field_specs.field_mul.? (I x2@) (I inv_z2@)))
                               (and
                                (=>
                                 ...
                                 (=>
                                  %%location_label%%13
                                  (= y_div_z_sq@ (curve25519_dalek!specs.field_specs.field_mul.? (I y2@) (I inv_z2@)))
                                ))
                                (=>
                                 (= y_div_z_sq@ (curve25519_dalek!specs.field_specs.field_mul.? (I y2@) (I inv_z2@)))
                                 (=>
                                  (= affine_lhs@ (curve25519_dalek!specs.field_specs.field_sub.? (I y_div_z_sq@) (I x_div_z_sq@)))
                                  (and
                                   (=>
                                    (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_distributes_over_sub_right.
                                     y2@ x2@ inv_z2@
                                    ...
                                    (=>
                                     %%location_label%%14
                                     (= affine_lhs@ (curve25519_dalek!specs.field_specs.field_mul.? (I y2_minus_x2@) (I inv_z2@)))
                                   ))
                                   (=>
                                    (= affine_lhs@ (curve25519_dalek!specs.field_specs.field_mul.? (I y2_minus_x2@) (I inv_z2@)))
                                    (and
                                     (=>
                                      ...
                                      (=>
                                       %%location_label%%15
                                       (= (curve25519_dalek!specs.field_specs.field_mul.? (I inv_z2@) (I inv_z2@)) inv_z4@)
                                     ))
                                     (=>
                                      (= (curve25519_dalek!specs.field_specs.field_mul.? (I inv_z2@) (I inv_z2@)) inv_z4@)
                                      (=>
                                       (= x2_y2_inv_z4@ (curve25519_dalek!specs.field_specs.field_mul.? (I x2_y2@) (I inv_z4@)))
                                       (and
                                        (=>
                                         (= tmp%4 (curve25519_dalek!specs.field_specs.field_mul.? (I y2@) (I inv_z2@)))
                                         (=>
                                          (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_assoc.
                                           x2@ inv_z2@ tmp%4
                                          )
                                          (=>
                                           (= tmp%5 (curve25519_dalek!specs.field_specs.field_mul.? (I y2@) (I inv_z2@)))
                                           (=>
                                            (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_comm.
                                             inv_z2@ tmp%5
                                            )
                                            (=>
                                             ...
                                             (=>
                                              (= tmp%6 (curve25519_dalek!specs.field_specs.field_mul.? (I inv_z2@) (I inv_z2@)))
                                              (=>
                                               (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_assoc.
                                                x2@ y2@ tmp%6
                                               )
                                               (=>
                                                %%location_label%%16
                                                (= (curve25519_dalek!specs.field_specs.field_mul.? (I x_div_z_sq@) (I y_div_z_sq@))
                                                 x2_y2_inv_z4@
                                        )))))))))
                                        (=>
                                         (= (curve25519_dalek!specs.field_specs.field_mul.? (I x_div_z_sq@) (I y_div_z_sq@))
                                         ...
                                         (=>
                                          (= affine_rhs@ (curve25519_dalek!specs.field_specs.field_add.? (I 1) (I (curve25519_dalek!specs.field_specs.field_mul.?
                                              (I d@) (I (curve25519_dalek!specs.field_specs.field_mul.? (I x_div_z_sq@) (I y_div_z_sq@)))
                                          ))))
                                          (=>
                                           (= tmp%7 (= affine_rhs@ (curve25519_dalek!specs.field_specs.field_add.? (I 1) (I (curve25519_dalek!specs.field_specs.field_mul.?
                                                (I d@) (I x2_y2_inv_z4@)
                                           )))))
                                           (and
                                            (=>
                                             ...
                                             (and
                                              (and
                                               (=>
                                                ...
                                                (=>
                                                 %%location_label%%18
                                                 (= inv_z4@ (curve25519_dalek!specs.field_specs.field_mul.? (I inv_z2@) (I inv_z2@)))
                                               ))
                                               (=>
                                                (= inv_z4@ (curve25519_dalek!specs.field_specs.field_mul.? (I inv_z2@) (I inv_z2@)))
                                                (=>
                                                  ...
                                                  (=>
                                                   ...
                                                   (and
                                                    ...
                                                    (=>
                                                     ...
                                                     (=>
                                                      %%location_label%%20
                                                      (= (curve25519_dalek!specs.field_specs.field_mul.? (I z2@) (I inv_z2@)) 1)
                                                  ))))
                                                  (=>
                                                   (= (curve25519_dalek!specs.field_specs.field_mul.? (I z2@) (I inv_z2@)) 1)
                                                   (and
                                                    (=>
                                                     ...
                                                     (=>
                                                      %%location_label%%21
                                                      (= (curve25519_dalek!specs.field_specs.field_mul.? (I 1) (I inv_z2@)) (EucMod inv_z2@
                                                        p@
                                                    ))))
                                                    (=>
                                                     (= (curve25519_dalek!specs.field_specs.field_mul.? (I 1) (I inv_z2@)) (EucMod inv_z2@
                                                     ...
                                                     (and
                                                      (and
                                                       (=>
                                                        %%location_label%%22
                                                        (req%curve25519_dalek!specs.field_specs.field_inv_property. z2@)
                                                       )
                                                       (=>
                                                        (ens%curve25519_dalek!specs.field_specs.field_inv_property. z2@)
                                                        (=>
                                                         %%location_label%%23
                                                         (< inv_z2@ p@)
                                                      )))
                                                       ...
                                                       (and
                                                        (and
                                                         ...
                                                         (=>
                                                          ...
                                                          (=>
                                                           %%location_label%%25
                                                           (= inv_z2@ (EucMod inv_z2@ p@))
                                                        )))
                                                        (=>
                                                         (= inv_z2@ (EucMod inv_z2@ p@))
                                                         (=>
                                                          %%location_label%%26
                                                          (= (curve25519_dalek!specs.field_specs.field_mul.? (I z2@) (I inv_z4@)) inv_z2@)
                                              ))))))))))))
                                              (=>
                                               (= (curve25519_dalek!specs.field_specs.field_mul.? (I z2@) (I inv_z4@)) inv_z2@)
                                               (and
                                                (=>
                                                 (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_assoc.
                                                  y2_minus_x2@ z2@ inv_z4@
                                                 )
                                                 (=>
                                                  %%location_label%%27
                                                  (= (curve25519_dalek!specs.field_specs.field_mul.? (I proj_lhs@) (I inv_z4@)) affine_lhs@)
                                                ))
                                                (=>
                                                 (= (curve25519_dalek!specs.field_specs.field_mul.? (I proj_lhs@) (I inv_z4@)) affine_lhs@)
                                                 (and
                                                  (and
                                                   ...
                                                   (=>
                                                    ...
                                                    (=>
                                                     %%location_label%%29
                                                     (= (curve25519_dalek!specs.field_specs.field_mul.? (I inv_z4@) (I z4@)) 1)
                                                  )))
                                                  (=>
                                                   (= (curve25519_dalek!specs.field_specs.field_mul.? (I inv_z4@) (I z4@)) 1)
                                                   (and
                                                     ...
                                                     (=>
                                                      ...
                                                      (=>
                                                       ...
                                                       (=>
                                                        ...
                                                        (=>
                                                         %%location_label%%30
                                                         (= (curve25519_dalek!specs.field_specs.field_mul.? (I inv_z4@) (I (curve25519_dalek!specs.field_specs.field_mul.?
                                                             (I d@) (I x2_y2@)
                                                           ))
                                                          ) (curve25519_dalek!specs.field_specs.field_mul.? (I d@) (I x2_y2_inv_z4@))
                                                    ))))))
                                                    (=>
                                                     (= (curve25519_dalek!specs.field_specs.field_mul.? (I inv_z4@) (I (curve25519_dalek!specs.field_specs.field_mul.?
                                                         (I d@) (I x2_y2@)
                                                     ...
                                                     (and
                                                      (=>
                                                       ...
                                                       (=>
                                                        (= tmp%8 (curve25519_dalek!specs.field_specs.field_mul.? (I d@) (I x2_y2@)))
                                                        (=>
                                                         (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_field_mul_distributes_over_add.
                                                          inv_z4@ z4@ tmp%8
                                                         )
                                                         (and
                                                          ...
                                                          (=>
                                                           ...
                                                           (=>
                                                            %%location_label%%32
                                                            (= (curve25519_dalek!specs.field_specs.field_mul.? (I proj_rhs@) (I inv_z4@)) affine_rhs@)
                                                      ))))))
                                                      (=>
                                                       (= (curve25519_dalek!specs.field_specs.field_mul.? (I proj_rhs@) (I inv_z4@)) affine_rhs@)
                                                       (=>
                                                        (= tmp%9 (= affine_lhs@ affine_rhs@))
                                                        (and
                                                         (=>
                                                          %%location_label%%33
                                                          tmp%9
