...
;; curve25519-dalek/src/lemmas/edwards_lemmas/pippenger_lemmas.rs:570:1: 577:2 (#0)
   ...
   (= (req%curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.lemma_pippenger_horner_correct.
     ...
     (=>
      ...
      (forall ((k$ Poly)) (!
        ...
        :qid user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_pippenger_horner_correct_114
        :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_pippenger_horner_correct_114
     )))
     (=>
      ...
      (forall ((k$ Poly)) (!
        ...
        :qid user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_pippenger_horner_correct_115
        :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_pippenger_horner_correct_115
   )))))
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::pippenger_lemmas::lemma_pippenger_horner_correct
;; curve25519-dalek/src/lemmas/edwards_lemmas/pippenger_lemmas.rs:570:1: 577:2 (#0)
...
(push)
 ...
 (assert
  (forall ((k$ Poly)) (!
    ...
    :qid user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_pippenger_horner_correct_123
    :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_pippenger_horner_correct_123
 )))
 (assert
  (forall ((k$ Poly)) (!
    (=>
    ...
    :qid user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_pippenger_horner_correct_124
    :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_pippenger_horner_correct_124
 )))
        ...
        (and
         (and
          (=>
           %%location_label%%0
           (req%curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.lemma_pippenger_zero_points_from.
            points_affine! digits! 0 w! digits_count!
          ))
          (=>
           (ens%curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.lemma_pippenger_zero_points_from.
            points_affine! digits! 0 w! digits_count!
             ...
             (and
              ...
              (=>
               (forall ((k$ Poly)) (!
                 ...
                 :qid user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_pippenger_horner_correct_117
                 :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_pippenger_horner_correct_117
               ))
               (and
                (=>
                 (has_type k$1@ INT)
                ...
                (=>
                 (forall ((k$ Poly)) (!
                   ...
                   :qid user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_pippenger_horner_correct_118
                   :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_pippenger_horner_correct_118
                 ))
                 (and
                  (and
                   (=>
                    ...
                    (check_decrease_int (let
                      ((scalars!$0 scalars_prefix@) (points_ep!$1 points_prefix@) (points_affine!$2 pts_prefix@)
                       (digits!$3 digs_prefix@) (w!$4 w!) (digits_count!$5 digits_count!)
                      )
                      (vstd!seq.Seq.len.? $ TYPE%curve25519_dalek!scalar.Scalar. (Poly%vstd!seq.Seq<curve25519_dalek!scalar.Scalar.>.
                        scalars!$0
                      ))
                   ...
                   (and
                    (=>
                     %%location_label%%9
                     (req%curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.lemma_pippenger_horner_correct.
                      scalars_prefix@ points_prefix@ pts_prefix@ digs_prefix@ w! digits_count!
                    ))
                    (=>
                     (ens%curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.lemma_pippenger_horner_correct.
                      scalars_prefix@ points_prefix@ pts_prefix@ digs_prefix@ w! digits_count!
                     ...
                     (=>
                      ...
                      (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.pippenger_horner.?
                         (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. pts_prefix@) (Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>.
                          ...
                          scalars_prefix@
                         ) (Poly%vstd!seq.Seq<curve25519_dalek!edwards.EdwardsPoint.>. points_prefix@)
                  )))))))
                  (=>
                   (= (curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.pippenger_horner.? (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>.
                      pts_prefix@
                     ) (Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>. digs_prefix@) (I 0) (I w!) (I digits_count!)
                    ) (curve25519_dalek!specs.edwards_specs.sum_of_scalar_muls.? (Poly%vstd!seq.Seq<curve25519_dalek!scalar.Scalar.>.
                      scalars_prefix@
                     ) (Poly%vstd!seq.Seq<curve25519_dalek!edwards.EdwardsPoint.>. points_prefix@)
                   ))
                   (and
                    ...
                    (=>
                     (forall ((k$ Poly)) (!
                       ...
                       :qid user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_pippenger_horner_correct_120
                       :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_pippenger_horner_correct_120
                     ))
                     (and
                      (=>
                       (has_type k$3@ INT)
                       (=>
                        ...
                        (=>
                         ...
                         (>= (vstd!seq.Seq.len.? $ (SINT 8) (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq. $ (SINT
                            ...
                            ) (Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>. digits!) k$3@
                           )
                          ) digits_count!
                      ))))
                      (=>
                       (forall ((k$ Poly)) (!
                         ...
                         :qid user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_pippenger_horner_correct_121
                         :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__pippenger_lemmas__lemma_pippenger_horner_correct_121
                       ))
                       (and
                        (=>
                         %%location_label%%13
                           ...
                           (and
                            (and
                             (=>
                              %%location_label%%14
                              (req%curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.lemma_pippenger_single.
                               P_last@ d_last@ 0 w! digits_count!
                             ))
                             (=>
                              (ens%curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.lemma_pippenger_single.
                               P_last@ d_last@ 0 w! digits_count!
                              ...
                              (=>
                               ...
                               (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. (curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.pippenger_horner.?
                                  (vstd!seq.Seq.push.? (DST $) (TYPE%tuple%2. $ NAT $ NAT) (vstd!seq.Seq.empty.? (DST
                                   ...
                                   ) (Poly%vstd!seq.Seq<i8.>. d_last@)
                                  ) (I 0) (I w!) (I digits_count!)
                                 )
                                ) (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul_signed.?
                                  (Poly%tuple%2. P_last@) (I (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w_from.?
                                    (Poly%vstd!seq.Seq<i8.>. d_last@) (I w!) (I 0) (I digits_count!)
                            ))))))))
                            (=>
                             (= (curve25519_dalek!lemmas.edwards_lemmas.pippenger_lemmas.pippenger_horner.? (vstd!seq.Seq.push.?
                                (DST $) (TYPE%tuple%2. $ NAT $ NAT) (vstd!seq.Seq.empty.? (DST $) (TYPE%tuple%2. $
                             ...
                             (=>
                              ...
                              (=>
                               (= tmp%6 (= (curve25519_dalek!specs.scalar_specs.reconstruct_radix_2w_from.? (Poly%vstd!seq.Seq<i8.>.
                                   d_last@
                                  ) (I w!) (I 0) (I digits_count!)
                                 ) scalar_nat@
                               ))
