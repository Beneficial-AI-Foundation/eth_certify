...
;; curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:456:1: 460:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::as_bytes_lemmas::lemma_as_bytes_from_bytes_roundtrip
;; curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:456:1: 460:2 (#0)
(get-info :all-statistics)
(push)
 (declare-const bytes_orig! %%Function%%)
 (declare-const fe! curve25519_dalek!backend.serial.u64.field.FieldElement51.)
 (declare-const bytes_decoded! %%Function%%)
 ...
 (assert
  (has_type (Poly%array%. bytes_orig!) (ARRAY $ (UINT 8) $ (CONST_INT 32)))
 )
 (assert
 ...
 (assert
  (has_type (Poly%array%. bytes_decoded!) (ARRAY $ (UINT 8) $ (CONST_INT 32)))
 )
 (assert
  (< (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. bytes_orig!)) (
    curve25519_dalek!specs.field_specs_u64.p.? (I 0)
 ...
 (assert
  (not (=>
    (= v@ (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. bytes_orig!)))
    (and
     (=>
      ...
      (=>
       %%location_label%%0
       (let
        ((tmp%%$ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))))
        (and
         (< 0 tmp%%$)
         (< tmp%%$ (vstd!arithmetic.power2.pow2.? (I 255)))
     ))))
     (=>
      (let
       ((tmp%%$ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))))
       ...
       (and
        (=>
         ...
         (and
          (=>
           %%location_label%%1
           (req%vstd!arithmetic.div_mod.lemma_small_mod. v@ tmp%1)
          )
          (=>
           (ens%vstd!arithmetic.div_mod.lemma_small_mod. v@ tmp%1)
           (=>
            %%location_label%%2
            (= (EucMod v@ (vstd!arithmetic.power2.pow2.? (I 255))) v@)
        ))))
        (=>
         (= (EucMod v@ (vstd!arithmetic.power2.pow2.? (I 255))) v@)
         (and
          (=>
           ...
           (and
            (=>
             %%location_label%%3
             (req%vstd!arithmetic.div_mod.lemma_small_mod. v@ tmp%2)
            )
            (=>
             (ens%vstd!arithmetic.div_mod.lemma_small_mod. v@ tmp%2)
             (=>
              %%location_label%%4
              (= (EucMod v@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) v@)
          ))))
          (=>
           (= (EucMod v@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))) v@)
           (=>
