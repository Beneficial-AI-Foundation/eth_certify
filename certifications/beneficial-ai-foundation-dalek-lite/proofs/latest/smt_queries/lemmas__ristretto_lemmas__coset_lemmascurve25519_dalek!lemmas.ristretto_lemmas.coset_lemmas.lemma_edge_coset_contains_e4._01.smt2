...
;; MODULE 'module lemmas::ristretto_lemmas::coset_lemmas'
;; curve25519-dalek/src/lemmas/ristretto_lemmas/coset_lemmas.rs:47:1: 47:58 (#0)
...
(assert
 (distinct fuel%vstd!arithmetic.div_mod.lemma_mod_bound. fuel%vstd!array.array_view.
  ...
  fuel%curve25519_dalek!specs.edwards_specs.edwards_add. fuel%curve25519_dalek!specs.field_specs.fe51_as_canonical_nat.
  ...
  fuel%curve25519_dalek!specs.field_specs_u64.u64_5_as_nat. fuel%curve25519_dalek!specs.ristretto_specs.ristretto_coset_affine.
...
;; Function-Def curve25519_dalek::lemmas::ristretto_lemmas::coset_lemmas::lemma_edge_coset_contains_e4
;; curve25519-dalek/src/lemmas/ristretto_lemmas/coset_lemmas.rs:47:1: 47:58 (#0)
...
(push)
 ...
 (declare-const i_val@ Int)
 (declare-const neg_i@ Int)
 ...
 (assert
  (not (=>
    ...
    (=>
     ...
     (=>
      (= i_val@ (curve25519_dalek!specs.field_specs.sqrt_m1.? (I 0)))
      (=>
       ...
       (=>
        ...
        (=>
         (= coset@ (curve25519_dalek!specs.ristretto_specs.ristretto_coset_affine.? (I x!) (
            I y!
         )))
         (=>
          ...
          (and
           ...
           (=>
            ...
            (=>
             (= tmp%2 (nClip (Sub (curve25519_dalek!specs.field_specs_u64.p.? (I 0)) 1)))
             (=>
              (= tmp%3 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
              (and
               (=>
                %%location_label%%1
                (req%vstd!arithmetic.div_mod.lemma_small_mod. tmp%2 tmp%3)
               )
               (=>
                (ens%vstd!arithmetic.div_mod.lemma_small_mod. tmp%2 tmp%3)
                (and
                 (=>
                  ...
                  (and
                   (=>
                    ...
                    (and
                     (=>
                      %%location_label%%3
                      (req%vstd!arithmetic.div_mod.lemma_mod_bound. i_val@ tmp%4)
                     )
                     (=>
                      (ens%vstd!arithmetic.div_mod.lemma_mod_bound. i_val@ tmp%4)
                      (=>
                       %%location_label%%4
                       (< i_val@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                   ))))
                    ...
                    (and
                     (=>
                      ...
                      (and
                       (=>
                        %%location_label%%5
                        (req%vstd!arithmetic.div_mod.lemma_mod_bound. neg_i@ tmp%5)
                       )
                       (=>
                        (ens%vstd!arithmetic.div_mod.lemma_mod_bound. neg_i@ tmp%5)
                        (=>
                         %%location_label%%6
                         (< neg_i@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                     ))))
                     (=>
                      (< neg_i@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                      (or
                       (and
                        (=>
                         ...
                         (=>
                          (= tmp%6 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2.
                              $ NAT $ NAT
                             ) (vstd!view.View.view.? $ (ARRAY (DST $) (TYPE%tuple%2. $ NAT $ NAT) $ (CONST_INT 4))
                              (Poly%array%. coset@)
                             ) (I 0)
                             ...
                             (=>
                              ...
                              (=>
                               ...
                               (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2.
                                ...
                                ) (Poly%tuple%2. (tuple%2./tuple%2 (I (EucMod i_val@ (curve25519_dalek!specs.field_specs_u64.p.?
                                     (I 0)
                                   ))
                                  ) (I (EucMod 0 (curve25519_dalek!specs.field_specs_u64.p.? (I 0))))
                             )))))
                             (=>
                              ...
                              (and
                               (=>
                                ...
                                (=>
                                 ...
                                 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2.
                                  ...
                                  ) (Poly%tuple%2. (tuple%2./tuple%2 (I (EucMod neg_i@ (curve25519_dalek!specs.field_specs_u64.p.?
                                       (I 0)
                                     ))
                                    ) (I (EucMod 0 (curve25519_dalek!specs.field_specs_u64.p.? (I 0))))
                               )))))
                               (=>
                                (= (%Poly%tuple%2. (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2. $ NAT $ NAT) (vstd!view.View.view.?
                                 ...
                                 ) (tuple%2./tuple%2 (I (EucMod neg_i@ (curve25519_dalek!specs.field_specs_u64.p.? (I 0))))
                                  (I (EucMod 0 (curve25519_dalek!specs.field_specs_u64.p.? (I 0))))
                                ))
                                (=>
                                 ...
                                 (and
                                  (=>
                                   %%location_label%%10
                                   (req%vstd!arithmetic.div_mod.lemma_small_mod. i_val@ tmp%7)
                                  )
                                  (=>
                                   (ens%vstd!arithmetic.div_mod.lemma_small_mod. i_val@ tmp%7)
                                   (=>
                                    (= tmp%8 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                                    (and
                                     (=>
                                      %%location_label%%11
                                      (req%vstd!arithmetic.div_mod.lemma_small_mod. neg_i@ tmp%8)
                                     )
                                     (=>
                                      (ens%vstd!arithmetic.div_mod.lemma_small_mod. neg_i@ tmp%8)
                                      (=>
                                       (= tmp%9 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                                       (and
                                        (=>
                                         %%location_label%%12
                                         (req%vstd!arithmetic.div_mod.lemma_small_mod. 0 tmp%9)
                                        )
                                        (=>
                                         (ens%vstd!arithmetic.div_mod.lemma_small_mod. 0 tmp%9)
                                         %%switch_label%%0
                        )))))))))))))))))
                        (=>
                         (not (and
                         ...
                         (or
                          (and
                           (=>
                            ...
                            (=>
                             (= tmp%10 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2.
                                 $ NAT $ NAT
                                ) (vstd!view.View.view.? $ (ARRAY (DST $) (TYPE%tuple%2. $ NAT $ NAT) $ (CONST_INT 4))
                                 (Poly%array%. coset@)
                                ) (I 0)
                               ) (Poly%tuple%2. (tuple%2./tuple%2 (I 0) (I neg_one@)))
                             ))
                             (and
                              (=>
                               %%location_label%%13
                                   ...
                                   (=>
                                    ...
                                    (=>
                                     ...
                                     (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2.
                                      ...
                                      ) (Poly%tuple%2. (tuple%2./tuple%2 (I neg_i@) (I 0)))
                                  ))))
                                  (=>
                                   (= (%Poly%tuple%2. (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2. $ NAT $ NAT) (vstd!view.View.view.?
                                       $ (ARRAY (DST $) (TYPE%tuple%2. $ NAT $ NAT) $ (CONST_INT 4)) (Poly%array%. coset@)
                                    ...
                                    (=>
                                     ...
                                     (=>
                                      ...
                                      (and
                                       (=>
                                        %%location_label%%19
                                        (req%vstd!arithmetic.div_mod.lemma_small_mod. i_val@ tmp%11)
                                       )
                                       (=>
                                        (ens%vstd!arithmetic.div_mod.lemma_small_mod. i_val@ tmp%11)
                                        %%switch_label%%1
                           )))))))))))))
                           (=>
                            (not (and
                                ...
                                (=>
                                 ...
                                 (and
                                  (=>
                                   ...
                                   (and
                                    (=>
                                     (= tmp%13 (nClip (Sub (curve25519_dalek!specs.field_specs_u64.p.? (I 0)) 1)))
                                     (=>
                                      (= tmp%14 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                                      (and
                                       (=>
                                        %%location_label%%23
                                        (req%vstd!arithmetic.div_mod.lemma_small_mod. tmp%13 tmp%14)
                                       )
                                       (=>
                                        (ens%vstd!arithmetic.div_mod.lemma_small_mod. tmp%13 tmp%14)
                                        (=>
                                         %%location_label%%24
                                         (= (EucMod (nClip (Mul x! x!)) (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                                          (nClip (Sub (curve25519_dalek!specs.field_specs_u64.p.? (I 0)) 1))
                                    ))))))
                                    (=>
                                     (= (EucMod (nClip (Mul x! x!)) (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                                      ...
                                      (=>
                                       ...
                                       (=>
                                        ...
                                        (and
                                         (=>
                                          %%location_label%%26
                                          (req%vstd!arithmetic.div_mod.lemma_small_mod. x! tmp%15)
                                         )
                                         (=>
                                          (ens%vstd!arithmetic.div_mod.lemma_small_mod. x! tmp%15)
                                          (=>
                                           (= tmp%16 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                                           (and
                                            (=>
                                             %%location_label%%27
                                             (req%vstd!arithmetic.div_mod.lemma_small_mod. i_val@ tmp%16)
                                            )
                                            (=>
                                             (ens%vstd!arithmetic.div_mod.lemma_small_mod. i_val@ tmp%16)
                                             (=>
                                              %%location_label%%28
                                              (or
                                               (= x! i_val@)
                                     ...
                                     (=>
                                      ...
                                      (and
                                       (=>
                                        ...
                                        (=>
                                         %%location_label%%31
                                         (= (curve25519_dalek!specs.field_specs.field_neg.? (I neg_i@)) (EucMod i_val@ (curve25519_dalek!specs.field_specs_u64.p.?
                                            (I 0)
                                       )))))
                                       (=>
                                        (= (curve25519_dalek!specs.field_specs.field_neg.? (I neg_i@)) (EucMod i_val@ (curve25519_dalek!specs.field_specs_u64.p.?
                                        ...
                                        (=>
                                         (= tmp%17 (curve25519_dalek!specs.field_specs_u64.p.? (I 0)))
                                         (and
                                          (=>
                                           %%location_label%%32
                                           (req%vstd!arithmetic.div_mod.lemma_small_mod. i_val@ tmp%17)
                                          )
                                          (=>
                                           (ens%vstd!arithmetic.div_mod.lemma_small_mod. i_val@ tmp%17)
                                           (and
                                            (=>
                                             (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_neg_square_eq.
                                              i_val@
                                             ...
                                             (=>
                                              ...
                                              (and
                                               (=>
                                                %%location_label%%33
                                                (req%vstd!arithmetic.div_mod.lemma_small_mod. i_val@ tmp%18)
                                               )
                                               (=>
                                                (ens%vstd!arithmetic.div_mod.lemma_small_mod. i_val@ tmp%18)
                                                (=>
                                                 %%location_label%%34
                                                 (= (curve25519_dalek!specs.field_specs.field_square.? (I neg_i@)) (curve25519_dalek!specs.field_specs.field_neg.?
                                                   (I 1)
                                            )))))))
                                            (=>
                                             (= (curve25519_dalek!specs.field_specs.field_square.? (I neg_i@)) (curve25519_dalek!specs.field_specs.field_neg.?
                              ...
                              (and
                               (and
                                (or
                                 (or
                                  (or
                                   (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. id$) (vstd!seq.Seq.index.?
                                     (DST $) (TYPE%tuple%2. $ NAT $ NAT) (vstd!view.View.view.? $ (ARRAY (DST $) (TYPE%tuple%2.
                                        $ NAT $ NAT
                                       ) $ (CONST_INT 4)
                                      ) (Poly%array%. coset$)
                                     ) (I 0)
                                ...
                                (or
                                 (or
                                  (or
                                   (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. i_pt$) (vstd!seq.Seq.index.?
                                     (DST $) (TYPE%tuple%2. $ NAT $ NAT) (vstd!view.View.view.? $ (ARRAY (DST $) (TYPE%tuple%2.
                                        $ NAT $ NAT
                                       ) $ (CONST_INT 4)
                                      ) (Poly%array%. coset$)
                               ...
                               (or
                                (or
                                 (or
                                  (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. neg_i_pt$) (vstd!seq.Seq.index.?
                                    (DST $) (TYPE%tuple%2. $ NAT $ NAT) (vstd!view.View.view.? $ (ARRAY (DST $) (TYPE%tuple%2.
                                       $ NAT $ NAT
                                      ) $ (CONST_INT 4)
                                     ) (Poly%array%. coset$)
