...
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_ratio_lemmas.rs:74:1: 78:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::sqrt_ratio_lemmas::lemma_is_sqrt_ratio_to_field
;; curve25519-dalek/src/lemmas/field_lemmas/sqrt_ratio_lemmas.rs:74:1: 78:2 (#0)
      ...
      (and
       (=>
        ...
        (and
         (=>
          %%location_label%%0
          (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_general. tmp%1 v! p@)
         )
         (=>
          (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_general. tmp%1 v! p@)
          (=>
           %%location_label%%1
           (= (EucMod (nClip (Mul (nClip (Mul x! x!)) v!)) p@) (EucMod (nClip (Mul (EucMod (nClip
                 (Mul x! x!)
                ) p@
               ) (EucMod v! p@)
              )
       ...
       (=>
        ...
        (and
         (and
          (=>
           %%location_label%%2
           (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. x2@ v! p@)
          )
          (=>
           (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_right. x2@ v! p@)
           (=>
            %%location_label%%3
            (= (curve25519_dalek!specs.field_specs.field_mul.? (I x2@) (I v!)) (EucMod u! p@))
         )))
         (=>
          (= (curve25519_dalek!specs.field_specs.field_mul.? (I x2@) (I v!)) (EucMod u! p@))
          (=>
