...
;; curve25519-dalek/src/lemmas/scalar_lemmas_extra.rs:147:5: 147:11 (#0)
...
;; Function-Def curve25519_dalek::lemmas::scalar_lemmas_extra::lemma_limb_from_adjacent_words
;; curve25519-dalek/src/lemmas/scalar_lemmas_extra.rs:147:5: 147:11 (#0)
...
(declare-const high_bits! (_ BitVec 64))
(declare-const prev_shift! (_ BitVec 64))
(declare-const prev_word! (_ BitVec 64))
(assert
 (and
  (and
   (bvugt high_bits! ((_ zero_extend 63) (_ bv0 1)))
   (bvult high_bits! ((_ zero_extend 58) (_ bv52 6)))
  )
  (= (bvadd ((_ zero_extend 1) prev_shift!) ((_ zero_extend 1) high_bits!)) ((_ zero_extend
     58
    ) (_ bv64 7)
))))
...
(assert
 (not (=>
   %%location_label%%0
   (bvult (bvlshr prev_word! prev_shift!) (bvshl ((_ zero_extend 63) (_ bv1 1)) high_bits!))
)))
(get-info :version)
