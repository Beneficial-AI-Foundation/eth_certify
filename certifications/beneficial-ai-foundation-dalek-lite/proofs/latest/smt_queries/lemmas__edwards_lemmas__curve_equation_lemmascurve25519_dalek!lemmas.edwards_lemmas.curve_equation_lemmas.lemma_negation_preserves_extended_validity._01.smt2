...
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:227:1: 227:88 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::curve_equation_lemmas::lemma_negation_preserves_extended_validity
;; curve25519-dalek/src/lemmas/edwards_lemmas/curve_equation_lemmas.rs:227:1: 227:88 (#0)
...
(push)
 ...
 (declare-const zt@ Int)
 (declare-const p@ Int)
 (declare-const neg_x@ Int)
 (declare-const neg_t@ Int)
 (assert
  fuel_defaults
 )
 (assert
  ...
  (not (=>
    ...
    (=>
     ...
     (=>
      ...
      (=>
       (= neg_t@ (curve25519_dalek!specs.field_specs.field_neg.? (I t!)))
       (and
        (and
         (=>
          (ens%curve25519_dalek!lemmas.field_lemmas.field_algebra_lemmas.lemma_neg_square_eq.
          ...
          (=>
           ...
           (=>
            %%location_label%%0
            (= (curve25519_dalek!specs.field_specs.field_square.? (I neg_x@)) (curve25519_dalek!specs.field_specs.field_square.?
              (I x!)
         )))))
         (=>
          (= (curve25519_dalek!specs.field_specs.field_square.? (I neg_x@)) (curve25519_dalek!specs.field_specs.field_square.?
          ...
          (=>
           %%location_label%%1
           (curve25519_dalek!specs.edwards_specs.is_on_edwards_curve_projective.? (I neg_x@)
            (I y!) (I z!)
        ))))
        (=>
         (curve25519_dalek!specs.edwards_specs.is_on_edwards_curve_projective.? (I neg_x@)
         ...
         (and
          (=>
           ...
           (=>
            (= zt@ (curve25519_dalek!specs.field_specs.field_mul.? (I z!) (I t!)))
            (=>
             (= tmp%1 (= xy@ zt@))
             (and
              (=>
                ...
                (=>
                 ...
                 (=>
                  ...
                  (=>
                   ...
                   (=>
                    %%location_label%%3
                    (= (curve25519_dalek!specs.field_specs.field_mul.? (I neg_x@) (I y!)) (curve25519_dalek!specs.field_specs.field_neg.?
                      (I xy@)
                ))))))
                (=>
                 (= (curve25519_dalek!specs.field_specs.field_mul.? (I neg_x@) (I y!)) (curve25519_dalek!specs.field_specs.field_neg.?
                 ...
                 (and
                  (=>
                   ...
                   (=>
                    %%location_label%%4
                    (= (curve25519_dalek!specs.field_specs.field_mul.? (I z!) (I neg_t@)) (curve25519_dalek!specs.field_specs.field_neg.?
                      (I zt@)
                  ))))
                  (=>
                   (= (curve25519_dalek!specs.field_specs.field_mul.? (I z!) (I neg_t@)) (curve25519_dalek!specs.field_specs.field_neg.?
                   ...
                   (=>
                    (= tmp%2 (= (curve25519_dalek!specs.field_specs.field_neg.? (I xy@)) (curve25519_dalek!specs.field_specs.field_neg.?
                       (I zt@)
                    )))
                    (and
                     (=>
                     ...
                     (=>
                      ...
                      (=>
                       %%location_label%%6
                       (= (curve25519_dalek!specs.field_specs.field_mul.? (I neg_x@) (I y!)) (curve25519_dalek!specs.field_specs.field_mul.?
                         (I z!) (I neg_t@)
          )))))))))))))))
          (=>
           (= (curve25519_dalek!specs.field_specs.field_mul.? (I neg_x@) (I y!)) (curve25519_dalek!specs.field_specs.field_mul.?
