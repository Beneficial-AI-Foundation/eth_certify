...
;; curve25519-dalek/src/lemmas/common_lemmas/to_nat_lemmas.rs:537:1: 537:73 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::to_nat_lemmas::lemma_suffix_zero_when_bytes_zero
;; curve25519-dalek/src/lemmas/common_lemmas/to_nat_lemmas.rs:537:1: 537:73 (#0)
...
(push)
 ...
 (assert
  (forall ((i$ Poly)) (!
    ...
    :qid user_curve25519_dalek__lemmas__common_lemmas__to_nat_lemmas__lemma_suffix_zero_when_bytes_zero_42
    :skolemid skolem_user_curve25519_dalek__lemmas__common_lemmas__to_nat_lemmas__lemma_suffix_zero_when_bytes_zero_42
 )))
        ...
        (=>
         ...
         (and
          ...
          (=>
           ...
           (and
            (=>
             (= tmp%2 (vstd!arithmetic.power2.pow2.? (I (nClip (Mul n! 8)))))
             (=>
