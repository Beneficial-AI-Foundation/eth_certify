...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:1373:1: 1373:65 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_solve_for_left_factor
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:1373:1: 1373:65 (#0)
  ...
  (not (=>
    ...
    (=>
     ...
     (=>
      ...
      (=>
       (= ab_mod@ (curve25519_dalek!specs.field_specs.field_mul.? (I a!) (I b!)))
       (and
        (and
         (=>
          %%location_label%%0
         ...
         (=>
          ...
          (=>
           ...
           (and
            (< inv_b@ p@)
            (= (EucMod (nClip (Mul (EucMod b! p@) inv_b@)) p@) 1)
        ))))
        (=>
         (and
          (< inv_b@ p@)
         ...
         (=>
          ...
          (and
           ...
           (=>
            ...
            (and
             (=>
              (ens%vstd!arithmetic.mul.lemma_mul_is_associative. a! b! inv_b@)
              (=>
               (= tmp%2 (= (EucMod (nClip (Mul (EucMod b! p@) inv_b@)) p@) 1))
               (and
                (=>
                 %%location_label%%3
                 tmp%2
                ...
                (=>
                 ...
                 (and
                  (=>
                   %%location_label%%4
                   (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. b! inv_b@ p@)
                  )
                  (=>
                   (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. b! inv_b@ p@)
                   (=>
                    (= tmp%3 (= (EucMod (nClip (Mul b! inv_b@)) p@) 1))
                    (and
                     (=>
                      %%location_label%%5
                      tmp%3
                       ...
                       (and
                        ...
                        (=>
                         ...
                         (=>
                          ...
                          (=>
                           %%location_label%%7
                           (= (EucMod (nClip (Mul (nClip (Mul a! b!)) inv_b@)) p@) (EucMod a! p@))
             ))))))))))))))
             (=>
              (= (EucMod (nClip (Mul (nClip (Mul a! b!)) inv_b@)) p@) (EucMod a! p@))
              (and
               (and
                (=>
                 %%location_label%%8
                 (req%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. c! inv_b@ p@)
                )
                (=>
                 (ens%vstd!arithmetic.div_mod.lemma_mul_mod_noop_left. c! inv_b@ p@)
                 (=>
                  %%location_label%%9
                  (= (EucMod (nClip (Mul ab_mod@ inv_b@)) p@) (curve25519_dalek!specs.field_specs.field_mul.?
                    (I c!) (I inv_b@)
               )))))
               (=>
                (= (EucMod (nClip (Mul ab_mod@ inv_b@)) p@) (curve25519_dalek!specs.field_specs.field_mul.?
                 ...
                 (=>
                  ...
                  (and
                   ...
                   (=>
                    ...
                    (=>
                     %%location_label%%11
                     (= (EucMod (nClip (Mul (nClip (Mul a! b!)) inv_b@)) p@) (EucMod (nClip (Mul ab_mod@ inv_b@))
                       p@
                 ))))))
                 (=>
                  (= (EucMod (nClip (Mul (nClip (Mul a! b!)) inv_b@)) p@) (EucMod (nClip (Mul ab_mod@ inv_b@))
