...
;; curve25519-dalek/src/lemmas/scalar_lemmas_extra.rs:421:1: 421:80 (#0)
...
;; Function-Def curve25519_dalek::lemmas::scalar_lemmas_extra::lemma_lo_limbs_bounded
;; curve25519-dalek/src/lemmas/scalar_lemmas_extra.rs:421:1: 421:80 (#0)
(get-info :all-statistics)
(push)
 (declare-const lo! curve25519_dalek!backend.serial.u64.scalar.Scalar52.)
 ...
 (assert
  (has_type (Poly%curve25519_dalek!backend.serial.u64.scalar.Scalar52. lo!) TYPE%curve25519_dalek!backend.serial.u64.scalar.Scalar52.)
 )
 (assert
 ...
 (assert
  (not (=>
    ...
    (and
     (=>
      %%location_label%%0
      (req%curve25519_dalek!lemmas.scalar_lemmas.lemma_borrow_and_mask_bounded. tmp%1 mask!)
     )
     (=>
      (ens%curve25519_dalek!lemmas.scalar_lemmas.lemma_borrow_and_mask_bounded. tmp%1 mask!)
      (=>
       (= tmp%2 (uClip 64 (bitor (I (uClip 64 (bitshr (I (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                 $ (ARRAY $ (UINT 64) $ (CONST_INT 8)) (Poly%array%. words!)
                ) (I 0)
              ))
             ) (I 52)
       ...
       (and
        (=>
         %%location_label%%1
         (req%curve25519_dalek!lemmas.scalar_lemmas.lemma_borrow_and_mask_bounded. tmp%2 mask!)
        )
        (=>
         (ens%curve25519_dalek!lemmas.scalar_lemmas.lemma_borrow_and_mask_bounded. tmp%2 mask!)
         (=>
          (= tmp%3 (uClip 64 (bitor (I (uClip 64 (bitshr (I (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                    $ (ARRAY $ (UINT 64) $ (CONST_INT 8)) (Poly%array%. words!)
                   ) (I 1)
                 ))
                ) (I 40)
          ...
          (and
           (=>
            %%location_label%%2
            (req%curve25519_dalek!lemmas.scalar_lemmas.lemma_borrow_and_mask_bounded. tmp%3 mask!)
           )
           (=>
            (ens%curve25519_dalek!lemmas.scalar_lemmas.lemma_borrow_and_mask_bounded. tmp%3 mask!)
            (=>
             (= tmp%4 (uClip 64 (bitor (I (uClip 64 (bitshr (I (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                       $ (ARRAY $ (UINT 64) $ (CONST_INT 8)) (Poly%array%. words!)
                      ) (I 2)
                    ))
                   ) (I 28)
             ...
             (and
              (=>
               %%location_label%%3
               (req%curve25519_dalek!lemmas.scalar_lemmas.lemma_borrow_and_mask_bounded. tmp%4 mask!)
              )
              (=>
               (ens%curve25519_dalek!lemmas.scalar_lemmas.lemma_borrow_and_mask_bounded. tmp%4 mask!)
               (=>
                (= tmp%5 (uClip 64 (bitor (I (uClip 64 (bitshr (I (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                          $ (ARRAY $ (UINT 64) $ (CONST_INT 8)) (Poly%array%. words!)
                         ) (I 3)
                       ))
                      ) (I 16)
                ...
                (and
                 (=>
                  %%location_label%%4
                  (req%curve25519_dalek!lemmas.scalar_lemmas.lemma_borrow_and_mask_bounded. tmp%5 mask!)
                 )
                 (=>
                  (ens%curve25519_dalek!lemmas.scalar_lemmas.lemma_borrow_and_mask_bounded. tmp%5 mask!)
                  (=>
                   %%location_label%%5
                   (forall ((i$ Poly)) (!
                     (=>
                     ...
                     :qid user_curve25519_dalek__lemmas__scalar_lemmas_extra__lemma_lo_limbs_bounded_30
                     :skolemid skolem_user_curve25519_dalek__lemmas__scalar_lemmas_extra__lemma_lo_limbs_bounded_30
 ))))))))))))))))))))
 (get-info :version)
