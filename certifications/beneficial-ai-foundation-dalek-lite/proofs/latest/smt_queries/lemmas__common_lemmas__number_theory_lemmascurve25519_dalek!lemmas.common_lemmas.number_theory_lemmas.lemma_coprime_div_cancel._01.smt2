...
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:330:9: 330:15 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::number_theory_lemmas::lemma_coprime_div_cancel
;; curve25519-dalek/src/lemmas/common_lemmas/number_theory_lemmas.rs:330:9: 330:15 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= (Add (Mul di@ x@) (Mul ai@ y@)) 1)
    (=>
     %%location_label%%0
     (= (Add (Mul (Mul bi@ di@) x@) (Mul (Mul ai@ bi@) y@)) bi@)
 ))))
 (get-info :version)
