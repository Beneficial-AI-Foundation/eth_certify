...
;; curve25519-dalek/src/lemmas/montgomery_curve_lemmas.rs:1422:1: 1422:90 (#0)
...
;; Function-Specs curve25519_dalek::lemmas::montgomery_curve_lemmas::axiom_edwards_to_montgomery_commutes_with_scalar_mul
(declare-fun req%curve25519_dalek!lemmas.montgomery_curve_lemmas.axiom_edwards_to_montgomery_commutes_with_scalar_mul.
 (Int Int Int) Bool
)
(declare-const %%global_location_label%%54 Bool)
(assert
 (forall ((x! Int) (y! Int) (n! Int)) (!
   (= (req%curve25519_dalek!lemmas.montgomery_curve_lemmas.axiom_edwards_to_montgomery_commutes_with_scalar_mul.
     x! y! n!
    ) (=>
     %%global_location_label%%54
     (curve25519_dalek!specs.edwards_specs.is_on_edwards_curve.? (I x!) (I y!))
   ))
   :pattern ((req%curve25519_dalek!lemmas.montgomery_curve_lemmas.axiom_edwards_to_montgomery_commutes_with_scalar_mul.
     x! y! n!
   ))
   :qid internal_req__curve25519_dalek!lemmas.montgomery_curve_lemmas.axiom_edwards_to_montgomery_commutes_with_scalar_mul._definition
   :skolemid skolem_internal_req__curve25519_dalek!lemmas.montgomery_curve_lemmas.axiom_edwards_to_montgomery_commutes_with_scalar_mul._definition
)))
(declare-fun ens%curve25519_dalek!lemmas.montgomery_curve_lemmas.axiom_edwards_to_montgomery_commutes_with_scalar_mul.
 (Int Int Int) Bool
)
(assert
 (forall ((x! Int) (y! Int) (n! Int)) (!
   (= (ens%curve25519_dalek!lemmas.montgomery_curve_lemmas.axiom_edwards_to_montgomery_commutes_with_scalar_mul.
     x! y! n!
    ) (and
     (curve25519_dalek!specs.edwards_specs.is_on_edwards_curve.? (tuple%2./tuple%2/0 (%Poly%tuple%2.
      ...
      ) (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.?
          (Poly%tuple%2. (tuple%2./tuple%2 (I x!) (I y!))) (I n!)
     )))))
     (= (curve25519_dalek!specs.montgomery_specs.montgomery_u_from_edwards_y.? (tuple%2./tuple%2/1
        (%Poly%tuple%2. (Poly%tuple%2. (curve25519_dalek!specs.edwards_specs.edwards_scalar_mul.?
           (Poly%tuple%2. (tuple%2./tuple%2 (I x!) (I y!))) (I n!)
       ))))
      ) (curve25519_dalek!specs.montgomery_specs.montgomery_scalar_mul_u.? (I (curve25519_dalek!specs.montgomery_specs.montgomery_u_from_edwards_y.?
         (I y!)
        )
       ) (I n!)
   ))))
   :pattern ((ens%curve25519_dalek!lemmas.montgomery_curve_lemmas.axiom_edwards_to_montgomery_commutes_with_scalar_mul.
     x! y! n!
   ))
   :qid internal_ens__curve25519_dalek!lemmas.montgomery_curve_lemmas.axiom_edwards_to_montgomery_commutes_with_scalar_mul._definition
   :skolemid skolem_internal_ens__curve25519_dalek!lemmas.montgomery_curve_lemmas.axiom_edwards_to_montgomery_commutes_with_scalar_mul._definition
)))

;; Function-Def curve25519_dalek::lemmas::montgomery_curve_lemmas::axiom_edwards_to_montgomery_commutes_with_scalar_mul
;; curve25519-dalek/src/lemmas/montgomery_curve_lemmas.rs:1422:1: 1422:90 (#0)
