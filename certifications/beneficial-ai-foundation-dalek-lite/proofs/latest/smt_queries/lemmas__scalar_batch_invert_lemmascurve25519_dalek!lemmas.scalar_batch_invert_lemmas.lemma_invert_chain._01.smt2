...
;; curve25519-dalek/src/lemmas/scalar_batch_invert_lemmas.rs:202:5: 202:11 (#0)
...
;; Function-Def curve25519_dalek::lemmas::scalar_batch_invert_lemmas::lemma_invert_chain
;; curve25519-dalek/src/lemmas/scalar_batch_invert_lemmas.rs:202:5: 202:11 (#0)
(set-option :smt.arith.solver 6)
(get-info :all-statistics)
(push)
 (declare-const acc_before! Int)
 (declare-const acc_after! Int)
 (declare-const final_acc! Int)
 ...
 (assert
  (not (=>
    %%location_label%%0
    (= (nClip (Mul (nClip (Mul final_acc! R@)) (nClip (Mul R@ product!)))) (nClip (Mul (
        nClip (Mul (nClip (Mul final_acc! product!)) R@)
       ) R@
 ))))))
 (get-info :version)
