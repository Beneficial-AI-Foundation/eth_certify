...
;; curve25519-dalek/src/lemmas/common_lemmas/bits_as_nat_lemmas.rs:381:1: 381:91 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::bits_as_nat_lemmas::lemma_bits_chunks_eq_bytes_prefix
;; curve25519-dalek/src/lemmas/common_lemmas/bits_as_nat_lemmas.rs:381:1: 381:91 (#0)
...
(push)
 ...
 (assert
  (forall ((i$ Poly)) (!
    ...
    :qid user_curve25519_dalek__lemmas__common_lemmas__bits_as_nat_lemmas__lemma_bits_chunks_eq_bytes_prefix_66
    :skolemid skolem_user_curve25519_dalek__lemmas__common_lemmas__bits_as_nat_lemmas__lemma_bits_chunks_eq_bytes_prefix_66
 )))
          ...
          (and
           (=>
            ...
            (check_decrease_int (let
              ((bits!$0 bits!) (bytes!$1 bytes!) (k!$2 tmp%1))
              k!$2
            ...
            (and
                    ...
                    (and
                     ...
                     (=>
                      ...
                      (and
                       (=>
                        %%location_label%%7
                        (req%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. i@ 8)
                       )
                       (=>
                        (ens%vstd!arithmetic.div_mod.lemma_fundamental_div_mod. i@ 8)
                        (=>
                         %%location_label%%8
                         (= (%B (vstd!seq.Seq.index.? $ BOOL (vstd!view.View.view.? $ (ARRAY $ BOOL $ (CONST_INT
                               256
             ...
             (=>
              (forall ((j$ Int)) (!
                ...
                :qid user_curve25519_dalek__lemmas__common_lemmas__bits_as_nat_lemmas__lemma_bits_chunks_eq_bytes_prefix_61
                :skolemid skolem_user_curve25519_dalek__lemmas__common_lemmas__bits_as_nat_lemmas__lemma_bits_chunks_eq_bytes_prefix_61
              ))
              (and
               (=>
                (= tmp%4 (%I (vstd!seq.Seq.index.? $ (UINT 8) (vstd!view.View.view.? $ (ARRAY $ (UINT 8)
                     $ (CONST_INT 32)
                    ) (Poly%array%. bytes!)
                   ) (I (Sub k! 1))
                )))
                (and
                 ...
                 (=>
                  ...
                  (=>
                   ...
                   (= (curve25519_dalek!specs.core_specs.bits_from_index_to_nat.? (Poly%array%. bits!)
                     (I m@) (I 8)
                    ) (curve25519_dalek!specs.core_specs.byte_bits_value.? (vstd!seq.Seq.index.? $ (UINT
                       8
                 ...
                 (=>
                  ...
                  (and
                   (=>
                    (= tmp%6 (Sub k! 1))
                    (=>
                     (ens%vstd!arithmetic.mul.lemma_mul_is_associative. 8 tmp%6 8)
                     (=>
                      %%location_label%%12
                      (= (Mul m@ 8) (Mul (Mul (Sub k! 1) 8) 8))
                   )))
                   (=>
                    (= (Mul m@ 8) (Mul (Mul (Sub k! 1) 8) 8))
                    (and
                     (=>
                      (= tmp%7 (vstd!arithmetic.power2.pow2.? (I m@)))
                      (=>
                       ...
                       (=>
                        (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. tmp%7 tmp%8)
                        (=>
                         %%location_label%%13
                         (= (nClip (Mul (vstd!arithmetic.power2.pow2.? (I m@)) (%I (vstd!seq.Seq.index.? $ (UINT
                               8
                              ) (vstd!view.View.view.? $ (ARRAY $ (UINT 8) $ (CONST_INT 32)) (Poly%array%. bytes!))
                              (I (Sub k! 1))
                           )))
                            ...
                            ) (vstd!arithmetic.power2.pow2.? (I (nClip (Mul (Sub k! 1) 8))))
                     )))))))
                     (=>
                      (= (nClip (Mul (vstd!arithmetic.power2.pow2.? (I m@)) (%I (vstd!seq.Seq.index.? $ (UINT
                            8
