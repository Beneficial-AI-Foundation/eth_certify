...
;; curve25519-dalek/src/lemmas/common_lemmas/mul_lemmas.rs:295:1: 306:2 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::mul_lemmas::lemma_mul_w0_and_reorder
;; curve25519-dalek/src/lemmas/common_lemmas/mul_lemmas.rs:295:1: 306:2 (#0)
    ...
    (=>
     ...
     (=>
      ...
      (=>
       ...
       (=>
        (ens%curve25519_dalek!lemmas.common_lemmas.mul_lemmas.lemma_mul_distributive_5_terms.
         w0! v0! tmp%1 tmp%2 tmp%3 tmp%4
        )
        (=>
         (ens%vstd!arithmetic.mul.lemma_mul_is_associative. w0! v1! s1!)
         (=>
          (ens%vstd!arithmetic.mul.lemma_mul_is_associative. w0! v2! s2!)
          (=>
           (ens%vstd!arithmetic.mul.lemma_mul_is_associative. w0! v3! s3!)
           (=>
            (ens%vstd!arithmetic.mul.lemma_mul_is_associative. w0! v4! s4!)
            (=>
             %%location_label%%0
             (= (Mul w0! (Add (Add (Add (Add v0! (Mul s1! v1!)) (Mul s2! v2!)) (Mul s3! v3!)) (Mul
                 s4! v4!
               ))
              ) (Add (Add (Add (Add (Mul s4! (Mul w0! v4!)) (Mul s3! (Mul w0! v3!))) (Mul s2! (Mul w0!
                   v2!
