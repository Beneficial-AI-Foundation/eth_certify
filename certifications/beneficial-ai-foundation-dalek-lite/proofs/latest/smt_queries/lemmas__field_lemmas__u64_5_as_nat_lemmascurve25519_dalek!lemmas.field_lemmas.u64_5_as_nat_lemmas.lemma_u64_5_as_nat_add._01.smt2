...
;; curve25519-dalek/src/lemmas/field_lemmas/u64_5_as_nat_lemmas.rs:69:1: 69:62 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::u64_5_as_nat_lemmas::lemma_u64_5_as_nat_add
;; curve25519-dalek/src/lemmas/field_lemmas/u64_5_as_nat_lemmas.rs:69:1: 69:62 (#0)
...
(push)
 ...
 (assert
  (forall ((i$ Poly)) (!
    ...
    :qid user_curve25519_dalek__lemmas__field_lemmas__u64_5_as_nat_lemmas__lemma_u64_5_as_nat_add_26
    :skolemid skolem_user_curve25519_dalek__lemmas__field_lemmas__u64_5_as_nat_lemmas__lemma_u64_5_as_nat_add_26
 )))
 ;; assertion failed
 ...
 (assert
  (not (=>
    (= c@ (%Poly%array%. (array_new $ (UINT 64) 5 (%%array%%0 (I (uClip 64 (Add (%I (vstd!seq.Seq.index.?
     ...
     (=>
      ...
      (=>
       ...
       (=>
        ...
        (=>
         (ens%vstd!arithmetic.mul.lemma_mul_is_distributive_add. tmp%1 tmp%2 tmp%3)
         (=>
                  ...
                  (=>
                   ...
                   (=>
                    ...
                    (=>
                     ...
                     (=>
                      %%location_label%%0
                      (= (curve25519_dalek!specs.field_specs_u64.u64_5_as_nat.? (Poly%array%. c@)) (Add (
                         Add (Add (Add (Add (Add (Add (Add (Add (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                                   $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. a!)
                                  ) (I 0)
                                 )
                                ) (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $
