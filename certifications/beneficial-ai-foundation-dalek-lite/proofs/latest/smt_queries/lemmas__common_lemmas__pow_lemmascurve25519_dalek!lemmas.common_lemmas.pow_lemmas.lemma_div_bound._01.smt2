...
;; curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:108:1: 108:53 (#0)
...
;; Function-Def curve25519_dalek::lemmas::common_lemmas::pow_lemmas::lemma_div_bound
;; curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:108:1: 108:53 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= tmp%1 (nClip (Sub b! a!)))
    (=>
     (ens%vstd!arithmetic.power2.lemma_pow2_adds. a! tmp%1)
     (=>
      (= tmp%2 (vstd!arithmetic.power2.pow2.? (I a!)))
      (=>
       (= tmp%3 (vstd!arithmetic.power2.pow2.? (I (nClip (Sub b! a!)))))
       (and
        (=>
         %%location_label%%0
         (req%curve25519_dalek!lemmas.common_lemmas.div_mod_lemmas.lemma_div_strictly_bounded.
