...
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:917:1: 917:56 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::field_algebra_lemmas::lemma_field_sub_eq_add_neg
;; curve25519-dalek/src/lemmas/field_lemmas/field_algebra_lemmas.rs:917:1: 917:56 (#0)
         ...
         (=>
          ...
          (and
           ...
           (=>
            (< b_mod@ p@)
            (=>
             (= tmp%1 (= (curve25519_dalek!specs.field_specs.field_neg.? (I b!)) (EucMod neg_b_raw@
                p@
             )))
             (and
              (=>
              ...
              (=>
               ...
               (and
                (=>
                 (= tmp%2 (= (nClip (Sub (nClip (Add a_mod@ p@)) b_mod@)) (nClip (Add a_mod@ neg_b_raw@))))
                 (and
                  (=>
                   %%location_label%%5
                   tmp%2
                  ...
                  (=>
                   ...
                   (=>
                    %%location_label%%6
                    (= (curve25519_dalek!specs.field_specs.field_sub.? (I a!) (I b!)) (EucMod (nClip (Add
                        a_mod@ neg_b_raw@
                       )
                      ) p@
                ))))))
                (=>
                 ...
                 (and
                  (and
                   (=>
                    (= tmp%3 (EucMod neg_b_raw@ p@))
                    (and
                     (=>
                      %%location_label%%7
                      (req%vstd!arithmetic.div_mod.lemma_add_mod_noop. a! tmp%3 p@)
                     )
                     (=>
                      (ens%vstd!arithmetic.div_mod.lemma_add_mod_noop. a! tmp%3 p@)
                      (and
                       (=>
                        %%location_label%%8
                        (req%vstd!arithmetic.div_mod.lemma_add_mod_noop. a! neg_b_raw@ p@)
                       )
                       (=>
                        (ens%vstd!arithmetic.div_mod.lemma_add_mod_noop. a! neg_b_raw@ p@)
                        (and
                         (=>
                          %%location_label%%9
                          (req%vstd!arithmetic.div_mod.lemma_mod_twice. neg_b_raw@ p@)
                         )
                         (=>
                          (ens%vstd!arithmetic.div_mod.lemma_mod_twice. neg_b_raw@ p@)
                          (=>
                           %%location_label%%10
                           (= (EucMod (nClip (Add a! (curve25519_dalek!specs.field_specs.field_neg.? (I b!))))
                             p@
                            ) (EucMod (nClip (Add a! neg_b_raw@)) p@)
                   )))))))))
                   (=>
                    (= (EucMod (nClip (Add a! (curve25519_dalek!specs.field_specs.field_neg.? (I b!))))
                      p@
                     ...
                     (and
                      ...
                      (=>
                       ...
                       (and
                        (=>
                         %%location_label%%12
                         (req%vstd!arithmetic.div_mod.lemma_add_mod_noop. a_mod@ neg_b_raw@ p@)
                        )
                        (=>
                         (ens%vstd!arithmetic.div_mod.lemma_add_mod_noop. a_mod@ neg_b_raw@ p@)
                         (and
                          (=>
                           %%location_label%%13
                           (req%vstd!arithmetic.div_mod.lemma_small_mod. a_mod@ p@)
                          )
                          (=>
                           (ens%vstd!arithmetic.div_mod.lemma_small_mod. a_mod@ p@)
                           (=>
                            %%location_label%%14
                            (= (EucMod (nClip (Add a! neg_b_raw@)) p@) (EucMod (nClip (Add a_mod@ neg_b_raw@))
                              p@
                     )))))))))
                     (=>
                      (= (EucMod (nClip (Add a! neg_b_raw@)) p@) (EucMod (nClip (Add a_mod@ neg_b_raw@))
                      ...
                      (=>
                       %%location_label%%15
                       (= (curve25519_dalek!specs.field_specs.field_add.? (I a!) (I (curve25519_dalek!specs.field_specs.field_neg.?
                           (I b!)
                         ))
                        ) (EucMod (nClip (Add a_mod@ neg_b_raw@)) p@)
                  ))))))
                  (=>
                   (= (curve25519_dalek!specs.field_specs.field_add.? (I a!) (I (curve25519_dalek!specs.field_specs.field_neg.?
                       (I b!)
