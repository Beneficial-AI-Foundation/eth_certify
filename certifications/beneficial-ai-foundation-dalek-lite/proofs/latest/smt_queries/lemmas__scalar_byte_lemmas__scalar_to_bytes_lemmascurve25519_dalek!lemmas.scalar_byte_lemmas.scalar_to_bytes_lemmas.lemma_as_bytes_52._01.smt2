...
;; curve25519-dalek/src/lemmas/scalar_byte_lemmas/scalar_to_bytes_lemmas.rs:143:1: 143:65 (#0)
   ...
   (= (req%curve25519_dalek!lemmas.scalar_byte_lemmas.scalar_to_bytes_lemmas.lemma_as_bytes_52.
     ...
     (=>
      ...
      (forall ((i$ Poly)) (!
        ...
        :qid user_curve25519_dalek__lemmas__scalar_byte_lemmas__scalar_to_bytes_lemmas__lemma_as_bytes_52_102
        :skolemid skolem_user_curve25519_dalek__lemmas__scalar_byte_lemmas__scalar_to_bytes_lemmas__lemma_as_bytes_52_102
     )))
     (=>
...
;; Function-Def curve25519_dalek::lemmas::scalar_byte_lemmas::scalar_to_bytes_lemmas::lemma_as_bytes_52
;; curve25519-dalek/src/lemmas/scalar_byte_lemmas/scalar_to_bytes_lemmas.rs:143:1: 143:65 (#0)
...
(push)
 ...
 (assert
  (forall ((i$ Poly)) (!
    ...
    :qid user_curve25519_dalek__lemmas__scalar_byte_lemmas__scalar_to_bytes_lemmas__lemma_as_bytes_52_117
    :skolemid skolem_user_curve25519_dalek__lemmas__scalar_byte_lemmas__scalar_to_bytes_lemmas__lemma_as_bytes_52_117
 )))
 (assert
  (curve25519_dalek!lemmas.scalar_byte_lemmas.scalar_to_bytes_lemmas.bytes_match_limbs_packing_52.?
   (Poly%array%. limbs!) (Poly%array%. bytes!)
     ...
     (and
      (and
       (and
        (=>
         %%location_label%%2
         (req%vstd!arithmetic.power2.lemma_pow2_strictly_increases. 52 256)
        )
        (=>
         (ens%vstd!arithmetic.power2.lemma_pow2_strictly_increases. 52 256)
         (=>
          %%location_label%%3
          (let
           ((tmp%%$ (Sub (vstd!arithmetic.power2.pow2.? (I 52)) 1)))
           (let
            ((tmp%%$1 (vstd!arithmetic.power2.pow2.? (I 52))))
            (and
             (and
              (<= (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64)
                   $ (CONST_INT 5)
             ...
             (< tmp%%$1 (vstd!arithmetic.power2.pow2.? (I 256)))
       ))))))
       (=>
        (let
         ((tmp%%$ (Sub (vstd!arithmetic.power2.pow2.? (I 52)) 1)))
         (let
          ...
          (and
           ...
           (< tmp%%$3 (vstd!arithmetic.power2.pow2.? (I 256)))
        )))
        (and
         (=>
          ...
          (and
           ...
           (=>
            ...
            (=>
             (ens%vstd!arithmetic.power2.lemma_pow2_pos. 52)
             (and
              (=>
               %%location_label%%5
               (req%vstd!arithmetic.power2.lemma_pow2_strictly_increases. 104 256)
              )
              (=>
               (ens%vstd!arithmetic.power2.lemma_pow2_strictly_increases. 104 256)
               (=>
                %%location_label%%6
                (let
                 ((tmp%%$ (Sub (vstd!arithmetic.power2.pow2.? (I 104)) (vstd!arithmetic.power2.pow2.?
                     (I 52)
                 ))))
                 (let
                  ((tmp%%$5 (vstd!arithmetic.power2.pow2.? (I 104))))
                  (and
                   (and
                    (<= (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 52)) (%I (vstd!seq.Seq.index.? $ (UINT
                          64
                   ...
                   (< tmp%%$5 (vstd!arithmetic.power2.pow2.? (I 256)))
         ))))))))))
         (=>
          (let
           ((tmp%%$ (Sub (vstd!arithmetic.power2.pow2.? (I 104)) (vstd!arithmetic.power2.pow2.?
           ...
           (let
            ...
            (and
             ...
             (< tmp%%$7 (vstd!arithmetic.power2.pow2.? (I 256)))
          )))
          (and
           (=>
            ...
            (and
             ...
             (=>
              ...
              (=>
               (ens%vstd!arithmetic.power2.lemma_pow2_pos. 104)
               (and
                (=>
                 %%location_label%%8
                 (req%vstd!arithmetic.power2.lemma_pow2_strictly_increases. 156 256)
                )
                (=>
                 (ens%vstd!arithmetic.power2.lemma_pow2_strictly_increases. 156 256)
                 (=>
                  %%location_label%%9
                  (let
                   ((tmp%%$ (Sub (vstd!arithmetic.power2.pow2.? (I 156)) (vstd!arithmetic.power2.pow2.?
                       (I 104)
                   ))))
                   (let
                    ((tmp%%$9 (vstd!arithmetic.power2.pow2.? (I 156))))
                    (and
                     (and
                      (<= (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 104)) (%I (vstd!seq.Seq.index.? $ (UINT
                            64
                     ...
                     (< tmp%%$9 (vstd!arithmetic.power2.pow2.? (I 256)))
           ))))))))))
           (=>
            (let
             ((tmp%%$ (Sub (vstd!arithmetic.power2.pow2.? (I 156)) (vstd!arithmetic.power2.pow2.?
             ...
             (let
              ((tmp%%$11 (vstd!arithmetic.power2.pow2.? (I 156))))
              (and
               (and
                (<= (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 104)) (%I (vstd!seq.Seq.index.? $ (UINT
                      64
               ...
               (< tmp%%$11 (vstd!arithmetic.power2.pow2.? (I 256)))
            )))
            (and
             (=>
              ...
              (and
               ...
               (=>
                ...
                (=>
                 (ens%vstd!arithmetic.power2.lemma_pow2_pos. 156)
                 (and
                  (=>
                   %%location_label%%11
                   (req%vstd!arithmetic.power2.lemma_pow2_strictly_increases. 208 256)
                  )
                  (=>
                   (ens%vstd!arithmetic.power2.lemma_pow2_strictly_increases. 208 256)
                   (=>
                    %%location_label%%12
                    (let
                     ((tmp%%$ (Sub (vstd!arithmetic.power2.pow2.? (I 208)) (vstd!arithmetic.power2.pow2.?
                         (I 156)
                     ))))
                     (let
                      ((tmp%%$13 (vstd!arithmetic.power2.pow2.? (I 208))))
                      (and
                       (and
                        (<= (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 156)) (%I (vstd!seq.Seq.index.? $ (UINT
                              64
                       ...
                       (< tmp%%$13 (vstd!arithmetic.power2.pow2.? (I 256)))
             ))))))))))
             (=>
              (let
               ((tmp%%$ (Sub (vstd!arithmetic.power2.pow2.? (I 208)) (vstd!arithmetic.power2.pow2.?
               ...
               (let
                ((tmp%%$15 (vstd!arithmetic.power2.pow2.? (I 208))))
                (and
                 (and
                  (<= (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 156)) (%I (vstd!seq.Seq.index.? $ (UINT
                        64
                 ...
                 (< tmp%%$15 (vstd!arithmetic.power2.pow2.? (I 256)))
              )))
              (=>
               (= tmp%4 (nClip (Add (nClip (Add (nClip (Add (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
               ...
               (=>
                ...
                (and
                 ...
                 (=>
                  ...
                  (=>
                   (= tmp%6 (nClip (Add (nClip (Add (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.?
                           $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%. limbs!)
                          ) (I 0)
                         )
                        ) (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 52)) (%I (vstd!seq.Seq.index.? $ (UINT
                   ...
                   (=>
                    ...
                    (and
                     ...
                     (=>
                      ...
                      (=>
                       (= tmp%8 (nClip (Add (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY
                              $ (UINT 64) $ (CONST_INT 5)
                             ) (Poly%array%. limbs!)
                            ) (I 0)
                           )
                             ...
                             (=>
                              ...
                              (and
                               (=>
                                ...
                                (=>
                                 ...
                                 (and
                                  (=>
                                   %%location_label%%17
                                   (req%vstd!arithmetic.div_mod.lemma_small_mod. tmp%12 tmp%13)
                                  )
                                  (=>
                                   (ens%vstd!arithmetic.div_mod.lemma_small_mod. tmp%12 tmp%13)
                                   (=>
                                    %%location_label%%18
                                    (= (EucMod (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT
                                           64
                               ...
                               (=>
                                ...
                                (and
                                 (=>
                                  (= tmp%14 (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 52)) (%I (vstd!seq.Seq.index.?
                                  ...
                                  (=>
                                   ...
                                   (and
                                    (=>
                                     %%location_label%%19
                                     (req%vstd!arithmetic.div_mod.lemma_small_mod. tmp%14 tmp%15)
                                    )
                                    (=>
                                     (ens%vstd!arithmetic.div_mod.lemma_small_mod. tmp%14 tmp%15)
                                     (=>
                                      %%location_label%%20
                                      (= (EucMod (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 52)) (%I (vstd!seq.Seq.index.?
                                            $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%.
                                              limbs!
                                             )
                                            ) (I 1)
                                 ...
                                 (=>
                                  ...
                                  (and
                                   (=>
                                    (= tmp%16 (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 104)) (%I (vstd!seq.Seq.index.?
                                         $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%.
                                           limbs!
                                          )
                                         ) (I 2)
                                    ...
                                    (=>
                                     (= tmp%17 (vstd!arithmetic.power2.pow2.? (I 256)))
                                     (and
                                      (=>
                                       %%location_label%%21
                                       (req%vstd!arithmetic.div_mod.lemma_small_mod. tmp%16 tmp%17)
                                      )
                                      (=>
                                       (ens%vstd!arithmetic.div_mod.lemma_small_mod. tmp%16 tmp%17)
                                       (=>
                                        %%location_label%%22
                                        (= (EucMod (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 104)) (%I (vstd!seq.Seq.index.?
                                              $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%.
                                                limbs!
                                               )
                                              ) (I 2)
                                   ...
                                   (=>
                                    ...
                                    (and
                                     (=>
                                      (= tmp%18 (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 156)) (%I (vstd!seq.Seq.index.?
                                           $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%.
                                             limbs!
                                            )
                                           ) (I 3)
                                      ...
                                      (=>
                                       (= tmp%19 (vstd!arithmetic.power2.pow2.? (I 256)))
                                       (and
                                        (=>
                                         %%location_label%%23
                                         (req%vstd!arithmetic.div_mod.lemma_small_mod. tmp%18 tmp%19)
                                        )
                                        (=>
                                         (ens%vstd!arithmetic.div_mod.lemma_small_mod. tmp%18 tmp%19)
                                         (=>
                                          %%location_label%%24
                                          (= (EucMod (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 156)) (%I (vstd!seq.Seq.index.?
                                                $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%.
                                                  limbs!
                                                 )
                                                ) (I 3)
                                     ...
                                     (=>
                                      ...
                                      (=>
                                       %%location_label%%25
                                       (= (EucMod (curve25519_dalek!specs.scalar52_specs.five_limbs_to_nat_aux.? (Poly%array%.
                                           limbs!
                                          )
                                         ) (vstd!arithmetic.power2.pow2.? (I 256))
                                          ...
                                          ) (EucMod (nClip (Mul (vstd!arithmetic.power2.pow2.? (I 208)) (%I (vstd!seq.Seq.index.?
                                               $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT 64) $ (CONST_INT 5)) (Poly%array%.
                                                 limbs!
                                                )
                                               ) (I 4)
      ...
      (=>
       ...
       (and
        (=>
         (= tmp%20 (vstd!arithmetic.power2.pow2.? (I 208)))
         (=>
          ...
          (=>
           (ens%vstd!arithmetic.mul.lemma_mul_is_commutative. tmp%20 tmp%21)
           (=>
            ...
            (and
             (=>
              %%location_label%%26
              (req%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_mul_mod. tmp%22 208
               256
             ))
             (=>
              (ens%curve25519_dalek!lemmas.common_lemmas.pow_lemmas.lemma_pow2_mul_mod. tmp%22 208
               256
              )
              (=>
               %%location_label%%27
           ...
           (=>
            ...
            (=>
             ...
             (= (curve25519_dalek!specs.core_specs.u8_32_as_nat.? (Poly%array%. bytes!)) (nClip
               (Add (nClip (Add (nClip (Add (nClip (Add (curve25519_dalek!lemmas.scalar_byte_lemmas.scalar_to_bytes_lemmas.limb0_byte_contribution_52.?
                       (Poly%array%. limbs!) (Poly%array%. bytes!)
                      ) (curve25519_dalek!lemmas.scalar_byte_lemmas.scalar_to_bytes_lemmas.limb1_byte_contribution_52.?
                       (Poly%array%. limbs!) (Poly%array%. bytes!)
                     ))
          ...
          (=>
           ...
           (and
            (=>
             ...
             (=>
              (= tmp%24 (vstd!arithmetic.power2.pow2.? (I 52)))
              (and
               (=>
                %%location_label%%30
                (req%vstd!arithmetic.div_mod.lemma_small_mod. tmp%23 tmp%24)
               )
               (=>
                (ens%vstd!arithmetic.div_mod.lemma_small_mod. tmp%23 tmp%24)
                (=>
                 %%location_label%%31
                 (= (EucMod (%I (vstd!seq.Seq.index.? $ (UINT 64) (vstd!view.View.view.? $ (ARRAY $ (UINT
                        64
