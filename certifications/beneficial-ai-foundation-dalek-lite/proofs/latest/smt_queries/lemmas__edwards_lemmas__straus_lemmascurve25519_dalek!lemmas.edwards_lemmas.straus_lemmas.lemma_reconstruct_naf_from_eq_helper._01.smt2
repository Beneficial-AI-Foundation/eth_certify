...
;; curve25519-dalek/src/lemmas/edwards_lemmas/straus_lemmas.rs:1221:7: 1221:68 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::straus_lemmas::lemma_reconstruct_naf_from_eq_helper
;; curve25519-dalek/src/lemmas/edwards_lemmas/straus_lemmas.rs:1221:7: 1221:68 (#0)
    ...
    (=>
     ...
     (or
            ...
            (=>
             ...
             (=>
              (= tmp%3 (= (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. sub@) (I 0))
                (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. naf!) (I k!))
              ))
              (and
               (=>
                %%location_label%%3
               ...
               (=>
                tmp%3
                (=>
                 (= tmp%4 (= (vstd!seq.Seq.len.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. sub@)) (Sub 256
                    k!
                 )))
                 (and
                  (=>
                     ...
                     (=>
                      ...
                      (=>
                       (= tmp%5 (= (vstd!seq.Seq.index.? $ (SINT 8) (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
                         ...
                         ) (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. sub@) (I (Add (%I j@) 1)))
                       ))
                       (and
                        (=>
                         %%location_label%%5
                        ...
                        (=>
                         ...
                         (=>
                          (= tmp%6 (= (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. sub@) (I (Add (%I
                            ...
                            ) (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. naf!) (I (Add (Add k! 1)
                               (%I j@)
                          )))))
                          (and
                           (=>
                           ...
                           (=>
                            tmp%6
                            (=>
                             (= tmp%7 (= (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. sub_next@) j@)
                               (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. naf!) (I (Add (Add k! 1) (
                                   %I j@
                             ))))))
                             (and
                              ...
                              (=>
                               ...
                               (=>
                                ...
                                (= (vstd!seq.Seq.index.? $ (SINT 8) (vstd!seq.Seq.subrange.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>.
                                 ...
                                 ) (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. sub_next@) j@)
                    )))))))))))))
                    (=>
                     (forall ((j$ Poly)) (!
                       (=>
                       ...
                       :pattern ((vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. sub_next@) j$))
                       :qid user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_reconstruct_naf_from_eq_helper_77
                       :skolemid skolem_user_curve25519_dalek__lemmas__edwards_lemmas__straus_lemmas__lemma_reconstruct_naf_from_eq_helper_77
                     ))
                     (=>
      ...
      (and
       ...
       (=>
        %%location_label%%10
        (= (curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.reconstruct_naf_from.? (Poly%vstd!seq.Seq<i8.>.
           naf!
          ) (I k!)
         ) (curve25519_dalek!specs.scalar_specs.reconstruct.? (vstd!seq.Seq.subrange.? $ (SINT
            8
