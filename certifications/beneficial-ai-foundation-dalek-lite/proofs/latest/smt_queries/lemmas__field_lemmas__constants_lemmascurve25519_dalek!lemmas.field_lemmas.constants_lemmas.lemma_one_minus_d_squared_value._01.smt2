...
;; curve25519-dalek/src/lemmas/field_lemmas/constants_lemmas.rs:309:1: 309:47 (#0)
...
;; Function-Def curve25519_dalek::lemmas::field_lemmas::constants_lemmas::lemma_one_minus_d_squared_value
;; curve25519-dalek/src/lemmas/field_lemmas/constants_lemmas.rs:309:1: 309:47 (#0)
 ...
 (assert
  (not (=>
    (let
     ...
     (let
      ((omd_val$ (EucMod (curve25519_dalek!lemmas.field_lemmas.constants_lemmas.local_u5_nat.?
          (Poly%array%. (curve25519_dalek!backend.serial.u64.field.FieldElement51./FieldElement51/limbs
      ...
      (let
       ...
       (let
        ((one_minus_d$ (EucMod (nClip (Sub (nClip (Add (EucMod 1 lp$) lp$)) (EucMod d_val$ lp$)))
           lp$
        )))
        (let
         ((one_plus_d$ (EucMod (nClip (Add 1 d_val$)) lp$)))
         (= omd_val$ (EucMod (nClip (Mul one_minus_d$ one_plus_d$)) lp$))
    )))))
    (=>
     (ens%curve25519_dalek!lemmas.field_lemmas.constants_lemmas.lemma_bridge_local_pow2.
      0
