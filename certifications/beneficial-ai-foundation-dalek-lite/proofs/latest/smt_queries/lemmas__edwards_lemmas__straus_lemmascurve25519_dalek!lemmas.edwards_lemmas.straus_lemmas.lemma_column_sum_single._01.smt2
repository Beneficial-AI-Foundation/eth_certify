...
;; curve25519-dalek/src/lemmas/edwards_lemmas/straus_lemmas.rs:762:1: 762:72 (#0)
...
;; Function-Def curve25519_dalek::lemmas::edwards_lemmas::straus_lemmas::lemma_column_sum_single
;; curve25519-dalek/src/lemmas/edwards_lemmas/straus_lemmas.rs:762:1: 762:72 (#0)
...
(push)
 ...
 (assert
  (not (=>
    (= pts@ (%Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. (vstd!seq.Seq.push.? (DST $) (TYPE%tuple%2.
        $ NAT $ NAT
       ) (vstd!seq.Seq.empty.? (DST $) (TYPE%tuple%2. $ NAT $ NAT)) (Poly%tuple%2. P!)
    )))
    (=>
     (= digs@ (%Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>. (vstd!seq.Seq.push.? $ (TYPE%vstd!seq.Seq.
         $ (SINT 8)
     ...
     (=>
      (= tmp%1 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (vstd!seq.Seq.index.? (DST $) (TYPE%tuple%2.
          $ NAT $ NAT
         ) (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. pts@) (I 0)
        ) (Poly%tuple%2. P!)
      ))
      (and
       (=>
       ...
       (=>
        tmp%1
        (=>
         (= tmp%2 (ext_eq false (TYPE%vstd!seq.Seq. $ (SINT 8)) (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq.
             $ (SINT 8)
            ) (Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>. digs@) (I 0)
           ) (Poly%vstd!seq.Seq<i8.>. d!)
         ))
         (and
          (=>
          ...
          (=>
           tmp%2
           (=>
            (= tmp%3 (= (vstd!seq.Seq.index.? $ (SINT 8) (vstd!seq.Seq.index.? $ (TYPE%vstd!seq.Seq.
                 $ (SINT 8)
                ) (Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>. digs@) (I 0)
               ) (I j!)
              ) (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. d!) (I j!))
            ...
            (and
             ...
             (=>
              tmp%3
              (=>
               (= prev@ (curve25519_dalek!lemmas.edwards_lemmas.straus_lemmas.straus_column_sum.?
                 (Poly%vstd!seq.Seq<tuple%2<nat./nat.>.>. pts@) (Poly%vstd!seq.Seq<vstd!seq.Seq<i8.>.>.
                  digs@
                 ) (I j!) (I 0)
               ))
               (=>
                (= tmp%4 (ext_eq false (TYPE%tuple%2. $ NAT $ NAT) (Poly%tuple%2. prev@) (Poly%tuple%2.
                   (curve25519_dalek!specs.edwards_specs.edwards_identity.? (I 0))
                )))
                (and
                 (=>
                 ...
                 (=>
                  ...
                  (=>
                   ...
                   (=>
                    (= tmp%5 (%I (vstd!seq.Seq.index.? $ (SINT 8) (Poly%vstd!seq.Seq<i8.>. d!) (I j!))))
                    (and
                     (=>
                      %%location_label%%4
                      (req%curve25519_dalek!lemmas.edwards_lemmas.curve_equation_lemmas.lemma_edwards_scalar_mul_signed_canonical.
                     ...
                     (=>
                      ...
                      (=>
                       ...
                       (=>
                        (= tmp%6 (%I (tuple%2./tuple%2/0 (%Poly%tuple%2. (Poly%tuple%2. id@)))))
                        (=>
                         (= tmp%7 (%I (tuple%2./tuple%2/1 (%Poly%tuple%2. (Poly%tuple%2. id@)))))
                         (=>
